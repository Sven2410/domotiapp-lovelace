...
`;function q(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var qn=null,gr=a=>{qn=a},ue=a=>String(a??"").split(".")[0],b=(a,e)=>e&&a?.states?.[e]||null,Y=(a,e)=>b(a,e)?.attributes??{},Ht=(a,e,t)=>t?null:Y(a,e).entity_picture||null;function fr(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function E(a,e,t){return t||Y(a,e).friendly_name||e||""}var Yl=new Set(["scene","script","input_button","button","event"]),Zn=a=>Yl.has(ue(a));function ee(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!Zn(a.entity_id):!1}function te(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(ue(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var Ql=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),br=a=>Ql.has(ue(a));function vr(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function Lt(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var V=(a,e)=>Lt(a,"hass-more-info",{entityId:e});function rt(a){switch(ue(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function Jl(a){switch(ue(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function me(a,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let i=n.confirmation===!0?{}:n.confirmation;if(!qn){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}qn(i).then(r=>{r&&hr(a,e,t,n)});return}hr(a,e,t,n)}}function hr(a,e,t,n){switch(n.action){case"more-info":V(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=Jl(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),Lt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":Lt(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":Lt(a,"ll-custom",n);break;default:break}}function B(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return a.addEventListener("pointerdown",d),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),a.removeEventListener("pointerdown",d),a.removeEventListener("click",c)}}function J(a,e){if(!e)return"";let t=ue(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function F(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var ur=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],kr=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],mr=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),Rt=(a,e)=>Math.round((mr(e)-mr(a))/864e5);function ot(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function It(a,e=new Date){if(!a)return"";let t=Rt(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?ur[a.getDay()]:`${ur[a.getDay()].slice(0,2)} ${a.getDate()} ${kr[a.getMonth()]}`}var xr=a=>a?`${a.getDate()} ${kr[a.getMonth()]}`:"";function ed(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function td(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function D(a,e=4){if(!a)return;let t=td(a);if(!t){e>0&&requestAnimationFrame(()=>D(a,e-1));return}let n=`${id(a,ed(t))}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}var Xn=new WeakMap,nd=12,ad=3;function id(a,e){let t=Xn.get(a)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-nd),i=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(i.length===2&&r>=ad){let s=Math.max(...i);return Xn.set(a,{rij:n,vast:{paar:i,waarde:s}}),s}return Xn.set(a,{rij:n,vast:null}),e}function Ge(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function R(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);D(a)});e.observe(a);for(let t of a.children)e.observe(t);return D(a),()=>e.disconnect()}var rd="home-assistant";function _r({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:i=()=>Date.now(),marker:r=rd,intervalMs:o=20,maxWachtMs:s=1e4}){let l=i();function d(){let h=a();if(!h)return!1;for(let[g,m]of e)try{h.get(g)||h.define(g,m)}catch(k){t(`kon ${g} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=a();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(i()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var wr=[];function O(a,e){wr.push([a,e])}function Ue({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function yr(a=()=>{}){_r({leesRegistry:()=>globalThis.customElements,definities:wr,waarschuw:a})}var od=`
  :host {
    ${G}
    display: block;
...
`,$={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},jr={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},I=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),U=(a,e="accent")=>$[a]??(a&&/[#(]|^var/.test(a)?a:$[e]),T=Symbol("incomplete"),sd=a=>`
  <div class="needs">
...
`;var Ft=a=>String(a??"").split(".")[0],Dr=new Set(["input_datetime","time","date","datetime"]),Cr=a=>Dr.has(Ft(a)),de=a=>String(a).padStart(2,"0");function Ed(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function ga(a){if(!a)return null;let e=Ft(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:Ed(a.state)}var Ad=a=>`${a.getFullYear()}-${de(a.getMonth()+1)}-${de(a.getDate())}T${de(a.getHours())}:${de(a.getMinutes())}`;function Md(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${de(Math.floor(n/60))}:${de(n%60)}`}function Lr(a,e=ga(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${de(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(Ft(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":Ad(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${de(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Hr(a,e,t){let n=Ft(a),i=String(t??"");if(!i||!Dr.has(n)||!e)return null;if(e==="time"){let h=i.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let g=`${de(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:g}]:["input_datetime","set_datetime",{entity_id:a,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${de(d)}:${c}:00`;if(n==="datetime"){let h=Md(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${l} ${p}`}]}var Rr=a=>String(a??"").split(".")[0],Ir=new Set(["input_select","select"]),fa=a=>Ir.has(Rr(a));function Se(a){if(!a||!fa(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function qt(a,e=Se(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function Zt(a,e,t=[]){let n=Rr(a),i=String(e??"");return!i||!Ir.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var Vr={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},Sd=/^.*program(?:me)?[_.\- ]/i,Nd=30,Od=95;function Td(a){return String(a??"").replace(Sd,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function Dd(a){let e=Td(a);if(!e.length)return"";let t=[];for(let i=0;i<e.length;i++){let r=e[i],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=Nd&&d<=Od?`${d} \xB0C`:o);continue}let s=e[i+1]?.toLowerCase(),l=s?Vr[o+s]:void 0;if(l){t.push(l),i++;continue}t.push(Vr[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function Cd(a,e){let t=i=>String(i??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(a)}function Xt(a,e){return Cd(a,e)?String(e):Dd(a)||String(a??"")}var Qt={row:44,tile:96,compact:44,beeld:120},ze=6,Pr=12,ba=22,Ld=["row","tile","compact","beeld"],Hd=["links","midden"],va=48,ka=320,Yt=120,ce=a=>{if(a==null||a==="")return Yt;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(ka,Math.max(va,e)):Yt},lt=a=>Hd.includes(a)?a:"links";function Br(a,e){let t=Array.isArray(a)?a:[],n=Array.from({length:e},(i,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var Rd=["card","items","none","open"],Jt=a=>typeof a?.name=="string"?a.name.trim():"",dt=a=>typeof a=="string"?{entity:a}:{...a},ct=a=>Math.min(Math.max(1,Number(a)||2),3),We=a=>Ld.includes(a)?a:"row",ie=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function Kr(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(n=>{let i=ct(n.columns);return{columns:i,layout:We(n.layout),align:lt(n.align),image_size:ce(n.image_size),column_names:Br(n.column_names,i),items:(n.items??n.entities??[]).map(dt)}});let e=(a?.items??a?.entities??[]).map(dt);if(!e.length)return[];let t=ct(a.columns);return[{columns:t,layout:We(a.layout),align:lt(a.align),image_size:ce(a.image_size),column_names:Br(a.column_names,t),items:e}]}function en(a){return Rd.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var Id=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns)),Vd=22;function Pd(a){let e=We(a?.layout);return e!=="beeld"?Qt[e]:ce(a?.image_size)+34}function xa(a){let e=a?.rows??[],t=Jt(a)?ba+ze:0;if(!e.length)return Pr+t+Qt.row;let n=(en(a)==="card"?Pr:0)+t;for(let i of e){let r=Id(i);n+=r*Pd(i)+(r-1)*ze,i.column_names?.length&&(n+=Vd+ze)}return n+(e.length-1)*ze}function pt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();ie(e)&&a.bewaard.push(e)}return a}function Gr(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:ct(n.columns),layout:We(n.layout),align:lt(n.align),image_size:ce(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(dt)})):(()=>{let n=(a.items??a.entities??[]).map(dt);return n.length?[{columns:ct(a.columns),layout:We(a.layout),align:lt(a.align),image_size:ce(a.image_size),column_names:Array.isArray(a.column_names)?[...a.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]),i.forEach((r,o)=>t.push(pt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var _a=a=>a.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Yt?{image_size:ce(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ie).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function wa(a,e,t){let n=new Set;for(let i of a){let r=/^r(\d+)(?:i(\d+))?$/.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:i);continue}n.add(o>e?`r${o+1}${s}`:i)}return n}var Ur=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],Bd=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],Kd=a=>Ur.find(e=>e.waarde===a)?.label??"Rij",Gd=`
...
`,ya=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Gr(e);this.gebouwd_&&JSON.stringify(_a(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=wa(this.open_,e,"weg")}rijErbij_(e){this.open_=wa(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{ie(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Gd;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=pt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return i?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(S=>({waarde:S,label:String(S),titel:`${S} entiteit${S>1?"en":""} in deze rij`})),()=>e.columns,S=>{e.columns=S,pt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let g=this.segment_(Ur.map(S=>({waarde:S.waarde,label:S.label})),()=>e.layout,S=>{e.layout=S,ke(),this.emit_()}),m=document.createElement("div");m.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",m.append(k,g.wrap),h.appendChild(m);let x=this.segment_(Bd.map(S=>({waarde:S.waarde,label:S.label})),()=>e.align??"links",S=>{e.align=S,this.emit_()}),z=document.createElement("div");z.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",z.append(_,x.wrap),h.appendChild(z);let L=document.createElement("div");L.className="beeldvak";let W=document.createElement("ha-form");W.hass=this.hass_,W.schema=[{name:"image_size",selector:{number:{min:va,max:ka,step:4,mode:"slider"}}}],W.computeLabel=()=>"Grootte van de afbeelding",W.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",W.data={image_size:ce(e.image_size)},W.addEventListener("value-changed",S=>{S.stopPropagation(),e.image_size=ce(S.detail.value?.image_size),this.emit_()}),L.appendChild(W),h.appendChild(L);let ke=()=>{let S=e.layout==="beeld";L.style.display=S?"":"none",z.style.display=S?"none":""};ke();let it=document.createElement("div");it.className="kolomvak";let se=document.createElement("ha-form");se.hass=this.hass_;let lr=()=>Array.from({length:e.columns},(S,ae)=>({name:`k${ae}`,selector:{text:{}}}));se.schema=lr(),se.computeLabel=S=>`Kop boven kolom ${Number(S.name.slice(1))+1}`,se.computeHelper=S=>S.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let dr=()=>Object.fromEntries(Array.from({length:e.columns},(S,ae)=>[`k${ae}`,e.column_names?.[ae]??""]));se.data=dr(),se.addEventListener("value-changed",S=>{S.stopPropagation();let ae=S.detail.value??{};e.column_names=Array.from({length:e.columns},(pr,ql)=>ae[`k${ql}`]??""),this.emit_()}),it.appendChild(se),h.appendChild(it);let cr=()=>{let S=e.items.filter(ie),ae=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&ae.push(Kd(e.layout)),ae.push(S.length?S.map(pr=>this.itemNaam_(pr)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&ae.push("met kolomkoppen"),l.textContent=ae.join(" \xB7 "),d.vernieuw(),g.vernieuw(),x.vernieuw(),ke(),se.schema.length!==e.columns&&(se.schema=lr()),se.data=dr()};return this.koppen_.push(cr),e.items.forEach((S,ae)=>h.appendChild(this.itemBlok_(e,S,t,ae))),n.append(i,h),cr(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(i+1),l.title=`Plek ${i+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(i,1),this.itemWeg_(n,i),pt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let g=document.createElement("div");g.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,x.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",_=>{_.stopPropagation();let L=_.detail.value;L.name?t.name=L.name:delete t.name,L.toggle===!0?t.toggle=!0:delete t.toggle;for(let W of["show_icon","show_name","show_state"])L[W]===!1?t[W]=!1:delete t[W];for(let W of["icon_tap_action","icon_hold_action","tap_action","hold_action"])L[W]?t[W]=L[W]:delete t[W];L.double_tap_action&&L.double_tap_action.action!=="none"?t.double_tap_action=L.double_tap_action:delete t.double_tap_action,this.emit_()});let z=()=>{c.textContent=ie(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ie(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ie(t)),h.hidden=!ie(t)};return this.koppen_.push(z),m.data={entity:t.entity||void 0},k.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(m,k,x),r.append(o,g),z(),r}emit_(){let e=_a(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-entities-card-editor",ya);var tn=class extends M{validate(e){let t=Kr(e);return t.some(n=>n.items.some(ie))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?U(e.tone):this.config.tone?U(this.config.tone):ue(e.entity)!=="light"?$.accent:fr(b(this.hass,e.entity))??$.lit}metSchakelaar_(e){return!!e.toggle&&br(e.entity)}metTijd_(e){return!Cr(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!fa(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",en(e)),this.style.containerType="inline-size";let t=en(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,g)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?Nr({label:"Aan of uit"}):""}
  ...
  `);N("domotiapp-entities-card",tn,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Z={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},X=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),Fe=a=>!a||a.state==="off",za=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),ht=a=>a?.state==="playing",Wr=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function Fr(a){if(!a)return[];let e=[];return(X(a,Z.TURN_ON)||X(a,Z.TURN_OFF))&&e.push("power"),Fe(a)||(X(a,Z.PREVIOUS_TRACK)&&e.push("prev"),X(a,Z.PLAY)||X(a,Z.PAUSE)||X(a,Z.PLAY_MEDIA)?e.push("play"):X(a,Z.STOP)&&e.push("stop"),X(a,Z.NEXT_TRACK)&&e.push("next")),e}var Ne=a=>a?.volume_entity||a?.entity;function ja(a){if(!za(a))return[];let e=[];return X(a,Z.VOLUME_MUTE)&&e.push("mute"),X(a,Z.VOLUME_SET)?e.push("slider"):X(a,Z.VOLUME_STEP)&&e.push("steps"),e}var je=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),qr=a=>a?.attributes?.volume_level!==void 0&&a?.attributes?.volume_level!==null,ut=a=>!!a?.attributes?.is_volume_muted,$a=a=>!!a?.attributes?.mass_player_type,Ea=a=>!!a?.attributes?.shuffle,Aa=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Zr=a=>({off:"all",all:"one",one:"off"})[Ud(a)]??"all",Ud=a=>["off","all","one"].includes(a)?a:"off";function Ma(a,{zoeken:e=!0,sleep:t=!1}={}){if(!za(a))return[];let n=[];return X(a,Z.SHUFFLE_SET)&&n.push("shuffle"),X(a,Z.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&$a(a)&&n.push("search"),n}function Xr(a,{tonen:e=!0}={}){if(!e||!za(a)||!X(a,Z.SELECT_SOURCE)||$a(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function nn(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function mt(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Wd="domotiapp-media-speler:";function Sa(a,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],i=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(a?.players)&&a.players.length?[...new Set([...n(a?.entity)?[a.entity]:[],...a.players.filter(n)])]:Fd(i(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function Fd(a,e){let t=a.filter(n=>$a(e?.states?.[n]));return t.length?t:a}var Yr=a=>Wd+(a??[]).join("|");function Qr(a,e,t){if(!a?.speaker_select)return a?.entity??"";let n=null;try{n=t?.getItem?.(Yr(e))??null}catch{n=null}return n&&e?.includes(n)?n:a.entity&&e?.includes(a.entity)?a.entity:a.entity||e?.[0]||""}function Jr(a,e,t){try{return a?.setItem?.(Yr(e),String(t)),!0}catch{return!1}}var Na="dacScrollSlot",eo=["position","top","left","right","width","overflow"];function to(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[Na])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(eo.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Na]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of eo)t.style[o]=i[o];t.dataset&&delete t.dataset[Na],e?.scrollTo?.(0,n)}}}var qd=[400,1e3,2e3,4e3,8e3,15e3,3e4],Zd=6e4;function Oe(a){let e=a?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(a?.message??""))}var fe=class{constructor(e,{wachttijden:t=qd,traag:n=Zd,klok:i,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=i??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},qe=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var Xd=`
  :host {
    ${G}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Oa=null,no=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Ta=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Oa=Oa??[q(Xd)],this.shadowRoot.adoptedStyleSheets=Oa}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=no(e.title??"Weet je het zeker?"),this.$("p").innerHTML=no(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};O("domotiapp-vraag",Ta);function gt(a={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(a);return e.focus?.(),t}gr(gt);var ao=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var $e=a=>`domotiapp_lovelace/media/${a}`;function Yd(a,e){if(!a)return null;if(e)return a.uri?{type:$e("favorite"),favorite:!0,uri:a.uri}:null;let t=io(a);return!t||!a.library_item_id?null:{type:$e("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function io(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var ro={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Da=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function oo(a,e,t=null){return a?.kind??io(e)??t??"playlists"}var Ca=a=>!!a?.uri,an=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:$e("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),so=(a,e,t)=>{let n=Yd(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},lo=(a,e)=>a.callWS({type:$e("playlist/create"),name:e}).then(t=>t?.playlist??null),co=(a,e)=>a.callWS({type:$e("playlist/remove"),library_item_id:String(e.library_item_id)}),po=(a,e)=>a.callWS({type:$e("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),ho=(a,e,t)=>a.callWS({type:$e("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),uo=(a,e,t)=>a.callWS({type:$e("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Qd=350,Jd={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function ec(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=Jd[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var tc=`
  :host {
    ${G}
...
`,Ha=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[q(nc+xe)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};O("domotiapp-bron-kiezer",Ha);function go(a,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(a,e,t),n.focus?.(),n}function fo(a,e){let t=a?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var ac=524288;function ic(a,e){let t=a?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&ac)!==0}function Ra(a,e,t){return e===t?"zelf":ic(a,e)?rc(a,e,t)?"mee":"los":"kan-niet"}function rc(a,e,t){if(fo(a,t).has(e))return!0;if(fo(a,t).size===0){let n=a?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function bo(a,e,t){let n=Ra(a,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var oc=`
  :host {
    ${G}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Ia=null,rn=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Va=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Ia=Ia??[q(oc)],this.shadowRoot.adoptedStyleSheets=Ia,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </div>`}).join("")}koppel_(e){let t=bo(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};O("domotiapp-speler-kiezer",Va);function vo(a,e,t,n){let i=document.querySelector("domotiapp-speler-kiezer");return i||(i=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var Pa=[15,30,45,60,90],Ba=30;function ko(a){let e=Math.max(0,Math.round(a)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),i=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(i).padStart(2,"0")}`}function Ka(a,{min:e=1,max:t=720}={}){let n=String(a??"").trim();if(!/^\d+$/.test(n))return null;let i=Number(n);return i>=e&&i<=t?i:null}var sc=`
  :host {
    ${G}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Ga=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(sc)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
  ...
  `);var Xa=class extends C{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(i=>typeof i=="string"?{entity:i}:i);t.covers=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()})),{name:"show_stop",selector:f.bool()}]}label(e){if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten."}};H("domotiapp-cover-card-editor",Xa);N("domotiapp-cover-card",cn,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function uc(a){if(!a)return{label:"Onbekend",home:null};switch(a.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:a.state,home:!1}}}var pn=class extends M{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((i,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        ...
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(B(e,{onTap:()=>V(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=b(this.hass,t.entity),i=uc(n);e.style.setProperty("--tone",i.home===!0?"var(--dac-good)":i.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=E(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,l=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():A.person),e.setAttribute("aria-label",`${r}, ${i.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return ge(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};y(pn,"css",`
    :host {
  ...
  `);var Ya=class extends C{setConfig(e){let t={...e},n=(e.persons??[]).map(i=>typeof i=="string"?{entity:i}:i);t.persons=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};H("domotiapp-person-card-editor",Ya);N("domotiapp-person-card",pn,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var Qa=a=>String(a??"").trim().split(/\s+/).filter(Boolean);function mc(a){let e=Qa(a);return e.filter((n,i)=>i===0||n.toLowerCase()!==e[i-1].toLowerCase()).join(" ")}function gc(a){let e=a.map(Qa).filter(i=>i.length);if(e.length<2)return 0;let t=0,n=Math.min(...e.map(i=>i.length));for(;t<n;){let i=e[0][t].toLowerCase();if(!e.every(r=>r[t].toLowerCase()===i))break;t++}return Math.min(t,n-1)}function Ja(a){let e=a.map(n=>mc(n)),t=gc(e);return e.map(n=>{let i=Qa(n),r=i.slice(t);return(r.length?r:i).join(" ")})}var fc=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function bc(a){for(let[e,t,n]of fc)if(e.test(a))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var jo={"geen datum":"geen datum",voorbij:"is geweest","bestaat niet":"sensor ontbreekt"},$o=a=>String(a??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),hn=class extends M{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}read_(){let e=new Date,t=this.config.sensors.map(r=>{let o=b(this.hass,r.entity),s=o?ot(o.state)??ot(o.attributes.date)??ot(o.attributes.next_date):null;return{cfg:r,st:o,date:s}}),n=t.map(r=>$o(E(this.hass,r.cfg.entity,r.cfg.name))),i=Ja(n);return t.map((r,o)=>{let s=r.cfg.label??i[o]??n[o],l=bc(r.cfg.label??r.cfg.entity+s),d=this.config.tones?.[r.cfg.entity];return{label:s,entity:r.cfg.entity,date:r.date,days:r.date?Rt(e,r.date):null,tone:U(d??r.cfg.tone??l.tone),icon:r.cfg.icon??l.icon,reden:r.st?r.date?Rt(e,r.date)<0?"voorbij":null:"geen datum":"bestaat niet"}}).sort((r,o)=>!r.reden&&!o.reden?r.date-o.date:r.reden?o.reden?r.label.localeCompare(o.label):1:-1)}komend_(e){return e.filter(t=>!t.reden)}breed_(){return this.config.layout==="breed"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("vorm",this.breed_()?"breed":"lijst"),`
      <div class="card surface">
        ...
        <div class="r" data-stil="true" style="--tone:${d.tone}">
          ...
          <span class="d">${jo[d.reden]??d.reden}</span>
        </div>`;let c=It(d.date),p=d.days<=6?`<small>${xr(d.date)}</small>`:"";return`
        <div class="r" style="--tone:${d.tone}">
          <i></i><span>${I(d.label)}</span>
          <span class="d">${c}${p}</span>
        </div>`}).join("")}}paintBreed_(e,t){let n=this.$(".breed");if(!n)return;let i=e.map(r=>`${r.label}|${+r.date}|${r.reden??""}`).join(",");n.dataset.sig!==i&&(n.dataset.sig=i,n.innerHTML=e.map(r=>{let o=r.reden?jo[r.reden]??r.reden:r.days===0?"vandaag":r.days===1?"morgen":It(r.date);return`
...
`,Yo=a=>a.filter(fn).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function Ze(a){let e=String(a?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function si(a){let e=a.cards?.length??0;return e?e===1?Ze(a.cards[0]):`${e} kaarten`:"Nog geen kaart"}var li=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(ri);this.gebouwd_&&JSON.stringify(Yo(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Nc;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let i=document.createElement("button");i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Tabblad toevoegen",i.disabled=this.tabs_.length>=8,i.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(i)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!fn(e)),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=si(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),i.append(r,o,c,p,h),n.appendChild(i);let g=document.createElement("div");g.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),g.append(m,k,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!Bo()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>Inhoud: <b>${si(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(bn()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>${e.cards.length?`<b>${si(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let i=document.createElement("button");return i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Kaart toevoegen",i.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(i),n}uitVoorbeeld(e,t,n){let i=this.tabs_[e];if(i){if(t==="toevoegen"){this.voegToeViaHa_(i,e);return}this.kaartActie_(i,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,i=Number.isInteger(t)?this.tabs_[t]:null;if(!i||!i.cards[n]){e?.remove();return}let r=this.bewerkVak_(i,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,i){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==i.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:i.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){qo(e.cards[i.index]);return}let r=Uo(e.cards,n,i);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let i=document.createElement("div");i.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=Ze(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&i.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=Ze(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||i.append(r,l),i}kaartTabbladen_(e,t,n,i,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let g of l.querySelectorAll("button"))g.setAttribute("aria-selected",String(g.dataset.blad===h));i.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let g=document.createElement("button");g.type="button",g.dataset.blad=h.id,g.textContent=h.naam,g.setAttribute("role","tab"),g.setAttribute("aria-selected","false"),g.addEventListener("click",()=>c(h.id)),l.appendChild(g)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,i,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[i],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[i]=l,o.config=l,this.emit_(),r.textContent=Ze(l))}),o}async voegToeViaHa_(e,t){let n=await Zo({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=v("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=Ze(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsKaart_(e,n,i,-1));p.disabled=i===0;let h=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsKaart_(e,n,i,1));h.disabled=i===e.cards.length-1;let g=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderKaart_(e,n,i));g.classList.add("weg"),o.append(s,l,p,h,g),r.appendChild(o);let m=document.createElement("div");m.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",x=>{x.stopPropagation();let z=x.detail?.config;z&&(e.cards[i]=z,this.emit_(),d.textContent=Ze(z),c.textContent=String(z.type??""))}),k.addEventListener("GUImode-changed",x=>x.stopPropagation()),m.appendChild(k),r.appendChild(m),r}verplaatsKaart_(e,t,n,i){let r=n+i;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let i=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){i.add(r);continue}let s=Number(o[1]);s!==n&&i.add(`t${t}k${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let i=document.createElement("input");i.type="text",i.placeholder="Zoek een kaart...",i.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=Vo(Io(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await Po(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),i.addEventListener("input",()=>{this.zoek_=i.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(i,r,s),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Yo(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-tabs-card-editor",li);var Qo=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*es(a){let e=Qo(a),t=0;for(;e&&t++<40;)yield e,e=Qo(e)}function Jo(a){let e=null;for(let n of es(a))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,i=0)=>{if(!n||i>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,i+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,i+1);if(o)return o}return null};return t(e)}var kn=class extends M{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=Lo(e),n={tone:"accent",...e,tabs:t};return t.length||(n[T]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(R(this.$(".card"))),this.kies_(Ro(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let i=Math.min(Math.max(0,e),n.length-1);this.open_=i;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===i));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===i);t&&Ho(this.opslag_(),oi(n),i),this.bouw_(i)}async bouw_(e){if(this.kinderen_.has(e)){D(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let i=document.createElement("div");i.className="leeg",i.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(i),D(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Jo(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,xt(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&bn()){t.replaceChildren(Fo({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),D(this.$(".card"));return}t.replaceChildren(...s),D(this.$(".card")),this.herijkIndeling_()}catch(i){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${I(i?.message??i)}</div>`,D(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,i]of this.kinderen_.entries()){if(!i)continue;let r=this.config?.tabs?.[n]?.cards??[];i.forEach((o,s)=>{let l=Go(o);l&&(t=!0),xt(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),D(this.$(".card"));return}if(t<=0)return;let i=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(i))}inVoorbeeld_(){for(let e of es(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Jo(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};y(kn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);N("domotiapp-tabs-card",kn,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var K={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},Oc=[[K.FOUT,["error","fout","aborting","afgebroken"]],[K.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[K.PAUZE,["pause","paused","pauze","onderbroken"]],[K.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[K.AF,["finished","complete","done","klaar met","afgelopen"]],[K.KLAAR,["ready","idle","standby","klaar","gereed"]],[K.UIT,["off","inactive","uit"]]],Tc=new Set([K.DRAAIT]);function ns(a){let e=String(a??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return K.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,i]of Oc)for(let r of i)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return K.ONBEKEND}var as=a=>Tc.has(ns(a?.state));function is(a,e=new Date){if(!a)return null;let t=String(a.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=a.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let i=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(i)return Number(i[1])*60+Number(i[2])+(i[3]?Math.round(Number(i[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function ts(a){if(a==null)return"";if(a<=0)return"Klaar";if(a<60)return`nog ${a} min`;let e=Math.floor(a/60),t=a%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function rs(a){if(!a)return null;let e=String(a.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var Dc=a=>!!a&&a.state==="on",os=a=>a===K.DRAAIT||a===K.PAUZE||a===K.UITGESTELD;function ss({status:a,deur:e,rest:t,pct:n}={}){let i=ns(a?.state),r=Dc(e);if(i===K.DRAAIT){let o=[];return t!=null?o.push(ts(t)):n!=null&&o.push(`${n}%`),{soort:i,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return i===K.PAUZE?{soort:i,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:i===K.FOUT?{soort:i,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:i===K.AF?{soort:i,tekst:"Programma klaar",tone:"good",waarschuwing:""}:i===K.UITGESTELD?{soort:i,tekst:t!=null?`Start over ${ts(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:i,tekst:"Klep open",tone:"warn",waarschuwing:""}:i===K.UIT?{soort:i,tekst:"Uit",tone:"neutral",waarschuwing:""}:i===K.KLAAR?{soort:i,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:K.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function ls(a){let e=String(a??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var Cc={good:$.good,warn:$.warn,bad:$.bad,neutral:$.neutral,accent:$.accent},xn=class extends M{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[T]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,i,r)=>`
  ...
  `);function Os(a,e,t=!1){if(!e)return"";let n=new Date(e);if(Number.isNaN(n.getTime()))return"";let i=a?.locale?.language??"nl",r=n.toLocaleTimeString(i,{hour:"2-digit",minute:"2-digit"}),o=new Date;return n.getDate()===o.getDate()&&n.getMonth()===o.getMonth()&&n.getFullYear()===o.getFullYear()&&!t?r:`${n.toLocaleDateString(i,{weekday:"short",day:"numeric",month:"short"})} ${r}`}function He(a){return String(a??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var Ai=class extends C{pickers(){return[]}setConfig(e){let t=e??{},n=[...Array.isArray(t.motion_sensors)?t.motion_sensors:[],...t.motion?[t.motion]:[]].filter(r=>typeof r=="string"),i={presets_aan:Ts(t)};for(let r of n){let o=t[`melder:${r}`]||this.hass_?.states?.[r]?.attributes?.friendly_name,s=En(r,o);s&&(i[`meldersoort:${r}`]=s)}super.setConfig({...i,...t})}schema(){let e=this.config_??{},t=s=>Array.isArray(s)?s.filter(l=>typeof l=="string"):[],n=t(e.cameras).map(s=>({name:`cam:${s}`,selector:f.text()})),i=[e.camera,...t(e.cameras)].filter(Boolean),r=t(e.motion_sensors).flatMap(s=>{let l=[{name:`melder:${s}`,selector:f.text()},{name:`meldersoort:${s}`,selector:f.select(_t.map(d=>({value:d.sleutel,label:d.label})))}];return i.length>1&&l.push({name:`melderbij:${s}`,selector:f.select([{value:"",label:"Bij alle camera's"},...i.map(d=>({value:d,label:this.hass?.states?.[d]?.attributes?.friendly_name??d}))])}),l}),o=e.snapshots?[{name:"snapshot_rustperiode",selector:f.number(0,3600)},{name:"snapshot_wachttijd",selector:f.number(0,60)},{name:"snapshot_ontvangers",selector:{entity:{domain:"person",multiple:!0}}},{name:"snapshot_alleen_afwezig",selector:f.bool()}]:[];return[{name:"camera",selector:f.entity("camera")},{name:"name",selector:f.text()},{name:"live_view",selector:f.bool()},{name:"cameras",selector:{entity:{domain:"camera",multiple:!0}}},...n,{name:"presets_aan",selector:f.bool()},...e.presets_aan?[ia("Presets en draaien","mdi:arrow-all",[{name:"presets",selector:f.entity(["select","input_select"])},{name:"preset_buttons",selector:{entity:{domain:["button","scene","script"],multiple:!0}}},{name:"ptz_up",selector:f.entity(["button","switch"])},{name:"ptz_down",selector:f.entity(["button","switch"])},{name:"ptz_left",selector:f.entity(["button","switch"])},{name:"ptz_right",selector:f.entity(["button","switch"])}])]:[],{name:"motion_sensors",selector:{entity:{domain:["binary_sensor","event","lock"],multiple:!0}}},...r,{name:"snapshots",selector:f.bool()},...o.length?[ia("Snapshots en meldingen","mdi:camera-burst",o)]:[]]}label(e){return e.name.startsWith("cam:")?`Naam voor ${E(this.hass,e.name.slice(4))||e.name.slice(4)}`:e.name.startsWith("melder:")?`Naam voor ${E(this.hass,e.name.slice(7))||e.name.slice(7)}`:e.name.startsWith("melderbij:")?"\u21B3 hoort bij welke camera":e.name.startsWith("meldersoort:")?"\u21B3 wat ziet hij":{camera:"Camera",name:"Naam",live_view:"Altijd live",presets:"Presets (keuzelijst)",preset_buttons:"Presets als losse knoppen",motion:"Bewegingsmelder",motion_sensors:"Bewegingsmelders",ptz_up:"Draaien: omhoog",ptz_down:"Draaien: omlaag",ptz_left:"Draaien: links",ptz_right:"Draaien: rechts",cameras:"Nog meer camera's op deze kaart",snapshots:"Snapshots en timeline",snapshot_rustperiode:"Rustperiode per melder (seconden)",snapshot_wachttijd:"Wachten voor het beeld (seconden)",snapshot_ontvangers:"Wie krijgt een melding",snapshot_alleen_afwezig:"Alleen melden als er niemand thuis is",presets_aan:"Presets en draaien"}[e.name]??super.label(e)}helper(e){return e.name.startsWith("meldersoort:")?"Bepaalt onder welke filterknop zijn beelden in de timeline vallen, en welk icoon er op het beeld staat als hij afgaat. Hij wordt geraden uit de naam \u2014 een Reolink klopt vanzelf.":e.name.startsWith("melderbij:")?"Laat dit op 'alle camera's' staan als je het niet weet. De kaart koppelt een melder vanzelf aan de camera waar hij op hetzelfde apparaat zit \u2014 bij een Reolink hoeft je dus niets in te vullen.":{camera:"Op de kaart staat een beeld dat zichzelf ververst. Inzoomen doe je met twee vingers, met het scrollwiel of met een dubbeltik; een gewone tik opent hem groot. Er staan geen knoppen op het beeld.",name:"De naam van de camera zelf. Hij staat linksboven op het beeld, en ook in de rij eronder als je meer camera's op deze kaart hebt staan.",live_view:"De stream staat dan altijd open. Mooier, maar op een dashboard met zes camera's zijn dat zes streams die de hele dag doorlopen.",presets:"De `select` van je camera-integratie \u2014 Reolink en ONVIF leveren die. De kaart maakt van elke optie een knop, onderin het beeld, dus een preset die je in de camera-app toevoegt verschijnt er vanzelf bij.",preset_buttons:"Voor integraties die geen keuzelijst maar losse knoppen leveren, zoals Amcrest en Dahua. Ze mogen naast de keuzelijst staan.",motion:"Het oude enkele veld. Gebruik liever Bewegingsmelders hierboven; deze blijft werken voor kaarten die hem al hebben.",motion_sensors:"Zolang er een aanstaat komt er een merkje op het beeld. Kies er gerust meerdere: een Reolink meldt persoon, voertuig en huisdier los van elkaar, en dan zie je w\xE9lke het is. Een deurbel (`event`) en een slot (`lock`) mogen er ook bij. Per melder kun je hieronder een naam en een soort invullen \u2014 die soort bepaalt onder welke filterknop hij in de timeline valt.",ptz_up:"De vier richtingsknoppen van je integratie. Vul je er geen in, dan komt het draaikruis er niet.",cameras:"Onder het beeld komt dan een rij met namen om tussen te wisselen; de camera waar je naar kijkt licht op. Handig voor de camera's die bij elkaar horen \u2014 voordeur, oprit, achtertuin. Per camera kun je hieronder een eigen naam invullen.",snapshots:"Bij elke detectie legt Home Assistant een beeld vast en zet dat onder de kaart in een strook, met filters erboven op dag, soort en camera \u2014 ook als er nergens een scherm aanstaat. Beelden blijven een week staan; daarboven wijkt vanzelf de oudste. Staat dit uit, dan wordt er niets vastgelegd en niets bewaard.",snapshot_rustperiode:"Hoe lang dezelfde melder daarna met rust wordt gelaten. Dit is het antwoord op tien meldingen achter elkaar. De klok loopt PER MELDER: meldt je camera persoon, voertuig en huisdier apart, dan houden die elkaar niet tegen \u2014 een auto die de oprit op rijdt en de bestuurder die uitstapt leveren allebei een beeld op. Nul betekent: alles vastleggen.",snapshot_wachttijd:"Wacht zoveel seconden na de detectie voordat het beeld genomen wordt. Op nul krijg je het moment zelf; op een of twee seconden staat degene meestal beter in beeld dan met zijn rug ernaartoe. Deze wachttijd verandert niets aan de rustperiode.",snapshot_ontvangers:"De personen die een melding op hun telefoon krijgen, met het beeld erbij. De kaart zoekt zelf de mobiele app van die persoon op. Buitenshuis heeft de telefoon een extern adres nodig (Nabu Casa of een eigen domein) om de foto te laden; zonder dat komt de melding w\xE9l aan, maar zonder plaatje.",snapshot_alleen_afwezig:"Dan blijft de telefoon stil zolang er iemand thuis is. Het beeld komt nog steeds in de timeline te staan \u2014 alleen de melding blijft achterwege. Dit scheelt in de praktijk meer meldingen dan de rustperiode.",presets_aan:"E\xE9n vinkje voor de hele bediening: de presetknoppen in het beeld en het draaikruis linksonder. Zet je het uit, dan blijft alles wat je gekozen hebt gewoon staan \u2014 het is alleen weg van het beeld."}[e.name]}};H("domotiapp-camera-card-editor",Ai);N("domotiapp-camera-card",Nn,{name:"DomotiApp Camera",description:"Live beeld met inzoomen en schuiven, de presets van je camera als knoppen, een draaikruis en een merkje zodra er beweging is."});var On=globalThis,Tn=On.ShadowRoot&&(On.ShadyCSS===void 0||On.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Mi=Symbol(),Ds=new WeakMap,yt=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Mi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Tn&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Ds.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Ds.set(t,e))}return e}toString(){return this.cssText}},be=a=>new yt(typeof a=="string"?a:a+"",void 0,Mi),ne=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new yt(t,a,Mi)},Cs=(a,e)=>{if(Tn)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=On.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},Si=Tn?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return be(t)})(a):a;var{is:sp,defineProperty:lp,getOwnPropertyDescriptor:dp,getOwnPropertyNames:cp,getOwnPropertySymbols:pp,getPrototypeOf:hp}=Object,Dn=globalThis,Ls=Dn.trustedTypes,up=Ls?Ls.emptyScript:"",mp=Dn.reactiveElementPolyfillSupport,zt=(a,e)=>a,Ni={toAttribute(a,e){switch(e){case Boolean:a=a?up:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Rs=(a,e)=>!sp(a,e),Hs={attribute:!0,type:String,converter:Ni,reflect:!1,useDefault:!1,hasChanged:Rs};Symbol.metadata??=Symbol("metadata"),Dn.litPropertyMetadata??=new WeakMap;var ve=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Hs){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&lp(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=dp(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Hs}static _$Ei(){if(this.hasOwnProperty(zt("elementProperties")))return;let e=hp(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(zt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(zt("properties"))){let t=this.properties,n=[...cp(t),...pp(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(Si(i))}else e!==void 0&&t.push(Si(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Cs(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Ni).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Ni;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Rs)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ve.elementStyles=[],ve.shadowRootOptions={mode:"open"},ve[zt("elementProperties")]=new Map,ve[zt("finalized")]=new Map,mp?.({ReactiveElement:ve}),(Dn.reactiveElementVersions??=[]).push("2.1.2");var Ri=globalThis,Is=a=>a,Cn=Ri.trustedTypes,Vs=Cn?Cn.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ws="$lit$",Me=`lit$${Math.random().toFixed(9).slice(2)}$`,Fs="?"+Me,gp=`<${Fs}>`,Ve=document,$t=()=>Ve.createComment(""),Et=a=>a===null||typeof a!="object"&&typeof a!="function",Ii=Array.isArray,fp=a=>Ii(a)||typeof a?.[Symbol.iterator]=="function",Oi=`[ 	
\f\r]`,jt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ps=/-->/g,Bs=/>/g,Re=RegExp(`>|${Oi}(?:([^\\s"'>=/]+)(${Oi}*=${Oi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ks=/'/g,Gs=/"/g,qs=/^(?:script|style|textarea|title)$/i,Vi=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),w=Vi(1),nb=Vi(2),ab=Vi(3),Pe=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),Us=new WeakMap,Ie=Ve.createTreeWalker(Ve,129);function Zs(a,e){if(!Ii(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Vs!==void 0?Vs.createHTML(e):e}var bp=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=jt;for(let s=0;s<t;s++){let l=a[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===jt?c[1]==="!--"?o=Ps:c[1]!==void 0?o=Bs:c[2]!==void 0?(qs.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=Re):c[3]!==void 0&&(o=Re):o===Re?c[0]===">"?(o=i??jt,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?Re:c[3]==='"'?Gs:Ks):o===Gs||o===Ks?o=Re:o===Ps||o===Bs?o=jt:(o=Re,i=void 0);let g=o===Re&&a[s+1].startsWith("/>")?" ":"";r+=o===jt?l+gp:p>=0?(n.push(d),l.slice(0,p)+Ws+l.slice(p)+Me+g):l+Me+(p===-2?s:g)}return[Zs(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},At=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=bp(e,t);if(this.el=a.createElement(d,n),Ie.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=Ie.nextNode())!==null&&l.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(Ws)){let h=c[o++],g=i.getAttribute(p).split(Me),m=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:m[2],strings:g,ctor:m[1]==="."?Di:m[1]==="?"?Ci:m[1]==="@"?Li:Je}),i.removeAttribute(p)}else p.startsWith(Me)&&(l.push({type:6,index:r}),i.removeAttribute(p));if(qs.test(i.tagName)){let p=i.textContent.split(Me),h=p.length-1;if(h>0){i.textContent=Cn?Cn.emptyScript:"";for(let g=0;g<h;g++)i.append(p[g],$t()),Ie.nextNode(),l.push({type:2,index:++r});i.append(p[h],$t())}}}else if(i.nodeType===8)if(i.data===Fs)l.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(Me,p+1))!==-1;)l.push({type:7,index:r}),p+=Me.length-1}r++}}static createElement(e,t){let n=Ve.createElement("template");return n.innerHTML=e,n}};function Qe(a,e,t=a,n){if(e===Pe)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=Et(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Qe(a,i._$AS(a,e.values),i,n)),e}var Ti=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??Ve).importNode(t,!0);Ie.currentNode=i;let r=Ie.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Mt(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Hi(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=Ie.nextNode(),o++)}return Ie.currentNode=Ve,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Mt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Qe(this,e,t),Et(e)?e===j||e==null||e===""?(this._$AH!==j&&this._$AR(),this._$AH=j):e!==this._$AH&&e!==Pe&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):fp(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==j&&Et(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ve.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=At.createElement(Zs(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new Ti(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Us.get(e.strings);return t===void 0&&Us.set(e.strings,t=new At(e)),t}k(e){Ii(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O($t()),this.O($t()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Is(e).nextSibling;Is(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Je=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=j,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=j}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Qe(this,e,t,0),o=!Et(e)||e!==this._$AH&&e!==Pe,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Qe(this,s[n+l],t,l),d===Pe&&(d=this._$AH[l]),o||=!Et(d)||d!==this._$AH[l],d===j?e=j:e!==j&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!i&&this.j(e)}j(e){e===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Di=class extends Je{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===j?void 0:e}},Ci=class extends Je{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==j)}},Li=class extends Je{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Qe(this,e,t,0)??j)===Pe)return;let n=this._$AH,i=e===j&&n!==j||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==j&&(n===j||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Hi=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Qe(this,e)}};var vp=Ri.litHtmlPolyfillSupport;vp?.(At,Mt),(Ri.litHtmlVersions??=[]).push("3.3.3");var Xs=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new Mt(e.insertBefore($t(),r),r,void 0,t??{})}return i._$AI(a),i};var Pi=globalThis,Q=class extends ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Xs(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Pe}};Q._$litElement$=!0,Q.finalized=!0,Pi.litElementHydrateSupport?.({LitElement:Q});var kp=Pi.litElementPolyfillSupport;kp?.({LitElement:Q});(Pi.litElementVersions??=[]).push("4.2.2");var oe=ne`
  :host {
    ${be(G)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${be(xe)}
`;var xp=["unavailable","unknown"],_p=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Ln({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||xp.includes(c.state)){i.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of _p)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function Hn(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var Ki=["hs","rgb","rgbw","rgbww","xy"],Gi="color_temp",wp="onoff";var Be="kleur";var yp=["unavailable","unknown"],Qs=["color_temp_kelvin","rgb_color","hs_color","xy_color"],zp=[0,100];function pe(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===wp,i=t!==null&&t.includes(Gi),r=t!==null&&t.some(d=>Ki.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!yp.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:i&&!l}}function jp(){return{state:"off"}}function Js(a,e){let t=e??pe(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...Np(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function el(a,e,t,n){return e?a&&a.state==="on"?{...a}:Js(t,n):{state:"off"}}function tl(a,e,t,n){let i=n??pe(t),r=Xi(a,t,i);return i.helderheid&&(r.brightness=P(e,1,255)),r}function Ui(a,e,t,n){let i=n??pe(t),r=Xi(a,t,i);return pl(r),r.color_temp_kelvin=P(e,i.minKelvin,i.maxKelvin),r}function Wi(a,e,t,n){let i=n??pe(t),r=Xi(a,t,i);return pl(r),r.hs_color=[P(e?.[0],0,360),P(e?.[1],0,100)],r}function Rn(a,e,t){return a??jp()}function nl(a,e,t){let n=Rn(a,e,t);if(typeof n.brightness=="number")return P(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?P(i,1,255):255}function Fi(a,e,t){let n=t??pe(e),i=Rn(a,e,n);if(typeof i.color_temp_kelvin=="number")return P(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?P(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function In(a,e,t){let n=Rn(a,e,t);if(Bi(n.hs_color))return[P(n.hs_color[0],0,360),P(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return Bi(i)?[P(i[0],0,360),P(i[1],0,100)]:[...zp]}function qi(a){return a!=null&&typeof a=="object"}function al(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!qi(i[s]?.lights?.[o]))return!0;return!1})}function il(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function Zi(a,e,t){return Rn(a,e,t).state==="on"}function rl(a,e,t){let n=t??pe(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=Zi(a,e,n),r=ol(n),o=r?$p(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===Be),kleurkeuze:i&&r,stand:i?o:null}}function ol(a){return!!(a?.kleurtemp&&a?.kleur)}function $p(a,e,t){let n=t??pe(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if(Qs.slice(1).some(r=>a[r]!==void 0))return Be}let i=e?.attributes?.color_mode;return i===Gi&&n.kleurtemp?"wit":Ki.includes(i)&&n.kleur?Be:"wit"}function sl(a,e,t,n){let i=n??pe(t);return ol(i)?e==="wit"?Ui(a,Fi(a,t,i),t,i):Wi(a,In(a,t,i),t,i):a}function ll(a){let e=P(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function dl(a){let e=P(a,1,100);return P(Math.round(e/100*255),1,255)}var Ep=1e3,Ap=4e4,Ys=7;function Mp(a){let e=P(a,Ep,Ap)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[P(t,0,255),P(n,0,255),P(i,0,255)]}function Sp(a){let[e,t,n]=Mp(a);return`rgb(${e}, ${t}, ${n})`}function cl(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:Ys},(r,o)=>{let s=o/(Ys-1),l=t+(n-t)*s;return`${Sp(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Np(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?P(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===Gi&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=P(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Ki.includes(i)&&Bi(t.hs_color)&&(n.hs_color=[P(t.hs_color[0],0,360),P(t.hs_color[1],0,100)]),n}function Xi(a,e,t){return a&&a.state==="on"?{...a}:Js(e,t)}function pl(a){for(let e of Qs)delete a[e]}function Bi(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function P(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Vn="domotiapp-scene-card",Yi="domotiapp-scene-card-editor",hl="domotiapp-scene-editor";var St=["een","twee","drie"],ul="pencil",ml=["grid_options","layout_options","view_layout","visibility"];var gl="entity_id",et=class extends Q{constructor(){super();y(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));y(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[gl]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[gl];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},i={...this._config,entity:n.entity};n.bare?i.bare=!0:delete i.bare,i.entity!==this._config?.entity&&(delete i.name_overrides,this._getypt={}),this._stuurDoor(i)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return j;let t=this._leden();return w`
      <ha-form
        .hass=${this.hass}
    ...
    `}_renderInhoud(){return this._toestand===Ji?w`<div class="inhoud">Bezig met laden…</div>`:this._toestand===bl?w`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=Zi(i,t,n),o=rl(i,t,n);return w`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${qi(i)?j:w`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?w`
                <div class="bediening">
    ...
    `}_renderKleurtemp(e,t,n,i){let r=Fi(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Ui(this._waardeVan(e),s.detail.value,t,n))};return w`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleur(e,t,n,i){let[r,o]=In(i,t,n),s=l=>d=>{d.stopPropagation();let c=In(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Wi(this._waardeVan(e),p,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Lp}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `]);var Hp="0.30.1",Rp=["type","entity","name_overrides","bare"],Kn="laden",Nt="klaar",tr="leeg",nr="geen-groep",vl="opslagfout",kl="fout",Ot=class extends Q{constructor(){super();y(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=Kn,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new fe(()=>this._haalScenesOp()),this._verbinding=new qe}static getConfigElement(){return document.createElement(Yi)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(i=>i.startsWith("light.")&&Array.isArray(t.states[i].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?R(t):null),D(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(i=>!Rp.includes(i)&&!ml.includes(i));n.length&&console.warn(`${Vn}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Ge(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===nr){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=Kn,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?tr:Nt,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let i=t?.code;if(this._melding=t?.message??String(t),Oe(t)&&this._herkansing.plan()){this._toestand=Kn;return}if(i==="home_assistant_error"){this._toestand=vl;return}if(!this.hass.states[n]){this._toestand=nr;return}this._toestand=kl}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==Nt)return;let{oproepen:n}=Ln({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let i=await Hn((r,o)=>this.hass.callService("light",r,o),n);i.length&&this._meldMislukking(i.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),i=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:i},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===Nt&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?tr:Nt}render(){if(!this._config)return j;switch(this._toestand){case nr:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case vl:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case kl:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,i=!1){return w`
      <div class="needs">
    ...
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=v(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===tr,n=this._toestand===Kn,i=this._iconen();return w`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${i.map((r,o)=>w`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Nt)return j;let t=al(this._scenes,this._leden,3).length,n=il(t);return n?w`<div class="mededeling">${n}</div>`:j}_renderEditor(){return w`
    ...
    `]);O(Vn,Ot);O(Yi,et);O(hl,tt);Ue({type:Vn,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Hp}).`,preview:!1});var Ke="domotiapp-alarm-card",ar="domotiapp-alarm-card-editor",xl="domotiapp-alarm-editor",_l="DomotiApp Wekker",wl="https://github.com/Sven2410/domotiapp-lovelace",he="domotiapp_lovelace",re=Object.freeze({get:`${he}/alarms/get`,save:`${he}/alarms/save`,setEnabled:`${he}/alarms/set_enabled`,delete:`${he}/alarms/delete`,stop:`${he}/alarms/stop`,clearMessage:`${he}/alarms/clear_message`,search:`${he}/sound/search`,entities:`${he}/entities/list`,previewStart:`${he}/preview/start`,subscribe:`${he}/updates/subscribe`}),Gn="#026FA1";function yl(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Ip="07:00";var Vp=["uri","name","media_type","image"],Pp="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Bp="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Kp="Music Assistant Wekker",Gp="Verlichting Wekker";function Un(){return{id:null,name:"",time:Ip,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function zl(a){let e=Un();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:ir(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:Tt(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function Tt(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of Vp)e[t]=a[t]===void 0?null:a[t];return e}function ir(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function rr(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),ir(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function jl(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:Tt(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function $l(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function El(a){return ir(a)&&a.slice(0,2)==="02"?Pp:null}function Al(a){return a===!1?Bp:null}function Ml(a){return typeof a?.endless=="boolean"?a.endless:null}function Wn(a,e){let t=e==="lamp",n=t?Gp:Kp,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function Sl(a,e){return Wn(e,"speaker")!==null?!1:rr(a).ok}var Wp=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Fp=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Dt="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",qp="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Zp="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",nt=class extends Q{constructor(){super(),this._concept=Un(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?zl(this.wekker):Un(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:re.previewStart,speaker:this._concept.speaker,sound:Tt(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:re.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Tt(e),endless:Ml(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=rr(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:re.save,person:this.person,alarm:jl(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return w`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return j;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=Wn(t,"speaker"),r=Wn(n,"lamp"),o=El(e.time),s=Al(e.endless),l=Sl(e,t);return w`
      <div class="kop">
  ...
  `]),y(at,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var or=at;O(Ke,Ct);O(ar,or);O(xl,nt);Ue({type:Ke,name:_l,description:`Wekkerkaart van DomotiApp (v${oh}).`,preview:!1,documentationURL:wl});var ch=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function Kl(a){return`/api/image/serve/${a}/original`}function Gl(a){return a?ch.includes(a.type)?a.size>12582912?`Deze afbeelding is ${Math.round(a.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var ph=`
...
`,sr=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(ph)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let i=document.createElement("img");i.src=this.value,i.alt="",i.onerror=()=>{n.dataset.bron="",n.innerHTML=v("car")},n.replaceChildren(i)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=v("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=Gl(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let i=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:i?{Authorization:`Bearer ${i}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(Kl(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};O("dac-foto-picker",sr);var hh="/api/domotiapp_lovelace/loader.js",Ul="domotiapp-lovelace-verversing";function Wl(a){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(a??""));return e?e[1].toLowerCase():null}async function uh(a){try{let e=await a(hh,{cache:"no-store"});return e?.ok?Wl(await e.text()):null}catch{return null}}function mh(){try{return globalThis.sessionStorage?.getItem(Ul)??null}catch{return null}}function gh(a){try{globalThis.sessionStorage?.setItem(Ul,a)}catch{return!1}return!0}function fh(a,e,t){return!a||!e?"onbekend":a===e?"actueel":t===e?"al-geprobeerd":"herladen"}function Fl({eigenUrl:a,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:i=18e5,klok:r=setInterval}={}){let o=Wl(a);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await uh(e);if(fh(o,p,mh())!=="herladen"||!gh(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,i);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var bh="0.30.1";yr(a=>console.warn(`domotiapp-lovelace: ${a}`));Fl({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${bh} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{bh as VERSION};
