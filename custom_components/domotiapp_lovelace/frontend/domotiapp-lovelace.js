var kl=Object.defineProperty;var xl=(a,e,t)=>e in a?kl(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var y=(a,e,t)=>xl(a,typeof e!="symbol"?e+"":e,t);var K=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function Z(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var Pn=null,rr=a=>{Pn=a},ue=a=>String(a??"").split(".")[0],b=(a,e)=>e&&a?.states?.[e]||null,Y=(a,e)=>b(a,e)?.attributes??{},Lt=(a,e,t)=>t?null:Y(a,e).entity_picture||null;function or(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function A(a,e,t){return t||Y(a,e).friendly_name||e||""}var _l=new Set(["scene","script","input_button","button","event"]),Vn=a=>_l.has(ue(a));function te(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!Vn(a.entity_id):!1}function W(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(ue(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var wl=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),sr=a=>wl.has(ue(a));function lr(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function Ct(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var R=(a,e)=>Ct(a,"hass-more-info",{entityId:e});function at(a){switch(ue(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function yl(a){switch(ue(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function me(a,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let i=n.confirmation===!0?{}:n.confirmation;if(!Pn){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}Pn(i).then(r=>{r&&nr(a,e,t,n)});return}nr(a,e,t,n)}}function nr(a,e,t,n){switch(n.action){case"more-info":R(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=yl(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),Ct(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":Ct(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":Ct(a,"ll-custom",n);break;default:break}}function V(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return a.addEventListener("pointerdown",d),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),a.removeEventListener("pointerdown",d),a.removeEventListener("click",c)}}function ee(a,e){if(!e)return"";let t=ue(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function q(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var ar=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],dr=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],ir=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),Bn=(a,e)=>Math.round((ir(e)-ir(a))/864e5);function it(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Kn(a,e=new Date){if(!a)return"";let t=Bn(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?ar[a.getDay()]:`${ar[a.getDay()].slice(0,2)} ${a.getDate()} ${dr[a.getMonth()]}`}var cr=a=>a?`${a.getDate()} ${dr[a.getMonth()]}`:"";function zl(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function $l(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function C(a,e=4){if(!a)return;let t=$l(a);if(!t){e>0&&requestAnimationFrame(()=>C(a,e-1));return}let n=`${Al(a,zl(t))}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}var Gn=new WeakMap,jl=12,El=3;function Al(a,e){let t=Gn.get(a)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-jl),i=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(i.length===2&&r>=El){let s=Math.max(...i);return Gn.set(a,{rij:n,vast:{paar:i,waarde:s}}),s}return Gn.set(a,{rij:n,vast:null}),e}function Be(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function I(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);C(a)});e.observe(a);for(let t of a.children)e.observe(t);return C(a),()=>e.disconnect()}var Ml="home-assistant";function pr({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:i=()=>Date.now(),marker:r=Ml,intervalMs:o=20,maxWachtMs:s=1e4}){let l=i();function d(){let h=a();if(!h)return!1;for(let[g,m]of e)try{h.get(g)||h.define(g,m)}catch(k){t(`kon ${g} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=a();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(i()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var hr=[];function O(a,e){hr.push([a,e])}function Ke({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function ur(a=()=>{}){pr({leesRegistry:()=>globalThis.customElements,definities:hr,waarschuw:a})}var Sl=`
  :host {
    ${K}
    display: block;
...
`,j={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},gr={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},F=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),G=(a,e="accent")=>j[a]??(a&&/[#(]|^var/.test(a)?a:j[e]),T=Symbol("incomplete"),Nl=a=>`
  <div class="needs">
...
`,Zn=null,Xn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Zn=Zn??[Z(Il)],this.shadowRoot.adoptedStyleSheets=Zn,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return j[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
      ...
      </div>`;let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let i=Hl.test(n);t.setAttribute("aria-invalid",String(!i)),i&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=!!this.value_,t=this.$(".sw");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.kleur_():"transparent"),t.title=e?`Kleur: ${gr[this.value_]??this.value_}`:"Kleur kiezen",/^#[0-9a-f]{6}$/i.test(this.kleur_())&&(this.$('input[type="color"]').value=this.kleur_()),this.$(".wissen").hidden=!e;let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let i=this.value_ in j?"":this.value_;n.value!==i&&(n.value=i),n.setAttribute("aria-invalid","false")}}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};O("dac-tone-picker",Xn);var f={entity:a=>({entity:a?{domain:a}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(a,e,t=1)=>({number:{min:a,max:e,step:t,mode:"box"}}),select:a=>({select:{mode:"dropdown",options:a}}),action:(a="more-info")=>({ui_action:{default_action:a}})},Qn=(...a)=>({type:"grid",name:"",schema:a});var Rl=[{name:"bare",selector:f.bool()}],Pl={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},L=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Rl}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return Vl[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),i=t("margin-top:16px");for(let o of e){let s=document.createElement({tone:"dac-tone-picker",foto:"dac-foto-picker"}[o.kind]??"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",l=>{l.stopPropagation(),this.patch_({[o.key]:l.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?i:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Pl[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),i.children.length&&this.appendChild(i)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[i,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[i];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},Vl={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Bl(a=new Date){let e=a.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var Kl=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Gl=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],Yn={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},Ul=["humidity","wind","uv","precipitation","sunset"],Wl=a=>a==null||Number.isNaN(+a)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+a/45)%8],Ht=class extends M{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),i=()=>this.toggleAttribute("narrow",n.matches);i(),n.addEventListener("change",i),this.teardown_.push(()=>n.removeEventListener("change",i))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Bl(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${Kl[e.getDay()]} ${e.getDate()} ${Gl[e.getMonth()]}`);let i=this.$(".clock");i&&this.text(i,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=b(this.hass,e.weather),n=Y(this.hass,e.weather),i=this.$(".now");if(i&&t){let l=rt(t.state);i.style.setProperty("--wtone",G(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${q(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=i.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=v(l,"cloud")),this.text(i.querySelector(".cond"),ee(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=Ul.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${G(Yn[l.key].tone)}" title="${Yn[l.key].label}">
             ${E[Yn[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let i=this.hass?.config?.unit_system?.wind_speed??"km/h",r=Wl(t.wind_bearing);return{key:e,value:`${q(this.hass,t.wind_speed,0)} ${i}${r?` ${r}`:""}`}}case"uv":{let r=Y(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(b(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${q(this.hass,r,1)}`}:null}case"precipitation":{let i=b(this.hass,n.precipitation_entity);if(i){let r=Number(i.state);if(Number.isNaN(r))return null;let o=i.attributes.unit_of_measurement??"mm";return{key:e,value:`${q(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${q(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${q(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=b(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};y(Ht,"css",`
  ...
  `);var Jn=class extends L{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[Qn({name:"weather",selector:f.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Qn({name:"sun",selector:f.entity("sun")},{name:"precipitation_entity",selector:f.entity("sensor")}),{name:"name",selector:f.text()},{name:"hide_below",selector:f.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};H("domotiapp-header-card-editor",Jn);N("domotiapp-header-card",Ht,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var It=class extends M{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      <div class="sep" style="--tone:${G(e.tone)}">
...
`;var ql=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Fl=new Set(["hs","rgb","rgbw","rgbww","xy"]),aa=a=>a?.attributes?.supported_color_modes??[],Zl=a=>aa(a).some(e=>ql.has(e)),Rt=a=>aa(a).some(e=>Fl.has(e)),Pt=a=>aa(a).includes("color_temp"),kr=a=>Math.max(1,Math.round((a??0)/255*100)),Vt=class extends M{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[T]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var Kt=a=>String(a??"").split(".")[0],zr=new Set(["input_datetime","time","date","datetime"]),$r=a=>zr.has(Kt(a)),de=a=>String(a).padStart(2,"0");function Ql(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function la(a){if(!a)return null;let e=Kt(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:Ql(a.state)}var Yl=a=>`${a.getFullYear()}-${de(a.getMonth()+1)}-${de(a.getDate())}T${de(a.getHours())}:${de(a.getMinutes())}`;function Jl(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${de(Math.floor(n/60))}:${de(n%60)}`}function jr(a,e=la(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${de(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(Kt(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":Yl(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${de(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Er(a,e,t){let n=Kt(a),i=String(t??"");if(!i||!zr.has(n)||!e)return null;if(e==="time"){let h=i.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let g=`${de(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:g}]:["input_datetime","set_datetime",{entity_id:a,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${de(d)}:${c}:00`;if(n==="datetime"){let h=Jl(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${l} ${p}`}]}var Ar=a=>String(a??"").split(".")[0],Mr=new Set(["input_select","select"]),da=a=>Mr.has(Ar(a));function Ne(a){if(!a||!da(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function Gt(a,e=Ne(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function Ut(a,e,t=[]){let n=Ar(a),i=String(e??"");return!i||!Mr.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var Sr={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},ed=/^.*program(?:me)?[_.\- ]/i,td=30,nd=95;function ad(a){return String(a??"").replace(ed,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function id(a){let e=ad(a);if(!e.length)return"";let t=[];for(let i=0;i<e.length;i++){let r=e[i],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=td&&d<=nd?`${d} \xB0C`:o);continue}let s=e[i+1]?.toLowerCase(),l=s?Sr[o+s]:void 0;if(l){t.push(l),i++;continue}t.push(Sr[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function rd(a,e){let t=i=>String(i??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(a)}function Wt(a,e){return rd(a,e)?String(e):id(a)||String(a??"")}var Ft={row:44,tile:96,compact:44,beeld:120},ze=6,Nr=12,ca=22,od=["row","tile","compact","beeld"],sd=["links","midden"],pa=48,ha=320,qt=120,ce=a=>{if(a==null||a==="")return qt;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(ha,Math.max(pa,e)):qt},ot=a=>sd.includes(a)?a:"links";function Or(a,e){let t=Array.isArray(a)?a:[],n=Array.from({length:e},(i,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var ld=["card","items","none","open"],Zt=a=>typeof a?.name=="string"?a.name.trim():"",st=a=>typeof a=="string"?{entity:a}:{...a},lt=a=>Math.min(Math.max(1,Number(a)||2),3),Ge=a=>od.includes(a)?a:"row",ie=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function Tr(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(n=>{let i=lt(n.columns);return{columns:i,layout:Ge(n.layout),align:ot(n.align),image_size:ce(n.image_size),column_names:Or(n.column_names,i),items:(n.items??n.entities??[]).map(st)}});let e=(a?.items??a?.entities??[]).map(st);if(!e.length)return[];let t=lt(a.columns);return[{columns:t,layout:Ge(a.layout),align:ot(a.align),image_size:ce(a.image_size),column_names:Or(a.column_names,t),items:e}]}function Xt(a){return ld.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var dd=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns)),cd=22;function pd(a){let e=Ge(a?.layout);return e!=="beeld"?Ft[e]:ce(a?.image_size)+34}function ua(a){let e=a?.rows??[],t=Zt(a)?ca+ze:0;if(!e.length)return Nr+t+Ft.row;let n=(Xt(a)==="card"?Nr:0)+t;for(let i of e){let r=dd(i);n+=r*pd(i)+(r-1)*ze,i.column_names?.length&&(n+=cd+ze)}return n+(e.length-1)*ze}function dt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();ie(e)&&a.bewaard.push(e)}return a}function Cr(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:lt(n.columns),layout:Ge(n.layout),align:ot(n.align),image_size:ce(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(st)})):(()=>{let n=(a.items??a.entities??[]).map(st);return n.length?[{columns:lt(a.columns),layout:Ge(a.layout),align:ot(a.align),image_size:ce(a.image_size),column_names:Array.isArray(a.column_names)?[...a.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]),i.forEach((r,o)=>t.push(dt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var ma=a=>a.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==qt?{image_size:ce(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ie).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function ga(a,e,t){let n=new Set;for(let i of a){let r=/^r(\d+)(?:i(\d+))?$/.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:i);continue}n.add(o>e?`r${o+1}${s}`:i)}return n}var Lr=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],hd=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],ud=a=>Lr.find(e=>e.waarde===a)?.label??"Rij",md=`
...
`,fa=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Cr(e);this.gebouwd_&&JSON.stringify(ma(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=ga(this.open_,e,"weg")}rijErbij_(e){this.open_=ga(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{ie(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=md;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=dt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return i?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(S=>({waarde:S,label:String(S),titel:`${S} entiteit${S>1?"en":""} in deze rij`})),()=>e.columns,S=>{e.columns=S,dt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let g=this.segment_(Lr.map(S=>({waarde:S.waarde,label:S.label})),()=>e.layout,S=>{e.layout=S,ke(),this.emit_()}),m=document.createElement("div");m.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",m.append(k,g.wrap),h.appendChild(m);let x=this.segment_(hd.map(S=>({waarde:S.waarde,label:S.label})),()=>e.align??"links",S=>{e.align=S,this.emit_()}),z=document.createElement("div");z.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",z.append(_,x.wrap),h.appendChild(z);let D=document.createElement("div");D.className="beeldvak";let U=document.createElement("ha-form");U.hass=this.hass_,U.schema=[{name:"image_size",selector:{number:{min:pa,max:ha,step:4,mode:"slider"}}}],U.computeLabel=()=>"Grootte van de afbeelding",U.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",U.data={image_size:ce(e.image_size)},U.addEventListener("value-changed",S=>{S.stopPropagation(),e.image_size=ce(S.detail.value?.image_size),this.emit_()}),D.appendChild(U),h.appendChild(D);let ke=()=>{let S=e.layout==="beeld";D.style.display=S?"":"none",z.style.display=S?"none":""};ke();let nt=document.createElement("div");nt.className="kolomvak";let se=document.createElement("ha-form");se.hass=this.hass_;let Yi=()=>Array.from({length:e.columns},(S,ae)=>({name:`k${ae}`,selector:{text:{}}}));se.schema=Yi(),se.computeLabel=S=>`Kop boven kolom ${Number(S.name.slice(1))+1}`,se.computeHelper=S=>S.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let Ji=()=>Object.fromEntries(Array.from({length:e.columns},(S,ae)=>[`k${ae}`,e.column_names?.[ae]??""]));se.data=Ji(),se.addEventListener("value-changed",S=>{S.stopPropagation();let ae=S.detail.value??{};e.column_names=Array.from({length:e.columns},(tr,vl)=>ae[`k${vl}`]??""),this.emit_()}),nt.appendChild(se),h.appendChild(nt);let er=()=>{let S=e.items.filter(ie),ae=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&ae.push(ud(e.layout)),ae.push(S.length?S.map(tr=>this.itemNaam_(tr)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&ae.push("met kolomkoppen"),l.textContent=ae.join(" \xB7 "),d.vernieuw(),g.vernieuw(),x.vernieuw(),ke(),se.schema.length!==e.columns&&(se.schema=Yi()),se.data=Ji()};return this.koppen_.push(er),e.items.forEach((S,ae)=>h.appendChild(this.itemBlok_(e,S,t,ae))),n.append(i,h),er(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(i+1),l.title=`Plek ${i+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(i,1),this.itemWeg_(n,i),dt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let g=document.createElement("div");g.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,x.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",_=>{_.stopPropagation();let D=_.detail.value;D.name?t.name=D.name:delete t.name,D.toggle===!0?t.toggle=!0:delete t.toggle;for(let U of["show_icon","show_name","show_state"])D[U]===!1?t[U]=!1:delete t[U];for(let U of["icon_tap_action","icon_hold_action","tap_action","hold_action"])D[U]?t[U]=D[U]:delete t[U];D.double_tap_action&&D.double_tap_action.action!=="none"?t.double_tap_action=D.double_tap_action:delete t.double_tap_action,this.emit_()});let z=()=>{c.textContent=ie(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ie(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ie(t)),h.hidden=!ie(t)};return this.koppen_.push(z),m.data={entity:t.entity||void 0},k.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(m,k,x),r.append(o,g),z(),r}emit_(){let e=ma(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-entities-card-editor",fa);var Qt=class extends M{validate(e){let t=Tr(e);return t.some(n=>n.items.some(ie))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?G(e.tone):this.config.tone?G(this.config.tone):ue(e.entity)!=="light"?j.accent:or(b(this.hass,e.entity))??j.lit}metSchakelaar_(e){return!!e.toggle&&sr(e.entity)}metTijd_(e){return!$r(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!da(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Xt(e)),this.style.containerType="inline-size";let t=Xt(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,g)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?_r({label:"Aan of uit"}):""}
            ...
            ${this.metKeuze_(h)?'<span class="keuzeslot" style="display:contents"></span>':""}
              ...
              style="--cols:${o.columns}">${o.column_names.map(h=>`<span>${F(h)}</span>`).join("")}</div>`:""}
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:Ft[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Zt(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>me(this,this.hass,t,t[s]??l),i={action:t.entity?"more-info":"none"};this.teardown_.push(V(e,{onTap:()=>n("tap_action",i),onHold:()=>n("hold_action",i),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(V(r,{onTap:()=>n("icon_tap_action",at(t.entity)),onHold:()=>n("icon_hold_action",i)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=Er(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=b(this.hass,t.entity),p=Ut(t.entity,d.value,Ne(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(wr(o,{value:()=>W(b(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>te(b(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Zt(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let i=b(this.hass,n.entity),r=W(i),o=!!n.entity&&te(i);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=A(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let _=Lt(this.hass,n.entity,n.icon),D=n.icon||(_?`pic:${_}`:Un(n.entity,Y(this.hass,n.entity)));d.dataset.icon!==D&&(d.dataset.icon=D,d.classList.toggle("pic",!!_),d.innerHTML=_?`<img src="${_}" alt="" loading="lazy" />`:v(n.icon||Un(n.entity,Y(this.hass,n.entity)))),d.style.setProperty("--tone",_?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(sa(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),g=null;if(h){let _=o?null:la(i);h.dataset.soort!==(_??"")&&(h.dataset.soort=_??"",h.innerHTML=_?`<input class="tijd" type="${_}" step="60" />`:""),g=h.querySelector(".tijd")}if(g&&(g.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==g)){let _=jr(i,h.dataset.soort);g.value!==_&&(g.value=_)}let m=t.querySelector(".keuzeslot"),k=null;if(m){let _=o?[]:Ne(i),D=_.map(ke=>Wt(ke,this.hass?.formatEntityState?.(i,ke))),U=JSON.stringify([_,D]);m.dataset.opties!==U&&(m.dataset.opties=U,m.innerHTML=_.length?`<select class="keuze">${_.map((ke,nt)=>`<option value="${F(ke)}">${F(D[nt])}</option>`).join("")}</select>`:""),k=m.querySelector(".keuze")}if(k&&(k.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==k)){let _=Gt(i);k.value!==_&&(k.value=_)}let x=t.querySelector(".st"),z=n.show_state??this.config.show_state;if(p||g||k)x.textContent="";else if(z===!1)x.textContent="";else if(o)x.textContent="Niet bereikbaar";else if(!i||Vn(i.entity_id))x.textContent="";else if(ue(i.entity_id)==="light"&&r&&i.attributes.brightness!=null)x.textContent=`${Math.round(i.attributes.brightness/255*100)}%`;else{let _=i.attributes.unit_of_measurement;x.textContent=_?`${i.state} ${_}`:ee(this.hass,i)}t.setAttribute("aria-label",`${l}${i?`, ${ee(this.hass,i)}`:""}`)})}getCardSize(){return ge(ua(this.config))}getGridOptions(){let e=ge(ua(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};y(Qt,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${ca}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);N("domotiapp-entities-card",Qt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var X={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},Q=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),Ue=a=>!a||a.state==="off",ba=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),ct=a=>a?.state==="playing",Dr=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function Hr(a){if(!a)return[];let e=[];return(Q(a,X.TURN_ON)||Q(a,X.TURN_OFF))&&e.push("power"),Ue(a)||(Q(a,X.PREVIOUS_TRACK)&&e.push("prev"),Q(a,X.PLAY)||Q(a,X.PAUSE)||Q(a,X.PLAY_MEDIA)?e.push("play"):Q(a,X.STOP)&&e.push("stop"),Q(a,X.NEXT_TRACK)&&e.push("next")),e}var Oe=a=>a?.volume_entity||a?.entity;function va(a){if(!ba(a))return[];let e=[];return Q(a,X.VOLUME_MUTE)&&e.push("mute"),Q(a,X.VOLUME_SET)?e.push("slider"):Q(a,X.VOLUME_STEP)&&e.push("steps"),e}var $e=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),pt=a=>!!a?.attributes?.is_volume_muted,ka=a=>!!a?.attributes?.mass_player_type,xa=a=>!!a?.attributes?.shuffle,_a=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ir=a=>({off:"all",all:"one",one:"off"})[gd(a)]??"all",gd=a=>["off","all","one"].includes(a)?a:"off";function wa(a,{zoeken:e=!0,sleep:t=!1}={}){if(!ba(a))return[];let n=[];return Q(a,X.SHUFFLE_SET)&&n.push("shuffle"),Q(a,X.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&ka(a)&&n.push("search"),n}function Rr(a,{tonen:e=!0}={}){if(!e||!ba(a)||!Q(a,X.SELECT_SOURCE)||ka(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function Yt(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function ht(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var fd="domotiapp-media-speler:";function ya(a,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],i=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(a?.players)&&a.players.length?[...new Set([...n(a?.entity)?[a.entity]:[],...a.players.filter(n)])]:bd(i(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function bd(a,e){let t=a.filter(n=>ka(e?.states?.[n]));return t.length?t:a}var Pr=a=>fd+(a??[]).join("|");function Vr(a,e,t){if(!a?.speaker_select)return a?.entity??"";let n=null;try{n=t?.getItem?.(Pr(e))??null}catch{n=null}return n&&e?.includes(n)?n:a.entity&&e?.includes(a.entity)?a.entity:a.entity||e?.[0]||""}function Br(a,e,t){try{return a?.setItem?.(Pr(e),String(t)),!0}catch{return!1}}var za="dacScrollSlot",Kr=["position","top","left","right","width","overflow"];function Gr(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[za])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(Kr.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[za]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Kr)t.style[o]=i[o];t.dataset&&delete t.dataset[za],e?.scrollTo?.(0,n)}}}var vd=[400,1e3,2e3,4e3,8e3,15e3,3e4],kd=6e4;function Te(a){let e=a?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(a?.message??""))}var fe=class{constructor(e,{wachttijden:t=vd,traag:n=kd,klok:i,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=i??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},We=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var xd=`
  :host {
    ${K}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,$a=null,Ur=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ja=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),$a=$a??[Z(xd)],this.shadowRoot.adoptedStyleSheets=$a}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=Ur(e.title??"Weet je het zeker?"),this.$("p").innerHTML=Ur(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};O("domotiapp-vraag",ja);function ut(a={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(a);return e.focus?.(),t}rr(ut);var Wr=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var je=a=>`domotiapp_lovelace/media/${a}`;function _d(a,e){if(!a)return null;if(e)return a.uri?{type:je("favorite"),favorite:!0,uri:a.uri}:null;let t=qr(a);return!t||!a.library_item_id?null:{type:je("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function qr(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Fr={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Ea=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Zr(a,e,t=null){return a?.kind??qr(e)??t??"playlists"}var Aa=a=>!!a?.uri,Jt=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:je("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),Xr=(a,e,t)=>{let n=_d(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Qr=(a,e)=>a.callWS({type:je("playlist/create"),name:e}).then(t=>t?.playlist??null),Yr=(a,e)=>a.callWS({type:je("playlist/remove"),library_item_id:String(e.library_item_id)}),Jr=(a,e)=>a.callWS({type:je("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),eo=(a,e,t)=>a.callWS({type:je("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),to=(a,e,t)=>a.callWS({type:je("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var wd=350,yd={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function zd(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=yd[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var $d=`
  :host {
    ${K}
...
`,Ma=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(xe+$d)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[],this.zoekHerkansing_=new fe(()=>this.zoek_()),this.speakerHerkansing_=new fe(()=>this.haalSpeakers_())}open(e,t,n,{radioModus:i=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=i,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=Gr(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Ea.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
...
`,Sa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Z(jd+xe)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};O("domotiapp-bron-kiezer",Sa);function ao(a,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(a,e,t),n.focus?.(),n}function io(a,e){let t=a?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var Ed=524288;function Ad(a,e){let t=a?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&Ed)!==0}function Na(a,e,t){return e===t?"zelf":Ad(a,e)?Md(a,e,t)?"mee":"los":"kan-niet"}function Md(a,e,t){if(io(a,t).has(e))return!0;if(io(a,t).size===0){let n=a?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function ro(a,e,t){let n=Na(a,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Sd=`
  :host {
    ${K}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Oa=null,en=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ta=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Oa=Oa??[Z(Sd)],this.shadowRoot.adoptedStyleSheets=Oa,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </div>`}).join("")}koppel_(e){let t=ro(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};O("domotiapp-speler-kiezer",Ta);function oo(a,e,t,n){let i=document.querySelector("domotiapp-speler-kiezer");return i||(i=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var Ca=[15,30,45,60,90],La=30;function so(a){let e=Math.max(0,Math.round(a)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),i=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(i).padStart(2,"0")}`}function Da(a,{min:e=1,max:t=720}={}){let n=String(a??"").trim();if(!/^\d+$/.test(n))return null;let i=Number(n);return i>=e&&i<=t?i:null}var Nd=`
  :host {
    ${K}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Ha=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(Nd)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
      ...
      </div>`,this.$(".snel").innerHTML=Ca.map(e=>`<button type="button" data-m="${e}" aria-pressed="false">${e}</button>`).join(""),this.$(".sluit").addEventListener("click",()=>this.dicht_()),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.dicht_()}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.dicht_(),e.key==="Enter"&&!this.hasAttribute("loopt")&&this.start_()}),this.$(".snel").addEventListener("click",e=>{let t=e.target.closest("[data-m]");t&&(this.$(".min").value=t.dataset.m,this.markeer_())}),this.$(".min").addEventListener("input",()=>this.markeer_()),this.$(".doe").addEventListener("click",()=>this.start_()),this.$(".weg").addEventListener("click",()=>this.stop_()),this.gebouwd_=!0}markeer_(){let e=this.$(".min").value.trim();for(let t of this.$(".snel").querySelectorAll("[data-m]"))t.setAttribute("aria-pressed",String(t.dataset.m===e));this.$(".fout").hidden=!0}async open(e,t,n){this.gebouwd_||this.bouw_(),this.hass=e,this.entity_=t,this.$(".waar").textContent=n??t,this.$(".min").value=String(Ca[1]),this.$(".fade").value=String(La),this.markeer_(),this.setAttribute("open",""),this.tabIndex=-1,this.focus?.(),await this.haalStand_(),this.hasAttribute("loopt")||setTimeout(()=>this.$(".min")?.focus(),60)}dicht_(){this.removeAttribute("open"),clearInterval(this.tik_),this.tik_=null}async haalStand_(){let e=null;try{e=((await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/list"}))?.timers??[]).find(n=>n.entity_id===this.entity_)??null}catch{e=null}this.toon_(e)}toon_(e){if(clearInterval(this.tik_),this.tik_=null,this.$(".weg").hidden=!e,!e){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",this.$(".doe").hidden=!1;return}this.setAttribute("loopt",""),this.$(".doe").textContent="Opnieuw instellen",this.$(".doe").hidden=!1,this.$(".uitleg").textContent=e.fade?`De laatste ${e.fade} seconden zakt het volume weg, daarna pauzeert de muziek en gaat het volume terug.`:"Aan het eind pauzeert de muziek.";let t=Date.parse(e.ends_at),n=()=>{let i=(t-Date.now())/1e3;this.$(".rest").textContent=so(i),i<=0&&(clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.hasAttribute("open")&&this.haalStand_(),1500))};n(),this.tik_=setInterval(n,1e3)}async start_(){if(this.hasAttribute("loopt")){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.$(".min")?.focus(),40);return}let e=Da(this.$(".min").value);if(e===null){this.melding_("Vul een heel aantal minuten in, tussen 1 en 720.");return}let t=Da(this.$(".fade").value,{min:0,max:600})??La;try{let n=await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/set",entity_id:this.entity_,minutes:e,fade:t});this.toon_(n)}catch(n){this.melding_(n?.message??"De sleeptimer kon niet gezet worden. Is DomotiApp Lovelace klaar met opstarten?")}}async stop_(){try{await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/cancel",entity_id:this.entity_})}catch{}await this.haalStand_()}melding_(e){let t=this.$(".fout");t.textContent=e,t.hidden=!1}};O("domotiapp-sleeptimer",Ha);function lo(a,e,t){let n=document.querySelector("domotiapp-sleeptimer");return n||(n=document.createElement("domotiapp-sleeptimer"),document.body.appendChild(n)),n.open(a,e,t??A(a,e)),n}var tn={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"},sleep:{icon:"sleep",label:"Sleeptimer"}},nn=class extends M{setConfig(e){this.ruw_=e,super.setConfig(this.metSpeler_(e))}metSpeler_(e){if(!e?.speaker_select)return e;let t=ya(e,this.hass),n=Vr(e,t,this.opslag_());return n&&n!==e.entity?{...e,entity:n}:e}set hass(e){let t=!this.hass_;if(super.hass=e,!t||!this.ruw_?.speaker_select)return;let n=this.metSpeler_(this.ruw_);n.entity&&n.entity!==this.config?.entity&&super.setConfig(n)}get hass(){return super.hass}opslag_(){try{return window.localStorage}catch{return null}}spelers_(){return ya(this.ruw_??this.config,this.hass)}groepsSpelers_(){let e=this.config.speakers;return Array.isArray(e)&&e.length||!this.config.speaker_select?e:this.spelers_()}kiesSpeler_(e){!e||e===this.config.entity||(Br(this.opslag_(),this.spelers_(),e),super.setConfig({...this.ruw_,entity:e}))}validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[T]:e.speaker_select?"Zet er een mediaspeler in, of wacht tot Home Assistant er een meldt.":"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?G(this.config.tone):j.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(s,l)=>me(this,this.hass,e,e[s]??l);this.teardown_.push(I(this.$(".card"))),this.teardown_.push(V(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(V(n,{onTap:()=>t("icon_tap_action",at(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation());let i=this.$(".hoesgroot");i&&(this.teardown_.push(V(i,{onTap:()=>t("icon_tap_action",at(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(i,"click",s=>s.stopPropagation()),this.on(i,"pointerdown",s=>s.stopPropagation()));let r=s=>{let l=s.target.closest?.("[data-k]");l&&(s.stopPropagation(),this.doe_(l.dataset.k))},o=this.$(".spelers");o&&(this.on(o,"click",r),this.on(o,"pointerdown",s=>s.stopPropagation())),this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".vol"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".extra"),"pointerdown",s=>s.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=b(this.hass,t),i=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return i(Ue(n)?"turn_on":"turn_off");case"bron":return ao(this.hass,t,A(this.hass,t,this.config.name));case"prev":return i("media_previous_track");case"next":return i("media_next_track");case"play":return i(ct(n)?"media_pause":"media_play");case"stop":return i("media_stop");case"mute":{let r=Oe(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!pt(b(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:Oe(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!xa(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:Ir(_a(n))},{entity_id:t});case"speler":{let r=this.spelers_();return oo(this.hass,r,t,o=>this.kiesSpeler_(o))}case"sleep":return lo(this.hass,t,A(this.hass,t,this.config.name));case"search":return no(this.hass,t,A(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.groepsSpelers_()});default:return}}paint(){let e=this.config,t=b(this.hass,e.entity),n=!t||t.state==="unavailable",i=Dr(t),r=this.$(".top");r.dataset.on=String(i),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:Lt(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||ht(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(l,"speaker")),o.style.setProperty("--tone",i&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(e.icon||ht(t),"speaker"));let c=A(this.hass,e.entity,e.name),p=Yt(t,g=>ee(this.hass,g)),h=this.$(".spelers");if(h){let g=A(this.hass,e.entity);this.text(".spelers .waar",g),h.setAttribute("aria-label",`Speaker kiezen. Nu: ${g}`)}this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),C(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),i=this.config.show_controls===!1||t?[]:Hr(e),r=i.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${tn[s].label}">${v(tn[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=ct(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=v(s))}}paintVolume_(e,t){let n=this.$(".vol"),i=Oe(this.config),r=i===this.config.entity?e:b(this.hass,i),o=this.config.show_volume===!1||t?[]:va(r),s=t?null:Rr(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=[...o,s?"bron":""].join(",");n.dataset.sig!==l&&(n.dataset.sig=l,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${v("volume")}</button>`:"")+(o.includes("slider")?le("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${v("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${v("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${v("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let d=n.querySelector(".bronknop");if(d){let m=s.nu||"Bron";this.text(d.querySelector("b"),m),d.setAttribute("aria-label",`Bron kiezen, nu ${m}`),d.title=`Kies uit ${s.aantal} bronnen`}let c=pt(r),p=$e(r),h=n.querySelector('[data-k="mute"]');if(h){let m=c?"volumeMute":"volume";h.dataset.icon!==m&&(h.dataset.icon=m,h.innerHTML=v(m)),h.setAttribute("aria-pressed",String(c))}let g=n.querySelector(".slider");g&&(this.attach_(g,"volume",{value:()=>$e(b(this.hass,Oe(this.config))),onInput:m=>this.setSlider_(g,m),onCommit:m=>this.hass.callService("media_player","volume_set",{volume_level:m/100},{entity_id:Oe(this.config)}),disabled:()=>te(b(this.hass,Oe(this.config)))}),g.classList.contains("dragging")||this.setSlider_(g,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),i=t||this.config.show_controls===!1?[]:wa(e,{zoeken:this.config.show_search!==!1,sleep:this.config.sleep_timer===!0});n.hidden=!i.length;let r=i.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map((c,p)=>`${c==="search"&&p>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${c}" aria-label="${tn[c].label}">${v(tn[c].icon)}</button>`).join("")),!i.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(xa(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let c=_a(e),p=c==="one"?"repeatOne":"repeat";s.dataset.icon!==p&&(s.dataset.icon=p,s.innerHTML=v(p)),s.setAttribute("aria-pressed",String(c!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[c])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass);let d=document.querySelector("domotiapp-speler-kiezer");d?.hasAttribute("open")&&(d.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let i=we(e,n);this.sliders_.set(t,i),this.teardown_.push(i)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=b(this.hass,this.config?.entity);return 1+(va(e).length?1:0)+(wa(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("media_player."));return n?{entity:n}:{}}};y(nn,"css",`
    :host { display: block; }
  ...
  `);var Ba=class extends L{defaults(){return{show_current:!0,forecast_type:"daily",days:ho}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:f.entity("weather")},{name:"name",selector:f.text()},{name:"forecast_type",selector:f.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:f.number(1,uo)},{name:"show_current",selector:f.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};H("domotiapp-forecast-card-editor",Ba);N("domotiapp-forecast-card",rn,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var gt={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},ft=(a,e)=>!!((a?.attributes?.supported_features??0)&e),Dd=(a={})=>{switch(a.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},on=class extends M{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      <div class="cv" data-i="${i}" data-shown="closed" style="--tone:${G(n.tone??e.tone,"solar")}">
        <button class="chip" type="button" aria-label="Meer info"></button>
        <div class="txt"><div class="nm"></div><div class="st"></div></div>
        ${this.keysHtml(e.show_stop!==!1)}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(i=>{this.on(i,"click",()=>{let r=i.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(V(e.querySelector(".chip"),{onTap:()=>R(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],i=b(this.hass,n.entity),r=Y(this.hass,n.entity),o=!i||i.state==="unavailable",s=i?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=A(this.hass,n.entity,n.name);let l=ft(i,gt.SET_POSITION)&&r.current_position!=null,d=l?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=Dd(r),p=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],h=e.querySelector(".chip");h.dataset.icon!==p&&(h.dataset.icon=p,h.innerHTML=v(p,c[d]));let g=e.querySelector(".st");this.dragging_.has(t)||(g.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":l?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(x=>{if(x.dataset.act==="stop"){x.disabled=o||!ft(i,gt.STOP);return}let z=x.dataset.act==="open";x.disabled=o||(z?!ft(i,gt.OPEN):!ft(i,gt.CLOSE))});let m=e.querySelector(".pos"),k=l&&this.config.show_position!==!1;if(m.hidden=!k,k){if(m.dataset.built||(m.dataset.built="1",m.innerHTML=le("position"),m.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let z=m.querySelector(".slider"),_=D=>{z.style.setProperty("--v",`${D}%`),z.setAttribute("aria-valuenow",String(D)),e.querySelector(".st").textContent=`${D}% open`};this.teardown_.push(we(z,{value:()=>Y(this.hass,n.entity).current_position??0,onInput:_,onCommit:D=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:D})}))}let x=m.querySelector(".slider");if(!x.classList.contains("dragging")){let z=r.current_position??0;x.style.setProperty("--v",`${z}%`),x.setAttribute("aria-valuenow",String(z))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>ft(b(this.hass,n.entity),gt.SET_POSITION));return ge(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("cover."));return{covers:n?[n]:[]}}};y(on,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Ka=class extends L{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(i=>typeof i=="string"?{entity:i}:i);t.covers=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()})),{name:"show_stop",selector:f.bool()}]}label(e){if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten."}};H("domotiapp-cover-card-editor",Ka);N("domotiapp-cover-card",on,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Hd(a){if(!a)return{label:"Onbekend",home:null};switch(a.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:a.state,home:!1}}}var sn=class extends M{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((i,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var Ga=class extends L{setConfig(e){let t={...e},n=(e.persons??[]).map(i=>typeof i=="string"?{entity:i}:i);t.persons=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};H("domotiapp-person-card-editor",Ga);N("domotiapp-person-card",sn,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var Id=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function Rd(a){for(let[e,t,n]of Id)if(e.test(a))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var mo=a=>String(a??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),ln=class extends M{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}read_(){let e=new Date;return this.config.sensors.map(t=>{let n=b(this.hass,t.entity);if(!n)return null;let i=it(n.state)??it(n.attributes.date)??it(n.attributes.next_date);if(!i)return null;let r=t.label??mo(A(this.hass,t.entity,t.name)),o=Rd(t.label??t.entity+r),s=this.config.tones?.[t.entity];return{label:r,date:i,days:Bn(e,i),tone:G(s??t.tone??o.tone),icon:t.icon??o.icon}}).filter(t=>t&&t.days>=0).sort((t,n)=>t.date-n.date)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),`
      <div class="card surface">
  ...
  `);var Ua=class extends L{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,i]of Object.entries(e.tones??{}))t[`kleur:${n}`]=i;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let i of Object.keys(t))i.startsWith("kleur:")&&(t[i]&&(n[i.slice(6)]=t[i]),delete t[i]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${mo(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};H("domotiapp-waste-card-editor",Ua);N("domotiapp-waste-card",ln,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function Ce(a){if(a==null||a==="")return 4;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function dn(a,e=!0){if(typeof a=="string")return{name:"",icon:"",path:a,action:null,items:[]};let t=a??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",action:t.action&&typeof t.action=="object"?{...t.action}:null,items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>dn(n,!1)):[]}}var Ee=a=>Array.isArray(a?.items)?a.items.filter(Ae):[],go=a=>Ee(a).length>0,Ae=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.path?.trim()||a.action));function fo(a){return(Array.isArray(a?.items)?a.items:[]).slice(0,20).map(t=>dn(t))}var bo=[{id:"domotitech",label:"DomotiTech",uitleg:"Opent domotitech.nl in een nieuw tabblad, met het logo erop.",bovenaan:!0,maak:()=>({name:"DomotiTech",icon:"domotitech",path:"https://domotitech.nl",action:null,items:[]})},{id:"herstart",label:"Herstart Home Assistant",uitleg:"Roept homeassistant.restart aan, met een bevestiging ervoor.",bovenaan:!0,maak:()=>({name:"Herstart",icon:"power",path:"",action:{action:"perform-action",perform_action:"homeassistant.restart",confirmation:{title:"Weet je het zeker?",text:"Weet je het zeker dat je Home Assistant wilt herstarten?"}},items:[]})}];function vo(a,e,t=!1){let n=Array.isArray(a)?[...a]:[];if(n.length>=8)return{lijst:n,plek:-1};let i=t?0:n.length;return n.splice(i,0,e),{lijst:n,plek:i}}function cn(a,e=4){let t=(a??[]).filter(Ae),n=Ce(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let i=Math.max(1,n-1);return{balk:t.slice(0,i),meer:t.slice(i),heeftMeer:!0}}function Wa(a){if(a&&typeof a=="object")return a.action?a.action:Wa(a.path);let e=String(a??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var Bd=`
...
Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:z},k.data={name:e.name,path:e.path},k.addEventListener("value-changed",x=>{x.stopPropagation();let z=x.detail.value??{};e.name=z.name??"",e.path=z.path??"",this.emit_()}),g.append(m,k,...this.subBlok_(e,t)),n.appendChild(g),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let i=document.createElement("div");i.className="sublijst",e.items.forEach((s,l)=>i.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,i,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let i=document.createElement("summary");i.textContent="\uFF0B  Subknop toevoegen",n.appendChild(i);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=vo(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of bo){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,i){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=v(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",i),r}subItemBlok_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=v(t.icon,"grid"),d.textContent=t.name||(Ae(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaatsSub_(e,n,i,-1));h.disabled=i===0;let g=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaatsSub_(e,n,i,1));g.disabled=i===e.items.length-1;let m=this.kopKnop_("Verwijderen",E.close,()=>this.verwijderSub_(e,n,i));m.classList.add("weg"),o.append(s,l,h,g,m),r.appendChild(o);let k=document.createElement("div");k.className="body";let x=document.createElement("dac-icon-picker");x.label="Icoon",x.fallback="grid",x.auto=!1,x.hass=this.hass_,x.value=t.icon,x.addEventListener("value-changed",_=>{_.stopPropagation(),t.icon=_.detail.value??"",this.emit_()});let z=document.createElement("ha-form");return z.hass=this.hass_,z.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],z.computeLabel=_=>({name:"Naam",path:"Waar gaat hij heen"})[_.name]??_.name,t.action&&(z.schema=[{name:"name",selector:{text:{}}}],z.computeHelper=_=>_.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),z.data={name:t.name,path:t.path},z.addEventListener("value-changed",_=>{_.stopPropagation();let D=_.detail.value??{};t.name=D.name??"",t.path=D.path??"",this.emit_()}),k.append(x,z),r.appendChild(k),r}verplaatsSub_(e,t,n,i){let r=n+i;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let i=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){i.add(r);continue}let s=Number(o[2]);s!==n&&i.add(`i${t}s${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let i=ko.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(`i${r>e?r-1:r}${i[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let i of this.open_){let r=ko.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(i)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=_o(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-navbar-card-editor",qa);var wo=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*bt(a){let e=wo(a),t=0;for(;e&&t++<40;)yield e,e=wo(e)}function Kd(a){for(let e of bt(a)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Gd(a){for(let e of bt(a))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Ud(a){for(let e of bt(a))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Wd(a){for(let e of bt(a))if(e.classList?.contains?.("section"))return e;return null}function yo(a){for(let e of bt(a)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var pn=class extends M{validate(e){let t=fo(e),n={labels:!0,tone:"accent",...e,items:t,max:Ce(e?.max)};return t.filter(i=>i.name||i.icon||i.path).length||(n[T]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:i}=cn(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let g=Ee(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      ...
      <div class="balk" style="--tone:${G(e.tone)}">
  ...
  `);N("domotiapp-navbar-card",pn,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var qd="dac-tabs:";function Xa(a){let e=a??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],i=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:i}}var hn=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.cards?.length));function zo(a){return(Array.isArray(a?.tabs)?a.tabs:[]).slice(0,8).map(Xa).filter(hn)}function Fd(a,e){if(!e)return 0;let t=Math.round(Number(a?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function Qa(a){let e=(a??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return qd+e}function Zd(a,e,t){let n=null;try{n=a?.getItem?.(e)??null}catch{return null}let i=Number(n);return n===null||n===""||!Number.isInteger(i)?null:i>=0&&i<t?i:null}function $o(a,e,t){try{return a?.setItem?.(e,String(t)),!0}catch{return!1}}function jo(a,e,t){return Zd(t,Qa(e),e.length)??Fd(a,e.length)}var Xd=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function Eo(){let a=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return a.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,i=t.type.startsWith("custom:domotiapp-")?0:1;return n-i||e.naam.localeCompare(t.naam,"nl")}),[...a,...Xd.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function Ao(a,e){let t=String(e??"").trim().toLowerCase();return t?a.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):a}async function Mo(a,e){let t={type:a};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let i=a.startsWith("custom:")?a.slice(7):`hui-${a}-card`,o=await customElements.get(i)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:a}}catch{}return t}var So=()=>!!customElements.get("hui-card-element-editor");function No(a,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},i=a,r=n(e),o=n(t);return r!==null&&(i=Math.max(i,r)),o!==null&&(i=Math.min(i,o)),i}function Qd(a,e){let t=a?.columns,n=a?.rows,i=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));i=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}i=Math.min(12,Math.max(1,No(i,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${i}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,No(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function vt(a,e,t){if(!a?.style)return;let{gridColumn:n,height:i}=Qd(e,t);a.style.gridColumn=n,a.style.height=i??""}function Oo(a){let e=a?._element??a?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function To(a,e,t={}){let n=Array.isArray(a)?[...a]:[],i=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(i)||!n[i]?null:(n.splice(i+1,0,structuredClone(n[i])),n);case"verwijder":return!Number.isInteger(i)||!n[i]?null:(n.splice(i,1),n);case"rooster":return!Number.isInteger(i)||!n[i]||!t.rooster?null:(n[i]={...n[i],grid_options:{...n[i].grid_options??{},...t.rooster}},n);default:return null}}var Co=a=>({...a?{config:a}:{},editMode:!0,saveConfig:async()=>{}}),Yd=()=>document.querySelector("home-assistant");function Lo({kaarten:a,hass:e,maakKaart:t,opActie:n}){let i=document.createElement("ha-sortable");i.disabled=!1,i.draggableSelector=".dac-kaart",i.rollback=!1,i.invertSwap=!0,i.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];a.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",vt(h,d?.grid_options);let g=document.createElement("hui-card-edit-mode");g.hass=e,g.lovelace=Co(),g.path=[0,0,c],g.hiddenOverlay=!1,g.appendChild(p),o.push(g),h.appendChild(g),r.appendChild(h)}),i.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};i.addEventListener("drag-start",()=>s(!1)),i.addEventListener("drag-end",()=>s(!0)),i.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))i.addEventListener(d,p=>{p.stopPropagation(),c(p)});return i}function Do(a){try{let e=typeof structuredClone=="function"?structuredClone(a):JSON.parse(JSON.stringify(a));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Ho({hass:a,kaarten:e}){let t=Yd();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let i=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(i?{kaart:i}:r?{kaarten:r}:null))},l=g=>{if(g?.detail?.dialogTag!=="hui-dialog-edit-card")return;let m=g.detail?.dialogParams?.cardConfig;g.stopImmediatePropagation?.(),g.stopPropagation(),m&&(i=m);let k=t.querySelector("hui-dialog-create-card");typeof k?.closeDialog=="function"&&k.closeDialog(),setTimeout(s,0)},d=g=>{g?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=a,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Co({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async g=>{let m=g?.views?.[0]?.sections?.[0]?.cards;Array.isArray(m)&&(r=m)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let g=p._layoutElement;if(!g)throw new Error("de proxysectie heeft geen layout-element");g.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(g){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",g),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var un=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var Jd=`
...
`,Ro=a=>a.filter(hn).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function qe(a){let e=String(a?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function Ya(a){let e=a.cards?.length??0;return e?e===1?qe(a.cards[0]):`${e} kaarten`:"Nog geen kaart"}var Ja=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(Xa);this.gebouwd_&&JSON.stringify(Ro(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Jd;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let i=document.createElement("button");i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Tabblad toevoegen",i.disabled=this.tabs_.length>=8,i.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(i)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!hn(e)),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=Ya(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",E.close,()=>this.verwijder_(t));h.classList.add("weg"),i.append(r,o,c,p,h),n.appendChild(i);let g=document.createElement("div");g.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),g.append(m,k,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!So()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>Inhoud: <b>${Ya(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(un()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>${e.cards.length?`<b>${Ya(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let i=document.createElement("button");return i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Kaart toevoegen",i.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(i),n}uitVoorbeeld(e,t,n){let i=this.tabs_[e];if(i){if(t==="toevoegen"){this.voegToeViaHa_(i,e);return}this.kaartActie_(i,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,i=Number.isInteger(t)?this.tabs_[t]:null;if(!i||!i.cards[n]){e?.remove();return}let r=this.bewerkVak_(i,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,i){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==i.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:i.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Do(e.cards[i.index]);return}let r=To(e.cards,n,i);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let i=document.createElement("div");i.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=qe(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&i.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=qe(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||i.append(r,l),i}kaartTabbladen_(e,t,n,i,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let g of l.querySelectorAll("button"))g.setAttribute("aria-selected",String(g.dataset.blad===h));i.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let g=document.createElement("button");g.type="button",g.dataset.blad=h.id,g.textContent=h.naam,g.setAttribute("role","tab"),g.setAttribute("aria-selected","false"),g.addEventListener("click",()=>c(h.id)),l.appendChild(g)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,i,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[i],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[i]=l,o.config=l,this.emit_(),r.textContent=qe(l))}),o}async voegToeViaHa_(e,t){let n=await Ho({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=v("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=qe(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaatsKaart_(e,n,i,-1));p.disabled=i===0;let h=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaatsKaart_(e,n,i,1));h.disabled=i===e.cards.length-1;let g=this.kopKnop_("Verwijderen",E.close,()=>this.verwijderKaart_(e,n,i));g.classList.add("weg"),o.append(s,l,p,h,g),r.appendChild(o);let m=document.createElement("div");m.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",x=>{x.stopPropagation();let z=x.detail?.config;z&&(e.cards[i]=z,this.emit_(),d.textContent=qe(z),c.textContent=String(z.type??""))}),k.addEventListener("GUImode-changed",x=>x.stopPropagation()),m.appendChild(k),r.appendChild(m),r}verplaatsKaart_(e,t,n,i){let r=n+i;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let i=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){i.add(r);continue}let s=Number(o[1]);s!==n&&i.add(`t${t}k${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let i=document.createElement("input");i.type="text",i.placeholder="Zoek een kaart...",i.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=Ao(Eo(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await Mo(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),i.addEventListener("input",()=>{this.zoek_=i.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(i,r,s),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Ro(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-tabs-card-editor",Ja);var Po=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Bo(a){let e=Po(a),t=0;for(;e&&t++<40;)yield e,e=Po(e)}function Vo(a){let e=null;for(let n of Bo(a))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,i=0)=>{if(!n||i>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,i+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,i+1);if(o)return o}return null};return t(e)}var gn=class extends M{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=zo(e),n={tone:"accent",...e,tabs:t};return t.length||(n[T]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);N("domotiapp-tabs-card",gn,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var B={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},ec=[[B.FOUT,["error","fout","aborting","afgebroken"]],[B.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[B.PAUZE,["pause","paused","pauze","onderbroken"]],[B.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[B.AF,["finished","complete","done","klaar met","afgelopen"]],[B.KLAAR,["ready","idle","standby","klaar","gereed"]],[B.UIT,["off","inactive","uit"]]],tc=new Set([B.DRAAIT]);function Go(a){let e=String(a??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return B.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,i]of ec)for(let r of i)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return B.ONBEKEND}var Uo=a=>tc.has(Go(a?.state));function Wo(a,e=new Date){if(!a)return null;let t=String(a.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=a.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let i=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(i)return Number(i[1])*60+Number(i[2])+(i[3]?Math.round(Number(i[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function Ko(a){if(a==null)return"";if(a<=0)return"Klaar";if(a<60)return`nog ${a} min`;let e=Math.floor(a/60),t=a%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function qo(a){if(!a)return null;let e=String(a.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var nc=a=>!!a&&a.state==="on",Fo=a=>a===B.DRAAIT||a===B.PAUZE||a===B.UITGESTELD;function Zo({status:a,deur:e,rest:t,pct:n}={}){let i=Go(a?.state),r=nc(e);if(i===B.DRAAIT){let o=[];return t!=null?o.push(Ko(t)):n!=null&&o.push(`${n}%`),{soort:i,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return i===B.PAUZE?{soort:i,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:i===B.FOUT?{soort:i,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:i===B.AF?{soort:i,tekst:"Programma klaar",tone:"good",waarschuwing:""}:i===B.UITGESTELD?{soort:i,tekst:t!=null?`Start over ${Ko(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:i,tekst:"Klep open",tone:"warn",waarschuwing:""}:i===B.UIT?{soort:i,tekst:"Uit",tone:"neutral",waarschuwing:""}:i===B.KLAAR?{soort:i,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:B.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function Xo(a){let e=String(a??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var ac={good:j.good,warn:j.warn,bad:j.bad,neutral:j.neutral,accent:j.accent},fn=class extends M{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[T]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,i,r)=>`
      <button type="button" class="knop ${n}" hidden>
        ${v(i)}<span class="lb">${F(r)}</span>
      </button>`;return`
      <div class="card surface" style="--tone:${j.accent}">
      ...
      </div>`}wire(){let e=this.config;this.on(this.$(".top"),"click",()=>{let t=e.status||e.remaining||e.program;t&&this.moreInfo_(t)}),this.on(this.$(".knop.start"),"click",()=>this.druk_(e.start)),this.on(this.$(".knop.stop"),"click",()=>this.druk_(e.stop)),this.on(this.$(".knop.slim"),"click",()=>{if(!e.smart)return;let t=W(b(this.hass,e.smart));this.hass.callService("homeassistant",t?"turn_off":"turn_on",{entity_id:e.smart})}),this.on(this.$(".rij.programma"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.program)return;t.stopPropagation();let i=Ut(e.program,n.value,Ne(b(this.hass,e.program)));i&&this.hass.callService(i[0],i[1],i[2])}),this.teardown_.push(I(this.$(".card")))}moreInfo_(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}druk_(e){let t=Xo(e);t&&this.hass.callService(t[0],t[1],t[2])}paint(){let e=this.config,t=b(this.hass,e.status),n=b(this.hass,e.door),i=Wo(b(this.hass,e.remaining)),r=qo(b(this.hass,e.progress)),o=Zo({status:t,deur:n,rest:i,pct:r}),s=Uo(t);this.toggleAttribute("draait",s),this.toggleAttribute("onbekend",s&&r==null);let l=this.$(".top"),d=ac[o.tone]??j.accent;this.$(".card").style.setProperty("--tone",d),l.classList.toggle("unavailable",o.soort==="onbekend");let c=this.$(".chip"),p=e.icon||"dishwasher";c.dataset.icon!==p&&(c.dataset.icon=p,c.innerHTML=v(p,"dishwasher")),c.style.setProperty("--tone",d),this.text(".nm",e.name||A(this.hass,e.status,null)||"Vaatwasser");let h=this.$(".st"),g=F(o.tekst),m=o.waarschuwing?` &middot; <span class="let">${F(o.waarschuwing)}</span>`:"";h.dataset.tekst!==g+m&&(h.dataset.tekst=g+m,h.innerHTML=g+m),l.setAttribute("aria-label",`${this.$(".nm").textContent}, ${o.tekst}`);let k=this.$(".balk"),x=Fo(o.soort)&&(r!=null||s);if(k.hidden=!x,x){let z=this.$(".vul"),_=r!=null?`${r}%`:"";_&&z.style.width!==_&&(z.style.width=_),k.setAttribute("role","progressbar"),r!=null?(k.setAttribute("aria-valuenow",String(r)),k.setAttribute("aria-valuemin","0"),k.setAttribute("aria-valuemax","100")):k.removeAttribute("aria-valuenow")}this.paintBediening_(),C(this.$(".card"))}paintBediening_(){let e=this.config,t=this.$(".programslot"),n=b(this.hass,e.program),i=e.program?Ne(n):[],r=i.map(d=>Wt(d,this.hass?.formatEntityState?.(n,d))),o=JSON.stringify([i,r]);t.dataset.opties!==o&&(t.dataset.opties=o,t.innerHTML=i.length?`<select class="keuze" aria-label="Programma">${i.map((d,c)=>`<option value="${F(d)}">${F(r[c])}</option>`).join("")}</select>`:"");let s=t.querySelector(".keuze");if(s&&this.shadowRoot.activeElement!==s){let d=Gt(n);s.value!==d&&(s.value=d)}let l=this.$(".knop.slim");l.hidden=!e.smart,e.smart&&(l.dataset.aan=String(W(b(this.hass,e.smart)))),this.$(".knop.start").hidden=!e.start,this.$(".knop.stop").hidden=!e.stop,this.$(".rij.programma").hidden=!s,this.$(".rij.knoppen").hidden=!e.smart&&!e.start&&!e.stop}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-dishwasher-card-editor")}static getStubConfig(e,t){return{status:((i,r)=>t?.find(o=>o.startsWith(i)&&r.test(o))??"")("sensor.",/vaatwas|dishwash/i),name:"Vaatwasser"}}};y(fn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var ei=class extends L{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"program",selector:f.entity(["select","input_select"])},{name:"start",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"smart",selector:f.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};H("domotiapp-dishwasher-card-editor",ei);N("domotiapp-dishwasher-card",fn,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});function ic(a,e,t,{live:n=!1,fit:i="cover"}={}){if(!t)return null;let r=typeof customElements<"u"&&customElements.get("hui-image"),o=r?"hui-image":"img",s=a;if((!s||s.localName!==o)&&(s=document.createElement(o),s.className="beeld"),r)s.hass=e,s.cameraImage=t,s.cameraView=n?"live":"auto",s.fitMode=i;else{let l=e?.states?.[t],d=l?.attributes?.entity_picture;d&&s.dataset.bron!==d&&(s.dataset.bron=d,s.src=d),s.alt=l?.attributes?.friendly_name??t,s.style.objectFit=i}return s}function bn(a,e,t,n){if(!a)return null;let i=a.querySelector(".beeld"),r=ic(i,e,t,n);return r?(r!==i&&(i?.remove(),a.appendChild(r)),r):(i?.remove(),null)}var ti={idle:{woord:"Klaar voor gebruik",toon:"neutral"},printing:{woord:"Aan het printen",toon:"accent"},paused:{woord:"Gepauzeerd",toon:"warn"},finished:{woord:"Klaar",toon:"good"},failed:{woord:"Mislukt",toon:"bad"},offline:{woord:"Offline",toon:"neutral"},prepare:{woord:"Voorbereiden",toon:"accent"},unknown:{woord:"Onbekend",toon:"neutral"}},rc={idle:["idle","operational","standby","ready","on","off"],printing:["printing","running","run","print","busy","active"],paused:["pause","paused","pausing"],finished:["finish","finished","complete","completed","done","success"],failed:["failed","fail","error","cancelled","canceled","stopped"],prepare:["prepare","preparing","heating","slicing","init"],offline:["offline","unavailable","unknown","disconnected"]};function ni(a){let e=String(a?.state??"").trim().toLowerCase();if(!e)return"unknown";if(e==="unavailable"||e==="none")return"offline";for(let[t,n]of Object.entries(rc))if(n.includes(e))return t;return"unknown"}function vn(a){let e=ni(a);return e==="printing"||e==="prepare"}function ai(a){let e=Number(a?.state);return Number.isFinite(e)?Math.max(0,Math.min(100,Math.round(e))):null}function ii(a){let e=Number(a?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:a?.attributes?.unit_of_measurement??"\xB0C"}:null}function ri(a,e=Date.now()){let t=String(a?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(a?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let o=Date.parse(t);if(Number.isFinite(o))return Math.max(0,Math.round((o-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let o=t.split(":").map(Number),[s,l]=o.length===3?o:[0,o[0]];return s*60+l}let i=Number(t);if(!Number.isFinite(i))return null;let r=String(a?.attributes?.unit_of_measurement??"").toLowerCase();return r==="h"||r==="u"||r.startsWith("hour")?Math.round(i*60):r==="s"||r.startsWith("sec")?Math.round(i/60):Math.round(i)}function oi(a){if(a==null)return"";let e=Math.max(0,Math.round(a));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function si(a,e=new Date){if(a==null)return"";let t=new Date(e.getTime()+a*6e4);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var oc=new Set(["unknown","unavailable","none","null","empty","leeg","off","unload","unloaded"]);function Le(a,{namen:e=!1}={}){if(typeof a!="string")return null;let t=a.trim();if(!t)return null;let n=t.replace(/^#/,"");return/^[0-9a-f]{8}$/i.test(n)?parseInt(n.slice(6),16)<16?null:`#${n.slice(0,6).toUpperCase()}`:/^[0-9a-f]{6}$/i.test(n)?`#${n.toUpperCase()}`:/^[0-9a-f]{3}$/i.test(n)?`#${n.toUpperCase()}`:/^rgba?\(/i.test(t)?t:!e||oc.has(t.toLowerCase())?null:/^[a-z]+$/i.test(t)?t:null}function Qo(a,e={}){let t=a?.attributes??{},n=Le(e.color,{namen:!0})??Le(t.color)??Le(Array.isArray(t.cols)?t.cols[0]:t.cols)??Le(t.filament_color)??Le(t.tray_color)??(/^#?[0-9a-f]{3,8}$/i.test(String(a?.state??""))?Le(a.state):null)??null,i=e.label||t.name||t.type||t.filament_type||t.tray_type||(a&&!Le(a.state)?a.state:"")||"",r=t.empty===!0||t.empty==="true"?!0:!n&&!String(i).trim(),o=Number(t.remain??t.remaining),s=t.remain_enabled!==!1&&!r;return{kleur:r?null:n,soort:String(i).trim(),leeg:r,actief:t.active===!0||t.active==="true",rest:s&&Number.isFinite(o)&&o>=0&&o<=100?Math.round(o):null}}var kt=[1,2,3,4],sc={good:j.good,warn:j.warn,bad:j.bad,neutral:j.neutral,accent:j.accent},kn=class extends M{validate(e){let t={name:"",icon:"printer",...e};return t.status||t.progress||t.camera||t.image||t.nozzle_temp||t.bed_temp||t.power||(t[T]="Kies minstens een printstatus. Camera, voortgang, temperaturen, de deur en de trays van de AMS mogen daarna."),t}watched(){let e=this.config;return[e.status,e.progress,e.remaining,e.nozzle_temp,e.bed_temp,e.door,e.power,e.camera,e.image,...kt.map(t=>e[`tray_${t}`])].filter(Boolean)}beeldSoort_(){let e=this.config;return e.camera&&e.image?this.beeld_??(vn(b(this.hass,e.status))?"camera":"image"):e.camera?"camera":e.image?"image":null}template(){return this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`
      <div class="card surface" style="--tone:${j.accent}">
        <div class="kop">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(I(this.$(".card"))),this.on(this.$(".ico"),"click",()=>R(this,e.status||e.power||e.camera||e.progress));let t=this.$(".aanuit");this.on(t,"click",i=>{i.stopPropagation(),this.schakel_()});let n=this.$(".wissel");this.on(n,"click",i=>{i.stopPropagation(),this.beeld_=this.beeldSoort_()==="camera"?"image":"camera",this.paint()}),this.on(this.$(".beeldvak"),"click",i=>{if(i.target.closest(".wissel"))return;let r=this.beeldSoort_()==="camera"?e.camera:e.image;r&&R(this,r)})}async schakel_(){let e=this.config.power;if(!e)return;let t=b(this.hass,e),n=W(t),i=String(e).split(".")[0];if(n){let r=ai(b(this.hass,this.config.progress)),o=vn(b(this.hass,this.config.status));if(!await ut({title:"Printer uitzetten?",text:o?`Er loopt een print${r===null?"":` (${r}% klaar)`}. Uitzetten breekt hem af, en dat is niet terug te draaien.`:"Weet je zeker dat je de printer wilt uitzetten?",confirmText:"Uitzetten",dismissText:"Aan laten"}))return}this.hass.callService(i,n?"turn_off":"turn_on",{entity_id:e})}paint(){let e=this.config,t=b(this.hass,e.status),n=ni(t),i=ti[n]??ti.unknown,r=vn(t),o=e.status&&(!t||t.state==="unavailable");this.toggleAttribute("dead",!!o),this.toggleAttribute("loopt",r&&!o),this.$(".card").style.setProperty("--tone",sc[i.toon]??j.accent),this.$(".ico").innerHTML=v(e.icon||"printer"),this.text(".nm",e.name||A(this.hass,e.status||e.power||e.camera,"3D-printer"));let s=String(t?.state??"").trim(),l=n==="unknown"&&s&&s.toLowerCase()!=="unknown",d=`<b>${this.veilig_(l?s:i.woord)}</b>${this.bijzin_()}`,c=this.$(".st");c.innerHTML!==d&&(c.innerHTML=d),this.paintAanUit_(),this.paintBeeld_(r),this.paintVoortgang_(r),this.paintTegels_(),this.paintAms_(),C(this.$(".card"))}bijzin_(){let e=ri(b(this.hass,this.config.remaining));return e===null||e<=0?"":` \xB7 nog ${this.veilig_(oi(e))}, klaar om ${this.veilig_(si(e))}`}paintAanUit_(){let e=this.$(".aanuit"),t=this.config.power;if(e.hidden=!t,!t)return;let n=W(b(this.hass,t));e.setAttribute("aria-pressed",String(n)),e.setAttribute("aria-label",n?"Printer uitzetten":"Printer aanzetten")}paintBeeld_(e){let t=this.config,n=this.$(".beeldvak"),i=this.beeldSoort_();if(n.hidden=!i,!i)return;let r=this.$(".wissel");if(r.hidden=!(t.camera&&t.image),!r.hidden){let d=i==="camera"?"Voorbeeld":"Camera";r.innerHTML=`${v(i==="camera"?"grid":"camera")}<span>${d}</span>`,r.setAttribute("aria-label",`Toon ${d.toLowerCase()}`)}if(i==="camera"){bn(n,this.hass,t.camera,{live:t.live_view===!0||e}),n.querySelector(".leeg")?.remove();return}n.querySelector("hui-image")?.remove();let s=b(this.hass,t.image)?.attributes?.entity_picture,l=n.querySelector("img.beeld");if(s)l||(l=document.createElement("img"),l.className="beeld",l.alt="Wat de printer aan het maken is",n.appendChild(l)),l.dataset.bron!==s&&(l.dataset.bron=s,l.src=s),n.querySelector(".leeg")?.remove();else if(l?.remove(),!n.querySelector(".leeg")){let d=document.createElement("span");d.className="leeg",d.textContent="Nog geen voorbeeld",n.appendChild(d)}}paintVoortgang_(e){let t=this.config,n=this.$(".voort"),i=ai(b(this.hass,t.progress)),r=ri(b(this.hass,t.remaining));if(n.hidden=i===null&&!e,n.hidden)return;let o=this.$(".balk");o.dataset.onbekend=String(i===null),o.querySelector("i").style.setProperty("--pct",`${i??0}%`),this.text(".pct",i===null?"Bezig":`${i}%`),this.text(".rest",r===null||r<=0?"":`nog ${oi(r)} \xB7 klaar om ${si(r)}`)}paintTegels_(){let e=this.config,t=this.$(".tegels"),n=[],i=ii(b(this.hass,e.nozzle_temp));i&&n.push({w:`${i.waarde}${i.eenheid}`,l:"Nozzle"});let r=ii(b(this.hass,e.bed_temp));r&&n.push({w:`${r.waarde}${r.eenheid}`,l:"Bed"});let o=b(this.hass,e.door);if(o){let l=W(o);n.push({w:l?"Open":"Dicht",l:"Deur",let:l})}if(t.hidden=!n.length,!n.length)return;t.style.setProperty("--kolommen",String(n.length));let s=n.map(l=>`${l.w}|${l.l}|${l.let??""}`).join(",");t.dataset.sig!==s&&(t.dataset.sig=s,t.innerHTML=n.map(l=>`<div class="tegel" data-let="${!!l.let}"><span class="w">${this.veilig_(l.w)}</span><span class="l">${this.veilig_(l.l)}</span></div>`).join(""))}paintAms_(){let e=this.config,t=this.$(".ams"),n=kt.filter(s=>e[`tray_${s}`]||e[`tray_${s}_color`]);if(t.hidden=!n.length,!n.length)return;let i=this.$(".ams .rij"),r=kt.map(s=>Qo(b(this.hass,e[`tray_${s}`]),{color:e[`tray_${s}_color`],label:e[`tray_${s}_label`]})),o=r.map(s=>`${s.kleur}|${s.soort}|${s.leeg}|${s.actief}|${s.rest}`).join(",");i.dataset.sig!==o&&(i.dataset.sig=o,i.innerHTML=r.map((s,l)=>{let d=`Tray ${l+1}`+(s.leeg?": leeg":s.soort?`: ${s.soort}`:"")+(s.rest===null?"":` \u2014 nog ${s.rest}%`)+(s.actief?" (in gebruik)":"");return`<div class="tray" data-leeg="${s.leeg}" data-actief="${s.actief}" style="--kleur:${s.kleur??"transparent"}" title="${this.veilig_(d)}"><span class="vlak">${s.rest===null?"":`<i style="--rest:${s.rest}%"></i>`}</span><span class="txt"><span class="nr">Tray ${l+1}</span><span class="so">${this.veilig_(s.leeg?"leeg":s.soort||"gevuld")}</span></span></div>`}).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.camera||this.config?.image?6:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-printer-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>/^sensor\./.test(i)&&/(print|stage|status)/i.test(i));return n?{status:n}:{}}};y(kn,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var li=class extends L{defaults(){return{icon:"printer"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"power",selector:f.entity(["switch","input_boolean"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"nozzle_temp",selector:f.entity(["sensor","number"])},{name:"bed_temp",selector:f.entity(["sensor","number"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"camera",selector:f.entity("camera")},{name:"live_view",selector:f.bool()},{name:"image",selector:f.entity(["image","camera"])},...kt.flatMap(e=>[{name:`tray_${e}`,selector:f.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:f.text()},{name:`tray_${e}_label`,selector:f.text()}])]}label(e){let t={};for(let n of kt)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};H("domotiapp-printer-card-editor",li);N("domotiapp-printer-card",kn,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var Fe={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},di=a=>a==="electric"||a==="hybrid",ci=a=>a==="fuel"||a==="hybrid",lc=["charging","charge","fast_charging","dc_charging","on","true","laden"],dc=["complete","completed","fully_charged","full","done","finished"],cc=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],pc=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function Yo(a){let e=String(a?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:lc.includes(e)?"charging":dc.includes(e)?"complete":cc.includes(e)?"connected":pc.includes(e)?"idle":"onbekend"}function Jo(a,e){if(a&&a!=="onbekend")return xn[a]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var xn={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function pi(a,e){let t=Number(a?.state);if(!Number.isFinite(t))return null;let n=String(a?.attributes?.unit_of_measurement??"").toLowerCase(),i=Number(e);return n!=="%"&&Number.isFinite(i)&&i>0?Math.max(0,Math.min(100,Math.round(t/i*100))):Math.max(0,Math.min(100,Math.round(t)))}function es(a){let e=Number(a?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:a?.attributes?.unit_of_measurement??"km"}:null}function hi(a){if(a==null)return null;let e=a<=10?"bad":a<=20?"warn":"good";return{procent:a,toon:e}}function ui(a,e=Date.now()){let t=String(a?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(a?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let i=String(a?.attributes?.unit_of_measurement??"").toLowerCase();return i==="h"||i.startsWith("hour")?Math.round(n*60):i==="s"||i.startsWith("sec")?Math.round(n/60):Math.round(n)}function mi(a){if(a==null)return"";let e=Math.max(0,Math.round(a));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function ts({open:a,slot:e,laden:t,laadMinuten:n,radius:i,aandrijving:r}){if(a)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${mi(n)}`:"";return{tekst:`${xn.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:xn.complete,toon:"good"}:t==="connected"?{tekst:xn.connected,toon:"neutral"}:i?{tekst:`Nog ${i.waarde} ${i.eenheid}`,toon:"neutral"}:{tekst:Fe[r]?.label??"",toon:"neutral"}}var hc=100,uc=["home","thuis","at_home","athome"],mc=["not_home","away","afwezig","weg","not home","nothome"];function gc(a,e,t,n){let r=d=>d*Math.PI/180,o=r(t-a),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(a))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function fc(a){let e=a?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let i=String(a?.state??""),r=i.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=i.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function ns(a,e,t=hc){if(!a)return{thuis:null,tekst:"",meters:null};let n=String(a.state??"").trim(),i=n.toLowerCase();if(i==="unavailable"||i==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(uc.includes(i))return{thuis:!0,tekst:"Thuis",meters:null};if(mc.includes(i))return{thuis:!1,tekst:"Afwezig",meters:null};let r=fc(a),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=gc(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var gi={good:j.good,warn:j.warn,bad:j.bad,neutral:j.neutral,accent:j.accent},_n=class extends M{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[T]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return Fe[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      <div class="card surface">
        <div class="kop">
        ...
        <div class="binnen">
      ...
      </div>`}wire(){this.teardown_.push(I(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;R(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".acties"),"click",e=>{let t=e.target.closest?.("[data-k]");t&&(e.stopPropagation(),this.doe_(t.dataset.k))}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&R(this,t.dataset.id)})}doe_(e){let t=this.config;if(e==="lock"){let n=b(this.hass,t.lock),i=String(n?.state)==="locked";return this.hass.callService("lock",i?"unlock":"lock",{entity_id:t.lock})}if(e==="climate"){let n=b(this.hass,t.climate),i=String(t.climate).split(".")[0];return this.hass.callService(i,W(n)?"turn_off":"turn_on",{entity_id:t.climate})}if(e==="location")return R(this,t.location)}paint(){let e=this.config,t=this.soort_(),n=di(t)?pi(b(this.hass,e.battery),e.battery_max):null,i=ci(t)?pi(b(this.hass,e.fuel),e.fuel_max):null,r=es(b(this.hass,e.range)),o=Yo(b(this.hass,e.charging)),s=ui(b(this.hass,e.charging_ready)),l=b(this.hass,e.lock),d=W(b(this.hass,e.doors))||W(b(this.hass,e.windows)),c=ns(b(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),p=e.battery&&!b(this.hass,e.battery)&&e.range&&!b(this.hass,e.range);this.toggleAttribute("dead",!!p),this.text(".nm",e.name||A(this.hass,e.battery||e.range||e.lock,"Auto"));let h=ts({open:d,slot:l?String(l.state):null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",h.tekst),this.$(".st").style.setProperty("--melding",gi[h.toon]??j.neutral),this.paintFoto_(),this.paintActies_(l,d),this.paintBalken_({accu:n,tank:i,radius:r,laden:o,soort:t}),this.paintTegels_(c,o),C(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=v(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=v(this.config.icon||"car")},e.replaceChildren(n)}paintActies_(e,t){let n=this.config,i=this.$(".acties"),r=[];if(n.lock&&e){let s=String(e.state)==="locked";r.push({k:"lock",icon:s?"lock":"lockOpen",label:s?"Openen":"Op slot zetten",aan:s,let:!s})}if(n.climate){let s=W(b(this.hass,n.climate));r.push({k:"climate",icon:"airco",label:"Klimaat",aan:s})}let o=r.map(s=>`${s.k}|${s.icon}|${s.aan}|${s.let}`).join(",");i.dataset.sig!==o&&(i.dataset.sig=o,i.innerHTML=r.map(s=>`<button type="button" data-k="${s.k}" aria-pressed="${!!s.aan}" data-let="${!!s.let}" aria-label="${s.label}">${v(s.icon)}</button>`).join(""))}paintBalken_({accu:e,tank:t,radius:n,laden:i,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=hi(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:i==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:i==="charging"})}if(t!==null){let h=hi(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":Fe[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=ui(b(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,g)=>{let m=g===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,k=h.laadt&&c?` \xB7 nog ${this.veilig_(mi(c))}`:"";return`
          <div class="meter" style="--balk:${gi[h.toon]??j.neutral}">
            <div class="regel">
          ...
          </div>`}).join(""))}paintTegels_(e,t){let n=this.config,i=this.$(".tegels"),r=[],o=(l,d)=>{let c=b(this.hass,l);if(!c||c.state==="unavailable"||c.state==="unknown")return;let p=c.attributes?.unit_of_measurement??"",h=Number(c.state),g=Number.isFinite(h)?`${Math.round(h*10)/10}${p?` ${p}`:""}`:c.state;r.push({id:l,w:g,l:d??A(this.hass,l,l)})};if(n.location&&e?.tekst){let l=e.thuis===!1&&e.meters!==null?e.meters>=1e3?` \xB7 ${Math.round(e.meters/100)/10} km`:` \xB7 ${e.meters} m`:"";r.push({id:n.location,w:e.tekst+l,l:"Waar hij staat",toon:e.thuis===!0?"good":null})}if(n.charging){let l=b(this.hass,n.charging),d=Jo(t,l);d&&r.push({id:n.charging,w:d,l:"Laadstatus",toon:t==="charging"?"accent":t==="complete"?"good":null})}n.odometer&&o(n.odometer,"Kilometerstand"),n.charging_power&&o(n.charging_power,"Laadvermogen");for(let l of Array.isArray(n.sensors)?n.sensors:[])o(l,null);if(i.hidden=!r.length,!r.length)return;let s=r.map(l=>`${l.id}|${l.w}|${l.toon??""}`).join(",");i.dataset.sig!==s&&(i.dataset.sig=s,i.innerHTML=r.map(l=>`<div class="tegel" data-id="${this.veilig_(l.id)}" role="button" tabindex="0"${l.toon?` style="--tegeltoon:${gi[l.toon]??j.neutral}"`:""}><span class="w">${this.veilig_(l.w)}</span><span class="l">${this.veilig_(l.l)}</span></div>`).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.photo_size==="groot"?5:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-auto-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>/^sensor\..*(battery|accu|soc)/i.test(i));return n?{battery:n,drivetrain:"electric"}:{drivetrain:"electric"}}};y(_n,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var fi=class extends L{defaults(){return{icon:"car",drivetrain:"electric",photo_size:"klein"}}pickers(){return[{key:"image",kind:"foto",label:"Foto van de auto"},{key:"icon",kind:"icon",label:"Icoon (zonder foto)",fallback:"car"}]}schema(){let e=Fe[this.config_?.drivetrain]?this.config_.drivetrain:"electric",t=[{name:"name",selector:f.text()},{name:"drivetrain",selector:f.select(Object.entries(Fe).map(([n,{label:i}])=>({value:n,label:i})))},{name:"photo_size",selector:f.select([{value:"klein",label:"Klein, naast de naam"},{value:"groot",label:"Groot, over de hele breedte"}])},{name:"range",selector:f.entity(["sensor","number"])}];return di(e)&&t.push({name:"battery",selector:f.entity(["sensor","number"])},{name:"battery_max",selector:f.number(1,400,1)},{name:"charging",selector:f.entity(["sensor","binary_sensor","switch"])},{name:"charging_ready",selector:f.entity(["sensor"])},{name:"charging_power",selector:f.entity(["sensor"])}),ci(e)&&t.push({name:"fuel",selector:f.entity(["sensor","number"])},{name:"fuel_max",selector:f.number(1,200,1)}),t.push({name:"lock",selector:f.entity("lock")},{name:"doors",selector:f.entity(["binary_sensor"])},{name:"windows",selector:f.entity(["binary_sensor"])},{name:"climate",selector:f.entity(["switch","climate","button"])},{name:"location",selector:f.entity(["device_tracker","sensor","person"])},{name:"home_radius",selector:f.number(10,2e3,10)},{name:"odometer",selector:f.entity(["sensor"])},{name:"sensors",selector:{entity:{multiple:!0}}}),t}label(e){return{name:"Naam",drivetrain:"Aandrijving",image:"Foto van de auto",photo_size:"Hoe groot staat de foto",range:"Actieradius",battery:"Accupercentage",battery_max:"Accu-inhoud (kWh), als de sensor geen procenten geeft",charging:"Laadstatus",charging_ready:"Klaar met laden om / nog te gaan",charging_power:"Laadvermogen",fuel:"Tankniveau",fuel_max:"Tankinhoud (liter), als de sensor geen procenten geeft",lock:"Portierslot",doors:"Deuren open",windows:"Ramen open",climate:"Voorverwarmen of koelen",location:"Waar hij staat",home_radius:"Hoe dichtbij is thuis (meter)",odometer:"Kilometerstand",sensors:"Extra sensoren als tegel"}[e.name]??super.label(e)}helper(e){return{drivetrain:"Bepaalt welke balken er op de kaart komen \u2014 een accu, een tank, of allebei \u2014 en welke velden je hieronder ziet.",image:"Kies een bestand of sleep er een op. Home Assistant zet hem in zijn eigen media-opslag; je kunt ook een pad als /local/auto.png intypen.",range:"In de eenheid van de sensor zelf. De kaart rekent niets om: staat je Home Assistant op mijlen, dan zie je mijlen.",battery_max:"Alleen nodig als je accusensor in kWh meldt in plaats van in procenten. Dan rekent de kaart het percentage zelf uit.",fuel_max:"Alleen nodig als je tanksensor in liters meldt in plaats van in procenten.",charging_ready:"Een aantal minuten, een klok of het tijdstip waarop hij vol is \u2014 alle drie worden gelezen.",doors:"Staat er iets open, dan zegt de kaart dat en gaat al het andere even opzij.",location:"Een device_tracker die home of not_home meldt, of een sensor met een coordinaat \u2014 beide worden gelezen. Bij een coordinaat rekent de kaart de afstand tot de locatie van je Home Assistant uit en maakt daar Thuis of Afwezig van.",home_radius:"Alleen van belang bij een sensor met een coordinaat. Binnen deze afstand van je huis heet de auto thuis. Leeg laten is 100 meter \u2014 ruim genoeg voor een oprit of een parkeerplaats om de hoek.",sensors:"Alles wat je verder nog kwijt wilt: bandenspanning, buitentemperatuur, de volgende beurt. Ze komen als tegels onderaan te staan, met de naam uit Home Assistant."}[e.name]}};H("domotiapp-auto-card-editor",fi);N("domotiapp-auto-card",_n,{name:"DomotiApp Auto",description:"Brandstof, hybride of elektrisch: accu- en tankbalk, actieradius, laadstatus, het slot en zoveel eigen sensoren als je kwijt wilt \u2014 met een foto van de auto erbij."});function wn(a){let e=Number(a);return Number.isFinite(e)?Math.max(1,Math.min(6,e)):1}function bc(a){let e=wn(a);return Math.max(0,(1-1/e)/2)}function xt(a,e,t){let n=bc(t),i=o=>Number.isFinite(Number(o))?Number(o):0,r=o=>Math.max(-n,Math.min(n,i(o)))+0;return{x:r(a),y:r(e)}}function Ze(a,e,t={x:0,y:0}){let n=wn(a?.zoom??1),i=wn(n*(Number(e)||1));if(i===n)return{zoom:n,...xt(a?.x,a?.y,n)};let r=Number(t?.x)||0,o=Number(t?.y)||0,s=(a?.x??0)+r*(1/n-1/i),l=(a?.y??0)+o*(1/n-1/i);return{zoom:i,...xt(s,l,i)}}function as({zoom:a=1,x:e=0,y:t=0}={}){let n=wn(a),i=xt(e,t,n);return`scale(${n}) translate(${(-i.x*100).toFixed(3)}%, ${(-i.y*100).toFixed(3)}%)`}var bi=[{k:"up",icoon:"arrowUp",label:"Omhoog"},{k:"left",icoon:"chevronRight",label:"Links",draai:180},{k:"right",icoon:"chevronRight",label:"Rechts"},{k:"down",icoon:"arrowDown",label:"Omlaag"}],yn=class extends M{validate(e){let t={name:"",...e};return!t.camera&&!(Array.isArray(t.cameras)&&t.cameras.length)&&(t[T]="Kies een camera. Presets, richtingsknoppen en een bewegingsmelder mogen daarna."),t}watched(){let e=this.config;return[...this.cameras_(),e.presets,e.motion,...Array.isArray(e.preset_buttons)?e.preset_buttons:[]].filter(Boolean)}cameras_(){let e=this.config,t=[e.camera,...Array.isArray(e.cameras)?e.cameras:[]].filter(Boolean);return[...new Set(t)]}huidig_(){let e=this.cameras_();return e.includes(this.cam_)?this.cam_:e[0]}template(){return this.config.bare&&this.setAttribute("bare",""),this.stand_=this.stand_??{zoom:1,x:0,y:0},`
      <div class="card surface">
        <div class="vak">
          ...
          <div class="over">
            <span class="nm"></span>
            <span class="rek"></span>
            <span class="merk" data-soort="beweging" hidden>${v("person")}<span>Beweging</span></span>
            <span class="merk" data-soort="live" hidden><span class="stip"></span><span>LIVE</span></span>
          </div>
          <div class="ptz" hidden>
            ${bi.map(t=>`<button type="button" data-r="${t.k}" aria-label="${t.label}"${t.draai?` style="transform: rotate(${t.draai}deg)"`:""}>${v(t.icoon)}</button>`).join("")}
          </div>
          <div class="knoppen">
            <button type="button" data-k="uit" aria-label="Uitzoomen">${v("minus")}</button>
            <button type="button" data-k="in" aria-label="Inzoomen">${v("plus")}</button>
            <button type="button" data-k="live" aria-pressed="false" aria-label="Live kijken">${v("cctv")}</button>
            <button type="button" data-k="groot" aria-label="Groot bekijken">${v("camera")}</button>
          </div>
        </div>
        <div class="presets" hidden></div>
        <div class="cams" hidden></div>
      </div>`}wire(){this.teardown_.push(I(this.$(".card"))),this.on(this.$(".knoppen"),"click",e=>{let t=e.target.closest?.("[data-k]");t&&(e.stopPropagation(),this.knop_(t.dataset.k))}),this.on(this.$(".ptz"),"click",e=>{let t=e.target.closest?.("[data-r]");t&&(e.stopPropagation(),this.draai_(t.dataset.r))}),this.on(this.$(".presets"),"click",e=>{let t=e.target.closest?.("[data-p]");t&&(e.stopPropagation(),this.preset_(t.dataset.p,t.dataset.soort))}),this.on(this.$(".cams"),"click",e=>{let t=e.target.closest?.("[data-cam]");t&&(e.stopPropagation(),this.cam_=t.dataset.cam,this.stand_={zoom:1,x:0,y:0},this.paint())}),this.zoomLuisteraars_()}zoomLuisteraars_(){let e=this.$(".vak"),t=new Map,n=null,i=null,r=0,o=l=>{let d=e.getBoundingClientRect();return{x:(l.clientX-d.left)/d.width-.5,y:(l.clientY-d.top)/d.height-.5}};this.on(e,"wheel",l=>{l.preventDefault(),this.zet_(Ze(this.stand_,l.deltaY<0?1.18:1/1.18,o(l)))},{passive:!1}),this.on(e,"pointerdown",l=>{if(t.set(l.pointerId,l),e.setPointerCapture?.(l.pointerId),r=0,t.size===2){let[d,c]=[...t.values()];i={afstand:Math.hypot(d.clientX-c.clientX,d.clientY-c.clientY),stand:{...this.stand_}},n=null}else this.stand_.zoom>1&&(n={x:l.clientX,y:l.clientY,stand:{...this.stand_}},this.setAttribute("sleept",""))}),this.on(e,"pointermove",l=>{if(t.has(l.pointerId)){if(t.set(l.pointerId,l),r=Math.max(r,Math.abs(l.movementX??0)+Math.abs(l.movementY??0)),i&&t.size===2){let[d,c]=[...t.values()],p=Math.hypot(d.clientX-c.clientX,d.clientY-c.clientY),h={x:(d.clientX+c.clientX)/2,y:(d.clientY+c.clientY)/2},g=e.getBoundingClientRect();this.zet_(Ze(i.stand,p/(i.afstand||1),{x:(h.x-g.left)/g.width-.5,y:(h.y-g.top)/g.height-.5}));return}if(n){let d=e.getBoundingClientRect(),c=(l.clientX-n.x)/d.width/this.stand_.zoom,p=(l.clientY-n.y)/d.height/this.stand_.zoom;this.zet_({zoom:this.stand_.zoom,...xt(n.stand.x-c,n.stand.y-p,this.stand_.zoom)})}}});let s=l=>{t.delete(l.pointerId),t.size<2&&(i=null),t.size||(n=null,this.removeAttribute("sleept"))};this.on(e,"pointerup",s),this.on(e,"pointercancel",s),this.on(e,"dblclick",l=>{l.target.closest(".knoppen, .ptz")||(l.preventDefault(),this.zet_(this.stand_.zoom>1?{zoom:1,x:0,y:0}:Ze({zoom:1,x:0,y:0},2.5,o(l))))}),this.on(e,"click",l=>{l.target.closest(".knoppen, .ptz")||r>6||this.config.tap_zoom!==!1&&R(this,this.huidig_())})}zet_(e){this.stand_=e,this.toggleAttribute("zoom",e.zoom>1),this.$(".schuif").style.setProperty("--tf",as(e));let t=this.$('[data-k="uit"]'),n=this.$('[data-k="in"]');t&&(t.disabled=e.zoom<=1),n&&(n.disabled=e.zoom>=6)}knop_(e){if(e==="in")return this.zet_(Ze(this.stand_,1.5));if(e==="uit")return this.zet_(Ze(this.stand_,1/1.5));if(e==="live")return this.live_=!this.live_,this.paint();if(e==="groot")return R(this,this.huidig_())}draai_(e){let t=this.config[`ptz_${e}`];if(!t)return;let n=String(t).split(".")[0];this.hass.callService(n,n==="button"?"press":"turn_on",{entity_id:t})}preset_(e,t){if(t==="knop"){let r=String(e).split(".")[0];return this.hass.callService(r,r==="button"?"press":"turn_on",{entity_id:e})}let n=this.config.presets,i=String(n).split(".")[0];return this.hass.callService(i,"select_option",{entity_id:n,option:e})}paint(){let e=this.config,t=this.huidig_(),n=b(this.hass,t),i=!n||n.state==="unavailable";this.toggleAttribute("dead",!!i),this.text(".nm",e.name||A(this.hass,t,"Camera"));let r=this.live_===!0||e.live_view===!0,o=this.$(".schuif");if(i){if(o.querySelector(".beeld")?.remove(),!this.$(".vak .leeg")){let c=document.createElement("span");c.className="leeg",c.textContent="Deze camera is niet bereikbaar",this.$(".vak").appendChild(c)}}else this.$(".vak .leeg")?.remove(),bn(o,this.hass,t,{live:r});let s=this.$('.merk[data-soort="live"]');s.hidden=!r||i;let l=this.$('[data-k="live"]');l.setAttribute("aria-pressed",String(r)),l.disabled=e.live_view===!0;let d=this.$('.merk[data-soort="beweging"]');d.hidden=!(e.motion&&W(b(this.hass,e.motion))),this.zet_(this.stand_),this.paintPtz_(),this.paintPresets_(),this.paintCams_(t),C(this.$(".card"))}paintPtz_(){let e=this.config,t=this.$(".ptz"),n=bi.some(i=>e[`ptz_${i.k}`]);if(t.hidden=!n,!!n)for(let i of bi){let r=t.querySelector(`[data-r="${i.k}"]`);r&&(r.hidden=!e[`ptz_${i.k}`])}}paintPresets_(){let e=this.config,t=this.$(".presets"),n=[],i=b(this.hass,e.presets),r=i?.attributes?.options;if(Array.isArray(r))for(let s of r)n.push({waarde:s,naam:s,soort:"keuze",aan:i.state===s});for(let s of Array.isArray(e.preset_buttons)?e.preset_buttons:[])b(this.hass,s)&&n.push({waarde:s,naam:A(this.hass,s,s),soort:"knop",aan:!1});if(t.hidden=!n.length,!n.length)return;let o=n.map(s=>`${s.waarde}|${s.aan}`).join(",");t.dataset.sig!==o&&(t.dataset.sig=o,t.innerHTML=n.map(s=>`<button type="button" data-p="${this.veilig_(s.waarde)}" data-soort="${s.soort}" aria-pressed="${s.aan}">${this.veilig_(s.naam)}</button>`).join(""))}paintCams_(e){let t=this.cameras_(),n=this.$(".cams");if(n.hidden=t.length<2,t.length<2)return;let i=`${t.join(",")}|${e}`;n.dataset.sig!==i&&(n.dataset.sig=i,n.innerHTML=t.map(r=>`<button type="button" data-cam="${this.veilig_(r)}" aria-pressed="${r===e}">${this.veilig_(A(this.hass,r,r))}</button>`).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return 5}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",3)}}static getConfigElement(){return document.createElement("domotiapp-camera-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("camera."));return n?{camera:n}:{}}};y(yn,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var vi=class extends L{pickers(){return[]}schema(){return[{name:"camera",selector:f.entity("camera")},{name:"name",selector:f.text()},{name:"live_view",selector:f.bool()},{name:"presets",selector:f.entity(["select","input_select"])},{name:"preset_buttons",selector:{entity:{domain:["button","scene","script"],multiple:!0}}},{name:"motion",selector:f.entity(["binary_sensor"])},{name:"ptz_up",selector:f.entity(["button","switch"])},{name:"ptz_down",selector:f.entity(["button","switch"])},{name:"ptz_left",selector:f.entity(["button","switch"])},{name:"ptz_right",selector:f.entity(["button","switch"])},{name:"cameras",selector:{entity:{domain:"camera",multiple:!0}}},{name:"tap_zoom",selector:f.bool()}]}label(e){return{camera:"Camera",name:"Naam",live_view:"Altijd live",presets:"Presets (keuzelijst)",preset_buttons:"Presets als losse knoppen",motion:"Bewegingsmelder",ptz_up:"Draaien: omhoog",ptz_down:"Draaien: omlaag",ptz_left:"Draaien: links",ptz_right:"Draaien: rechts",cameras:"Nog meer camera's op deze kaart",tap_zoom:"Tikken opent het beeld groot"}[e.name]??super.label(e)}helper(e){return{camera:"Op de kaart staat een beeld dat zichzelf ververst; met de knop rechtsonder gaat hij echt live. Inzoomen kan met het wiel, met twee vingers of met + en \u2212.",live_view:"De stream staat dan altijd open. Mooier, maar op een dashboard met zes camera's zijn dat zes streams die de hele dag doorlopen.",presets:"De `select` van je camera-integratie \u2014 Reolink en ONVIF leveren die. De kaart maakt van elke optie een knop, dus een preset die je in de camera-app toevoegt verschijnt er vanzelf bij.",preset_buttons:"Voor integraties die geen keuzelijst maar losse knoppen leveren, zoals Amcrest en Dahua. Ze mogen naast de keuzelijst staan.",motion:"Zolang deze aanstaat komt er een merkje 'Beweging' op het beeld te staan.",ptz_up:"De vier richtingsknoppen van je integratie. Vul je er geen in, dan komt het draaikruis er niet.",cameras:"Onder het beeld komt dan een rij met namen om tussen te wisselen. Handig voor de camera's die bij elkaar horen \u2014 voordeur, oprit, achtertuin."}[e.name]}};H("domotiapp-camera-card-editor",vi);N("domotiapp-camera-card",yn,{name:"DomotiApp Camera",description:"Live beeld met inzoomen en schuiven, de presets van je camera als knoppen, een draaikruis en een merkje zodra er beweging is."});var zn=globalThis,$n=zn.ShadowRoot&&(zn.ShadyCSS===void 0||zn.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ki=Symbol(),is=new WeakMap,_t=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==ki)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if($n&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=is.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&is.set(t,e))}return e}toString(){return this.cssText}},be=a=>new _t(typeof a=="string"?a:a+"",void 0,ki),ne=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new _t(t,a,ki)},rs=(a,e)=>{if($n)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=zn.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},xi=$n?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return be(t)})(a):a;var{is:kc,defineProperty:xc,getOwnPropertyDescriptor:_c,getOwnPropertyNames:wc,getOwnPropertySymbols:yc,getPrototypeOf:zc}=Object,jn=globalThis,os=jn.trustedTypes,$c=os?os.emptyScript:"",jc=jn.reactiveElementPolyfillSupport,wt=(a,e)=>a,_i={toAttribute(a,e){switch(e){case Boolean:a=a?$c:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},ls=(a,e)=>!kc(a,e),ss={attribute:!0,type:String,converter:_i,reflect:!1,useDefault:!1,hasChanged:ls};Symbol.metadata??=Symbol("metadata"),jn.litPropertyMetadata??=new WeakMap;var ve=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=ss){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&xc(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=_c(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ss}static _$Ei(){if(this.hasOwnProperty(wt("elementProperties")))return;let e=zc(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(wt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(wt("properties"))){let t=this.properties,n=[...wc(t),...yc(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(xi(i))}else e!==void 0&&t.push(xi(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return rs(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:_i).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:_i;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??ls)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ve.elementStyles=[],ve.shadowRootOptions={mode:"open"},ve[wt("elementProperties")]=new Map,ve[wt("finalized")]=new Map,jc?.({ReactiveElement:ve}),(jn.reactiveElementVersions??=[]).push("2.1.2");var Ai=globalThis,ds=a=>a,En=Ai.trustedTypes,cs=En?En.createPolicy("lit-html",{createHTML:a=>a}):void 0,fs="$lit$",Se=`lit$${Math.random().toFixed(9).slice(2)}$`,bs="?"+Se,Ec=`<${bs}>`,Ie=document,zt=()=>Ie.createComment(""),$t=a=>a===null||typeof a!="object"&&typeof a!="function",Mi=Array.isArray,Ac=a=>Mi(a)||typeof a?.[Symbol.iterator]=="function",wi=`[ 	
\f\r]`,yt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ps=/-->/g,hs=/>/g,De=RegExp(`>|${wi}(?:([^\\s"'>=/]+)(${wi}*=${wi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),us=/'/g,ms=/"/g,vs=/^(?:script|style|textarea|title)$/i,Si=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),w=Si(1),tf=Si(2),nf=Si(3),Re=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),gs=new WeakMap,He=Ie.createTreeWalker(Ie,129);function ks(a,e){if(!Mi(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return cs!==void 0?cs.createHTML(e):e}var Mc=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=yt;for(let s=0;s<t;s++){let l=a[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===yt?c[1]==="!--"?o=ps:c[1]!==void 0?o=hs:c[2]!==void 0?(vs.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=De):c[3]!==void 0&&(o=De):o===De?c[0]===">"?(o=i??yt,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?De:c[3]==='"'?ms:us):o===ms||o===us?o=De:o===ps||o===hs?o=yt:(o=De,i=void 0);let g=o===De&&a[s+1].startsWith("/>")?" ":"";r+=o===yt?l+Ec:p>=0?(n.push(d),l.slice(0,p)+fs+l.slice(p)+Se+g):l+Se+(p===-2?s:g)}return[ks(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},jt=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=Mc(e,t);if(this.el=a.createElement(d,n),He.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=He.nextNode())!==null&&l.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(fs)){let h=c[o++],g=i.getAttribute(p).split(Se),m=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:m[2],strings:g,ctor:m[1]==="."?zi:m[1]==="?"?$i:m[1]==="@"?ji:Qe}),i.removeAttribute(p)}else p.startsWith(Se)&&(l.push({type:6,index:r}),i.removeAttribute(p));if(vs.test(i.tagName)){let p=i.textContent.split(Se),h=p.length-1;if(h>0){i.textContent=En?En.emptyScript:"";for(let g=0;g<h;g++)i.append(p[g],zt()),He.nextNode(),l.push({type:2,index:++r});i.append(p[h],zt())}}}else if(i.nodeType===8)if(i.data===bs)l.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(Se,p+1))!==-1;)l.push({type:7,index:r}),p+=Se.length-1}r++}}static createElement(e,t){let n=Ie.createElement("template");return n.innerHTML=e,n}};function Xe(a,e,t=a,n){if(e===Re)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=$t(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Xe(a,i._$AS(a,e.values),i,n)),e}var yi=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??Ie).importNode(t,!0);He.currentNode=i;let r=He.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Et(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Ei(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=He.nextNode(),o++)}return He.currentNode=Ie,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Et=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Xe(this,e,t),$t(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==Re&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ac(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==$&&$t(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ie.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=jt.createElement(ks(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new yi(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=gs.get(e.strings);return t===void 0&&gs.set(e.strings,t=new jt(e)),t}k(e){Mi(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O(zt()),this.O(zt()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=ds(e).nextSibling;ds(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Qe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=$}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Xe(this,e,t,0),o=!$t(e)||e!==this._$AH&&e!==Re,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Xe(this,s[n+l],t,l),d===Re&&(d=this._$AH[l]),o||=!$t(d)||d!==this._$AH[l],d===$?e=$:e!==$&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!i&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},zi=class extends Qe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}},$i=class extends Qe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==$)}},ji=class extends Qe{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Xe(this,e,t,0)??$)===Re)return;let n=this._$AH,i=e===$&&n!==$||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==$&&(n===$||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ei=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Xe(this,e)}};var Sc=Ai.litHtmlPolyfillSupport;Sc?.(jt,Et),(Ai.litHtmlVersions??=[]).push("3.3.3");var xs=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new Et(e.insertBefore(zt(),r),r,void 0,t??{})}return i._$AI(a),i};var Ni=globalThis,J=class extends ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xs(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Re}};J._$litElement$=!0,J.finalized=!0,Ni.litElementHydrateSupport?.({LitElement:J});var Nc=Ni.litElementPolyfillSupport;Nc?.({LitElement:J});(Ni.litElementVersions??=[]).push("4.2.2");var oe=ne`
  :host {
    ${be(K)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${be(xe)}
`;var Oc=["unavailable","unknown"],Tc=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function An({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||Oc.includes(c.state)){i.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of Tc)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function Mn(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var Ti=["hs","rgb","rgbw","rgbww","xy"],Ci="color_temp",Cc="onoff";var Pe="kleur";var Lc=["unavailable","unknown"],ws=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Dc=[0,100];function pe(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Cc,i=t!==null&&t.includes(Ci),r=t!==null&&t.some(d=>Ti.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Lc.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:i&&!l}}function Hc(){return{state:"off"}}function ys(a,e){let t=e??pe(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...Kc(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function zs(a,e,t,n){return e?a&&a.state==="on"?{...a}:ys(t,n):{state:"off"}}function $s(a,e,t,n){let i=n??pe(t),r=Pi(a,t,i);return i.helderheid&&(r.brightness=P(e,1,255)),r}function Li(a,e,t,n){let i=n??pe(t),r=Pi(a,t,i);return Ls(r),r.color_temp_kelvin=P(e,i.minKelvin,i.maxKelvin),r}function Di(a,e,t,n){let i=n??pe(t),r=Pi(a,t,i);return Ls(r),r.hs_color=[P(e?.[0],0,360),P(e?.[1],0,100)],r}function Sn(a,e,t){return a??Hc()}function js(a,e,t){let n=Sn(a,e,t);if(typeof n.brightness=="number")return P(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?P(i,1,255):255}function Hi(a,e,t){let n=t??pe(e),i=Sn(a,e,n);if(typeof i.color_temp_kelvin=="number")return P(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?P(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Nn(a,e,t){let n=Sn(a,e,t);if(Oi(n.hs_color))return[P(n.hs_color[0],0,360),P(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return Oi(i)?[P(i[0],0,360),P(i[1],0,100)]:[...Dc]}function Ii(a){return a!=null&&typeof a=="object"}function Es(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Ii(i[s]?.lights?.[o]))return!0;return!1})}function As(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function Ri(a,e,t){return Sn(a,e,t).state==="on"}function Ms(a,e,t){let n=t??pe(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=Ri(a,e,n),r=Ss(n),o=r?Ic(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===Pe),kleurkeuze:i&&r,stand:i?o:null}}function Ss(a){return!!(a?.kleurtemp&&a?.kleur)}function Ic(a,e,t){let n=t??pe(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if(ws.slice(1).some(r=>a[r]!==void 0))return Pe}let i=e?.attributes?.color_mode;return i===Ci&&n.kleurtemp?"wit":Ti.includes(i)&&n.kleur?Pe:"wit"}function Ns(a,e,t,n){let i=n??pe(t);return Ss(i)?e==="wit"?Li(a,Hi(a,t,i),t,i):Di(a,Nn(a,t,i),t,i):a}function Os(a){let e=P(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Ts(a){let e=P(a,1,100);return P(Math.round(e/100*255),1,255)}var Rc=1e3,Pc=4e4,_s=7;function Vc(a){let e=P(a,Rc,Pc)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[P(t,0,255),P(n,0,255),P(i,0,255)]}function Bc(a){let[e,t,n]=Vc(a);return`rgb(${e}, ${t}, ${n})`}function Cs(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:_s},(r,o)=>{let s=o/(_s-1),l=t+(n-t)*s;return`${Bc(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Kc(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?P(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===Ci&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=P(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Ti.includes(i)&&Oi(t.hs_color)&&(n.hs_color=[P(t.hs_color[0],0,360),P(t.hs_color[1],0,100)]),n}function Pi(a,e,t){return a&&a.state==="on"?{...a}:ys(e,t)}function Ls(a){for(let e of ws)delete a[e]}function Oi(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function P(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var On="domotiapp-scene-card",Vi="domotiapp-scene-card-editor",Ds="domotiapp-scene-editor";var At=["een","twee","drie"],Hs="pencil",Is=["grid_options","layout_options","view_layout","visibility"];var Rs="entity_id",Ye=class extends J{constructor(){super();y(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));y(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Rs]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Rs];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},i={...this._config,entity:n.entity};n.bare?i.bare=!0:delete i.bare,i.entity!==this._config?.entity&&(delete i.name_overrides,this._getypt={}),this._stuurDoor(i)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return $;let t=this._leden();return w`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?w`
          ...
          `:$}
    `}};y(Ye,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),y(Ye,"styles",[oe,ne`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===Ki?w`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Vs?w`
        <div class="inhoud">
      ...
      <div class="inhoud">
        ...
        ${this._melding?w`<ha-alert alert-type="error">${this._melding}</ha-alert>`:$}
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=Ri(i,t,n),o=Ms(i,t,n);return w`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
              ${this._naam(e)}
              ${n.bekend?n.beschikbaar?$:w`<span class="hint">niet bereikbaar</span>`:w`<span class="hint">lamp niet gevonden</span>`}
            </span>
            ${Ii(i)?$:w`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?w`
                <div class="bediening">
                  ${o.kleurkeuze?this._renderKleurkeuze(e,t,n,i,o.stand):$}
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,zs(i,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:$}
        </div>
    ...
    `}_renderBesturing(e,t,n,i,r){return w`
      ${r.helderheid?this._renderHelderheid(e,t,n,i):$}
      ${r.kleurtemp?this._renderKleurtemp(e,t,n,i):$}
      ${r.kleur?this._renderKleur(e,t,n,i):$}
    `}_renderHelderheid(e,t,n,i){let r=Os(js(i,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,$s(this._waardeVan(e),Ts(s.detail.value),t,n))};return w`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,i,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Ns(this._waardeVan(e),s,t,n))};return w`
      <div class="kleurkeuze">
        <button
          class="keuze ${r===Pe?"actief":""}"
          aria-pressed=${r===Pe?"true":"false"}
          @click=${o(Pe)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,i){let r=Hi(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Li(this._waardeVan(e),s.detail.value,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Cs(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,i){let[r,o]=Nn(i,t,n),s=l=>d=>{d.stopPropagation();let c=Nn(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Di(this._waardeVan(e),p,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Fc}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};y(Je,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),y(Je,"styles",[oe,ne`
    ...
    `]);var Zc="0.22.0",Xc=["type","entity","name_overrides","bare"],Ln="laden",Mt="klaar",Ui="leeg",Wi="geen-groep",Bs="opslagfout",Ks="fout",St=class extends J{constructor(){super();y(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=Ln,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new fe(()=>this._haalScenesOp()),this._verbinding=new We}static getConfigElement(){return document.createElement(Vi)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(i=>i.startsWith("light.")&&Array.isArray(t.states[i].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?I(t):null),C(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(i=>!Xc.includes(i)&&!Is.includes(i));n.length&&console.warn(`${On}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Be(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===Wi){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=Ln,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?Ui:Mt,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let i=t?.code;if(this._melding=t?.message??String(t),Te(t)&&this._herkansing.plan()){this._toestand=Ln;return}if(i==="home_assistant_error"){this._toestand=Bs;return}if(!this.hass.states[n]){this._toestand=Wi;return}this._toestand=Ks}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==Mt)return;let{oproepen:n}=An({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let i=await Mn((r,o)=>this.hass.callService("light",r,o),n);i.length&&this._meldMislukking(i.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),i=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:i},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===Mt&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Ui:Mt}render(){if(!this._config)return $;switch(this._toestand){case Wi:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Bs:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Ks:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,i=!1){return w`
      <div class="needs">
        <span class="mark">${this._icoon("question")}</span>
        <span>
          <b>${t}</b>
          ${n?w`<span class="detail">${n}</span>`:$}
          ${i?w`<button type="button" class="opnieuw" @click=${this._opnieuw}>
                Opnieuw proberen
              </button>`:$}
        </span>
      </div>
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=v(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===Ui,n=this._toestand===Ln,i=this._iconen();return w`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${i.map((r,o)=>w`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Mt)return $;let t=Es(this._scenes,this._leden,3).length,n=As(t);return n?w`<div class="mededeling">${n}</div>`:$}_renderEditor(){return w`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||At[n])}};y(St,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),y(St,"styles",[oe,ne`
      :host { display: block; }
    ...
    `]);O(On,St);O(Vi,Ye);O(Ds,Je);Ke({type:On,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Zc}).`,preview:!1});var Ve="domotiapp-alarm-card",qi="domotiapp-alarm-card-editor",Gs="domotiapp-alarm-editor",Us="DomotiApp Wekker",Ws="https://github.com/Sven2410/domotiapp-lovelace",he="domotiapp_lovelace",re=Object.freeze({get:`${he}/alarms/get`,save:`${he}/alarms/save`,setEnabled:`${he}/alarms/set_enabled`,delete:`${he}/alarms/delete`,stop:`${he}/alarms/stop`,clearMessage:`${he}/alarms/clear_message`,search:`${he}/sound/search`,entities:`${he}/entities/list`,previewStart:`${he}/preview/start`,subscribe:`${he}/updates/subscribe`}),Dn="#026FA1";function qs(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Qc="07:00";var Yc=["uri","name","media_type","image"],Jc="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",ep="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var tp="Music Assistant Wekker",np="Verlichting Wekker";function Hn(){return{id:null,name:"",time:Qc,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Fs(a){let e=Hn();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:Fi(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:Nt(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function Nt(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of Yc)e[t]=a[t]===void 0?null:a[t];return e}function Fi(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Zi(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),Fi(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Zs(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:Nt(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function Xs(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function Qs(a){return Fi(a)&&a.slice(0,2)==="02"?Jc:null}function Ys(a){return a===!1?ep:null}function Js(a){return typeof a?.endless=="boolean"?a.endless:null}function In(a,e){let t=e==="lamp",n=t?np:tp,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function el(a,e){return In(e,"speaker")!==null?!1:Zi(a).ok}var ip=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],rp=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Ot="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",op="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",sp="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",et=class extends J{constructor(){super(),this._concept=Hn(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Fs(this.wekker):Hn(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:re.previewStart,speaker:this._concept.speaker,sound:Nt(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:re.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Nt(e),endless:Js(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Zi(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:re.save,person:this.person,alarm:Zs(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return w`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return $;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=In(t,"speaker"),r=In(n,"lamp"),o=Qs(e.time),s=Ys(e.endless),l=el(e,t);return w`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${ip.map(([d,c])=>w`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Xs(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${i?w`<div class="uitleg">${this._svg(Ot)}<span>${i}</span></div>`:w`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        ${e.sound?w`<div class="gekozen">
              ${e.sound.image?w`<img src=${e.sound.image} alt="" />`:$}
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${rp.map(([d,c])=>w`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${this._treffers?w`<div class="treffers">
              ${this._treffers.length===0?w`<div class="treffer">Niets gevonden.</div>`:this._treffers.map(d=>w`<button
                    ...
                    >
                      ${d.image?w`<img src=${d.image} alt="" />`:$}
                      <span>${d.name}</span>
                      <span class="soort">${d.media_type??""}</span>
                    </button>`)}
            </div>`:$}
        ${s?w`<div class="waarschuwing">${this._svg(Ot)}<span>${s}</span></div>`:$}
      </div>
      ...
      <div class="blok">
        ...
        ${r?w`<div class="uitleg">${this._svg(Ot)}<span>${r}</span></div>`:w`
              <div class="vak">
                <select
                  id="lamp"
      ...
      ${this._melding?w`<div class="blok">
            <div class="waarschuwing ${this._melding.fout?"fout":""}">
              ${this._svg(Ot)}<span>${this._melding.tekst}</span>
            </div>
          </div>`:$}
    ...
    `}};y(et,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),y(et,"styles",[oe,ne`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${be(Dn)});
      display: block;
  ...
  `]);var tl="person",lp="Kies een persoon in de kaartinstellingen.",nl="De gekozen persoon is niet gevonden.",dp="De opgeslagen wekkers van deze persoon zijn onleesbaar.",ab=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function al(a){if(!a||typeof a!="object"||Array.isArray(a))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=a.person;if(e==null||e==="")return{...a};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${tl}.`))throw new Error(`'${e}' zit niet in het domein ${tl}. Kies een persoon, zoals person.sven.`);return{...a}}function il(a){return{type:`custom:${a}`}}function rl(a,e){return a?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:nl,isFout:!0}:{soort:"ontbreekt",tekst:lp,isFout:!1}}function ol(a,e){return a==="not_found"?nl:a==="home_assistant_error"?dp:e||"Er ging iets mis bij het ophalen van de wekkers."}var cp=["ma","di","wo","do","vr","za","zo"],pp="Geen wekkers ingesteld",hp="Eenmalig",up="Eenmalig \u2014 afgelopen",mp="Geen wekker actief",sl="Stoppen",gp="Er is een melding over deze wekker, maar de tekst ontbreekt.";function fp(a){return!Array.isArray(a)||a.length===0?hp:[...new Set(a)].sort((t,n)=>t-n).map(t=>cp[t-1]??"?").join(" ")}function bp(a,e){return!a||Array.isArray(a.days)&&a.days.length>0?!1:Date.parse(a?.one_shot_at??"")<=e}function ll(a,e){return bp(a,e)?up:fp(a?.days)}function dl(a){let e=a?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:gp,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function cl(a){let e=a?.alarms;if(!Array.isArray(e)||e.length===0)return pp;let t=a?.next_fire?.text;return typeof t=="string"&&t.trim()?t:mp}function pl(a,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(a??[]).find(s=>s?.id===o)).filter(Boolean),i=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:i.length?i.join(" en "):"Wekker",tijd:r.join(" en ")}}var vp="0.22.0",kp="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",xp="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",hl="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",_p="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Rn=(a,e="icoon")=>w`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${a} />
  </svg>`,Tt=class extends J{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null,this._herkansing=new fe(()=>this._haalOp()),this._verbinding=new We}setConfig(e){let t=al(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(qi)}static getStubConfig(){return il(Ve)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:Be(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&(this._startAbonnement(),this._verbinding.herverbonden(this.hass)&&(this._herkansing.herstel(),this._haalOp())),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?I(e):null),C(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:re.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${Ve}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${Ve}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let i=new Set(this._toestand.ringing??[]);n==="started"?i.add(t):i.delete(t),this._toestand={...this._toestand,ringing:[...i]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:re.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null,this._herkansing.herstel()}catch(t){if(this._config?.person!==e||Te(t)&&this._herkansing.plan())return;this._toestand=null,this._fout=ol(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:re.entities})}catch(t){this._entiteiten=null,console.warn(`${Ve}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:re.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:re.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:re.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:re.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?pl(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return $;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=rl(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let i=this._stop();return this._editorVoor!==void 0&&!i?w`<div class="card surface">
    ...
    `}_bevestiging(e){return w`<div class="onderrij bevestiging">
      <span class="boodschap">${qs(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=dl(e),i=!!e.enabled;return w`
      <div class="rij ${i?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?w`<div class="onderrij ${n.isFout?"fout":""}">
            ${Rn(n.isFout?_p:hl,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:$}
    `}};y(Tt,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),y(Tt,"styles",[oe,ne`
  ...
  `]);var tt=class tt extends J{constructor(){super(...arguments);y(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?$:w`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};y(tt,"properties",{hass:{attribute:!1},_config:{state:!0}}),y(tt,"styles",[oe,ne`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),y(tt,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Xi=tt;O(Ve,Tt);O(qi,Xi);O(Gs,et);Ke({type:Ve,name:Us,description:`Wekkerkaart van DomotiApp (v${vp}).`,preview:!1,documentationURL:Ws});var wp=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function ul(a){return`/api/image/serve/${a}/original`}function ml(a){return a?wp.includes(a.type)?a.size>12582912?`Deze afbeelding is ${Math.round(a.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var yp=`
...
`,Qi=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(yp)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');document.activeElement!==this&&e.value!==this.value&&(e.value=this.value);let t=this.$(".voorbeeld");if(this.value){if(t.dataset.bron!==this.value){t.dataset.bron=this.value;let n=document.createElement("img");n.src=this.value,n.alt="",n.onerror=()=>{t.dataset.bron="",t.innerHTML=v("car")},t.replaceChildren(n)}}else t.dataset.bron!==""&&(t.dataset.bron="",t.innerHTML=v("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=ml(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let i=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:i?{Authorization:`Bearer ${i}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(ul(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};O("dac-foto-picker",Qi);var zp="/api/domotiapp_lovelace/loader.js",gl="domotiapp-lovelace-verversing";function fl(a){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(a??""));return e?e[1].toLowerCase():null}async function $p(a){try{let e=await a(zp,{cache:"no-store"});return e?.ok?fl(await e.text()):null}catch{return null}}function jp(){try{return globalThis.sessionStorage?.getItem(gl)??null}catch{return null}}function Ep(a){try{globalThis.sessionStorage?.setItem(gl,a)}catch{return!1}return!0}function Ap(a,e,t){return!a||!e?"onbekend":a===e?"actueel":t===e?"al-geprobeerd":"herladen"}function bl({eigenUrl:a,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:i=18e5,klok:r=setInterval}={}){let o=fl(a);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await $p(e);if(Ap(o,p,jp())!=="herladen"||!Ep(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,i);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var Mp="0.22.0";ur(a=>console.warn(`domotiapp-lovelace: ${a}`));bl({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${Mp} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Mp as VERSION};
