var ur=Object.defineProperty;var mr=(i,e,t)=>e in i?ur(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var w=(i,e,t)=>mr(i,typeof e!="symbol"?e+"":e,t);var F=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function ee(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var se=i=>String(i??"").split(".")[0],f=(i,e)=>e&&i?.states?.[e]||null,P=(i,e)=>f(i,e)?.attributes??{},at=(i,e,t)=>t?null:P(i,e).entity_picture||null;function pi(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function L(i,e,t){return t||P(i,e).friendly_name||e||""}var gr=new Set(["scene","script","input_button","button","event"]),Vt=i=>gr.has(se(i));function W(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Vt(i.entity_id):!1}function Oe(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(se(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var fr=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),hi=i=>fr.has(se(i));function ui(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function it(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var U=(i,e)=>it(i,"hass-more-info",{entityId:e});function Ce(i){switch(se(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function br(i){switch(se(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function be(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":U(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=br(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),it(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":it(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":it(i,"ll-custom",n);break;default:break}}function T(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function G(i,e){if(!e)return"";let t=se(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function V(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var di=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],mi=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],ci=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),It=(i,e)=>Math.round((ci(e)-ci(i))/864e5);function Le(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Kt(i,e=new Date){if(!i)return"";let t=It(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?di[i.getDay()]:`${di[i.getDay()].slice(0,2)} ${i.getDate()} ${mi[i.getMonth()]}`}var gi=i=>i?`${i.getDate()} ${mi[i.getMonth()]}`:"";function vr(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function _r(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function q(i,e=4){if(!i)return;let t=_r(i);if(!t){e>0&&requestAnimationFrame(()=>q(i,e-1));return}let n=`${vr(t)}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}function Z(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);q(i)});e.observe(i);for(let t of i.children)e.observe(t);return q(i),()=>e.disconnect()}var xr="home-assistant";function fi({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=xr,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let m=i();if(!m)return!1;for(let[x,u]of e)try{m.get(x)||m.define(x,u)}catch(y){t(`kon ${x} niet registreren: ${y&&y.message}`)}return!0}function c(){let m=i();return!m||!m.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var bi=[];function N(i,e){bi.push([i,e])}function je({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function vi(i=()=>{}){fi({leesRegistry:()=>globalThis.customElements,definities:bi,waarschuw:i})}var kr=`
  :host {
    ${F}
    display: block;
...
`,C={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},rt={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},K=(i,e="accent")=>C[i]??(i&&/[#(]|^var/.test(i)?i:C[e]),O=Symbol("incomplete"),wr=i=>`
  <div class="needs">
  ...
  </div>`,yr=56,_i=8,Y=i=>Math.max(1,Math.ceil((i+_i)/(yr+_i))),E=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[ee(kr+pe+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[O]||ui(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[O]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[O];if(e.innerHTML=t?wr(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(Z(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}};w(E,"css","");function A(i,e,{name:t,description:n,preview:a=!0}={}){N(i,e),je({type:i,name:t,description:n,preview:a})}function D(i,e){N(i,e)}var h=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,z={house:h(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
    ...
    <ellipse cx="13.9" cy="12.1" rx="1.7" ry="2.8"/>`)};function b(i,e="question"){return i?z[i]?z[i]:i.includes(":")?`<ha-icon class="icon" icon="${i}"></ha-icon>`:z[e]??z.question:z[e]??z.question}function Ut(i,e={}){switch(String(i??"").split(".")[0]){case"light":return"bulb";case"switch":return"switchOn";case"cover":return e.device_class==="awning"||e.device_class==="blind"?"awning":"shutter";case"person":case"device_tracker":return"person";case"climate":return"thermo";case"binary_sensor":return e.device_class==="smoke"?"smoke":"shield";case"alarm_control_panel":return"shield";case"scene":case"script":case"input_button":case"button":return"star";case"weather":return"cloudSun";case"date":return"calendar";case"time":case"datetime":return"clock";case"input_datetime":return e.has_time===!1?"calendar":"clock";case"media_player":return e.device_class==="tv"?"tv":e.device_class==="receiver"?"radio":"speaker";default:return"question"}}function De(i){switch(i){case"sunny":case"clear-night":return"sun";case"partlycloudy":return"cloudSun";case"cloudy":return"cloud";case"rainy":case"pouring":case"hail":case"lightning":case"lightning-rainy":return"rain";case"snowy":case"snowy-rainy":return"snow";case"fog":return"fog";case"windy":case"windy-variant":return"wind";default:return"cloud"}}var $r=[["Woning",["house","floorB","floor1","floor2","garage","door","window","grid"]],["Rolluiken",["shutter","shutterOpen","awning","garageOpen","garageClosed","arrowUp","arrowDown","stop"]],["Licht en stroom",["bulb","bulbGroup","switchOn","power","plug","bolt","battery"]],["Personen",["person","people","away"]],["Apparaten",["tv","speaker","camera","car","washer","dishwasher","printer","fan","airco","radio"]],["Media",["play","pause","next","prev","volume","volumeMute","shuffle","repeat","repeatOne","search","speakers","music","speaker","tv","radio"]],["Afval",["bin","binWheeled","calendar"]],["Weer",["sun","cloud","cloudSun","rain","snow","fog","wind","drop","uv","sunrise","sunset","thermo"]],["Status",["shield","lock","lockOpen","key","wifi","smoke","warning","check","close","clock","gaugeArrow"]],["Cijfers",["een","twee","drie","vier","vijf","zes","zeven","acht","negen","tien"]],["Overig",["star","moon","leaf","cog","dots","plus","minus","chevronRight","chevronDown","question","pencil"]]],jr=`
...
`,Wt=null,Bt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Wt=Wt??[ee(jr)],this.shadowRoot.adoptedStyleSheets=Wt,this.value_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,Gt=null,qt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Gt=Gt??[ee(Ar)],this.shadowRoot.adoptedStyleSheets=Gt,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in C)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${C[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${zr.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
  ...
  `);var Yt=class extends M{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[Ft({name:"weather",selector:v.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Ft({name:"sun",selector:v.entity("sun")},{name:"precipitation_entity",selector:v.entity("sensor")}),{name:"name",selector:v.text()},{name:"hide_below",selector:v.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",bare:"Zonder kaartrand",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};D("domotiapp-header-card-editor",Yt);A("domotiapp-header-card",ot,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var st=class extends E{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
  ...
  `);var Jt=class extends M{defaults(){return{line:!0,tone:"accent"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:Zt.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:v.text()},{name:"line",selector:v.bool()},{name:"secondary_entity",selector:v.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};D("domotiapp-separator-card-editor",Jt);A("domotiapp-separator-card",st,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var Qt=(i,e,t)=>Math.min(t,Math.max(e,i));function he(i,e){let t=e.min??0,n=e.max??100,a=e.step??1,r=!1,o=u=>{let y=i.getBoundingClientRect();if(!y.width)return t;let k=Qt((u-y.left)/y.width,0,1),$=t+k*(n-t);return Qt(Math.round($/a)*a,t,n)},s=u=>{try{i.setPointerCapture?.(u)}catch{}},l=u=>{try{i.hasPointerCapture?.(u)&&i.releasePointerCapture(u)}catch{}},d=u=>{e.disabled?.()||u.button!=null&&u.button!==0||(r=!0,s(u.pointerId),i.classList.add("dragging"),e.onInput(o(u.clientX)),u.preventDefault())},c=u=>{r&&(e.onInput(o(u.clientX)),u.preventDefault())},p=u=>{r&&(r=!1,l(u.pointerId),i.classList.remove("dragging"),e.onCommit(o(u.clientX)))},m=u=>{r&&(r=!1,l(u?.pointerId),i.classList.remove("dragging"),e.onInput(e.value()))},x=u=>{if(e.disabled?.())return;let y=(n-t)/10,k={ArrowLeft:-a,ArrowDown:-a,ArrowRight:a,ArrowUp:a,PageDown:-y,PageUp:y,Home:-1/0,End:1/0};if(!(u.key in k))return;u.preventDefault();let $=e.value(),re=Qt(k[u.key]===-1/0?t:k[u.key]===1/0?n:$+k[u.key],t,n);e.onInput(re),e.onCommit(re)};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",m),i.addEventListener("keydown",x),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",m),i.removeEventListener("keydown",x)}}var te=(i="")=>`
...
`;var Lr=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Dr=new Set(["hs","rgb","rgbw","rgbww","xy"]),tn=i=>i?.attributes?.supported_color_modes??[],Rr=i=>tn(i).some(e=>Lr.has(e)),lt=i=>tn(i).some(e=>Dr.has(e)),dt=i=>tn(i).includes("color_temp"),xi=i=>Math.max(1,Math.round((i??0)/255*100)),ct=class extends E{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[O]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var an=class extends M{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:v.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:v.text()},{name:"step",selector:v.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};D("domotiapp-climate-card-editor",an);A("domotiapp-climate-card",pt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var yi=({label:i="Aan of uit",cls:e=""}={})=>`<button class="toggle ${e}" type="button" role="switch" aria-checked="false" aria-label="${i}"><span class="knob"></span></button>`;function rn(i,e){if(!i)return;let t=String(!!e);i.getAttribute("aria-checked")!==t&&i.setAttribute("aria-checked",t)}function $i(i,e){let t=i.querySelector(".knob"),n=!1,a=0,r=!1,o=!1,s=()=>{n=!1,i.classList.remove("dragging"),t?.style.removeProperty("--knob")},l=u=>{u!==e.value()&&(rn(i,u),e.set(u))},d=u=>{if(!e.disabled?.()&&!(u.button!=null&&u.button!==0)){u.stopPropagation(),n=!0,r=!1,o=!1,a=u.clientX,i.classList.add("dragging");try{i.setPointerCapture?.(u.pointerId)}catch{}}},c=u=>{if(!n)return;let y=u.clientX-a;Math.abs(y)>3&&(r=!0);let k=e.value()?22:0,$=Math.min(22,Math.max(0,k+y));t?.style.setProperty("--knob",`${$}px`)},p=u=>{if(!n)return;u.stopPropagation();let y=u.clientX-a,k=e.value()?22:0,$=Math.min(22,Math.max(0,k+y));s();try{i.hasPointerCapture?.(u.pointerId)&&i.releasePointerCapture(u.pointerId)}catch{}o=!0,l(r?$>22/2:!e.value())},m=()=>{n&&s()},x=u=>{if(u.stopPropagation(),u.preventDefault(),o){o=!1;return}e.disabled?.()||l(!e.value())};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",m),i.addEventListener("click",x),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",m),i.removeEventListener("click",x)}}var ji=`
  .toggle {
...
`;var ht=i=>String(i??"").split(".")[0],Ei=new Set(["input_datetime","time","date","datetime"]),zi=i=>Ei.has(ht(i)),ne=i=>String(i).padStart(2,"0");function Pr(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function on(i){if(!i)return null;let e=ht(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:Pr(i.state)}var Vr=i=>`${i.getFullYear()}-${ne(i.getMonth()+1)}-${ne(i.getDate())}T${ne(i.getHours())}:${ne(i.getMinutes())}`;function Ir(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${ne(Math.floor(n/60))}:${ne(n%60)}`}function Si(i,e=on(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${ne(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(ht(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":Vr(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${ne(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Ai(i,e,t){let n=ht(i),a=String(t??"");if(!a||!Ei.has(n)||!e)return null;if(e==="time"){let m=a.match(/^(\d{1,2}):(\d{2})/);if(!m)return null;let x=`${ne(m[1])}:${m[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:x}]:["input_datetime","set_datetime",{entity_id:i,time:x}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${ne(d)}:${c}:00`;if(n==="datetime"){let m=Ir(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${m}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var ut={row:44,tile:96,compact:44},Re=6,Mi=12,Kr=["row","tile","compact"],Ur=["card","items","none"],He=i=>typeof i=="string"?{entity:i}:{...i},Pe=i=>Math.min(Math.max(1,Number(i)||2),3),Ee=i=>Kr.includes(i)?i:"row",J=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function Ti(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(t=>({columns:Pe(t.columns),layout:Ee(t.layout),items:(t.items??t.entities??[]).map(He)}));let e=(i?.items??i?.entities??[]).map(He);return e.length?[{columns:Pe(i.columns),layout:Ee(i.layout),items:e}]:[]}function mt(i){return Ur.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var Wr=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns));function sn(i){let e=i?.rows??[];if(!e.length)return Mi+ut.row;let t=mt(i)==="card"?Mi:0;for(let n of e){let a=Wr(n);t+=a*ut[Ee(n.layout)]+(a-1)*Re}return t+(e.length-1)*Re}var Oi=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],Br=i=>Oi.find(e=>e.waarde===i)?.label??"Rij";function gt(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();J(e)&&i.bewaard.push(e)}return i}function Gr(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Pe(n.columns),layout:Ee(n.layout),items:(n.items??n.entities??[]).map(He)})):(()=>{let n=(i.items??i.entities??[]).map(He);return n.length?[{columns:Pe(i.columns),layout:Ee(i.layout),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]);for(let r of a)t.push(gt({columns:n.columns,layout:n.layout,items:r}))}return t}var Ni=i=>i.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(J).map(t=>structuredClone(t))})).filter(e=>e.items.length),qr=`
...
`,ln=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=Gr(e);this.gebouwd_&&JSON.stringify(Ni(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(r>e?`r${r-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{J(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=qr;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=gt({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};n.surface==="items"||n.surface==="none"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(k=>({waarde:k,label:String(k),titel:`${k} entiteit${k>1?"en":""} in deze rij`})),()=>e.columns,k=>{e.columns=k,gt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c);let p=document.createElement("div");p.className="rijbody";let m=this.segment_(Oi.map(k=>({waarde:k.waarde,label:k.label})),()=>e.layout,k=>{e.layout=k,this.emit_()}),x=document.createElement("div");x.className="vormrij";let u=document.createElement("b");u.textContent="Vorm van deze rij",x.append(u,m.wrap),p.appendChild(x);let y=()=>{let k=e.items.filter(J),$=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&$.push(Br(e.layout)),$.push(k.length?k.map(re=>this.itemNaam_(re)).join(", "):"nog leeg"),l.textContent=$.join(" \xB7 "),d.vernieuw(),m.vernieuw()};return this.koppen_.push(y),e.items.forEach((k,$)=>p.appendChild(this.itemBlok_(e,k,t,$))),n.append(a,p),y(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),gt(e),this.emit_(),this.build_()}),o.append(s,l,d,m);let x=document.createElement("div");x.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",u.addEventListener("value-changed",j=>{j.stopPropagation(),t.entity=j.detail.value.entity??"",this.emit_()});let y=document.createElement("dac-icon-picker");y.label="Icoon",y.hass=this.hass_,y.addEventListener("value-changed",j=>{j.stopPropagation(),j.detail.value?t.icon=j.detail.value:delete t.icon,this.emit_()});let k=document.createElement("dac-tone-picker");k.label="Kleur",k.hass=this.hass_,k.addEventListener("value-changed",j=>{j.stopPropagation(),j.detail.value?t.tone=j.detail.value:delete t.tone,this.emit_()});let $=document.createElement("ha-form");$.hass=this.hass_,$.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],$.computeLabel=j=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[j.name]??j.name,$.computeHelper=j=>{if(j.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(j.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(j.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(j.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},$.addEventListener("value-changed",j=>{j.stopPropagation();let oe=j.detail.value;oe.name?t.name=oe.name:delete t.name,oe.toggle===!0?t.toggle=!0:delete t.toggle;for(let ce of["show_icon","show_name","show_state"])oe[ce]===!1?t[ce]=!1:delete t[ce];for(let ce of["icon_tap_action","icon_hold_action","tap_action","hold_action"])oe[ce]?t[ce]=oe[ce]:delete t[ce];oe.double_tap_action&&oe.double_tap_action.action!=="none"?t.double_tap_action=oe.double_tap_action:delete t.double_tap_action,this.emit_()});let re=()=>{c.textContent=J(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(J(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!J(t)),m.hidden=!J(t)};return this.koppen_.push(re),u.data={entity:t.entity||void 0},y.value=t.icon??"",k.value=t.tone??"",$.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},x.append(u,y,k,$),r.append(o,x),re(),r}emit_(){let e=Ni(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};N("domotiapp-entities-card-editor",ln);var ft=class extends E{validate(e){let t=Ti(e);return t.some(n=>n.items.some(J))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[O]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?K(e.tone):this.config.tone?K(this.config.tone):se(e.entity)!=="light"?C.accent:pi(f(this.hass,e.entity))??C.lit}metSchakelaar_(e){return!!e.toggle&&hi(e.entity)}metTijd_(e){return!zi(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",mt(e)),this.style.containerType="inline-size";let t=mt(e)==="items";return`<div class="card surface">${e.rows.map((a,r)=>{let o=e.state_position==="right"&&a.layout!=="tile",s=`<span class="st${o?" rechts":""}"></span>`,l=a.items.map((d,c)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${o?s:""}
            ${this.metSchakelaar_(d)?yi({label:"Aan of uit"}):""}
            ${this.metTijd_(d)?'<span class="tijdslot" style="display:contents"></span>':""}
          </div>`).join("");return`
      <div class="row" data-vorm="${a.layout}"
           style="--cols:${a.columns};--it-h:${ut[a.layout]}px">${l}</div>`}).join("")}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>be(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(T(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(T(r,{onTap:()=>n("icon_tap_action",Ce(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let m=p.target?.closest?.(".tijd");if(m&&(p.stopPropagation(),p.type==="click"))try{m.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let m=p.target?.closest?.(".tijd");m&&(p.stopPropagation(),l=Ai(t.entity,m.type,m.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}let o=e.querySelector(".toggle");o&&this.teardown_.push($i(o,{value:()=>Oe(f(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>W(f(this.hass,t.entity))}))})}paint(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=f(this.hass,t.entity),a=Oe(n),r=!!t.entity&&W(n);e.dataset.on=String(a),e.classList.toggle("unavailable",r);let o=this.tone_(t);e.style.setProperty("--tone",o);let s=L(this.hass,t.entity,t.name),l=e.querySelector(".chip");if(l){let y=at(this.hass,t.entity,t.icon),k=t.icon||(y?`pic:${y}`:Ut(t.entity,P(this.hass,t.entity)));l.dataset.icon!==k&&(l.dataset.icon=k,l.classList.toggle("pic",!!y),l.innerHTML=y?`<img src="${y}" alt="" loading="lazy" />`:b(t.icon||Ut(t.entity,P(this.hass,t.entity)))),l.style.setProperty("--tone",y?"var(--dac-ink-3)":a?o:"var(--dac-ink-3)"),l.setAttribute("aria-label",t.entity?`${s} schakelen`:"Icoon")}let d=e.querySelector(".nm");d&&this.text(d,s);let c=e.querySelector(".toggle");c&&(rn(c,a),c.style.setProperty("--tone",o),c.setAttribute("aria-label",`${s} aan of uit`));let p=e.querySelector(".tijdslot"),m=null;if(p){let y=r?null:on(n);p.dataset.soort!==(y??"")&&(p.dataset.soort=y??"",p.innerHTML=y?`<input class="tijd" type="${y}" step="60" />`:""),m=p.querySelector(".tijd")}if(m&&(m.setAttribute("aria-label",`${s} instellen`),this.shadowRoot.activeElement!==m)){let y=Si(n,p.dataset.soort);m.value!==y&&(m.value=y)}let x=e.querySelector(".st"),u=t.show_state??this.config.show_state;if(c||m)x.textContent="";else if(u===!1)x.textContent="";else if(r)x.textContent="Niet bereikbaar";else if(!n||Vt(n.entity_id))x.textContent="";else if(se(n.entity_id)==="light"&&a&&n.attributes.brightness!=null)x.textContent=`${Math.round(n.attributes.brightness/255*100)}%`;else{let y=n.attributes.unit_of_measurement;x.textContent=y?`${n.state} ${y}`:G(this.hass,n)}e.setAttribute("aria-label",`${s}${n?`, ${G(this.hass,n)}`:""}`)})}getCardSize(){return Y(sn(this.config))}getGridOptions(){let e=Y(sn(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};w(ft,"css",`
    :host { display: block; height: 100%; }
  ...
  `);A("domotiapp-entities-card",ft,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var R={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},H=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),dn=i=>!i||i.state==="off",cn=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),pn=i=>i?.state==="playing",Ci=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function Li(i){if(!i)return[];let e=[];return(H(i,R.TURN_ON)||H(i,R.TURN_OFF))&&e.push("power"),dn(i)||(H(i,R.PREVIOUS_TRACK)&&e.push("prev"),H(i,R.PLAY)||H(i,R.PAUSE)||H(i,R.PLAY_MEDIA)?e.push("play"):H(i,R.STOP)&&e.push("stop"),H(i,R.NEXT_TRACK)&&e.push("next")),e}var ve=i=>i?.volume_entity||i?.entity;function hn(i){if(!cn(i))return[];let e=[];return H(i,R.VOLUME_MUTE)&&e.push("mute"),H(i,R.VOLUME_SET)?e.push("slider"):H(i,R.VOLUME_STEP)&&e.push("steps"),e}var me=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Ve=i=>!!i?.attributes?.is_volume_muted,Di=i=>!!i?.attributes?.mass_player_type,un=i=>!!i?.attributes?.shuffle,mn=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ri=i=>({off:"all",all:"one",one:"off"})[Fr(i)]??"all",Fr=i=>["off","all","one"].includes(i)?i:"off";function gn(i,{zoeken:e=!0}={}){if(!cn(i))return[];let t=[];return H(i,R.SHUFFLE_SET)&&t.push("shuffle"),H(i,R.REPEAT_SET)&&t.push("repeat"),e&&Di(i)&&t.push("search"),t}function Hi(i,{tonen:e=!0}={}){if(!e||!cn(i)||!H(i,R.SELECT_SOURCE)||Di(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Pi(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function fn(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var bn="dacScrollSlot",Vi=["position","top","left","right","width","overflow"];function Ii(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[bn])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(Vi.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[bn]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Vi)t.style[o]=a[o];t.dataset&&delete t.dataset[bn],e?.scrollTo?.(0,n)}}}var Ki=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var ge=i=>`domotiapp_lovelace/media/${i}`;function Zr(i,e){if(!i)return null;if(e)return i.uri?{type:ge("favorite"),favorite:!0,uri:i.uri}:null;let t=Ui(i);return!t||!i.library_item_id?null:{type:ge("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function Ui(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Wi={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},vn=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Bi(i,e,t=null){return i?.kind??Ui(e)??t??"playlists"}var _n=i=>!!i?.uri,bt=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:ge("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),Gi=(i,e,t)=>{let n=Zr(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},qi=(i,e)=>i.callWS({type:ge("playlist/create"),name:e}).then(t=>t?.playlist??null),Fi=(i,e)=>i.callWS({type:ge("playlist/remove"),library_item_id:String(e.library_item_id)}),Zi=(i,e)=>i.callWS({type:ge("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Xi=(i,e,t)=>i.callWS({type:ge("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Yi=(i,e,t)=>i.callWS({type:ge("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Xr=350,Yr={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Jr(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Yr[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Qr=`
  :host {
    ${F}
...
`,xn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=ee(pe+Qr)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=Ii(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${vn.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
        ...
        <div class="menu" hidden></div>
          ...
          <div class="rij" data-i="${a}" data-knoppen="${d}">
            ...
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let l=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let d=he(s,{value:()=>me(f(this.hass,l)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:l})});this.schuiven_.set(l,d)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,l=o.querySelector(".slider");if(!l||l.classList.contains("dragging"))continue;let d=f(this.hass,s),c=me(d);this.zetSchuif_(l,c,Ve(d))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let a=e.parentElement.querySelector(".pct");a&&(a.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=me(f(this.hass,this.entity_)),a=f(this.hass,e);H(a,R.VOLUME_SET)&&me(a)!==n&&this.hass.callService("media_player","volume_set",{volume_level:n/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};N("domotiapp-media-browser",xn);function Ji(i,e,t,n={}){let a=document.querySelector("domotiapp-media-browser");return a||(a=document.createElement("domotiapp-media-browser"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var eo=`
  :host {
    ${F}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,kn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ee(eo+pe)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
      ...
      </div>`}wire(){let e=this.config,t=(o,s)=>be(this,this.hass,e,e[o]??s);this.teardown_.push(Z(this.$(".card"))),this.teardown_.push(T(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(T(n,{onTap:()=>t("icon_tap_action",Ce(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",o=>o.stopPropagation()),this.on(n,"pointerdown",o=>o.stopPropagation());let a=this.$(".hoesgroot");a&&(this.teardown_.push(T(a,{onTap:()=>t("icon_tap_action",Ce(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(a,"click",o=>o.stopPropagation()),this.on(a,"pointerdown",o=>o.stopPropagation()));let r=o=>{let s=o.target.closest?.("[data-k]");s&&(o.stopPropagation(),this.doe_(s.dataset.k))};this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".vol"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".extra"),"pointerdown",o=>o.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=f(this.hass,t),a=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return a(dn(n)?"turn_on":"turn_off");case"bron":return Qi(this.hass,t,L(this.hass,t,this.config.name));case"prev":return a("media_previous_track");case"next":return a("media_next_track");case"play":return a(pn(n)?"media_pause":"media_play");case"stop":return a("media_stop");case"mute":{let r=ve(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Ve(f(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:ve(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!un(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:Ri(mn(n))},{entity_id:t});case"search":return Ji(this.hass,t,L(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.config.speakers});default:return}}paint(){let e=this.config,t=f(this.hass,e.entity),n=!t||t.state==="unavailable",a=Ci(t),r=this.$(".top");r.dataset.on=String(a),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:at(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||fn(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(l,"speaker")),o.style.setProperty("--tone",a&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(e.icon||fn(t),"speaker"));let c=L(this.hass,e.entity,e.name),p=Pi(t,m=>G(this.hass,m));this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),q(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),a=this.config.show_controls===!1||t?[]:Li(e),r=a.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${vt[s].label}">${b(vt[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=pn(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s))}}paintVolume_(e,t){let n=this.$(".vol"),a=ve(this.config),r=a===this.config.entity?e:f(this.hass,a),o=this.config.show_volume===!1||t?[]:hn(r),s=t?null:Hi(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=[...o,s?"bron":""].join(",");n.dataset.sig!==l&&(n.dataset.sig=l,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${b("volume")}</button>`:"")+(o.includes("slider")?te("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${b("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${b("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${b("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let d=n.querySelector(".bronknop");if(d){let u=s.nu||"Bron";this.text(d.querySelector("b"),u),d.setAttribute("aria-label",`Bron kiezen, nu ${u}`),d.title=`Kies uit ${s.aantal} bronnen`}let c=Ve(r),p=me(r),m=n.querySelector('[data-k="mute"]');if(m){let u=c?"volumeMute":"volume";m.dataset.icon!==u&&(m.dataset.icon=u,m.innerHTML=b(u)),m.setAttribute("aria-pressed",String(c))}let x=n.querySelector(".slider");x&&(this.attach_(x,"volume",{value:()=>me(f(this.hass,ve(this.config))),onInput:u=>this.setSlider_(x,u),onCommit:u=>this.hass.callService("media_player","volume_set",{volume_level:u/100},{entity_id:ve(this.config)}),disabled:()=>W(f(this.hass,ve(this.config)))}),x.classList.contains("dragging")||this.setSlider_(x,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),a=t||this.config.show_controls===!1?[]:gn(e,{zoeken:this.config.show_search!==!1});n.hidden=!a.length;let r=a.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map((d,c)=>`${d==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${d}" aria-label="${vt[d].label}">${b(vt[d].icon)}</button>`).join("")),!a.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(un(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let d=mn(e),c=d==="one"?"repeatOne":"repeat";s.dataset.icon!==c&&(s.dataset.icon=c,s.innerHTML=b(c)),s.setAttribute("aria-pressed",String(d!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[d])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let a=he(e,n);this.sliders_.set(t,a),this.teardown_.push(a)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=f(this.hass,this.config?.entity);return 1+(hn(e).length?1:0)+(gn(e).length?1:0)}getGridOptions(){return this.config?.layout==="groot"?{columns:12,rows:"auto",min_columns:6,min_rows:6}:{columns:12,rows:"auto",min_columns:4,min_rows:1}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("media_player."));return n?{entity:n}:{}}};w(_t,"css",`
    :host { display: block; }
  ...
  `);var wn=class extends M{defaults(){return{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"entity",selector:v.entity("media_player")},{name:"name",selector:v.text()},{name:"layout",selector:v.select([{value:"row",label:"Rij (\xE9\xE9n rasterrij hoog)"},{value:"groot",label:"Groot (telefoonformaat, grote knoppen)"}])},{name:"volume_entity",selector:v.entity("media_player")},{name:"show_artwork",selector:v.bool()},{name:"show_controls",selector:v.bool()},{name:"show_volume",selector:v.bool()},{name:"show_source",selector:v.bool()},{name:"radio_mode",selector:v.bool()},{name:"speakers",selector:{entity:{domain:"media_player",integration:"music_assistant",multiple:!0}}},{name:"show_search",selector:v.bool()},{name:"icon_tap_action",selector:v.action("toggle")},{name:"icon_hold_action",selector:v.action("more-info")},{name:"tap_action",selector:v.action("more-info")},{name:"hold_action",selector:v.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",layout:"Vorm",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_source:"Bronknop tonen",radio_mode:"Doorspelen na een nummer",speakers:"Speakers om mee te groeperen",show_search:"Zoeken en groeperen tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="layout")return"Groot is bedoeld voor een pop-up of een kolom waar de kaart alle ruimte krijgt: grote hoes, grote knoppen.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="speakers")return'De speakers die onderin het zoekscherm staan om samen te laten spelen. Laat je dit leeg, dan valt de kaart terug op het label "Music Assistant Media" in Home Assistant.';if(e.name==="radio_mode")return"Zoals Spotify: is het gekozen nummer klaar, dan zoekt Music Assistant er zelf muziek bij in plaats van te stoppen. Staat dit uit, dan kan het nog steeds per keer via het menu bij een treffer.";if(e.name==="show_source")return"Voor een tv-ontvanger of een versterker met ingangen: een knop met de zender die nu aanstaat, die een zoekbaar overzicht opent. Kan de speler geen bron kiezen, dan verschijnt hij niet.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};D("domotiapp-media-card-editor",wn);A("domotiapp-media-card",_t,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var Ie=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd"},{sleutel:"co",label:"Koolmonoxide",icoon:"warning",alarm:"Koolmonoxide gedetecteerd"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],yn=20;function $n(i){if(!i||i.state==="unavailable"||i.state==="unknown")return null;if(String(i.entity_id??"").startsWith("binary_sensor."))return i.state==="on"?0:null;let e=Number(i.state);return Number.isFinite(e)?e:null}var to=i=>!!i&&i.state==="on",no=i=>!i||i.state==="unavailable"||i.state==="unknown";function ea(i,e){let t=i.filter(a=>!a.meting);for(let a of t)if(to(e(a.sleutel)))return{soort:"alarm",tekst:a.alarm,tone:"bad",icoon:a.icoon};if(i.length&&i.every(a=>no(e(a.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smoke"};let n=$n(e("battery"));return n!=null&&n<=yn?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smoke"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smoke"}}var io={good:C.good,warn:C.warn,bad:C.bad,neutral:C.neutral,accent:C.accent},xt=class extends E{validate(e){return Ie.filter(n=>e[n.sleutel]).length?{...e}:{...e,[O]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return Ie.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return Ie.filter(e=>this.config[e.sleutel])}toestand_(){let e=ea(this.gekozen_(),t=>f(this.hass,this.config[t]));return{...e,tone:io[e.tone]??C.accent}}batterijPct_(){return $n(f(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare","");let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}">${b(t.icoon)}
      ...
      </div>`}wire(){let e=this.config,t=this.gekozen_()[0];this.teardown_.push(T(this.$(".top"),{onTap:()=>e.tap_action?be(this,this.hass,e,e.tap_action):U(this,e.smoke??e[t.sleutel]),onHold:()=>be(this,this.hass,e,e.hold_action??{action:"more-info"})})),this.$$(".pil").forEach(n=>{let a=e[n.dataset.soort];a&&(this.on(n,"click",r=>{r.stopPropagation(),U(this,a)}),this.on(n,"pointerdown",r=>r.stopPropagation()),n.style.cursor="pointer")})}paint(){let e=this.config,t=this.toestand_(),n=this.$(".top");this.toggleAttribute("alarm",t.soort==="alarm"),n.style.setProperty("--tone",t.tone),n.classList.toggle("unavailable",t.soort==="weg");let a=this.$(".chip"),r=e.icon||t.icoon;a.dataset.icon!==r&&(a.dataset.icon=r,a.innerHTML=b(r,"smoke")),a.style.setProperty("--tone",t.tone);let o=this.gekozen_()[0];this.text(".nm",e.name||L(this.hass,e.smoke??e[o.sleutel],null)),this.text(".st",t.tekst),n.setAttribute("aria-label",`${this.$(".nm").textContent}${t.tekst?`, ${t.tekst}`:""}`),this.$$(".pil").forEach(s=>this.paintPil_(s)),this.$(".meta").hidden=this.gekozen_().length<=1&&!this.config.always_meta}paintPil_(e){let t=Ie.find(o=>o.sleutel===e.dataset.soort),n=f(this.hass,this.config[t.sleutel]),a=e.querySelector("b");if(!n||W(n)){a.textContent="\u2014",e.dataset.let="";return}if(t.meting){let o=n.attributes.unit_of_measurement??"",s=Number(n.state);a.textContent=Number.isFinite(s)?`${V(this.hass,s,t.sleutel==="temperature"?1:0)} ${o}`.trim():G(this.hass,n);let l=t.sleutel==="battery"?this.batterijPct_():null;e.dataset.let=l!=null&&l<=yn?"warn":"";return}let r=Oe(n);a.textContent=r?"Alarm":"Rustig",e.dataset.let=r?"bad":""}regels_(){return this.gekozen_().length>1?2:1}getCardSize(){return this.regels_()}getGridOptions(){let e=this.regels_()===1?1:Y(90);return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-smoke-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("binary_sensor.")&&/rook|smoke/i.test(a));return n?{smoke:n}:{}}};w(xt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var En=class extends M{defaults(){return{show_current:!0,forecast_type:"daily",days:ta}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:v.entity("weather")},{name:"name",selector:v.text()},{name:"forecast_type",selector:v.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:v.number(1,na)},{name:"show_current",selector:v.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};D("domotiapp-forecast-card-editor",En);A("domotiapp-forecast-card",kt,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var Ke={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},Ue=(i,e)=>!!((i?.attributes?.supported_features??0)&e),ro=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},wt=class extends E{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[O]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(T(e.querySelector(".chip"),{onTap:()=>U(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=f(this.hass,n.entity),r=P(this.hass,n.entity),o=!a||a.state==="unavailable",s=a?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=L(this.hass,n.entity,n.name);let l=Ue(a,Ke.SET_POSITION)&&r.current_position!=null,d=l?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=ro(r),p=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],m=e.querySelector(".chip");m.dataset.icon!==p&&(m.dataset.icon=p,m.innerHTML=b(p,c[d]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":l?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(k=>{if(k.dataset.act==="stop"){k.disabled=o||!Ue(a,Ke.STOP);return}let $=k.dataset.act==="open";k.disabled=o||($?!Ue(a,Ke.OPEN):!Ue(a,Ke.CLOSE))});let u=e.querySelector(".pos"),y=l&&this.config.show_position!==!1;if(u.hidden=!y,y){if(u.dataset.built||(u.dataset.built="1",u.innerHTML=te("position"),u.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let $=u.querySelector(".slider"),re=j=>{$.style.setProperty("--v",`${j}%`),$.setAttribute("aria-valuenow",String(j)),e.querySelector(".st").textContent=`${j}% open`};this.teardown_.push(he($,{value:()=>P(this.hass,n.entity).current_position??0,onInput:re,onCommit:j=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:j})}))}let k=u.querySelector(".slider");if(!k.classList.contains("dragging")){let $=r.current_position??0;k.style.setProperty("--v",`${$}%`),k.setAttribute("aria-valuenow",String($))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>Ue(f(this.hass,n.entity),Ke.SET_POSITION));return Y(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};w(wt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var zn=class extends M{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:v.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};D("domotiapp-cover-card-editor",zn);A("domotiapp-cover-card",wt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function oo(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var yt=class extends E{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[O]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(T(e,{onTap:()=>U(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=f(this.hass,t.entity),a=oo(n);e.style.setProperty("--tone",a.home===!0?"var(--dac-good)":a.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=L(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,l=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():z.person),e.setAttribute("aria-label",`${r}, ${a.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return Y(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};w(yt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var An=class extends M{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${ia(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};D("domotiapp-waste-card-editor",An);A("domotiapp-waste-card",$t,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var jt=globalThis,Et=jt.ShadowRoot&&(jt.ShadyCSS===void 0||jt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Mn=Symbol(),aa=new WeakMap,We=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Mn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Et&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=aa.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&aa.set(t,e))}return e}toString(){return this.cssText}},le=i=>new We(typeof i=="string"?i:i+"",void 0,Mn),B=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new We(t,i,Mn)},ra=(i,e)=>{if(Et)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=jt.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},Tn=Et?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return le(t)})(i):i;var{is:co,defineProperty:po,getOwnPropertyDescriptor:ho,getOwnPropertyNames:uo,getOwnPropertySymbols:mo,getPrototypeOf:go}=Object,zt=globalThis,oa=zt.trustedTypes,fo=oa?oa.emptyScript:"",bo=zt.reactiveElementPolyfillSupport,Be=(i,e)=>i,Nn={toAttribute(i,e){switch(e){case Boolean:i=i?fo:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},la=(i,e)=>!co(i,e),sa={attribute:!0,type:String,converter:Nn,reflect:!1,useDefault:!1,hasChanged:la};Symbol.metadata??=Symbol("metadata"),zt.litPropertyMetadata??=new WeakMap;var de=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=sa){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&po(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=ho(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??sa}static _$Ei(){if(this.hasOwnProperty(Be("elementProperties")))return;let e=go(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Be("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Be("properties"))){let t=this.properties,n=[...uo(t),...mo(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(Tn(a))}else e!==void 0&&t.push(Tn(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ra(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Nn).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Nn;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??la)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};de.elementStyles=[],de.shadowRootOptions={mode:"open"},de[Be("elementProperties")]=new Map,de[Be("finalized")]=new Map,bo?.({ReactiveElement:de}),(zt.reactiveElementVersions??=[]).push("2.1.2");var Pn=globalThis,da=i=>i,St=Pn.trustedTypes,ca=St?St.createPolicy("lit-html",{createHTML:i=>i}):void 0,fa="$lit$",fe=`lit$${Math.random().toFixed(9).slice(2)}$`,ba="?"+fe,vo=`<${ba}>`,ke=document,qe=()=>ke.createComment(""),Fe=i=>i===null||typeof i!="object"&&typeof i!="function",Vn=Array.isArray,_o=i=>Vn(i)||typeof i?.[Symbol.iterator]=="function",On=`[ 	
\f\r]`,Ge=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,pa=/-->/g,ha=/>/g,_e=RegExp(`>|${On}(?:([^\\s"'>=/]+)(${On}*=${On}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ua=/'/g,ma=/"/g,va=/^(?:script|style|textarea|title)$/i,In=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),g=In(1),Od=In(2),Cd=In(3),we=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),ga=new WeakMap,xe=ke.createTreeWalker(ke,129);function _a(i,e){if(!Vn(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ca!==void 0?ca.createHTML(e):e}var xo=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=Ge;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Ge?c[1]==="!--"?o=pa:c[1]!==void 0?o=ha:c[2]!==void 0?(va.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=_e):c[3]!==void 0&&(o=_e):o===_e?c[0]===">"?(o=a??Ge,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?_e:c[3]==='"'?ma:ua):o===ma||o===ua?o=_e:o===pa||o===ha?o=Ge:(o=_e,a=void 0);let x=o===_e&&i[s+1].startsWith("/>")?" ":"";r+=o===Ge?l+vo:p>=0?(n.push(d),l.slice(0,p)+fa+l.slice(p)+fe+x):l+fe+(p===-2?s:x)}return[_a(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Ze=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=xo(e,t);if(this.el=i.createElement(d,n),xe.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=xe.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(fa)){let m=c[o++],x=a.getAttribute(p).split(fe),u=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:u[2],strings:x,ctor:u[1]==="."?Ln:u[1]==="?"?Dn:u[1]==="@"?Rn:Se}),a.removeAttribute(p)}else p.startsWith(fe)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(va.test(a.tagName)){let p=a.textContent.split(fe),m=p.length-1;if(m>0){a.textContent=St?St.emptyScript:"";for(let x=0;x<m;x++)a.append(p[x],qe()),xe.nextNode(),l.push({type:2,index:++r});a.append(p[m],qe())}}}else if(a.nodeType===8)if(a.data===ba)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(fe,p+1))!==-1;)l.push({type:7,index:r}),p+=fe.length-1}r++}}static createElement(e,t){let n=ke.createElement("template");return n.innerHTML=e,n}};function ze(i,e,t=i,n){if(e===we)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=Fe(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=ze(i,a._$AS(i,e.values),a,n)),e}var Cn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??ke).importNode(t,!0);xe.currentNode=a;let r=xe.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Xe(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Hn(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=xe.nextNode(),o++)}return xe.currentNode=ke,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Xe=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ze(this,e,t),Fe(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==we&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):_o(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==_&&Fe(this._$AH)?this._$AA.nextSibling.data=e:this.T(ke.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Ze.createElement(_a(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Cn(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=ga.get(e.strings);return t===void 0&&ga.set(e.strings,t=new Ze(e)),t}k(e){Vn(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(qe()),this.O(qe()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=da(e).nextSibling;da(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Se=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=_}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=ze(this,e,t,0),o=!Fe(e)||e!==this._$AH&&e!==we,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=ze(this,s[n+l],t,l),d===we&&(d=this._$AH[l]),o||=!Fe(d)||d!==this._$AH[l],d===_?e=_:e!==_&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ln=class extends Se{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}},Dn=class extends Se{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==_)}},Rn=class extends Se{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=ze(this,e,t,0)??_)===we)return;let n=this._$AH,a=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==_&&(n===_||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Hn=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ze(this,e)}};var ko=Pn.litHtmlPolyfillSupport;ko?.(Ze,Xe),(Pn.litHtmlVersions??=[]).push("3.3.3");var xa=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new Xe(e.insertBefore(qe(),r),r,void 0,t??{})}return a._$AI(i),a};var Kn=globalThis,I=class extends de{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xa(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return we}};I._$litElement$=!0,I.finalized=!0,Kn.litElementHydrateSupport?.({LitElement:I});var wo=Kn.litElementPolyfillSupport;wo?.({LitElement:I});(Kn.litElementVersions??=[]).push("4.2.2");var Q=B`
  :host {
    ${le(F)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${le(pe)}
`;var yo=["unavailable","unknown"],$o=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function At({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||yo.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let m of $o)if(d[m]!==void 0){p[m]=d[m];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Mt(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var Wn=["hs","rgb","rgbw","rgbww","xy"],Bn="color_temp",jo="onoff";var ye="kleur";var Eo=["unavailable","unknown"],wa=["color_temp_kelvin","rgb_color","hs_color","xy_color"],zo=[0,100];function ie(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===jo,a=t!==null&&t.includes(Bn),r=t!==null&&t.some(d=>Wn.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Eo.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function So(){return{state:"off"}}function ya(i,e){let t=e??ie(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...Co(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function $a(i,e,t,n){return e?i&&i.state==="on"?{...i}:ya(t,n):{state:"off"}}function ja(i,e,t,n){let a=n??ie(t),r=Yn(i,t,a);return a.helderheid&&(r.brightness=S(e,1,255)),r}function Gn(i,e,t,n){let a=n??ie(t),r=Yn(i,t,a);return La(r),r.color_temp_kelvin=S(e,a.minKelvin,a.maxKelvin),r}function qn(i,e,t,n){let a=n??ie(t),r=Yn(i,t,a);return La(r),r.hs_color=[S(e?.[0],0,360),S(e?.[1],0,100)],r}function Tt(i,e,t){return i??So()}function Ea(i,e,t){let n=Tt(i,e,t);if(typeof n.brightness=="number")return S(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?S(a,1,255):255}function Fn(i,e,t){let n=t??ie(e),a=Tt(i,e,n);if(typeof a.color_temp_kelvin=="number")return S(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?S(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Nt(i,e,t){let n=Tt(i,e,t);if(Un(n.hs_color))return[S(n.hs_color[0],0,360),S(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Un(a)?[S(a[0],0,360),S(a[1],0,100)]:[...zo]}function Zn(i){return i!=null&&typeof i=="object"}function za(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Zn(a[s]?.lights?.[o]))return!0;return!1})}function Sa(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Xn(i,e,t){return Tt(i,e,t).state==="on"}function Aa(i,e,t){let n=t??ie(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Xn(i,e,n),r=Ma(n),o=r?Ao(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===ye),kleurkeuze:a&&r,stand:a?o:null}}function Ma(i){return!!(i?.kleurtemp&&i?.kleur)}function Ao(i,e,t){let n=t??ie(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(wa.slice(1).some(r=>i[r]!==void 0))return ye}let a=e?.attributes?.color_mode;return a===Bn&&n.kleurtemp?"wit":Wn.includes(a)&&n.kleur?ye:"wit"}function Ta(i,e,t,n){let a=n??ie(t);return Ma(a)?e==="wit"?Gn(i,Fn(i,t,a),t,a):qn(i,Nt(i,t,a),t,a):i}function Na(i){let e=S(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Oa(i){let e=S(i,1,100);return S(Math.round(e/100*255),1,255)}var Mo=1e3,To=4e4,ka=7;function No(i){let e=S(i,Mo,To)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[S(t,0,255),S(n,0,255),S(a,0,255)]}function Oo(i){let[e,t,n]=No(i);return`rgb(${e}, ${t}, ${n})`}function Ca(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:ka},(r,o)=>{let s=o/(ka-1),l=t+(n-t)*s;return`${Oo(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Co(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?S(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===Bn&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=S(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Wn.includes(a)&&Un(t.hs_color)&&(n.hs_color=[S(t.hs_color[0],0,360),S(t.hs_color[1],0,100)]),n}function Yn(i,e,t){return i&&i.state==="on"?{...i}:ya(e,t)}function La(i){for(let e of wa)delete i[e]}function Un(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function S(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Ot="domotiapp-scene-card",Jn="domotiapp-scene-card-editor",Da="domotiapp-scene-editor";var Ye=["een","twee","drie"],Ra="pencil",Ha=["grid_options","layout_options","view_layout","visibility"];var Pa="entity_id",Ae=class extends I{constructor(){super();w(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));w(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Pa]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Pa];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return _;let t=this._leden();return g`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?g`
          ...
          `:_}
    `}};w(Ae,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),w(Ae,"styles",[Q,B`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===ei?g`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Ia?g`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=Xn(a,t,n),o=Aa(a,t,n);return g`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${Zn(a)?_:g`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?g`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,$a(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:_}
        </div>
    ...
    `}_renderHelderheid(e,t,n,a){let r=Na(Ea(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,ja(this._waardeVan(e),Oa(s.detail.value),t,n))};return g`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Ta(this._waardeVan(e),s,t,n))};return g`
      <div class="kleurkeuze">
        <button
          class="keuze ${r===ye?"actief":""}"
          aria-pressed=${r===ye?"true":"false"}
          @click=${o(ye)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,a){let r=Fn(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Gn(this._waardeVan(e),s.detail.value,t,n))};return g`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleur(e,t,n,a){let[r,o]=Nt(a,t,n),s=l=>d=>{d.stopPropagation();let c=Nt(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,qn(this._waardeVan(e),p,t,n))};return g`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Po}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};w(Me,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),w(Me,"styles",[Q,B`
    ...
    `]);var Vo="0.9.0",Io=["type","entity","name_overrides"],ni="laden",Je="klaar",ii="leeg",ai="geen-groep",Ka="opslagfout",Ua="fout",Qe=class extends I{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=ni,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(Jn)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}updated(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?Z(e):null),q(e)}disconnectedCallback(){super.disconnectedCallback(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!Io.includes(n)&&!Ha.includes(n));t.length&&console.warn(`${Ot}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===ai){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=ni,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?ii:Je}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=Ka;return}if(!this.hass.states[t]){this._toestand=ai;return}this._toestand=Ua}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==Je)return;let{oproepen:t}=At({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await Mt((a,r)=>this.hass.callService("light",a,r),t);n.length&&this._meldMislukking(n.map(a=>a.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(a=>this._naam(a)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===Je&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?ii:Je}render(){if(!this._config)return _;switch(this._toestand){case ai:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Ka:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Ua:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return g`
      <div class="needs">
    ...
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=b(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===ii,t=this._toestand===ni,n=this._iconen();return g`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((a,r)=>g`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Je)return _;let e=za(this._scenes,this._leden,3).length,t=Sa(e);return t?g`<div class="mededeling">${t}</div>`:_}_renderEditor(){return g`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||Ye[t])}};w(Qe,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),w(Qe,"styles",[Q,B`
      :host { display: block; }
    ...
    `]);N(Ot,Qe);N(Jn,Ae);N(Da,Me);je({type:Ot,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Vo}).`,preview:!1});var $e="domotiapp-alarm-card",ri="domotiapp-alarm-card-editor",Wa="domotiapp-alarm-editor",Ba="DomotiApp Wekker",Ga="https://github.com/Sven2410/domotiapp-lovelace",ae="domotiapp_lovelace",X=Object.freeze({get:`${ae}/alarms/get`,save:`${ae}/alarms/save`,setEnabled:`${ae}/alarms/set_enabled`,delete:`${ae}/alarms/delete`,stop:`${ae}/alarms/stop`,clearMessage:`${ae}/alarms/clear_message`,search:`${ae}/sound/search`,entities:`${ae}/entities/list`,previewStart:`${ae}/preview/start`,subscribe:`${ae}/updates/subscribe`}),Dt="#026FA1";function qa(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Ko="07:00";var Uo=["uri","name","media_type","image"],Wo="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Bo="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Go="Music Assistant Wekker",qo="Verlichting Wekker";function Rt(){return{id:null,name:"",time:Ko,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Fa(i){let e=Rt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:oi(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:et(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function et(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Uo)e[t]=i[t]===void 0?null:i[t];return e}function oi(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function si(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),oi(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Za(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:et(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Xa(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Ya(i){return oi(i)&&i.slice(0,2)==="02"?Wo:null}function Ja(i){return i===!1?Bo:null}function Qa(i){return typeof i?.endless=="boolean"?i.endless:null}function Ht(i,e){let t=e==="lamp",n=t?qo:Go,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function er(i,e){return Ht(e,"speaker")!==null?!1:si(i).ok}var Zo=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Xo=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],tt="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Yo="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Jo="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Te=class extends I{constructor(){super(),this._concept=Rt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Fa(this.wekker):Rt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:X.previewStart,speaker:this._concept.speaker,sound:et(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:X.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:et(e),endless:Qa(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=si(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:X.save,person:this.person,alarm:Za(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return g`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return _;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Ht(t,"speaker"),r=Ht(n,"lamp"),o=Ya(e.time),s=Ja(e.endless),l=er(e,t);return g`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Zo.map(([d,c])=>g`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Xa(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${a?g`<div class="uitleg">${this._svg(tt)}<span>${a}</span></div>`:g`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Xo.map(([d,c])=>g`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${s?g`<div class="waarschuwing">${this._svg(tt)}<span>${s}</span></div>`:_}
      </div>
      ...
      <div class="blok">
        ...
        ${r?g`<div class="uitleg">${this._svg(tt)}<span>${r}</span></div>`:g`
              <div class="vak">
                <select
                  id="lamp"
    ...
    `}};w(Te,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),w(Te,"styles",[Q,B`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${le(Dt)});
      display: block;
  ...
  `]);var tr="person",Qo="Kies een persoon in de kaartinstellingen.",nr="De gekozen persoon is niet gevonden.",es="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Oc=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function ir(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${tr}.`))throw new Error(`'${e}' zit niet in het domein ${tr}. Kies een persoon, zoals person.sven.`);return{...i}}function ar(i){return{type:`custom:${i}`}}function rr(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:nr,isFout:!0}:{soort:"ontbreekt",tekst:Qo,isFout:!1}}function or(i,e){return i==="not_found"?nr:i==="home_assistant_error"?es:e||"Er ging iets mis bij het ophalen van de wekkers."}var ts=["ma","di","wo","do","vr","za","zo"],ns="Geen wekkers ingesteld",is="Eenmalig",as="Eenmalig \u2014 afgelopen",rs="Geen wekker actief",sr="Stoppen",os="Er is een melding over deze wekker, maar de tekst ontbreekt.";function ss(i){return!Array.isArray(i)||i.length===0?is:[...new Set(i)].sort((t,n)=>t-n).map(t=>ts[t-1]??"?").join(" ")}function ls(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function lr(i,e){return ls(i,e)?as:ss(i?.days)}function dr(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:os,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function cr(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return ns;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:rs}function pr(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var ds="0.9.0",cs="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",ps="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",hr="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",hs="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Pt=(i,e="icoon")=>g`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,nt=class extends I{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=ir(e),n=t.person!==this._config?.person;this._config=t,n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(ri)}static getStubConfig(){return ar($e)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?Z(e):null),q(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:X.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${$e}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${$e}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:X.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=or(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:X.entities})}catch(t){this._entiteiten=null,console.warn(`${$e}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:X.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:X.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:X.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:X.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?pr(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return _;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=rr(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?g`<div class="card surface">
    ...
    >
      ...
      <div class="kop ${e.length===0?"leeg":""}">
        <span class="volgende">${cr(this._toestand)}</span>
        <button
          class="icoonknop"
    ...
    `}_bevestiging(e){return g`<div class="onderrij bevestiging">
      <span class="boodschap">${qa(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=dr(e),a=!!e.enabled;return g`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?g`<div class="onderrij ${n.isFout?"fout":""}">
            ${Pt(n.isFout?hs:hr,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:_}
    `}};w(nt,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),w(nt,"styles",[Q,B`
  ...
  `]);var Ne=class Ne extends I{constructor(){super(...arguments);w(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?_:g`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};w(Ne,"properties",{hass:{attribute:!1},_config:{state:!0}}),w(Ne,"styles",[Q,B`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),w(Ne,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var li=Ne;N($e,nt);N(ri,li);N(Wa,Te);je({type:$e,name:Ba,description:`Wekkerkaart van DomotiApp (v${ds}).`,preview:!1,documentationURL:Ga});var us="0.9.0";vi(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${us} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{us as VERSION};
