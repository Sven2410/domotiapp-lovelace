var Ur=Object.defineProperty;var Wr=(i,e,t)=>e in i?Ur(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var w=(i,e,t)=>Wr(i,typeof e!="symbol"?e+"":e,t);var X=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function ne(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var se=i=>String(i??"").split(".")[0],b=(i,e)=>e&&i?.states?.[e]||null,I=(i,e)=>b(i,e)?.attributes??{},dt=(i,e,t)=>t?null:I(i,e).entity_picture||null;function Ai(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function D(i,e,t){return t||I(i,e).friendly_name||e||""}var Gr=new Set(["scene","script","input_button","button","event"]),Xt=i=>Gr.has(se(i));function W(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Xt(i.entity_id):!1}function He(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(se(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var qr=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),Mi=i=>qr.has(se(i));function Ti(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function lt(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var U=(i,e)=>lt(i,"hass-more-info",{entityId:e});function Ve(i){switch(se(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function Fr(i){switch(se(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function le(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":U(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=Fr(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),lt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":lt(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":lt(i,"ll-custom",n);break;default:break}}function C(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function q(i,e){if(!e)return"";let t=se(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function K(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Ei=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Ni=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Si=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),Yt=(i,e)=>Math.round((Si(e)-Si(i))/864e5);function Pe(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Jt(i,e=new Date){if(!i)return"";let t=Yt(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Ei[i.getDay()]:`${Ei[i.getDay()].slice(0,2)} ${i.getDate()} ${Ni[i.getMonth()]}`}var Oi=i=>i?`${i.getDate()} ${Ni[i.getMonth()]}`:"";function Zr(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function Xr(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function F(i,e=4){if(!i)return;let t=Xr(i);if(!t){e>0&&requestAnimationFrame(()=>F(i,e-1));return}let n=`${Zr(t)}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}function Se(i){let e=parseFloat(i?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function Y(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);F(i)});e.observe(i);for(let t of i.children)e.observe(t);return F(i),()=>e.disconnect()}var Yr="home-assistant";function Ci({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=Yr,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let m=i();if(!m)return!1;for(let[k,u]of e)try{m.get(k)||m.define(k,u)}catch(y){t(`kon ${k} niet registreren: ${y&&y.message}`)}return!0}function c(){let m=i();return!m||!m.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var Li=[];function M(i,e){Li.push([i,e])}function Ae({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function Di(i=()=>{}){Ci({leesRegistry:()=>globalThis.customElements,definities:Li,waarschuw:i})}var Jr=`
  :host {
    ${X}
    display: block;
...
`,L={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ct={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},ke=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),H=(i,e="accent")=>L[i]??(i&&/[#(]|^var/.test(i)?i:L[e]),T=Symbol("incomplete"),Qr=i=>`
  <div class="needs">
  ...
  </div>`,eo=56,Ri=8,Q=i=>Math.max(1,Math.ceil((i+Ri)/(eo+Ri))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[ne(Jr+he+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[T]||Ti(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[T]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[T];if(e.innerHTML=t?Qr(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(Y(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return Se(this.$(e))??t}};w(S,"css","");function A(i,e,{name:t,description:n,preview:a=!0}={}){M(i,e),Ae({type:i,name:t,description:n,preview:a})}function R(i,e){M(i,e)}var h=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,E={house:h(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,tn=null,Pi=i=>i.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${ue(n)} (${n})" aria-pressed="false">${E[n]??""}<span class="naam">${ue(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),nn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),tn=tn??[ne(ao)],this.shadowRoot.adoptedStyleSheets=tn,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,an=null,rn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),an=an??[ne(lo)],this.shadowRoot.adoptedStyleSheets=an,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in L)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${L[e]}"
      title="${ct[e]}" aria-label="${ct[e]}" aria-pressed="false">${E.check}</button>`}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${oo.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),a=()=>this.toggleAttribute("narrow",n.matches);a(),n.addEventListener("change",a),this.teardown_.push(()=>n.removeEventListener("change",a))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=ho(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${uo[e.getDay()]} ${e.getDate()} ${mo[e.getMonth()]}`);let a=this.$(".clock");a&&this.text(a,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=b(this.hass,e.weather),n=I(this.hass,e.weather),a=this.$(".now");if(a&&t){let l=Ie(t.state);a.style.setProperty("--wtone",H(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${K(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=a.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=v(l,"cloud")),this.text(a.querySelector(".cond"),q(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=go.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${H(ln[l.key].tone)}" title="${ln[l.key].label}">
             ${E[ln[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let a=this.hass?.config?.unit_system?.wind_speed??"km/h",r=fo(t.wind_bearing);return{key:e,value:`${K(this.hass,t.wind_speed,0)} ${a}${r?` ${r}`:""}`}}case"uv":{let r=I(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(b(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${K(this.hass,r,1)}`}:null}case"precipitation":{let a=b(this.hass,n.precipitation_entity);if(a){let r=Number(a.state);if(Number.isNaN(r))return null;let o=a.attributes.unit_of_measurement??"mm";return{key:e,value:`${K(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${K(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${K(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=b(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};w(ht,"css",`
  ...
  `);var dn=class extends O{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[on({name:"weather",selector:_.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),on({name:"sun",selector:_.entity("sun")},{name:"precipitation_entity",selector:_.entity("sensor")}),{name:"name",selector:_.text()},{name:"hide_below",selector:_.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};R("domotiapp-header-card-editor",dn);A("domotiapp-header-card",ht,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var ut=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      <div class="sep" style="--tone:${H(e.tone)}">
      ...
      </div>`}paint(){this.text("h3",this.config.name??"");let e=this.$(".sub");if(!e)return;let t=b(this.hass,this.config.secondary_entity),n=e.querySelector(".si"),a=e.querySelector(".sv");if(!t){a.textContent="",n.innerHTML="";return}let r=this.config.secondary_icon??"";n.dataset.icon!==r&&(n.dataset.icon=r,n.innerHTML=r?v(r):"");let o=t.attributes.unit_of_measurement;a.textContent=o?`${t.state} ${o}`:t.attributes.current_temperature!=null?`${t.attributes.current_temperature} \xB0C`:q(this.hass,t)}getCardSize(){return 1}getGridOptions(){return{columns:"full",rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-separator-card-editor")}static getStubConfig(){return{name:"Nieuwe sectie",icon:"house",tone:"accent"}}};w(ut,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var cn=class extends O{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:sn.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:_.text()},{name:"line",selector:_.bool()},{name:"secondary_entity",selector:_.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};R("domotiapp-separator-card-editor",cn);A("domotiapp-separator-card",ut,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var pn=(i,e,t)=>Math.min(t,Math.max(e,i));function me(i,e){let t=e.min??0,n=e.max??100,a=e.step??1,r=!1,o=u=>{let y=i.getBoundingClientRect();if(!y.width)return t;let g=pn((u-y.left)/y.width,0,1),$=t+g*(n-t);return pn(Math.round($/a)*a,t,n)},s=u=>{try{i.setPointerCapture?.(u)}catch{}},l=u=>{try{i.hasPointerCapture?.(u)&&i.releasePointerCapture(u)}catch{}},d=u=>{e.disabled?.()||u.button!=null&&u.button!==0||(r=!0,s(u.pointerId),i.classList.add("dragging"),e.onInput(o(u.clientX)),u.preventDefault())},c=u=>{r&&(e.onInput(o(u.clientX)),u.preventDefault())},p=u=>{r&&(r=!1,l(u.pointerId),i.classList.remove("dragging"),e.onCommit(o(u.clientX)))},m=u=>{r&&(r=!1,l(u?.pointerId),i.classList.remove("dragging"),e.onInput(e.value()))},k=u=>{if(e.disabled?.())return;let y=(n-t)/10,g={ArrowLeft:-a,ArrowDown:-a,ArrowRight:a,ArrowUp:a,PageDown:-y,PageUp:y,Home:-1/0,End:1/0};if(!(u.key in g))return;u.preventDefault();let $=e.value(),j=pn(g[u.key]===-1/0?t:g[u.key]===1/0?n:$+g[u.key],t,n);e.onInput(j),e.onCommit(j)};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",m),i.addEventListener("keydown",k),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",m),i.removeEventListener("keydown",k)}}var ie=(i="")=>`
...
`;var bo=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),vo=new Set(["hs","rgb","rgbw","rgbww","xy"]),un=i=>i?.attributes?.supported_color_modes??[],ko=i=>un(i).some(e=>bo.has(e)),mt=i=>un(i).some(e=>vo.has(e)),gt=i=>un(i).includes("color_temp"),Ii=i=>Math.max(1,Math.round((i??0)/255*100)),ft=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[T]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var hn=class extends O{defaults(){return{show_colour:!0}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"bulb"}]}schema(){return[{name:"entity",selector:_.entity("light")},{name:"name",selector:_.text()},{name:"show_colour",selector:_.bool()}]}label(e){return{entity:"Lamp",name:"Naam (overschrijft die van de lamp)",show_colour:"Kleurstrips tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"E\xE9n lamp per kaart. Dimbaar krijgt een schuif, alleen schakelbaar een tuimelaar.";if(e.name==="show_colour")return"Kleur en kleurtemperatuur verschijnen zodra de lamp aan is. De kaart is dan twee rijen hoog."}};R("domotiapp-light-card-editor",hn);A("domotiapp-light-card",ft,{name:"DomotiApp Verlichting",description:"E\xE9n lamp op \xE9\xE9n rasterrij: dimmen, kleur en kleurtemperatuur."});function Ki(i){if(!i)return null;let e=Number(i.state);return Number.isFinite(e)?e:null}function _o(i){let e=i?.attributes?.hvac_action;return e||(i?.state==="off"?"off":i?.state==="cool"?"cooling":i?.state==="heat"?"idle":null)}var mn={heating:"var(--dac-solar)",cooling:"var(--dac-grid-in)",drying:"var(--dac-grid-in)",fan:"var(--dac-grid-in)"},Bi={heating:"Verwarmt",cooling:"Koelt",drying:"Ontvochtigt",fan:"Ventileert",idle:"Uit",off:"Uit"},bt=class extends S{validate(e){return e.entity||e.temperature||e.humidity?{...e}:{...e,[T]:"Kies een thermostaat, of een temperatuursensor."}}watched(){let e=this.config;return[e.entity,e.temperature,e.humidity].filter(Boolean)}step_(){let e=I(this.hass,this.config.entity);return Number(this.config.step??e.target_temp_step)||.5}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.entity||this.setAttribute("readout",""),`
      <div class="card surface">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(C(this.$(".chip"),{onTap:()=>U(this,e.entity||e.temperature||e.humidity)}));let t=this.$(".set");t&&t.querySelectorAll("button").forEach(n=>this.on(n,"click",()=>this.nudge_(Number(n.dataset.d))))}nudge_(e){let t=this.config,n=I(this.hass,t.entity),a=this.step_(),r=Number(n.min_temp??5),o=Number(n.max_temp??35),s=this.pending_??Number(n.temperature);if(!Number.isFinite(s))return;let l=Math.min(o,Math.max(r,Math.round((s+e*a)/a)*a));this.pending_=l,this.paintTarget_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null,this.hass.callService("climate","set_temperature",{entity_id:t.entity,temperature:this.pending_}),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450)}paintTarget_(){let e=this.$(".target");if(!e)return;let t=I(this.hass,this.config.entity),n=this.pending_??Number(t.temperature);e.classList.toggle("pending",this.pending_!=null),e.textContent=Number.isFinite(n)?`${K(this.hass,n,n%1?1:0)}\xB0`:"--"}paint(){let e=this.config,t=e.entity?b(this.hass,e.entity):null,n=e.entity?W(t):!1;this.toggleAttribute("dead",n);let a=_o(t),r=e.tone?H(e.tone):mn[a]??"var(--dac-ink-3)";this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("busy",!!mn[a]);let o=this.$(".chip"),s=e.icon||"thermo";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=v(s,"thermo")),o.style.setProperty("--tone",mn[a]?r:"var(--dac-ink-3)"),this.text(".nm",D(this.hass,e.entity||e.temperature||e.humidity,e.name));let l=e.temperature?Ki(b(this.hass,e.temperature)):Number(I(this.hass,e.entity).current_temperature),d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.text(".temp",Number.isFinite(l)?`${K(this.hass,l,1)} ${d}`:"--");let c=e.humidity?Ki(b(this.hass,e.humidity)):null,p=this.$(".hum");p.innerHTML=c==null?"":`${E.drop}${K(this.hass,c,0)}%`,this.text(".sep",c==null?"":"\xB7"),e.entity&&!e.humidity&&Bi[a]&&a!=="idle"&&(this.text(".sep","\xB7"),p.textContent=Bi[a]),this.paintTarget_();let m=this.$(".set");if(m){let k=I(this.hass,e.entity),u=this.pending_??Number(k.temperature);m.querySelector('[data-d="-1"]').disabled=n||u<=Number(k.min_temp??5),m.querySelector('[data-d="1"]').disabled=n||u>=Number(k.max_temp??35)}}getCardSize(){return 1}getGridOptions(){return{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-climate-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("climate."));return n?{entity:n}:{}}};w(bt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var gn=class extends O{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:_.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:_.text()},{name:"step",selector:_.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};R("domotiapp-climate-card-editor",gn);A("domotiapp-climate-card",bt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var Ui=({label:i="Aan of uit",cls:e=""}={})=>`<button class="toggle ${e}" type="button" role="switch" aria-checked="false" aria-label="${i}"><span class="knob"></span></button>`;function fn(i,e){if(!i)return;let t=String(!!e);i.getAttribute("aria-checked")!==t&&i.setAttribute("aria-checked",t)}function Wi(i,e){let t=i.querySelector(".knob"),n=!1,a=0,r=!1,o=!1,s=()=>{n=!1,i.classList.remove("dragging"),t?.style.removeProperty("--knob")},l=u=>{u!==e.value()&&(fn(i,u),e.set(u))},d=u=>{if(!e.disabled?.()&&!(u.button!=null&&u.button!==0)){u.stopPropagation(),n=!0,r=!1,o=!1,a=u.clientX,i.classList.add("dragging");try{i.setPointerCapture?.(u.pointerId)}catch{}}},c=u=>{if(!n)return;let y=u.clientX-a;Math.abs(y)>3&&(r=!0);let g=e.value()?22:0,$=Math.min(22,Math.max(0,g+y));t?.style.setProperty("--knob",`${$}px`)},p=u=>{if(!n)return;u.stopPropagation();let y=u.clientX-a,g=e.value()?22:0,$=Math.min(22,Math.max(0,g+y));s();try{i.hasPointerCapture?.(u.pointerId)&&i.releasePointerCapture(u.pointerId)}catch{}o=!0,l(r?$>22/2:!e.value())},m=()=>{n&&s()},k=u=>{if(u.stopPropagation(),u.preventDefault(),o){o=!1;return}e.disabled?.()||l(!e.value())};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",m),i.addEventListener("click",k),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",m),i.removeEventListener("click",k)}}var Gi=`
  .toggle {
...
`;var vt=i=>String(i??"").split(".")[0],qi=new Set(["input_datetime","time","date","datetime"]),Fi=i=>qi.has(vt(i)),ae=i=>String(i).padStart(2,"0");function xo(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function bn(i){if(!i)return null;let e=vt(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:xo(i.state)}var wo=i=>`${i.getFullYear()}-${ae(i.getMonth()+1)}-${ae(i.getDate())}T${ae(i.getHours())}:${ae(i.getMinutes())}`;function yo(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${ae(Math.floor(n/60))}:${ae(n%60)}`}function Zi(i,e=bn(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${ae(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(vt(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":wo(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${ae(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Xi(i,e,t){let n=vt(i),a=String(t??"");if(!a||!qi.has(n)||!e)return null;if(e==="time"){let m=a.match(/^(\d{1,2}):(\d{2})/);if(!m)return null;let k=`${ae(m[1])}:${m[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:k}]:["input_datetime","set_datetime",{entity_id:i,time:k}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${ae(d)}:${c}:00`;if(n==="datetime"){let m=yo(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${m}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var Yi=i=>String(i??"").split(".")[0],Ji=new Set(["input_select","select"]),vn=i=>Ji.has(Yi(i));function kt(i){if(!i||!vn(i.entity_id))return[];let e=i.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function Qi(i,e=kt(i)){let t=String(i?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function ea(i,e,t=[]){let n=Yi(i),a=String(e??"");return!a||!Ji.has(n)||t.length&&!t.includes(a)?null:[n,"select_option",{entity_id:i,option:a}]}var _t={row:44,tile:96,compact:44},Me=6,ta=12,kn=22,$o=["row","tile","compact"],jo=["card","items","none"],xt=i=>typeof i?.name=="string"?i.name.trim():"",Ke=i=>typeof i=="string"?{entity:i}:{...i},Be=i=>Math.min(Math.max(1,Number(i)||2),3),Te=i=>$o.includes(i)?i:"row",ee=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function na(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(t=>({columns:Be(t.columns),layout:Te(t.layout),items:(t.items??t.entities??[]).map(Ke)}));let e=(i?.items??i?.entities??[]).map(Ke);return e.length?[{columns:Be(i.columns),layout:Te(i.layout),items:e}]:[]}function wt(i){return jo.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var zo=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns));function _n(i){let e=i?.rows??[],t=xt(i)?kn+Me:0;if(!e.length)return ta+t+_t.row;let n=(wt(i)==="card"?ta:0)+t;for(let a of e){let r=zo(a);n+=r*_t[Te(a.layout)]+(r-1)*Me}return n+(e.length-1)*Me}var aa=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],Eo=i=>aa.find(e=>e.waarde===i)?.label??"Rij";function yt(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();ee(e)&&i.bewaard.push(e)}return i}function So(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Be(n.columns),layout:Te(n.layout),items:(n.items??n.entities??[]).map(Ke)})):(()=>{let n=(i.items??i.entities??[]).map(Ke);return n.length?[{columns:Be(i.columns),layout:Te(i.layout),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]);for(let r of a)t.push(yt({columns:n.columns,layout:n.layout,items:r}))}return t}var ia=i=>i.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(ee).map(t=>structuredClone(t))})).filter(e=>e.items.length),Ao=`
...
`,xn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=So(e);this.gebouwd_&&JSON.stringify(ia(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(r>e?`r${r-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{ee(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Ao;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=yt({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(g=>({waarde:g,label:String(g),titel:`${g} entiteit${g>1?"en":""} in deze rij`})),()=>e.columns,g=>{e.columns=g,yt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c);let p=document.createElement("div");p.className="rijbody";let m=this.segment_(aa.map(g=>({waarde:g.waarde,label:g.label})),()=>e.layout,g=>{e.layout=g,this.emit_()}),k=document.createElement("div");k.className="vormrij";let u=document.createElement("b");u.textContent="Vorm van deze rij",k.append(u,m.wrap),p.appendChild(k);let y=()=>{let g=e.items.filter(ee),$=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&$.push(Eo(e.layout)),$.push(g.length?g.map(j=>this.itemNaam_(j)).join(", "):"nog leeg"),l.textContent=$.join(" \xB7 "),d.vernieuw(),m.vernieuw()};return this.koppen_.push(y),e.items.forEach((g,$)=>p.appendChild(this.itemBlok_(e,g,t,$))),n.append(a,p),y(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),yt(e),this.emit_(),this.build_()}),o.append(s,l,d,m);let k=document.createElement("div");k.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",u.addEventListener("value-changed",z=>{z.stopPropagation(),t.entity=z.detail.value.entity??"",this.emit_()});let y=document.createElement("dac-icon-picker");y.label="Icoon",y.hass=this.hass_,y.addEventListener("value-changed",z=>{z.stopPropagation(),z.detail.value?t.icon=z.detail.value:delete t.icon,this.emit_()});let g=document.createElement("dac-tone-picker");g.label="Kleur",g.hass=this.hass_,g.addEventListener("value-changed",z=>{z.stopPropagation(),z.detail.value?t.tone=z.detail.value:delete t.tone,this.emit_()});let $=document.createElement("ha-form");$.hass=this.hass_,$.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],$.computeLabel=z=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[z.name]??z.name,$.computeHelper=z=>{if(z.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(z.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(z.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(z.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},$.addEventListener("value-changed",z=>{z.stopPropagation();let Z=z.detail.value;Z.name?t.name=Z.name:delete t.name,Z.toggle===!0?t.toggle=!0:delete t.toggle;for(let pe of["show_icon","show_name","show_state"])Z[pe]===!1?t[pe]=!1:delete t[pe];for(let pe of["icon_tap_action","icon_hold_action","tap_action","hold_action"])Z[pe]?t[pe]=Z[pe]:delete t[pe];Z.double_tap_action&&Z.double_tap_action.action!=="none"?t.double_tap_action=Z.double_tap_action:delete t.double_tap_action,this.emit_()});let j=()=>{c.textContent=ee(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ee(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ee(t)),m.hidden=!ee(t)};return this.koppen_.push(j),u.data={entity:t.entity||void 0},y.value=t.icon??"",g.value=t.tone??"",$.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},k.append(u,y,g,$),r.append(o,k),j(),r}emit_(){let e=ia(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-entities-card-editor",xn);var $t=class extends S{validate(e){let t=na(e);return t.some(n=>n.items.some(ee))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?H(e.tone):this.config.tone?H(this.config.tone):se(e.entity)!=="light"?L.accent:Ai(b(this.hass,e.entity))??L.lit}metSchakelaar_(e){return!!e.toggle&&Mi(e.entity)}metTijd_(e){return!Fi(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!vn(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",wt(e)),this.style.containerType="inline-size";let t=wt(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((p,m)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(p)?Ui({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}"
           style="--cols:${o.columns};--it-h:${_t[o.layout]}px">${c}</div>`}).join("");return`<div class="card surface">${xt(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>le(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(C(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(C(r,{onTap:()=>n("icon_tap_action",Ve(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let m=p.target?.closest?.(".tijd");if(m&&(p.stopPropagation(),p.type==="click"))try{m.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let m=p.target?.closest?.(".tijd");m&&(p.stopPropagation(),l=Xi(t.entity,m.type,m.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=b(this.hass,t.entity),p=ea(t.entity,d.value,kt(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(Wi(o,{value:()=>He(b(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>W(b(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,xt(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let a=b(this.hass,n.entity),r=He(a),o=!!n.entity&&W(a);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=D(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let j=dt(this.hass,n.entity,n.icon),z=n.icon||(j?`pic:${j}`:Qt(n.entity,I(this.hass,n.entity)));d.dataset.icon!==z&&(d.dataset.icon=z,d.classList.toggle("pic",!!j),d.innerHTML=j?`<img src="${j}" alt="" loading="lazy" />`:v(n.icon||Qt(n.entity,I(this.hass,n.entity)))),d.style.setProperty("--tone",j?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(fn(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let m=t.querySelector(".tijdslot"),k=null;if(m){let j=o?null:bn(a);m.dataset.soort!==(j??"")&&(m.dataset.soort=j??"",m.innerHTML=j?`<input class="tijd" type="${j}" step="60" />`:""),k=m.querySelector(".tijd")}if(k&&(k.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==k)){let j=Zi(a,m.dataset.soort);k.value!==j&&(k.value=j)}let u=t.querySelector(".keuzeslot"),y=null;if(u){let j=o?[]:kt(a),z=JSON.stringify(j);u.dataset.opties!==z&&(u.dataset.opties=z,u.innerHTML=j.length?`<select class="keuze">${j.map(Z=>`<option value="${ke(Z)}">${ke(Z)}</option>`).join("")}</select>`:""),y=u.querySelector(".keuze")}if(y&&(y.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==y)){let j=Qi(a);y.value!==j&&(y.value=j)}let g=t.querySelector(".st"),$=n.show_state??this.config.show_state;if(p||k||y)g.textContent="";else if($===!1)g.textContent="";else if(o)g.textContent="Niet bereikbaar";else if(!a||Xt(a.entity_id))g.textContent="";else if(se(a.entity_id)==="light"&&r&&a.attributes.brightness!=null)g.textContent=`${Math.round(a.attributes.brightness/255*100)}%`;else{let j=a.attributes.unit_of_measurement;g.textContent=j?`${a.state} ${j}`:q(this.hass,a)}t.setAttribute("aria-label",`${l}${a?`, ${q(this.hass,a)}`:""}`)})}getCardSize(){return Q(_n(this.config))}getGridOptions(){let e=Q(_n(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};w($t,"css",`
    :host { display: block; height: 100%; }

    .card {
      height: 100%; min-height: 56px; padding: 5px 10px;
      display: flex; flex-direction: column; justify-content: center; gap: ${Me}px;
    }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${kn}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }

    .row {
      display: grid; gap: ${Me}px;
  ...
  `);A("domotiapp-entities-card",$t,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var V={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},P=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),wn=i=>!i||i.state==="off",yn=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),$n=i=>i?.state==="playing",ra=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function oa(i){if(!i)return[];let e=[];return(P(i,V.TURN_ON)||P(i,V.TURN_OFF))&&e.push("power"),wn(i)||(P(i,V.PREVIOUS_TRACK)&&e.push("prev"),P(i,V.PLAY)||P(i,V.PAUSE)||P(i,V.PLAY_MEDIA)?e.push("play"):P(i,V.STOP)&&e.push("stop"),P(i,V.NEXT_TRACK)&&e.push("next")),e}var _e=i=>i?.volume_entity||i?.entity;function jn(i){if(!yn(i))return[];let e=[];return P(i,V.VOLUME_MUTE)&&e.push("mute"),P(i,V.VOLUME_SET)?e.push("slider"):P(i,V.VOLUME_STEP)&&e.push("steps"),e}var fe=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Ue=i=>!!i?.attributes?.is_volume_muted,sa=i=>!!i?.attributes?.mass_player_type,zn=i=>!!i?.attributes?.shuffle,En=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},la=i=>({off:"all",all:"one",one:"off"})[Mo(i)]??"all",Mo=i=>["off","all","one"].includes(i)?i:"off";function Sn(i,{zoeken:e=!0}={}){if(!yn(i))return[];let t=[];return P(i,V.SHUFFLE_SET)&&t.push("shuffle"),P(i,V.REPEAT_SET)&&t.push("repeat"),e&&sa(i)&&t.push("search"),t}function da(i,{tonen:e=!0}={}){if(!e||!yn(i)||!P(i,V.SELECT_SOURCE)||sa(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function ca(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function An(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Mn="dacScrollSlot",pa=["position","top","left","right","width","overflow"];function ha(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[Mn])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(pa.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Mn]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of pa)t.style[o]=a[o];t.dataset&&delete t.dataset[Mn],e?.scrollTo?.(0,n)}}}var ua=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var be=i=>`domotiapp_lovelace/media/${i}`;function To(i,e){if(!i)return null;if(e)return i.uri?{type:be("favorite"),favorite:!0,uri:i.uri}:null;let t=ma(i);return!t||!i.library_item_id?null:{type:be("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function ma(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var ga={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Tn=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function fa(i,e,t=null){return i?.kind??ma(e)??t??"playlists"}var Nn=i=>!!i?.uri,jt=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:be("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),ba=(i,e,t)=>{let n=To(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},va=(i,e)=>i.callWS({type:be("playlist/create"),name:e}).then(t=>t?.playlist??null),ka=(i,e)=>i.callWS({type:be("playlist/remove"),library_item_id:String(e.library_item_id)}),_a=(i,e)=>i.callWS({type:be("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),xa=(i,e,t)=>i.callWS({type:be("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),wa=(i,e,t)=>i.callWS({type:be("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var No=350,Oo={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Co(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Oo[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Lo=`
  :host {
    ${X}
...
`,On=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=ne(he+Lo)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=ha(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Tn.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
        ...
        <div class="menu" hidden></div>
          ...
          <div class="rij" data-i="${a}" data-knoppen="${d}">
            ...
            <div class="spreker" data-speaker="${o.entity_id}" data-zelf="${s}" data-mee="${l}">
              ...
              ${l&&d?`${ie()}<span class="pct tnum"></span>`:l?'<span class="stil">geen volumeregeling</span>':""}
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let l=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let d=me(s,{value:()=>fe(b(this.hass,l)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:l})});this.schuiven_.set(l,d)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,l=o.querySelector(".slider");if(!l||l.classList.contains("dragging"))continue;let d=b(this.hass,s),c=fe(d);this.zetSchuif_(l,c,Ue(d))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let a=e.parentElement.querySelector(".pct");a&&(a.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=fe(b(this.hass,this.entity_)),a=b(this.hass,e);P(a,V.VOLUME_SET)&&fe(a)!==n&&this.hass.callService("media_player","volume_set",{volume_level:n/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};M("domotiapp-media-browser",On);function ya(i,e,t,n={}){let a=document.querySelector("domotiapp-media-browser");return a||(a=document.createElement("domotiapp-media-browser"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var Do=`
  :host {
    ${X}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Cn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ne(Do+he)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
      ...
      </div>`}wire(){let e=this.config,t=(o,s)=>le(this,this.hass,e,e[o]??s);this.teardown_.push(Y(this.$(".card"))),this.teardown_.push(C(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(C(n,{onTap:()=>t("icon_tap_action",Ve(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",o=>o.stopPropagation()),this.on(n,"pointerdown",o=>o.stopPropagation());let a=this.$(".hoesgroot");a&&(this.teardown_.push(C(a,{onTap:()=>t("icon_tap_action",Ve(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(a,"click",o=>o.stopPropagation()),this.on(a,"pointerdown",o=>o.stopPropagation()));let r=o=>{let s=o.target.closest?.("[data-k]");s&&(o.stopPropagation(),this.doe_(s.dataset.k))};this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".vol"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".extra"),"pointerdown",o=>o.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=b(this.hass,t),a=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return a(wn(n)?"turn_on":"turn_off");case"bron":return $a(this.hass,t,D(this.hass,t,this.config.name));case"prev":return a("media_previous_track");case"next":return a("media_next_track");case"play":return a($n(n)?"media_pause":"media_play");case"stop":return a("media_stop");case"mute":{let r=_e(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Ue(b(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:_e(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!zn(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:la(En(n))},{entity_id:t});case"search":return ya(this.hass,t,D(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.config.speakers});default:return}}paint(){let e=this.config,t=b(this.hass,e.entity),n=!t||t.state==="unavailable",a=ra(t),r=this.$(".top");r.dataset.on=String(a),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:dt(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||An(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(l,"speaker")),o.style.setProperty("--tone",a&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(e.icon||An(t),"speaker"));let c=D(this.hass,e.entity,e.name),p=ca(t,m=>q(this.hass,m));this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),F(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),a=this.config.show_controls===!1||t?[]:oa(e),r=a.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${zt[s].label}">${v(zt[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=$n(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=v(s))}}paintVolume_(e,t){let n=this.$(".vol"),a=_e(this.config),r=a===this.config.entity?e:b(this.hass,a),o=this.config.show_volume===!1||t?[]:jn(r),s=t?null:da(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=[...o,s?"bron":""].join(",");n.dataset.sig!==l&&(n.dataset.sig=l,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${v("volume")}</button>`:"")+(o.includes("slider")?ie("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${v("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${v("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${v("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let d=n.querySelector(".bronknop");if(d){let u=s.nu||"Bron";this.text(d.querySelector("b"),u),d.setAttribute("aria-label",`Bron kiezen, nu ${u}`),d.title=`Kies uit ${s.aantal} bronnen`}let c=Ue(r),p=fe(r),m=n.querySelector('[data-k="mute"]');if(m){let u=c?"volumeMute":"volume";m.dataset.icon!==u&&(m.dataset.icon=u,m.innerHTML=v(u)),m.setAttribute("aria-pressed",String(c))}let k=n.querySelector(".slider");k&&(this.attach_(k,"volume",{value:()=>fe(b(this.hass,_e(this.config))),onInput:u=>this.setSlider_(k,u),onCommit:u=>this.hass.callService("media_player","volume_set",{volume_level:u/100},{entity_id:_e(this.config)}),disabled:()=>W(b(this.hass,_e(this.config)))}),k.classList.contains("dragging")||this.setSlider_(k,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),a=t||this.config.show_controls===!1?[]:Sn(e,{zoeken:this.config.show_search!==!1});n.hidden=!a.length;let r=a.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map((d,c)=>`${d==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${d}" aria-label="${zt[d].label}">${v(zt[d].icon)}</button>`).join("")),!a.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(zn(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let d=En(e),c=d==="one"?"repeatOne":"repeat";s.dataset.icon!==c&&(s.dataset.icon=c,s.innerHTML=v(c)),s.setAttribute("aria-pressed",String(d!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[d])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let a=me(e,n);this.sliders_.set(t,a),this.teardown_.push(a)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=b(this.hass,this.config?.entity);return 1+(jn(e).length?1:0)+(Sn(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("media_player."));return n?{entity:n}:{}}};w(Et,"css",`
    :host { display: block; }
  ...
  `);var Vn=class extends O{defaults(){return{show_current:!0,forecast_type:"daily",days:Ea}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:_.entity("weather")},{name:"name",selector:_.text()},{name:"forecast_type",selector:_.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:_.number(1,Sa)},{name:"show_current",selector:_.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};R("domotiapp-forecast-card-editor",Vn);A("domotiapp-forecast-card",At,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var Ge={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},qe=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Io=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},Mt=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      <div class="cv" data-i="${a}" data-shown="closed" style="--tone:${H(n.tone??e.tone,"solar")}">
        <button class="chip" type="button" aria-label="Meer info"></button>
        <div class="txt"><div class="nm"></div><div class="st"></div></div>
        ${this.keysHtml(e.show_stop!==!1)}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(C(e.querySelector(".chip"),{onTap:()=>U(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=b(this.hass,n.entity),r=I(this.hass,n.entity),o=!a||a.state==="unavailable",s=a?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=D(this.hass,n.entity,n.name);let l=qe(a,Ge.SET_POSITION)&&r.current_position!=null,d=l?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=Io(r),p=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],m=e.querySelector(".chip");m.dataset.icon!==p&&(m.dataset.icon=p,m.innerHTML=v(p,c[d]));let k=e.querySelector(".st");this.dragging_.has(t)||(k.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":l?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(g=>{if(g.dataset.act==="stop"){g.disabled=o||!qe(a,Ge.STOP);return}let $=g.dataset.act==="open";g.disabled=o||($?!qe(a,Ge.OPEN):!qe(a,Ge.CLOSE))});let u=e.querySelector(".pos"),y=l&&this.config.show_position!==!1;if(u.hidden=!y,y){if(u.dataset.built||(u.dataset.built="1",u.innerHTML=ie("position"),u.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let $=u.querySelector(".slider"),j=z=>{$.style.setProperty("--v",`${z}%`),$.setAttribute("aria-valuenow",String(z)),e.querySelector(".st").textContent=`${z}% open`};this.teardown_.push(me($,{value:()=>I(this.hass,n.entity).current_position??0,onInput:j,onCommit:z=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:z})}))}let g=u.querySelector(".slider");if(!g.classList.contains("dragging")){let $=r.current_position??0;g.style.setProperty("--v",`${$}%`),g.setAttribute("aria-valuenow",String($))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>qe(b(this.hass,n.entity),Ge.SET_POSITION));return Q(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};w(Mt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Pn=class extends O{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:_.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};R("domotiapp-cover-card-editor",Pn);A("domotiapp-cover-card",Mt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Ko(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var Tt=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(C(e,{onTap:()=>U(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=b(this.hass,t.entity),a=Ko(n);e.style.setProperty("--tone",a.home===!0?"var(--dac-good)":a.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=D(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,l=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():E.person),e.setAttribute("aria-label",`${r}, ${a.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return Q(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};w(Tt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Kn=class extends O{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Aa(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};R("domotiapp-waste-card-editor",Kn);A("domotiapp-waste-card",Nt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function xe(i){if(i==null||i==="")return 4;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Bn(i){if(typeof i=="string")return{name:"",icon:"",path:i};let e=i??{};return{name:typeof e.name=="string"?e.name:"",icon:typeof e.icon=="string"?e.icon:"",path:typeof e.path=="string"?e.path:typeof e.url=="string"?e.url:typeof e.navigation_path=="string"?e.navigation_path:""}}var Fe=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.path?.trim()));function Ma(i){return(Array.isArray(i?.items)?i.items:[]).slice(0,20).map(Bn)}function Ot(i,e=4){let t=(i??[]).filter(Fe),n=xe(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let a=Math.max(1,n-1);return{balk:t.slice(0,a),meer:t.slice(a),heeftMeer:!0}}function Ta(i){let e=String(i??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var Go=`
...
`,Na=i=>i.filter(Fe).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.path?{path:e.path}:{}})),Un=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(Bn);this.gebouwd_&&JSON.stringify(Na(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Go;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_()),t.appendChild(this.kleurKiezer_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:a}=Ot(this.items_,this.rest_.max),r=a.length,o=this.items_.filter(Fe);if(this.items_.forEach((l,d)=>{if(o.indexOf(l)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(l,d))}),!this.items_.length){let l=document.createElement("p");l.className="uitleg",l.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(l)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${xe(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:xe(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=xe(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}kleurKiezer_(){let e=document.createElement("dac-tone-picker");return e.label="Kleur",e.hass=this.hass_,e.value=this.rest_.tone??"accent",e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value;n&&n!=="accent"?this.rest_.tone=n:delete this.rest_.tone,this.emit_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{let g=!Fe(e);n.dataset.leeg=String(g),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||(g?"Nieuwe knop":e.path||"Zonder naam"),l.textContent=e.path?e.path:e.icon?`${ue(e.icon)} -- nog geen pad`:"Nog geen pad"};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let m=this.kopKnop_("Verwijderen",E.close,()=>this.verwijder_(t));m.classList.add("weg"),a.append(r,o,c,p,m),n.appendChild(a);let k=document.createElement("div");k.className="body";let u=document.createElement("dac-icon-picker");u.label="Icoon",u.fallback="grid",u.auto=!1,u.hass=this.hass_,u.value=e.icon,u.addEventListener("value-changed",g=>{g.stopPropagation(),e.icon=g.detail.value??"",this.emit_()});let y=document.createElement("ha-form");return y.hass=this.hass_,y.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],y.computeLabel=g=>({name:"Naam",path:"Waar gaat hij heen"})[g.name]??g.name,y.computeHelper=g=>g.name==="path"?"/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.":void 0,y.data={name:e.name,path:e.path},y.addEventListener("value-changed",g=>{g.stopPropagation();let $=g.detail.value??{};e.name=$.name??"",e.path=$.path??"",this.emit_()}),k.append(u,y),n.appendChild(k),n}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Number(n.slice(1));a!==e&&t.add(`i${a>e?a-1:a}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=this.open_.has(`i${e}`),a=this.open_.has(`i${t}`);this.open_.delete(`i${e}`),this.open_.delete(`i${t}`),a&&this.open_.add(`i${e}`),n&&this.open_.add(`i${t}`)}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Na(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-navbar-card-editor",Un);var Oa=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*qn(i){let e=Oa(i),t=0;for(;e&&t++<40;)yield e,e=Oa(e)}function qo(i){for(let e of qn(i)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Fo(i){for(let e of qn(i))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Ca(i){for(let e of qn(i)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Ct=class extends S{validate(e){let t=Ma(e),n={labels:!0,tone:"accent",...e,items:t,max:xe(e?.max)};return t.filter(a=>a.name||a.icon||a.path).length||(n[T]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:a}=Ot(e.items,e.max),r=(l,d)=>`
      <button type="button" class="knop" data-i="${d}" title="${ke(l.name)}">
        <span class="ico">${v(l.icon,"grid")}</span>
        <span class="naam">${ke(l.name)}</span>
      </button>`,o=(l,d)=>`
      <button type="button" class="regel" data-i="${d}">
        <span class="mi">${v(l.icon,"grid")}</span>
        <span class="mt">${ke(l.name||l.path)}</span>
      </button>`,s=e.items.filter(l=>l.name||l.icon||l.path);return`
      <div class="balk" style="--tone:${H(e.tone)}">
        ${t.map(l=>r(l,s.indexOf(l))).join("")}
        ${a?`<button type="button" class="knop meer" aria-expanded="false" aria-haspopup="true">
  ...
  `);A("domotiapp-navbar-card",Ct,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var Lt=globalThis,Dt=Lt.ShadowRoot&&(Lt.ShadyCSS===void 0||Lt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fn=Symbol(),La=new WeakMap,Ze=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Fn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Dt&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=La.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&La.set(t,e))}return e}toString(){return this.cssText}},de=i=>new Ze(typeof i=="string"?i:i+"",void 0,Fn),G=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new Ze(t,i,Fn)},Da=(i,e)=>{if(Dt)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=Lt.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},Zn=Dt?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return de(t)})(i):i;var{is:Zo,defineProperty:Xo,getOwnPropertyDescriptor:Yo,getOwnPropertyNames:Jo,getOwnPropertySymbols:Qo,getPrototypeOf:es}=Object,Rt=globalThis,Ra=Rt.trustedTypes,ts=Ra?Ra.emptyScript:"",ns=Rt.reactiveElementPolyfillSupport,Xe=(i,e)=>i,Xn={toAttribute(i,e){switch(e){case Boolean:i=i?ts:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Va=(i,e)=>!Zo(i,e),Ha={attribute:!0,type:String,converter:Xn,reflect:!1,useDefault:!1,hasChanged:Va};Symbol.metadata??=Symbol("metadata"),Rt.litPropertyMetadata??=new WeakMap;var ce=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ha){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&Xo(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=Yo(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ha}static _$Ei(){if(this.hasOwnProperty(Xe("elementProperties")))return;let e=es(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Xe("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Xe("properties"))){let t=this.properties,n=[...Jo(t),...Qo(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(Zn(a))}else e!==void 0&&t.push(Zn(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Da(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Xn).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Xn;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Va)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ce.elementStyles=[],ce.shadowRootOptions={mode:"open"},ce[Xe("elementProperties")]=new Map,ce[Xe("finalized")]=new Map,ns?.({ReactiveElement:ce}),(Rt.reactiveElementVersions??=[]).push("2.1.2");var ii=globalThis,Pa=i=>i,Ht=ii.trustedTypes,Ia=Ht?Ht.createPolicy("lit-html",{createHTML:i=>i}):void 0,qa="$lit$",ve=`lit$${Math.random().toFixed(9).slice(2)}$`,Fa="?"+ve,is=`<${Fa}>`,$e=document,Je=()=>$e.createComment(""),Qe=i=>i===null||typeof i!="object"&&typeof i!="function",ai=Array.isArray,as=i=>ai(i)||typeof i?.[Symbol.iterator]=="function",Yn=`[ 	
\f\r]`,Ye=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ka=/-->/g,Ba=/>/g,we=RegExp(`>|${Yn}(?:([^\\s"'>=/]+)(${Yn}*=${Yn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ua=/'/g,Wa=/"/g,Za=/^(?:script|style|textarea|title)$/i,ri=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),f=ri(1),Dc=ri(2),Rc=ri(3),je=Symbol.for("lit-noChange"),x=Symbol.for("lit-nothing"),Ga=new WeakMap,ye=$e.createTreeWalker($e,129);function Xa(i,e){if(!ai(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ia!==void 0?Ia.createHTML(e):e}var rs=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=Ye;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Ye?c[1]==="!--"?o=Ka:c[1]!==void 0?o=Ba:c[2]!==void 0?(Za.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=we):c[3]!==void 0&&(o=we):o===we?c[0]===">"?(o=a??Ye,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?we:c[3]==='"'?Wa:Ua):o===Wa||o===Ua?o=we:o===Ka||o===Ba?o=Ye:(o=we,a=void 0);let k=o===we&&i[s+1].startsWith("/>")?" ":"";r+=o===Ye?l+is:p>=0?(n.push(d),l.slice(0,p)+qa+l.slice(p)+ve+k):l+ve+(p===-2?s:k)}return[Xa(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},et=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=rs(e,t);if(this.el=i.createElement(d,n),ye.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=ye.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(qa)){let m=c[o++],k=a.getAttribute(p).split(ve),u=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:u[2],strings:k,ctor:u[1]==="."?Qn:u[1]==="?"?ei:u[1]==="@"?ti:Oe}),a.removeAttribute(p)}else p.startsWith(ve)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(Za.test(a.tagName)){let p=a.textContent.split(ve),m=p.length-1;if(m>0){a.textContent=Ht?Ht.emptyScript:"";for(let k=0;k<m;k++)a.append(p[k],Je()),ye.nextNode(),l.push({type:2,index:++r});a.append(p[m],Je())}}}else if(a.nodeType===8)if(a.data===Fa)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(ve,p+1))!==-1;)l.push({type:7,index:r}),p+=ve.length-1}r++}}static createElement(e,t){let n=$e.createElement("template");return n.innerHTML=e,n}};function Ne(i,e,t=i,n){if(e===je)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=Qe(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Ne(i,a._$AS(i,e.values),a,n)),e}var Jn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??$e).importNode(t,!0);ye.currentNode=a;let r=ye.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new tt(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new ni(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=ye.nextNode(),o++)}return ye.currentNode=$e,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},tt=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ne(this,e,t),Qe(e)?e===x||e==null||e===""?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==je&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):as(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==x&&Qe(this._$AH)?this._$AA.nextSibling.data=e:this.T($e.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=et.createElement(Xa(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Jn(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Ga.get(e.strings);return t===void 0&&Ga.set(e.strings,t=new et(e)),t}k(e){ai(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(Je()),this.O(Je()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Pa(e).nextSibling;Pa(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Oe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=x}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Ne(this,e,t,0),o=!Qe(e)||e!==this._$AH&&e!==je,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Ne(this,s[n+l],t,l),d===je&&(d=this._$AH[l]),o||=!Qe(d)||d!==this._$AH[l],d===x?e=x:e!==x&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Qn=class extends Oe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===x?void 0:e}},ei=class extends Oe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==x)}},ti=class extends Oe{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Ne(this,e,t,0)??x)===je)return;let n=this._$AH,a=e===x&&n!==x||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==x&&(n===x||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ni=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ne(this,e)}};var os=ii.litHtmlPolyfillSupport;os?.(et,tt),(ii.litHtmlVersions??=[]).push("3.3.3");var Ya=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new tt(e.insertBefore(Je(),r),r,void 0,t??{})}return a._$AI(i),a};var oi=globalThis,B=class extends ce{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ya(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return je}};B._$litElement$=!0,B.finalized=!0,oi.litElementHydrateSupport?.({LitElement:B});var ss=oi.litElementPolyfillSupport;ss?.({LitElement:B});(oi.litElementVersions??=[]).push("4.2.2");var te=G`
  :host {
    ${de(X)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${de(he)}
`;var ls=["unavailable","unknown"],ds=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Vt({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||ls.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let m of ds)if(d[m]!==void 0){p[m]=d[m];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Pt(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var li=["hs","rgb","rgbw","rgbww","xy"],di="color_temp",cs="onoff";var ze="kleur";var ps=["unavailable","unknown"],Qa=["color_temp_kelvin","rgb_color","hs_color","xy_color"],hs=[0,100];function re(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===cs,a=t!==null&&t.includes(di),r=t!==null&&t.some(d=>li.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!ps.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function us(){return{state:"off"}}function er(i,e){let t=e??re(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...ks(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function tr(i,e,t,n){return e?i&&i.state==="on"?{...i}:er(t,n):{state:"off"}}function nr(i,e,t,n){let a=n??re(t),r=gi(i,t,a);return a.helderheid&&(r.brightness=N(e,1,255)),r}function ci(i,e,t,n){let a=n??re(t),r=gi(i,t,a);return hr(r),r.color_temp_kelvin=N(e,a.minKelvin,a.maxKelvin),r}function pi(i,e,t,n){let a=n??re(t),r=gi(i,t,a);return hr(r),r.hs_color=[N(e?.[0],0,360),N(e?.[1],0,100)],r}function It(i,e,t){return i??us()}function ir(i,e,t){let n=It(i,e,t);if(typeof n.brightness=="number")return N(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?N(a,1,255):255}function hi(i,e,t){let n=t??re(e),a=It(i,e,n);if(typeof a.color_temp_kelvin=="number")return N(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?N(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Kt(i,e,t){let n=It(i,e,t);if(si(n.hs_color))return[N(n.hs_color[0],0,360),N(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return si(a)?[N(a[0],0,360),N(a[1],0,100)]:[...hs]}function ui(i){return i!=null&&typeof i=="object"}function ar(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!ui(a[s]?.lights?.[o]))return!0;return!1})}function rr(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function mi(i,e,t){return It(i,e,t).state==="on"}function or(i,e,t){let n=t??re(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=mi(i,e,n),r=sr(n),o=r?ms(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===ze),kleurkeuze:a&&r,stand:a?o:null}}function sr(i){return!!(i?.kleurtemp&&i?.kleur)}function ms(i,e,t){let n=t??re(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(Qa.slice(1).some(r=>i[r]!==void 0))return ze}let a=e?.attributes?.color_mode;return a===di&&n.kleurtemp?"wit":li.includes(a)&&n.kleur?ze:"wit"}function lr(i,e,t,n){let a=n??re(t);return sr(a)?e==="wit"?ci(i,hi(i,t,a),t,a):pi(i,Kt(i,t,a),t,a):i}function dr(i){let e=N(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function cr(i){let e=N(i,1,100);return N(Math.round(e/100*255),1,255)}var gs=1e3,fs=4e4,Ja=7;function bs(i){let e=N(i,gs,fs)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[N(t,0,255),N(n,0,255),N(a,0,255)]}function vs(i){let[e,t,n]=bs(i);return`rgb(${e}, ${t}, ${n})`}function pr(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:Ja},(r,o)=>{let s=o/(Ja-1),l=t+(n-t)*s;return`${vs(l)} ${Math.round(s*100)}%`}).join(", ")})`}function ks(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?N(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===di&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=N(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&li.includes(a)&&si(t.hs_color)&&(n.hs_color=[N(t.hs_color[0],0,360),N(t.hs_color[1],0,100)]),n}function gi(i,e,t){return i&&i.state==="on"?{...i}:er(e,t)}function hr(i){for(let e of Qa)delete i[e]}function si(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function N(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Bt="domotiapp-scene-card",fi="domotiapp-scene-card-editor",ur="domotiapp-scene-editor";var nt=["een","twee","drie"],mr="pencil",gr=["grid_options","layout_options","view_layout","visibility"];var fr="entity_id",Ce=class extends B{constructor(){super();w(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));w(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[fr]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[fr];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return x;let t=this._leden();return f`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?f`
          ...
          `:x}
    `}};w(Ce,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),w(Ce,"styles",[te,G`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===vi?f`<div class="inhoud">Bezig met laden…</div>`:this._toestand===vr?f`
        <div class="inhoud">
      ...
      <div class="inhoud">
        ...
        ${this._melding?f`<ha-alert alert-type="error">${this._melding}</ha-alert>`:x}
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=mi(a,t,n),o=or(a,t,n);return f`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
              ${this._naam(e)}
              ${n.bekend?n.beschikbaar?x:f`<span class="hint">niet bereikbaar</span>`:f`<span class="hint">lamp niet gevonden</span>`}
            </span>
            ${ui(a)?x:f`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?f`
                <div class="bediening">
                  ${o.kleurkeuze?this._renderKleurkeuze(e,t,n,a,o.stand):x}
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,tr(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:x}
        </div>
    ...
    `}_renderBesturing(e,t,n,a,r){return f`
      ${r.helderheid?this._renderHelderheid(e,t,n,a):x}
      ${r.kleurtemp?this._renderKleurtemp(e,t,n,a):x}
      ${r.kleur?this._renderKleur(e,t,n,a):x}
    `}_renderHelderheid(e,t,n,a){let r=dr(ir(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,nr(this._waardeVan(e),cr(s.detail.value),t,n))};return f`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,lr(this._waardeVan(e),s,t,n))};return f`
      <div class="kleurkeuze">
        <button
          class="keuze ${r===ze?"actief":""}"
          aria-pressed=${r===ze?"true":"false"}
          @click=${o(ze)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,a){let r=hi(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,ci(this._waardeVan(e),s.detail.value,t,n))};return f`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${pr(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=Kt(a,t,n),s=l=>d=>{d.stopPropagation();let c=Kt(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,pi(this._waardeVan(e),p,t,n))};return f`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${$s}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};w(Le,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),w(Le,"styles",[te,G`
    ...
    `]);var js="0.9.0",zs=["type","entity","name_overrides","bare"],_i="laden",it="klaar",xi="leeg",wi="geen-groep",kr="opslagfout",_r="fout",at=class extends B{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=_i,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(fi)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}updated(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?Y(e):null),F(e)}disconnectedCallback(){super.disconnectedCallback(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!zs.includes(n)&&!gr.includes(n));t.length&&console.warn(`${Bt}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e,this.toggleAttribute("bare",!!e.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Se(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===wi){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=_i,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?xi:it}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=kr;return}if(!this.hass.states[t]){this._toestand=wi;return}this._toestand=_r}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==it)return;let{oproepen:t}=Vt({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await Pt((a,r)=>this.hass.callService("light",a,r),t);n.length&&this._meldMislukking(n.map(a=>a.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(a=>this._naam(a)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===it&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?xi:it}render(){if(!this._config)return x;switch(this._toestand){case wi:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case kr:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case _r:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return f`
      <div class="needs">
        <span class="mark">${this._icoon("question")}</span>
        <span>
          <b>${e}</b>
          ${t?f`<span class="detail">${t}</span>`:x}
        </span>
      </div>
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=v(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===xi,t=this._toestand===_i,n=this._iconen();return f`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((a,r)=>f`
      ...
      ${this._editorOpen?this._renderEditor():x}
    `}_renderNieuweLampen(){if(this._toestand!==it)return x;let e=ar(this._scenes,this._leden,3).length,t=rr(e);return t?f`<div class="mededeling">${t}</div>`:x}_renderEditor(){return f`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||nt[t])}};w(at,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),w(at,"styles",[te,G`
      :host { display: block; }
    ...
    `]);M(Bt,at);M(fi,Ce);M(ur,Le);Ae({type:Bt,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${js}).`,preview:!1});var Ee="domotiapp-alarm-card",yi="domotiapp-alarm-card-editor",xr="domotiapp-alarm-editor",wr="DomotiApp Wekker",yr="https://github.com/Sven2410/domotiapp-lovelace",oe="domotiapp_lovelace",J=Object.freeze({get:`${oe}/alarms/get`,save:`${oe}/alarms/save`,setEnabled:`${oe}/alarms/set_enabled`,delete:`${oe}/alarms/delete`,stop:`${oe}/alarms/stop`,clearMessage:`${oe}/alarms/clear_message`,search:`${oe}/sound/search`,entities:`${oe}/entities/list`,previewStart:`${oe}/preview/start`,subscribe:`${oe}/updates/subscribe`}),Gt="#026FA1";function $r(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Es="07:00";var Ss=["uri","name","media_type","image"],As="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Ms="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Ts="Music Assistant Wekker",Ns="Verlichting Wekker";function qt(){return{id:null,name:"",time:Es,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function jr(i){let e=qt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:$i(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:rt(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function rt(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Ss)e[t]=i[t]===void 0?null:i[t];return e}function $i(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ji(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),$i(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function zr(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:rt(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Er(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Sr(i){return $i(i)&&i.slice(0,2)==="02"?As:null}function Ar(i){return i===!1?Ms:null}function Mr(i){return typeof i?.endless=="boolean"?i.endless:null}function Ft(i,e){let t=e==="lamp",n=t?Ns:Ts,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function Tr(i,e){return Ft(e,"speaker")!==null?!1:ji(i).ok}var Cs=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Ls=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],ot="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ds="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Rs="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",De=class extends B{constructor(){super(),this._concept=qt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?jr(this.wekker):qt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:J.previewStart,speaker:this._concept.speaker,sound:rt(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:J.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:rt(e),endless:Mr(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ji(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:J.save,person:this.person,alarm:zr(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return f`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return x;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Ft(t,"speaker"),r=Ft(n,"lamp"),o=Sr(e.time),s=Ar(e.endless),l=Tr(e,t);return f`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Cs.map(([d,c])=>f`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Er(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${a?f`<div class="uitleg">${this._svg(ot)}<span>${a}</span></div>`:f`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
              ...
              >
                ...
                ${(t?.entities??[]).map(d=>f`<option value=${d.entity_id} ?selected=${d.entity_id===e.speaker}>
                    ${d.name}
                  </option>`)}
              </select>
            </div>`}
      ...
      <div class="blok">
        ...
        ${e.sound?f`<div class="gekozen">
              ${e.sound.image?f`<img src=${e.sound.image} alt="" />`:x}
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Ls.map(([d,c])=>f`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
            ...
            @click=${()=>this._zoek()}
          >
            ${this._svg(this._zoekt?Rs:Ds)}
          </button>
        </div>
        ${this._treffers?f`<div class="treffers">
              ${this._treffers.length===0?f`<div class="treffer">Niets gevonden.</div>`:this._treffers.map(d=>f`<button
                      class="treffer"
                      type="button"
                      @click=${()=>this._kiesGeluid(d)}
                    >
                      ${d.image?f`<img src=${d.image} alt="" />`:x}
                      <span>${d.name}</span>
                      <span class="soort">${d.media_type??""}</span>
                    </button>`)}
            </div>`:x}
        ${s?f`<div class="waarschuwing">${this._svg(ot)}<span>${s}</span></div>`:x}
      </div>
      ...
      <div class="blok">
        ...
        ${r?f`<div class="uitleg">${this._svg(ot)}<span>${r}</span></div>`:f`
              <div class="vak">
                <select
                  id="lamp"
    ...
    `}};w(De,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),w(De,"styles",[te,G`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${de(Gt)});
      display: block;
  ...
  `]);var Nr="person",Hs="Kies een persoon in de kaartinstellingen.",Or="De gekozen persoon is niet gevonden.",Vs="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Dp=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Cr(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Nr}.`))throw new Error(`'${e}' zit niet in het domein ${Nr}. Kies een persoon, zoals person.sven.`);return{...i}}function Lr(i){return{type:`custom:${i}`}}function Dr(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Or,isFout:!0}:{soort:"ontbreekt",tekst:Hs,isFout:!1}}function Rr(i,e){return i==="not_found"?Or:i==="home_assistant_error"?Vs:e||"Er ging iets mis bij het ophalen van de wekkers."}var Ps=["ma","di","wo","do","vr","za","zo"],Is="Geen wekkers ingesteld",Ks="Eenmalig",Bs="Eenmalig \u2014 afgelopen",Us="Geen wekker actief",Hr="Stoppen",Ws="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Gs(i){return!Array.isArray(i)||i.length===0?Ks:[...new Set(i)].sort((t,n)=>t-n).map(t=>Ps[t-1]??"?").join(" ")}function qs(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function Vr(i,e){return qs(i,e)?Bs:Gs(i?.days)}function Pr(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Ws,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function Ir(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return Is;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Us}function Kr(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var Fs="0.9.0",Zs="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Xs="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",Br="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ys="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Zt=(i,e="icoon")=>f`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,st=class extends B{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=Cr(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(yi)}static getStubConfig(){return Lr(Ee)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:Se(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?Y(e):null),F(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:J.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${Ee}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${Ee}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:J.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=Rr(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:J.entities})}catch(t){this._entiteiten=null,console.warn(`${Ee}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:J.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:J.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:J.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:J.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?Kr(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return x;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=Dr(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?f`<div class="card surface">
    ...
    `}_bevestiging(e){return f`<div class="onderrij bevestiging">
    ...
    </div>`}_rij(e,t){let n=Pr(e),a=!!e.enabled;return f`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${this._bevestigVoor===e.id?this._bevestiging(e):x}
      ${n?f`<div class="onderrij ${n.isFout?"fout":""}">
            ${Zt(n.isFout?Ys:Br,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:x}
    `}};w(st,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),w(st,"styles",[te,G`
  ...
  `]);var Re=class Re extends B{constructor(){super(...arguments);w(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?x:f`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};w(Re,"properties",{hass:{attribute:!1},_config:{state:!0}}),w(Re,"styles",[te,G`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),w(Re,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var zi=Re;M(Ee,st);M(yi,zi);M(xr,De);Ae({type:Ee,name:wr,description:`Wekkerkaart van DomotiApp (v${Fs}).`,preview:!1,documentationURL:yr});var Js="0.9.0";Di(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${Js} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Js as VERSION};
