var xh=Object.defineProperty;var wh=(i,e,t)=>e in i?xh(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var j=(i,e,t)=>wh(i,typeof e!="symbol"?e+"":e,t);var U=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function X(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var ci=null,vs=i=>{ci=i},Le=i=>String(i??"").split(".")[0],k=(i,e)=>e&&i?.states?.[e]||null,F=(i,e)=>k(i,e)?.attributes??{},An=(i,e,t)=>t?null:F(i,e).entity_picture||null;function Mn(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function D(i,e,t){return t||F(i,e).friendly_name||e||""}var _h=new Set(["scene","script","input_button","button","event"]),pi=i=>_h.has(Le(i));function oe(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!pi(i.entity_id):!1}function q(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(Le(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var yh=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),ks=i=>yh.has(Le(i));function xs(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function $n(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var K=(i,e)=>$n(i,"hass-more-info",{entityId:e});function tt(i){switch(Le(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function jh(i){switch(Le(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function ae(i,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let a=n.confirmation===!0?{}:n.confirmation;if(!ci){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}ci(a).then(r=>{r&&fs(i,e,t,n)});return}fs(i,e,t,n)}}function fs(i,e,t,n){switch(n.action){case"more-info":K(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=jh(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),$n(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":$n(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":$n(i,"ll-custom",n);break;default:break}}function B(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function ee(i,e){if(!e)return"";let t=Le(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function G(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var bs=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],ws=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],En=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),vt=(i,e)=>Math.round((En(e)-En(i))/864e5);function fe(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/(?:^|\D)(\d{1,2})[-./](\d{1,2})[-./](\d{4})(?!\d)/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/(?:^|\D)(\d{4})-(\d{1,2})-(\d{1,2})(?!\d)/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function kt(i,e=new Date){if(!i)return"";let t=vt(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?bs[i.getDay()]:`${bs[i.getDay()].slice(0,2)} ${i.getDate()} ${ws[i.getMonth()]}`}var Sn=i=>i?`${i.getDate()} ${ws[i.getMonth()]}`:"";function zh(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function $h(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function R(i,e=4){if(!i)return;let t=$h(i);if(!t){e>0&&requestAnimationFrame(()=>R(i,e-1));return}let n=`${Mh(i,zh(t))}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}var hi=new WeakMap,Eh=12,Ah=3;function Mh(i,e){let t=hi.get(i)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-Eh),a=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(a.length===2&&r>=Ah){let s=Math.max(...a);return hi.set(i,{rij:n,vast:{paar:a,waarde:s}}),s}return hi.set(i,{rij:n,vast:null}),e}function xt(i){let e=parseFloat(i?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function V(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);R(i)});e.observe(i);for(let t of i.children)e.observe(t);return R(i),()=>e.disconnect()}var Sh="home-assistant";function _s({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=Sh,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let h=i();if(!h)return!1;for(let[u,m]of e)try{h.get(u)||h.define(u,m)}catch(b){t(`kon ${u} niet registreren: ${b&&b.message}`)}return!0}function c(){let h=i();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var ys=[];function H(i,e){ys.push([i,e])}function wt({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function js({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customBadges=window.customBadges??[],!window.customBadges.some(r=>r.type===i)&&window.customBadges.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function zs(i=()=>{}){_s({leesRegistry:()=>globalThis.customElements,definities:ys,waarschuw:i})}var Nh=`
  :host {
    ${U}
    display: block;
...
`,A={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},Es={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},y=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Z=(i,e="accent")=>A[i]??(i&&/[#(]|^var/.test(i)?i:A[e]),I=Symbol("incomplete"),Dh=i=>`
  <div class="needs">
  ...
  </div>`,Lh=56,$s=8,Te=i=>Math.max(1,Math.ceil((i+$s)/(Lh+$s))),M=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[X(Nh+Ve+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let a=n.target;!a?.matches||a.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||a.isConnected&&a.matches(":focus-visible")&&a.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[I]||xs(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[I]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[I];if(e.innerHTML=t?Dh(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(V(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return xt(this.$(e))??t}};j(M,"css","");function L(i,e,{name:t,description:n,preview:a=!0}={}){H(i,e),wt({type:i,name:t,description:n,preview:a})}function Nn(i,e,{name:t,description:n,preview:a=!0}={}){H(i,e),js({type:i,name:t,description:n,preview:a})}function O(i,e){H(i,e)}var g=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,S={house:g(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,gi=null,Ss=i=>i.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${Be(n)} (${n})" aria-pressed="false">${S[n]??""}<span class="naam">${Be(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),fi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),gi=gi??[X(Rh)],this.shadowRoot.adoptedStyleSheets=gi,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
        <button type="button" class="current" aria-expanded="false">
          <span class="preview"></span>
          <span class="who"><b></b><small></small></span>
          <span class="caret">${S.chevronDown}</span>
        </button>
        <div class="panel">
          <div class="zoekrij">
            <span class="zoekveld">
              <span class="loep">${S.search}</span>
              <input id="zoek" type="search" placeholder="Zoek een icoon -- slapen, gordijn, vaatwasser"
                     spellcheck="false" autocomplete="off" />
              <button type="button" class="wis" title="Zoekopdracht wissen">${S.close}</button>
            </span>
          </div>
          <div class="groepen">${Ss(Dn)}</div>
          <div class="mdi">
...
`,bi=null,vi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),bi=bi??[X(Ih)],this.shadowRoot.adoptedStyleSheets=bi,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return A[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
      ...
      </div>`;let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let a=Hh.test(n);t.setAttribute("aria-invalid",String(!a)),a&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=!!this.value_,t=this.$(".sw");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.kleur_():"transparent"),t.title=e?`Kleur: ${Es[this.value_]??this.value_}`:"Kleur kiezen",/^#[0-9a-f]{6}$/i.test(this.kleur_())&&(this.$('input[type="color"]').value=this.kleur_()),this.$(".wissen").hidden=!e;let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let a=this.value_ in A?"":this.value_;n.value!==a&&(n.value=a),n.setAttribute("aria-invalid","false")}}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};H("dac-tone-picker",vi);var f={entity:i=>({entity:i?{domain:i}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(i,e,t=1)=>({number:{min:i,max:e,step:t,mode:"box"}}),select:i=>({select:{mode:"dropdown",options:i}}),action:(i="more-info")=>({ui_action:{default_action:i}})},ki=(...i)=>({type:"grid",name:"",schema:i}),xi=(i,e,t,n=!1)=>({type:"expandable",name:"",title:i,icon:e,expanded:n,schema:t}),Vh=[{name:"bare",selector:f.bool()}],Bh={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},T=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Vh}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return e.type==="expandable"?e.title??"":Ph[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),a=t("margin-top:16px");for(let o of e){let s=document.createElement({tone:"dac-tone-picker",foto:"dac-foto-picker"}[o.kind]??"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",l=>{l.stopPropagation(),this.patch_({[o.key]:l.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?a:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Bh[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),a.children.length&&this.appendChild(a)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[a,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[a];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},Ph={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Kh(i=new Date){let e=i.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var Gh=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Wh=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],wi={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},Uh=["humidity","wind","uv","precipitation","sunset"],Fh=i=>i==null||Number.isNaN(+i)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+i/45)%8],Ln=class extends M{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
  ...
  `);var _i=class extends T{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[ki({name:"weather",selector:f.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),ki({name:"sun",selector:f.entity("sun")},{name:"precipitation_entity",selector:f.entity("sensor")}),{name:"name",selector:f.text()},{name:"hide_below",selector:f.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};O("domotiapp-header-card-editor",_i);L("domotiapp-header-card",Ln,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var Tn=class extends M{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
  ...
  `);var yi=class extends T{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"line",selector:f.bool()},{name:"secondary_entity",selector:f.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};O("domotiapp-separator-card-editor",yi);L("domotiapp-separator-card",Tn,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var qh={goed:"good","let op":"warn",letop:"warn",kritiek:"bad",accent:"accent",oranje:"solar",blauw:"house",lichtblauw:"water",magenta:"magenta",roze:"pink",groenblauw:"teal",lampgeel:"lit",neutraal:"neutral",grijs:"neutral",groen:"good",rood:"bad",geel:"warn"},Ns=i=>{let e=String(i??"").trim();return e?qh[e.toLowerCase()]??e:""},Zh=new Set(["light","switch","fan","input_boolean","binary_sensor","automation","script","siren","lock","cover","media_player","person","device_tracker","alarm_control_panel","climate","water_heater","humidifier","vacuum","remote"]),Ds=i=>Zh.has(String(i??"").split(".")[0]);function ji(i){let e=String(i?.icon_template??"").trim();return e||(i?.icon??"")}function On(i){let e=String(i?.path??"").trim();return e?{soort:"pad",pad:e}:{soort:"geschiedenis"}}var zi={links:"flex-start",midden:"center",rechts:"flex-end"};function Ls(i){return zi[i]??zi.links}function Ts(){return Object.keys(zi)}function Os(i){let e=String(i?.label??"").trim();if(e)return e;let t=String(i?.path??"").trim();return t?`Naar ${t}`:"Terug"}var Yh="domotiapp-terug-card",Cs="domotiapp-terug-card-editor",Cn=class extends M{validate(e){return{icon:"arrowLeft",align:"links",...e}}watched(){return[]}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),`
      <div class="houder" style="--uit:${Ls(e.align)}">
        <button class="chip" type="button">
          <span class="ico"></span>
          <span class="tekst"></span>
        </button>
      </div>`}wire(){this.teardown_.push(B(this.$(".chip"),{onTap:()=>this.terug_()}))}terug_(){let e=On(this.config);if(e.soort==="geschiedenis"){history.back();return}ae(this,this.hass,this.config,{action:"navigate",navigation_path:e.pad})}paint(){let e=this.config,t=e.icon||"arrowLeft",n=this.$(".ico");n.dataset.icon!==t&&(n.dataset.icon=t,n.innerHTML=v(t,"arrowLeft")),this.text(".tekst",e.label??""),this.$(".chip").title=Os(e)}getCardSize(){return 1}getGridOptions(){return{rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement(Cs)}static getStubConfig(){return{icon:"arrowLeft",label:"Terug",align:"links"}}};j(Cn,"css",`
    :host { display: block; height: 100%; }
...
`;var Xh=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Qh=new Set(["hs","rgb","rgbw","rgbww","xy"]),Mi=i=>i?.attributes?.supported_color_modes??[],Jh=i=>Mi(i).some(e=>Xh.has(e)),Rn=i=>Mi(i).some(e=>Qh.has(e)),Hn=i=>Mi(i).includes("color_temp"),Rs=i=>Math.max(1,Math.round((i??0)/255*100)),In=class extends M{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[I]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var Is=i=>String(i??"").split(".")[0],Vs=new Set(["input_select","select"]),Li=i=>Vs.has(Is(i));function we(i){if(!i||!Li(i.entity_id))return[];let e=i.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function yt(i,e=we(i)){let t=String(i?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function jt(i,e,t=[]){let n=Is(i),a=String(e??"");return!a||!Vs.has(n)||t.length&&!t.includes(a)?null:[n,"select_option",{entity_id:i,option:a}]}var be=i=>String(i??"").split(".")[0],Oe=i=>i==null||i===""||i==="unknown"||i==="unavailable",Ge={domeinen:["sensor"],device_class:"temperature",rol:"tegel",eenheid:"\xB0C"},tu={hoofd_climate:{key:"entity",label:"Apparaat (climate)",domeinen:["climate"],rol:"hoofd",hulp:"De climate-entiteit. Daar komen de standen en de temperatuurknoppen vandaan. Leeg laten mag: dan toont de kaart alleen de sensoren."},hoofd_ventilatie:{key:"entity",label:"Ventilatie-unit",domeinen:["fan","select","input_select","climate"],rol:"hoofd",hulp:"Een fan-entiteit (standen of percentage), of een keuzelijst met de standen. Leeg laten mag."},hoofd_boiler:{key:"entity",label:"Boiler (water_heater of climate)",domeinen:["water_heater","climate"],rol:"hoofd",hulp:"Daar komen de doeltemperatuur en de bedrijfsstanden vandaan. Leeg laten mag."},temperature:{key:"temperature",label:"Binnentemperatuur",...Ge,hulp:"Wint van de meting van het apparaat zelf."},outdoor:{key:"outdoor",label:"Buitentemperatuur",...Ge},humidity:{key:"humidity",label:"Luchtvochtigheid",domeinen:["sensor"],device_class:"humidity",rol:"tegel",eenheid:"%"},co2:{key:"co2",label:"CO\u2082",domeinen:["sensor"],rol:"tegel",eenheid:"ppm",hulp:"Kleurt oranje boven 1200 ppm en rood boven 1600."},voc:{key:"voc",label:"Luchtkwaliteit (VOC)",domeinen:["sensor"],rol:"tegel"},power:{key:"power",label:"Vermogen",domeinen:["sensor"],device_class:"power",rol:"tegel",eenheid:"W"},energy:{key:"energy",label:"Energie vandaag",domeinen:["sensor"],device_class:"energy",rol:"tegel",eenheid:"kWh"},flow_temp:{key:"flow_temp",label:"Aanvoertemperatuur",...Ge},return_temp:{key:"return_temp",label:"Retourtemperatuur",...Ge},dhw_temp:{key:"dhw_temp",label:"Tapwatertemperatuur",...Ge},water_temp:{key:"water_temp",label:"Watertemperatuur",...Ge,hulp:"Wint van de meting van de boiler zelf."},supply_temp:{key:"supply_temp",label:"Toevoertemperatuur",...Ge},exhaust_temp:{key:"exhaust_temp",label:"Afvoertemperatuur",...Ge},cop:{key:"cop",label:"COP",domeinen:["sensor"],rol:"tegel",hulp:"Rendement: geleverde warmte gedeeld door verbruikte stroom."},thermal:{key:"thermal",label:"Thermisch vermogen",domeinen:["sensor"],rol:"tegel",eenheid:"kW"},compressor:{key:"compressor",label:"Compressor",domeinen:["sensor","binary_sensor"],rol:"tegel",hulp:"Een toerental of percentage, of een aan/uit-sensor."},flow_rate:{key:"flow_rate",label:"Debiet",domeinen:["sensor"],rol:"tegel",eenheid:"l/min"},pressure:{key:"pressure",label:"Waterdruk",domeinen:["sensor"],rol:"tegel",eenheid:"bar"},status:{key:"status",label:"Statussensor",domeinen:["sensor"],rol:"status",hulp:"Een sensor met een woord als toestand (Verwarmen, Tapwater, Stand 2). Komt in de regel onder de naam."},fault:{key:"fault",label:"Storing",domeinen:["binary_sensor"],rol:"storing",hulp:"Een binary_sensor die aan gaat bij een storing. De kaart kleurt dan rood, wat er verder ook aan de hand is."},filter:{key:"filter",label:"Filter",domeinen:["binary_sensor","sensor"],rol:"filter",hulp:"Een binary_sensor die aan gaat als het filter vervangen moet worden, of een sensor met de dagen tot vervanging."},bypass:{key:"bypass",label:"Bypass",domeinen:["binary_sensor"],rol:"tegel"},heating:{key:"heating",label:"Verwarmt (aan/uit)",domeinen:["binary_sensor"],rol:"verwarmt",hulp:"Een binary_sensor die aan is zolang de boiler opwarmt."},mode:{key:"mode",label:"Bedrijfsmodus (keuzelijst)",domeinen:["select","input_select"],rol:"keuze",hulp:"Een keuzelijst van de integratie, bijvoorbeeld Verwarmen / Koelen / Auto. Verschijnt als uitklaplijst op de kaart."},boost:{key:"boost",label:"Boost",domeinen:["switch","input_boolean","button","input_button","script"],rol:"boost",hulp:"Een schakelaar wordt een schuifschakelaar op de kaart; een knop of script een drukknop."}},zt={airco:{label:"Airco",naam:"Airco",icoon:"airco",velden:["hoofd_climate","temperature","outdoor","humidity","power","energy","fault"]},warmtepomp:{label:"Warmtepomp",naam:"Warmtepomp",icoon:"heatPump",velden:["hoofd_climate","status","fault","flow_temp","return_temp","outdoor","dhw_temp","cop","power","thermal","energy","compressor","flow_rate","pressure","mode","boost"]},ventilatie:{label:"Ventilatie (WTW)",naam:"Ventilatie",icoon:"fan",velden:["hoofd_ventilatie","status","fault","co2","humidity","voc","temperature","outdoor","supply_temp","exhaust_temp","filter","bypass","power","boost"]},boiler:{label:"Boiler / warm water",naam:"Boiler",icoon:"boiler",velden:["hoofd_boiler","water_temp","heating","power","energy","fault","mode","boost"]}},nt="airco",at=i=>zt[i]??zt[nt],We=i=>at(i).velden.map(e=>tu[e]),Ti=(i,e)=>We(i).filter(t=>t.rol===e),Ps={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",dry:"Drogen",fan_only:"Ventileren"},nu={heating:"Verwarmt",cooling:"Koelt",drying:"Droogt",fan:"Ventileert",idle:"Standby",off:"Uit",preheating:"Voorverwarmt",defrosting:"Ontdooit"},Bs={off:"Uit",on:"Aan",auto:"Auto",low:"Laag",lowest:"Laagst",min:"Min",minimum:"Min",medium:"Midden",mid:"Midden",middle:"Midden",high:"Hoog",highest:"Hoogst",max:"Max",maximum:"Max",boost:"Boost",turbo:"Turbo",quiet:"Stil",silent:"Stil",silence:"Stil",sleep:"Nacht",night:"Nacht",away:"Afwezig",home:"Thuis",eco:"Eco",comfort:"Comfort",party:"Feest",holiday:"Vakantie",electric:"Elektrisch",gas:"Gas",heat_pump:"Warmtepomp",high_demand:"Veel vraag",performance:"Snel",...Ps};function he(i){let e=String(i??"").trim();if(!e)return"";let t=e.toLowerCase().replace(/[\s-]+/g,"_");if(Bs[t])return Bs[t];let n=e.replace(/_/g," ");return n.charAt(0).toUpperCase()+n.slice(1)}function au(i,e){let t=String(i??"").toLowerCase(),n=Math.abs(Number(e));return t.includes("\xB0")||t==="c"||t==="f"?1:t==="%"||t==="ppm"||t==="w"||t==="hz"||t==="rpm"||t==="ppb"?0:t==="kwh"||t==="kw"||t==="bar"||t==="l/min"||t==="m\xB3/h"||t?n>=100?0:1:n>=100?0:n>=10?1:2}function iu(i,e,t="nl"){let n=Number(i);if(!Number.isFinite(n))return"--";let a=au(e,n);return n.toLocaleString(t,{minimumFractionDigits:a,maximumFractionDigits:a})}var ru={bypass:["Open","Dicht"],compressor:["Aan","Uit"],heating:["Ja","Nee"],filter:["Vervangen","Schoon"]};function ou(i,e,t="nl"){if(!i||!e)return null;let n=String(e.state??"").trim(),a=e.attributes?.unit_of_measurement??i.eenheid??"";if(be(e.entity_id)==="binary_sensor"){let[l,d]=ru[i.key]??["Aan","Uit"],c=Oe(n),p=n==="on";return{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:c?"--":p?l:d,eenheid:"",let:i.key==="filter"&&p?"warn":""}}let r=Number(n),o=!Oe(n)&&Number.isFinite(r),s="";return i.key==="co2"&&o&&(s=r>=1600?"bad":r>=1200?"warn":""),i.key==="filter"&&o&&(s=r<=0?"warn":""),{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:o?iu(r,a,t):Oe(n)?"--":n,eenheid:o?a:"",let:s}}function Ks(i,e,t,n="nl"){let a=[];for(let r of We(i)){if(r.rol!=="tegel"&&r.rol!=="filter")continue;let o=e?.[r.key];if(!o)continue;let s=ou(r,t(o)??{entity_id:o,state:"unavailable",attributes:{}},n);s&&a.push(s)}return a}function Gs({soort:i,hoofd:e,status:t,fault:n,filter:a,heating:r}={}){let o=su(a);if(n&&n.state==="on")return{tekst:"Storing",tone:"bad",bezig:!1,waarschuwing:o};if(e&&Oe(e.state))return{tekst:"Niet bereikbaar",tone:"neutral",bezig:!1,waarschuwing:o};let s=t&&!Oe(t.state)?he(t.state):"",l=be(e?.entity_id);if(e&&l==="climate"){let c=(e.attributes??{}).hvac_action??(e.state==="off"?"off":"idle"),p=nu[c]??he(c),h=c==="heating"||c==="preheating"?"solar":["cooling","drying","fan"].includes(c)?"water":"neutral",u=h!=="neutral"||c==="defrosting";return{tekst:s&&s!==p?`${p} \xB7 ${s}`:p,tone:h,bezig:u,waarschuwing:o}}if(e&&l==="fan"){let d=e.attributes??{};if(e.state==="off")return{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o};let c=d.preset_mode?he(d.preset_mode):Number.isFinite(Number(d.percentage))?`${Math.round(Number(d.percentage))}%`:"Aan";return{tekst:s&&s!==c?`${c} \xB7 ${s}`:`Ventileert \xB7 ${c}`,tone:"water",bezig:!0,waarschuwing:o}}if(e&&l==="water_heater"){let d=e.attributes??{},c=he(e.state),p=r?r.state==="on":d.operation_mode!=="off"&&e.state!=="off"&&d.hvac_action==="heating";return e.state==="off"?{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:p?`Verwarmt \xB7 ${c}`:c,tone:p?"solar":"neutral",bezig:p,waarschuwing:o}}if(e&&(l==="select"||l==="input_select")){let d=he(e.state),c=/^(uit|off)$/i.test(e.state);return{tekst:c?"Uit":`Stand \xB7 ${d}`,tone:c?"neutral":"water",bezig:!c,waarschuwing:o}}return r&&r.state==="on"?{tekst:s?`Verwarmt \xB7 ${s}`:"Verwarmt",tone:"solar",bezig:!0,waarschuwing:o}:s?{tekst:s,tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:at(i).naam,tone:"neutral",bezig:!1,waarschuwing:o}}function su(i){if(!i||Oe(i.state))return"";if(be(i.entity_id)==="binary_sensor")return i.state==="on"?"Filter vervangen":"";let e=Number(i.state);return Number.isFinite(e)&&e<=0?"Filter vervangen":""}var lu=[["0","Uit"],["33","Laag"],["66","Midden"],["100","Hoog"]];function Oi(i){if(!i)return[];let e=i.attributes??{},t=be(i.entity_id),n=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"&&r!==""):[];if(t==="climate")return n(e.hvac_modes).map(a=>({waarde:a,label:Ps[a]??he(a)}));if(t==="water_heater")return n(e.operation_list).map(a=>({waarde:a,label:he(a)}));if(t==="select"||t==="input_select")return n(e.options).map(a=>({waarde:a,label:he(a)}));if(t==="fan"){let a=n(e.preset_modes);if(a.length)return a.map(r=>({waarde:r,label:he(r)}));if(e.percentage!=null||e.percentage_step!=null){let r=Number(e.percentage_step)||1;return lu.map(([o,s])=>({waarde:String(Math.min(100,Math.round(Number(o)/r)*r)),label:s}))}return[{waarde:"off",label:"Uit"},{waarde:"on",label:"Aan"}]}return[]}function Ws(i,e=Oi(i)){if(!i||Oe(i.state))return"";let t=i.attributes??{};if(be(i.entity_id)==="fan"){if(t.preset_mode&&e.some(r=>r.waarde===t.preset_mode))return t.preset_mode;if(i.state==="off")return e.some(r=>r.waarde==="0")?"0":"off";let a=Number(t.percentage);if(Number.isFinite(a)&&e.length){let r=e[0];for(let o of e)Math.abs(Number(o.waarde)-a)<Math.abs(Number(r.waarde)-a)&&(r=o);return r.waarde}return i.state==="on"?"on":""}return e.some(a=>a.waarde===i.state)?i.state:""}function Us(i,e){if(!i)return null;let t=i.entity_id,n=String(e??"");if(!n)return null;let a=be(t);switch(a){case"climate":return["climate","set_hvac_mode",{entity_id:t,hvac_mode:n}];case"water_heater":return["water_heater","set_operation_mode",{entity_id:t,operation_mode:n}];case"select":case"input_select":return[a,"select_option",{entity_id:t,option:n}];case"fan":{let r=i.attributes?.preset_modes;if(Array.isArray(r)&&r.includes(n))return["fan","set_preset_mode",{entity_id:t,preset_mode:n}];if(n==="off")return["fan","turn_off",{entity_id:t}];if(n==="on")return["fan","turn_on",{entity_id:t}];let o=Number(n);return Number.isFinite(o)?o<=0?["fan","turn_off",{entity_id:t}]:["fan","set_percentage",{entity_id:t,percentage:o}]:null}default:return null}}function Ci(i){let e=i?.attributes?.fan_modes;return be(i?.entity_id)!=="climate"||!Array.isArray(e)?[]:e.filter(t=>typeof t=="string"&&t).map(t=>({waarde:t,label:he(t)}))}function Fs(i,e){let t=String(e??"");return!i||!t||!Ci(i).some(n=>n.waarde===t)?null:["climate","set_fan_mode",{entity_id:i.entity_id,fan_mode:t}]}function Ri(i,e){if(!i||Oe(i.state))return null;let t=i.attributes??{},n=be(i.entity_id);if(n!=="climate"&&n!=="water_heater")return null;let a=Number(t.temperature);if(!Number.isFinite(a))return null;let r=Number(e)||Number(t.target_temp_step)||(n==="water_heater"?1:.5);return{min:Number(t.min_temp??(n==="water_heater"?30:5)),max:Number(t.max_temp??(n==="water_heater"?70:35)),stap:r,doel:a,huidig:Number.isFinite(Number(t.current_temperature))?Number(t.current_temperature):null}}function qs(i,e,t){if(!i)return null;let a=(Number.isFinite(e)?e:i.doel)+t*i.stap,r=Math.round(a/i.stap)*i.stap,o=Math.round(r*100)/100;return Math.min(i.max,Math.max(i.min,o))}function Zs(i,e){if(!i||!Number.isFinite(e))return null;let t=be(i.entity_id);return t!=="climate"&&t!=="water_heater"?null:[t,"set_temperature",{entity_id:i.entity_id,temperature:e}]}var Ys=i=>["switch","input_boolean"].includes(be(i));function Hi(i,e=!0){let t=String(i??""),n=be(t);switch(n){case"switch":case"input_boolean":return["homeassistant",e?"turn_on":"turn_off",{entity_id:t}];case"button":case"input_button":return[n,"press",{entity_id:t}];case"script":return["script","turn_on",{entity_id:t}];default:return null}}function Xs(i,e){let t=Number(e?.state);if(e&&!Oe(e.state)&&Number.isFinite(t))return t;let n=i?.attributes?.current_temperature;if(n==null||n==="")return null;let a=Number(n);return Number.isFinite(a)?a:null}var Qs={solar:A.solar,water:A.water,bad:A.bad,warn:A.warn,neutral:"var(--dac-ink-3)"},Gn=class extends M{validate(e){let t={soort:nt,...e};return zt[t.soort]||(t.soort=nt),We(t.soort).some(a=>t[a.key])||(t[I]="Kies de soort en minstens \xE9\xE9n entiteit: het apparaat zelf, of een sensor."),t}watched(){let e=this.config;return We(e.soort).map(t=>e[t.key]).filter(Boolean)}hoofd_(){return k(this.hass,this.config.entity)??null}metRol_(e){let t=Ti(this.config.soort,e)[0];return t?k(this.hass,this.config[t.key])??null:null}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=e.boost?Ys(e.boost)?Bn({label:"Boost"}):`<button type="button" class="knop">${v("bolt")}<span>Boost</span></button>`:"";return`
      ...
      </div>`}wire(){let e=this.config;if(this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(V(this.$(".card"))),this.on(this.$(".top"),"click",()=>{let t=e.entity||this.watched()[0];t&&K(this,t)}),this.on(this.$(".standen"),"click",t=>{let n=t.target?.closest?.(".seg");if(!n||n.disabled)return;t.stopPropagation();let a=Us(this.hoofd_(),n.dataset.waarde);a&&this.hass.callService(a[0],a[1],a[2])}),this.$$(".set button").forEach(t=>this.on(t,"click",()=>this.nudge_(Number(t.dataset.d)))),this.on(this.$(".rij.ventilator"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n)return;t.stopPropagation();let a=Fs(this.hoofd_(),n.value);a&&this.hass.callService(a[0],a[1],a[2])}),this.on(this.$(".rij.modus"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.mode)return;t.stopPropagation();let a=jt(e.mode,n.value,we(k(this.hass,e.mode)));a&&this.hass.callService(a[0],a[1],a[2])}),e.boost){let t=this.$(".rij.boost .toggle"),n=this.$(".rij.boost .knop");t&&this.teardown_.push(Pn(t,{value:()=>q(k(this.hass,e.boost)),set:a=>{let r=Hi(e.boost,a);r&&this.hass.callService(r[0],r[1],r[2])}})),n&&this.on(n,"click",a=>{a.stopPropagation();let r=Hi(e.boost,!0);r&&this.hass.callService(r[0],r[1],r[2])})}}nudge_(e){let t=this.hoofd_(),n=Ri(t,this.config.step);n&&(this.pending_=qs(n,this.pending_??n.doel,e),this.paintDoel_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null;let a=Zs(t,this.pending_);a&&this.hass.callService(a[0],a[1],a[2]),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450))}paintDoel_(){let e=this.$(".set"),t=Ri(this.hoofd_(),this.config.step);if(e.hidden=!t,!t)return;let n=this.pending_??t.doel,a=e.querySelector(".target");a.classList.toggle("pending",this.pending_!=null),a.innerHTML=`${G(this.hass,n,n%1?1:0)}\xB0<small>doel</small>`,e.querySelector('[data-d="-1"]').disabled=n<=t.min,e.querySelector('[data-d="1"]').disabled=n>=t.max}paint(){let e=this.config,t=at(e.soort),n=this.hoofd_(),a=Gs({soort:e.soort,hoofd:n,status:this.metRol_("status"),fault:this.metRol_("storing"),filter:this.metRol_("filter"),heating:this.metRol_("verwarmt")}),r=Qs[a.tone]??Qs.neutral;this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("bezig",a.bezig),this.toggleAttribute("storing",a.tone==="bad"),this.$(".top").classList.toggle("dood",a.tekst==="Niet bereikbaar");let o=this.$(".chip"),s=e.icon||t.icoon;o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=v(s,t.icoon)),this.text(".nm",e.name||(e.entity?D(this.hass,e.entity,null):"")||t.naam);let l=this.$(".st"),d=y(a.tekst)+(a.waarschuwing?` &middot; <span class="let">${y(a.waarschuwing)}</span>`:"");l.dataset.html!==d&&(l.dataset.html=d,l.innerHTML=d),this.$(".top").setAttribute("aria-label",`${this.$(".nm").textContent}, ${a.tekst}`);let c=e.soort==="boiler"?"water_temp":"temperature",p=k(this.hass,e[c])??null,h=Xs(n,p),u=p?.attributes?.unit_of_measurement??this.hass?.config?.unit_system?.temperature??"\xB0C",m=this.$(".graden"),b=h==null?"":`${G(this.hass,h,1)}<small>${y(u)}</small>`;if(m.dataset.html!==b&&(m.dataset.html=b,m.innerHTML=b),this.paintTegels_(h==null?null:c),this.paintStanden_(n),this.paintDoel_(),this.paintKeuzes_(n),e.boost){let x=this.$(".rij.boost .toggle");x&&(x.style.setProperty("--tone",A.accent),Kt(x,q(k(this.hass,e.boost))))}R(this.$(".card"))}paintTegels_(e){let t=this.config,n=this.$(".tegels"),a=Ks(t.soort,t,o=>k(this.hass,o)??null,this.hass?.locale?.language??"nl").filter(o=>o.key!==e);n.hidden=a.length===0;let r=JSON.stringify(a);n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(o=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var Ii=class extends T{defaults(){return{soort:nt}}soort_(){return zt[this.config_?.soort]?this.config_.soort:nt}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:at(this.soort_()).icoon,auto:!1}]}sync_(){super.sync_();for(let e of this.pickers_??[])e.dataset.key==="icon"&&(e.fallback=at(this.soort_()).icoon)}schema(){let e=this.soort_(),t=We(e).map(r=>({name:r.key,selector:{entity:{domain:r.domeinen,...r.device_class?{device_class:r.device_class}:{}}}})),a=Ti(e,"hoofd")[0]?.domeinen.some(r=>r==="climate"||r==="water_heater");return[{name:"soort",selector:f.select(Object.entries(zt).map(([r,o])=>({value:r,label:o.label})))},{name:"name",selector:f.text()},...t,...a?[{name:"step",selector:f.number(.1,5,.1)}]:[]]}label(e){let t=We(this.soort_()).find(n=>n.key===e.name);return t?t.label:{soort:"Soort apparaat",name:"Naam",step:"Stap van de temperatuurknoppen"}[e.name]??super.label(e)}helper(e){let t=We(this.soort_()).find(n=>n.key===e.name);if(t?.hulp)return t.hulp;if(e.name==="soort")return"Bepaalt welke velden hieronder staan, het icoon, en hoe de statusregel leest.";if(e.name==="name")return`Leeg laten geeft de naam van het apparaat, of anders "${at(this.soort_()).naam}".`;if(e.name==="step")return"Leeg laten volgt het apparaat: een halve graad bij een climate, een hele bij een boiler."}};O("domotiapp-hvac-card-editor",Ii);L("domotiapp-hvac-card",Gn,{name:"DomotiApp HVAC",description:"Airco, warmtepomp, ventilatie of boiler: status, metingen als tegels, de standen van het apparaat, doeltemperatuur en boost."});var Wn=i=>String(i??"").split(".")[0],Js=new Set(["input_datetime","time","date","datetime"]),el=i=>Js.has(Wn(i)),_e=i=>String(i).padStart(2,"0");function du(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function Vi(i){if(!i)return null;let e=Wn(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:du(i.state)}var cu=i=>`${i.getFullYear()}-${_e(i.getMonth()+1)}-${_e(i.getDate())}T${_e(i.getHours())}:${_e(i.getMinutes())}`;function pu(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${_e(Math.floor(n/60))}:${_e(n%60)}`}function tl(i,e=Vi(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${_e(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(Wn(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":cu(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${_e(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function nl(i,e,t){let n=Wn(i),a=String(t??"");if(!a||!Js.has(n)||!e)return null;if(e==="time"){let h=a.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let u=`${_e(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:u}]:["input_datetime","set_datetime",{entity_id:i,time:u}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${_e(d)}:${c}:00`;if(n==="datetime"){let h=pu(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var al={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},hu=/^.*program(?:me)?[_.\- ]/i,uu=30,mu=95;function gu(i){return String(i??"").replace(hu,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function fu(i){let e=gu(i);if(!e.length)return"";let t=[];for(let a=0;a<e.length;a++){let r=e[a],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=uu&&d<=mu?`${d} \xB0C`:o);continue}let s=e[a+1]?.toLowerCase(),l=s?al[o+s]:void 0;if(l){t.push(l),a++;continue}t.push(al[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function bu(i,e){let t=a=>String(a??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(i)}function Un(i,e){return bu(i,e)?String(e):fu(i)||String(i??"")}var qn={row:44,tile:96,compact:44,beeld:120},Ue=6,il=12,Bi=22,vu=["row","tile","compact","beeld"],ku=["links","midden"],Pi=48,Ki=320,Fn=120,ye=i=>{if(i==null||i==="")return Fn;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(Ki,Math.max(Pi,e)):Fn},Gt=i=>ku.includes(i)?i:"links";function rl(i,e){let t=Array.isArray(i)?i:[],n=Array.from({length:e},(a,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var xu=["card","items","none","open"],Zn=i=>typeof i?.name=="string"?i.name.trim():"",Wt=i=>typeof i=="string"?{entity:i}:{...i},Ut=i=>Math.min(Math.max(1,Number(i)||2),3),$t=i=>vu.includes(i)?i:"row",ue=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function ol(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(n=>{let a=Ut(n.columns);return{columns:a,layout:$t(n.layout),align:Gt(n.align),image_size:ye(n.image_size),column_names:rl(n.column_names,a),items:(n.items??n.entities??[]).map(Wt)}});let e=(i?.items??i?.entities??[]).map(Wt);if(!e.length)return[];let t=Ut(i.columns);return[{columns:t,layout:$t(i.layout),align:Gt(i.align),image_size:ye(i.image_size),column_names:rl(i.column_names,t),items:e}]}function Yn(i){return xu.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var wu=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns)),_u=22;function yu(i){let e=$t(i?.layout);return e!=="beeld"?qn[e]:ye(i?.image_size)+34}function Gi(i){let e=i?.rows??[],t=Zn(i)?Bi+Ue:0;if(!e.length)return il+t+qn.row;let n=(Yn(i)==="card"?il:0)+t;for(let a of e){let r=wu(a);n+=r*yu(a)+(r-1)*Ue,a.column_names?.length&&(n+=_u+Ue)}return n+(e.length-1)*Ue}function Ft(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();ue(e)&&i.bewaard.push(e)}return i}function sl(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Ut(n.columns),layout:$t(n.layout),align:Gt(n.align),image_size:ye(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(Wt)})):(()=>{let n=(i.items??i.entities??[]).map(Wt);return n.length?[{columns:Ut(i.columns),layout:$t(i.layout),align:Gt(i.align),image_size:ye(i.image_size),column_names:Array.isArray(i.column_names)?[...i.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]),a.forEach((r,o)=>t.push(Ft({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var Wi=i=>i.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Fn?{image_size:ye(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ue).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function Ui(i,e,t){let n=new Set;for(let a of i){let r=/^r(\d+)(?:i(\d+))?$/.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:a);continue}n.add(o>e?`r${o+1}${s}`:a)}return n}var ll=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],ju=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],zu=i=>ll.find(e=>e.waarde===i)?.label??"Rij",$u=`
...
`,Fi=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=sl(e);this.gebouwd_&&JSON.stringify(Wi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=Ui(this.open_,e,"weg")}rijErbij_(e){this.open_=Ui(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{ue(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=$u;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=Ft({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(C=>({waarde:C,label:String(C),titel:`${C} entiteit${C>1?"en":""} in deze rij`})),()=>e.columns,C=>{e.columns=C,Ft(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let u=this.segment_(ll.map(C=>({waarde:C.waarde,label:C.label})),()=>e.layout,C=>{e.layout=C,ne(),this.emit_()}),m=document.createElement("div");m.className="vormrij";let b=document.createElement("b");b.textContent="Vorm van deze rij",m.append(b,u.wrap),h.appendChild(m);let x=this.segment_(ju.map(C=>({waarde:C.waarde,label:C.label})),()=>e.align??"links",C=>{e.align=C,this.emit_()}),w=document.createElement("div");w.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",w.append(_,x.wrap),h.appendChild(w);let z=document.createElement("div");z.className="beeldvak";let N=document.createElement("ha-form");N.hass=this.hass_,N.schema=[{name:"image_size",selector:{number:{min:Pi,max:Ki,step:4,mode:"slider"}}}],N.computeLabel=()=>"Grootte van de afbeelding",N.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",N.data={image_size:ye(e.image_size)},N.addEventListener("value-changed",C=>{C.stopPropagation(),e.image_size=ye(C.detail.value?.image_size),this.emit_()}),z.appendChild(N),h.appendChild(z);let ne=()=>{let C=e.layout==="beeld";z.style.display=C?"":"none",w.style.display=C?"none":""};ne();let ge=document.createElement("div");ge.className="kolomvak";let ke=document.createElement("ha-form");ke.hass=this.hass_;let hs=()=>Array.from({length:e.columns},(C,pe)=>({name:`k${pe}`,selector:{text:{}}}));ke.schema=hs(),ke.computeLabel=C=>`Kop boven kolom ${Number(C.name.slice(1))+1}`,ke.computeHelper=C=>C.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let us=()=>Object.fromEntries(Array.from({length:e.columns},(C,pe)=>[`k${pe}`,e.column_names?.[pe]??""]));ke.data=us(),ke.addEventListener("value-changed",C=>{C.stopPropagation();let pe=C.detail.value??{};e.column_names=Array.from({length:e.columns},(gs,kh)=>pe[`k${kh}`]??""),this.emit_()}),ge.appendChild(ke),h.appendChild(ge);let ms=()=>{let C=e.items.filter(ue),pe=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&pe.push(zu(e.layout)),pe.push(C.length?C.map(gs=>this.itemNaam_(gs)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&pe.push("met kolomkoppen"),l.textContent=pe.join(" \xB7 "),d.vernieuw(),u.vernieuw(),x.vernieuw(),ne(),ke.schema.length!==e.columns&&(ke.schema=hs()),ke.data=us()};return this.koppen_.push(ms),e.items.forEach((C,pe)=>h.appendChild(this.itemBlok_(e,C,t,pe))),n.append(a,h),ms(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(a,1),this.itemWeg_(n,a),Ft(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let u=document.createElement("div");u.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let b=document.createElement("dac-icon-picker");b.label="Icoon",b.hass=this.hass_,b.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,x.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",_=>{_.stopPropagation();let z=_.detail.value;z.name?t.name=z.name:delete t.name,z.toggle===!0?t.toggle=!0:delete t.toggle;for(let N of["show_icon","show_name","show_state"])z[N]===!1?t[N]=!1:delete t[N];for(let N of["icon_tap_action","icon_hold_action","tap_action","hold_action"])z[N]?t[N]=z[N]:delete t[N];z.double_tap_action&&z.double_tap_action.action!=="none"?t.double_tap_action=z.double_tap_action:delete t.double_tap_action,this.emit_()});let w=()=>{c.textContent=ue(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ue(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ue(t)),h.hidden=!ue(t)};return this.koppen_.push(w),m.data={entity:t.entity||void 0},b.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},u.append(m,b,x),r.append(o,u),w(),r}emit_(){let e=Wi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};H("domotiapp-entities-card-editor",Fi);var Xn=class extends M{validate(e){let t=ol(e);return t.some(n=>n.items.some(ue))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[I]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?Z(e.tone):this.config.tone?Z(this.config.tone):Le(e.entity)!=="light"?A.accent:Mn(k(this.hass,e.entity))??A.lit}metSchakelaar_(e){return!!e.toggle&&ks(e.entity)}metTijd_(e){return!el(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!Li(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Yn(e)),this.style.containerType="inline-size";let t=Yn(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,u)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?Bn({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:qn[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Zn(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>ae(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(B(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(B(r,{onTap:()=>n("icon_tap_action",tt(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=nl(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=k(this.hass,t.entity),p=jt(t.entity,d.value,we(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(Pn(o,{value:()=>q(k(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>oe(k(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Zn(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let a=k(this.hass,n.entity),r=q(a),o=!!n.entity&&oe(a);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=D(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let _=An(this.hass,n.entity,n.icon),z=n.icon||(_?`pic:${_}`:ui(n.entity,F(this.hass,n.entity)));d.dataset.icon!==z&&(d.dataset.icon=z,d.classList.toggle("pic",!!_),d.innerHTML=_?`<img src="${_}" alt="" loading="lazy" />`:v(n.icon||ui(n.entity,F(this.hass,n.entity)))),d.style.setProperty("--tone",_?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(Kt(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),u=null;if(h){let _=o?null:Vi(a);h.dataset.soort!==(_??"")&&(h.dataset.soort=_??"",h.innerHTML=_?`<input class="tijd" type="${_}" step="60" />`:""),u=h.querySelector(".tijd")}if(u&&(u.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==u)){let _=tl(a,h.dataset.soort);u.value!==_&&(u.value=_)}let m=t.querySelector(".keuzeslot"),b=null;if(m){let _=o?[]:we(a),z=_.map(ne=>Un(ne,this.hass?.formatEntityState?.(a,ne))),N=JSON.stringify([_,z]);m.dataset.opties!==N&&(m.dataset.opties=N,m.innerHTML=_.length?`<select class="keuze">${_.map((ne,ge)=>`<option value="${y(ne)}">${y(z[ge])}</option>`).join("")}</select>`:""),b=m.querySelector(".keuze")}if(b&&(b.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==b)){let _=yt(a);b.value!==_&&(b.value=_)}let x=t.querySelector(".st"),w=n.show_state??this.config.show_state;if(p||u||b)x.textContent="";else if(w===!1)x.textContent="";else if(o)x.textContent="Niet bereikbaar";else if(!a||pi(a.entity_id))x.textContent="";else if(Le(a.entity_id)==="light"&&r&&a.attributes.brightness!=null)x.textContent=`${Math.round(a.attributes.brightness/255*100)}%`;else{let _=a.attributes.unit_of_measurement;x.textContent=_?`${a.state} ${_}`:ee(this.hass,a)}t.setAttribute("aria-label",`${l}${a?`, ${ee(this.hass,a)}`:""}`)})}getCardSize(){return Te(Gi(this.config))}getGridOptions(){let e=Te(Gi(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};j(Xn,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${Bi}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);L("domotiapp-entities-card",Xn,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Q={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},J=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),Et=i=>!i||i.state==="off",qi=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),qt=i=>i?.state==="playing",dl=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function cl(i){if(!i)return[];let e=[];return(J(i,Q.TURN_ON)||J(i,Q.TURN_OFF))&&e.push("power"),Et(i)||(J(i,Q.PREVIOUS_TRACK)&&e.push("prev"),J(i,Q.PLAY)||J(i,Q.PAUSE)||J(i,Q.PLAY_MEDIA)?e.push("play"):J(i,Q.STOP)&&e.push("stop"),J(i,Q.NEXT_TRACK)&&e.push("next")),e}var it=i=>i?.volume_entity||i?.entity;function Zi(i){if(!qi(i))return[];let e=[];return J(i,Q.VOLUME_MUTE)&&e.push("mute"),J(i,Q.VOLUME_SET)?e.push("slider"):J(i,Q.VOLUME_STEP)&&e.push("steps"),e}var Fe=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),pl=i=>i?.attributes?.volume_level!==void 0&&i?.attributes?.volume_level!==null,Zt=i=>!!i?.attributes?.is_volume_muted,Yi=i=>!!i?.attributes?.mass_player_type,Xi=i=>!!i?.attributes?.shuffle,Qi=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},hl=i=>({off:"all",all:"one",one:"off"})[Eu(i)]??"all",Eu=i=>["off","all","one"].includes(i)?i:"off";function Ji(i,{zoeken:e=!0,sleep:t=!1}={}){if(!qi(i))return[];let n=[];return J(i,Q.SHUFFLE_SET)&&n.push("shuffle"),J(i,Q.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&Yi(i)&&n.push("search"),n}function ul(i,{tonen:e=!0}={}){if(!e||!qi(i)||!J(i,Q.SELECT_SOURCE)||Yi(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Qn(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function Yt(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Au="domotiapp-media-speler:";function er(i,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],a=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(i?.players)&&i.players.length?[...new Set([...n(i?.entity)?[i.entity]:[],...i.players.filter(n)])]:Mu(a(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function Mu(i,e){let t=i.filter(n=>Yi(e?.states?.[n]));return t.length?t:i}var ml=i=>Au+(i??[]).join("|");function gl(i,e,t){if(!i?.speaker_select)return i?.entity??"";let n=null;try{n=t?.getItem?.(ml(e))??null}catch{n=null}return n&&e?.includes(n)?n:i.entity&&e?.includes(i.entity)?i.entity:i.entity||e?.[0]||""}function fl(i,e,t){try{return i?.setItem?.(ml(e),String(t)),!0}catch{return!1}}var tr="dacScrollSlot",bl=["position","top","left","right","width","overflow"];function Jn(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[tr])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(bl.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[tr]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of bl)t.style[o]=a[o];t.dataset&&delete t.dataset[tr],e?.scrollTo?.(0,n)}}}var Su=[400,1e3,2e3,4e3,8e3,15e3,3e4],Nu=6e4;function ie(i){let e=i?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(i?.message??""))}var se=class{constructor(e,{wachttijden:t=Su,traag:n=Nu,klok:a,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=a??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},je=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var Du=`
  :host {
    ${U}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,nr=null,vl=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ar=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),nr=nr??[X(Du)],this.shadowRoot.adoptedStyleSheets=nr}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=vl(e.title??"Weet je het zeker?"),this.$("p").innerHTML=vl(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};H("domotiapp-vraag",ar);function ze(i={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(i);return e.focus?.(),t}vs(ze);var kl=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var qe=i=>`domotiapp_lovelace/media/${i}`;function Lu(i,e){if(!i)return null;if(e)return i.uri?{type:qe("favorite"),favorite:!0,uri:i.uri}:null;let t=xl(i);return!t||!i.library_item_id?null:{type:qe("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function xl(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var wl={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},ir=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function _l(i,e,t=null){return i?.kind??xl(e)??t??"playlists"}var rr=i=>!!i?.uri,ea=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:qe("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),yl=(i,e,t)=>{let n=Lu(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},jl=(i,e)=>i.callWS({type:qe("playlist/create"),name:e}).then(t=>t?.playlist??null),zl=(i,e)=>i.callWS({type:qe("playlist/remove"),library_item_id:String(e.library_item_id)}),$l=(i,e)=>i.callWS({type:qe("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),El=(i,e,t)=>i.callWS({type:qe("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Al=(i,e,t)=>i.callWS({type:qe("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Tu=350,Ou={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Cu(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Ou[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Ru=`
  :host {
    ${U}
...
`,or=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=X(Ve+Ru)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[],this.zoekHerkansing_=new se(()=>this.zoek_()),this.speakerHerkansing_=new se(()=>this.haalSpeakers_())}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=Jn(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${ir.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
...
`,sr=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[X(Hu+Ve)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};H("domotiapp-bron-kiezer",sr);function Sl(i,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(i,e,t),n.focus?.(),n}function Nl(i,e){let t=i?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var Iu=524288;function Vu(i,e){let t=i?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&Iu)!==0}function lr(i,e,t){return e===t?"zelf":Vu(i,e)?Bu(i,e,t)?"mee":"los":"kan-niet"}function Bu(i,e,t){if(Nl(i,t).has(e))return!0;if(Nl(i,t).size===0){let n=i?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function Dl(i,e,t){let n=lr(i,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Pu=`
  :host {
    ${U}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,dr=null,ta=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),cr=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),dr=dr??[X(Pu)],this.shadowRoot.adoptedStyleSheets=dr,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="tel"></div>
        <div class="lijst" role="listbox"></div>
      </div>`,this.gebouwd_=!0;let e=(t,n,a)=>{t.addEventListener(n,a),this.opruimen_.push(()=>t.removeEventListener(n,a))};e(this.$(".sluit"),"click",()=>this.sluit()),e(this.$(".laag"),"click",t=>{t.target===this.$(".laag")&&this.sluit()}),e(this.$("input"),"input",t=>{this.filter_=t.target.value.trim().toLowerCase(),this.teken_()}),e(this.$("input"),"keydown",t=>{t.key==="Enter"&&this.$(".sp")?.click()}),e(this,"keydown",t=>{t.key==="Escape"&&this.hasAttribute("open")&&this.sluit()}),e(this.$(".lijst"),"click",t=>{let n=t.target.closest(".mee");if(n)return t.stopPropagation(),this.koppel_(n.dataset.id);let a=t.target.closest(".sp");a&&this.kies_(a.dataset.id)})}$(e){return this.shadowRoot.querySelector(e)}set hass(e){this.hass_=e,this.hasAttribute("open")&&this.gebouwd_&&this.teken_()}get hass(){return this.hass_}open(e,t,n,a){this.hass_=e,this.lijst_=Array.isArray(t)?t:[],this.huidig_=n,this.opKeuze_=a,this.filter_="",this.gebouwd_||this.bouw_(),this.$("input").value="",this.$(".zoek").hidden=this.lijst_.length<8,this.setAttribute("open",""),this.teken_(),this.$(".zoek").hidden||setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open")}teken_(){let e=this.lijst_,t=this.filter_?e.filter(a=>String(D(this.hass,a)).toLowerCase().includes(this.filter_)):[...e];this.$(".sub").textContent=this.huidig_?`Nu: ${D(this.hass,this.huidig_)}`:"",this.$(".tel").textContent=this.filter_?`${t.length} van ${e.length}`:`${e.length} speaker${e.length===1?"":"s"}`;let n=this.$(".lijst");if(!t.length){n.innerHTML='<div class="leeg">Niets gevonden.</div>';return}n.innerHTML=t.map(a=>{let r=k(this.hass,a),o=a===this.huidig_,s=Et(r)?"Uit":Qn(r,c=>ee(this.hass,c)),l=lr(this.hass,a,this.huidig_),d=l==="mee";return`<div class="rij">
                  <button class="sp" type="button" role="option" data-id="${ta(a)}"
                    data-speelt="${qt(r)}" data-uit="${Et(r)}"
                    aria-current="${o}" aria-selected="${o}">
                    <span class="ico">${v(Yt(r),"speaker")}</span>
                    <span class="tekst">
                      <b>${ta(D(this.hass,a))}</b>
                      <span>${ta(d?`${s} \xB7 speelt mee`:s)}</span>
                    </span>
                    ${o?'<span class="nu">NU</span>':""}
                  </button>
                  <button class="mee" type="button" data-id="${ta(a)}"
                ...
                </div>`}).join("")}koppel_(e){let t=Dl(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};H("domotiapp-speler-kiezer",cr);function Ll(i,e,t,n){let a=document.querySelector("domotiapp-speler-kiezer");return a||(a=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var pr=[15,30,45,60,90],hr=30;function Tl(i){let e=Math.max(0,Math.round(i)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),a=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(a).padStart(2,"0")}`}function ur(i,{min:e=1,max:t=720}={}){let n=String(i??"").trim();if(!/^\d+$/.test(n))return null;let a=Number(n);return a>=e&&a<=t?a:null}var Ku=`
  :host {
    ${U}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,mr=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=X(Ku)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
  ...
  `);var gr=class extends T{defaults(){return{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"}]}schema(){return[{name:"entity",selector:f.entity("media_player")},{name:"name",selector:f.text()},{name:"speaker_select",selector:f.bool()},{name:"players",selector:{entity:{domain:"media_player",multiple:!0}}},{name:"layout",selector:f.select([{value:"row",label:"Rij (\xE9\xE9n rasterrij hoog)"},{value:"groot",label:"Groot (telefoonformaat, grote knoppen)"}])},{name:"volume_entity",selector:f.entity("media_player")},{name:"show_artwork",selector:f.bool()},{name:"show_controls",selector:f.bool()},{name:"show_volume",selector:f.bool()},{name:"show_source",selector:f.bool()},{name:"radio_mode",selector:f.bool()},{name:"speakers",selector:{entity:{domain:"media_player",integration:"music_assistant",multiple:!0}}},{name:"show_search",selector:f.bool()},{name:"sleep_timer",selector:f.bool()},{name:"icon_tap_action",selector:f.action("toggle")},{name:"icon_hold_action",selector:f.action("more-info")},{name:"tap_action",selector:f.action("more-info")},{name:"hold_action",selector:f.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",speaker_select:"Algemene mediaspeler",players:"Welke speakers je mag kiezen",layout:"Vorm",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_source:"Bronknop tonen",radio_mode:"Doorspelen na een nummer",speakers:"Speakers om mee te groeperen",show_search:"Zoeken en groeperen tonen",sleep_timer:"Sleeptimer tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="speaker_select")return"De kaart krijgt er een balk bij waarmee je kiest waar de muziek heen gaat. De speler hierboven is de standaard; de keuze wordt per apparaat onthouden, dus je telefoon en de tablet in de gang kunnen op iets anders staan.";if(e.name==="players")return"Laat je dit leeg, dan staan de speakers van Music Assistant in de lijst -- geen televisies of streamers, want daar stuur je geen muziek naartoe. Vul je er zelf een paar in, dan is dat de lijst, wat er ook in staat.";if(e.name==="layout")return"Groot is bedoeld voor een pop-up of een kolom waar de kaart alle ruimte krijgt: grote hoes, grote knoppen.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="sleep_timer")return"Zet er een knop bij waarmee je instelt hoe lang de muziek nog mag doorspelen. De laatste seconden zakt het volume weg, daarna pauzeert de speler en gaat het volume terug naar waar het stond. De timer loopt in Home Assistant zelf, dus hij telt gewoon door als je je telefoon weglegt.";if(e.name==="speakers")return'De speakers die onderin het zoekscherm staan om samen te laten spelen. Laat je dit leeg op een algemene mediaspeler, dan zijn dat dezelfde speakers als in de keuzelijst; op een gewone kaart valt hij terug op het label "Music Assistant Media" in Home Assistant.';if(e.name==="radio_mode")return"Zoals Spotify: is het gekozen nummer klaar, dan zoekt Music Assistant er zelf muziek bij in plaats van te stoppen. Staat dit uit, dan kan het nog steeds per keer via het menu bij een treffer.";if(e.name==="show_source")return"Voor een tv-ontvanger of een versterker met ingangen: een knop met de zender die nu aanstaat, die een zoekbaar overzicht opent. Kan de speler geen bron kiezen, dan verschijnt hij niet.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};O("domotiapp-media-card-editor",gr);L("domotiapp-media-card",aa,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var Xt=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd",rust:"Geen"},{sleutel:"co",label:"Koolmonoxide",icoon:"co",alarm:"Koolmonoxide gedetecteerd",rust:"Geen"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm",rust:"Normaal"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],Cl=i=>i?.rust??"Rustig",fr=20;function br(i){if(!i||i.state==="unavailable"||i.state==="unknown")return null;if(String(i.entity_id??"").startsWith("binary_sensor."))return i.state==="on"?0:null;let e=Number(i.state);return Number.isFinite(e)?e:null}var Gu=i=>!!i&&i.state==="on",Wu=i=>!i||i.state==="unavailable"||i.state==="unknown";function Rl(i,e){let t=i.filter(a=>!a.meting);for(let a of t)if(Gu(e(a.sleutel)))return{soort:"alarm",tekst:a.alarm,tone:"bad",icoon:a.icoon};if(i.length&&i.every(a=>Wu(e(a.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smokeDetector"};let n=br(e("battery"));return n!=null&&n<=fr?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smokeDetector"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smokeDetector"}}var Uu={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},ia=class extends M{validate(e){return Xt.filter(n=>e[n.sleutel]).length?{...e}:{...e,[I]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return Xt.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return Xt.filter(e=>this.config[e.sleutel])}toestand_(){let e=Rl(this.gekozen_(),t=>k(this.hass,this.config[t]));return{...e,tone:Uu[e.tone]??A.accent}}batterijPct_(){return br(k(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare","");let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}" title="${t.label}">${v(t.icoon)}<b></b></span>`).join("");return`
      ...
      </div>`}wire(){let e=this.config,t=this.gekozen_()[0];this.teardown_.push(B(this.$(".top"),{onTap:()=>e.tap_action?ae(this,this.hass,e,e.tap_action):K(this,e.smoke??e[t.sleutel]),onHold:()=>ae(this,this.hass,e,e.hold_action??{action:"more-info"})})),this.$$(".pil").forEach(a=>{let r=e[a.dataset.soort];r&&(this.on(a,"click",o=>{o.stopPropagation(),K(this,r)}),this.on(a,"pointerdown",o=>o.stopPropagation()),a.style.cursor="pointer")});let n=this.$(".card");if(n&&typeof ResizeObserver=="function"){let a=new ResizeObserver(()=>this.pasAan_());a.observe(n),this.teardown_.push(()=>a.disconnect())}this.teardown_.push(V(this.$(".card")))}paint(){let e=this.config,t=this.toestand_(),n=this.$(".top");this.toggleAttribute("alarm",t.soort==="alarm"),n.style.setProperty("--tone",t.tone),n.classList.toggle("unavailable",t.soort==="weg");let a=this.$(".chip"),r=e.icon||t.icoon;a.dataset.icon!==r&&(a.dataset.icon=r,a.innerHTML=v(r,"smoke")),a.style.setProperty("--tone",t.tone);let o=this.gekozen_()[0];this.text(".nm",e.name||D(this.hass,e.smoke??e[o.sleutel],null)),this.text(".st",t.tekst),n.setAttribute("aria-label",`${this.$(".nm").textContent}${t.tekst?`, ${t.tekst}`:""}`),this.$$(".pil").forEach(s=>this.paintPil_(s)),this.$(".meta").hidden=this.gekozen_().length<=1&&!this.config.always_meta,this.pasAan_(),R(this.$(".card"))}pasAan_(){let e=this.$(".meta");if(!e||e.hidden)return;let t=()=>{let a=e.querySelector(".pil")?.offsetHeight??0;return a&&Math.round((e.scrollHeight+a/2)/a-.5)||1};this.removeAttribute("krapper"),!(t()<=1)&&this.setAttribute("krapper","")}paintPil_(e){let t=Xt.find(s=>s.sleutel===e.dataset.soort),n=k(this.hass,this.config[t.sleutel]),a=e.querySelector("b"),r=s=>e.setAttribute("aria-label",`${t.label}: ${s}`);if(!n||oe(n)){a.textContent="\u2014",r("onbekend"),e.dataset.let="";return}if(t.meting){let s=n.attributes.unit_of_measurement??"",l=Number(n.state);a.textContent=Number.isFinite(l)?`${G(this.hass,l,t.sleutel==="temperature"?1:0)} ${s}`.trim():ee(this.hass,n);let d=t.sleutel==="battery"?this.batterijPct_():null;e.dataset.let=d!=null&&d<=fr?"warn":"",r(a.textContent);return}let o=q(n);a.textContent=o?"Alarm":Cl(t),r(a.textContent),e.dataset.let=o?"bad":""}regels_(){return this.gekozen_().length>1?2:1}getCardSize(){return this.regels_()}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:this.minRijen_(".card",this.regels_())}}static getConfigElement(){return document.createElement("domotiapp-smoke-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("binary_sensor.")&&/rook|smoke/i.test(a));return n?{smoke:n}:{}}};j(ia,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var kr=class extends T{defaults(){return{show_current:!0,forecast_type:"daily",days:Hl}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:f.entity("weather")},{name:"name",selector:f.text()},{name:"forecast_type",selector:f.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:f.number(1,Il)},{name:"show_current",selector:f.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};O("domotiapp-forecast-card-editor",kr);L("domotiapp-forecast-card",ra,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var At={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},Vl={open_cover:At.OPEN,close_cover:At.CLOSE,stop_cover:At.STOP},Bl=(i={},e={},t)=>i[t]??e[t],xr=(i,e)=>!!Bl(i,e,"poort"),wr=(i,e)=>!!Bl(i,e,"invert");function Pl(i={},e=!1){if(e||i.device_class==="gate")return{open:"gateOpen",closed:"gate"};switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}}var Kl=i=>i?{open:"Openen",close:"Sluiten"}:{open:"Open",close:"Dicht"},qu={open:"closed",closed:"open",opening:"closing",closing:"opening"},Gl=(i,e)=>e?qu[i]??i:i,oa=(i,e)=>e&&i!=null?100-i:i;function _r(i,e){if(i==="stop")return"stop_cover";let t=i==="open";return(e?!t:t)?"open_cover":"close_cover"}function Wl({state:i,positie:e,aanname:t}){return e!=null?e>0?"open":"closed":i==="open"||i==="closed"?i:t??"closed"}function Ul({dood:i,state:e,positie:t,toon:n=!0}){return i?"Niet bereikbaar":n?e==="opening"?"Gaat open":e==="closing"?"Gaat dicht":t!=null?`${t}% open`:e==="open"?"Open":e==="closed"?"Dicht":"":""}var yr=(i,e)=>!!((i?.attributes?.supported_features??0)&e),sa=class extends M{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[I]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e,t){let n=Kl(t),a=(r,o,s)=>`<button type="button" class="${t?"tekst":""}" data-act="${r}" aria-label="${o}">${s}</button>`;return`
      <div class="keys${t?" woorden":""}">
        ${a("open",n.open,t?n.open:S.arrowUp)}
        ${e?`<button type="button" data-act="stop" aria-label="Stop">${S.stop}</button>`:""}
        ${a("close",n.close,t?n.close:S.arrowDown)}
      ...
      <div class="cv" data-i="${a}" data-shown="closed" style="--tone:${Z(n.tone??e.tone,"solar")}">
        ...
        ${this.keysHtml(e.show_stop!==!1,xr(n,e))}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o=this.config.covers[+t];this.hass.callService("cover",_r(r,wr(o,this.config)),{entity_id:o.entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(B(e.querySelector(".chip"),{onTap:()=>K(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=k(this.hass,n.entity),r=F(this.hass,n.entity),o=!a||a.state==="unavailable",s=wr(n,this.config),l=xr(n,this.config),d=Gl(a?.state??"unknown",s);e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=D(this.hass,n.entity,n.name);let c=yr(a,At.SET_POSITION)&&r.current_position!=null,p=c?oa(r.current_position,s):null,h=Wl({state:d,positie:p,aanname:this.assumed_.get(t)});e.dataset.shown=h;let u=Pl(r,l),m=(h==="open"?n.icon_open:n.icon_closed)??(h==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??u[h],b=e.querySelector(".chip");b.dataset.icon!==m&&(b.dataset.icon=m,b.innerHTML=v(m,u[h]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=Ul({dood:o,state:d,positie:p,toon:this.toonStatus_()})),e.querySelectorAll(".keys button").forEach(z=>{let N=_r(z.dataset.act,s);z.disabled=o||!yr(a,Vl[N])});let w=e.querySelector(".pos"),_=c&&this.config.show_position!==!1;if(w.hidden=!_,_){if(w.dataset.built||(w.dataset.built="1",w.innerHTML=xe("position"),w.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let N=w.querySelector(".slider"),ne=ge=>{N.style.setProperty("--v",`${ge}%`),N.setAttribute("aria-valuenow",String(ge)),this.toonStatus_()&&(e.querySelector(".st").textContent=`${ge}% open`)};this.teardown_.push(Pe(N,{value:()=>oa(F(this.hass,n.entity).current_position??0,s),onInput:ne,onCommit:ge=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:oa(ge,s)})}))}let z=w.querySelector(".slider");if(!z.classList.contains("dragging")){let N=p??0;z.style.setProperty("--v",`${N}%`),z.setAttribute("aria-valuenow",String(N))}}})}toonStatus_(){return this.config.show_state!==!1}rows_(){let e=this.config?.covers??[],t=e.some(n=>yr(k(this.hass,n.entity),At.SET_POSITION));return Te(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};j(sa,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var jr=class extends T{defaults(){return{show_stop:!0,show_position:!0,show_state:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(a=>typeof a=="string"?{entity:a}:a);t.covers=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name),a.poort&&(t[`poort:${a.entity}`]=!0),a.invert&&(t[`invert:${a.entity}`]=!0);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(a=>{let r={};return t[`naam:${a}`]&&(r.name=t[`naam:${a}`]),t[`poort:${a}`]&&(r.poort=!0),t[`invert:${a}`]&&(r.invert=!0),Object.keys(r).length?{entity:a,...r}:a});for(let a of Object.keys(t))/^(naam|poort|invert):/.test(a)&&delete t[a];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.flatMap(t=>[{name:`naam:${t}`,selector:f.text()},{name:`poort:${t}`,selector:f.bool()},{name:`invert:${t}`,selector:f.bool()}]),{name:"show_stop",selector:f.bool()},{name:"show_state",selector:f.bool()}]}naamVan_(e){return this.config_?.[`naam:${e}`]||this.hass?.states?.[e]?.attributes?.friendly_name||e}label(e){return e.name.startsWith("naam:")?`Naam voor ${this.naamVan_(e.name.slice(5))}`:e.name.startsWith("poort:")?`${this.naamVan_(e.name.slice(6))} is een poort`:e.name.startsWith("invert:")?`${this.naamVan_(e.name.slice(7))} omgekeerd aangesloten`:{covers:"Rolluiken",show_stop:"Stopknop tonen",show_state:"Status tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten.";if(e.name.startsWith("poort:"))return"Zet pijltjes om in Openen en Sluiten, en geeft een poorticoon. Een poort schuift opzij, dus omhoog en omlaag zeggen er niets over.";if(e.name.startsWith("invert:"))return"Voor een motor die andersom is aangesloten: open wordt dicht en dicht wordt open. De knoppen, de status en de schuif draaien samen om.";if(e.name==="show_state")return"Haalt de regel Open, Dicht of het percentage onder de naam weg. Niet bereikbaar blijft altijd staan."}};O("domotiapp-cover-card-editor",jr);L("domotiapp-cover-card",sa,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Zu(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var la=class extends M{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[I]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var zr=class extends T{setConfig(e){let t={...e},n=(e.persons??[]).map(a=>typeof a=="string"?{entity:a}:a);t.persons=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(a=>{let r=t[`naam:${a}`];return r?{entity:a,name:r}:a});for(let a of Object.keys(t))a.startsWith("naam:")&&delete t[a];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};O("domotiapp-person-card-editor",zr);L("domotiapp-person-card",la,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var $r=i=>String(i??"").trim().split(/\s+/).filter(Boolean);function Yu(i){let e=$r(i);return e.filter((n,a)=>a===0||n.toLowerCase()!==e[a-1].toLowerCase()).join(" ")}function Xu(i){let e=i.map($r).filter(a=>a.length);if(e.length<2)return 0;let t=0,n=Math.min(...e.map(a=>a.length));for(;t<n;){let a=e[0][t].toLowerCase();if(!e.every(r=>r[t].toLowerCase()===a))break;t++}return Math.min(t,n-1)}function Qt(i){let e=i.map(n=>Yu(n)),t=Xu(e);return e.map(n=>{let a=$r(n),r=a.slice(t);return(r.length?r:a).join(" ")})}var Qu=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function Ju(i){for(let[e,t,n]of Qu)if(e.test(i))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var Fl={"geen datum":"geen datum",voorbij:"is geweest","bestaat niet":"sensor ontbreekt"},ql=i=>String(i??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),da=class extends M{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[I]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}wire(){this.breed_()&&this.teardown_.push(V(this.$(".card")))}read_(){let e=new Date,t=this.config.sensors.map(r=>{let o=k(this.hass,r.entity),s=o?fe(o.state)??fe(o.attributes.date)??fe(o.attributes.next_date)??fe(o.attributes.Year_month_day_date):null;return{cfg:r,st:o,date:s}}),n=t.map(r=>ql(D(this.hass,r.cfg.entity,r.cfg.name))),a=Qt(n);return t.map((r,o)=>{let s=r.cfg.label??a[o]??n[o],l=Ju(r.cfg.label??r.cfg.entity+s),d=this.config.tones?.[r.cfg.entity];return{label:s,entity:r.cfg.entity,date:r.date,days:r.date?vt(e,r.date):null,tone:Z(d??r.cfg.tone??l.tone),icon:r.cfg.icon??l.icon,reden:r.st?r.date?vt(e,r.date)<0?"voorbij":null:"geen datum":"bestaat niet"}}).sort((r,o)=>!r.reden&&!o.reden?r.date-o.date:r.reden?o.reden?r.label.localeCompare(o.label):1:-1)}komend_(e){return e.filter(t=>!t.reden)}breed_(){return this.config.layout==="breed"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("vorm",this.breed_()?"breed":"lijst"),this.breed_()?`
      <div class="card surface">
        <div class="rij">
  ...
  `);var Er=class extends T{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){let e=this.ids_(),t=Qt(e.map(n=>ql(this.hass?.states?.[n]?.attributes?.friendly_name??n)||n));return e.map((n,a)=>({key:`kleur:${n}`,kind:"tone",label:`Kleur voor ${t[a]||n}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"layout",selector:f.select([{value:"lijst",label:"Lijst (eerstvolgende uitgelicht)"},{value:"breed",label:"Over de breedte (veel lager)"}])}]}label(e){return{sensors:"Afvalsensoren",layout:"Vorm",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="layout")return"Over de breedte zet alle bakken naast elkaar in plaats van onder elkaar. Vier bakken passen dan op \xE9\xE9n rasterrij in plaats van vier \u2014 dat scheelt bijna tweehonderd pixels. De eerstvolgende licht op.";if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};O("domotiapp-waste-card-editor",Er);L("domotiapp-waste-card",da,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function rt(i){if(i==null||i==="")return 4;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function ca(i,e=!0){if(typeof i=="string")return{name:"",icon:"",path:i,action:null,items:[]};let t=i??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",action:t.action&&typeof t.action=="object"?{...t.action}:null,items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>ca(n,!1)):[]}}var Ze=i=>Array.isArray(i?.items)?i.items.filter(Ye):[],Zl=i=>Ze(i).length>0,Ye=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.path?.trim()||i.action));function Yl(i){return(Array.isArray(i?.items)?i.items:[]).slice(0,20).map(t=>ca(t))}var Xl=[{id:"domotitech",label:"DomotiTech",uitleg:"Opent domotitech.nl in een nieuw tabblad, met het logo erop.",bovenaan:!0,maak:()=>({name:"DomotiTech",icon:"domotitech",path:"https://domotitech.nl",action:null,items:[]})},{id:"herstart",label:"Herstart Home Assistant",uitleg:"Roept homeassistant.restart aan, met een bevestiging ervoor.",bovenaan:!0,maak:()=>({name:"Herstart",icon:"power",path:"",action:{action:"perform-action",perform_action:"homeassistant.restart",confirmation:{title:"Weet je het zeker?",text:"Weet je het zeker dat je Home Assistant wilt herstarten?"}},items:[]})}];function Ql(i,e,t=!1){let n=Array.isArray(i)?[...i]:[];if(n.length>=8)return{lijst:n,plek:-1};let a=t?0:n.length;return n.splice(a,0,e),{lijst:n,plek:a}}function pa(i,e=4){let t=(i??[]).filter(Ye),n=rt(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let a=Math.max(1,n-1);return{balk:t.slice(0,a),meer:t.slice(a),heeftMeer:!0}}function Ar(i){if(i&&typeof i=="object")return i.action?i.action:Ar(i.path);let e=String(i??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var nm=`
...
`,Jl=/^i(\d+)(s\d+)?$/,ed=i=>({...i.name?{name:i.name}:{},...i.icon?{icon:i.icon}:{},...i.path?{path:i.path}:{},...i.action?{action:structuredClone(i.action)}:{}}),td=i=>i.filter(Ye).map(e=>{let t=(e.items??[]).filter(Ye).map(ed);return{...ed(e),...t.length?{items:t}:{}}}),Mr=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(n=>ca(n));this.gebouwd_&&JSON.stringify(td(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=nm;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:a}=pa(this.items_,this.rest_.max),r=a.length,o=this.items_.filter(Ye);if(this.items_.forEach((l,d)=>{if(o.indexOf(l)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(l,d))}),!this.items_.length){let l=document.createElement("p");l.className="uitleg",l.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(l)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${rt(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:rt(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=rt(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{let x=!Ye(e);n.dataset.leeg=String(x),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||(x?"Nieuwe knop":e.path||"Zonder naam");let w=Ze(e).length;l.textContent=w?`Menu met ${w} knop${w===1?"":"pen"}`:e.path?e.path:e.icon?`${Be(e.icon)} -- nog geen pad`:"Nog geen pad"};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let h=this.kopKnop_("Verwijderen",S.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let u=document.createElement("div");u.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let b=document.createElement("ha-form");return b.hass=this.hass_,b.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],b.computeLabel=x=>({name:"Naam",path:"Waar gaat hij heen"})[x.name]??x.name,b.computeHelper=x=>{if(x.name!=="path")return;let w="/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.";return Zl(e)?`${w}

Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:w},b.data={name:e.name,path:e.path},b.addEventListener("value-changed",x=>{x.stopPropagation();let w=x.detail.value??{};e.name=w.name??"",e.path=w.path??"",this.emit_()}),u.append(m,b,...this.subBlok_(e,t)),n.appendChild(u),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let a=document.createElement("div");a.className="sublijst",e.items.forEach((s,l)=>a.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,a,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let a=document.createElement("summary");a.textContent="\uFF0B  Subknop toevoegen",n.appendChild(a);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=Ql(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of Xl){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,a){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=v(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",a),r}subItemBlok_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=v(t.icon,"grid"),d.textContent=t.name||(Ye(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaatsSub_(e,n,a,-1));h.disabled=a===0;let u=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaatsSub_(e,n,a,1));u.disabled=a===e.items.length-1;let m=this.kopKnop_("Verwijderen",S.close,()=>this.verwijderSub_(e,n,a));m.classList.add("weg"),o.append(s,l,h,u,m),r.appendChild(o);let b=document.createElement("div");b.className="body";let x=document.createElement("dac-icon-picker");x.label="Icoon",x.fallback="grid",x.auto=!1,x.hass=this.hass_,x.value=t.icon,x.addEventListener("value-changed",_=>{_.stopPropagation(),t.icon=_.detail.value??"",this.emit_()});let w=document.createElement("ha-form");return w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],w.computeLabel=_=>({name:"Naam",path:"Waar gaat hij heen"})[_.name]??_.name,t.action&&(w.schema=[{name:"name",selector:{text:{}}}],w.computeHelper=_=>_.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),w.data={name:t.name,path:t.path},w.addEventListener("value-changed",_=>{_.stopPropagation();let z=_.detail.value??{};t.name=z.name??"",t.path=z.path??"",this.emit_()}),b.append(x,w),r.appendChild(b),r}verplaatsSub_(e,t,n,a){let r=n+a;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let a=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){a.add(r);continue}let s=Number(o[2]);s!==n&&a.add(`i${t}s${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Jl.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(`i${r>e?r-1:r}${a[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let a of this.open_){let r=Jl.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(a)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=td(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};H("domotiapp-navbar-card-editor",Mr);var nd=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Jt(i){let e=nd(i),t=0;for(;e&&t++<40;)yield e,e=nd(e)}function am(i){for(let e of Jt(i)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function im(i){for(let e of Jt(i))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function rm(i){for(let e of Jt(i))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function om(i){for(let e of Jt(i))if(e.classList?.contains?.("section"))return e;return null}function ad(i){for(let e of Jt(i)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var ha=class extends M{validate(e){let t=Yl(e),n={labels:!0,tone:"accent",...e,items:t,max:rt(e?.max)};return t.filter(a=>a.name||a.icon||a.path).length||(n[I]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:a}=pa(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let u=Ze(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      ...
      <div class="regel kop">
        <span class="mi">${v(c.icon,"grid")}</span>
        <span class="mt">${y(c.name||c.path)}</span>
      </div>`+h.map((m,b)=>s(m,p,b,"sub")).join(""):s(c,p)}).join(""),d=t.map(c=>{let p=Ze(c);if(!p.length)return"";let h=r.indexOf(c);return`<div class="menu submenu" data-id="s${h}" role="menu">${p.map((u,m)=>s(u,h,m)).join("")}</div>`}).join("");return`
  ...
  `);L("domotiapp-navbar-card",ha,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var sm="dac-tabs:";function Dr(i){let e=i??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],a=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:a}}var ua=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.cards?.length));function id(i){return(Array.isArray(i?.tabs)?i.tabs:[]).slice(0,8).map(Dr).filter(ua)}function lm(i,e){if(!e)return 0;let t=Math.round(Number(i?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function Lr(i){let e=(i??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return sm+e}function dm(i,e,t){let n=null;try{n=i?.getItem?.(e)??null}catch{return null}let a=Number(n);return n===null||n===""||!Number.isInteger(a)?null:a>=0&&a<t?a:null}function rd(i,e,t){try{return i?.setItem?.(e,String(t)),!0}catch{return!1}}function od(i,e,t){return dm(t,Lr(e),e.length)??lm(i,e.length)}var cm=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function sd(){let i=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return i.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,a=t.type.startsWith("custom:domotiapp-")?0:1;return n-a||e.naam.localeCompare(t.naam,"nl")}),[...i,...cm.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function ld(i,e){let t=String(e??"").trim().toLowerCase();return t?i.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):i}async function dd(i,e){let t={type:i};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let a=i.startsWith("custom:")?i.slice(7):`hui-${i}-card`,o=await customElements.get(a)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:i}}catch{}return t}var cd=()=>!!customElements.get("hui-card-element-editor");function pd(i,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},a=i,r=n(e),o=n(t);return r!==null&&(a=Math.max(a,r)),o!==null&&(a=Math.min(a,o)),a}function pm(i,e){let t=i?.columns,n=i?.rows,a=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));a=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}a=Math.min(12,Math.max(1,pd(a,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${a}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,pd(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function en(i,e,t){if(!i?.style)return;let{gridColumn:n,height:a}=pm(e,t);i.style.gridColumn=n,i.style.height=a??""}function hd(i){let e=i?._element??i?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function ud(i,e,t={}){let n=Array.isArray(i)?[...i]:[],a=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(a)||!n[a]?null:(n.splice(a+1,0,structuredClone(n[a])),n);case"verwijder":return!Number.isInteger(a)||!n[a]?null:(n.splice(a,1),n);case"rooster":return!Number.isInteger(a)||!n[a]||!t.rooster?null:(n[a]={...n[a],grid_options:{...n[a].grid_options??{},...t.rooster}},n);default:return null}}var md=i=>({...i?{config:i}:{},editMode:!0,saveConfig:async()=>{}}),hm=()=>document.querySelector("home-assistant");function gd({kaarten:i,hass:e,maakKaart:t,opActie:n}){let a=document.createElement("ha-sortable");a.disabled=!1,a.draggableSelector=".dac-kaart",a.rollback=!1,a.invertSwap=!0,a.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];i.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",en(h,d?.grid_options);let u=document.createElement("hui-card-edit-mode");u.hass=e,u.lovelace=md(),u.path=[0,0,c],u.hiddenOverlay=!1,u.appendChild(p),o.push(u),h.appendChild(u),r.appendChild(h)}),a.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};a.addEventListener("drag-start",()=>s(!1)),a.addEventListener("drag-end",()=>s(!0)),a.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))a.addEventListener(d,p=>{p.stopPropagation(),c(p)});return a}function fd(i){try{let e=typeof structuredClone=="function"?structuredClone(i):JSON.parse(JSON.stringify(i));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function bd({hass:i,kaarten:e}){let t=hm();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let a=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(a?{kaart:a}:r?{kaarten:r}:null))},l=u=>{if(u?.detail?.dialogTag!=="hui-dialog-edit-card")return;let m=u.detail?.dialogParams?.cardConfig;u.stopImmediatePropagation?.(),u.stopPropagation(),m&&(a=m);let b=t.querySelector("hui-dialog-create-card");typeof b?.closeDialog=="function"&&b.closeDialog(),setTimeout(s,0)},d=u=>{u?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=i,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...md({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async u=>{let m=u?.views?.[0]?.sections?.[0]?.cards;Array.isArray(m)&&(r=m)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let u=p._layoutElement;if(!u)throw new Error("de proxysectie heeft geen layout-element");u.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(u){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",u),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var ma=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var um=`
...
`,kd=i=>i.filter(ua).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function Mt(i){let e=String(i?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function Tr(i){let e=i.cards?.length??0;return e?e===1?Mt(i.cards[0]):`${e} kaarten`:"Nog geen kaart"}var Or=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(Dr);this.gebouwd_&&JSON.stringify(kd(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=um;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let a=document.createElement("button");a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Tabblad toevoegen",a.disabled=this.tabs_.length>=8,a.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(a)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},a=Number(n.default_tab);Number.isFinite(a)&&a>1?this.rest_.default_tab=a:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!ua(e)),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=Tr(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",S.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let u=document.createElement("div");u.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let b=document.createElement("ha-form");return b.hass=this.hass_,b.schema=[{name:"name",selector:{text:{}}}],b.computeLabel=()=>"Naam",b.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",b.data={name:e.name},b.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),u.append(m,b,this.inhoudBlok_(e,t)),n.appendChild(u),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!cd()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>Inhoud: <b>${Tr(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(ma()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>${e.cards.length?`<b>${Tr(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let a=document.createElement("button");return a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Kaart toevoegen",a.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(a),n}uitVoorbeeld(e,t,n){let a=this.tabs_[e];if(a){if(t==="toevoegen"){this.voegToeViaHa_(a,e);return}this.kaartActie_(a,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,a=Number.isInteger(t)?this.tabs_[t]:null;if(!a||!a.cards[n]){e?.remove();return}let r=this.bewerkVak_(a,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,a){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==a.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:a.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){fd(e.cards[a.index]);return}let r=ud(e.cards,n,a);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let a=document.createElement("div");a.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=Mt(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&a.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=Mt(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||a.append(r,l),a}kaartTabbladen_(e,t,n,a,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let u of l.querySelectorAll("button"))u.setAttribute("aria-selected",String(u.dataset.blad===h));a.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let u=document.createElement("button");u.type="button",u.dataset.blad=h.id,u.textContent=h.naam,u.setAttribute("role","tab"),u.setAttribute("aria-selected","false"),u.addEventListener("click",()=>c(h.id)),l.appendChild(u)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,a,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[a],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[a]=l,o.config=l,this.emit_(),r.textContent=Mt(l))}),o}async voegToeViaHa_(e,t){let n=await bd({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=v("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=Mt(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaatsKaart_(e,n,a,-1));p.disabled=a===0;let h=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaatsKaart_(e,n,a,1));h.disabled=a===e.cards.length-1;let u=this.kopKnop_("Verwijderen",S.close,()=>this.verwijderKaart_(e,n,a));u.classList.add("weg"),o.append(s,l,p,h,u),r.appendChild(o);let m=document.createElement("div");m.className="body";let b=document.createElement("hui-card-element-editor");return b.hass=this.hass_,this.lovelace_&&(b.lovelace=this.lovelace_),b.value=t,b.addEventListener("config-changed",x=>{x.stopPropagation();let w=x.detail?.config;w&&(e.cards[a]=w,this.emit_(),d.textContent=Mt(w),c.textContent=String(w.type??""))}),b.addEventListener("GUImode-changed",x=>x.stopPropagation()),m.appendChild(b),r.appendChild(m),r}verplaatsKaart_(e,t,n,a){let r=n+a;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let a=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){a.add(r);continue}let s=Number(o[1]);s!==n&&a.add(`t${t}k${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let a=document.createElement("input");a.type="text",a.placeholder="Zoek een kaart...",a.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=ld(sd(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await dd(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),a.addEventListener("input",()=>{this.zoek_=a.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(a,r,s),n}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let a=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),a&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Number(n.slice(1));a!==e&&t.add(`t${a>e?a-1:a}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=kd(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};H("domotiapp-tabs-card-editor",Or);var xd=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*_d(i){let e=xd(i),t=0;for(;e&&t++<40;)yield e,e=xd(e)}function wd(i){let e=null;for(let n of _d(i))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,a=0)=>{if(!n||a>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,a+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,a+1);if(o)return o}return null};return t(e)}var fa=class extends M{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=id(e),n={tone:"accent",...e,tabs:t};return t.length||(n[I]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((a,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(V(this.$(".card"))),this.kies_(od(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let a=Math.min(Math.max(0,e),n.length-1);this.open_=a;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===a));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===a);t&&rd(this.opslag_(),Lr(n),a),this.bouw_(a)}async bouw_(e){if(this.kinderen_.has(e)){R(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let a=document.createElement("div");a.className="leeg",a.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(a),R(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=wd(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,en(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&ma()){t.replaceChildren(gd({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),R(this.$(".card"));return}t.replaceChildren(...s),R(this.$(".card")),this.herijkIndeling_()}catch(a){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${y(a?.message??a)}</div>`,R(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,a]of this.kinderen_.entries()){if(!a)continue;let r=this.config?.tabs?.[n]?.cards??[];a.forEach((o,s)=>{let l=hd(o);l&&(t=!0),en(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),R(this.$(".card"));return}if(t<=0)return;let a=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(a))}inVoorbeeld_(){for(let e of _d(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),wd(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};j(fa,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);L("domotiapp-tabs-card",fa,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var Y={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},mm=[[Y.FOUT,["error","fout","aborting","afgebroken"]],[Y.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[Y.PAUZE,["pause","paused","pauze","onderbroken"]],[Y.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[Y.AF,["finished","complete","done","klaar met","afgelopen"]],[Y.KLAAR,["ready","idle","standby","klaar","gereed"]],[Y.UIT,["off","inactive","uit"]]],gm=new Set([Y.DRAAIT]);function jd(i){let e=String(i??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return Y.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,a]of mm)for(let r of a)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return Y.ONBEKEND}var zd=i=>gm.has(jd(i?.state));function $d(i,e=new Date){if(!i)return null;let t=String(i.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=i.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let a=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(a)return Number(a[1])*60+Number(a[2])+(a[3]?Math.round(Number(a[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function yd(i){if(i==null)return"";if(i<=0)return"Klaar";if(i<60)return`nog ${i} min`;let e=Math.floor(i/60),t=i%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Ed(i){if(!i)return null;let e=String(i.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var fm=i=>!!i&&i.state==="on",Ad=i=>i===Y.DRAAIT||i===Y.PAUZE||i===Y.UITGESTELD;function Md({status:i,deur:e,rest:t,pct:n}={}){let a=jd(i?.state),r=fm(e);if(a===Y.DRAAIT){let o=[];return t!=null?o.push(yd(t)):n!=null&&o.push(`${n}%`),{soort:a,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return a===Y.PAUZE?{soort:a,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:a===Y.FOUT?{soort:a,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:a===Y.AF?{soort:a,tekst:"Programma klaar",tone:"good",waarschuwing:""}:a===Y.UITGESTELD?{soort:a,tekst:t!=null?`Start over ${yd(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:a,tekst:"Klep open",tone:"warn",waarschuwing:""}:a===Y.UIT?{soort:a,tekst:"Uit",tone:"neutral",waarschuwing:""}:a===Y.KLAAR?{soort:a,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:Y.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function Sd(i){let e=String(i??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var bm={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},ba=class extends M{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[I]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,a,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var Cr=class extends T{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"program",selector:f.entity(["select","input_select"])},{name:"start",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"smart",selector:f.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};O("domotiapp-dishwasher-card-editor",Cr);L("domotiapp-dishwasher-card",ba,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});function vm(i,e,t,{live:n=!1,fit:a="cover"}={}){if(!t)return null;let r=typeof customElements<"u"&&customElements.get("hui-image"),o=r?"hui-image":"img",s=i;if((!s||s.localName!==o)&&(s=document.createElement(o),s.className="beeld"),r){let l=n?"live":"auto";s.cameraImage!==t&&(s.cameraImage=t),s.cameraView!==l&&(s.cameraView=l),s.fitMode!==a&&(s.fitMode=a),s.hass=e}else{let l=e?.states?.[t],d=l?.attributes?.entity_picture;d&&s.dataset.bron!==d&&(s.dataset.bron=d,s.src=d),s.alt=l?.attributes?.friendly_name??t,s.style.objectFit=a}return s}function va(i,e,t,n){if(!i)return null;let a=i.querySelector(".beeld"),r=vm(a,e,t,n);return r?(r!==a&&(a?.remove(),i.appendChild(r)),r):(a?.remove(),null)}var Rr={idle:{woord:"Klaar voor gebruik",toon:"neutral"},printing:{woord:"Aan het printen",toon:"accent"},paused:{woord:"Gepauzeerd",toon:"warn"},finished:{woord:"Klaar",toon:"good"},failed:{woord:"Mislukt",toon:"bad"},offline:{woord:"Offline",toon:"neutral"},prepare:{woord:"Voorbereiden",toon:"accent"},unknown:{woord:"Onbekend",toon:"neutral"}},km={idle:["idle","operational","standby","ready","on","off"],printing:["printing","running","run","print","busy","active"],paused:["pause","paused","pausing"],finished:["finish","finished","complete","completed","done","success"],failed:["failed","fail","error","cancelled","canceled","stopped"],prepare:["prepare","preparing","heating","slicing","init"],offline:["offline","unavailable","unknown","disconnected"]};function Hr(i){let e=String(i?.state??"").trim().toLowerCase();if(!e)return"unknown";if(e==="unavailable"||e==="none")return"offline";for(let[t,n]of Object.entries(km))if(n.includes(e))return t;return"unknown"}function ka(i){let e=Hr(i);return e==="printing"||e==="prepare"}function Ir(i){let e=Number(i?.state);return Number.isFinite(e)?Math.max(0,Math.min(100,Math.round(e))):null}function Vr(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"\xB0C"}:null}function Br(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let o=Date.parse(t);if(Number.isFinite(o))return Math.max(0,Math.round((o-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let o=t.split(":").map(Number),[s,l]=o.length===3?o:[0,o[0]];return s*60+l}let a=Number(t);if(!Number.isFinite(a))return null;let r=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return r==="h"||r==="u"||r.startsWith("hour")?Math.round(a*60):r==="s"||r.startsWith("sec")?Math.round(a/60):Math.round(a)}function Pr(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function Kr(i,e=new Date){if(i==null)return"";let t=new Date(e.getTime()+i*6e4);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var xm=new Set(["unknown","unavailable","none","null","empty","leeg","off","unload","unloaded"]);function ot(i,{namen:e=!1}={}){if(typeof i!="string")return null;let t=i.trim();if(!t)return null;let n=t.replace(/^#/,"");return/^[0-9a-f]{8}$/i.test(n)?parseInt(n.slice(6),16)<16?null:`#${n.slice(0,6).toUpperCase()}`:/^[0-9a-f]{6}$/i.test(n)?`#${n.toUpperCase()}`:/^[0-9a-f]{3}$/i.test(n)?`#${n.toUpperCase()}`:/^rgba?\(/i.test(t)?t:!e||xm.has(t.toLowerCase())?null:/^[a-z]+$/i.test(t)?t:null}function Nd(i,e={}){let t=i?.attributes??{},n=ot(e.color,{namen:!0})??ot(t.color)??ot(Array.isArray(t.cols)?t.cols[0]:t.cols)??ot(t.filament_color)??ot(t.tray_color)??(/^#?[0-9a-f]{3,8}$/i.test(String(i?.state??""))?ot(i.state):null)??null,a=e.label||t.type||t.filament_type||t.tray_type||t.name||(i&&!ot(i.state)?i.state:"")||"",r=t.empty===!0||t.empty==="true"?!0:!n&&!String(a).trim(),o=Number(t.remain??t.remaining),s=t.remain_enabled!==!1&&!r;return{kleur:r?null:n,soort:String(a).trim(),leeg:r,actief:t.active===!0||t.active==="true",rest:s&&Number.isFinite(o)&&o>=0&&o<=100?Math.round(o):null}}var St=[1,2,3,4],wm={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},xa=class extends M{validate(e){let t={name:"",icon:"printer3d",...e};return t.status||t.progress||t.camera||t.image||t.nozzle_temp||t.bed_temp||t.power||(t[I]="Kies minstens een printstatus. Camera, voortgang, temperaturen, de deur en de trays van de AMS mogen daarna."),t}watched(){let e=this.config;return[e.status,e.progress,e.remaining,e.nozzle_temp,e.bed_temp,e.door,e.power,e.camera,e.image,...St.map(t=>e[`tray_${t}`])].filter(Boolean)}beeldSoort_(){let e=this.config;return e.camera&&e.image?this.beeld_??(ka(k(this.hass,e.status))?"camera":"image"):e.camera?"camera":e.image?"image":null}template(){return this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`
      <div class="card surface" style="--tone:${A.accent}">
        <div class="kop">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(V(this.$(".card"))),this.on(this.$(".ico"),"click",()=>K(this,e.status||e.power||e.camera||e.progress));let t=this.$(".aanuit");this.on(t,"click",a=>{a.stopPropagation(),this.schakel_()});let n=this.$(".wissel");this.on(n,"click",a=>{a.stopPropagation(),this.beeld_=this.beeldSoort_()==="camera"?"image":"camera",this.paint()}),this.on(this.$(".beeldvak"),"click",a=>{if(a.target.closest(".wissel"))return;let r=this.beeldSoort_()==="camera"?e.camera:e.image;r&&K(this,r)})}async schakel_(){let e=this.config.power;if(!e)return;let t=k(this.hass,e),n=q(t),a=String(e).split(".")[0];if(n){let r=Ir(k(this.hass,this.config.progress)),o=ka(k(this.hass,this.config.status));if(!await ze({title:"Printer uitzetten?",text:o?`Er loopt een print${r===null?"":` (${r}% klaar)`}. Uitzetten breekt hem af, en dat is niet terug te draaien.`:"Weet je zeker dat je de printer wilt uitzetten?",confirmText:"Uitzetten",dismissText:"Aan laten"}))return}this.hass.callService(a,n?"turn_off":"turn_on",{entity_id:e})}paint(){let e=this.config,t=k(this.hass,e.status),n=Hr(t),a=Rr[n]??Rr.unknown,r=ka(t),o=e.status&&(!t||t.state==="unavailable");this.toggleAttribute("dead",!!o),this.toggleAttribute("loopt",r&&!o),this.$(".card").style.setProperty("--tone",wm[a.toon]??A.accent),this.$(".ico").innerHTML=v(e.icon||"printer3d"),this.text(".nm",e.name||D(this.hass,e.status||e.power||e.camera,"3D-printer"));let s=String(t?.state??"").trim(),l=n==="unknown"&&s&&s.toLowerCase()!=="unknown",d=`<b>${this.veilig_(l?s:a.woord)}</b>${this.bijzin_()}`,c=this.$(".st");c.innerHTML!==d&&(c.innerHTML=d),this.paintAanUit_(),this.paintBeeld_(r),this.paintVoortgang_(r),this.paintTegels_(),this.paintAms_(),R(this.$(".card"))}bijzin_(){let e=Br(k(this.hass,this.config.remaining));return e===null||e<=0?"":` \xB7 nog ${this.veilig_(Pr(e))}, klaar om ${this.veilig_(Kr(e))}`}paintAanUit_(){let e=this.$(".aanuit"),t=this.config.power;if(e.hidden=!t,!t)return;let n=q(k(this.hass,t));e.setAttribute("aria-pressed",String(n)),e.setAttribute("aria-label",n?"Printer uitzetten":"Printer aanzetten")}paintBeeld_(e){let t=this.config,n=this.$(".beeldvak"),a=this.beeldSoort_();if(n.hidden=!a,!a)return;let r=this.$(".wissel");if(r.hidden=!(t.camera&&t.image),!r.hidden){let d=a==="camera"?"Voorbeeld":"Camera";r.innerHTML=`${v(a==="camera"?"grid":"camera")}<span>${d}</span>`,r.setAttribute("aria-label",`Toon ${d.toLowerCase()}`)}if(a==="camera"){va(n,this.hass,t.camera,{live:t.live_view===!0||e}),n.querySelector(".leeg")?.remove();return}n.querySelector("hui-image")?.remove();let s=k(this.hass,t.image)?.attributes?.entity_picture,l=n.querySelector("img.beeld");if(s)l||(l=document.createElement("img"),l.className="beeld",l.alt="Wat de printer aan het maken is",n.appendChild(l)),l.dataset.bron!==s&&(l.dataset.bron=s,l.src=s),n.querySelector(".leeg")?.remove();else if(l?.remove(),!n.querySelector(".leeg")){let d=document.createElement("span");d.className="leeg",d.textContent="Nog geen voorbeeld",n.appendChild(d)}}paintVoortgang_(e){let t=this.config,n=this.$(".voort"),a=Ir(k(this.hass,t.progress)),r=Br(k(this.hass,t.remaining));if(n.hidden=a===null&&!e,n.hidden)return;let o=this.$(".balk");o.dataset.onbekend=String(a===null),o.querySelector("i").style.setProperty("--pct",`${a??0}%`),this.text(".pct",a===null?"Bezig":`${a}%`),this.text(".rest",r===null||r<=0?"":`nog ${Pr(r)} \xB7 klaar om ${Kr(r)}`)}paintTegels_(){let e=this.config,t=this.$(".tegels"),n=[],a=Vr(k(this.hass,e.nozzle_temp));a&&n.push({w:`${a.waarde}${a.eenheid}`,l:"Nozzle"});let r=Vr(k(this.hass,e.bed_temp));r&&n.push({w:`${r.waarde}${r.eenheid}`,l:"Bed"});let o=k(this.hass,e.door);if(o){let l=q(o);n.push({w:l?"Open":"Dicht",l:"Deur",let:l})}if(t.hidden=!n.length,!n.length)return;t.style.setProperty("--kolommen",String(n.length));let s=n.map(l=>`${l.w}|${l.l}|${l.let??""}`).join(",");t.dataset.sig!==s&&(t.dataset.sig=s,t.innerHTML=n.map(l=>`<div class="tegel" data-let="${!!l.let}"><span class="w">${this.veilig_(l.w)}</span><span class="l">${this.veilig_(l.l)}</span></div>`).join(""))}paintAms_(){let e=this.config,t=this.$(".ams"),n=St.filter(l=>e[`tray_${l}`]||e[`tray_${l}_color`]);if(t.hidden=!n.length,!n.length)return;let a=this.$(".ams .rij"),r=St.map(l=>Nd(k(this.hass,e[`tray_${l}`]),{color:e[`tray_${l}_color`],label:e[`tray_${l}_label`]})),o=St.map(l=>k(this.hass,e[`tray_${l}`])?.attributes?.name??""),s=r.map(l=>`${l.kleur}|${l.soort}|${l.leeg}|${l.actief}|${l.rest}`).join(",");a.dataset.sig!==s&&(a.dataset.sig=s,a.innerHTML=r.map((l,d)=>{let c=o[d],p=`Tray ${d+1}`+(l.leeg?": leeg":c||l.soort?`: ${c||l.soort}`:"")+(l.rest===null?"":` \u2014 nog ${l.rest}%`)+(l.actief?" (in gebruik)":"");return`<div class="tray" data-leeg="${l.leeg}" data-actief="${l.actief}" style="--kleur:${l.kleur??"transparent"}" title="${this.veilig_(p)}"><span class="vlak">${l.rest===null?"":`<i style="--rest:${l.rest}%"></i>`}</span><span class="txt"><span class="nr">Tray ${d+1}</span><span class="so">${this.veilig_(l.leeg?"leeg":l.soort||"gevuld")}</span></span></div>`}).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.camera||this.config?.image?6:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-printer-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>/^sensor\./.test(a)&&/(print|stage|status)/i.test(a));return n?{status:n}:{}}};j(xa,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var Gr=class extends T{defaults(){return{icon:"printer3d"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer3d",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"power",selector:f.entity(["switch","input_boolean"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"nozzle_temp",selector:f.entity(["sensor","number"])},{name:"bed_temp",selector:f.entity(["sensor","number"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"camera",selector:f.entity("camera")},{name:"live_view",selector:f.bool()},{name:"image",selector:f.entity(["image","camera"])},...St.flatMap(e=>[{name:`tray_${e}`,selector:f.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:f.text()},{name:`tray_${e}_label`,selector:f.text()}])]}label(e){let t={};for(let n of St)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};O("domotiapp-printer-card-editor",Gr);L("domotiapp-printer-card",xa,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var Nt={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},Wr=i=>i==="electric"||i==="hybrid",Ur=i=>i==="fuel"||i==="hybrid",_m=["charging","charge","fast_charging","dc_charging","on","true","laden"],ym=["complete","completed","fully_charged","full","done","finished"],jm=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],zm=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function Dd(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:_m.includes(e)?"charging":ym.includes(e)?"complete":jm.includes(e)?"connected":zm.includes(e)?"idle":"onbekend"}function Ld(i,e){if(i&&i!=="onbekend")return wa[i]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var wa={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function Fr(i,e){let t=Number(i?.state);if(!Number.isFinite(t))return null;let n=String(i?.attributes?.unit_of_measurement??"").toLowerCase(),a=Number(e);return n!=="%"&&Number.isFinite(a)&&a>0?Math.max(0,Math.min(100,Math.round(t/a*100))):Math.max(0,Math.min(100,Math.round(t)))}function Td(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"km"}:null}function qr(i){if(i==null)return null;let e=i<=10?"bad":i<=20?"warn":"good";return{procent:i,toon:e}}function Zr(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let a=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return a==="h"||a.startsWith("hour")?Math.round(n*60):a==="s"||a.startsWith("sec")?Math.round(n/60):Math.round(n)}function Yr(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function Od({open:i,slot:e,laden:t,laadMinuten:n,radius:a,aandrijving:r}){if(i)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${Yr(n)}`:"";return{tekst:`${wa.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:wa.complete,toon:"good"}:t==="connected"?{tekst:wa.connected,toon:"neutral"}:a?{tekst:`Nog ${a.waarde} ${a.eenheid}`,toon:"neutral"}:{tekst:Nt[r]?.label??"",toon:"neutral"}}var $m=100,Em=["home","thuis","at_home","athome"],Am=["not_home","away","afwezig","weg","not home","nothome"];function Mm(i,e,t,n){let r=d=>d*Math.PI/180,o=r(t-i),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(i))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function Sm(i){let e=i?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let a=String(i?.state??""),r=a.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=a.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function Cd(i,e,t=$m){if(!i)return{thuis:null,tekst:"",meters:null};let n=String(i.state??"").trim(),a=n.toLowerCase();if(a==="unavailable"||a==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(Em.includes(a))return{thuis:!0,tekst:"Thuis",meters:null};if(Am.includes(a))return{thuis:!1,tekst:"Afwezig",meters:null};let r=Sm(i),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=Mm(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var Nm=["open","opened","ajar","unlatched","on","true","unlocked"],Dm=["closed","close","shut","secured","locked","off","false","not_open"];function Xr(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:Nm.includes(e)?!0:Dm.includes(e)?!1:/(^|[^a-z])(ajar|open)([^a-z]|$)/.test(e)?!0:null}function Rd(i){let e=String(i?.state??"").trim().toLowerCase();if(!e||e==="unavailable"||e==="unknown")return null;if(String(i?.entity_id??"").split(".")[0]==="lock")return e==="locked"?!0:e==="unlocked"||e==="open"||e==="opening"?!1:null;if(i?.attributes?.device_class==="lock"){if(e==="on")return!1;if(e==="off")return!0}return["locked","lock","secured","closed","off","false"].includes(e)?!0:["unlocked","unlock","open","unsecured","on","true"].includes(e)?!1:null}var Qr={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},_a=class extends M{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[I]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return Nt[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      <div class="card surface">
        <div class="kop">
      ...
      </div>`}wire(){this.teardown_.push(V(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;K(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&K(this,t.dataset.id)})}paint(){let e=this.config,t=this.soort_(),n=Wr(t)?Fr(k(this.hass,e.battery),e.battery_max):null,a=Ur(t)?Fr(k(this.hass,e.fuel),e.fuel_max):null,r=Td(k(this.hass,e.range)),o=Dd(k(this.hass,e.charging)),s=Zr(k(this.hass,e.charging_ready)),l=k(this.hass,e.lock),d=Xr(k(this.hass,e.doors)),c=Xr(k(this.hass,e.windows)),p=d===!0||c===!0,h=Rd(l),u=Cd(k(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),m=e.battery&&!k(this.hass,e.battery)&&e.range&&!k(this.hass,e.range);this.toggleAttribute("dead",!!m),this.text(".nm",e.name||D(this.hass,e.battery||e.range||e.lock,"Auto"));let b=Od({open:p,slot:h===!1?"unlocked":h===!0?"locked":null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",b.tekst),this.$(".st").style.setProperty("--melding",Qr[b.toon]??A.neutral),this.paintFoto_(),this.paintBalken_({accu:n,tank:a,radius:r,laden:o,soort:t}),this.paintTegels_(u,o,{slot:h,deurOpen:d,raamOpen:c}),R(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=v(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=v(this.config.icon||"car")},e.replaceChildren(n)}paintBalken_({accu:e,tank:t,radius:n,laden:a,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=qr(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:a==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:a==="charging"})}if(t!==null){let h=qr(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":Nt[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=Zr(k(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,u)=>{let m=u===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,b=h.laadt&&c?` \xB7 nog ${this.veilig_(Yr(c))}`:"";return`
          <div class="meter" style="--balk:${Qr[h.toon]??A.neutral}">
            <div class="regel">
  ...
  `);var Jr=class extends T{defaults(){return{icon:"car",drivetrain:"electric",photo_size:"klein"}}pickers(){return[{key:"image",kind:"foto",label:"Foto van de auto"},{key:"icon",kind:"icon",label:"Icoon (zonder foto)",fallback:"car"}]}schema(){let e=Nt[this.config_?.drivetrain]?this.config_.drivetrain:"electric",t=[{name:"name",selector:f.text()},{name:"drivetrain",selector:f.select(Object.entries(Nt).map(([n,{label:a}])=>({value:n,label:a})))},{name:"photo_size",selector:f.select([{value:"klein",label:"Klein, naast de naam"},{value:"groot",label:"Groot, over de hele breedte"}])},{name:"range",selector:f.entity(["sensor","number"])}];return Wr(e)&&t.push({name:"battery",selector:f.entity(["sensor","number"])},{name:"battery_max",selector:f.number(1,400,1)},{name:"charging",selector:f.entity(["sensor","binary_sensor","switch"])},{name:"charging_ready",selector:f.entity(["sensor"])},{name:"charging_power",selector:f.entity(["sensor"])}),Ur(e)&&t.push({name:"fuel",selector:f.entity(["sensor","number"])},{name:"fuel_max",selector:f.number(1,200,1)}),t.push({name:"lock",selector:f.entity(["lock","sensor","binary_sensor"])},{name:"doors",selector:f.entity(["binary_sensor","sensor","cover"])},{name:"windows",selector:f.entity(["binary_sensor","sensor","cover"])},{name:"climate",selector:f.entity(["sensor","binary_sensor","switch","climate"])},{name:"location",selector:f.entity(["device_tracker","sensor","person"])},{name:"home_radius",selector:f.number(10,2e3,10)},{name:"odometer",selector:f.entity(["sensor"])},{name:"sensors",selector:{entity:{multiple:!0}}}),t}label(e){return{name:"Naam",drivetrain:"Aandrijving",image:"Foto van de auto",photo_size:"Hoe groot staat de foto",range:"Actieradius",battery:"Accupercentage",battery_max:"Accu-inhoud (kWh), als de sensor geen procenten geeft",charging:"Laadstatus",charging_ready:"Klaar met laden om / nog te gaan",charging_power:"Laadvermogen",fuel:"Tankniveau",fuel_max:"Tankinhoud (liter), als de sensor geen procenten geeft",lock:"Portierslot",doors:"Deuren open",windows:"Ramen open",climate:"Voorverwarmen (alleen uitlezen)",location:"Waar hij staat",home_radius:"Hoe dichtbij is thuis (meter)",odometer:"Kilometerstand",sensors:"Extra sensoren als tegel"}[e.name]??super.label(e)}helper(e){return{drivetrain:"Bepaalt welke balken er op de kaart komen \u2014 een accu, een tank, of allebei \u2014 en welke velden je hieronder ziet.",image:"Kies een bestand of sleep er een op. Home Assistant zet hem in zijn eigen media-opslag; je kunt ook een pad als /local/auto.png intypen.",range:"In de eenheid van de sensor zelf. De kaart rekent niets om: staat je Home Assistant op mijlen, dan zie je mijlen.",battery_max:"Alleen nodig als je accusensor in kWh meldt in plaats van in procenten. Dan rekent de kaart het percentage zelf uit.",fuel_max:"Alleen nodig als je tanksensor in liters meldt in plaats van in procenten.",charging_ready:"Een aantal minuten, een klok of het tijdstip waarop hij vol is \u2014 alle drie worden gelezen.",doors:"Staat er iets open, dan zegt de kaart dat en gaat al het andere even opzij. Een binary_sensor mag, maar een gewone sensor met een woord erin ook \u2014 Closed, Open, Ajar en LOCKED worden allemaal gelezen.",lock:"Alleen uitlezen: deze kaart bedient niets. Een lock-entiteit mag, maar ook een sensor die LOCKED of UNLOCKED meldt.",location:"Een device_tracker die home of not_home meldt, of een sensor met een coordinaat \u2014 beide worden gelezen. Bij een coordinaat rekent de kaart de afstand tot de locatie van je Home Assistant uit en maakt daar Thuis of Afwezig van.",home_radius:"Alleen van belang bij een sensor met een coordinaat. Binnen deze afstand van je huis heet de auto thuis. Leeg laten is 100 meter \u2014 ruim genoeg voor een oprit of een parkeerplaats om de hoek.",sensors:"Alles wat je verder nog kwijt wilt: bandenspanning, buitentemperatuur, de volgende beurt. Ze komen als tegels onderaan te staan, met de naam uit Home Assistant."}[e.name]}};O("domotiapp-auto-card-editor",Jr);L("domotiapp-auto-card",_a,{name:"DomotiApp Auto",description:"Brandstof, hybride of elektrisch: accu- en tankbalk, actieradius, laadstatus, het slot en zoveel eigen sensoren als je kwijt wilt \u2014 met een foto van de auto erbij."});function Hd(i,e){return i?.entities?.[e]?.device_id??null}function eo(i,e,t,n){if(n&&t.includes(n))return n;let a=Hd(i,e);if(a){let r=t.filter(o=>Hd(i,o)===a);if(r.length===1)return r[0]}return null}function ya(i,e,t,n,a){let r=eo(i,e,t,n);return r===null||r===a}var Vd=[{sleutel:"mens",label:"Mens",icoon:"person",woorden:["person","persoon","personen","mens","people","human"]},{sleutel:"dier",label:"Dier",icoon:"dier",woorden:["pet","pets","dier","dieren","huisdier","animal","dog","hond","cat","kat"]},{sleutel:"voertuig",label:"Voertuig",icoon:"car",woorden:["vehicle","voertuig","car","auto","truck","vrachtwagen","motorcycle"]},{sleutel:"aanbellen",label:"Aanbellen",icoon:"bell",woorden:["doorbell","deurbel","aanbellen","aangebeld","visitor","bezoeker","bel","ring","chime"]},{sleutel:"ontgrendeling",label:"Ontgrendeling",icoon:"lockOpen",woorden:["unlock","unlocked","ontgrendeld","ontgrendeling","slot","lock","opener","deuropener","buzzer","toegang","access","entry","keypad","badge","pas"]}],Bd={sleutel:"beweging",label:"Beweging",icoon:"cctv",woorden:[]},nn=[...Vd,Bd];function Pd(i){return nn.find(e=>e.sleutel===i)??Bd}function Id(i){return String(i??"").toLowerCase().split(/[^a-z0-9]+/).filter(Boolean)}function ja(i,e,t){if(String(i??"").split(".")[0]==="lock")return"ontgrendeling";if(t==="doorbell")return"aanbellen";let a=new Set([...Id(i),...Id(e)]);for(let r of Vd)if(r.woorden.some(o=>a.has(o)))return r.sleutel;return null}function Kd(i,e={}){let t=i?.melder,n=t?e[`meldersoort:${t}`]:null;return n&&nn.some(a=>a.sleutel===n)?n:ja(t,i?.naam)}function tn(i){let e=Date.parse(i?.tijd??"");return Number.isNaN(e)?null:e}function za(i,{soorten:e,camera:t,dag:n,config:a}={}){let r=e instanceof Set?e:new Set(e??[]),o=n==null?null:le(n);return(Array.isArray(i)?i:[]).filter(s=>{if(r.size){let l=Kd(s,a);if(!l||!r.has(l))return!1}if(t&&s.camera!==t)return!1;if(o){let l=tn(s);if(l===null||l<o.vanaf||l>=o.tot)return!1}return!0})}function Gd(i,e={}){let t={};for(let n of Array.isArray(i)?i:[]){let a=Kd(n,e);a&&(t[a]=(t[a]??0)+1)}return t}function Wd(i){let e=new Set((Array.isArray(i)?i:[]).map(t=>t?.soort).filter(Boolean));return nn.filter(t=>e.has(t.sleutel))}function Ud(i,e,t){let n=Array.isArray(e)?e:[];if(n.some(r=>r==null))return[...i??[]];let a=new Set(n.filter(Boolean));for(let r of Array.isArray(t)?t:[])r?.camera&&a.add(r.camera);return(i??[]).filter(r=>a.has(r))}function to(i){let e=new Set;for(let t of Array.isArray(i)?i:[]){let n=tn(t);n!==null&&e.add(le(n).vanaf)}return[...e].sort((t,n)=>n-t)}function $a(i,e,t){let n=le(e).vanaf,a=(i??[]).filter(r=>t<0?r<n:r>n);return a.length?t<0?a[0]:a[a.length-1]:null}function no(i){let e=new Map;for(let n of Array.isArray(i)?i:[]){let a=tn(n),r=a===null?null:le(a).vanaf;e.has(r)||e.set(r,[]),e.get(r).push(n)}return[...e.entries()].map(([n,a])=>({dag:n,beelden:a.sort((r,o)=>(tn(o)??0)-(tn(r)??0)),bytes:a.reduce((r,o)=>r+(Number(o.bytes)||0),0)})).sort((n,a)=>n.dag===null?1:a.dag===null?-1:a.dag-n.dag)}function ao(i){let e=Number(i)||0;return e>=1024*1024*1024?`${(e/(1024*1024*1024)).toFixed(1)} GB`:e>=1024*1024?`${Math.round(e/(1024*1024))} MB`:e>=1024?`${Math.round(e/1024)} kB`:`${e} B`}function le(i){let e=new Date(i),t=new Date(e.getFullYear(),e.getMonth(),e.getDate()).getTime(),n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1).getTime();return{vanaf:t,tot:n}}function io(i,e){let t=new Date(i);return new Date(t.getFullYear(),t.getMonth(),t.getDate()+e).getTime()}var Lm=["zo","ma","di","wo","do","vr","za"],Tm=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"];function Dt(i,e=Date.now()){if(i==null)return"Alles";let t=le(e).vanaf,n=le(i).vanaf,a=Math.round((t-n)/864e5);if(a===0)return"Vandaag";if(a===1)return"Gisteren";let r=new Date(n);return`${Lm[r.getDay()]} ${r.getDate()} ${Tm[r.getMonth()]}`}function Om(i){let e=[i?.camera,...Array.isArray(i?.cameras)?i.cameras:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function Cm(i){let e=[...Array.isArray(i?.motion_sensors)?i.motion_sensors:[],...i?.motion?[i.motion]:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function Rm(i,e){let t=Om(e),n=Cm(e),a=!!e?.snapshots;return t.map(r=>{let o=n.filter(l=>ya(i,l,t,e?.[`melderbij:${l}`],r)),s={};for(let l of o){let d=e?.[`melder:${l}`];typeof d=="string"&&d.trim()&&(s[l]=d.trim())}return{camera:r,aan:a&&o.length>0,melders:o,namen:s,rustperiode:Fd(e?.snapshot_rustperiode,60),wachttijd:Fd(e?.snapshot_wachttijd,0),ontvangers:Im(e?.snapshot_ontvangers).filter(l=>l.startsWith("person.")),alleen_afwezig:!!e?.snapshot_alleen_afwezig,stil_schakelaar:typeof e?.snapshot_stil=="string"&&e.snapshot_stil?e.snapshot_stil:null,stil_omgekeerd:!!e?.snapshot_stil_omgekeerd}})}function Hm(i,e){if(!e)return!0;for(let t of Object.keys(i))if(!ro(i[t],e[t]))return!0;return!1}function qd(i,e,t){return Rm(i,e).filter(n=>Hm(n,t?.[n.camera]))}function ro(i,e){return Array.isArray(i)&&Array.isArray(e)?i.length===e.length&&i.every((t,n)=>ro(t,e[n])):i&&e&&typeof i=="object"&&typeof e=="object"?[...new Set([...Object.keys(i),...Object.keys(e)])].every(n=>ro(i[n],e[n])):i===e}function Im(i){return Array.isArray(i)?i.filter(e=>typeof e=="string"):typeof i=="string"&&i?[i]:[]}function Fd(i,e){let t=Number(i);return Number.isFinite(t)&&t>=0?Math.round(t):e}var Vm=`
  :host {
    ${U}
...
`;function st(i){return String(i??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var oo=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[X(Vm)],this.beelden_=[]}open(e){this.opts_=e,this.beelden_=e.beelden??[],this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.alleenBeeld_=!!e.beeld,this.$(".scherm").hidden=this.alleenBeeld_,e.beeld?this.toonGroot_(e.beeld):this.$(".groot").hidden=!0,this.teken_()}zet(e){this.beelden_=e??[],this.hasAttribute("open")&&this.teken_()}sluit(){this.removeAttribute("open"),this.opts_?.dicht?.()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      ...
      </div>`,this.shadowRoot.addEventListener("click",e=>{e.stopPropagation();let t=this.$(".groot");if(!t.hidden&&e.composedPath().includes(t)){if(this.alleenBeeld_)return this.sluit();t.hidden=!0;return}if(e.target.closest?.(".terug"))return this.sluit();let n=e.target.closest?.("[data-weg]");if(n){let o=this.beelden_.find(s=>s.id===n.dataset.weg);return this.opts_?.wis?.([n.dataset.weg],o?`dit beeld van ${o.naam??"de camera"}`:"dit beeld")}let a=e.target.closest?.("[data-wisdag]");if(a){let o=no(this.beelden_).find(s=>String(s.dag)===a.dataset.wisdag);return o?this.opts_?.wis?.(o.beelden.map(s=>s.id),`${o.beelden.length} beelden van ${Dt(o.dag).toLowerCase()}`):void 0}if(e.target.closest?.(".wis"))return this.beelden_.length?this.opts_?.wis?.(this.beelden_.map(o=>o.id),`alle ${this.beelden_.length} beelden`):void 0;let r=e.target.closest?.("[data-beeld]");r&&this.toonGroot_(r.dataset.beeld)}),this.tabIndex=-1,this.addEventListener("keydown",e=>{e.key==="Escape"&&(e.stopPropagation(),!this.$(".groot").hidden&&!this.alleenBeeld_?this.$(".groot").hidden=!0:this.sluit())})}toonGroot_(e){let t=this.beelden_.find(a=>a.id===e);if(!t)return;let n=this.$(".groot");n.querySelector("img").src=t.url,n.querySelector(".onder").textContent=`${this.opts_.camNaam(t.camera)} \xB7 ${t.naam??""} \xB7 ${this.opts_.klok(t.tijd,!0)}`,n.hidden=!1}teken_(){if(this.alleenBeeld_)return;let e=no(this.beelden_),t=this.beelden_.reduce((r,o)=>r+(Number(o.bytes)||0),0),n=this.opts_.meerdere;this.$(".stat").textContent=this.beelden_.length?`${this.beelden_.length} beelden \xB7 ${ao(t)}`:"",this.$(".wis").disabled=!this.beelden_.length,this.$(".lijst").innerHTML=e.length?e.map(r=>{let o=r.dag===null?"Zonder datum":Dt(r.dag);return`<div class="dagkop"><span>${st(o)}</span><span class="bij">${r.beelden.length} \xB7 ${ao(r.bytes)}</span><button type="button" data-wisdag="${r.dag}">Wis deze dag</button></div><div class="raster">`+r.beelden.map(s=>{let l=n?`${st(this.opts_.camNaam(s.camera))} \xB7 `:"";return`<button type="button" class="kiek" data-beeld="${st(s.id)}"><img src="${st(s.url)}" alt="" loading="lazy"><span class="bij">${l}${st(s.naam??"")} \xB7 ${st(this.opts_.klok(s.tijd))}</span><span class="weg" role="button" data-weg="${st(s.id)}" aria-label="Verwijder">${v("close")}</span></button>`}).join("")+"</div>"}).join(""):'<div class="leeg">Er liggen geen snapshots.</div>';let a=this.$(".groot");!a.hidden&&this.alleenBeeld_===!1&&(this.beelden_.some(o=>a.querySelector("img").src.includes(o.id))||(a.hidden=!0))}};H("domotiapp-camera-archief",oo);function Zd(i){let e=document.querySelector("domotiapp-camera-archief");return e||(e=document.createElement("domotiapp-camera-archief"),document.body.appendChild(e)),e.open(i),e.focus?.(),e}function so(i){document.querySelector("domotiapp-camera-archief")?.zet(i)}function Ea(i){let e=Number(i);return Number.isFinite(e)?Math.max(1,Math.min(6,e)):1}function Bm(i){let e=Ea(i);return Math.max(0,(1-1/e)/2)}function an(i,e,t){let n=Bm(t),a=o=>Number.isFinite(Number(o))?Number(o):0,r=o=>Math.max(-n,Math.min(n,a(o)))+0;return{x:r(i),y:r(e)}}function Aa(i,e,t={x:0,y:0}){let n=Ea(i?.zoom??1),a=Ea(n*(Number(e)||1));if(a===n)return{zoom:n,...an(i?.x,i?.y,n)};let r=Number(t?.x)||0,o=Number(t?.y)||0,s=(i?.x??0)+r*(1/n-1/a),l=(i?.y??0)+o*(1/n-1/a);return{zoom:a,...an(s,l,a)}}function Yd({zoom:i=1,x:e=0,y:t=0}={}){let n=Ea(i),a=an(e,t,n);return`scale(${n}) translate(${(-a.x*100).toFixed(3)}%, ${(-a.y*100).toFixed(3)}%)`}var Qd=[{sleutel:"auto",label:"Volgt de camera",css:null},{sleutel:"16:9",label:"16:9 (breed)",css:"16 / 9"},{sleutel:"4:3",label:"4:3",css:"4 / 3"},{sleutel:"3:2",label:"3:2",css:"3 / 2"},{sleutel:"1:1",label:"Vierkant",css:"1 / 1"}],Pm=7,Ma=[{k:"up",icoon:"arrowUp",label:"Omhoog"},{k:"left",icoon:"chevronRight",label:"Links",draai:180},{k:"right",icoon:"chevronRight",label:"Rechts"},{k:"down",icoon:"arrowDown",label:"Omlaag"}];function Jd(i){return!!(i.presets||Array.isArray(i.preset_buttons)&&i.preset_buttons.length||Ma.some(e=>i[`ptz_${e.k}`]))}var Sa=class extends M{validate(e){let t={name:"",...e};return!t.camera&&!(Array.isArray(t.cameras)&&t.cameras.length)&&(t[I]="Kies een camera. Presets, richtingsknoppen en een bewegingsmelder mogen daarna."),t.presets_aan===void 0&&(t.presets_aan=Jd(t)),t}watched(){let e=this.config;return[...this.cameras_(),e.presets,e.snapshot_stil,...this.melders_().map(t=>t.entity),...Array.isArray(e.preset_buttons)?e.preset_buttons:[]].filter(Boolean)}paintStil_(){let e=this.$(".stil");if(!e)return;let t=this.config.snapshot_stil;if(!t){e.hidden=!0;return}let n=k(this.hass,t),a=q(n)===!!this.config.snapshot_stil_omgekeerd;e.hidden=!1,e.setAttribute("aria-pressed",String(a));let r=a?"Meldingen staan aan; tik om ze uit te zetten":"Meldingen staan uit; tik om ze weer aan te zetten";e.setAttribute("aria-label",r),e.title=r;let o=a?"bell":"bellOff";e.dataset.icoon!==o&&(e.dataset.icoon=o,e.innerHTML=v(o))}melders_(){let e=this.config,t=[...Array.isArray(e.motion_sensors)?e.motion_sensors:[],...e.motion?[e.motion]:[]].filter(n=>typeof n=="string");return[...new Set(t)].map(n=>{let a=e[`melder:${n}`]||D(this.hass,n)||"Beweging";return{entity:n,naam:a,bijCamera:e[`melderbij:${n}`],soort:e[`meldersoort:${n}`]||ja(n,a,k(this.hass,n)?.attributes?.device_class)}})}cameras_(){let e=this.config,t=[e.camera,...Array.isArray(e.cameras)?e.cameras:[]].filter(Boolean);return[...new Set(t)]}huidig_(){let e=this.cameras_();return e.includes(this.cam_)?this.cam_:e[0]}template(){return this.config.bare&&this.setAttribute("bare",""),this.stand_=this.stand_??{zoom:1,x:0,y:0},`
      <div class="card surface">
        <div class="vak">
          ...
          <div class="ptz" hidden>
            ${Ma.map(t=>`<button type="button" data-r="${t.k}" aria-label="${t.label}"${t.draai?` style="transform: rotate(${t.draai}deg)"`:""}>${v(t.icoon)}</button>`).join("")}
          </div>
...
`;function vc(i,e,t,n=new Date){let a=En(n),r=(i??[]).map(l=>{let d=e(l),c=d?fe(d.state)??fe(d.attributes?.date)??fe(d.attributes?.next_date)??fe(d.attributes?.Year_month_day_date):null;return{id:l,st:d,datum:c}}),o=r.map(l=>t(l.id)),s=Qt(o);return r.map((l,d)=>{let c=l.datum?vt(a,l.datum):null;return{id:l.id,naam:s[d]||o[d]||l.id,datum:l.datum,dagen:c,reden:l.st?l.datum?c<0?"voorbij":null:"geen datum":"bestaat niet"}}).sort((l,d)=>!l.reden&&!d.reden?l.datum-d.datum:l.reden?d.reden?l.naam.localeCompare(d.naam):1:-1)}var po=i=>(i??[]).filter(e=>!e.reden);function ho(i,e=new Date){return!i||i.reden?"":kt(i.datum,e)}var kc=i=>new Date(i.getFullYear(),i.getMonth(),i.getDate());function Ta(i,e=0,t=new Date){let n=Math.round(e)||0;if(i==="dag"){let o=kc(t);o.setDate(o.getDate()+n);let s=new Date(o);return s.setDate(s.getDate()+1),{van:o,tot:s,periode:"hour"}}if(i==="week"){let o=kc(t),s=(o.getDay()+6)%7;o.setDate(o.getDate()-s+n*7);let l=new Date(o);return l.setDate(l.getDate()+7),{van:o,tot:l,periode:"day"}}if(i==="maand"){let o=new Date(t.getFullYear(),t.getMonth()+n,1),s=new Date(t.getFullYear(),t.getMonth()+n+1,1);return{van:o,tot:s,periode:"day"}}let a=new Date(t.getFullYear()+n,0,1),r=new Date(t.getFullYear()+n+1,0,1);return{van:a,tot:r,periode:"month"}}var sn=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"];function xc(i,e=0,t=new Date){let n=Math.round(e)||0,a=Ta(i,n,t).van;if(i==="dag")return n===0?"Vandaag":n===-1?"Gisteren":`${a.getDate()} ${sn[a.getMonth()]}`;if(i==="week"){if(n===0)return"Deze week";if(n===-1)return"Vorige week";let r=new Date(a);return r.setDate(r.getDate()+6),`${a.getDate()} ${sn[a.getMonth()].slice(0,3)} \u2013 ${r.getDate()} ${sn[r.getMonth()].slice(0,3)}`}if(i==="maand"){if(n===0)return"Deze maand";let r=a.getFullYear()===t.getFullYear()?"":` ${a.getFullYear()}`;return`${sn[a.getMonth()]}${r}`}return n===0?"Dit jaar":String(a.getFullYear())}var Ee={verbruik:{naam:"Van het net",tone:"var(--dac-grid-in)",teken:1},teruglevering:{naam:"Teruggeleverd",tone:"var(--dac-grid-out)",teken:-1},zon:{naam:"Zonnepanelen",tone:"var(--dac-solar)",teken:1},accu_uit:{naam:"Uit de accu",tone:"var(--dac-device-2)",teken:1},accu_in:{naam:"Naar de accu",tone:"var(--dac-device-2)",teken:-1},gas:{naam:"Gas",tone:"var(--dac-device-1)",teken:1},water:{naam:"Water",tone:"var(--dac-grid-in)",teken:1},apparaat:{naam:"Apparaat",tone:"var(--dac-house)",teken:1}},La=i=>typeof i=="string"&&i.trim()?i.trim():null;function wc(i){let e=[],t=(n,a,r)=>{let o=La(a);if(!o||e.some(l=>l.statistiek===o&&l.rol===n))return;let s=n==="apparaat"?o:Ee[n]?.naam??o;e.push({rol:n,statistiek:o,naam:r??s})};for(let n of i?.energy_sources??[]){let a=La(n?.name);switch(n?.type){case"grid":{t("verbruik",n.stat_energy_from,a),t("teruglevering",n.stat_energy_to,a?`${a} terug`:null);for(let r of n.flow_from??[])t("verbruik",r?.stat_energy_from,a);for(let r of n.flow_to??[])t("teruglevering",r?.stat_energy_to,a?`${a} terug`:null);break}case"solar":t("zon",n.stat_energy_from,a);break;case"battery":t("accu_uit",n.stat_energy_from,a),t("accu_in",n.stat_energy_to,a?`${a} laden`:null);break;case"gas":t("gas",n.stat_energy_from,a);break;case"water":t("water",n.stat_energy_from,a);break;default:break}}for(let n of i?.device_consumption??[])t("apparaat",n?.stat_consumption,La(n?.name));for(let n of i?.device_consumption_water??[])t("apparaat",n?.stat_consumption,La(n?.name));return e}var uo=i=>[...new Set(i.map(e=>e.statistiek))],_c=i=>i.some(e=>e.rol!=="apparaat"),Oa=i=>Number.isFinite(Number(i))?Number(i):0;function yc(i,e){let t={};for(let n of i){let a=e?.[n.statistiek]??[],r=0;for(let o of a)r+=Oa(o?.change);t[n.statistiek]=Math.max(0,Math.round(r*1e3)/1e3)}return t}function ct(i,e,t){let n=yc(i,e),a=0;for(let r of i)r.rol===t&&(a+=n[r.statistiek]??0);return Math.round(a*1e3)/1e3}function jc(i,e,{van:t,tot:n,periode:a="hour"}={}){let r=new Map,o=t instanceof Date?t.getTime():Number(t)||0,s=n instanceof Date?n.getTime():Number(n)||1/0;for(let d of i)for(let c of e?.[d.statistiek]??[]){let p=Number(c?.start);if(!Number.isFinite(p)||p<o||p>=s)continue;r.has(p)||r.set(p,{start:p,rollen:{}});let h=r.get(p);h.rollen[d.rol]=(h.rollen[d.rol]??0)+Oa(c?.change)}let l=[...r.values()].sort((d,c)=>d.start-c.start).map(d=>{let c={};for(let[p,h]of Object.entries(d.rollen))c[p]=Math.max(0,Math.round(h*1e3)/1e3);return{start:d.start,rollen:c}});return qm(l,{van:t,tot:n,periode:a})}function qm(i,{van:e,tot:t,periode:n="hour"}={}){let a=e instanceof Date?e.getTime():Number(e),r=t instanceof Date?t.getTime():Number(t);if(!Number.isFinite(a)||!Number.isFinite(r)||r<=a)return i;let o=c=>{let p=new Date(c);return n==="month"?p.setMonth(p.getMonth()+1):n==="day"||n==="week"?p.setDate(p.getDate()+1):p.setHours(p.getHours()+1),p},s=new Map(i.map(c=>[c.start,c])),l=[],d=new Date(a);for(let c=0;c<400&&d.getTime()<r;c+=1)l.push(s.get(d.getTime())??{start:d.getTime(),rollen:{}}),d=o(d);for(let c of i)l.some(p=>p.start===c.start)||l.push(c);return l.sort((c,p)=>c.start-p.start)}function mo(i,e){let t=ct(i,e,"verbruik"),n=ct(i,e,"teruglevering"),a=ct(i,e,"zon"),r=ct(i,e,"accu_uit"),o=ct(i,e,"accu_in"),s=ct(i,e,"gas"),l=ct(i,e,"water"),d=Math.max(0,Math.round((a-n)*1e3)/1e3),c=Math.round((t+r+d)*1e3)/1e3,p=c>0?Math.round((d+r)/c*100):null;return{netIn:t,netUit:n,zon:a,accuUit:r,accuIn:o,gas:s,water:l,eigen:d,verbruikt:c,zelfvoorzienend:p}}function re(i,e="kWh"){let t=Oa(i),n=Math.abs(t)>=100?0:Math.abs(t)>=10?1:2,a=t.toLocaleString("nl-NL",{minimumFractionDigits:n,maximumFractionDigits:n});return e?`${a} ${e}`:a}var zc=i=>Oa(i).toLocaleString("nl-NL",{style:"currency",currency:"EUR"}),Zm=["zo","ma","di","wo","do","vr","za"];function $c(i,e){let t=new Date(i);return e==="dag"?String(t.getHours()).padStart(2,"0"):e==="week"?Zm[t.getDay()]:e==="maand"?String(t.getDate()):sn[t.getMonth()].slice(0,3)}function Ec(i){let e={},t=n=>{let a=Number(n);return Number.isFinite(a)&&a>0?a:null};for(let n of i?.energy_sources??[]){for(let r of n?.flow_from??[]){let o=t(r?.number_energy_price);r?.stat_energy_from&&o&&(e[r.stat_energy_from]=o)}let a=t(n?.number_energy_price);a&&n.stat_energy_from&&(e[n.stat_energy_from]=a)}return e}function Ac(i,e,t){let n=yc(i,e),a=0,r=!0;for(let o of i){if(o.rol==="apparaat"||o.rol==="teruglevering")continue;let s=t?.[o.statistiek];if(s==null){(n[o.statistiek]??0)>0&&(r=!1);continue}a+=(n[o.statistiek]??0)*s}return{bedrag:Math.round(a*100)/100,compleet:r}}var pt=["ma","di","wo","do","vr","za","zo"],Tt={ma:"maandag",di:"dinsdag",wo:"woensdag",do:"donderdag",vr:"vrijdag",za:"zaterdag",zo:"zondag"},Nc=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],Dc=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Ca=i=>String(i).padStart(2,"0"),ln=i=>pt[(i.getDay()+6)%7],Ce=i=>`${i.getFullYear()}-${Ca(i.getMonth()+1)}-${Ca(i.getDate())}`,Ae=i=>`${Ca(i.getHours())}:${Ca(i.getMinutes())}`,Qe=i=>`${Ce(i)}T${Ae(i)}`,Lc=i=>`${Tt[ln(i)]} ${i.getDate()} ${Nc[i.getMonth()]}`;function Mc(i){if(!i)return"";let[,e,t]=i.split("-").map(Number);return`${t} ${Nc[e-1]}`}function Tc(i,e){let t=Ce(i);if(t===Ce(e))return"vandaag";let n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1);return t===Ce(n)?"morgen":Tt[ln(i)]}function Ym(i,e){let t=e.length===10?`${e}T00:00`:e,n=i?.van?i.van.length===10?`${i.van}T00:00`:i.van:null,a=i?.tot?i.tot.length===10?`${i.tot}T23:59`:i.tot:null;return!(n&&n>t||a&&a<t)}var dn=(i,e)=>(i??[]).filter(t=>t.tekst&&Ym(t,e));function Oc(i,e){let t=e.length===10?`${e}T00:00`:e;return(i??[]).filter(n=>n.tekst&&n.van&&(n.van.length===10?`${n.van}T00:00`:n.van)>t).sort((n,a)=>String(n.van).localeCompare(String(a.van)))}function Sc(i){if(!i)return"";let[e,t]=i.split("T");return t?`${Mc(e)} ${t}`:Mc(e)}function go(i){let e=Sc(i?.van),t=Sc(i?.tot);return e&&t?`${e} t/m ${t}`:e?`vanaf ${e}`:t?`tot en met ${t}`:""}function Cc(i){return(i??[]).filter(e=>e.titel).map(e=>({...e,eigen:!1})).sort((e,t)=>String(t.datum??"").localeCompare(String(e.datum??"")))}function fo(i,e){let t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=[];for(let a of i??[]){if(!a?.naam||!a?.datum)continue;let[r,o,s]=a.datum.split("-").map(Number);if(!o||!s)continue;let l=new Date(t.getFullYear(),o-1,s);l<t&&(l=new Date(t.getFullYear()+1,o-1,s));let d=Math.round((l-t)/864e5),c=a.jaar_tonen!==!1&&r>1900?l.getFullYear()-r:null;n.push({...a,dagen:d,leeftijd:c,wanneer:d===0?"vandaag":d===1?"morgen":`${pt[(l.getDay()+6)%7]} ${l.getDate()} ${Dc[l.getMonth()]}`})}return n.sort((a,r)=>a.dagen-r.dagen||a.naam.localeCompare(r.naam,"nl"))}var Xm=i=>i?.length?i.map(([e,t])=>`${e} \u2013 ${t}`).join(", "):"gesloten";function bo(i,e){let t=Ce(e),n=i?.openingstijden?.[ln(e)]??[],a="";for(let r of i?.uitzonderingen??[])r.datum===t&&(n=r.tijden??[],a=r.reden??"");return{tijden:n,reden:a}}function cn(i,e){let{tijden:t,reden:n}=bo(i,e),a=Ae(e),r=t.find(([s,l])=>s<=a&&a<l),o=t.find(([s])=>s>a);return{open:!!r,tot:r?r[1]:null,straks:o?o[0]:null,tijden:t,reden:n}}function Qm(i,e){let t=cn(i,e);if(t.straks)return{dag:"vandaag",tijd:t.straks};for(let n=1;n<=14;n+=1){let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()+n),{tijden:r}=bo(i,a);if(r.length)return{dag:n===1?"morgen":Tt[ln(a)],tijd:r[0][0]}}return null}function Rc(i,e){let t=ln(e);return pt.map(n=>{let a=n===t?bo(i,e):null,r=a?a.tijden:i?.openingstijden?.[n]??[];return{dag:n,naam:Tt[n],tekst:Xm(r),reden:a?.reden??"",vandaag:n===t}})}var vo=i=>pt.some(e=>(i?.openingstijden?.[e]??[]).length>0);function Hc(i){return(i?.installatie?.verlichting?.length??0)>0?i?.instellingen?.verlichting_tonen!==!1:!1}function ko(i,e,t=null){let n=["welkom"];return(i?.personen?.length??0)>0&&n.push("aanwezig"),(t?dn(i?.mededelingen,t).length>0:(i?.mededelingen?.length??0)>0)&&n.push("mededelingen"),(e?.length??0)>0&&n.push("nieuws"),i?.installatie?.weer&&n.push("weer"),i?.installatie?.energie&&n.push("energie"),(i?.installatie?.afval?.length??0)>0&&n.push("afval"),Hc(i)&&n.push("verlichting"),(i?.installatie?.agendas?.length??0)>0&&n.push("agenda"),(i?.verjaardagen?.length??0)>0&&n.push("verjaardagen"),n}function xo(i){let e=String(i??"").trim().split(/\s+/).filter(Boolean);return e.length?e.length===1?e[0].slice(0,2).toUpperCase():(e[0][0]+e[e.length-1][0]).toUpperCase():"?"}function Ic(i){let e=new Map;for(let t of i??[]){let n=t.functie||"";e.has(n)||e.set(n,[]),e.get(n).push(t)}return[...e].map(([t,n])=>({functie:t,personen:n}))}function wo(i){let e=i??[];return{aanwezig:e.filter(t=>t.aanwezig),afwezig:e.filter(t=>!t.aanwezig)}}function Vc(i){let{aanwezig:e,afwezig:t}=wo(i);return[...e,...t]}function _o(i,e){if(!i)return"";let t=new Date(i);if(Number.isNaN(t.getTime()))return"";let n=Math.round((e-t)/6e4);if(n<1)return"zojuist";if(n<60)return`${n} min geleden`;if(Ce(t)===Ce(e))return`vandaag ${Ae(t)}`;let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()-1);return Ce(t)===Ce(a)?`gisteren ${Ae(t)}`:`${t.getDate()} ${Dc[t.getMonth()]}`}function Bc(i,e){let t=cn(i,e),n=["Gesloten"];t.reden&&n.push(t.reden);let a=Qm(i,e);return a&&n.push(`${a.dag} open om ${a.tijd}`),n.join(" \xB7 ")}var Me=6,Se=6,Je={welkom:{naam:"Welkom",icoon:"house",pagina:null,aantal:!1,maat:[6,1]},weer:{naam:"Weer",icoon:"sun",pagina:"weer",aantal:!1,maat:[2,2]},mededeling:{naam:"Mededelingen",icoon:"bell",pagina:"mededelingen",aantal:!1,maat:[2,1]},openingstijden:{naam:"Openingstijden",icoon:"clock",pagina:null,aantal:!1,maat:[2,3]},aanwezig:{naam:"Aanwezig",icoon:"people",pagina:"aanwezig",aantal:!0,maat:[2,3]},nieuws:{naam:"Nieuws",icoon:"news",pagina:"nieuws",aantal:!0,maat:[2,4]},verlichting:{naam:"Verlichting",icoon:"bulb",pagina:"verlichting",aantal:!0,maat:[2,1]},agenda:{naam:"Agenda",icoon:"calendar",pagina:"agenda",aantal:!0,maat:[2,2]},verjaardagen:{naam:"Verjaardagen",icoon:"cake",pagina:"verjaardagen",aantal:!0,maat:[2,2]},energie:{naam:"Energie",icoon:"bolt",pagina:"energie",aantal:!1,maat:[2,2]},afval:{naam:"Afvalkalender",icoon:"bin",pagina:"afval",aantal:!1,maat:[2,2]}},Jm=new Set(["aanwezig","nieuws","verlichting","agenda","verjaardagen"]),eg=[0,.85,1,1.12,1.25,1.35,1.45],tg=[0,.8,1,1.15,1.3,1.4,1.5];function Pc(i,e,t){let n=eg[Math.min(Me,Math.max(1,Math.round(e)||1))],a=tg[Math.min(Se,Math.max(1,Math.round(t)||1))],r=Jm.has(i)?n:Math.sqrt(n*a);return Math.round(r*1e3)/1e3}function Kc({beschikbaar:i,hoogte:e,gap:t=0,aantal:n,kolommen:a=1,minPas:r=.72,drempel:o=.4}){if(!n||!(e>0)||!(i>0))return{rijen:0,tonen:0,pas:1};let s=Math.max(1,a),l=Math.ceil(n/s),d=Math.floor((i+t)/(e+t)),c=1;if(d<l){let p=d+1,u=(i-(p-1)*t)/p/e,m=i-d*e-Math.max(0,d-1)*t;(d===0||u>=r&&m>=o*e)&&(d=p,c=Math.min(1,Math.max(d===1?.5:r,u)))}return d=Math.min(d,l),{rijen:d,tonen:Math.min(n,d*s),pas:Math.round(c*1e3)/1e3}}var Gc=Object.keys(Je);function Ra(){return{blokken:[["welkom",0,0,2,2,0],["weer",0,2,2,2,0],["openingstijden",0,4,2,2,0],["aanwezig",2,0,2,3,6],["mededeling",2,3,2,1,0],["verlichting",2,4,2,2,4],["nieuws",4,0,2,6,6]].map(([e,t,n,a,r,o])=>({id:`std-${e}`,soort:e,x:t,y:n,w:a,h:r,aantal:o}))}}var yo=(i,e)=>i.x<e.x+e.w&&e.x<i.x+i.w&&i.y<e.y+e.h&&e.y<i.y+i.h,ng=i=>i.x>=0&&i.y>=0&&i.w>=1&&i.h>=1&&i.x+i.w<=Me&&i.y+i.h<=Se;function Ha(i,e){return ng(e)?!(i??[]).some(t=>t.id!==e.id&&yo(t,e)):!1}function jo(i,e,t){for(let n=0;n+t<=Se;n+=1)for(let a=0;a+e<=Me;a+=1)if(Ha(i,{id:"",x:a,y:n,w:e,h:t}))return{x:a,y:n};return null}function Ia(i,e,t,n,a={}){let r=e??{};switch(i){case"welkom":return null;case"weer":return r.installatie?.weer?null:"Geen weerentiteit gekozen (kaartinstellingen van het infoscherm)";case"mededeling":return dn(r.mededelingen,n).length?null:"Geen mededeling die nu geldt";case"verjaardagen":return(r.verjaardagen?.length??0)>0?null:"Nog geen verjaardagen";case"openingstijden":return vo(r.praktijk)?null:"Geen openingstijden ingevuld";case"aanwezig":return(r.personen?.length??0)>0?null:"Nog geen medewerkers";case"nieuws":return null;case"energie":return r.installatie?.energie||a.energieDashboard?null:"Geen energiesensor gekozen, en geen energiedashboard in Home Assistant";case"verlichting":return(r.installatie?.verlichting?.length??0)>0?Hc(r)?null:"Verlichting staat uit in het beheer":"Geen lampen gekozen (kaartinstellingen van het infoscherm)";case"agenda":return(r.installatie?.agendas?.length??0)>0?null:"Geen agenda gekozen (kaartinstellingen van het infoscherm)";case"afval":return(r.installatie?.afval?.length??0)>0?null:"Geen afvalsensoren gekozen (kaartinstellingen van het infoscherm)";default:return"Onbekend blok"}}function Wc(i){let e=i??{};return e.state_class==="total_increasing"||e.state_class==="total"?!0:/wh$/i.test(String(e.unit_of_measurement??"").trim())}function Uc(i){let e=[];for(let t of i??[]){let n=Number(t?.s??t?.state);if(!Number.isFinite(n))continue;let a=t?.lu??t?.last_updated,r=typeof a=="number"?a*1e3:Date.parse(a);Number.isFinite(r)&&e.push({t:r,v:n})}return e.sort((t,n)=>t.t-n.t)}function Fc(i,{nu:e,tellerstand:t=!1,venster:n=24}={}){let a=e,r=a-n*36e5,o=(i??[]).filter(p=>p.t<=a),s=o.filter(p=>p.t>=r-36e5);if(!t){let p=s.filter(m=>m.t>=r),h=o.filter(m=>m.t<r).pop();h&&p.unshift({t:r,v:h.v});let u=p[p.length-1];return u&&u.t<a&&p.push({t:a,v:u.v}),{punten:p,van:r,tot:a,perUur:!1}}let l=[],d=Math.floor(r/36e5)*36e5,c=o.filter(p=>p.t<d).pop()?.v??null;for(let p=d;p<a;p+=36e5){let h=s.filter(m=>m.t>=p&&m.t<p+36e5),u=h.length?h[h.length-1].v:null;u!==null&&c!==null&&l.push({t:p,v:u>=c?Math.round((u-c)*1e3)/1e3:0}),u!==null&&(c=u)}return{punten:l.filter(p=>p.t>=r),van:r,tot:a,perUur:!0}}function qc(i){let e=i?.punten??[];if(!e.length)return{nu:null,gemiddeld:null,piek:null,totaal:null};let t=e.map(a=>a.v),n=t.reduce((a,r)=>a+r,0);return{nu:t[t.length-1],gemiddeld:n/t.length,piek:Math.max(...t),totaal:i.perUur?n:null}}function zo(i,{w:e=1e3,h:t=400}={}){let n=i?.punten??[];if(n.length<2||!(i.tot>i.van))return{lijn:"",vlak:"",min:0,max:0};let a=n.map(u=>u.v),r=Math.min(0,...a),o=Math.max(...a),s=o>r?r+(o-r)/.95:r+1,l=u=>((u-i.van)/(i.tot-i.van)*e).toFixed(1),d=u=>(t-(u-r)/(s-r)*t).toFixed(1),c=n.map((u,m)=>`${m?"L":"M"}${l(u.t)},${d(u.v)}`).join(" "),p=d(Math.max(r,0)),h=`${c} L${l(n[n.length-1].t)},${p} L${l(n[0].t)},${p} Z`;return{lijn:c,vlak:h,min:r,max:s}}function Zc(i,e="W",t=null){if(i==null||!Number.isFinite(Number(i)))return"--";let n=Number(i),a=String(e??"").trim();/^wh?$/i.test(a)&&Math.abs(n)>=1e3&&(n/=1e3,a=`k${a}`);let r=t??(Math.abs(n)>=100?0:Math.abs(n)>=10?1:2),o=n.toLocaleString("nl-NL",{minimumFractionDigits:r,maximumFractionDigits:r});return a?`${o} ${a}`:o}function Yc(i,e=48){let t=i?.punten??[];if(t.length<2||!(i.tot>i.van))return i;let n=(i.tot-i.van)/e,a=[],r=t[0].v;for(let o=0;o<e;o+=1){let s=i.van+o*n,l=s+n,d=t.filter(p=>p.t>=s&&p.t<l),c=d.length?d.reduce((p,h)=>p+h.v,0)/d.length:r;r=c,a.push({t:s+n/2,v:Math.round(c*1e3)/1e3})}return a.unshift({t:i.van,v:t[0].v}),a.push({t:i.tot,v:t[t.length-1].v}),{...i,punten:a}}function Xc(i,{w:e=1e3,h:t=400,spanning:n=.5}={}){let a=zo(i,{w:e,h:t}),r=i?.punten??[];if(r.length<3||!a.lijn)return a;let{min:o,max:s}=a,l=r.map(m=>[(m.t-i.van)/(i.tot-i.van)*e,t-(m.v-o)/(s-o)*t]),d=m=>m.toFixed(1),c=`M${d(l[0][0])},${d(l[0][1])}`;for(let m=0;m<l.length-1;m+=1){let b=l[m-1]??l[m],x=l[m],w=l[m+1],_=l[m+2]??w,z=[x[0]+(w[0]-b[0])/6*n*2,x[1]+(w[1]-b[1])/6*n*2],N=[w[0]-(_[0]-x[0])/6*n*2,w[1]-(_[1]-x[1])/6*n*2];z[1]=Math.min(t,Math.max(0,z[1])),N[1]=Math.min(t,Math.max(0,N[1])),z[0]=Math.min(w[0],Math.max(x[0],z[0])),N[0]=Math.min(w[0],Math.max(z[0],N[0])),c+=` C${d(z[0])},${d(z[1])} ${d(N[0])},${d(N[1])} ${d(w[0])},${d(w[1])}`}let p=d(t-(Math.max(o,0)-o)/(s-o)*t),h=l[l.length-1],u=`${c} L${d(h[0])},${p} L${d(l[0][0])},${p} Z`;return{lijn:c,vlak:u,min:o,max:s}}var ag="domotiapp-infoscherm-card",Va=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,pn={news:Va('<rect x="3.4" y="4.6" width="17.2" height="14.8" rx="2"/><path d="M7.2 9.2h9.6M7.2 12.6h9.6M7.2 16h5.6"/>'),cake:Va('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),offline:Va('<path d="M3.4 6.8a13.6 13.6 0 0 1 17.2 0M6.6 10.4a9 9 0 0 1 10.8 0M9.8 14a4.4 4.4 0 0 1 4.4 0"/><circle cx="12" cy="18" r="1"/><path d="M4 4l16 16"/>'),back:Va('<path d="m14.6 6.2-5.6 5.8 5.6 5.8"/>')},Qc=i=>pn[i]??v(i),Ba={aanwezig:{eyebrow:"Wie is er vandaag",titel:"Aanwezig",onder:"Tik op uw naam om u aan of af te melden."},nieuws:{eyebrow:"Nieuws",titel:"Wat er speelt",onder:""},weer:{eyebrow:"Weer",titel:"Vandaag en de komende dagen",onder:""},verlichting:{eyebrow:"Verlichting",titel:"Lampen",onder:"Tik op een lamp om hem aan of uit te zetten."},agenda:{eyebrow:"Agenda",titel:"Vandaag",onder:""},verjaardagen:{eyebrow:"Verjaardagen",titel:"Wie is er binnenkort jarig",onder:""},energie:{eyebrow:"Energie",titel:"Verbruik",onder:""},mededelingen:{eyebrow:"Mededelingen",titel:"Wat er speelt",onder:""},afval:{eyebrow:"Afval",titel:"Wanneer moet wat aan straat",onder:""}},$o=24,ig=`
  :host { display: block; height: 100%; }
...
`,hn=class extends M{constructor(){super(),this.stand_=null,this.feeds_=[],this.pagina_="welkom",this.uren_=[],this.dagen_=[],this.afspraken_=[],this.herkansing_=new se(()=>this.haal_()),this.dashHerkansing_=new se(()=>this.dashProbeer_(!0)),this.verbinding_=new je,this.fout_=null,this.html_=new Map,this.weerEntiteit_=null,this.weerOpzeggen_=[],this.agendaSleutel_="",this.mAuto_=0,this.energie_={entiteit:null,punten:[],geladen:0},this.dash_={prefs:null,bronnen:[],prijzen:{},stats:{},sleutel:"",bezig:!1,gehaald:0,fout:null,periode:"dag",offset:0}}validate(e){return{...e}}installatie_(){let e=this.stand_?.installatie??{};return{weer:e.weer??null,energie:e.energie??null,agendas:Array.isArray(e.agendas)?e.agendas:[],afval:Array.isArray(e.afval)?e.afval:[],verlichting:Array.isArray(e.verlichting)?e.verlichting:[]}}standNu_(){return this.stand_?{...this.stand_,installatie:this.installatie_()}:null}watched(){let e=this.installatie_();return[e.weer,e.energie,"sun.sun",...e.verlichting.map(t=>t.entity)].filter(Boolean)}getCardSize(){return 12}template(){let e=t=>`
      ...
      </div>`}wire(){let e=this.$(".scherm");this.on(e,"pointerdown",()=>this.leeft_(),{capture:!0,passive:!0}),this.on(e,"scroll",l=>{let d=l.target;d?.classList?.contains("m-baan")&&(this.mededelingTeller_(d),Date.now()>this.mAuto_&&this.mededelingStart_())},{capture:!0,passive:!0}),this.on(e,"pointerdown",l=>{let d=l.target?.closest?.(".m-baan");d&&l.pointerType!=="touch"&&this.sleepMededeling_(l,d)}),this.on(e,"click",l=>{let d=l.target,c=d.closest(".m-stippen span");if(c)return this.mededelingNaar_(c.closest(".blok")?.querySelector(".m-baan"),[...c.parentElement.children].indexOf(c));let p=d.closest(".bk[data-pagina]");if(p)return this.gaNaar_(p.dataset.pagina);let h=d.closest(".ed-per button[data-per]");if(h)return this.dashNaar_({periode:h.dataset.per});let u=d.closest(".ed-stap button[data-stap]");if(u&&!u.disabled)return this.dashNaar_({stap:Number(u.dataset.stap)});if(d.closest(".terug"))return this.gaNaar_("welkom");if(d.closest(".detail .sluit"))return this.sluitBericht_();let m=d.closest(".persoon[data-id]");if(m)return this.tikPersoon_(m.dataset.id);let b=d.closest(".lamp[data-id]");if(b)return this.tikLamp_(b.dataset.id);let x=d.closest(".bericht[data-id]");if(x)return this.openBericht_(x.dataset.id)});let t=()=>{if(this.inDialoog_())return e.style.setProperty("--hoogte","600px");let d=Math.max(0,Math.round(this.getBoundingClientRect().top))+(this.inBewerkmodus_()?72:0),c=d?`calc(100dvh - ${d}px)`:"100dvh";e.style.getPropertyValue("--hoogte")!==c&&e.style.setProperty("--hoogte",c)},n=()=>{t();let l=e.getBoundingClientRect();if(!l.width)return;let d=Number(this.stand_?.scherm?.schaal)||1,c=Math.min(l.width/1194,l.height?l.height/834:9)*d;e.style.setProperty("--ss",Math.max(.35,c).toFixed(3)),requestAnimationFrame(()=>this.pasAlleBij_())};this.meet_=n;let a=new ResizeObserver(n);a.observe(e),this.teardown_.push(()=>a.disconnect()),this.on(window,"resize",t),n();let r=()=>{this.paintKlok_(),this.paintRaster_(),this.klokTimer_=setTimeout(r,6e4-Date.now()%6e4+20)};r(),this.teardown_.push(()=>clearTimeout(this.klokTimer_)),this.mededelingStart_(),this.teardown_.push(()=>clearInterval(this.mTimer_)),this.leeft_(),this.teardown_.push(()=>clearTimeout(this.terugTimer_));let o=setInterval(()=>this.haalAgenda_(),10*6e4);this.teardown_.push(()=>clearInterval(o));let s=setInterval(()=>this.laadEnergie_(!0),15*6e4);this.teardown_.push(()=>clearInterval(s)),this.teardown_.push(()=>this.herkansing_.stop()),this.teardown_.push(()=>this.dashHerkansing_.stop()),this.teardown_.push(()=>this.zegWeerOp_()),this.haal_(),this.luister_()}inBewerkmodus_(){let e=this.parentNode;for(;e;){if(e.tagName?.toLowerCase()==="hui-card-options")return!0;e=e.parentNode??e.host??null}return!1}inDialoog_(){let e=this;for(;e;){let n=e.getRootNode?.()?.host;if(!n)return!1;let a=n.tagName?.toLowerCase()??"";if(a==="hui-dialog-edit-card"||a==="hui-card-preview"||a.startsWith("hui-dialog"))return!0;e=n}return!1}async haal_(){if(this.hass?.connection)try{let e=await rn(this.hass);this.feeds_=e.feeds??[],this.fout_=null,this.herkansing_.herstel(),this.nieuweStand_(e.stand),this.dashProbeer_()}catch(e){if(ie(e)){this.herkansing_.plan();return}this.fout_=e?.message??"Het infoscherm kon niet laden.",this.paint()}}nieuweStand_(e){this.stand_=e,this.meet_?.(),this.abonneerWeer_(),this.laadEnergie_(),this.haalAgenda_(),this.mededelingStart_(),this.paint()}async abonnement_(e){let t=!1;this.teardown_.push(()=>{t=!0});let n=await e();return t?n():this.teardown_.push(()=>{try{n()}catch{}}),n}async luister_(){if(this.hass?.connection?.subscribeMessage)try{await this.abonnement_(()=>Na(this.hass,e=>{e?.soort==="stand"?this.nieuweStand_(e.stand):e?.soort==="feeds"&&(this.feeds_=e.feeds??[],this.paint())}))}catch{}}set hass(e){let t=this.verbinding_.herverbonden(e);super.hass=e,t&&this.built_&&(this.haal_(),this.luister_()),this.paintMerkje_()}get hass(){return super.hass}zegWeerOp_(){for(let e of this.weerOpzeggen_)try{e()}catch{}this.weerOpzeggen_=[],this.weerEntiteit_=null}async abonneerWeer_(){let e=this.installatie_().weer;if(e!==this.weerEntiteit_&&(this.zegWeerOp_(),this.weerEntiteit_=e,this.uren_=[],this.dagen_=[],!(!e||!this.hass?.connection?.subscribeMessage)))for(let[t,n]of[["hourly","uren_"],["daily","dagen_"]])try{let a=await this.hass.connection.subscribeMessage(r=>{this.weerEntiteit_===e&&(this[n]=r?.forecast??[],this.paintRaster_(),this.paintPagina_("weer"))},{type:"weather/subscribe_forecast",forecast_type:t,entity_id:e});this.weerEntiteit_!==e?a():this.weerOpzeggen_.push(a)}catch{}}async haalAgenda_(){let e=this.installatie_().agendas;if(!e.length||!this.hass?.connection){this.afspraken_=[],this.agendaSleutel_="";return}this.agendaSleutel_=e.join(",");let t=new Date,n=new Date(t.getFullYear(),t.getMonth(),t.getDate()),a=new Date(t.getFullYear(),t.getMonth(),t.getDate()+1);try{let o=(await this.hass.connection.sendMessagePromise({type:"call_service",domain:"calendar",service:"get_events",service_data:{entity_id:e,start_date_time:n.toISOString(),end_date_time:a.toISOString()},return_response:!0}))?.response??{},s=[];for(let[l,d]of Object.entries(o))for(let c of d?.events??[])s.push({kalender:l,...c});s.sort((l,d)=>String(l.start).localeCompare(String(d.start))),this.afspraken_=s}catch{this.afspraken_=[]}this.paintRaster_(),this.paintPagina_("agenda")}async laadEnergie_(e=!1){let t=this.installatie_().energie;if(t===this.energie_.entiteit&&this.energie_.geladen&&!e||(t!==this.energie_.entiteit&&(this.energie_={entiteit:t,punten:[],geladen:0}),!t||!this.hass?.connection?.sendMessagePromise))return;let n=new Date,a=new Date(n.getTime()-($o+1)*36e5);try{let r=await this.hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:a.toISOString(),end_time:n.toISOString(),entity_ids:[t],minimal_response:!0,no_attributes:!0,significant_changes_only:!1});if(this.energie_.entiteit!==t)return;this.energie_.punten=Uc(r?.[t]),this.energie_.geladen=Date.now()}catch{this.energie_.geladen=Date.now()}this.energieLive_(),this.paintRaster_(),this.paintPagina_("energie")}async dashProbeer_(e=!1){if(!this.hass?.connection?.sendMessagePromise)return;let t=this.heeftDashboard_();try{await this.laadDashPrefs_(),this.heeftDashboard_()!==t&&this.paintRaster_(),(this.pagina_==="energie"||!this.installatie_().energie)&&(await this.laadDashStats_(e),this.paintRaster_()),this.dashHerkansing_.herstel()}catch(n){if(ie(n)){this.dashHerkansing_.plan();return}this.dash_.fout="Het energiedashboard is niet te lezen.",this.paintPagina_("energie")}}heeftDashboard_(){return _c(this.dash_.bronnen)}async laadDashPrefs_(){if(!(this.dash_.prefs||!this.hass?.connection?.sendMessagePromise))try{let e=await this.hass.connection.sendMessagePromise({type:"energy/get_prefs"});this.dash_.prefs=e??{},this.dash_.bronnen=wc(e),this.dash_.prijzen=Ec(e)}catch(e){if(ie(e))throw e;this.dash_.prefs={},this.dash_.bronnen=[],this.dash_.fout=e?.code==="not_found"?null:"Het energiedashboard is niet te lezen."}}async laadDashStats_(e=!1){if(await this.laadDashPrefs_(),!this.heeftDashboard_()||!this.hass?.connection?.sendMessagePromise)return;let t=this.dash_,n=uo(t.bronnen),a=Ta(t.periode,t.offset),r=`${t.periode}|${t.offset}|${n.join(",")}`;if(!(!e&&r===t.sleutel&&t.gehaald)&&!t.bezig){t.bezig=!0;try{let o=await this.hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:a.van.toISOString(),end_time:a.tot.toISOString(),statistic_ids:n,period:a.periode,types:["change"]});if(`${this.dash_.periode}|${this.dash_.offset}|${uo(this.dash_.bronnen).join(",")}`!==r)return;t.stats=o??{},t.sleutel=r,t.gehaald=Date.now(),t.fout=null}catch(o){if(ie(o))throw o;t.fout="De geschiedenis is niet op te halen."}finally{t.bezig=!1}this.paintPagina_("energie")}}dashNaar_({periode:e,stap:t}){let n=this.dash_;e&&e!==n.periode&&(n.periode=e,n.offset=0),t&&(n.offset=Math.min(0,n.offset+t)),n.gehaald=0,this.paintPagina_("energie"),this.leeft_(),this.dashProbeer_(!0)}htmlDashboard_(){let e=this.dash_,t=Ta(e.periode,e.offset),n=mo(e.bronnen,e.stats),a=jc(e.bronnen,e.stats,t),r=Ac(e.bronnen,e.stats,e.prijzen),o=(b,x)=>`<button type="button" data-per="${b}" aria-pressed="${e.periode===b}">${x}</button>`,s=[];for(let b of["zon","accu_uit","verbruik","teruglevering","accu_in"])a.some(x=>(x.rollen[b]??0)>0)&&s.push(b);let l=s.filter(b=>Ee[b]?.teken===1),d=Math.max(.001,...a.map(b=>l.reduce((x,w)=>x+(b.rollen[w]??0),0))),c=a.length?`<div class="ed-staven">
          ${a.map(b=>{let x=l.map(_=>{let z=b.rollen[_]??0;return z<=0?"":`<i style="--rol:${Ee[_].tone};height:${(z/d*100).toFixed(2)}%"></i>`}).reverse().join(""),w=l.filter(_=>(b.rollen[_]??0)>0).map(_=>`${Ee[_].naam}: ${re(b.rollen[_])}`).join(" \xB7 ");return`<span class="ed-staaf" title="${y(w)}">${x}</span>`}).join("")}
        </div>
        <div class="ed-as">${a.map(b=>`<span>${y($c(b.start,e.periode))}</span>`).join("")}</div>`:`<div class="ed-leeg">${y(e.fout??(e.bezig?"Bezig met ophalen\u2026":"Geen gegevens in deze periode."))}</div>`,p=(b,x,w,_)=>`<div class="ed-tegel" style="--rol:${Ee[w]?.tone??"var(--dac-ink-3)"}">
        <span class="ed-l">${y(b)}</span>
        <span class="ed-w">${y(x)}</span>
        ${_?`<span class="ed-b">${y(_)}</span>`:""}
      </div>`,h=[p("Van het net",re(n.netIn),"verbruik",n.zelfvoorzienend!==null?`${100-n.zelfvoorzienend}% van het verbruik`:""),n.zon>0?p("Opgewekt",re(n.zon),"zon",n.eigen>0?`${re(n.eigen)} zelf gebruikt`:""):"",n.netUit>0?p("Teruggeleverd",re(n.netUit),"teruglevering",""):"",n.accuUit>0||n.accuIn>0?p("Uit de accu",re(n.accuUit),"accu_uit",`${re(n.accuIn)} geladen`):"",n.gas>0?p("Gas",re(n.gas,"m\xB3"),"gas",""):"",n.water>0?p("Water",re(n.water,"m\xB3"),"water",""):"",r.bedrag>0?p("Kosten",zc(r.bedrag),"apparaat",r.compleet?"bij de ingestelde prijs":"schatting, niet alles heeft een prijs"):""].filter(Boolean).join(""),u=e.bronnen.map(b=>{let x=e.stats?.[b.statistiek]??[],w=0;for(let _ of x)w+=Number(_?.change)||0;return{...b,waarde:Math.max(0,Math.round(w*1e3)/1e3)}}).filter(b=>b.waarde>0).sort((b,x)=>x.waarde-b.waarde),m=b=>b==="gas"||b==="water"?"m\xB3":"kWh";return`<div class="ed">
      <div class="ed-balk">
        <div class="ed-per">
        ...
        <div class="ed-stap">
          ...
          <span class="ed-wanneer">${y(xc(e.periode,e.offset))}</span>
      ...
      <div class="ed-vak">
        <div class="ed-kop">
          ...
          <span class="ed-legenda">
            ${s.map(b=>`<span><i style="--rol:${Ee[b].tone}"></i>${y(Ee[b].naam)}</span>`).join("")}
          </span>
        </div>
        ${c}
      </div>
      ...
      ${u.length?`<div class="ed-bronnen">
        ${u.map(b=>`<div class="ed-bron" style="--rol:${Ee[b.rol]?.tone??"var(--dac-ink-3)"}">
          <i></i><span class="ed-n">${y(b.naam)}</span>
          <span class="ed-v">${y(re(b.waarde,m(b.rol)))}</span>
        </div>`).join("")}
      </div>`:""}

      <div class="ed-voet">Uit het energiedashboard van Home Assistant.</div>
    </div>`}htmlEnergieBlokDash_(){let e=this.dash_,n=e.periode==="dag"&&e.offset===0?mo(e.bronnen,e.stats):null;if(!n||!e.gehaald&&!n.verbruikt)return'<div class="e-nu"><span class="e-waarde">--</span></div>';let a=(r,o,s)=>`<div class="ed-bron" style="--rol:${Ee[s].tone}"><i></i><span class="ed-n">${y(r)}</span><span class="ed-v">${y(o)}</span></div>`;return`<div class="e-nu"><span class="e-waarde">${y(re(n.verbruikt))}</span></div>
      <div class="ed-bronnen">
        ${a("Van het net",re(n.netIn),"verbruik")}
        ${n.zon>0?a("Opgewekt",re(n.zon),"zon"):""}
        ${n.gas>0?a("Gas",re(n.gas,"m\xB3"),"gas"):""}
      </div>`}energieLive_(){let e=this.energie_;if(!e.entiteit)return;let t=k(this.hass,e.entiteit),n=Number(t?.state);if(!t||!Number.isFinite(n))return;let a=Date.parse(t.last_updated)||Date.now(),r=e.punten[e.punten.length-1];if(r&&r.t>=a)return;e.punten.push({t:a,v:n});let o=Date.now()-($o+2)*36e5;(e.punten.length>2e3||e.punten[0]&&e.punten[0].t<o)&&(e.punten=e.punten.filter(s=>s.t>=o))}htmlEnergie_(e=!1,t=!1){let n=this.installatie_().energie;if(!n)return this.heeftDashboard_()?this.htmlEnergieBlokDash_():"";this.energieLive_();let a=F(this.hass,n),r=a.unit_of_measurement??"W",o=Wc(a),s=Date.now(),l=Fc(this.energie_.punten,{nu:s,tellerstand:o,venster:$o}),d=qc(l),c=e?zo(l):Xc(Yc(l,48)),p=k(this.hass,n),h=!p||p.state==="unavailable"||p.state==="unknown",u=o?d.nu:Number(p?.state),m=z=>Zc(z,r),b=l.punten[l.punten.length-1],x=b&&c.max>c.min?(1-(b.v-c.min)/(c.max-c.min))*100:null,w=z=>{let N=[];for(let ne=0;ne<z;ne+=1)N.push(Ae(new Date(l.van+(l.tot-l.van)*ne/(z-1))));return N[z-1]="nu",N},_=c.lijn?`<div class="e-grafiek">
      ...
      <i></i>
      <span class="af-n">${y(e.naam)}</span>
      <span class="af-w">${y(ho(e))}${t&&e.dagen>1?` \xB7 over ${e.dagen} dagen`:""}</span>
    ...
    </div>`}htmlWeerNu_(){let e=this.installatie_().weer,t=k(this.hass,e),n=F(this.hass,e),a=n.temperature,r=[];return t&&r.push(fc[t.state]??ee(this.hass,t)),typeof n.humidity=="number"&&r.push(`${Math.round(n.humidity)}% vochtig`),typeof n.wind_speed=="number"&&r.push(`wind ${G(this.hass,n.wind_speed,0)} ${n.wind_speed_unit??"km/h"}`),`<div class="w-nu"><div class="w-icoon">${Da(t?.state,this.nacht_())}</div><div><div class="temp">${typeof a=="number"?`${G(this.hass,a,0)}\xB0`:"--\xB0"}</div><div class="w-tekst">${y(r.join(" \xB7 "))}</div></div></div>`}htmlUren_(e){let t=Date.now(),n=this.uren_.filter(a=>new Date(a.datetime).getTime()>t-30*6e4).slice(0,e);return n.length?`<div class="uren" style="grid-template-columns: repeat(${n.length}, minmax(0, 1fr))">${n.map(a=>{let r=new Date(a.datetime);return`<div class="uur"><span class="u">${Ae(r)}</span>${Da(a.condition,r.getHours()<7||r.getHours()>=21)}<span class="t">${typeof a.temperature=="number"?`${Math.round(a.temperature)}\xB0`:"--"}</span></div>`}).join("")}</div>`:""}htmlDagen_(){let e=new Date,t=this.dagen_.slice(0,7);return t.length?`<div class="dagen">${t.map(n=>{let a=new Date(n.datetime);return`<div class="dag"><span class="u">${y(Tc(a,e))}</span>${Da(n.condition)}<span class="t">${typeof n.temperature=="number"?`${Math.round(n.temperature)}\xB0`:"--"}</span>${typeof n.templow=="number"?`<span class="t2">${Math.round(n.templow)}\xB0</span>`:""}</div>`}).join("")}</div>`:""}htmlPersoon_(e){return`<div class="persoon ${e.aanwezig?"aan":""}" role="button" tabindex="0" data-id="${y(e.id)}">
      ...
      <div class="foto"></div>
      <div class="b-tekst">
        <div class="b-bron">${y(n)}${e.datum?` \xB7 ${y(_o(e.datum,new Date))}`:""}</div>
      ...
      <div class="l-tekst"><div class="l-naam">${y(c)}</div><div class="l-status">${d}</div></div>
    </div>`}htmlAfspraak_(e){let n=!String(e.start).includes("T")?"hele dag":`${Ae(new Date(e.start))}${e.end?` \u2013 ${Ae(new Date(e.end))}`:""}`,a=F(this.hass,e.kalender).friendly_name??e.kalender,r=this.installatie_().agendas.length>1;return`<div class="afspraak"><span class="a-tijd">${y(n)}</span><span class="a-tekst">${y(e.summary??"")}</span>${r?`<span class="a-kalender">${y(a)}</span>`:""}</div>`}paintPaginas_(){ko(this.standNu_(),this.feeds_,Qe(new Date)).includes(this.pagina_)||(this.pagina_="welkom");for(let t of this.$$(".pagina"))t.classList.toggle("actief",t.dataset.p===this.pagina_)}paintPagina_(e){if(e!==this.pagina_||e==="welkom")return;let t=this.$(`.p-inhoud[data-p="${e}"]`);if(!t)return;let n=this.stand_?.scherm??{};switch(e){case"aanwezig":{let a=this.stand_?.personen??[],r=d=>`<div class="tegels">${d.map(c=>this.htmlPersoon_(c)).join("")}</div>`,o=n.aanwezig_weergave??"gescheiden",s;if(o==="functie"){let d=Ic(a);s=`<div class="kolommen ${d.length>=3?"drie":"twee"}">${d.map(c=>`<div class="kolom"><div class="eyebrow">${y(c.functie||"Overig")} \xB7 ${c.personen.length}</div>${r(c.personen)}</div>`).join("")}</div>`}else if(o==="lijst")s=`<div class="tegels kol-3">${a.map(d=>this.htmlPersoon_(d)).join("")}</div>`;else{let{aanwezig:d,afwezig:c}=wo(a);s=`<div class="kolommen twee">
          ...
          </div>`,!1);break}case"agenda":{let a=this.afspraken_;this.vul_(t,a.length?`<div class="afspraken">${a.map(r=>this.htmlAfspraak_(r)).join("")}</div>`:'<div class="leeg">Geen afspraken vandaag.</div>',!1);break}case"afval":{let a=this.afvalLijst_(),r=po(a),o=a.filter(l=>l.reden),s=r.length?`<div class="af-pagina">
            ...
            </div>`:'<div class="leeg">Geen ophaaldata gevonden. Controleer of de gekozen sensoren een datum als toestand hebben.</div>';this.vul_(t,s,!1);break}default:}}paintMerkje_(){let e=this.$(".merkje");if(!e)return;let t=this.hass?.connected===!1;e.classList.toggle("open",t||!!this.fout_),this.text(".merkje span",t?"Geen verbinding":this.fout_??"")}};j(hn,"css",ig);L(ag,hn,{name:"DomotiApp Infoscherm",description:"Beeldvullend scherm voor een wachtkamer: logo, klok, weer, energie, wie er is, mededelingen, nieuws, verjaardagen en verlichting. Toevoegen en klaar; alles komt uit DomotiApp Infoscherm Beheer.",preview:!1});hn.getStubConfig=()=>({});var So="domotiapp-infoscherm-beheer-card",rg=["personen","mededelingen","verjaardagen","praktijk","scherm","installatie","indeling","instellingen"],Eo=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,ep={layout:Eo('<rect x="3.4" y="3.4" width="17.2" height="17.2" rx="2"/><path d="M3.4 9.6h17.2M9.6 9.6v11"/>'),cake:Eo('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),grip:Eo('<circle cx="9" cy="6" r="1.2" fill="currentColor"/><circle cx="15" cy="6" r="1.2" fill="currentColor"/><circle cx="9" cy="12" r="1.2" fill="currentColor"/><circle cx="15" cy="12" r="1.2" fill="currentColor"/><circle cx="9" cy="18" r="1.2" fill="currentColor"/><circle cx="15" cy="18" r="1.2" fill="currentColor"/>')},og=i=>ep[i]??v(i),Re=[{key:"personen",titel:"Medewerkers",icoon:"people",secties:["personen"]},{key:"mededelingen",titel:"Mededelingen",icoon:"bell",secties:["mededelingen","scherm"]},{key:"verjaardagen",titel:"Verjaardagen",icoon:"cake",secties:["verjaardagen"]},{key:"praktijk",titel:"Openingstijden",icoon:"clock",secties:["praktijk"]},{key:"indeling",titel:"Indeling van het scherm",icoon:"layout",secties:["indeling"]},{key:"verlichting",titel:"Verlichting",icoon:"bulb",secties:["installatie","instellingen"]},{key:"instellingen",titel:"Instellingen en logo",icoon:"cog",secties:["scherm","instellingen"]}],tp=["weather","energy","lights","calendars","waste","kiosk_users"],Pa=i=>Array.isArray(i)?i.filter(e=>typeof e=="string"&&e):typeof i=="string"&&i?[i]:[],np={title:"Infoscherm",weather:"",energy:"",lights:[],calendars:[],waste:[],kiosk_users:[],show_personen:!0,show_mededelingen:!0,show_verjaardagen:!0,show_praktijk:!0,show_indeling:!0,show_verlichting:!0,show_instellingen:!0,open:"personen"},sg=`
...
`,Jc=i=>JSON.parse(JSON.stringify(i??null)),P=i=>y(i??""),Ka=(i,e,t)=>Math.min(t,Math.max(e,i)),lg=700,Ao=150,Ot=class extends M{constructor(){super(),this.stand_=null,this.rechten_={},this.feedFouten_={},this.werk_={},this.vuil_=new Set,this.bezig_=new Set,this.versie_={},this.timers_={},this.fouten_={},this.uitgesteld_=new Set,this.open_=null,this.meldingen_={},this.herkansing_=new se(()=>this.haal_()),this.verbinding_=new je,this.fout_=null,this.laatstOpgeslagen_=""}validate(e){return this.installatieInConfig_=tp.some(t=>e[t]!==void 0),{...np,...e,weather:typeof e.weather=="string"?e.weather:"",energy:typeof e.energy=="string"?e.energy:"",lights:Pa(e.lights),calendars:Pa(e.calendars),waste:Pa(e.waste),kiosk_users:Pa(e.kiosk_users)}}watched(){return[]}async sync_(){if(!this.hass?.connection||!this.stand_||!this.hass.user?.is_admin||!this.installatieInConfig_)return;let e=this.config,t={weer:e.weather||null,energie:e.energy||null,agendas:e.calendars,afval:e.waste,verlichting:e.lights,kiosk_gebruikers:e.kiosk_users},n=JSON.stringify(t),a=this.stand_.installatie??{},r=JSON.stringify({weer:a.weer??null,energie:a.energie??null,agendas:a.agendas??[],afval:a.afval??[],verlichting:(a.verlichting??[]).map(o=>o.entity),kiosk_gebruikers:this.stand_.instellingen?.kiosk_gebruikers??[]});if(!(n===r||n===this.laatstGesynct_)){this.laatstGesynct_=n;try{await rc(this.hass,t)}catch{this.laatstGesynct_=""}}}getCardSize(){return 6}getGridOptions(){return{columns:"full",rows:"auto",min_rows:this.minRijen_(".card",6)}}blokken_(){return Re.filter(e=>this.config[`show_${e.key}`]!==!1&&(!e.admin||this.rechten_.is_admin))}blokInfo_(e){return Re.find(t=>t.key===e)}template(){let e=this.config;return`
      ...
      <div class="lijst">${e.map((a,r)=>`<div class="item mededeling" data-i="${r}">
          <div class="veld"><label>Tekst op het scherm</label><textarea data-veld="tekst" data-i="${r}" rows="2">${P(a.tekst)}</textarea></div>
      ...
      <div class="veld"><label>Afwijkende dagen (feestdagen, studiedagen)</label>
      ...
      </div>`}htmlIndeling_(e){let t=e?.blokken??[],n=Qe(new Date),a=t.map(s=>{let l=Je[s.soort];if(!l)return"";let d=Ia(s.soort,this.stand_,[],n);return`<div class="ib ${d?"ontbreekt":""}" data-id="${P(s.id)}" style="${this.ibStijl_(s)}" title="${P(d?`${l.naam}: ${d}`:`${l.naam} -- sleep om te verplaatsen, hoek rechtsonder om de maat te wijzigen`)}">
          <div class="ib-in">
        ...
        </div>`}).join(""),r=new Set(t.map(s=>s.soort)),o=Gc.filter(s=>!r.has(s));return`<div class="hulp">Zo staat het welkomscherm op de iPad. Sleep een blok om het te verplaatsen, trek aan de hoek rechtsonder om het groter of kleiner te maken, en zet met \u2212 en + hoeveel er in een blok staat ("alle" = zoveel als er is). Een gestippeld blok staat NIET op het scherm zolang er niets in te tonen valt; de reden staat erin. Elke wijziging gaat meteen naar het scherm.</div>
      ...
      <div class="lijst">${a||'<div class="leeg">Er zijn nog geen lampen gekozen.</div>'}</div>`}htmlInstellingen_(e={},t={}){let n=(t.feeds??[]).map((a,r)=>`<div class="item feed" data-i="${r}">
          ...
          ${this.feedFouten_[a.url]?`<div class="feedfout" style="grid-column: 1 / -1">Niet opgehaald: ${P(this.feedFouten_[a.url])}</div>`:""}
        </div>`).join("");return`
      <div class="rij twee">
      ...
      </div>`}plaatjes_(e){for(let t of e.querySelectorAll("[data-bestand]:not([data-bestand=''])"))on(this.hass,t.dataset.bestand).then(n=>{n&&t.isConnected&&(t.innerHTML=`<img alt="" src="${n}">`)})}markeer_(e,t,n=Ao){this.vuil_.add(e),this.bron_={...this.bron_??{},[e]:t},this.versie_[e]=(this.versie_[e]??0)+1,this.fouten_[e]=null,t&&(this.meldingen_[t]=null,this.tel_(t)),this.status_("Opslaan\u2026","bezig"),clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),n)}invoer_(e){let t=e.target;if(t?.dataset?.actie==="blok_toevoegen")return this.blokToevoegen_(t.value,t);let n=t?.dataset?.veld;if(!n)return;let a=t.closest(".blok")?.dataset.blok;if(!a)return;let r=this.blokInfo_(a),o=t.dataset.s||r.secties[0],s=t.dataset.i,l=this.werk_[o],d=t.type==="checkbox"?t.checked:t.value,c=t.type==="text"||t.type==="url"||t.type==="number"||t.tagName==="TEXTAREA",p=t.type==="color";if(!((c||p)&&e.type!=="input")&&!(!c&&!p&&e.type!=="change")){if(o==="personen"||o==="mededelingen"||o==="verjaardagen"){let h=l[Number(s)];if(!h)return;if(h[n]=d,n==="naam"){let u=t.closest(".item")?.querySelector(".avatar");u&&!u.querySelector("img")&&(u.textContent=xo(d))}if(n==="aanwezig"){h._aanwezig=!0;let u=t.closest(".vink")?.querySelector(".vl");u&&(u.textContent=d?"Aanwezig":"Afwezig"),t.closest(".item")?.querySelector(".avatar")?.classList.toggle("aan",d)}}else if(o==="praktijk")this.invoerPraktijk_(l,n,s,d,t);else if(o==="scherm")if(n==="accent_kleur"){l.accent=d;let h=t.closest(".b-onder")?.querySelector('[data-veld="accent"]');h&&(h.value=d)}else if(n==="accent")l.accent=String(d).trim()||null;else if(t.type==="number"){let h=Number(d);if(!Number.isFinite(h))return;l[n]=h}else l[n]=d;else if(o==="installatie"){if(n==="l_naam"){let h=l.verlichting?.[Number(s)];h&&(h.naam=d)}}else if(o==="instellingen")if(n.startsWith("f_")){let h=l.feeds[Number(s)];h&&(h[n.slice(2)]=d)}else l[n]=d;this.markeer_(o,a,c?lg:Ao)}}invoerPraktijk_(e,t,n,a,r){if(t==="ot_open"){e.openingstijden??={},e.openingstijden[n]=a?[["08:00","17:00"]]:[];let o=r.closest(".ot-tabel");for(let l of o.querySelectorAll(`input[type="time"][data-i="${n}"]`)){l.disabled=!a;let[,d,c]=l.dataset.veld.split("_");l.value=e.openingstijden[n][Number(d)]?.[Number(c)]??""}let s=r.closest(".vink")?.querySelector(".vl");s&&(s.textContent=a?"open":"gesloten")}else if(t.startsWith("ot_")){let[,o,s]=t.split("_").map(Number);e.openingstijden??={};let l=e.openingstijden[n]??[];for(;l.length<=o;)l.push(["",""]);l[o][s]=a,e.openingstijden[n]=l.filter((d,c)=>c===0||d[0]&&d[1]),e.openingstijden[n].length||(e.openingstijden[n]=[["",""]])}else if(t.startsWith("u_")){let o=e.uitzonderingen[Number(n)];if(!o)return;let s=t.slice(2);if(s==="open"){o.tijden=a?[["08:00","17:00"]]:[];let l=r.closest(".item");for(let c of l.querySelectorAll('input[type="time"]'))c.disabled=!a,c.value=a?c.dataset.veld==="u_van"?"08:00":"17:00":"";let d=r.closest(".vink")?.querySelector(".vl");d&&(d.textContent=a?"open":"gesloten")}else s==="van"||s==="tot"?o.tijden=[[s==="van"?a:o.tijden?.[0]?.[0]??"",s==="tot"?a:o.tijden?.[0]?.[1]??""]]:o[s]=a}else e[t]=a}blokToevoegen_(e,t){t&&(t.value="");let n=Je[e];if(!n)return;let a=this.werk_.indeling??(this.werk_.indeling={blokken:[]});if(a.blokken.some(l=>l.soort===e))return;let[r,o]=n.maat,s=jo(a.blokken,r,o);for(;!s&&(r>1||o>1);)o>1?o-=1:r-=1,s=jo(a.blokken,r,o);return s?(a.blokken.push({id:`b-${Date.now().toString(36)}${Math.floor(Math.random()*1e4).toString(36)}`,soort:e,x:s.x,y:s.y,w:r,h:o,aantal:n.aantal?3:0}),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):(this.meldingen_.indeling={tekst:"Er is geen plek meer. Maak eerst een ander blok kleiner of haal er een weg.",fout:!0},this.teken_("indeling",!0))}sleepLijst_(e,t){let n=t.closest(".item"),a=n?.parentElement,r=n?.closest(".blok")?.dataset.blok;if(!n||!a||!r||e.pointerType==="mouse"&&e.button!==0)return;let o=this.blokInfo_(r).secties[0],s=this.werk_[o],l=Number(n.dataset.i);if(!Array.isArray(s)||!s[l])return;e.preventDefault(),n.classList.add("sleept");let d=p=>{let h=[...a.children].filter(m=>m!==n),u=null;for(let m of h){let b=m.getBoundingClientRect();if(p.clientY<b.top+b.height/2){u=m;break}}n.nextElementSibling!==u&&n!==u&&a.insertBefore(n,u)},c=()=>{window.removeEventListener("pointermove",d,!0),window.removeEventListener("pointerup",c,!0),window.removeEventListener("pointercancel",c,!0),n.classList.remove("sleept");let p=[...a.children].indexOf(n);if(p!==l&&p>=0){let[h]=s.splice(l,1);s.splice(p,0,h),this.markeer_(o,r)}this.teken_(r,!0)};window.addEventListener("pointermove",d,!0),window.addEventListener("pointerup",c,!0),window.addEventListener("pointercancel",c,!0),this.teardown_.push(c)}sleepStart_(e){let t=e.target.closest?.(".greep");if(t)return this.sleepLijst_(e,t);let n=e.target.closest?.(".ib");if(!n||e.target.closest("button, input, select")||e.pointerType==="mouse"&&e.button!==0)return;let a=n.closest(".raster"),r=this.werk_.indeling,o=r?.blokken?.find(w=>w.id===n.dataset.id);if(!o||!a)return;let s=e.target.closest(".ib-greep")?"maat":"plaats",l=a.getBoundingClientRect(),d=l.width/Me,c=l.height/Se,p={x:e.clientX,y:e.clientY},h={...o},u=!1;e.preventDefault();try{n.setPointerCapture(e.pointerId)}catch{}n.classList.add("sleept");let m=w=>{if(s!=="plaats")return null;let _=r.blokken.filter(N=>N.id!==w.id&&yo(N,w));if(_.length!==1)return null;let z=_[0];return z.w===w.w&&z.h===w.h&&z.x===w.x&&z.y===w.y?z:null},b=w=>{let _=Math.round((w.clientX-p.x)/d),z=Math.round((w.clientY-p.y)/c);(_||z)&&(u=!0),h=s==="plaats"?{...o,x:Ka(o.x+_,0,Me-o.w),y:Ka(o.y+z,0,Se-o.h)}:{...o,w:Ka(o.w+_,1,Me-o.x),h:Ka(o.h+z,1,Se-o.y)},n.classList.toggle("ongeldig",!Ha(r.blokken,h)&&!m(h)),n.style.cssText=this.ibStijl_(h)},x=()=>{n.removeEventListener("pointermove",b),n.removeEventListener("pointerup",x),n.removeEventListener("pointercancel",x),n.classList.remove("sleept","ongeldig");let w=h.x!==o.x||h.y!==o.y||h.w!==o.w||h.h!==o.h,_=u&&w?m(h):null;_?(Object.assign(_,{x:o.x,y:o.y}),Object.assign(o,{x:h.x,y:h.y}),this.markeer_("indeling","indeling")):u&&w&&Ha(r.blokken,h)&&(Object.assign(o,h),this.markeer_("indeling","indeling")),this.teken_("indeling",!0)};n.addEventListener("pointermove",b),n.addEventListener("pointerup",x),n.addEventListener("pointercancel",x)}async klik_(e){let t=e.target.closest(".bk");if(t){let c=t.closest(".blok").dataset.blok;this.open_=this.open_===c?null:c;for(let p of this.$$(".blok"))p.classList.toggle("open",p.dataset.blok===this.open_);this.open_&&this.uitgesteld_.has(this.open_)&&this.teken_(this.open_,!0);return}let n=e.target.closest("[data-actie]");if(!n||n.disabled||n.tagName==="SELECT")return;let a=n.closest(".blok")?.dataset.blok,r=n.dataset.actie;if(r==="segment"){let c=n.closest(".segment");for(let p of c.querySelectorAll("button"))p.classList.toggle("aan",p===n),p.setAttribute("aria-checked",String(p===n));return c.value=n.dataset.waarde,this.invoer_({target:c,type:"change"})}let o=Number(n.dataset.i),l=this.blokInfo_(a)?.secties[0],d=this.werk_[l];if(r==="nieuw"){let c={personen:{naam:"",functie:"",aanwezig:!1},mededelingen:{tekst:""},verjaardagen:{naam:"",datum:"",jaar_tonen:!0}}[l];d.push(c),this.teken_(a,!0),this.$(`.blok[data-blok="${a}"] .item:last-of-type input[type="text"], .blok[data-blok="${a}"] .item:last-of-type textarea`)?.focus();return}if(r==="verwijder"){let c=d[o],p=c?.naam||c?.titel||c?.tekst||"dit item";return c&&(c.id||c.naam||c.titel||c.tekst)&&!await ze({title:"Verwijderen?",text:`"${p}" verdwijnt meteen van het scherm.`,confirmText:"Verwijderen"})?void 0:(d.splice(o,1),this.markeer_(l,a),this.teken_(a,!0))}if(r==="foto"||r==="logo"){this.doel_=r==="logo"?{sectie:"scherm",blok:a,veld:"logo"}:{sectie:l,blok:a,i:o,veld:"foto"};let c=this.$(".file");c.value="",c.click();return}if(r==="fotoweg"||r==="logoweg")return r==="logoweg"?(this.werk_.scherm.logo=null,this.markeer_("scherm",a)):(d[o].foto=null,this.markeer_(l,a)),this.teken_(a,!0);if(r==="u_nieuw")return d.uitzonderingen??=[],d.uitzonderingen.push({datum:"",tijden:[],reden:""}),this.teken_(a,!0);if(r==="u_verwijder")return d.uitzonderingen.splice(o,1),this.markeer_(l,a),this.teken_(a,!0);if(r==="f_nieuw"){let c=this.werk_.instellingen;return c.feeds??=[],c.feeds.push({naam:"",url:""}),this.teken_(a,!0)}if(r==="f_verwijder")return this.werk_.instellingen.feeds.splice(o,1),this.markeer_("instellingen",a),this.teken_(a,!0);if(r==="f_ververs"){n.disabled=!0;try{let c=await sc(this.hass);this.feedFouten_=c.feed_fouten??{},this.meldingen_[a]={tekst:`${(c.feeds??[]).length} bericht(en) opgehaald.`}}catch(c){this.meldingen_[a]={tekst:c?.message??"Ophalen lukte niet.",fout:!0}}return this.teken_(a,!0)}if(r==="blok_weg"||r==="aantal_min"||r==="aantal_plus"){let c=this.werk_.indeling,p=c?.blokken?.find(h=>h.id===n.dataset.id);return p?(r==="blok_weg"?c.blokken=c.blokken.filter(h=>h!==p):r==="aantal_min"?p.aantal=p.aantal<=1?0:p.aantal-1:p.aantal=Math.min(50,(p.aantal||0)+1),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}if(r==="indeling_standaard")return await ze({title:"Standaardindeling?",text:"De blokken gaan terug naar hun oorspronkelijke plek en maat.",confirmText:"Terugzetten"})?(this.werk_.indeling=Ra(),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}async bestandGekozen_(e){let t=e.target.files?.[0],n=this.doel_;if(this.doel_=null,!t||!n)return;let{sectie:a,blok:r,i:o,veld:s}=n;this.meldingen_[r]={tekst:"Bezig met uploaden\u2026"},this.teken_(r,!0);try{let l=await dc(this.hass,t),d=this.werk_[a],c=o===void 0?d:d[o],p=c[s];c[s]=l.id,p&&(this.oudeBestanden_=[...this.oudeBestanden_??[],p]),this.meldingen_[r]={tekst:`${l.naam||"Bestand"} ge\xFCpload.`},this.markeer_(a,r)}catch(l){this.meldingen_[r]={tekst:l?.message??"Uploaden lukte niet.",fout:!0}}this.teken_(r,!0)}payload_(e){let t=this.werk_[e];switch(e){case"personen":return(t??[]).filter(n=>n.naam?.trim()).map(({_aanwezig:n,aanwezig:a,...r})=>n?{...r,aanwezig:a}:r);case"mededelingen":return(t??[]).filter(n=>n.tekst?.trim());case"verjaardagen":return(t??[]).filter(n=>n.naam?.trim()&&n.datum);case"praktijk":return{openingstijden:Object.fromEntries(pt.map(n=>[n,(t.openingstijden?.[n]??[]).filter(a=>a[0]&&a[1])])),uitzonderingen:(t.uitzonderingen??[]).filter(n=>n.datum).map(n=>({...n,tijden:(n.tijden??[]).filter(a=>a[0]&&a[1])}))};case"instellingen":return{...t,feeds:(t.feeds??[]).filter(n=>n.url?.trim())};default:return t}}async bewaar_(e){if(!this.hass||this.bezig_.has(e))return;let t=this.versie_[e]??0;this.bezig_.add(e),this.status_("Opslaan\u2026","bezig");try{let a=(await ic(this.hass,e,this.payload_(e)))[e];this.koppel_(e,a),this.stand_&&(this.stand_[e]=Jc(a)),this.fouten_[e]=null,(this.versie_[e]??0)===t&&this.vuil_.delete(e);let r=new Date;this.laatstOpgeslagen_=`${String(r.getHours()).padStart(2,"0")}:${String(r.getMinutes()).padStart(2,"0")}`;for(let o of this.oudeBestanden_??[])this.inGebruik_(o)||(oc(this.hass,o).catch(()=>{}),cc(o));this.oudeBestanden_=[]}catch(n){this.fouten_[e]=n?.message??"Opslaan lukte niet."}finally{this.bezig_.delete(e)}this.vuil_.has(e)&&(this.versie_[e]??0)!==t&&!this.fouten_[e]&&(clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),Ao));for(let n of Re)n.secties.includes(e)&&this.tel_(n.key);if(!this.fouten_[e])for(let n of Re)n.secties.includes(e)&&n.key!==this.bron_?.[e]&&this.teken_(n.key);if(this.fouten_[e]){this.status_(`Niet opgeslagen: ${this.fouten_[e]}`,"fout");for(let n of Re)n.secties.includes(e)&&this.teken_(n.key)}else!this.bezig_.size&&!this.vuil_.size&&this.status_(`Opgeslagen ${this.laatstOpgeslagen_}`,"ok")}koppel_(e,t){let n=this.werk_[e];if(!Array.isArray(n)||!Array.isArray(t))return;let a={personen:o=>o.naam?.trim(),mededelingen:o=>o.tekst?.trim(),verjaardagen:o=>o.naam?.trim()&&o.datum}[e];if(!a)return;let r=0;n.forEach((o,s)=>{if(!a(o))return;let l=t[r];if(r+=1,!l)return;o.id=l.id,e==="personen"&&(o.initialen=l.initialen,o._aanwezig&&delete o._aanwezig);let d=this.$(`.blok[data-blok="${e}"] .item[data-i="${s}"]`);d&&(d.dataset.id=l.id)})}inGebruik_(e){let t=this.stand_??{};return t.scherm?.logo===e||(t.personen??[]).some(n=>n.foto===e)||(this.werk_.personen??[]).some(n=>n.foto===e)||this.werk_.scherm?.logo===e}};j(Ot,"css",sg);var dg={title:"Titel",weather:"Weerentiteit",energy:"Energiesensor (vermogen of tellerstand)",lights:"Lampen en schakelaars op het scherm",calendars:"Agenda's (de afspraken van vandaag)",kiosk_users:"Kioskaccounts",show_personen:"Blok Medewerkers",show_mededelingen:"Blok Mededelingen",show_verjaardagen:"Blok Verjaardagen",show_praktijk:"Blok Openingstijden",show_indeling:"Blok Indeling",show_verlichting:"Blok Verlichting",show_instellingen:"Blok Instellingen en logo",open:"Staat open bij het laden"},cg={weather:"Leeg = geen weer op het scherm.",energy:"Het blok Energie: een vermogenssensor (W of kW) geeft een live lijn van de afgelopen 24 uur; een tellerstand (kWh) het verbruik per uur. Leeg = geen energie op het scherm.",lights:"De namen zoals ze op het scherm staan geeft de receptie hieronder in het blok Verlichting; daar staat ook de schakelaar om ze te tonen.",kiosk_users:"Het account waarmee de iPad is ingelogd. Zo'n account mag alleen aanwezigheid omzetten en lampen schakelen, en niets beheren. Alleen een beheerder ziet deze lijst.",show_instellingen:"Logo, accent, uiterlijk, het welkomblok en de nieuwsbronnen. Zet dit blok uit op een dashboard voor een receptie die daar niet aan hoeft te zitten."},Mo=class extends T{defaults(){return{...np}}setConfig(e){this.ruwLeeg_=!tp.some(t=>e?.[t]!==void 0),super.setConfig(e),this.zaai_()}set hass(e){super.hass=e,this.gebruikers_===void 0&&e?.connection&&e.user?.is_admin&&(this.gebruikers_=null,lc(e).then(t=>{this.gebruikers_=(t.gebruikers??[]).map(n=>({value:n.id,label:`${n.naam}${n.is_admin?" (beheerder)":""}`})),this.sync_()}).catch(()=>{this.gebruikers_=[]})),this.zaad_===void 0&&e?.connection&&(this.zaad_=null,rn(e).then(t=>{let n=t.stand?.installatie??{};this.zaad_={weather:n.weer??"",energy:n.energie??"",lights:(n.verlichting??[]).map(a=>a.entity),calendars:n.agendas??[],kiosk_users:t.stand?.instellingen?.kiosk_gebruikers??[]},this.zaai_()}).catch(()=>{this.zaad_={}}))}get hass(){return super.hass}zaai_(){!this.zaad_||!this.ruwLeeg_||this.gezaaid_||(this.gezaaid_=!0,this.config_={...this.config_,...this.zaad_},this.sync_())}schema(){let e=[{name:"weather",selector:f.entity("weather")},{name:"energy",selector:f.entity("sensor")},{name:"lights",selector:{entity:{multiple:!0,domain:["light","switch"]}}},{name:"calendars",selector:{entity:{multiple:!0,domain:"calendar"}}},{name:"waste",selector:{entity:{multiple:!0,domain:"sensor"}}}];return this.gebruikers_?.length&&e.push({name:"kiosk_users",selector:{select:{multiple:!0,mode:"list",options:this.gebruikers_}}}),[...e,{name:"title",selector:f.text()},{name:"open",selector:f.select([...Re.map(t=>({value:t.key,label:t.titel})),{value:"geen",label:"Alles dicht"}])},...Re.map(t=>({name:`show_${t.key}`,selector:f.bool()}))]}label(e){return dg[e.name]??super.label(e)}helper(e){return cg[e.name]}};L(So,Ot,{name:"DomotiApp Infoscherm Beheer",description:"Voor de receptie: medewerkers, mededelingen, verjaardagen, openingstijden, de indeling van het scherm en het logo. Alles wordt vanzelf opgeslagen en staat meteen op het scherm. De installateur kiest hier ook het weer, de energiesensor, de lampen, de agenda's en het kioskaccount.",preview:!1});O(`${So}-editor`,Mo);Ot.getConfigElement=()=>document.createElement(`${So}-editor`);Ot.getStubConfig=()=>({title:"Infoscherm"});var Ga=globalThis,Wa=Ga.ShadowRoot&&(Ga.ShadyCSS===void 0||Ga.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,No=Symbol(),ap=new WeakMap,un=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==No)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Wa&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=ap.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&ap.set(t,e))}return e}toString(){return this.cssText}},He=i=>new un(typeof i=="string"?i:i+"",void 0,No),ce=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new un(t,i,No)},ip=(i,e)=>{if(Wa)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=Ga.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},Do=Wa?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return He(t)})(i):i;var{is:pg,defineProperty:hg,getOwnPropertyDescriptor:ug,getOwnPropertyNames:mg,getOwnPropertySymbols:gg,getPrototypeOf:fg}=Object,Ua=globalThis,rp=Ua.trustedTypes,bg=rp?rp.emptyScript:"",vg=Ua.reactiveElementPolyfillSupport,mn=(i,e)=>i,Lo={toAttribute(i,e){switch(e){case Boolean:i=i?bg:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},sp=(i,e)=>!pg(i,e),op={attribute:!0,type:String,converter:Lo,reflect:!1,useDefault:!1,hasChanged:sp};Symbol.metadata??=Symbol("metadata"),Ua.litPropertyMetadata??=new WeakMap;var Ie=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=op){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&hg(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=ug(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??op}static _$Ei(){if(this.hasOwnProperty(mn("elementProperties")))return;let e=fg(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(mn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(mn("properties"))){let t=this.properties,n=[...mg(t),...gg(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(Do(a))}else e!==void 0&&t.push(Do(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ip(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Lo).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Lo;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??sp)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};Ie.elementStyles=[],Ie.shadowRootOptions={mode:"open"},Ie[mn("elementProperties")]=new Map,Ie[mn("finalized")]=new Map,vg?.({ReactiveElement:Ie}),(Ua.reactiveElementVersions??=[]).push("2.1.2");var Vo=globalThis,lp=i=>i,Fa=Vo.trustedTypes,dp=Fa?Fa.createPolicy("lit-html",{createHTML:i=>i}):void 0,gp="$lit$",et=`lit$${Math.random().toFixed(9).slice(2)}$`,fp="?"+et,kg=`<${fp}>`,mt=document,fn=()=>mt.createComment(""),bn=i=>i===null||typeof i!="object"&&typeof i!="function",Bo=Array.isArray,xg=i=>Bo(i)||typeof i?.[Symbol.iterator]=="function",To=`[ 	
\f\r]`,gn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,cp=/-->/g,pp=/>/g,ht=RegExp(`>|${To}(?:([^\\s"'>=/]+)(${To}*=${To}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),hp=/'/g,up=/"/g,bp=/^(?:script|style|textarea|title)$/i,Po=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),$=Po(1),k1=Po(2),x1=Po(3),gt=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),mp=new WeakMap,ut=mt.createTreeWalker(mt,129);function vp(i,e){if(!Bo(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return dp!==void 0?dp.createHTML(e):e}var wg=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=gn;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===gn?c[1]==="!--"?o=cp:c[1]!==void 0?o=pp:c[2]!==void 0?(bp.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=ht):c[3]!==void 0&&(o=ht):o===ht?c[0]===">"?(o=a??gn,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?ht:c[3]==='"'?up:hp):o===up||o===hp?o=ht:o===cp||o===pp?o=gn:(o=ht,a=void 0);let u=o===ht&&i[s+1].startsWith("/>")?" ":"";r+=o===gn?l+kg:p>=0?(n.push(d),l.slice(0,p)+gp+l.slice(p)+et+u):l+et+(p===-2?s:u)}return[vp(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},vn=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=wg(e,t);if(this.el=i.createElement(d,n),ut.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=ut.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(gp)){let h=c[o++],u=a.getAttribute(p).split(et),m=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:m[2],strings:u,ctor:m[1]==="."?Co:m[1]==="?"?Ro:m[1]==="@"?Ho:Rt}),a.removeAttribute(p)}else p.startsWith(et)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(bp.test(a.tagName)){let p=a.textContent.split(et),h=p.length-1;if(h>0){a.textContent=Fa?Fa.emptyScript:"";for(let u=0;u<h;u++)a.append(p[u],fn()),ut.nextNode(),l.push({type:2,index:++r});a.append(p[h],fn())}}}else if(a.nodeType===8)if(a.data===fp)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(et,p+1))!==-1;)l.push({type:7,index:r}),p+=et.length-1}r++}}static createElement(e,t){let n=mt.createElement("template");return n.innerHTML=e,n}};function Ct(i,e,t=i,n){if(e===gt)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=bn(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Ct(i,a._$AS(i,e.values),a,n)),e}var Oo=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??mt).importNode(t,!0);ut.currentNode=a;let r=ut.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new kn(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Io(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=ut.nextNode(),o++)}return ut.currentNode=mt,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},kn=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ct(this,e,t),bn(e)?e===E||e==null||e===""?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==gt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):xg(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&bn(this._$AH)?this._$AA.nextSibling.data=e:this.T(mt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=vn.createElement(vp(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Oo(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=mp.get(e.strings);return t===void 0&&mp.set(e.strings,t=new vn(e)),t}k(e){Bo(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(fn()),this.O(fn()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=lp(e).nextSibling;lp(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Rt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=E}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Ct(this,e,t,0),o=!bn(e)||e!==this._$AH&&e!==gt,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Ct(this,s[n+l],t,l),d===gt&&(d=this._$AH[l]),o||=!bn(d)||d!==this._$AH[l],d===E?e=E:e!==E&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Co=class extends Rt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}},Ro=class extends Rt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}},Ho=class extends Rt{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Ct(this,e,t,0)??E)===gt)return;let n=this._$AH,a=e===E&&n!==E||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==E&&(n===E||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Io=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ct(this,e)}};var _g=Vo.litHtmlPolyfillSupport;_g?.(vn,kn),(Vo.litHtmlVersions??=[]).push("3.3.3");var kp=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new kn(e.insertBefore(fn(),r),r,void 0,t??{})}return a._$AI(i),a};var Ko=globalThis,te=class extends Ie{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=kp(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return gt}};te._$litElement$=!0,te.finalized=!0,Ko.litElementHydrateSupport?.({LitElement:te});var yg=Ko.litElementPolyfillSupport;yg?.({LitElement:te});(Ko.litElementVersions??=[]).push("4.2.2");var ve=ce`
  :host {
    ${He(U)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${He(Ve)}
`;var jg=["unavailable","unknown"],zg=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function qa({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||jg.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of zg)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Za(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var Wo=["hs","rgb","rgbw","rgbww","xy"],Uo="color_temp",$g="onoff";var ft="kleur";var Eg=["unavailable","unknown"],wp=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Ag=[0,100];function Ne(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===$g,a=t!==null&&t.includes(Uo),r=t!==null&&t.some(d=>Wo.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Eg.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function Mg(){return{state:"off"}}function _p(i,e){let t=e??Ne(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...Og(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function yp(i,e,t,n){return e?i&&i.state==="on"?{...i}:_p(t,n):{state:"off"}}function jp(i,e,t,n){let a=n??Ne(t),r=Qo(i,t,a);return a.helderheid&&(r.brightness=W(e,1,255)),r}function Fo(i,e,t,n){let a=n??Ne(t),r=Qo(i,t,a);return Tp(r),r.color_temp_kelvin=W(e,a.minKelvin,a.maxKelvin),r}function qo(i,e,t,n){let a=n??Ne(t),r=Qo(i,t,a);return Tp(r),r.hs_color=[W(e?.[0],0,360),W(e?.[1],0,100)],r}function Ya(i,e,t){return i??Mg()}function zp(i,e,t){let n=Ya(i,e,t);if(typeof n.brightness=="number")return W(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?W(a,1,255):255}function Zo(i,e,t){let n=t??Ne(e),a=Ya(i,e,n);if(typeof a.color_temp_kelvin=="number")return W(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?W(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Xa(i,e,t){let n=Ya(i,e,t);if(Go(n.hs_color))return[W(n.hs_color[0],0,360),W(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Go(a)?[W(a[0],0,360),W(a[1],0,100)]:[...Ag]}function Yo(i){return i!=null&&typeof i=="object"}function $p(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Yo(a[s]?.lights?.[o]))return!0;return!1})}function Ep(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Xo(i,e,t){return Ya(i,e,t).state==="on"}function Ap(i,e,t){let n=t??Ne(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Xo(i,e,n),r=Mp(n),o=r?Sg(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===ft),kleurkeuze:a&&r,stand:a?o:null}}function Mp(i){return!!(i?.kleurtemp&&i?.kleur)}function Sg(i,e,t){let n=t??Ne(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(wp.slice(1).some(r=>i[r]!==void 0))return ft}let a=e?.attributes?.color_mode;return a===Uo&&n.kleurtemp?"wit":Wo.includes(a)&&n.kleur?ft:"wit"}function Sp(i,e,t,n){let a=n??Ne(t);return Mp(a)?e==="wit"?Fo(i,Zo(i,t,a),t,a):qo(i,Xa(i,t,a),t,a):i}function Np(i){let e=W(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Dp(i){let e=W(i,1,100);return W(Math.round(e/100*255),1,255)}var Ng=1e3,Dg=4e4,xp=7;function Lg(i){let e=W(i,Ng,Dg)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[W(t,0,255),W(n,0,255),W(a,0,255)]}function Tg(i){let[e,t,n]=Lg(i);return`rgb(${e}, ${t}, ${n})`}function Lp(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:xp},(r,o)=>{let s=o/(xp-1),l=t+(n-t)*s;return`${Tg(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Og(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?W(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===Uo&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=W(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Wo.includes(a)&&Go(t.hs_color)&&(n.hs_color=[W(t.hs_color[0],0,360),W(t.hs_color[1],0,100)]),n}function Qo(i,e,t){return i&&i.state==="on"?{...i}:_p(e,t)}function Tp(i){for(let e of wp)delete i[e]}function Go(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function W(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Qa="domotiapp-scene-card",Jo="domotiapp-scene-card-editor",Op="domotiapp-scene-editor";var xn=["een","twee","drie"],Cp="pencil",Rp=["grid_options","layout_options","view_layout","visibility"];var Hp="entity_id",Ht=class extends te{constructor(){super();j(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));j(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Hp]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Hp];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},a={...this._config,entity:n.entity};n.bare?a.bare=!0:delete a.bare,a.entity!==this._config?.entity&&(delete a.name_overrides,this._getypt={}),this._stuurDoor(a)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return E;let t=this._leden();return $`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?$`
          ...
          `:E}
    `}};j(Ht,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),j(Ht,"styles",[ve,ce`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===ts?$`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Vp?$`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=Xo(a,t,n),o=Ap(a,t,n);return $`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${Yo(a)?E:$`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?$`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,yp(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:E}
        </div>
    ...
    `}_renderHelderheid(e,t,n,a){let r=Np(zp(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,jp(this._waardeVan(e),Dp(s.detail.value),t,n))};return $`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Sp(this._waardeVan(e),s,t,n))};return $`
    ...
    `}_renderKleurtemp(e,t,n,a){let r=Zo(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Fo(this._waardeVan(e),s.detail.value,t,n))};return $`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Lp(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=Xa(a,t,n),s=l=>d=>{d.stopPropagation();let c=Xa(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,qo(this._waardeVan(e),p,t,n))};return $`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Vg}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};j(It,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),j(It,"styles",[ve,ce`
    ...
    `]);var Bg="0.46.0",Pg=["type","entity","name_overrides","bare"],ti="laden",wn="klaar",as="leeg",is="geen-groep",Bp="opslagfout",Pp="fout",_n=class extends te{constructor(){super();j(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=ti,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new se(()=>this._haalScenesOp()),this._verbinding=new je}static getConfigElement(){return document.createElement(Jo)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(a=>a.startsWith("light.")&&Array.isArray(t.states[a].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?V(t):null),R(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(a=>!Pg.includes(a)&&!Rp.includes(a));n.length&&console.warn(`${Qa}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:xt(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===is){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=ti,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?as:wn,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let a=t?.code;if(this._melding=t?.message??String(t),ie(t)&&this._herkansing.plan()){this._toestand=ti;return}if(a==="home_assistant_error"){this._toestand=Bp;return}if(!this.hass.states[n]){this._toestand=is;return}this._toestand=Pp}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==wn)return;let{oproepen:n}=qa({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let a=await Za((r,o)=>this.hass.callService("light",r,o),n);a.length&&this._meldMislukking(a.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),a=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:a},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===wn&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?as:wn}render(){if(!this._config)return E;switch(this._toestand){case is:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Bp:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Pp:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,a=!1){return $`
      <div class="needs">
    ...
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=v(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===as,n=this._toestand===ti,a=this._iconen();return $`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${a.map((r,o)=>$`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==wn)return E;let t=$p(this._scenes,this._leden,3).length,n=Ep(t);return n?$`<div class="mededeling">${n}</div>`:E}_renderEditor(){return $`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||xn[n])}};j(_n,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),j(_n,"styles",[ve,ce`
      :host { display: block; }
    ...
    `]);H(Qa,_n);H(Jo,Ht);H(Op,It);wt({type:Qa,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Bg}).`,preview:!1});var bt="domotiapp-alarm-card",rs="domotiapp-alarm-card-editor",Kp="domotiapp-alarm-editor",Gp="DomotiApp Wekker",Wp="https://github.com/Sven2410/domotiapp-lovelace",De="domotiapp_lovelace",me=Object.freeze({get:`${De}/alarms/get`,save:`${De}/alarms/save`,setEnabled:`${De}/alarms/set_enabled`,delete:`${De}/alarms/delete`,stop:`${De}/alarms/stop`,clearMessage:`${De}/alarms/clear_message`,search:`${De}/sound/search`,entities:`${De}/entities/list`,previewStart:`${De}/preview/start`,subscribe:`${De}/updates/subscribe`}),ni="#026FA1";function Up(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Kg="07:00";var Gg=["uri","name","media_type","image"],Wg="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Ug="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Fg="Music Assistant Wekker",qg="Verlichting Wekker";function ai(){return{id:null,name:"",time:Kg,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Fp(i){let e=ai();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:os(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:yn(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function yn(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Gg)e[t]=i[t]===void 0?null:i[t];return e}function os(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ss(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),os(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function qp(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:yn(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Zp(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Yp(i){return os(i)&&i.slice(0,2)==="02"?Wg:null}function Xp(i){return i===!1?Ug:null}function Qp(i){return typeof i?.endless=="boolean"?i.endless:null}function ii(i,e){let t=e==="lamp",n=t?qg:Fg,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function Jp(i,e){return ii(e,"speaker")!==null?!1:ss(i).ok}var Yg=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Xg=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],jn="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Qg="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Jg="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Vt=class extends te{constructor(){super(),this._concept=ai(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Fp(this.wekker):ai(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:me.previewStart,speaker:this._concept.speaker,sound:yn(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:me.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:yn(e),endless:Qp(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ss(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:me.save,person:this.person,alarm:qp(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return $`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return E;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=ii(t,"speaker"),r=ii(n,"lamp"),o=Yp(e.time),s=Xp(e.endless),l=Jp(e,t);return $`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Yg.map(([d,c])=>$`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Zp(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Xg.map(([d,c])=>$`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
    ...
    `}};j(Vt,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),j(Vt,"styles",[ve,ce`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${He(ni)});
      display: block;
  ...
  `]);var eh="person",ef="Kies een persoon in de kaartinstellingen.",th="De gekozen persoon is niet gevonden.",tf="De opgeslagen wekkers van deze persoon zijn onleesbaar.",x0=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function nh(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${eh}.`))throw new Error(`'${e}' zit niet in het domein ${eh}. Kies een persoon, zoals person.sven.`);return{...i}}function ah(i){return{type:`custom:${i}`}}function ih(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:th,isFout:!0}:{soort:"ontbreekt",tekst:ef,isFout:!1}}function rh(i,e){return i==="not_found"?th:i==="home_assistant_error"?tf:e||"Er ging iets mis bij het ophalen van de wekkers."}var nf=["ma","di","wo","do","vr","za","zo"],af="Geen wekkers ingesteld",rf="Eenmalig",of="Eenmalig \u2014 afgelopen",sf="Geen wekker actief",oh="Stoppen",lf="Er is een melding over deze wekker, maar de tekst ontbreekt.";function df(i){return!Array.isArray(i)||i.length===0?rf:[...new Set(i)].sort((t,n)=>t-n).map(t=>nf[t-1]??"?").join(" ")}function cf(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function sh(i,e){return cf(i,e)?of:df(i?.days)}function lh(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:lf,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function dh(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return af;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:sf}function ch(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var pf="0.46.0",hf="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",uf="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",ph="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",mf="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",ri=(i,e="icoon")=>$`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    ...
    `}_bevestiging(e){return $`<div class="onderrij bevestiging">
      <span class="boodschap">${Up(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=lh(e),a=!!e.enabled;return $`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?$`<div class="onderrij ${n.isFout?"fout":""}">
            ${ri(n.isFout?mf:ph,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:E}
    `}};j(zn,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),j(zn,"styles",[ve,ce`
  ...
  `]);var Bt=class Bt extends te{constructor(){super(...arguments);j(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?E:$`
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};j(Bt,"properties",{hass:{attribute:!1},_config:{state:!0}}),j(Bt,"styles",[ve,ce`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),j(Bt,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var ls=Bt;H(bt,zn);H(rs,ls);H(Kp,Vt);wt({type:bt,name:Gp,description:`Wekkerkaart van DomotiApp (v${pf}).`,preview:!1,documentationURL:Wp});var oi=i=>typeof i=="string"&&(i.includes("{{")||i.includes("{%"));function gf(i){return i==null?"":typeof i=="string"?i.trim():Array.isArray(i)?i.join(", "):typeof i=="object"?JSON.stringify(i):String(i)}function ff(i,e,t,n){let a=!1,r=null,o=i?.connection;return o?.subscribeMessage?(o.subscribeMessage(s=>{if(!a){if(s?.error){n("",String(s.error));return}n(gf(s?.result),null)}},{type:"render_template",template:e,variables:t??{},report_errors:!0}).then(s=>{if(a){try{s()}catch{}return}r=s}).catch(s=>{a||n("",String(s?.message??s))}),()=>{a=!0;try{r?.()}catch{}r=null}):(n("",null),()=>{})}var si=class{constructor(e){this.bijWijziging_=e,this.velden_=new Map}zet(e,t,n){let a=JSON.stringify(n??{});for(let[r,o]of Object.entries(t)){let s=`${a}\0${o??""}`,l=this.velden_.get(r);if(!oi(o)){l&&(l.opzeggen(),this.velden_.delete(r));continue}if(l?.sleutel===s)continue;l?.opzeggen();let d={sleutel:s,waarde:"",fout:null,opzeggen:()=>{}};this.velden_.set(r,d),d.opzeggen=ff(e,o,n,(c,p)=>{d.waarde===c&&d.fout===p||(d.waarde=c,d.fout=p,this.bijWijziging_())})}for(let r of[...this.velden_.keys()])r in t||(this.velden_.get(r).opzeggen(),this.velden_.delete(r))}waarde(e,t){let n=this.velden_.get(e);return n?n.waarde:oi(t)?"":t??""}fout(e){return this.velden_.get(e)?.fout??null}fouten(){let e=[];for(let[t,n]of this.velden_)n.fout&&e.push(`${t}: ${n.fout}`);return e}stop(){for(let e of this.velden_.values())e.opzeggen();this.velden_.clear()}};var bf="domotiapp-template-badge",hh="domotiapp-template-badge-editor",vf=["icon","content","label","tone"],li=class extends M{validate(e){return{...e}}watched(){return this.config?.entity?[this.config.entity]:[]}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),(e.tap_action?.action??"standaard")!=="none"||this.setAttribute("stil",""),`
      ...
      </button>`}wire(){this.sjablonen_=new si(()=>this.paint()),this.teardown_.push(()=>this.sjablonen_.stop());let e=this.$(".badge");this.teardown_.push(B(e,{onTap:()=>this.doe_("tap_action"),onHold:()=>this.doe_("hold_action"),onDouble:()=>this.doe_("double_tap_action")}))}doe_(e){let t=this.config,n=t[e]??(e==="tap_action"&&t.entity?tt(t.entity):null);n&&ae(this,this.hass,t,n)}toon_(){let e=Ns(this.sjablonen_.waarde("tone",this.config.tone));if(e)return Z(e,"accent");let t=this.config.entity,n=k(this.hass,t);return n?t.startsWith("light.")?Mn(n):Ds(t)?q(n)?"var(--dac-accent-hi)":"var(--dac-ink-3)":"var(--dac-ink-2)":"var(--dac-ink-2)"}paint(){let e=this.config,t=Object.fromEntries(vf.map(d=>[d,e[d]]));t.icon=ji(e),this.sjablonen_.zet(this.hass,t,{entity:e.entity??"",user:this.hass?.user?.name??""});let n=this.sjablonen_.fouten();this.toggleAttribute("fout",n.length>0);let a=this.sjablonen_.waarde("label",e.label),r=n.length?"Sjabloonfout":this.sjablonen_.waarde("content",e.content);this.text(".label",a),this.text(".content",r),this.$(".badge").title=n.length?n.join(`
`):e.label??"";let o=(a?1:0)+(r?1:0);this.setAttribute("regels",String(o)),this.$(".badge").style.setProperty("--tone",this.toon_());let s=this.$(".ico"),l=n.length?"warning":this.sjablonen_.waarde("icon",ji(e));s.dataset.icon!==l&&(s.dataset.icon=l,s.innerHTML=l?v(l):"")}getCardSize(){return 1}static getConfigElement(){return document.createElement(hh)}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("light."));return n?{entity:n,label:"Lamp",icon:"bulb",content:"{% if is_state(entity, 'on') %}Aan{% else %}Uit{% endif %}"}:{label:"Lampen aan",icon:"bulb",content:"{{ states.light | selectattr('state','eq','on') | list | count }}"}}};j(li,"css",`
    :host { display: block; }
  ...
  `);var ds=class extends T{defaults(){return{tap_action:{action:"more-info"}}}setConfig(e){let t={...e};oi(t.icon)&&!String(t.icon_template??"").trim()&&(t.icon_template=t.icon,delete t.icon),super.setConfig(t)}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"shield",auto:!1}]}schema(){return[{name:"entity",selector:f.entity()},{name:"label",selector:f.multiline()},{name:"content",selector:f.multiline()},{name:"icon_template",selector:f.multiline()},{name:"tone",selector:f.text()},{name:"tap_action",selector:f.action("more-info")},{name:"hold_action",selector:f.action("none")}]}label(e){return{entity:"Entiteit (optioneel)",label:"Bovenste regel",content:"Onderste regel",icon_template:"Icoon via een sjabloon (optioneel)",tone:"Kleur van het icoon",tap_action:"Bij tikken",hold_action:"Bij vasthouden"}[e.name]??super.label(e)}helper(e){return{entity:"Alleen nodig als de badge iets van \xE9\xE9n ding laat zien. In de sjablonen hieronder is hij beschikbaar als `entity`, zodat je `states(entity)` kunt schrijven.",label:"De kleine regel bovenin, bijvoorbeeld Alarm of Vaatwasser. Mag een sjabloon zijn.",content:"De dikke regel eronder: wat er op dit moment aan de hand is. Hier hoort het sjabloon, bijvoorbeeld {% if is_state(entity, 'on') %}Rook!{% else %}Geen rook{% endif %}.",icon_template:"Alleen invullen als het icoon per toestand moet verschillen. Onze eigen iconen heten dai:, die van Home Assistant mdi: \u2014 bijvoorbeeld {% if is_state(entity,'on') %}dai:alarmOn{% else %}dai:alarmOff{% endif %}. De naam die je nodig hebt staat onder het icoon in de kiezer hierboven. Staat hier iets, dan wint het van het gekozen icoon.",tone:"Leeg laten is het beste: dan volgt het icoon vanzelf de toestand. Wil je het sturen, zet er dan goed, let op of kritiek in \u2014 of een sjabloon dat dat uitrekent, voor een melder die rood hoort te worden.",hold_action:"Wat er gebeurt als je hem ingedrukt houdt. Laat op Geen actie staan als je niets wilt."}[e.name]}};O(hh,ds);Nn(bf,li,{name:"DomotiApp Badge",description:"Een pil in de kop van je view: icoon, een kop en een waarde. Alle drie mogen een sjabloon zijn, en de achtergrond kan er helemaal af."});var kf="domotiapp-terug-badge",uh="domotiapp-terug-badge-editor",di=class extends M{validate(e){return{icon:"arrowLeft",...e}}watched(){return[]}template(){return this.config.bare&&this.setAttribute("bare",""),`
      <button class="badge" type="button">
        <span class="ico"></span>
        <span class="tekst"></span>
      </button>`}wire(){this.teardown_.push(B(this.$(".badge"),{onTap:()=>this.terug_()}))}terug_(){let e=On(this.config);if(e.soort==="geschiedenis"){history.back();return}ae(this,this.hass,this.config,{action:"navigate",navigation_path:e.pad})}paint(){let e=this.config,t=e.icon||"arrowLeft",n=this.$(".ico");n.dataset.icon!==t&&(n.dataset.icon=t,n.innerHTML=v(t,"arrowLeft")),this.text(".tekst",e.label??""),this.$(".badge").title=e.label||(this.config.path?`Naar ${this.config.path}`:"Terug")}getCardSize(){return 1}static getConfigElement(){return document.createElement(uh)}static getStubConfig(){return{icon:"arrowLeft",label:"Terug"}}};j(di,"css",`
    :host { display: block; }
    ...
    .badge:focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var cs=class extends T{defaults(){return{icon:"arrowLeft"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"arrowLeft",auto:!1}]}schema(){return[{name:"path",selector:f.text()},{name:"label",selector:f.text()}]}label(e){return{path:"Waar gaat hij heen",label:"Tekst ernaast (optioneel)"}[e.name]??super.label(e)}helper(e){return{path:"Het pad waar je altijd op uitkomt, bijvoorbeeld /dashboard/thuis. Begint het met een # dan opent hij een pop-up op de huidige view. Laat je het leeg, dan gaat hij \xE9\xE9n stap terug in de geschiedenis \u2014 net als de terugknop van je browser.",label:"Laat leeg voor alleen het pijltje. Dat is meestal genoeg en het scheelt breedte in de kop."}[e.name]}};O(uh,cs);Nn(kf,di,{name:"DomotiApp Terug",description:"Een pijltje terug in de kop van je view: naar een vaste plek die je zelf opgeeft, of \xE9\xE9n stap terug als je niets invult."});var xf=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function mh(i){return`/api/image/serve/${i}/original`}function gh(i){return i?xf.includes(i.type)?i.size>12582912?`Deze afbeelding is ${Math.round(i.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var wf=`
...
`,ps=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=X(wf)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let a=document.createElement("img");a.src=this.value,a.alt="",a.onerror=()=>{n.dataset.bron="",n.innerHTML=v("car")},n.replaceChildren(a)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=v("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=gh(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let a=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:a?{Authorization:`Bearer ${a}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(mh(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};H("dac-foto-picker",ps);var _f="/api/domotiapp_lovelace/loader.js",fh="domotiapp-lovelace-verversing";function bh(i){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(i??""));return e?e[1].toLowerCase():null}async function yf(i){try{let e=await i(_f,{cache:"no-store"});return e?.ok?bh(await e.text()):null}catch{return null}}function jf(){try{return globalThis.sessionStorage?.getItem(fh)??null}catch{return null}}function zf(i){try{globalThis.sessionStorage?.setItem(fh,i)}catch{return!1}return!0}function $f(i,e,t){return!i||!e?"onbekend":i===e?"actueel":t===e?"al-geprobeerd":"herladen"}function vh({eigenUrl:i,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:a=18e5,klok:r=setInterval}={}){let o=bh(i);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await yf(e);if($f(o,p,jf())!=="herladen"||!zf(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,a);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var Ef="0.46.0";zs(i=>console.warn(`domotiapp-lovelace: ${i}`));vh({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${Ef} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Ef as VERSION};
