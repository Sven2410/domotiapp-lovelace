...
`,A={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ns={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},y=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),X=(i,e="accent")=>A[i]??(i&&/[#(]|^var/.test(i)?i:A[e]),R=Symbol("incomplete"),Pp=i=>`
  <div class="needs">
    ...
    <path d="M12 5.7V4.2"/>`),refill:g(`<path d="M12 2.8c1.7 2 2.6 3.5 2.6 4.6a2.6 2.6 0 0 1-5.2 0c0-1.1.9-2.6 2.6-4.6z"/>
...
`,an=class extends T{constructor(){super(),this.stand_=null,this.feeds_=[],this.pagina_="welkom",this.uren_=[],this.dagen_=[],this.afspraken_=[],this.herkansing_=new le(()=>this.haal_()),this.verbinding_=new we,this.fout_=null,this.html_=new Map,this.weerEntiteit_=null,this.weerOpzeggen_=[],this.agendaSleutel_="",this.mAuto_=0,this.energie_={entiteit:null,punten:[],geladen:0}}validate(e){return{...e}}installatie_(){let e=this.stand_?.installatie??{};return{weer:e.weer??null,energie:e.energie??null,agendas:Array.isArray(e.agendas)?e.agendas:[],verlichting:Array.isArray(e.verlichting)?e.verlichting:[]}}standNu_(){return this.stand_?{...this.stand_,installatie:this.installatie_()}:null}watched(){let e=this.installatie_();return[e.weer,e.energie,"sun.sun",...e.verlichting.map(t=>t.entity)].filter(Boolean)}getCardSize(){return 12}template(){let e=t=>`
      ...
      <div class="scherm">
        ...
        <div class="merkje">${nn.offline}<span>Geen verbinding</span></div>
          ...
          <span class="e-piek">piek ${y(m(d.piek))}</span>
