var to=Object.defineProperty;var no=(a,e,t)=>e in a?to(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var y=(a,e,t)=>no(a,typeof e!="symbol"?e+"":e,t);var Y=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function ae(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var le=a=>String(a??"").split(".")[0],k=(a,e)=>e&&a?.states?.[e]||null,K=(a,e)=>k(a,e)?.attributes??{},dt=(a,e,t)=>t?null:K(a,e).entity_picture||null;function Oa(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function D(a,e,t){return t||K(a,e).friendly_name||e||""}var ao=new Set(["scene","script","input_button","button","event"]),Jt=a=>ao.has(le(a));function G(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!Jt(a.entity_id):!1}function He(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(le(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var io=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),La=a=>io.has(le(a));function Da(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function lt(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var W=(a,e)=>lt(a,"hass-more-info",{entityId:e});function Ve(a){switch(le(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function ro(a){switch(le(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function de(a,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":W(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=ro(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),lt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":lt(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":lt(a,"ll-custom",n);break;default:break}}function O(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return a.addEventListener("pointerdown",d),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),a.removeEventListener("pointerdown",d),a.removeEventListener("click",c)}}function Z(a,e){if(!e)return"";let t=le(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function B(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Na=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Ra=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Ca=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),Qt=(a,e)=>Math.round((Ca(e)-Ca(a))/864e5);function Pe(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function en(a,e=new Date){if(!a)return"";let t=Qt(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Na[a.getDay()]:`${Na[a.getDay()].slice(0,2)} ${a.getDate()} ${Ra[a.getMonth()]}`}var Ha=a=>a?`${a.getDate()} ${Ra[a.getMonth()]}`:"";function oo(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function so(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function V(a,e=4){if(!a)return;let t=so(a);if(!t){e>0&&requestAnimationFrame(()=>V(a,e-1));return}let n=`${oo(t)}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}function Se(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function q(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);V(a)});e.observe(a);for(let t of a.children)e.observe(t);return V(a),()=>e.disconnect()}var lo="home-assistant";function Va({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:i=()=>Date.now(),marker:r=lo,intervalMs:o=20,maxWachtMs:s=1e4}){let l=i();function d(){let m=a();if(!m)return!1;for(let[v,u]of e)try{m.get(v)||m.define(v,u)}catch(w){t(`kon ${v} niet registreren: ${w&&w.message}`)}return!0}function c(){let m=a();return!m||!m.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(i()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var Pa=[];function M(a,e){Pa.push([a,e])}function Ae({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function Ia(a=()=>{}){Va({leesRegistry:()=>globalThis.customElements,definities:Pa,waarschuw:a})}var co=`
  :host {
    ${Y}
    display: block;
...
`,L={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ct={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},Q=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),R=(a,e="accent")=>L[a]??(a&&/[#(]|^var/.test(a)?a:L[e]),T=Symbol("incomplete"),po=a=>`
  <div class="needs">
  ...
  </div>`,ho=56,Ka=8,ee=a=>Math.max(1,Math.ceil((a+Ka)/(ho+Ka))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[ae(co+ue+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[T]||Da(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[T]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[T];if(e.innerHTML=t?po(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(q(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,i){e&&(e.addEventListener(t,n,i),this.teardown_.push(()=>e.removeEventListener(t,n,i)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return Se(this.$(e))??t}};y(S,"css","");function A(a,e,{name:t,description:n,preview:i=!0}={}){M(a,e),Ae({type:a,name:t,description:n,preview:i})}function H(a,e){M(a,e)}var h=(a,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${a}</svg>`,j={house:h(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,an=null,Wa=a=>a.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${me(n)} (${n})" aria-pressed="false">${j[n]??""}<span class="naam">${me(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),rn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),an=an??[ae(fo)],this.shadowRoot.adoptedStyleSheets=an,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,on=null,sn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),on=on??[ae(_o)],this.shadowRoot.adoptedStyleSheets=on,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in L)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${L[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${vo.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),i=()=>this.toggleAttribute("narrow",n.matches);i(),n.addEventListener("change",i),this.teardown_.push(()=>n.removeEventListener("change",i))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=yo(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${$o[e.getDay()]} ${e.getDate()} ${jo[e.getMonth()]}`);let i=this.$(".clock");i&&this.text(i,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=k(this.hass,e.weather),n=K(this.hass,e.weather),i=this.$(".now");if(i&&t){let l=Ie(t.state);i.style.setProperty("--wtone",R(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${B(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=i.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=b(l,"cloud")),this.text(i.querySelector(".cond"),Z(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=zo.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${R(cn[l.key].tone)}" title="${cn[l.key].label}">
             ${j[cn[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let i=this.hass?.config?.unit_system?.wind_speed??"km/h",r=Eo(t.wind_bearing);return{key:e,value:`${B(this.hass,t.wind_speed,0)} ${i}${r?` ${r}`:""}`}}case"uv":{let r=K(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(k(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${B(this.hass,r,1)}`}:null}case"precipitation":{let i=k(this.hass,n.precipitation_entity);if(i){let r=Number(i.state);if(Number.isNaN(r))return null;let o=i.attributes.unit_of_measurement??"mm";return{key:e,value:`${B(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${B(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${B(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=k(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};y(ht,"css",`
  ...
  `);var pn=class extends C{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[ln({name:"weather",selector:_.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),ln({name:"sun",selector:_.entity("sun")},{name:"precipitation_entity",selector:_.entity("sensor")}),{name:"name",selector:_.text()},{name:"hide_below",selector:_.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};H("domotiapp-header-card-editor",pn);A("domotiapp-header-card",ht,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var ut=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      ...
      </div>`}paint(){this.text("h3",this.config.name??"");let e=this.$(".sub");if(!e)return;let t=k(this.hass,this.config.secondary_entity),n=e.querySelector(".si"),i=e.querySelector(".sv");if(!t){i.textContent="",n.innerHTML="";return}let r=this.config.secondary_icon??"";n.dataset.icon!==r&&(n.dataset.icon=r,n.innerHTML=r?b(r):"");let o=t.attributes.unit_of_measurement;i.textContent=o?`${t.state} ${o}`:t.attributes.current_temperature!=null?`${t.attributes.current_temperature} \xB0C`:Z(this.hass,t)}getCardSize(){return 1}getGridOptions(){return{columns:"full",rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-separator-card-editor")}static getStubConfig(){return{name:"Nieuwe sectie",icon:"house",tone:"accent"}}};y(ut,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var hn=class extends C{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:dn.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:_.text()},{name:"line",selector:_.bool()},{name:"secondary_entity",selector:_.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};H("domotiapp-separator-card-editor",hn);A("domotiapp-separator-card",ut,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var un=(a,e,t)=>Math.min(t,Math.max(e,a));function ge(a,e){let t=e.min??0,n=e.max??100,i=e.step??1,r=!1,o=u=>{let w=a.getBoundingClientRect();if(!w.width)return t;let g=un((u-w.left)/w.width,0,1),$=t+g*(n-t);return un(Math.round($/i)*i,t,n)},s=u=>{try{a.setPointerCapture?.(u)}catch{}},l=u=>{try{a.hasPointerCapture?.(u)&&a.releasePointerCapture(u)}catch{}},d=u=>{e.disabled?.()||u.button!=null&&u.button!==0||(r=!0,s(u.pointerId),a.classList.add("dragging"),e.onInput(o(u.clientX)),u.preventDefault())},c=u=>{r&&(e.onInput(o(u.clientX)),u.preventDefault())},p=u=>{r&&(r=!1,l(u.pointerId),a.classList.remove("dragging"),e.onCommit(o(u.clientX)))},m=u=>{r&&(r=!1,l(u?.pointerId),a.classList.remove("dragging"),e.onInput(e.value()))},v=u=>{if(e.disabled?.())return;let w=(n-t)/10,g={ArrowLeft:-i,ArrowDown:-i,ArrowRight:i,ArrowUp:i,PageDown:-w,PageUp:w,Home:-1/0,End:1/0};if(!(u.key in g))return;u.preventDefault();let $=e.value(),z=un(g[u.key]===-1/0?t:g[u.key]===1/0?n:$+g[u.key],t,n);e.onInput(z),e.onCommit(z)};return a.addEventListener("pointerdown",d),a.addEventListener("pointermove",c),a.addEventListener("pointerup",p),a.addEventListener("pointercancel",m),a.addEventListener("keydown",v),()=>{a.removeEventListener("pointerdown",d),a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",p),a.removeEventListener("pointercancel",m),a.removeEventListener("keydown",v)}}var ie=(a="")=>`
...
`;var So=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Ao=new Set(["hs","rgb","rgbw","rgbww","xy"]),gn=a=>a?.attributes?.supported_color_modes??[],Mo=a=>gn(a).some(e=>So.has(e)),mt=a=>gn(a).some(e=>Ao.has(e)),gt=a=>gn(a).includes("color_temp"),Ga=a=>Math.max(1,Math.round((a??0)/255*100)),ft=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[T]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var mn=class extends C{defaults(){return{show_colour:!0}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"bulb"}]}schema(){return[{name:"entity",selector:_.entity("light")},{name:"name",selector:_.text()},{name:"show_colour",selector:_.bool()}]}label(e){return{entity:"Lamp",name:"Naam (overschrijft die van de lamp)",show_colour:"Kleurstrips tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"E\xE9n lamp per kaart. Dimbaar krijgt een schuif, alleen schakelbaar een tuimelaar.";if(e.name==="show_colour")return"Kleur en kleurtemperatuur verschijnen zodra de lamp aan is. De kaart is dan twee rijen hoog."}};H("domotiapp-light-card-editor",mn);A("domotiapp-light-card",ft,{name:"DomotiApp Verlichting",description:"E\xE9n lamp op \xE9\xE9n rasterrij: dimmen, kleur en kleurtemperatuur."});function qa(a){if(!a)return null;let e=Number(a.state);return Number.isFinite(e)?e:null}function To(a){let e=a?.attributes?.hvac_action;return e||(a?.state==="off"?"off":a?.state==="cool"?"cooling":a?.state==="heat"?"idle":null)}var fn={heating:"var(--dac-solar)",cooling:"var(--dac-grid-in)",drying:"var(--dac-grid-in)",fan:"var(--dac-grid-in)"},Fa={heating:"Verwarmt",cooling:"Koelt",drying:"Ontvochtigt",fan:"Ventileert",idle:"Uit",off:"Uit"},bt=class extends S{validate(e){return e.entity||e.temperature||e.humidity?{...e}:{...e,[T]:"Kies een thermostaat, of een temperatuursensor."}}watched(){let e=this.config;return[e.entity,e.temperature,e.humidity].filter(Boolean)}step_(){let e=K(this.hass,this.config.entity);return Number(this.config.step??e.target_temp_step)||.5}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.entity||this.setAttribute("readout",""),`
      <div class="card surface">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(O(this.$(".chip"),{onTap:()=>W(this,e.entity||e.temperature||e.humidity)}));let t=this.$(".set");t&&t.querySelectorAll("button").forEach(n=>this.on(n,"click",()=>this.nudge_(Number(n.dataset.d))))}nudge_(e){let t=this.config,n=K(this.hass,t.entity),i=this.step_(),r=Number(n.min_temp??5),o=Number(n.max_temp??35),s=this.pending_??Number(n.temperature);if(!Number.isFinite(s))return;let l=Math.min(o,Math.max(r,Math.round((s+e*i)/i)*i));this.pending_=l,this.paintTarget_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null,this.hass.callService("climate","set_temperature",{entity_id:t.entity,temperature:this.pending_}),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450)}paintTarget_(){let e=this.$(".target");if(!e)return;let t=K(this.hass,this.config.entity),n=this.pending_??Number(t.temperature);e.classList.toggle("pending",this.pending_!=null),e.textContent=Number.isFinite(n)?`${B(this.hass,n,n%1?1:0)}\xB0`:"--"}paint(){let e=this.config,t=e.entity?k(this.hass,e.entity):null,n=e.entity?G(t):!1;this.toggleAttribute("dead",n);let i=To(t),r=e.tone?R(e.tone):fn[i]??"var(--dac-ink-3)";this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("busy",!!fn[i]);let o=this.$(".chip"),s=e.icon||"thermo";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s,"thermo")),o.style.setProperty("--tone",fn[i]?r:"var(--dac-ink-3)"),this.text(".nm",D(this.hass,e.entity||e.temperature||e.humidity,e.name));let l=e.temperature?qa(k(this.hass,e.temperature)):Number(K(this.hass,e.entity).current_temperature),d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.text(".temp",Number.isFinite(l)?`${B(this.hass,l,1)} ${d}`:"--");let c=e.humidity?qa(k(this.hass,e.humidity)):null,p=this.$(".hum");p.innerHTML=c==null?"":`${j.drop}${B(this.hass,c,0)}%`,this.text(".sep",c==null?"":"\xB7"),e.entity&&!e.humidity&&Fa[i]&&i!=="idle"&&(this.text(".sep","\xB7"),p.textContent=Fa[i]),this.paintTarget_();let m=this.$(".set");if(m){let v=K(this.hass,e.entity),u=this.pending_??Number(v.temperature);m.querySelector('[data-d="-1"]').disabled=n||u<=Number(v.min_temp??5),m.querySelector('[data-d="1"]').disabled=n||u>=Number(v.max_temp??35)}}getCardSize(){return 1}getGridOptions(){return{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-climate-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("climate."));return n?{entity:n}:{}}};y(bt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var bn=class extends C{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:_.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:_.text()},{name:"step",selector:_.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};H("domotiapp-climate-card-editor",bn);A("domotiapp-climate-card",bt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var Za=({label:a="Aan of uit",cls:e=""}={})=>`<button class="toggle ${e}" type="button" role="switch" aria-checked="false" aria-label="${a}"><span class="knob"></span></button>`;function vn(a,e){if(!a)return;let t=String(!!e);a.getAttribute("aria-checked")!==t&&a.setAttribute("aria-checked",t)}function Xa(a,e){let t=a.querySelector(".knob"),n=!1,i=0,r=!1,o=!1,s=()=>{n=!1,a.classList.remove("dragging"),t?.style.removeProperty("--knob")},l=u=>{u!==e.value()&&(vn(a,u),e.set(u))},d=u=>{if(!e.disabled?.()&&!(u.button!=null&&u.button!==0)){u.stopPropagation(),n=!0,r=!1,o=!1,i=u.clientX,a.classList.add("dragging");try{a.setPointerCapture?.(u.pointerId)}catch{}}},c=u=>{if(!n)return;let w=u.clientX-i;Math.abs(w)>3&&(r=!0);let g=e.value()?22:0,$=Math.min(22,Math.max(0,g+w));t?.style.setProperty("--knob",`${$}px`)},p=u=>{if(!n)return;u.stopPropagation();let w=u.clientX-i,g=e.value()?22:0,$=Math.min(22,Math.max(0,g+w));s();try{a.hasPointerCapture?.(u.pointerId)&&a.releasePointerCapture(u.pointerId)}catch{}o=!0,l(r?$>22/2:!e.value())},m=()=>{n&&s()},v=u=>{if(u.stopPropagation(),u.preventDefault(),o){o=!1;return}e.disabled?.()||l(!e.value())};return a.addEventListener("pointerdown",d),a.addEventListener("pointermove",c),a.addEventListener("pointerup",p),a.addEventListener("pointercancel",m),a.addEventListener("click",v),()=>{a.removeEventListener("pointerdown",d),a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",p),a.removeEventListener("pointercancel",m),a.removeEventListener("click",v)}}var Ya=`
  .toggle {
...
`;var vt=a=>String(a??"").split(".")[0],Ja=new Set(["input_datetime","time","date","datetime"]),Qa=a=>Ja.has(vt(a)),re=a=>String(a).padStart(2,"0");function No(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function kn(a){if(!a)return null;let e=vt(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:No(a.state)}var Co=a=>`${a.getFullYear()}-${re(a.getMonth()+1)}-${re(a.getDate())}T${re(a.getHours())}:${re(a.getMinutes())}`;function Oo(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${re(Math.floor(n/60))}:${re(n%60)}`}function ei(a,e=kn(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${re(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(vt(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":Co(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${re(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function ti(a,e,t){let n=vt(a),i=String(t??"");if(!i||!Ja.has(n)||!e)return null;if(e==="time"){let m=i.match(/^(\d{1,2}):(\d{2})/);if(!m)return null;let v=`${re(m[1])}:${m[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:v}]:["input_datetime","set_datetime",{entity_id:a,time:v}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${re(d)}:${c}:00`;if(n==="datetime"){let m=Oo(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${l}T${p}${m}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${l} ${p}`}]}var ni=a=>String(a??"").split(".")[0],ai=new Set(["input_select","select"]),_n=a=>ai.has(ni(a));function kt(a){if(!a||!_n(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function ii(a,e=kt(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function ri(a,e,t=[]){let n=ni(a),i=String(e??"");return!i||!ai.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var _t={row:44,tile:96,compact:44},Me=6,oi=12,xn=22,Lo=["row","tile","compact"],Do=["card","items","none"],xt=a=>typeof a?.name=="string"?a.name.trim():"",Ke=a=>typeof a=="string"?{entity:a}:{...a},Be=a=>Math.min(Math.max(1,Number(a)||2),3),Te=a=>Lo.includes(a)?a:"row",te=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function si(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(t=>({columns:Be(t.columns),layout:Te(t.layout),items:(t.items??t.entities??[]).map(Ke)}));let e=(a?.items??a?.entities??[]).map(Ke);return e.length?[{columns:Be(a.columns),layout:Te(a.layout),items:e}]:[]}function wt(a){return Do.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var Ro=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns));function wn(a){let e=a?.rows??[],t=xt(a)?xn+Me:0;if(!e.length)return oi+t+_t.row;let n=(wt(a)==="card"?oi:0)+t;for(let i of e){let r=Ro(i);n+=r*_t[Te(i.layout)]+(r-1)*Me}return n+(e.length-1)*Me}var di=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],Ho=a=>di.find(e=>e.waarde===a)?.label??"Rij";function yt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();te(e)&&a.bewaard.push(e)}return a}function Vo(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:Be(n.columns),layout:Te(n.layout),items:(n.items??n.entities??[]).map(Ke)})):(()=>{let n=(a.items??a.entities??[]).map(Ke);return n.length?[{columns:Be(a.columns),layout:Te(a.layout),items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]);for(let r of i)t.push(yt({columns:n.columns,layout:n.layout,items:r}))}return t}var li=a=>a.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(te).map(t=>structuredClone(t))})).filter(e=>e.items.length),Po=`
...
`,yn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=Vo(e);this.gebouwd_&&JSON.stringify(li(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let i=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(r>e?`r${r-1}${i[2]===void 0?"":`i${i[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{te(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Po;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=yt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return i?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(g=>({waarde:g,label:String(g),titel:`${g} entiteit${g>1?"en":""} in deze rij`})),()=>e.columns,g=>{e.columns=g,yt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,d.wrap,c);let p=document.createElement("div");p.className="rijbody";let m=this.segment_(di.map(g=>({waarde:g.waarde,label:g.label})),()=>e.layout,g=>{e.layout=g,this.emit_()}),v=document.createElement("div");v.className="vormrij";let u=document.createElement("b");u.textContent="Vorm van deze rij",v.append(u,m.wrap),p.appendChild(v);let w=()=>{let g=e.items.filter(te),$=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&$.push(Ho(e.layout)),$.push(g.length?g.map(z=>this.itemNaam_(z)).join(", "):"nog leeg"),l.textContent=$.join(" \xB7 "),d.vernieuw(),m.vernieuw()};return this.koppen_.push(w),e.items.forEach((g,$)=>p.appendChild(this.itemBlok_(e,g,t,$))),n.append(i,p),w(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(i+1),l.title=`Plek ${i+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(i,1),this.itemWeg_(n,i),yt(e),this.emit_(),this.build_()}),o.append(s,l,d,m);let v=document.createElement("div");v.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",u.addEventListener("value-changed",E=>{E.stopPropagation(),t.entity=E.detail.value.entity??"",this.emit_()});let w=document.createElement("dac-icon-picker");w.label="Icoon",w.hass=this.hass_,w.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.icon=E.detail.value:delete t.icon,this.emit_()});let g=document.createElement("dac-tone-picker");g.label="Kleur",g.hass=this.hass_,g.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.tone=E.detail.value:delete t.tone,this.emit_()});let $=document.createElement("ha-form");$.hass=this.hass_,$.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],$.computeLabel=E=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[E.name]??E.name,$.computeHelper=E=>{if(E.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(E.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(E.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(E.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},$.addEventListener("value-changed",E=>{E.stopPropagation();let X=E.detail.value;X.name?t.name=X.name:delete t.name,X.toggle===!0?t.toggle=!0:delete t.toggle;for(let he of["show_icon","show_name","show_state"])X[he]===!1?t[he]=!1:delete t[he];for(let he of["icon_tap_action","icon_hold_action","tap_action","hold_action"])X[he]?t[he]=X[he]:delete t[he];X.double_tap_action&&X.double_tap_action.action!=="none"?t.double_tap_action=X.double_tap_action:delete t.double_tap_action,this.emit_()});let z=()=>{c.textContent=te(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(te(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!te(t)),m.hidden=!te(t)};return this.koppen_.push(z),u.data={entity:t.entity||void 0},w.value=t.icon??"",g.value=t.tone??"",$.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},v.append(u,w,g,$),r.append(o,v),z(),r}emit_(){let e=li(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-entities-card-editor",yn);var $t=class extends S{validate(e){let t=si(e);return t.some(n=>n.items.some(te))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?R(e.tone):this.config.tone?R(this.config.tone):le(e.entity)!=="light"?L.accent:Oa(k(this.hass,e.entity))??L.lit}metSchakelaar_(e){return!!e.toggle&&La(e.entity)}metTijd_(e){return!Qa(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!_n(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",wt(e)),this.style.containerType="inline-size";let t=wt(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((p,m)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(p)?Za({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}"
           style="--cols:${o.columns};--it-h:${_t[o.layout]}px">${c}</div>`}).join("");return`<div class="card surface">${xt(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>de(this,this.hass,t,t[s]??l),i={action:t.entity?"more-info":"none"};this.teardown_.push(O(e,{onTap:()=>n("tap_action",i),onHold:()=>n("hold_action",i),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(O(r,{onTap:()=>n("icon_tap_action",Ve(t.entity)),onHold:()=>n("icon_hold_action",i)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let m=p.target?.closest?.(".tijd");if(m&&(p.stopPropagation(),p.type==="click"))try{m.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let m=p.target?.closest?.(".tijd");m&&(p.stopPropagation(),l=ti(t.entity,m.type,m.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=k(this.hass,t.entity),p=ri(t.entity,d.value,kt(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(Xa(o,{value:()=>He(k(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>G(k(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,xt(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let i=k(this.hass,n.entity),r=He(i),o=!!n.entity&&G(i);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=D(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let z=dt(this.hass,n.entity,n.icon),E=n.icon||(z?`pic:${z}`:tn(n.entity,K(this.hass,n.entity)));d.dataset.icon!==E&&(d.dataset.icon=E,d.classList.toggle("pic",!!z),d.innerHTML=z?`<img src="${z}" alt="" loading="lazy" />`:b(n.icon||tn(n.entity,K(this.hass,n.entity)))),d.style.setProperty("--tone",z?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(vn(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let m=t.querySelector(".tijdslot"),v=null;if(m){let z=o?null:kn(i);m.dataset.soort!==(z??"")&&(m.dataset.soort=z??"",m.innerHTML=z?`<input class="tijd" type="${z}" step="60" />`:""),v=m.querySelector(".tijd")}if(v&&(v.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==v)){let z=ei(i,m.dataset.soort);v.value!==z&&(v.value=z)}let u=t.querySelector(".keuzeslot"),w=null;if(u){let z=o?[]:kt(i),E=JSON.stringify(z);u.dataset.opties!==E&&(u.dataset.opties=E,u.innerHTML=z.length?`<select class="keuze">${z.map(X=>`<option value="${Q(X)}">${Q(X)}</option>`).join("")}</select>`:""),w=u.querySelector(".keuze")}if(w&&(w.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==w)){let z=ii(i);w.value!==z&&(w.value=z)}let g=t.querySelector(".st"),$=n.show_state??this.config.show_state;if(p||v||w)g.textContent="";else if($===!1)g.textContent="";else if(o)g.textContent="Niet bereikbaar";else if(!i||Jt(i.entity_id))g.textContent="";else if(le(i.entity_id)==="light"&&r&&i.attributes.brightness!=null)g.textContent=`${Math.round(i.attributes.brightness/255*100)}%`;else{let z=i.attributes.unit_of_measurement;g.textContent=z?`${i.state} ${z}`:Z(this.hass,i)}t.setAttribute("aria-label",`${l}${i?`, ${Z(this.hass,i)}`:""}`)})}getCardSize(){return ee(wn(this.config))}getGridOptions(){let e=ee(wn(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};y($t,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${xn}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);A("domotiapp-entities-card",$t,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var P={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},I=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),$n=a=>!a||a.state==="off",jn=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),zn=a=>a?.state==="playing",ci=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function pi(a){if(!a)return[];let e=[];return(I(a,P.TURN_ON)||I(a,P.TURN_OFF))&&e.push("power"),$n(a)||(I(a,P.PREVIOUS_TRACK)&&e.push("prev"),I(a,P.PLAY)||I(a,P.PAUSE)||I(a,P.PLAY_MEDIA)?e.push("play"):I(a,P.STOP)&&e.push("stop"),I(a,P.NEXT_TRACK)&&e.push("next")),e}var _e=a=>a?.volume_entity||a?.entity;function En(a){if(!jn(a))return[];let e=[];return I(a,P.VOLUME_MUTE)&&e.push("mute"),I(a,P.VOLUME_SET)?e.push("slider"):I(a,P.VOLUME_STEP)&&e.push("steps"),e}var be=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),Ue=a=>!!a?.attributes?.is_volume_muted,hi=a=>!!a?.attributes?.mass_player_type,Sn=a=>!!a?.attributes?.shuffle,An=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},ui=a=>({off:"all",all:"one",one:"off"})[Io(a)]??"all",Io=a=>["off","all","one"].includes(a)?a:"off";function Mn(a,{zoeken:e=!0}={}){if(!jn(a))return[];let t=[];return I(a,P.SHUFFLE_SET)&&t.push("shuffle"),I(a,P.REPEAT_SET)&&t.push("repeat"),e&&hi(a)&&t.push("search"),t}function mi(a,{tonen:e=!0}={}){if(!e||!jn(a)||!I(a,P.SELECT_SOURCE)||hi(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function gi(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function Tn(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Nn="dacScrollSlot",fi=["position","top","left","right","width","overflow"];function bi(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[Nn])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(fi.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Nn]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of fi)t.style[o]=i[o];t.dataset&&delete t.dataset[Nn],e?.scrollTo?.(0,n)}}}var vi=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var ve=a=>`domotiapp_lovelace/media/${a}`;function Ko(a,e){if(!a)return null;if(e)return a.uri?{type:ve("favorite"),favorite:!0,uri:a.uri}:null;let t=ki(a);return!t||!a.library_item_id?null:{type:ve("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function ki(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var _i={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Cn=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function xi(a,e,t=null){return a?.kind??ki(e)??t??"playlists"}var On=a=>!!a?.uri,jt=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:ve("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),wi=(a,e,t)=>{let n=Ko(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},yi=(a,e)=>a.callWS({type:ve("playlist/create"),name:e}).then(t=>t?.playlist??null),$i=(a,e)=>a.callWS({type:ve("playlist/remove"),library_item_id:String(e.library_item_id)}),ji=(a,e)=>a.callWS({type:ve("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),zi=(a,e,t)=>a.callWS({type:ve("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Ei=(a,e,t)=>a.callWS({type:ve("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Bo=350,Uo={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Wo(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=Uo[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Go=`
  :host {
    ${Y}
...
`,Ln=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=ae(ue+Go)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n,{radioModus:i=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=i,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=bi(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Cn.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
        ...
        <div class="menu" hidden></div>
          ...
          <div class="rij" data-i="${i}" data-knoppen="${d}">
            ...
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let l=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let d=ge(s,{value:()=>be(k(this.hass,l)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:l})});this.schuiven_.set(l,d)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,l=o.querySelector(".slider");if(!l||l.classList.contains("dragging"))continue;let d=k(this.hass,s),c=be(d);this.zetSchuif_(l,c,Ue(d))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let i=e.parentElement.querySelector(".pct");i&&(i.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=be(k(this.hass,this.entity_)),i=k(this.hass,e);I(i,P.VOLUME_SET)&&be(i)!==n&&this.hass.callService("media_player","volume_set",{volume_level:n/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};M("domotiapp-media-browser",Ln);function Si(a,e,t,n={}){let i=document.querySelector("domotiapp-media-browser");return i||(i=document.createElement("domotiapp-media-browser"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var qo=`
  :host {
    ${Y}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Dn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ae(qo+ue)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};M("domotiapp-bron-kiezer",Dn);function Ai(a,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(a,e,t),n.focus?.(),n}var zt={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"}},Et=class extends S{validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[T]:"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?R(this.config.tone):L.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(o,s)=>de(this,this.hass,e,e[o]??s);this.teardown_.push(q(this.$(".card"))),this.teardown_.push(O(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(O(n,{onTap:()=>t("icon_tap_action",Ve(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",o=>o.stopPropagation()),this.on(n,"pointerdown",o=>o.stopPropagation());let i=this.$(".hoesgroot");i&&(this.teardown_.push(O(i,{onTap:()=>t("icon_tap_action",Ve(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(i,"click",o=>o.stopPropagation()),this.on(i,"pointerdown",o=>o.stopPropagation()));let r=o=>{let s=o.target.closest?.("[data-k]");s&&(o.stopPropagation(),this.doe_(s.dataset.k))};this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".vol"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".extra"),"pointerdown",o=>o.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=k(this.hass,t),i=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return i($n(n)?"turn_on":"turn_off");case"bron":return Ai(this.hass,t,D(this.hass,t,this.config.name));case"prev":return i("media_previous_track");case"next":return i("media_next_track");case"play":return i(zn(n)?"media_pause":"media_play");case"stop":return i("media_stop");case"mute":{let r=_e(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Ue(k(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:_e(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!Sn(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:ui(An(n))},{entity_id:t});case"search":return Si(this.hass,t,D(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.config.speakers});default:return}}paint(){let e=this.config,t=k(this.hass,e.entity),n=!t||t.state==="unavailable",i=ci(t),r=this.$(".top");r.dataset.on=String(i),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:dt(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||Tn(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(l,"speaker")),o.style.setProperty("--tone",i&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(e.icon||Tn(t),"speaker"));let c=D(this.hass,e.entity,e.name),p=gi(t,m=>Z(this.hass,m));this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),V(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),i=this.config.show_controls===!1||t?[]:pi(e),r=i.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${zt[s].label}">${b(zt[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=zn(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s))}}paintVolume_(e,t){let n=this.$(".vol"),i=_e(this.config),r=i===this.config.entity?e:k(this.hass,i),o=this.config.show_volume===!1||t?[]:En(r),s=t?null:mi(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=[...o,s?"bron":""].join(",");n.dataset.sig!==l&&(n.dataset.sig=l,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${b("volume")}</button>`:"")+(o.includes("slider")?ie("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${b("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${b("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${b("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let d=n.querySelector(".bronknop");if(d){let u=s.nu||"Bron";this.text(d.querySelector("b"),u),d.setAttribute("aria-label",`Bron kiezen, nu ${u}`),d.title=`Kies uit ${s.aantal} bronnen`}let c=Ue(r),p=be(r),m=n.querySelector('[data-k="mute"]');if(m){let u=c?"volumeMute":"volume";m.dataset.icon!==u&&(m.dataset.icon=u,m.innerHTML=b(u)),m.setAttribute("aria-pressed",String(c))}let v=n.querySelector(".slider");v&&(this.attach_(v,"volume",{value:()=>be(k(this.hass,_e(this.config))),onInput:u=>this.setSlider_(v,u),onCommit:u=>this.hass.callService("media_player","volume_set",{volume_level:u/100},{entity_id:_e(this.config)}),disabled:()=>G(k(this.hass,_e(this.config)))}),v.classList.contains("dragging")||this.setSlider_(v,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),i=t||this.config.show_controls===!1?[]:Mn(e,{zoeken:this.config.show_search!==!1});n.hidden=!i.length;let r=i.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map((d,c)=>`${d==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${d}" aria-label="${zt[d].label}">${b(zt[d].icon)}</button>`).join("")),!i.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(Sn(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let d=An(e),c=d==="one"?"repeatOne":"repeat";s.dataset.icon!==c&&(s.dataset.icon=c,s.innerHTML=b(c)),s.setAttribute("aria-pressed",String(d!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[d])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let i=ge(e,n);this.sliders_.set(t,i),this.teardown_.push(i)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=k(this.hass,this.config?.entity);return 1+(En(e).length?1:0)+(Mn(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("media_player."));return n?{entity:n}:{}}};y(Et,"css",`
    :host { display: block; }
  ...
  `);var Rn=class extends C{defaults(){return{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"entity",selector:_.entity("media_player")},{name:"name",selector:_.text()},{name:"layout",selector:_.select([{value:"row",label:"Rij (\xE9\xE9n rasterrij hoog)"},{value:"groot",label:"Groot (telefoonformaat, grote knoppen)"}])},{name:"volume_entity",selector:_.entity("media_player")},{name:"show_artwork",selector:_.bool()},{name:"show_controls",selector:_.bool()},{name:"show_volume",selector:_.bool()},{name:"show_source",selector:_.bool()},{name:"radio_mode",selector:_.bool()},{name:"speakers",selector:{entity:{domain:"media_player",integration:"music_assistant",multiple:!0}}},{name:"show_search",selector:_.bool()},{name:"icon_tap_action",selector:_.action("toggle")},{name:"icon_hold_action",selector:_.action("more-info")},{name:"tap_action",selector:_.action("more-info")},{name:"hold_action",selector:_.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",layout:"Vorm",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_source:"Bronknop tonen",radio_mode:"Doorspelen na een nummer",speakers:"Speakers om mee te groeperen",show_search:"Zoeken en groeperen tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="layout")return"Groot is bedoeld voor een pop-up of een kolom waar de kaart alle ruimte krijgt: grote hoes, grote knoppen.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="speakers")return'De speakers die onderin het zoekscherm staan om samen te laten spelen. Laat je dit leeg, dan valt de kaart terug op het label "Music Assistant Media" in Home Assistant.';if(e.name==="radio_mode")return"Zoals Spotify: is het gekozen nummer klaar, dan zoekt Music Assistant er zelf muziek bij in plaats van te stoppen. Staat dit uit, dan kan het nog steeds per keer via het menu bij een treffer.";if(e.name==="show_source")return"Voor een tv-ontvanger of een versterker met ingangen: een knop met de zender die nu aanstaat, die een zoekbaar overzicht opent. Kan de speler geen bron kiezen, dan verschijnt hij niet.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};H("domotiapp-media-card-editor",Rn);A("domotiapp-media-card",Et,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var We=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd",rust:"Geen"},{sleutel:"co",label:"Koolmonoxide",icoon:"co",alarm:"Koolmonoxide gedetecteerd",rust:"Geen"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm",rust:"Normaal"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],Mi=a=>a?.rust??"Rustig",Hn=20;function Vn(a){if(!a||a.state==="unavailable"||a.state==="unknown")return null;if(String(a.entity_id??"").startsWith("binary_sensor."))return a.state==="on"?0:null;let e=Number(a.state);return Number.isFinite(e)?e:null}var Fo=a=>!!a&&a.state==="on",Zo=a=>!a||a.state==="unavailable"||a.state==="unknown";function Ti(a,e){let t=a.filter(i=>!i.meting);for(let i of t)if(Fo(e(i.sleutel)))return{soort:"alarm",tekst:i.alarm,tone:"bad",icoon:i.icoon};if(a.length&&a.every(i=>Zo(e(i.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smokeDetector"};let n=Vn(e("battery"));return n!=null&&n<=Hn?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smokeDetector"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smokeDetector"}}var Xo={good:L.good,warn:L.warn,bad:L.bad,neutral:L.neutral,accent:L.accent},St=class extends S{validate(e){return We.filter(n=>e[n.sleutel]).length?{...e}:{...e,[T]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return We.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return We.filter(e=>this.config[e.sleutel])}toestand_(){let e=Ti(this.gekozen_(),t=>k(this.hass,this.config[t]));return{...e,tone:Xo[e.tone]??L.accent}}batterijPct_(){return Vn(k(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}">${b(t.icoon)}
      ...
      </div>`}wire(){let e=this.config,t=this.gekozen_()[0];this.teardown_.push(O(this.$(".top"),{onTap:()=>e.tap_action?de(this,this.hass,e,e.tap_action):W(this,e.smoke??e[t.sleutel]),onHold:()=>de(this,this.hass,e,e.hold_action??{action:"more-info"})})),this.$$(".pil").forEach(n=>{let i=e[n.dataset.soort];i&&(this.on(n,"click",r=>{r.stopPropagation(),W(this,i)}),this.on(n,"pointerdown",r=>r.stopPropagation()),n.style.cursor="pointer")})}paint(){let e=this.config,t=this.toestand_(),n=this.$(".top");this.toggleAttribute("alarm",t.soort==="alarm"),n.style.setProperty("--tone",t.tone),n.classList.toggle("unavailable",t.soort==="weg");let i=this.$(".chip"),r=e.icon||t.icoon;i.dataset.icon!==r&&(i.dataset.icon=r,i.innerHTML=b(r,"smoke")),i.style.setProperty("--tone",t.tone);let o=this.gekozen_()[0];this.text(".nm",e.name||D(this.hass,e.smoke??e[o.sleutel],null)),this.text(".st",t.tekst),n.setAttribute("aria-label",`${this.$(".nm").textContent}${t.tekst?`, ${t.tekst}`:""}`),this.$$(".pil").forEach(s=>this.paintPil_(s)),this.$(".meta").hidden=this.gekozen_().length<=1&&!this.config.always_meta}paintPil_(e){let t=We.find(o=>o.sleutel===e.dataset.soort),n=k(this.hass,this.config[t.sleutel]),i=e.querySelector("b");if(!n||G(n)){i.textContent="\u2014",e.dataset.let="";return}if(t.meting){let o=n.attributes.unit_of_measurement??"",s=Number(n.state);i.textContent=Number.isFinite(s)?`${B(this.hass,s,t.sleutel==="temperature"?1:0)} ${o}`.trim():Z(this.hass,n);let l=t.sleutel==="battery"?this.batterijPct_():null;e.dataset.let=l!=null&&l<=Hn?"warn":"";return}let r=He(n);i.textContent=r?"Alarm":Mi(t),e.dataset.let=r?"bad":""}regels_(){return this.gekozen_().length>1?2:1}getCardSize(){return this.regels_()}getGridOptions(){let e=this.regels_()===1?1:ee(90);return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-smoke-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("binary_sensor.")&&/rook|smoke/i.test(i));return n?{smoke:n}:{}}};y(St,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Pn=class extends C{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"smoke"}]}schema(){return[{name:"name",selector:_.text()},{name:"smoke",selector:_.entity()},{name:"co",selector:_.entity()},{name:"heat",selector:_.entity()},{name:"temperature",selector:_.entity()},{name:"battery",selector:_.entity()},{name:"tap_action",selector:_.action("more-info")},{name:"hold_action",selector:_.action("more-info")}]}label(e){return{name:"Naam (overschrijft die van de melder)",smoke:"Rook",co:"Koolmonoxide",heat:"Warmte",temperature:"Temperatuur",battery:"Batterij",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="smoke")return"Alle vijf zijn optioneel: vul in wat je melder heeft. Wat je leeg laat, komt niet op de kaart.";if(e.name==="battery")return"Een percentage of een 'batterij bijna leeg'-sensor. Onder de 20% meldt de kaart het uit zichzelf."}};H("domotiapp-smoke-card-editor",Pn);A("domotiapp-smoke-card",St,{name:"DomotiApp Rookmelder",description:"Rook, koolmonoxide, warmte, temperatuur en batterij \u2014 alles optioneel."});var Yo=["zo","ma","di","wo","do","vr","za"],Ni=5,Ci=8,At=class extends S{validate(e){if(!e.entity)return{...e,[T]:"Kies een weerentiteit."};let t=Math.min(Math.max(1,Number(e.days)||Ni),Ci);return{show_current:!0,forecast_type:"daily",...e,days:t}}watched(){return[this.config.entity]}template(){this.config.bare&&this.setAttribute("bare","");let e=this.config;return`
      ...
      </div>`}wire(){this.teardown_.push(q(this.$(".card"))),this.teardown_.push(O(this.$(".nu"),{onTap:()=>W(this,this.config.entity),onHold:()=>W(this,this.config.entity)})),this.abonneer_()}async abonneer_(){let e=this.config;this.opzeggen_?.(),this.opzeggen_=null;let t=this.hass?.connection;if(!t?.subscribeMessage){this.forecastFout_="Geen verbinding voor de voorspelling.",this.paintRij_();return}try{let n=await t.subscribeMessage(i=>{this.forecast_=i?.forecast??[],this.forecastFout_=null,this.paintRij_()},{type:"weather/subscribe_forecast",forecast_type:e.forecast_type==="hourly"?"hourly":"daily",entity_id:e.entity});if(!this.isConnected){n();return}this.opzeggen_=n,this.teardown_.push(()=>{try{n()}catch{}this.opzeggen_=null})}catch{this.forecastFout_=e.forecast_type==="hourly"?"Deze weerbron geeft geen uurvoorspelling.":"Deze weerbron geeft geen dagvoorspelling.",this.paintRij_()}}paint(){let e=this.config,t=k(this.hass,e.entity),n=G(t);this.$(".nu").classList.toggle("unavailable",n);let r=this.$(".chip"),o=e.icon||Ie(t?.state);r.dataset.icon!==o&&(r.dataset.icon=o,r.innerHTML=b(o,"cloud")),this.text(".nm",D(this.hass,e.entity,e.name)),this.text(".st",n?"Niet bereikbaar":Z(this.hass,t));let s=this.$(".graden"),l=t?.attributes?.temperature,d=t?.attributes?.temperature_unit??"\xB0C";s.innerHTML=l==null?"":`${B(this.hass,l,Number.isInteger(l)?0:1)}<small>${d}</small>`,this.paintRij_(),V(this.$(".card"))}paintRij_(){let e=this.$(".rij");if(!e)return;let t=this.config;if(this.forecastFout_&&!this.forecast_?.length){e.style.setProperty("--n",1),e.innerHTML=`<div class="leeg">${this.forecastFout_}</div>`;return}let n=(this.forecast_??[]).slice(0,t.days);if(!n.length){e.style.setProperty("--n",1),e.innerHTML='<div class="leeg">Nog geen voorspelling ontvangen\u2026</div>';return}e.style.setProperty("--n",n.length);let i=k(this.hass,t.entity)?.attributes?.temperature_unit??"";e.innerHTML=n.map((r,o)=>{let s=this.wanneer_(r.datetime,o),l=b(Ie(r.condition),"cloud"),d=r.temperature==null?"":`${B(this.hass,r.temperature,0)}\xB0`,c=r.templow==null?"":`${B(this.hass,r.templow,0)}\xB0`,p=r.precipitation_probability==null?"":`<span class="nat">${b("drop")}${Math.round(r.precipitation_probability)}%</span>`;return`
  ...
  `);var In=class extends C{defaults(){return{show_current:!0,forecast_type:"daily",days:Ni}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:_.entity("weather")},{name:"name",selector:_.text()},{name:"forecast_type",selector:_.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:_.number(1,Ci)},{name:"show_current",selector:_.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};H("domotiapp-forecast-card-editor",In);A("domotiapp-forecast-card",At,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var Ge={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},qe=(a,e)=>!!((a?.attributes?.supported_features??0)&e),Jo=(a={})=>{switch(a.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},Mt=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      <div class="cv" data-i="${i}" data-shown="closed" style="--tone:${R(n.tone??e.tone,"solar")}">
        <button class="chip" type="button" aria-label="Meer info"></button>
        <div class="txt"><div class="nm"></div><div class="st"></div></div>
        ${this.keysHtml(e.show_stop!==!1)}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(i=>{this.on(i,"click",()=>{let r=i.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(O(e.querySelector(".chip"),{onTap:()=>W(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],i=k(this.hass,n.entity),r=K(this.hass,n.entity),o=!i||i.state==="unavailable",s=i?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=D(this.hass,n.entity,n.name);let l=qe(i,Ge.SET_POSITION)&&r.current_position!=null,d=l?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=Jo(r),p=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],m=e.querySelector(".chip");m.dataset.icon!==p&&(m.dataset.icon=p,m.innerHTML=b(p,c[d]));let v=e.querySelector(".st");this.dragging_.has(t)||(v.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":l?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(g=>{if(g.dataset.act==="stop"){g.disabled=o||!qe(i,Ge.STOP);return}let $=g.dataset.act==="open";g.disabled=o||($?!qe(i,Ge.OPEN):!qe(i,Ge.CLOSE))});let u=e.querySelector(".pos"),w=l&&this.config.show_position!==!1;if(u.hidden=!w,w){if(u.dataset.built||(u.dataset.built="1",u.innerHTML=ie("position"),u.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let $=u.querySelector(".slider"),z=E=>{$.style.setProperty("--v",`${E}%`),$.setAttribute("aria-valuenow",String(E)),e.querySelector(".st").textContent=`${E}% open`};this.teardown_.push(ge($,{value:()=>K(this.hass,n.entity).current_position??0,onInput:z,onCommit:E=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:E})}))}let g=u.querySelector(".slider");if(!g.classList.contains("dragging")){let $=r.current_position??0;g.style.setProperty("--v",`${$}%`),g.setAttribute("aria-valuenow",String($))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>qe(k(this.hass,n.entity),Ge.SET_POSITION));return ee(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("cover."));return{covers:n?[n]:[]}}};y(Mt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Kn=class extends C{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:_.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};H("domotiapp-cover-card-editor",Kn);A("domotiapp-cover-card",Mt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Qo(a){if(!a)return{label:"Onbekend",home:null};switch(a.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:a.state,home:!1}}}var Tt=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((i,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(O(e,{onTap:()=>W(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=k(this.hass,t.entity),i=Qo(n);e.style.setProperty("--tone",i.home===!0?"var(--dac-good)":i.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=D(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,l=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():j.person),e.setAttribute("aria-label",`${r}, ${i.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return ee(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};y(Tt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Un=class extends C{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,i]of Object.entries(e.tones??{}))t[`kleur:${n}`]=i;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let i of Object.keys(t))i.startsWith("kleur:")&&(t[i]&&(n[i.slice(6)]=t[i]),delete t[i]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Oi(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};H("domotiapp-waste-card-editor",Un);A("domotiapp-waste-card",Nt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function xe(a){if(a==null||a==="")return 4;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Wn(a){if(typeof a=="string")return{name:"",icon:"",path:a};let e=a??{};return{name:typeof e.name=="string"?e.name:"",icon:typeof e.icon=="string"?e.icon:"",path:typeof e.path=="string"?e.path:typeof e.url=="string"?e.url:typeof e.navigation_path=="string"?e.navigation_path:""}}var Fe=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.path?.trim()));function Li(a){return(Array.isArray(a?.items)?a.items:[]).slice(0,20).map(Wn)}function Ct(a,e=4){let t=(a??[]).filter(Fe),n=xe(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let i=Math.max(1,n-1);return{balk:t.slice(0,i),meer:t.slice(i),heeftMeer:!0}}function Di(a){let e=String(a??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var as=`
...
`,Ri=a=>a.filter(Fe).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.path?{path:e.path}:{}})),Gn=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(Wn);this.gebouwd_&&JSON.stringify(Ri(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=as;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_()),t.appendChild(this.kleurKiezer_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:i}=Ct(this.items_,this.rest_.max),r=i.length,o=this.items_.filter(Fe);if(this.items_.forEach((l,d)=>{if(o.indexOf(l)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(l,d))}),!this.items_.length){let l=document.createElement("p");l.className="uitleg",l.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(l)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${xe(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:xe(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=xe(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}kleurKiezer_(){let e=document.createElement("dac-tone-picker");return e.label="Kleur",e.hass=this.hass_,e.value=this.rest_.tone??"accent",e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value;n&&n!=="accent"?this.rest_.tone=n:delete this.rest_.tone,this.emit_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{let g=!Fe(e);n.dataset.leeg=String(g),r.innerHTML=b(e.icon,"grid"),s.textContent=e.name||(g?"Nieuwe knop":e.path||"Zonder naam"),l.textContent=e.path?e.path:e.icon?`${me(e.icon)} -- nog geen pad`:"Nog geen pad"};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let m=this.kopKnop_("Verwijderen",j.close,()=>this.verwijder_(t));m.classList.add("weg"),i.append(r,o,c,p,m),n.appendChild(i);let v=document.createElement("div");v.className="body";let u=document.createElement("dac-icon-picker");u.label="Icoon",u.fallback="grid",u.auto=!1,u.hass=this.hass_,u.value=e.icon,u.addEventListener("value-changed",g=>{g.stopPropagation(),e.icon=g.detail.value??"",this.emit_()});let w=document.createElement("ha-form");return w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],w.computeLabel=g=>({name:"Naam",path:"Waar gaat hij heen"})[g.name]??g.name,w.computeHelper=g=>g.name==="path"?"/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.":void 0,w.data={name:e.name,path:e.path},w.addEventListener("value-changed",g=>{g.stopPropagation();let $=g.detail.value??{};e.name=$.name??"",e.path=$.path??"",this.emit_()}),v.append(u,w),n.appendChild(v),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`i${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=this.open_.has(`i${e}`),i=this.open_.has(`i${t}`);this.open_.delete(`i${e}`),this.open_.delete(`i${t}`),i&&this.open_.add(`i${e}`),n&&this.open_.add(`i${t}`)}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Ri(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-navbar-card-editor",Gn);var Hi=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Zn(a){let e=Hi(a),t=0;for(;e&&t++<40;)yield e,e=Hi(e)}function is(a){for(let e of Zn(a)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function rs(a){for(let e of Zn(a))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Vi(a){for(let e of Zn(a)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Ot=class extends S{validate(e){let t=Li(e),n={labels:!0,tone:"accent",...e,items:t,max:xe(e?.max)};return t.filter(i=>i.name||i.icon||i.path).length||(n[T]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:i}=Ct(e.items,e.max),r=(l,d)=>`
      <button type="button" class="knop" data-i="${d}" title="${Q(l.name)}">
        <span class="ico">${b(l.icon,"grid")}</span>
        <span class="naam">${Q(l.name)}</span>
      </button>`,o=(l,d)=>`
      <button type="button" class="regel" data-i="${d}">
        <span class="mi">${b(l.icon,"grid")}</span>
        <span class="mt">${Q(l.name||l.path)}</span>
  ...
  `);A("domotiapp-navbar-card",Ot,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var os="dac-tabs:";function Xn(a){let e=a??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=null;return e.card&&typeof e.card=="object"?n=e.card:Array.isArray(e.cards)&&e.cards.length&&(n=e.cards.length===1?e.cards[0]:{type:"vertical-stack",cards:e.cards}),{name:t,icon:typeof e.icon=="string"?e.icon:"",card:n}}var Lt=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.card));function Pi(a){return(Array.isArray(a?.tabs)?a.tabs:[]).slice(0,8).map(Xn).filter(Lt)}function ss(a,e){if(!e)return 0;let t=Math.round(Number(a?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function Yn(a){let e=(a??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return os+e}function ls(a,e,t){let n=null;try{n=a?.getItem?.(e)??null}catch{return null}let i=Number(n);return n===null||n===""||!Number.isInteger(i)?null:i>=0&&i<t?i:null}function Ii(a,e,t){try{return a?.setItem?.(e,String(t)),!0}catch{return!1}}function Ki(a,e,t){return ls(t,Yn(e),e.length)??ss(a,e.length)}var ds=`
...
`,Ui=a=>a.filter(Lt).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.card?{card:structuredClone(e.card)}:{}}));function Wi(a){if(!a.card)return"Nog geen kaart";let e=String(a.card.type??"").replace(/^custom:/,"");return e==="vertical-stack"||e==="horizontal-stack"||e==="grid"?`${e} met ${(a.card.cards??[]).length} kaarten`:e||"een kaart"}var Jn=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(Xn);this.gebouwd_&&JSON.stringify(Ui(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=ds;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_()),t.appendChild(this.kleurKiezer_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((o,s)=>n.appendChild(this.tabBlok_(o,s)));let i=document.createElement("p");i.className="uitleg",i.textContent="De kaart die in een tab zit, stel je in via Code-editor weergeven. Naam, icoon en volgorde kunnen hier; de inhoud blijft staan als je die aanpast.",t.appendChild(i);let r=document.createElement("button");r.type="button",r.className="toevoegen",r.textContent="\uFF0B  Tabblad toevoegen",r.disabled=this.tabs_.length>=8,r.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",card:null}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(r)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}kleurKiezer_(){let e=document.createElement("dac-tone-picker");return e.label="Kleur van het actieve tabblad",e.hass=this.hass_,e.value=this.rest_.tone??"accent",e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value;n&&n!=="accent"?this.rest_.tone=n:delete this.rest_.tone,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!Lt(e)),r.innerHTML=b(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=Wi(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let m=this.kopKnop_("Verwijderen",j.close,()=>this.verwijder_(t));m.classList.add("weg"),i.append(r,o,c,p,m),n.appendChild(i);let v=document.createElement("div");v.className="body";let u=document.createElement("dac-icon-picker");u.label="Icoon",u.fallback="grid",u.auto=!1,u.hass=this.hass_,u.value=e.icon,u.addEventListener("value-changed",$=>{$.stopPropagation(),e.icon=$.detail.value??"",this.emit_()});let w=document.createElement("ha-form");w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}}],w.computeLabel=()=>"Naam",w.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",w.data={name:e.name},w.addEventListener("value-changed",$=>{$.stopPropagation(),e.name=$.detail.value?.name??"",this.emit_()});let g=document.createElement("div");return g.className="inhoud",g.innerHTML=`${b("grid")}<span>Inhoud: <b>${Wi(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,v.append(u,w,g),n.appendChild(v),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Ui(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-tabs-card-editor",Jn);var Dt=class extends S{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=Pi(e),n={tone:"accent",...e,tabs:t};return t.length||(n[T]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}set hass(e){super.hass=e;for(let t of this.kinderen_.values())t&&(t.hass=e)}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
      ...
      <div class="card surface" style="--tone:${R(e.tone)}">
        <div class="balk" role="tablist">${t}</div>
        <div class="vakken">${n}</div>
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(q(this.$(".card"))),this.kies_(Ki(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let i=Math.min(Math.max(0,e),n.length-1);this.open_=i;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===i));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===i);t&&Ii(this.opslag_(),Yn(n),i),this.bouw_(i)}async bouw_(e){if(this.kinderen_.has(e)){V(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.card){t.innerHTML='<div class="leeg">Deze tab heeft nog geen kaart.</div>',V(this.$(".card"));return}this.kinderen_.set(e,null);try{let i=await window.loadCardHelpers?.();if(!i)throw new Error("loadCardHelpers ontbreekt");let r=i.createCardElement(n.card);r.hass=this.hass,this.kinderen_.set(e,r),t.replaceChildren(r),V(this.$(".card"))}catch(i){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${Q(i?.message??i)}</div>`,V(this.$(".card"))}}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};y(Dt,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);A("domotiapp-tabs-card",Dt,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var Rt=globalThis,Ht=Rt.ShadowRoot&&(Rt.ShadyCSS===void 0||Rt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Qn=Symbol(),Gi=new WeakMap,Ze=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Qn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ht&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Gi.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Gi.set(t,e))}return e}toString(){return this.cssText}},ce=a=>new Ze(typeof a=="string"?a:a+"",void 0,Qn),F=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new Ze(t,a,Qn)},qi=(a,e)=>{if(Ht)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=Rt.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},ea=Ht?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return ce(t)})(a):a;var{is:cs,defineProperty:ps,getOwnPropertyDescriptor:hs,getOwnPropertyNames:us,getOwnPropertySymbols:ms,getPrototypeOf:gs}=Object,Vt=globalThis,Fi=Vt.trustedTypes,fs=Fi?Fi.emptyScript:"",bs=Vt.reactiveElementPolyfillSupport,Xe=(a,e)=>a,ta={toAttribute(a,e){switch(e){case Boolean:a=a?fs:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Xi=(a,e)=>!cs(a,e),Zi={attribute:!0,type:String,converter:ta,reflect:!1,useDefault:!1,hasChanged:Xi};Symbol.metadata??=Symbol("metadata"),Vt.litPropertyMetadata??=new WeakMap;var pe=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Zi){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&ps(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=hs(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Zi}static _$Ei(){if(this.hasOwnProperty(Xe("elementProperties")))return;let e=gs(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Xe("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Xe("properties"))){let t=this.properties,n=[...us(t),...ms(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(ea(i))}else e!==void 0&&t.push(ea(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return qi(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:ta).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ta;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Xi)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};pe.elementStyles=[],pe.shadowRootOptions={mode:"open"},pe[Xe("elementProperties")]=new Map,pe[Xe("finalized")]=new Map,bs?.({ReactiveElement:pe}),(Vt.reactiveElementVersions??=[]).push("2.1.2");var la=globalThis,Yi=a=>a,Pt=la.trustedTypes,Ji=Pt?Pt.createPolicy("lit-html",{createHTML:a=>a}):void 0,ir="$lit$",ke=`lit$${Math.random().toFixed(9).slice(2)}$`,rr="?"+ke,vs=`<${rr}>`,$e=document,Je=()=>$e.createComment(""),Qe=a=>a===null||typeof a!="object"&&typeof a!="function",da=Array.isArray,ks=a=>da(a)||typeof a?.[Symbol.iterator]=="function",na=`[ 	
\f\r]`,Ye=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Qi=/-->/g,er=/>/g,we=RegExp(`>|${na}(?:([^\\s"'>=/]+)(${na}*=${na}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),tr=/'/g,nr=/"/g,or=/^(?:script|style|textarea|title)$/i,ca=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),f=ca(1),hp=ca(2),up=ca(3),je=Symbol.for("lit-noChange"),x=Symbol.for("lit-nothing"),ar=new WeakMap,ye=$e.createTreeWalker($e,129);function sr(a,e){if(!da(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ji!==void 0?Ji.createHTML(e):e}var _s=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=Ye;for(let s=0;s<t;s++){let l=a[s],d,c,p=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Ye?c[1]==="!--"?o=Qi:c[1]!==void 0?o=er:c[2]!==void 0?(or.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=we):c[3]!==void 0&&(o=we):o===we?c[0]===">"?(o=i??Ye,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?we:c[3]==='"'?nr:tr):o===nr||o===tr?o=we:o===Qi||o===er?o=Ye:(o=we,i=void 0);let v=o===we&&a[s+1].startsWith("/>")?" ":"";r+=o===Ye?l+vs:p>=0?(n.push(d),l.slice(0,p)+ir+l.slice(p)+ke+v):l+ke+(p===-2?s:v)}return[sr(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},et=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=_s(e,t);if(this.el=a.createElement(d,n),ye.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=ye.nextNode())!==null&&l.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(ir)){let m=c[o++],v=i.getAttribute(p).split(ke),u=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:u[2],strings:v,ctor:u[1]==="."?ia:u[1]==="?"?ra:u[1]==="@"?oa:Ce}),i.removeAttribute(p)}else p.startsWith(ke)&&(l.push({type:6,index:r}),i.removeAttribute(p));if(or.test(i.tagName)){let p=i.textContent.split(ke),m=p.length-1;if(m>0){i.textContent=Pt?Pt.emptyScript:"";for(let v=0;v<m;v++)i.append(p[v],Je()),ye.nextNode(),l.push({type:2,index:++r});i.append(p[m],Je())}}}else if(i.nodeType===8)if(i.data===rr)l.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(ke,p+1))!==-1;)l.push({type:7,index:r}),p+=ke.length-1}r++}}static createElement(e,t){let n=$e.createElement("template");return n.innerHTML=e,n}};function Ne(a,e,t=a,n){if(e===je)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=Qe(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Ne(a,i._$AS(a,e.values),i,n)),e}var aa=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??$e).importNode(t,!0);ye.currentNode=i;let r=ye.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new tt(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new sa(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=ye.nextNode(),o++)}return ye.currentNode=$e,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},tt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ne(this,e,t),Qe(e)?e===x||e==null||e===""?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==je&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ks(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==x&&Qe(this._$AH)?this._$AA.nextSibling.data=e:this.T($e.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=et.createElement(sr(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new aa(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=ar.get(e.strings);return t===void 0&&ar.set(e.strings,t=new et(e)),t}k(e){da(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O(Je()),this.O(Je()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Yi(e).nextSibling;Yi(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ce=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=x}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Ne(this,e,t,0),o=!Qe(e)||e!==this._$AH&&e!==je,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Ne(this,s[n+l],t,l),d===je&&(d=this._$AH[l]),o||=!Qe(d)||d!==this._$AH[l],d===x?e=x:e!==x&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!i&&this.j(e)}j(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ia=class extends Ce{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===x?void 0:e}},ra=class extends Ce{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==x)}},oa=class extends Ce{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Ne(this,e,t,0)??x)===je)return;let n=this._$AH,i=e===x&&n!==x||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==x&&(n===x||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},sa=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ne(this,e)}};var xs=la.litHtmlPolyfillSupport;xs?.(et,tt),(la.litHtmlVersions??=[]).push("3.3.3");var lr=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new tt(e.insertBefore(Je(),r),r,void 0,t??{})}return i._$AI(a),i};var pa=globalThis,U=class extends pe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=lr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return je}};U._$litElement$=!0,U.finalized=!0,pa.litElementHydrateSupport?.({LitElement:U});var ws=pa.litElementPolyfillSupport;ws?.({LitElement:U});(pa.litElementVersions??=[]).push("4.2.2");var ne=F`
  :host {
    ${ce(Y)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${ce(ue)}
`;var ys=["unavailable","unknown"],$s=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function It({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||ys.includes(c.state)){i.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let m of $s)if(d[m]!==void 0){p[m]=d[m];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function Kt(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var ua=["hs","rgb","rgbw","rgbww","xy"],ma="color_temp",js="onoff";var ze="kleur";var zs=["unavailable","unknown"],cr=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Es=[0,100];function oe(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===js,i=t!==null&&t.includes(ma),r=t!==null&&t.some(d=>ua.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!zs.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:i&&!l}}function Ss(){return{state:"off"}}function pr(a,e){let t=e??oe(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...Os(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function hr(a,e,t,n){return e?a&&a.state==="on"?{...a}:pr(t,n):{state:"off"}}function ur(a,e,t,n){let i=n??oe(t),r=_a(a,t,i);return i.helderheid&&(r.brightness=N(e,1,255)),r}function ga(a,e,t,n){let i=n??oe(t),r=_a(a,t,i);return yr(r),r.color_temp_kelvin=N(e,i.minKelvin,i.maxKelvin),r}function fa(a,e,t,n){let i=n??oe(t),r=_a(a,t,i);return yr(r),r.hs_color=[N(e?.[0],0,360),N(e?.[1],0,100)],r}function Bt(a,e,t){return a??Ss()}function mr(a,e,t){let n=Bt(a,e,t);if(typeof n.brightness=="number")return N(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?N(i,1,255):255}function ba(a,e,t){let n=t??oe(e),i=Bt(a,e,n);if(typeof i.color_temp_kelvin=="number")return N(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?N(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Ut(a,e,t){let n=Bt(a,e,t);if(ha(n.hs_color))return[N(n.hs_color[0],0,360),N(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return ha(i)?[N(i[0],0,360),N(i[1],0,100)]:[...Es]}function va(a){return a!=null&&typeof a=="object"}function gr(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!va(i[s]?.lights?.[o]))return!0;return!1})}function fr(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function ka(a,e,t){return Bt(a,e,t).state==="on"}function br(a,e,t){let n=t??oe(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=ka(a,e,n),r=vr(n),o=r?As(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===ze),kleurkeuze:i&&r,stand:i?o:null}}function vr(a){return!!(a?.kleurtemp&&a?.kleur)}function As(a,e,t){let n=t??oe(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if(cr.slice(1).some(r=>a[r]!==void 0))return ze}let i=e?.attributes?.color_mode;return i===ma&&n.kleurtemp?"wit":ua.includes(i)&&n.kleur?ze:"wit"}function kr(a,e,t,n){let i=n??oe(t);return vr(i)?e==="wit"?ga(a,ba(a,t,i),t,i):fa(a,Ut(a,t,i),t,i):a}function _r(a){let e=N(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function xr(a){let e=N(a,1,100);return N(Math.round(e/100*255),1,255)}var Ms=1e3,Ts=4e4,dr=7;function Ns(a){let e=N(a,Ms,Ts)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[N(t,0,255),N(n,0,255),N(i,0,255)]}function Cs(a){let[e,t,n]=Ns(a);return`rgb(${e}, ${t}, ${n})`}function wr(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:dr},(r,o)=>{let s=o/(dr-1),l=t+(n-t)*s;return`${Cs(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Os(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?N(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===ma&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=N(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&ua.includes(i)&&ha(t.hs_color)&&(n.hs_color=[N(t.hs_color[0],0,360),N(t.hs_color[1],0,100)]),n}function _a(a,e,t){return a&&a.state==="on"?{...a}:pr(e,t)}function yr(a){for(let e of cr)delete a[e]}function ha(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function N(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Wt="domotiapp-scene-card",xa="domotiapp-scene-card-editor",$r="domotiapp-scene-editor";var nt=["een","twee","drie"],jr="pencil",zr=["grid_options","layout_options","view_layout","visibility"];var Er="entity_id",Oe=class extends U{constructor(){super();y(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));y(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Er]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Er];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return x;let t=this._leden();return f`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?f`
          ...
          `:x}
    `}};y(Oe,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),y(Oe,"styles",[ne,F`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `]);var Ls="domotiapp_lovelace/snapshot/create",Ds="domotiapp_lovelace/snapshot/close",Gt=class{constructor({roepCommandoAan:e,entityId:t}){this._roep=e,this._entityId=t,this._aanmaak=null,this._afsluiting=null}get heeftSnapshot(){return this._aanmaak!==null}get isGesloten(){return this._afsluiting!==null}async zorgVoorSnapshot(){return this._aanmaak===null&&(this._aanmaak=this._roep(Ls,{entity_id:this._entityId}).catch(e=>{throw this._aanmaak=null,e})),this._aanmaak}async sluit({opslaan:e=!1}={}){return this.heeftSnapshot?this._afsluiting!==null?this._afsluiting:(this._afsluiting=(async()=>{try{await this._aanmaak}catch{return{gedaan:!1}}return await this._roep(Ds,{entity_id:this._entityId,restore:!e}),{gedaan:!0}})(),this._afsluiting):{gedaan:!1}}};async function Sr({beheer:a,oproepen:e,voerUit:t}){return await a.zorgVoorSnapshot(),t(e)}var ya="laden",$a="klaar",Ar="fout",Vs=`linear-gradient(to right, ${[0,60,120,180,240,300,360].map(a=>`hsl(${a}, 100%, 50%)`).join(", ")})`,Le=class extends U{constructor(){super(),this._scenes=null,this._leden=[],this._tab=0,this._toestand=ya,this._melding="",this._bezig=!1,this._kelvinGemeld=new Set,this._snapshot=null}firstUpdated(){this._haalOp()}async _haalOp(){this._toestand=ya;try{let e=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:this.entityId});return this._neemOver(e),this._toestand=$a,e}catch(e){return this._melding=e?.message??String(e),this._toestand=Ar,null}}_neemOver(e){this._scenes=Array.from({length:3},(t,n)=>{let i=e.scenes?.[n]??{};return{icon:i.icon||nt[n],lights:{...i.lights??{}}}}),this._leden=e.member_entity_ids??[],this._melding=""}_stateVan(e){return this.hass?.states?.[e]}_besturingVan(e){let t=oe(this._stateVan(e));return t.kelvinUitDefaults&&!this._kelvinGemeld.has(e)&&(this._kelvinGemeld.add(e),console.warn(`domotiapp-scene-editor: ${e} meldt geen Kelvin-grenzen; ${t.minKelvin}\u2013${t.maxKelvin} K aangehouden (SPEC 6.3).`)),t}_waardeVan(e){return this._scenes?.[this._tab]?.lights?.[e]}_zetLamp(e,t){this._scenes=this._scenes.map((n,i)=>{if(i!==this._tab)return n;let r={...n.lights};return t===void 0?delete r[e]:r[e]=t,{...n,lights:r}})}_zetIcoon(e){this._scenes=this._scenes.map((t,n)=>n===this._tab?{...t,icon:e||nt[n]}:t)}_kiesTab(e){this._tab=e}get _kanOpslaan(){return this._toestand===$a&&!this._bezig&&this._leden.length>0}async _slaOp(){if(!this._kanOpslaan)return;this._bezig=!0,this._melding="";try{await this.hass.callWS({type:"domotiapp_lovelace/scenes/save",entity_id:this.entityId,scenes:this._scenes})}catch(t){this._melding=t?.message??String(t),this._bezig=!1;return}let e=await this._haalOp();this._bezig=!1,e&&this.dispatchEvent(new CustomEvent("scenes-opgeslagen",{detail:e,bubbles:!0,composed:!0})),this._sluit({opslaan:!0})}get _beheer(){return this._snapshot===null&&(this._snapshot=new Gt({entityId:this.entityId,roepCommandoAan:(e,t)=>this.hass.callWS({type:e,...t})})),this._snapshot}get _kanVoorbeeld(){return this._toestand===$a&&!this._bezig&&this._leden.length>0}async _voorbeeld(){if(!this._kanVoorbeeld)return;let{oproepen:e}=It({scene:this._scenes[this._tab],memberEntityIds:this._leden,states:this.hass.states});this._bezig=!0,this._melding="";try{let t=await Sr({beheer:this._beheer,oproepen:e,voerUit:n=>Kt((i,r)=>this.hass.callService("light",i,r),n)});t.length&&(this._melding=`Deze lampen reageerden niet: ${t.map(n=>this._naam(n.entityId)).join(", ")}.`)}catch(t){this._melding=`Het voorbeeld is niet gestart: ${t?.message??String(t)}`}finally{this._bezig=!1}}_sluit({opslaan:e=!1}={}){this.dispatchEvent(new CustomEvent("editor-gesloten",{bubbles:!0,composed:!0})),this._sluitSnapshot({opslaan:e})}async _sluitSnapshot({opslaan:e}){try{await this._beheer.sluit({opslaan:e})}catch(t){console.warn(`domotiapp-scene-editor: de snapshot kon niet worden ${e?"verwijderd":"hersteld"}: ${t?.message??t}`)}}disconnectedCallback(){super.disconnectedCallback(),this._snapshot&&this._snapshot.heeftSnapshot&&this._sluitSnapshot({opslaan:!1})}_dialoogGesloten(e){e.stopPropagation(),this._sluit()}_naam(e){return this.nameOverrides?.[e]||this._stateVan(e)?.attributes?.friendly_name||e}render(){return f`
      <ha-dialog
        open
    ...
    `}_renderInhoud(){return this._toestand===ya?f`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Ar?f`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=ka(i,t,n),o=br(i,t,n);return f`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${va(i)?x:f`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?f`
                <div class="bediening">
                  ${o.kleurkeuze?this._renderKleurkeuze(e,t,n,i,o.stand):x}
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,hr(i,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:x}
        </div>
    ...
    `}_renderBesturing(e,t,n,i,r){return f`
      ${r.helderheid?this._renderHelderheid(e,t,n,i):x}
      ${r.kleurtemp?this._renderKleurtemp(e,t,n,i):x}
      ${r.kleur?this._renderKleur(e,t,n,i):x}
    `}_renderHelderheid(e,t,n,i){let r=_r(mr(i,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,ur(this._waardeVan(e),xr(s.detail.value),t,n))};return f`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,i,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,kr(this._waardeVan(e),s,t,n))};return f`
    ...
    `}_renderKleurtemp(e,t,n,i){let r=ba(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,ga(this._waardeVan(e),s.detail.value,t,n))};return f`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${wr(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,i){let[r,o]=Ut(i,t,n),s=l=>d=>{d.stopPropagation();let c=Ut(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,fa(this._waardeVan(e),p,t,n))};return f`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Vs}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};y(Le,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),y(Le,"styles",[ne,F`
    ...
    `]);var Ps="0.9.0",Is=["type","entity","name_overrides","bare"],ja="laden",at="klaar",za="leeg",Ea="geen-groep",Mr="opslagfout",Tr="fout",it=class extends U{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=ja,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(xa)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}updated(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?q(e):null),V(e)}disconnectedCallback(){super.disconnectedCallback(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!Is.includes(n)&&!zr.includes(n));t.length&&console.warn(`${Wt}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e,this.toggleAttribute("bare",!!e.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Se(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===Ea){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=ja,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?za:at}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=Mr;return}if(!this.hass.states[t]){this._toestand=Ea;return}this._toestand=Tr}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==at)return;let{oproepen:t}=It({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await Kt((i,r)=>this.hass.callService("light",i,r),t);n.length&&this._meldMislukking(n.map(i=>i.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(i=>this._naam(i)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===at&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?za:at}render(){if(!this._config)return x;switch(this._toestand){case Ea:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Mr:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Tr:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return f`
      <div class="needs">
    ...
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=b(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===za,t=this._toestand===ja,n=this._iconen();return f`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((i,r)=>f`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==at)return x;let e=gr(this._scenes,this._leden,3).length,t=fr(e);return t?f`<div class="mededeling">${t}</div>`:x}_renderEditor(){return f`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||nt[t])}};y(it,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),y(it,"styles",[ne,F`
      :host { display: block; }
    ...
    `]);M(Wt,it);M(xa,Oe);M($r,Le);Ae({type:Wt,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Ps}).`,preview:!1});var Ee="domotiapp-alarm-card",Sa="domotiapp-alarm-card-editor",Nr="domotiapp-alarm-editor",Cr="DomotiApp Wekker",Or="https://github.com/Sven2410/domotiapp-lovelace",se="domotiapp_lovelace",J=Object.freeze({get:`${se}/alarms/get`,save:`${se}/alarms/save`,setEnabled:`${se}/alarms/set_enabled`,delete:`${se}/alarms/delete`,stop:`${se}/alarms/stop`,clearMessage:`${se}/alarms/clear_message`,search:`${se}/sound/search`,entities:`${se}/entities/list`,previewStart:`${se}/preview/start`,subscribe:`${se}/updates/subscribe`}),Ft="#026FA1";function Lr(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Ks="07:00";var Bs=["uri","name","media_type","image"],Us="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Ws="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Gs="Music Assistant Wekker",qs="Verlichting Wekker";function Zt(){return{id:null,name:"",time:Ks,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Dr(a){let e=Zt();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:Aa(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:rt(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function rt(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of Bs)e[t]=a[t]===void 0?null:a[t];return e}function Aa(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Ma(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),Aa(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Rr(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:rt(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function Hr(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function Vr(a){return Aa(a)&&a.slice(0,2)==="02"?Us:null}function Pr(a){return a===!1?Ws:null}function Ir(a){return typeof a?.endless=="boolean"?a.endless:null}function Xt(a,e){let t=e==="lamp",n=t?qs:Gs,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function Kr(a,e){return Xt(e,"speaker")!==null?!1:Ma(a).ok}var Zs=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Xs=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],ot="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ys="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Js="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",De=class extends U{constructor(){super(),this._concept=Zt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Dr(this.wekker):Zt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:J.previewStart,speaker:this._concept.speaker,sound:rt(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:J.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:rt(e),endless:Ir(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Ma(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:J.save,person:this.person,alarm:Rr(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return f`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return x;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=Xt(t,"speaker"),r=Xt(n,"lamp"),o=Vr(e.time),s=Pr(e.endless),l=Kr(e,t);return f`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Zs.map(([d,c])=>f`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Hr(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${i?f`<div class="uitleg">${this._svg(ot)}<span>${i}</span></div>`:f`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Xs.map(([d,c])=>f`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
    ...
    `}};y(De,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),y(De,"styles",[ne,F`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${ce(Ft)});
      display: block;
  ...
  `]);var Br="person",Qs="Kies een persoon in de kaartinstellingen.",Ur="De gekozen persoon is niet gevonden.",el="De opgeslagen wekkers van deze persoon zijn onleesbaar.",hh=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Wr(a){if(!a||typeof a!="object"||Array.isArray(a))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=a.person;if(e==null||e==="")return{...a};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Br}.`))throw new Error(`'${e}' zit niet in het domein ${Br}. Kies een persoon, zoals person.sven.`);return{...a}}function Gr(a){return{type:`custom:${a}`}}function qr(a,e){return a?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Ur,isFout:!0}:{soort:"ontbreekt",tekst:Qs,isFout:!1}}function Fr(a,e){return a==="not_found"?Ur:a==="home_assistant_error"?el:e||"Er ging iets mis bij het ophalen van de wekkers."}var tl=["ma","di","wo","do","vr","za","zo"],nl="Geen wekkers ingesteld",al="Eenmalig",il="Eenmalig \u2014 afgelopen",rl="Geen wekker actief",Zr="Stoppen",ol="Er is een melding over deze wekker, maar de tekst ontbreekt.";function sl(a){return!Array.isArray(a)||a.length===0?al:[...new Set(a)].sort((t,n)=>t-n).map(t=>tl[t-1]??"?").join(" ")}function ll(a,e){return!a||Array.isArray(a.days)&&a.days.length>0?!1:Date.parse(a?.one_shot_at??"")<=e}function Xr(a,e){return ll(a,e)?il:sl(a?.days)}function Yr(a){let e=a?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:ol,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function Jr(a){let e=a?.alarms;if(!Array.isArray(e)||e.length===0)return nl;let t=a?.next_fire?.text;return typeof t=="string"&&t.trim()?t:rl}function Qr(a,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(a??[]).find(s=>s?.id===o)).filter(Boolean),i=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:i.length?i.join(" en "):"Wekker",tijd:r.join(" en ")}}var dl="0.9.0",cl="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",pl="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",eo="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",hl="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Yt=(a,e="icoon")=>f`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${a} />
  </svg>`,st=class extends U{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=Wr(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(Sa)}static getStubConfig(){return Gr(Ee)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:Se(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?q(e):null),V(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:J.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${Ee}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${Ee}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let i=new Set(this._toestand.ringing??[]);n==="started"?i.add(t):i.delete(t),this._toestand={...this._toestand,ringing:[...i]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:J.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=Fr(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:J.entities})}catch(t){this._entiteiten=null,console.warn(`${Ee}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:J.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:J.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:J.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:J.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?Qr(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return x;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=qr(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let i=this._stop();return this._editorVoor!==void 0&&!i?f`<div class="card surface">
    ...
    `}_bevestiging(e){return f`<div class="onderrij bevestiging">
      <span class="boodschap">${Lr(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=Yr(e),i=!!e.enabled;return f`
      <div class="rij ${i?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?f`<div class="onderrij ${n.isFout?"fout":""}">
            ${Yt(n.isFout?hl:eo,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:x}
    `}};y(st,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),y(st,"styles",[ne,F`
  ...
  `]);var Re=class Re extends U{constructor(){super(...arguments);y(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?x:f`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};y(Re,"properties",{hass:{attribute:!1},_config:{state:!0}}),y(Re,"styles",[ne,F`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),y(Re,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Ta=Re;M(Ee,st);M(Sa,Ta);M(Nr,De);Ae({type:Ee,name:Cr,description:`Wekkerkaart van DomotiApp (v${dl}).`,preview:!1,documentationURL:Or});var ul="0.9.0";Ia(a=>console.warn(`domotiapp-lovelace: ${a}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${ul} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{ul as VERSION};
