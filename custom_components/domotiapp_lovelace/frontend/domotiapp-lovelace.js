var Pa=Object.defineProperty;var Ra=(i,e,t)=>e in i?Pa(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var _=(i,e,t)=>Ra(i,typeof e!="symbol"?e+"":e,t);var Y=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function se(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var ie=i=>String(i??"").split(".")[0],f=(i,e)=>e&&i?.states?.[e]||null,P=(i,e)=>f(i,e)?.attributes??{},et=(i,e,t)=>t?null:P(i,e).entity_picture||null;function Qn(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function L(i,e,t){return t||P(i,e).friendly_name||e||""}var Ha=new Set(["scene","script","input_button","button","event"]),Ot=i=>Ha.has(ie(i));function W(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Ot(i.entity_id):!1}function je(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(ie(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var Va=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),ei=i=>Va.has(ie(i));function ti(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function Qe(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var U=(i,e)=>Qe(i,"hass-more-info",{entityId:e});function Me(i){switch(ie(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function Ia(i){switch(ie(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function he(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":U(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=Ia(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),Qe(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":Qe(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":Qe(i,"ll-custom",n);break;default:break}}function T(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=h=>{h.button!=null&&h.button!==0||(o=Date.now())},c=()=>{let h=o?Date.now()-o:0;if(o=0,t&&h>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",h=>h.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function G(i,e){if(!e)return"";let t=ie(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function R(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Yn=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],ni=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Jn=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),Lt=(i,e)=>Math.round((Jn(e)-Jn(i))/864e5);function Te(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Dt(i,e=new Date){if(!i)return"";let t=Lt(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Yn[i.getDay()]:`${Yn[i.getDay()].slice(0,2)} ${i.getDate()} ${ni[i.getMonth()]}`}var ii=i=>i?`${i.getDate()} ${ni[i.getMonth()]}`:"";var Ka="home-assistant";function ai({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=Ka,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let m=i();if(!m)return!1;for(let[x,u]of e)try{m.get(x)||m.define(x,u)}catch($){t(`kon ${x} niet registreren: ${$&&$.message}`)}return!0}function c(){let m=i();return!m||!m.get(r)?!1:d()}if(c())return!0;let h=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(h,o)}};return n(h,o),!1}var ri=[];function D(i,e){ri.push([i,e])}function ke({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function oi(i=()=>{}){ai({leesRegistry:()=>globalThis.customElements,definities:ri,waarschuw:i})}var Ua=`
  :host {
    ${Y}
    display: block;
...
`,C={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},tt={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},V=(i,e="accent")=>C[i]??(i&&/[#(]|^var/.test(i)?i:C[e]),N=Symbol("incomplete"),Wa=i=>`
  <div class="needs">
  ...
  </div>`,Ba=56,si=8,F=i=>Math.max(1,Math.ceil((i+si)/(Ba+si))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[se(Ua+xe+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[N]||ti(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[N]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[N];e.innerHTML=t?Wa(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,!t&&(this.wire(),this.wired_=!0,this.hass_&&this.paint())}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}};_(S,"css","");function j(i,e,{name:t,description:n,preview:a=!0}={}){D(i,e),ke({type:i,name:t,description:n,preview:a})}function O(i,e){D(i,e)}var p=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,z={house:p(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,Vt=null,It=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Vt=Vt??[se(Ya)],this.shadowRoot.adoptedStyleSheets=Vt,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in C)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${C[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${Za.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),a=()=>this.toggleAttribute("narrow",n.matches);a(),n.addEventListener("change",a),this.teardown_.push(()=>n.removeEventListener("change",a))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Ja(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${Qa[e.getDay()]} ${e.getDate()} ${er[e.getMonth()]}`);let a=this.$(".clock");a&&this.text(a,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=f(this.hass,e.weather),n=P(this.hass,e.weather),a=this.$(".now");if(a&&t){let l=Ne(t.state);a.style.setProperty("--wtone",V(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${R(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=a.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=w(l,"cloud")),this.text(a.querySelector(".cond"),G(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=tr.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${V(Wt[l.key].tone)}" title="${Wt[l.key].label}">
             ${z[Wt[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let a=this.hass?.config?.unit_system?.wind_speed??"km/h",r=nr(t.wind_bearing);return{key:e,value:`${R(this.hass,t.wind_speed,0)} ${a}${r?` ${r}`:""}`}}case"uv":{let r=P(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(f(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${R(this.hass,r,1)}`}:null}case"precipitation":{let a=f(this.hass,n.precipitation_entity);if(a){let r=Number(a.state);if(Number.isNaN(r))return null;let o=a.attributes.unit_of_measurement??"mm";return{key:e,value:`${R(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${R(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${R(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=f(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};_(nt,"css",`
  ...
  `);var Bt=class extends M{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[Kt({name:"weather",selector:v.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Kt({name:"sun",selector:v.entity("sun")},{name:"precipitation_entity",selector:v.entity("sensor")}),{name:"name",selector:v.text()},{name:"hide_below",selector:v.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",bare:"Zonder kaartrand",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};O("domotiapp-header-card-editor",Bt);j("domotiapp-header-card",nt,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var it=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
  ...
  `);var Gt=class extends M{defaults(){return{line:!0,tone:"accent"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:Ut.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:v.text()},{name:"line",selector:v.bool()},{name:"secondary_entity",selector:v.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};O("domotiapp-separator-card-editor",Gt);j("domotiapp-separator-card",it,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var qt=(i,e,t)=>Math.min(t,Math.max(e,i));function le(i,e){let t=e.min??0,n=e.max??100,a=e.step??1,r=!1,o=u=>{let $=i.getBoundingClientRect();if(!$.width)return t;let k=qt((u-$.left)/$.width,0,1),y=t+k*(n-t);return qt(Math.round(y/a)*a,t,n)},s=u=>{try{i.setPointerCapture?.(u)}catch{}},l=u=>{try{i.hasPointerCapture?.(u)&&i.releasePointerCapture(u)}catch{}},d=u=>{e.disabled?.()||u.button!=null&&u.button!==0||(r=!0,s(u.pointerId),i.classList.add("dragging"),e.onInput(o(u.clientX)),u.preventDefault())},c=u=>{r&&(e.onInput(o(u.clientX)),u.preventDefault())},h=u=>{r&&(r=!1,l(u.pointerId),i.classList.remove("dragging"),e.onCommit(o(u.clientX)))},m=u=>{r&&(r=!1,l(u?.pointerId),i.classList.remove("dragging"),e.onInput(e.value()))},x=u=>{if(e.disabled?.())return;let $=(n-t)/10,k={ArrowLeft:-a,ArrowDown:-a,ArrowRight:a,ArrowUp:a,PageDown:-$,PageUp:$,Home:-1/0,End:1/0};if(!(u.key in k))return;u.preventDefault();let y=e.value(),te=qt(k[u.key]===-1/0?t:k[u.key]===1/0?n:y+k[u.key],t,n);e.onInput(te),e.onCommit(te)};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",h),i.addEventListener("pointercancel",m),i.addEventListener("keydown",x),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",h),i.removeEventListener("pointercancel",m),i.removeEventListener("keydown",x)}}var J=(i="")=>`
...
`;var ir=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),ar=new Set(["hs","rgb","rgbw","rgbww","xy"]),Zt=i=>i?.attributes?.supported_color_modes??[],rr=i=>Zt(i).some(e=>ir.has(e)),at=i=>Zt(i).some(e=>ar.has(e)),rt=i=>Zt(i).includes("color_temp"),li=i=>Math.max(1,Math.round((i??0)/255*100)),ot=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[N]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var lt={row:44,tile:96,compact:44},Ce=6,mi=12,sr=["row","tile","compact"],lr=["card","items","none"],Oe=i=>typeof i=="string"?{entity:i}:{...i},Le=i=>Math.min(Math.max(1,Number(i)||2),3),we=i=>sr.includes(i)?i:"row",Z=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function gi(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(t=>({columns:Le(t.columns),layout:we(t.layout),items:(t.items??t.entities??[]).map(Oe)}));let e=(i?.items??i?.entities??[]).map(Oe);return e.length?[{columns:Le(i.columns),layout:we(i.layout),items:e}]:[]}function dt(i){return lr.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var dr=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns));function Qt(i){let e=i?.rows??[];if(!e.length)return mi+lt.row;let t=dt(i)==="card"?mi:0;for(let n of e){let a=dr(n);t+=a*lt[we(n.layout)]+(a-1)*Ce}return t+(e.length-1)*Ce}var bi=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],cr=i=>bi.find(e=>e.waarde===i)?.label??"Rij";function ct(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();Z(e)&&i.bewaard.push(e)}return i}function pr(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Le(n.columns),layout:we(n.layout),items:(n.items??n.entities??[]).map(Oe)})):(()=>{let n=(i.items??i.entities??[]).map(Oe);return n.length?[{columns:Le(i.columns),layout:we(i.layout),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]);for(let r of a)t.push(ct({columns:n.columns,layout:n.layout,items:r}))}return t}var fi=i=>i.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(Z).map(t=>structuredClone(t))})).filter(e=>e.items.length),hr=`
...
`,en=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=pr(e);this.gebouwd_&&JSON.stringify(fi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(r>e?`r${r-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{Z(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=hr;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=ct({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};n.surface==="items"||n.surface==="none"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(k=>({waarde:k,label:String(k),titel:`${k} entiteit${k>1?"en":""} in deze rij`})),()=>e.columns,k=>{e.columns=k,ct(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c);let h=document.createElement("div");h.className="rijbody";let m=this.segment_(bi.map(k=>({waarde:k.waarde,label:k.label})),()=>e.layout,k=>{e.layout=k,this.emit_()}),x=document.createElement("div");x.className="vormrij";let u=document.createElement("b");u.textContent="Vorm van deze rij",x.append(u,m.wrap),h.appendChild(x);let $=()=>{let k=e.items.filter(Z),y=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&y.push(cr(e.layout)),y.push(k.length?k.map(te=>this.itemNaam_(te)).join(", "):"nog leeg"),l.textContent=y.join(" \xB7 "),d.vernieuw(),m.vernieuw()};return this.koppen_.push($),e.items.forEach((k,y)=>h.appendChild(this.itemBlok_(e,k,t,y))),n.append(a,h),$(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),h=document.createElement("small");d.append(c,h);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),ct(e),this.emit_(),this.build_()}),o.append(s,l,d,m);let x=document.createElement("div");x.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",u.addEventListener("value-changed",E=>{E.stopPropagation(),t.entity=E.detail.value.entity??"",this.emit_()});let $=document.createElement("dac-icon-picker");$.label="Icoon",$.hass=this.hass_,$.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.icon=E.detail.value:delete t.icon,this.emit_()});let k=document.createElement("dac-tone-picker");k.label="Kleur",k.hass=this.hass_,k.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.tone=E.detail.value:delete t.tone,this.emit_()});let y=document.createElement("ha-form");y.hass=this.hass_,y.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],y.computeLabel=E=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[E.name]??E.name,y.computeHelper=E=>{if(E.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(E.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(E.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},y.addEventListener("value-changed",E=>{E.stopPropagation();let ne=E.detail.value;ne.name?t.name=ne.name:delete t.name,ne.toggle===!0?t.toggle=!0:delete t.toggle;for(let oe of["show_icon","show_name","show_state"])ne[oe]===!1?t[oe]=!1:delete t[oe];for(let oe of["icon_tap_action","icon_hold_action","tap_action","hold_action"])ne[oe]?t[oe]=ne[oe]:delete t[oe];ne.double_tap_action&&ne.double_tap_action.action!=="none"?t.double_tap_action=ne.double_tap_action:delete t.double_tap_action,this.emit_()});let te=()=>{c.textContent=Z(t)?this.itemNaam_(t):"Kies een entiteit",h.textContent=t.entity||(Z(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!Z(t)),m.hidden=!Z(t)};return this.koppen_.push(te),u.data={entity:t.entity||void 0},$.value=t.icon??"",k.value=t.tone??"",y.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},x.append(u,$,k,y),r.append(o,x),te(),r}emit_(){let e=fi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};D("domotiapp-entities-card-editor",en);var pt=class extends S{validate(e){let t=gi(e);return t.some(n=>n.items.some(Z))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[N]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?V(e.tone):this.config.tone?V(this.config.tone):ie(e.entity)!=="light"?C.accent:Qn(f(this.hass,e.entity))??C.lit}metSchakelaar_(e){return!!e.toggle&&ei(e.entity)}template(){let e=this.config;this.setAttribute("vlak",dt(e)),this.style.containerType="inline-size";let t=dt(e)==="items";return`<div class="card surface">${e.rows.map((a,r)=>{let o=e.state_position==="right"&&a.layout!=="tile",s=`<span class="st${o?" rechts":""}"></span>`,l=a.items.map((d,c)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${o?s:""}
            ${this.metSchakelaar_(d)?pi({label:"Aan of uit"}):""}
          </div>`).join("");return`
      <div class="row" data-vorm="${a.layout}"
           style="--cols:${a.columns};--it-h:${lt[a.layout]}px">${l}</div>`}).join("")}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>he(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(T(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");r&&(this.teardown_.push(T(r,{onTap:()=>n("icon_tap_action",Me(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation()));let o=e.querySelector(".toggle");o&&this.teardown_.push(hi(o,{value:()=>je(f(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>W(f(this.hass,t.entity))}))})}paint(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=f(this.hass,t.entity),a=je(n),r=!!t.entity&&W(n);e.dataset.on=String(a),e.classList.toggle("unavailable",r);let o=this.tone_(t);e.style.setProperty("--tone",o);let s=L(this.hass,t.entity,t.name),l=e.querySelector(".chip");if(l){let x=et(this.hass,t.entity,t.icon),u=t.icon||(x?`pic:${x}`:Pt(t.entity,P(this.hass,t.entity)));l.dataset.icon!==u&&(l.dataset.icon=u,l.classList.toggle("pic",!!x),l.innerHTML=x?`<img src="${x}" alt="" loading="lazy" />`:w(t.icon||Pt(t.entity,P(this.hass,t.entity)))),l.style.setProperty("--tone",x?"var(--dac-ink-3)":a?o:"var(--dac-ink-3)"),l.setAttribute("aria-label",t.entity?`${s} schakelen`:"Icoon")}let d=e.querySelector(".nm");d&&this.text(d,s);let c=e.querySelector(".toggle");c&&(Jt(c,a),c.style.setProperty("--tone",o),c.setAttribute("aria-label",`${s} aan of uit`));let h=e.querySelector(".st"),m=t.show_state??this.config.show_state;if(c)h.textContent="";else if(m===!1)h.textContent="";else if(r)h.textContent="Niet bereikbaar";else if(!n||Ot(n.entity_id))h.textContent="";else if(ie(n.entity_id)==="light"&&a&&n.attributes.brightness!=null)h.textContent=`${Math.round(n.attributes.brightness/255*100)}%`;else{let x=n.attributes.unit_of_measurement;h.textContent=x?`${n.state} ${x}`:G(this.hass,n)}e.setAttribute("aria-label",`${s}${n?`, ${G(this.hass,n)}`:""}`)})}getCardSize(){return F(Qt(this.config))}getGridOptions(){let e=F(Qt(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};_(pt,"css",`
    :host { display: block; height: 100%; }

    .card {
      height: 100%; min-height: 56px; padding: 5px 10px;
      display: flex; flex-direction: column; justify-content: center; gap: ${Ce}px;
    }
  ...
  `);j("domotiapp-entities-card",pt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var I={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},K=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),tn=i=>!i||i.state==="off",vi=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),nn=i=>i?.state==="playing",_i=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function xi(i){if(!i)return[];let e=[];return(K(i,I.TURN_ON)||K(i,I.TURN_OFF))&&e.push("power"),tn(i)||(K(i,I.PREVIOUS_TRACK)&&e.push("prev"),K(i,I.PLAY)||K(i,I.PAUSE)||K(i,I.PLAY_MEDIA)?e.push("play"):K(i,I.STOP)&&e.push("stop"),K(i,I.NEXT_TRACK)&&e.push("next")),e}var ue=i=>i?.volume_entity||i?.entity;function an(i){if(!vi(i))return[];let e=[];return K(i,I.VOLUME_MUTE)&&e.push("mute"),K(i,I.VOLUME_SET)?e.push("slider"):K(i,I.VOLUME_STEP)&&e.push("steps"),e}var ce=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),De=i=>!!i?.attributes?.is_volume_muted,ur=i=>!!i?.attributes?.mass_player_type,rn=i=>!!i?.attributes?.shuffle,on=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},ki=i=>({off:"all",all:"one",one:"off"})[mr(i)]??"all",mr=i=>["off","all","one"].includes(i)?i:"off";function sn(i,{zoeken:e=!0}={}){if(!vi(i))return[];let t=[];return K(i,I.SHUFFLE_SET)&&t.push("shuffle"),K(i,I.REPEAT_SET)&&t.push("repeat"),e&&ur(i)&&t.push("search"),t}function wi(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function ln(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var gr=350,fr=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]],br={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function vr(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=br[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var _r=`
  :host {
    ${Y}
...
`,dn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=se(xe+_r)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n){this.hass=e,this.entity_=t,this.naam_=n,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=a=>{a.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.haalSpeakers_(),setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0)}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${fr.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
  ...
  `);var cn=class extends M{defaults(){return{layout:"row",show_artwork:!0,show_volume:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"entity",selector:v.entity("media_player")},{name:"name",selector:v.text()},{name:"layout",selector:v.select([{value:"row",label:"Rij (\xE9\xE9n rasterrij hoog)"},{value:"groot",label:"Groot (telefoonformaat, grote knoppen)"}])},{name:"volume_entity",selector:v.entity("media_player")},{name:"show_artwork",selector:v.bool()},{name:"show_controls",selector:v.bool()},{name:"show_volume",selector:v.bool()},{name:"show_search",selector:v.bool()},{name:"icon_tap_action",selector:v.action("toggle")},{name:"icon_hold_action",selector:v.action("more-info")},{name:"tap_action",selector:v.action("more-info")},{name:"hold_action",selector:v.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",layout:"Vorm",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_search:"Zoeken en groeperen tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="layout")return"Groot is bedoeld voor een pop-up of een kolom waar de kaart alle ruimte krijgt: grote hoes, grote knoppen.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};O("domotiapp-media-card-editor",cn);j("domotiapp-media-card",ut,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var Pe=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd"},{sleutel:"co",label:"Koolmonoxide",icoon:"warning",alarm:"Koolmonoxide gedetecteerd"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],pn=20;function hn(i){if(!i||i.state==="unavailable"||i.state==="unknown")return null;if(String(i.entity_id??"").startsWith("binary_sensor."))return i.state==="on"?0:null;let e=Number(i.state);return Number.isFinite(e)?e:null}var xr=i=>!!i&&i.state==="on",kr=i=>!i||i.state==="unavailable"||i.state==="unknown";function $i(i,e){let t=i.filter(a=>!a.meting);for(let a of t)if(xr(e(a.sleutel)))return{soort:"alarm",tekst:a.alarm,tone:"bad",icoon:a.icoon};if(i.length&&i.every(a=>kr(e(a.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smoke"};let n=hn(e("battery"));return n!=null&&n<=pn?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smoke"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smoke"}}var wr={good:C.good,warn:C.warn,bad:C.bad,neutral:C.neutral,accent:C.accent},mt=class extends S{validate(e){return Pe.filter(n=>e[n.sleutel]).length?{...e}:{...e,[N]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return Pe.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return Pe.filter(e=>this.config[e.sleutel])}toestand_(){let e=$i(this.gekozen_(),t=>f(this.hass,this.config[t]));return{...e,tone:wr[e.tone]??C.accent}}batterijPct_(){return hn(f(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare","");let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}">${w(t.icoon)}
      ...
      </div>`}wire(){let e=this.config,t=this.gekozen_()[0];this.teardown_.push(T(this.$(".top"),{onTap:()=>e.tap_action?he(this,this.hass,e,e.tap_action):U(this,e.smoke??e[t.sleutel]),onHold:()=>he(this,this.hass,e,e.hold_action??{action:"more-info"})})),this.$$(".pil").forEach(n=>{let a=e[n.dataset.soort];a&&(this.on(n,"click",r=>{r.stopPropagation(),U(this,a)}),this.on(n,"pointerdown",r=>r.stopPropagation()),n.style.cursor="pointer")})}paint(){let e=this.config,t=this.toestand_(),n=this.$(".top");this.toggleAttribute("alarm",t.soort==="alarm"),n.style.setProperty("--tone",t.tone),n.classList.toggle("unavailable",t.soort==="weg");let a=this.$(".chip"),r=e.icon||t.icoon;a.dataset.icon!==r&&(a.dataset.icon=r,a.innerHTML=w(r,"smoke")),a.style.setProperty("--tone",t.tone);let o=this.gekozen_()[0];this.text(".nm",e.name||L(this.hass,e.smoke??e[o.sleutel],null)),this.text(".st",t.tekst),n.setAttribute("aria-label",`${this.$(".nm").textContent}${t.tekst?`, ${t.tekst}`:""}`),this.$$(".pil").forEach(s=>this.paintPil_(s)),this.$(".meta").hidden=this.gekozen_().length<=1&&!this.config.always_meta}paintPil_(e){let t=Pe.find(o=>o.sleutel===e.dataset.soort),n=f(this.hass,this.config[t.sleutel]),a=e.querySelector("b");if(!n||W(n)){a.textContent="\u2014",e.dataset.let="";return}if(t.meting){let o=n.attributes.unit_of_measurement??"",s=Number(n.state);a.textContent=Number.isFinite(s)?`${R(this.hass,s,t.sleutel==="temperature"?1:0)} ${o}`.trim():G(this.hass,n);let l=t.sleutel==="battery"?this.batterijPct_():null;e.dataset.let=l!=null&&l<=pn?"warn":"";return}let r=je(n);a.textContent=r?"Alarm":"Rustig",e.dataset.let=r?"bad":""}regels_(){return this.gekozen_().length>1?2:1}getCardSize(){return this.regels_()}getGridOptions(){let e=this.regels_()===1?1:F(90);return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-smoke-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("binary_sensor.")&&/rook|smoke/i.test(a));return n?{smoke:n}:{}}};_(mt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var un=class extends M{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"smoke"}]}schema(){return[{name:"name",selector:v.text()},{name:"smoke",selector:v.entity()},{name:"co",selector:v.entity()},{name:"heat",selector:v.entity()},{name:"temperature",selector:v.entity()},{name:"battery",selector:v.entity()},{name:"tap_action",selector:v.action("more-info")},{name:"hold_action",selector:v.action("more-info")}]}label(e){return{name:"Naam (overschrijft die van de melder)",smoke:"Rook",co:"Koolmonoxide",heat:"Warmte",temperature:"Temperatuur",battery:"Batterij",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="smoke")return"Alle vijf zijn optioneel: vul in wat je melder heeft. Wat je leeg laat, komt niet op de kaart.";if(e.name==="battery")return"Een percentage of een 'batterij bijna leeg'-sensor. Onder de 20% meldt de kaart het uit zichzelf."}};O("domotiapp-smoke-card-editor",un);j("domotiapp-smoke-card",mt,{name:"DomotiApp Rookmelder",description:"Rook, koolmonoxide, warmte, temperatuur en batterij \u2014 alles optioneel."});var yr=["zo","ma","di","wo","do","vr","za"],Ei=5,Si=8,gt=class extends S{validate(e){if(!e.entity)return{...e,[N]:"Kies een weerentiteit."};let t=Math.min(Math.max(1,Number(e.days)||Ei),Si);return{show_current:!0,forecast_type:"daily",...e,days:t}}watched(){return[this.config.entity]}template(){this.config.bare&&this.setAttribute("bare","");let e=this.config;return`
      ...
      </div>`}wire(){this.teardown_.push(T(this.$(".nu"),{onTap:()=>U(this,this.config.entity),onHold:()=>U(this,this.config.entity)})),this.abonneer_()}async abonneer_(){let e=this.config;this.opzeggen_?.(),this.opzeggen_=null;let t=this.hass?.connection;if(!t?.subscribeMessage){this.forecastFout_="Geen verbinding voor de voorspelling.",this.paintRij_();return}try{let n=await t.subscribeMessage(a=>{this.forecast_=a?.forecast??[],this.forecastFout_=null,this.paintRij_()},{type:"weather/subscribe_forecast",forecast_type:e.forecast_type==="hourly"?"hourly":"daily",entity_id:e.entity});if(!this.isConnected){n();return}this.opzeggen_=n,this.teardown_.push(()=>{try{n()}catch{}this.opzeggen_=null})}catch{this.forecastFout_=e.forecast_type==="hourly"?"Deze weerbron geeft geen uurvoorspelling.":"Deze weerbron geeft geen dagvoorspelling.",this.paintRij_()}}paint(){let e=this.config,t=f(this.hass,e.entity),n=W(t);this.$(".nu").classList.toggle("unavailable",n);let r=this.$(".chip"),o=e.icon||Ne(t?.state);r.dataset.icon!==o&&(r.dataset.icon=o,r.innerHTML=w(o,"cloud")),this.text(".nm",L(this.hass,e.entity,e.name)),this.text(".st",n?"Niet bereikbaar":G(this.hass,t));let s=this.$(".graden"),l=t?.attributes?.temperature,d=t?.attributes?.temperature_unit??"\xB0C";s.innerHTML=l==null?"":`${R(this.hass,l,Number.isInteger(l)?0:1)}<small>${d}</small>`,this.paintRij_()}paintRij_(){let e=this.$(".rij");if(!e)return;let t=this.config;if(this.forecastFout_&&!this.forecast_?.length){e.style.setProperty("--n",1),e.innerHTML=`<div class="leeg">${this.forecastFout_}</div>`;return}let n=(this.forecast_??[]).slice(0,t.days);if(!n.length){e.style.setProperty("--n",1),e.innerHTML='<div class="leeg">Nog geen voorspelling ontvangen\u2026</div>';return}e.style.setProperty("--n",n.length);let a=f(this.hass,t.entity)?.attributes?.temperature_unit??"";e.innerHTML=n.map((r,o)=>{let s=this.wanneer_(r.datetime,o),l=w(Ne(r.condition),"cloud"),d=r.temperature==null?"":`${R(this.hass,r.temperature,0)}\xB0`,c=r.templow==null?"":`${R(this.hass,r.templow,0)}\xB0`,h=r.precipitation_probability==null?"":`<span class="nat">${w("drop")}${Math.round(r.precipitation_probability)}%</span>`;return`
  ...
  `);var mn=class extends M{defaults(){return{show_current:!0,forecast_type:"daily",days:Ei}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:v.entity("weather")},{name:"name",selector:v.text()},{name:"forecast_type",selector:v.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:v.number(1,Si)},{name:"show_current",selector:v.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};O("domotiapp-forecast-card-editor",mn);j("domotiapp-forecast-card",gt,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var Re={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},He=(i,e)=>!!((i?.attributes?.supported_features??0)&e),$r=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},ft=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[N]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(T(e.querySelector(".chip"),{onTap:()=>U(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=f(this.hass,n.entity),r=P(this.hass,n.entity),o=!a||a.state==="unavailable",s=a?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=L(this.hass,n.entity,n.name);let l=He(a,Re.SET_POSITION)&&r.current_position!=null,d=l?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=$r(r),h=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],m=e.querySelector(".chip");m.dataset.icon!==h&&(m.dataset.icon=h,m.innerHTML=w(h,c[d]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":l?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(k=>{if(k.dataset.act==="stop"){k.disabled=o||!He(a,Re.STOP);return}let y=k.dataset.act==="open";k.disabled=o||(y?!He(a,Re.OPEN):!He(a,Re.CLOSE))});let u=e.querySelector(".pos"),$=l&&this.config.show_position!==!1;if(u.hidden=!$,$){if(u.dataset.built||(u.dataset.built="1",u.innerHTML=J("position"),u.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let y=u.querySelector(".slider"),te=E=>{y.style.setProperty("--v",`${E}%`),y.setAttribute("aria-valuenow",String(E)),e.querySelector(".st").textContent=`${E}% open`};this.teardown_.push(le(y,{value:()=>P(this.hass,n.entity).current_position??0,onInput:te,onCommit:E=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:E})}))}let k=u.querySelector(".slider");if(!k.classList.contains("dragging")){let y=r.current_position??0;k.style.setProperty("--v",`${y}%`),k.setAttribute("aria-valuenow",String(y))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>He(f(this.hass,n.entity),Re.SET_POSITION));return F(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};_(ft,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var gn=class extends M{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:v.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};O("domotiapp-cover-card-editor",gn);j("domotiapp-cover-card",ft,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Er(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var bt=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[N]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(T(e,{onTap:()=>U(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=f(this.hass,t.entity),a=Er(n);e.style.setProperty("--tone",a.home===!0?"var(--dac-good)":a.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=L(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,l=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():z.person),e.setAttribute("aria-label",`${r}, ${a.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return F(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};_(bt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var bn=class extends M{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${zi(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};O("domotiapp-waste-card-editor",bn);j("domotiapp-waste-card",vt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var _t=globalThis,xt=_t.ShadowRoot&&(_t.ShadyCSS===void 0||_t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,vn=Symbol(),Ai=new WeakMap,Ve=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==vn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(xt&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Ai.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Ai.set(t,e))}return e}toString(){return this.cssText}},ae=i=>new Ve(typeof i=="string"?i:i+"",void 0,vn),B=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new Ve(t,i,vn)},ji=(i,e)=>{if(xt)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=_t.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},_n=xt?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return ae(t)})(i):i;var{is:Ar,defineProperty:jr,getOwnPropertyDescriptor:Mr,getOwnPropertyNames:Tr,getOwnPropertySymbols:Nr,getPrototypeOf:Cr}=Object,kt=globalThis,Mi=kt.trustedTypes,Or=Mi?Mi.emptyScript:"",Lr=kt.reactiveElementPolyfillSupport,Ie=(i,e)=>i,xn={toAttribute(i,e){switch(e){case Boolean:i=i?Or:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Ni=(i,e)=>!Ar(i,e),Ti={attribute:!0,type:String,converter:xn,reflect:!1,useDefault:!1,hasChanged:Ni};Symbol.metadata??=Symbol("metadata"),kt.litPropertyMetadata??=new WeakMap;var re=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ti){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&jr(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=Mr(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ti}static _$Ei(){if(this.hasOwnProperty(Ie("elementProperties")))return;let e=Cr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Ie("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ie("properties"))){let t=this.properties,n=[...Tr(t),...Nr(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(_n(a))}else e!==void 0&&t.push(_n(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ji(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:xn).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:xn;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Ni)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};re.elementStyles=[],re.shadowRootOptions={mode:"open"},re[Ie("elementProperties")]=new Map,re[Ie("finalized")]=new Map,Lr?.({ReactiveElement:re}),(kt.reactiveElementVersions??=[]).push("2.1.2");var zn=globalThis,Ci=i=>i,wt=zn.trustedTypes,Oi=wt?wt.createPolicy("lit-html",{createHTML:i=>i}):void 0,Vi="$lit$",pe=`lit$${Math.random().toFixed(9).slice(2)}$`,Ii="?"+pe,Dr=`<${Ii}>`,fe=document,Ue=()=>fe.createComment(""),We=i=>i===null||typeof i!="object"&&typeof i!="function",An=Array.isArray,Pr=i=>An(i)||typeof i?.[Symbol.iterator]=="function",kn=`[ 	
\f\r]`,Ke=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Li=/-->/g,Di=/>/g,me=RegExp(`>|${kn}(?:([^\\s"'>=/]+)(${kn}*=${kn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Pi=/'/g,Ri=/"/g,Ki=/^(?:script|style|textarea|title)$/i,jn=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),g=jn(1),Ol=jn(2),Ll=jn(3),be=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Hi=new WeakMap,ge=fe.createTreeWalker(fe,129);function Ui(i,e){if(!An(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Oi!==void 0?Oi.createHTML(e):e}var Rr=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=Ke;for(let s=0;s<t;s++){let l=i[s],d,c,h=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Ke?c[1]==="!--"?o=Li:c[1]!==void 0?o=Di:c[2]!==void 0?(Ki.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=me):c[3]!==void 0&&(o=me):o===me?c[0]===">"?(o=a??Ke,h=-1):c[1]===void 0?h=-2:(h=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?me:c[3]==='"'?Ri:Pi):o===Ri||o===Pi?o=me:o===Li||o===Di?o=Ke:(o=me,a=void 0);let x=o===me&&i[s+1].startsWith("/>")?" ":"";r+=o===Ke?l+Dr:h>=0?(n.push(d),l.slice(0,h)+Vi+l.slice(h)+pe+x):l+pe+(h===-2?s:x)}return[Ui(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Be=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=Rr(e,t);if(this.el=i.createElement(d,n),ge.currentNode=this.el.content,t===2||t===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(a=ge.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let h of a.getAttributeNames())if(h.endsWith(Vi)){let m=c[o++],x=a.getAttribute(h).split(pe),u=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:u[2],strings:x,ctor:u[1]==="."?yn:u[1]==="?"?$n:u[1]==="@"?En:$e}),a.removeAttribute(h)}else h.startsWith(pe)&&(l.push({type:6,index:r}),a.removeAttribute(h));if(Ki.test(a.tagName)){let h=a.textContent.split(pe),m=h.length-1;if(m>0){a.textContent=wt?wt.emptyScript:"";for(let x=0;x<m;x++)a.append(h[x],Ue()),ge.nextNode(),l.push({type:2,index:++r});a.append(h[m],Ue())}}}else if(a.nodeType===8)if(a.data===Ii)l.push({type:2,index:r});else{let h=-1;for(;(h=a.data.indexOf(pe,h+1))!==-1;)l.push({type:7,index:r}),h+=pe.length-1}r++}}static createElement(e,t){let n=fe.createElement("template");return n.innerHTML=e,n}};function ye(i,e,t=i,n){if(e===be)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=We(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=ye(i,a._$AS(i,e.values),a,n)),e}var wn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??fe).importNode(t,!0);ge.currentNode=a;let r=ge.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Ge(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Sn(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=ge.nextNode(),o++)}return ge.currentNode=fe,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Ge=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ye(this,e,t),We(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==be&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Pr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&We(this._$AH)?this._$AA.nextSibling.data=e:this.T(fe.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Be.createElement(Ui(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new wn(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Hi.get(e.strings);return t===void 0&&Hi.set(e.strings,t=new Be(e)),t}k(e){An(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(Ue()),this.O(Ue()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Ci(e).nextSibling;Ci(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},$e=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=b}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=ye(this,e,t,0),o=!We(e)||e!==this._$AH&&e!==be,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=ye(this,s[n+l],t,l),d===be&&(d=this._$AH[l]),o||=!We(d)||d!==this._$AH[l],d===b?e=b:e!==b&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},yn=class extends $e{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},$n=class extends $e{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},En=class extends $e{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=ye(this,e,t,0)??b)===be)return;let n=this._$AH,a=e===b&&n!==b||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==b&&(n===b||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Sn=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ye(this,e)}};var Hr=zn.litHtmlPolyfillSupport;Hr?.(Be,Ge),(zn.litHtmlVersions??=[]).push("3.3.3");var Wi=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new Ge(e.insertBefore(Ue(),r),r,void 0,t??{})}return a._$AI(i),a};var Mn=globalThis,H=class extends re{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Wi(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return be}};H._$litElement$=!0,H.finalized=!0,Mn.litElementHydrateSupport?.({LitElement:H});var Vr=Mn.litElementPolyfillSupport;Vr?.({LitElement:H});(Mn.litElementVersions??=[]).push("4.2.2");var X=B`
  :host {
    ${ae(Y)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${ae(xe)}
`;var Ir=["unavailable","unknown"],Kr=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function yt({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||Ir.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let h={entity_id:l,transition:1};typeof d.brightness=="number"&&(h.brightness=d.brightness);for(let m of Kr)if(d[m]!==void 0){h[m]=d[m];break}n.push({service:"turn_on",data:h})}return{oproepen:n,overgeslagen:a}}async function $t(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var Nn=["hs","rgb","rgbw","rgbww","xy"],Cn="color_temp",Ur="onoff";var ve="kleur";var Wr=["unavailable","unknown"],Gi=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Br=[0,100];function Q(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Ur,a=t!==null&&t.includes(Cn),r=t!==null&&t.some(d=>Nn.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Wr.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function Gr(){return{state:"off"}}function qi(i,e){let t=e??Q(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...Jr(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function Fi(i,e,t,n){return e?i&&i.state==="on"?{...i}:qi(t,n):{state:"off"}}function Zi(i,e,t,n){let a=n??Q(t),r=Hn(i,t,a);return a.helderheid&&(r.brightness=A(e,1,255)),r}function On(i,e,t,n){let a=n??Q(t),r=Hn(i,t,a);return ra(r),r.color_temp_kelvin=A(e,a.minKelvin,a.maxKelvin),r}function Ln(i,e,t,n){let a=n??Q(t),r=Hn(i,t,a);return ra(r),r.hs_color=[A(e?.[0],0,360),A(e?.[1],0,100)],r}function Et(i,e,t){return i??Gr()}function Xi(i,e,t){let n=Et(i,e,t);if(typeof n.brightness=="number")return A(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?A(a,1,255):255}function Dn(i,e,t){let n=t??Q(e),a=Et(i,e,n);if(typeof a.color_temp_kelvin=="number")return A(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?A(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function St(i,e,t){let n=Et(i,e,t);if(Tn(n.hs_color))return[A(n.hs_color[0],0,360),A(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Tn(a)?[A(a[0],0,360),A(a[1],0,100)]:[...Br]}function Pn(i){return i!=null&&typeof i=="object"}function Yi(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Pn(a[s]?.lights?.[o]))return!0;return!1})}function Ji(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Rn(i,e,t){return Et(i,e,t).state==="on"}function Qi(i,e,t){let n=t??Q(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Rn(i,e,n),r=ea(n),o=r?qr(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===ve),kleurkeuze:a&&r,stand:a?o:null}}function ea(i){return!!(i?.kleurtemp&&i?.kleur)}function qr(i,e,t){let n=t??Q(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(Gi.slice(1).some(r=>i[r]!==void 0))return ve}let a=e?.attributes?.color_mode;return a===Cn&&n.kleurtemp?"wit":Nn.includes(a)&&n.kleur?ve:"wit"}function ta(i,e,t,n){let a=n??Q(t);return ea(a)?e==="wit"?On(i,Dn(i,t,a),t,a):Ln(i,St(i,t,a),t,a):i}function na(i){let e=A(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function ia(i){let e=A(i,1,100);return A(Math.round(e/100*255),1,255)}var Fr=1e3,Zr=4e4,Bi=7;function Xr(i){let e=A(i,Fr,Zr)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[A(t,0,255),A(n,0,255),A(a,0,255)]}function Yr(i){let[e,t,n]=Xr(i);return`rgb(${e}, ${t}, ${n})`}function aa(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:Bi},(r,o)=>{let s=o/(Bi-1),l=t+(n-t)*s;return`${Yr(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Jr(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?A(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===Cn&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=A(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Nn.includes(a)&&Tn(t.hs_color)&&(n.hs_color=[A(t.hs_color[0],0,360),A(t.hs_color[1],0,100)]),n}function Hn(i,e,t){return i&&i.state==="on"?{...i}:qi(e,t)}function ra(i){for(let e of Gi)delete i[e]}function Tn(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function A(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var zt="domotiapp-scene-card",Vn="domotiapp-scene-card-editor",oa="domotiapp-scene-editor";var qe=["een","twee","drie"],sa="pencil",la=["grid_options","layout_options","view_layout","visibility"];var da="entity_id",Ee=class extends H{constructor(){super();_(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));_(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[da]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[da];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return b;let t=this._leden();return g`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?g`
          ...
          `:b}
    `}};_(Ee,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),_(Ee,"styles",[X,B`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===Kn?g`<div class="inhoud">Bezig met laden…</div>`:this._toestand===pa?g`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=Rn(a,t,n),o=Qi(a,t,n);return g`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
          ...
          ${n.bekend?g`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,Fi(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:b}
        </div>
    ...
    `}_renderHelderheid(e,t,n,a){let r=na(Xi(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,Zi(this._waardeVan(e),ia(s.detail.value),t,n))};return g`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurtemp(e,t,n,a){let r=Dn(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,On(this._waardeVan(e),s.detail.value,t,n))};return g`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${aa(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=St(a,t,n),s=l=>d=>{d.stopPropagation();let c=St(this._waardeVan(e),t,n),h=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Ln(this._waardeVan(e),h,t,n))};return g`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${io}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};_(Se,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),_(Se,"styles",[X,B`
    ...
    `]);var ao="0.6.0",ro=["type","entity","name_overrides"],Wn="laden",Fe="klaar",Bn="leeg",Gn="geen-groep",ha="opslagfout",ua="fout",Ze=class extends H{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=Wn,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(Vn)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!ro.includes(n)&&!la.includes(n));t.length&&console.warn(`${zt}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===Gn){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=Wn,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?Bn:Fe}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=ha;return}if(!this.hass.states[t]){this._toestand=Gn;return}this._toestand=ua}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==Fe)return;let{oproepen:t}=yt({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await $t((a,r)=>this.hass.callService("light",a,r),t);n.length&&this._meldMislukking(n.map(a=>a.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(a=>this._naam(a)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===Fe&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Bn:Fe}render(){if(!this._config)return b;switch(this._toestand){case Gn:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case ha:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case ua:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return g`
      <div class="needs">
    ...
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=w(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===Bn,t=this._toestand===Wn,n=this._iconen();return g`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((a,r)=>g`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Fe)return b;let e=Yi(this._scenes,this._leden,3).length,t=Ji(e);return t?g`<div class="mededeling">${t}</div>`:b}_renderEditor(){return g`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||qe[t])}};_(Ze,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),_(Ze,"styles",[X,B`
      :host { display: block; }
    ...
    `]);D(zt,Ze);D(Vn,Ee);D(oa,Se);ke({type:zt,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${ao}).`,preview:!1});var _e="domotiapp-alarm-card",qn="domotiapp-alarm-card-editor",ma="domotiapp-alarm-editor",ga="DomotiApp Wekker",fa="https://github.com/Sven2410/domotiapp-lovelace",ee="domotiapp_lovelace",q=Object.freeze({get:`${ee}/alarms/get`,save:`${ee}/alarms/save`,setEnabled:`${ee}/alarms/set_enabled`,delete:`${ee}/alarms/delete`,stop:`${ee}/alarms/stop`,clearMessage:`${ee}/alarms/clear_message`,search:`${ee}/sound/search`,entities:`${ee}/entities/list`,previewStart:`${ee}/preview/start`,subscribe:`${ee}/updates/subscribe`}),Mt="#026FA1";function ba(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var oo="07:00";var so=["uri","name","media_type","image"],lo="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",co="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var po="Music Assistant Wekker",ho="Verlichting Wekker";function Tt(){return{id:null,name:"",time:oo,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function va(i){let e=Tt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:Fn(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:Xe(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function Xe(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of so)e[t]=i[t]===void 0?null:i[t];return e}function Fn(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Zn(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),Fn(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function _a(i){let e={name:(i.name||"").trim(),time:i.time,days:[...new Set(i.days||[])].sort((t,n)=>t-n),enabled:i.enabled!==!1,sound:Xe(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(e.id=i.id),e}function xa(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function ka(i){return Fn(i)&&i.slice(0,2)==="02"?lo:null}function wa(i){return i===!1?co:null}function ya(i){return typeof i?.endless=="boolean"?i.endless:null}function Nt(i,e){let t=e==="lamp",n=t?ho:po,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function $a(i,e){return Nt(e,"speaker")!==null?!1:Zn(i).ok}var mo=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],go=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Ye="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",fo="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",bo="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",ze=class extends H{constructor(){super(),this._concept=Tt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?va(this.wekker):Tt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:q.previewStart,speaker:this._concept.speaker,sound:Xe(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:q.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Xe(e),endless:ya(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Zn(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:q.save,person:this.person,alarm:_a(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return g`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return b;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Nt(t,"speaker"),r=Nt(n,"lamp"),o=ka(e.time),s=wa(e.endless),l=$a(e,t);return g`
      <div class="kop">
      ...
      <div class="blok">
        ...
        ${a?g`<div class="uitleg">${this._svg(Ye)}<span>${a}</span></div>`:g`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${go.map(([d,c])=>g`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${s?g`<div class="waarschuwing">${this._svg(Ye)}<span>${s}</span></div>`:b}
      </div>
      ...
      <div class="blok">
        ...
        ${r?g`<div class="uitleg">${this._svg(Ye)}<span>${r}</span></div>`:g`
              <div class="vak">
                <select
                  id="lamp"
      ...
      ${this._melding?g`<div class="blok">
            <div class="waarschuwing ${this._melding.fout?"fout":""}">
              ${this._svg(Ye)}<span>${this._melding.tekst}</span>
            </div>
          </div>`:b}
    ...
    `}};_(ze,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),_(ze,"styles",[X,B`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${ae(Mt)});
      display: block;
  ...
  `]);var Ea="person",vo="Kies een persoon in de kaartinstellingen.",Sa="De gekozen persoon is niet gevonden.",_o="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Cd=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function za(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Ea}.`))throw new Error(`'${e}' zit niet in het domein ${Ea}. Kies een persoon, zoals person.sven.`);return{...i}}function Aa(i){return{type:`custom:${i}`}}function ja(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Sa,isFout:!0}:{soort:"ontbreekt",tekst:vo,isFout:!1}}function Ma(i,e){return i==="not_found"?Sa:i==="home_assistant_error"?_o:e||"Er ging iets mis bij het ophalen van de wekkers."}var xo=["ma","di","wo","do","vr","za","zo"],ko="Geen wekkers ingesteld",wo="Eenmalig",yo="Eenmalig \u2014 afgelopen",$o="Geen wekker actief",Ta="Stoppen",Eo="Er is een melding over deze wekker, maar de tekst ontbreekt.";function So(i){return!Array.isArray(i)||i.length===0?wo:[...new Set(i)].sort((t,n)=>t-n).map(t=>xo[t-1]??"?").join(" ")}function zo(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function Na(i,e){return zo(i,e)?yo:So(i?.days)}function Ca(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Eo,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function Oa(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return ko;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:$o}function La(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var Ao="0.6.0",jo="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Mo="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",Da="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",To="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Ct=(i,e="icoon")=>g`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,Je=class extends H{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=za(e),n=t.person!==this._config?.person;this._config=t,n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(qn)}static getStubConfig(){return Aa(_e)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement()}updated(e){e.has("hass")&&this.hass&&this._startAbonnement()}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:q.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${_e}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${_e}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:q.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=Ma(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:q.entities})}catch(t){this._entiteiten=null,console.warn(`${_e}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:q.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:q.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:q.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:q.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?La(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return b;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=ja(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?g`<div class="card surface">
    ...
    `}_bevestiging(e){return g`<div class="onderrij bevestiging">
      <span class="boodschap">${ba(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=Ca(e),a=!!e.enabled;return g`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?g`<div class="onderrij ${n.isFout?"fout":""}">
            ${Ct(n.isFout?To:Da,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:b}
    `}};_(Je,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),_(Je,"styles",[X,B`
  ...
  `]);var Ae=class Ae extends H{constructor(){super(...arguments);_(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?b:g`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};_(Ae,"properties",{hass:{attribute:!1},_config:{state:!0}}),_(Ae,"styles",[X,B`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),_(Ae,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var Xn=Ae;D(_e,Je);D(qn,Xn);D(ma,ze);ke({type:_e,name:ga,description:`Wekkerkaart van DomotiApp (v${Ao}).`,preview:!1,documentationURL:fa});var No="0.6.0";oi(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${No} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{No as VERSION};
