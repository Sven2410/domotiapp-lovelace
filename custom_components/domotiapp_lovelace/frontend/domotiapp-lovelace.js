var fp=Object.defineProperty;var bp=(i,e,t)=>e in i?fp(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var j=(i,e,t)=>bp(i,typeof e!="symbol"?e+"":e,t);var W=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function q(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var Ka=null,Uo=i=>{Ka=i},$e=i=>String(i??"").split(".")[0],v=(i,e)=>e&&i?.states?.[e]||null,Z=(i,e)=>v(i,e)?.attributes??{},bn=(i,e,t)=>t?null:Z(i,e).entity_picture||null;function Fo(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function M(i,e,t){return t||Z(i,e).friendly_name||e||""}var vp=new Set(["scene","script","input_button","button","event"]),Ga=i=>vp.has($e(i));function ne(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Ga(i.entity_id):!1}function Y(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch($e(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var kp=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),qo=i=>kp.has($e(i));function Zo(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function fn(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var P=(i,e)=>fn(i,"hass-more-info",{entityId:e});function Lt(i){switch($e(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function xp(i){switch($e(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function Ee(i,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let a=n.confirmation===!0?{}:n.confirmation;if(!Ka){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}Ka(a).then(r=>{r&&Ko(i,e,t,n)});return}Ko(i,e,t,n)}}function Ko(i,e,t,n){switch(n.action){case"more-info":P(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=xp(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),fn(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":fn(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":fn(i,"ll-custom",n);break;default:break}}function U(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function ee(i,e){if(!e)return"";let t=$e(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function K(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Go=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Xo=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Wo=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),vn=(i,e)=>Math.round((Wo(e)-Wo(i))/864e5);function ht(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/(?:^|\D)(\d{1,2})[-./](\d{1,2})[-./](\d{4})(?!\d)/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/(?:^|\D)(\d{4})-(\d{1,2})-(\d{1,2})(?!\d)/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function kn(i,e=new Date){if(!i)return"";let t=vn(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Go[i.getDay()]:`${Go[i.getDay()].slice(0,2)} ${i.getDate()} ${Xo[i.getMonth()]}`}var Yo=i=>i?`${i.getDate()} ${Xo[i.getMonth()]}`:"";function wp(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function _p(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function D(i,e=4){if(!i)return;let t=_p(i);if(!t){e>0&&requestAnimationFrame(()=>D(i,e-1));return}let n=`${zp(i,wp(t))}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}var Wa=new WeakMap,yp=12,jp=3;function zp(i,e){let t=Wa.get(i)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-yp),a=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(a.length===2&&r>=jp){let s=Math.max(...a);return Wa.set(i,{rij:n,vast:{paar:a,waarde:s}}),s}return Wa.set(i,{rij:n,vast:null}),e}function ut(i){let e=parseFloat(i?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function V(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);D(i)});e.observe(i);for(let t of i.children)e.observe(t);return D(i),()=>e.disconnect()}var $p="home-assistant";function Qo({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=$p,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let h=i();if(!h)return!1;for(let[m,g]of e)try{h.get(m)||h.define(m,g)}catch(k){t(`kon ${m} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=i();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var Jo=[];function C(i,e){Jo.push([i,e])}function mt({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function es(i=()=>{}){Qo({leesRegistry:()=>globalThis.customElements,definities:Jo,waarschuw:i})}var Ep=`
  :host {
    ${W}
    display: block;
...
`,E={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ns={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},y=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),X=(i,e="accent")=>E[i]??(i&&/[#(]|^var/.test(i)?i:E[e]),R=Symbol("incomplete"),Ap=i=>`
  <div class="needs">
...
`,Xa=null,Ya=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Xa=Xa??[q(Lp)],this.shadowRoot.adoptedStyleSheets=Xa,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return E[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
  ...
  `);var ti=class extends L{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[Qa({name:"weather",selector:f.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Qa({name:"sun",selector:f.entity("sun")},{name:"precipitation_entity",selector:f.entity("sensor")}),{name:"name",selector:f.text()},{name:"hide_below",selector:f.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};H("domotiapp-header-card-editor",ti);T("domotiapp-header-card",wn,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var _n=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
  ...
  `);var ni=class extends L{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"line",selector:f.bool()},{name:"secondary_entity",selector:f.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};H("domotiapp-separator-card-editor",ni);T("domotiapp-separator-card",_n,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var ai=(i,e,t)=>Math.min(t,Math.max(e,i));function Ve(i,e){let t=e.min??0,n=e.max??100,a=e.step??1,r=!1,o=g=>{let k=i.getBoundingClientRect();if(!k.width)return t;let w=ai((g-k.left)/k.width,0,1),x=t+w*(n-t);return ai(Math.round(x/a)*a,t,n)},s=g=>{try{i.setPointerCapture?.(g)}catch{}},l=g=>{try{i.hasPointerCapture?.(g)&&i.releasePointerCapture(g)}catch{}},d=g=>{e.disabled?.()||g.button!=null&&g.button!==0||(r=!0,s(g.pointerId),i.classList.add("dragging"),e.onInput(o(g.clientX)),g.preventDefault())},c=g=>{r&&(e.onInput(o(g.clientX)),g.preventDefault())},p=g=>{r&&(r=!1,l(g.pointerId),i.classList.remove("dragging"),e.onCommit(o(g.clientX)))},h=g=>{r&&(r=!1,l(g?.pointerId),i.classList.remove("dragging"),e.onInput(e.value()))},m=g=>{if(e.disabled?.())return;let k=(n-t)/10,w={ArrowLeft:-a,ArrowDown:-a,ArrowRight:a,ArrowUp:a,PageDown:-k,PageUp:k,Home:-1/0,End:1/0};if(!(g.key in w))return;g.preventDefault();let x=e.value(),_=ai(w[g.key]===-1/0?t:w[g.key]===1/0?n:x+w[g.key],t,n);e.onInput(_),e.onCommit(_)};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",h),i.addEventListener("keydown",m),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",h),i.removeEventListener("keydown",m)}}var be=(i="")=>`
...
`;var Gp=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Wp=new Set(["hs","rgb","rgbw","rgbww","xy"]),ri=i=>i?.attributes?.supported_color_modes??[],Up=i=>ri(i).some(e=>Gp.has(e)),yn=i=>ri(i).some(e=>Wp.has(e)),jn=i=>ri(i).includes("color_temp"),os=i=>Math.max(1,Math.round((i??0)/255*100)),zn=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[R]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var ls=i=>String(i??"").split(".")[0],ds=new Set(["input_select","select"]),di=i=>ds.has(ls(i));function ve(i){if(!i||!di(i.entity_id))return[];let e=i.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function gt(i,e=ve(i)){let t=String(i?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function ft(i,e,t=[]){let n=ls(i),a=String(e??"");return!a||!ds.has(n)||t.length&&!t.includes(a)?null:[n,"select_option",{entity_id:i,option:a}]}var ue=i=>String(i??"").split(".")[0],Me=i=>i==null||i===""||i==="unknown"||i==="unavailable",Be={domeinen:["sensor"],device_class:"temperature",rol:"tegel",eenheid:"\xB0C"},qp={hoofd_climate:{key:"entity",label:"Apparaat (climate)",domeinen:["climate"],rol:"hoofd",hulp:"De climate-entiteit. Daar komen de standen en de temperatuurknoppen vandaan. Leeg laten mag: dan toont de kaart alleen de sensoren."},hoofd_ventilatie:{key:"entity",label:"Ventilatie-unit",domeinen:["fan","select","input_select","climate"],rol:"hoofd",hulp:"Een fan-entiteit (standen of percentage), of een keuzelijst met de standen. Leeg laten mag."},hoofd_boiler:{key:"entity",label:"Boiler (water_heater of climate)",domeinen:["water_heater","climate"],rol:"hoofd",hulp:"Daar komen de doeltemperatuur en de bedrijfsstanden vandaan. Leeg laten mag."},temperature:{key:"temperature",label:"Binnentemperatuur",...Be,hulp:"Wint van de meting van het apparaat zelf."},outdoor:{key:"outdoor",label:"Buitentemperatuur",...Be},humidity:{key:"humidity",label:"Luchtvochtigheid",domeinen:["sensor"],device_class:"humidity",rol:"tegel",eenheid:"%"},co2:{key:"co2",label:"CO\u2082",domeinen:["sensor"],rol:"tegel",eenheid:"ppm",hulp:"Kleurt oranje boven 1200 ppm en rood boven 1600."},voc:{key:"voc",label:"Luchtkwaliteit (VOC)",domeinen:["sensor"],rol:"tegel"},power:{key:"power",label:"Vermogen",domeinen:["sensor"],device_class:"power",rol:"tegel",eenheid:"W"},energy:{key:"energy",label:"Energie vandaag",domeinen:["sensor"],device_class:"energy",rol:"tegel",eenheid:"kWh"},flow_temp:{key:"flow_temp",label:"Aanvoertemperatuur",...Be},return_temp:{key:"return_temp",label:"Retourtemperatuur",...Be},dhw_temp:{key:"dhw_temp",label:"Tapwatertemperatuur",...Be},water_temp:{key:"water_temp",label:"Watertemperatuur",...Be,hulp:"Wint van de meting van de boiler zelf."},supply_temp:{key:"supply_temp",label:"Toevoertemperatuur",...Be},exhaust_temp:{key:"exhaust_temp",label:"Afvoertemperatuur",...Be},cop:{key:"cop",label:"COP",domeinen:["sensor"],rol:"tegel",hulp:"Rendement: geleverde warmte gedeeld door verbruikte stroom."},thermal:{key:"thermal",label:"Thermisch vermogen",domeinen:["sensor"],rol:"tegel",eenheid:"kW"},compressor:{key:"compressor",label:"Compressor",domeinen:["sensor","binary_sensor"],rol:"tegel",hulp:"Een toerental of percentage, of een aan/uit-sensor."},flow_rate:{key:"flow_rate",label:"Debiet",domeinen:["sensor"],rol:"tegel",eenheid:"l/min"},pressure:{key:"pressure",label:"Waterdruk",domeinen:["sensor"],rol:"tegel",eenheid:"bar"},status:{key:"status",label:"Statussensor",domeinen:["sensor"],rol:"status",hulp:"Een sensor met een woord als toestand (Verwarmen, Tapwater, Stand 2). Komt in de regel onder de naam."},fault:{key:"fault",label:"Storing",domeinen:["binary_sensor"],rol:"storing",hulp:"Een binary_sensor die aan gaat bij een storing. De kaart kleurt dan rood, wat er verder ook aan de hand is."},filter:{key:"filter",label:"Filter",domeinen:["binary_sensor","sensor"],rol:"filter",hulp:"Een binary_sensor die aan gaat als het filter vervangen moet worden, of een sensor met de dagen tot vervanging."},bypass:{key:"bypass",label:"Bypass",domeinen:["binary_sensor"],rol:"tegel"},heating:{key:"heating",label:"Verwarmt (aan/uit)",domeinen:["binary_sensor"],rol:"verwarmt",hulp:"Een binary_sensor die aan is zolang de boiler opwarmt."},mode:{key:"mode",label:"Bedrijfsmodus (keuzelijst)",domeinen:["select","input_select"],rol:"keuze",hulp:"Een keuzelijst van de integratie, bijvoorbeeld Verwarmen / Koelen / Auto. Verschijnt als uitklaplijst op de kaart."},boost:{key:"boost",label:"Boost",domeinen:["switch","input_boolean","button","input_button","script"],rol:"boost",hulp:"Een schakelaar wordt een schuifschakelaar op de kaart; een knop of script een drukknop."}},bt={airco:{label:"Airco",naam:"Airco",icoon:"airco",velden:["hoofd_climate","temperature","outdoor","humidity","power","energy","fault"]},warmtepomp:{label:"Warmtepomp",naam:"Warmtepomp",icoon:"heatPump",velden:["hoofd_climate","status","fault","flow_temp","return_temp","outdoor","dhw_temp","cop","power","thermal","energy","compressor","flow_rate","pressure","mode","boost"]},ventilatie:{label:"Ventilatie (WTW)",naam:"Ventilatie",icoon:"fan",velden:["hoofd_ventilatie","status","fault","co2","humidity","voc","temperature","outdoor","supply_temp","exhaust_temp","filter","bypass","power","boost"]},boiler:{label:"Boiler / warm water",naam:"Boiler",icoon:"boiler",velden:["hoofd_boiler","water_temp","heating","power","energy","fault","mode","boost"]}},Ye="airco",Qe=i=>bt[i]??bt[Ye],Pe=i=>Qe(i).velden.map(e=>qp[e]),ci=(i,e)=>Pe(i).filter(t=>t.rol===e),ps={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",dry:"Drogen",fan_only:"Ventileren"},Zp={heating:"Verwarmt",cooling:"Koelt",drying:"Droogt",fan:"Ventileert",idle:"Standby",off:"Uit",preheating:"Voorverwarmt",defrosting:"Ontdooit"},cs={off:"Uit",on:"Aan",auto:"Auto",low:"Laag",lowest:"Laagst",min:"Min",minimum:"Min",medium:"Midden",mid:"Midden",middle:"Midden",high:"Hoog",highest:"Hoogst",max:"Max",maximum:"Max",boost:"Boost",turbo:"Turbo",quiet:"Stil",silent:"Stil",silence:"Stil",sleep:"Nacht",night:"Nacht",away:"Afwezig",home:"Thuis",eco:"Eco",comfort:"Comfort",party:"Feest",holiday:"Vakantie",electric:"Elektrisch",gas:"Gas",heat_pump:"Warmtepomp",high_demand:"Veel vraag",performance:"Snel",...ps};function le(i){let e=String(i??"").trim();if(!e)return"";let t=e.toLowerCase().replace(/[\s-]+/g,"_");if(cs[t])return cs[t];let n=e.replace(/_/g," ");return n.charAt(0).toUpperCase()+n.slice(1)}function Xp(i,e){let t=String(i??"").toLowerCase(),n=Math.abs(Number(e));return t.includes("\xB0")||t==="c"||t==="f"?1:t==="%"||t==="ppm"||t==="w"||t==="hz"||t==="rpm"||t==="ppb"?0:t==="kwh"||t==="kw"||t==="bar"||t==="l/min"||t==="m\xB3/h"||t?n>=100?0:1:n>=100?0:n>=10?1:2}function Yp(i,e,t="nl"){let n=Number(i);if(!Number.isFinite(n))return"--";let a=Xp(e,n);return n.toLocaleString(t,{minimumFractionDigits:a,maximumFractionDigits:a})}var Qp={bypass:["Open","Dicht"],compressor:["Aan","Uit"],heating:["Ja","Nee"],filter:["Vervangen","Schoon"]};function Jp(i,e,t="nl"){if(!i||!e)return null;let n=String(e.state??"").trim(),a=e.attributes?.unit_of_measurement??i.eenheid??"";if(ue(e.entity_id)==="binary_sensor"){let[l,d]=Qp[i.key]??["Aan","Uit"],c=Me(n),p=n==="on";return{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:c?"--":p?l:d,eenheid:"",let:i.key==="filter"&&p?"warn":""}}let r=Number(n),o=!Me(n)&&Number.isFinite(r),s="";return i.key==="co2"&&o&&(s=r>=1600?"bad":r>=1200?"warn":""),i.key==="filter"&&o&&(s=r<=0?"warn":""),{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:o?Yp(r,a,t):Me(n)?"--":n,eenheid:o?a:"",let:s}}function hs(i,e,t,n="nl"){let a=[];for(let r of Pe(i)){if(r.rol!=="tegel"&&r.rol!=="filter")continue;let o=e?.[r.key];if(!o)continue;let s=Jp(r,t(o)??{entity_id:o,state:"unavailable",attributes:{}},n);s&&a.push(s)}return a}function us({soort:i,hoofd:e,status:t,fault:n,filter:a,heating:r}={}){let o=eh(a);if(n&&n.state==="on")return{tekst:"Storing",tone:"bad",bezig:!1,waarschuwing:o};if(e&&Me(e.state))return{tekst:"Niet bereikbaar",tone:"neutral",bezig:!1,waarschuwing:o};let s=t&&!Me(t.state)?le(t.state):"",l=ue(e?.entity_id);if(e&&l==="climate"){let c=(e.attributes??{}).hvac_action??(e.state==="off"?"off":"idle"),p=Zp[c]??le(c),h=c==="heating"||c==="preheating"?"solar":["cooling","drying","fan"].includes(c)?"water":"neutral",m=h!=="neutral"||c==="defrosting";return{tekst:s&&s!==p?`${p} \xB7 ${s}`:p,tone:h,bezig:m,waarschuwing:o}}if(e&&l==="fan"){let d=e.attributes??{};if(e.state==="off")return{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o};let c=d.preset_mode?le(d.preset_mode):Number.isFinite(Number(d.percentage))?`${Math.round(Number(d.percentage))}%`:"Aan";return{tekst:s&&s!==c?`${c} \xB7 ${s}`:`Ventileert \xB7 ${c}`,tone:"water",bezig:!0,waarschuwing:o}}if(e&&l==="water_heater"){let d=e.attributes??{},c=le(e.state),p=r?r.state==="on":d.operation_mode!=="off"&&e.state!=="off"&&d.hvac_action==="heating";return e.state==="off"?{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:p?`Verwarmt \xB7 ${c}`:c,tone:p?"solar":"neutral",bezig:p,waarschuwing:o}}if(e&&(l==="select"||l==="input_select")){let d=le(e.state),c=/^(uit|off)$/i.test(e.state);return{tekst:c?"Uit":`Stand \xB7 ${d}`,tone:c?"neutral":"water",bezig:!c,waarschuwing:o}}return r&&r.state==="on"?{tekst:s?`Verwarmt \xB7 ${s}`:"Verwarmt",tone:"solar",bezig:!0,waarschuwing:o}:s?{tekst:s,tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:Qe(i).naam,tone:"neutral",bezig:!1,waarschuwing:o}}function eh(i){if(!i||Me(i.state))return"";if(ue(i.entity_id)==="binary_sensor")return i.state==="on"?"Filter vervangen":"";let e=Number(i.state);return Number.isFinite(e)&&e<=0?"Filter vervangen":""}var th=[["0","Uit"],["33","Laag"],["66","Midden"],["100","Hoog"]];function pi(i){if(!i)return[];let e=i.attributes??{},t=ue(i.entity_id),n=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"&&r!==""):[];if(t==="climate")return n(e.hvac_modes).map(a=>({waarde:a,label:ps[a]??le(a)}));if(t==="water_heater")return n(e.operation_list).map(a=>({waarde:a,label:le(a)}));if(t==="select"||t==="input_select")return n(e.options).map(a=>({waarde:a,label:le(a)}));if(t==="fan"){let a=n(e.preset_modes);if(a.length)return a.map(r=>({waarde:r,label:le(r)}));if(e.percentage!=null||e.percentage_step!=null){let r=Number(e.percentage_step)||1;return th.map(([o,s])=>({waarde:String(Math.min(100,Math.round(Number(o)/r)*r)),label:s}))}return[{waarde:"off",label:"Uit"},{waarde:"on",label:"Aan"}]}return[]}function ms(i,e=pi(i)){if(!i||Me(i.state))return"";let t=i.attributes??{};if(ue(i.entity_id)==="fan"){if(t.preset_mode&&e.some(r=>r.waarde===t.preset_mode))return t.preset_mode;if(i.state==="off")return e.some(r=>r.waarde==="0")?"0":"off";let a=Number(t.percentage);if(Number.isFinite(a)&&e.length){let r=e[0];for(let o of e)Math.abs(Number(o.waarde)-a)<Math.abs(Number(r.waarde)-a)&&(r=o);return r.waarde}return i.state==="on"?"on":""}return e.some(a=>a.waarde===i.state)?i.state:""}function gs(i,e){if(!i)return null;let t=i.entity_id,n=String(e??"");if(!n)return null;let a=ue(t);switch(a){case"climate":return["climate","set_hvac_mode",{entity_id:t,hvac_mode:n}];case"water_heater":return["water_heater","set_operation_mode",{entity_id:t,operation_mode:n}];case"select":case"input_select":return[a,"select_option",{entity_id:t,option:n}];case"fan":{let r=i.attributes?.preset_modes;if(Array.isArray(r)&&r.includes(n))return["fan","set_preset_mode",{entity_id:t,preset_mode:n}];if(n==="off")return["fan","turn_off",{entity_id:t}];if(n==="on")return["fan","turn_on",{entity_id:t}];let o=Number(n);return Number.isFinite(o)?o<=0?["fan","turn_off",{entity_id:t}]:["fan","set_percentage",{entity_id:t,percentage:o}]:null}default:return null}}function hi(i){let e=i?.attributes?.fan_modes;return ue(i?.entity_id)!=="climate"||!Array.isArray(e)?[]:e.filter(t=>typeof t=="string"&&t).map(t=>({waarde:t,label:le(t)}))}function fs(i,e){let t=String(e??"");return!i||!t||!hi(i).some(n=>n.waarde===t)?null:["climate","set_fan_mode",{entity_id:i.entity_id,fan_mode:t}]}function ui(i,e){if(!i||Me(i.state))return null;let t=i.attributes??{},n=ue(i.entity_id);if(n!=="climate"&&n!=="water_heater")return null;let a=Number(t.temperature);if(!Number.isFinite(a))return null;let r=Number(e)||Number(t.target_temp_step)||(n==="water_heater"?1:.5);return{min:Number(t.min_temp??(n==="water_heater"?30:5)),max:Number(t.max_temp??(n==="water_heater"?70:35)),stap:r,doel:a,huidig:Number.isFinite(Number(t.current_temperature))?Number(t.current_temperature):null}}function bs(i,e,t){if(!i)return null;let a=(Number.isFinite(e)?e:i.doel)+t*i.stap,r=Math.round(a/i.stap)*i.stap,o=Math.round(r*100)/100;return Math.min(i.max,Math.max(i.min,o))}function vs(i,e){if(!i||!Number.isFinite(e))return null;let t=ue(i.entity_id);return t!=="climate"&&t!=="water_heater"?null:[t,"set_temperature",{entity_id:i.entity_id,temperature:e}]}var ks=i=>["switch","input_boolean"].includes(ue(i));function mi(i,e=!0){let t=String(i??""),n=ue(t);switch(n){case"switch":case"input_boolean":return["homeassistant",e?"turn_on":"turn_off",{entity_id:t}];case"button":case"input_button":return[n,"press",{entity_id:t}];case"script":return["script","turn_on",{entity_id:t}];default:return null}}function xs(i,e){let t=Number(e?.state);if(e&&!Me(e.state)&&Number.isFinite(t))return t;let n=i?.attributes?.current_temperature;if(n==null||n==="")return null;let a=Number(n);return Number.isFinite(a)?a:null}var ws={solar:E.solar,water:E.water,bad:E.bad,warn:E.warn,neutral:"var(--dac-ink-3)"},Sn=class extends S{validate(e){let t={soort:Ye,...e};return bt[t.soort]||(t.soort=Ye),Pe(t.soort).some(a=>t[a.key])||(t[R]="Kies de soort en minstens \xE9\xE9n entiteit: het apparaat zelf, of een sensor."),t}watched(){let e=this.config;return Pe(e.soort).map(t=>e[t.key]).filter(Boolean)}hoofd_(){return v(this.hass,this.config.entity)??null}metRol_(e){let t=ci(this.config.soort,e)[0];return t?v(this.hass,this.config[t.key])??null:null}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=e.boost?ks(e.boost)?En({label:"Boost"}):`<button type="button" class="knop">${b("bolt")}<span>Boost</span></button>`:"";return`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var gi=class extends L{defaults(){return{soort:Ye}}soort_(){return bt[this.config_?.soort]?this.config_.soort:Ye}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:Qe(this.soort_()).icoon,auto:!1}]}sync_(){super.sync_();for(let e of this.pickers_??[])e.dataset.key==="icon"&&(e.fallback=Qe(this.soort_()).icoon)}schema(){let e=this.soort_(),t=Pe(e).map(r=>({name:r.key,selector:{entity:{domain:r.domeinen,...r.device_class?{device_class:r.device_class}:{}}}})),a=ci(e,"hoofd")[0]?.domeinen.some(r=>r==="climate"||r==="water_heater");return[{name:"soort",selector:f.select(Object.entries(bt).map(([r,o])=>({value:r,label:o.label})))},{name:"name",selector:f.text()},...t,...a?[{name:"step",selector:f.number(.1,5,.1)}]:[]]}label(e){let t=Pe(this.soort_()).find(n=>n.key===e.name);return t?t.label:{soort:"Soort apparaat",name:"Naam",step:"Stap van de temperatuurknoppen"}[e.name]??super.label(e)}helper(e){let t=Pe(this.soort_()).find(n=>n.key===e.name);if(t?.hulp)return t.hulp;if(e.name==="soort")return"Bepaalt welke velden hieronder staan, het icoon, en hoe de statusregel leest.";if(e.name==="name")return`Leeg laten geeft de naam van het apparaat, of anders "${Qe(this.soort_()).naam}".`;if(e.name==="step")return"Leeg laten volgt het apparaat: een halve graad bij een climate, een hele bij een boiler."}};H("domotiapp-hvac-card-editor",gi);T("domotiapp-hvac-card",Sn,{name:"DomotiApp HVAC",description:"Airco, warmtepomp, ventilatie of boiler: status, metingen als tegels, de standen van het apparaat, doeltemperatuur en boost."});var Nn=i=>String(i??"").split(".")[0],_s=new Set(["input_datetime","time","date","datetime"]),ys=i=>_s.has(Nn(i)),ke=i=>String(i).padStart(2,"0");function nh(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function fi(i){if(!i)return null;let e=Nn(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:nh(i.state)}var ah=i=>`${i.getFullYear()}-${ke(i.getMonth()+1)}-${ke(i.getDate())}T${ke(i.getHours())}:${ke(i.getMinutes())}`;function ih(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${ke(Math.floor(n/60))}:${ke(n%60)}`}function js(i,e=fi(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${ke(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(Nn(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":ah(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${ke(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function zs(i,e,t){let n=Nn(i),a=String(t??"");if(!a||!_s.has(n)||!e)return null;if(e==="time"){let h=a.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let m=`${ke(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:m}]:["input_datetime","set_datetime",{entity_id:i,time:m}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${ke(d)}:${c}:00`;if(n==="datetime"){let h=ih(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var $s={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},rh=/^.*program(?:me)?[_.\- ]/i,oh=30,sh=95;function lh(i){return String(i??"").replace(rh,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function dh(i){let e=lh(i);if(!e.length)return"";let t=[];for(let a=0;a<e.length;a++){let r=e[a],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=oh&&d<=sh?`${d} \xB0C`:o);continue}let s=e[a+1]?.toLowerCase(),l=s?$s[o+s]:void 0;if(l){t.push(l),a++;continue}t.push($s[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function ch(i,e){let t=a=>String(a??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(i)}function Tn(i,e){return ch(i,e)?String(e):dh(i)||String(i??"")}var Dn={row:44,tile:96,compact:44,beeld:120},Ke=6,Es=12,bi=22,ph=["row","tile","compact","beeld"],hh=["links","midden"],vi=48,ki=320,On=120,xe=i=>{if(i==null||i==="")return On;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(ki,Math.max(vi,e)):On},Ht=i=>hh.includes(i)?i:"links";function As(i,e){let t=Array.isArray(i)?i:[],n=Array.from({length:e},(a,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var uh=["card","items","none","open"],Ln=i=>typeof i?.name=="string"?i.name.trim():"",Vt=i=>typeof i=="string"?{entity:i}:{...i},It=i=>Math.min(Math.max(1,Number(i)||2),3),vt=i=>ph.includes(i)?i:"row",de=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function Ms(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(n=>{let a=It(n.columns);return{columns:a,layout:vt(n.layout),align:Ht(n.align),image_size:xe(n.image_size),column_names:As(n.column_names,a),items:(n.items??n.entities??[]).map(Vt)}});let e=(i?.items??i?.entities??[]).map(Vt);if(!e.length)return[];let t=It(i.columns);return[{columns:t,layout:vt(i.layout),align:Ht(i.align),image_size:xe(i.image_size),column_names:As(i.column_names,t),items:e}]}function Cn(i){return uh.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var mh=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns)),gh=22;function fh(i){let e=vt(i?.layout);return e!=="beeld"?Dn[e]:xe(i?.image_size)+34}function xi(i){let e=i?.rows??[],t=Ln(i)?bi+Ke:0;if(!e.length)return Es+t+Dn.row;let n=(Cn(i)==="card"?Es:0)+t;for(let a of e){let r=mh(a);n+=r*fh(a)+(r-1)*Ke,a.column_names?.length&&(n+=gh+Ke)}return n+(e.length-1)*Ke}function Bt(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();de(e)&&i.bewaard.push(e)}return i}function Ss(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:It(n.columns),layout:vt(n.layout),align:Ht(n.align),image_size:xe(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(Vt)})):(()=>{let n=(i.items??i.entities??[]).map(Vt);return n.length?[{columns:It(i.columns),layout:vt(i.layout),align:Ht(i.align),image_size:xe(i.image_size),column_names:Array.isArray(i.column_names)?[...i.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]),a.forEach((r,o)=>t.push(Bt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var wi=i=>i.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==On?{image_size:xe(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(de).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function _i(i,e,t){let n=new Set;for(let a of i){let r=/^r(\d+)(?:i(\d+))?$/.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:a);continue}n.add(o>e?`r${o+1}${s}`:a)}return n}var Ns=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],bh=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],vh=i=>Ns.find(e=>e.waarde===i)?.label??"Rij",kh=`
...
`,yi=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Ss(e);this.gebouwd_&&JSON.stringify(wi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=_i(this.open_,e,"weg")}rijErbij_(e){this.open_=_i(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{de(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=kh;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=Bt({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(O=>({waarde:O,label:String(O),titel:`${O} entiteit${O>1?"en":""} in deze rij`})),()=>e.columns,O=>{e.columns=O,Bt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let m=this.segment_(Ns.map(O=>({waarde:O.waarde,label:O.label})),()=>e.layout,O=>{e.layout=O,ge(),this.emit_()}),g=document.createElement("div");g.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",g.append(k,m.wrap),h.appendChild(g);let w=this.segment_(bh.map(O=>({waarde:O.waarde,label:O.label})),()=>e.align??"links",O=>{e.align=O,this.emit_()}),x=document.createElement("div");x.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",x.append(_,w.wrap),h.appendChild(x);let N=document.createElement("div");N.className="beeldvak";let I=document.createElement("ha-form");I.hass=this.hass_,I.schema=[{name:"image_size",selector:{number:{min:vi,max:ki,step:4,mode:"slider"}}}],I.computeLabel=()=>"Grootte van de afbeelding",I.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",I.data={image_size:xe(e.image_size)},I.addEventListener("value-changed",O=>{O.stopPropagation(),e.image_size=xe(O.detail.value?.image_size),this.emit_()}),N.appendChild(I),h.appendChild(N);let ge=()=>{let O=e.layout==="beeld";N.style.display=O?"":"none",x.style.display=O?"none":""};ge();let he=document.createElement("div");he.className="kolomvak";let fe=document.createElement("ha-form");fe.hass=this.hass_;let Vo=()=>Array.from({length:e.columns},(O,oe)=>({name:`k${oe}`,selector:{text:{}}}));fe.schema=Vo(),fe.computeLabel=O=>`Kop boven kolom ${Number(O.name.slice(1))+1}`,fe.computeHelper=O=>O.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let Io=()=>Object.fromEntries(Array.from({length:e.columns},(O,oe)=>[`k${oe}`,e.column_names?.[oe]??""]));fe.data=Io(),fe.addEventListener("value-changed",O=>{O.stopPropagation();let oe=O.detail.value??{};e.column_names=Array.from({length:e.columns},(Po,gp)=>oe[`k${gp}`]??""),this.emit_()}),he.appendChild(fe),h.appendChild(he);let Bo=()=>{let O=e.items.filter(de),oe=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&oe.push(vh(e.layout)),oe.push(O.length?O.map(Po=>this.itemNaam_(Po)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&oe.push("met kolomkoppen"),l.textContent=oe.join(" \xB7 "),d.vernieuw(),m.vernieuw(),w.vernieuw(),ge(),fe.schema.length!==e.columns&&(fe.schema=Vo()),fe.data=Io()};return this.koppen_.push(Bo),e.items.forEach((O,oe)=>h.appendChild(this.itemBlok_(e,O,t,oe))),n.append(a,h),Bo(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(a,1),this.itemWeg_(n,a),Bt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let m=document.createElement("div");m.className="itembody";let g=document.createElement("ha-form");g.hass=this.hass_,g.schema=[{name:"entity",selector:{entity:{}}}],g.computeLabel=()=>"Entiteit",g.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",g.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let w=document.createElement("ha-form");w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],w.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,w.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},w.addEventListener("value-changed",_=>{_.stopPropagation();let N=_.detail.value;N.name?t.name=N.name:delete t.name,N.toggle===!0?t.toggle=!0:delete t.toggle;for(let I of["show_icon","show_name","show_state"])N[I]===!1?t[I]=!1:delete t[I];for(let I of["icon_tap_action","icon_hold_action","tap_action","hold_action"])N[I]?t[I]=N[I]:delete t[I];N.double_tap_action&&N.double_tap_action.action!=="none"?t.double_tap_action=N.double_tap_action:delete t.double_tap_action,this.emit_()});let x=()=>{c.textContent=de(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(de(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!de(t)),h.hidden=!de(t)};return this.koppen_.push(x),g.data={entity:t.entity||void 0},k.value=t.icon??"",w.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},m.append(g,k,w),r.append(o,m),x(),r}emit_(){let e=wi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-entities-card-editor",yi);var Rn=class extends S{validate(e){let t=Ms(e);return t.some(n=>n.items.some(de))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[R]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?X(e.tone):this.config.tone?X(this.config.tone):$e(e.entity)!=="light"?E.accent:Fo(v(this.hass,e.entity))??E.lit}metSchakelaar_(e){return!!e.toggle&&qo(e.entity)}metTijd_(e){return!ys(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!di(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Cn(e)),this.style.containerType="inline-size";let t=Cn(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,m)=>`
      ...
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:Dn[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Ln(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>Ee(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(U(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(U(r,{onTap:()=>n("icon_tap_action",Lt(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=zs(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=v(this.hass,t.entity),p=ft(t.entity,d.value,ve(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(An(o,{value:()=>Y(v(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>ne(v(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Ln(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let a=v(this.hass,n.entity),r=Y(a),o=!!n.entity&&ne(a);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=M(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let _=bn(this.hass,n.entity,n.icon),N=n.icon||(_?`pic:${_}`:Ua(n.entity,Z(this.hass,n.entity)));d.dataset.icon!==N&&(d.dataset.icon=N,d.classList.toggle("pic",!!_),d.innerHTML=_?`<img src="${_}" alt="" loading="lazy" />`:b(n.icon||Ua(n.entity,Z(this.hass,n.entity)))),d.style.setProperty("--tone",_?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(Rt(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),m=null;if(h){let _=o?null:fi(a);h.dataset.soort!==(_??"")&&(h.dataset.soort=_??"",h.innerHTML=_?`<input class="tijd" type="${_}" step="60" />`:""),m=h.querySelector(".tijd")}if(m&&(m.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==m)){let _=js(a,h.dataset.soort);m.value!==_&&(m.value=_)}let g=t.querySelector(".keuzeslot"),k=null;if(g){let _=o?[]:ve(a),N=_.map(ge=>Tn(ge,this.hass?.formatEntityState?.(a,ge))),I=JSON.stringify([_,N]);g.dataset.opties!==I&&(g.dataset.opties=I,g.innerHTML=_.length?`<select class="keuze">${_.map((ge,he)=>`<option value="${y(ge)}">${y(N[he])}</option>`).join("")}</select>`:""),k=g.querySelector(".keuze")}if(k&&(k.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==k)){let _=gt(a);k.value!==_&&(k.value=_)}let w=t.querySelector(".st"),x=n.show_state??this.config.show_state;if(p||m||k)w.textContent="";else if(x===!1)w.textContent="";else if(o)w.textContent="Niet bereikbaar";else if(!a||Ga(a.entity_id))w.textContent="";else if($e(a.entity_id)==="light"&&r&&a.attributes.brightness!=null)w.textContent=`${Math.round(a.attributes.brightness/255*100)}%`;else{let _=a.attributes.unit_of_measurement;w.textContent=_?`${a.state} ${_}`:ee(this.hass,a)}t.setAttribute("aria-label",`${l}${a?`, ${ee(this.hass,a)}`:""}`)})}getCardSize(){return Ae(xi(this.config))}getGridOptions(){let e=Ae(xi(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};j(Rn,"css",`
    :host { display: block; height: 100%; }
  ...
  `);T("domotiapp-entities-card",Rn,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Q={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},J=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),kt=i=>!i||i.state==="off",ji=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),Pt=i=>i?.state==="playing",Ts=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function Os(i){if(!i)return[];let e=[];return(J(i,Q.TURN_ON)||J(i,Q.TURN_OFF))&&e.push("power"),kt(i)||(J(i,Q.PREVIOUS_TRACK)&&e.push("prev"),J(i,Q.PLAY)||J(i,Q.PAUSE)||J(i,Q.PLAY_MEDIA)?e.push("play"):J(i,Q.STOP)&&e.push("stop"),J(i,Q.NEXT_TRACK)&&e.push("next")),e}var Je=i=>i?.volume_entity||i?.entity;function zi(i){if(!ji(i))return[];let e=[];return J(i,Q.VOLUME_MUTE)&&e.push("mute"),J(i,Q.VOLUME_SET)?e.push("slider"):J(i,Q.VOLUME_STEP)&&e.push("steps"),e}var Ge=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Ds=i=>i?.attributes?.volume_level!==void 0&&i?.attributes?.volume_level!==null,Kt=i=>!!i?.attributes?.is_volume_muted,$i=i=>!!i?.attributes?.mass_player_type,Ei=i=>!!i?.attributes?.shuffle,Ai=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ls=i=>({off:"all",all:"one",one:"off"})[xh(i)]??"all",xh=i=>["off","all","one"].includes(i)?i:"off";function Mi(i,{zoeken:e=!0,sleep:t=!1}={}){if(!ji(i))return[];let n=[];return J(i,Q.SHUFFLE_SET)&&n.push("shuffle"),J(i,Q.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&$i(i)&&n.push("search"),n}function Cs(i,{tonen:e=!0}={}){if(!e||!ji(i)||!J(i,Q.SELECT_SOURCE)||$i(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Hn(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function Gt(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var wh="domotiapp-media-speler:";function Si(i,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],a=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(i?.players)&&i.players.length?[...new Set([...n(i?.entity)?[i.entity]:[],...i.players.filter(n)])]:_h(a(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function _h(i,e){let t=i.filter(n=>$i(e?.states?.[n]));return t.length?t:i}var Rs=i=>wh+(i??[]).join("|");function Hs(i,e,t){if(!i?.speaker_select)return i?.entity??"";let n=null;try{n=t?.getItem?.(Rs(e))??null}catch{n=null}return n&&e?.includes(n)?n:i.entity&&e?.includes(i.entity)?i.entity:i.entity||e?.[0]||""}function Vs(i,e,t){try{return i?.setItem?.(Rs(e),String(t)),!0}catch{return!1}}var Ni="dacScrollSlot",Is=["position","top","left","right","width","overflow"];function Vn(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[Ni])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(Is.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Ni]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Is)t.style[o]=a[o];t.dataset&&delete t.dataset[Ni],e?.scrollTo?.(0,n)}}}var yh=[400,1e3,2e3,4e3,8e3,15e3,3e4],jh=6e4;function ce(i){let e=i?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(i?.message??""))}var se=class{constructor(e,{wachttijden:t=yh,traag:n=jh,klok:a,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=a??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},we=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var zh=`
  :host {
    ${W}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Ti=null,Bs=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Oi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Ti=Ti??[q(zh)],this.shadowRoot.adoptedStyleSheets=Ti}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=Bs(e.title??"Weet je het zeker?"),this.$("p").innerHTML=Bs(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};C("domotiapp-vraag",Oi);function _e(i={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(i);return e.focus?.(),t}Uo(_e);var Ps=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var We=i=>`domotiapp_lovelace/media/${i}`;function $h(i,e){if(!i)return null;if(e)return i.uri?{type:We("favorite"),favorite:!0,uri:i.uri}:null;let t=Ks(i);return!t||!i.library_item_id?null:{type:We("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function Ks(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Gs={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Di=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Ws(i,e,t=null){return i?.kind??Ks(e)??t??"playlists"}var Li=i=>!!i?.uri,In=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:We("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),Us=(i,e,t)=>{let n=$h(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Fs=(i,e)=>i.callWS({type:We("playlist/create"),name:e}).then(t=>t?.playlist??null),qs=(i,e)=>i.callWS({type:We("playlist/remove"),library_item_id:String(e.library_item_id)}),Zs=(i,e)=>i.callWS({type:We("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Xs=(i,e,t)=>i.callWS({type:We("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Ys=(i,e,t)=>i.callWS({type:We("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Eh=350,Ah={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Mh(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Ah[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Sh=`
  :host {
    ${W}
...
`,Ri=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[q(Nh+Re)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};C("domotiapp-bron-kiezer",Ri);function Js(i,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(i,e,t),n.focus?.(),n}function el(i,e){let t=i?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var Th=524288;function Oh(i,e){let t=i?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&Th)!==0}function Hi(i,e,t){return e===t?"zelf":Oh(i,e)?Dh(i,e,t)?"mee":"los":"kan-niet"}function Dh(i,e,t){if(el(i,t).has(e))return!0;if(el(i,t).size===0){let n=i?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function tl(i,e,t){let n=Hi(i,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Lh=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Vi=null,Bn=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ii=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Vi=Vi??[q(Lh)],this.shadowRoot.adoptedStyleSheets=Vi,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="tel"></div>
        <div class="lijst" role="listbox"></div>
      </div>`,this.gebouwd_=!0;let e=(t,n,a)=>{t.addEventListener(n,a),this.opruimen_.push(()=>t.removeEventListener(n,a))};e(this.$(".sluit"),"click",()=>this.sluit()),e(this.$(".laag"),"click",t=>{t.target===this.$(".laag")&&this.sluit()}),e(this.$("input"),"input",t=>{this.filter_=t.target.value.trim().toLowerCase(),this.teken_()}),e(this.$("input"),"keydown",t=>{t.key==="Enter"&&this.$(".sp")?.click()}),e(this,"keydown",t=>{t.key==="Escape"&&this.hasAttribute("open")&&this.sluit()}),e(this.$(".lijst"),"click",t=>{let n=t.target.closest(".mee");if(n)return t.stopPropagation(),this.koppel_(n.dataset.id);let a=t.target.closest(".sp");a&&this.kies_(a.dataset.id)})}$(e){return this.shadowRoot.querySelector(e)}set hass(e){this.hass_=e,this.hasAttribute("open")&&this.gebouwd_&&this.teken_()}get hass(){return this.hass_}open(e,t,n,a){this.hass_=e,this.lijst_=Array.isArray(t)?t:[],this.huidig_=n,this.opKeuze_=a,this.filter_="",this.gebouwd_||this.bouw_(),this.$("input").value="",this.$(".zoek").hidden=this.lijst_.length<8,this.setAttribute("open",""),this.teken_(),this.$(".zoek").hidden||setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open")}teken_(){let e=this.lijst_,t=this.filter_?e.filter(a=>String(M(this.hass,a)).toLowerCase().includes(this.filter_)):[...e];this.$(".sub").textContent=this.huidig_?`Nu: ${M(this.hass,this.huidig_)}`:"",this.$(".tel").textContent=this.filter_?`${t.length} van ${e.length}`:`${e.length} speaker${e.length===1?"":"s"}`;let n=this.$(".lijst");if(!t.length){n.innerHTML='<div class="leeg">Niets gevonden.</div>';return}n.innerHTML=t.map(a=>{let r=v(this.hass,a),o=a===this.huidig_,s=kt(r)?"Uit":Hn(r,c=>ee(this.hass,c)),l=Hi(this.hass,a,this.huidig_),d=l==="mee";return`<div class="rij">
                ...
                </div>`}).join("")}koppel_(e){let t=tl(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};C("domotiapp-speler-kiezer",Ii);function nl(i,e,t,n){let a=document.querySelector("domotiapp-speler-kiezer");return a||(a=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var Bi=[15,30,45,60,90],Pi=30;function al(i){let e=Math.max(0,Math.round(i)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),a=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(a).padStart(2,"0")}`}function Ki(i,{min:e=1,max:t=720}={}){let n=String(i??"").trim();if(!/^\d+$/.test(n))return null;let a=Number(n);return a>=e&&a<=t?a:null}var Ch=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Gi=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(Ch)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
  ...
  `);var qi=class extends L{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"smoke"}]}schema(){return[{name:"name",selector:f.text()},{name:"smoke",selector:f.entity()},{name:"co",selector:f.entity()},{name:"heat",selector:f.entity()},{name:"temperature",selector:f.entity()},{name:"battery",selector:f.entity()},{name:"tap_action",selector:f.action("more-info")},{name:"hold_action",selector:f.action("more-info")}]}label(e){return{name:"Naam (overschrijft die van de melder)",smoke:"Rook",co:"Koolmonoxide",heat:"Warmte",temperature:"Temperatuur",battery:"Batterij",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="smoke")return"Alle vijf zijn optioneel: vul in wat je melder heeft. Wat je leeg laat, komt niet op de kaart.";if(e.name==="battery")return"Een percentage of een 'batterij bijna leeg'-sensor. Onder de 20% meldt de kaart het uit zichzelf."}};H("domotiapp-smoke-card-editor",qi);T("domotiapp-smoke-card",Gn,{name:"DomotiApp Rookmelder",description:"Rook, koolmonoxide, warmte, temperatuur en batterij \u2014 alles optioneel."});var Ih=["zo","ma","di","wo","do","vr","za"],sl=5,ll=8,Wn=class extends S{validate(e){if(!e.entity)return{...e,[R]:"Kies een weerentiteit."};let t=Math.min(Math.max(1,Number(e.days)||sl),ll);return{show_current:!0,forecast_type:"daily",...e,days:t}}watched(){return[this.config.entity]}template(){this.config.bare&&this.setAttribute("bare","");let e=this.config;return`
      ...
      </div>`}wire(){this.teardown_.push(V(this.$(".card"))),this.teardown_.push(U(this.$(".nu"),{onTap:()=>P(this,this.config.entity),onHold:()=>P(this,this.config.entity)})),this.abonneer_()}async abonneer_(){let e=this.config;this.opzeggen_?.(),this.opzeggen_=null;let t=this.hass?.connection;if(!t?.subscribeMessage){this.forecastFout_="Geen verbinding voor de voorspelling.",this.paintRij_();return}try{let n=await t.subscribeMessage(a=>{this.forecast_=a?.forecast??[],this.forecastFout_=null,this.paintRij_()},{type:"weather/subscribe_forecast",forecast_type:e.forecast_type==="hourly"?"hourly":"daily",entity_id:e.entity});if(!this.isConnected){n();return}this.opzeggen_=n,this.teardown_.push(()=>{try{n()}catch{}this.opzeggen_=null})}catch{this.forecastFout_=e.forecast_type==="hourly"?"Deze weerbron geeft geen uurvoorspelling.":"Deze weerbron geeft geen dagvoorspelling.",this.paintRij_()}}paint(){let e=this.config,t=v(this.hass,e.entity),n=ne(t);this.$(".nu").classList.toggle("unavailable",n);let r=this.$(".chip"),o=e.icon||Ct(t?.state);r.dataset.icon!==o&&(r.dataset.icon=o,r.innerHTML=b(o,"cloud")),this.text(".nm",M(this.hass,e.entity,e.name)),this.text(".st",n?"Niet bereikbaar":ee(this.hass,t));let s=this.$(".graden"),l=t?.attributes?.temperature,d=t?.attributes?.temperature_unit??"\xB0C";s.innerHTML=l==null?"":`${K(this.hass,l,Number.isInteger(l)?0:1)}<small>${d}</small>`,this.paintRij_(),D(this.$(".card"))}paintRij_(){let e=this.$(".rij");if(!e)return;let t=this.config;if(this.forecastFout_&&!this.forecast_?.length){e.style.setProperty("--n",1),e.innerHTML=`<div class="leeg">${this.forecastFout_}</div>`;return}let n=(this.forecast_??[]).slice(0,t.days);if(!n.length){e.style.setProperty("--n",1),e.innerHTML='<div class="leeg">Nog geen voorspelling ontvangen\u2026</div>';return}e.style.setProperty("--n",n.length);let a=v(this.hass,t.entity)?.attributes?.temperature_unit??"";e.innerHTML=n.map((r,o)=>{let s=this.wanneer_(r.datetime,o),l=b(Ct(r.condition),"cloud"),d=r.temperature==null?"":`${K(this.hass,r.temperature,0)}\xB0`,c=r.templow==null?"":`${K(this.hass,r.templow,0)}\xB0`,p=r.precipitation_probability==null?"":`<span class="nat">${b("drop")}${Math.round(r.precipitation_probability)}%</span>`;return`
  ...
  `);var Zi=class extends L{defaults(){return{show_current:!0,forecast_type:"daily",days:sl}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:f.entity("weather")},{name:"name",selector:f.text()},{name:"forecast_type",selector:f.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:f.number(1,ll)},{name:"show_current",selector:f.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};H("domotiapp-forecast-card-editor",Zi);T("domotiapp-forecast-card",Wn,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var xt={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},dl={open_cover:xt.OPEN,close_cover:xt.CLOSE,stop_cover:xt.STOP},cl=(i={},e={},t)=>i[t]??e[t],Xi=(i,e)=>!!cl(i,e,"poort"),Yi=(i,e)=>!!cl(i,e,"invert");function pl(i={},e=!1){if(e||i.device_class==="gate")return{open:"gateOpen",closed:"gate"};switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}}var hl=i=>i?{open:"Openen",close:"Sluiten"}:{open:"Open",close:"Dicht"},Bh={open:"closed",closed:"open",opening:"closing",closing:"opening"},ul=(i,e)=>e?Bh[i]??i:i,Un=(i,e)=>e&&i!=null?100-i:i;function Qi(i,e){if(i==="stop")return"stop_cover";let t=i==="open";return(e?!t:t)?"open_cover":"close_cover"}function ml({state:i,positie:e,aanname:t}){return e!=null?e>0?"open":"closed":i==="open"||i==="closed"?i:t??"closed"}function gl({dood:i,state:e,positie:t,toon:n=!0}){return i?"Niet bereikbaar":n?e==="opening"?"Gaat open":e==="closing"?"Gaat dicht":t!=null?`${t}% open`:e==="open"?"Open":e==="closed"?"Dicht":"":""}var Ji=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Fn=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[R]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e,t){let n=hl(t),a=(r,o,s)=>`<button type="button" class="${t?"tekst":""}" data-act="${r}" aria-label="${o}">${s}</button>`;return`
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o=this.config.covers[+t];this.hass.callService("cover",Qi(r,Yi(o,this.config)),{entity_id:o.entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(U(e.querySelector(".chip"),{onTap:()=>P(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=v(this.hass,n.entity),r=Z(this.hass,n.entity),o=!a||a.state==="unavailable",s=Yi(n,this.config),l=Xi(n,this.config),d=ul(a?.state??"unknown",s);e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=M(this.hass,n.entity,n.name);let c=Ji(a,xt.SET_POSITION)&&r.current_position!=null,p=c?Un(r.current_position,s):null,h=ml({state:d,positie:p,aanname:this.assumed_.get(t)});e.dataset.shown=h;let m=pl(r,l),g=(h==="open"?n.icon_open:n.icon_closed)??(h==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??m[h],k=e.querySelector(".chip");k.dataset.icon!==g&&(k.dataset.icon=g,k.innerHTML=b(g,m[h]));let w=e.querySelector(".st");this.dragging_.has(t)||(w.textContent=gl({dood:o,state:d,positie:p,toon:this.toonStatus_()})),e.querySelectorAll(".keys button").forEach(N=>{let I=Qi(N.dataset.act,s);N.disabled=o||!Ji(a,dl[I])});let x=e.querySelector(".pos"),_=c&&this.config.show_position!==!1;if(x.hidden=!_,_){if(x.dataset.built||(x.dataset.built="1",x.innerHTML=be("position"),x.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let I=x.querySelector(".slider"),ge=he=>{I.style.setProperty("--v",`${he}%`),I.setAttribute("aria-valuenow",String(he)),this.toonStatus_()&&(e.querySelector(".st").textContent=`${he}% open`)};this.teardown_.push(Ve(I,{value:()=>Un(Z(this.hass,n.entity).current_position??0,s),onInput:ge,onCommit:he=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:Un(he,s)})}))}let N=x.querySelector(".slider");if(!N.classList.contains("dragging")){let I=p??0;N.style.setProperty("--v",`${I}%`),N.setAttribute("aria-valuenow",String(I))}}})}toonStatus_(){return this.config.show_state!==!1}rows_(){let e=this.config?.covers??[],t=e.some(n=>Ji(v(this.hass,n.entity),xt.SET_POSITION));return Ae(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};j(Fn,"css",`
    :host { display: block; height: 100%; }
...
`,_l=/^i(\d+)(s\d+)?$/,yl=i=>({...i.name?{name:i.name}:{},...i.icon?{icon:i.icon}:{},...i.path?{path:i.path}:{},...i.action?{action:structuredClone(i.action)}:{}}),jl=i=>i.filter(Fe).map(e=>{let t=(e.items??[]).filter(Fe).map(yl);return{...yl(e),...t.length?{items:t}:{}}}),or=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(n=>Xn(n));this.gebouwd_&&JSON.stringify(jl(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Zh;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:a}=Yn(this.items_,this.rest_.max),r=a.length,o=this.items_.filter(Fe);if(this.items_.forEach((l,d)=>{if(o.indexOf(l)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(l,d))}),!this.items_.length){let l=document.createElement("p");l.className="uitleg",l.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(l)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${et(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:et(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=et(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{let w=!Fe(e);n.dataset.leeg=String(w),r.innerHTML=b(e.icon,"grid"),s.textContent=e.name||(w?"Nieuwe knop":e.path||"Zonder naam");let x=Ue(e).length;l.textContent=x?`Menu met ${x} knop${x===1?"":"pen"}`:e.path?e.path:e.icon?`${He(e.icon)} -- nog geen pad`:"Nog geen pad"};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let m=document.createElement("div");m.className="body";let g=document.createElement("dac-icon-picker");g.label="Icoon",g.fallback="grid",g.auto=!1,g.hass=this.hass_,g.value=e.icon,g.addEventListener("value-changed",w=>{w.stopPropagation(),e.icon=w.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],k.computeLabel=w=>({name:"Naam",path:"Waar gaat hij heen"})[w.name]??w.name,k.computeHelper=w=>{if(w.name!=="path")return;let x="/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.";return vl(e)?`${x}

Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:x},k.data={name:e.name,path:e.path},k.addEventListener("value-changed",w=>{w.stopPropagation();let x=w.detail.value??{};e.name=x.name??"",e.path=x.path??"",this.emit_()}),m.append(g,k,...this.subBlok_(e,t)),n.appendChild(m),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let a=document.createElement("div");a.className="sublijst",e.items.forEach((s,l)=>a.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,a,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let a=document.createElement("summary");a.textContent="\uFF0B  Subknop toevoegen",n.appendChild(a);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=wl(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of xl){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,a){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=b(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",a),r}subItemBlok_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=b(t.icon,"grid"),d.textContent=t.name||(Fe(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsSub_(e,n,a,-1));h.disabled=a===0;let m=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsSub_(e,n,a,1));m.disabled=a===e.items.length-1;let g=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderSub_(e,n,a));g.classList.add("weg"),o.append(s,l,h,m,g),r.appendChild(o);let k=document.createElement("div");k.className="body";let w=document.createElement("dac-icon-picker");w.label="Icoon",w.fallback="grid",w.auto=!1,w.hass=this.hass_,w.value=t.icon,w.addEventListener("value-changed",_=>{_.stopPropagation(),t.icon=_.detail.value??"",this.emit_()});let x=document.createElement("ha-form");return x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],x.computeLabel=_=>({name:"Naam",path:"Waar gaat hij heen"})[_.name]??_.name,t.action&&(x.schema=[{name:"name",selector:{text:{}}}],x.computeHelper=_=>_.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),x.data={name:t.name,path:t.path},x.addEventListener("value-changed",_=>{_.stopPropagation();let N=_.detail.value??{};t.name=N.name??"",t.path=N.path??"",this.emit_()}),k.append(w,x),r.appendChild(k),r}verplaatsSub_(e,t,n,a){let r=n+a;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let a=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){a.add(r);continue}let s=Number(o[2]);s!==n&&a.add(`i${t}s${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let a=_l.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(`i${r>e?r-1:r}${a[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let a of this.open_){let r=_l.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(a)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=jl(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-navbar-card-editor",or);var zl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Ut(i){let e=zl(i),t=0;for(;e&&t++<40;)yield e,e=zl(e)}function Xh(i){for(let e of Ut(i)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Yh(i){for(let e of Ut(i))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Qh(i){for(let e of Ut(i))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Jh(i){for(let e of Ut(i))if(e.classList?.contains?.("section"))return e;return null}function $l(i){for(let e of Ut(i)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Qn=class extends S{validate(e){let t=kl(e),n={labels:!0,tone:"accent",...e,items:t,max:et(e?.max)};return t.filter(a=>a.name||a.icon||a.path).length||(n[R]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:a}=Yn(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let m=Ue(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      <button type="button" class="knop" data-i="${p}" title="${y(c.name)}"${m}>
        <span class="ico">${b(c.icon,"grid")}</span>
        <span class="naam">${y(c.name)}</span>
      </button>`},s=(c,p,h=null,m="")=>`
      <button type="button" class="regel${m?` ${m}`:""}" data-i="${p}"${h===null?"":` data-s="${h}"`}>
      ...
      <div class="regel kop">
        <span class="mi">${b(c.icon,"grid")}</span>
        <span class="mt">${y(c.name||c.path)}</span>
      </div>`+h.map((g,k)=>s(g,p,k,"sub")).join(""):s(c,p)}).join(""),d=t.map(c=>{let p=Ue(c);if(!p.length)return"";let h=r.indexOf(c);return`<div class="menu submenu" data-id="s${h}" role="menu">${p.map((m,g)=>s(m,h,g)).join("")}</div>`}).join("");return`
  ...
  `);T("domotiapp-navbar-card",Qn,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var eu="dac-tabs:";function dr(i){let e=i??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],a=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:a}}var Jn=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.cards?.length));function El(i){return(Array.isArray(i?.tabs)?i.tabs:[]).slice(0,8).map(dr).filter(Jn)}function tu(i,e){if(!e)return 0;let t=Math.round(Number(i?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function cr(i){let e=(i??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return eu+e}function nu(i,e,t){let n=null;try{n=i?.getItem?.(e)??null}catch{return null}let a=Number(n);return n===null||n===""||!Number.isInteger(a)?null:a>=0&&a<t?a:null}function Al(i,e,t){try{return i?.setItem?.(e,String(t)),!0}catch{return!1}}function Ml(i,e,t){return nu(t,cr(e),e.length)??tu(i,e.length)}var au=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function Sl(){let i=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return i.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,a=t.type.startsWith("custom:domotiapp-")?0:1;return n-a||e.naam.localeCompare(t.naam,"nl")}),[...i,...au.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function Nl(i,e){let t=String(e??"").trim().toLowerCase();return t?i.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):i}async function Tl(i,e){let t={type:i};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let a=i.startsWith("custom:")?i.slice(7):`hui-${i}-card`,o=await customElements.get(a)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:i}}catch{}return t}var Ol=()=>!!customElements.get("hui-card-element-editor");function Dl(i,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},a=i,r=n(e),o=n(t);return r!==null&&(a=Math.max(a,r)),o!==null&&(a=Math.min(a,o)),a}function iu(i,e){let t=i?.columns,n=i?.rows,a=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));a=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}a=Math.min(12,Math.max(1,Dl(a,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${a}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,Dl(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function Ft(i,e,t){if(!i?.style)return;let{gridColumn:n,height:a}=iu(e,t);i.style.gridColumn=n,i.style.height=a??""}function Ll(i){let e=i?._element??i?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function Cl(i,e,t={}){let n=Array.isArray(i)?[...i]:[],a=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(a)||!n[a]?null:(n.splice(a+1,0,structuredClone(n[a])),n);case"verwijder":return!Number.isInteger(a)||!n[a]?null:(n.splice(a,1),n);case"rooster":return!Number.isInteger(a)||!n[a]||!t.rooster?null:(n[a]={...n[a],grid_options:{...n[a].grid_options??{},...t.rooster}},n);default:return null}}var Rl=i=>({...i?{config:i}:{},editMode:!0,saveConfig:async()=>{}}),ru=()=>document.querySelector("home-assistant");function Hl({kaarten:i,hass:e,maakKaart:t,opActie:n}){let a=document.createElement("ha-sortable");a.disabled=!1,a.draggableSelector=".dac-kaart",a.rollback=!1,a.invertSwap=!0,a.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];i.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",Ft(h,d?.grid_options);let m=document.createElement("hui-card-edit-mode");m.hass=e,m.lovelace=Rl(),m.path=[0,0,c],m.hiddenOverlay=!1,m.appendChild(p),o.push(m),h.appendChild(m),r.appendChild(h)}),a.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};a.addEventListener("drag-start",()=>s(!1)),a.addEventListener("drag-end",()=>s(!0)),a.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))a.addEventListener(d,p=>{p.stopPropagation(),c(p)});return a}function Vl(i){try{let e=typeof structuredClone=="function"?structuredClone(i):JSON.parse(JSON.stringify(i));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Il({hass:i,kaarten:e}){let t=ru();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let a=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(a?{kaart:a}:r?{kaarten:r}:null))},l=m=>{if(m?.detail?.dialogTag!=="hui-dialog-edit-card")return;let g=m.detail?.dialogParams?.cardConfig;m.stopImmediatePropagation?.(),m.stopPropagation(),g&&(a=g);let k=t.querySelector("hui-dialog-create-card");typeof k?.closeDialog=="function"&&k.closeDialog(),setTimeout(s,0)},d=m=>{m?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=i,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Rl({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async m=>{let g=m?.views?.[0]?.sections?.[0]?.cards;Array.isArray(g)&&(r=g)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let m=p._layoutElement;if(!m)throw new Error("de proxysectie heeft geen layout-element");m.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(m){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",m),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var ea=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var ou=`
...
`,Pl=i=>i.filter(Jn).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function wt(i){let e=String(i?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function pr(i){let e=i.cards?.length??0;return e?e===1?wt(i.cards[0]):`${e} kaarten`:"Nog geen kaart"}var hr=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(dr);this.gebouwd_&&JSON.stringify(Pl(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=ou;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let a=document.createElement("button");a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Tabblad toevoegen",a.disabled=this.tabs_.length>=8,a.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(a)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},a=Number(n.default_tab);Number.isFinite(a)&&a>1?this.rest_.default_tab=a:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!Jn(e)),r.innerHTML=b(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=pr(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let m=document.createElement("div");m.className="body";let g=document.createElement("dac-icon-picker");g.label="Icoon",g.fallback="grid",g.auto=!1,g.hass=this.hass_,g.value=e.icon,g.addEventListener("value-changed",w=>{w.stopPropagation(),e.icon=w.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",w=>{w.stopPropagation(),e.name=w.detail.value?.name??"",this.emit_()}),m.append(g,k,this.inhoudBlok_(e,t)),n.appendChild(m),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!Ol()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${b("grid")}<span>Inhoud: <b>${pr(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(ea()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${b("grid")}<span>${e.cards.length?`<b>${pr(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let a=document.createElement("button");return a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Kaart toevoegen",a.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(a),n}uitVoorbeeld(e,t,n){let a=this.tabs_[e];if(a){if(t==="toevoegen"){this.voegToeViaHa_(a,e);return}this.kaartActie_(a,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,a=Number.isInteger(t)?this.tabs_[t]:null;if(!a||!a.cards[n]){e?.remove();return}let r=this.bewerkVak_(a,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,a){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==a.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:a.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Vl(e.cards[a.index]);return}let r=Cl(e.cards,n,a);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let a=document.createElement("div");a.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=wt(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&a.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=wt(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||a.append(r,l),a}kaartTabbladen_(e,t,n,a,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let m of l.querySelectorAll("button"))m.setAttribute("aria-selected",String(m.dataset.blad===h));a.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let m=document.createElement("button");m.type="button",m.dataset.blad=h.id,m.textContent=h.naam,m.setAttribute("role","tab"),m.setAttribute("aria-selected","false"),m.addEventListener("click",()=>c(h.id)),l.appendChild(m)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,a,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[a],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[a]=l,o.config=l,this.emit_(),r.textContent=wt(l))}),o}async voegToeViaHa_(e,t){let n=await Il({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=b("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=wt(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsKaart_(e,n,a,-1));p.disabled=a===0;let h=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsKaart_(e,n,a,1));h.disabled=a===e.cards.length-1;let m=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderKaart_(e,n,a));m.classList.add("weg"),o.append(s,l,p,h,m),r.appendChild(o);let g=document.createElement("div");g.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",w=>{w.stopPropagation();let x=w.detail?.config;x&&(e.cards[a]=x,this.emit_(),d.textContent=wt(x),c.textContent=String(x.type??""))}),k.addEventListener("GUImode-changed",w=>w.stopPropagation()),g.appendChild(k),r.appendChild(g),r}verplaatsKaart_(e,t,n,a){let r=n+a;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let a=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){a.add(r);continue}let s=Number(o[1]);s!==n&&a.add(`t${t}k${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let a=document.createElement("input");a.type="text",a.placeholder="Zoek een kaart...",a.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=Nl(Sl(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await Tl(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),a.addEventListener("input",()=>{this.zoek_=a.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(a,r,s),n}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let a=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),a&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Number(n.slice(1));a!==e&&t.add(`t${a>e?a-1:a}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Pl(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-tabs-card-editor",hr);var Kl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Wl(i){let e=Kl(i),t=0;for(;e&&t++<40;)yield e,e=Kl(e)}function Gl(i){let e=null;for(let n of Wl(i))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,a=0)=>{if(!n||a>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,a+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,a+1);if(o)return o}return null};return t(e)}var na=class extends S{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=El(e),n={tone:"accent",...e,tabs:t};return t.length||(n[R]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((a,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(V(this.$(".card"))),this.kies_(Ml(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let a=Math.min(Math.max(0,e),n.length-1);this.open_=a;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===a));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===a);t&&Al(this.opslag_(),cr(n),a),this.bouw_(a)}async bouw_(e){if(this.kinderen_.has(e)){D(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let a=document.createElement("div");a.className="leeg",a.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(a),D(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Gl(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,Ft(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&ea()){t.replaceChildren(Hl({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),D(this.$(".card"));return}t.replaceChildren(...s),D(this.$(".card")),this.herijkIndeling_()}catch(a){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${y(a?.message??a)}</div>`,D(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,a]of this.kinderen_.entries()){if(!a)continue;let r=this.config?.tabs?.[n]?.cards??[];a.forEach((o,s)=>{let l=Ll(o);l&&(t=!0),Ft(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),D(this.$(".card"));return}if(t<=0)return;let a=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(a))}inVoorbeeld_(){for(let e of Wl(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Gl(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};j(na,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);T("domotiapp-tabs-card",na,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var F={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},su=[[F.FOUT,["error","fout","aborting","afgebroken"]],[F.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[F.PAUZE,["pause","paused","pauze","onderbroken"]],[F.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[F.AF,["finished","complete","done","klaar met","afgelopen"]],[F.KLAAR,["ready","idle","standby","klaar","gereed"]],[F.UIT,["off","inactive","uit"]]],lu=new Set([F.DRAAIT]);function Fl(i){let e=String(i??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return F.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,a]of su)for(let r of a)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return F.ONBEKEND}var ql=i=>lu.has(Fl(i?.state));function Zl(i,e=new Date){if(!i)return null;let t=String(i.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=i.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let a=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(a)return Number(a[1])*60+Number(a[2])+(a[3]?Math.round(Number(a[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function Ul(i){if(i==null)return"";if(i<=0)return"Klaar";if(i<60)return`nog ${i} min`;let e=Math.floor(i/60),t=i%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Xl(i){if(!i)return null;let e=String(i.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var du=i=>!!i&&i.state==="on",Yl=i=>i===F.DRAAIT||i===F.PAUZE||i===F.UITGESTELD;function Ql({status:i,deur:e,rest:t,pct:n}={}){let a=Fl(i?.state),r=du(e);if(a===F.DRAAIT){let o=[];return t!=null?o.push(Ul(t)):n!=null&&o.push(`${n}%`),{soort:a,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return a===F.PAUZE?{soort:a,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:a===F.FOUT?{soort:a,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:a===F.AF?{soort:a,tekst:"Programma klaar",tone:"good",waarschuwing:""}:a===F.UITGESTELD?{soort:a,tekst:t!=null?`Start over ${Ul(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:a,tekst:"Klep open",tone:"warn",waarschuwing:""}:a===F.UIT?{soort:a,tekst:"Uit",tone:"neutral",waarschuwing:""}:a===F.KLAAR?{soort:a,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:F.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function Jl(i){let e=String(i??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var cu={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},aa=class extends S{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[R]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,a,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var ur=class extends L{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"program",selector:f.entity(["select","input_select"])},{name:"start",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"smart",selector:f.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};H("domotiapp-dishwasher-card-editor",ur);T("domotiapp-dishwasher-card",aa,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});function pu(i,e,t,{live:n=!1,fit:a="cover"}={}){if(!t)return null;let r=typeof customElements<"u"&&customElements.get("hui-image"),o=r?"hui-image":"img",s=i;if((!s||s.localName!==o)&&(s=document.createElement(o),s.className="beeld"),r){let l=n?"live":"auto";s.cameraImage!==t&&(s.cameraImage=t),s.cameraView!==l&&(s.cameraView=l),s.fitMode!==a&&(s.fitMode=a),s.hass=e}else{let l=e?.states?.[t],d=l?.attributes?.entity_picture;d&&s.dataset.bron!==d&&(s.dataset.bron=d,s.src=d),s.alt=l?.attributes?.friendly_name??t,s.style.objectFit=a}return s}function ia(i,e,t,n){if(!i)return null;let a=i.querySelector(".beeld"),r=pu(a,e,t,n);return r?(r!==a&&(a?.remove(),i.appendChild(r)),r):(a?.remove(),null)}var mr={idle:{woord:"Klaar voor gebruik",toon:"neutral"},printing:{woord:"Aan het printen",toon:"accent"},paused:{woord:"Gepauzeerd",toon:"warn"},finished:{woord:"Klaar",toon:"good"},failed:{woord:"Mislukt",toon:"bad"},offline:{woord:"Offline",toon:"neutral"},prepare:{woord:"Voorbereiden",toon:"accent"},unknown:{woord:"Onbekend",toon:"neutral"}},hu={idle:["idle","operational","standby","ready","on","off"],printing:["printing","running","run","print","busy","active"],paused:["pause","paused","pausing"],finished:["finish","finished","complete","completed","done","success"],failed:["failed","fail","error","cancelled","canceled","stopped"],prepare:["prepare","preparing","heating","slicing","init"],offline:["offline","unavailable","unknown","disconnected"]};function gr(i){let e=String(i?.state??"").trim().toLowerCase();if(!e)return"unknown";if(e==="unavailable"||e==="none")return"offline";for(let[t,n]of Object.entries(hu))if(n.includes(e))return t;return"unknown"}function ra(i){let e=gr(i);return e==="printing"||e==="prepare"}function fr(i){let e=Number(i?.state);return Number.isFinite(e)?Math.max(0,Math.min(100,Math.round(e))):null}function br(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"\xB0C"}:null}function vr(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let o=Date.parse(t);if(Number.isFinite(o))return Math.max(0,Math.round((o-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let o=t.split(":").map(Number),[s,l]=o.length===3?o:[0,o[0]];return s*60+l}let a=Number(t);if(!Number.isFinite(a))return null;let r=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return r==="h"||r==="u"||r.startsWith("hour")?Math.round(a*60):r==="s"||r.startsWith("sec")?Math.round(a/60):Math.round(a)}function kr(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function xr(i,e=new Date){if(i==null)return"";let t=new Date(e.getTime()+i*6e4);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var uu=new Set(["unknown","unavailable","none","null","empty","leeg","off","unload","unloaded"]);function tt(i,{namen:e=!1}={}){if(typeof i!="string")return null;let t=i.trim();if(!t)return null;let n=t.replace(/^#/,"");return/^[0-9a-f]{8}$/i.test(n)?parseInt(n.slice(6),16)<16?null:`#${n.slice(0,6).toUpperCase()}`:/^[0-9a-f]{6}$/i.test(n)?`#${n.toUpperCase()}`:/^[0-9a-f]{3}$/i.test(n)?`#${n.toUpperCase()}`:/^rgba?\(/i.test(t)?t:!e||uu.has(t.toLowerCase())?null:/^[a-z]+$/i.test(t)?t:null}function ed(i,e={}){let t=i?.attributes??{},n=tt(e.color,{namen:!0})??tt(t.color)??tt(Array.isArray(t.cols)?t.cols[0]:t.cols)??tt(t.filament_color)??tt(t.tray_color)??(/^#?[0-9a-f]{3,8}$/i.test(String(i?.state??""))?tt(i.state):null)??null,a=e.label||t.type||t.filament_type||t.tray_type||t.name||(i&&!tt(i.state)?i.state:"")||"",r=t.empty===!0||t.empty==="true"?!0:!n&&!String(a).trim(),o=Number(t.remain??t.remaining),s=t.remain_enabled!==!1&&!r;return{kleur:r?null:n,soort:String(a).trim(),leeg:r,actief:t.active===!0||t.active==="true",rest:s&&Number.isFinite(o)&&o>=0&&o<=100?Math.round(o):null}}var _t=[1,2,3,4],mu={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},oa=class extends S{validate(e){let t={name:"",icon:"printer3d",...e};return t.status||t.progress||t.camera||t.image||t.nozzle_temp||t.bed_temp||t.power||(t[R]="Kies minstens een printstatus. Camera, voortgang, temperaturen, de deur en de trays van de AMS mogen daarna."),t}watched(){let e=this.config;return[e.status,e.progress,e.remaining,e.nozzle_temp,e.bed_temp,e.door,e.power,e.camera,e.image,..._t.map(t=>e[`tray_${t}`])].filter(Boolean)}beeldSoort_(){let e=this.config;return e.camera&&e.image?this.beeld_??(ra(v(this.hass,e.status))?"camera":"image"):e.camera?"camera":e.image?"image":null}template(){return this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`
      <div class="card surface" style="--tone:${E.accent}">
        <div class="kop">
  ...
  `);var wr=class extends L{defaults(){return{icon:"printer3d"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer3d",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"power",selector:f.entity(["switch","input_boolean"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"nozzle_temp",selector:f.entity(["sensor","number"])},{name:"bed_temp",selector:f.entity(["sensor","number"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"camera",selector:f.entity("camera")},{name:"live_view",selector:f.bool()},{name:"image",selector:f.entity(["image","camera"])},..._t.flatMap(e=>[{name:`tray_${e}`,selector:f.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:f.text()},{name:`tray_${e}_label`,selector:f.text()}])]}label(e){let t={};for(let n of _t)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};H("domotiapp-printer-card-editor",wr);T("domotiapp-printer-card",oa,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var yt={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},_r=i=>i==="electric"||i==="hybrid",yr=i=>i==="fuel"||i==="hybrid",gu=["charging","charge","fast_charging","dc_charging","on","true","laden"],fu=["complete","completed","fully_charged","full","done","finished"],bu=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],vu=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function td(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:gu.includes(e)?"charging":fu.includes(e)?"complete":bu.includes(e)?"connected":vu.includes(e)?"idle":"onbekend"}function nd(i,e){if(i&&i!=="onbekend")return sa[i]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var sa={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function jr(i,e){let t=Number(i?.state);if(!Number.isFinite(t))return null;let n=String(i?.attributes?.unit_of_measurement??"").toLowerCase(),a=Number(e);return n!=="%"&&Number.isFinite(a)&&a>0?Math.max(0,Math.min(100,Math.round(t/a*100))):Math.max(0,Math.min(100,Math.round(t)))}function ad(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"km"}:null}function zr(i){if(i==null)return null;let e=i<=10?"bad":i<=20?"warn":"good";return{procent:i,toon:e}}function $r(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let a=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return a==="h"||a.startsWith("hour")?Math.round(n*60):a==="s"||a.startsWith("sec")?Math.round(n/60):Math.round(n)}function Er(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function id({open:i,slot:e,laden:t,laadMinuten:n,radius:a,aandrijving:r}){if(i)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${Er(n)}`:"";return{tekst:`${sa.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:sa.complete,toon:"good"}:t==="connected"?{tekst:sa.connected,toon:"neutral"}:a?{tekst:`Nog ${a.waarde} ${a.eenheid}`,toon:"neutral"}:{tekst:yt[r]?.label??"",toon:"neutral"}}var ku=100,xu=["home","thuis","at_home","athome"],wu=["not_home","away","afwezig","weg","not home","nothome"];function _u(i,e,t,n){let r=d=>d*Math.PI/180,o=r(t-i),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(i))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function yu(i){let e=i?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let a=String(i?.state??""),r=a.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=a.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function rd(i,e,t=ku){if(!i)return{thuis:null,tekst:"",meters:null};let n=String(i.state??"").trim(),a=n.toLowerCase();if(a==="unavailable"||a==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(xu.includes(a))return{thuis:!0,tekst:"Thuis",meters:null};if(wu.includes(a))return{thuis:!1,tekst:"Afwezig",meters:null};let r=yu(i),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=_u(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var ju=["open","opened","ajar","unlatched","on","true","unlocked"],zu=["closed","close","shut","secured","locked","off","false","not_open"];function Ar(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:ju.includes(e)?!0:zu.includes(e)?!1:/(^|[^a-z])(ajar|open)([^a-z]|$)/.test(e)?!0:null}function od(i){let e=String(i?.state??"").trim().toLowerCase();if(!e||e==="unavailable"||e==="unknown")return null;if(String(i?.entity_id??"").split(".")[0]==="lock")return e==="locked"?!0:e==="unlocked"||e==="open"||e==="opening"?!1:null;if(i?.attributes?.device_class==="lock"){if(e==="on")return!1;if(e==="off")return!0}return["locked","lock","secured","closed","off","false"].includes(e)?!0:["unlocked","unlock","open","unsecured","on","true"].includes(e)?!1:null}var Mr={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},la=class extends S{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[R]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return yt[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      ...
      </div>`}wire(){this.teardown_.push(V(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;P(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&P(this,t.dataset.id)})}paint(){let e=this.config,t=this.soort_(),n=_r(t)?jr(v(this.hass,e.battery),e.battery_max):null,a=yr(t)?jr(v(this.hass,e.fuel),e.fuel_max):null,r=ad(v(this.hass,e.range)),o=td(v(this.hass,e.charging)),s=$r(v(this.hass,e.charging_ready)),l=v(this.hass,e.lock),d=Ar(v(this.hass,e.doors)),c=Ar(v(this.hass,e.windows)),p=d===!0||c===!0,h=od(l),m=rd(v(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),g=e.battery&&!v(this.hass,e.battery)&&e.range&&!v(this.hass,e.range);this.toggleAttribute("dead",!!g),this.text(".nm",e.name||M(this.hass,e.battery||e.range||e.lock,"Auto"));let k=id({open:p,slot:h===!1?"unlocked":h===!0?"locked":null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",k.tekst),this.$(".st").style.setProperty("--melding",Mr[k.toon]??E.neutral),this.paintFoto_(),this.paintBalken_({accu:n,tank:a,radius:r,laden:o,soort:t}),this.paintTegels_(m,o,{slot:h,deurOpen:d,raamOpen:c}),D(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=b(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=b(this.config.icon||"car")},e.replaceChildren(n)}paintBalken_({accu:e,tank:t,radius:n,laden:a,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=zr(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:a==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:a==="charging"})}if(t!==null){let h=zr(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":yt[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=$r(v(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,m)=>{let g=m===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,k=h.laadt&&c?` \xB7 nog ${this.veilig_(Er(c))}`:"";return`
...
`;var rt=["ma","di","wo","do","vr","za","zo"],$t={ma:"maandag",di:"dinsdag",wo:"woensdag",do:"donderdag",vr:"vrijdag",za:"zaterdag",zo:"zondag"},Bu=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],Bd=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],xa=i=>String(i).padStart(2,"0"),Qt=i=>rt[(i.getDay()+6)%7],Se=i=>`${i.getFullYear()}-${xa(i.getMonth()+1)}-${xa(i.getDate())}`,Ne=i=>`${xa(i.getHours())}:${xa(i.getMinutes())}`,Jt=i=>`${Se(i)}T${Ne(i)}`,Pd=i=>`${$t[Qt(i)]} ${i.getDate()} ${Bu[i.getMonth()]}`;function Kd(i,e){let t=Se(i);if(t===Se(e))return"vandaag";let n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1);return t===Se(n)?"morgen":$t[Qt(i)]}function Pu(i,e){let t=e.length===10?`${e}T00:00`:e,n=i?.van?i.van.length===10?`${i.van}T00:00`:i.van:null,a=i?.tot?i.tot.length===10?`${i.tot}T23:59`:i.tot:null;return!(n&&n>t||a&&a<t)}var Br=(i,e)=>(i??[]).filter(t=>t.tekst&&Pu(t,e));function Gd(i){return(i??[]).filter(e=>e.titel).map(e=>({...e,eigen:!1})).sort((e,t)=>String(t.datum??"").localeCompare(String(e.datum??"")))}function Pr(i,e){let t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=[];for(let a of i??[]){if(!a?.naam||!a?.datum)continue;let[r,o,s]=a.datum.split("-").map(Number);if(!o||!s)continue;let l=new Date(t.getFullYear(),o-1,s);l<t&&(l=new Date(t.getFullYear()+1,o-1,s));let d=Math.round((l-t)/864e5),c=a.jaar_tonen!==!1&&r>1900?l.getFullYear()-r:null;n.push({...a,dagen:d,leeftijd:c,wanneer:d===0?"vandaag":d===1?"morgen":`${rt[(l.getDay()+6)%7]} ${l.getDate()} ${Bd[l.getMonth()]}`})}return n.sort((a,r)=>a.dagen-r.dagen||a.naam.localeCompare(r.naam,"nl"))}var Ku=i=>i?.length?i.map(([e,t])=>`${e} \u2013 ${t}`).join(", "):"gesloten";function Kr(i,e){let t=Se(e),n=i?.openingstijden?.[Qt(e)]??[],a="";for(let r of i?.uitzonderingen??[])r.datum===t&&(n=r.tijden??[],a=r.reden??"");return{tijden:n,reden:a}}function en(i,e){let{tijden:t,reden:n}=Kr(i,e),a=Ne(e),r=t.find(([s,l])=>s<=a&&a<l),o=t.find(([s])=>s>a);return{open:!!r,tot:r?r[1]:null,straks:o?o[0]:null,tijden:t,reden:n}}function Gu(i,e){let t=en(i,e);if(t.straks)return{dag:"vandaag",tijd:t.straks};for(let n=1;n<=14;n+=1){let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()+n),{tijden:r}=Kr(i,a);if(r.length)return{dag:n===1?"morgen":$t[Qt(a)],tijd:r[0][0]}}return null}function Wd(i,e){let t=Qt(e);return rt.map(n=>{let a=n===t?Kr(i,e):null,r=a?a.tijden:i?.openingstijden?.[n]??[];return{dag:n,naam:$t[n],tekst:Ku(r),reden:a?.reden??"",vandaag:n===t}})}var Gr=i=>rt.some(e=>(i?.openingstijden?.[e]??[]).length>0);function Ud(i){return(i?.installatie?.verlichting?.length??0)>0?i?.instellingen?.verlichting_tonen!==!1:!1}function Wr(i,e){let t=["welkom"];return(i?.personen?.length??0)>0&&t.push("aanwezig"),(e?.length??0)>0&&t.push("nieuws"),i?.installatie?.weer&&t.push("weer"),Ud(i)&&t.push("verlichting"),(i?.installatie?.agendas?.length??0)>0&&t.push("agenda"),(i?.verjaardagen?.length??0)>0&&t.push("verjaardagen"),t}function Ur(i){let e=String(i??"").trim().split(/\s+/).filter(Boolean);return e.length?e.length===1?e[0].slice(0,2).toUpperCase():(e[0][0]+e[e.length-1][0]).toUpperCase():"?"}function Fd(i){let e=new Map;for(let t of i??[]){let n=t.functie||"";e.has(n)||e.set(n,[]),e.get(n).push(t)}return[...e].map(([t,n])=>({functie:t,personen:n}))}function Fr(i){let e=i??[];return{aanwezig:e.filter(t=>t.aanwezig),afwezig:e.filter(t=>!t.aanwezig)}}function qd(i){let{aanwezig:e,afwezig:t}=Fr(i);return[...e,...t]}function qr(i,e){if(!i)return"";let t=new Date(i);if(Number.isNaN(t.getTime()))return"";let n=Math.round((e-t)/6e4);if(n<1)return"zojuist";if(n<60)return`${n} min geleden`;if(Se(t)===Se(e))return`vandaag ${Ne(t)}`;let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()-1);return Se(t)===Se(a)?`gisteren ${Ne(t)}`:`${t.getDate()} ${Bd[t.getMonth()]}`}function Zd(i,e){let t=en(i,e),n=["Gesloten"];t.reden&&n.push(t.reden);let a=Gu(i,e);return a&&n.push(`${a.dag} open om ${a.tijd}`),n.join(" \xB7 ")}var Te=6,Oe=6,Ze={welkom:{naam:"Welkom",icoon:"house",pagina:null,aantal:!1,maat:[6,1]},weer:{naam:"Weer",icoon:"sun",pagina:"weer",aantal:!1,maat:[2,2]},mededeling:{naam:"Mededelingen",icoon:"bell",pagina:null,aantal:!1,maat:[2,1]},openingstijden:{naam:"Openingstijden",icoon:"clock",pagina:null,aantal:!1,maat:[2,3]},aanwezig:{naam:"Aanwezig",icoon:"people",pagina:"aanwezig",aantal:!0,maat:[2,3]},nieuws:{naam:"Nieuws",icoon:"news",pagina:"nieuws",aantal:!0,maat:[2,4]},verlichting:{naam:"Verlichting",icoon:"bulb",pagina:"verlichting",aantal:!0,maat:[2,1]},agenda:{naam:"Agenda",icoon:"calendar",pagina:"agenda",aantal:!0,maat:[2,2]},verjaardagen:{naam:"Verjaardagen",icoon:"cake",pagina:"verjaardagen",aantal:!0,maat:[2,2]}},Xd=Object.keys(Ze);function wa(){return{blokken:[["welkom",0,0,6,1,0],["weer",0,1,2,2,0],["aanwezig",2,1,2,3,4],["nieuws",4,1,2,5,3],["openingstijden",0,3,2,3,0],["mededeling",2,4,2,1,0],["verlichting",2,5,2,1,4]].map(([e,t,n,a,r,o])=>({id:`std-${e}`,soort:e,x:t,y:n,w:a,h:r,aantal:o}))}}var Zr=(i,e)=>i.x<e.x+e.w&&e.x<i.x+i.w&&i.y<e.y+e.h&&e.y<i.y+i.h,Wu=i=>i.x>=0&&i.y>=0&&i.w>=1&&i.h>=1&&i.x+i.w<=Te&&i.y+i.h<=Oe;function _a(i,e){return Wu(e)?!(i??[]).some(t=>t.id!==e.id&&Zr(t,e)):!1}function Xr(i,e,t){for(let n=0;n+t<=Oe;n+=1)for(let a=0;a+e<=Te;a+=1)if(_a(i,{id:"",x:a,y:n,w:e,h:t}))return{x:a,y:n};return null}function ya(i,e,t,n){let a=e??{};switch(i){case"welkom":return null;case"weer":return a.installatie?.weer?null:"Geen weerentiteit gekozen (kaartinstellingen van het infoscherm)";case"mededeling":return Br(a.mededelingen,n).length?null:"Geen mededeling die nu geldt";case"verjaardagen":return(a.verjaardagen?.length??0)>0?null:"Nog geen verjaardagen";case"openingstijden":return Gr(a.praktijk)?null:"Geen openingstijden ingevuld";case"aanwezig":return(a.personen?.length??0)>0?null:"Nog geen medewerkers";case"nieuws":return null;case"verlichting":return(a.installatie?.verlichting?.length??0)>0?Ud(a)?null:"Verlichting staat uit in het beheer":"Geen lampen gekozen (kaartinstellingen van het infoscherm)";case"agenda":return(a.installatie?.agendas?.length??0)>0?null:"Geen agenda gekozen (kaartinstellingen van het infoscherm)";default:return"Onbekend blok"}}var eo="domotiapp-infoscherm-card",ja=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,tn={news:ja('<rect x="3.4" y="4.6" width="17.2" height="14.8" rx="2"/><path d="M7.2 9.2h9.6M7.2 12.6h9.6M7.2 16h5.6"/>'),cake:ja('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),offline:ja('<path d="M3.4 6.8a13.6 13.6 0 0 1 17.2 0M6.6 10.4a9 9 0 0 1 10.8 0M9.8 14a4.4 4.4 0 0 1 4.4 0"/><circle cx="12" cy="18" r="1"/><path d="M4 4l16 16"/>'),back:ja('<path d="m14.6 6.2-5.6 5.8 5.6 5.8"/>')},Yd=i=>tn[i]??b(i),za={aanwezig:{eyebrow:"Wie is er vandaag",titel:"Aanwezig",onder:"Tik op uw naam om u aan of af te melden."},nieuws:{eyebrow:"Nieuws",titel:"Wat er speelt",onder:""},weer:{eyebrow:"Weer",titel:"De komende dagen",onder:""},verlichting:{eyebrow:"Verlichting",titel:"Lampen",onder:"Tik op een lamp om hem aan of uit te zetten."},agenda:{eyebrow:"Agenda",titel:"Vandaag",onder:""},verjaardagen:{eyebrow:"Verjaardagen",titel:"Wie is er binnenkort jarig",onder:""}},Qr={weather:"",lights:[],calendars:[],kiosk_users:[]},Yr=i=>Array.isArray(i)?i.filter(e=>typeof e=="string"&&e):typeof i=="string"&&i?[i]:[],Uu=`
  :host { display: block; height: 100%; }
  ...
  ${Id}
`,Et=class extends S{constructor(){super(),this.stand_=null,this.feeds_=[],this.pagina_="welkom",this.uren_=[],this.dagen_=[],this.afspraken_=[],this.herkansing_=new se(()=>this.haal_()),this.verbinding_=new we,this.fout_=null,this.html_=new Map,this.weerEntiteit_=null,this.weerOpzeggen_=[],this.agendaSleutel_="",this.laatstGesynct_="",this.mAuto_=0}validate(e){return{...Qr,...e,weather:typeof e.weather=="string"?e.weather:"",lights:Yr(e.lights),calendars:Yr(e.calendars),kiosk_users:Yr(e.kiosk_users)}}installatie_(){let e=this.config??Qr,t=new Map((this.stand_?.installatie?.verlichting??[]).map(n=>[n.entity,n.naam]));return{weer:e.weather||null,agendas:e.calendars,verlichting:e.lights.map(n=>({entity:n,naam:t.get(n)??""}))}}standNu_(){return this.stand_?{...this.stand_,installatie:this.installatie_()}:null}async sync_(){if(!this.hass?.connection||!this.stand_||!this.hass.user?.is_admin)return;let e=this.config,t={weer:e.weather||null,agendas:e.calendars,verlichting:e.lights,kiosk_gebruikers:e.kiosk_users},n=JSON.stringify(t),a=this.stand_.installatie??{},r=JSON.stringify({weer:a.weer??null,agendas:a.agendas??[],verlichting:(a.verlichting??[]).map(o=>o.entity),kiosk_gebruikers:this.stand_.instellingen?.kiosk_gebruikers??[]});if(!(n===r||n===this.laatstGesynct_)){this.laatstGesynct_=n;try{await Ad(this.hass,t)}catch{this.laatstGesynct_=""}}}watched(){let e=this.installatie_();return[e.weer,"sun.sun",...e.verlichting.map(t=>t.entity)].filter(Boolean)}getCardSize(){return 12}template(){let e=t=>`
      ...
      <div class="l-tekst"><div class="l-naam">${y(c)}</div><div class="l-status">${d}</div></div>
    </div>`}htmlAfspraak_(e){let n=!String(e.start).includes("T")?"hele dag":`${Ne(new Date(e.start))}${e.end?` \u2013 ${Ne(new Date(e.end))}`:""}`,a=Z(this.hass,e.kalender).friendly_name??e.kalender,r=this.installatie_().agendas.length>1;return`<div class="afspraak"><span class="a-tijd">${y(n)}</span><span class="a-tekst">${y(e.summary??"")}</span>${r?`<span class="a-kalender">${y(a)}</span>`:""}</div>`}paintPaginas_(){Wr(this.standNu_(),this.feeds_).includes(this.pagina_)||(this.pagina_="welkom");for(let t of this.$$(".pagina"))t.classList.toggle("actief",t.dataset.p===this.pagina_)}paintPagina_(e){if(e!==this.pagina_||e==="welkom")return;let t=this.$(`.p-inhoud[data-p="${e}"]`);if(!t)return;let n=this.stand_?.scherm??{};switch(e){case"aanwezig":{let a=this.stand_?.personen??[],r=d=>`<div class="tegels">${d.map(c=>this.htmlPersoon_(c)).join("")}</div>`,o=n.aanwezig_weergave??"gescheiden",s;if(o==="functie"){let d=Fd(a);s=`<div class="kolommen ${d.length>=3?"drie":"twee"}">${d.map(c=>`<div class="kolom"><div class="eyebrow">${y(c.functie||"Overig")} \xB7 ${c.personen.length}</div>${r(c.personen)}</div>`).join("")}</div>`}else if(o==="lijst")s=`<div class="tegels kol-3">${a.map(d=>this.htmlPersoon_(d)).join("")}</div>`;else{let{aanwezig:d,afwezig:c}=Fr(a);s=`<div class="kolommen twee">
          ...
          </div>`}this.vul_(t,s);let l=a.filter(d=>d.aanwezig).length;this.text(".pagina[data-p='aanwezig'] .pk-titel",n.aanwezig_teller!==!1&&a.length?`${l} van ${a.length} aanwezig`:"Aanwezig");break}case"nieuws":{let a=this.nieuws_();this.vul_(t,a.length?`<div class="nieuws-raster">${a.map(r=>this.htmlBericht_(r,!0)).join("")}</div>`:'<div class="leeg">Er is op dit moment geen nieuws.</div>');break}case"weer":{this.vul_(t,`<div class="weerpagina">${this.htmlWeerNu_()}${this.htmlUren_(8)}${this.htmlDagen_()}</div>`,!1);break}case"verlichting":{let a=this.installatie_().verlichting;this.vul_(t,`<div class="lampen kol-3">${a.map(r=>this.htmlLamp_(r)).join("")}</div>`,!1);break}case"verjaardagen":{let a=Pr(this.stand_?.verjaardagen,new Date);this.vul_(t,a.length?`<div class="vj-raster">${a.map(r=>this.htmlVerjaardag_(r)).join("")}</div>`:'<div class="leeg">Geen verjaardagen.</div>',!1);break}case"agenda":{let a=this.afspraken_;this.vul_(t,a.length?`<div class="afspraken">${a.map(r=>this.htmlAfspraak_(r)).join("")}</div>`:'<div class="leeg">Geen afspraken vandaag.</div>',!1);break}default:}}paintMerkje_(){let e=this.$(".merkje");if(!e)return;let t=this.hass?.connected===!1;e.classList.toggle("open",t||!!this.fout_),this.text(".merkje span",t?"Geen verbinding":this.fout_??"")}};j(Et,"css",Uu);var Fu={weather:"Weerentiteit",lights:"Lampen en schakelaars op het scherm",calendars:"Agenda's (de afspraken van vandaag)",kiosk_users:"Kioskaccounts"},qu={weather:"Leeg = geen weer op het scherm.",lights:"De namen zoals ze op het scherm staan geeft de receptie in het beheer (blok Verlichting), en daar staat ook de schakelaar om ze te tonen.",kiosk_users:"Het account waarmee de iPad is ingelogd. Zo'n account mag alleen aanwezigheid omzetten en lampen schakelen, en niets beheren. Alleen een beheerder ziet deze lijst."},Jr=class extends L{defaults(){return{...Qr}}gedeeldeVelden(){return[]}set hass(e){super.hass=e,this.gebruikers_===void 0&&e?.connection&&e.user?.is_admin&&(this.gebruikers_=null,Nd(e).then(t=>{this.gebruikers_=(t.gebruikers??[]).map(n=>({value:n.id,label:`${n.naam}${n.is_admin?" (beheerder)":""}`})),this.sync_()}).catch(()=>{this.gebruikers_=[]}))}get hass(){return super.hass}schema(){let e=[{name:"weather",selector:f.entity("weather")},{name:"lights",selector:{entity:{multiple:!0,domain:["light","switch"]}}},{name:"calendars",selector:{entity:{multiple:!0,domain:"calendar"}}}];return this.gebruikers_?.length&&e.push({name:"kiosk_users",selector:{select:{multiple:!0,mode:"list",options:this.gebruikers_}}}),e}label(e){return Fu[e.name]??super.label(e)}helper(e){return qu[e.name]}};T(eo,Et,{name:"DomotiApp Infoscherm",description:"Beeldvullend scherm voor een wachtkamer: logo, klok, weer, wie er is, mededelingen, nieuws, verjaardagen en verlichting. De entiteiten kiest u hier; de inhoud komt uit DomotiApp Infoscherm Beheer.",preview:!1});H(`${eo}-editor`,Jr);Et.getConfigElement=()=>document.createElement(`${eo}-editor`);Et.getStubConfig=()=>({});var io="domotiapp-infoscherm-beheer-card",Zu=["personen","mededelingen","verjaardagen","praktijk","scherm","installatie","indeling","instellingen"],to=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,Jd={layout:to('<rect x="3.4" y="3.4" width="17.2" height="17.2" rx="2"/><path d="M3.4 9.6h17.2M9.6 9.6v11"/>'),cake:to('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),grip:to('<circle cx="9" cy="6" r="1.2" fill="currentColor"/><circle cx="15" cy="6" r="1.2" fill="currentColor"/><circle cx="9" cy="12" r="1.2" fill="currentColor"/><circle cx="15" cy="12" r="1.2" fill="currentColor"/><circle cx="9" cy="18" r="1.2" fill="currentColor"/><circle cx="15" cy="18" r="1.2" fill="currentColor"/>')},Xu=i=>Jd[i]??b(i),De=[{key:"personen",titel:"Medewerkers",icoon:"people",secties:["personen"]},{key:"mededelingen",titel:"Mededelingen",icoon:"bell",secties:["mededelingen","scherm"]},{key:"verjaardagen",titel:"Verjaardagen",icoon:"cake",secties:["verjaardagen"]},{key:"praktijk",titel:"Openingstijden",icoon:"clock",secties:["praktijk"]},{key:"indeling",titel:"Indeling van het scherm",icoon:"layout",secties:["indeling"]},{key:"verlichting",titel:"Verlichting",icoon:"bulb",secties:["installatie","instellingen"]},{key:"instellingen",titel:"Instellingen en logo",icoon:"cog",secties:["scherm","instellingen"]}],ec={title:"Infoscherm",show_personen:!0,show_mededelingen:!0,show_verjaardagen:!0,show_praktijk:!0,show_indeling:!0,show_verlichting:!0,show_instellingen:!0,open:"personen"},Yu=`
  ...
  .raster {
    ...
    background-size: calc(100% / ${Te}) calc(100% / ${Oe});
...
`,Qd=i=>JSON.parse(JSON.stringify(i??null)),B=i=>y(i??""),$a=(i,e,t)=>Math.min(t,Math.max(e,i)),Qu=700,no=150,At=class extends S{constructor(){super(),this.stand_=null,this.rechten_={},this.feedFouten_={},this.werk_={},this.vuil_=new Set,this.bezig_=new Set,this.versie_={},this.timers_={},this.fouten_={},this.uitgesteld_=new Set,this.open_=null,this.meldingen_={},this.herkansing_=new se(()=>this.haal_()),this.verbinding_=new we,this.fout_=null,this.laatstOpgeslagen_=""}validate(e){return{...ec,...e}}watched(){return[]}getCardSize(){return 6}getGridOptions(){return{columns:"full",rows:"auto",min_rows:this.minRijen_(".card",6)}}blokken_(){return De.filter(e=>this.config[`show_${e.key}`]!==!1&&(!e.admin||this.rechten_.is_admin))}blokInfo_(e){return De.find(t=>t.key===e)}template(){let e=this.config;return`
      ...
      <div class="veld"><label>Afwijkende dagen (feestdagen, studiedagen)</label>
        ...
        </div>`}).join(""),r=new Set(t.map(s=>s.soort)),o=Xd.filter(s=>!r.has(s));return`<div class="hulp">Zo staat het welkomscherm op de iPad. Sleep een blok om het te verplaatsen, trek aan de hoek rechtsonder om het groter of kleiner te maken, en zet met \u2212 en + hoeveel er in een blok staat ("alle" = zoveel als er is). Een gestippeld blok staat NIET op het scherm zolang er niets in te tonen valt; de reden staat erin. Elke wijziging gaat meteen naar het scherm.</div>
      ...
      </div>`}ibStijl_(e){return`left:${(e.x/Te*100).toFixed(3)}%;top:${(e.y/Oe*100).toFixed(3)}%;width:${(e.w/Te*100).toFixed(3)}%;height:${(e.h/Oe*100).toFixed(3)}%`}htmlVerlichting_(e={},t={}){let a=(e.verlichting??[]).map((r,o)=>{let s=this.hass?.states?.[r.entity]?.attributes??{};return`<div class="item lamp" data-i="${o}">
      ...
      </div>`}plaatjes_(e){for(let t of e.querySelectorAll("[data-bestand]:not([data-bestand=''])"))Yt(this.hass,t.dataset.bestand).then(n=>{n&&t.isConnected&&(t.innerHTML=`<img alt="" src="${n}">`)})}markeer_(e,t,n=no){this.vuil_.add(e),this.bron_={...this.bron_??{},[e]:t},this.versie_[e]=(this.versie_[e]??0)+1,this.fouten_[e]=null,t&&(this.meldingen_[t]=null,this.tel_(t)),this.status_("Opslaan\u2026","bezig"),clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),n)}invoer_(e){let t=e.target;if(t?.dataset?.actie==="blok_toevoegen")return this.blokToevoegen_(t.value,t);let n=t?.dataset?.veld;if(!n)return;let a=t.closest(".blok")?.dataset.blok;if(!a)return;let r=this.blokInfo_(a),o=t.dataset.s||r.secties[0],s=t.dataset.i,l=this.werk_[o],d=t.type==="checkbox"?t.checked:t.value,c=t.type==="text"||t.type==="url"||t.type==="number"||t.tagName==="TEXTAREA",p=t.type==="color";if(!((c||p)&&e.type!=="input")&&!(!c&&!p&&e.type!=="change")){if(o==="personen"||o==="mededelingen"||o==="verjaardagen"){let h=l[Number(s)];if(!h)return;if(h[n]=d,n==="naam"){let m=t.closest(".item")?.querySelector(".avatar");m&&!m.querySelector("img")&&(m.textContent=Ur(d))}if(n==="aanwezig"){h._aanwezig=!0;let m=t.closest(".vink")?.querySelector(".vl");m&&(m.textContent=d?"Aanwezig":"Afwezig"),t.closest(".item")?.querySelector(".avatar")?.classList.toggle("aan",d)}}else if(o==="praktijk")this.invoerPraktijk_(l,n,s,d,t);else if(o==="scherm")if(n==="accent_kleur"){l.accent=d;let h=t.closest(".b-onder")?.querySelector('[data-veld="accent"]');h&&(h.value=d)}else if(n==="accent")l.accent=String(d).trim()||null;else if(t.type==="number"){let h=Number(d);if(!Number.isFinite(h))return;l[n]=h}else l[n]=d;else if(o==="installatie"){if(n==="l_naam"){let h=l.verlichting?.[Number(s)];h&&(h.naam=d)}}else if(o==="instellingen")if(n.startsWith("f_")){let h=l.feeds[Number(s)];h&&(h[n.slice(2)]=d)}else l[n]=d;this.markeer_(o,a,c?Qu:no)}}invoerPraktijk_(e,t,n,a,r){if(t==="ot_open"){e.openingstijden??={},e.openingstijden[n]=a?[["08:00","17:00"]]:[];let o=r.closest(".ot-tabel");for(let l of o.querySelectorAll(`input[type="time"][data-i="${n}"]`)){l.disabled=!a;let[,d,c]=l.dataset.veld.split("_");l.value=e.openingstijden[n][Number(d)]?.[Number(c)]??""}let s=r.closest(".vink")?.querySelector(".vl");s&&(s.textContent=a?"open":"gesloten")}else if(t.startsWith("ot_")){let[,o,s]=t.split("_").map(Number);e.openingstijden??={};let l=e.openingstijden[n]??[];for(;l.length<=o;)l.push(["",""]);l[o][s]=a,e.openingstijden[n]=l.filter((d,c)=>c===0||d[0]&&d[1]),e.openingstijden[n].length||(e.openingstijden[n]=[["",""]])}else if(t.startsWith("u_")){let o=e.uitzonderingen[Number(n)];if(!o)return;let s=t.slice(2);if(s==="open"){o.tijden=a?[["08:00","17:00"]]:[];let l=r.closest(".item");for(let c of l.querySelectorAll('input[type="time"]'))c.disabled=!a,c.value=a?c.dataset.veld==="u_van"?"08:00":"17:00":"";let d=r.closest(".vink")?.querySelector(".vl");d&&(d.textContent=a?"open":"gesloten")}else s==="van"||s==="tot"?o.tijden=[[s==="van"?a:o.tijden?.[0]?.[0]??"",s==="tot"?a:o.tijden?.[0]?.[1]??""]]:o[s]=a}else e[t]=a}blokToevoegen_(e,t){t&&(t.value="");let n=Ze[e];if(!n)return;let a=this.werk_.indeling??(this.werk_.indeling={blokken:[]});if(a.blokken.some(l=>l.soort===e))return;let[r,o]=n.maat,s=Xr(a.blokken,r,o);for(;!s&&(r>1||o>1);)o>1?o-=1:r-=1,s=Xr(a.blokken,r,o);return s?(a.blokken.push({id:`b-${Date.now().toString(36)}${Math.floor(Math.random()*1e4).toString(36)}`,soort:e,x:s.x,y:s.y,w:r,h:o,aantal:n.aantal?3:0}),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):(this.meldingen_.indeling={tekst:"Er is geen plek meer. Maak eerst een ander blok kleiner of haal er een weg.",fout:!0},this.teken_("indeling",!0))}sleepLijst_(e,t){let n=t.closest(".item"),a=n?.parentElement,r=n?.closest(".blok")?.dataset.blok;if(!n||!a||!r||e.pointerType==="mouse"&&e.button!==0)return;let o=this.blokInfo_(r).secties[0],s=this.werk_[o],l=Number(n.dataset.i);if(!Array.isArray(s)||!s[l])return;e.preventDefault(),n.classList.add("sleept");let d=p=>{let h=[...a.children].filter(g=>g!==n),m=null;for(let g of h){let k=g.getBoundingClientRect();if(p.clientY<k.top+k.height/2){m=g;break}}n.nextElementSibling!==m&&n!==m&&a.insertBefore(n,m)},c=()=>{window.removeEventListener("pointermove",d,!0),window.removeEventListener("pointerup",c,!0),window.removeEventListener("pointercancel",c,!0),n.classList.remove("sleept");let p=[...a.children].indexOf(n);if(p!==l&&p>=0){let[h]=s.splice(l,1);s.splice(p,0,h),this.markeer_(o,r)}this.teken_(r,!0)};window.addEventListener("pointermove",d,!0),window.addEventListener("pointerup",c,!0),window.addEventListener("pointercancel",c,!0),this.teardown_.push(c)}sleepStart_(e){let t=e.target.closest?.(".greep");if(t)return this.sleepLijst_(e,t);let n=e.target.closest?.(".ib");if(!n||e.target.closest("button, input, select")||e.pointerType==="mouse"&&e.button!==0)return;let a=n.closest(".raster"),r=this.werk_.indeling,o=r?.blokken?.find(x=>x.id===n.dataset.id);if(!o||!a)return;let s=e.target.closest(".ib-greep")?"maat":"plaats",l=a.getBoundingClientRect(),d=l.width/Te,c=l.height/Oe,p={x:e.clientX,y:e.clientY},h={...o},m=!1;e.preventDefault();try{n.setPointerCapture(e.pointerId)}catch{}n.classList.add("sleept");let g=x=>{if(s!=="plaats")return null;let _=r.blokken.filter(I=>I.id!==x.id&&Zr(I,x));if(_.length!==1)return null;let N=_[0];return N.w===x.w&&N.h===x.h&&N.x===x.x&&N.y===x.y?N:null},k=x=>{let _=Math.round((x.clientX-p.x)/d),N=Math.round((x.clientY-p.y)/c);(_||N)&&(m=!0),h=s==="plaats"?{...o,x:$a(o.x+_,0,Te-o.w),y:$a(o.y+N,0,Oe-o.h)}:{...o,w:$a(o.w+_,1,Te-o.x),h:$a(o.h+N,1,Oe-o.y)},n.classList.toggle("ongeldig",!_a(r.blokken,h)&&!g(h)),n.style.cssText=this.ibStijl_(h)},w=()=>{n.removeEventListener("pointermove",k),n.removeEventListener("pointerup",w),n.removeEventListener("pointercancel",w),n.classList.remove("sleept","ongeldig");let x=h.x!==o.x||h.y!==o.y||h.w!==o.w||h.h!==o.h,_=m&&x?g(h):null;_?(Object.assign(_,{x:o.x,y:o.y}),Object.assign(o,{x:h.x,y:h.y}),this.markeer_("indeling","indeling")):m&&x&&_a(r.blokken,h)&&(Object.assign(o,h),this.markeer_("indeling","indeling")),this.teken_("indeling",!0)};n.addEventListener("pointermove",k),n.addEventListener("pointerup",w),n.addEventListener("pointercancel",w)}async klik_(e){let t=e.target.closest(".bk");if(t){let c=t.closest(".blok").dataset.blok;this.open_=this.open_===c?null:c;for(let p of this.$$(".blok"))p.classList.toggle("open",p.dataset.blok===this.open_);this.open_&&this.uitgesteld_.has(this.open_)&&this.teken_(this.open_,!0);return}let n=e.target.closest("[data-actie]");if(!n||n.disabled||n.tagName==="SELECT")return;let a=n.closest(".blok")?.dataset.blok,r=n.dataset.actie,o=Number(n.dataset.i),l=this.blokInfo_(a)?.secties[0],d=this.werk_[l];if(r==="nieuw"){let c={personen:{naam:"",functie:"",aanwezig:!1},mededelingen:{tekst:""},verjaardagen:{naam:"",datum:"",jaar_tonen:!0}}[l];d.push(c),this.teken_(a,!0),this.$(`.blok[data-blok="${a}"] .item:last-of-type input[type="text"], .blok[data-blok="${a}"] .item:last-of-type textarea`)?.focus();return}if(r==="verwijder"){let c=d[o],p=c?.naam||c?.titel||c?.tekst||"dit item";return c&&(c.id||c.naam||c.titel||c.tekst)&&!await _e({title:"Verwijderen?",text:`"${p}" verdwijnt meteen van het scherm.`,confirmText:"Verwijderen"})?void 0:(d.splice(o,1),this.markeer_(l,a),this.teken_(a,!0))}if(r==="foto"||r==="logo"){this.doel_=r==="logo"?{sectie:"scherm",blok:a,veld:"logo"}:{sectie:l,blok:a,i:o,veld:"foto"};let c=this.$(".file");c.value="",c.click();return}if(r==="fotoweg"||r==="logoweg")return r==="logoweg"?(this.werk_.scherm.logo=null,this.markeer_("scherm",a)):(d[o].foto=null,this.markeer_(l,a)),this.teken_(a,!0);if(r==="u_nieuw")return d.uitzonderingen??=[],d.uitzonderingen.push({datum:"",tijden:[],reden:""}),this.teken_(a,!0);if(r==="u_verwijder")return d.uitzonderingen.splice(o,1),this.markeer_(l,a),this.teken_(a,!0);if(r==="f_nieuw"){let c=this.werk_.instellingen;return c.feeds??=[],c.feeds.push({naam:"",url:""}),this.teken_(a,!0)}if(r==="f_verwijder")return this.werk_.instellingen.feeds.splice(o,1),this.markeer_("instellingen",a),this.teken_(a,!0);if(r==="f_ververs"){n.disabled=!0;try{let c=await Sd(this.hass);this.feedFouten_=c.feed_fouten??{},this.meldingen_[a]={tekst:`${(c.feeds??[]).length} bericht(en) opgehaald.`}}catch(c){this.meldingen_[a]={tekst:c?.message??"Ophalen lukte niet.",fout:!0}}return this.teken_(a,!0)}if(r==="blok_weg"||r==="aantal_min"||r==="aantal_plus"){let c=this.werk_.indeling,p=c?.blokken?.find(h=>h.id===n.dataset.id);return p?(r==="blok_weg"?c.blokken=c.blokken.filter(h=>h!==p):r==="aantal_min"?p.aantal=p.aantal<=1?0:p.aantal-1:p.aantal=Math.min(50,(p.aantal||0)+1),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}if(r==="indeling_standaard")return await _e({title:"Standaardindeling?",text:"De blokken gaan terug naar hun oorspronkelijke plek en maat.",confirmText:"Terugzetten"})?(this.werk_.indeling=wa(),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}async bestandGekozen_(e){let t=e.target.files?.[0],n=this.doel_;if(this.doel_=null,!t||!n)return;let{sectie:a,blok:r,i:o,veld:s}=n;this.meldingen_[r]={tekst:"Bezig met uploaden\u2026"},this.teken_(r,!0);try{let l=await Td(this.hass,t),d=this.werk_[a],c=o===void 0?d:d[o],p=c[s];c[s]=l.id,p&&(this.oudeBestanden_=[...this.oudeBestanden_??[],p]),this.meldingen_[r]={tekst:`${l.naam||"Bestand"} ge\xFCpload.`},this.markeer_(a,r)}catch(l){this.meldingen_[r]={tekst:l?.message??"Uploaden lukte niet.",fout:!0}}this.teken_(r,!0)}payload_(e){let t=this.werk_[e];switch(e){case"personen":return(t??[]).filter(n=>n.naam?.trim()).map(({_aanwezig:n,aanwezig:a,...r})=>n?{...r,aanwezig:a}:r);case"mededelingen":return(t??[]).filter(n=>n.tekst?.trim());case"verjaardagen":return(t??[]).filter(n=>n.naam?.trim()&&n.datum);case"praktijk":return{openingstijden:Object.fromEntries(rt.map(n=>[n,(t.openingstijden?.[n]??[]).filter(a=>a[0]&&a[1])])),uitzonderingen:(t.uitzonderingen??[]).filter(n=>n.datum).map(n=>({...n,tijden:(n.tijden??[]).filter(a=>a[0]&&a[1])}))};case"instellingen":return{...t,feeds:(t.feeds??[]).filter(n=>n.url?.trim())};default:return t}}async bewaar_(e){if(!this.hass||this.bezig_.has(e))return;let t=this.versie_[e]??0;this.bezig_.add(e),this.status_("Opslaan\u2026","bezig");try{let a=(await Ed(this.hass,e,this.payload_(e)))[e];this.koppel_(e,a),this.stand_&&(this.stand_[e]=Qd(a)),this.fouten_[e]=null,(this.versie_[e]??0)===t&&this.vuil_.delete(e);let r=new Date;this.laatstOpgeslagen_=`${String(r.getHours()).padStart(2,"0")}:${String(r.getMinutes()).padStart(2,"0")}`;for(let o of this.oudeBestanden_??[])this.inGebruik_(o)||(Md(this.hass,o).catch(()=>{}),Od(o));this.oudeBestanden_=[]}catch(n){this.fouten_[e]=n?.message??"Opslaan lukte niet."}finally{this.bezig_.delete(e)}this.vuil_.has(e)&&(this.versie_[e]??0)!==t&&!this.fouten_[e]&&(clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),no));for(let n of De)n.secties.includes(e)&&this.tel_(n.key);if(!this.fouten_[e])for(let n of De)n.secties.includes(e)&&n.key!==this.bron_?.[e]&&this.teken_(n.key);if(this.fouten_[e]){this.status_(`Niet opgeslagen: ${this.fouten_[e]}`,"fout");for(let n of De)n.secties.includes(e)&&this.teken_(n.key)}else!this.bezig_.size&&!this.vuil_.size&&this.status_(`Opgeslagen ${this.laatstOpgeslagen_}`,"ok")}koppel_(e,t){let n=this.werk_[e];if(!Array.isArray(n)||!Array.isArray(t))return;let a={personen:o=>o.naam?.trim(),mededelingen:o=>o.tekst?.trim(),verjaardagen:o=>o.naam?.trim()&&o.datum}[e];if(!a)return;let r=0;n.forEach((o,s)=>{if(!a(o))return;let l=t[r];if(r+=1,!l)return;o.id=l.id,e==="personen"&&(o.initialen=l.initialen,o._aanwezig&&delete o._aanwezig);let d=this.$(`.blok[data-blok="${e}"] .item[data-i="${s}"]`);d&&(d.dataset.id=l.id)})}inGebruik_(e){let t=this.stand_??{};return t.scherm?.logo===e||(t.personen??[]).some(n=>n.foto===e)||(this.werk_.personen??[]).some(n=>n.foto===e)||this.werk_.scherm?.logo===e}};j(At,"css",Yu);var Ju={title:"Titel",show_personen:"Blok Medewerkers",show_mededelingen:"Blok Mededelingen",show_verjaardagen:"Blok Verjaardagen",show_praktijk:"Blok Openingstijden",show_indeling:"Blok Indeling",show_verlichting:"Blok Verlichting",show_instellingen:"Blok Instellingen en logo",open:"Staat open bij het laden"},ao=class extends L{defaults(){return{...ec}}schema(){return[{name:"title",selector:f.text()},{name:"open",selector:f.select([...De.map(e=>({value:e.key,label:e.titel})),{value:"",label:"Alles dicht"}])},...De.map(e=>({name:`show_${e.key}`,selector:f.bool()}))]}label(e){return Ju[e.name]??super.label(e)}helper(e){if(e.name==="show_instellingen")return"Logo, accent, uiterlijk, het welkomblok en de nieuwsbronnen. Zet dit blok uit op een dashboard voor een receptie die daar niet aan hoeft te zitten."}};T(io,At,{name:"DomotiApp Infoscherm Beheer",description:"Voor de receptie: medewerkers, mededelingen, verjaardagen, openingstijden, de indeling van het scherm en het logo. Alles wordt vanzelf opgeslagen en staat meteen op het scherm.",preview:!1});H(`${io}-editor`,ao);At.getConfigElement=()=>document.createElement(`${io}-editor`);At.getStubConfig=()=>({title:"Infoscherm"});var Ea=globalThis,Aa=Ea.ShadowRoot&&(Ea.ShadyCSS===void 0||Ea.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ro=Symbol(),tc=new WeakMap,nn=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==ro)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Aa&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=tc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&tc.set(t,e))}return e}toString(){return this.cssText}},Le=i=>new nn(typeof i=="string"?i:i+"",void 0,ro),re=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new nn(t,i,ro)},nc=(i,e)=>{if(Aa)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=Ea.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},oo=Aa?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return Le(t)})(i):i;var{is:em,defineProperty:tm,getOwnPropertyDescriptor:nm,getOwnPropertyNames:am,getOwnPropertySymbols:im,getPrototypeOf:rm}=Object,Ma=globalThis,ac=Ma.trustedTypes,om=ac?ac.emptyScript:"",sm=Ma.reactiveElementPolyfillSupport,an=(i,e)=>i,so={toAttribute(i,e){switch(e){case Boolean:i=i?om:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},rc=(i,e)=>!em(i,e),ic={attribute:!0,type:String,converter:so,reflect:!1,useDefault:!1,hasChanged:rc};Symbol.metadata??=Symbol("metadata"),Ma.litPropertyMetadata??=new WeakMap;var Ce=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=ic){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&tm(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=nm(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ic}static _$Ei(){if(this.hasOwnProperty(an("elementProperties")))return;let e=rm(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(an("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(an("properties"))){let t=this.properties,n=[...am(t),...im(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(oo(a))}else e!==void 0&&t.push(oo(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return nc(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:so).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:so;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??rc)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};Ce.elementStyles=[],Ce.shadowRootOptions={mode:"open"},Ce[an("elementProperties")]=new Map,Ce[an("finalized")]=new Map,sm?.({ReactiveElement:Ce}),(Ma.reactiveElementVersions??=[]).push("2.1.2");var go=globalThis,oc=i=>i,Sa=go.trustedTypes,sc=Sa?Sa.createPolicy("lit-html",{createHTML:i=>i}):void 0,uc="$lit$",Xe=`lit$${Math.random().toFixed(9).slice(2)}$`,mc="?"+Xe,lm=`<${mc}>`,lt=document,on=()=>lt.createComment(""),sn=i=>i===null||typeof i!="object"&&typeof i!="function",fo=Array.isArray,dm=i=>fo(i)||typeof i?.[Symbol.iterator]=="function",lo=`[ 	
\f\r]`,rn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,lc=/-->/g,dc=/>/g,ot=RegExp(`>|${lo}(?:([^\\s"'>=/]+)(${lo}*=${lo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),cc=/'/g,pc=/"/g,gc=/^(?:script|style|textarea|title)$/i,bo=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),z=bo(1),Px=bo(2),Kx=bo(3),dt=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),hc=new WeakMap,st=lt.createTreeWalker(lt,129);function fc(i,e){if(!fo(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return sc!==void 0?sc.createHTML(e):e}var cm=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=rn;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===rn?c[1]==="!--"?o=lc:c[1]!==void 0?o=dc:c[2]!==void 0?(gc.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=ot):c[3]!==void 0&&(o=ot):o===ot?c[0]===">"?(o=a??rn,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?ot:c[3]==='"'?pc:cc):o===pc||o===cc?o=ot:o===lc||o===dc?o=rn:(o=ot,a=void 0);let m=o===ot&&i[s+1].startsWith("/>")?" ":"";r+=o===rn?l+lm:p>=0?(n.push(d),l.slice(0,p)+uc+l.slice(p)+Xe+m):l+Xe+(p===-2?s:m)}return[fc(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},ln=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=cm(e,t);if(this.el=i.createElement(d,n),st.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=st.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(uc)){let h=c[o++],m=a.getAttribute(p).split(Xe),g=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:g[2],strings:m,ctor:g[1]==="."?po:g[1]==="?"?ho:g[1]==="@"?uo:St}),a.removeAttribute(p)}else p.startsWith(Xe)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(gc.test(a.tagName)){let p=a.textContent.split(Xe),h=p.length-1;if(h>0){a.textContent=Sa?Sa.emptyScript:"";for(let m=0;m<h;m++)a.append(p[m],on()),st.nextNode(),l.push({type:2,index:++r});a.append(p[h],on())}}}else if(a.nodeType===8)if(a.data===mc)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(Xe,p+1))!==-1;)l.push({type:7,index:r}),p+=Xe.length-1}r++}}static createElement(e,t){let n=lt.createElement("template");return n.innerHTML=e,n}};function Mt(i,e,t=i,n){if(e===dt)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=sn(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Mt(i,a._$AS(i,e.values),a,n)),e}var co=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??lt).importNode(t,!0);st.currentNode=a;let r=st.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new dn(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new mo(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=st.nextNode(),o++)}return st.currentNode=lt,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},dn=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Mt(this,e,t),sn(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==dt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):dm(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==$&&sn(this._$AH)?this._$AA.nextSibling.data=e:this.T(lt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=ln.createElement(fc(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new co(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=hc.get(e.strings);return t===void 0&&hc.set(e.strings,t=new ln(e)),t}k(e){fo(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(on()),this.O(on()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=oc(e).nextSibling;oc(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},St=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=$}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Mt(this,e,t,0),o=!sn(e)||e!==this._$AH&&e!==dt,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Mt(this,s[n+l],t,l),d===dt&&(d=this._$AH[l]),o||=!sn(d)||d!==this._$AH[l],d===$?e=$:e!==$&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},po=class extends St{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}},ho=class extends St{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==$)}},uo=class extends St{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Mt(this,e,t,0)??$)===dt)return;let n=this._$AH,a=e===$&&n!==$||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==$&&(n===$||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},mo=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Mt(this,e)}};var pm=go.litHtmlPolyfillSupport;pm?.(ln,dn),(go.litHtmlVersions??=[]).push("3.3.3");var bc=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new dn(e.insertBefore(on(),r),r,void 0,t??{})}return a._$AI(i),a};var vo=globalThis,te=class extends Ce{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=bc(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return dt}};te._$litElement$=!0,te.finalized=!0,vo.litElementHydrateSupport?.({LitElement:te});var hm=vo.litElementPolyfillSupport;hm?.({LitElement:te});(vo.litElementVersions??=[]).push("4.2.2");var me=re`
  :host {
    ${Le(W)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${Le(Re)}
`;var um=["unavailable","unknown"],mm=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Na({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||um.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of mm)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Ta(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var xo=["hs","rgb","rgbw","rgbww","xy"],wo="color_temp",gm="onoff";var ct="kleur";var fm=["unavailable","unknown"],kc=["color_temp_kelvin","rgb_color","hs_color","xy_color"],bm=[0,100];function je(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===gm,a=t!==null&&t.includes(wo),r=t!==null&&t.some(d=>xo.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!fm.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function vm(){return{state:"off"}}function xc(i,e){let t=e??je(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...jm(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function wc(i,e,t,n){return e?i&&i.state==="on"?{...i}:xc(t,n):{state:"off"}}function _c(i,e,t,n){let a=n??je(t),r=Eo(i,t,a);return a.helderheid&&(r.brightness=G(e,1,255)),r}function _o(i,e,t,n){let a=n??je(t),r=Eo(i,t,a);return Tc(r),r.color_temp_kelvin=G(e,a.minKelvin,a.maxKelvin),r}function yo(i,e,t,n){let a=n??je(t),r=Eo(i,t,a);return Tc(r),r.hs_color=[G(e?.[0],0,360),G(e?.[1],0,100)],r}function Oa(i,e,t){return i??vm()}function yc(i,e,t){let n=Oa(i,e,t);if(typeof n.brightness=="number")return G(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?G(a,1,255):255}function jo(i,e,t){let n=t??je(e),a=Oa(i,e,n);if(typeof a.color_temp_kelvin=="number")return G(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?G(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Da(i,e,t){let n=Oa(i,e,t);if(ko(n.hs_color))return[G(n.hs_color[0],0,360),G(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return ko(a)?[G(a[0],0,360),G(a[1],0,100)]:[...bm]}function zo(i){return i!=null&&typeof i=="object"}function jc(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!zo(a[s]?.lights?.[o]))return!0;return!1})}function zc(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function $o(i,e,t){return Oa(i,e,t).state==="on"}function $c(i,e,t){let n=t??je(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=$o(i,e,n),r=Ec(n),o=r?km(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===ct),kleurkeuze:a&&r,stand:a?o:null}}function Ec(i){return!!(i?.kleurtemp&&i?.kleur)}function km(i,e,t){let n=t??je(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(kc.slice(1).some(r=>i[r]!==void 0))return ct}let a=e?.attributes?.color_mode;return a===wo&&n.kleurtemp?"wit":xo.includes(a)&&n.kleur?ct:"wit"}function Ac(i,e,t,n){let a=n??je(t);return Ec(a)?e==="wit"?_o(i,jo(i,t,a),t,a):yo(i,Da(i,t,a),t,a):i}function Mc(i){let e=G(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Sc(i){let e=G(i,1,100);return G(Math.round(e/100*255),1,255)}var xm=1e3,wm=4e4,vc=7;function _m(i){let e=G(i,xm,wm)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[G(t,0,255),G(n,0,255),G(a,0,255)]}function ym(i){let[e,t,n]=_m(i);return`rgb(${e}, ${t}, ${n})`}function Nc(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:vc},(r,o)=>{let s=o/(vc-1),l=t+(n-t)*s;return`${ym(l)} ${Math.round(s*100)}%`}).join(", ")})`}function jm(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?G(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===wo&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=G(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&xo.includes(a)&&ko(t.hs_color)&&(n.hs_color=[G(t.hs_color[0],0,360),G(t.hs_color[1],0,100)]),n}function Eo(i,e,t){return i&&i.state==="on"?{...i}:xc(e,t)}function Tc(i){for(let e of kc)delete i[e]}function ko(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function G(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var La="domotiapp-scene-card",Ao="domotiapp-scene-card-editor",Oc="domotiapp-scene-editor";var cn=["een","twee","drie"],Dc="pencil",Lc=["grid_options","layout_options","view_layout","visibility"];var Cc="entity_id",Nt=class extends te{constructor(){super();j(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));j(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Cc]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Cc];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},a={...this._config,entity:n.entity};n.bare?a.bare=!0:delete a.bare,a.entity!==this._config?.entity&&(delete a.name_overrides,this._getypt={}),this._stuurDoor(a)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return $;let t=this._leden();return z`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?z`
          ...
          `:$}
    `}};j(Nt,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),j(Nt,"styles",[me,re`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===So?z`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Hc?z`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=$o(a,t,n),o=$c(a,t,n);return z`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${zo(a)?$:z`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?z`
                <div class="bediening">
    ...
    `}_renderHelderheid(e,t,n,a){let r=Mc(yc(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,_c(this._waardeVan(e),Sc(s.detail.value),t,n))};return z`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Ac(this._waardeVan(e),s,t,n))};return z`
    ...
    `}_renderKleurtemp(e,t,n,a){let r=jo(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,_o(this._waardeVan(e),s.detail.value,t,n))};return z`
      <div class="besturing">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Nc(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=Da(a,t,n),s=l=>d=>{d.stopPropagation();let c=Da(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,yo(this._waardeVan(e),p,t,n))};return z`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Mm}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};j(Tt,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),j(Tt,"styles",[me,re`
    ...
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=b(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===To,n=this._toestand===Ha,a=this._iconen();return z`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${a.map((r,o)=>z`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==pn)return $;let t=jc(this._scenes,this._leden,3).length,n=zc(t);return n?z`<div class="mededeling">${n}</div>`:$}_renderEditor(){return z`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||cn[n])}};j(hn,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),j(hn,"styles",[me,re`
      :host { display: block; }
    ...
    `]);C(La,hn);C(Ao,Nt);C(Oc,Tt);mt({type:La,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Sm}).`,preview:!1});var pt="domotiapp-alarm-card",Do="domotiapp-alarm-card-editor",Bc="domotiapp-alarm-editor",Pc="DomotiApp Wekker",Kc="https://github.com/Sven2410/domotiapp-lovelace",ze="domotiapp_lovelace",pe=Object.freeze({get:`${ze}/alarms/get`,save:`${ze}/alarms/save`,setEnabled:`${ze}/alarms/set_enabled`,delete:`${ze}/alarms/delete`,stop:`${ze}/alarms/stop`,clearMessage:`${ze}/alarms/clear_message`,search:`${ze}/sound/search`,entities:`${ze}/entities/list`,previewStart:`${ze}/preview/start`,subscribe:`${ze}/updates/subscribe`}),Va="#026FA1";function Gc(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Tm="07:00";var Om=["uri","name","media_type","image"],Dm="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Lm="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Cm="Music Assistant Wekker",Rm="Verlichting Wekker";function Ia(){return{id:null,name:"",time:Tm,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Wc(i){let e=Ia();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:Lo(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:un(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function un(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Om)e[t]=i[t]===void 0?null:i[t];return e}function Lo(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Co(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),Lo(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Uc(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:un(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Fc(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function qc(i){return Lo(i)&&i.slice(0,2)==="02"?Dm:null}function Zc(i){return i===!1?Lm:null}function Xc(i){return typeof i?.endless=="boolean"?i.endless:null}function Ba(i,e){let t=e==="lamp",n=t?Rm:Cm,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function Yc(i,e){return Ba(e,"speaker")!==null?!1:Co(i).ok}var Vm=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Im=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],mn="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Bm="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Pm="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Ot=class extends te{constructor(){super(),this._concept=Ia(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Wc(this.wekker):Ia(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:pe.previewStart,speaker:this._concept.speaker,sound:un(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:pe.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:un(e),endless:Xc(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Co(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:pe.save,person:this.person,alarm:Uc(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return z`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return $;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Ba(t,"speaker"),r=Ba(n,"lamp"),o=qc(e.time),s=Zc(e.endless),l=Yc(e,t);return z`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Im.map(([d,c])=>z`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
    ...
    `}};j(Ot,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),j(Ot,"styles",[me,re`
    :host {
  ...
  `]);var Qc="person",Km="Kies een persoon in de kaartinstellingen.",Jc="De gekozen persoon is niet gevonden.",Gm="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Kw=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function ep(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Qc}.`))throw new Error(`'${e}' zit niet in het domein ${Qc}. Kies een persoon, zoals person.sven.`);return{...i}}function tp(i){return{type:`custom:${i}`}}function np(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Jc,isFout:!0}:{soort:"ontbreekt",tekst:Km,isFout:!1}}function ap(i,e){return i==="not_found"?Jc:i==="home_assistant_error"?Gm:e||"Er ging iets mis bij het ophalen van de wekkers."}var Wm=["ma","di","wo","do","vr","za","zo"],Um="Geen wekkers ingesteld",Fm="Eenmalig",qm="Eenmalig \u2014 afgelopen",Zm="Geen wekker actief",ip="Stoppen",Xm="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Ym(i){return!Array.isArray(i)||i.length===0?Fm:[...new Set(i)].sort((t,n)=>t-n).map(t=>Wm[t-1]??"?").join(" ")}function Qm(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function rp(i,e){return Qm(i,e)?qm:Ym(i?.days)}function op(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Xm,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function sp(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return Um;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Zm}function lp(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var Jm="0.38.0",eg="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",tg="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",dp="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",ng="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Pa=(i,e="icoon")=>z`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,gn=class extends te{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null,this._herkansing=new se(()=>this._haalOp()),this._verbinding=new we}setConfig(e){let t=ep(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(Do)}static getStubConfig(){return tp(pt)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:ut(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&(this._startAbonnement(),this._verbinding.herverbonden(this.hass)&&(this._herkansing.herstel(),this._haalOp())),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?V(e):null),D(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:pe.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${pt}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${pt}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:pe.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null,this._herkansing.herstel()}catch(t){if(this._config?.person!==e||ce(t)&&this._herkansing.plan())return;this._toestand=null,this._fout=ap(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:pe.entities})}catch(t){this._entiteiten=null,console.warn(`${pt}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:pe.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:pe.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:pe.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:pe.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?lp(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return $;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=np(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?z`<div class="card surface">
    ...
    `}_bevestiging(e){return z`<div class="onderrij bevestiging">
      <span class="boodschap">${Gc(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=op(e),a=!!e.enabled;return z`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?z`<div class="onderrij ${n.isFout?"fout":""}">
            ${Pa(n.isFout?ng:dp,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:$}
    `}};j(gn,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),j(gn,"styles",[me,re`
  ...
  `]);var Dt=class Dt extends te{constructor(){super(...arguments);j(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?$:z`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};j(Dt,"properties",{hass:{attribute:!1},_config:{state:!0}}),j(Dt,"styles",[me,re`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),j(Dt,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Ro=Dt;C(pt,gn);C(Do,Ro);C(Bc,Ot);mt({type:pt,name:Pc,description:`Wekkerkaart van DomotiApp (v${Jm}).`,preview:!1,documentationURL:Kc});var ag=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function cp(i){return`/api/image/serve/${i}/original`}function pp(i){return i?ag.includes(i.type)?i.size>12582912?`Deze afbeelding is ${Math.round(i.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var ig=`
...
`,Ho=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(ig)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let a=document.createElement("img");a.src=this.value,a.alt="",a.onerror=()=>{n.dataset.bron="",n.innerHTML=b("car")},n.replaceChildren(a)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=b("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=pp(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let a=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:a?{Authorization:`Bearer ${a}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(cp(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};C("dac-foto-picker",Ho);var rg="/api/domotiapp_lovelace/loader.js",hp="domotiapp-lovelace-verversing";function up(i){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(i??""));return e?e[1].toLowerCase():null}async function og(i){try{let e=await i(rg,{cache:"no-store"});return e?.ok?up(await e.text()):null}catch{return null}}function sg(){try{return globalThis.sessionStorage?.getItem(hp)??null}catch{return null}}function lg(i){try{globalThis.sessionStorage?.setItem(hp,i)}catch{return!1}return!0}function dg(i,e,t){return!i||!e?"onbekend":i===e?"actueel":t===e?"al-geprobeerd":"herladen"}function mp({eigenUrl:i,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:a=18e5,klok:r=setInterval}={}){let o=up(i);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await og(e);if(dg(o,p,sg())!=="herladen"||!lg(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,a);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var cg="0.38.0";es(i=>console.warn(`domotiapp-lovelace: ${i}`));mp({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${cg} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{cg as VERSION};
