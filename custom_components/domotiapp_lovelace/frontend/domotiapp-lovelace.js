var To=Object.defineProperty;var Co=(a,e,t)=>e in a?To(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var $=(a,e,t)=>Co(a,typeof e!="symbol"?e+"":e,t);var ee=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function ie(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var de=a=>String(a??"").split(".")[0],k=(a,e)=>e&&a?.states?.[e]||null,W=(a,e)=>k(a,e)?.attributes??{},mt=(a,e,t)=>t?null:W(a,e).entity_picture||null;function Ua(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function D(a,e,t){return t||W(a,e).friendly_name||e||""}var Oo=new Set(["scene","script","input_button","button","event"]),dn=a=>Oo.has(de(a));function Z(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!dn(a.entity_id):!1}function ge(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(de(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var Lo=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),Wa=a=>Lo.has(de(a));function Ga(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function ut(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var F=(a,e)=>ut(a,"hass-more-info",{entityId:e});function Be(a){switch(de(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function Do(a){switch(de(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function ce(a,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":F(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=Do(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),ut(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":ut(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":ut(a,"ll-custom",n);break;default:break}}function H(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,d=null,l=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){d=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(d),s=0,n()};return a.addEventListener("pointerdown",l),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(d),a.removeEventListener("pointerdown",l),a.removeEventListener("click",c)}}function J(a,e){if(!e)return"";let t=de(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function G(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Ka=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],qa=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Ba=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),cn=(a,e)=>Math.round((Ba(e)-Ba(a))/864e5);function Ue(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function pn(a,e=new Date){if(!a)return"";let t=cn(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Ka[a.getDay()]:`${Ka[a.getDay()].slice(0,2)} ${a.getDate()} ${qa[a.getMonth()]}`}var Fa=a=>a?`${a.getDate()} ${qa[a.getMonth()]}`:"";function Ro(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function Ho(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function O(a,e=4){if(!a)return;let t=Ho(a);if(!t){e>0&&requestAnimationFrame(()=>O(a,e-1));return}let n=`${Ro(t)}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}function Ce(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function I(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);O(a)});e.observe(a);for(let t of a.children)e.observe(t);return O(a),()=>e.disconnect()}var Vo="home-assistant";function Za({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(d,l)=>setTimeout(d,l),nu:i=()=>Date.now(),marker:r=Vo,intervalMs:o=20,maxWachtMs:s=1e4}){let d=i();function l(){let u=a();if(!u)return!1;for(let[g,h]of e)try{u.get(g)||u.define(g,h)}catch(b){t(`kon ${g} niet registreren: ${b&&b.message}`)}return!0}function c(){let u=a();return!u||!u.get(r)?!1:l()}if(c())return!0;let p=()=>{if(!c()){if(i()-d>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),l();return}n(p,o)}};return n(p,o),!1}var Xa=[];function T(a,e){Xa.push([a,e])}function Oe({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function Ya(a=()=>{}){Za({leesRegistry:()=>globalThis.customElements,definities:Xa,waarschuw:a})}var Po=`
  :host {
    ${ee}
    display: block;
...
`,A={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},gt={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},K=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),P=(a,e="accent")=>A[a]??(a&&/[#(]|^var/.test(a)?a:A[e]),N=Symbol("incomplete"),Io=a=>`
  <div class="needs">
  ...
  </div>`,Ko=56,Ja=8,pe=a=>Math.max(1,Math.ceil((a+Ja)/(Ko+Ja))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[ie(Po+me+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let i=n.target;!i?.matches||i.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||i.isConnected&&i.matches(":focus-visible")&&i.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[N]||Ga(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[N]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[N];if(e.innerHTML=t?Io(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(I(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,i){e&&(e.addEventListener(t,n,i),this.teardown_.push(()=>e.removeEventListener(t,n,i)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return Ce(this.$(e))??t}};$(S,"css","");function M(a,e,{name:t,description:n,preview:i=!0}={}){T(a,e),Oe({type:a,name:t,description:n,preview:i})}function R(a,e){T(a,e)}var m=(a,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${a}</svg>`,j={house:m(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,fn=null,bn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),fn=fn??[ie(Xo)],this.shadowRoot.adoptedStyleSheets=fn,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in A)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${A[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${Fo.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
      ...
      </div>`,this.shadowRoot.querySelectorAll("button.sw").forEach(n=>n.addEventListener("click",()=>this.emit_(n.dataset.tone)));let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let i=Zo.test(n);t.setAttribute("aria-invalid",String(!i)),i&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=this.eigen_();this.shadowRoot.querySelectorAll("button.sw").forEach(i=>i.setAttribute("aria-pressed",String((i.dataset.tone||"")===this.value_)));let t=this.$(".eigen");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.value_:"transparent"),t.title=e?`Eigen kleur: ${this.value_}`:"Eigen kleur",e&&/^#[0-9a-f]{6}$/i.test(this.value_)&&(this.$('input[type="color"]').value=this.value_);let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let i=e?this.value_:"";n.value!==i&&(n.value=i),n.setAttribute("aria-invalid","false")}this.$(".chosen").innerHTML=this.value_?e?`Gekozen: <b>${this.value_}</b> &mdash; eigen kleur.`:`Gekozen: <b>${gt[this.value_]??this.value_}</b>`:"Gekozen: <b>Automatisch</b> &mdash; de kaart kiest op domein en toestand."}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};T("dac-tone-picker",bn);var x={entity:a=>({entity:a?{domain:a}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(a,e,t=1)=>({number:{min:a,max:e,step:t,mode:"box"}}),select:a=>({select:{mode:"dropdown",options:a}}),action:(a="more-info")=>({ui_action:{default_action:a}})},vn=(...a)=>({type:"grid",name:"",schema:a});var Yo=[{name:"bare",selector:x.bool()}],Jo={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},C=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Yo}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return kn[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),i=t("margin-top:16px");for(let o of e){let s=document.createElement(o.kind==="tone"?"dac-tone-picker":"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",d=>{d.stopPropagation(),this.patch_({[o.key]:d.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?i:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Jo[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),i.children.length&&this.appendChild(i)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[i,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[i];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},kn={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Qo(a=new Date){let e=a.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var es=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],ts=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],xn={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},ns=["humidity","wind","uv","precipitation","sunset"],as=a=>a==null||Number.isNaN(+a)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+a/45)%8],bt=class extends S{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),i=()=>this.toggleAttribute("narrow",n.matches);i(),n.addEventListener("change",i),this.teardown_.push(()=>n.removeEventListener("change",i))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Qo(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${es[e.getDay()]} ${e.getDate()} ${ts[e.getMonth()]}`);let i=this.$(".clock");i&&this.text(i,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=k(this.hass,e.weather),n=W(this.hass,e.weather),i=this.$(".now");if(i&&t){let d=We(t.state);i.style.setProperty("--wtone",P(e.tone,"water"));let l=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${G(this.hass,n.temperature,0)}<span>${l}</span>`:"--";let c=i.querySelector(".ic");c.dataset.icon!==d&&(c.dataset.icon=d,c.innerHTML=v(d,"cloud")),this.text(i.querySelector(".cond"),J(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=ns.map(d=>this.chip_(d,n)).filter(Boolean),s=o.map(d=>`${d.key}${d.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(d=>`<span class="chip2" style="--tone:${P(xn[d.key].tone)}" title="${xn[d.key].label}">
             ${j[xn[d.key].icon]??""}${d.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let i=this.hass?.config?.unit_system?.wind_speed??"km/h",r=as(t.wind_bearing);return{key:e,value:`${G(this.hass,t.wind_speed,0)} ${i}${r?` ${r}`:""}`}}case"uv":{let r=W(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(k(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${G(this.hass,r,1)}`}:null}case"precipitation":{let i=k(this.hass,n.precipitation_entity);if(i){let r=Number(i.state);if(Number.isNaN(r))return null;let o=i.attributes.unit_of_measurement??"mm";return{key:e,value:`${G(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${G(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${G(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=k(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};$(bt,"css",`
  ...
  `);var _n=class extends C{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[vn({name:"weather",selector:x.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),vn({name:"sun",selector:x.entity("sun")},{name:"precipitation_entity",selector:x.entity("sensor")}),{name:"name",selector:x.text()},{name:"hide_below",selector:x.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};R("domotiapp-header-card-editor",_n);M("domotiapp-header-card",bt,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var vt=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
  ...
  `);var wn=class extends C{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:kn.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:x.text()},{name:"line",selector:x.bool()},{name:"secondary_entity",selector:x.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};R("domotiapp-separator-card-editor",wn);M("domotiapp-separator-card",vt,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var yn=(a,e,t)=>Math.min(t,Math.max(e,a));function be(a,e){let t=e.min??0,n=e.max??100,i=e.step??1,r=!1,o=h=>{let b=a.getBoundingClientRect();if(!b.width)return t;let f=yn((h-b.left)/b.width,0,1),w=t+f*(n-t);return yn(Math.round(w/i)*i,t,n)},s=h=>{try{a.setPointerCapture?.(h)}catch{}},d=h=>{try{a.hasPointerCapture?.(h)&&a.releasePointerCapture(h)}catch{}},l=h=>{e.disabled?.()||h.button!=null&&h.button!==0||(r=!0,s(h.pointerId),a.classList.add("dragging"),e.onInput(o(h.clientX)),h.preventDefault())},c=h=>{r&&(e.onInput(o(h.clientX)),h.preventDefault())},p=h=>{r&&(r=!1,d(h.pointerId),a.classList.remove("dragging"),e.onCommit(o(h.clientX)))},u=h=>{r&&(r=!1,d(h?.pointerId),a.classList.remove("dragging"),e.onInput(e.value()))},g=h=>{if(e.disabled?.())return;let b=(n-t)/10,f={ArrowLeft:-i,ArrowDown:-i,ArrowRight:i,ArrowUp:i,PageDown:-b,PageUp:b,Home:-1/0,End:1/0};if(!(h.key in f))return;h.preventDefault();let w=e.value(),z=yn(f[h.key]===-1/0?t:f[h.key]===1/0?n:w+f[h.key],t,n);e.onInput(z),e.onCommit(z)};return a.addEventListener("pointerdown",l),a.addEventListener("pointermove",c),a.addEventListener("pointerup",p),a.addEventListener("pointercancel",u),a.addEventListener("keydown",g),()=>{a.removeEventListener("pointerdown",l),a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",p),a.removeEventListener("pointercancel",u),a.removeEventListener("keydown",g)}}var re=(a="")=>`
...
`;var is=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),rs=new Set(["hs","rgb","rgbw","rgbww","xy"]),zn=a=>a?.attributes?.supported_color_modes??[],os=a=>zn(a).some(e=>is.has(e)),kt=a=>zn(a).some(e=>rs.has(e)),xt=a=>zn(a).includes("color_temp"),ni=a=>Math.max(1,Math.round((a??0)/255*100)),_t=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[N]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var En=class extends C{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:x.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:x.text()},{name:"step",selector:x.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};R("domotiapp-climate-card-editor",En);M("domotiapp-climate-card",wt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var ri=({label:a="Aan of uit",cls:e=""}={})=>`<button class="toggle ${e}" type="button" role="switch" aria-checked="false" aria-label="${a}"><span class="knob"></span></button>`;function Sn(a,e){if(!a)return;let t=String(!!e);a.getAttribute("aria-checked")!==t&&a.setAttribute("aria-checked",t)}function oi(a,e){let t=a.querySelector(".knob"),n=!1,i=0,r=!1,o=!1,s=()=>{n=!1,a.classList.remove("dragging"),t?.style.removeProperty("--knob")},d=h=>{h!==e.value()&&(Sn(a,h),e.set(h))},l=h=>{if(!e.disabled?.()&&!(h.button!=null&&h.button!==0)){h.stopPropagation(),n=!0,r=!1,o=!1,i=h.clientX,a.classList.add("dragging");try{a.setPointerCapture?.(h.pointerId)}catch{}}},c=h=>{if(!n)return;let b=h.clientX-i;Math.abs(b)>3&&(r=!0);let f=e.value()?22:0,w=Math.min(22,Math.max(0,f+b));t?.style.setProperty("--knob",`${w}px`)},p=h=>{if(!n)return;h.stopPropagation();let b=h.clientX-i,f=e.value()?22:0,w=Math.min(22,Math.max(0,f+b));s();try{a.hasPointerCapture?.(h.pointerId)&&a.releasePointerCapture(h.pointerId)}catch{}o=!0,d(r?w>22/2:!e.value())},u=()=>{n&&s()},g=h=>{if(h.stopPropagation(),h.preventDefault(),o){o=!1;return}e.disabled?.()||d(!e.value())};return a.addEventListener("pointerdown",l),a.addEventListener("pointermove",c),a.addEventListener("pointerup",p),a.addEventListener("pointercancel",u),a.addEventListener("click",g),()=>{a.removeEventListener("pointerdown",l),a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",p),a.removeEventListener("pointercancel",u),a.removeEventListener("click",g)}}var si=`
  .toggle {
...
`;var yt=a=>String(a??"").split(".")[0],li=new Set(["input_datetime","time","date","datetime"]),di=a=>li.has(yt(a)),oe=a=>String(a).padStart(2,"0");function ls(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function An(a){if(!a)return null;let e=yt(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:ls(a.state)}var ds=a=>`${a.getFullYear()}-${oe(a.getMonth()+1)}-${oe(a.getDate())}T${oe(a.getHours())}:${oe(a.getMinutes())}`;function cs(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${oe(Math.floor(n/60))}:${oe(n%60)}`}function ci(a,e=An(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${oe(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(yt(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":ds(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${oe(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function pi(a,e,t){let n=yt(a),i=String(t??"");if(!i||!li.has(n)||!e)return null;if(e==="time"){let u=i.match(/^(\d{1,2}):(\d{2})/);if(!u)return null;let g=`${oe(u[1])}:${u[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:g}]:["input_datetime","set_datetime",{entity_id:a,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,d,l,c]=r,p=`${oe(l)}:${c}:00`;if(n==="datetime"){let u=cs(new Date(+o,+s-1,+d,+l,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${d}T${p}${u}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${d} ${p}`}]}var hi=a=>String(a??"").split(".")[0],ui=new Set(["input_select","select"]),Mn=a=>ui.has(hi(a));function $e(a){if(!a||!Mn(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function $t(a,e=$e(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function zt(a,e,t=[]){let n=hi(a),i=String(e??"");return!i||!ui.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var mi={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},ps=/^.*program(?:me)?[_.\- ]/i,hs=30,us=95;function ms(a){return String(a??"").replace(ps,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function gs(a){let e=ms(a);if(!e.length)return"";let t=[];for(let i=0;i<e.length;i++){let r=e[i],o=r.toLowerCase();if(/^\d+$/.test(o)){let l=Number(o);t.push(l>=hs&&l<=us?`${l} \xB0C`:o);continue}let s=e[i+1]?.toLowerCase(),d=s?mi[o+s]:void 0;if(d){t.push(d),i++;continue}t.push(mi[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function fs(a,e){let t=i=>String(i??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(a)}function jt(a,e){return fs(a,e)?String(e):gs(a)||String(a??"")}var Et={row:44,tile:96,compact:44},Le=6,gi=12,Nn=22,bs=["row","tile","compact"],vs=["card","items","none","open"],St=a=>typeof a?.name=="string"?a.name.trim():"",Ge=a=>typeof a=="string"?{entity:a}:{...a},qe=a=>Math.min(Math.max(1,Number(a)||2),3),De=a=>bs.includes(a)?a:"row",ne=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function fi(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(t=>({columns:qe(t.columns),layout:De(t.layout),items:(t.items??t.entities??[]).map(Ge)}));let e=(a?.items??a?.entities??[]).map(Ge);return e.length?[{columns:qe(a.columns),layout:De(a.layout),items:e}]:[]}function At(a){return vs.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var ks=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns));function Tn(a){let e=a?.rows??[],t=St(a)?Nn+Le:0;if(!e.length)return gi+t+Et.row;let n=(At(a)==="card"?gi:0)+t;for(let i of e){let r=ks(i);n+=r*Et[De(i.layout)]+(r-1)*Le}return n+(e.length-1)*Le}var vi=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],xs=a=>vi.find(e=>e.waarde===a)?.label??"Rij";function Mt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();ne(e)&&a.bewaard.push(e)}return a}function _s(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:qe(n.columns),layout:De(n.layout),items:(n.items??n.entities??[]).map(Ge)})):(()=>{let n=(a.items??a.entities??[]).map(Ge);return n.length?[{columns:qe(a.columns),layout:De(a.layout),items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]);for(let r of i)t.push(Mt({columns:n.columns,layout:n.layout,items:r}))}return t}var bi=a=>a.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(ne).map(t=>structuredClone(t))})).filter(e=>e.items.length),ws=`
...
`,Cn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=_s(e);this.gebouwd_&&JSON.stringify(bi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let i=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(r>e?`r${r-1}${i[2]===void 0?"":`i${i[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{ne(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=ws;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=Mt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(d=>{let l=document.createElement("button");l.type="button",l.textContent=d.label,d.titel&&(l.title=d.titel);let c=()=>{t()!==d.waarde&&n(d.waarde)};return i?this.binnenKop_(l,c):l.addEventListener("click",c),r.appendChild(l),[l,d.waarde]}),s=()=>o.forEach(([d,l])=>d.setAttribute("aria-pressed",String(t()===l)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let d=document.createElement("small");o.append(s,d);let l=this.segment_([1,2,3].map(f=>({waarde:f,label:String(f),titel:`${f} entiteit${f>1?"en":""} in deze rij`})),()=>e.columns,f=>{e.columns=f,Mt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,l.wrap,c);let p=document.createElement("div");p.className="rijbody";let u=this.segment_(vi.map(f=>({waarde:f.waarde,label:f.label})),()=>e.layout,f=>{e.layout=f,this.emit_()}),g=document.createElement("div");g.className="vormrij";let h=document.createElement("b");h.textContent="Vorm van deze rij",g.append(h,u.wrap),p.appendChild(g);let b=()=>{let f=e.items.filter(ne),w=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&w.push(xs(e.layout)),w.push(f.length?f.map(z=>this.itemNaam_(z)).join(", "):"nog leeg"),d.textContent=w.join(" \xB7 "),l.vernieuw(),u.vernieuw()};return this.koppen_.push(b),e.items.forEach((f,w)=>p.appendChild(this.itemBlok_(e,f,t,w))),n.append(i,p),b(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let d=document.createElement("span");d.className="nr",d.textContent=String(i+1),d.title=`Plek ${i+1} in de rij`;let l=document.createElement("span");l.className="titel";let c=document.createElement("b"),p=document.createElement("small");l.append(c,p);let u=document.createElement("button");u.type="button",u.className="weg",u.title="Deze plek leegmaken",u.textContent="\u2715",this.binnenKop_(u,()=>{e.items.splice(i,1),this.itemWeg_(n,i),Mt(e),this.emit_(),this.build_()}),o.append(s,d,l,u);let g=document.createElement("div");g.className="itembody";let h=document.createElement("ha-form");h.hass=this.hass_,h.schema=[{name:"entity",selector:{entity:{}}}],h.computeLabel=()=>"Entiteit",h.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",h.addEventListener("value-changed",E=>{E.stopPropagation(),t.entity=E.detail.value.entity??"",this.emit_()});let b=document.createElement("dac-icon-picker");b.label="Icoon",b.hass=this.hass_,b.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.icon=E.detail.value:delete t.icon,this.emit_()});let f=document.createElement("dac-tone-picker");f.label="Kleur",f.hass=this.hass_,f.addEventListener("value-changed",E=>{E.stopPropagation(),E.detail.value?t.tone=E.detail.value:delete t.tone,this.emit_()});let w=document.createElement("ha-form");w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],w.computeLabel=E=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[E.name]??E.name,w.computeHelper=E=>{if(E.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(E.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(E.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(E.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},w.addEventListener("value-changed",E=>{E.stopPropagation();let Q=E.detail.value;Q.name?t.name=Q.name:delete t.name,Q.toggle===!0?t.toggle=!0:delete t.toggle;for(let Y of["show_icon","show_name","show_state"])Q[Y]===!1?t[Y]=!1:delete t[Y];for(let Y of["icon_tap_action","icon_hold_action","tap_action","hold_action"])Q[Y]?t[Y]=Q[Y]:delete t[Y];Q.double_tap_action&&Q.double_tap_action.action!=="none"?t.double_tap_action=Q.double_tap_action:delete t.double_tap_action,this.emit_()});let z=()=>{c.textContent=ne(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ne(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ne(t)),u.hidden=!ne(t)};return this.koppen_.push(z),h.data={entity:t.entity||void 0},b.value=t.icon??"",f.value=t.tone??"",w.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(h,b,f,w),r.append(o,g),z(),r}emit_(){let e=bi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};T("domotiapp-entities-card-editor",Cn);var Nt=class extends S{validate(e){let t=fi(e);return t.some(n=>n.items.some(ne))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[N]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?P(e.tone):this.config.tone?P(this.config.tone):de(e.entity)!=="light"?A.accent:Ua(k(this.hass,e.entity))??A.lit}metSchakelaar_(e){return!!e.toggle&&Wa(e.entity)}metTijd_(e){return!di(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!Mn(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",At(e)),this.style.containerType="inline-size";let t=At(e)==="items",n=e.rows.map((o,s)=>{let d=e.state_position==="right"&&o.layout!=="tile",l=`<span class="st${d?" rechts":""}"></span>`,c=o.items.map((p,u)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${d?l:""}
            ${this.metSchakelaar_(p)?ri({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}"
           style="--cols:${o.columns};--it-h:${Et[o.layout]}px">${c}</div>`}).join("");return`<div class="card surface">${St(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,d)=>ce(this,this.hass,t,t[s]??d),i={action:t.entity?"more-info":"none"};this.teardown_.push(H(e,{onTap:()=>n("tap_action",i),onHold:()=>n("hold_action",i),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(H(r,{onTap:()=>n("icon_tap_action",Be(t.entity)),onHold:()=>n("icon_hold_action",i)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let u=p.target?.closest?.(".tijd");if(u&&(p.stopPropagation(),p.type==="click"))try{u.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let d=null,l=null,c=()=>{clearTimeout(l),l=null;let p=d;d=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(l)),this.on(e,"change",p=>{let u=p.target?.closest?.(".tijd");u&&(p.stopPropagation(),d=pi(t.entity,u.type,u.value),clearTimeout(l),l=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=d=>{d.target?.closest?.(".keuze")&&d.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",d=>{let l=d.target?.closest?.(".keuze");if(!l)return;d.stopPropagation();let c=k(this.hass,t.entity),p=zt(t.entity,l.value,$e(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(oi(o,{value:()=>ge(k(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>Z(k(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,St(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let i=k(this.hass,n.entity),r=ge(i),o=!!n.entity&&Z(i);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let d=D(this.hass,n.entity,n.name),l=t.querySelector(".chip");if(l){let z=mt(this.hass,n.entity,n.icon),E=n.icon||(z?`pic:${z}`:hn(n.entity,W(this.hass,n.entity)));l.dataset.icon!==E&&(l.dataset.icon=E,l.classList.toggle("pic",!!z),l.innerHTML=z?`<img src="${z}" alt="" loading="lazy" />`:v(n.icon||hn(n.entity,W(this.hass,n.entity)))),l.style.setProperty("--tone",z?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),l.setAttribute("aria-label",n.entity?`${d} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,d);let p=t.querySelector(".toggle");p&&(Sn(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${d} aan of uit`));let u=t.querySelector(".tijdslot"),g=null;if(u){let z=o?null:An(i);u.dataset.soort!==(z??"")&&(u.dataset.soort=z??"",u.innerHTML=z?`<input class="tijd" type="${z}" step="60" />`:""),g=u.querySelector(".tijd")}if(g&&(g.setAttribute("aria-label",`${d} instellen`),this.shadowRoot.activeElement!==g)){let z=ci(i,u.dataset.soort);g.value!==z&&(g.value=z)}let h=t.querySelector(".keuzeslot"),b=null;if(h){let z=o?[]:$e(i),E=z.map(Y=>jt(Y,this.hass?.formatEntityState?.(i,Y))),Q=JSON.stringify([z,E]);h.dataset.opties!==Q&&(h.dataset.opties=Q,h.innerHTML=z.length?`<select class="keuze">${z.map((Y,No)=>`<option value="${K(Y)}">${K(E[No])}</option>`).join("")}</select>`:""),b=h.querySelector(".keuze")}if(b&&(b.setAttribute("aria-label",`${d} kiezen`),this.shadowRoot.activeElement!==b)){let z=$t(i);b.value!==z&&(b.value=z)}let f=t.querySelector(".st"),w=n.show_state??this.config.show_state;if(p||g||b)f.textContent="";else if(w===!1)f.textContent="";else if(o)f.textContent="Niet bereikbaar";else if(!i||dn(i.entity_id))f.textContent="";else if(de(i.entity_id)==="light"&&r&&i.attributes.brightness!=null)f.textContent=`${Math.round(i.attributes.brightness/255*100)}%`;else{let z=i.attributes.unit_of_measurement;f.textContent=z?`${i.state} ${z}`:J(this.hass,i)}t.setAttribute("aria-label",`${d}${i?`, ${J(this.hass,i)}`:""}`)})}getCardSize(){return pe(Tn(this.config))}getGridOptions(){let e=pe(Tn(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};$(Nt,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${Nn}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);M("domotiapp-entities-card",Nt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var B={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},U=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),On=a=>!a||a.state==="off",Ln=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),Dn=a=>a?.state==="playing",ki=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function xi(a){if(!a)return[];let e=[];return(U(a,B.TURN_ON)||U(a,B.TURN_OFF))&&e.push("power"),On(a)||(U(a,B.PREVIOUS_TRACK)&&e.push("prev"),U(a,B.PLAY)||U(a,B.PAUSE)||U(a,B.PLAY_MEDIA)?e.push("play"):U(a,B.STOP)&&e.push("stop"),U(a,B.NEXT_TRACK)&&e.push("next")),e}var ze=a=>a?.volume_entity||a?.entity;function Rn(a){if(!Ln(a))return[];let e=[];return U(a,B.VOLUME_MUTE)&&e.push("mute"),U(a,B.VOLUME_SET)?e.push("slider"):U(a,B.VOLUME_STEP)&&e.push("steps"),e}var ke=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),Fe=a=>!!a?.attributes?.is_volume_muted,_i=a=>!!a?.attributes?.mass_player_type,Hn=a=>!!a?.attributes?.shuffle,Vn=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},wi=a=>({off:"all",all:"one",one:"off"})[ys(a)]??"all",ys=a=>["off","all","one"].includes(a)?a:"off";function Pn(a,{zoeken:e=!0}={}){if(!Ln(a))return[];let t=[];return U(a,B.SHUFFLE_SET)&&t.push("shuffle"),U(a,B.REPEAT_SET)&&t.push("repeat"),e&&_i(a)&&t.push("search"),t}function yi(a,{tonen:e=!0}={}){if(!e||!Ln(a)||!U(a,B.SELECT_SOURCE)||_i(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function $i(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function In(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Kn="dacScrollSlot",zi=["position","top","left","right","width","overflow"];function ji(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[Kn])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(zi.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Kn]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of zi)t.style[o]=i[o];t.dataset&&delete t.dataset[Kn],e?.scrollTo?.(0,n)}}}var Ei=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var xe=a=>`domotiapp_lovelace/media/${a}`;function $s(a,e){if(!a)return null;if(e)return a.uri?{type:xe("favorite"),favorite:!0,uri:a.uri}:null;let t=Si(a);return!t||!a.library_item_id?null:{type:xe("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function Si(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Ai={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Bn=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Mi(a,e,t=null){return a?.kind??Si(e)??t??"playlists"}var Un=a=>!!a?.uri,Tt=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:xe("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),Ni=(a,e,t)=>{let n=$s(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Ti=(a,e)=>a.callWS({type:xe("playlist/create"),name:e}).then(t=>t?.playlist??null),Ci=(a,e)=>a.callWS({type:xe("playlist/remove"),library_item_id:String(e.library_item_id)}),Oi=(a,e)=>a.callWS({type:xe("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Li=(a,e,t)=>a.callWS({type:xe("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Di=(a,e,t)=>a.callWS({type:xe("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var zs=350,js={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Es(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=js[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Ss=`
  :host {
    ${ee}
...
`,Wn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=ie(me+Ss)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n,{radioModus:i=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=i,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=ji(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Bn.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
        ...
        <div class="menu" hidden></div>
          ...
          <div class="rij" data-i="${i}" data-knoppen="${l}">
            ...
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let d=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let l=be(s,{value:()=>ke(k(this.hass,d)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:d})});this.schuiven_.set(d,l)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,d=o.querySelector(".slider");if(!d||d.classList.contains("dragging"))continue;let l=k(this.hass,s),c=ke(l);this.zetSchuif_(d,c,Fe(l))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let i=e.parentElement.querySelector(".pct");i&&(i.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=ke(k(this.hass,this.entity_)),i=k(this.hass,e);U(i,B.VOLUME_SET)&&ke(i)!==n&&this.hass.callService("media_player","volume_set",{volume_level:n/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};T("domotiapp-media-browser",Wn);function Ri(a,e,t,n={}){let i=document.querySelector("domotiapp-media-browser");return i||(i=document.createElement("domotiapp-media-browser"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var As=`
  :host {
    ${ee}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Gn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ie(As+me)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};T("domotiapp-bron-kiezer",Gn);function Hi(a,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(a,e,t),n.focus?.(),n}var Ct={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"}},Ot=class extends S{validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[N]:"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?P(this.config.tone):A.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(o,s)=>ce(this,this.hass,e,e[o]??s);this.teardown_.push(I(this.$(".card"))),this.teardown_.push(H(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(H(n,{onTap:()=>t("icon_tap_action",Be(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",o=>o.stopPropagation()),this.on(n,"pointerdown",o=>o.stopPropagation());let i=this.$(".hoesgroot");i&&(this.teardown_.push(H(i,{onTap:()=>t("icon_tap_action",Be(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(i,"click",o=>o.stopPropagation()),this.on(i,"pointerdown",o=>o.stopPropagation()));let r=o=>{let s=o.target.closest?.("[data-k]");s&&(o.stopPropagation(),this.doe_(s.dataset.k))};this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".vol"),"pointerdown",o=>o.stopPropagation()),this.on(this.$(".extra"),"pointerdown",o=>o.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=k(this.hass,t),i=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return i(On(n)?"turn_on":"turn_off");case"bron":return Hi(this.hass,t,D(this.hass,t,this.config.name));case"prev":return i("media_previous_track");case"next":return i("media_next_track");case"play":return i(Dn(n)?"media_pause":"media_play");case"stop":return i("media_stop");case"mute":{let r=ze(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Fe(k(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:ze(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!Hn(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:wi(Vn(n))},{entity_id:t});case"search":return Ri(this.hass,t,D(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.config.speakers});default:return}}paint(){let e=this.config,t=k(this.hass,e.entity),n=!t||t.state==="unavailable",i=ki(t),r=this.$(".top");r.dataset.on=String(i),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:mt(this.hass,e.entity,e.icon),d=s?`pic:${s}`:e.icon||In(t);o.dataset.icon!==d&&(o.dataset.icon=d,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(d,"speaker")),o.style.setProperty("--tone",i&&!s?this.tone_():"var(--dac-ink-3)");let l=this.$(".hoesgroot");l&&l.dataset.icon!==d&&(l.dataset.icon=d,l.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:v(e.icon||In(t),"speaker"));let c=D(this.hass,e.entity,e.name),p=$i(t,u=>J(this.hass,u));this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),O(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),i=this.config.show_controls===!1||t?[]:xi(e),r=i.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${Ct[s].label}">${v(Ct[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=Dn(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=v(s))}}paintVolume_(e,t){let n=this.$(".vol"),i=ze(this.config),r=i===this.config.entity?e:k(this.hass,i),o=this.config.show_volume===!1||t?[]:Rn(r),s=t?null:yi(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let d=[...o,s?"bron":""].join(",");n.dataset.sig!==d&&(n.dataset.sig=d,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${v("volume")}</button>`:"")+(o.includes("slider")?re("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${v("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${v("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${v("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let l=n.querySelector(".bronknop");if(l){let h=s.nu||"Bron";this.text(l.querySelector("b"),h),l.setAttribute("aria-label",`Bron kiezen, nu ${h}`),l.title=`Kies uit ${s.aantal} bronnen`}let c=Fe(r),p=ke(r),u=n.querySelector('[data-k="mute"]');if(u){let h=c?"volumeMute":"volume";u.dataset.icon!==h&&(u.dataset.icon=h,u.innerHTML=v(h)),u.setAttribute("aria-pressed",String(c))}let g=n.querySelector(".slider");g&&(this.attach_(g,"volume",{value:()=>ke(k(this.hass,ze(this.config))),onInput:h=>this.setSlider_(g,h),onCommit:h=>this.hass.callService("media_player","volume_set",{volume_level:h/100},{entity_id:ze(this.config)}),disabled:()=>Z(k(this.hass,ze(this.config)))}),g.classList.contains("dragging")||this.setSlider_(g,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),i=t||this.config.show_controls===!1?[]:Pn(e,{zoeken:this.config.show_search!==!1});n.hidden=!i.length;let r=i.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map((l,c)=>`${l==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${l}" aria-label="${Ct[l].label}">${v(Ct[l].icon)}</button>`).join("")),!i.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(Hn(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let l=Vn(e),c=l==="one"?"repeatOne":"repeat";s.dataset.icon!==c&&(s.dataset.icon=c,s.innerHTML=v(c)),s.setAttribute("aria-pressed",String(l!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[l])}let d=document.querySelector("domotiapp-media-browser");d?.hasAttribute("open")&&(d.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let i=be(e,n);this.sliders_.set(t,i),this.teardown_.push(i)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=k(this.hass,this.config?.entity);return 1+(Rn(e).length?1:0)+(Pn(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("media_player."));return n?{entity:n}:{}}};$(Ot,"css",`
    :host { display: block; }
  ...
  `);var Yn=class extends C{defaults(){return{show_current:!0,forecast_type:"daily",days:Ii}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:x.entity("weather")},{name:"name",selector:x.text()},{name:"forecast_type",selector:x.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:x.number(1,Ki)},{name:"show_current",selector:x.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};R("domotiapp-forecast-card-editor",Yn);M("domotiapp-forecast-card",Dt,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var Xe={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},Ye=(a,e)=>!!((a?.attributes?.supported_features??0)&e),Os=(a={})=>{switch(a.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},Rt=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[N]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(i=>{this.on(i,"click",()=>{let r=i.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(H(e.querySelector(".chip"),{onTap:()=>F(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],i=k(this.hass,n.entity),r=W(this.hass,n.entity),o=!i||i.state==="unavailable",s=i?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=D(this.hass,n.entity,n.name);let d=Ye(i,Xe.SET_POSITION)&&r.current_position!=null,l=d?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=l;let c=Os(r),p=(l==="open"?n.icon_open:n.icon_closed)??(l==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[l],u=e.querySelector(".chip");u.dataset.icon!==p&&(u.dataset.icon=p,u.innerHTML=v(p,c[l]));let g=e.querySelector(".st");this.dragging_.has(t)||(g.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":d?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(f=>{if(f.dataset.act==="stop"){f.disabled=o||!Ye(i,Xe.STOP);return}let w=f.dataset.act==="open";f.disabled=o||(w?!Ye(i,Xe.OPEN):!Ye(i,Xe.CLOSE))});let h=e.querySelector(".pos"),b=d&&this.config.show_position!==!1;if(h.hidden=!b,b){if(h.dataset.built||(h.dataset.built="1",h.innerHTML=re("position"),h.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let w=h.querySelector(".slider"),z=E=>{w.style.setProperty("--v",`${E}%`),w.setAttribute("aria-valuenow",String(E)),e.querySelector(".st").textContent=`${E}% open`};this.teardown_.push(be(w,{value:()=>W(this.hass,n.entity).current_position??0,onInput:z,onCommit:E=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:E})}))}let f=h.querySelector(".slider");if(!f.classList.contains("dragging")){let w=r.current_position??0;f.style.setProperty("--v",`${w}%`),f.setAttribute("aria-valuenow",String(w))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>Ye(k(this.hass,n.entity),Xe.SET_POSITION));return pe(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("cover."));return{covers:n?[n]:[]}}};$(Rt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Jn=class extends C{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:x.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};R("domotiapp-cover-card-editor",Jn);M("domotiapp-cover-card",Rt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Ls(a){if(!a)return{label:"Onbekend",home:null};switch(a.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:a.state,home:!1}}}var Ht=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[N]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((i,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(H(e,{onTap:()=>F(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=k(this.hass,t.entity),i=Ls(n);e.style.setProperty("--tone",i.home===!0?"var(--dac-good)":i.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=D(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r);let o=e.querySelector(".ph"),s=n?.attributes?.entity_picture,d=s?`img:${s}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==d&&(o.dataset.kind=d,o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:r?r[0].toUpperCase():j.person),e.setAttribute("aria-label",`${r}, ${i.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return pe(10+t*45+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};$(Ht,"css",`
    :host {
  ...
  `);var ea=class extends C{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,i]of Object.entries(e.tones??{}))t[`kleur:${n}`]=i;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let i of Object.keys(t))i.startsWith("kleur:")&&(t[i]&&(n[i.slice(6)]=t[i]),delete t[i]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Bi(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};R("domotiapp-waste-card-editor",ea);M("domotiapp-waste-card",Vt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function je(a){if(a==null||a==="")return 4;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Pt(a,e=!0){if(typeof a=="string")return{name:"",icon:"",path:a,items:[]};let t=a??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>Pt(n,!1)):[]}}var _e=a=>Array.isArray(a?.items)?a.items.filter(we):[],Ui=a=>_e(a).length>0,we=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.path?.trim()));function Wi(a){return(Array.isArray(a?.items)?a.items:[]).slice(0,20).map(t=>Pt(t))}function It(a,e=4){let t=(a??[]).filter(we),n=je(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let i=Math.max(1,n-1);return{balk:t.slice(0,i),meer:t.slice(i),heeftMeer:!0}}function Gi(a){let e=String(a??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var Ps=`
...
`,qi=/^i(\d+)(s\d+)?$/,Fi=a=>({...a.name?{name:a.name}:{},...a.icon?{icon:a.icon}:{},...a.path?{path:a.path}:{}}),Zi=a=>a.filter(we).map(e=>{let t=(e.items??[]).filter(we).map(Fi);return{...Fi(e),...t.length?{items:t}:{}}}),ta=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(n=>Pt(n));this.gebouwd_&&JSON.stringify(Zi(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Ps;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_()),t.appendChild(this.kleurKiezer_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:i}=It(this.items_,this.rest_.max),r=i.length,o=this.items_.filter(we);if(this.items_.forEach((d,l)=>{if(o.indexOf(d)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(d,l))}),!this.items_.length){let d=document.createElement("p");d.className="uitleg",d.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(d)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${je(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:je(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=je(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}kleurKiezer_(){let e=document.createElement("dac-tone-picker");return e.label="Kleur",e.hass=this.hass_,e.value=this.rest_.tone??"accent",e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value;n&&n!=="accent"?this.rest_.tone=n:delete this.rest_.tone,this.emit_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),d=document.createElement("small");o.append(s,d);let l=()=>{let f=!we(e);n.dataset.leeg=String(f),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||(f?"Nieuwe knop":e.path||"Zonder naam");let w=_e(e).length;d.textContent=w?`Menu met ${w} knop${w===1?"":"pen"}`:e.path?e.path:e.icon?`${fe(e.icon)} -- nog geen pad`:"Nog geen pad"};l(),this.koppen_.push(l);let c=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let u=this.kopKnop_("Verwijderen",j.close,()=>this.verwijder_(t));u.classList.add("weg"),i.append(r,o,c,p,u),n.appendChild(i);let g=document.createElement("div");g.className="body";let h=document.createElement("dac-icon-picker");h.label="Icoon",h.fallback="grid",h.auto=!1,h.hass=this.hass_,h.value=e.icon,h.addEventListener("value-changed",f=>{f.stopPropagation(),e.icon=f.detail.value??"",this.emit_()});let b=document.createElement("ha-form");return b.hass=this.hass_,b.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],b.computeLabel=f=>({name:"Naam",path:"Waar gaat hij heen"})[f.name]??f.name,b.computeHelper=f=>{if(f.name!=="path")return;let w="/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.";return Ui(e)?`${w}

Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:w},b.data={name:e.name,path:e.path},b.addEventListener("value-changed",f=>{f.stopPropagation();let w=f.detail.value??{};e.name=w.name??"",e.path=w.path??"",this.emit_()}),g.append(h,b,...this.subBlok_(e,t)),n.appendChild(g),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let i=document.createElement("div");i.className="sublijst",e.items.forEach((s,d)=>i.appendChild(this.subItemBlok_(e,s,t,d)));let r=document.createElement("button");r.type="button",r.className="subtoevoegen",r.textContent="\uFF0B  Subknop toevoegen",r.disabled=e.items.length>=8,r.addEventListener("click",()=>{e.items.push({name:"",icon:"",path:"",items:[]}),this.open_.add(`i${t}`),this.open_.add(`i${t}s${e.items.length-1}`),this.emit_(),this.build_()});let o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,i,r,o]}subItemBlok_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let d=document.createElement("span");d.className="titel";let l=document.createElement("b"),c=document.createElement("small");d.append(l,c);let p=()=>{s.innerHTML=v(t.icon,"grid"),l.textContent=t.name||(we(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.path||"Nog geen pad"};p(),this.koppen_.push(p);let u=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaatsSub_(e,n,i,-1));u.disabled=i===0;let g=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaatsSub_(e,n,i,1));g.disabled=i===e.items.length-1;let h=this.kopKnop_("Verwijderen",j.close,()=>this.verwijderSub_(e,n,i));h.classList.add("weg"),o.append(s,d,u,g,h),r.appendChild(o);let b=document.createElement("div");b.className="body";let f=document.createElement("dac-icon-picker");f.label="Icoon",f.fallback="grid",f.auto=!1,f.hass=this.hass_,f.value=t.icon,f.addEventListener("value-changed",z=>{z.stopPropagation(),t.icon=z.detail.value??"",this.emit_()});let w=document.createElement("ha-form");return w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],w.computeLabel=z=>({name:"Naam",path:"Waar gaat hij heen"})[z.name]??z.name,w.data={name:t.name,path:t.path},w.addEventListener("value-changed",z=>{z.stopPropagation();let E=z.detail.value??{};t.name=E.name??"",t.path=E.path??"",this.emit_()}),b.append(f,w),r.appendChild(b),r}verplaatsSub_(e,t,n,i){let r=n+i;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let i=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){i.add(r);continue}let s=Number(o[2]);s!==n&&i.add(`i${t}s${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let i=qi.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(`i${r>e?r-1:r}${i[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let i of this.open_){let r=qi.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(i)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Zi(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};T("domotiapp-navbar-card-editor",ta);var Xi=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Je(a){let e=Xi(a),t=0;for(;e&&t++<40;)yield e,e=Xi(e)}function Is(a){for(let e of Je(a)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Ks(a){for(let e of Je(a))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Bs(a){for(let e of Je(a))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Us(a){for(let e of Je(a))if(e.classList?.contains?.("section"))return e;return null}function Yi(a){for(let e of Je(a)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Kt=class extends S{validate(e){let t=Wi(e),n={labels:!0,tone:"accent",...e,items:t,max:je(e?.max)};return t.filter(i=>i.name||i.icon||i.path).length||(n[N]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:i}=It(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let g=_e(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      ...
      </button>`,d=n.map(c=>{let p=r.indexOf(c),u=_e(c);return u.length?`
      <div class="regel kop">
        <span class="mi">${v(c.icon,"grid")}</span>
        <span class="mt">${K(c.name||c.path)}</span>
      </div>`+u.map((h,b)=>s(h,p,b,"sub")).join(""):s(c,p)}).join(""),l=t.map(c=>{let p=_e(c);if(!p.length)return"";let u=r.indexOf(c);return`<div class="menu submenu" data-id="s${u}" role="menu">${p.map((g,h)=>s(g,u,h)).join("")}</div>`}).join("");return`
  ...
  `);M("domotiapp-navbar-card",Kt,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var Ws="dac-tabs:";function ia(a){let e=a??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],i=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:i}}var Bt=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.cards?.length));function Ji(a){return(Array.isArray(a?.tabs)?a.tabs:[]).slice(0,8).map(ia).filter(Bt)}function Gs(a,e){if(!e)return 0;let t=Math.round(Number(a?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function ra(a){let e=(a??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return Ws+e}function qs(a,e,t){let n=null;try{n=a?.getItem?.(e)??null}catch{return null}let i=Number(n);return n===null||n===""||!Number.isInteger(i)?null:i>=0&&i<t?i:null}function Qi(a,e,t){try{return a?.setItem?.(e,String(t)),!0}catch{return!1}}function er(a,e,t){return qs(t,ra(e),e.length)??Gs(a,e.length)}var Fs=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function tr(){let a=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return a.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,i=t.type.startsWith("custom:domotiapp-")?0:1;return n-i||e.naam.localeCompare(t.naam,"nl")}),[...a,...Fs.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function nr(a,e){let t=String(e??"").trim().toLowerCase();return t?a.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):a}async function ar(a,e){let t={type:a};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let i=a.startsWith("custom:")?a.slice(7):`hui-${a}-card`,o=await customElements.get(i)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:a}}catch{}return t}var ir=()=>!!customElements.get("hui-card-element-editor");function rr(a,e,t={}){let n=Array.isArray(a)?[...a]:[],i=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(i)||!n[i]?null:(n.splice(i+1,0,structuredClone(n[i])),n);case"verwijder":return!Number.isInteger(i)||!n[i]?null:(n.splice(i,1),n);case"rooster":return!Number.isInteger(i)||!n[i]||!t.rooster?null:(n[i]={...n[i],grid_options:{...n[i].grid_options??{},...t.rooster}},n);default:return null}}var or=a=>({...a?{config:a}:{},editMode:!0,saveConfig:async()=>{}}),Zs=()=>document.querySelector("home-assistant");function sr({kaarten:a,hass:e,maakKaart:t,opActie:n}){let i=document.createElement("ha-sortable");i.disabled=!1,i.draggableSelector=".dac-kaart",i.rollback=!1,i.invertSwap=!0,i.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];a.forEach((l,c)=>{let p=t(l,c);if(!p)return;let u=document.createElement("div");u.className="dac-kaart";let g=document.createElement("hui-card-edit-mode");g.hass=e,g.lovelace=or(),g.path=[0,0,c],g.hiddenOverlay=!1,g.appendChild(p),o.push(g),u.appendChild(g),r.appendChild(u)}),i.appendChild(r);let s=l=>{for(let c of o)c.hiddenOverlay=!l};i.addEventListener("drag-start",()=>s(!1)),i.addEventListener("drag-end",()=>s(!0)),i.addEventListener("item-moved",l=>{l.stopPropagation(),n("verplaats",{van:l.detail.oldIndex,naar:l.detail.newIndex})});let d={"ll-edit-card":l=>n("bewerk",{index:l.detail.path[2]}),"ll-duplicate-card":l=>n("dupliceer",{index:l.detail.path[2]}),"ll-delete-card":l=>n("verwijder",{index:l.detail.path[2]}),"ll-copy-card":l=>n("kopieer",{index:l.detail.path[2]}),"ll-change-grid-options":l=>n("rooster",{index:l.detail.path?.[2],rooster:l.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[l,c]of Object.entries(d))i.addEventListener(l,p=>{p.stopPropagation(),c(p)});return i}function lr(a){try{let e=typeof structuredClone=="function"?structuredClone(a):JSON.parse(JSON.stringify(a));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function dr({hass:a,kaarten:e}){let t=Zs();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let i=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",d,!0),window.removeEventListener("dialog-closed",l,!0),n(i?{kaart:i}:r?{kaarten:r}:null))},d=g=>{if(g?.detail?.dialogTag!=="hui-dialog-edit-card")return;let h=g.detail?.dialogParams?.cardConfig;g.stopImmediatePropagation?.(),g.stopPropagation(),h&&(i=h);let b=t.querySelector("hui-dialog-create-card");typeof b?.closeDialog=="function"&&b.closeDialog(),setTimeout(s,0)},l=g=>{g?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",d,!0),window.addEventListener("dialog-closed",l,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=a,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...or({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async g=>{let h=g?.views?.[0]?.sections?.[0]?.cards;Array.isArray(h)&&(r=h)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let g=p._layoutElement;if(!g)throw new Error("de proxysectie heeft geen layout-element");g.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(g){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",g),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var Ut=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var Xs=`
...
`,pr=a=>a.filter(Bt).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function Qe(a){let e=String(a?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function oa(a){let e=a.cards?.length??0;return e?e===1?Qe(a.cards[0]):`${e} kaarten`:"Nog geen kaart"}var sa=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(ia);this.gebouwd_&&JSON.stringify(pr(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker, hui-card-element-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Xs;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_()),t.appendChild(this.kleurKiezer_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let i=document.createElement("button");i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Tabblad toevoegen",i.disabled=this.tabs_.length>=8,i.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(i)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}kleurKiezer_(){let e=document.createElement("dac-tone-picker");return e.label="Kleur van het actieve tabblad",e.hass=this.hass_,e.value=this.rest_.tone??"accent",e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value;n&&n!=="accent"?this.rest_.tone=n:delete this.rest_.tone,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),d=document.createElement("small");o.append(s,d);let l=()=>{n.dataset.leeg=String(!Bt(e)),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,d.textContent=oa(e)};l(),this.koppen_.push(l);let c=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let u=this.kopKnop_("Verwijderen",j.close,()=>this.verwijder_(t));u.classList.add("weg"),i.append(r,o,c,p,u),n.appendChild(i);let g=document.createElement("div");g.className="body";let h=document.createElement("dac-icon-picker");h.label="Icoon",h.fallback="grid",h.auto=!1,h.hass=this.hass_,h.value=e.icon,h.addEventListener("value-changed",f=>{f.stopPropagation(),e.icon=f.detail.value??"",this.emit_()});let b=document.createElement("ha-form");return b.hass=this.hass_,b.schema=[{name:"name",selector:{text:{}}}],b.computeLabel=()=>"Naam",b.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",b.data={name:e.name},b.addEventListener("value-changed",f=>{f.stopPropagation(),e.name=f.detail.value?.name??"",this.emit_()}),g.append(h,b,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!ir()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>Inhoud: <b>${oa(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(Ut()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>${e.cards.length?`<b>${oa(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let i=document.createElement("button");return i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Kaart toevoegen",i.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(i),n}uitVoorbeeld(e,t,n){let i=this.tabs_[e];if(i){if(t==="toevoegen"){this.voegToeViaHa_(i,e);return}this.kaartActie_(i,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,i=Number.isInteger(t)?this.tabs_[t]:null;if(!i||!i.cards[n]){e?.remove();return}let r=this.bewerkVak_(i,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,i){if(n==="bewerk"){this.bewerkt_={tab:t,index:i.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){lr(e.cards[i.index]);return}let r=rr(e.cards,n,i);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let i=document.createElement("div");i.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=Qe(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let d=document.createElement("div");d.className="body";let l=document.createElement("hui-card-element-editor");return l.hass=this.hass_,this.lovelace_&&(l.lovelace=this.lovelace_),l.value=e.cards[n],l.addEventListener("config-changed",c=>{c.stopPropagation();let p=c.detail?.config;p&&(e.cards[n]=p,this.emit_(),o.textContent=Qe(p))}),l.addEventListener("GUImode-changed",c=>c.stopPropagation()),d.appendChild(l),i.append(r,d),i}async voegToeViaHa_(e,t){let n=await dr({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=v("grid");let d=document.createElement("span");d.className="titel";let l=document.createElement("b");l.textContent=Qe(t);let c=document.createElement("small");c.textContent=String(t?.type??""),d.append(l,c);let p=this.kopKnop_("Omhoog",j.arrowUp,()=>this.verplaatsKaart_(e,n,i,-1));p.disabled=i===0;let u=this.kopKnop_("Omlaag",j.arrowDown,()=>this.verplaatsKaart_(e,n,i,1));u.disabled=i===e.cards.length-1;let g=this.kopKnop_("Verwijderen",j.close,()=>this.verwijderKaart_(e,n,i));g.classList.add("weg"),o.append(s,d,p,u,g),r.appendChild(o);let h=document.createElement("div");h.className="body";let b=document.createElement("hui-card-element-editor");return b.hass=this.hass_,this.lovelace_&&(b.lovelace=this.lovelace_),b.value=t,b.addEventListener("config-changed",f=>{f.stopPropagation();let w=f.detail?.config;w&&(e.cards[i]=w,this.emit_(),l.textContent=Qe(w),c.textContent=String(w.type??""))}),b.addEventListener("GUImode-changed",f=>f.stopPropagation()),h.appendChild(b),r.appendChild(h),r}verplaatsKaart_(e,t,n,i){let r=n+i;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let i=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){i.add(r);continue}let s=Number(o[1]);s!==n&&i.add(`t${t}k${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let i=document.createElement("input");i.type="text",i.placeholder="Zoek een kaart...",i.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let d=nr(tr(),this.zoek_);if(r.replaceChildren(),!d.length){let l=document.createElement("p");l.className="leeg",l.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(l);return}for(let l of d){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=l.naam;let u=document.createElement("small");u.textContent=l.uitleg||l.type,c.append(p,u),c.addEventListener("click",async()=>{e.cards.push(await ar(l.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),i.addEventListener("input",()=>{this.zoek_=i.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(i,r,s),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=pr(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};T("domotiapp-tabs-card-editor",sa);var hr=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Ys(a){let e=hr(a),t=0;for(;e&&t++<40;)yield e,e=hr(e)}function Js(a){let e=null;for(let n of Ys(a))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,i=0)=>{if(!n||i>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,i+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,i+1);if(o)return o}return null};return t(e)}var Wt=class extends S{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=Ji(e),n={tone:"accent",...e,tabs:t};return t.length||(n[N]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e)}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(I(this.$(".card"))),this.kies_(er(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let i=Math.min(Math.max(0,e),n.length-1);this.open_=i;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===i));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===i);t&&Qi(this.opslag_(),ra(n),i),this.bouw_(i)}async bouw_(e){if(this.kinderen_.has(e)){O(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){t.innerHTML='<div class="leeg">Deze tab heeft nog geen kaart.</div>',O(this.$(".card"));return}this.kinderen_.set(e,null);try{let i=await window.loadCardHelpers?.();if(!i)throw new Error("loadCardHelpers ontbreekt");let r=n.cards.map(s=>{let d=i.createCardElement(s);return d.hass=this.hass,d});this.kinderen_.set(e,r);let o=Js(this);if(o&&Ut()){t.replaceChildren(sr({hass:this.hass,kaarten:n.cards,maakKaart:(s,d)=>r[d]??null,opActie:(s,d)=>o.uitVoorbeeld?.(e,s,d)}),this.voegToeKnop_(o,e)),O(this.$(".card"));return}t.replaceChildren(...r),O(this.$(".card"))}catch(i){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${K(i?.message??i)}</div>`,O(this.$(".card"))}}}voegToeKnop_(e,t){let n=document.createElement("button");return n.type="button",n.className="voegtoe",n.textContent="\uFF0B  Kaart toevoegen",n.addEventListener("click",i=>{i.stopPropagation(),e.uitVoorbeeld?.(t,"toevoegen",{})}),n}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};$(Wt,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);M("domotiapp-tabs-card",Wt,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var V={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},Qs=[[V.FOUT,["error","fout","aborting","afgebroken"]],[V.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[V.PAUZE,["pause","paused","pauze","onderbroken"]],[V.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[V.AF,["finished","complete","done","klaar met","afgelopen"]],[V.KLAAR,["ready","idle","standby","klaar","gereed"]],[V.UIT,["off","inactive","uit"]]],el=new Set([V.DRAAIT]);function mr(a){let e=String(a??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return V.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,i]of Qs)for(let r of i)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return V.ONBEKEND}var gr=a=>el.has(mr(a?.state));function fr(a,e=new Date){if(!a)return null;let t=String(a.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=a.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let i=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(i)return Number(i[1])*60+Number(i[2])+(i[3]?Math.round(Number(i[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function ur(a){if(a==null)return"";if(a<=0)return"Klaar";if(a<60)return`nog ${a} min`;let e=Math.floor(a/60),t=a%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function br(a){if(!a)return null;let e=String(a.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var tl=a=>!!a&&a.state==="on",vr=a=>a===V.DRAAIT||a===V.PAUZE||a===V.UITGESTELD;function kr({status:a,deur:e,rest:t,pct:n}={}){let i=mr(a?.state),r=tl(e);if(i===V.DRAAIT){let o=[];return t!=null?o.push(ur(t)):n!=null&&o.push(`${n}%`),{soort:i,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return i===V.PAUZE?{soort:i,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:i===V.FOUT?{soort:i,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:i===V.AF?{soort:i,tekst:"Programma klaar",tone:"good",waarschuwing:""}:i===V.UITGESTELD?{soort:i,tekst:t!=null?`Start over ${ur(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:i,tekst:"Klep open",tone:"warn",waarschuwing:""}:i===V.UIT?{soort:i,tekst:"Uit",tone:"neutral",waarschuwing:""}:i===V.KLAAR?{soort:i,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:V.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function xr(a){let e=String(a??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var nl={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},Gt=class extends S{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[N]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,i,r)=>`
      ...
      </div>`}wire(){let e=this.config;this.on(this.$(".top"),"click",()=>{let t=e.status||e.remaining||e.program;t&&this.moreInfo_(t)}),this.on(this.$(".knop.start"),"click",()=>this.druk_(e.start)),this.on(this.$(".knop.stop"),"click",()=>this.druk_(e.stop)),this.on(this.$(".knop.slim"),"click",()=>{if(!e.smart)return;let t=ge(k(this.hass,e.smart));this.hass.callService("homeassistant",t?"turn_off":"turn_on",{entity_id:e.smart})}),this.on(this.$(".rij.programma"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.program)return;t.stopPropagation();let i=zt(e.program,n.value,$e(k(this.hass,e.program)));i&&this.hass.callService(i[0],i[1],i[2])}),this.teardown_.push(I(this.$(".card")))}moreInfo_(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}druk_(e){let t=xr(e);t&&this.hass.callService(t[0],t[1],t[2])}paint(){let e=this.config,t=k(this.hass,e.status),n=k(this.hass,e.door),i=fr(k(this.hass,e.remaining)),r=br(k(this.hass,e.progress)),o=kr({status:t,deur:n,rest:i,pct:r}),s=gr(t);this.toggleAttribute("draait",s),this.toggleAttribute("onbekend",s&&r==null);let d=this.$(".top"),l=nl[o.tone]??A.accent;this.$(".card").style.setProperty("--tone",l),d.classList.toggle("unavailable",o.soort==="onbekend");let c=this.$(".chip"),p=e.icon||"dishwasher";c.dataset.icon!==p&&(c.dataset.icon=p,c.innerHTML=v(p,"dishwasher")),c.style.setProperty("--tone",l),this.text(".nm",e.name||D(this.hass,e.status,null)||"Vaatwasser");let u=this.$(".st"),g=K(o.tekst),h=o.waarschuwing?` &middot; <span class="let">${K(o.waarschuwing)}</span>`:"";u.dataset.tekst!==g+h&&(u.dataset.tekst=g+h,u.innerHTML=g+h),d.setAttribute("aria-label",`${this.$(".nm").textContent}, ${o.tekst}`);let b=this.$(".balk"),f=vr(o.soort)&&(r!=null||s);if(b.hidden=!f,f){let w=this.$(".vul"),z=r!=null?`${r}%`:"";z&&w.style.width!==z&&(w.style.width=z),b.setAttribute("role","progressbar"),r!=null?(b.setAttribute("aria-valuenow",String(r)),b.setAttribute("aria-valuemin","0"),b.setAttribute("aria-valuemax","100")):b.removeAttribute("aria-valuenow")}this.paintBediening_(),O(this.$(".card"))}paintBediening_(){let e=this.config,t=this.$(".programslot"),n=k(this.hass,e.program),i=e.program?$e(n):[],r=i.map(l=>jt(l,this.hass?.formatEntityState?.(n,l))),o=JSON.stringify([i,r]);t.dataset.opties!==o&&(t.dataset.opties=o,t.innerHTML=i.length?`<select class="keuze" aria-label="Programma">${i.map((l,c)=>`<option value="${K(l)}">${K(r[c])}</option>`).join("")}</select>`:"");let s=t.querySelector(".keuze");if(s&&this.shadowRoot.activeElement!==s){let l=$t(n);s.value!==l&&(s.value=l)}let d=this.$(".knop.slim");d.hidden=!e.smart,e.smart&&(d.dataset.aan=String(ge(k(this.hass,e.smart)))),this.$(".knop.start").hidden=!e.start,this.$(".knop.stop").hidden=!e.stop,this.$(".rij.programma").hidden=!s,this.$(".rij.knoppen").hidden=!e.smart&&!e.start&&!e.stop}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-dishwasher-card-editor")}static getStubConfig(e,t){return{status:((i,r)=>t?.find(o=>o.startsWith(i)&&r.test(o))??"")("sensor.",/vaatwas|dishwash/i),name:"Vaatwasser"}}};$(Gt,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var la=class extends C{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:x.text()},{name:"status",selector:x.entity(["sensor","binary_sensor"])},{name:"remaining",selector:x.entity(["sensor"])},{name:"progress",selector:x.entity(["sensor","number"])},{name:"program",selector:x.entity(["select","input_select"])},{name:"start",selector:x.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:x.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:x.entity(["binary_sensor"])},{name:"smart",selector:x.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};R("domotiapp-dishwasher-card-editor",la);M("domotiapp-dishwasher-card",Gt,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});var qt=globalThis,Ft=qt.ShadowRoot&&(qt.ShadyCSS===void 0||qt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,da=Symbol(),_r=new WeakMap,et=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==da)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ft&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=_r.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&_r.set(t,e))}return e}toString(){return this.cssText}},he=a=>new et(typeof a=="string"?a:a+"",void 0,da),X=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new et(t,a,da)},wr=(a,e)=>{if(Ft)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=qt.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},ca=Ft?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return he(t)})(a):a;var{is:al,defineProperty:il,getOwnPropertyDescriptor:rl,getOwnPropertyNames:ol,getOwnPropertySymbols:sl,getPrototypeOf:ll}=Object,Zt=globalThis,yr=Zt.trustedTypes,dl=yr?yr.emptyScript:"",cl=Zt.reactiveElementPolyfillSupport,tt=(a,e)=>a,pa={toAttribute(a,e){switch(e){case Boolean:a=a?dl:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},zr=(a,e)=>!al(a,e),$r={attribute:!0,type:String,converter:pa,reflect:!1,useDefault:!1,hasChanged:zr};Symbol.metadata??=Symbol("metadata"),Zt.litPropertyMetadata??=new WeakMap;var ue=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=$r){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&il(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=rl(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??$r}static _$Ei(){if(this.hasOwnProperty(tt("elementProperties")))return;let e=ll(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(tt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tt("properties"))){let t=this.properties,n=[...ol(t),...sl(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(ca(i))}else e!==void 0&&t.push(ca(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return wr(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:pa).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:pa;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??zr)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ue.elementStyles=[],ue.shadowRootOptions={mode:"open"},ue[tt("elementProperties")]=new Map,ue[tt("finalized")]=new Map,cl?.({ReactiveElement:ue}),(Zt.reactiveElementVersions??=[]).push("2.1.2");var va=globalThis,jr=a=>a,Xt=va.trustedTypes,Er=Xt?Xt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Cr="$lit$",ye=`lit$${Math.random().toFixed(9).slice(2)}$`,Or="?"+ye,pl=`<${Or}>`,Ae=document,at=()=>Ae.createComment(""),it=a=>a===null||typeof a!="object"&&typeof a!="function",ka=Array.isArray,hl=a=>ka(a)||typeof a?.[Symbol.iterator]=="function",ha=`[ 	
\f\r]`,nt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Sr=/-->/g,Ar=/>/g,Ee=RegExp(`>|${ha}(?:([^\\s"'>=/]+)(${ha}*=${ha}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Mr=/'/g,Nr=/"/g,Lr=/^(?:script|style|textarea|title)$/i,xa=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),_=xa(1),zh=xa(2),jh=xa(3),Me=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Tr=new WeakMap,Se=Ae.createTreeWalker(Ae,129);function Dr(a,e){if(!ka(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Er!==void 0?Er.createHTML(e):e}var ul=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=nt;for(let s=0;s<t;s++){let d=a[s],l,c,p=-1,u=0;for(;u<d.length&&(o.lastIndex=u,c=o.exec(d),c!==null);)u=o.lastIndex,o===nt?c[1]==="!--"?o=Sr:c[1]!==void 0?o=Ar:c[2]!==void 0?(Lr.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=Ee):c[3]!==void 0&&(o=Ee):o===Ee?c[0]===">"?(o=i??nt,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,l=c[1],o=c[3]===void 0?Ee:c[3]==='"'?Nr:Mr):o===Nr||o===Mr?o=Ee:o===Sr||o===Ar?o=nt:(o=Ee,i=void 0);let g=o===Ee&&a[s+1].startsWith("/>")?" ":"";r+=o===nt?d+pl:p>=0?(n.push(l),d.slice(0,p)+Cr+d.slice(p)+ye+g):d+ye+(p===-2?s:g)}return[Dr(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},rt=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,d=this.parts,[l,c]=ul(e,t);if(this.el=a.createElement(l,n),Se.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=Se.nextNode())!==null&&d.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(Cr)){let u=c[o++],g=i.getAttribute(p).split(ye),h=/([.?@])?(.*)/.exec(u);d.push({type:1,index:r,name:h[2],strings:g,ctor:h[1]==="."?ma:h[1]==="?"?ga:h[1]==="@"?fa:He}),i.removeAttribute(p)}else p.startsWith(ye)&&(d.push({type:6,index:r}),i.removeAttribute(p));if(Lr.test(i.tagName)){let p=i.textContent.split(ye),u=p.length-1;if(u>0){i.textContent=Xt?Xt.emptyScript:"";for(let g=0;g<u;g++)i.append(p[g],at()),Se.nextNode(),d.push({type:2,index:++r});i.append(p[u],at())}}}else if(i.nodeType===8)if(i.data===Or)d.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(ye,p+1))!==-1;)d.push({type:7,index:r}),p+=ye.length-1}r++}}static createElement(e,t){let n=Ae.createElement("template");return n.innerHTML=e,n}};function Re(a,e,t=a,n){if(e===Me)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=it(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Re(a,i._$AS(a,e.values),i,n)),e}var ua=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??Ae).importNode(t,!0);Se.currentNode=i;let r=Se.nextNode(),o=0,s=0,d=n[0];for(;d!==void 0;){if(o===d.index){let l;d.type===2?l=new ot(r,r.nextSibling,this,e):d.type===1?l=new d.ctor(r,d.name,d.strings,this,e):d.type===6&&(l=new ba(r,this,e)),this._$AV.push(l),d=n[++s]}o!==d?.index&&(r=Se.nextNode(),o++)}return Se.currentNode=Ae,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},ot=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Re(this,e,t),it(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==Me&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):hl(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&it(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ae.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=rt.createElement(Dr(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new ua(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Tr.get(e.strings);return t===void 0&&Tr.set(e.strings,t=new rt(e)),t}k(e){ka(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O(at()),this.O(at()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=jr(e).nextSibling;jr(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},He=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Re(this,e,t,0),o=!it(e)||e!==this._$AH&&e!==Me,o&&(this._$AH=e);else{let s=e,d,l;for(e=r[0],d=0;d<r.length-1;d++)l=Re(this,s[n+d],t,d),l===Me&&(l=this._$AH[d]),o||=!it(l)||l!==this._$AH[d],l===y?e=y:e!==y&&(e+=(l??"")+r[d+1]),this._$AH[d]=l}o&&!i&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ma=class extends He{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},ga=class extends He{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},fa=class extends He{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Re(this,e,t,0)??y)===Me)return;let n=this._$AH,i=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==y&&(n===y||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ba=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Re(this,e)}};var ml=va.litHtmlPolyfillSupport;ml?.(rt,ot),(va.litHtmlVersions??=[]).push("3.3.3");var Rr=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new ot(e.insertBefore(at(),r),r,void 0,t??{})}return i._$AI(a),i};var _a=globalThis,q=class extends ue{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Rr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Me}};q._$litElement$=!0,q.finalized=!0,_a.litElementHydrateSupport?.({LitElement:q});var gl=_a.litElementPolyfillSupport;gl?.({LitElement:q});(_a.litElementVersions??=[]).push("4.2.2");var ae=X`
  :host {
    ${he(ee)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${he(me)}
`;var fl=["unavailable","unknown"],bl=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Yt({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let d of o){let l=r[d];if(!l||typeof l!="object")continue;let c=s[d];if(!c||fl.includes(c.state)){i.push(d);continue}if(l.state==="off"){n.push({service:"turn_off",data:{entity_id:d,transition:1}});continue}let p={entity_id:d,transition:1};typeof l.brightness=="number"&&(p.brightness=l.brightness);for(let u of bl)if(l[u]!==void 0){p[u]=l[u];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function Jt(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var ya=["hs","rgb","rgbw","rgbww","xy"],$a="color_temp",vl="onoff";var Ne="kleur";var kl=["unavailable","unknown"],Vr=["color_temp_kelvin","rgb_color","hs_color","xy_color"],xl=[0,100];function se(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===vl,i=t!==null&&t.includes($a),r=t!==null&&t.some(l=>ya.includes(l)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,d=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!kl.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:d?Math.round(o):2e3,maxKelvin:d?Math.round(s):6535,kelvinUitDefaults:i&&!d}}function _l(){return{state:"off"}}function Pr(a,e){let t=e??se(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...El(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function Ir(a,e,t,n){return e?a&&a.state==="on"?{...a}:Pr(t,n):{state:"off"}}function Kr(a,e,t,n){let i=n??se(t),r=Ma(a,t,i);return i.helderheid&&(r.brightness=L(e,1,255)),r}function za(a,e,t,n){let i=n??se(t),r=Ma(a,t,i);return Jr(r),r.color_temp_kelvin=L(e,i.minKelvin,i.maxKelvin),r}function ja(a,e,t,n){let i=n??se(t),r=Ma(a,t,i);return Jr(r),r.hs_color=[L(e?.[0],0,360),L(e?.[1],0,100)],r}function Qt(a,e,t){return a??_l()}function Br(a,e,t){let n=Qt(a,e,t);if(typeof n.brightness=="number")return L(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?L(i,1,255):255}function Ea(a,e,t){let n=t??se(e),i=Qt(a,e,n);if(typeof i.color_temp_kelvin=="number")return L(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?L(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function en(a,e,t){let n=Qt(a,e,t);if(wa(n.hs_color))return[L(n.hs_color[0],0,360),L(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return wa(i)?[L(i[0],0,360),L(i[1],0,100)]:[...xl]}function Sa(a){return a!=null&&typeof a=="object"}function Ur(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Sa(i[s]?.lights?.[o]))return!0;return!1})}function Wr(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function Aa(a,e,t){return Qt(a,e,t).state==="on"}function Gr(a,e,t){let n=t??se(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=Aa(a,e,n),r=qr(n),o=r?wl(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===Ne),kleurkeuze:i&&r,stand:i?o:null}}function qr(a){return!!(a?.kleurtemp&&a?.kleur)}function wl(a,e,t){let n=t??se(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if(Vr.slice(1).some(r=>a[r]!==void 0))return Ne}let i=e?.attributes?.color_mode;return i===$a&&n.kleurtemp?"wit":ya.includes(i)&&n.kleur?Ne:"wit"}function Fr(a,e,t,n){let i=n??se(t);return qr(i)?e==="wit"?za(a,Ea(a,t,i),t,i):ja(a,en(a,t,i),t,i):a}function Zr(a){let e=L(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Xr(a){let e=L(a,1,100);return L(Math.round(e/100*255),1,255)}var yl=1e3,$l=4e4,Hr=7;function zl(a){let e=L(a,yl,$l)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[L(t,0,255),L(n,0,255),L(i,0,255)]}function jl(a){let[e,t,n]=zl(a);return`rgb(${e}, ${t}, ${n})`}function Yr(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:Hr},(r,o)=>{let s=o/(Hr-1),d=t+(n-t)*s;return`${jl(d)} ${Math.round(s*100)}%`}).join(", ")})`}function El(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?L(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===$a&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=L(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&ya.includes(i)&&wa(t.hs_color)&&(n.hs_color=[L(t.hs_color[0],0,360),L(t.hs_color[1],0,100)]),n}function Ma(a,e,t){return a&&a.state==="on"?{...a}:Pr(e,t)}function Jr(a){for(let e of Vr)delete a[e]}function wa(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function L(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var tn="domotiapp-scene-card",Na="domotiapp-scene-card-editor",Qr="domotiapp-scene-editor";var st=["een","twee","drie"],eo="pencil",to=["grid_options","layout_options","view_layout","visibility"];var no="entity_id",Ve=class extends q{constructor(){super();$(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));$(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[no]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[no];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},i={...this._config,entity:n.entity};n.bare?i.bare=!0:delete i.bare,i.entity!==this._config?.entity&&(delete i.name_overrides,this._getypt={}),this._stuurDoor(i)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return y;let t=this._leden();return _`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?_`
          ...
          `:y}
    `}};$(Ve,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),$(Ve,"styles",[ae,X`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===Ca?_`<div class="inhoud">Bezig met laden…</div>`:this._toestand===io?_`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=Aa(i,t,n),o=Gr(i,t,n);return _`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${Sa(i)?y:_`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?_`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,Ir(i,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:y}
        </div>
    ...
    `}_renderHelderheid(e,t,n,i){let r=Zr(Br(i,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,Kr(this._waardeVan(e),Xr(s.detail.value),t,n))};return _`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,i,r){let o=s=>d=>{d.stopPropagation(),s!==r&&this._zetLamp(e,Fr(this._waardeVan(e),s,t,n))};return _`
    ...
    `}_renderKleurtemp(e,t,n,i){let r=Ea(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,za(this._waardeVan(e),s.detail.value,t,n))};return _`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Yr(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,i){let[r,o]=en(i,t,n),s=d=>l=>{l.stopPropagation();let c=en(this._waardeVan(e),t,n),p=d==="tint"?[l.detail.value,c[1]]:[c[0],l.detail.value];this._zetLamp(e,ja(this._waardeVan(e),p,t,n))};return _`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${Tl}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `]);var Cl="0.14.0",Ol=["type","entity","name_overrides","bare"],La="laden",lt="klaar",Da="leeg",Ra="geen-groep",ro="opslagfout",oo="fout",dt=class extends q{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=La,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(Na)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}updated(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?I(e):null),O(e)}disconnectedCallback(){super.disconnectedCallback(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!Ol.includes(n)&&!to.includes(n));t.length&&console.warn(`${tn}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e,this.toggleAttribute("bare",!!e.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Ce(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===Ra){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=La,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?Da:lt}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=ro;return}if(!this.hass.states[t]){this._toestand=Ra;return}this._toestand=oo}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==lt)return;let{oproepen:t}=Yt({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await Jt((i,r)=>this.hass.callService("light",i,r),t);n.length&&this._meldMislukking(n.map(i=>i.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(i=>this._naam(i)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===lt&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Da:lt}render(){if(!this._config)return y;switch(this._toestand){case Ra:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case ro:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case oo:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return _`
      <div class="needs">
    ...
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=v(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===Da,t=this._toestand===La,n=this._iconen();return _`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((i,r)=>_`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==lt)return y;let e=Ur(this._scenes,this._leden,3).length,t=Wr(e);return t?_`<div class="mededeling">${t}</div>`:y}_renderEditor(){return _`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||st[t])}};$(dt,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),$(dt,"styles",[ae,X`
      :host { display: block; }
    ...
    `]);T(tn,dt);T(Na,Ve);T(Qr,Pe);Oe({type:tn,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Cl}).`,preview:!1});var Te="domotiapp-alarm-card",Ha="domotiapp-alarm-card-editor",so="domotiapp-alarm-editor",lo="DomotiApp Wekker",co="https://github.com/Sven2410/domotiapp-lovelace",le="domotiapp_lovelace",te=Object.freeze({get:`${le}/alarms/get`,save:`${le}/alarms/save`,setEnabled:`${le}/alarms/set_enabled`,delete:`${le}/alarms/delete`,stop:`${le}/alarms/stop`,clearMessage:`${le}/alarms/clear_message`,search:`${le}/sound/search`,entities:`${le}/entities/list`,previewStart:`${le}/preview/start`,subscribe:`${le}/updates/subscribe`}),rn="#026FA1";function po(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var Ll="07:00";var Dl=["uri","name","media_type","image"],Rl="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Hl="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Vl="Music Assistant Wekker",Pl="Verlichting Wekker";function on(){return{id:null,name:"",time:Ll,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function ho(a){let e=on();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:Va(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:ct(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function ct(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of Dl)e[t]=a[t]===void 0?null:a[t];return e}function Va(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Pa(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),Va(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function uo(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:ct(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function mo(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function go(a){return Va(a)&&a.slice(0,2)==="02"?Rl:null}function fo(a){return a===!1?Hl:null}function bo(a){return typeof a?.endless=="boolean"?a.endless:null}function sn(a,e){let t=e==="lamp",n=t?Pl:Vl,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function vo(a,e){return sn(e,"speaker")!==null?!1:Pa(a).ok}var Kl=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Bl=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],pt="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ul="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Wl="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Ie=class extends q{constructor(){super(),this._concept=on(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?ho(this.wekker):on(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:te.previewStart,speaker:this._concept.speaker,sound:ct(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:te.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:ct(e),endless:bo(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Pa(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:te.save,person:this.person,alarm:uo(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return _`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return y;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=sn(t,"speaker"),r=sn(n,"lamp"),o=go(e.time),s=fo(e.endless),d=vo(e,t);return _`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Kl.map(([l,c])=>_`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:mo(e.days,l)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${i?_`<div class="uitleg">${this._svg(pt)}<span>${i}</span></div>`:_`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Bl.map(([l,c])=>_`<option value=${l}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${s?_`<div class="waarschuwing">${this._svg(pt)}<span>${s}</span></div>`:y}
      </div>
      ...
      <div class="blok">
        ...
        ${r?_`<div class="uitleg">${this._svg(pt)}<span>${r}</span></div>`:_`
              <div class="vak">
                <select
                  id="lamp"
      ...
      ${this._melding?_`<div class="blok">
            <div class="waarschuwing ${this._melding.fout?"fout":""}">
              ${this._svg(pt)}<span>${this._melding.tekst}</span>
            </div>
          </div>`:y}
    ...
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${he(rn)});
      display: block;
  ...
  `]);var ko="person",Gl="Kies een persoon in de kaartinstellingen.",xo="De gekozen persoon is niet gevonden.",ql="De opgeslagen wekkers van deze persoon zijn onleesbaar.",zu=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function _o(a){if(!a||typeof a!="object"||Array.isArray(a))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=a.person;if(e==null||e==="")return{...a};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${ko}.`))throw new Error(`'${e}' zit niet in het domein ${ko}. Kies een persoon, zoals person.sven.`);return{...a}}function wo(a){return{type:`custom:${a}`}}function yo(a,e){return a?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:xo,isFout:!0}:{soort:"ontbreekt",tekst:Gl,isFout:!1}}function $o(a,e){return a==="not_found"?xo:a==="home_assistant_error"?ql:e||"Er ging iets mis bij het ophalen van de wekkers."}var Fl=["ma","di","wo","do","vr","za","zo"],Zl="Geen wekkers ingesteld",Xl="Eenmalig",Yl="Eenmalig \u2014 afgelopen",Jl="Geen wekker actief",zo="Stoppen",Ql="Er is een melding over deze wekker, maar de tekst ontbreekt.";function ed(a){return!Array.isArray(a)||a.length===0?Xl:[...new Set(a)].sort((t,n)=>t-n).map(t=>Fl[t-1]??"?").join(" ")}function td(a,e){return!a||Array.isArray(a.days)&&a.days.length>0?!1:Date.parse(a?.one_shot_at??"")<=e}function jo(a,e){return td(a,e)?Yl:ed(a?.days)}function Eo(a){let e=a?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Ql,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function So(a){let e=a?.alarms;if(!Array.isArray(e)||e.length===0)return Zl;let t=a?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Jl}function Ao(a,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(a??[]).find(s=>s?.id===o)).filter(Boolean),i=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:i.length?i.join(" en "):"Wekker",tijd:r.join(" en ")}}var nd="0.14.0",ad="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",id="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",Mo="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",rd="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",ln=(a,e="icoon")=>_`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${a} />
  </svg>`,ht=class extends q{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=_o(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(Ha)}static getStubConfig(){return wo(Te)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:Ce(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?I(e):null),O(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:te.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${Te}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${Te}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let i=new Set(this._toestand.ringing??[]);n==="started"?i.add(t):i.delete(t),this._toestand={...this._toestand,ringing:[...i]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:te.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=$o(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:te.entities})}catch(t){this._entiteiten=null,console.warn(`${Te}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:te.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:te.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:te.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:te.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?Ao(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return y;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=yo(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let i=this._stop();return this._editorVoor!==void 0&&!i?_`<div class="card surface">
    ...
    `}_bevestiging(e){return _`<div class="onderrij bevestiging">
      <span class="boodschap">${po(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=Eo(e),i=!!e.enabled;return _`
      <div class="rij ${i?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?_`<div class="onderrij ${n.isFout?"fout":""}">
            ${ln(n.isFout?rd:Mo,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:y}
    `}};$(ht,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),$(ht,"styles",[ae,X`
  ...
  `]);var Ke=class Ke extends q{constructor(){super(...arguments);$(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?y:_`
      <div class="uitleg">
  ...
  `]),$(Ke,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Ia=Ke;T(Te,ht);T(Ha,Ia);T(so,Ie);Oe({type:Te,name:lo,description:`Wekkerkaart van DomotiApp (v${nd}).`,preview:!1,documentationURL:co});var od="0.14.0";Ya(a=>console.warn(`domotiapp-lovelace: ${a}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${od} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{od as VERSION};
