var Sp=Object.defineProperty;var Np=(i,e,t)=>e in i?Sp(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var j=(i,e,t)=>Np(i,typeof e!="symbol"?e+"":e,t);var W=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function Z(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var Ga=null,Uo=i=>{Ga=i},Me=i=>String(i??"").split(".")[0],v=(i,e)=>e&&i?.states?.[e]||null,U=(i,e)=>v(i,e)?.attributes??{},kn=(i,e,t)=>t?null:U(i,e).entity_picture||null;function Fo(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function N(i,e,t){return t||U(i,e).friendly_name||e||""}var Tp=new Set(["scene","script","input_button","button","event"]),Wa=i=>Tp.has(Me(i));function ae(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Wa(i.entity_id):!1}function X(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(Me(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var Op=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),qo=i=>Op.has(Me(i));function Zo(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function vn(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var P=(i,e)=>vn(i,"hass-more-info",{entityId:e});function Lt(i){switch(Me(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function Dp(i){switch(Me(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function Se(i,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let a=n.confirmation===!0?{}:n.confirmation;if(!Ga){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}Ga(a).then(r=>{r&&Ko(i,e,t,n)});return}Ko(i,e,t,n)}}function Ko(i,e,t,n){switch(n.action){case"more-info":P(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=Dp(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),vn(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":vn(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":vn(i,"ll-custom",n);break;default:break}}function F(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function ee(i,e){if(!e)return"";let t=Me(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function K(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Go=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Xo=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Wo=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),xn=(i,e)=>Math.round((Wo(e)-Wo(i))/864e5);function ut(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/(?:^|\D)(\d{1,2})[-./](\d{1,2})[-./](\d{4})(?!\d)/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/(?:^|\D)(\d{4})-(\d{1,2})-(\d{1,2})(?!\d)/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function wn(i,e=new Date){if(!i)return"";let t=xn(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Go[i.getDay()]:`${Go[i.getDay()].slice(0,2)} ${i.getDate()} ${Xo[i.getMonth()]}`}var Yo=i=>i?`${i.getDate()} ${Xo[i.getMonth()]}`:"";function Lp(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function Cp(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function L(i,e=4){if(!i)return;let t=Cp(i);if(!t){e>0&&requestAnimationFrame(()=>L(i,e-1));return}let n=`${Ip(i,Lp(t))}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}var Ua=new WeakMap,Rp=12,Hp=3;function Ip(i,e){let t=Ua.get(i)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-Rp),a=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(a.length===2&&r>=Hp){let s=Math.max(...a);return Ua.set(i,{rij:n,vast:{paar:a,waarde:s}}),s}return Ua.set(i,{rij:n,vast:null}),e}function mt(i){let e=parseFloat(i?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function I(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);L(i)});e.observe(i);for(let t of i.children)e.observe(t);return L(i),()=>e.disconnect()}var Vp="home-assistant";function Qo({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=Vp,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let h=i();if(!h)return!1;for(let[u,m]of e)try{h.get(u)||h.define(u,m)}catch(k){t(`kon ${u} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=i();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var Jo=[];function C(i,e){Jo.push([i,e])}function gt({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function es(i=()=>{}){Qo({leesRegistry:()=>globalThis.customElements,definities:Jo,waarschuw:i})}var Bp=`
  :host {
    ${W}
    display: block;
...
`,A={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ns={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},y=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Y=(i,e="accent")=>A[i]??(i&&/[#(]|^var/.test(i)?i:A[e]),R=Symbol("incomplete"),Pp=i=>`
  <div class="needs">
  ...
  </div>`,Kp=56,ts=8,Ne=i=>Math.max(1,Math.ceil((i+ts)/(Kp+ts))),T=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[Z(Bp+Re+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let a=n.target;!a?.matches||a.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||a.isConnected&&a.matches(":focus-visible")&&a.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[R]||Zo(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[R]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[R];if(e.innerHTML=t?Pp(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(I(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return mt(this.$(e))??t}};j(T,"css","");function O(i,e,{name:t,description:n,preview:a=!0}={}){C(i,e),gt({type:i,name:t,description:n,preview:a})}function V(i,e){C(i,e)}var g=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,S={house:g(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,Za=null,rs=i=>i.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${He(n)} (${n})" aria-pressed="false">${S[n]??""}<span class="naam">${He(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),Xa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Za=Za??[Z(Fp)],this.shadowRoot.adoptedStyleSheets=Za,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,Ya=null,Qa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Ya=Ya??[Z(Zp)],this.shadowRoot.adoptedStyleSheets=Ya,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return A[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
      ...
      </div>`;let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let a=qp.test(n);t.setAttribute("aria-invalid",String(!a)),a&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=!!this.value_,t=this.$(".sw");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.kleur_():"transparent"),t.title=e?`Kleur: ${ns[this.value_]??this.value_}`:"Kleur kiezen",/^#[0-9a-f]{6}$/i.test(this.kleur_())&&(this.$('input[type="color"]').value=this.kleur_()),this.$(".wissen").hidden=!e;let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let a=this.value_ in A?"":this.value_;n.value!==a&&(n.value=a),n.setAttribute("aria-invalid","false")}}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};C("dac-tone-picker",Qa);var f={entity:i=>({entity:i?{domain:i}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(i,e,t=1)=>({number:{min:i,max:e,step:t,mode:"box"}}),select:i=>({select:{mode:"dropdown",options:i}}),action:(i="more-info")=>({ui_action:{default_action:i}})},Ja=(...i)=>({type:"grid",name:"",schema:i}),ei=(i,e,t,n=!1)=>({type:"expandable",name:"",title:i,icon:e,expanded:n,schema:t}),Xp=[{name:"bare",selector:f.bool()}],Yp={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},H=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Xp}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return e.type==="expandable"?e.title??"":Qp[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),a=t("margin-top:16px");for(let o of e){let s=document.createElement({tone:"dac-tone-picker",foto:"dac-foto-picker"}[o.kind]??"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",l=>{l.stopPropagation(),this.patch_({[o.key]:l.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?a:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Yp[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),a.children.length&&this.appendChild(a)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[a,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[a];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},Qp={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Jp(i=new Date){let e=i.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var eh=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],th=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],ti={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},nh=["humidity","wind","uv","precipitation","sunset"],ah=i=>i==null||Number.isNaN(+i)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+i/45)%8],yn=class extends T{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),a=()=>this.toggleAttribute("narrow",n.matches);a(),n.addEventListener("change",a),this.teardown_.push(()=>n.removeEventListener("change",a))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Jp(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${eh[e.getDay()]} ${e.getDate()} ${th[e.getMonth()]}`);let a=this.$(".clock");a&&this.text(a,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=v(this.hass,e.weather),n=U(this.hass,e.weather),a=this.$(".now");if(a&&t){let l=Ct(t.state);a.style.setProperty("--wtone",Y(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${K(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=a.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=b(l,"cloud")),this.text(a.querySelector(".cond"),ee(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=nh.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${Y(ti[l.key].tone)}" title="${ti[l.key].label}">
             ${S[ti[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let a=this.hass?.config?.unit_system?.wind_speed??"km/h",r=ah(t.wind_bearing);return{key:e,value:`${K(this.hass,t.wind_speed,0)} ${a}${r?` ${r}`:""}`}}case"uv":{let r=U(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(v(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${K(this.hass,r,1)}`}:null}case"precipitation":{let a=v(this.hass,n.precipitation_entity);if(a){let r=Number(a.state);if(Number.isNaN(r))return null;let o=a.attributes.unit_of_measurement??"mm";return{key:e,value:`${K(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${K(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${K(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=v(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};j(yn,"css",`
  ...
  `);var ni=class extends H{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[Ja({name:"weather",selector:f.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Ja({name:"sun",selector:f.entity("sun")},{name:"precipitation_entity",selector:f.entity("sensor")}),{name:"name",selector:f.text()},{name:"hide_below",selector:f.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};V("domotiapp-header-card-editor",ni);O("domotiapp-header-card",yn,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var jn=class extends T{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      <div class="sep" style="--tone:${Y(e.tone)}">
...
`;var ih=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),rh=new Set(["hs","rgb","rgbw","rgbww","xy"]),oi=i=>i?.attributes?.supported_color_modes??[],oh=i=>oi(i).some(e=>ih.has(e)),zn=i=>oi(i).some(e=>rh.has(e)),$n=i=>oi(i).includes("color_temp"),os=i=>Math.max(1,Math.round((i??0)/255*100)),En=class extends T{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[R]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var ri=class extends H{defaults(){return{show_colour:!0}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"bulb"}]}schema(){return[{name:"entity",selector:f.entity("light")},{name:"name",selector:f.text()},{name:"show_colour",selector:f.bool()}]}label(e){return{entity:"Lamp",name:"Naam (overschrijft die van de lamp)",show_colour:"Kleurstrips tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"E\xE9n lamp per kaart. Dimbaar krijgt een schuif, alleen schakelbaar een tuimelaar.";if(e.name==="show_colour")return"Kleur en kleurtemperatuur verschijnen zodra de lamp aan is. De kaart is dan twee rijen hoog."}};V("domotiapp-light-card-editor",ri);O("domotiapp-light-card",En,{name:"DomotiApp Verlichting",description:"E\xE9n lamp op \xE9\xE9n rasterrij: dimmen, kleur en kleurtemperatuur."});function ss(i){if(!i)return null;let e=Number(i.state);return Number.isFinite(e)?e:null}function sh(i){let e=i?.attributes?.hvac_action;return e||(i?.state==="off"?"off":i?.state==="cool"?"cooling":i?.state==="heat"?"idle":null)}var si={heating:"var(--dac-solar)",cooling:"var(--dac-grid-in)",drying:"var(--dac-grid-in)",fan:"var(--dac-grid-in)"},li={heating:"Verwarmt",cooling:"Koelt",drying:"Ontvochtigt",fan:"Ventileert",idle:"Uit",off:"Uit"},An=class extends T{validate(e){return e.entity||e.temperature||e.humidity?{...e}:{...e,[R]:"Kies een thermostaat, of een temperatuursensor."}}watched(){let e=this.config;return[e.entity,e.temperature,e.humidity].filter(Boolean)}step_(){let e=U(this.hass,this.config.entity);return Number(this.config.step??e.target_temp_step)||.5}gestapeld_(){return this.config.layout==="gestapeld"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.entity||this.setAttribute("readout",""),this.setAttribute("vorm",this.gestapeld_()?"gestapeld":"rij"),`
      <div class="card surface">
        <div class="kop">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.gestapeld_()&&this.teardown_.push(I(this.$(".card"))),this.teardown_.push(F(this.$(".chip"),{onTap:()=>P(this,e.entity||e.temperature||e.humidity)}));let t=this.$(".set");t&&t.querySelectorAll("button").forEach(n=>this.on(n,"click",()=>this.nudge_(Number(n.dataset.d))))}nudge_(e){let t=this.config,n=U(this.hass,t.entity),a=this.step_(),r=Number(n.min_temp??5),o=Number(n.max_temp??35),s=this.pending_??Number(n.temperature);if(!Number.isFinite(s))return;let l=Math.min(o,Math.max(r,Math.round((s+e*a)/a)*a));this.pending_=l,this.paintTarget_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null,this.hass.callService("climate","set_temperature",{entity_id:t.entity,temperature:this.pending_}),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450)}paintTarget_(){let e=this.$(".target");if(!e)return;let t=U(this.hass,this.config.entity),n=this.pending_??Number(t.temperature);e.classList.toggle("pending",this.pending_!=null),e.textContent=Number.isFinite(n)?`${K(this.hass,n,n%1?1:0)}\xB0`:"--"}paint(){let e=this.config,t=e.entity?v(this.hass,e.entity):null,n=e.entity?ae(t):!1;this.toggleAttribute("dead",n);let a=sh(t),r=e.tone?Y(e.tone):si[a]??"var(--dac-ink-3)";this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("busy",!!si[a]);let o=this.$(".chip"),s=e.icon||"thermo";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s,"thermo")),o.style.setProperty("--tone",si[a]?r:"var(--dac-ink-3)"),this.text(".nm",N(this.hass,e.entity||e.temperature||e.humidity,e.name));let l=e.temperature?ss(v(this.hass,e.temperature)):Number(U(this.hass,e.entity).current_temperature),d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.text(".temp",Number.isFinite(l)?`${K(this.hass,l,1)} ${d}`:"--");let c=e.humidity?ss(v(this.hass,e.humidity)):null,p=this.$(".hum");if(this.gestapeld_()){this.text(".temp",""),p.textContent=li[a]??"";let u=this.$(".t-temp"),m=this.$(".t-hum");u.hidden=!Number.isFinite(l),m.hidden=c==null,u.hidden||(u.querySelector(".w").textContent=`${K(this.hass,l,1)} ${d}`),m.hidden||(m.querySelector(".w").textContent=`${K(this.hass,c,0)}%`)}else p.innerHTML=c==null?"":`${S.drop}${K(this.hass,c,0)}%`,this.text(".sep",c==null?"":"\xB7"),e.entity&&!e.humidity&&li[a]&&a!=="idle"&&(this.text(".sep","\xB7"),p.textContent=li[a]);this.paintTarget_();let h=this.$(".set");if(h){let u=U(this.hass,e.entity),m=this.pending_??Number(u.temperature);h.querySelector('[data-d="-1"]').disabled=n||m<=Number(u.min_temp??5),h.querySelector('[data-d="1"]').disabled=n||m>=Number(u.max_temp??35)}this.gestapeld_()&&L(this.$(".card"))}getCardSize(){return this.gestapeld_()?3:1}getGridOptions(){return this.gestapeld_()?{columns:12,rows:"auto",min_columns:4,min_rows:this.minRijen_(".card",this.config.entity?3:2)}:{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-climate-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("climate."));return n?{entity:n}:{}}};j(An,"css",`
    :host { display: block; height: 100%; }
...
`;var ls=i=>String(i??"").split(".")[0],ds=new Set(["input_select","select"]),ci=i=>ds.has(ls(i));function ve(i){if(!i||!ci(i.entity_id))return[];let e=i.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function ft(i,e=ve(i)){let t=String(i?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function bt(i,e,t=[]){let n=ls(i),a=String(e??"");return!a||!ds.has(n)||t.length&&!t.includes(a)?null:[n,"select_option",{entity_id:i,option:a}]}var me=i=>String(i??"").split(".")[0],Te=i=>i==null||i===""||i==="unknown"||i==="unavailable",Be={domeinen:["sensor"],device_class:"temperature",rol:"tegel",eenheid:"\xB0C"},lh={hoofd_climate:{key:"entity",label:"Apparaat (climate)",domeinen:["climate"],rol:"hoofd",hulp:"De climate-entiteit. Daar komen de standen en de temperatuurknoppen vandaan. Leeg laten mag: dan toont de kaart alleen de sensoren."},hoofd_ventilatie:{key:"entity",label:"Ventilatie-unit",domeinen:["fan","select","input_select","climate"],rol:"hoofd",hulp:"Een fan-entiteit (standen of percentage), of een keuzelijst met de standen. Leeg laten mag."},hoofd_boiler:{key:"entity",label:"Boiler (water_heater of climate)",domeinen:["water_heater","climate"],rol:"hoofd",hulp:"Daar komen de doeltemperatuur en de bedrijfsstanden vandaan. Leeg laten mag."},temperature:{key:"temperature",label:"Binnentemperatuur",...Be,hulp:"Wint van de meting van het apparaat zelf."},outdoor:{key:"outdoor",label:"Buitentemperatuur",...Be},humidity:{key:"humidity",label:"Luchtvochtigheid",domeinen:["sensor"],device_class:"humidity",rol:"tegel",eenheid:"%"},co2:{key:"co2",label:"CO\u2082",domeinen:["sensor"],rol:"tegel",eenheid:"ppm",hulp:"Kleurt oranje boven 1200 ppm en rood boven 1600."},voc:{key:"voc",label:"Luchtkwaliteit (VOC)",domeinen:["sensor"],rol:"tegel"},power:{key:"power",label:"Vermogen",domeinen:["sensor"],device_class:"power",rol:"tegel",eenheid:"W"},energy:{key:"energy",label:"Energie vandaag",domeinen:["sensor"],device_class:"energy",rol:"tegel",eenheid:"kWh"},flow_temp:{key:"flow_temp",label:"Aanvoertemperatuur",...Be},return_temp:{key:"return_temp",label:"Retourtemperatuur",...Be},dhw_temp:{key:"dhw_temp",label:"Tapwatertemperatuur",...Be},water_temp:{key:"water_temp",label:"Watertemperatuur",...Be,hulp:"Wint van de meting van de boiler zelf."},supply_temp:{key:"supply_temp",label:"Toevoertemperatuur",...Be},exhaust_temp:{key:"exhaust_temp",label:"Afvoertemperatuur",...Be},cop:{key:"cop",label:"COP",domeinen:["sensor"],rol:"tegel",hulp:"Rendement: geleverde warmte gedeeld door verbruikte stroom."},thermal:{key:"thermal",label:"Thermisch vermogen",domeinen:["sensor"],rol:"tegel",eenheid:"kW"},compressor:{key:"compressor",label:"Compressor",domeinen:["sensor","binary_sensor"],rol:"tegel",hulp:"Een toerental of percentage, of een aan/uit-sensor."},flow_rate:{key:"flow_rate",label:"Debiet",domeinen:["sensor"],rol:"tegel",eenheid:"l/min"},pressure:{key:"pressure",label:"Waterdruk",domeinen:["sensor"],rol:"tegel",eenheid:"bar"},status:{key:"status",label:"Statussensor",domeinen:["sensor"],rol:"status",hulp:"Een sensor met een woord als toestand (Verwarmen, Tapwater, Stand 2). Komt in de regel onder de naam."},fault:{key:"fault",label:"Storing",domeinen:["binary_sensor"],rol:"storing",hulp:"Een binary_sensor die aan gaat bij een storing. De kaart kleurt dan rood, wat er verder ook aan de hand is."},filter:{key:"filter",label:"Filter",domeinen:["binary_sensor","sensor"],rol:"filter",hulp:"Een binary_sensor die aan gaat als het filter vervangen moet worden, of een sensor met de dagen tot vervanging."},bypass:{key:"bypass",label:"Bypass",domeinen:["binary_sensor"],rol:"tegel"},heating:{key:"heating",label:"Verwarmt (aan/uit)",domeinen:["binary_sensor"],rol:"verwarmt",hulp:"Een binary_sensor die aan is zolang de boiler opwarmt."},mode:{key:"mode",label:"Bedrijfsmodus (keuzelijst)",domeinen:["select","input_select"],rol:"keuze",hulp:"Een keuzelijst van de integratie, bijvoorbeeld Verwarmen / Koelen / Auto. Verschijnt als uitklaplijst op de kaart."},boost:{key:"boost",label:"Boost",domeinen:["switch","input_boolean","button","input_button","script"],rol:"boost",hulp:"Een schakelaar wordt een schuifschakelaar op de kaart; een knop of script een drukknop."}},vt={airco:{label:"Airco",naam:"Airco",icoon:"airco",velden:["hoofd_climate","temperature","outdoor","humidity","power","energy","fault"]},warmtepomp:{label:"Warmtepomp",naam:"Warmtepomp",icoon:"heatPump",velden:["hoofd_climate","status","fault","flow_temp","return_temp","outdoor","dhw_temp","cop","power","thermal","energy","compressor","flow_rate","pressure","mode","boost"]},ventilatie:{label:"Ventilatie (WTW)",naam:"Ventilatie",icoon:"fan",velden:["hoofd_ventilatie","status","fault","co2","humidity","voc","temperature","outdoor","supply_temp","exhaust_temp","filter","bypass","power","boost"]},boiler:{label:"Boiler / warm water",naam:"Boiler",icoon:"boiler",velden:["hoofd_boiler","water_temp","heating","power","energy","fault","mode","boost"]}},Qe="airco",Je=i=>vt[i]??vt[Qe],Pe=i=>Je(i).velden.map(e=>lh[e]),pi=(i,e)=>Pe(i).filter(t=>t.rol===e),ps={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",dry:"Drogen",fan_only:"Ventileren"},dh={heating:"Verwarmt",cooling:"Koelt",drying:"Droogt",fan:"Ventileert",idle:"Standby",off:"Uit",preheating:"Voorverwarmt",defrosting:"Ontdooit"},cs={off:"Uit",on:"Aan",auto:"Auto",low:"Laag",lowest:"Laagst",min:"Min",minimum:"Min",medium:"Midden",mid:"Midden",middle:"Midden",high:"Hoog",highest:"Hoogst",max:"Max",maximum:"Max",boost:"Boost",turbo:"Turbo",quiet:"Stil",silent:"Stil",silence:"Stil",sleep:"Nacht",night:"Nacht",away:"Afwezig",home:"Thuis",eco:"Eco",comfort:"Comfort",party:"Feest",holiday:"Vakantie",electric:"Elektrisch",gas:"Gas",heat_pump:"Warmtepomp",high_demand:"Veel vraag",performance:"Snel",...ps};function de(i){let e=String(i??"").trim();if(!e)return"";let t=e.toLowerCase().replace(/[\s-]+/g,"_");if(cs[t])return cs[t];let n=e.replace(/_/g," ");return n.charAt(0).toUpperCase()+n.slice(1)}function ch(i,e){let t=String(i??"").toLowerCase(),n=Math.abs(Number(e));return t.includes("\xB0")||t==="c"||t==="f"?1:t==="%"||t==="ppm"||t==="w"||t==="hz"||t==="rpm"||t==="ppb"?0:t==="kwh"||t==="kw"||t==="bar"||t==="l/min"||t==="m\xB3/h"||t?n>=100?0:1:n>=100?0:n>=10?1:2}function ph(i,e,t="nl"){let n=Number(i);if(!Number.isFinite(n))return"--";let a=ch(e,n);return n.toLocaleString(t,{minimumFractionDigits:a,maximumFractionDigits:a})}var hh={bypass:["Open","Dicht"],compressor:["Aan","Uit"],heating:["Ja","Nee"],filter:["Vervangen","Schoon"]};function uh(i,e,t="nl"){if(!i||!e)return null;let n=String(e.state??"").trim(),a=e.attributes?.unit_of_measurement??i.eenheid??"";if(me(e.entity_id)==="binary_sensor"){let[l,d]=hh[i.key]??["Aan","Uit"],c=Te(n),p=n==="on";return{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:c?"--":p?l:d,eenheid:"",let:i.key==="filter"&&p?"warn":""}}let r=Number(n),o=!Te(n)&&Number.isFinite(r),s="";return i.key==="co2"&&o&&(s=r>=1600?"bad":r>=1200?"warn":""),i.key==="filter"&&o&&(s=r<=0?"warn":""),{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:o?ph(r,a,t):Te(n)?"--":n,eenheid:o?a:"",let:s}}function hs(i,e,t,n="nl"){let a=[];for(let r of Pe(i)){if(r.rol!=="tegel"&&r.rol!=="filter")continue;let o=e?.[r.key];if(!o)continue;let s=uh(r,t(o)??{entity_id:o,state:"unavailable",attributes:{}},n);s&&a.push(s)}return a}function us({soort:i,hoofd:e,status:t,fault:n,filter:a,heating:r}={}){let o=mh(a);if(n&&n.state==="on")return{tekst:"Storing",tone:"bad",bezig:!1,waarschuwing:o};if(e&&Te(e.state))return{tekst:"Niet bereikbaar",tone:"neutral",bezig:!1,waarschuwing:o};let s=t&&!Te(t.state)?de(t.state):"",l=me(e?.entity_id);if(e&&l==="climate"){let c=(e.attributes??{}).hvac_action??(e.state==="off"?"off":"idle"),p=dh[c]??de(c),h=c==="heating"||c==="preheating"?"solar":["cooling","drying","fan"].includes(c)?"water":"neutral",u=h!=="neutral"||c==="defrosting";return{tekst:s&&s!==p?`${p} \xB7 ${s}`:p,tone:h,bezig:u,waarschuwing:o}}if(e&&l==="fan"){let d=e.attributes??{};if(e.state==="off")return{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o};let c=d.preset_mode?de(d.preset_mode):Number.isFinite(Number(d.percentage))?`${Math.round(Number(d.percentage))}%`:"Aan";return{tekst:s&&s!==c?`${c} \xB7 ${s}`:`Ventileert \xB7 ${c}`,tone:"water",bezig:!0,waarschuwing:o}}if(e&&l==="water_heater"){let d=e.attributes??{},c=de(e.state),p=r?r.state==="on":d.operation_mode!=="off"&&e.state!=="off"&&d.hvac_action==="heating";return e.state==="off"?{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:p?`Verwarmt \xB7 ${c}`:c,tone:p?"solar":"neutral",bezig:p,waarschuwing:o}}if(e&&(l==="select"||l==="input_select")){let d=de(e.state),c=/^(uit|off)$/i.test(e.state);return{tekst:c?"Uit":`Stand \xB7 ${d}`,tone:c?"neutral":"water",bezig:!c,waarschuwing:o}}return r&&r.state==="on"?{tekst:s?`Verwarmt \xB7 ${s}`:"Verwarmt",tone:"solar",bezig:!0,waarschuwing:o}:s?{tekst:s,tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:Je(i).naam,tone:"neutral",bezig:!1,waarschuwing:o}}function mh(i){if(!i||Te(i.state))return"";if(me(i.entity_id)==="binary_sensor")return i.state==="on"?"Filter vervangen":"";let e=Number(i.state);return Number.isFinite(e)&&e<=0?"Filter vervangen":""}var gh=[["0","Uit"],["33","Laag"],["66","Midden"],["100","Hoog"]];function hi(i){if(!i)return[];let e=i.attributes??{},t=me(i.entity_id),n=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"&&r!==""):[];if(t==="climate")return n(e.hvac_modes).map(a=>({waarde:a,label:ps[a]??de(a)}));if(t==="water_heater")return n(e.operation_list).map(a=>({waarde:a,label:de(a)}));if(t==="select"||t==="input_select")return n(e.options).map(a=>({waarde:a,label:de(a)}));if(t==="fan"){let a=n(e.preset_modes);if(a.length)return a.map(r=>({waarde:r,label:de(r)}));if(e.percentage!=null||e.percentage_step!=null){let r=Number(e.percentage_step)||1;return gh.map(([o,s])=>({waarde:String(Math.min(100,Math.round(Number(o)/r)*r)),label:s}))}return[{waarde:"off",label:"Uit"},{waarde:"on",label:"Aan"}]}return[]}function ms(i,e=hi(i)){if(!i||Te(i.state))return"";let t=i.attributes??{};if(me(i.entity_id)==="fan"){if(t.preset_mode&&e.some(r=>r.waarde===t.preset_mode))return t.preset_mode;if(i.state==="off")return e.some(r=>r.waarde==="0")?"0":"off";let a=Number(t.percentage);if(Number.isFinite(a)&&e.length){let r=e[0];for(let o of e)Math.abs(Number(o.waarde)-a)<Math.abs(Number(r.waarde)-a)&&(r=o);return r.waarde}return i.state==="on"?"on":""}return e.some(a=>a.waarde===i.state)?i.state:""}function gs(i,e){if(!i)return null;let t=i.entity_id,n=String(e??"");if(!n)return null;let a=me(t);switch(a){case"climate":return["climate","set_hvac_mode",{entity_id:t,hvac_mode:n}];case"water_heater":return["water_heater","set_operation_mode",{entity_id:t,operation_mode:n}];case"select":case"input_select":return[a,"select_option",{entity_id:t,option:n}];case"fan":{let r=i.attributes?.preset_modes;if(Array.isArray(r)&&r.includes(n))return["fan","set_preset_mode",{entity_id:t,preset_mode:n}];if(n==="off")return["fan","turn_off",{entity_id:t}];if(n==="on")return["fan","turn_on",{entity_id:t}];let o=Number(n);return Number.isFinite(o)?o<=0?["fan","turn_off",{entity_id:t}]:["fan","set_percentage",{entity_id:t,percentage:o}]:null}default:return null}}function ui(i){let e=i?.attributes?.fan_modes;return me(i?.entity_id)!=="climate"||!Array.isArray(e)?[]:e.filter(t=>typeof t=="string"&&t).map(t=>({waarde:t,label:de(t)}))}function fs(i,e){let t=String(e??"");return!i||!t||!ui(i).some(n=>n.waarde===t)?null:["climate","set_fan_mode",{entity_id:i.entity_id,fan_mode:t}]}function mi(i,e){if(!i||Te(i.state))return null;let t=i.attributes??{},n=me(i.entity_id);if(n!=="climate"&&n!=="water_heater")return null;let a=Number(t.temperature);if(!Number.isFinite(a))return null;let r=Number(e)||Number(t.target_temp_step)||(n==="water_heater"?1:.5);return{min:Number(t.min_temp??(n==="water_heater"?30:5)),max:Number(t.max_temp??(n==="water_heater"?70:35)),stap:r,doel:a,huidig:Number.isFinite(Number(t.current_temperature))?Number(t.current_temperature):null}}function bs(i,e,t){if(!i)return null;let a=(Number.isFinite(e)?e:i.doel)+t*i.stap,r=Math.round(a/i.stap)*i.stap,o=Math.round(r*100)/100;return Math.min(i.max,Math.max(i.min,o))}function vs(i,e){if(!i||!Number.isFinite(e))return null;let t=me(i.entity_id);return t!=="climate"&&t!=="water_heater"?null:[t,"set_temperature",{entity_id:i.entity_id,temperature:e}]}var ks=i=>["switch","input_boolean"].includes(me(i));function gi(i,e=!0){let t=String(i??""),n=me(t);switch(n){case"switch":case"input_boolean":return["homeassistant",e?"turn_on":"turn_off",{entity_id:t}];case"button":case"input_button":return[n,"press",{entity_id:t}];case"script":return["script","turn_on",{entity_id:t}];default:return null}}function xs(i,e){let t=Number(e?.state);if(e&&!Te(e.state)&&Number.isFinite(t))return t;let n=i?.attributes?.current_temperature;if(n==null||n==="")return null;let a=Number(n);return Number.isFinite(a)?a:null}var ws={solar:A.solar,water:A.water,bad:A.bad,warn:A.warn,neutral:"var(--dac-ink-3)"},Tn=class extends T{validate(e){let t={soort:Qe,...e};return vt[t.soort]||(t.soort=Qe),Pe(t.soort).some(a=>t[a.key])||(t[R]="Kies de soort en minstens \xE9\xE9n entiteit: het apparaat zelf, of een sensor."),t}watched(){let e=this.config;return Pe(e.soort).map(t=>e[t.key]).filter(Boolean)}hoofd_(){return v(this.hass,this.config.entity)??null}metRol_(e){let t=pi(this.config.soort,e)[0];return t?v(this.hass,this.config[t.key])??null:null}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=e.boost?ks(e.boost)?Mn({label:"Boost"}):`<button type="button" class="knop">${b("bolt")}<span>Boost</span></button>`:"";return`
      <div class="card surface" style="--tone:var(--dac-ink-3)">
      ...
      </div>`}wire(){let e=this.config;if(this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(I(this.$(".card"))),this.on(this.$(".top"),"click",()=>{let t=e.entity||this.watched()[0];t&&P(this,t)}),this.on(this.$(".standen"),"click",t=>{let n=t.target?.closest?.(".seg");if(!n||n.disabled)return;t.stopPropagation();let a=gs(this.hoofd_(),n.dataset.waarde);a&&this.hass.callService(a[0],a[1],a[2])}),this.$$(".set button").forEach(t=>this.on(t,"click",()=>this.nudge_(Number(t.dataset.d)))),this.on(this.$(".rij.ventilator"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n)return;t.stopPropagation();let a=fs(this.hoofd_(),n.value);a&&this.hass.callService(a[0],a[1],a[2])}),this.on(this.$(".rij.modus"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.mode)return;t.stopPropagation();let a=bt(e.mode,n.value,ve(v(this.hass,e.mode)));a&&this.hass.callService(a[0],a[1],a[2])}),e.boost){let t=this.$(".rij.boost .toggle"),n=this.$(".rij.boost .knop");t&&this.teardown_.push(Sn(t,{value:()=>X(v(this.hass,e.boost)),set:a=>{let r=gi(e.boost,a);r&&this.hass.callService(r[0],r[1],r[2])}})),n&&this.on(n,"click",a=>{a.stopPropagation();let r=gi(e.boost,!0);r&&this.hass.callService(r[0],r[1],r[2])})}}nudge_(e){let t=this.hoofd_(),n=mi(t,this.config.step);n&&(this.pending_=bs(n,this.pending_??n.doel,e),this.paintDoel_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null;let a=vs(t,this.pending_);a&&this.hass.callService(a[0],a[1],a[2]),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450))}paintDoel_(){let e=this.$(".set"),t=mi(this.hoofd_(),this.config.step);if(e.hidden=!t,!t)return;let n=this.pending_??t.doel,a=e.querySelector(".target");a.classList.toggle("pending",this.pending_!=null),a.innerHTML=`${K(this.hass,n,n%1?1:0)}\xB0<small>doel</small>`,e.querySelector('[data-d="-1"]').disabled=n<=t.min,e.querySelector('[data-d="1"]').disabled=n>=t.max}paint(){let e=this.config,t=Je(e.soort),n=this.hoofd_(),a=us({soort:e.soort,hoofd:n,status:this.metRol_("status"),fault:this.metRol_("storing"),filter:this.metRol_("filter"),heating:this.metRol_("verwarmt")}),r=ws[a.tone]??ws.neutral;this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("bezig",a.bezig),this.toggleAttribute("storing",a.tone==="bad"),this.$(".top").classList.toggle("dood",a.tekst==="Niet bereikbaar");let o=this.$(".chip"),s=e.icon||t.icoon;o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s,t.icoon)),this.text(".nm",e.name||(e.entity?N(this.hass,e.entity,null):"")||t.naam);let l=this.$(".st"),d=y(a.tekst)+(a.waarschuwing?` &middot; <span class="let">${y(a.waarschuwing)}</span>`:"");l.dataset.html!==d&&(l.dataset.html=d,l.innerHTML=d),this.$(".top").setAttribute("aria-label",`${this.$(".nm").textContent}, ${a.tekst}`);let c=e.soort==="boiler"?"water_temp":"temperature",p=v(this.hass,e[c])??null,h=xs(n,p),u=p?.attributes?.unit_of_measurement??this.hass?.config?.unit_system?.temperature??"\xB0C",m=this.$(".graden"),k=h==null?"":`${K(this.hass,h,1)}<small>${y(u)}</small>`;if(m.dataset.html!==k&&(m.dataset.html=k,m.innerHTML=k),this.paintTegels_(h==null?null:c),this.paintStanden_(n),this.paintDoel_(),this.paintKeuzes_(n),e.boost){let x=this.$(".rij.boost .toggle");x&&(x.style.setProperty("--tone",A.accent),Rt(x,X(v(this.hass,e.boost))))}L(this.$(".card"))}paintTegels_(e){let t=this.config,n=this.$(".tegels"),a=hs(t.soort,t,o=>v(this.hass,o)??null,this.hass?.locale?.language??"nl").filter(o=>o.key!==e);n.hidden=a.length===0;let r=JSON.stringify(a);n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(o=>`
        ...
        </div>`).join(""))}paintStanden_(e){let t=this.$(".standen"),n=hi(e);if(t.hidden=n.length<2,t.hidden)return;let a=ms(e,n),r=!e||e.state==="unavailable",o=JSON.stringify([n,a,r]);t.dataset.sig!==o&&(t.dataset.sig=o,t.innerHTML=n.map(s=>`<button type="button" class="seg" data-waarde="${y(s.waarde)}" aria-pressed="${s.waarde===a}"${r?" disabled":""}>${y(s.label)}</button>`).join(""))}paintKeuzes_(e){let t=this.config,n=ui(e),a=this.$(".ventslot");this.vulLijst_(a,n,e?.attributes?.fan_mode??"","Ventilator"),this.$(".rij.ventilator").hidden=n.length===0;let r=v(this.hass,t.mode),o=t.mode?ve(r).map(l=>({waarde:l,label:de(l)})):[],s=this.$(".modusslot");this.vulLijst_(s,o,ft(r),"Modus"),this.$(".rij.modus").hidden=o.length===0}vulLijst_(e,t,n,a){let r=JSON.stringify(t);e.dataset.opties!==r&&(e.dataset.opties=r,e.innerHTML=t.length?`<select class="keuze" aria-label="${y(a)}">${t.map(s=>`<option value="${y(s.waarde)}">${y(s.label)}</option>`).join("")}</select>`:"");let o=e.querySelector(".keuze");o&&this.shadowRoot.activeElement!==o&&o.value!==n&&(o.value=n)}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-hvac-card-editor")}static getStubConfig(e,t){let n=t?.find(o=>o.startsWith("climate.")),a=t?.find(o=>o.startsWith("fan.")),r=t?.find(o=>o.startsWith("water_heater."));return r?{soort:"boiler",entity:r}:n?{soort:"airco",entity:n}:a?{soort:"ventilatie",entity:a}:{soort:Qe}}};j(Tn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var fi=class extends H{defaults(){return{soort:Qe}}soort_(){return vt[this.config_?.soort]?this.config_.soort:Qe}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:Je(this.soort_()).icoon,auto:!1}]}sync_(){super.sync_();for(let e of this.pickers_??[])e.dataset.key==="icon"&&(e.fallback=Je(this.soort_()).icoon)}schema(){let e=this.soort_(),t=Pe(e).map(r=>({name:r.key,selector:{entity:{domain:r.domeinen,...r.device_class?{device_class:r.device_class}:{}}}})),a=pi(e,"hoofd")[0]?.domeinen.some(r=>r==="climate"||r==="water_heater");return[{name:"soort",selector:f.select(Object.entries(vt).map(([r,o])=>({value:r,label:o.label})))},{name:"name",selector:f.text()},...t,...a?[{name:"step",selector:f.number(.1,5,.1)}]:[]]}label(e){let t=Pe(this.soort_()).find(n=>n.key===e.name);return t?t.label:{soort:"Soort apparaat",name:"Naam",step:"Stap van de temperatuurknoppen"}[e.name]??super.label(e)}helper(e){let t=Pe(this.soort_()).find(n=>n.key===e.name);if(t?.hulp)return t.hulp;if(e.name==="soort")return"Bepaalt welke velden hieronder staan, het icoon, en hoe de statusregel leest.";if(e.name==="name")return`Leeg laten geeft de naam van het apparaat, of anders "${Je(this.soort_()).naam}".`;if(e.name==="step")return"Leeg laten volgt het apparaat: een halve graad bij een climate, een hele bij een boiler."}};V("domotiapp-hvac-card-editor",fi);O("domotiapp-hvac-card",Tn,{name:"DomotiApp HVAC",description:"Airco, warmtepomp, ventilatie of boiler: status, metingen als tegels, de standen van het apparaat, doeltemperatuur en boost."});var On=i=>String(i??"").split(".")[0],_s=new Set(["input_datetime","time","date","datetime"]),ys=i=>_s.has(On(i)),ke=i=>String(i).padStart(2,"0");function fh(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function bi(i){if(!i)return null;let e=On(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:fh(i.state)}var bh=i=>`${i.getFullYear()}-${ke(i.getMonth()+1)}-${ke(i.getDate())}T${ke(i.getHours())}:${ke(i.getMinutes())}`;function vh(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${ke(Math.floor(n/60))}:${ke(n%60)}`}function js(i,e=bi(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${ke(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(On(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":bh(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${ke(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function zs(i,e,t){let n=On(i),a=String(t??"");if(!a||!_s.has(n)||!e)return null;if(e==="time"){let h=a.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let u=`${ke(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:u}]:["input_datetime","set_datetime",{entity_id:i,time:u}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${ke(d)}:${c}:00`;if(n==="datetime"){let h=vh(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var $s={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},kh=/^.*program(?:me)?[_.\- ]/i,xh=30,wh=95;function _h(i){return String(i??"").replace(kh,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function yh(i){let e=_h(i);if(!e.length)return"";let t=[];for(let a=0;a<e.length;a++){let r=e[a],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=xh&&d<=wh?`${d} \xB0C`:o);continue}let s=e[a+1]?.toLowerCase(),l=s?$s[o+s]:void 0;if(l){t.push(l),a++;continue}t.push($s[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function jh(i,e){let t=a=>String(a??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(i)}function Dn(i,e){return jh(i,e)?String(e):yh(i)||String(i??"")}var Cn={row:44,tile:96,compact:44,beeld:120},Ke=6,Es=12,vi=22,zh=["row","tile","compact","beeld"],$h=["links","midden"],ki=48,xi=320,Ln=120,xe=i=>{if(i==null||i==="")return Ln;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(xi,Math.max(ki,e)):Ln},Ht=i=>$h.includes(i)?i:"links";function As(i,e){let t=Array.isArray(i)?i:[],n=Array.from({length:e},(a,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var Eh=["card","items","none","open"],Rn=i=>typeof i?.name=="string"?i.name.trim():"",It=i=>typeof i=="string"?{entity:i}:{...i},Vt=i=>Math.min(Math.max(1,Number(i)||2),3),kt=i=>zh.includes(i)?i:"row",ce=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function Ms(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(n=>{let a=Vt(n.columns);return{columns:a,layout:kt(n.layout),align:Ht(n.align),image_size:xe(n.image_size),column_names:As(n.column_names,a),items:(n.items??n.entities??[]).map(It)}});let e=(i?.items??i?.entities??[]).map(It);if(!e.length)return[];let t=Vt(i.columns);return[{columns:t,layout:kt(i.layout),align:Ht(i.align),image_size:xe(i.image_size),column_names:As(i.column_names,t),items:e}]}function Hn(i){return Eh.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var Ah=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns)),Mh=22;function Sh(i){let e=kt(i?.layout);return e!=="beeld"?Cn[e]:xe(i?.image_size)+34}function wi(i){let e=i?.rows??[],t=Rn(i)?vi+Ke:0;if(!e.length)return Es+t+Cn.row;let n=(Hn(i)==="card"?Es:0)+t;for(let a of e){let r=Ah(a);n+=r*Sh(a)+(r-1)*Ke,a.column_names?.length&&(n+=Mh+Ke)}return n+(e.length-1)*Ke}function Bt(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();ce(e)&&i.bewaard.push(e)}return i}function Ss(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Vt(n.columns),layout:kt(n.layout),align:Ht(n.align),image_size:xe(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(It)})):(()=>{let n=(i.items??i.entities??[]).map(It);return n.length?[{columns:Vt(i.columns),layout:kt(i.layout),align:Ht(i.align),image_size:xe(i.image_size),column_names:Array.isArray(i.column_names)?[...i.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]),a.forEach((r,o)=>t.push(Bt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var _i=i=>i.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Ln?{image_size:xe(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ce).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function yi(i,e,t){let n=new Set;for(let a of i){let r=/^r(\d+)(?:i(\d+))?$/.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:a);continue}n.add(o>e?`r${o+1}${s}`:a)}return n}var Ns=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],Nh=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],Th=i=>Ns.find(e=>e.waarde===i)?.label??"Rij",Oh=`
...
`,ji=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Ss(e);this.gebouwd_&&JSON.stringify(_i(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=yi(this.open_,e,"weg")}rijErbij_(e){this.open_=yi(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{ce(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Oh;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=Bt({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(D=>({waarde:D,label:String(D),titel:`${D} entiteit${D>1?"en":""} in deze rij`})),()=>e.columns,D=>{e.columns=D,Bt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let u=this.segment_(Ns.map(D=>({waarde:D.waarde,label:D.label})),()=>e.layout,D=>{e.layout=D,ne(),this.emit_()}),m=document.createElement("div");m.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",m.append(k,u.wrap),h.appendChild(m);let x=this.segment_(Nh.map(D=>({waarde:D.waarde,label:D.label})),()=>e.align??"links",D=>{e.align=D,this.emit_()}),w=document.createElement("div");w.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",w.append(_,x.wrap),h.appendChild(w);let $=document.createElement("div");$.className="beeldvak";let M=document.createElement("ha-form");M.hass=this.hass_,M.schema=[{name:"image_size",selector:{number:{min:ki,max:xi,step:4,mode:"slider"}}}],M.computeLabel=()=>"Grootte van de afbeelding",M.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",M.data={image_size:xe(e.image_size)},M.addEventListener("value-changed",D=>{D.stopPropagation(),e.image_size=xe(D.detail.value?.image_size),this.emit_()}),$.appendChild(M),h.appendChild($);let ne=()=>{let D=e.layout==="beeld";$.style.display=D?"":"none",w.style.display=D?"none":""};ne();let ue=document.createElement("div");ue.className="kolomvak";let fe=document.createElement("ha-form");fe.hass=this.hass_;let Io=()=>Array.from({length:e.columns},(D,se)=>({name:`k${se}`,selector:{text:{}}}));fe.schema=Io(),fe.computeLabel=D=>`Kop boven kolom ${Number(D.name.slice(1))+1}`,fe.computeHelper=D=>D.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let Vo=()=>Object.fromEntries(Array.from({length:e.columns},(D,se)=>[`k${se}`,e.column_names?.[se]??""]));fe.data=Vo(),fe.addEventListener("value-changed",D=>{D.stopPropagation();let se=D.detail.value??{};e.column_names=Array.from({length:e.columns},(Po,Mp)=>se[`k${Mp}`]??""),this.emit_()}),ue.appendChild(fe),h.appendChild(ue);let Bo=()=>{let D=e.items.filter(ce),se=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&se.push(Th(e.layout)),se.push(D.length?D.map(Po=>this.itemNaam_(Po)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&se.push("met kolomkoppen"),l.textContent=se.join(" \xB7 "),d.vernieuw(),u.vernieuw(),x.vernieuw(),ne(),fe.schema.length!==e.columns&&(fe.schema=Io()),fe.data=Vo()};return this.koppen_.push(Bo),e.items.forEach((D,se)=>h.appendChild(this.itemBlok_(e,D,t,se))),n.append(a,h),Bo(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(a,1),this.itemWeg_(n,a),Bt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let u=document.createElement("div");u.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,x.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",_=>{_.stopPropagation();let $=_.detail.value;$.name?t.name=$.name:delete t.name,$.toggle===!0?t.toggle=!0:delete t.toggle;for(let M of["show_icon","show_name","show_state"])$[M]===!1?t[M]=!1:delete t[M];for(let M of["icon_tap_action","icon_hold_action","tap_action","hold_action"])$[M]?t[M]=$[M]:delete t[M];$.double_tap_action&&$.double_tap_action.action!=="none"?t.double_tap_action=$.double_tap_action:delete t.double_tap_action,this.emit_()});let w=()=>{c.textContent=ce(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ce(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ce(t)),h.hidden=!ce(t)};return this.koppen_.push(w),m.data={entity:t.entity||void 0},k.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},u.append(m,k,x),r.append(o,u),w(),r}emit_(){let e=_i(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-entities-card-editor",ji);var In=class extends T{validate(e){let t=Ms(e);return t.some(n=>n.items.some(ce))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[R]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?Y(e.tone):this.config.tone?Y(this.config.tone):Me(e.entity)!=="light"?A.accent:Fo(v(this.hass,e.entity))??A.lit}metSchakelaar_(e){return!!e.toggle&&qo(e.entity)}metTijd_(e){return!ys(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!ci(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Hn(e)),this.style.containerType="inline-size";let t=Hn(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,u)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?Mn({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:Cn[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Rn(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>Se(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(F(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(F(r,{onTap:()=>n("icon_tap_action",Lt(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=zs(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=v(this.hass,t.entity),p=bt(t.entity,d.value,ve(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(Sn(o,{value:()=>X(v(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>ae(v(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Rn(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let a=v(this.hass,n.entity),r=X(a),o=!!n.entity&&ae(a);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=N(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let _=kn(this.hass,n.entity,n.icon),$=n.icon||(_?`pic:${_}`:Fa(n.entity,U(this.hass,n.entity)));d.dataset.icon!==$&&(d.dataset.icon=$,d.classList.toggle("pic",!!_),d.innerHTML=_?`<img src="${_}" alt="" loading="lazy" />`:b(n.icon||Fa(n.entity,U(this.hass,n.entity)))),d.style.setProperty("--tone",_?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(Rt(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),u=null;if(h){let _=o?null:bi(a);h.dataset.soort!==(_??"")&&(h.dataset.soort=_??"",h.innerHTML=_?`<input class="tijd" type="${_}" step="60" />`:""),u=h.querySelector(".tijd")}if(u&&(u.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==u)){let _=js(a,h.dataset.soort);u.value!==_&&(u.value=_)}let m=t.querySelector(".keuzeslot"),k=null;if(m){let _=o?[]:ve(a),$=_.map(ne=>Dn(ne,this.hass?.formatEntityState?.(a,ne))),M=JSON.stringify([_,$]);m.dataset.opties!==M&&(m.dataset.opties=M,m.innerHTML=_.length?`<select class="keuze">${_.map((ne,ue)=>`<option value="${y(ne)}">${y($[ue])}</option>`).join("")}</select>`:""),k=m.querySelector(".keuze")}if(k&&(k.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==k)){let _=ft(a);k.value!==_&&(k.value=_)}let x=t.querySelector(".st"),w=n.show_state??this.config.show_state;if(p||u||k)x.textContent="";else if(w===!1)x.textContent="";else if(o)x.textContent="Niet bereikbaar";else if(!a||Wa(a.entity_id))x.textContent="";else if(Me(a.entity_id)==="light"&&r&&a.attributes.brightness!=null)x.textContent=`${Math.round(a.attributes.brightness/255*100)}%`;else{let _=a.attributes.unit_of_measurement;x.textContent=_?`${a.state} ${_}`:ee(this.hass,a)}t.setAttribute("aria-label",`${l}${a?`, ${ee(this.hass,a)}`:""}`)})}getCardSize(){return Ne(wi(this.config))}getGridOptions(){let e=Ne(wi(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};j(In,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${vi}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);O("domotiapp-entities-card",In,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Q={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},J=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),xt=i=>!i||i.state==="off",zi=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),Pt=i=>i?.state==="playing",Ts=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function Os(i){if(!i)return[];let e=[];return(J(i,Q.TURN_ON)||J(i,Q.TURN_OFF))&&e.push("power"),xt(i)||(J(i,Q.PREVIOUS_TRACK)&&e.push("prev"),J(i,Q.PLAY)||J(i,Q.PAUSE)||J(i,Q.PLAY_MEDIA)?e.push("play"):J(i,Q.STOP)&&e.push("stop"),J(i,Q.NEXT_TRACK)&&e.push("next")),e}var et=i=>i?.volume_entity||i?.entity;function $i(i){if(!zi(i))return[];let e=[];return J(i,Q.VOLUME_MUTE)&&e.push("mute"),J(i,Q.VOLUME_SET)?e.push("slider"):J(i,Q.VOLUME_STEP)&&e.push("steps"),e}var Ge=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Ds=i=>i?.attributes?.volume_level!==void 0&&i?.attributes?.volume_level!==null,Kt=i=>!!i?.attributes?.is_volume_muted,Ei=i=>!!i?.attributes?.mass_player_type,Ai=i=>!!i?.attributes?.shuffle,Mi=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ls=i=>({off:"all",all:"one",one:"off"})[Dh(i)]??"all",Dh=i=>["off","all","one"].includes(i)?i:"off";function Si(i,{zoeken:e=!0,sleep:t=!1}={}){if(!zi(i))return[];let n=[];return J(i,Q.SHUFFLE_SET)&&n.push("shuffle"),J(i,Q.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&Ei(i)&&n.push("search"),n}function Cs(i,{tonen:e=!0}={}){if(!e||!zi(i)||!J(i,Q.SELECT_SOURCE)||Ei(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Vn(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function Gt(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var Lh="domotiapp-media-speler:";function Ni(i,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],a=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(i?.players)&&i.players.length?[...new Set([...n(i?.entity)?[i.entity]:[],...i.players.filter(n)])]:Ch(a(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function Ch(i,e){let t=i.filter(n=>Ei(e?.states?.[n]));return t.length?t:i}var Rs=i=>Lh+(i??[]).join("|");function Hs(i,e,t){if(!i?.speaker_select)return i?.entity??"";let n=null;try{n=t?.getItem?.(Rs(e))??null}catch{n=null}return n&&e?.includes(n)?n:i.entity&&e?.includes(i.entity)?i.entity:i.entity||e?.[0]||""}function Is(i,e,t){try{return i?.setItem?.(Rs(e),String(t)),!0}catch{return!1}}var Ti="dacScrollSlot",Vs=["position","top","left","right","width","overflow"];function Bn(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[Ti])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(Vs.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Ti]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Vs)t.style[o]=a[o];t.dataset&&delete t.dataset[Ti],e?.scrollTo?.(0,n)}}}var Rh=[400,1e3,2e3,4e3,8e3,15e3,3e4],Hh=6e4;function pe(i){let e=i?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(i?.message??""))}var le=class{constructor(e,{wachttijden:t=Rh,traag:n=Hh,klok:a,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=a??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},we=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var Ih=`
  :host {
    ${W}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Oi=null,Bs=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Di=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Oi=Oi??[Z(Ih)],this.shadowRoot.adoptedStyleSheets=Oi}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=Bs(e.title??"Weet je het zeker?"),this.$("p").innerHTML=Bs(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};C("domotiapp-vraag",Di);function _e(i={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(i);return e.focus?.(),t}Uo(_e);var Ps=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var We=i=>`domotiapp_lovelace/media/${i}`;function Vh(i,e){if(!i)return null;if(e)return i.uri?{type:We("favorite"),favorite:!0,uri:i.uri}:null;let t=Ks(i);return!t||!i.library_item_id?null:{type:We("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function Ks(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Gs={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Li=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Ws(i,e,t=null){return i?.kind??Ks(e)??t??"playlists"}var Ci=i=>!!i?.uri,Pn=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:We("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),Us=(i,e,t)=>{let n=Vh(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Fs=(i,e)=>i.callWS({type:We("playlist/create"),name:e}).then(t=>t?.playlist??null),qs=(i,e)=>i.callWS({type:We("playlist/remove"),library_item_id:String(e.library_item_id)}),Zs=(i,e)=>i.callWS({type:We("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Xs=(i,e,t)=>i.callWS({type:We("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Ys=(i,e,t)=>i.callWS({type:We("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Bh=350,Ph={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Kh(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Ph[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Gh=`
  :host {
    ${W}
...
`,Ri=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(Re+Gh)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[],this.zoekHerkansing_=new le(()=>this.zoek_()),this.speakerHerkansing_=new le(()=>this.haalSpeakers_())}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=Bn(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Li.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
...
`,Hi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Z(Wh+Re)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};C("domotiapp-bron-kiezer",Hi);function Js(i,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(i,e,t),n.focus?.(),n}function el(i,e){let t=i?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var Uh=524288;function Fh(i,e){let t=i?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&Uh)!==0}function Ii(i,e,t){return e===t?"zelf":Fh(i,e)?qh(i,e,t)?"mee":"los":"kan-niet"}function qh(i,e,t){if(el(i,t).has(e))return!0;if(el(i,t).size===0){let n=i?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function tl(i,e,t){let n=Ii(i,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Zh=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Vi=null,Kn=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Bi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Vi=Vi??[Z(Zh)],this.shadowRoot.adoptedStyleSheets=Vi,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="tel"></div>
        <div class="lijst" role="listbox"></div>
      </div>`,this.gebouwd_=!0;let e=(t,n,a)=>{t.addEventListener(n,a),this.opruimen_.push(()=>t.removeEventListener(n,a))};e(this.$(".sluit"),"click",()=>this.sluit()),e(this.$(".laag"),"click",t=>{t.target===this.$(".laag")&&this.sluit()}),e(this.$("input"),"input",t=>{this.filter_=t.target.value.trim().toLowerCase(),this.teken_()}),e(this.$("input"),"keydown",t=>{t.key==="Enter"&&this.$(".sp")?.click()}),e(this,"keydown",t=>{t.key==="Escape"&&this.hasAttribute("open")&&this.sluit()}),e(this.$(".lijst"),"click",t=>{let n=t.target.closest(".mee");if(n)return t.stopPropagation(),this.koppel_(n.dataset.id);let a=t.target.closest(".sp");a&&this.kies_(a.dataset.id)})}$(e){return this.shadowRoot.querySelector(e)}set hass(e){this.hass_=e,this.hasAttribute("open")&&this.gebouwd_&&this.teken_()}get hass(){return this.hass_}open(e,t,n,a){this.hass_=e,this.lijst_=Array.isArray(t)?t:[],this.huidig_=n,this.opKeuze_=a,this.filter_="",this.gebouwd_||this.bouw_(),this.$("input").value="",this.$(".zoek").hidden=this.lijst_.length<8,this.setAttribute("open",""),this.teken_(),this.$(".zoek").hidden||setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open")}teken_(){let e=this.lijst_,t=this.filter_?e.filter(a=>String(N(this.hass,a)).toLowerCase().includes(this.filter_)):[...e];this.$(".sub").textContent=this.huidig_?`Nu: ${N(this.hass,this.huidig_)}`:"",this.$(".tel").textContent=this.filter_?`${t.length} van ${e.length}`:`${e.length} speaker${e.length===1?"":"s"}`;let n=this.$(".lijst");if(!t.length){n.innerHTML='<div class="leeg">Niets gevonden.</div>';return}n.innerHTML=t.map(a=>{let r=v(this.hass,a),o=a===this.huidig_,s=xt(r)?"Uit":Vn(r,c=>ee(this.hass,c)),l=Ii(this.hass,a,this.huidig_),d=l==="mee";return`<div class="rij">
                  <button class="sp" type="button" role="option" data-id="${Kn(a)}"
                    data-speelt="${Pt(r)}" data-uit="${xt(r)}"
                    aria-current="${o}" aria-selected="${o}">
                    <span class="ico">${b(Gt(r),"speaker")}</span>
                    <span class="tekst">
                      <b>${Kn(N(this.hass,a))}</b>
                      <span>${Kn(d?`${s} \xB7 speelt mee`:s)}</span>
                    </span>
                    ${o?'<span class="nu">NU</span>':""}
                  </button>
                  <button class="mee" type="button" data-id="${Kn(a)}"
                ...
                </div>`}).join("")}koppel_(e){let t=tl(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};C("domotiapp-speler-kiezer",Bi);function nl(i,e,t,n){let a=document.querySelector("domotiapp-speler-kiezer");return a||(a=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var Pi=[15,30,45,60,90],Ki=30;function al(i){let e=Math.max(0,Math.round(i)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),a=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(a).padStart(2,"0")}`}function Gi(i,{min:e=1,max:t=720}={}){let n=String(i??"").trim();if(!/^\d+$/.test(n))return null;let a=Number(n);return a>=e&&a<=t?a:null}var Xh=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Wi=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(Xh)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
      ...
      </div>`,this.$(".snel").innerHTML=Pi.map(e=>`<button type="button" data-m="${e}" aria-pressed="false">${e}</button>`).join(""),this.$(".sluit").addEventListener("click",()=>this.dicht_()),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.dicht_()}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.dicht_(),e.key==="Enter"&&!this.hasAttribute("loopt")&&this.start_()}),this.$(".snel").addEventListener("click",e=>{let t=e.target.closest("[data-m]");t&&(this.$(".min").value=t.dataset.m,this.markeer_())}),this.$(".min").addEventListener("input",()=>this.markeer_()),this.$(".doe").addEventListener("click",()=>this.start_()),this.$(".weg").addEventListener("click",()=>this.stop_()),this.gebouwd_=!0}markeer_(){let e=this.$(".min").value.trim();for(let t of this.$(".snel").querySelectorAll("[data-m]"))t.setAttribute("aria-pressed",String(t.dataset.m===e));this.$(".fout").hidden=!0}async open(e,t,n){this.gebouwd_||this.bouw_(),this.hass=e,this.entity_=t,this.$(".waar").textContent=n??t,this.$(".min").value=String(Pi[1]),this.$(".fade").value=String(Ki),this.markeer_(),this.setAttribute("open",""),this.tabIndex=-1,this.focus?.(),await this.haalStand_(),this.hasAttribute("loopt")||setTimeout(()=>this.$(".min")?.focus(),60)}dicht_(){this.removeAttribute("open"),clearInterval(this.tik_),this.tik_=null}async haalStand_(){let e=null;try{e=((await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/list"}))?.timers??[]).find(n=>n.entity_id===this.entity_)??null}catch{e=null}this.toon_(e)}toon_(e){if(clearInterval(this.tik_),this.tik_=null,this.$(".weg").hidden=!e,!e){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",this.$(".doe").hidden=!1;return}this.setAttribute("loopt",""),this.$(".doe").textContent="Opnieuw instellen",this.$(".doe").hidden=!1,this.$(".uitleg").textContent=e.fade?`De laatste ${e.fade} seconden zakt het volume weg, daarna pauzeert de muziek en gaat het volume terug.`:"Aan het eind pauzeert de muziek.";let t=Date.parse(e.ends_at),n=()=>{let a=(t-Date.now())/1e3;this.$(".rest").textContent=al(a),a<=0&&(clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.hasAttribute("open")&&this.haalStand_(),1500))};n(),this.tik_=setInterval(n,1e3)}async start_(){if(this.hasAttribute("loopt")){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.$(".min")?.focus(),40);return}let e=Gi(this.$(".min").value);if(e===null){this.melding_("Vul een heel aantal minuten in, tussen 1 en 720.");return}let t=Gi(this.$(".fade").value,{min:0,max:600})??Ki;try{let n=await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/set",entity_id:this.entity_,minutes:e,fade:t});this.toon_(n)}catch(n){this.melding_(n?.message??"De sleeptimer kon niet gezet worden. Is DomotiApp Lovelace klaar met opstarten?")}}async stop_(){try{await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/cancel",entity_id:this.entity_})}catch{}await this.haalStand_()}melding_(e){let t=this.$(".fout");t.textContent=e,t.hidden=!1}};C("domotiapp-sleeptimer",Wi);function il(i,e,t){let n=document.querySelector("domotiapp-sleeptimer");return n||(n=document.createElement("domotiapp-sleeptimer"),document.body.appendChild(n)),n.open(i,e,t??N(i,e)),n}var Gn={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"},sleep:{icon:"sleep",label:"Sleeptimer"}},Wn=class extends T{setConfig(e){this.ruw_=e,super.setConfig(this.metSpeler_(e))}metSpeler_(e){if(!e?.speaker_select)return e;let t=Ni(e,this.hass),n=Hs(e,t,this.opslag_());return n&&n!==e.entity?{...e,entity:n}:e}set hass(e){let t=!this.hass_;if(super.hass=e,!t||!this.ruw_?.speaker_select)return;let n=this.metSpeler_(this.ruw_);n.entity&&n.entity!==this.config?.entity&&super.setConfig(n)}get hass(){return super.hass}opslag_(){try{return window.localStorage}catch{return null}}spelers_(){return Ni(this.ruw_??this.config,this.hass)}groepsSpelers_(){let e=this.config.speakers;return Array.isArray(e)&&e.length||!this.config.speaker_select?e:this.spelers_()}kiesSpeler_(e){!e||e===this.config.entity||(Is(this.opslag_(),this.spelers_(),e),super.setConfig({...this.ruw_,entity:e}))}validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[R]:e.speaker_select?"Zet er een mediaspeler in, of wacht tot Home Assistant er een meldt.":"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?Y(this.config.tone):A.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(s,l)=>Se(this,this.hass,e,e[s]??l);this.teardown_.push(I(this.$(".card"))),this.teardown_.push(F(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(F(n,{onTap:()=>t("icon_tap_action",Lt(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation());let a=this.$(".hoesgroot");a&&(this.teardown_.push(F(a,{onTap:()=>t("icon_tap_action",Lt(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(a,"click",s=>s.stopPropagation()),this.on(a,"pointerdown",s=>s.stopPropagation()));let r=s=>{let l=s.target.closest?.("[data-k]");l&&(s.stopPropagation(),this.doe_(l.dataset.k))},o=this.$(".spelers");o&&(this.on(o,"click",r),this.on(o,"pointerdown",s=>s.stopPropagation())),this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".vol"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".extra"),"pointerdown",s=>s.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=v(this.hass,t),a=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return a(xt(n)?"turn_on":"turn_off");case"bron":return Js(this.hass,t,N(this.hass,t,this.config.name));case"prev":return a("media_previous_track");case"next":return a("media_next_track");case"play":return a(Pt(n)?"media_pause":"media_play");case"stop":return a("media_stop");case"mute":{let r=et(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Kt(v(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:et(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!Ai(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:Ls(Mi(n))},{entity_id:t});case"speler":{let r=this.spelers_();return nl(this.hass,r,t,o=>this.kiesSpeler_(o))}case"sleep":return il(this.hass,t,N(this.hass,t,this.config.name));case"search":return Qs(this.hass,t,N(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.groepsSpelers_()});default:return}}paint(){let e=this.config,t=v(this.hass,e.entity),n=!t||t.state==="unavailable",a=Ts(t),r=this.$(".top");r.dataset.on=String(a),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:kn(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||Gt(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(l,"speaker")),o.style.setProperty("--tone",a&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:b(e.icon||Gt(t),"speaker"));let c=N(this.hass,e.entity,e.name),p=Vn(t,u=>ee(this.hass,u)),h=this.$(".spelers");if(h){let u=N(this.hass,e.entity);this.text(".spelers .waar",u),h.setAttribute("aria-label",`Speaker kiezen. Nu: ${u}`)}this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),L(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),a=this.config.show_controls===!1||t?[]:Os(e),r=a.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${Gn[s].label}">${b(Gn[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=Pt(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=b(s))}}paintVolume_(e,t){let n=this.$(".vol"),a=et(this.config),r=a===this.config.entity?e:v(this.hass,a),o=this.config.show_volume===!1||t?[]:$i(r),s=t?null:Cs(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=Ds(r)&&(o.includes("slider")||o.includes("steps")),d=[...o,s?"bron":"",l?"pct":""].join(",");n.dataset.sig!==d&&(n.dataset.sig=d,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${b("volume")}</button>`:"")+(o.includes("slider")?be("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${b("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${b("plus")}</button>`:"")+(l?'<span class="pct tnum"></span>':"")+(s?`<button class="bronknop" type="button" data-k="bron">${b("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let c=n.querySelector(".bronknop");if(c){let k=s.nu||"Bron";this.text(c.querySelector("b"),k),c.setAttribute("aria-label",`Bron kiezen, nu ${k}`),c.title=`Kies uit ${s.aantal} bronnen`}let p=Kt(r),h=Ge(r),u=n.querySelector('[data-k="mute"]');if(u){let k=p?"volumeMute":"volume";u.dataset.icon!==k&&(u.dataset.icon=k,u.innerHTML=b(k)),u.setAttribute("aria-pressed",String(p))}let m=n.querySelector(".slider");m&&(this.attach_(m,"volume",{value:()=>Ge(v(this.hass,et(this.config))),onInput:k=>this.setSlider_(m,k),onCommit:k=>this.hass.callService("media_player","volume_set",{volume_level:k/100},{entity_id:et(this.config)}),disabled:()=>ae(v(this.hass,et(this.config)))}),m.classList.contains("dragging")||this.setSlider_(m,h)),l&&this.text(".pct",p?"Gedempt":`${h}%`)}paintExtra_(e,t){let n=this.$(".extra"),a=t||this.config.show_controls===!1?[]:Si(e,{zoeken:this.config.show_search!==!1,sleep:this.config.sleep_timer===!0});n.hidden=!a.length;let r=a.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map((c,p)=>`${c==="search"&&p>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${c}" aria-label="${Gn[c].label}">${b(Gn[c].icon)}</button>`).join("")),!a.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(Ai(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let c=Mi(e),p=c==="one"?"repeatOne":"repeat";s.dataset.icon!==p&&(s.dataset.icon=p,s.innerHTML=b(p)),s.setAttribute("aria-pressed",String(c!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[c])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass);let d=document.querySelector("domotiapp-speler-kiezer");d?.hasAttribute("open")&&(d.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let a=Ie(e,n);this.sliders_.set(t,a),this.teardown_.push(a)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=v(this.hass,this.config?.entity);return 1+($i(e).length?1:0)+(Si(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("media_player."));return n?{entity:n}:{}}};j(Wn,"css",`
    :host { display: block; }
  ...
  `);var Xi=class extends H{defaults(){return{show_current:!0,forecast_type:"daily",days:sl}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:f.entity("weather")},{name:"name",selector:f.text()},{name:"forecast_type",selector:f.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:f.number(1,ll)},{name:"show_current",selector:f.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};V("domotiapp-forecast-card-editor",Xi);O("domotiapp-forecast-card",Fn,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var wt={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},dl={open_cover:wt.OPEN,close_cover:wt.CLOSE,stop_cover:wt.STOP},cl=(i={},e={},t)=>i[t]??e[t],Yi=(i,e)=>!!cl(i,e,"poort"),Qi=(i,e)=>!!cl(i,e,"invert");function pl(i={},e=!1){if(e||i.device_class==="gate")return{open:"gateOpen",closed:"gate"};switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}}var hl=i=>i?{open:"Openen",close:"Sluiten"}:{open:"Open",close:"Dicht"},tu={open:"closed",closed:"open",opening:"closing",closing:"opening"},ul=(i,e)=>e?tu[i]??i:i,qn=(i,e)=>e&&i!=null?100-i:i;function Ji(i,e){if(i==="stop")return"stop_cover";let t=i==="open";return(e?!t:t)?"open_cover":"close_cover"}function ml({state:i,positie:e,aanname:t}){return e!=null?e>0?"open":"closed":i==="open"||i==="closed"?i:t??"closed"}function gl({dood:i,state:e,positie:t,toon:n=!0}){return i?"Niet bereikbaar":n?e==="opening"?"Gaat open":e==="closing"?"Gaat dicht":t!=null?`${t}% open`:e==="open"?"Open":e==="closed"?"Dicht":"":""}var er=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Zn=class extends T{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[R]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e,t){let n=hl(t),a=(r,o,s)=>`<button type="button" class="${t?"tekst":""}" data-act="${r}" aria-label="${o}">${s}</button>`;return`
      ...
      <div class="cv" data-i="${a}" data-shown="closed" style="--tone:${Y(n.tone??e.tone,"solar")}">
        <button class="chip" type="button" aria-label="Meer info"></button>
        <div class="txt"><div class="nm"></div><div class="st"></div></div>
        ${this.keysHtml(e.show_stop!==!1,Yi(n,e))}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o=this.config.covers[+t];this.hass.callService("cover",Ji(r,Qi(o,this.config)),{entity_id:o.entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(F(e.querySelector(".chip"),{onTap:()=>P(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=v(this.hass,n.entity),r=U(this.hass,n.entity),o=!a||a.state==="unavailable",s=Qi(n,this.config),l=Yi(n,this.config),d=ul(a?.state??"unknown",s);e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=N(this.hass,n.entity,n.name);let c=er(a,wt.SET_POSITION)&&r.current_position!=null,p=c?qn(r.current_position,s):null,h=ml({state:d,positie:p,aanname:this.assumed_.get(t)});e.dataset.shown=h;let u=pl(r,l),m=(h==="open"?n.icon_open:n.icon_closed)??(h==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??u[h],k=e.querySelector(".chip");k.dataset.icon!==m&&(k.dataset.icon=m,k.innerHTML=b(m,u[h]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=gl({dood:o,state:d,positie:p,toon:this.toonStatus_()})),e.querySelectorAll(".keys button").forEach($=>{let M=Ji($.dataset.act,s);$.disabled=o||!er(a,dl[M])});let w=e.querySelector(".pos"),_=c&&this.config.show_position!==!1;if(w.hidden=!_,_){if(w.dataset.built||(w.dataset.built="1",w.innerHTML=be("position"),w.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let M=w.querySelector(".slider"),ne=ue=>{M.style.setProperty("--v",`${ue}%`),M.setAttribute("aria-valuenow",String(ue)),this.toonStatus_()&&(e.querySelector(".st").textContent=`${ue}% open`)};this.teardown_.push(Ie(M,{value:()=>qn(U(this.hass,n.entity).current_position??0,s),onInput:ne,onCommit:ue=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:qn(ue,s)})}))}let $=w.querySelector(".slider");if(!$.classList.contains("dragging")){let M=p??0;$.style.setProperty("--v",`${M}%`),$.setAttribute("aria-valuenow",String(M))}}})}toonStatus_(){return this.config.show_state!==!1}rows_(){let e=this.config?.covers??[],t=e.some(n=>er(v(this.hass,n.entity),wt.SET_POSITION));return Ne(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};j(Zn,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var tr=class extends H{defaults(){return{show_stop:!0,show_position:!0,show_state:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(a=>typeof a=="string"?{entity:a}:a);t.covers=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name),a.poort&&(t[`poort:${a.entity}`]=!0),a.invert&&(t[`invert:${a.entity}`]=!0);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(a=>{let r={};return t[`naam:${a}`]&&(r.name=t[`naam:${a}`]),t[`poort:${a}`]&&(r.poort=!0),t[`invert:${a}`]&&(r.invert=!0),Object.keys(r).length?{entity:a,...r}:a});for(let a of Object.keys(t))/^(naam|poort|invert):/.test(a)&&delete t[a];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.flatMap(t=>[{name:`naam:${t}`,selector:f.text()},{name:`poort:${t}`,selector:f.bool()},{name:`invert:${t}`,selector:f.bool()}]),{name:"show_stop",selector:f.bool()},{name:"show_state",selector:f.bool()}]}naamVan_(e){return this.config_?.[`naam:${e}`]||this.hass?.states?.[e]?.attributes?.friendly_name||e}label(e){return e.name.startsWith("naam:")?`Naam voor ${this.naamVan_(e.name.slice(5))}`:e.name.startsWith("poort:")?`${this.naamVan_(e.name.slice(6))} is een poort`:e.name.startsWith("invert:")?`${this.naamVan_(e.name.slice(7))} omgekeerd aangesloten`:{covers:"Rolluiken",show_stop:"Stopknop tonen",show_state:"Status tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten.";if(e.name.startsWith("poort:"))return"Zet pijltjes om in Openen en Sluiten, en geeft een poorticoon. Een poort schuift opzij, dus omhoog en omlaag zeggen er niets over.";if(e.name.startsWith("invert:"))return"Voor een motor die andersom is aangesloten: open wordt dicht en dicht wordt open. De knoppen, de status en de schuif draaien samen om.";if(e.name==="show_state")return"Haalt de regel Open, Dicht of het percentage onder de naam weg. Niet bereikbaar blijft altijd staan."}};V("domotiapp-cover-card-editor",tr);O("domotiapp-cover-card",Zn,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function nu(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var Xn=class extends T{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[R]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var nr=class extends H{setConfig(e){let t={...e},n=(e.persons??[]).map(a=>typeof a=="string"?{entity:a}:a);t.persons=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(a=>{let r=t[`naam:${a}`];return r?{entity:a,name:r}:a});for(let a of Object.keys(t))a.startsWith("naam:")&&delete t[a];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:f.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};V("domotiapp-person-card-editor",nr);O("domotiapp-person-card",Xn,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var ar=i=>String(i??"").trim().split(/\s+/).filter(Boolean);function au(i){let e=ar(i);return e.filter((n,a)=>a===0||n.toLowerCase()!==e[a-1].toLowerCase()).join(" ")}function iu(i){let e=i.map(ar).filter(a=>a.length);if(e.length<2)return 0;let t=0,n=Math.min(...e.map(a=>a.length));for(;t<n;){let a=e[0][t].toLowerCase();if(!e.every(r=>r[t].toLowerCase()===a))break;t++}return Math.min(t,n-1)}function ir(i){let e=i.map(n=>au(n)),t=iu(e);return e.map(n=>{let a=ar(n),r=a.slice(t);return(r.length?r:a).join(" ")})}var ru=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function ou(i){for(let[e,t,n]of ru)if(e.test(i))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var fl={"geen datum":"geen datum",voorbij:"is geweest","bestaat niet":"sensor ontbreekt"},bl=i=>String(i??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),Yn=class extends T{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[R]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}wire(){this.breed_()&&this.teardown_.push(I(this.$(".card")))}read_(){let e=new Date,t=this.config.sensors.map(r=>{let o=v(this.hass,r.entity),s=o?ut(o.state)??ut(o.attributes.date)??ut(o.attributes.next_date)??ut(o.attributes.Year_month_day_date):null;return{cfg:r,st:o,date:s}}),n=t.map(r=>bl(N(this.hass,r.cfg.entity,r.cfg.name))),a=ir(n);return t.map((r,o)=>{let s=r.cfg.label??a[o]??n[o],l=ou(r.cfg.label??r.cfg.entity+s),d=this.config.tones?.[r.cfg.entity];return{label:s,entity:r.cfg.entity,date:r.date,days:r.date?xn(e,r.date):null,tone:Y(d??r.cfg.tone??l.tone),icon:r.cfg.icon??l.icon,reden:r.st?r.date?xn(e,r.date)<0?"voorbij":null:"geen datum":"bestaat niet"}}).sort((r,o)=>!r.reden&&!o.reden?r.date-o.date:r.reden?o.reden?r.label.localeCompare(o.label):1:-1)}komend_(e){return e.filter(t=>!t.reden)}breed_(){return this.config.layout==="breed"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("vorm",this.breed_()?"breed":"lijst"),this.breed_()?`
      <div class="card surface">
        <div class="rij">
  ...
  `);var rr=class extends H{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){let e=this.ids_(),t=ir(e.map(n=>bl(this.hass?.states?.[n]?.attributes?.friendly_name??n)||n));return e.map((n,a)=>({key:`kleur:${n}`,kind:"tone",label:`Kleur voor ${t[a]||n}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"layout",selector:f.select([{value:"lijst",label:"Lijst (eerstvolgende uitgelicht)"},{value:"breed",label:"Over de breedte (veel lager)"}])}]}label(e){return{sensors:"Afvalsensoren",layout:"Vorm",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="layout")return"Over de breedte zet alle bakken naast elkaar in plaats van onder elkaar. Vier bakken passen dan op \xE9\xE9n rasterrij in plaats van vier \u2014 dat scheelt bijna tweehonderd pixels. De eerstvolgende licht op.";if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};V("domotiapp-waste-card-editor",rr);O("domotiapp-waste-card",Yn,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function tt(i){if(i==null||i==="")return 4;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Qn(i,e=!0){if(typeof i=="string")return{name:"",icon:"",path:i,action:null,items:[]};let t=i??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",action:t.action&&typeof t.action=="object"?{...t.action}:null,items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>Qn(n,!1)):[]}}var Ue=i=>Array.isArray(i?.items)?i.items.filter(Fe):[],vl=i=>Ue(i).length>0,Fe=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.path?.trim()||i.action));function kl(i){return(Array.isArray(i?.items)?i.items:[]).slice(0,20).map(t=>Qn(t))}var xl=[{id:"domotitech",label:"DomotiTech",uitleg:"Opent domotitech.nl in een nieuw tabblad, met het logo erop.",bovenaan:!0,maak:()=>({name:"DomotiTech",icon:"domotitech",path:"https://domotitech.nl",action:null,items:[]})},{id:"herstart",label:"Herstart Home Assistant",uitleg:"Roept homeassistant.restart aan, met een bevestiging ervoor.",bovenaan:!0,maak:()=>({name:"Herstart",icon:"power",path:"",action:{action:"perform-action",perform_action:"homeassistant.restart",confirmation:{title:"Weet je het zeker?",text:"Weet je het zeker dat je Home Assistant wilt herstarten?"}},items:[]})}];function wl(i,e,t=!1){let n=Array.isArray(i)?[...i]:[];if(n.length>=8)return{lijst:n,plek:-1};let a=t?0:n.length;return n.splice(a,0,e),{lijst:n,plek:a}}function Jn(i,e=4){let t=(i??[]).filter(Fe),n=tt(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let a=Math.max(1,n-1);return{balk:t.slice(0,a),meer:t.slice(a),heeftMeer:!0}}function or(i){if(i&&typeof i=="object")return i.action?i.action:or(i.path);let e=String(i??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var du=`
...
Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:w},k.data={name:e.name,path:e.path},k.addEventListener("value-changed",x=>{x.stopPropagation();let w=x.detail.value??{};e.name=w.name??"",e.path=w.path??"",this.emit_()}),u.append(m,k,...this.subBlok_(e,t)),n.appendChild(u),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let a=document.createElement("div");a.className="sublijst",e.items.forEach((s,l)=>a.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,a,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let a=document.createElement("summary");a.textContent="\uFF0B  Subknop toevoegen",n.appendChild(a);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=wl(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of xl){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,a){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=b(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",a),r}subItemBlok_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=b(t.icon,"grid"),d.textContent=t.name||(Fe(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaatsSub_(e,n,a,-1));h.disabled=a===0;let u=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaatsSub_(e,n,a,1));u.disabled=a===e.items.length-1;let m=this.kopKnop_("Verwijderen",S.close,()=>this.verwijderSub_(e,n,a));m.classList.add("weg"),o.append(s,l,h,u,m),r.appendChild(o);let k=document.createElement("div");k.className="body";let x=document.createElement("dac-icon-picker");x.label="Icoon",x.fallback="grid",x.auto=!1,x.hass=this.hass_,x.value=t.icon,x.addEventListener("value-changed",_=>{_.stopPropagation(),t.icon=_.detail.value??"",this.emit_()});let w=document.createElement("ha-form");return w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],w.computeLabel=_=>({name:"Naam",path:"Waar gaat hij heen"})[_.name]??_.name,t.action&&(w.schema=[{name:"name",selector:{text:{}}}],w.computeHelper=_=>_.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),w.data={name:t.name,path:t.path},w.addEventListener("value-changed",_=>{_.stopPropagation();let $=_.detail.value??{};t.name=$.name??"",t.path=$.path??"",this.emit_()}),k.append(x,w),r.appendChild(k),r}verplaatsSub_(e,t,n,a){let r=n+a;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let a=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){a.add(r);continue}let s=Number(o[2]);s!==n&&a.add(`i${t}s${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let a=_l.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(`i${r>e?r-1:r}${a[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let a of this.open_){let r=_l.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(a)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=jl(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-navbar-card-editor",sr);var zl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Ut(i){let e=zl(i),t=0;for(;e&&t++<40;)yield e,e=zl(e)}function cu(i){for(let e of Ut(i)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function pu(i){for(let e of Ut(i))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function hu(i){for(let e of Ut(i))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function uu(i){for(let e of Ut(i))if(e.classList?.contains?.("section"))return e;return null}function $l(i){for(let e of Ut(i)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var ea=class extends T{validate(e){let t=kl(e),n={labels:!0,tone:"accent",...e,items:t,max:tt(e?.max)};return t.filter(a=>a.name||a.icon||a.path).length||(n[R]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:a}=Jn(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let u=Ue(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      ...
      <div class="balk" style="--tone:${Y(e.tone)}">
  ...
  `);O("domotiapp-navbar-card",ea,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var mu="dac-tabs:";function cr(i){let e=i??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],a=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:a}}var ta=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.cards?.length));function El(i){return(Array.isArray(i?.tabs)?i.tabs:[]).slice(0,8).map(cr).filter(ta)}function gu(i,e){if(!e)return 0;let t=Math.round(Number(i?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function pr(i){let e=(i??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return mu+e}function fu(i,e,t){let n=null;try{n=i?.getItem?.(e)??null}catch{return null}let a=Number(n);return n===null||n===""||!Number.isInteger(a)?null:a>=0&&a<t?a:null}function Al(i,e,t){try{return i?.setItem?.(e,String(t)),!0}catch{return!1}}function Ml(i,e,t){return fu(t,pr(e),e.length)??gu(i,e.length)}var bu=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function Sl(){let i=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return i.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,a=t.type.startsWith("custom:domotiapp-")?0:1;return n-a||e.naam.localeCompare(t.naam,"nl")}),[...i,...bu.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function Nl(i,e){let t=String(e??"").trim().toLowerCase();return t?i.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):i}async function Tl(i,e){let t={type:i};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let a=i.startsWith("custom:")?i.slice(7):`hui-${i}-card`,o=await customElements.get(a)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:i}}catch{}return t}var Ol=()=>!!customElements.get("hui-card-element-editor");function Dl(i,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},a=i,r=n(e),o=n(t);return r!==null&&(a=Math.max(a,r)),o!==null&&(a=Math.min(a,o)),a}function vu(i,e){let t=i?.columns,n=i?.rows,a=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));a=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}a=Math.min(12,Math.max(1,Dl(a,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${a}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,Dl(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function Ft(i,e,t){if(!i?.style)return;let{gridColumn:n,height:a}=vu(e,t);i.style.gridColumn=n,i.style.height=a??""}function Ll(i){let e=i?._element??i?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function Cl(i,e,t={}){let n=Array.isArray(i)?[...i]:[],a=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(a)||!n[a]?null:(n.splice(a+1,0,structuredClone(n[a])),n);case"verwijder":return!Number.isInteger(a)||!n[a]?null:(n.splice(a,1),n);case"rooster":return!Number.isInteger(a)||!n[a]||!t.rooster?null:(n[a]={...n[a],grid_options:{...n[a].grid_options??{},...t.rooster}},n);default:return null}}var Rl=i=>({...i?{config:i}:{},editMode:!0,saveConfig:async()=>{}}),ku=()=>document.querySelector("home-assistant");function Hl({kaarten:i,hass:e,maakKaart:t,opActie:n}){let a=document.createElement("ha-sortable");a.disabled=!1,a.draggableSelector=".dac-kaart",a.rollback=!1,a.invertSwap=!0,a.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];i.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",Ft(h,d?.grid_options);let u=document.createElement("hui-card-edit-mode");u.hass=e,u.lovelace=Rl(),u.path=[0,0,c],u.hiddenOverlay=!1,u.appendChild(p),o.push(u),h.appendChild(u),r.appendChild(h)}),a.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};a.addEventListener("drag-start",()=>s(!1)),a.addEventListener("drag-end",()=>s(!0)),a.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))a.addEventListener(d,p=>{p.stopPropagation(),c(p)});return a}function Il(i){try{let e=typeof structuredClone=="function"?structuredClone(i):JSON.parse(JSON.stringify(i));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Vl({hass:i,kaarten:e}){let t=ku();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let a=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(a?{kaart:a}:r?{kaarten:r}:null))},l=u=>{if(u?.detail?.dialogTag!=="hui-dialog-edit-card")return;let m=u.detail?.dialogParams?.cardConfig;u.stopImmediatePropagation?.(),u.stopPropagation(),m&&(a=m);let k=t.querySelector("hui-dialog-create-card");typeof k?.closeDialog=="function"&&k.closeDialog(),setTimeout(s,0)},d=u=>{u?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=i,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Rl({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async u=>{let m=u?.views?.[0]?.sections?.[0]?.cards;Array.isArray(m)&&(r=m)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let u=p._layoutElement;if(!u)throw new Error("de proxysectie heeft geen layout-element");u.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(u){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",u),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var na=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var xu=`
...
`,Pl=i=>i.filter(ta).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function _t(i){let e=String(i?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function hr(i){let e=i.cards?.length??0;return e?e===1?_t(i.cards[0]):`${e} kaarten`:"Nog geen kaart"}var ur=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(cr);this.gebouwd_&&JSON.stringify(Pl(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=xu;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let a=document.createElement("button");a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Tabblad toevoegen",a.disabled=this.tabs_.length>=8,a.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(a)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},a=Number(n.default_tab);Number.isFinite(a)&&a>1?this.rest_.default_tab=a:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!ta(e)),r.innerHTML=b(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=hr(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",S.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let u=document.createElement("div");u.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),u.append(m,k,this.inhoudBlok_(e,t)),n.appendChild(u),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!Ol()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${b("grid")}<span>Inhoud: <b>${hr(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(na()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${b("grid")}<span>${e.cards.length?`<b>${hr(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let a=document.createElement("button");return a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Kaart toevoegen",a.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(a),n}uitVoorbeeld(e,t,n){let a=this.tabs_[e];if(a){if(t==="toevoegen"){this.voegToeViaHa_(a,e);return}this.kaartActie_(a,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,a=Number.isInteger(t)?this.tabs_[t]:null;if(!a||!a.cards[n]){e?.remove();return}let r=this.bewerkVak_(a,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,a){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==a.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:a.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Il(e.cards[a.index]);return}let r=Cl(e.cards,n,a);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let a=document.createElement("div");a.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=_t(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&a.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=_t(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||a.append(r,l),a}kaartTabbladen_(e,t,n,a,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let u of l.querySelectorAll("button"))u.setAttribute("aria-selected",String(u.dataset.blad===h));a.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let u=document.createElement("button");u.type="button",u.dataset.blad=h.id,u.textContent=h.naam,u.setAttribute("role","tab"),u.setAttribute("aria-selected","false"),u.addEventListener("click",()=>c(h.id)),l.appendChild(u)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,a,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[a],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[a]=l,o.config=l,this.emit_(),r.textContent=_t(l))}),o}async voegToeViaHa_(e,t){let n=await Vl({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=b("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=_t(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",S.arrowUp,()=>this.verplaatsKaart_(e,n,a,-1));p.disabled=a===0;let h=this.kopKnop_("Omlaag",S.arrowDown,()=>this.verplaatsKaart_(e,n,a,1));h.disabled=a===e.cards.length-1;let u=this.kopKnop_("Verwijderen",S.close,()=>this.verwijderKaart_(e,n,a));u.classList.add("weg"),o.append(s,l,p,h,u),r.appendChild(o);let m=document.createElement("div");m.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",x=>{x.stopPropagation();let w=x.detail?.config;w&&(e.cards[a]=w,this.emit_(),d.textContent=_t(w),c.textContent=String(w.type??""))}),k.addEventListener("GUImode-changed",x=>x.stopPropagation()),m.appendChild(k),r.appendChild(m),r}verplaatsKaart_(e,t,n,a){let r=n+a;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let a=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){a.add(r);continue}let s=Number(o[1]);s!==n&&a.add(`t${t}k${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let a=document.createElement("input");a.type="text",a.placeholder="Zoek een kaart...",a.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=Nl(Sl(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await Tl(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),a.addEventListener("input",()=>{this.zoek_=a.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(a,r,s),n}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let a=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),a&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Number(n.slice(1));a!==e&&t.add(`t${a>e?a-1:a}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Pl(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-tabs-card-editor",ur);var Kl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Wl(i){let e=Kl(i),t=0;for(;e&&t++<40;)yield e,e=Kl(e)}function Gl(i){let e=null;for(let n of Wl(i))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,a=0)=>{if(!n||a>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,a+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,a+1);if(o)return o}return null};return t(e)}var ia=class extends T{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=El(e),n={tone:"accent",...e,tabs:t};return t.length||(n[R]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((a,r)=>`
      ...
      <div class="card surface" style="--tone:${Y(e.tone)}">
        <div class="balk" role="tablist">${t}</div>
        <div class="vakken">${n}</div>
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(I(this.$(".card"))),this.kies_(Ml(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let a=Math.min(Math.max(0,e),n.length-1);this.open_=a;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===a));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===a);t&&Al(this.opslag_(),pr(n),a),this.bouw_(a)}async bouw_(e){if(this.kinderen_.has(e)){L(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let a=document.createElement("div");a.className="leeg",a.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(a),L(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Gl(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,Ft(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&na()){t.replaceChildren(Hl({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),L(this.$(".card"));return}t.replaceChildren(...s),L(this.$(".card")),this.herijkIndeling_()}catch(a){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${y(a?.message??a)}</div>`,L(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,a]of this.kinderen_.entries()){if(!a)continue;let r=this.config?.tabs?.[n]?.cards??[];a.forEach((o,s)=>{let l=Ll(o);l&&(t=!0),Ft(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),L(this.$(".card"));return}if(t<=0)return;let a=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(a))}inVoorbeeld_(){for(let e of Wl(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Gl(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};j(ia,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);O("domotiapp-tabs-card",ia,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var q={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},wu=[[q.FOUT,["error","fout","aborting","afgebroken"]],[q.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[q.PAUZE,["pause","paused","pauze","onderbroken"]],[q.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[q.AF,["finished","complete","done","klaar met","afgelopen"]],[q.KLAAR,["ready","idle","standby","klaar","gereed"]],[q.UIT,["off","inactive","uit"]]],_u=new Set([q.DRAAIT]);function Fl(i){let e=String(i??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return q.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,a]of wu)for(let r of a)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return q.ONBEKEND}var ql=i=>_u.has(Fl(i?.state));function Zl(i,e=new Date){if(!i)return null;let t=String(i.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=i.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let a=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(a)return Number(a[1])*60+Number(a[2])+(a[3]?Math.round(Number(a[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function Ul(i){if(i==null)return"";if(i<=0)return"Klaar";if(i<60)return`nog ${i} min`;let e=Math.floor(i/60),t=i%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Xl(i){if(!i)return null;let e=String(i.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var yu=i=>!!i&&i.state==="on",Yl=i=>i===q.DRAAIT||i===q.PAUZE||i===q.UITGESTELD;function Ql({status:i,deur:e,rest:t,pct:n}={}){let a=Fl(i?.state),r=yu(e);if(a===q.DRAAIT){let o=[];return t!=null?o.push(Ul(t)):n!=null&&o.push(`${n}%`),{soort:a,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return a===q.PAUZE?{soort:a,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:a===q.FOUT?{soort:a,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:a===q.AF?{soort:a,tekst:"Programma klaar",tone:"good",waarschuwing:""}:a===q.UITGESTELD?{soort:a,tekst:t!=null?`Start over ${Ul(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:a,tekst:"Klep open",tone:"warn",waarschuwing:""}:a===q.UIT?{soort:a,tekst:"Uit",tone:"neutral",waarschuwing:""}:a===q.KLAAR?{soort:a,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:q.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function Jl(i){let e=String(i??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var ju={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},ra=class extends T{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[R]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,a,r)=>`
      ...
      </div>`}wire(){let e=this.config;this.on(this.$(".top"),"click",()=>{let t=e.status||e.remaining||e.program;t&&this.moreInfo_(t)}),this.on(this.$(".knop.start"),"click",()=>this.druk_(e.start)),this.on(this.$(".knop.stop"),"click",()=>this.druk_(e.stop)),this.on(this.$(".knop.slim"),"click",()=>{if(!e.smart)return;let t=X(v(this.hass,e.smart));this.hass.callService("homeassistant",t?"turn_off":"turn_on",{entity_id:e.smart})}),this.on(this.$(".rij.programma"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.program)return;t.stopPropagation();let a=bt(e.program,n.value,ve(v(this.hass,e.program)));a&&this.hass.callService(a[0],a[1],a[2])}),this.teardown_.push(I(this.$(".card")))}moreInfo_(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}druk_(e){let t=Jl(e);t&&this.hass.callService(t[0],t[1],t[2])}paint(){let e=this.config,t=v(this.hass,e.status),n=v(this.hass,e.door),a=Zl(v(this.hass,e.remaining)),r=Xl(v(this.hass,e.progress)),o=Ql({status:t,deur:n,rest:a,pct:r}),s=ql(t);this.toggleAttribute("draait",s),this.toggleAttribute("onbekend",s&&r==null);let l=this.$(".top"),d=ju[o.tone]??A.accent;this.$(".card").style.setProperty("--tone",d),l.classList.toggle("unavailable",o.soort==="onbekend");let c=this.$(".chip"),p=e.icon||"dishwasher";c.dataset.icon!==p&&(c.dataset.icon=p,c.innerHTML=b(p,"dishwasher")),c.style.setProperty("--tone",d),this.text(".nm",e.name||N(this.hass,e.status,null)||"Vaatwasser");let h=this.$(".st"),u=y(o.tekst),m=o.waarschuwing?` &middot; <span class="let">${y(o.waarschuwing)}</span>`:"";h.dataset.tekst!==u+m&&(h.dataset.tekst=u+m,h.innerHTML=u+m),l.setAttribute("aria-label",`${this.$(".nm").textContent}, ${o.tekst}`);let k=this.$(".balk"),x=Yl(o.soort)&&(r!=null||s);if(k.hidden=!x,x){let w=this.$(".vul"),_=r!=null?`${r}%`:"";_&&w.style.width!==_&&(w.style.width=_),k.setAttribute("role","progressbar"),r!=null?(k.setAttribute("aria-valuenow",String(r)),k.setAttribute("aria-valuemin","0"),k.setAttribute("aria-valuemax","100")):k.removeAttribute("aria-valuenow")}this.paintBediening_(),L(this.$(".card"))}paintBediening_(){let e=this.config,t=this.$(".programslot"),n=v(this.hass,e.program),a=e.program?ve(n):[],r=a.map(d=>Dn(d,this.hass?.formatEntityState?.(n,d))),o=JSON.stringify([a,r]);t.dataset.opties!==o&&(t.dataset.opties=o,t.innerHTML=a.length?`<select class="keuze" aria-label="Programma">${a.map((d,c)=>`<option value="${y(d)}">${y(r[c])}</option>`).join("")}</select>`:"");let s=t.querySelector(".keuze");if(s&&this.shadowRoot.activeElement!==s){let d=ft(n);s.value!==d&&(s.value=d)}let l=this.$(".knop.slim");l.hidden=!e.smart,e.smart&&(l.dataset.aan=String(X(v(this.hass,e.smart)))),this.$(".knop.start").hidden=!e.start,this.$(".knop.stop").hidden=!e.stop,this.$(".rij.programma").hidden=!s,this.$(".rij.knoppen").hidden=!e.smart&&!e.start&&!e.stop}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-dishwasher-card-editor")}static getStubConfig(e,t){return{status:((a,r)=>t?.find(o=>o.startsWith(a)&&r.test(o))??"")("sensor.",/vaatwas|dishwash/i),name:"Vaatwasser"}}};j(ra,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var mr=class extends H{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"program",selector:f.entity(["select","input_select"])},{name:"start",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:f.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"smart",selector:f.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};V("domotiapp-dishwasher-card-editor",mr);O("domotiapp-dishwasher-card",ra,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});function zu(i,e,t,{live:n=!1,fit:a="cover"}={}){if(!t)return null;let r=typeof customElements<"u"&&customElements.get("hui-image"),o=r?"hui-image":"img",s=i;if((!s||s.localName!==o)&&(s=document.createElement(o),s.className="beeld"),r){let l=n?"live":"auto";s.cameraImage!==t&&(s.cameraImage=t),s.cameraView!==l&&(s.cameraView=l),s.fitMode!==a&&(s.fitMode=a),s.hass=e}else{let l=e?.states?.[t],d=l?.attributes?.entity_picture;d&&s.dataset.bron!==d&&(s.dataset.bron=d,s.src=d),s.alt=l?.attributes?.friendly_name??t,s.style.objectFit=a}return s}function oa(i,e,t,n){if(!i)return null;let a=i.querySelector(".beeld"),r=zu(a,e,t,n);return r?(r!==a&&(a?.remove(),i.appendChild(r)),r):(a?.remove(),null)}var gr={idle:{woord:"Klaar voor gebruik",toon:"neutral"},printing:{woord:"Aan het printen",toon:"accent"},paused:{woord:"Gepauzeerd",toon:"warn"},finished:{woord:"Klaar",toon:"good"},failed:{woord:"Mislukt",toon:"bad"},offline:{woord:"Offline",toon:"neutral"},prepare:{woord:"Voorbereiden",toon:"accent"},unknown:{woord:"Onbekend",toon:"neutral"}},$u={idle:["idle","operational","standby","ready","on","off"],printing:["printing","running","run","print","busy","active"],paused:["pause","paused","pausing"],finished:["finish","finished","complete","completed","done","success"],failed:["failed","fail","error","cancelled","canceled","stopped"],prepare:["prepare","preparing","heating","slicing","init"],offline:["offline","unavailable","unknown","disconnected"]};function fr(i){let e=String(i?.state??"").trim().toLowerCase();if(!e)return"unknown";if(e==="unavailable"||e==="none")return"offline";for(let[t,n]of Object.entries($u))if(n.includes(e))return t;return"unknown"}function sa(i){let e=fr(i);return e==="printing"||e==="prepare"}function br(i){let e=Number(i?.state);return Number.isFinite(e)?Math.max(0,Math.min(100,Math.round(e))):null}function vr(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"\xB0C"}:null}function kr(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let o=Date.parse(t);if(Number.isFinite(o))return Math.max(0,Math.round((o-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let o=t.split(":").map(Number),[s,l]=o.length===3?o:[0,o[0]];return s*60+l}let a=Number(t);if(!Number.isFinite(a))return null;let r=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return r==="h"||r==="u"||r.startsWith("hour")?Math.round(a*60):r==="s"||r.startsWith("sec")?Math.round(a/60):Math.round(a)}function xr(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function wr(i,e=new Date){if(i==null)return"";let t=new Date(e.getTime()+i*6e4);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var Eu=new Set(["unknown","unavailable","none","null","empty","leeg","off","unload","unloaded"]);function nt(i,{namen:e=!1}={}){if(typeof i!="string")return null;let t=i.trim();if(!t)return null;let n=t.replace(/^#/,"");return/^[0-9a-f]{8}$/i.test(n)?parseInt(n.slice(6),16)<16?null:`#${n.slice(0,6).toUpperCase()}`:/^[0-9a-f]{6}$/i.test(n)?`#${n.toUpperCase()}`:/^[0-9a-f]{3}$/i.test(n)?`#${n.toUpperCase()}`:/^rgba?\(/i.test(t)?t:!e||Eu.has(t.toLowerCase())?null:/^[a-z]+$/i.test(t)?t:null}function ed(i,e={}){let t=i?.attributes??{},n=nt(e.color,{namen:!0})??nt(t.color)??nt(Array.isArray(t.cols)?t.cols[0]:t.cols)??nt(t.filament_color)??nt(t.tray_color)??(/^#?[0-9a-f]{3,8}$/i.test(String(i?.state??""))?nt(i.state):null)??null,a=e.label||t.type||t.filament_type||t.tray_type||t.name||(i&&!nt(i.state)?i.state:"")||"",r=t.empty===!0||t.empty==="true"?!0:!n&&!String(a).trim(),o=Number(t.remain??t.remaining),s=t.remain_enabled!==!1&&!r;return{kleur:r?null:n,soort:String(a).trim(),leeg:r,actief:t.active===!0||t.active==="true",rest:s&&Number.isFinite(o)&&o>=0&&o<=100?Math.round(o):null}}var yt=[1,2,3,4],Au={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},la=class extends T{validate(e){let t={name:"",icon:"printer3d",...e};return t.status||t.progress||t.camera||t.image||t.nozzle_temp||t.bed_temp||t.power||(t[R]="Kies minstens een printstatus. Camera, voortgang, temperaturen, de deur en de trays van de AMS mogen daarna."),t}watched(){let e=this.config;return[e.status,e.progress,e.remaining,e.nozzle_temp,e.bed_temp,e.door,e.power,e.camera,e.image,...yt.map(t=>e[`tray_${t}`])].filter(Boolean)}beeldSoort_(){let e=this.config;return e.camera&&e.image?this.beeld_??(sa(v(this.hass,e.status))?"camera":"image"):e.camera?"camera":e.image?"image":null}template(){return this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`
      <div class="card surface" style="--tone:${A.accent}">
        <div class="kop">
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(I(this.$(".card"))),this.on(this.$(".ico"),"click",()=>P(this,e.status||e.power||e.camera||e.progress));let t=this.$(".aanuit");this.on(t,"click",a=>{a.stopPropagation(),this.schakel_()});let n=this.$(".wissel");this.on(n,"click",a=>{a.stopPropagation(),this.beeld_=this.beeldSoort_()==="camera"?"image":"camera",this.paint()}),this.on(this.$(".beeldvak"),"click",a=>{if(a.target.closest(".wissel"))return;let r=this.beeldSoort_()==="camera"?e.camera:e.image;r&&P(this,r)})}async schakel_(){let e=this.config.power;if(!e)return;let t=v(this.hass,e),n=X(t),a=String(e).split(".")[0];if(n){let r=br(v(this.hass,this.config.progress)),o=sa(v(this.hass,this.config.status));if(!await _e({title:"Printer uitzetten?",text:o?`Er loopt een print${r===null?"":` (${r}% klaar)`}. Uitzetten breekt hem af, en dat is niet terug te draaien.`:"Weet je zeker dat je de printer wilt uitzetten?",confirmText:"Uitzetten",dismissText:"Aan laten"}))return}this.hass.callService(a,n?"turn_off":"turn_on",{entity_id:e})}paint(){let e=this.config,t=v(this.hass,e.status),n=fr(t),a=gr[n]??gr.unknown,r=sa(t),o=e.status&&(!t||t.state==="unavailable");this.toggleAttribute("dead",!!o),this.toggleAttribute("loopt",r&&!o),this.$(".card").style.setProperty("--tone",Au[a.toon]??A.accent),this.$(".ico").innerHTML=b(e.icon||"printer3d"),this.text(".nm",e.name||N(this.hass,e.status||e.power||e.camera,"3D-printer"));let s=String(t?.state??"").trim(),l=n==="unknown"&&s&&s.toLowerCase()!=="unknown",d=`<b>${this.veilig_(l?s:a.woord)}</b>${this.bijzin_()}`,c=this.$(".st");c.innerHTML!==d&&(c.innerHTML=d),this.paintAanUit_(),this.paintBeeld_(r),this.paintVoortgang_(r),this.paintTegels_(),this.paintAms_(),L(this.$(".card"))}bijzin_(){let e=kr(v(this.hass,this.config.remaining));return e===null||e<=0?"":` \xB7 nog ${this.veilig_(xr(e))}, klaar om ${this.veilig_(wr(e))}`}paintAanUit_(){let e=this.$(".aanuit"),t=this.config.power;if(e.hidden=!t,!t)return;let n=X(v(this.hass,t));e.setAttribute("aria-pressed",String(n)),e.setAttribute("aria-label",n?"Printer uitzetten":"Printer aanzetten")}paintBeeld_(e){let t=this.config,n=this.$(".beeldvak"),a=this.beeldSoort_();if(n.hidden=!a,!a)return;let r=this.$(".wissel");if(r.hidden=!(t.camera&&t.image),!r.hidden){let d=a==="camera"?"Voorbeeld":"Camera";r.innerHTML=`${b(a==="camera"?"grid":"camera")}<span>${d}</span>`,r.setAttribute("aria-label",`Toon ${d.toLowerCase()}`)}if(a==="camera"){oa(n,this.hass,t.camera,{live:t.live_view===!0||e}),n.querySelector(".leeg")?.remove();return}n.querySelector("hui-image")?.remove();let s=v(this.hass,t.image)?.attributes?.entity_picture,l=n.querySelector("img.beeld");if(s)l||(l=document.createElement("img"),l.className="beeld",l.alt="Wat de printer aan het maken is",n.appendChild(l)),l.dataset.bron!==s&&(l.dataset.bron=s,l.src=s),n.querySelector(".leeg")?.remove();else if(l?.remove(),!n.querySelector(".leeg")){let d=document.createElement("span");d.className="leeg",d.textContent="Nog geen voorbeeld",n.appendChild(d)}}paintVoortgang_(e){let t=this.config,n=this.$(".voort"),a=br(v(this.hass,t.progress)),r=kr(v(this.hass,t.remaining));if(n.hidden=a===null&&!e,n.hidden)return;let o=this.$(".balk");o.dataset.onbekend=String(a===null),o.querySelector("i").style.setProperty("--pct",`${a??0}%`),this.text(".pct",a===null?"Bezig":`${a}%`),this.text(".rest",r===null||r<=0?"":`nog ${xr(r)} \xB7 klaar om ${wr(r)}`)}paintTegels_(){let e=this.config,t=this.$(".tegels"),n=[],a=vr(v(this.hass,e.nozzle_temp));a&&n.push({w:`${a.waarde}${a.eenheid}`,l:"Nozzle"});let r=vr(v(this.hass,e.bed_temp));r&&n.push({w:`${r.waarde}${r.eenheid}`,l:"Bed"});let o=v(this.hass,e.door);if(o){let l=X(o);n.push({w:l?"Open":"Dicht",l:"Deur",let:l})}if(t.hidden=!n.length,!n.length)return;t.style.setProperty("--kolommen",String(n.length));let s=n.map(l=>`${l.w}|${l.l}|${l.let??""}`).join(",");t.dataset.sig!==s&&(t.dataset.sig=s,t.innerHTML=n.map(l=>`<div class="tegel" data-let="${!!l.let}"><span class="w">${this.veilig_(l.w)}</span><span class="l">${this.veilig_(l.l)}</span></div>`).join(""))}paintAms_(){let e=this.config,t=this.$(".ams"),n=yt.filter(l=>e[`tray_${l}`]||e[`tray_${l}_color`]);if(t.hidden=!n.length,!n.length)return;let a=this.$(".ams .rij"),r=yt.map(l=>ed(v(this.hass,e[`tray_${l}`]),{color:e[`tray_${l}_color`],label:e[`tray_${l}_label`]})),o=yt.map(l=>v(this.hass,e[`tray_${l}`])?.attributes?.name??""),s=r.map(l=>`${l.kleur}|${l.soort}|${l.leeg}|${l.actief}|${l.rest}`).join(",");a.dataset.sig!==s&&(a.dataset.sig=s,a.innerHTML=r.map((l,d)=>{let c=o[d],p=`Tray ${d+1}`+(l.leeg?": leeg":c||l.soort?`: ${c||l.soort}`:"")+(l.rest===null?"":` \u2014 nog ${l.rest}%`)+(l.actief?" (in gebruik)":"");return`<div class="tray" data-leeg="${l.leeg}" data-actief="${l.actief}" style="--kleur:${l.kleur??"transparent"}" title="${this.veilig_(p)}"><span class="vlak">${l.rest===null?"":`<i style="--rest:${l.rest}%"></i>`}</span><span class="txt"><span class="nr">Tray ${d+1}</span><span class="so">${this.veilig_(l.leeg?"leeg":l.soort||"gevuld")}</span></span></div>`}).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.camera||this.config?.image?6:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-printer-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>/^sensor\./.test(a)&&/(print|stage|status)/i.test(a));return n?{status:n}:{}}};j(la,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var _r=class extends H{defaults(){return{icon:"printer3d"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer3d",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"power",selector:f.entity(["switch","input_boolean"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"nozzle_temp",selector:f.entity(["sensor","number"])},{name:"bed_temp",selector:f.entity(["sensor","number"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"camera",selector:f.entity("camera")},{name:"live_view",selector:f.bool()},{name:"image",selector:f.entity(["image","camera"])},...yt.flatMap(e=>[{name:`tray_${e}`,selector:f.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:f.text()},{name:`tray_${e}_label`,selector:f.text()}])]}label(e){let t={};for(let n of yt)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};V("domotiapp-printer-card-editor",_r);O("domotiapp-printer-card",la,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var jt={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},yr=i=>i==="electric"||i==="hybrid",jr=i=>i==="fuel"||i==="hybrid",Mu=["charging","charge","fast_charging","dc_charging","on","true","laden"],Su=["complete","completed","fully_charged","full","done","finished"],Nu=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],Tu=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function td(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:Mu.includes(e)?"charging":Su.includes(e)?"complete":Nu.includes(e)?"connected":Tu.includes(e)?"idle":"onbekend"}function nd(i,e){if(i&&i!=="onbekend")return da[i]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var da={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function zr(i,e){let t=Number(i?.state);if(!Number.isFinite(t))return null;let n=String(i?.attributes?.unit_of_measurement??"").toLowerCase(),a=Number(e);return n!=="%"&&Number.isFinite(a)&&a>0?Math.max(0,Math.min(100,Math.round(t/a*100))):Math.max(0,Math.min(100,Math.round(t)))}function ad(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"km"}:null}function $r(i){if(i==null)return null;let e=i<=10?"bad":i<=20?"warn":"good";return{procent:i,toon:e}}function Er(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let a=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return a==="h"||a.startsWith("hour")?Math.round(n*60):a==="s"||a.startsWith("sec")?Math.round(n/60):Math.round(n)}function Ar(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function id({open:i,slot:e,laden:t,laadMinuten:n,radius:a,aandrijving:r}){if(i)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${Ar(n)}`:"";return{tekst:`${da.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:da.complete,toon:"good"}:t==="connected"?{tekst:da.connected,toon:"neutral"}:a?{tekst:`Nog ${a.waarde} ${a.eenheid}`,toon:"neutral"}:{tekst:jt[r]?.label??"",toon:"neutral"}}var Ou=100,Du=["home","thuis","at_home","athome"],Lu=["not_home","away","afwezig","weg","not home","nothome"];function Cu(i,e,t,n){let r=d=>d*Math.PI/180,o=r(t-i),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(i))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function Ru(i){let e=i?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let a=String(i?.state??""),r=a.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=a.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function rd(i,e,t=Ou){if(!i)return{thuis:null,tekst:"",meters:null};let n=String(i.state??"").trim(),a=n.toLowerCase();if(a==="unavailable"||a==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(Du.includes(a))return{thuis:!0,tekst:"Thuis",meters:null};if(Lu.includes(a))return{thuis:!1,tekst:"Afwezig",meters:null};let r=Ru(i),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=Cu(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var Hu=["open","opened","ajar","unlatched","on","true","unlocked"],Iu=["closed","close","shut","secured","locked","off","false","not_open"];function Mr(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:Hu.includes(e)?!0:Iu.includes(e)?!1:/(^|[^a-z])(ajar|open)([^a-z]|$)/.test(e)?!0:null}function od(i){let e=String(i?.state??"").trim().toLowerCase();if(!e||e==="unavailable"||e==="unknown")return null;if(String(i?.entity_id??"").split(".")[0]==="lock")return e==="locked"?!0:e==="unlocked"||e==="open"||e==="opening"?!1:null;if(i?.attributes?.device_class==="lock"){if(e==="on")return!1;if(e==="off")return!0}return["locked","lock","secured","closed","off","false"].includes(e)?!0:["unlocked","unlock","open","unsecured","on","true"].includes(e)?!1:null}var Sr={good:A.good,warn:A.warn,bad:A.bad,neutral:A.neutral,accent:A.accent},ca=class extends T{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[R]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return jt[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      <div class="card surface">
        <div class="kop">
      ...
      </div>`}wire(){this.teardown_.push(I(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;P(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&P(this,t.dataset.id)})}paint(){let e=this.config,t=this.soort_(),n=yr(t)?zr(v(this.hass,e.battery),e.battery_max):null,a=jr(t)?zr(v(this.hass,e.fuel),e.fuel_max):null,r=ad(v(this.hass,e.range)),o=td(v(this.hass,e.charging)),s=Er(v(this.hass,e.charging_ready)),l=v(this.hass,e.lock),d=Mr(v(this.hass,e.doors)),c=Mr(v(this.hass,e.windows)),p=d===!0||c===!0,h=od(l),u=rd(v(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),m=e.battery&&!v(this.hass,e.battery)&&e.range&&!v(this.hass,e.range);this.toggleAttribute("dead",!!m),this.text(".nm",e.name||N(this.hass,e.battery||e.range||e.lock,"Auto"));let k=id({open:p,slot:h===!1?"unlocked":h===!0?"locked":null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",k.tekst),this.$(".st").style.setProperty("--melding",Sr[k.toon]??A.neutral),this.paintFoto_(),this.paintBalken_({accu:n,tank:a,radius:r,laden:o,soort:t}),this.paintTegels_(u,o,{slot:h,deurOpen:d,raamOpen:c}),L(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=b(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=b(this.config.icon||"car")},e.replaceChildren(n)}paintBalken_({accu:e,tank:t,radius:n,laden:a,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=$r(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:a==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:a==="charging"})}if(t!==null){let h=$r(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":jt[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=Er(v(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,u)=>{let m=u===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,k=h.laadt&&c?` \xB7 nog ${this.veilig_(Ar(c))}`:"";return`
          <div class="meter" style="--balk:${Sr[h.toon]??A.neutral}">
            <div class="regel">
  ...
  `);var Nr=class extends H{defaults(){return{icon:"car",drivetrain:"electric",photo_size:"klein"}}pickers(){return[{key:"image",kind:"foto",label:"Foto van de auto"},{key:"icon",kind:"icon",label:"Icoon (zonder foto)",fallback:"car"}]}schema(){let e=jt[this.config_?.drivetrain]?this.config_.drivetrain:"electric",t=[{name:"name",selector:f.text()},{name:"drivetrain",selector:f.select(Object.entries(jt).map(([n,{label:a}])=>({value:n,label:a})))},{name:"photo_size",selector:f.select([{value:"klein",label:"Klein, naast de naam"},{value:"groot",label:"Groot, over de hele breedte"}])},{name:"range",selector:f.entity(["sensor","number"])}];return yr(e)&&t.push({name:"battery",selector:f.entity(["sensor","number"])},{name:"battery_max",selector:f.number(1,400,1)},{name:"charging",selector:f.entity(["sensor","binary_sensor","switch"])},{name:"charging_ready",selector:f.entity(["sensor"])},{name:"charging_power",selector:f.entity(["sensor"])}),jr(e)&&t.push({name:"fuel",selector:f.entity(["sensor","number"])},{name:"fuel_max",selector:f.number(1,200,1)}),t.push({name:"lock",selector:f.entity(["lock","sensor","binary_sensor"])},{name:"doors",selector:f.entity(["binary_sensor","sensor","cover"])},{name:"windows",selector:f.entity(["binary_sensor","sensor","cover"])},{name:"climate",selector:f.entity(["sensor","binary_sensor","switch","climate"])},{name:"location",selector:f.entity(["device_tracker","sensor","person"])},{name:"home_radius",selector:f.number(10,2e3,10)},{name:"odometer",selector:f.entity(["sensor"])},{name:"sensors",selector:{entity:{multiple:!0}}}),t}label(e){return{name:"Naam",drivetrain:"Aandrijving",image:"Foto van de auto",photo_size:"Hoe groot staat de foto",range:"Actieradius",battery:"Accupercentage",battery_max:"Accu-inhoud (kWh), als de sensor geen procenten geeft",charging:"Laadstatus",charging_ready:"Klaar met laden om / nog te gaan",charging_power:"Laadvermogen",fuel:"Tankniveau",fuel_max:"Tankinhoud (liter), als de sensor geen procenten geeft",lock:"Portierslot",doors:"Deuren open",windows:"Ramen open",climate:"Voorverwarmen (alleen uitlezen)",location:"Waar hij staat",home_radius:"Hoe dichtbij is thuis (meter)",odometer:"Kilometerstand",sensors:"Extra sensoren als tegel"}[e.name]??super.label(e)}helper(e){return{drivetrain:"Bepaalt welke balken er op de kaart komen \u2014 een accu, een tank, of allebei \u2014 en welke velden je hieronder ziet.",image:"Kies een bestand of sleep er een op. Home Assistant zet hem in zijn eigen media-opslag; je kunt ook een pad als /local/auto.png intypen.",range:"In de eenheid van de sensor zelf. De kaart rekent niets om: staat je Home Assistant op mijlen, dan zie je mijlen.",battery_max:"Alleen nodig als je accusensor in kWh meldt in plaats van in procenten. Dan rekent de kaart het percentage zelf uit.",fuel_max:"Alleen nodig als je tanksensor in liters meldt in plaats van in procenten.",charging_ready:"Een aantal minuten, een klok of het tijdstip waarop hij vol is \u2014 alle drie worden gelezen.",doors:"Staat er iets open, dan zegt de kaart dat en gaat al het andere even opzij. Een binary_sensor mag, maar een gewone sensor met een woord erin ook \u2014 Closed, Open, Ajar en LOCKED worden allemaal gelezen.",lock:"Alleen uitlezen: deze kaart bedient niets. Een lock-entiteit mag, maar ook een sensor die LOCKED of UNLOCKED meldt.",location:"Een device_tracker die home of not_home meldt, of een sensor met een coordinaat \u2014 beide worden gelezen. Bij een coordinaat rekent de kaart de afstand tot de locatie van je Home Assistant uit en maakt daar Thuis of Afwezig van.",home_radius:"Alleen van belang bij een sensor met een coordinaat. Binnen deze afstand van je huis heet de auto thuis. Leeg laten is 100 meter \u2014 ruim genoeg voor een oprit of een parkeerplaats om de hoek.",sensors:"Alles wat je verder nog kwijt wilt: bandenspanning, buitentemperatuur, de volgende beurt. Ze komen als tegels onderaan te staan, met de naam uit Home Assistant."}[e.name]}};V("domotiapp-auto-card-editor",Nr);O("domotiapp-auto-card",ca,{name:"DomotiApp Auto",description:"Brandstof, hybride of elektrisch: accu- en tankbalk, actieradius, laadstatus, het slot en zoveel eigen sensoren als je kwijt wilt \u2014 met een foto van de auto erbij."});function sd(i,e){return i?.entities?.[e]?.device_id??null}function Tr(i,e,t,n){if(n&&t.includes(n))return n;let a=sd(i,e);if(a){let r=t.filter(o=>sd(i,o)===a);if(r.length===1)return r[0]}return null}function pa(i,e,t,n,a){let r=Tr(i,e,t,n);return r===null||r===a}var dd=[{sleutel:"mens",label:"Mens",icoon:"person",woorden:["person","persoon","personen","mens","people","human"]},{sleutel:"dier",label:"Dier",icoon:"dier",woorden:["pet","pets","dier","dieren","huisdier","animal","dog","hond","cat","kat"]},{sleutel:"voertuig",label:"Voertuig",icoon:"car",woorden:["vehicle","voertuig","car","auto","truck","vrachtwagen","motorcycle"]},{sleutel:"aanbellen",label:"Aanbellen",icoon:"bell",woorden:["doorbell","deurbel","aanbellen","aangebeld","visitor","bezoeker","bel","ring","chime"]},{sleutel:"ontgrendeling",label:"Ontgrendeling",icoon:"lockOpen",woorden:["unlock","unlocked","ontgrendeld","ontgrendeling","slot","lock","opener","deuropener","buzzer","toegang","access","entry","keypad","badge","pas"]}],cd={sleutel:"beweging",label:"Beweging",icoon:"cctv",woorden:[]},Zt=[...dd,cd];function pd(i){return Zt.find(e=>e.sleutel===i)??cd}function ld(i){return String(i??"").toLowerCase().split(/[^a-z0-9]+/).filter(Boolean)}function ha(i,e,t){if(String(i??"").split(".")[0]==="lock")return"ontgrendeling";if(t==="doorbell")return"aanbellen";let a=new Set([...ld(i),...ld(e)]);for(let r of dd)if(r.woorden.some(o=>a.has(o)))return r.sleutel;return null}function hd(i,e={}){let t=i?.melder,n=t?e[`meldersoort:${t}`]:null;return n&&Zt.some(a=>a.sleutel===n)?n:ha(t,i?.naam)}function qt(i){let e=Date.parse(i?.tijd??"");return Number.isNaN(e)?null:e}function ua(i,{soorten:e,camera:t,dag:n,config:a}={}){let r=e instanceof Set?e:new Set(e??[]),o=n==null?null:ie(n);return(Array.isArray(i)?i:[]).filter(s=>{if(r.size){let l=hd(s,a);if(!l||!r.has(l))return!1}if(t&&s.camera!==t)return!1;if(o){let l=qt(s);if(l===null||l<o.vanaf||l>=o.tot)return!1}return!0})}function ud(i,e={}){let t={};for(let n of Array.isArray(i)?i:[]){let a=hd(n,e);a&&(t[a]=(t[a]??0)+1)}return t}function md(i){let e=new Set((Array.isArray(i)?i:[]).map(t=>t?.soort).filter(Boolean));return Zt.filter(t=>e.has(t.sleutel))}function gd(i,e,t){let n=Array.isArray(e)?e:[];if(n.some(r=>r==null))return[...i??[]];let a=new Set(n.filter(Boolean));for(let r of Array.isArray(t)?t:[])r?.camera&&a.add(r.camera);return(i??[]).filter(r=>a.has(r))}function Or(i){let e=new Set;for(let t of Array.isArray(i)?i:[]){let n=qt(t);n!==null&&e.add(ie(n).vanaf)}return[...e].sort((t,n)=>n-t)}function ma(i,e,t){let n=ie(e).vanaf,a=(i??[]).filter(r=>t<0?r<n:r>n);return a.length?t<0?a[0]:a[a.length-1]:null}function Dr(i){let e=new Map;for(let n of Array.isArray(i)?i:[]){let a=qt(n),r=a===null?null:ie(a).vanaf;e.has(r)||e.set(r,[]),e.get(r).push(n)}return[...e.entries()].map(([n,a])=>({dag:n,beelden:a.sort((r,o)=>(qt(o)??0)-(qt(r)??0)),bytes:a.reduce((r,o)=>r+(Number(o.bytes)||0),0)})).sort((n,a)=>n.dag===null?1:a.dag===null?-1:a.dag-n.dag)}function Lr(i){let e=Number(i)||0;return e>=1024*1024*1024?`${(e/(1024*1024*1024)).toFixed(1)} GB`:e>=1024*1024?`${Math.round(e/(1024*1024))} MB`:e>=1024?`${Math.round(e/1024)} kB`:`${e} B`}function ie(i){let e=new Date(i),t=new Date(e.getFullYear(),e.getMonth(),e.getDate()).getTime(),n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1).getTime();return{vanaf:t,tot:n}}function Cr(i,e){let t=new Date(i);return new Date(t.getFullYear(),t.getMonth(),t.getDate()+e).getTime()}var Vu=["zo","ma","di","wo","do","vr","za"],Bu=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"];function zt(i,e=Date.now()){if(i==null)return"Alles";let t=ie(e).vanaf,n=ie(i).vanaf,a=Math.round((t-n)/864e5);if(a===0)return"Vandaag";if(a===1)return"Gisteren";let r=new Date(n);return`${Vu[r.getDay()]} ${r.getDate()} ${Bu[r.getMonth()]}`}function Pu(i){let e=[i?.camera,...Array.isArray(i?.cameras)?i.cameras:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function Ku(i){let e=[...Array.isArray(i?.motion_sensors)?i.motion_sensors:[],...i?.motion?[i.motion]:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function Gu(i,e){let t=Pu(e),n=Ku(e),a=!!e?.snapshots;return t.map(r=>{let o=n.filter(l=>pa(i,l,t,e?.[`melderbij:${l}`],r)),s={};for(let l of o){let d=e?.[`melder:${l}`];typeof d=="string"&&d.trim()&&(s[l]=d.trim())}return{camera:r,aan:a&&o.length>0,melders:o,namen:s,rustperiode:fd(e?.snapshot_rustperiode,60),wachttijd:fd(e?.snapshot_wachttijd,0),ontvangers:Uu(e?.snapshot_ontvangers).filter(l=>l.startsWith("person.")),alleen_afwezig:!!e?.snapshot_alleen_afwezig,stil_schakelaar:typeof e?.snapshot_stil=="string"&&e.snapshot_stil?e.snapshot_stil:null}})}function Wu(i,e){if(!e)return!0;for(let t of Object.keys(i))if(!Rr(i[t],e[t]))return!0;return!1}function bd(i,e,t){return Gu(i,e).filter(n=>Wu(n,t?.[n.camera]))}function Rr(i,e){return Array.isArray(i)&&Array.isArray(e)?i.length===e.length&&i.every((t,n)=>Rr(t,e[n])):i&&e&&typeof i=="object"&&typeof e=="object"?[...new Set([...Object.keys(i),...Object.keys(e)])].every(n=>Rr(i[n],e[n])):i===e}function Uu(i){return Array.isArray(i)?i.filter(e=>typeof e=="string"):typeof i=="string"&&i?[i]:[]}function fd(i,e){let t=Number(i);return Number.isFinite(t)&&t>=0?Math.round(t):e}var Fu=`
  :host {
    ${W}
...
`;function at(i){return String(i??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var Hr=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Z(Fu)],this.beelden_=[]}open(e){this.opts_=e,this.beelden_=e.beelden??[],this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.alleenBeeld_=!!e.beeld,this.$(".scherm").hidden=this.alleenBeeld_,e.beeld?this.toonGroot_(e.beeld):this.$(".groot").hidden=!0,this.teken_()}zet(e){this.beelden_=e??[],this.hasAttribute("open")&&this.teken_()}sluit(){this.removeAttribute("open"),this.opts_?.dicht?.()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      ...
      </div>`,this.shadowRoot.addEventListener("click",e=>{e.stopPropagation();let t=this.$(".groot");if(!t.hidden&&e.composedPath().includes(t)){if(this.alleenBeeld_)return this.sluit();t.hidden=!0;return}if(e.target.closest?.(".terug"))return this.sluit();let n=e.target.closest?.("[data-weg]");if(n){let o=this.beelden_.find(s=>s.id===n.dataset.weg);return this.opts_?.wis?.([n.dataset.weg],o?`dit beeld van ${o.naam??"de camera"}`:"dit beeld")}let a=e.target.closest?.("[data-wisdag]");if(a){let o=Dr(this.beelden_).find(s=>String(s.dag)===a.dataset.wisdag);return o?this.opts_?.wis?.(o.beelden.map(s=>s.id),`${o.beelden.length} beelden van ${zt(o.dag).toLowerCase()}`):void 0}if(e.target.closest?.(".wis"))return this.beelden_.length?this.opts_?.wis?.(this.beelden_.map(o=>o.id),`alle ${this.beelden_.length} beelden`):void 0;let r=e.target.closest?.("[data-beeld]");r&&this.toonGroot_(r.dataset.beeld)}),this.tabIndex=-1,this.addEventListener("keydown",e=>{e.key==="Escape"&&(e.stopPropagation(),!this.$(".groot").hidden&&!this.alleenBeeld_?this.$(".groot").hidden=!0:this.sluit())})}toonGroot_(e){let t=this.beelden_.find(a=>a.id===e);if(!t)return;let n=this.$(".groot");n.querySelector("img").src=t.url,n.querySelector(".onder").textContent=`${this.opts_.camNaam(t.camera)} \xB7 ${t.naam??""} \xB7 ${this.opts_.klok(t.tijd,!0)}`,n.hidden=!1}teken_(){if(this.alleenBeeld_)return;let e=Dr(this.beelden_),t=this.beelden_.reduce((r,o)=>r+(Number(o.bytes)||0),0),n=this.opts_.meerdere;this.$(".stat").textContent=this.beelden_.length?`${this.beelden_.length} beelden \xB7 ${Lr(t)}`:"",this.$(".wis").disabled=!this.beelden_.length,this.$(".lijst").innerHTML=e.length?e.map(r=>{let o=r.dag===null?"Zonder datum":zt(r.dag);return`<div class="dagkop"><span>${at(o)}</span><span class="bij">${r.beelden.length} \xB7 ${Lr(r.bytes)}</span><button type="button" data-wisdag="${r.dag}">Wis deze dag</button></div><div class="raster">`+r.beelden.map(s=>{let l=n?`${at(this.opts_.camNaam(s.camera))} \xB7 `:"";return`<button type="button" class="kiek" data-beeld="${at(s.id)}"><img src="${at(s.url)}" alt="" loading="lazy"><span class="bij">${l}${at(s.naam??"")} \xB7 ${at(this.opts_.klok(s.tijd))}</span><span class="weg" role="button" data-weg="${at(s.id)}" aria-label="Verwijder">${b("close")}</span></button>`}).join("")+"</div>"}).join(""):'<div class="leeg">Er liggen geen snapshots.</div>';let a=this.$(".groot");!a.hidden&&this.alleenBeeld_===!1&&(this.beelden_.some(o=>a.querySelector("img").src.includes(o.id))||(a.hidden=!0))}};C("domotiapp-camera-archief",Hr);function vd(i){let e=document.querySelector("domotiapp-camera-archief");return e||(e=document.createElement("domotiapp-camera-archief"),document.body.appendChild(e)),e.open(i),e.focus?.(),e}function Ir(i){document.querySelector("domotiapp-camera-archief")?.zet(i)}function ga(i){let e=Number(i);return Number.isFinite(e)?Math.max(1,Math.min(6,e)):1}function qu(i){let e=ga(i);return Math.max(0,(1-1/e)/2)}function Xt(i,e,t){let n=qu(t),a=o=>Number.isFinite(Number(o))?Number(o):0,r=o=>Math.max(-n,Math.min(n,a(o)))+0;return{x:r(i),y:r(e)}}function fa(i,e,t={x:0,y:0}){let n=ga(i?.zoom??1),a=ga(n*(Number(e)||1));if(a===n)return{zoom:n,...Xt(i?.x,i?.y,n)};let r=Number(t?.x)||0,o=Number(t?.y)||0,s=(i?.x??0)+r*(1/n-1/a),l=(i?.y??0)+o*(1/n-1/a);return{zoom:a,...Xt(s,l,a)}}function kd({zoom:i=1,x:e=0,y:t=0}={}){let n=ga(i),a=Xt(e,t,n);return`scale(${n}) translate(${(-a.x*100).toFixed(3)}%, ${(-a.y*100).toFixed(3)}%)`}var wd=[{sleutel:"auto",label:"Volgt de camera",css:null},{sleutel:"16:9",label:"16:9 (breed)",css:"16 / 9"},{sleutel:"4:3",label:"4:3",css:"4 / 3"},{sleutel:"3:2",label:"3:2",css:"3 / 2"},{sleutel:"1:1",label:"Vierkant",css:"1 / 1"}],Zu=7,ba=[{k:"up",icoon:"arrowUp",label:"Omhoog"},{k:"left",icoon:"chevronRight",label:"Links",draai:180},{k:"right",icoon:"chevronRight",label:"Rechts"},{k:"down",icoon:"arrowDown",label:"Omlaag"}];function _d(i){return!!(i.presets||Array.isArray(i.preset_buttons)&&i.preset_buttons.length||ba.some(e=>i[`ptz_${e.k}`]))}var va=class extends T{validate(e){let t={name:"",...e};return!t.camera&&!(Array.isArray(t.cameras)&&t.cameras.length)&&(t[R]="Kies een camera. Presets, richtingsknoppen en een bewegingsmelder mogen daarna."),t.presets_aan===void 0&&(t.presets_aan=_d(t)),t}watched(){let e=this.config;return[...this.cameras_(),e.presets,e.snapshot_stil,...this.melders_().map(t=>t.entity),...Array.isArray(e.preset_buttons)?e.preset_buttons:[]].filter(Boolean)}paintStil_(){let e=this.$(".stil");if(!e)return;let t=this.config.snapshot_stil;if(!t){e.hidden=!0;return}let n=v(this.hass,t),a=X(n);e.hidden=!1,e.setAttribute("aria-pressed",String(a));let r=a?"Meldingen staan uit; tik om ze weer aan te zetten":"Meldingen staan aan; tik om ze uit te zetten";e.setAttribute("aria-label",r),e.title=r;let o=a?"bellOff":"bell";e.dataset.icoon!==o&&(e.dataset.icoon=o,e.innerHTML=b(o))}melders_(){let e=this.config,t=[...Array.isArray(e.motion_sensors)?e.motion_sensors:[],...e.motion?[e.motion]:[]].filter(n=>typeof n=="string");return[...new Set(t)].map(n=>{let a=e[`melder:${n}`]||N(this.hass,n)||"Beweging";return{entity:n,naam:a,bijCamera:e[`melderbij:${n}`],soort:e[`meldersoort:${n}`]||ha(n,a,v(this.hass,n)?.attributes?.device_class)}})}cameras_(){let e=this.config,t=[e.camera,...Array.isArray(e.cameras)?e.cameras:[]].filter(Boolean);return[...new Set(t)]}huidig_(){let e=this.cameras_();return e.includes(this.cam_)?this.cam_:e[0]}template(){return this.config.bare&&this.setAttribute("bare",""),this.stand_=this.stand_??{zoom:1,x:0,y:0},`
      <div class="card surface">
        <div class="vak">
          ...
          <div class="ptz" hidden>
            ${ba.map(t=>`<button type="button" data-r="${t.k}" aria-label="${t.label}"${t.draai?` style="transform: rotate(${t.draai}deg)"`:""}>${b(t.icoon)}</button>`).join("")}
          </div>
...
`;var ot=["ma","di","wo","do","vr","za","zo"],Et={ma:"maandag",di:"dinsdag",wo:"woensdag",do:"donderdag",vr:"vrijdag",za:"zaterdag",zo:"zondag"},Kd=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],Gd=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],wa=i=>String(i).padStart(2,"0"),Jt=i=>ot[(i.getDay()+6)%7],Oe=i=>`${i.getFullYear()}-${wa(i.getMonth()+1)}-${wa(i.getDate())}`,je=i=>`${wa(i.getHours())}:${wa(i.getMinutes())}`,Ze=i=>`${Oe(i)}T${je(i)}`,Wd=i=>`${Et[Jt(i)]} ${i.getDate()} ${Kd[i.getMonth()]}`;function Bd(i){if(!i)return"";let[,e,t]=i.split("-").map(Number);return`${t} ${Kd[e-1]}`}function Ud(i,e){let t=Oe(i);if(t===Oe(e))return"vandaag";let n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1);return t===Oe(n)?"morgen":Et[Jt(i)]}function tm(i,e){let t=e.length===10?`${e}T00:00`:e,n=i?.van?i.van.length===10?`${i.van}T00:00`:i.van:null,a=i?.tot?i.tot.length===10?`${i.tot}T23:59`:i.tot:null;return!(n&&n>t||a&&a<t)}var en=(i,e)=>(i??[]).filter(t=>t.tekst&&tm(t,e));function Fd(i,e){let t=e.length===10?`${e}T00:00`:e;return(i??[]).filter(n=>n.tekst&&n.van&&(n.van.length===10?`${n.van}T00:00`:n.van)>t).sort((n,a)=>String(n.van).localeCompare(String(a.van)))}function Pd(i){if(!i)return"";let[e,t]=i.split("T");return t?`${Bd(e)} ${t}`:Bd(e)}function Pr(i){let e=Pd(i?.van),t=Pd(i?.tot);return e&&t?`${e} t/m ${t}`:e?`vanaf ${e}`:t?`tot en met ${t}`:""}function qd(i){return(i??[]).filter(e=>e.titel).map(e=>({...e,eigen:!1})).sort((e,t)=>String(t.datum??"").localeCompare(String(e.datum??"")))}function Kr(i,e){let t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=[];for(let a of i??[]){if(!a?.naam||!a?.datum)continue;let[r,o,s]=a.datum.split("-").map(Number);if(!o||!s)continue;let l=new Date(t.getFullYear(),o-1,s);l<t&&(l=new Date(t.getFullYear()+1,o-1,s));let d=Math.round((l-t)/864e5),c=a.jaar_tonen!==!1&&r>1900?l.getFullYear()-r:null;n.push({...a,dagen:d,leeftijd:c,wanneer:d===0?"vandaag":d===1?"morgen":`${ot[(l.getDay()+6)%7]} ${l.getDate()} ${Gd[l.getMonth()]}`})}return n.sort((a,r)=>a.dagen-r.dagen||a.naam.localeCompare(r.naam,"nl"))}var nm=i=>i?.length?i.map(([e,t])=>`${e} \u2013 ${t}`).join(", "):"gesloten";function Gr(i,e){let t=Oe(e),n=i?.openingstijden?.[Jt(e)]??[],a="";for(let r of i?.uitzonderingen??[])r.datum===t&&(n=r.tijden??[],a=r.reden??"");return{tijden:n,reden:a}}function tn(i,e){let{tijden:t,reden:n}=Gr(i,e),a=je(e),r=t.find(([s,l])=>s<=a&&a<l),o=t.find(([s])=>s>a);return{open:!!r,tot:r?r[1]:null,straks:o?o[0]:null,tijden:t,reden:n}}function am(i,e){let t=tn(i,e);if(t.straks)return{dag:"vandaag",tijd:t.straks};for(let n=1;n<=14;n+=1){let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()+n),{tijden:r}=Gr(i,a);if(r.length)return{dag:n===1?"morgen":Et[Jt(a)],tijd:r[0][0]}}return null}function Zd(i,e){let t=Jt(e);return ot.map(n=>{let a=n===t?Gr(i,e):null,r=a?a.tijden:i?.openingstijden?.[n]??[];return{dag:n,naam:Et[n],tekst:nm(r),reden:a?.reden??"",vandaag:n===t}})}var Wr=i=>ot.some(e=>(i?.openingstijden?.[e]??[]).length>0);function Xd(i){return(i?.installatie?.verlichting?.length??0)>0?i?.instellingen?.verlichting_tonen!==!1:!1}function Ur(i,e,t=null){let n=["welkom"];return(i?.personen?.length??0)>0&&n.push("aanwezig"),(t?en(i?.mededelingen,t).length>0:(i?.mededelingen?.length??0)>0)&&n.push("mededelingen"),(e?.length??0)>0&&n.push("nieuws"),i?.installatie?.weer&&n.push("weer"),i?.installatie?.energie&&n.push("energie"),Xd(i)&&n.push("verlichting"),(i?.installatie?.agendas?.length??0)>0&&n.push("agenda"),(i?.verjaardagen?.length??0)>0&&n.push("verjaardagen"),n}function Fr(i){let e=String(i??"").trim().split(/\s+/).filter(Boolean);return e.length?e.length===1?e[0].slice(0,2).toUpperCase():(e[0][0]+e[e.length-1][0]).toUpperCase():"?"}function Yd(i){let e=new Map;for(let t of i??[]){let n=t.functie||"";e.has(n)||e.set(n,[]),e.get(n).push(t)}return[...e].map(([t,n])=>({functie:t,personen:n}))}function qr(i){let e=i??[];return{aanwezig:e.filter(t=>t.aanwezig),afwezig:e.filter(t=>!t.aanwezig)}}function Qd(i){let{aanwezig:e,afwezig:t}=qr(i);return[...e,...t]}function Zr(i,e){if(!i)return"";let t=new Date(i);if(Number.isNaN(t.getTime()))return"";let n=Math.round((e-t)/6e4);if(n<1)return"zojuist";if(n<60)return`${n} min geleden`;if(Oe(t)===Oe(e))return`vandaag ${je(t)}`;let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()-1);return Oe(t)===Oe(a)?`gisteren ${je(t)}`:`${t.getDate()} ${Gd[t.getMonth()]}`}function Jd(i,e){let t=tn(i,e),n=["Gesloten"];t.reden&&n.push(t.reden);let a=am(i,e);return a&&n.push(`${a.dag} open om ${a.tijd}`),n.join(" \xB7 ")}var ze=6,$e=6,Xe={welkom:{naam:"Welkom",icoon:"house",pagina:null,aantal:!1,maat:[6,1]},weer:{naam:"Weer",icoon:"sun",pagina:"weer",aantal:!1,maat:[2,2]},mededeling:{naam:"Mededelingen",icoon:"bell",pagina:"mededelingen",aantal:!1,maat:[2,1]},openingstijden:{naam:"Openingstijden",icoon:"clock",pagina:null,aantal:!1,maat:[2,3]},aanwezig:{naam:"Aanwezig",icoon:"people",pagina:"aanwezig",aantal:!0,maat:[2,3]},nieuws:{naam:"Nieuws",icoon:"news",pagina:"nieuws",aantal:!0,maat:[2,4]},verlichting:{naam:"Verlichting",icoon:"bulb",pagina:"verlichting",aantal:!0,maat:[2,1]},agenda:{naam:"Agenda",icoon:"calendar",pagina:"agenda",aantal:!0,maat:[2,2]},verjaardagen:{naam:"Verjaardagen",icoon:"cake",pagina:"verjaardagen",aantal:!0,maat:[2,2]},energie:{naam:"Energie",icoon:"bolt",pagina:"energie",aantal:!1,maat:[2,2]}},im=new Set(["aanwezig","nieuws","verlichting","agenda","verjaardagen"]),rm=[0,.85,1,1.12,1.25,1.35,1.45],om=[0,.8,1,1.15,1.3,1.4,1.5];function ec(i,e,t){let n=rm[Math.min(ze,Math.max(1,Math.round(e)||1))],a=om[Math.min($e,Math.max(1,Math.round(t)||1))],r=im.has(i)?n:Math.sqrt(n*a);return Math.round(r*1e3)/1e3}function tc({beschikbaar:i,hoogte:e,gap:t=0,aantal:n,kolommen:a=1,minPas:r=.72,drempel:o=.4}){if(!n||!(e>0)||!(i>0))return{rijen:0,tonen:0,pas:1};let s=Math.max(1,a),l=Math.ceil(n/s),d=Math.floor((i+t)/(e+t)),c=1;if(d<l){let p=d+1,u=(i-(p-1)*t)/p/e,m=i-d*e-Math.max(0,d-1)*t;(d===0||u>=r&&m>=o*e)&&(d=p,c=Math.min(1,Math.max(d===1?.5:r,u)))}return d=Math.min(d,l),{rijen:d,tonen:Math.min(n,d*s),pas:Math.round(c*1e3)/1e3}}var nc=Object.keys(Xe);function _a(){return{blokken:[["welkom",0,0,2,2,0],["weer",0,2,2,2,0],["openingstijden",0,4,2,2,0],["aanwezig",2,0,2,3,6],["mededeling",2,3,2,1,0],["verlichting",2,4,2,2,4],["nieuws",4,0,2,6,6]].map(([e,t,n,a,r,o])=>({id:`std-${e}`,soort:e,x:t,y:n,w:a,h:r,aantal:o}))}}var Xr=(i,e)=>i.x<e.x+e.w&&e.x<i.x+i.w&&i.y<e.y+e.h&&e.y<i.y+i.h,sm=i=>i.x>=0&&i.y>=0&&i.w>=1&&i.h>=1&&i.x+i.w<=ze&&i.y+i.h<=$e;function ya(i,e){return sm(e)?!(i??[]).some(t=>t.id!==e.id&&Xr(t,e)):!1}function Yr(i,e,t){for(let n=0;n+t<=$e;n+=1)for(let a=0;a+e<=ze;a+=1)if(ya(i,{id:"",x:a,y:n,w:e,h:t}))return{x:a,y:n};return null}function ja(i,e,t,n){let a=e??{};switch(i){case"welkom":return null;case"weer":return a.installatie?.weer?null:"Geen weerentiteit gekozen (kaartinstellingen van het infoscherm)";case"mededeling":return en(a.mededelingen,n).length?null:"Geen mededeling die nu geldt";case"verjaardagen":return(a.verjaardagen?.length??0)>0?null:"Nog geen verjaardagen";case"openingstijden":return Wr(a.praktijk)?null:"Geen openingstijden ingevuld";case"aanwezig":return(a.personen?.length??0)>0?null:"Nog geen medewerkers";case"nieuws":return null;case"energie":return a.installatie?.energie?null:"Geen energiesensor gekozen (kaartinstellingen van het infoscherm)";case"verlichting":return(a.installatie?.verlichting?.length??0)>0?Xd(a)?null:"Verlichting staat uit in het beheer":"Geen lampen gekozen (kaartinstellingen van het infoscherm)";case"agenda":return(a.installatie?.agendas?.length??0)>0?null:"Geen agenda gekozen (kaartinstellingen van het infoscherm)";default:return"Onbekend blok"}}function ac(i){let e=i??{};return e.state_class==="total_increasing"||e.state_class==="total"?!0:/wh$/i.test(String(e.unit_of_measurement??"").trim())}function ic(i){let e=[];for(let t of i??[]){let n=Number(t?.s??t?.state);if(!Number.isFinite(n))continue;let a=t?.lu??t?.last_updated,r=typeof a=="number"?a*1e3:Date.parse(a);Number.isFinite(r)&&e.push({t:r,v:n})}return e.sort((t,n)=>t.t-n.t)}function rc(i,{nu:e,tellerstand:t=!1,venster:n=24}={}){let a=e,r=a-n*36e5,o=(i??[]).filter(p=>p.t<=a),s=o.filter(p=>p.t>=r-36e5);if(!t){let p=s.filter(m=>m.t>=r),h=o.filter(m=>m.t<r).pop();h&&p.unshift({t:r,v:h.v});let u=p[p.length-1];return u&&u.t<a&&p.push({t:a,v:u.v}),{punten:p,van:r,tot:a,perUur:!1}}let l=[],d=Math.floor(r/36e5)*36e5,c=o.filter(p=>p.t<d).pop()?.v??null;for(let p=d;p<a;p+=36e5){let h=s.filter(m=>m.t>=p&&m.t<p+36e5),u=h.length?h[h.length-1].v:null;u!==null&&c!==null&&l.push({t:p,v:u>=c?Math.round((u-c)*1e3)/1e3:0}),u!==null&&(c=u)}return{punten:l.filter(p=>p.t>=r),van:r,tot:a,perUur:!0}}function oc(i){let e=i?.punten??[];if(!e.length)return{nu:null,gemiddeld:null,piek:null,totaal:null};let t=e.map(a=>a.v),n=t.reduce((a,r)=>a+r,0);return{nu:t[t.length-1],gemiddeld:n/t.length,piek:Math.max(...t),totaal:i.perUur?n:null}}function Qr(i,{w:e=1e3,h:t=400}={}){let n=i?.punten??[];if(n.length<2||!(i.tot>i.van))return{lijn:"",vlak:"",min:0,max:0};let a=n.map(u=>u.v),r=Math.min(0,...a),o=Math.max(...a),s=o>r?r+(o-r)/.95:r+1,l=u=>((u-i.van)/(i.tot-i.van)*e).toFixed(1),d=u=>(t-(u-r)/(s-r)*t).toFixed(1),c=n.map((u,m)=>`${m?"L":"M"}${l(u.t)},${d(u.v)}`).join(" "),p=d(Math.max(r,0)),h=`${c} L${l(n[n.length-1].t)},${p} L${l(n[0].t)},${p} Z`;return{lijn:c,vlak:h,min:r,max:s}}function sc(i,e="W",t=null){if(i==null||!Number.isFinite(Number(i)))return"--";let n=Number(i),a=String(e??"").trim();/^wh?$/i.test(a)&&Math.abs(n)>=1e3&&(n/=1e3,a=`k${a}`);let r=t??(Math.abs(n)>=100?0:Math.abs(n)>=10?1:2),o=n.toLocaleString("nl-NL",{minimumFractionDigits:r,maximumFractionDigits:r});return a?`${o} ${a}`:o}function lc(i,e=48){let t=i?.punten??[];if(t.length<2||!(i.tot>i.van))return i;let n=(i.tot-i.van)/e,a=[],r=t[0].v;for(let o=0;o<e;o+=1){let s=i.van+o*n,l=s+n,d=t.filter(p=>p.t>=s&&p.t<l),c=d.length?d.reduce((p,h)=>p+h.v,0)/d.length:r;r=c,a.push({t:s+n/2,v:Math.round(c*1e3)/1e3})}return a.unshift({t:i.van,v:t[0].v}),a.push({t:i.tot,v:t[t.length-1].v}),{...i,punten:a}}function dc(i,{w:e=1e3,h:t=400,spanning:n=.5}={}){let a=Qr(i,{w:e,h:t}),r=i?.punten??[];if(r.length<3||!a.lijn)return a;let{min:o,max:s}=a,l=r.map(m=>[(m.t-i.van)/(i.tot-i.van)*e,t-(m.v-o)/(s-o)*t]),d=m=>m.toFixed(1),c=`M${d(l[0][0])},${d(l[0][1])}`;for(let m=0;m<l.length-1;m+=1){let k=l[m-1]??l[m],x=l[m],w=l[m+1],_=l[m+2]??w,$=[x[0]+(w[0]-k[0])/6*n*2,x[1]+(w[1]-k[1])/6*n*2],M=[w[0]-(_[0]-x[0])/6*n*2,w[1]-(_[1]-x[1])/6*n*2];$[1]=Math.min(t,Math.max(0,$[1])),M[1]=Math.min(t,Math.max(0,M[1])),$[0]=Math.min(w[0],Math.max(x[0],$[0])),M[0]=Math.min(w[0],Math.max($[0],M[0])),c+=` C${d($[0])},${d($[1])} ${d(M[0])},${d(M[1])} ${d(w[0])},${d(w[1])}`}let p=d(t-(Math.max(o,0)-o)/(s-o)*t),h=l[l.length-1],u=`${c} L${d(h[0])},${p} L${d(l[0][0])},${p} Z`;return{lijn:c,vlak:u,min:o,max:s}}var lm="domotiapp-infoscherm-card",za=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,nn={news:za('<rect x="3.4" y="4.6" width="17.2" height="14.8" rx="2"/><path d="M7.2 9.2h9.6M7.2 12.6h9.6M7.2 16h5.6"/>'),cake:za('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),offline:za('<path d="M3.4 6.8a13.6 13.6 0 0 1 17.2 0M6.6 10.4a9 9 0 0 1 10.8 0M9.8 14a4.4 4.4 0 0 1 4.4 0"/><circle cx="12" cy="18" r="1"/><path d="M4 4l16 16"/>'),back:za('<path d="m14.6 6.2-5.6 5.8 5.6 5.8"/>')},cc=i=>nn[i]??b(i),$a={aanwezig:{eyebrow:"Wie is er vandaag",titel:"Aanwezig",onder:"Tik op uw naam om u aan of af te melden."},nieuws:{eyebrow:"Nieuws",titel:"Wat er speelt",onder:""},weer:{eyebrow:"Weer",titel:"Vandaag en de komende dagen",onder:""},verlichting:{eyebrow:"Verlichting",titel:"Lampen",onder:"Tik op een lamp om hem aan of uit te zetten."},agenda:{eyebrow:"Agenda",titel:"Vandaag",onder:""},verjaardagen:{eyebrow:"Verjaardagen",titel:"Wie is er binnenkort jarig",onder:""},energie:{eyebrow:"Energie",titel:"Verbruik",onder:""},mededelingen:{eyebrow:"Mededelingen",titel:"Wat er speelt",onder:""}},Jr=24,dm=`
  :host { display: block; height: 100%; }
  ...
  ${Vd}
`,an=class extends T{constructor(){super(),this.stand_=null,this.feeds_=[],this.pagina_="welkom",this.uren_=[],this.dagen_=[],this.afspraken_=[],this.herkansing_=new le(()=>this.haal_()),this.verbinding_=new we,this.fout_=null,this.html_=new Map,this.weerEntiteit_=null,this.weerOpzeggen_=[],this.agendaSleutel_="",this.mAuto_=0,this.energie_={entiteit:null,punten:[],geladen:0}}validate(e){return{...e}}installatie_(){let e=this.stand_?.installatie??{};return{weer:e.weer??null,energie:e.energie??null,agendas:Array.isArray(e.agendas)?e.agendas:[],verlichting:Array.isArray(e.verlichting)?e.verlichting:[]}}standNu_(){return this.stand_?{...this.stand_,installatie:this.installatie_()}:null}watched(){let e=this.installatie_();return[e.weer,e.energie,"sun.sun",...e.verlichting.map(t=>t.entity)].filter(Boolean)}getCardSize(){return 12}template(){let e=t=>`
      <section class="pagina" data-p="${t}">
        <div class="paginakop">
          <button class="terug" type="button">${nn.back}<span>Terug</span></button>
          <div class="pk-tekst"><div class="eyebrow">${$a[t].eyebrow}</div><div class="titel pk-titel">${$a[t].titel}</div></div>
          <div class="onder">${$a[t].onder}</div>
        </div>
        <div class="p-inhoud" data-p="${t}"></div>
      </section>`;return`
      <div class="scherm">
        <section class="pagina actief" data-p="welkom"><div class="raster"></div></section>
        ${Object.keys($a).map(e).join("")}
    ...
    </div>`}htmlWeerNu_(){let e=this.installatie_().weer,t=v(this.hass,e),n=U(this.hass,e),a=n.temperature,r=[];return t&&r.push(Id[t.state]??ee(this.hass,t)),typeof n.humidity=="number"&&r.push(`${Math.round(n.humidity)}% vochtig`),typeof n.wind_speed=="number"&&r.push(`wind ${K(this.hass,n.wind_speed,0)} ${n.wind_speed_unit??"km/h"}`),`<div class="w-nu"><div class="w-icoon">${xa(t?.state,this.nacht_())}</div><div><div class="temp">${typeof a=="number"?`${K(this.hass,a,0)}\xB0`:"--\xB0"}</div><div class="w-tekst">${y(r.join(" \xB7 "))}</div></div></div>`}htmlUren_(e){let t=Date.now(),n=this.uren_.filter(a=>new Date(a.datetime).getTime()>t-30*6e4).slice(0,e);return n.length?`<div class="uren" style="grid-template-columns: repeat(${n.length}, minmax(0, 1fr))">${n.map(a=>{let r=new Date(a.datetime);return`<div class="uur"><span class="u">${je(r)}</span>${xa(a.condition,r.getHours()<7||r.getHours()>=21)}<span class="t">${typeof a.temperature=="number"?`${Math.round(a.temperature)}\xB0`:"--"}</span></div>`}).join("")}</div>`:""}htmlDagen_(){let e=new Date,t=this.dagen_.slice(0,7);return t.length?`<div class="dagen">${t.map(n=>{let a=new Date(n.datetime);return`<div class="dag"><span class="u">${y(Ud(a,e))}</span>${xa(n.condition)}<span class="t">${typeof n.temperature=="number"?`${Math.round(n.temperature)}\xB0`:"--"}</span>${typeof n.templow=="number"?`<span class="t2">${Math.round(n.templow)}\xB0</span>`:""}</div>`}).join("")}</div>`:""}htmlPersoon_(e){return`<div class="persoon ${e.aanwezig?"aan":""}" role="button" tabindex="0" data-id="${y(e.id)}">
      ...
      <div class="foto"></div>
      <div class="b-tekst">
        <div class="b-bron">${y(n)}${e.datum?` \xB7 ${y(Zr(e.datum,new Date))}`:""}</div>
        <div class="b-titel">${y(e.titel)}</div>
        ${t&&e.tekst?`<div class="b-samenvatting">${y(e.tekst)}</div>`:""}
      </div>
    </div>`}htmlLamp_(e){let t=e.entity,n=v(this.hass,t),a=n?.attributes??{},r=X(n),o=!n||n.state==="unavailable",s=a.rgb_color,l=r&&Array.isArray(s)&&!(s[0]>240&&s[1]>240&&s[2]>240)?`rgb(${s.join(",")})`:"",d=o?"Niet bereikbaar":r?typeof a.brightness=="number"?`Aan \xB7 ${Math.round(a.brightness/255*100)}%`:"Aan":"Uit",c=e.naam||a.friendly_name||t;return`<div class="lamp ${r?"aan":""} ${o?"dood":""}" role="button" tabindex="0" data-id="${y(t)}" style="${l?`--lampkleur:${l}`:""}">
      <div class="chip">${b("bulb")}</div>
      <div class="l-tekst"><div class="l-naam">${y(c)}</div><div class="l-status">${d}</div></div>
    </div>`}htmlAfspraak_(e){let n=!String(e.start).includes("T")?"hele dag":`${je(new Date(e.start))}${e.end?` \u2013 ${je(new Date(e.end))}`:""}`,a=U(this.hass,e.kalender).friendly_name??e.kalender,r=this.installatie_().agendas.length>1;return`<div class="afspraak"><span class="a-tijd">${y(n)}</span><span class="a-tekst">${y(e.summary??"")}</span>${r?`<span class="a-kalender">${y(a)}</span>`:""}</div>`}paintPaginas_(){Ur(this.standNu_(),this.feeds_,Ze(new Date)).includes(this.pagina_)||(this.pagina_="welkom");for(let t of this.$$(".pagina"))t.classList.toggle("actief",t.dataset.p===this.pagina_)}paintPagina_(e){if(e!==this.pagina_||e==="welkom")return;let t=this.$(`.p-inhoud[data-p="${e}"]`);if(!t)return;let n=this.stand_?.scherm??{};switch(e){case"aanwezig":{let a=this.stand_?.personen??[],r=d=>`<div class="tegels">${d.map(c=>this.htmlPersoon_(c)).join("")}</div>`,o=n.aanwezig_weergave??"gescheiden",s;if(o==="functie"){let d=Yd(a);s=`<div class="kolommen ${d.length>=3?"drie":"twee"}">${d.map(c=>`<div class="kolom"><div class="eyebrow">${y(c.functie||"Overig")} \xB7 ${c.personen.length}</div>${r(c.personen)}</div>`).join("")}</div>`}else if(o==="lijst")s=`<div class="tegels kol-3">${a.map(d=>this.htmlPersoon_(d)).join("")}</div>`;else{let{aanwezig:d,afwezig:c}=qr(a);s=`<div class="kolommen twee">
          ...
          </div>`,!1);break}case"agenda":{let a=this.afspraken_;this.vul_(t,a.length?`<div class="afspraken">${a.map(r=>this.htmlAfspraak_(r)).join("")}</div>`:'<div class="leeg">Geen afspraken vandaag.</div>',!1);break}default:}}paintMerkje_(){let e=this.$(".merkje");if(!e)return;let t=this.hass?.connected===!1;e.classList.toggle("open",t||!!this.fout_),this.text(".merkje span",t?"Geen verbinding":this.fout_??"")}};j(an,"css",dm);O(lm,an,{name:"DomotiApp Infoscherm",description:"Beeldvullend scherm voor een wachtkamer: logo, klok, weer, energie, wie er is, mededelingen, nieuws, verjaardagen en verlichting. Toevoegen en klaar; alles komt uit DomotiApp Infoscherm Beheer.",preview:!1});an.getStubConfig=()=>({});var io="domotiapp-infoscherm-beheer-card",cm=["personen","mededelingen","verjaardagen","praktijk","scherm","installatie","indeling","instellingen"],eo=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,hc={layout:eo('<rect x="3.4" y="3.4" width="17.2" height="17.2" rx="2"/><path d="M3.4 9.6h17.2M9.6 9.6v11"/>'),cake:eo('<path d="M4.4 19.4h15.2v-6.2a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2z"/><path d="M4.4 15.6c1.3 0 1.3 1.2 2.5 1.2s1.3-1.2 2.5-1.2 1.3 1.2 2.6 1.2 1.3-1.2 2.5-1.2 1.3 1.2 2.5 1.2 1.3-1.2 2.6-1.2"/><path d="M12 11.2V8.4M9 11.2V8.8M15 11.2V8.8"/><path d="M12 8.4a1.3 1.3 0 0 0 1-2.2L12 4.6l-1 1.6a1.3 1.3 0 0 0 1 2.2z"/>'),grip:eo('<circle cx="9" cy="6" r="1.2" fill="currentColor"/><circle cx="15" cy="6" r="1.2" fill="currentColor"/><circle cx="9" cy="12" r="1.2" fill="currentColor"/><circle cx="15" cy="12" r="1.2" fill="currentColor"/><circle cx="9" cy="18" r="1.2" fill="currentColor"/><circle cx="15" cy="18" r="1.2" fill="currentColor"/>')},pm=i=>hc[i]??b(i),De=[{key:"personen",titel:"Medewerkers",icoon:"people",secties:["personen"]},{key:"mededelingen",titel:"Mededelingen",icoon:"bell",secties:["mededelingen","scherm"]},{key:"verjaardagen",titel:"Verjaardagen",icoon:"cake",secties:["verjaardagen"]},{key:"praktijk",titel:"Openingstijden",icoon:"clock",secties:["praktijk"]},{key:"indeling",titel:"Indeling van het scherm",icoon:"layout",secties:["indeling"]},{key:"verlichting",titel:"Verlichting",icoon:"bulb",secties:["installatie","instellingen"]},{key:"instellingen",titel:"Instellingen en logo",icoon:"cog",secties:["scherm","instellingen"]}],uc=["weather","energy","lights","calendars","kiosk_users"],to=i=>Array.isArray(i)?i.filter(e=>typeof e=="string"&&e):typeof i=="string"&&i?[i]:[],mc={title:"Infoscherm",weather:"",energy:"",lights:[],calendars:[],kiosk_users:[],show_personen:!0,show_mededelingen:!0,show_verjaardagen:!0,show_praktijk:!0,show_indeling:!0,show_verlichting:!0,show_instellingen:!0,open:"personen"},hm=`
  ...
  .raster {
    ...
    background-size: calc(100% / ${ze}) calc(100% / ${$e});
...
`,pc=i=>JSON.parse(JSON.stringify(i??null)),B=i=>y(i??""),Ea=(i,e,t)=>Math.min(t,Math.max(e,i)),um=700,no=150,At=class extends T{constructor(){super(),this.stand_=null,this.rechten_={},this.feedFouten_={},this.werk_={},this.vuil_=new Set,this.bezig_=new Set,this.versie_={},this.timers_={},this.fouten_={},this.uitgesteld_=new Set,this.open_=null,this.meldingen_={},this.herkansing_=new le(()=>this.haal_()),this.verbinding_=new we,this.fout_=null,this.laatstOpgeslagen_=""}validate(e){return this.installatieInConfig_=uc.some(t=>e[t]!==void 0),{...mc,...e,weather:typeof e.weather=="string"?e.weather:"",energy:typeof e.energy=="string"?e.energy:"",lights:to(e.lights),calendars:to(e.calendars),kiosk_users:to(e.kiosk_users)}}watched(){return[]}async sync_(){if(!this.hass?.connection||!this.stand_||!this.hass.user?.is_admin||!this.installatieInConfig_)return;let e=this.config,t={weer:e.weather||null,energie:e.energy||null,agendas:e.calendars,verlichting:e.lights,kiosk_gebruikers:e.kiosk_users},n=JSON.stringify(t),a=this.stand_.installatie??{},r=JSON.stringify({weer:a.weer??null,energie:a.energie??null,agendas:a.agendas??[],verlichting:(a.verlichting??[]).map(o=>o.entity),kiosk_gebruikers:this.stand_.instellingen?.kiosk_gebruikers??[]});if(!(n===r||n===this.laatstGesynct_)){this.laatstGesynct_=n;try{await Ad(this.hass,t)}catch{this.laatstGesynct_=""}}}getCardSize(){return 6}getGridOptions(){return{columns:"full",rows:"auto",min_rows:this.minRijen_(".card",6)}}blokken_(){return De.filter(e=>this.config[`show_${e.key}`]!==!1&&(!e.admin||this.rechten_.is_admin))}blokInfo_(e){return De.find(t=>t.key===e)}template(){let e=this.config;return`
      ...
      <div><button class="knop" type="button" data-actie="nieuw">${b("plus")} Verjaardag toevoegen</button></div>`}htmlPraktijk_(e={}){let t=e.openingstijden??{},n=ot.map(r=>{let o=t[r]??[],s=o.length===0,l=(d,c)=>o[d]?.[c]??"";return`<span class="dag">${Et[r]}</span>
      ...
      <div class="veld"><label>Afwijkende dagen (feestdagen, studiedagen)</label>
      ...
      </div>`}htmlIndeling_(e){let t=e?.blokken??[],n=Ze(new Date),a=t.map(s=>{let l=Xe[s.soort];if(!l)return"";let d=ja(s.soort,this.stand_,[],n);return`<div class="ib ${d?"ontbreekt":""}" data-id="${B(s.id)}" style="${this.ibStijl_(s)}" title="${B(d?`${l.naam}: ${d}`:`${l.naam} -- sleep om te verplaatsen, hoek rechtsonder om de maat te wijzigen`)}">
          <div class="ib-in">
        ...
        </div>`}).join(""),r=new Set(t.map(s=>s.soort)),o=nc.filter(s=>!r.has(s));return`<div class="hulp">Zo staat het welkomscherm op de iPad. Sleep een blok om het te verplaatsen, trek aan de hoek rechtsonder om het groter of kleiner te maken, en zet met \u2212 en + hoeveel er in een blok staat ("alle" = zoveel als er is). Een gestippeld blok staat NIET op het scherm zolang er niets in te tonen valt; de reden staat erin. Elke wijziging gaat meteen naar het scherm.</div>
      ...
      </div>`}ibStijl_(e){return`left:${(e.x/ze*100).toFixed(3)}%;top:${(e.y/$e*100).toFixed(3)}%;width:${(e.w/ze*100).toFixed(3)}%;height:${(e.h/$e*100).toFixed(3)}%`}htmlVerlichting_(e={},t={}){let a=(e.verlichting??[]).map((r,o)=>{let s=this.hass?.states?.[r.entity]?.attributes??{};return`<div class="item lamp" data-i="${o}">
      ...
      </div>`}plaatjes_(e){for(let t of e.querySelectorAll("[data-bestand]:not([data-bestand=''])"))Qt(this.hass,t.dataset.bestand).then(n=>{n&&t.isConnected&&(t.innerHTML=`<img alt="" src="${n}">`)})}markeer_(e,t,n=no){this.vuil_.add(e),this.bron_={...this.bron_??{},[e]:t},this.versie_[e]=(this.versie_[e]??0)+1,this.fouten_[e]=null,t&&(this.meldingen_[t]=null,this.tel_(t)),this.status_("Opslaan\u2026","bezig"),clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),n)}invoer_(e){let t=e.target;if(t?.dataset?.actie==="blok_toevoegen")return this.blokToevoegen_(t.value,t);let n=t?.dataset?.veld;if(!n)return;let a=t.closest(".blok")?.dataset.blok;if(!a)return;let r=this.blokInfo_(a),o=t.dataset.s||r.secties[0],s=t.dataset.i,l=this.werk_[o],d=t.type==="checkbox"?t.checked:t.value,c=t.type==="text"||t.type==="url"||t.type==="number"||t.tagName==="TEXTAREA",p=t.type==="color";if(!((c||p)&&e.type!=="input")&&!(!c&&!p&&e.type!=="change")){if(o==="personen"||o==="mededelingen"||o==="verjaardagen"){let h=l[Number(s)];if(!h)return;if(h[n]=d,n==="naam"){let u=t.closest(".item")?.querySelector(".avatar");u&&!u.querySelector("img")&&(u.textContent=Fr(d))}if(n==="aanwezig"){h._aanwezig=!0;let u=t.closest(".vink")?.querySelector(".vl");u&&(u.textContent=d?"Aanwezig":"Afwezig"),t.closest(".item")?.querySelector(".avatar")?.classList.toggle("aan",d)}}else if(o==="praktijk")this.invoerPraktijk_(l,n,s,d,t);else if(o==="scherm")if(n==="accent_kleur"){l.accent=d;let h=t.closest(".b-onder")?.querySelector('[data-veld="accent"]');h&&(h.value=d)}else if(n==="accent")l.accent=String(d).trim()||null;else if(t.type==="number"){let h=Number(d);if(!Number.isFinite(h))return;l[n]=h}else l[n]=d;else if(o==="installatie"){if(n==="l_naam"){let h=l.verlichting?.[Number(s)];h&&(h.naam=d)}}else if(o==="instellingen")if(n.startsWith("f_")){let h=l.feeds[Number(s)];h&&(h[n.slice(2)]=d)}else l[n]=d;this.markeer_(o,a,c?um:no)}}invoerPraktijk_(e,t,n,a,r){if(t==="ot_open"){e.openingstijden??={},e.openingstijden[n]=a?[["08:00","17:00"]]:[];let o=r.closest(".ot-tabel");for(let l of o.querySelectorAll(`input[type="time"][data-i="${n}"]`)){l.disabled=!a;let[,d,c]=l.dataset.veld.split("_");l.value=e.openingstijden[n][Number(d)]?.[Number(c)]??""}let s=r.closest(".vink")?.querySelector(".vl");s&&(s.textContent=a?"open":"gesloten")}else if(t.startsWith("ot_")){let[,o,s]=t.split("_").map(Number);e.openingstijden??={};let l=e.openingstijden[n]??[];for(;l.length<=o;)l.push(["",""]);l[o][s]=a,e.openingstijden[n]=l.filter((d,c)=>c===0||d[0]&&d[1]),e.openingstijden[n].length||(e.openingstijden[n]=[["",""]])}else if(t.startsWith("u_")){let o=e.uitzonderingen[Number(n)];if(!o)return;let s=t.slice(2);if(s==="open"){o.tijden=a?[["08:00","17:00"]]:[];let l=r.closest(".item");for(let c of l.querySelectorAll('input[type="time"]'))c.disabled=!a,c.value=a?c.dataset.veld==="u_van"?"08:00":"17:00":"";let d=r.closest(".vink")?.querySelector(".vl");d&&(d.textContent=a?"open":"gesloten")}else s==="van"||s==="tot"?o.tijden=[[s==="van"?a:o.tijden?.[0]?.[0]??"",s==="tot"?a:o.tijden?.[0]?.[1]??""]]:o[s]=a}else e[t]=a}blokToevoegen_(e,t){t&&(t.value="");let n=Xe[e];if(!n)return;let a=this.werk_.indeling??(this.werk_.indeling={blokken:[]});if(a.blokken.some(l=>l.soort===e))return;let[r,o]=n.maat,s=Yr(a.blokken,r,o);for(;!s&&(r>1||o>1);)o>1?o-=1:r-=1,s=Yr(a.blokken,r,o);return s?(a.blokken.push({id:`b-${Date.now().toString(36)}${Math.floor(Math.random()*1e4).toString(36)}`,soort:e,x:s.x,y:s.y,w:r,h:o,aantal:n.aantal?3:0}),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):(this.meldingen_.indeling={tekst:"Er is geen plek meer. Maak eerst een ander blok kleiner of haal er een weg.",fout:!0},this.teken_("indeling",!0))}sleepLijst_(e,t){let n=t.closest(".item"),a=n?.parentElement,r=n?.closest(".blok")?.dataset.blok;if(!n||!a||!r||e.pointerType==="mouse"&&e.button!==0)return;let o=this.blokInfo_(r).secties[0],s=this.werk_[o],l=Number(n.dataset.i);if(!Array.isArray(s)||!s[l])return;e.preventDefault(),n.classList.add("sleept");let d=p=>{let h=[...a.children].filter(m=>m!==n),u=null;for(let m of h){let k=m.getBoundingClientRect();if(p.clientY<k.top+k.height/2){u=m;break}}n.nextElementSibling!==u&&n!==u&&a.insertBefore(n,u)},c=()=>{window.removeEventListener("pointermove",d,!0),window.removeEventListener("pointerup",c,!0),window.removeEventListener("pointercancel",c,!0),n.classList.remove("sleept");let p=[...a.children].indexOf(n);if(p!==l&&p>=0){let[h]=s.splice(l,1);s.splice(p,0,h),this.markeer_(o,r)}this.teken_(r,!0)};window.addEventListener("pointermove",d,!0),window.addEventListener("pointerup",c,!0),window.addEventListener("pointercancel",c,!0),this.teardown_.push(c)}sleepStart_(e){let t=e.target.closest?.(".greep");if(t)return this.sleepLijst_(e,t);let n=e.target.closest?.(".ib");if(!n||e.target.closest("button, input, select")||e.pointerType==="mouse"&&e.button!==0)return;let a=n.closest(".raster"),r=this.werk_.indeling,o=r?.blokken?.find(w=>w.id===n.dataset.id);if(!o||!a)return;let s=e.target.closest(".ib-greep")?"maat":"plaats",l=a.getBoundingClientRect(),d=l.width/ze,c=l.height/$e,p={x:e.clientX,y:e.clientY},h={...o},u=!1;e.preventDefault();try{n.setPointerCapture(e.pointerId)}catch{}n.classList.add("sleept");let m=w=>{if(s!=="plaats")return null;let _=r.blokken.filter(M=>M.id!==w.id&&Xr(M,w));if(_.length!==1)return null;let $=_[0];return $.w===w.w&&$.h===w.h&&$.x===w.x&&$.y===w.y?$:null},k=w=>{let _=Math.round((w.clientX-p.x)/d),$=Math.round((w.clientY-p.y)/c);(_||$)&&(u=!0),h=s==="plaats"?{...o,x:Ea(o.x+_,0,ze-o.w),y:Ea(o.y+$,0,$e-o.h)}:{...o,w:Ea(o.w+_,1,ze-o.x),h:Ea(o.h+$,1,$e-o.y)},n.classList.toggle("ongeldig",!ya(r.blokken,h)&&!m(h)),n.style.cssText=this.ibStijl_(h)},x=()=>{n.removeEventListener("pointermove",k),n.removeEventListener("pointerup",x),n.removeEventListener("pointercancel",x),n.classList.remove("sleept","ongeldig");let w=h.x!==o.x||h.y!==o.y||h.w!==o.w||h.h!==o.h,_=u&&w?m(h):null;_?(Object.assign(_,{x:o.x,y:o.y}),Object.assign(o,{x:h.x,y:h.y}),this.markeer_("indeling","indeling")):u&&w&&ya(r.blokken,h)&&(Object.assign(o,h),this.markeer_("indeling","indeling")),this.teken_("indeling",!0)};n.addEventListener("pointermove",k),n.addEventListener("pointerup",x),n.addEventListener("pointercancel",x)}async klik_(e){let t=e.target.closest(".bk");if(t){let c=t.closest(".blok").dataset.blok;this.open_=this.open_===c?null:c;for(let p of this.$$(".blok"))p.classList.toggle("open",p.dataset.blok===this.open_);this.open_&&this.uitgesteld_.has(this.open_)&&this.teken_(this.open_,!0);return}let n=e.target.closest("[data-actie]");if(!n||n.disabled||n.tagName==="SELECT")return;let a=n.closest(".blok")?.dataset.blok,r=n.dataset.actie;if(r==="segment"){let c=n.closest(".segment");for(let p of c.querySelectorAll("button"))p.classList.toggle("aan",p===n),p.setAttribute("aria-checked",String(p===n));return c.value=n.dataset.waarde,this.invoer_({target:c,type:"change"})}let o=Number(n.dataset.i),l=this.blokInfo_(a)?.secties[0],d=this.werk_[l];if(r==="nieuw"){let c={personen:{naam:"",functie:"",aanwezig:!1},mededelingen:{tekst:""},verjaardagen:{naam:"",datum:"",jaar_tonen:!0}}[l];d.push(c),this.teken_(a,!0),this.$(`.blok[data-blok="${a}"] .item:last-of-type input[type="text"], .blok[data-blok="${a}"] .item:last-of-type textarea`)?.focus();return}if(r==="verwijder"){let c=d[o],p=c?.naam||c?.titel||c?.tekst||"dit item";return c&&(c.id||c.naam||c.titel||c.tekst)&&!await _e({title:"Verwijderen?",text:`"${p}" verdwijnt meteen van het scherm.`,confirmText:"Verwijderen"})?void 0:(d.splice(o,1),this.markeer_(l,a),this.teken_(a,!0))}if(r==="foto"||r==="logo"){this.doel_=r==="logo"?{sectie:"scherm",blok:a,veld:"logo"}:{sectie:l,blok:a,i:o,veld:"foto"};let c=this.$(".file");c.value="",c.click();return}if(r==="fotoweg"||r==="logoweg")return r==="logoweg"?(this.werk_.scherm.logo=null,this.markeer_("scherm",a)):(d[o].foto=null,this.markeer_(l,a)),this.teken_(a,!0);if(r==="u_nieuw")return d.uitzonderingen??=[],d.uitzonderingen.push({datum:"",tijden:[],reden:""}),this.teken_(a,!0);if(r==="u_verwijder")return d.uitzonderingen.splice(o,1),this.markeer_(l,a),this.teken_(a,!0);if(r==="f_nieuw"){let c=this.werk_.instellingen;return c.feeds??=[],c.feeds.push({naam:"",url:""}),this.teken_(a,!0)}if(r==="f_verwijder")return this.werk_.instellingen.feeds.splice(o,1),this.markeer_("instellingen",a),this.teken_(a,!0);if(r==="f_ververs"){n.disabled=!0;try{let c=await Sd(this.hass);this.feedFouten_=c.feed_fouten??{},this.meldingen_[a]={tekst:`${(c.feeds??[]).length} bericht(en) opgehaald.`}}catch(c){this.meldingen_[a]={tekst:c?.message??"Ophalen lukte niet.",fout:!0}}return this.teken_(a,!0)}if(r==="blok_weg"||r==="aantal_min"||r==="aantal_plus"){let c=this.werk_.indeling,p=c?.blokken?.find(h=>h.id===n.dataset.id);return p?(r==="blok_weg"?c.blokken=c.blokken.filter(h=>h!==p):r==="aantal_min"?p.aantal=p.aantal<=1?0:p.aantal-1:p.aantal=Math.min(50,(p.aantal||0)+1),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}if(r==="indeling_standaard")return await _e({title:"Standaardindeling?",text:"De blokken gaan terug naar hun oorspronkelijke plek en maat.",confirmText:"Terugzetten"})?(this.werk_.indeling=_a(),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}async bestandGekozen_(e){let t=e.target.files?.[0],n=this.doel_;if(this.doel_=null,!t||!n)return;let{sectie:a,blok:r,i:o,veld:s}=n;this.meldingen_[r]={tekst:"Bezig met uploaden\u2026"},this.teken_(r,!0);try{let l=await Td(this.hass,t),d=this.werk_[a],c=o===void 0?d:d[o],p=c[s];c[s]=l.id,p&&(this.oudeBestanden_=[...this.oudeBestanden_??[],p]),this.meldingen_[r]={tekst:`${l.naam||"Bestand"} ge\xFCpload.`},this.markeer_(a,r)}catch(l){this.meldingen_[r]={tekst:l?.message??"Uploaden lukte niet.",fout:!0}}this.teken_(r,!0)}payload_(e){let t=this.werk_[e];switch(e){case"personen":return(t??[]).filter(n=>n.naam?.trim()).map(({_aanwezig:n,aanwezig:a,...r})=>n?{...r,aanwezig:a}:r);case"mededelingen":return(t??[]).filter(n=>n.tekst?.trim());case"verjaardagen":return(t??[]).filter(n=>n.naam?.trim()&&n.datum);case"praktijk":return{openingstijden:Object.fromEntries(ot.map(n=>[n,(t.openingstijden?.[n]??[]).filter(a=>a[0]&&a[1])])),uitzonderingen:(t.uitzonderingen??[]).filter(n=>n.datum).map(n=>({...n,tijden:(n.tijden??[]).filter(a=>a[0]&&a[1])}))};case"instellingen":return{...t,feeds:(t.feeds??[]).filter(n=>n.url?.trim())};default:return t}}async bewaar_(e){if(!this.hass||this.bezig_.has(e))return;let t=this.versie_[e]??0;this.bezig_.add(e),this.status_("Opslaan\u2026","bezig");try{let a=(await Ed(this.hass,e,this.payload_(e)))[e];this.koppel_(e,a),this.stand_&&(this.stand_[e]=pc(a)),this.fouten_[e]=null,(this.versie_[e]??0)===t&&this.vuil_.delete(e);let r=new Date;this.laatstOpgeslagen_=`${String(r.getHours()).padStart(2,"0")}:${String(r.getMinutes()).padStart(2,"0")}`;for(let o of this.oudeBestanden_??[])this.inGebruik_(o)||(Md(this.hass,o).catch(()=>{}),Od(o));this.oudeBestanden_=[]}catch(n){this.fouten_[e]=n?.message??"Opslaan lukte niet."}finally{this.bezig_.delete(e)}this.vuil_.has(e)&&(this.versie_[e]??0)!==t&&!this.fouten_[e]&&(clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),no));for(let n of De)n.secties.includes(e)&&this.tel_(n.key);if(!this.fouten_[e])for(let n of De)n.secties.includes(e)&&n.key!==this.bron_?.[e]&&this.teken_(n.key);if(this.fouten_[e]){this.status_(`Niet opgeslagen: ${this.fouten_[e]}`,"fout");for(let n of De)n.secties.includes(e)&&this.teken_(n.key)}else!this.bezig_.size&&!this.vuil_.size&&this.status_(`Opgeslagen ${this.laatstOpgeslagen_}`,"ok")}koppel_(e,t){let n=this.werk_[e];if(!Array.isArray(n)||!Array.isArray(t))return;let a={personen:o=>o.naam?.trim(),mededelingen:o=>o.tekst?.trim(),verjaardagen:o=>o.naam?.trim()&&o.datum}[e];if(!a)return;let r=0;n.forEach((o,s)=>{if(!a(o))return;let l=t[r];if(r+=1,!l)return;o.id=l.id,e==="personen"&&(o.initialen=l.initialen,o._aanwezig&&delete o._aanwezig);let d=this.$(`.blok[data-blok="${e}"] .item[data-i="${s}"]`);d&&(d.dataset.id=l.id)})}inGebruik_(e){let t=this.stand_??{};return t.scherm?.logo===e||(t.personen??[]).some(n=>n.foto===e)||(this.werk_.personen??[]).some(n=>n.foto===e)||this.werk_.scherm?.logo===e}};j(At,"css",hm);var mm={title:"Titel",weather:"Weerentiteit",energy:"Energiesensor (vermogen of tellerstand)",lights:"Lampen en schakelaars op het scherm",calendars:"Agenda's (de afspraken van vandaag)",kiosk_users:"Kioskaccounts",show_personen:"Blok Medewerkers",show_mededelingen:"Blok Mededelingen",show_verjaardagen:"Blok Verjaardagen",show_praktijk:"Blok Openingstijden",show_indeling:"Blok Indeling",show_verlichting:"Blok Verlichting",show_instellingen:"Blok Instellingen en logo",open:"Staat open bij het laden"},gm={weather:"Leeg = geen weer op het scherm.",energy:"Het blok Energie: een vermogenssensor (W of kW) geeft een live lijn van de afgelopen 24 uur; een tellerstand (kWh) het verbruik per uur. Leeg = geen energie op het scherm.",lights:"De namen zoals ze op het scherm staan geeft de receptie hieronder in het blok Verlichting; daar staat ook de schakelaar om ze te tonen.",kiosk_users:"Het account waarmee de iPad is ingelogd. Zo'n account mag alleen aanwezigheid omzetten en lampen schakelen, en niets beheren. Alleen een beheerder ziet deze lijst.",show_instellingen:"Logo, accent, uiterlijk, het welkomblok en de nieuwsbronnen. Zet dit blok uit op een dashboard voor een receptie die daar niet aan hoeft te zitten."},ao=class extends H{defaults(){return{...mc}}setConfig(e){this.ruwLeeg_=!uc.some(t=>e?.[t]!==void 0),super.setConfig(e),this.zaai_()}set hass(e){super.hass=e,this.gebruikers_===void 0&&e?.connection&&e.user?.is_admin&&(this.gebruikers_=null,Nd(e).then(t=>{this.gebruikers_=(t.gebruikers??[]).map(n=>({value:n.id,label:`${n.naam}${n.is_admin?" (beheerder)":""}`})),this.sync_()}).catch(()=>{this.gebruikers_=[]})),this.zaad_===void 0&&e?.connection&&(this.zaad_=null,Yt(e).then(t=>{let n=t.stand?.installatie??{};this.zaad_={weather:n.weer??"",energy:n.energie??"",lights:(n.verlichting??[]).map(a=>a.entity),calendars:n.agendas??[],kiosk_users:t.stand?.instellingen?.kiosk_gebruikers??[]},this.zaai_()}).catch(()=>{this.zaad_={}}))}get hass(){return super.hass}zaai_(){!this.zaad_||!this.ruwLeeg_||this.gezaaid_||(this.gezaaid_=!0,this.config_={...this.config_,...this.zaad_},this.sync_())}schema(){let e=[{name:"weather",selector:f.entity("weather")},{name:"energy",selector:f.entity("sensor")},{name:"lights",selector:{entity:{multiple:!0,domain:["light","switch"]}}},{name:"calendars",selector:{entity:{multiple:!0,domain:"calendar"}}}];return this.gebruikers_?.length&&e.push({name:"kiosk_users",selector:{select:{multiple:!0,mode:"list",options:this.gebruikers_}}}),[...e,{name:"title",selector:f.text()},{name:"open",selector:f.select([...De.map(t=>({value:t.key,label:t.titel})),{value:"geen",label:"Alles dicht"}])},...De.map(t=>({name:`show_${t.key}`,selector:f.bool()}))]}label(e){return mm[e.name]??super.label(e)}helper(e){return gm[e.name]}};O(io,At,{name:"DomotiApp Infoscherm Beheer",description:"Voor de receptie: medewerkers, mededelingen, verjaardagen, openingstijden, de indeling van het scherm en het logo. Alles wordt vanzelf opgeslagen en staat meteen op het scherm. De installateur kiest hier ook het weer, de energiesensor, de lampen, de agenda's en het kioskaccount.",preview:!1});V(`${io}-editor`,ao);At.getConfigElement=()=>document.createElement(`${io}-editor`);At.getStubConfig=()=>({title:"Infoscherm"});var Aa=globalThis,Ma=Aa.ShadowRoot&&(Aa.ShadyCSS===void 0||Aa.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ro=Symbol(),gc=new WeakMap,rn=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==ro)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ma&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=gc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&gc.set(t,e))}return e}toString(){return this.cssText}},Le=i=>new rn(typeof i=="string"?i:i+"",void 0,ro),oe=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new rn(t,i,ro)},fc=(i,e)=>{if(Ma)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=Aa.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},oo=Ma?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return Le(t)})(i):i;var{is:fm,defineProperty:bm,getOwnPropertyDescriptor:vm,getOwnPropertyNames:km,getOwnPropertySymbols:xm,getPrototypeOf:wm}=Object,Sa=globalThis,bc=Sa.trustedTypes,_m=bc?bc.emptyScript:"",ym=Sa.reactiveElementPolyfillSupport,on=(i,e)=>i,so={toAttribute(i,e){switch(e){case Boolean:i=i?_m:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},kc=(i,e)=>!fm(i,e),vc={attribute:!0,type:String,converter:so,reflect:!1,useDefault:!1,hasChanged:kc};Symbol.metadata??=Symbol("metadata"),Sa.litPropertyMetadata??=new WeakMap;var Ce=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=vc){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&bm(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=vm(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??vc}static _$Ei(){if(this.hasOwnProperty(on("elementProperties")))return;let e=wm(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(on("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(on("properties"))){let t=this.properties,n=[...km(t),...xm(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(oo(a))}else e!==void 0&&t.push(oo(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return fc(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:so).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:so;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??kc)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};Ce.elementStyles=[],Ce.shadowRootOptions={mode:"open"},Ce[on("elementProperties")]=new Map,Ce[on("finalized")]=new Map,ym?.({ReactiveElement:Ce}),(Sa.reactiveElementVersions??=[]).push("2.1.2");var go=globalThis,xc=i=>i,Na=go.trustedTypes,wc=Na?Na.createPolicy("lit-html",{createHTML:i=>i}):void 0,Ec="$lit$",Ye=`lit$${Math.random().toFixed(9).slice(2)}$`,Ac="?"+Ye,jm=`<${Ac}>`,dt=document,ln=()=>dt.createComment(""),dn=i=>i===null||typeof i!="object"&&typeof i!="function",fo=Array.isArray,zm=i=>fo(i)||typeof i?.[Symbol.iterator]=="function",lo=`[ 	
\f\r]`,sn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_c=/-->/g,yc=/>/g,st=RegExp(`>|${lo}(?:([^\\s"'>=/]+)(${lo}*=${lo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),jc=/'/g,zc=/"/g,Mc=/^(?:script|style|textarea|title)$/i,bo=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),z=bo(1),aw=bo(2),iw=bo(3),ct=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),$c=new WeakMap,lt=dt.createTreeWalker(dt,129);function Sc(i,e){if(!fo(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return wc!==void 0?wc.createHTML(e):e}var $m=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=sn;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===sn?c[1]==="!--"?o=_c:c[1]!==void 0?o=yc:c[2]!==void 0?(Mc.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=st):c[3]!==void 0&&(o=st):o===st?c[0]===">"?(o=a??sn,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?st:c[3]==='"'?zc:jc):o===zc||o===jc?o=st:o===_c||o===yc?o=sn:(o=st,a=void 0);let u=o===st&&i[s+1].startsWith("/>")?" ":"";r+=o===sn?l+jm:p>=0?(n.push(d),l.slice(0,p)+Ec+l.slice(p)+Ye+u):l+Ye+(p===-2?s:u)}return[Sc(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},cn=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=$m(e,t);if(this.el=i.createElement(d,n),lt.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=lt.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(Ec)){let h=c[o++],u=a.getAttribute(p).split(Ye),m=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:m[2],strings:u,ctor:m[1]==="."?po:m[1]==="?"?ho:m[1]==="@"?uo:St}),a.removeAttribute(p)}else p.startsWith(Ye)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(Mc.test(a.tagName)){let p=a.textContent.split(Ye),h=p.length-1;if(h>0){a.textContent=Na?Na.emptyScript:"";for(let u=0;u<h;u++)a.append(p[u],ln()),lt.nextNode(),l.push({type:2,index:++r});a.append(p[h],ln())}}}else if(a.nodeType===8)if(a.data===Ac)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(Ye,p+1))!==-1;)l.push({type:7,index:r}),p+=Ye.length-1}r++}}static createElement(e,t){let n=dt.createElement("template");return n.innerHTML=e,n}};function Mt(i,e,t=i,n){if(e===ct)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=dn(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Mt(i,a._$AS(i,e.values),a,n)),e}var co=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??dt).importNode(t,!0);lt.currentNode=a;let r=lt.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new pn(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new mo(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=lt.nextNode(),o++)}return lt.currentNode=dt,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},pn=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Mt(this,e,t),dn(e)?e===E||e==null||e===""?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==ct&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):zm(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&dn(this._$AH)?this._$AA.nextSibling.data=e:this.T(dt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=cn.createElement(Sc(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new co(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=$c.get(e.strings);return t===void 0&&$c.set(e.strings,t=new cn(e)),t}k(e){fo(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(ln()),this.O(ln()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=xc(e).nextSibling;xc(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},St=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=E}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Mt(this,e,t,0),o=!dn(e)||e!==this._$AH&&e!==ct,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Mt(this,s[n+l],t,l),d===ct&&(d=this._$AH[l]),o||=!dn(d)||d!==this._$AH[l],d===E?e=E:e!==E&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},po=class extends St{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}},ho=class extends St{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}},uo=class extends St{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Mt(this,e,t,0)??E)===ct)return;let n=this._$AH,a=e===E&&n!==E||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==E&&(n===E||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},mo=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Mt(this,e)}};var Em=go.litHtmlPolyfillSupport;Em?.(cn,pn),(go.litHtmlVersions??=[]).push("3.3.3");var Nc=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new pn(e.insertBefore(ln(),r),r,void 0,t??{})}return a._$AI(i),a};var vo=globalThis,te=class extends Ce{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Nc(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ct}};te._$litElement$=!0,te.finalized=!0,vo.litElementHydrateSupport?.({LitElement:te});var Am=vo.litElementPolyfillSupport;Am?.({LitElement:te});(vo.litElementVersions??=[]).push("4.2.2");var ge=oe`
  :host {
    ${Le(W)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${Le(Re)}
`;var Mm=["unavailable","unknown"],Sm=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Ta({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||Mm.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of Sm)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Oa(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var xo=["hs","rgb","rgbw","rgbww","xy"],wo="color_temp",Nm="onoff";var pt="kleur";var Tm=["unavailable","unknown"],Oc=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Om=[0,100];function Ee(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Nm,a=t!==null&&t.includes(wo),r=t!==null&&t.some(d=>xo.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Tm.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function Dm(){return{state:"off"}}function Dc(i,e){let t=e??Ee(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...Vm(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function Lc(i,e,t,n){return e?i&&i.state==="on"?{...i}:Dc(t,n):{state:"off"}}function Cc(i,e,t,n){let a=n??Ee(t),r=Eo(i,t,a);return a.helderheid&&(r.brightness=G(e,1,255)),r}function _o(i,e,t,n){let a=n??Ee(t),r=Eo(i,t,a);return Uc(r),r.color_temp_kelvin=G(e,a.minKelvin,a.maxKelvin),r}function yo(i,e,t,n){let a=n??Ee(t),r=Eo(i,t,a);return Uc(r),r.hs_color=[G(e?.[0],0,360),G(e?.[1],0,100)],r}function Da(i,e,t){return i??Dm()}function Rc(i,e,t){let n=Da(i,e,t);if(typeof n.brightness=="number")return G(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?G(a,1,255):255}function jo(i,e,t){let n=t??Ee(e),a=Da(i,e,n);if(typeof a.color_temp_kelvin=="number")return G(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?G(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function La(i,e,t){let n=Da(i,e,t);if(ko(n.hs_color))return[G(n.hs_color[0],0,360),G(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return ko(a)?[G(a[0],0,360),G(a[1],0,100)]:[...Om]}function zo(i){return i!=null&&typeof i=="object"}function Hc(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!zo(a[s]?.lights?.[o]))return!0;return!1})}function Ic(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function $o(i,e,t){return Da(i,e,t).state==="on"}function Vc(i,e,t){let n=t??Ee(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=$o(i,e,n),r=Bc(n),o=r?Lm(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===pt),kleurkeuze:a&&r,stand:a?o:null}}function Bc(i){return!!(i?.kleurtemp&&i?.kleur)}function Lm(i,e,t){let n=t??Ee(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(Oc.slice(1).some(r=>i[r]!==void 0))return pt}let a=e?.attributes?.color_mode;return a===wo&&n.kleurtemp?"wit":xo.includes(a)&&n.kleur?pt:"wit"}function Pc(i,e,t,n){let a=n??Ee(t);return Bc(a)?e==="wit"?_o(i,jo(i,t,a),t,a):yo(i,La(i,t,a),t,a):i}function Kc(i){let e=G(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Gc(i){let e=G(i,1,100);return G(Math.round(e/100*255),1,255)}var Cm=1e3,Rm=4e4,Tc=7;function Hm(i){let e=G(i,Cm,Rm)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[G(t,0,255),G(n,0,255),G(a,0,255)]}function Im(i){let[e,t,n]=Hm(i);return`rgb(${e}, ${t}, ${n})`}function Wc(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:Tc},(r,o)=>{let s=o/(Tc-1),l=t+(n-t)*s;return`${Im(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Vm(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?G(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===wo&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=G(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&xo.includes(a)&&ko(t.hs_color)&&(n.hs_color=[G(t.hs_color[0],0,360),G(t.hs_color[1],0,100)]),n}function Eo(i,e,t){return i&&i.state==="on"?{...i}:Dc(e,t)}function Uc(i){for(let e of Oc)delete i[e]}function ko(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function G(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Ca="domotiapp-scene-card",Ao="domotiapp-scene-card-editor",Fc="domotiapp-scene-editor";var hn=["een","twee","drie"],qc="pencil",Zc=["grid_options","layout_options","view_layout","visibility"];var Xc="entity_id",Nt=class extends te{constructor(){super();j(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));j(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Xc]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Xc];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},a={...this._config,entity:n.entity};n.bare?a.bare=!0:delete a.bare,a.entity!==this._config?.entity&&(delete a.name_overrides,this._getypt={}),this._stuurDoor(a)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return E;let t=this._leden();return z`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?z`
          ...
          `:E}
    `}};j(Nt,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),j(Nt,"styles",[ge,oe`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===So?z`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Qc?z`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=$o(a,t,n),o=Vc(a,t,n);return z`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${zo(a)?E:z`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?z`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,Lc(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:E}
        </div>
    ...
    `}_renderHelderheid(e,t,n,a){let r=Kc(Rc(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,Cc(this._waardeVan(e),Gc(s.detail.value),t,n))};return z`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Pc(this._waardeVan(e),s,t,n))};return z`
      <div class="kleurkeuze">
        <button
          class="keuze ${r===pt?"actief":""}"
          aria-pressed=${r===pt?"true":"false"}
          @click=${o(pt)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,a){let r=jo(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,_o(this._waardeVan(e),s.detail.value,t,n))};return z`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Wc(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=La(a,t,n),s=l=>d=>{d.stopPropagation();let c=La(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,yo(this._waardeVan(e),p,t,n))};return z`
      <div class="besturing">
        <div class="label">
    ...
    `}};j(Tt,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),j(Tt,"styles",[ge,oe`
    ...
    `]);var Um="0.41.0",Fm=["type","entity","name_overrides","bare"],Ia="laden",un="klaar",To="leeg",Oo="geen-groep",Jc="opslagfout",ep="fout",mn=class extends te{constructor(){super();j(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=Ia,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new le(()=>this._haalScenesOp()),this._verbinding=new we}static getConfigElement(){return document.createElement(Ao)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(a=>a.startsWith("light.")&&Array.isArray(t.states[a].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?I(t):null),L(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(a=>!Fm.includes(a)&&!Zc.includes(a));n.length&&console.warn(`${Ca}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:mt(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===Oo){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=Ia,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?To:un,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let a=t?.code;if(this._melding=t?.message??String(t),pe(t)&&this._herkansing.plan()){this._toestand=Ia;return}if(a==="home_assistant_error"){this._toestand=Jc;return}if(!this.hass.states[n]){this._toestand=Oo;return}this._toestand=ep}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==un)return;let{oproepen:n}=Ta({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let a=await Oa((r,o)=>this.hass.callService("light",r,o),n);a.length&&this._meldMislukking(a.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),a=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:a},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===un&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?To:un}render(){if(!this._config)return E;switch(this._toestand){case Oo:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Jc:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case ep:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,a=!1){return z`
      <div class="needs">
    ...
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=b(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===To,n=this._toestand===Ia,a=this._iconen();return z`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${a.map((r,o)=>z`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==un)return E;let t=Hc(this._scenes,this._leden,3).length,n=Ic(t);return n?z`<div class="mededeling">${n}</div>`:E}_renderEditor(){return z`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||hn[n])}};j(mn,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),j(mn,"styles",[ge,oe`
      :host { display: block; }
    ...
    `]);C(Ca,mn);C(Ao,Nt);C(Fc,Tt);gt({type:Ca,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Um}).`,preview:!1});var ht="domotiapp-alarm-card",Do="domotiapp-alarm-card-editor",tp="domotiapp-alarm-editor",np="DomotiApp Wekker",ap="https://github.com/Sven2410/domotiapp-lovelace",Ae="domotiapp_lovelace",he=Object.freeze({get:`${Ae}/alarms/get`,save:`${Ae}/alarms/save`,setEnabled:`${Ae}/alarms/set_enabled`,delete:`${Ae}/alarms/delete`,stop:`${Ae}/alarms/stop`,clearMessage:`${Ae}/alarms/clear_message`,search:`${Ae}/sound/search`,entities:`${Ae}/entities/list`,previewStart:`${Ae}/preview/start`,subscribe:`${Ae}/updates/subscribe`}),Va="#026FA1";function ip(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var qm="07:00";var Zm=["uri","name","media_type","image"],Xm="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Ym="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Qm="Music Assistant Wekker",Jm="Verlichting Wekker";function Ba(){return{id:null,name:"",time:qm,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function rp(i){let e=Ba();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:Lo(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:gn(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function gn(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Zm)e[t]=i[t]===void 0?null:i[t];return e}function Lo(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Co(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),Lo(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function op(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:gn(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function sp(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function lp(i){return Lo(i)&&i.slice(0,2)==="02"?Xm:null}function dp(i){return i===!1?Ym:null}function cp(i){return typeof i?.endless=="boolean"?i.endless:null}function Pa(i,e){let t=e==="lamp",n=t?Jm:Qm,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function pp(i,e){return Pa(e,"speaker")!==null?!1:Co(i).ok}var tg=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],ng=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],fn="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",ag="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",ig="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Ot=class extends te{constructor(){super(),this._concept=Ba(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?rp(this.wekker):Ba(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:he.previewStart,speaker:this._concept.speaker,sound:gn(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:he.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:gn(e),endless:cp(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Co(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:he.save,person:this.person,alarm:op(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return z`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return E;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Pa(t,"speaker"),r=Pa(n,"lamp"),o=lp(e.time),s=dp(e.endless),l=pp(e,t);return z`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${tg.map(([d,c])=>z`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:sp(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${ng.map(([d,c])=>z`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
    ...
    `}};j(Ot,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),j(Ot,"styles",[ge,oe`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${Le(Va)});
      display: block;
  ...
  `]);var hp="person",rg="Kies een persoon in de kaartinstellingen.",up="De gekozen persoon is niet gevonden.",og="De opgeslagen wekkers van deze persoon zijn onleesbaar.",i1=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function mp(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${hp}.`))throw new Error(`'${e}' zit niet in het domein ${hp}. Kies een persoon, zoals person.sven.`);return{...i}}function gp(i){return{type:`custom:${i}`}}function fp(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:up,isFout:!0}:{soort:"ontbreekt",tekst:rg,isFout:!1}}function bp(i,e){return i==="not_found"?up:i==="home_assistant_error"?og:e||"Er ging iets mis bij het ophalen van de wekkers."}var sg=["ma","di","wo","do","vr","za","zo"],lg="Geen wekkers ingesteld",dg="Eenmalig",cg="Eenmalig \u2014 afgelopen",pg="Geen wekker actief",vp="Stoppen",hg="Er is een melding over deze wekker, maar de tekst ontbreekt.";function ug(i){return!Array.isArray(i)||i.length===0?dg:[...new Set(i)].sort((t,n)=>t-n).map(t=>sg[t-1]??"?").join(" ")}function mg(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function kp(i,e){return mg(i,e)?cg:ug(i?.days)}function xp(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:hg,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function wp(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return lg;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:pg}function _p(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var gg="0.41.0",fg="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",bg="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",yp="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",vg="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Ka=(i,e="icoon")=>z`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,bn=class extends te{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null,this._herkansing=new le(()=>this._haalOp()),this._verbinding=new we}setConfig(e){let t=mp(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(Do)}static getStubConfig(){return gp(ht)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:mt(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&(this._startAbonnement(),this._verbinding.herverbonden(this.hass)&&(this._herkansing.herstel(),this._haalOp())),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?I(e):null),L(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:he.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${ht}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${ht}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:he.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null,this._herkansing.herstel()}catch(t){if(this._config?.person!==e||pe(t)&&this._herkansing.plan())return;this._toestand=null,this._fout=bp(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:he.entities})}catch(t){this._entiteiten=null,console.warn(`${ht}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:he.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:he.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:he.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:he.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?_p(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return E;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=fp(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?z`<div class="card surface">
    ...
    `}_bevestiging(e){return z`<div class="onderrij bevestiging">
      <span class="boodschap">${ip(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=xp(e),a=!!e.enabled;return z`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?z`<div class="onderrij ${n.isFout?"fout":""}">
            ${Ka(n.isFout?vg:yp,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:E}
    `}};j(bn,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),j(bn,"styles",[ge,oe`
  ...
  `]);var Dt=class Dt extends te{constructor(){super(...arguments);j(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?E:z`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};j(Dt,"properties",{hass:{attribute:!1},_config:{state:!0}}),j(Dt,"styles",[ge,oe`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),j(Dt,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Ro=Dt;C(ht,bn);C(Do,Ro);C(tp,Ot);gt({type:ht,name:np,description:`Wekkerkaart van DomotiApp (v${gg}).`,preview:!1,documentationURL:ap});var kg=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function jp(i){return`/api/image/serve/${i}/original`}function zp(i){return i?kg.includes(i.type)?i.size>12582912?`Deze afbeelding is ${Math.round(i.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var xg=`
...
`,Ho=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=Z(xg)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let a=document.createElement("img");a.src=this.value,a.alt="",a.onerror=()=>{n.dataset.bron="",n.innerHTML=b("car")},n.replaceChildren(a)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=b("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=zp(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let a=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:a?{Authorization:`Bearer ${a}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(jp(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};C("dac-foto-picker",Ho);var wg="/api/domotiapp_lovelace/loader.js",$p="domotiapp-lovelace-verversing";function Ep(i){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(i??""));return e?e[1].toLowerCase():null}async function _g(i){try{let e=await i(wg,{cache:"no-store"});return e?.ok?Ep(await e.text()):null}catch{return null}}function yg(){try{return globalThis.sessionStorage?.getItem($p)??null}catch{return null}}function jg(i){try{globalThis.sessionStorage?.setItem($p,i)}catch{return!1}return!0}function zg(i,e,t){return!i||!e?"onbekend":i===e?"actueel":t===e?"al-geprobeerd":"herladen"}function Ap({eigenUrl:i,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:a=18e5,klok:r=setInterval}={}){let o=Ep(i);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await _g(e);if(zg(o,p,yg())!=="herladen"||!jg(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,a);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var $g="0.41.0";es(i=>console.warn(`domotiapp-lovelace: ${i}`));Ap({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${$g} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{$g as VERSION};
