var yl=Object.defineProperty;var zl=(a,e,t)=>e in a?yl(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var y=(a,e,t)=>zl(a,typeof e!="symbol"?e+"":e,t);var K=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function F(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var Pn=null,or=a=>{Pn=a},ue=a=>String(a??"").split(".")[0],b=(a,e)=>e&&a?.states?.[e]||null,Q=(a,e)=>b(a,e)?.attributes??{},Ct=(a,e,t)=>t?null:Q(a,e).entity_picture||null;function sr(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function E(a,e,t){return t||Q(a,e).friendly_name||e||""}var jl=new Set(["scene","script","input_button","button","event"]),Vn=a=>jl.has(ue(a));function ee(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!Vn(a.entity_id):!1}function te(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(ue(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var $l=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),lr=a=>$l.has(ue(a));function dr(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function Tt(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var R=(a,e)=>Tt(a,"hass-more-info",{entityId:e});function at(a){switch(ue(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function El(a){switch(ue(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function me(a,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let i=n.confirmation===!0?{}:n.confirmation;if(!Pn){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}Pn(i).then(r=>{r&&ar(a,e,t,n)});return}ar(a,e,t,n)}}function ar(a,e,t,n){switch(n.action){case"more-info":R(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=El(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),Tt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":Tt(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":Tt(a,"ll-custom",n);break;default:break}}function V(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return a.addEventListener("pointerdown",d),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),a.removeEventListener("pointerdown",d),a.removeEventListener("click",c)}}function J(a,e){if(!e)return"";let t=ue(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function W(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var ir=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],cr=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],rr=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),Bn=(a,e)=>Math.round((rr(e)-rr(a))/864e5);function it(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Kn(a,e=new Date){if(!a)return"";let t=Bn(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?ir[a.getDay()]:`${ir[a.getDay()].slice(0,2)} ${a.getDate()} ${cr[a.getMonth()]}`}var pr=a=>a?`${a.getDate()} ${cr[a.getMonth()]}`:"";function Al(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function Ml(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function C(a,e=4){if(!a)return;let t=Ml(a);if(!t){e>0&&requestAnimationFrame(()=>C(a,e-1));return}let n=`${Ol(a,Al(t))}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}var Gn=new WeakMap,Sl=12,Nl=3;function Ol(a,e){let t=Gn.get(a)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-Sl),i=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(i.length===2&&r>=Nl){let s=Math.max(...i);return Gn.set(a,{rij:n,vast:{paar:i,waarde:s}}),s}return Gn.set(a,{rij:n,vast:null}),e}function Be(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function I(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);C(a)});e.observe(a);for(let t of a.children)e.observe(t);return C(a),()=>e.disconnect()}var Tl="home-assistant";function hr({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:i=()=>Date.now(),marker:r=Tl,intervalMs:o=20,maxWachtMs:s=1e4}){let l=i();function d(){let h=a();if(!h)return!1;for(let[g,m]of e)try{h.get(g)||h.define(g,m)}catch(k){t(`kon ${g} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=a();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(i()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var ur=[];function O(a,e){ur.push([a,e])}function Ke({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function mr(a=()=>{}){hr({leesRegistry:()=>globalThis.customElements,definities:ur,waarschuw:a})}var Cl=`
  :host {
    ${K}
    display: block;
...
`,$={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},fr={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},q=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),G=(a,e="accent")=>$[a]??(a&&/[#(]|^var/.test(a)?a:$[e]),T=Symbol("incomplete"),Ll=a=>`
  <div class="needs">
  ...
  </div>`,Dl=56,gr=8,ge=a=>Math.max(1,Math.ceil((a+gr)/(Dl+gr))),M=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[F(Cl+xe+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let i=n.target;!i?.matches||i.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||i.isConnected&&i.matches(":focus-visible")&&i.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[T]||dr(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[T]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[T];if(e.innerHTML=t?Ll(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(I(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,i){e&&(e.addEventListener(t,n,i),this.teardown_.push(()=>e.removeEventListener(t,n,i)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return Be(this.$(e))??t}};y(M,"css","");function N(a,e,{name:t,description:n,preview:i=!0}={}){O(a,e),Ke({type:a,name:t,description:n,preview:i})}function H(a,e){O(a,e)}var u=(a,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${a}</svg>`,A={house:u(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`;var Bt=a=>String(a??"").split(".")[0],jr=new Set(["input_datetime","time","date","datetime"]),$r=a=>jr.has(Bt(a)),de=a=>String(a).padStart(2,"0");function td(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function la(a){if(!a)return null;let e=Bt(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:td(a.state)}var nd=a=>`${a.getFullYear()}-${de(a.getMonth()+1)}-${de(a.getDate())}T${de(a.getHours())}:${de(a.getMinutes())}`;function ad(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${de(Math.floor(n/60))}:${de(n%60)}`}function Er(a,e=la(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${de(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(Bt(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":nd(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${de(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Ar(a,e,t){let n=Bt(a),i=String(t??"");if(!i||!jr.has(n)||!e)return null;if(e==="time"){let h=i.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let g=`${de(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:g}]:["input_datetime","set_datetime",{entity_id:a,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${de(d)}:${c}:00`;if(n==="datetime"){let h=ad(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${l} ${p}`}]}var Mr=a=>String(a??"").split(".")[0],Sr=new Set(["input_select","select"]),da=a=>Sr.has(Mr(a));function Se(a){if(!a||!da(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function Kt(a,e=Se(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function Gt(a,e,t=[]){let n=Mr(a),i=String(e??"");return!i||!Sr.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var Nr={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},id=/^.*program(?:me)?[_.\- ]/i,rd=30,od=95;function sd(a){return String(a??"").replace(id,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function ld(a){let e=sd(a);if(!e.length)return"";let t=[];for(let i=0;i<e.length;i++){let r=e[i],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=rd&&d<=od?`${d} \xB0C`:o);continue}let s=e[i+1]?.toLowerCase(),l=s?Nr[o+s]:void 0;if(l){t.push(l),i++;continue}t.push(Nr[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function dd(a,e){let t=i=>String(i??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(a)}function Ut(a,e){return dd(a,e)?String(e):ld(a)||String(a??"")}var qt={row:44,tile:96,compact:44,beeld:120},ze=6,Or=12,ca=22,cd=["row","tile","compact","beeld"],pd=["links","midden"],pa=48,ha=320,Wt=120,ce=a=>{if(a==null||a==="")return Wt;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(ha,Math.max(pa,e)):Wt},ot=a=>pd.includes(a)?a:"links";function Tr(a,e){let t=Array.isArray(a)?a:[],n=Array.from({length:e},(i,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var hd=["card","items","none","open"],Ft=a=>typeof a?.name=="string"?a.name.trim():"",st=a=>typeof a=="string"?{entity:a}:{...a},lt=a=>Math.min(Math.max(1,Number(a)||2),3),Ge=a=>cd.includes(a)?a:"row",ie=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function Cr(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(n=>{let i=lt(n.columns);return{columns:i,layout:Ge(n.layout),align:ot(n.align),image_size:ce(n.image_size),column_names:Tr(n.column_names,i),items:(n.items??n.entities??[]).map(st)}});let e=(a?.items??a?.entities??[]).map(st);if(!e.length)return[];let t=lt(a.columns);return[{columns:t,layout:Ge(a.layout),align:ot(a.align),image_size:ce(a.image_size),column_names:Tr(a.column_names,t),items:e}]}function Zt(a){return hd.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var ud=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns)),md=22;function gd(a){let e=Ge(a?.layout);return e!=="beeld"?qt[e]:ce(a?.image_size)+34}function ua(a){let e=a?.rows??[],t=Ft(a)?ca+ze:0;if(!e.length)return Or+t+qt.row;let n=(Zt(a)==="card"?Or:0)+t;for(let i of e){let r=ud(i);n+=r*gd(i)+(r-1)*ze,i.column_names?.length&&(n+=md+ze)}return n+(e.length-1)*ze}function dt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();ie(e)&&a.bewaard.push(e)}return a}function Lr(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:lt(n.columns),layout:Ge(n.layout),align:ot(n.align),image_size:ce(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(st)})):(()=>{let n=(a.items??a.entities??[]).map(st);return n.length?[{columns:lt(a.columns),layout:Ge(a.layout),align:ot(a.align),image_size:ce(a.image_size),column_names:Array.isArray(a.column_names)?[...a.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]),i.forEach((r,o)=>t.push(dt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var ma=a=>a.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Wt?{image_size:ce(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ie).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function ga(a,e,t){let n=new Set;for(let i of a){let r=/^r(\d+)(?:i(\d+))?$/.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:i);continue}n.add(o>e?`r${o+1}${s}`:i)}return n}var Dr=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],fd=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],bd=a=>Dr.find(e=>e.waarde===a)?.label??"Rij",vd=`
...
`,fa=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Lr(e);this.gebouwd_&&JSON.stringify(ma(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=ga(this.open_,e,"weg")}rijErbij_(e){this.open_=ga(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{ie(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=vd;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=dt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return i?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(S=>({waarde:S,label:String(S),titel:`${S} entiteit${S>1?"en":""} in deze rij`})),()=>e.columns,S=>{e.columns=S,dt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let g=this.segment_(Dr.map(S=>({waarde:S.waarde,label:S.label})),()=>e.layout,S=>{e.layout=S,ke(),this.emit_()}),m=document.createElement("div");m.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",m.append(k,g.wrap),h.appendChild(m);let x=this.segment_(fd.map(S=>({waarde:S.waarde,label:S.label})),()=>e.align??"links",S=>{e.align=S,this.emit_()}),z=document.createElement("div");z.className="vormrij";let _=document.createElement("b");_.textContent="Uitlijning",z.append(_,x.wrap),h.appendChild(z);let D=document.createElement("div");D.className="beeldvak";let U=document.createElement("ha-form");U.hass=this.hass_,U.schema=[{name:"image_size",selector:{number:{min:pa,max:ha,step:4,mode:"slider"}}}],U.computeLabel=()=>"Grootte van de afbeelding",U.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",U.data={image_size:ce(e.image_size)},U.addEventListener("value-changed",S=>{S.stopPropagation(),e.image_size=ce(S.detail.value?.image_size),this.emit_()}),D.appendChild(U),h.appendChild(D);let ke=()=>{let S=e.layout==="beeld";D.style.display=S?"":"none",z.style.display=S?"none":""};ke();let nt=document.createElement("div");nt.className="kolomvak";let se=document.createElement("ha-form");se.hass=this.hass_;let Ji=()=>Array.from({length:e.columns},(S,ae)=>({name:`k${ae}`,selector:{text:{}}}));se.schema=Ji(),se.computeLabel=S=>`Kop boven kolom ${Number(S.name.slice(1))+1}`,se.computeHelper=S=>S.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let er=()=>Object.fromEntries(Array.from({length:e.columns},(S,ae)=>[`k${ae}`,e.column_names?.[ae]??""]));se.data=er(),se.addEventListener("value-changed",S=>{S.stopPropagation();let ae=S.detail.value??{};e.column_names=Array.from({length:e.columns},(nr,wl)=>ae[`k${wl}`]??""),this.emit_()}),nt.appendChild(se),h.appendChild(nt);let tr=()=>{let S=e.items.filter(ie),ae=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&ae.push(bd(e.layout)),ae.push(S.length?S.map(nr=>this.itemNaam_(nr)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&ae.push("met kolomkoppen"),l.textContent=ae.join(" \xB7 "),d.vernieuw(),g.vernieuw(),x.vernieuw(),ke(),se.schema.length!==e.columns&&(se.schema=Ji()),se.data=er()};return this.koppen_.push(tr),e.items.forEach((S,ae)=>h.appendChild(this.itemBlok_(e,S,t,ae))),n.append(i,h),tr(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(i+1),l.title=`Plek ${i+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(i,1),this.itemWeg_(n,i),dt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let g=document.createElement("div");g.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",_=>{_.stopPropagation(),t.entity=_.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",_=>{_.stopPropagation(),_.detail.value?t.icon=_.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=_=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[_.name]??_.name,x.computeHelper=_=>{if(_.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(_.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(_.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(_.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",_=>{_.stopPropagation();let D=_.detail.value;D.name?t.name=D.name:delete t.name,D.toggle===!0?t.toggle=!0:delete t.toggle;for(let U of["show_icon","show_name","show_state"])D[U]===!1?t[U]=!1:delete t[U];for(let U of["icon_tap_action","icon_hold_action","tap_action","hold_action"])D[U]?t[U]=D[U]:delete t[U];D.double_tap_action&&D.double_tap_action.action!=="none"?t.double_tap_action=D.double_tap_action:delete t.double_tap_action,this.emit_()});let z=()=>{c.textContent=ie(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ie(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ie(t)),h.hidden=!ie(t)};return this.koppen_.push(z),m.data={entity:t.entity||void 0},k.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(m,k,x),r.append(o,g),z(),r}emit_(){let e=ma(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-entities-card-editor",fa);var Xt=class extends M{validate(e){let t=Cr(e);return t.some(n=>n.items.some(ie))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?G(e.tone):this.config.tone?G(this.config.tone):ue(e.entity)!=="light"?$.accent:sr(b(this.hass,e.entity))??$.lit}metSchakelaar_(e){return!!e.toggle&&lr(e.entity)}metTijd_(e){return!$r(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!da(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Zt(e)),this.style.containerType="inline-size";let t=Zt(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,g)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?wr({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:qt[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Ft(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>me(this,this.hass,t,t[s]??l),i={action:t.entity?"more-info":"none"};this.teardown_.push(V(e,{onTap:()=>n("tap_action",i),onHold:()=>n("hold_action",i),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(V(r,{onTap:()=>n("icon_tap_action",at(t.entity)),onHold:()=>n("icon_hold_action",i)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=Ar(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=b(this.hass,t.entity),p=Gt(t.entity,d.value,Se(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(yr(o,{value:()=>te(b(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>ee(b(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Ft(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let i=b(this.hass,n.entity),r=te(i),o=!!n.entity&&ee(i);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=E(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let _=Ct(this.hass,n.entity,n.icon),D=n.icon||(_?`pic:${_}`:Un(n.entity,Q(this.hass,n.entity)));d.dataset.icon!==D&&(d.dataset.icon=D,d.classList.toggle("pic",!!_),d.innerHTML=_?`<img src="${_}" alt="" loading="lazy" />`:v(n.icon||Un(n.entity,Q(this.hass,n.entity)))),d.style.setProperty("--tone",_?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(sa(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),g=null;if(h){let _=o?null:la(i);h.dataset.soort!==(_??"")&&(h.dataset.soort=_??"",h.innerHTML=_?`<input class="tijd" type="${_}" step="60" />`:""),g=h.querySelector(".tijd")}if(g&&(g.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==g)){let _=Er(i,h.dataset.soort);g.value!==_&&(g.value=_)}let m=t.querySelector(".keuzeslot"),k=null;if(m){let _=o?[]:Se(i),D=_.map(ke=>Ut(ke,this.hass?.formatEntityState?.(i,ke))),U=JSON.stringify([_,D]);m.dataset.opties!==U&&(m.dataset.opties=U,m.innerHTML=_.length?`<select class="keuze">${_.map((ke,nt)=>`<option value="${q(ke)}">${q(D[nt])}</option>`).join("")}</select>`:""),k=m.querySelector(".keuze")}if(k&&(k.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==k)){let _=Kt(i);k.value!==_&&(k.value=_)}let x=t.querySelector(".st"),z=n.show_state??this.config.show_state;if(p||g||k)x.textContent="";else if(z===!1)x.textContent="";else if(o)x.textContent="Niet bereikbaar";else if(!i||Vn(i.entity_id))x.textContent="";else if(ue(i.entity_id)==="light"&&r&&i.attributes.brightness!=null)x.textContent=`${Math.round(i.attributes.brightness/255*100)}%`;else{let _=i.attributes.unit_of_measurement;x.textContent=_?`${i.state} ${_}`:J(this.hass,i)}t.setAttribute("aria-label",`${l}${i?`, ${J(this.hass,i)}`:""}`)})}getCardSize(){return ge(ua(this.config))}getGridOptions(){let e=ge(ua(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};y(Xt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);N("domotiapp-entities-card",Xt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Z={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},X=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),Ue=a=>!a||a.state==="off",ba=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),ct=a=>a?.state==="playing",Hr=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function Ir(a){if(!a)return[];let e=[];return(X(a,Z.TURN_ON)||X(a,Z.TURN_OFF))&&e.push("power"),Ue(a)||(X(a,Z.PREVIOUS_TRACK)&&e.push("prev"),X(a,Z.PLAY)||X(a,Z.PAUSE)||X(a,Z.PLAY_MEDIA)?e.push("play"):X(a,Z.STOP)&&e.push("stop"),X(a,Z.NEXT_TRACK)&&e.push("next")),e}var Ne=a=>a?.volume_entity||a?.entity;function va(a){if(!ba(a))return[];let e=[];return X(a,Z.VOLUME_MUTE)&&e.push("mute"),X(a,Z.VOLUME_SET)?e.push("slider"):X(a,Z.VOLUME_STEP)&&e.push("steps"),e}var je=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),pt=a=>!!a?.attributes?.is_volume_muted,ka=a=>!!a?.attributes?.mass_player_type,xa=a=>!!a?.attributes?.shuffle,_a=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Rr=a=>({off:"all",all:"one",one:"off"})[kd(a)]??"all",kd=a=>["off","all","one"].includes(a)?a:"off";function wa(a,{zoeken:e=!0,sleep:t=!1}={}){if(!ba(a))return[];let n=[];return X(a,Z.SHUFFLE_SET)&&n.push("shuffle"),X(a,Z.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&ka(a)&&n.push("search"),n}function Pr(a,{tonen:e=!0}={}){if(!e||!ba(a)||!X(a,Z.SELECT_SOURCE)||ka(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function Qt(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function ht(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var xd="domotiapp-media-speler:";function ya(a,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],i=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(a?.players)&&a.players.length?[...new Set([...n(a?.entity)?[a.entity]:[],...a.players.filter(n)])]:_d(i(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function _d(a,e){let t=a.filter(n=>ka(e?.states?.[n]));return t.length?t:a}var Vr=a=>xd+(a??[]).join("|");function Br(a,e,t){if(!a?.speaker_select)return a?.entity??"";let n=null;try{n=t?.getItem?.(Vr(e))??null}catch{n=null}return n&&e?.includes(n)?n:a.entity&&e?.includes(a.entity)?a.entity:a.entity||e?.[0]||""}function Kr(a,e,t){try{return a?.setItem?.(Vr(e),String(t)),!0}catch{return!1}}var za="dacScrollSlot",Gr=["position","top","left","right","width","overflow"];function Ur(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[za])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(Gr.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[za]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Gr)t.style[o]=i[o];t.dataset&&delete t.dataset[za],e?.scrollTo?.(0,n)}}}var wd=[400,1e3,2e3,4e3,8e3,15e3,3e4],yd=6e4;function Oe(a){let e=a?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(a?.message??""))}var fe=class{constructor(e,{wachttijden:t=wd,traag:n=yd,klok:i,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=i??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},We=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var zd=`
  :host {
    ${K}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,ja=null,Wr=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),$a=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),ja=ja??[F(zd)],this.shadowRoot.adoptedStyleSheets=ja}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=Wr(e.title??"Weet je het zeker?"),this.$("p").innerHTML=Wr(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};O("domotiapp-vraag",$a);function ut(a={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(a);return e.focus?.(),t}or(ut);var qr=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var $e=a=>`domotiapp_lovelace/media/${a}`;function jd(a,e){if(!a)return null;if(e)return a.uri?{type:$e("favorite"),favorite:!0,uri:a.uri}:null;let t=Fr(a);return!t||!a.library_item_id?null:{type:$e("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function Fr(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Zr={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Ea=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Xr(a,e,t=null){return a?.kind??Fr(e)??t??"playlists"}var Aa=a=>!!a?.uri,Yt=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:$e("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),Qr=(a,e,t)=>{let n=jd(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Yr=(a,e)=>a.callWS({type:$e("playlist/create"),name:e}).then(t=>t?.playlist??null),Jr=(a,e)=>a.callWS({type:$e("playlist/remove"),library_item_id:String(e.library_item_id)}),eo=(a,e)=>a.callWS({type:$e("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),to=(a,e,t)=>a.callWS({type:$e("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),no=(a,e,t)=>a.callWS({type:$e("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var $d=350,Ed={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Ad(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=Ed[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Md=`
  :host {
    ${K}
          ...
          <div class="rij" data-i="${i}" data-knoppen="${d}">
            <button class="tr" type="button">
              ...
              <span class="tekst">
                ...
                <span class="ond">${this.veilig_(Ad(n))}</span>
              </span>
...
`,Sa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[F(Sd+xe)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};O("domotiapp-bron-kiezer",Sa);function io(a,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(a,e,t),n.focus?.(),n}function ro(a,e){let t=a?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var Nd=524288;function Od(a,e){let t=a?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&Nd)!==0}function Na(a,e,t){return e===t?"zelf":Od(a,e)?Td(a,e,t)?"mee":"los":"kan-niet"}function Td(a,e,t){if(ro(a,t).has(e))return!0;if(ro(a,t).size===0){let n=a?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function oo(a,e,t){let n=Na(a,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Cd=`
  :host {
    ${K}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Oa=null,Jt=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ta=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Oa=Oa??[F(Cd)],this.shadowRoot.adoptedStyleSheets=Oa,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </div>`}).join("")}koppel_(e){let t=oo(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};O("domotiapp-speler-kiezer",Ta);function so(a,e,t,n){let i=document.querySelector("domotiapp-speler-kiezer");return i||(i=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var Ca=[15,30,45,60,90],La=30;function lo(a){let e=Math.max(0,Math.round(a)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),i=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(i).padStart(2,"0")}`}function Da(a,{min:e=1,max:t=720}={}){let n=String(a??"").trim();if(!/^\d+$/.test(n))return null;let i=Number(n);return i>=e&&i<=t?i:null}var Ld=`
  :host {
    ${K}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Ha=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=F(Ld)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
...
Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:z},k.data={name:e.name,path:e.path},k.addEventListener("value-changed",x=>{x.stopPropagation();let z=x.detail.value??{};e.name=z.name??"",e.path=z.path??"",this.emit_()}),g.append(m,k,...this.subBlok_(e,t)),n.appendChild(g),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let i=document.createElement("div");i.className="sublijst",e.items.forEach((s,l)=>i.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,i,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let i=document.createElement("summary");i.textContent="\uFF0B  Subknop toevoegen",n.appendChild(i);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=ko(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of vo){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,i){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=v(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",i),r}subItemBlok_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=v(t.icon,"grid"),d.textContent=t.name||(Ae(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsSub_(e,n,i,-1));h.disabled=i===0;let g=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsSub_(e,n,i,1));g.disabled=i===e.items.length-1;let m=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderSub_(e,n,i));m.classList.add("weg"),o.append(s,l,h,g,m),r.appendChild(o);let k=document.createElement("div");k.className="body";let x=document.createElement("dac-icon-picker");x.label="Icoon",x.fallback="grid",x.auto=!1,x.hass=this.hass_,x.value=t.icon,x.addEventListener("value-changed",_=>{_.stopPropagation(),t.icon=_.detail.value??"",this.emit_()});let z=document.createElement("ha-form");return z.hass=this.hass_,z.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],z.computeLabel=_=>({name:"Naam",path:"Waar gaat hij heen"})[_.name]??_.name,t.action&&(z.schema=[{name:"name",selector:{text:{}}}],z.computeHelper=_=>_.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),z.data={name:t.name,path:t.path},z.addEventListener("value-changed",_=>{_.stopPropagation();let D=_.detail.value??{};t.name=D.name??"",t.path=D.path??"",this.emit_()}),k.append(x,z),r.appendChild(k),r}verplaatsSub_(e,t,n,i){let r=n+i;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let i=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){i.add(r);continue}let s=Number(o[2]);s!==n&&i.add(`i${t}s${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let i=xo.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(`i${r>e?r-1:r}${i[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let i of this.open_){let r=xo.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(i)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=wo(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-navbar-card-editor",qa);var yo=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*bt(a){let e=yo(a),t=0;for(;e&&t++<40;)yield e,e=yo(e)}function qd(a){for(let e of bt(a)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Fd(a){for(let e of bt(a))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Zd(a){for(let e of bt(a))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Xd(a){for(let e of bt(a))if(e.classList?.contains?.("section"))return e;return null}function zo(a){for(let e of bt(a)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var cn=class extends M{validate(e){let t=bo(e),n={labels:!0,tone:"accent",...e,items:t,max:Te(e?.max)};return t.filter(i=>i.name||i.icon||i.path).length||(n[T]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:i}=dn(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let g=Ee(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
  ...
  `);N("domotiapp-navbar-card",cn,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var Qd="dac-tabs:";function Xa(a){let e=a??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],i=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:i}}var pn=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.cards?.length));function jo(a){return(Array.isArray(a?.tabs)?a.tabs:[]).slice(0,8).map(Xa).filter(pn)}function Yd(a,e){if(!e)return 0;let t=Math.round(Number(a?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function Qa(a){let e=(a??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return Qd+e}function Jd(a,e,t){let n=null;try{n=a?.getItem?.(e)??null}catch{return null}let i=Number(n);return n===null||n===""||!Number.isInteger(i)?null:i>=0&&i<t?i:null}function $o(a,e,t){try{return a?.setItem?.(e,String(t)),!0}catch{return!1}}function Eo(a,e,t){return Jd(t,Qa(e),e.length)??Yd(a,e.length)}var ec=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function Ao(){let a=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return a.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,i=t.type.startsWith("custom:domotiapp-")?0:1;return n-i||e.naam.localeCompare(t.naam,"nl")}),[...a,...ec.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function Mo(a,e){let t=String(e??"").trim().toLowerCase();return t?a.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):a}async function So(a,e){let t={type:a};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let i=a.startsWith("custom:")?a.slice(7):`hui-${a}-card`,o=await customElements.get(i)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:a}}catch{}return t}var No=()=>!!customElements.get("hui-card-element-editor");function Oo(a,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},i=a,r=n(e),o=n(t);return r!==null&&(i=Math.max(i,r)),o!==null&&(i=Math.min(i,o)),i}function tc(a,e){let t=a?.columns,n=a?.rows,i=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));i=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}i=Math.min(12,Math.max(1,Oo(i,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${i}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,Oo(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function vt(a,e,t){if(!a?.style)return;let{gridColumn:n,height:i}=tc(e,t);a.style.gridColumn=n,a.style.height=i??""}function To(a){let e=a?._element??a?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function Co(a,e,t={}){let n=Array.isArray(a)?[...a]:[],i=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(i)||!n[i]?null:(n.splice(i+1,0,structuredClone(n[i])),n);case"verwijder":return!Number.isInteger(i)||!n[i]?null:(n.splice(i,1),n);case"rooster":return!Number.isInteger(i)||!n[i]||!t.rooster?null:(n[i]={...n[i],grid_options:{...n[i].grid_options??{},...t.rooster}},n);default:return null}}var Lo=a=>({...a?{config:a}:{},editMode:!0,saveConfig:async()=>{}}),nc=()=>document.querySelector("home-assistant");function Do({kaarten:a,hass:e,maakKaart:t,opActie:n}){let i=document.createElement("ha-sortable");i.disabled=!1,i.draggableSelector=".dac-kaart",i.rollback=!1,i.invertSwap=!0,i.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];a.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",vt(h,d?.grid_options);let g=document.createElement("hui-card-edit-mode");g.hass=e,g.lovelace=Lo(),g.path=[0,0,c],g.hiddenOverlay=!1,g.appendChild(p),o.push(g),h.appendChild(g),r.appendChild(h)}),i.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};i.addEventListener("drag-start",()=>s(!1)),i.addEventListener("drag-end",()=>s(!0)),i.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))i.addEventListener(d,p=>{p.stopPropagation(),c(p)});return i}function Ho(a){try{let e=typeof structuredClone=="function"?structuredClone(a):JSON.parse(JSON.stringify(a));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Io({hass:a,kaarten:e}){let t=nc();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let i=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(i?{kaart:i}:r?{kaarten:r}:null))},l=g=>{if(g?.detail?.dialogTag!=="hui-dialog-edit-card")return;let m=g.detail?.dialogParams?.cardConfig;g.stopImmediatePropagation?.(),g.stopPropagation(),m&&(i=m);let k=t.querySelector("hui-dialog-create-card");typeof k?.closeDialog=="function"&&k.closeDialog(),setTimeout(s,0)},d=g=>{g?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=a,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Lo({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async g=>{let m=g?.views?.[0]?.sections?.[0]?.cards;Array.isArray(m)&&(r=m)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let g=p._layoutElement;if(!g)throw new Error("de proxysectie heeft geen layout-element");g.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(g){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",g),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var hn=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var ac=`
...
`,Po=a=>a.filter(pn).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function qe(a){let e=String(a?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function Ya(a){let e=a.cards?.length??0;return e?e===1?qe(a.cards[0]):`${e} kaarten`:"Nog geen kaart"}var Ja=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(Xa);this.gebouwd_&&JSON.stringify(Po(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=ac;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let i=document.createElement("button");i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Tabblad toevoegen",i.disabled=this.tabs_.length>=8,i.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(i)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!pn(e)),r.innerHTML=v(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=Ya(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),i.append(r,o,c,p,h),n.appendChild(i);let g=document.createElement("div");g.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),g.append(m,k,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!No()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>Inhoud: <b>${Ya(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(hn()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${v("grid")}<span>${e.cards.length?`<b>${Ya(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let i=document.createElement("button");return i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Kaart toevoegen",i.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(i),n}uitVoorbeeld(e,t,n){let i=this.tabs_[e];if(i){if(t==="toevoegen"){this.voegToeViaHa_(i,e);return}this.kaartActie_(i,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,i=Number.isInteger(t)?this.tabs_[t]:null;if(!i||!i.cards[n]){e?.remove();return}let r=this.bewerkVak_(i,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,i){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==i.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:i.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Ho(e.cards[i.index]);return}let r=Co(e.cards,n,i);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let i=document.createElement("div");i.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=qe(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&i.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=qe(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||i.append(r,l),i}kaartTabbladen_(e,t,n,i,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let g of l.querySelectorAll("button"))g.setAttribute("aria-selected",String(g.dataset.blad===h));i.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let g=document.createElement("button");g.type="button",g.dataset.blad=h.id,g.textContent=h.naam,g.setAttribute("role","tab"),g.setAttribute("aria-selected","false"),g.addEventListener("click",()=>c(h.id)),l.appendChild(g)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,i,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[i],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[i]=l,o.config=l,this.emit_(),r.textContent=qe(l))}),o}async voegToeViaHa_(e,t){let n=await Io({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=v("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=qe(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsKaart_(e,n,i,-1));p.disabled=i===0;let h=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsKaart_(e,n,i,1));h.disabled=i===e.cards.length-1;let g=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderKaart_(e,n,i));g.classList.add("weg"),o.append(s,l,p,h,g),r.appendChild(o);let m=document.createElement("div");m.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",x=>{x.stopPropagation();let z=x.detail?.config;z&&(e.cards[i]=z,this.emit_(),d.textContent=qe(z),c.textContent=String(z.type??""))}),k.addEventListener("GUImode-changed",x=>x.stopPropagation()),m.appendChild(k),r.appendChild(m),r}verplaatsKaart_(e,t,n,i){let r=n+i;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let i=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){i.add(r);continue}let s=Number(o[1]);s!==n&&i.add(`t${t}k${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let i=document.createElement("input");i.type="text",i.placeholder="Zoek een kaart...",i.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=Mo(Ao(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await So(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),i.addEventListener("input",()=>{this.zoek_=i.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(i,r,s),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Po(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};O("domotiapp-tabs-card-editor",Ja);var Vo=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Ko(a){let e=Vo(a),t=0;for(;e&&t++<40;)yield e,e=Vo(e)}function Bo(a){let e=null;for(let n of Ko(a))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,i=0)=>{if(!n||i>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,i+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,i+1);if(o)return o}return null};return t(e)}var mn=class extends M{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=jo(e),n={tone:"accent",...e,tabs:t};return t.length||(n[T]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(I(this.$(".card"))),this.kies_(Eo(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let i=Math.min(Math.max(0,e),n.length-1);this.open_=i;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===i));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===i);t&&$o(this.opslag_(),Qa(n),i),this.bouw_(i)}async bouw_(e){if(this.kinderen_.has(e)){C(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let i=document.createElement("div");i.className="leeg",i.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(i),C(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Bo(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,vt(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&hn()){t.replaceChildren(Do({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),C(this.$(".card"));return}t.replaceChildren(...s),C(this.$(".card")),this.herijkIndeling_()}catch(i){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${q(i?.message??i)}</div>`,C(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,i]of this.kinderen_.entries()){if(!i)continue;let r=this.config?.tabs?.[n]?.cards??[];i.forEach((o,s)=>{let l=To(o);l&&(t=!0),vt(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),C(this.$(".card"));return}if(t<=0)return;let i=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(i))}inVoorbeeld_(){for(let e of Ko(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Bo(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};y(mn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);N("domotiapp-tabs-card",mn,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var B={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},ic=[[B.FOUT,["error","fout","aborting","afgebroken"]],[B.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[B.PAUZE,["pause","paused","pauze","onderbroken"]],[B.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[B.AF,["finished","complete","done","klaar met","afgelopen"]],[B.KLAAR,["ready","idle","standby","klaar","gereed"]],[B.UIT,["off","inactive","uit"]]],rc=new Set([B.DRAAIT]);function Uo(a){let e=String(a??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return B.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,i]of ic)for(let r of i)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return B.ONBEKEND}var Wo=a=>rc.has(Uo(a?.state));function qo(a,e=new Date){if(!a)return null;let t=String(a.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=a.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let i=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(i)return Number(i[1])*60+Number(i[2])+(i[3]?Math.round(Number(i[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function Go(a){if(a==null)return"";if(a<=0)return"Klaar";if(a<60)return`nog ${a} min`;let e=Math.floor(a/60),t=a%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Fo(a){if(!a)return null;let e=String(a.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var oc=a=>!!a&&a.state==="on",Zo=a=>a===B.DRAAIT||a===B.PAUZE||a===B.UITGESTELD;function Xo({status:a,deur:e,rest:t,pct:n}={}){let i=Uo(a?.state),r=oc(e);if(i===B.DRAAIT){let o=[];return t!=null?o.push(Go(t)):n!=null&&o.push(`${n}%`),{soort:i,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return i===B.PAUZE?{soort:i,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:i===B.FOUT?{soort:i,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:i===B.AF?{soort:i,tekst:"Programma klaar",tone:"good",waarschuwing:""}:i===B.UITGESTELD?{soort:i,tekst:t!=null?`Start over ${Go(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:i,tekst:"Klep open",tone:"warn",waarschuwing:""}:i===B.UIT?{soort:i,tekst:"Uit",tone:"neutral",waarschuwing:""}:i===B.KLAAR?{soort:i,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:B.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function Qo(a){let e=String(a??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var sc={good:$.good,warn:$.warn,bad:$.bad,neutral:$.neutral,accent:$.accent},gn=class extends M{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[T]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,i,r)=>`
  ...
  `);var li=class extends L{defaults(){return{icon:"printer3d"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer3d",auto:!1}]}schema(){return[{name:"name",selector:f.text()},{name:"status",selector:f.entity(["sensor","binary_sensor"])},{name:"power",selector:f.entity(["switch","input_boolean"])},{name:"progress",selector:f.entity(["sensor","number"])},{name:"remaining",selector:f.entity(["sensor"])},{name:"nozzle_temp",selector:f.entity(["sensor","number"])},{name:"bed_temp",selector:f.entity(["sensor","number"])},{name:"door",selector:f.entity(["binary_sensor"])},{name:"camera",selector:f.entity("camera")},{name:"live_view",selector:f.bool()},{name:"image",selector:f.entity(["image","camera"])},...Fe.flatMap(e=>[{name:`tray_${e}`,selector:f.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:f.text()},{name:`tray_${e}_label`,selector:f.text()}])]}label(e){let t={};for(let n of Fe)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};H("domotiapp-printer-card-editor",li);N("domotiapp-printer-card",vn,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var Ze={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},di=a=>a==="electric"||a==="hybrid",ci=a=>a==="fuel"||a==="hybrid",hc=["charging","charge","fast_charging","dc_charging","on","true","laden"],uc=["complete","completed","fully_charged","full","done","finished"],mc=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],gc=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function Jo(a){let e=String(a?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:hc.includes(e)?"charging":uc.includes(e)?"complete":mc.includes(e)?"connected":gc.includes(e)?"idle":"onbekend"}function es(a,e){if(a&&a!=="onbekend")return kn[a]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var kn={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function pi(a,e){let t=Number(a?.state);if(!Number.isFinite(t))return null;let n=String(a?.attributes?.unit_of_measurement??"").toLowerCase(),i=Number(e);return n!=="%"&&Number.isFinite(i)&&i>0?Math.max(0,Math.min(100,Math.round(t/i*100))):Math.max(0,Math.min(100,Math.round(t)))}function ts(a){let e=Number(a?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:a?.attributes?.unit_of_measurement??"km"}:null}function hi(a){if(a==null)return null;let e=a<=10?"bad":a<=20?"warn":"good";return{procent:a,toon:e}}function ui(a,e=Date.now()){let t=String(a?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(a?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let i=String(a?.attributes?.unit_of_measurement??"").toLowerCase();return i==="h"||i.startsWith("hour")?Math.round(n*60):i==="s"||i.startsWith("sec")?Math.round(n/60):Math.round(n)}function mi(a){if(a==null)return"";let e=Math.max(0,Math.round(a));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function ns({open:a,slot:e,laden:t,laadMinuten:n,radius:i,aandrijving:r}){if(a)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${mi(n)}`:"";return{tekst:`${kn.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:kn.complete,toon:"good"}:t==="connected"?{tekst:kn.connected,toon:"neutral"}:i?{tekst:`Nog ${i.waarde} ${i.eenheid}`,toon:"neutral"}:{tekst:Ze[r]?.label??"",toon:"neutral"}}var fc=100,bc=["home","thuis","at_home","athome"],vc=["not_home","away","afwezig","weg","not home","nothome"];function kc(a,e,t,n){let r=d=>d*Math.PI/180,o=r(t-a),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(a))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function xc(a){let e=a?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let i=String(a?.state??""),r=i.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=i.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function as(a,e,t=fc){if(!a)return{thuis:null,tekst:"",meters:null};let n=String(a.state??"").trim(),i=n.toLowerCase();if(i==="unavailable"||i==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(bc.includes(i))return{thuis:!0,tekst:"Thuis",meters:null};if(vc.includes(i))return{thuis:!1,tekst:"Afwezig",meters:null};let r=xc(a),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=kc(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var _c=["open","opened","ajar","unlatched","on","true","unlocked"],wc=["closed","close","shut","secured","locked","off","false","not_open"];function gi(a){let e=String(a?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:_c.includes(e)?!0:wc.includes(e)?!1:/(^|[^a-z])(ajar|open)([^a-z]|$)/.test(e)?!0:null}function is(a){let e=String(a?.state??"").trim().toLowerCase();if(!e||e==="unavailable"||e==="unknown")return null;if(String(a?.entity_id??"").split(".")[0]==="lock")return e==="locked"?!0:e==="unlocked"||e==="open"||e==="opening"?!1:null;if(a?.attributes?.device_class==="lock"){if(e==="on")return!1;if(e==="off")return!0}return["locked","lock","secured","closed","off","false"].includes(e)?!0:["unlocked","unlock","open","unsecured","on","true"].includes(e)?!1:null}var fi={good:$.good,warn:$.warn,bad:$.bad,neutral:$.neutral,accent:$.accent},xn=class extends M{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[T]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return Ze[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      ...
      </div>`}wire(){this.teardown_.push(I(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;R(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&R(this,t.dataset.id)})}paint(){let e=this.config,t=this.soort_(),n=di(t)?pi(b(this.hass,e.battery),e.battery_max):null,i=ci(t)?pi(b(this.hass,e.fuel),e.fuel_max):null,r=ts(b(this.hass,e.range)),o=Jo(b(this.hass,e.charging)),s=ui(b(this.hass,e.charging_ready)),l=b(this.hass,e.lock),d=gi(b(this.hass,e.doors)),c=gi(b(this.hass,e.windows)),p=d===!0||c===!0,h=is(l),g=as(b(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),m=e.battery&&!b(this.hass,e.battery)&&e.range&&!b(this.hass,e.range);this.toggleAttribute("dead",!!m),this.text(".nm",e.name||E(this.hass,e.battery||e.range||e.lock,"Auto"));let k=ns({open:p,slot:h===!1?"unlocked":h===!0?"locked":null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",k.tekst),this.$(".st").style.setProperty("--melding",fi[k.toon]??$.neutral),this.paintFoto_(),this.paintBalken_({accu:n,tank:i,radius:r,laden:o,soort:t}),this.paintTegels_(g,o,{slot:h,deurOpen:d,raamOpen:c}),C(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=v(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=v(this.config.icon||"car")},e.replaceChildren(n)}paintBalken_({accu:e,tank:t,radius:n,laden:i,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=hi(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:i==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:i==="charging"})}if(t!==null){let h=hi(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":Ze[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=ui(b(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,g)=>{let m=g===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,k=h.laadt&&c?` \xB7 nog ${this.veilig_(mi(c))}`:"";return`
          <div class="meter" style="--balk:${fi[h.toon]??$.neutral}">
            <div class="regel">
  ...
  `);var ki=class extends L{pickers(){return[]}schema(){let e=this.config_??{},t=o=>Array.isArray(o)?o.filter(s=>typeof s=="string"):[],n=t(e.cameras).map(o=>({name:`cam:${o}`,selector:f.text()})),i=[e.camera,...t(e.cameras)].filter(Boolean),r=t(e.motion_sensors).flatMap(o=>{let s=[{name:`melder:${o}`,selector:f.text()}];return i.length>1&&s.push({name:`melderbij:${o}`,selector:f.select([{value:"",label:"Bij alle camera's"},...i.map(l=>({value:l,label:this.hass?.states?.[l]?.attributes?.friendly_name??l}))])}),s});return[{name:"camera",selector:f.entity("camera")},{name:"name",selector:f.text()},{name:"live_view",selector:f.bool()},{name:"presets",selector:f.entity(["select","input_select"])},{name:"preset_buttons",selector:{entity:{domain:["button","scene","script"],multiple:!0}}},{name:"motion_sensors",selector:{entity:{domain:"binary_sensor",multiple:!0}}},...r,{name:"ptz_up",selector:f.entity(["button","switch"])},{name:"ptz_down",selector:f.entity(["button","switch"])},{name:"ptz_left",selector:f.entity(["button","switch"])},{name:"ptz_right",selector:f.entity(["button","switch"])},{name:"cameras",selector:{entity:{domain:"camera",multiple:!0}}},...n,{name:"tap_zoom",selector:f.bool()}]}label(e){return e.name.startsWith("cam:")?`Naam voor ${E(this.hass,e.name.slice(4))||e.name.slice(4)}`:e.name.startsWith("melder:")?`Naam voor ${E(this.hass,e.name.slice(7))||e.name.slice(7)}`:e.name.startsWith("melderbij:")?"\u21B3 hoort bij welke camera":{camera:"Camera",name:"Naam",live_view:"Altijd live",presets:"Presets (keuzelijst)",preset_buttons:"Presets als losse knoppen",motion:"Bewegingsmelder",motion_sensors:"Bewegingsmelders",ptz_up:"Draaien: omhoog",ptz_down:"Draaien: omlaag",ptz_left:"Draaien: links",ptz_right:"Draaien: rechts",cameras:"Nog meer camera's op deze kaart",tap_zoom:"Tikken opent het beeld groot"}[e.name]??super.label(e)}helper(e){return e.name.startsWith("melderbij:")?"Laat dit op 'alle camera's' staan als je het niet weet. De kaart koppelt een melder vanzelf aan de camera waar hij op hetzelfde apparaat zit \u2014 bij een Reolink hoeft je dus niets in te vullen.":{camera:"Op de kaart staat een beeld dat zichzelf ververst. Inzoomen doe je met twee vingers, met het scrollwiel of met een dubbeltik; een gewone tik opent hem groot. Er staan geen knoppen op het beeld.",live_view:"De stream staat dan altijd open. Mooier, maar op een dashboard met zes camera's zijn dat zes streams die de hele dag doorlopen.",presets:"De `select` van je camera-integratie \u2014 Reolink en ONVIF leveren die. De kaart maakt van elke optie een knop, onderin het beeld, dus een preset die je in de camera-app toevoegt verschijnt er vanzelf bij.",preset_buttons:"Voor integraties die geen keuzelijst maar losse knoppen leveren, zoals Amcrest en Dahua. Ze mogen naast de keuzelijst staan.",motion:"Het oude enkele veld. Gebruik liever Bewegingsmelders hierboven; deze blijft werken voor kaarten die hem al hebben.",motion_sensors:"Zolang er een aanstaat komt er een merkje op het beeld. Kies er gerust meerdere: een Reolink meldt persoon, voertuig en huisdier los van elkaar, en dan zie je w\xE9lke het is. Per melder kun je hieronder een eigen naam invullen.",ptz_up:"De vier richtingsknoppen van je integratie. Vul je er geen in, dan komt het draaikruis er niet.",cameras:"Onder het beeld komt dan een rij met namen om tussen te wisselen; de camera waar je naar kijkt licht op. Handig voor de camera's die bij elkaar horen \u2014 voordeur, oprit, achtertuin. Per camera kun je hieronder een eigen naam invullen.",tap_zoom:"Staat dit aan, dan opent een tik op het beeld de camera groot. Zet je het uit, dan gebeurt er niets bij een tik \u2014 handig op een tablet aan de muur waar per ongeluk aanraken makkelijk gaat."}[e.name]}};H("domotiapp-camera-card-editor",ki);N("domotiapp-camera-card",yn,{name:"DomotiApp Camera",description:"Live beeld met inzoomen en schuiven, de presets van je camera als knoppen, een draaikruis en een merkje zodra er beweging is."});var zn=globalThis,jn=zn.ShadowRoot&&(zn.ShadyCSS===void 0||zn.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xi=Symbol(),ls=new WeakMap,xt=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==xi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(jn&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=ls.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&ls.set(t,e))}return e}toString(){return this.cssText}},be=a=>new xt(typeof a=="string"?a:a+"",void 0,xi),ne=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new xt(t,a,xi)},ds=(a,e)=>{if(jn)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=zn.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},_i=jn?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return be(t)})(a):a;var{is:jc,defineProperty:$c,getOwnPropertyDescriptor:Ec,getOwnPropertyNames:Ac,getOwnPropertySymbols:Mc,getPrototypeOf:Sc}=Object,$n=globalThis,cs=$n.trustedTypes,Nc=cs?cs.emptyScript:"",Oc=$n.reactiveElementPolyfillSupport,_t=(a,e)=>a,wi={toAttribute(a,e){switch(e){case Boolean:a=a?Nc:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},hs=(a,e)=>!jc(a,e),ps={attribute:!0,type:String,converter:wi,reflect:!1,useDefault:!1,hasChanged:hs};Symbol.metadata??=Symbol("metadata"),$n.litPropertyMetadata??=new WeakMap;var ve=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=ps){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&$c(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=Ec(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ps}static _$Ei(){if(this.hasOwnProperty(_t("elementProperties")))return;let e=Sc(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(_t("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(_t("properties"))){let t=this.properties,n=[...Ac(t),...Mc(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(_i(i))}else e!==void 0&&t.push(_i(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ds(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:wi).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:wi;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??hs)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ve.elementStyles=[],ve.shadowRootOptions={mode:"open"},ve[_t("elementProperties")]=new Map,ve[_t("finalized")]=new Map,Oc?.({ReactiveElement:ve}),($n.reactiveElementVersions??=[]).push("2.1.2");var Mi=globalThis,us=a=>a,En=Mi.trustedTypes,ms=En?En.createPolicy("lit-html",{createHTML:a=>a}):void 0,xs="$lit$",Me=`lit$${Math.random().toFixed(9).slice(2)}$`,_s="?"+Me,Tc=`<${_s}>`,Ie=document,yt=()=>Ie.createComment(""),zt=a=>a===null||typeof a!="object"&&typeof a!="function",Si=Array.isArray,Cc=a=>Si(a)||typeof a?.[Symbol.iterator]=="function",yi=`[ 	
\f\r]`,wt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gs=/-->/g,fs=/>/g,De=RegExp(`>|${yi}(?:([^\\s"'>=/]+)(${yi}*=${yi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),bs=/'/g,vs=/"/g,ws=/^(?:script|style|textarea|title)$/i,Ni=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),w=Ni(1),pf=Ni(2),hf=Ni(3),Re=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),ks=new WeakMap,He=Ie.createTreeWalker(Ie,129);function ys(a,e){if(!Si(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return ms!==void 0?ms.createHTML(e):e}var Lc=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=wt;for(let s=0;s<t;s++){let l=a[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===wt?c[1]==="!--"?o=gs:c[1]!==void 0?o=fs:c[2]!==void 0?(ws.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=De):c[3]!==void 0&&(o=De):o===De?c[0]===">"?(o=i??wt,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?De:c[3]==='"'?vs:bs):o===vs||o===bs?o=De:o===gs||o===fs?o=wt:(o=De,i=void 0);let g=o===De&&a[s+1].startsWith("/>")?" ":"";r+=o===wt?l+Tc:p>=0?(n.push(d),l.slice(0,p)+xs+l.slice(p)+Me+g):l+Me+(p===-2?s:g)}return[ys(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},jt=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=Lc(e,t);if(this.el=a.createElement(d,n),He.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=He.nextNode())!==null&&l.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(xs)){let h=c[o++],g=i.getAttribute(p).split(Me),m=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:m[2],strings:g,ctor:m[1]==="."?ji:m[1]==="?"?$i:m[1]==="@"?Ei:Qe}),i.removeAttribute(p)}else p.startsWith(Me)&&(l.push({type:6,index:r}),i.removeAttribute(p));if(ws.test(i.tagName)){let p=i.textContent.split(Me),h=p.length-1;if(h>0){i.textContent=En?En.emptyScript:"";for(let g=0;g<h;g++)i.append(p[g],yt()),He.nextNode(),l.push({type:2,index:++r});i.append(p[h],yt())}}}else if(i.nodeType===8)if(i.data===_s)l.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(Me,p+1))!==-1;)l.push({type:7,index:r}),p+=Me.length-1}r++}}static createElement(e,t){let n=Ie.createElement("template");return n.innerHTML=e,n}};function Xe(a,e,t=a,n){if(e===Re)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=zt(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Xe(a,i._$AS(a,e.values),i,n)),e}var zi=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??Ie).importNode(t,!0);He.currentNode=i;let r=He.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new $t(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Ai(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=He.nextNode(),o++)}return He.currentNode=Ie,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},$t=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Xe(this,e,t),zt(e)?e===j||e==null||e===""?(this._$AH!==j&&this._$AR(),this._$AH=j):e!==this._$AH&&e!==Re&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Cc(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==j&&zt(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ie.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=jt.createElement(ys(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new zi(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=ks.get(e.strings);return t===void 0&&ks.set(e.strings,t=new jt(e)),t}k(e){Si(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O(yt()),this.O(yt()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=us(e).nextSibling;us(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Qe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=j,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=j}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Xe(this,e,t,0),o=!zt(e)||e!==this._$AH&&e!==Re,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Xe(this,s[n+l],t,l),d===Re&&(d=this._$AH[l]),o||=!zt(d)||d!==this._$AH[l],d===j?e=j:e!==j&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!i&&this.j(e)}j(e){e===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ji=class extends Qe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===j?void 0:e}},$i=class extends Qe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==j)}},Ei=class extends Qe{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Xe(this,e,t,0)??j)===Re)return;let n=this._$AH,i=e===j&&n!==j||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==j&&(n===j||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ai=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Xe(this,e)}};var Dc=Mi.litHtmlPolyfillSupport;Dc?.(jt,$t),(Mi.litHtmlVersions??=[]).push("3.3.3");var zs=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new $t(e.insertBefore(yt(),r),r,void 0,t??{})}return i._$AI(a),i};var Oi=globalThis,Y=class extends ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=zs(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Re}};Y._$litElement$=!0,Y.finalized=!0,Oi.litElementHydrateSupport?.({LitElement:Y});var Hc=Oi.litElementPolyfillSupport;Hc?.({LitElement:Y});(Oi.litElementVersions??=[]).push("4.2.2");var oe=ne`
  :host {
    ${be(K)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${be(xe)}
`;var Ic=["unavailable","unknown"],Rc=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function An({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||Ic.includes(c.state)){i.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of Rc)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function Mn(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var Ci=["hs","rgb","rgbw","rgbww","xy"],Li="color_temp",Pc="onoff";var Pe="kleur";var Vc=["unavailable","unknown"],$s=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Bc=[0,100];function pe(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Pc,i=t!==null&&t.includes(Li),r=t!==null&&t.some(d=>Ci.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!Vc.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:i&&!l}}function Kc(){return{state:"off"}}function Es(a,e){let t=e??pe(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...Zc(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function As(a,e,t,n){return e?a&&a.state==="on"?{...a}:Es(t,n):{state:"off"}}function Ms(a,e,t,n){let i=n??pe(t),r=Vi(a,t,i);return i.helderheid&&(r.brightness=P(e,1,255)),r}function Di(a,e,t,n){let i=n??pe(t),r=Vi(a,t,i);return Rs(r),r.color_temp_kelvin=P(e,i.minKelvin,i.maxKelvin),r}function Hi(a,e,t,n){let i=n??pe(t),r=Vi(a,t,i);return Rs(r),r.hs_color=[P(e?.[0],0,360),P(e?.[1],0,100)],r}function Sn(a,e,t){return a??Kc()}function Ss(a,e,t){let n=Sn(a,e,t);if(typeof n.brightness=="number")return P(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?P(i,1,255):255}function Ii(a,e,t){let n=t??pe(e),i=Sn(a,e,n);if(typeof i.color_temp_kelvin=="number")return P(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?P(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Nn(a,e,t){let n=Sn(a,e,t);if(Ti(n.hs_color))return[P(n.hs_color[0],0,360),P(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return Ti(i)?[P(i[0],0,360),P(i[1],0,100)]:[...Bc]}function Ri(a){return a!=null&&typeof a=="object"}function Ns(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Ri(i[s]?.lights?.[o]))return!0;return!1})}function Os(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function Pi(a,e,t){return Sn(a,e,t).state==="on"}function Ts(a,e,t){let n=t??pe(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=Pi(a,e,n),r=Cs(n),o=r?Gc(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===Pe),kleurkeuze:i&&r,stand:i?o:null}}function Cs(a){return!!(a?.kleurtemp&&a?.kleur)}function Gc(a,e,t){let n=t??pe(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if($s.slice(1).some(r=>a[r]!==void 0))return Pe}let i=e?.attributes?.color_mode;return i===Li&&n.kleurtemp?"wit":Ci.includes(i)&&n.kleur?Pe:"wit"}function Ls(a,e,t,n){let i=n??pe(t);return Cs(i)?e==="wit"?Di(a,Ii(a,t,i),t,i):Hi(a,Nn(a,t,i),t,i):a}function Ds(a){let e=P(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function Hs(a){let e=P(a,1,100);return P(Math.round(e/100*255),1,255)}var Uc=1e3,Wc=4e4,js=7;function qc(a){let e=P(a,Uc,Wc)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[P(t,0,255),P(n,0,255),P(i,0,255)]}function Fc(a){let[e,t,n]=qc(a);return`rgb(${e}, ${t}, ${n})`}function Is(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:js},(r,o)=>{let s=o/(js-1),l=t+(n-t)*s;return`${Fc(l)} ${Math.round(s*100)}%`}).join(", ")})`}function Zc(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?P(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===Li&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=P(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Ci.includes(i)&&Ti(t.hs_color)&&(n.hs_color=[P(t.hs_color[0],0,360),P(t.hs_color[1],0,100)]),n}function Vi(a,e,t){return a&&a.state==="on"?{...a}:Es(e,t)}function Rs(a){for(let e of $s)delete a[e]}function Ti(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function P(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var On="domotiapp-scene-card",Bi="domotiapp-scene-card-editor",Ps="domotiapp-scene-editor";var Et=["een","twee","drie"],Vs="pencil",Bs=["grid_options","layout_options","view_layout","visibility"];var Ks="entity_id",Ye=class extends Y{constructor(){super();y(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));y(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Ks]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Ks];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},i={...this._config,entity:n.entity};n.bare?i.bare=!0:delete i.bare,i.entity!==this._config?.entity&&(delete i.name_overrides,this._getypt={}),this._stuurDoor(i)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return j;let t=this._leden();return w`
      <ha-form
        .hass=${this.hass}
    ...
    `}_renderInhoud(){return this._toestand===Gi?w`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Us?w`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=Pi(i,t,n),o=Ts(i,t,n);return w`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${Ri(i)?j:w`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?w`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,As(i,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:j}
        </div>
    ...
    `}_renderHelderheid(e,t,n,i){let r=Ds(Ss(i,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,Ms(this._waardeVan(e),Hs(s.detail.value),t,n))};return w`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,i,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,Ls(this._waardeVan(e),s,t,n))};return w`
    ...
    `}_renderKleurtemp(e,t,n,i){let r=Ii(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Di(this._waardeVan(e),s.detail.value,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Is(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,i){let[r,o]=Nn(i,t,n),s=l=>d=>{d.stopPropagation();let c=Nn(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Hi(this._waardeVan(e),p,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${ep}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `]);var tp="0.24.0",np=["type","entity","name_overrides","bare"],Ln="laden",At="klaar",Wi="leeg",qi="geen-groep",Ws="opslagfout",qs="fout",Mt=class extends Y{constructor(){super();y(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=Ln,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new fe(()=>this._haalScenesOp()),this._verbinding=new We}static getConfigElement(){return document.createElement(Bi)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(i=>i.startsWith("light.")&&Array.isArray(t.states[i].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?I(t):null),C(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(i=>!np.includes(i)&&!Bs.includes(i));n.length&&console.warn(`${On}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Be(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===qi){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=Ln,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?Wi:At,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let i=t?.code;if(this._melding=t?.message??String(t),Oe(t)&&this._herkansing.plan()){this._toestand=Ln;return}if(i==="home_assistant_error"){this._toestand=Ws;return}if(!this.hass.states[n]){this._toestand=qi;return}this._toestand=qs}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==At)return;let{oproepen:n}=An({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let i=await Mn((r,o)=>this.hass.callService("light",r,o),n);i.length&&this._meldMislukking(i.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),i=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:i},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===At&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Wi:At}render(){if(!this._config)return j;switch(this._toestand){case qi:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Ws:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case qs:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,i=!1){return w`
      <div class="needs">
    ...
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=v(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===Wi,n=this._toestand===Ln,i=this._iconen();return w`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${i.map((r,o)=>w`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==At)return j;let t=Ns(this._scenes,this._leden,3).length,n=Os(t);return n?w`<div class="mededeling">${n}</div>`:j}_renderEditor(){return w`
    ...
    `]);O(On,Mt);O(Bi,Ye);O(Ps,Je);Ke({type:On,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${tp}).`,preview:!1});var Ve="domotiapp-alarm-card",Fi="domotiapp-alarm-card-editor",Fs="domotiapp-alarm-editor",Zs="DomotiApp Wekker",Xs="https://github.com/Sven2410/domotiapp-lovelace",he="domotiapp_lovelace",re=Object.freeze({get:`${he}/alarms/get`,save:`${he}/alarms/save`,setEnabled:`${he}/alarms/set_enabled`,delete:`${he}/alarms/delete`,stop:`${he}/alarms/stop`,clearMessage:`${he}/alarms/clear_message`,search:`${he}/sound/search`,entities:`${he}/entities/list`,previewStart:`${he}/preview/start`,subscribe:`${he}/updates/subscribe`}),Dn="#026FA1";function Qs(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var ap="07:00";var ip=["uri","name","media_type","image"],rp="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",op="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var sp="Music Assistant Wekker",lp="Verlichting Wekker";function Hn(){return{id:null,name:"",time:ap,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Ys(a){let e=Hn();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:Zi(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:St(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function St(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of ip)e[t]=a[t]===void 0?null:a[t];return e}function Zi(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Xi(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),Zi(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Js(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:St(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function el(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function tl(a){return Zi(a)&&a.slice(0,2)==="02"?rp:null}function nl(a){return a===!1?op:null}function al(a){return typeof a?.endless=="boolean"?a.endless:null}function In(a,e){let t=e==="lamp",n=t?lp:sp,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function il(a,e){return In(e,"speaker")!==null?!1:Xi(a).ok}var cp=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],pp=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Nt="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",hp="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",up="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",et=class extends Y{constructor(){super(),this._concept=Hn(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Ys(this.wekker):Hn(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:re.previewStart,speaker:this._concept.speaker,sound:St(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:re.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:St(e),endless:al(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Xi(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:re.save,person:this.person,alarm:Js(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return w`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return j;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=In(t,"speaker"),r=In(n,"lamp"),o=tl(e.time),s=nl(e.endless),l=il(e,t);return w`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${cp.map(([d,c])=>w`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:el(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${pp.map(([d,c])=>w`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
  ...
  `]);var rl="person",mp="Kies een persoon in de kaartinstellingen.",ol="De gekozen persoon is niet gevonden.",gp="De opgeslagen wekkers van deze persoon zijn onleesbaar.",hb=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function sl(a){if(!a||typeof a!="object"||Array.isArray(a))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=a.person;if(e==null||e==="")return{...a};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${rl}.`))throw new Error(`'${e}' zit niet in het domein ${rl}. Kies een persoon, zoals person.sven.`);return{...a}}function ll(a){return{type:`custom:${a}`}}function dl(a,e){return a?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:ol,isFout:!0}:{soort:"ontbreekt",tekst:mp,isFout:!1}}function cl(a,e){return a==="not_found"?ol:a==="home_assistant_error"?gp:e||"Er ging iets mis bij het ophalen van de wekkers."}var fp=["ma","di","wo","do","vr","za","zo"],bp="Geen wekkers ingesteld",vp="Eenmalig",kp="Eenmalig \u2014 afgelopen",xp="Geen wekker actief",pl="Stoppen",_p="Er is een melding over deze wekker, maar de tekst ontbreekt.";function wp(a){return!Array.isArray(a)||a.length===0?vp:[...new Set(a)].sort((t,n)=>t-n).map(t=>fp[t-1]??"?").join(" ")}function yp(a,e){return!a||Array.isArray(a.days)&&a.days.length>0?!1:Date.parse(a?.one_shot_at??"")<=e}function hl(a,e){return yp(a,e)?kp:wp(a?.days)}function ul(a){let e=a?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:_p,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function ml(a){let e=a?.alarms;if(!Array.isArray(e)||e.length===0)return bp;let t=a?.next_fire?.text;return typeof t=="string"&&t.trim()?t:xp}function gl(a,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(a??[]).find(s=>s?.id===o)).filter(Boolean),i=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:i.length?i.join(" en "):"Wekker",tijd:r.join(" en ")}}var zp="0.24.0",jp="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",$p="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",fl="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ep="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Rn=(a,e="icoon")=>w`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    ...
    </div>`}_rij(e,t){let n=ul(e),i=!!e.enabled;return w`
      <div class="rij ${i?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
  ...
  `]),y(tt,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Qi=tt;O(Ve,Ot);O(Fi,Qi);O(Fs,et);Ke({type:Ve,name:Zs,description:`Wekkerkaart van DomotiApp (v${zp}).`,preview:!1,documentationURL:Xs});var Ap=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function bl(a){return`/api/image/serve/${a}/original`}function vl(a){return a?Ap.includes(a.type)?a.size>12582912?`Deze afbeelding is ${Math.round(a.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var Mp=`
...
`,Yi=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=F(Mp)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="kop"></div>
      <div class="vak">
      ...
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let i=document.createElement("img");i.src=this.value,i.alt="",i.onerror=()=>{n.dataset.bron="",n.innerHTML=v("car")},n.replaceChildren(i)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=v("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=vl(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let i=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:i?{Authorization:`Bearer ${i}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(bl(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};O("dac-foto-picker",Yi);var Sp="/api/domotiapp_lovelace/loader.js",kl="domotiapp-lovelace-verversing";function xl(a){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(a??""));return e?e[1].toLowerCase():null}async function Np(a){try{let e=await a(Sp,{cache:"no-store"});return e?.ok?xl(await e.text()):null}catch{return null}}function Op(){try{return globalThis.sessionStorage?.getItem(kl)??null}catch{return null}}function Tp(a){try{globalThis.sessionStorage?.setItem(kl,a)}catch{return!1}return!0}function Cp(a,e,t){return!a||!e?"onbekend":a===e?"actueel":t===e?"al-geprobeerd":"herladen"}function _l({eigenUrl:a,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:i=18e5,klok:r=setInterval}={}){let o=xl(a);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await Np(e);if(Cp(o,p,Op())!=="herladen"||!Tp(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,i);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var Lp="0.24.0";mr(a=>console.warn(`domotiapp-lovelace: ${a}`));_l({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${Lp} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Lp as VERSION};
