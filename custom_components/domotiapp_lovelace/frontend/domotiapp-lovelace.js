var dp=Object.defineProperty;var cp=(i,e,t)=>e in i?dp(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var z=(i,e,t)=>cp(i,typeof e!="symbol"?e+"":e,t);var W=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function q(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var Ka=null,Bo=i=>{Ka=i},Ee=i=>String(i??"").split(".")[0],v=(i,e)=>e&&i?.states?.[e]||null,Z=(i,e)=>v(i,e)?.attributes??{},bn=(i,e,t)=>t?null:Z(i,e).entity_picture||null;function Po(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function M(i,e,t){return t||Z(i,e).friendly_name||e||""}var pp=new Set(["scene","script","input_button","button","event"]),Ga=i=>pp.has(Ee(i));function ne(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Ga(i.entity_id):!1}function Y(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(Ee(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var hp=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),Ko=i=>hp.has(Ee(i));function Go(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function fn(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var P=(i,e)=>fn(i,"hass-more-info",{entityId:e});function Rt(i){switch(Ee(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function up(i){switch(Ee(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function Ae(i,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let a=n.confirmation===!0?{}:n.confirmation;if(!Ka){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}Ka(a).then(r=>{r&&Ho(i,e,t,n)});return}Ho(i,e,t,n)}}function Ho(i,e,t,n){switch(n.action){case"more-info":P(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=up(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),fn(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":fn(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":fn(i,"ll-custom",n);break;default:break}}function U(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function ee(i,e){if(!e)return"";let t=Ee(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function K(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var Io=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Wo=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Vo=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),vn=(i,e)=>Math.round((Vo(e)-Vo(i))/864e5);function ct(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/(?:^|\D)(\d{1,2})[-./](\d{1,2})[-./](\d{4})(?!\d)/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/(?:^|\D)(\d{4})-(\d{1,2})-(\d{1,2})(?!\d)/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function kn(i,e=new Date){if(!i)return"";let t=vn(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?Io[i.getDay()]:`${Io[i.getDay()].slice(0,2)} ${i.getDate()} ${Wo[i.getMonth()]}`}var Uo=i=>i?`${i.getDate()} ${Wo[i.getMonth()]}`:"";function mp(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function gp(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function T(i,e=4){if(!i)return;let t=gp(i);if(!t){e>0&&requestAnimationFrame(()=>T(i,e-1));return}let n=`${vp(i,mp(t))}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}var Wa=new WeakMap,fp=12,bp=3;function vp(i,e){let t=Wa.get(i)??{rij:[],vast:null};if(t.vast!==null){if(t.vast.paar.includes(e))return t.vast.waarde;t.vast=null,t.rij=[]}let n=[...t.rij,e].slice(-fp),a=[...new Set(n)],r=n.reduce((s,l,d)=>d>0&&l!==n[d-1]?s+1:s,0);if(a.length===2&&r>=bp){let s=Math.max(...a);return Wa.set(i,{rij:n,vast:{paar:a,waarde:s}}),s}return Wa.set(i,{rij:n,vast:null}),e}function pt(i){let e=parseFloat(i?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function H(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);T(i)});e.observe(i);for(let t of i.children)e.observe(t);return T(i),()=>e.disconnect()}var kp="home-assistant";function Fo({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=kp,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let h=i();if(!h)return!1;for(let[g,u]of e)try{h.get(g)||h.define(g,u)}catch(k){t(`kon ${g} niet registreren: ${k&&k.message}`)}return!0}function c(){let h=i();return!h||!h.get(r)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var qo=[];function D(i,e){qo.push([i,e])}function ht({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function Zo(i=()=>{}){Fo({leesRegistry:()=>globalThis.customElements,definities:qo,waarschuw:i})}var xp=`
  :host {
    ${W}
    display: block;
...
`,E={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},Yo={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},_=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),X=(i,e="accent")=>E[i]??(i&&/[#(]|^var/.test(i)?i:E[e]),L=Symbol("incomplete"),wp=i=>`
  <div class="needs">
  ...
  </div>`,_p=56,Xo=8,Me=i=>Math.max(1,Math.ceil((i+Xo)/(_p+Xo))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[q(xp+Ce+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let a=n.target;!a?.matches||a.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||a.isConnected&&a.matches(":focus-visible")&&a.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[L]||Go(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[L]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[L];if(e.innerHTML=t?wp(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(H(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return pt(this.$(e))??t}};z(S,"css","");function N(i,e,{name:t,description:n,preview:a=!0}={}){D(i,e),ht({type:i,name:t,description:n,preview:a})}function I(i,e){D(i,e)}var m=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,A={house:m(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
    ...
    <path d="M5.2 18.4v2.4M18.8 18.4v2.4"/>`),speelkamer:m(`<circle cx="6.8" cy="7.6" r="2.8"/>
    <circle cx="17.2" cy="7.6" r="2.8"/>
    <circle cx="12" cy="13.8" r="5.8"/>
    <path d="M9.8 12.4v.1M14.2 12.4v.1"/>
    <circle cx="12" cy="15.6" r="1.9"/>
    <path d="M12 14.7v.1"/>`),stairs:m(`<path d="M3.6 20.4V16h4.3v-4.3h4.3V7.4h4.3V3.2h4.1"/>
    ...
    <path d="M5.2 6.6h13.6M5.2 8.6h13.6"/>`),gate:m(`<path d="M2.6 20.6h18.8"/>
    <path d="M4.2 20.6V6.8M19.8 20.6V6.8"/>
    <path d="M5.8 9.6h12.4M5.8 16.6h12.4"/>
    <path d="M8.4 9.6v7M15.6 9.6v7"/>
    <path d="M11.4 9.6v7M12.6 9.6v7"/>`),gateOpen:m(`<path d="M2.6 20.6h18.8"/>
    <path d="M4.2 20.6V6.8M19.8 20.6V6.8"/>
    <path d="M4.2 9.6h3.6M4.2 16.6h3.6"/>
    <path d="M7.8 9.6v7"/>
    <path d="M16.2 9.6h3.6M16.2 16.6h3.6"/>
    <path d="M16.2 9.6v7"/>`),eettafel:m(`<path d="M3 9.6h18"/>
    ...
    <path d="M15.8 20.4v-3.2a1.4 1.4 0 0 1 1.4-1.4h1.2a1.4 1.4 0 0 1 1.4 1.4v3.2"/>`),veranda:m(`<path d="M2.2 9.4 12 4.2l9.8 5.2"/>
    <path d="M4.6 9.4v10.4M19.4 9.4v10.4"/>
    <path d="M2.2 19.8h19.6"/>
    <path d="M4.6 12.2h14.8"/>`),pollenradar:m(`<circle cx="12" cy="12" r="2.2"/>
    <path d="M12 9.8V7.4M12 14.2v2.4M9.8 12H7.4M14.2 12h2.4"/>
    <path d="M6.4 6.4a7.9 7.9 0 0 0 0 11.2M17.6 17.6a7.9 7.9 0 0 0 0-11.2"/>
    <path d="M3.6 3.6a11.9 11.9 0 0 0 0 16.8M20.4 20.4a11.9 11.9 0 0 0 0-16.8"/>`),gras:m(`<path d="M3 20.4h18"/>
    <path d="M12 20.4V8.6"/>
    <path d="M12 12.4c-1.4-.8-2.2-2.2-2.2-4 1.5.2 2.2 1.6 2.2 4Z"/>
    <path d="M12 9.6c1.4-.8 2.2-2.2 2.2-4-1.5.2-2.2 1.6-2.2 4Z"/>
    <path d="M7 20.4c0-4 .8-6.6 2.4-8M17 20.4c0-4-.8-6.6-2.4-8"/>`),kruiden:m(`<path d="M12 20.8v-6.4"/>
    <path d="M12 14.4c0-3.4 1.8-5.6 5.4-6.6.4 3.8-1.6 6.4-5.4 6.6Z"/>
    <path d="M12 14.4c0-2.8-1.5-4.6-4.4-5.4-.3 3.1 1.3 5.2 4.4 5.4Z"/>
    <path d="M12 10.6c0-2.2 1-3.8 3-4.6"/>`),circulatiepomp:m(`<circle cx="12" cy="13.6" r="5.4"/>
    ...
    <path d="M12 13.6h.02"/>`),awning:m(`<path d="M2.8 11.4 6.2 5h11.6l3.4 6.4z"/>
    ...
    <path d="M14.6 17.4h6M18 14.8l2.6 2.6-2.6 2.6"/>`),dier:m(`<circle cx="6.6" cy="10.2" r="2.3"/>
    <circle cx="11" cy="6.4" r="2.4"/>
    <circle cx="15.6" cy="6.4" r="2.4"/>
    <circle cx="18.6" cy="10.4" r="2.3"/>
    <path d="M12.6 14.4c2.9 0 5 2 5 4.1 0 1.6-1.3 2.6-2.8 2.6-1 0-1.5-.4-2.2-.4s-1.2.4-2.2.4c-1.5 0-2.8-1-2.8-2.6 0-2.1 2.1-4.1 5-4.1Z"/>`),bin:m(`<path d="M3.6 6.8h16.8"/>
    ...
    <path d="M3.4 16.8h6.2a2.5 2.5 0 1 1-2.5 2.5"/>`),drop:m('<path d="M12 3.4s5.6 6.1 5.6 9.8a5.6 5.6 0 0 1-11.2 0C6.4 9.5 12 3.4 12 3.4Z"/>'),humidity:m(`<path d="M12 3.4s5.6 6.1 5.6 9.8a5.6 5.6 0 0 1-11.2 0C6.4 9.5 12 3.4 12 3.4Z"/>
    <path d="M10.1 16.1 13.9 12"/>
    <circle cx="10.2" cy="12.3" r=".95"/>
    <circle cx="13.8" cy="15.8" r=".95"/>`),lux:m(`<circle cx="12" cy="6.9" r="2.8"/>
    ...
    <path d="M5.6 16.2h12.8a1.2 1.2 0 0 1 1.2 1.2v2.4a1.2 1.2 0 0 1-1.2 1.2H5.6a1.2 1.2 0 0 1-1.2-1.2v-2.4a1.2 1.2 0 0 1 1.2-1.2Z"/>`),windSpeed:m(`<path d="M3.6 6.6h7.6a2.3 2.3 0 1 0-2.3-2.3"/>
    <path d="M3.6 10.6h4.8"/>
    <path d="M4.6 20.2a7.4 7.4 0 0 1 14.8 0"/>
    <path d="M12 20.2 16.2 15"/>
    <circle cx="12" cy="20.2" r=".9"/>`),weatherCode:m(`<path d="M7.6 14.4a3.7 3.7 0 0 1-.5-7.4 4.9 4.9 0 0 1 9.5-1 3.4 3.4 0 0 1 .5 6.7"/>
    <path d="M10.6 16.4 9.8 21M15 16.4l-.8 4.6"/>
    <path d="M8.6 17.9h7.2M8.2 19.6h7.2"/>`),forecast:m(`<path d="M7.4 11.8a3.6 3.6 0 0 1-.4-7.2 4.8 4.8 0 0 1 9.3-1 3.3 3.3 0 0 1 .5 6.5"/>
    <path d="m3.8 20.4 4.2-4.1 3 2.6 4.5-5.1"/>
    <path d="M15.9 12.8h4.3v4.3"/>`),rainfall:m(`<path d="M7.6 2.6 6.7 4.8M12 2.2l-.9 2.2M16.4 2.6l-.9 2.2"/>
    <path d="M9.2 7.4h5.6a1 1 0 0 1 1 1v10.8a2.4 2.4 0 0 1-2.4 2.4h-2.8a2.4 2.4 0 0 1-2.4-2.4V8.4a1 1 0 0 1 1-1Z"/>
    <path d="M9.2 11.8h2.1M9.2 14.8h2.1M9.2 17.8h2.1"/>`),weatherStation:m(`<path d="M12 8.2v12.4"/>
    ...
    <path d="M9.6 12.6h4.8M9.6 16h4.8"/>`),rainRadar:m(`<circle cx="12" cy="12" r="8.6"/>
    <circle cx="12" cy="12" r="4.3"/>
    <path d="M12 12 18.1 7.9"/>
    <circle cx="12" cy="12" r=".9"/>
    <path d="M8.6 16.2l-.8 1.9M11.4 17l-.8 1.9M14.2 16.2l-.8 1.9"/>`),uv:m(`<circle cx="12" cy="11.4" r="3.4"/>
    ...
    <circle cx="7.4" cy="12.5" r=".95"/><circle cx="16.6" cy="12.5" r=".95"/>`),van:m(`<path d="M2.6 16.2h18.8"/>
    ...
    <circle cx="6.6" cy="13.4" r=".95"/><circle cx="17.4" cy="13.4" r=".95"/>`),plug:m(`<path d="M9 3.4v5.2M15 3.4v5.2"/>
    ...
    <path d="M7 15.4h10v4a.6.6 0 0 1-.6.6H7.6a.6.6 0 0 1-.6-.6z"/>`),printer3d:m(`<path d="M4 3.6h16a.6.6 0 0 1 .6.6v15.2a.6.6 0 0 1-.6.6H4a.6.6 0 0 1-.6-.6V4.2a.6.6 0 0 1 .6-.6z"/>
    <path d="M3.4 8.4h17.2"/>
    <path d="M12 8.4v2.6"/>
    <path d="M10.4 11h3.2l-1.6 2.4z"/>
    <path d="M7.2 17.2h9.6"/>`),handmatig:m(`<path d="M11 12.2V5.6a1.6 1.6 0 0 1 3.2 0v6.4"/>
    <path d="M14.2 11.6v-1.4a1.5 1.5 0 0 1 3 0v1.6"/>
    <path d="M17.2 11.8v-.8a1.5 1.5 0 0 1 3 0v4.6a5.4 5.4 0 0 1-5.4 5.4h-2a4.6 4.6 0 0 1-3.7-1.9L5.4 15a1.6 1.6 0 0 1 2.4-2.1L11 15.8"/>`),koelkast:m(`<rect x="5.6" y="2.8" width="12.8" height="18.4" rx="1.8"/>
    <path d="M5.6 10.2h12.8"/>
    <path d="M8.2 6.2v2.2M8.2 12.4v2.4"/>`),oven:m(`<rect x="3.4" y="3.6" width="17.2" height="16.8" rx="1.8"/>
    <path d="M3.4 8.6h17.2"/>
    <circle cx="7" cy="6.1" r=".9"/><circle cx="10.4" cy="6.1" r=".9"/>
    <rect x="6.4" y="11.4" width="11.2" height="6.4" rx="1.2"/>`),magnetron:m(`<rect x="2.4" y="5.6" width="19.2" height="12.8" rx="1.8"/>
    <rect x="4.8" y="8.2" width="10.4" height="7.6" rx="1.2"/>
    <path d="M17.8 8.6v2.4"/>
    <circle cx="17.8" cy="14.6" r="1.1"/>`),key:m(`<circle cx="7.8" cy="12" r="3.8"/>
    ...
    <path d="M5 15.4v5M3 20.4h4"/>`),floorHeating:m(`<path d="M2.8 20.6h18.4"/>
    <path d="M5.6 17.6V5.8a2 2 0 0 1 4 0v11.8a2 2 0 0 0 4 0V5.8a2 2 0 0 1 4 0v11.8"/>`),heatPump:m(`<rect x="2.8" y="6.2" width="13.4" height="11.6" rx="1.8"/>
    <circle cx="9.5" cy="12" r="3.5"/>
    <circle cx="9.5" cy="12" r=".8"/>
    <path d="M9.5 8.5a3.5 3.5 0 0 1 3 1.8M9.5 15.5a3.5 3.5 0 0 1-3-1.8"/>
    <path d="M18.8 9.2c1.3 1.8 1.3 3.8 0 5.6M21.2 7.4c2 2.9 2 6.3 0 9.2"/>`),qr:m(`<rect x="3.4" y="3.4" width="6.4" height="6.4" rx="1.2"/>
...
`,qa=null,es=i=>i.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${Re(n)} (${n})" aria-pressed="false">${A[n]??""}<span class="naam">${Re(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),Za=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),qa=qa??[q($p)],this.shadowRoot.adoptedStyleSheets=qa,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,Xa=null,Ya=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Xa=Xa??[q(Ap)],this.shadowRoot.adoptedStyleSheets=Xa,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return E[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
      ...
      </div>`;let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let a=Ep.test(n);t.setAttribute("aria-invalid",String(!a)),a&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=!!this.value_,t=this.$(".sw");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.kleur_():"transparent"),t.title=e?`Kleur: ${Yo[this.value_]??this.value_}`:"Kleur kiezen",/^#[0-9a-f]{6}$/i.test(this.kleur_())&&(this.$('input[type="color"]').value=this.kleur_()),this.$(".wissen").hidden=!e;let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let a=this.value_ in E?"":this.value_;n.value!==a&&(n.value=a),n.setAttribute("aria-invalid","false")}}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};D("dac-tone-picker",Ya);var b={entity:i=>({entity:i?{domain:i}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(i,e,t=1)=>({number:{min:i,max:e,step:t,mode:"box"}}),select:i=>({select:{mode:"dropdown",options:i}}),action:(i="more-info")=>({ui_action:{default_action:i}})},Qa=(...i)=>({type:"grid",name:"",schema:i}),Ja=(i,e,t,n=!1)=>({type:"expandable",name:"",title:i,icon:e,expanded:n,schema:t}),Mp=[{name:"bare",selector:b.bool()}],Sp={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},C=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Mp}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return e.type==="expandable"?e.title??"":Np[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),a=t("margin-top:16px");for(let o of e){let s=document.createElement({tone:"dac-tone-picker",foto:"dac-foto-picker"}[o.kind]??"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",l=>{l.stopPropagation(),this.patch_({[o.key]:l.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?a:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Sp[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),a.children.length&&this.appendChild(a)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[a,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[a];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},Np={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Op(i=new Date){let e=i.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var Tp=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Dp=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],ei={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},Lp=["humidity","wind","uv","precipitation","sunset"],Cp=i=>i==null||Number.isNaN(+i)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+i/45)%8],wn=class extends S{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),a=()=>this.toggleAttribute("narrow",n.matches);a(),n.addEventListener("change",a),this.teardown_.push(()=>n.removeEventListener("change",a))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Op(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${Tp[e.getDay()]} ${e.getDate()} ${Dp[e.getMonth()]}`);let a=this.$(".clock");a&&this.text(a,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=v(this.hass,e.weather),n=Z(this.hass,e.weather),a=this.$(".now");if(a&&t){let l=Ht(t.state);a.style.setProperty("--wtone",X(e.tone,"water"));let d=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${K(this.hass,n.temperature,0)}<span>${d}</span>`:"--";let c=a.querySelector(".ic");c.dataset.icon!==l&&(c.dataset.icon=l,c.innerHTML=f(l,"cloud")),this.text(a.querySelector(".cond"),ee(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=Lp.map(l=>this.chip_(l,n)).filter(Boolean),s=o.map(l=>`${l.key}${l.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(l=>`<span class="chip2" style="--tone:${X(ei[l.key].tone)}" title="${ei[l.key].label}">
             ${A[ei[l.key].icon]??""}${l.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let a=this.hass?.config?.unit_system?.wind_speed??"km/h",r=Cp(t.wind_bearing);return{key:e,value:`${K(this.hass,t.wind_speed,0)} ${a}${r?` ${r}`:""}`}}case"uv":{let r=Z(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(v(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${K(this.hass,r,1)}`}:null}case"precipitation":{let a=v(this.hass,n.precipitation_entity);if(a){let r=Number(a.state);if(Number.isNaN(r))return null;let o=a.attributes.unit_of_measurement??"mm";return{key:e,value:`${K(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${K(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${K(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=v(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};z(wn,"css",`
  ...
  `);var ti=class extends C{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[Qa({name:"weather",selector:b.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Qa({name:"sun",selector:b.entity("sun")},{name:"precipitation_entity",selector:b.entity("sensor")}),{name:"name",selector:b.text()},{name:"hide_below",selector:b.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};I("domotiapp-header-card-editor",ti);N("domotiapp-header-card",wn,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var _n=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      <div class="sep" style="--tone:${X(e.tone)}">
      ...
      </div>`}paint(){this.text("h3",this.config.name??"");let e=this.$(".sub");if(!e)return;let t=v(this.hass,this.config.secondary_entity),n=e.querySelector(".si"),a=e.querySelector(".sv");if(!t){a.textContent="",n.innerHTML="";return}let r=this.config.secondary_icon??"";n.dataset.icon!==r&&(n.dataset.icon=r,n.innerHTML=r?f(r):"");let o=t.attributes.unit_of_measurement;a.textContent=o?`${t.state} ${o}`:t.attributes.current_temperature!=null?`${t.attributes.current_temperature} \xB0C`:ee(this.hass,t)}getCardSize(){return 1}getGridOptions(){return{columns:"full",rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-separator-card-editor")}static getStubConfig(){return{name:"Nieuwe sectie",icon:"house",tone:"accent"}}};z(_n,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var ni=class extends C{defaults(){return{line:!0,tone:"accent"}}gedeeldeVelden(){return[]}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:b.text()},{name:"line",selector:b.bool()},{name:"secondary_entity",selector:b.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};I("domotiapp-separator-card-editor",ni);N("domotiapp-separator-card",_n,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var ai=(i,e,t)=>Math.min(t,Math.max(e,i));function He(i,e){let t=e.min??0,n=e.max??100,a=e.step??1,r=!1,o=u=>{let k=i.getBoundingClientRect();if(!k.width)return t;let x=ai((u-k.left)/k.width,0,1),w=t+x*(n-t);return ai(Math.round(w/a)*a,t,n)},s=u=>{try{i.setPointerCapture?.(u)}catch{}},l=u=>{try{i.hasPointerCapture?.(u)&&i.releasePointerCapture(u)}catch{}},d=u=>{e.disabled?.()||u.button!=null&&u.button!==0||(r=!0,s(u.pointerId),i.classList.add("dragging"),e.onInput(o(u.clientX)),u.preventDefault())},c=u=>{r&&(e.onInput(o(u.clientX)),u.preventDefault())},p=u=>{r&&(r=!1,l(u.pointerId),i.classList.remove("dragging"),e.onCommit(o(u.clientX)))},h=u=>{r&&(r=!1,l(u?.pointerId),i.classList.remove("dragging"),e.onInput(e.value()))},g=u=>{if(e.disabled?.())return;let k=(n-t)/10,x={ArrowLeft:-a,ArrowDown:-a,ArrowRight:a,ArrowUp:a,PageDown:-k,PageUp:k,Home:-1/0,End:1/0};if(!(u.key in x))return;u.preventDefault();let w=e.value(),y=ai(x[u.key]===-1/0?t:x[u.key]===1/0?n:w+x[u.key],t,n);e.onInput(y),e.onCommit(y)};return i.addEventListener("pointerdown",d),i.addEventListener("pointermove",c),i.addEventListener("pointerup",p),i.addEventListener("pointercancel",h),i.addEventListener("keydown",g),()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",c),i.removeEventListener("pointerup",p),i.removeEventListener("pointercancel",h),i.removeEventListener("keydown",g)}}var ve=(i="")=>`
...
`;var Rp=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Hp=new Set(["hs","rgb","rgbw","rgbww","xy"]),ri=i=>i?.attributes?.supported_color_modes??[],Ip=i=>ri(i).some(e=>Rp.has(e)),yn=i=>ri(i).some(e=>Hp.has(e)),zn=i=>ri(i).includes("color_temp"),ts=i=>Math.max(1,Math.round((i??0)/255*100)),jn=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[L]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var as=i=>String(i??"").split(".")[0],is=new Set(["input_select","select"]),di=i=>is.has(as(i));function ke(i){if(!i||!di(i.entity_id))return[];let e=i.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function ut(i,e=ke(i)){let t=String(i?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function mt(i,e,t=[]){let n=as(i),a=String(e??"");return!a||!is.has(n)||t.length&&!t.includes(a)?null:[n,"select_option",{entity_id:i,option:a}]}var me=i=>String(i??"").split(".")[0],Se=i=>i==null||i===""||i==="unknown"||i==="unavailable",Ve={domeinen:["sensor"],device_class:"temperature",rol:"tegel",eenheid:"\xB0C"},Bp={hoofd_climate:{key:"entity",label:"Apparaat (climate)",domeinen:["climate"],rol:"hoofd",hulp:"De climate-entiteit. Daar komen de standen en de temperatuurknoppen vandaan. Leeg laten mag: dan toont de kaart alleen de sensoren."},hoofd_ventilatie:{key:"entity",label:"Ventilatie-unit",domeinen:["fan","select","input_select","climate"],rol:"hoofd",hulp:"Een fan-entiteit (standen of percentage), of een keuzelijst met de standen. Leeg laten mag."},hoofd_boiler:{key:"entity",label:"Boiler (water_heater of climate)",domeinen:["water_heater","climate"],rol:"hoofd",hulp:"Daar komen de doeltemperatuur en de bedrijfsstanden vandaan. Leeg laten mag."},temperature:{key:"temperature",label:"Binnentemperatuur",...Ve,hulp:"Wint van de meting van het apparaat zelf."},outdoor:{key:"outdoor",label:"Buitentemperatuur",...Ve},humidity:{key:"humidity",label:"Luchtvochtigheid",domeinen:["sensor"],device_class:"humidity",rol:"tegel",eenheid:"%"},co2:{key:"co2",label:"CO\u2082",domeinen:["sensor"],rol:"tegel",eenheid:"ppm",hulp:"Kleurt oranje boven 1200 ppm en rood boven 1600."},voc:{key:"voc",label:"Luchtkwaliteit (VOC)",domeinen:["sensor"],rol:"tegel"},power:{key:"power",label:"Vermogen",domeinen:["sensor"],device_class:"power",rol:"tegel",eenheid:"W"},energy:{key:"energy",label:"Energie vandaag",domeinen:["sensor"],device_class:"energy",rol:"tegel",eenheid:"kWh"},flow_temp:{key:"flow_temp",label:"Aanvoertemperatuur",...Ve},return_temp:{key:"return_temp",label:"Retourtemperatuur",...Ve},dhw_temp:{key:"dhw_temp",label:"Tapwatertemperatuur",...Ve},water_temp:{key:"water_temp",label:"Watertemperatuur",...Ve,hulp:"Wint van de meting van de boiler zelf."},supply_temp:{key:"supply_temp",label:"Toevoertemperatuur",...Ve},exhaust_temp:{key:"exhaust_temp",label:"Afvoertemperatuur",...Ve},cop:{key:"cop",label:"COP",domeinen:["sensor"],rol:"tegel",hulp:"Rendement: geleverde warmte gedeeld door verbruikte stroom."},thermal:{key:"thermal",label:"Thermisch vermogen",domeinen:["sensor"],rol:"tegel",eenheid:"kW"},compressor:{key:"compressor",label:"Compressor",domeinen:["sensor","binary_sensor"],rol:"tegel",hulp:"Een toerental of percentage, of een aan/uit-sensor."},flow_rate:{key:"flow_rate",label:"Debiet",domeinen:["sensor"],rol:"tegel",eenheid:"l/min"},pressure:{key:"pressure",label:"Waterdruk",domeinen:["sensor"],rol:"tegel",eenheid:"bar"},status:{key:"status",label:"Statussensor",domeinen:["sensor"],rol:"status",hulp:"Een sensor met een woord als toestand (Verwarmen, Tapwater, Stand 2). Komt in de regel onder de naam."},fault:{key:"fault",label:"Storing",domeinen:["binary_sensor"],rol:"storing",hulp:"Een binary_sensor die aan gaat bij een storing. De kaart kleurt dan rood, wat er verder ook aan de hand is."},filter:{key:"filter",label:"Filter",domeinen:["binary_sensor","sensor"],rol:"filter",hulp:"Een binary_sensor die aan gaat als het filter vervangen moet worden, of een sensor met de dagen tot vervanging."},bypass:{key:"bypass",label:"Bypass",domeinen:["binary_sensor"],rol:"tegel"},heating:{key:"heating",label:"Verwarmt (aan/uit)",domeinen:["binary_sensor"],rol:"verwarmt",hulp:"Een binary_sensor die aan is zolang de boiler opwarmt."},mode:{key:"mode",label:"Bedrijfsmodus (keuzelijst)",domeinen:["select","input_select"],rol:"keuze",hulp:"Een keuzelijst van de integratie, bijvoorbeeld Verwarmen / Koelen / Auto. Verschijnt als uitklaplijst op de kaart."},boost:{key:"boost",label:"Boost",domeinen:["switch","input_boolean","button","input_button","script"],rol:"boost",hulp:"Een schakelaar wordt een schuifschakelaar op de kaart; een knop of script een drukknop."}},gt={airco:{label:"Airco",naam:"Airco",icoon:"airco",velden:["hoofd_climate","temperature","outdoor","humidity","power","energy","fault"]},warmtepomp:{label:"Warmtepomp",naam:"Warmtepomp",icoon:"heatPump",velden:["hoofd_climate","status","fault","flow_temp","return_temp","outdoor","dhw_temp","cop","power","thermal","energy","compressor","flow_rate","pressure","mode","boost"]},ventilatie:{label:"Ventilatie (WTW)",naam:"Ventilatie",icoon:"fan",velden:["hoofd_ventilatie","status","fault","co2","humidity","voc","temperature","outdoor","supply_temp","exhaust_temp","filter","bypass","power","boost"]},boiler:{label:"Boiler / warm water",naam:"Boiler",icoon:"boiler",velden:["hoofd_boiler","water_temp","heating","power","energy","fault","mode","boost"]}},Ye="airco",Qe=i=>gt[i]??gt[Ye],Be=i=>Qe(i).velden.map(e=>Bp[e]),ci=(i,e)=>Be(i).filter(t=>t.rol===e),os={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",dry:"Drogen",fan_only:"Ventileren"},Pp={heating:"Verwarmt",cooling:"Koelt",drying:"Droogt",fan:"Ventileert",idle:"Standby",off:"Uit",preheating:"Voorverwarmt",defrosting:"Ontdooit"},rs={off:"Uit",on:"Aan",auto:"Auto",low:"Laag",lowest:"Laagst",min:"Min",minimum:"Min",medium:"Midden",mid:"Midden",middle:"Midden",high:"Hoog",highest:"Hoogst",max:"Max",maximum:"Max",boost:"Boost",turbo:"Turbo",quiet:"Stil",silent:"Stil",silence:"Stil",sleep:"Nacht",night:"Nacht",away:"Afwezig",home:"Thuis",eco:"Eco",comfort:"Comfort",party:"Feest",holiday:"Vakantie",electric:"Elektrisch",gas:"Gas",heat_pump:"Warmtepomp",high_demand:"Veel vraag",performance:"Snel",...os};function de(i){let e=String(i??"").trim();if(!e)return"";let t=e.toLowerCase().replace(/[\s-]+/g,"_");if(rs[t])return rs[t];let n=e.replace(/_/g," ");return n.charAt(0).toUpperCase()+n.slice(1)}function Kp(i,e){let t=String(i??"").toLowerCase(),n=Math.abs(Number(e));return t.includes("\xB0")||t==="c"||t==="f"?1:t==="%"||t==="ppm"||t==="w"||t==="hz"||t==="rpm"||t==="ppb"?0:t==="kwh"||t==="kw"||t==="bar"||t==="l/min"||t==="m\xB3/h"||t?n>=100?0:1:n>=100?0:n>=10?1:2}function Gp(i,e,t="nl"){let n=Number(i);if(!Number.isFinite(n))return"--";let a=Kp(e,n);return n.toLocaleString(t,{minimumFractionDigits:a,maximumFractionDigits:a})}var Wp={bypass:["Open","Dicht"],compressor:["Aan","Uit"],heating:["Ja","Nee"],filter:["Vervangen","Schoon"]};function Up(i,e,t="nl"){if(!i||!e)return null;let n=String(e.state??"").trim(),a=e.attributes?.unit_of_measurement??i.eenheid??"";if(me(e.entity_id)==="binary_sensor"){let[l,d]=Wp[i.key]??["Aan","Uit"],c=Se(n),p=n==="on";return{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:c?"--":p?l:d,eenheid:"",let:i.key==="filter"&&p?"warn":""}}let r=Number(n),o=!Se(n)&&Number.isFinite(r),s="";return i.key==="co2"&&o&&(s=r>=1600?"bad":r>=1200?"warn":""),i.key==="filter"&&o&&(s=r<=0?"warn":""),{key:i.key,label:i.label.replace(/\s*\(.*\)$/,""),waarde:o?Gp(r,a,t):Se(n)?"--":n,eenheid:o?a:"",let:s}}function ss(i,e,t,n="nl"){let a=[];for(let r of Be(i)){if(r.rol!=="tegel"&&r.rol!=="filter")continue;let o=e?.[r.key];if(!o)continue;let s=Up(r,t(o)??{entity_id:o,state:"unavailable",attributes:{}},n);s&&a.push(s)}return a}function ls({soort:i,hoofd:e,status:t,fault:n,filter:a,heating:r}={}){let o=Fp(a);if(n&&n.state==="on")return{tekst:"Storing",tone:"bad",bezig:!1,waarschuwing:o};if(e&&Se(e.state))return{tekst:"Niet bereikbaar",tone:"neutral",bezig:!1,waarschuwing:o};let s=t&&!Se(t.state)?de(t.state):"",l=me(e?.entity_id);if(e&&l==="climate"){let c=(e.attributes??{}).hvac_action??(e.state==="off"?"off":"idle"),p=Pp[c]??de(c),h=c==="heating"||c==="preheating"?"solar":["cooling","drying","fan"].includes(c)?"water":"neutral",g=h!=="neutral"||c==="defrosting";return{tekst:s&&s!==p?`${p} \xB7 ${s}`:p,tone:h,bezig:g,waarschuwing:o}}if(e&&l==="fan"){let d=e.attributes??{};if(e.state==="off")return{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o};let c=d.preset_mode?de(d.preset_mode):Number.isFinite(Number(d.percentage))?`${Math.round(Number(d.percentage))}%`:"Aan";return{tekst:s&&s!==c?`${c} \xB7 ${s}`:`Ventileert \xB7 ${c}`,tone:"water",bezig:!0,waarschuwing:o}}if(e&&l==="water_heater"){let d=e.attributes??{},c=de(e.state),p=r?r.state==="on":d.operation_mode!=="off"&&e.state!=="off"&&d.hvac_action==="heating";return e.state==="off"?{tekst:"Uit",tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:p?`Verwarmt \xB7 ${c}`:c,tone:p?"solar":"neutral",bezig:p,waarschuwing:o}}if(e&&(l==="select"||l==="input_select")){let d=de(e.state),c=/^(uit|off)$/i.test(e.state);return{tekst:c?"Uit":`Stand \xB7 ${d}`,tone:c?"neutral":"water",bezig:!c,waarschuwing:o}}return r&&r.state==="on"?{tekst:s?`Verwarmt \xB7 ${s}`:"Verwarmt",tone:"solar",bezig:!0,waarschuwing:o}:s?{tekst:s,tone:"neutral",bezig:!1,waarschuwing:o}:{tekst:Qe(i).naam,tone:"neutral",bezig:!1,waarschuwing:o}}function Fp(i){if(!i||Se(i.state))return"";if(me(i.entity_id)==="binary_sensor")return i.state==="on"?"Filter vervangen":"";let e=Number(i.state);return Number.isFinite(e)&&e<=0?"Filter vervangen":""}var qp=[["0","Uit"],["33","Laag"],["66","Midden"],["100","Hoog"]];function pi(i){if(!i)return[];let e=i.attributes??{},t=me(i.entity_id),n=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"&&r!==""):[];if(t==="climate")return n(e.hvac_modes).map(a=>({waarde:a,label:os[a]??de(a)}));if(t==="water_heater")return n(e.operation_list).map(a=>({waarde:a,label:de(a)}));if(t==="select"||t==="input_select")return n(e.options).map(a=>({waarde:a,label:de(a)}));if(t==="fan"){let a=n(e.preset_modes);if(a.length)return a.map(r=>({waarde:r,label:de(r)}));if(e.percentage!=null||e.percentage_step!=null){let r=Number(e.percentage_step)||1;return qp.map(([o,s])=>({waarde:String(Math.min(100,Math.round(Number(o)/r)*r)),label:s}))}return[{waarde:"off",label:"Uit"},{waarde:"on",label:"Aan"}]}return[]}function ds(i,e=pi(i)){if(!i||Se(i.state))return"";let t=i.attributes??{};if(me(i.entity_id)==="fan"){if(t.preset_mode&&e.some(r=>r.waarde===t.preset_mode))return t.preset_mode;if(i.state==="off")return e.some(r=>r.waarde==="0")?"0":"off";let a=Number(t.percentage);if(Number.isFinite(a)&&e.length){let r=e[0];for(let o of e)Math.abs(Number(o.waarde)-a)<Math.abs(Number(r.waarde)-a)&&(r=o);return r.waarde}return i.state==="on"?"on":""}return e.some(a=>a.waarde===i.state)?i.state:""}function cs(i,e){if(!i)return null;let t=i.entity_id,n=String(e??"");if(!n)return null;let a=me(t);switch(a){case"climate":return["climate","set_hvac_mode",{entity_id:t,hvac_mode:n}];case"water_heater":return["water_heater","set_operation_mode",{entity_id:t,operation_mode:n}];case"select":case"input_select":return[a,"select_option",{entity_id:t,option:n}];case"fan":{let r=i.attributes?.preset_modes;if(Array.isArray(r)&&r.includes(n))return["fan","set_preset_mode",{entity_id:t,preset_mode:n}];if(n==="off")return["fan","turn_off",{entity_id:t}];if(n==="on")return["fan","turn_on",{entity_id:t}];let o=Number(n);return Number.isFinite(o)?o<=0?["fan","turn_off",{entity_id:t}]:["fan","set_percentage",{entity_id:t,percentage:o}]:null}default:return null}}function hi(i){let e=i?.attributes?.fan_modes;return me(i?.entity_id)!=="climate"||!Array.isArray(e)?[]:e.filter(t=>typeof t=="string"&&t).map(t=>({waarde:t,label:de(t)}))}function ps(i,e){let t=String(e??"");return!i||!t||!hi(i).some(n=>n.waarde===t)?null:["climate","set_fan_mode",{entity_id:i.entity_id,fan_mode:t}]}function ui(i,e){if(!i||Se(i.state))return null;let t=i.attributes??{},n=me(i.entity_id);if(n!=="climate"&&n!=="water_heater")return null;let a=Number(t.temperature);if(!Number.isFinite(a))return null;let r=Number(e)||Number(t.target_temp_step)||(n==="water_heater"?1:.5);return{min:Number(t.min_temp??(n==="water_heater"?30:5)),max:Number(t.max_temp??(n==="water_heater"?70:35)),stap:r,doel:a,huidig:Number.isFinite(Number(t.current_temperature))?Number(t.current_temperature):null}}function hs(i,e,t){if(!i)return null;let a=(Number.isFinite(e)?e:i.doel)+t*i.stap,r=Math.round(a/i.stap)*i.stap,o=Math.round(r*100)/100;return Math.min(i.max,Math.max(i.min,o))}function us(i,e){if(!i||!Number.isFinite(e))return null;let t=me(i.entity_id);return t!=="climate"&&t!=="water_heater"?null:[t,"set_temperature",{entity_id:i.entity_id,temperature:e}]}var ms=i=>["switch","input_boolean"].includes(me(i));function mi(i,e=!0){let t=String(i??""),n=me(t);switch(n){case"switch":case"input_boolean":return["homeassistant",e?"turn_on":"turn_off",{entity_id:t}];case"button":case"input_button":return[n,"press",{entity_id:t}];case"script":return["script","turn_on",{entity_id:t}];default:return null}}function gs(i,e){let t=Number(e?.state);if(e&&!Se(e.state)&&Number.isFinite(t))return t;let n=i?.attributes?.current_temperature;if(n==null||n==="")return null;let a=Number(n);return Number.isFinite(a)?a:null}var fs={solar:E.solar,water:E.water,bad:E.bad,warn:E.warn,neutral:"var(--dac-ink-3)"},Sn=class extends S{validate(e){let t={soort:Ye,...e};return gt[t.soort]||(t.soort=Ye),Be(t.soort).some(a=>t[a.key])||(t[L]="Kies de soort en minstens \xE9\xE9n entiteit: het apparaat zelf, of een sensor."),t}watched(){let e=this.config;return Be(e.soort).map(t=>e[t.key]).filter(Boolean)}hoofd_(){return v(this.hass,this.config.entity)??null}metRol_(e){let t=ci(this.config.soort,e)[0];return t?v(this.hass,this.config[t.key])??null:null}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=e.boost?ms(e.boost)?En({label:"Boost"}):`<button type="button" class="knop">${f("bolt")}<span>Boost</span></button>`:"";return`
      <div class="card surface" style="--tone:var(--dac-ink-3)">
      ...
      </div>`}wire(){let e=this.config;if(this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(H(this.$(".card"))),this.on(this.$(".top"),"click",()=>{let t=e.entity||this.watched()[0];t&&P(this,t)}),this.on(this.$(".standen"),"click",t=>{let n=t.target?.closest?.(".seg");if(!n||n.disabled)return;t.stopPropagation();let a=cs(this.hoofd_(),n.dataset.waarde);a&&this.hass.callService(a[0],a[1],a[2])}),this.$$(".set button").forEach(t=>this.on(t,"click",()=>this.nudge_(Number(t.dataset.d)))),this.on(this.$(".rij.ventilator"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n)return;t.stopPropagation();let a=ps(this.hoofd_(),n.value);a&&this.hass.callService(a[0],a[1],a[2])}),this.on(this.$(".rij.modus"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.mode)return;t.stopPropagation();let a=mt(e.mode,n.value,ke(v(this.hass,e.mode)));a&&this.hass.callService(a[0],a[1],a[2])}),e.boost){let t=this.$(".rij.boost .toggle"),n=this.$(".rij.boost .knop");t&&this.teardown_.push(An(t,{value:()=>Y(v(this.hass,e.boost)),set:a=>{let r=mi(e.boost,a);r&&this.hass.callService(r[0],r[1],r[2])}})),n&&this.on(n,"click",a=>{a.stopPropagation();let r=mi(e.boost,!0);r&&this.hass.callService(r[0],r[1],r[2])})}}nudge_(e){let t=this.hoofd_(),n=ui(t,this.config.step);n&&(this.pending_=hs(n,this.pending_??n.doel,e),this.paintDoel_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null;let a=us(t,this.pending_);a&&this.hass.callService(a[0],a[1],a[2]),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450))}paintDoel_(){let e=this.$(".set"),t=ui(this.hoofd_(),this.config.step);if(e.hidden=!t,!t)return;let n=this.pending_??t.doel,a=e.querySelector(".target");a.classList.toggle("pending",this.pending_!=null),a.innerHTML=`${K(this.hass,n,n%1?1:0)}\xB0<small>doel</small>`,e.querySelector('[data-d="-1"]').disabled=n<=t.min,e.querySelector('[data-d="1"]').disabled=n>=t.max}paint(){let e=this.config,t=Qe(e.soort),n=this.hoofd_(),a=ls({soort:e.soort,hoofd:n,status:this.metRol_("status"),fault:this.metRol_("storing"),filter:this.metRol_("filter"),heating:this.metRol_("verwarmt")}),r=fs[a.tone]??fs.neutral;this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("bezig",a.bezig),this.toggleAttribute("storing",a.tone==="bad"),this.$(".top").classList.toggle("dood",a.tekst==="Niet bereikbaar");let o=this.$(".chip"),s=e.icon||t.icoon;o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=f(s,t.icoon)),this.text(".nm",e.name||(e.entity?M(this.hass,e.entity,null):"")||t.naam);let l=this.$(".st"),d=_(a.tekst)+(a.waarschuwing?` &middot; <span class="let">${_(a.waarschuwing)}</span>`:"");l.dataset.html!==d&&(l.dataset.html=d,l.innerHTML=d),this.$(".top").setAttribute("aria-label",`${this.$(".nm").textContent}, ${a.tekst}`);let c=e.soort==="boiler"?"water_temp":"temperature",p=v(this.hass,e[c])??null,h=gs(n,p),g=p?.attributes?.unit_of_measurement??this.hass?.config?.unit_system?.temperature??"\xB0C",u=this.$(".graden"),k=h==null?"":`${K(this.hass,h,1)}<small>${_(g)}</small>`;if(u.dataset.html!==k&&(u.dataset.html=k,u.innerHTML=k),this.paintTegels_(h==null?null:c),this.paintStanden_(n),this.paintDoel_(),this.paintKeuzes_(n),e.boost){let x=this.$(".rij.boost .toggle");x&&(x.style.setProperty("--tone",E.accent),It(x,Y(v(this.hass,e.boost))))}T(this.$(".card"))}paintTegels_(e){let t=this.config,n=this.$(".tegels"),a=ss(t.soort,t,o=>v(this.hass,o)??null,this.hass?.locale?.language??"nl").filter(o=>o.key!==e);n.hidden=a.length===0;let r=JSON.stringify(a);n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(o=>`
        ...
        </div>`).join(""))}paintStanden_(e){let t=this.$(".standen"),n=pi(e);if(t.hidden=n.length<2,t.hidden)return;let a=ds(e,n),r=!e||e.state==="unavailable",o=JSON.stringify([n,a,r]);t.dataset.sig!==o&&(t.dataset.sig=o,t.innerHTML=n.map(s=>`<button type="button" class="seg" data-waarde="${_(s.waarde)}" aria-pressed="${s.waarde===a}"${r?" disabled":""}>${_(s.label)}</button>`).join(""))}paintKeuzes_(e){let t=this.config,n=hi(e),a=this.$(".ventslot");this.vulLijst_(a,n,e?.attributes?.fan_mode??"","Ventilator"),this.$(".rij.ventilator").hidden=n.length===0;let r=v(this.hass,t.mode),o=t.mode?ke(r).map(l=>({waarde:l,label:de(l)})):[],s=this.$(".modusslot");this.vulLijst_(s,o,ut(r),"Modus"),this.$(".rij.modus").hidden=o.length===0}vulLijst_(e,t,n,a){let r=JSON.stringify(t);e.dataset.opties!==r&&(e.dataset.opties=r,e.innerHTML=t.length?`<select class="keuze" aria-label="${_(a)}">${t.map(s=>`<option value="${_(s.waarde)}">${_(s.label)}</option>`).join("")}</select>`:"");let o=e.querySelector(".keuze");o&&this.shadowRoot.activeElement!==o&&o.value!==n&&(o.value=n)}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-hvac-card-editor")}static getStubConfig(e,t){let n=t?.find(o=>o.startsWith("climate.")),a=t?.find(o=>o.startsWith("fan.")),r=t?.find(o=>o.startsWith("water_heater."));return r?{soort:"boiler",entity:r}:n?{soort:"airco",entity:n}:a?{soort:"ventilatie",entity:a}:{soort:Ye}}};z(Sn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var gi=class extends C{defaults(){return{soort:Ye}}soort_(){return gt[this.config_?.soort]?this.config_.soort:Ye}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:Qe(this.soort_()).icoon,auto:!1}]}sync_(){super.sync_();for(let e of this.pickers_??[])e.dataset.key==="icon"&&(e.fallback=Qe(this.soort_()).icoon)}schema(){let e=this.soort_(),t=Be(e).map(r=>({name:r.key,selector:{entity:{domain:r.domeinen,...r.device_class?{device_class:r.device_class}:{}}}})),a=ci(e,"hoofd")[0]?.domeinen.some(r=>r==="climate"||r==="water_heater");return[{name:"soort",selector:b.select(Object.entries(gt).map(([r,o])=>({value:r,label:o.label})))},{name:"name",selector:b.text()},...t,...a?[{name:"step",selector:b.number(.1,5,.1)}]:[]]}label(e){let t=Be(this.soort_()).find(n=>n.key===e.name);return t?t.label:{soort:"Soort apparaat",name:"Naam",step:"Stap van de temperatuurknoppen"}[e.name]??super.label(e)}helper(e){let t=Be(this.soort_()).find(n=>n.key===e.name);if(t?.hulp)return t.hulp;if(e.name==="soort")return"Bepaalt welke velden hieronder staan, het icoon, en hoe de statusregel leest.";if(e.name==="name")return`Leeg laten geeft de naam van het apparaat, of anders "${Qe(this.soort_()).naam}".`;if(e.name==="step")return"Leeg laten volgt het apparaat: een halve graad bij een climate, een hele bij een boiler."}};I("domotiapp-hvac-card-editor",gi);N("domotiapp-hvac-card",Sn,{name:"DomotiApp HVAC",description:"Airco, warmtepomp, ventilatie of boiler: status, metingen als tegels, de standen van het apparaat, doeltemperatuur en boost."});var Nn=i=>String(i??"").split(".")[0],bs=new Set(["input_datetime","time","date","datetime"]),vs=i=>bs.has(Nn(i)),xe=i=>String(i).padStart(2,"0");function Zp(i){let e=String(i??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function fi(i){if(!i)return null;let e=Nn(i.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=i.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:Zp(i.state)}var Xp=i=>`${i.getFullYear()}-${xe(i.getMonth()+1)}-${xe(i.getDate())}T${xe(i.getHours())}:${xe(i.getMinutes())}`;function Yp(i){let e=-i.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${xe(Math.floor(n/60))}:${xe(n%60)}`}function ks(i,e=fi(i)){if(!i||!e)return"";let t=String(i.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let a=t.match(/^(\d{1,2}):(\d{2})/);return a?`${xe(a[1])}:${a[2]}`:""}if(e==="date"){let a=t.match(/^(\d{4}-\d{2}-\d{2})$/);return a?a[1]:""}if(Nn(i.entity_id)==="datetime"){let a=new Date(t);return Number.isNaN(+a)?"":Xp(a)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${xe(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function xs(i,e,t){let n=Nn(i),a=String(t??"");if(!a||!bs.has(n)||!e)return null;if(e==="time"){let h=a.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let g=`${xe(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:i,time:g}]:["input_datetime","set_datetime",{entity_id:i,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(a)?n==="date"?["date","set_value",{entity_id:i,date:a}]:["input_datetime","set_datetime",{entity_id:i,date:a}]:null;let r=a.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,l,d,c]=r,p=`${xe(d)}:${c}:00`;if(n==="datetime"){let h=Yp(new Date(+o,+s-1,+l,+d,+c));return["datetime","set_value",{entity_id:i,datetime:`${o}-${s}-${l}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:i,datetime:`${o}-${s}-${l} ${p}`}]}var ws={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},Qp=/^.*program(?:me)?[_.\- ]/i,Jp=30,eh=95;function th(i){return String(i??"").replace(Qp,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function nh(i){let e=th(i);if(!e.length)return"";let t=[];for(let a=0;a<e.length;a++){let r=e[a],o=r.toLowerCase();if(/^\d+$/.test(o)){let d=Number(o);t.push(d>=Jp&&d<=eh?`${d} \xB0C`:o);continue}let s=e[a+1]?.toLowerCase(),l=s?ws[o+s]:void 0;if(l){t.push(l),a++;continue}t.push(ws[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function ah(i,e){let t=a=>String(a??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(i)}function On(i,e){return ah(i,e)?String(e):nh(i)||String(i??"")}var Dn={row:44,tile:96,compact:44,beeld:120},Pe=6,_s=12,bi=22,ih=["row","tile","compact","beeld"],rh=["links","midden"],vi=48,ki=320,Tn=120,we=i=>{if(i==null||i==="")return Tn;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(ki,Math.max(vi,e)):Tn},Vt=i=>rh.includes(i)?i:"links";function ys(i,e){let t=Array.isArray(i)?i:[],n=Array.from({length:e},(a,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var oh=["card","items","none","open"],Ln=i=>typeof i?.name=="string"?i.name.trim():"",Bt=i=>typeof i=="string"?{entity:i}:{...i},Pt=i=>Math.min(Math.max(1,Number(i)||2),3),ft=i=>ih.includes(i)?i:"row",ce=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function zs(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(n=>{let a=Pt(n.columns);return{columns:a,layout:ft(n.layout),align:Vt(n.align),image_size:we(n.image_size),column_names:ys(n.column_names,a),items:(n.items??n.entities??[]).map(Bt)}});let e=(i?.items??i?.entities??[]).map(Bt);if(!e.length)return[];let t=Pt(i.columns);return[{columns:t,layout:ft(i.layout),align:Vt(i.align),image_size:we(i.image_size),column_names:ys(i.column_names,t),items:e}]}function Cn(i){return oh.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var sh=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns)),lh=22;function dh(i){let e=ft(i?.layout);return e!=="beeld"?Dn[e]:we(i?.image_size)+34}function xi(i){let e=i?.rows??[],t=Ln(i)?bi+Pe:0;if(!e.length)return _s+t+Dn.row;let n=(Cn(i)==="card"?_s:0)+t;for(let a of e){let r=sh(a);n+=r*dh(a)+(r-1)*Pe,a.column_names?.length&&(n+=lh+Pe)}return n+(e.length-1)*Pe}function Kt(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();ce(e)&&i.bewaard.push(e)}return i}function js(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Pt(n.columns),layout:ft(n.layout),align:Vt(n.align),image_size:we(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(Bt)})):(()=>{let n=(i.items??i.entities??[]).map(Bt);return n.length?[{columns:Pt(i.columns),layout:ft(i.layout),align:Vt(i.align),image_size:we(i.image_size),column_names:Array.isArray(i.column_names)?[...i.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]),a.forEach((r,o)=>t.push(Kt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var wi=i=>i.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Tn?{image_size:we(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ce).map(n=>structuredClone(n))}}).filter(e=>e.items.length);function _i(i,e,t){let n=new Set;for(let a of i){let r=/^r(\d+)(?:i(\d+))?$/.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]===void 0?"":`i${r[2]}`;if(t==="weg"){if(o===e)continue;n.add(o>e?`r${o-1}${s}`:a);continue}n.add(o>e?`r${o+1}${s}`:a)}return n}var $s=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],ch=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],ph=i=>$s.find(e=>e.waarde===i)?.label??"Rij",hh=`
...
`,yi=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=js(e);this.gebouwd_&&JSON.stringify(wi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){this.open_=_i(this.open_,e,"weg")}rijErbij_(e){this.open_=_i(this.open_,e,"erbij")}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{ce(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=hh;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=Kt({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(O=>({waarde:O,label:String(O),titel:`${O} entiteit${O>1?"en":""} in deze rij`})),()=>e.columns,O=>{e.columns=O,Kt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg dupliceer",c.title="Rij dupliceren",c.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2"/><path d="M6.5 15H5.6A1.6 1.6 0 0 1 4 13.4V5.6A1.6 1.6 0 0 1 5.6 4h7.8A1.6 1.6 0 0 1 15 5.6v.9"/></svg>',this.binnenKop_(c,()=>{this.rows_.splice(t+1,0,structuredClone(this.rows_[t])),this.rijErbij_(t),this.open_.add(`r${t+1}`),this.emit_(),this.build_()});let p=document.createElement("button");p.type="button",p.className="weg",p.title="Rij verwijderen",p.textContent="\u2715",this.binnenKop_(p,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c,p);let h=document.createElement("div");h.className="rijbody";let g=this.segment_($s.map(O=>({waarde:O.waarde,label:O.label})),()=>e.layout,O=>{e.layout=O,fe(),this.emit_()}),u=document.createElement("div");u.className="vormrij";let k=document.createElement("b");k.textContent="Vorm van deze rij",u.append(k,g.wrap),h.appendChild(u);let x=this.segment_(ch.map(O=>({waarde:O.waarde,label:O.label})),()=>e.align??"links",O=>{e.align=O,this.emit_()}),w=document.createElement("div");w.className="vormrij";let y=document.createElement("b");y.textContent="Uitlijning",w.append(y,x.wrap),h.appendChild(w);let V=document.createElement("div");V.className="beeldvak";let B=document.createElement("ha-form");B.hass=this.hass_,B.schema=[{name:"image_size",selector:{number:{min:vi,max:ki,step:4,mode:"slider"}}}],B.computeLabel=()=>"Grootte van de afbeelding",B.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",B.data={image_size:we(e.image_size)},B.addEventListener("value-changed",O=>{O.stopPropagation(),e.image_size=we(O.detail.value?.image_size),this.emit_()}),V.appendChild(B),h.appendChild(V);let fe=()=>{let O=e.layout==="beeld";V.style.display=O?"":"none",w.style.display=O?"none":""};fe();let ue=document.createElement("div");ue.className="kolomvak";let be=document.createElement("ha-form");be.hass=this.hass_;let Do=()=>Array.from({length:e.columns},(O,se)=>({name:`k${se}`,selector:{text:{}}}));be.schema=Do(),be.computeLabel=O=>`Kop boven kolom ${Number(O.name.slice(1))+1}`,be.computeHelper=O=>O.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let Lo=()=>Object.fromEntries(Array.from({length:e.columns},(O,se)=>[`k${se}`,e.column_names?.[se]??""]));be.data=Lo(),be.addEventListener("value-changed",O=>{O.stopPropagation();let se=O.detail.value??{};e.column_names=Array.from({length:e.columns},(Ro,lp)=>se[`k${lp}`]??""),this.emit_()}),ue.appendChild(be),h.appendChild(ue);let Co=()=>{let O=e.items.filter(ce),se=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&se.push(ph(e.layout)),se.push(O.length?O.map(Ro=>this.itemNaam_(Ro)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&se.push("met kolomkoppen"),l.textContent=se.join(" \xB7 "),d.vernieuw(),g.vernieuw(),x.vernieuw(),fe(),be.schema.length!==e.columns&&(be.schema=Do()),be.data=Lo()};return this.koppen_.push(Co),e.items.forEach((O,se)=>h.appendChild(this.itemBlok_(e,O,t,se))),n.append(a,h),Co(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(a,1),this.itemWeg_(n,a),Kt(e),this.emit_(),this.build_()}),o.append(s,l,d,h);let g=document.createElement("div");g.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",u.addEventListener("value-changed",y=>{y.stopPropagation(),t.entity=y.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",y=>{y.stopPropagation(),y.detail.value?t.icon=y.detail.value:delete t.icon,this.emit_()});let x=document.createElement("ha-form");x.hass=this.hass_,x.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],x.computeLabel=y=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[y.name]??y.name,x.computeHelper=y=>{if(y.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(y.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(y.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(y.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},x.addEventListener("value-changed",y=>{y.stopPropagation();let V=y.detail.value;V.name?t.name=V.name:delete t.name,V.toggle===!0?t.toggle=!0:delete t.toggle;for(let B of["show_icon","show_name","show_state"])V[B]===!1?t[B]=!1:delete t[B];for(let B of["icon_tap_action","icon_hold_action","tap_action","hold_action"])V[B]?t[B]=V[B]:delete t[B];V.double_tap_action&&V.double_tap_action.action!=="none"?t.double_tap_action=V.double_tap_action:delete t.double_tap_action,this.emit_()});let w=()=>{c.textContent=ce(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ce(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ce(t)),h.hidden=!ce(t)};return this.koppen_.push(w),u.data={entity:t.entity||void 0},k.value=t.icon??"",x.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(u,k,x),r.append(o,g),w(),r}emit_(){let e=wi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};D("domotiapp-entities-card-editor",yi);var Rn=class extends S{validate(e){let t=zs(e);return t.some(n=>n.items.some(ce))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[L]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?X(e.tone):this.config.tone?X(this.config.tone):Ee(e.entity)!=="light"?E.accent:Po(v(this.hass,e.entity))??E.lit}metSchakelaar_(e){return!!e.toggle&&Ko(e.entity)}metTijd_(e){return!vs(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!di(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Cn(e)),this.style.containerType="inline-size";let t=Cn(e)==="items",n=e.rows.map((o,s)=>{let l=e.state_position==="right"&&o.layout!=="tile",d=`<span class="st${l?" rechts":""}"></span>`,c=o.items.map((h,g)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${l?d:""}
            ${this.metSchakelaar_(h)?En({label:"Aan of uit"}):""}
      ...
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:Dn[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${Ln(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,l)=>Ae(this,this.hass,t,t[s]??l),a={action:t.entity?"more-info":"none"};this.teardown_.push(U(e,{onTap:()=>n("tap_action",a),onHold:()=>n("hold_action",a),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(U(r,{onTap:()=>n("icon_tap_action",Rt(t.entity)),onHold:()=>n("icon_hold_action",a)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let l=null,d=null,c=()=>{clearTimeout(d),d=null;let p=l;l=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(d)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),l=xs(t.entity,h.type,h.value),clearTimeout(d),d=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=l=>{l.target?.closest?.(".keuze")&&l.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",l=>{let d=l.target?.closest?.(".keuze");if(!d)return;l.stopPropagation();let c=v(this.hass,t.entity),p=mt(t.entity,d.value,ke(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(An(o,{value:()=>Y(v(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>ne(v(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,Ln(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let a=v(this.hass,n.entity),r=Y(a),o=!!n.entity&&ne(a);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let l=M(this.hass,n.entity,n.name),d=t.querySelector(".chip");if(d){let y=bn(this.hass,n.entity,n.icon),V=n.icon||(y?`pic:${y}`:Ua(n.entity,Z(this.hass,n.entity)));d.dataset.icon!==V&&(d.dataset.icon=V,d.classList.toggle("pic",!!y),d.innerHTML=y?`<img src="${y}" alt="" loading="lazy" />`:f(n.icon||Ua(n.entity,Z(this.hass,n.entity)))),d.style.setProperty("--tone",y?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),d.setAttribute("aria-label",n.entity?`${l} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,l);let p=t.querySelector(".toggle");p&&(It(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${l} aan of uit`));let h=t.querySelector(".tijdslot"),g=null;if(h){let y=o?null:fi(a);h.dataset.soort!==(y??"")&&(h.dataset.soort=y??"",h.innerHTML=y?`<input class="tijd" type="${y}" step="60" />`:""),g=h.querySelector(".tijd")}if(g&&(g.setAttribute("aria-label",`${l} instellen`),this.shadowRoot.activeElement!==g)){let y=ks(a,h.dataset.soort);g.value!==y&&(g.value=y)}let u=t.querySelector(".keuzeslot"),k=null;if(u){let y=o?[]:ke(a),V=y.map(fe=>On(fe,this.hass?.formatEntityState?.(a,fe))),B=JSON.stringify([y,V]);u.dataset.opties!==B&&(u.dataset.opties=B,u.innerHTML=y.length?`<select class="keuze">${y.map((fe,ue)=>`<option value="${_(fe)}">${_(V[ue])}</option>`).join("")}</select>`:""),k=u.querySelector(".keuze")}if(k&&(k.setAttribute("aria-label",`${l} kiezen`),this.shadowRoot.activeElement!==k)){let y=ut(a);k.value!==y&&(k.value=y)}let x=t.querySelector(".st"),w=n.show_state??this.config.show_state;if(p||g||k)x.textContent="";else if(w===!1)x.textContent="";else if(o)x.textContent="Niet bereikbaar";else if(!a||Ga(a.entity_id))x.textContent="";else if(Ee(a.entity_id)==="light"&&r&&a.attributes.brightness!=null)x.textContent=`${Math.round(a.attributes.brightness/255*100)}%`;else{let y=a.attributes.unit_of_measurement;x.textContent=y?`${a.state} ${y}`:ee(this.hass,a)}t.setAttribute("aria-label",`${l}${a?`, ${ee(this.hass,a)}`:""}`)})}getCardSize(){return Me(xi(this.config))}getGridOptions(){let e=Me(xi(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};z(Rn,"css",`
    :host { display: block; height: 100%; }

    .card {
      height: 100%; min-height: 56px; padding: 5px 10px;
      display: flex; flex-direction: column; justify-content: center; gap: ${Pe}px;
    }
  ...
  `);N("domotiapp-entities-card",Rn,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var Q={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},J=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),bt=i=>!i||i.state==="off",zi=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),Gt=i=>i?.state==="playing",Es=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function As(i){if(!i)return[];let e=[];return(J(i,Q.TURN_ON)||J(i,Q.TURN_OFF))&&e.push("power"),bt(i)||(J(i,Q.PREVIOUS_TRACK)&&e.push("prev"),J(i,Q.PLAY)||J(i,Q.PAUSE)||J(i,Q.PLAY_MEDIA)?e.push("play"):J(i,Q.STOP)&&e.push("stop"),J(i,Q.NEXT_TRACK)&&e.push("next")),e}var Je=i=>i?.volume_entity||i?.entity;function ji(i){if(!zi(i))return[];let e=[];return J(i,Q.VOLUME_MUTE)&&e.push("mute"),J(i,Q.VOLUME_SET)?e.push("slider"):J(i,Q.VOLUME_STEP)&&e.push("steps"),e}var Ke=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Ms=i=>i?.attributes?.volume_level!==void 0&&i?.attributes?.volume_level!==null,Wt=i=>!!i?.attributes?.is_volume_muted,$i=i=>!!i?.attributes?.mass_player_type,Ei=i=>!!i?.attributes?.shuffle,Ai=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ss=i=>({off:"all",all:"one",one:"off"})[uh(i)]??"all",uh=i=>["off","all","one"].includes(i)?i:"off";function Mi(i,{zoeken:e=!0,sleep:t=!1}={}){if(!zi(i))return[];let n=[];return J(i,Q.SHUFFLE_SET)&&n.push("shuffle"),J(i,Q.REPEAT_SET)&&n.push("repeat"),t&&n.push("sleep"),e&&$i(i)&&n.push("search"),n}function Ns(i,{tonen:e=!0}={}){if(!e||!zi(i)||!J(i,Q.SELECT_SOURCE)||$i(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Hn(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function Ut(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var mh="domotiapp-media-speler:";function Si(i,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],a=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(i?.players)&&i.players.length?[...new Set([...n(i?.entity)?[i.entity]:[],...i.players.filter(n)])]:gh(a(),e)).sort((s,l)=>String(t(s)).localeCompare(String(t(l)),"nl"))}function gh(i,e){let t=i.filter(n=>$i(e?.states?.[n]));return t.length?t:i}var Os=i=>mh+(i??[]).join("|");function Ts(i,e,t){if(!i?.speaker_select)return i?.entity??"";let n=null;try{n=t?.getItem?.(Os(e))??null}catch{n=null}return n&&e?.includes(n)?n:i.entity&&e?.includes(i.entity)?i.entity:i.entity||e?.[0]||""}function Ds(i,e,t){try{return i?.setItem?.(Os(e),String(t)),!0}catch{return!1}}var Ni="dacScrollSlot",Ls=["position","top","left","right","width","overflow"];function In(i=globalThis.document,e=globalThis.window){let t=i?.body;if(!t?.style||t.dataset?.[Ni])return()=>{};let n=e?.scrollY??i.documentElement?.scrollTop??0,a=Object.fromEntries(Ls.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[Ni]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of Ls)t.style[o]=a[o];t.dataset&&delete t.dataset[Ni],e?.scrollTo?.(0,n)}}}var fh=[400,1e3,2e3,4e3,8e3,15e3,3e4],bh=6e4;function pe(i){let e=i?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(i?.message??""))}var le=class{constructor(e,{wachttijden:t=fh,traag:n=bh,klok:a,stopKlok:r}={}){this.doe_=e,this.wachttijden_=t,this.traag_=n,this.klok_=a??((o,s)=>setTimeout(o,s)),this.stopKlok_=r??(o=>clearTimeout(o)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){let e=this.magNog;if(this.timer_)return e;let t=e?this.wachttijden_[this.poging]:this.traag_;return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},t),e}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}},_e=class{constructor(){this.was_=!0}herverbonden(e){let t=e?.connected!==!1,n=t&&!this.was_;return this.was_=t,n}};var vh=`
  :host {
    ${W}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Oi=null,Cs=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Ti=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Oi=Oi??[q(vh)],this.shadowRoot.adoptedStyleSheets=Oi}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
      ...
      </div>`,this.gebouwd_=!0,this.$(".nee").addEventListener("click",()=>this.klaar_(!1)),this.$(".ja").addEventListener("click",()=>this.klaar_(!0)),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.klaar_(!1)}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.klaar_(!1)})}$(e){return this.shadowRoot.querySelector(e)}open(e){return this.gebouwd_||this.bouw_(),this.$("h2").innerHTML=Cs(e.title??"Weet je het zeker?"),this.$("p").innerHTML=Cs(e.text??"Weet je zeker dat je dit wilt doen?"),this.$(".nee").textContent=e.dismissText??"Annuleren",this.$(".ja").textContent=e.confirmText??"OK",this.setAttribute("open",""),setTimeout(()=>this.$(".nee")?.focus(),40),new Promise(t=>{this.antwoord_=t})}klaar_(e){if(!this.hasAttribute("open"))return;this.removeAttribute("open");let t=this.antwoord_;this.antwoord_=null,t?.(e)}};D("domotiapp-vraag",Ti);function ye(i={}){let e=document.querySelector("domotiapp-vraag");e||(e=document.createElement("domotiapp-vraag"),document.body.appendChild(e)),e.tabIndex=-1;let t=e.open(i);return e.focus?.(),t}Bo(ye);var Rs=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var Ge=i=>`domotiapp_lovelace/media/${i}`;function kh(i,e){if(!i)return null;if(e)return i.uri?{type:Ge("favorite"),favorite:!0,uri:i.uri}:null;let t=Hs(i);return!t||!i.library_item_id?null:{type:Ge("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function Hs(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Is={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},Di=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function Vs(i,e,t=null){return i?.kind??Hs(e)??t??"playlists"}var Li=i=>!!i?.uri,Vn=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:Ge("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),Bs=(i,e,t)=>{let n=kh(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Ps=(i,e)=>i.callWS({type:Ge("playlist/create"),name:e}).then(t=>t?.playlist??null),Ks=(i,e)=>i.callWS({type:Ge("playlist/remove"),library_item_id:String(e.library_item_id)}),Gs=(i,e)=>i.callWS({type:Ge("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Ws=(i,e,t)=>i.callWS({type:Ge("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Us=(i,e,t)=>i.callWS({type:Ge("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var xh=350,wh={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function _h(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=wh[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var yh=`
  :host {
    ${W}
...
`,Ci=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(Ce+yh)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[],this.zoekHerkansing_=new le(()=>this.zoek_()),this.speakerHerkansing_=new le(()=>this.haalSpeakers_())}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.scrollLos_??=In(),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.scrollLos_?.(),this.scrollLos_=null}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${Di.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
          ...
          <div class="rij" data-i="${a}" data-knoppen="${d}">
            ...
            <div class="spreker" data-speaker="${o.entity_id}" data-zelf="${s}" data-mee="${l}">
              <button class="mee" type="button" data-speaker="${o.entity_id}"
                ...
                ${f(l?"volume":"speaker")}<span>${this.veilig_(o.name)}</span>
              </button>
              ${l&&d?`${ve()}<span class="pct tnum"></span>`:l?'<span class="stil">geen volumeregeling</span>':""}
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let l=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let d=He(s,{value:()=>Ke(v(this.hass,l)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:l})});this.schuiven_.set(l,d)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,l=o.querySelector(".slider");if(!l||l.classList.contains("dragging"))continue;let d=v(this.hass,s),c=Ke(d);this.zetSchuif_(l,c,Wt(d))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let a=e.parentElement.querySelector(".pct");a&&(a.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=v(this.hass,this.entity_);if(typeof n?.attributes?.volume_level!="number")return;let a=Ke(n),r=v(this.hass,e);J(r,Q.VOLUME_SET)&&Ke(r)!==a&&this.hass.callService("media_player","volume_set",{volume_level:a/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.zoekHerkansing_.stop(),this.speakerHerkansing_.stop(),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};D("domotiapp-media-browser",Ci);function Fs(i,e,t,n={}){let a=document.querySelector("domotiapp-media-browser");return a||(a=document.createElement("domotiapp-media-browser"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var zh=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Ri=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[q(zh+Ce)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="lijst" role="listbox"></div>
                ...
                </button>`}).join("")}kies_(e){!e||!this.hass||(this.hass.callService("media_player","select_source",{entity_id:this.entity_,source:e}),this.sluit())}};D("domotiapp-bron-kiezer",Ri);function qs(i,e,t){let n=document.querySelector("domotiapp-bron-kiezer");return n||(n=document.createElement("domotiapp-bron-kiezer"),document.body.appendChild(n)),n.tabIndex=-1,n.open(i,e,t),n.focus?.(),n}function Zs(i,e){let t=i?.states?.[e]?.attributes?.group_members;return new Set(Array.isArray(t)?t:[])}var jh=524288;function $h(i,e){let t=i?.states?.[e];return!t||t.state==="unavailable"?!1:(Number(t.attributes?.supported_features)&jh)!==0}function Hi(i,e,t){return e===t?"zelf":$h(i,e)?Eh(i,e,t)?"mee":"los":"kan-niet"}function Eh(i,e,t){if(Zs(i,t).has(e))return!0;if(Zs(i,t).size===0){let n=i?.states?.[e]?.attributes?.group_members;if(Array.isArray(n)&&n.includes(t))return!0}return!1}function Xs(i,e,t){let n=Hi(i,e,t);return n==="zelf"||n==="kan-niet"?null:n==="mee"?{domein:"media_player",service:"unjoin",data:{},doel:{entity_id:e}}:{domein:"media_player",service:"join",data:{group_members:[e]},doel:{entity_id:t}}}var Ah=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,Ii=null,Bn=i=>String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Vi=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Ii=Ii??[q(Ah)],this.shadowRoot.adoptedStyleSheets=Ii,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="tel"></div>
        <div class="lijst" role="listbox"></div>
      </div>`,this.gebouwd_=!0;let e=(t,n,a)=>{t.addEventListener(n,a),this.opruimen_.push(()=>t.removeEventListener(n,a))};e(this.$(".sluit"),"click",()=>this.sluit()),e(this.$(".laag"),"click",t=>{t.target===this.$(".laag")&&this.sluit()}),e(this.$("input"),"input",t=>{this.filter_=t.target.value.trim().toLowerCase(),this.teken_()}),e(this.$("input"),"keydown",t=>{t.key==="Enter"&&this.$(".sp")?.click()}),e(this,"keydown",t=>{t.key==="Escape"&&this.hasAttribute("open")&&this.sluit()}),e(this.$(".lijst"),"click",t=>{let n=t.target.closest(".mee");if(n)return t.stopPropagation(),this.koppel_(n.dataset.id);let a=t.target.closest(".sp");a&&this.kies_(a.dataset.id)})}$(e){return this.shadowRoot.querySelector(e)}set hass(e){this.hass_=e,this.hasAttribute("open")&&this.gebouwd_&&this.teken_()}get hass(){return this.hass_}open(e,t,n,a){this.hass_=e,this.lijst_=Array.isArray(t)?t:[],this.huidig_=n,this.opKeuze_=a,this.filter_="",this.gebouwd_||this.bouw_(),this.$("input").value="",this.$(".zoek").hidden=this.lijst_.length<8,this.setAttribute("open",""),this.teken_(),this.$(".zoek").hidden||setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open")}teken_(){let e=this.lijst_,t=this.filter_?e.filter(a=>String(M(this.hass,a)).toLowerCase().includes(this.filter_)):[...e];this.$(".sub").textContent=this.huidig_?`Nu: ${M(this.hass,this.huidig_)}`:"",this.$(".tel").textContent=this.filter_?`${t.length} van ${e.length}`:`${e.length} speaker${e.length===1?"":"s"}`;let n=this.$(".lijst");if(!t.length){n.innerHTML='<div class="leeg">Niets gevonden.</div>';return}n.innerHTML=t.map(a=>{let r=v(this.hass,a),o=a===this.huidig_,s=bt(r)?"Uit":Hn(r,c=>ee(this.hass,c)),l=Hi(this.hass,a,this.huidig_),d=l==="mee";return`<div class="rij">
                  <button class="sp" type="button" role="option" data-id="${Bn(a)}"
                    data-speelt="${Gt(r)}" data-uit="${bt(r)}"
                    aria-current="${o}" aria-selected="${o}">
                    <span class="ico">${f(Ut(r),"speaker")}</span>
                    <span class="tekst">
                      <b>${Bn(M(this.hass,a))}</b>
                      <span>${Bn(d?`${s} \xB7 speelt mee`:s)}</span>
                    </span>
                    ${o?'<span class="nu">NU</span>':""}
                  </button>
                  <button class="mee" type="button" data-id="${Bn(a)}"
                    ...
                    ${f(d?"volume":"speakers")}<span>${d?"MEE":"ERBIJ"}</span>
                  </button>
                </div>`}).join("")}koppel_(e){let t=Xs(this.hass,e,this.huidig_);t&&this.hass.callService(t.domein,t.service,t.data,t.doel)}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};D("domotiapp-speler-kiezer",Vi);function Ys(i,e,t,n){let a=document.querySelector("domotiapp-speler-kiezer");return a||(a=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(a)),a.tabIndex=-1,a.open(i,e,t,n),a.focus?.(),a}var Bi=[15,30,45,60,90],Pi=30;function Qs(i){let e=Math.max(0,Math.round(i)),t=Math.floor(e/3600),n=Math.floor(e%3600/60),a=e%60,r=t?String(n).padStart(2,"0"):String(n);return`${t?`${t}:`:""}${r}:${String(a).padStart(2,"0")}`}function Ki(i,{min:e=1,max:t=720}={}){let n=String(i??"").trim();if(!/^\d+$/.test(n))return null;let a=Number(n);return a>=e&&a<=t?a:null}var Mh=`
  :host {
    ${W}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,Gi=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(Mh)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <div class="vak" role="dialog" aria-modal="true" aria-label="Sleeptimer">
          <header>
            <span class="ic">${f("sleep")}</span>
            <span class="t">
              <h2>Sleeptimer</h2>
              <span class="waar"></span>
            </span>
            <button class="sluit" type="button" aria-label="Sluiten">${f("close")}</button>
          </header>
      ...
      </div>`,this.$(".snel").innerHTML=Bi.map(e=>`<button type="button" data-m="${e}" aria-pressed="false">${e}</button>`).join(""),this.$(".sluit").addEventListener("click",()=>this.dicht_()),this.$(".laag").addEventListener("click",e=>{e.target===this.$(".laag")&&this.dicht_()}),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.dicht_(),e.key==="Enter"&&!this.hasAttribute("loopt")&&this.start_()}),this.$(".snel").addEventListener("click",e=>{let t=e.target.closest("[data-m]");t&&(this.$(".min").value=t.dataset.m,this.markeer_())}),this.$(".min").addEventListener("input",()=>this.markeer_()),this.$(".doe").addEventListener("click",()=>this.start_()),this.$(".weg").addEventListener("click",()=>this.stop_()),this.gebouwd_=!0}markeer_(){let e=this.$(".min").value.trim();for(let t of this.$(".snel").querySelectorAll("[data-m]"))t.setAttribute("aria-pressed",String(t.dataset.m===e));this.$(".fout").hidden=!0}async open(e,t,n){this.gebouwd_||this.bouw_(),this.hass=e,this.entity_=t,this.$(".waar").textContent=n??t,this.$(".min").value=String(Bi[1]),this.$(".fade").value=String(Pi),this.markeer_(),this.setAttribute("open",""),this.tabIndex=-1,this.focus?.(),await this.haalStand_(),this.hasAttribute("loopt")||setTimeout(()=>this.$(".min")?.focus(),60)}dicht_(){this.removeAttribute("open"),clearInterval(this.tik_),this.tik_=null}async haalStand_(){let e=null;try{e=((await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/list"}))?.timers??[]).find(n=>n.entity_id===this.entity_)??null}catch{e=null}this.toon_(e)}toon_(e){if(clearInterval(this.tik_),this.tik_=null,this.$(".weg").hidden=!e,!e){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",this.$(".doe").hidden=!1;return}this.setAttribute("loopt",""),this.$(".doe").textContent="Opnieuw instellen",this.$(".doe").hidden=!1,this.$(".uitleg").textContent=e.fade?`De laatste ${e.fade} seconden zakt het volume weg, daarna pauzeert de muziek en gaat het volume terug.`:"Aan het eind pauzeert de muziek.";let t=Date.parse(e.ends_at),n=()=>{let a=(t-Date.now())/1e3;this.$(".rest").textContent=Qs(a),a<=0&&(clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.hasAttribute("open")&&this.haalStand_(),1500))};n(),this.tik_=setInterval(n,1e3)}async start_(){if(this.hasAttribute("loopt")){this.removeAttribute("loopt"),this.$(".doe").textContent="Starten",clearInterval(this.tik_),this.tik_=null,setTimeout(()=>this.$(".min")?.focus(),40);return}let e=Ki(this.$(".min").value);if(e===null){this.melding_("Vul een heel aantal minuten in, tussen 1 en 720.");return}let t=Ki(this.$(".fade").value,{min:0,max:600})??Pi;try{let n=await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/set",entity_id:this.entity_,minutes:e,fade:t});this.toon_(n)}catch(n){this.melding_(n?.message??"De sleeptimer kon niet gezet worden. Is DomotiApp Lovelace klaar met opstarten?")}}async stop_(){try{await this.hass.callWS({type:"domotiapp_lovelace/media/sleeptimer/cancel",entity_id:this.entity_})}catch{}await this.haalStand_()}melding_(e){let t=this.$(".fout");t.textContent=e,t.hidden=!1}};D("domotiapp-sleeptimer",Gi);function Js(i,e,t){let n=document.querySelector("domotiapp-sleeptimer");return n||(n=document.createElement("domotiapp-sleeptimer"),document.body.appendChild(n)),n.open(i,e,t??M(i,e)),n}var Pn={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"},sleep:{icon:"sleep",label:"Sleeptimer"}},Kn=class extends S{setConfig(e){this.ruw_=e,super.setConfig(this.metSpeler_(e))}metSpeler_(e){if(!e?.speaker_select)return e;let t=Si(e,this.hass),n=Ts(e,t,this.opslag_());return n&&n!==e.entity?{...e,entity:n}:e}set hass(e){let t=!this.hass_;if(super.hass=e,!t||!this.ruw_?.speaker_select)return;let n=this.metSpeler_(this.ruw_);n.entity&&n.entity!==this.config?.entity&&super.setConfig(n)}get hass(){return super.hass}opslag_(){try{return window.localStorage}catch{return null}}spelers_(){return Si(this.ruw_??this.config,this.hass)}groepsSpelers_(){let e=this.config.speakers;return Array.isArray(e)&&e.length||!this.config.speaker_select?e:this.spelers_()}kiesSpeler_(e){!e||e===this.config.entity||(Ds(this.opslag_(),this.spelers_(),e),super.setConfig({...this.ruw_,entity:e}))}validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[L]:e.speaker_select?"Zet er een mediaspeler in, of wacht tot Home Assistant er een meldt.":"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?X(this.config.tone):E.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(s,l)=>Ae(this,this.hass,e,e[s]??l);this.teardown_.push(H(this.$(".card"))),this.teardown_.push(U(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(U(n,{onTap:()=>t("icon_tap_action",Rt(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation());let a=this.$(".hoesgroot");a&&(this.teardown_.push(U(a,{onTap:()=>t("icon_tap_action",Rt(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(a,"click",s=>s.stopPropagation()),this.on(a,"pointerdown",s=>s.stopPropagation()));let r=s=>{let l=s.target.closest?.("[data-k]");l&&(s.stopPropagation(),this.doe_(l.dataset.k))},o=this.$(".spelers");o&&(this.on(o,"click",r),this.on(o,"pointerdown",s=>s.stopPropagation())),this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".vol"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".extra"),"pointerdown",s=>s.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=v(this.hass,t),a=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return a(bt(n)?"turn_on":"turn_off");case"bron":return qs(this.hass,t,M(this.hass,t,this.config.name));case"prev":return a("media_previous_track");case"next":return a("media_next_track");case"play":return a(Gt(n)?"media_pause":"media_play");case"stop":return a("media_stop");case"mute":{let r=Je(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Wt(v(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:Je(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!Ei(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:Ss(Ai(n))},{entity_id:t});case"speler":{let r=this.spelers_();return Ys(this.hass,r,t,o=>this.kiesSpeler_(o))}case"sleep":return Js(this.hass,t,M(this.hass,t,this.config.name));case"search":return Fs(this.hass,t,M(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.groepsSpelers_()});default:return}}paint(){let e=this.config,t=v(this.hass,e.entity),n=!t||t.state==="unavailable",a=Es(t),r=this.$(".top");r.dataset.on=String(a),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:bn(this.hass,e.entity,e.icon),l=s?`pic:${s}`:e.icon||Ut(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:f(l,"speaker")),o.style.setProperty("--tone",a&&!s?this.tone_():"var(--dac-ink-3)");let d=this.$(".hoesgroot");d&&d.dataset.icon!==l&&(d.dataset.icon=l,d.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:f(e.icon||Ut(t),"speaker"));let c=M(this.hass,e.entity,e.name),p=Hn(t,g=>ee(this.hass,g)),h=this.$(".spelers");if(h){let g=M(this.hass,e.entity);this.text(".spelers .waar",g),h.setAttribute("aria-label",`Speaker kiezen. Nu: ${g}`)}this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),T(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),a=this.config.show_controls===!1||t?[]:As(e),r=a.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${Pn[s].label}">${f(Pn[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=Gt(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=f(s))}}paintVolume_(e,t){let n=this.$(".vol"),a=Je(this.config),r=a===this.config.entity?e:v(this.hass,a),o=this.config.show_volume===!1||t?[]:ji(r),s=t?null:Ns(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let l=Ms(r)&&(o.includes("slider")||o.includes("steps")),d=[...o,s?"bron":"",l?"pct":""].join(",");n.dataset.sig!==d&&(n.dataset.sig=d,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${f("volume")}</button>`:"")+(o.includes("slider")?ve("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${f("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${f("plus")}</button>`:"")+(l?'<span class="pct tnum"></span>':"")+(s?`<button class="bronknop" type="button" data-k="bron">${f("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let c=n.querySelector(".bronknop");if(c){let k=s.nu||"Bron";this.text(c.querySelector("b"),k),c.setAttribute("aria-label",`Bron kiezen, nu ${k}`),c.title=`Kies uit ${s.aantal} bronnen`}let p=Wt(r),h=Ke(r),g=n.querySelector('[data-k="mute"]');if(g){let k=p?"volumeMute":"volume";g.dataset.icon!==k&&(g.dataset.icon=k,g.innerHTML=f(k)),g.setAttribute("aria-pressed",String(p))}let u=n.querySelector(".slider");u&&(this.attach_(u,"volume",{value:()=>Ke(v(this.hass,Je(this.config))),onInput:k=>this.setSlider_(u,k),onCommit:k=>this.hass.callService("media_player","volume_set",{volume_level:k/100},{entity_id:Je(this.config)}),disabled:()=>ne(v(this.hass,Je(this.config)))}),u.classList.contains("dragging")||this.setSlider_(u,h)),l&&this.text(".pct",p?"Gedempt":`${h}%`)}paintExtra_(e,t){let n=this.$(".extra"),a=t||this.config.show_controls===!1?[]:Mi(e,{zoeken:this.config.show_search!==!1,sleep:this.config.sleep_timer===!0});n.hidden=!a.length;let r=a.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=a.map((c,p)=>`${c==="search"&&p>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${c}" aria-label="${Pn[c].label}">${f(Pn[c].icon)}</button>`).join("")),!a.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(Ei(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let c=Ai(e),p=c==="one"?"repeatOne":"repeat";s.dataset.icon!==p&&(s.dataset.icon=p,s.innerHTML=f(p)),s.setAttribute("aria-pressed",String(c!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[c])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass);let d=document.querySelector("domotiapp-speler-kiezer");d?.hasAttribute("open")&&(d.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let a=He(e,n);this.sliders_.set(t,a),this.teardown_.push(a)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=v(this.hass,this.config?.entity);return 1+(ji(e).length?1:0)+(Mi(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("media_player."));return n?{entity:n}:{}}};z(Kn,"css",`
    :host { display: block; }
  ...
  `);var Wi=class extends C{defaults(){return{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"}]}schema(){return[{name:"entity",selector:b.entity("media_player")},{name:"name",selector:b.text()},{name:"speaker_select",selector:b.bool()},{name:"players",selector:{entity:{domain:"media_player",multiple:!0}}},{name:"layout",selector:b.select([{value:"row",label:"Rij (\xE9\xE9n rasterrij hoog)"},{value:"groot",label:"Groot (telefoonformaat, grote knoppen)"}])},{name:"volume_entity",selector:b.entity("media_player")},{name:"show_artwork",selector:b.bool()},{name:"show_controls",selector:b.bool()},{name:"show_volume",selector:b.bool()},{name:"show_source",selector:b.bool()},{name:"radio_mode",selector:b.bool()},{name:"speakers",selector:{entity:{domain:"media_player",integration:"music_assistant",multiple:!0}}},{name:"show_search",selector:b.bool()},{name:"sleep_timer",selector:b.bool()},{name:"icon_tap_action",selector:b.action("toggle")},{name:"icon_hold_action",selector:b.action("more-info")},{name:"tap_action",selector:b.action("more-info")},{name:"hold_action",selector:b.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",speaker_select:"Algemene mediaspeler",players:"Welke speakers je mag kiezen",layout:"Vorm",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_source:"Bronknop tonen",radio_mode:"Doorspelen na een nummer",speakers:"Speakers om mee te groeperen",show_search:"Zoeken en groeperen tonen",sleep_timer:"Sleeptimer tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="speaker_select")return"De kaart krijgt er een balk bij waarmee je kiest waar de muziek heen gaat. De speler hierboven is de standaard; de keuze wordt per apparaat onthouden, dus je telefoon en de tablet in de gang kunnen op iets anders staan.";if(e.name==="players")return"Laat je dit leeg, dan staan de speakers van Music Assistant in de lijst -- geen televisies of streamers, want daar stuur je geen muziek naartoe. Vul je er zelf een paar in, dan is dat de lijst, wat er ook in staat.";if(e.name==="layout")return"Groot is bedoeld voor een pop-up of een kolom waar de kaart alle ruimte krijgt: grote hoes, grote knoppen.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="sleep_timer")return"Zet er een knop bij waarmee je instelt hoe lang de muziek nog mag doorspelen. De laatste seconden zakt het volume weg, daarna pauzeert de speler en gaat het volume terug naar waar het stond. De timer loopt in Home Assistant zelf, dus hij telt gewoon door als je je telefoon weglegt.";if(e.name==="speakers")return'De speakers die onderin het zoekscherm staan om samen te laten spelen. Laat je dit leeg op een algemene mediaspeler, dan zijn dat dezelfde speakers als in de keuzelijst; op een gewone kaart valt hij terug op het label "Music Assistant Media" in Home Assistant.';if(e.name==="radio_mode")return"Zoals Spotify: is het gekozen nummer klaar, dan zoekt Music Assistant er zelf muziek bij in plaats van te stoppen. Staat dit uit, dan kan het nog steeds per keer via het menu bij een treffer.";if(e.name==="show_source")return"Voor een tv-ontvanger of een versterker met ingangen: een knop met de zender die nu aanstaat, die een zoekbaar overzicht opent. Kan de speler geen bron kiezen, dan verschijnt hij niet.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};I("domotiapp-media-card-editor",Wi);N("domotiapp-media-card",Kn,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var Ft=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd",rust:"Geen"},{sleutel:"co",label:"Koolmonoxide",icoon:"co",alarm:"Koolmonoxide gedetecteerd",rust:"Geen"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm",rust:"Normaal"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],el=i=>i?.rust??"Rustig",Ui=20;function Fi(i){if(!i||i.state==="unavailable"||i.state==="unknown")return null;if(String(i.entity_id??"").startsWith("binary_sensor."))return i.state==="on"?0:null;let e=Number(i.state);return Number.isFinite(e)?e:null}var Sh=i=>!!i&&i.state==="on",Nh=i=>!i||i.state==="unavailable"||i.state==="unknown";function tl(i,e){let t=i.filter(a=>!a.meting);for(let a of t)if(Sh(e(a.sleutel)))return{soort:"alarm",tekst:a.alarm,tone:"bad",icoon:a.icoon};if(i.length&&i.every(a=>Nh(e(a.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smokeDetector"};let n=Fi(e("battery"));return n!=null&&n<=Ui?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smokeDetector"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smokeDetector"}}var Oh={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},Gn=class extends S{validate(e){return Ft.filter(n=>e[n.sleutel]).length?{...e}:{...e,[L]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return Ft.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return Ft.filter(e=>this.config[e.sleutel])}toestand_(){let e=tl(this.gekozen_(),t=>v(this.hass,this.config[t]));return{...e,tone:Oh[e.tone]??E.accent}}batterijPct_(){return Fi(v(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare","");let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}" title="${t.label}">${f(t.icoon)}<b></b></span>`).join("");return`
      ...
      </div>`}wire(){let e=this.config,t=this.gekozen_()[0];this.teardown_.push(U(this.$(".top"),{onTap:()=>e.tap_action?Ae(this,this.hass,e,e.tap_action):P(this,e.smoke??e[t.sleutel]),onHold:()=>Ae(this,this.hass,e,e.hold_action??{action:"more-info"})})),this.$$(".pil").forEach(a=>{let r=e[a.dataset.soort];r&&(this.on(a,"click",o=>{o.stopPropagation(),P(this,r)}),this.on(a,"pointerdown",o=>o.stopPropagation()),a.style.cursor="pointer")});let n=this.$(".card");if(n&&typeof ResizeObserver=="function"){let a=new ResizeObserver(()=>this.pasAan_());a.observe(n),this.teardown_.push(()=>a.disconnect())}this.teardown_.push(H(this.$(".card")))}paint(){let e=this.config,t=this.toestand_(),n=this.$(".top");this.toggleAttribute("alarm",t.soort==="alarm"),n.style.setProperty("--tone",t.tone),n.classList.toggle("unavailable",t.soort==="weg");let a=this.$(".chip"),r=e.icon||t.icoon;a.dataset.icon!==r&&(a.dataset.icon=r,a.innerHTML=f(r,"smoke")),a.style.setProperty("--tone",t.tone);let o=this.gekozen_()[0];this.text(".nm",e.name||M(this.hass,e.smoke??e[o.sleutel],null)),this.text(".st",t.tekst),n.setAttribute("aria-label",`${this.$(".nm").textContent}${t.tekst?`, ${t.tekst}`:""}`),this.$$(".pil").forEach(s=>this.paintPil_(s)),this.$(".meta").hidden=this.gekozen_().length<=1&&!this.config.always_meta,this.pasAan_(),T(this.$(".card"))}pasAan_(){let e=this.$(".meta");if(!e||e.hidden)return;let t=()=>{let a=e.querySelector(".pil")?.offsetHeight??0;return a&&Math.round((e.scrollHeight+a/2)/a-.5)||1};this.removeAttribute("krapper"),!(t()<=1)&&this.setAttribute("krapper","")}paintPil_(e){let t=Ft.find(s=>s.sleutel===e.dataset.soort),n=v(this.hass,this.config[t.sleutel]),a=e.querySelector("b"),r=s=>e.setAttribute("aria-label",`${t.label}: ${s}`);if(!n||ne(n)){a.textContent="\u2014",r("onbekend"),e.dataset.let="";return}if(t.meting){let s=n.attributes.unit_of_measurement??"",l=Number(n.state);a.textContent=Number.isFinite(l)?`${K(this.hass,l,t.sleutel==="temperature"?1:0)} ${s}`.trim():ee(this.hass,n);let d=t.sleutel==="battery"?this.batterijPct_():null;e.dataset.let=d!=null&&d<=Ui?"warn":"",r(a.textContent);return}let o=Y(n);a.textContent=o?"Alarm":el(t),r(a.textContent),e.dataset.let=o?"bad":""}regels_(){return this.gekozen_().length>1?2:1}getCardSize(){return this.regels_()}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:this.minRijen_(".card",this.regels_())}}static getConfigElement(){return document.createElement("domotiapp-smoke-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("binary_sensor.")&&/rook|smoke/i.test(a));return n?{smoke:n}:{}}};z(Gn,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var qi=class extends C{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"smoke"}]}schema(){return[{name:"name",selector:b.text()},{name:"smoke",selector:b.entity()},{name:"co",selector:b.entity()},{name:"heat",selector:b.entity()},{name:"temperature",selector:b.entity()},{name:"battery",selector:b.entity()},{name:"tap_action",selector:b.action("more-info")},{name:"hold_action",selector:b.action("more-info")}]}label(e){return{name:"Naam (overschrijft die van de melder)",smoke:"Rook",co:"Koolmonoxide",heat:"Warmte",temperature:"Temperatuur",battery:"Batterij",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="smoke")return"Alle vijf zijn optioneel: vul in wat je melder heeft. Wat je leeg laat, komt niet op de kaart.";if(e.name==="battery")return"Een percentage of een 'batterij bijna leeg'-sensor. Onder de 20% meldt de kaart het uit zichzelf."}};I("domotiapp-smoke-card-editor",qi);N("domotiapp-smoke-card",Gn,{name:"DomotiApp Rookmelder",description:"Rook, koolmonoxide, warmte, temperatuur en batterij \u2014 alles optioneel."});var Th=["zo","ma","di","wo","do","vr","za"],nl=5,al=8,Wn=class extends S{validate(e){if(!e.entity)return{...e,[L]:"Kies een weerentiteit."};let t=Math.min(Math.max(1,Number(e.days)||nl),al);return{show_current:!0,forecast_type:"daily",...e,days:t}}watched(){return[this.config.entity]}template(){this.config.bare&&this.setAttribute("bare","");let e=this.config;return`
      ...
      </div>`}wire(){this.teardown_.push(H(this.$(".card"))),this.teardown_.push(U(this.$(".nu"),{onTap:()=>P(this,this.config.entity),onHold:()=>P(this,this.config.entity)})),this.abonneer_()}async abonneer_(){let e=this.config;this.opzeggen_?.(),this.opzeggen_=null;let t=this.hass?.connection;if(!t?.subscribeMessage){this.forecastFout_="Geen verbinding voor de voorspelling.",this.paintRij_();return}try{let n=await t.subscribeMessage(a=>{this.forecast_=a?.forecast??[],this.forecastFout_=null,this.paintRij_()},{type:"weather/subscribe_forecast",forecast_type:e.forecast_type==="hourly"?"hourly":"daily",entity_id:e.entity});if(!this.isConnected){n();return}this.opzeggen_=n,this.teardown_.push(()=>{try{n()}catch{}this.opzeggen_=null})}catch{this.forecastFout_=e.forecast_type==="hourly"?"Deze weerbron geeft geen uurvoorspelling.":"Deze weerbron geeft geen dagvoorspelling.",this.paintRij_()}}paint(){let e=this.config,t=v(this.hass,e.entity),n=ne(t);this.$(".nu").classList.toggle("unavailable",n);let r=this.$(".chip"),o=e.icon||Ht(t?.state);r.dataset.icon!==o&&(r.dataset.icon=o,r.innerHTML=f(o,"cloud")),this.text(".nm",M(this.hass,e.entity,e.name)),this.text(".st",n?"Niet bereikbaar":ee(this.hass,t));let s=this.$(".graden"),l=t?.attributes?.temperature,d=t?.attributes?.temperature_unit??"\xB0C";s.innerHTML=l==null?"":`${K(this.hass,l,Number.isInteger(l)?0:1)}<small>${d}</small>`,this.paintRij_(),T(this.$(".card"))}paintRij_(){let e=this.$(".rij");if(!e)return;let t=this.config;if(this.forecastFout_&&!this.forecast_?.length){e.style.setProperty("--n",1),e.innerHTML=`<div class="leeg">${this.forecastFout_}</div>`;return}let n=(this.forecast_??[]).slice(0,t.days);if(!n.length){e.style.setProperty("--n",1),e.innerHTML='<div class="leeg">Nog geen voorspelling ontvangen\u2026</div>';return}e.style.setProperty("--n",n.length);let a=v(this.hass,t.entity)?.attributes?.temperature_unit??"";e.innerHTML=n.map((r,o)=>{let s=this.wanneer_(r.datetime,o),l=f(Ht(r.condition),"cloud"),d=r.temperature==null?"":`${K(this.hass,r.temperature,0)}\xB0`,c=r.templow==null?"":`${K(this.hass,r.templow,0)}\xB0`,p=r.precipitation_probability==null?"":`<span class="nat">${f("drop")}${Math.round(r.precipitation_probability)}%</span>`;return`
  ...
  `);var Zi=class extends C{defaults(){return{show_current:!0,forecast_type:"daily",days:nl}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:b.entity("weather")},{name:"name",selector:b.text()},{name:"forecast_type",selector:b.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:b.number(1,al)},{name:"show_current",selector:b.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};I("domotiapp-forecast-card-editor",Zi);N("domotiapp-forecast-card",Wn,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var vt={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},il={open_cover:vt.OPEN,close_cover:vt.CLOSE,stop_cover:vt.STOP},rl=(i={},e={},t)=>i[t]??e[t],Xi=(i,e)=>!!rl(i,e,"poort"),Yi=(i,e)=>!!rl(i,e,"invert");function ol(i={},e=!1){if(e||i.device_class==="gate")return{open:"gateOpen",closed:"gate"};switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}}var sl=i=>i?{open:"Openen",close:"Sluiten"}:{open:"Open",close:"Dicht"},Dh={open:"closed",closed:"open",opening:"closing",closing:"opening"},ll=(i,e)=>e?Dh[i]??i:i,Un=(i,e)=>e&&i!=null?100-i:i;function Qi(i,e){if(i==="stop")return"stop_cover";let t=i==="open";return(e?!t:t)?"open_cover":"close_cover"}function dl({state:i,positie:e,aanname:t}){return e!=null?e>0?"open":"closed":i==="open"||i==="closed"?i:t??"closed"}function cl({dood:i,state:e,positie:t,toon:n=!0}){return i?"Niet bereikbaar":n?e==="opening"?"Gaat open":e==="closing"?"Gaat dicht":t!=null?`${t}% open`:e==="open"?"Open":e==="closed"?"Dicht":"":""}var Ji=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Fn=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[L]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e,t){let n=sl(t),a=(r,o,s)=>`<button type="button" class="${t?"tekst":""}" data-act="${r}" aria-label="${o}">${s}</button>`;return`
      ...
      <div class="cv" data-i="${a}" data-shown="closed" style="--tone:${X(n.tone??e.tone,"solar")}">
        <button class="chip" type="button" aria-label="Meer info"></button>
        <div class="txt"><div class="nm"></div><div class="st"></div></div>
        ${this.keysHtml(e.show_stop!==!1,Xi(n,e))}
        <div class="pos" hidden></div>
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let r=a.dataset.act,o=this.config.covers[+t];this.hass.callService("cover",Qi(r,Yi(o,this.config)),{entity_id:o.entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(U(e.querySelector(".chip"),{onTap:()=>P(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=v(this.hass,n.entity),r=Z(this.hass,n.entity),o=!a||a.state==="unavailable",s=Yi(n,this.config),l=Xi(n,this.config),d=ll(a?.state??"unknown",s);e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=M(this.hass,n.entity,n.name);let c=Ji(a,vt.SET_POSITION)&&r.current_position!=null,p=c?Un(r.current_position,s):null,h=dl({state:d,positie:p,aanname:this.assumed_.get(t)});e.dataset.shown=h;let g=ol(r,l),u=(h==="open"?n.icon_open:n.icon_closed)??(h==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??g[h],k=e.querySelector(".chip");k.dataset.icon!==u&&(k.dataset.icon=u,k.innerHTML=f(u,g[h]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=cl({dood:o,state:d,positie:p,toon:this.toonStatus_()})),e.querySelectorAll(".keys button").forEach(V=>{let B=Qi(V.dataset.act,s);V.disabled=o||!Ji(a,il[B])});let w=e.querySelector(".pos"),y=c&&this.config.show_position!==!1;if(w.hidden=!y,y){if(w.dataset.built||(w.dataset.built="1",w.innerHTML=ve("position"),w.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let B=w.querySelector(".slider"),fe=ue=>{B.style.setProperty("--v",`${ue}%`),B.setAttribute("aria-valuenow",String(ue)),this.toonStatus_()&&(e.querySelector(".st").textContent=`${ue}% open`)};this.teardown_.push(He(B,{value:()=>Un(Z(this.hass,n.entity).current_position??0,s),onInput:fe,onCommit:ue=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:Un(ue,s)})}))}let V=w.querySelector(".slider");if(!V.classList.contains("dragging")){let B=p??0;V.style.setProperty("--v",`${B}%`),V.setAttribute("aria-valuenow",String(B))}}})}toonStatus_(){return this.config.show_state!==!1}rows_(){let e=this.config?.covers??[],t=e.some(n=>Ji(v(this.hass,n.entity),vt.SET_POSITION));return Me(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};z(Fn,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var er=class extends C{defaults(){return{show_stop:!0,show_position:!0,show_state:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(a=>typeof a=="string"?{entity:a}:a);t.covers=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name),a.poort&&(t[`poort:${a.entity}`]=!0),a.invert&&(t[`invert:${a.entity}`]=!0);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(a=>{let r={};return t[`naam:${a}`]&&(r.name=t[`naam:${a}`]),t[`poort:${a}`]&&(r.poort=!0),t[`invert:${a}`]&&(r.invert=!0),Object.keys(r).length?{entity:a,...r}:a});for(let a of Object.keys(t))/^(naam|poort|invert):/.test(a)&&delete t[a];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.flatMap(t=>[{name:`naam:${t}`,selector:b.text()},{name:`poort:${t}`,selector:b.bool()},{name:`invert:${t}`,selector:b.bool()}]),{name:"show_stop",selector:b.bool()},{name:"show_state",selector:b.bool()}]}naamVan_(e){return this.config_?.[`naam:${e}`]||this.hass?.states?.[e]?.attributes?.friendly_name||e}label(e){return e.name.startsWith("naam:")?`Naam voor ${this.naamVan_(e.name.slice(5))}`:e.name.startsWith("poort:")?`${this.naamVan_(e.name.slice(6))} is een poort`:e.name.startsWith("invert:")?`${this.naamVan_(e.name.slice(7))} omgekeerd aangesloten`:{covers:"Rolluiken",show_stop:"Stopknop tonen",show_state:"Status tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten.";if(e.name.startsWith("poort:"))return"Zet pijltjes om in Openen en Sluiten, en geeft een poorticoon. Een poort schuift opzij, dus omhoog en omlaag zeggen er niets over.";if(e.name.startsWith("invert:"))return"Voor een motor die andersom is aangesloten: open wordt dicht en dicht wordt open. De knoppen, de status en de schuif draaien samen om.";if(e.name==="show_state")return"Haalt de regel Open, Dicht of het percentage onder de naam weg. Niet bereikbaar blijft altijd staan."}};I("domotiapp-cover-card-editor",er);N("domotiapp-cover-card",Fn,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Lh(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var qn=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[L]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var tr=class extends C{setConfig(e){let t={...e},n=(e.persons??[]).map(a=>typeof a=="string"?{entity:a}:a);t.persons=n.map(a=>a.entity);for(let a of n)a.name&&(t[`naam:${a.entity}`]=a.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(a=>{let r=t[`naam:${a}`];return r?{entity:a,name:r}:a});for(let a of Object.keys(t))a.startsWith("naam:")&&delete t[a];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:b.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};I("domotiapp-person-card-editor",tr);N("domotiapp-person-card",qn,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var nr=i=>String(i??"").trim().split(/\s+/).filter(Boolean);function Ch(i){let e=nr(i);return e.filter((n,a)=>a===0||n.toLowerCase()!==e[a-1].toLowerCase()).join(" ")}function Rh(i){let e=i.map(nr).filter(a=>a.length);if(e.length<2)return 0;let t=0,n=Math.min(...e.map(a=>a.length));for(;t<n;){let a=e[0][t].toLowerCase();if(!e.every(r=>r[t].toLowerCase()===a))break;t++}return Math.min(t,n-1)}function ar(i){let e=i.map(n=>Ch(n)),t=Rh(e);return e.map(n=>{let a=nr(n),r=a.slice(t);return(r.length?r:a).join(" ")})}var Hh=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function Ih(i){for(let[e,t,n]of Hh)if(e.test(i))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var pl={"geen datum":"geen datum",voorbij:"is geweest","bestaat niet":"sensor ontbreekt"},hl=i=>String(i??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),Zn=class extends S{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[L]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}wire(){this.breed_()&&this.teardown_.push(H(this.$(".card")))}read_(){let e=new Date,t=this.config.sensors.map(r=>{let o=v(this.hass,r.entity),s=o?ct(o.state)??ct(o.attributes.date)??ct(o.attributes.next_date)??ct(o.attributes.Year_month_day_date):null;return{cfg:r,st:o,date:s}}),n=t.map(r=>hl(M(this.hass,r.cfg.entity,r.cfg.name))),a=ar(n);return t.map((r,o)=>{let s=r.cfg.label??a[o]??n[o],l=Ih(r.cfg.label??r.cfg.entity+s),d=this.config.tones?.[r.cfg.entity];return{label:s,entity:r.cfg.entity,date:r.date,days:r.date?vn(e,r.date):null,tone:X(d??r.cfg.tone??l.tone),icon:r.cfg.icon??l.icon,reden:r.st?r.date?vn(e,r.date)<0?"voorbij":null:"geen datum":"bestaat niet"}}).sort((r,o)=>!r.reden&&!o.reden?r.date-o.date:r.reden?o.reden?r.label.localeCompare(o.label):1:-1)}komend_(e){return e.filter(t=>!t.reden)}breed_(){return this.config.layout==="breed"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("vorm",this.breed_()?"breed":"lijst"),this.breed_()?`
      <div class="card surface">
        <div class="rij">
      ...
      <div class="card surface">
        ...
        <div class="breed"></div>
        <div class="empty" hidden>Geen ophaaldata gevonden. Controleer of de gekozen sensoren een datum als toestand hebben.</div>
      </div>`}paint(){let e=this.read_(),t=this.komend_(e),n=this.$(".hero"),a=this.$(".list"),r=this.$(".empty");if(r.hidden=e.length>0,this.breed_()){this.paintBreed_(e,t[0]),T(this.$(".card"));return}if(n&&(n.hidden=t.length===0,t.length)){let o=t[0];n.style.setProperty("--tone",o.tone),this.setAttribute("urgency",o.days===0?"today":o.days===1?"tomorrow":"later");let s=n.querySelector(".bin");s.dataset.icon!==o.icon&&(s.dataset.icon=o.icon,s.innerHTML=f(o.icon,"bin")),this.text(n.querySelector(".eyebrow"),kn(o.date)),this.text(n.querySelector(".big"),o.label),this.text(n.querySelector(".n"),o.days===0?"nu":String(o.days)),this.text(n.querySelector(".u"),o.days===0?"aan de weg":o.days===1?"dag":"dagen")}if(a){let o=t[0],s=this.config.show_hero===!1?e:e.filter(d=>d!==o),l=s.map(d=>`${d.label}${+d.date}${d.reden??""}`).join("|");if(a.dataset.sig===l)return;a.dataset.sig=l,a.innerHTML=s.map(d=>{if(d.reden)return`
        <div class="r" data-stil="true" style="--tone:${d.tone}">
          <i></i><span>${_(d.label)}</span>
          <span class="d">${pl[d.reden]??d.reden}</span>
        </div>`;let c=kn(d.date),p=d.days<=6?`<small>${Uo(d.date)}</small>`:"";return`
        <div class="r" style="--tone:${d.tone}">
          <i></i><span>${_(d.label)}</span>
          <span class="d">${c}${p}</span>
        </div>`}).join("")}}paintBreed_(e,t){let n=this.$(".breed");if(!n)return;let a=e.map(r=>`${r.label}|${+r.date}|${r.reden??""}`).join(",");n.dataset.sig!==a&&(n.dataset.sig=a,n.innerHTML=e.map(r=>{let o=r.reden?pl[r.reden]??r.reden:r.days===0?"vandaag":r.days===1?"morgen":kn(r.date);return`
  ...
  `);var ir=class extends C{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){let e=this.ids_(),t=ar(e.map(n=>hl(this.hass?.states?.[n]?.attributes?.friendly_name??n)||n));return e.map((n,a)=>({key:`kleur:${n}`,kind:"tone",label:`Kleur voor ${t[a]||n}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"layout",selector:b.select([{value:"lijst",label:"Lijst (eerstvolgende uitgelicht)"},{value:"breed",label:"Over de breedte (veel lager)"}])}]}label(e){return{sensors:"Afvalsensoren",layout:"Vorm",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="layout")return"Over de breedte zet alle bakken naast elkaar in plaats van onder elkaar. Vier bakken passen dan op \xE9\xE9n rasterrij in plaats van vier \u2014 dat scheelt bijna tweehonderd pixels. De eerstvolgende licht op.";if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};I("domotiapp-waste-card-editor",ir);N("domotiapp-waste-card",Zn,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function et(i){if(i==null||i==="")return 4;let e=Math.round(Number(i));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Xn(i,e=!0){if(typeof i=="string")return{name:"",icon:"",path:i,action:null,items:[]};let t=i??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",action:t.action&&typeof t.action=="object"?{...t.action}:null,items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>Xn(n,!1)):[]}}var We=i=>Array.isArray(i?.items)?i.items.filter(Ue):[],ul=i=>We(i).length>0,Ue=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.path?.trim()||i.action));function ml(i){return(Array.isArray(i?.items)?i.items:[]).slice(0,20).map(t=>Xn(t))}var gl=[{id:"domotitech",label:"DomotiTech",uitleg:"Opent domotitech.nl in een nieuw tabblad, met het logo erop.",bovenaan:!0,maak:()=>({name:"DomotiTech",icon:"domotitech",path:"https://domotitech.nl",action:null,items:[]})},{id:"herstart",label:"Herstart Home Assistant",uitleg:"Roept homeassistant.restart aan, met een bevestiging ervoor.",bovenaan:!0,maak:()=>({name:"Herstart",icon:"power",path:"",action:{action:"perform-action",perform_action:"homeassistant.restart",confirmation:{title:"Weet je het zeker?",text:"Weet je het zeker dat je Home Assistant wilt herstarten?"}},items:[]})}];function fl(i,e,t=!1){let n=Array.isArray(i)?[...i]:[];if(n.length>=8)return{lijst:n,plek:-1};let a=t?0:n.length;return n.splice(a,0,e),{lijst:n,plek:a}}function Yn(i,e=4){let t=(i??[]).filter(Ue),n=et(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let a=Math.max(1,n-1);return{balk:t.slice(0,a),meer:t.slice(a),heeftMeer:!0}}function rr(i){if(i&&typeof i=="object")return i.action?i.action:rr(i.path);let e=String(i??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var Ph=`
...
`,bl=/^i(\d+)(s\d+)?$/,vl=i=>({...i.name?{name:i.name}:{},...i.icon?{icon:i.icon}:{},...i.path?{path:i.path}:{},...i.action?{action:structuredClone(i.action)}:{}}),kl=i=>i.filter(Ue).map(e=>{let t=(e.items??[]).filter(Ue).map(vl);return{...vl(e),...t.length?{items:t}:{}}}),or=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(n=>Xn(n));this.gebouwd_&&JSON.stringify(kl(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Ph;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:a}=Yn(this.items_,this.rest_.max),r=a.length,o=this.items_.filter(Ue);if(this.items_.forEach((l,d)=>{if(o.indexOf(l)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(l,d))}),!this.items_.length){let l=document.createElement("p");l.className="uitleg",l.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(l)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${et(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:et(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=et(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{let x=!Ue(e);n.dataset.leeg=String(x),r.innerHTML=f(e.icon,"grid"),s.textContent=e.name||(x?"Nieuwe knop":e.path||"Zonder naam");let w=We(e).length;l.textContent=w?`Menu met ${w} knop${w===1?"":"pen"}`:e.path?e.path:e.icon?`${Re(e.icon)} -- nog geen pad`:"Nog geen pad"};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let g=document.createElement("div");g.className="body";let u=document.createElement("dac-icon-picker");u.label="Icoon",u.fallback="grid",u.auto=!1,u.hass=this.hass_,u.value=e.icon,u.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],k.computeLabel=x=>({name:"Naam",path:"Waar gaat hij heen"})[x.name]??x.name,k.computeHelper=x=>{if(x.name!=="path")return;let w="/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.";return ul(e)?`${w}

Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:w},k.data={name:e.name,path:e.path},k.addEventListener("value-changed",x=>{x.stopPropagation();let w=x.detail.value??{};e.name=w.name??"",e.path=w.path??"",this.emit_()}),g.append(u,k,...this.subBlok_(e,t)),n.appendChild(g),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let a=document.createElement("div");a.className="sublijst",e.items.forEach((s,l)=>a.appendChild(this.subItemBlok_(e,s,t,l)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,a,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let a=document.createElement("summary");a.textContent="\uFF0B  Subknop toevoegen",n.appendChild(a);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,l)=>{let{lijst:d,plek:c}=fl(e.items,s,l);c<0||(e.items=d,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of gl){let l=s.maak();r.appendChild(this.keuzeKnop_(l.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,a){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=f(e,"plus");let s=document.createElement("span");s.className="tekst";let l=document.createElement("b");l.textContent=t;let d=document.createElement("small");return d.textContent=n,s.append(l,d),r.append(o,s),r.addEventListener("click",a),r}subItemBlok_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let l=document.createElement("span");l.className="titel";let d=document.createElement("b"),c=document.createElement("small");l.append(d,c);let p=()=>{s.innerHTML=f(t.icon,"grid"),d.textContent=t.name||(Ue(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsSub_(e,n,a,-1));h.disabled=a===0;let g=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsSub_(e,n,a,1));g.disabled=a===e.items.length-1;let u=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderSub_(e,n,a));u.classList.add("weg"),o.append(s,l,h,g,u),r.appendChild(o);let k=document.createElement("div");k.className="body";let x=document.createElement("dac-icon-picker");x.label="Icoon",x.fallback="grid",x.auto=!1,x.hass=this.hass_,x.value=t.icon,x.addEventListener("value-changed",y=>{y.stopPropagation(),t.icon=y.detail.value??"",this.emit_()});let w=document.createElement("ha-form");return w.hass=this.hass_,w.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],w.computeLabel=y=>({name:"Naam",path:"Waar gaat hij heen"})[y.name]??y.name,t.action&&(w.schema=[{name:"name",selector:{text:{}}}],w.computeHelper=y=>y.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),w.data={name:t.name,path:t.path},w.addEventListener("value-changed",y=>{y.stopPropagation();let V=y.detail.value??{};t.name=V.name??"",t.path=V.path??"",this.emit_()}),k.append(x,w),r.appendChild(k),r}verplaatsSub_(e,t,n,a){let r=n+a;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let a=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){a.add(r);continue}let s=Number(o[2]);s!==n&&a.add(`i${t}s${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let a=bl.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(`i${r>e?r-1:r}${a[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let a of this.open_){let r=bl.exec(a);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(a)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=kl(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};D("domotiapp-navbar-card-editor",or);var xl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*qt(i){let e=xl(i),t=0;for(;e&&t++<40;)yield e,e=xl(e)}function Kh(i){for(let e of qt(i)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Gh(i){for(let e of qt(i))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Wh(i){for(let e of qt(i))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Uh(i){for(let e of qt(i))if(e.classList?.contains?.("section"))return e;return null}function wl(i){for(let e of qt(i)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Qn=class extends S{validate(e){let t=ml(e),n={labels:!0,tone:"accent",...e,items:t,max:et(e?.max)};return t.filter(a=>a.name||a.icon||a.path).length||(n[L]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:a}=Yn(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let g=We(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      <button type="button" class="knop" data-i="${p}" title="${_(c.name)}"${g}>
      ...
      </button>`,l=n.map(c=>{let p=r.indexOf(c),h=We(c);return h.length?`
      <div class="regel kop">
        <span class="mi">${f(c.icon,"grid")}</span>
        <span class="mt">${_(c.name||c.path)}</span>
      </div>`+h.map((u,k)=>s(u,p,k,"sub")).join(""):s(c,p)}).join(""),d=t.map(c=>{let p=We(c);if(!p.length)return"";let h=r.indexOf(c);return`<div class="menu submenu" data-id="s${h}" role="menu">${p.map((g,u)=>s(g,h,u)).join("")}</div>`}).join("");return`
      <div class="balk" style="--tone:${X(e.tone)}">
  ...
  `);N("domotiapp-navbar-card",Qn,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var Fh="dac-tabs:";function dr(i){let e=i??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],a=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:a}}var Jn=i=>!!(i&&(i.name?.trim()||i.icon?.trim()||i.cards?.length));function _l(i){return(Array.isArray(i?.tabs)?i.tabs:[]).slice(0,8).map(dr).filter(Jn)}function qh(i,e){if(!e)return 0;let t=Math.round(Number(i?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function cr(i){let e=(i??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return Fh+e}function Zh(i,e,t){let n=null;try{n=i?.getItem?.(e)??null}catch{return null}let a=Number(n);return n===null||n===""||!Number.isInteger(a)?null:a>=0&&a<t?a:null}function yl(i,e,t){try{return i?.setItem?.(e,String(t)),!0}catch{return!1}}function zl(i,e,t){return Zh(t,cr(e),e.length)??qh(i,e.length)}var Xh=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function jl(){let i=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return i.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,a=t.type.startsWith("custom:domotiapp-")?0:1;return n-a||e.naam.localeCompare(t.naam,"nl")}),[...i,...Xh.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function $l(i,e){let t=String(e??"").trim().toLowerCase();return t?i.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):i}async function El(i,e){let t={type:i};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let a=i.startsWith("custom:")?i.slice(7):`hui-${i}-card`,o=await customElements.get(a)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:i}}catch{}return t}var Al=()=>!!customElements.get("hui-card-element-editor");function Ml(i,e,t){let n=s=>{if(s==null||s==="")return null;let l=Math.round(Number(s));return Number.isFinite(l)?l:null},a=i,r=n(e),o=n(t);return r!==null&&(a=Math.max(a,r)),o!==null&&(a=Math.min(a,o)),a}function Yh(i,e){let t=i?.columns,n=i?.rows,a=12;if(t!=null&&t!=="full"){let s=Math.round(Number(t));a=Number.isFinite(s)?Math.min(12,Math.max(1,s)):12}a=Math.min(12,Math.max(1,Ml(a,e?.min_columns,e?.max_columns)));let r={gridColumn:`span ${a}`},o=Math.round(Number(n));return n!=="auto"&&Number.isFinite(o)&&o>=1&&(r.height=`${Math.max(1,Ml(o,e?.min_rows,e?.max_rows))*64-8}px`),r}function Zt(i,e,t){if(!i?.style)return;let{gridColumn:n,height:a}=Yh(e,t);i.style.gridColumn=n,i.style.height=a??""}function Sl(i){let e=i?._element??i?.shadowRoot?.firstElementChild??null;if(typeof e?.getGridOptions!="function")return null;try{let t=e.getGridOptions();return t&&typeof t=="object"?t:null}catch{return null}}function Nl(i,e,t={}){let n=Array.isArray(i)?[...i]:[],a=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(a)||!n[a]?null:(n.splice(a+1,0,structuredClone(n[a])),n);case"verwijder":return!Number.isInteger(a)||!n[a]?null:(n.splice(a,1),n);case"rooster":return!Number.isInteger(a)||!n[a]||!t.rooster?null:(n[a]={...n[a],grid_options:{...n[a].grid_options??{},...t.rooster}},n);default:return null}}var Ol=i=>({...i?{config:i}:{},editMode:!0,saveConfig:async()=>{}}),Qh=()=>document.querySelector("home-assistant");function Tl({kaarten:i,hass:e,maakKaart:t,opActie:n}){let a=document.createElement("ha-sortable");a.disabled=!1,a.draggableSelector=".dac-kaart",a.rollback=!1,a.invertSwap=!0,a.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];i.forEach((d,c)=>{let p=t(d,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",Zt(h,d?.grid_options);let g=document.createElement("hui-card-edit-mode");g.hass=e,g.lovelace=Ol(),g.path=[0,0,c],g.hiddenOverlay=!1,g.appendChild(p),o.push(g),h.appendChild(g),r.appendChild(h)}),a.appendChild(r);let s=d=>{for(let c of o)c.hiddenOverlay=!d};a.addEventListener("drag-start",()=>s(!1)),a.addEventListener("drag-end",()=>s(!0)),a.addEventListener("item-moved",d=>{d.stopPropagation(),n("verplaats",{van:d.detail.oldIndex,naar:d.detail.newIndex})});let l={"ll-edit-card":d=>n("bewerk",{index:d.detail.path[2]}),"ll-duplicate-card":d=>n("dupliceer",{index:d.detail.path[2]}),"ll-delete-card":d=>n("verwijder",{index:d.detail.path[2]}),"ll-copy-card":d=>n("kopieer",{index:d.detail.path[2]}),"ll-change-grid-options":d=>n("rooster",{index:d.detail.path?.[2],rooster:d.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[d,c]of Object.entries(l))a.addEventListener(d,p=>{p.stopPropagation(),c(p)});return a}function Dl(i){try{let e=typeof structuredClone=="function"?structuredClone(i):JSON.parse(JSON.stringify(i));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Ll({hass:i,kaarten:e}){let t=Qh();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let a=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",l,!0),window.removeEventListener("dialog-closed",d,!0),n(a?{kaart:a}:r?{kaarten:r}:null))},l=g=>{if(g?.detail?.dialogTag!=="hui-dialog-edit-card")return;let u=g.detail?.dialogParams?.cardConfig;g.stopImmediatePropagation?.(),g.stopPropagation(),u&&(a=u);let k=t.querySelector("hui-dialog-create-card");typeof k?.closeDialog=="function"&&k.closeDialog(),setTimeout(s,0)},d=g=>{g?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",l,!0),window.addEventListener("dialog-closed",d,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=i,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Ol({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async g=>{let u=g?.views?.[0]?.sections?.[0]?.cards;Array.isArray(u)&&(r=u)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let g=p._layoutElement;if(!g)throw new Error("de proxysectie heeft geen layout-element");g.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(g){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",g),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var ea=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var Jh=`
...
`,Rl=i=>i.filter(Jn).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function kt(i){let e=String(i?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function pr(i){let e=i.cards?.length??0;return e?e===1?kt(i.cards[0]):`${e} kaarten`:"Nog geen kaart"}var hr=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(dr);this.gebouwd_&&JSON.stringify(Rl(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Jh;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let a=document.createElement("button");a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Tabblad toevoegen",a.disabled=this.tabs_.length>=8,a.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(a)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},a=Number(n.default_tab);Number.isFinite(a)&&a>1?this.rest_.default_tab=a:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),l=document.createElement("small");o.append(s,l);let d=()=>{n.dataset.leeg=String(!Jn(e)),r.innerHTML=f(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,l.textContent=pr(e)};d(),this.koppen_.push(d);let c=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",A.close,()=>this.verwijder_(t));h.classList.add("weg"),a.append(r,o,c,p,h),n.appendChild(a);let g=document.createElement("div");g.className="body";let u=document.createElement("dac-icon-picker");u.label="Icoon",u.fallback="grid",u.auto=!1,u.hass=this.hass_,u.value=e.icon,u.addEventListener("value-changed",x=>{x.stopPropagation(),e.icon=x.detail.value??"",this.emit_()});let k=document.createElement("ha-form");return k.hass=this.hass_,k.schema=[{name:"name",selector:{text:{}}}],k.computeLabel=()=>"Naam",k.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",k.data={name:e.name},k.addEventListener("value-changed",x=>{x.stopPropagation(),e.name=x.detail.value?.name??"",this.emit_()}),g.append(u,k,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!Al()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${f("grid")}<span>Inhoud: <b>${pr(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(ea()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${f("grid")}<span>${e.cards.length?`<b>${pr(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let a=document.createElement("button");return a.type="button",a.className="toevoegen",a.textContent="\uFF0B  Kaart toevoegen",a.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(a),n}uitVoorbeeld(e,t,n){let a=this.tabs_[e];if(a){if(t==="toevoegen"){this.voegToeViaHa_(a,e);return}this.kaartActie_(a,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,a=Number.isInteger(t)?this.tabs_[t]:null;if(!a||!a.cards[n]){e?.remove();return}let r=this.bewerkVak_(a,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,a){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==a.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:a.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Dl(e.cards[a.index]);return}let r=Nl(e.cards,n,a);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let a=document.createElement("div");a.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=kt(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let l=document.createElement("div");l.className="body";let d=this.kaartTabbladen_(e,t,n,l,o);d&&a.append(r,d,l);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=kt(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,l.appendChild(c),d||a.append(r,l),a}kaartTabbladen_(e,t,n,a,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let l=document.createElement("div");l.className="kaarttabs";let d=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let g of l.querySelectorAll("button"))g.setAttribute("aria-selected",String(g.dataset.blad===h));a.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of d){let g=document.createElement("button");g.type="button",g.dataset.blad=h.id,g.textContent=h.naam,g.setAttribute("role","tab"),g.setAttribute("aria-selected","false"),g.addEventListener("click",()=>c(h.id)),l.appendChild(g)}let p=d.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),l}bladInhoud_(e,t,n,a,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[a],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let l=s.detail?.value;l&&(t.cards[a]=l,o.config=l,this.emit_(),r.textContent=kt(l))}),o}async voegToeViaHa_(e,t){let n=await Ll({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,a){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=f("grid");let l=document.createElement("span");l.className="titel";let d=document.createElement("b");d.textContent=kt(t);let c=document.createElement("small");c.textContent=String(t?.type??""),l.append(d,c);let p=this.kopKnop_("Omhoog",A.arrowUp,()=>this.verplaatsKaart_(e,n,a,-1));p.disabled=a===0;let h=this.kopKnop_("Omlaag",A.arrowDown,()=>this.verplaatsKaart_(e,n,a,1));h.disabled=a===e.cards.length-1;let g=this.kopKnop_("Verwijderen",A.close,()=>this.verwijderKaart_(e,n,a));g.classList.add("weg"),o.append(s,l,p,h,g),r.appendChild(o);let u=document.createElement("div");u.className="body";let k=document.createElement("hui-card-element-editor");return k.hass=this.hass_,this.lovelace_&&(k.lovelace=this.lovelace_),k.value=t,k.addEventListener("config-changed",x=>{x.stopPropagation();let w=x.detail?.config;w&&(e.cards[a]=w,this.emit_(),d.textContent=kt(w),c.textContent=String(w.type??""))}),k.addEventListener("GUImode-changed",x=>x.stopPropagation()),u.appendChild(k),r.appendChild(u),r}verplaatsKaart_(e,t,n,a){let r=n+a;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let a=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){a.add(r);continue}let s=Number(o[1]);s!==n&&a.add(`t${t}k${s>n?s-1:s}`)}this.open_=a,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let a=document.createElement("input");a.type="text",a.placeholder="Zoek een kaart...",a.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let l=$l(jl(),this.zoek_);if(r.replaceChildren(),!l.length){let d=document.createElement("p");d.className="leeg",d.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(d);return}for(let d of l){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=d.naam;let h=document.createElement("small");h.textContent=d.uitleg||d.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await El(d.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),a.addEventListener("input",()=>{this.zoek_=a.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(a,r,s),n}kopKnop_(e,t,n){let a=document.createElement("button");return a.type="button",a.className="rondknop",a.title=e,a.setAttribute("aria-label",e),a.innerHTML=t,a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),a.disabled||n()}),a}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let a=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),a&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let a=Number(n.slice(1));a!==e&&t.add(`t${a>e?a-1:a}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Rl(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};D("domotiapp-tabs-card-editor",hr);var Hl=i=>i.parentElement??(i.parentNode&&i.parentNode.host)??null;function*Vl(i){let e=Hl(i),t=0;for(;e&&t++<40;)yield e,e=Hl(e)}function Il(i){let e=null;for(let n of Vl(i))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,a=0)=>{if(!n||a>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,a+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,a+1);if(o)return o}return null};return t(e)}var na=class extends S{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=_l(e),n={tone:"accent",...e,tabs:t};return t.length||(n[L]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e);this.herijkIndeling_()}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((a,r)=>`
        <button type="button" class="tab" role="tab" data-i="${r}" aria-selected="false"
                title="${_(a.name)}">
          ${a.icon?`<span class="ic">${f(a.icon,"grid")}</span>`:""}
          <span class="nm">${_(a.name||`Tab ${r+1}`)}</span>
        </button>`).join(""),n=e.tabs.map((a,r)=>`<div class="vak" data-i="${r}" role="tabpanel"></div>`).join("");return`
      <div class="card surface" style="--tone:${X(e.tone)}">
        <div class="balk" role="tablist">${t}</div>
        <div class="vakken">${n}</div>
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(H(this.$(".card"))),this.kies_(zl(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let a=Math.min(Math.max(0,e),n.length-1);this.open_=a;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===a));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===a);t&&yl(this.opslag_(),cr(n),a),this.bouw_(a)}async bouw_(e){if(this.kinderen_.has(e)){T(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let a=document.createElement("div");a.className="leeg",a.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(a),T(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Il(this),o=!!r,s=n.cards.map(l=>{let d=document.createElement("hui-card");return d.hass=this.hass,d.preview=o,d.config=l,Zt(d,l?.grid_options),d});if(this.kinderen_.set(e,s),r&&ea()){t.replaceChildren(Tl({hass:this.hass,kaarten:n.cards,maakKaart:(l,d)=>s[d]??null,opActie:(l,d)=>r.uitVoorbeeld?.(e,l,d)}),this.voegToeKnop_(e)),T(this.$(".card"));return}t.replaceChildren(...s),T(this.$(".card")),this.herijkIndeling_()}catch(a){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${_(a?.message??a)}</div>`,T(this.$(".card"))}}}herijkIndeling_(e=3){let t=!1;for(let[n,a]of this.kinderen_.entries()){if(!a)continue;let r=this.config?.tabs?.[n]?.cards??[];a.forEach((o,s)=>{let l=Sl(o);l&&(t=!0),Zt(o,r[s]?.grid_options,l)})}!t&&e>0&&requestAnimationFrame(()=>this.herijkIndeling_(e-1))}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),T(this.$(".card"));return}if(t<=0)return;let a=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(a))}inVoorbeeld_(){for(let e of Vl(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Il(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};z(na,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);N("domotiapp-tabs-card",na,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var F={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},eu=[[F.FOUT,["error","fout","aborting","afgebroken"]],[F.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[F.PAUZE,["pause","paused","pauze","onderbroken"]],[F.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[F.AF,["finished","complete","done","klaar met","afgelopen"]],[F.KLAAR,["ready","idle","standby","klaar","gereed"]],[F.UIT,["off","inactive","uit"]]],tu=new Set([F.DRAAIT]);function Pl(i){let e=String(i??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return F.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,a]of eu)for(let r of a)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return F.ONBEKEND}var Kl=i=>tu.has(Pl(i?.state));function Gl(i,e=new Date){if(!i)return null;let t=String(i.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=i.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let a=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(a)return Number(a[1])*60+Number(a[2])+(a[3]?Math.round(Number(a[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function Bl(i){if(i==null)return"";if(i<=0)return"Klaar";if(i<60)return`nog ${i} min`;let e=Math.floor(i/60),t=i%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Wl(i){if(!i)return null;let e=String(i.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var nu=i=>!!i&&i.state==="on",Ul=i=>i===F.DRAAIT||i===F.PAUZE||i===F.UITGESTELD;function Fl({status:i,deur:e,rest:t,pct:n}={}){let a=Pl(i?.state),r=nu(e);if(a===F.DRAAIT){let o=[];return t!=null?o.push(Bl(t)):n!=null&&o.push(`${n}%`),{soort:a,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return a===F.PAUZE?{soort:a,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:a===F.FOUT?{soort:a,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:a===F.AF?{soort:a,tekst:"Programma klaar",tone:"good",waarschuwing:""}:a===F.UITGESTELD?{soort:a,tekst:t!=null?`Start over ${Bl(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:a,tekst:"Klep open",tone:"warn",waarschuwing:""}:a===F.UIT?{soort:a,tekst:"Uit",tone:"neutral",waarschuwing:""}:a===F.KLAAR?{soort:a,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:F.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function ql(i){let e=String(i??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var au={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},aa=class extends S{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[L]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,a,r)=>`
      <button type="button" class="knop ${n}" hidden>
        ${f(a)}<span class="lb">${_(r)}</span>
      </button>`;return`
      ...
      </div>`}wire(){let e=this.config;this.on(this.$(".top"),"click",()=>{let t=e.status||e.remaining||e.program;t&&this.moreInfo_(t)}),this.on(this.$(".knop.start"),"click",()=>this.druk_(e.start)),this.on(this.$(".knop.stop"),"click",()=>this.druk_(e.stop)),this.on(this.$(".knop.slim"),"click",()=>{if(!e.smart)return;let t=Y(v(this.hass,e.smart));this.hass.callService("homeassistant",t?"turn_off":"turn_on",{entity_id:e.smart})}),this.on(this.$(".rij.programma"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.program)return;t.stopPropagation();let a=mt(e.program,n.value,ke(v(this.hass,e.program)));a&&this.hass.callService(a[0],a[1],a[2])}),this.teardown_.push(H(this.$(".card")))}moreInfo_(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}druk_(e){let t=ql(e);t&&this.hass.callService(t[0],t[1],t[2])}paint(){let e=this.config,t=v(this.hass,e.status),n=v(this.hass,e.door),a=Gl(v(this.hass,e.remaining)),r=Wl(v(this.hass,e.progress)),o=Fl({status:t,deur:n,rest:a,pct:r}),s=Kl(t);this.toggleAttribute("draait",s),this.toggleAttribute("onbekend",s&&r==null);let l=this.$(".top"),d=au[o.tone]??E.accent;this.$(".card").style.setProperty("--tone",d),l.classList.toggle("unavailable",o.soort==="onbekend");let c=this.$(".chip"),p=e.icon||"dishwasher";c.dataset.icon!==p&&(c.dataset.icon=p,c.innerHTML=f(p,"dishwasher")),c.style.setProperty("--tone",d),this.text(".nm",e.name||M(this.hass,e.status,null)||"Vaatwasser");let h=this.$(".st"),g=_(o.tekst),u=o.waarschuwing?` &middot; <span class="let">${_(o.waarschuwing)}</span>`:"";h.dataset.tekst!==g+u&&(h.dataset.tekst=g+u,h.innerHTML=g+u),l.setAttribute("aria-label",`${this.$(".nm").textContent}, ${o.tekst}`);let k=this.$(".balk"),x=Ul(o.soort)&&(r!=null||s);if(k.hidden=!x,x){let w=this.$(".vul"),y=r!=null?`${r}%`:"";y&&w.style.width!==y&&(w.style.width=y),k.setAttribute("role","progressbar"),r!=null?(k.setAttribute("aria-valuenow",String(r)),k.setAttribute("aria-valuemin","0"),k.setAttribute("aria-valuemax","100")):k.removeAttribute("aria-valuenow")}this.paintBediening_(),T(this.$(".card"))}paintBediening_(){let e=this.config,t=this.$(".programslot"),n=v(this.hass,e.program),a=e.program?ke(n):[],r=a.map(d=>On(d,this.hass?.formatEntityState?.(n,d))),o=JSON.stringify([a,r]);t.dataset.opties!==o&&(t.dataset.opties=o,t.innerHTML=a.length?`<select class="keuze" aria-label="Programma">${a.map((d,c)=>`<option value="${_(d)}">${_(r[c])}</option>`).join("")}</select>`:"");let s=t.querySelector(".keuze");if(s&&this.shadowRoot.activeElement!==s){let d=ut(n);s.value!==d&&(s.value=d)}let l=this.$(".knop.slim");l.hidden=!e.smart,e.smart&&(l.dataset.aan=String(Y(v(this.hass,e.smart)))),this.$(".knop.start").hidden=!e.start,this.$(".knop.stop").hidden=!e.stop,this.$(".rij.programma").hidden=!s,this.$(".rij.knoppen").hidden=!e.smart&&!e.start&&!e.stop}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-dishwasher-card-editor")}static getStubConfig(e,t){return{status:((a,r)=>t?.find(o=>o.startsWith(a)&&r.test(o))??"")("sensor.",/vaatwas|dishwash/i),name:"Vaatwasser"}}};z(aa,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var ur=class extends C{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:b.text()},{name:"status",selector:b.entity(["sensor","binary_sensor"])},{name:"remaining",selector:b.entity(["sensor"])},{name:"progress",selector:b.entity(["sensor","number"])},{name:"program",selector:b.entity(["select","input_select"])},{name:"start",selector:b.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:b.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:b.entity(["binary_sensor"])},{name:"smart",selector:b.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};I("domotiapp-dishwasher-card-editor",ur);N("domotiapp-dishwasher-card",aa,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});function iu(i,e,t,{live:n=!1,fit:a="cover"}={}){if(!t)return null;let r=typeof customElements<"u"&&customElements.get("hui-image"),o=r?"hui-image":"img",s=i;if((!s||s.localName!==o)&&(s=document.createElement(o),s.className="beeld"),r){let l=n?"live":"auto";s.cameraImage!==t&&(s.cameraImage=t),s.cameraView!==l&&(s.cameraView=l),s.fitMode!==a&&(s.fitMode=a),s.hass=e}else{let l=e?.states?.[t],d=l?.attributes?.entity_picture;d&&s.dataset.bron!==d&&(s.dataset.bron=d,s.src=d),s.alt=l?.attributes?.friendly_name??t,s.style.objectFit=a}return s}function ia(i,e,t,n){if(!i)return null;let a=i.querySelector(".beeld"),r=iu(a,e,t,n);return r?(r!==a&&(a?.remove(),i.appendChild(r)),r):(a?.remove(),null)}var mr={idle:{woord:"Klaar voor gebruik",toon:"neutral"},printing:{woord:"Aan het printen",toon:"accent"},paused:{woord:"Gepauzeerd",toon:"warn"},finished:{woord:"Klaar",toon:"good"},failed:{woord:"Mislukt",toon:"bad"},offline:{woord:"Offline",toon:"neutral"},prepare:{woord:"Voorbereiden",toon:"accent"},unknown:{woord:"Onbekend",toon:"neutral"}},ru={idle:["idle","operational","standby","ready","on","off"],printing:["printing","running","run","print","busy","active"],paused:["pause","paused","pausing"],finished:["finish","finished","complete","completed","done","success"],failed:["failed","fail","error","cancelled","canceled","stopped"],prepare:["prepare","preparing","heating","slicing","init"],offline:["offline","unavailable","unknown","disconnected"]};function gr(i){let e=String(i?.state??"").trim().toLowerCase();if(!e)return"unknown";if(e==="unavailable"||e==="none")return"offline";for(let[t,n]of Object.entries(ru))if(n.includes(e))return t;return"unknown"}function ra(i){let e=gr(i);return e==="printing"||e==="prepare"}function fr(i){let e=Number(i?.state);return Number.isFinite(e)?Math.max(0,Math.min(100,Math.round(e))):null}function br(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"\xB0C"}:null}function vr(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let o=Date.parse(t);if(Number.isFinite(o))return Math.max(0,Math.round((o-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let o=t.split(":").map(Number),[s,l]=o.length===3?o:[0,o[0]];return s*60+l}let a=Number(t);if(!Number.isFinite(a))return null;let r=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return r==="h"||r==="u"||r.startsWith("hour")?Math.round(a*60):r==="s"||r.startsWith("sec")?Math.round(a/60):Math.round(a)}function kr(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function xr(i,e=new Date){if(i==null)return"";let t=new Date(e.getTime()+i*6e4);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var ou=new Set(["unknown","unavailable","none","null","empty","leeg","off","unload","unloaded"]);function tt(i,{namen:e=!1}={}){if(typeof i!="string")return null;let t=i.trim();if(!t)return null;let n=t.replace(/^#/,"");return/^[0-9a-f]{8}$/i.test(n)?parseInt(n.slice(6),16)<16?null:`#${n.slice(0,6).toUpperCase()}`:/^[0-9a-f]{6}$/i.test(n)?`#${n.toUpperCase()}`:/^[0-9a-f]{3}$/i.test(n)?`#${n.toUpperCase()}`:/^rgba?\(/i.test(t)?t:!e||ou.has(t.toLowerCase())?null:/^[a-z]+$/i.test(t)?t:null}function Zl(i,e={}){let t=i?.attributes??{},n=tt(e.color,{namen:!0})??tt(t.color)??tt(Array.isArray(t.cols)?t.cols[0]:t.cols)??tt(t.filament_color)??tt(t.tray_color)??(/^#?[0-9a-f]{3,8}$/i.test(String(i?.state??""))?tt(i.state):null)??null,a=e.label||t.type||t.filament_type||t.tray_type||t.name||(i&&!tt(i.state)?i.state:"")||"",r=t.empty===!0||t.empty==="true"?!0:!n&&!String(a).trim(),o=Number(t.remain??t.remaining),s=t.remain_enabled!==!1&&!r;return{kleur:r?null:n,soort:String(a).trim(),leeg:r,actief:t.active===!0||t.active==="true",rest:s&&Number.isFinite(o)&&o>=0&&o<=100?Math.round(o):null}}var xt=[1,2,3,4],su={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},oa=class extends S{validate(e){let t={name:"",icon:"printer3d",...e};return t.status||t.progress||t.camera||t.image||t.nozzle_temp||t.bed_temp||t.power||(t[L]="Kies minstens een printstatus. Camera, voortgang, temperaturen, de deur en de trays van de AMS mogen daarna."),t}watched(){let e=this.config;return[e.status,e.progress,e.remaining,e.nozzle_temp,e.bed_temp,e.door,e.power,e.camera,e.image,...xt.map(t=>e[`tray_${t}`])].filter(Boolean)}beeldSoort_(){let e=this.config;return e.camera&&e.image?this.beeld_??(ra(v(this.hass,e.status))?"camera":"image"):e.camera?"camera":e.image?"image":null}template(){return this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`
      <div class="card surface" style="--tone:${E.accent}">
        <div class="kop">
          ...
          <button class="aanuit" type="button" aria-pressed="false"
                  aria-label="Printer aan of uit" hidden>${f("power")}</button>
        </div>
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(H(this.$(".card"))),this.on(this.$(".ico"),"click",()=>P(this,e.status||e.power||e.camera||e.progress));let t=this.$(".aanuit");this.on(t,"click",a=>{a.stopPropagation(),this.schakel_()});let n=this.$(".wissel");this.on(n,"click",a=>{a.stopPropagation(),this.beeld_=this.beeldSoort_()==="camera"?"image":"camera",this.paint()}),this.on(this.$(".beeldvak"),"click",a=>{if(a.target.closest(".wissel"))return;let r=this.beeldSoort_()==="camera"?e.camera:e.image;r&&P(this,r)})}async schakel_(){let e=this.config.power;if(!e)return;let t=v(this.hass,e),n=Y(t),a=String(e).split(".")[0];if(n){let r=fr(v(this.hass,this.config.progress)),o=ra(v(this.hass,this.config.status));if(!await ye({title:"Printer uitzetten?",text:o?`Er loopt een print${r===null?"":` (${r}% klaar)`}. Uitzetten breekt hem af, en dat is niet terug te draaien.`:"Weet je zeker dat je de printer wilt uitzetten?",confirmText:"Uitzetten",dismissText:"Aan laten"}))return}this.hass.callService(a,n?"turn_off":"turn_on",{entity_id:e})}paint(){let e=this.config,t=v(this.hass,e.status),n=gr(t),a=mr[n]??mr.unknown,r=ra(t),o=e.status&&(!t||t.state==="unavailable");this.toggleAttribute("dead",!!o),this.toggleAttribute("loopt",r&&!o),this.$(".card").style.setProperty("--tone",su[a.toon]??E.accent),this.$(".ico").innerHTML=f(e.icon||"printer3d"),this.text(".nm",e.name||M(this.hass,e.status||e.power||e.camera,"3D-printer"));let s=String(t?.state??"").trim(),l=n==="unknown"&&s&&s.toLowerCase()!=="unknown",d=`<b>${this.veilig_(l?s:a.woord)}</b>${this.bijzin_()}`,c=this.$(".st");c.innerHTML!==d&&(c.innerHTML=d),this.paintAanUit_(),this.paintBeeld_(r),this.paintVoortgang_(r),this.paintTegels_(),this.paintAms_(),T(this.$(".card"))}bijzin_(){let e=vr(v(this.hass,this.config.remaining));return e===null||e<=0?"":` \xB7 nog ${this.veilig_(kr(e))}, klaar om ${this.veilig_(xr(e))}`}paintAanUit_(){let e=this.$(".aanuit"),t=this.config.power;if(e.hidden=!t,!t)return;let n=Y(v(this.hass,t));e.setAttribute("aria-pressed",String(n)),e.setAttribute("aria-label",n?"Printer uitzetten":"Printer aanzetten")}paintBeeld_(e){let t=this.config,n=this.$(".beeldvak"),a=this.beeldSoort_();if(n.hidden=!a,!a)return;let r=this.$(".wissel");if(r.hidden=!(t.camera&&t.image),!r.hidden){let d=a==="camera"?"Voorbeeld":"Camera";r.innerHTML=`${f(a==="camera"?"grid":"camera")}<span>${d}</span>`,r.setAttribute("aria-label",`Toon ${d.toLowerCase()}`)}if(a==="camera"){ia(n,this.hass,t.camera,{live:t.live_view===!0||e}),n.querySelector(".leeg")?.remove();return}n.querySelector("hui-image")?.remove();let s=v(this.hass,t.image)?.attributes?.entity_picture,l=n.querySelector("img.beeld");if(s)l||(l=document.createElement("img"),l.className="beeld",l.alt="Wat de printer aan het maken is",n.appendChild(l)),l.dataset.bron!==s&&(l.dataset.bron=s,l.src=s),n.querySelector(".leeg")?.remove();else if(l?.remove(),!n.querySelector(".leeg")){let d=document.createElement("span");d.className="leeg",d.textContent="Nog geen voorbeeld",n.appendChild(d)}}paintVoortgang_(e){let t=this.config,n=this.$(".voort"),a=fr(v(this.hass,t.progress)),r=vr(v(this.hass,t.remaining));if(n.hidden=a===null&&!e,n.hidden)return;let o=this.$(".balk");o.dataset.onbekend=String(a===null),o.querySelector("i").style.setProperty("--pct",`${a??0}%`),this.text(".pct",a===null?"Bezig":`${a}%`),this.text(".rest",r===null||r<=0?"":`nog ${kr(r)} \xB7 klaar om ${xr(r)}`)}paintTegels_(){let e=this.config,t=this.$(".tegels"),n=[],a=br(v(this.hass,e.nozzle_temp));a&&n.push({w:`${a.waarde}${a.eenheid}`,l:"Nozzle"});let r=br(v(this.hass,e.bed_temp));r&&n.push({w:`${r.waarde}${r.eenheid}`,l:"Bed"});let o=v(this.hass,e.door);if(o){let l=Y(o);n.push({w:l?"Open":"Dicht",l:"Deur",let:l})}if(t.hidden=!n.length,!n.length)return;t.style.setProperty("--kolommen",String(n.length));let s=n.map(l=>`${l.w}|${l.l}|${l.let??""}`).join(",");t.dataset.sig!==s&&(t.dataset.sig=s,t.innerHTML=n.map(l=>`<div class="tegel" data-let="${!!l.let}"><span class="w">${this.veilig_(l.w)}</span><span class="l">${this.veilig_(l.l)}</span></div>`).join(""))}paintAms_(){let e=this.config,t=this.$(".ams"),n=xt.filter(l=>e[`tray_${l}`]||e[`tray_${l}_color`]);if(t.hidden=!n.length,!n.length)return;let a=this.$(".ams .rij"),r=xt.map(l=>Zl(v(this.hass,e[`tray_${l}`]),{color:e[`tray_${l}_color`],label:e[`tray_${l}_label`]})),o=xt.map(l=>v(this.hass,e[`tray_${l}`])?.attributes?.name??""),s=r.map(l=>`${l.kleur}|${l.soort}|${l.leeg}|${l.actief}|${l.rest}`).join(",");a.dataset.sig!==s&&(a.dataset.sig=s,a.innerHTML=r.map((l,d)=>{let c=o[d],p=`Tray ${d+1}`+(l.leeg?": leeg":c||l.soort?`: ${c||l.soort}`:"")+(l.rest===null?"":` \u2014 nog ${l.rest}%`)+(l.actief?" (in gebruik)":"");return`<div class="tray" data-leeg="${l.leeg}" data-actief="${l.actief}" style="--kleur:${l.kleur??"transparent"}" title="${this.veilig_(p)}"><span class="vlak">${l.rest===null?"":`<i style="--rest:${l.rest}%"></i>`}</span><span class="txt"><span class="nr">Tray ${d+1}</span><span class="so">${this.veilig_(l.leeg?"leeg":l.soort||"gevuld")}</span></span></div>`}).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.camera||this.config?.image?6:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-printer-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>/^sensor\./.test(a)&&/(print|stage|status)/i.test(a));return n?{status:n}:{}}};z(oa,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var wr=class extends C{defaults(){return{icon:"printer3d"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"printer3d",auto:!1}]}schema(){return[{name:"name",selector:b.text()},{name:"status",selector:b.entity(["sensor","binary_sensor"])},{name:"power",selector:b.entity(["switch","input_boolean"])},{name:"progress",selector:b.entity(["sensor","number"])},{name:"remaining",selector:b.entity(["sensor"])},{name:"nozzle_temp",selector:b.entity(["sensor","number"])},{name:"bed_temp",selector:b.entity(["sensor","number"])},{name:"door",selector:b.entity(["binary_sensor"])},{name:"camera",selector:b.entity("camera")},{name:"live_view",selector:b.bool()},{name:"image",selector:b.entity(["image","camera"])},...xt.flatMap(e=>[{name:`tray_${e}`,selector:b.entity(["sensor","select","text"])},{name:`tray_${e}_color`,selector:b.text()},{name:`tray_${e}_label`,selector:b.text()}])]}label(e){let t={};for(let n of xt)t[`tray_${n}`]=`Tray ${n}`,t[`tray_${n}_color`]=`Tray ${n}: kleur met de hand`,t[`tray_${n}_label`]=`Tray ${n}: naam met de hand`;return{name:"Naam",status:"Printstatus",power:"Aan/uit-schakelaar",progress:"Printvoortgang (0-100%)",remaining:"Eindtijd of resterende tijd",nozzle_temp:"Nozzletemperatuur",bed_temp:"Bedtemperatuur",door:"Deur van de printer",camera:"Camera",live_view:"Altijd live beeld",image:"Voorbeeld van de print",...t}[e.name]??super.label(e)}helper(e){if(e.name==="status")return"De sensor die meldt wat hij doet. RUNNING, IDLE, FINISH, PAUSE en FAILED worden herkend, en die van Octoprint en Klipper ook.";if(e.name==="power")return"Zetten en uitzetten. Bij UITzetten vraagt de kaart eerst of je het zeker weet \u2014 en loopt er een print, dan staat erbij hoe ver hij was.";if(e.name==="remaining")return"Een aantal minuten, een klok als 1:24:00 of het tijdstip waarop hij klaar is: alle drie worden gelezen. De kaart toont beide \u2014 hoe lang nog \xE9n hoe laat.";if(e.name==="camera")return"Het live beeld van de printer. Staat er ook een voorbeeld ingesteld, dan komt er een knop om te wisselen.";if(e.name==="live_view")return"Normaal ververst het beeld een paar keer per minuut en gaat hij alleen echt live zolang er een print loopt. Met deze knop staat de stream altijd aan \u2014 mooier, maar het kost een verbinding die de hele dag openstaat.";if(e.name==="image")return"De `image`-entiteit met de plaat van wat hij aan het maken is.";if(e.name==="tray_1")return"De vier trays van de AMS. De kaart haalt de kleur en het soort filament uit de attributen van de entiteit; Bambu levert die als hexwaarde. Lukt dat niet, vul dan hieronder zelf een kleur in.";if(/^tray_\d_color$/.test(e.name))return"Alleen nodig als de entiteit zijn kleur niet meelevert. Een hexwaarde (#FF6B00) of een kleurnaam."}};I("domotiapp-printer-card-editor",wr);N("domotiapp-printer-card",oa,{name:"DomotiApp 3D-printer",description:"Live camerabeeld of het voorbeeld, voortgang met eindtijd, temperaturen, de deur en de vier trays van de AMS met hun echte kleur."});var wt={fuel:{label:"Brandstof",icoon:"petrol"},hybrid:{label:"Hybride",icoon:"leaf"},electric:{label:"Elektrisch",icoon:"bolt"}},_r=i=>i==="electric"||i==="hybrid",yr=i=>i==="fuel"||i==="hybrid",lu=["charging","charge","fast_charging","dc_charging","on","true","laden"],du=["complete","completed","fully_charged","full","done","finished"],cu=["connected","plugged","plugged_in","cable_connected","ready_to_charge"],pu=["not_plugged_in","not_plugged","notpluggedin","unplugged","disconnected","not_charging","notcharging","off","false","idle","no"];function Xl(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:lu.includes(e)?"charging":du.includes(e)?"complete":cu.includes(e)?"connected":pu.includes(e)?"idle":"onbekend"}function Yl(i,e){if(i&&i!=="onbekend")return sa[i]??"";let t=String(e?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return"";let n=t.replace(/[_-]+/g," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}var sa={charging:"Aan het laden",complete:"Volgeladen",connected:"Aan de lader",idle:"Niet aan de lader"};function zr(i,e){let t=Number(i?.state);if(!Number.isFinite(t))return null;let n=String(i?.attributes?.unit_of_measurement??"").toLowerCase(),a=Number(e);return n!=="%"&&Number.isFinite(a)&&a>0?Math.max(0,Math.min(100,Math.round(t/a*100))):Math.max(0,Math.min(100,Math.round(t)))}function Ql(i){let e=Number(i?.state);return Number.isFinite(e)?{waarde:Math.round(e),eenheid:i?.attributes?.unit_of_measurement??"km"}:null}function jr(i){if(i==null)return null;let e=i<=10?"bad":i<=20?"warn":"good";return{procent:i,toon:e}}function $r(i,e=Date.now()){let t=String(i?.state??"").trim();if(!t||t==="unavailable"||t==="unknown")return null;if(i?.attributes?.device_class==="timestamp"||/[T ]\d{2}:\d{2}/.test(t)){let r=Date.parse(t);if(Number.isFinite(r))return Math.max(0,Math.round((r-e)/6e4))}if(/^\d+:\d{2}(:\d{2})?$/.test(t)){let r=t.split(":").map(Number),[o,s]=r.length===3?r:[0,r[0]];return o*60+s}let n=Number(t);if(!Number.isFinite(n))return null;let a=String(i?.attributes?.unit_of_measurement??"").toLowerCase();return a==="h"||a.startsWith("hour")?Math.round(n*60):a==="s"||a.startsWith("sec")?Math.round(n/60):Math.round(n)}function Er(i){if(i==null)return"";let e=Math.max(0,Math.round(i));return e<60?`${e} min`:`${Math.floor(e/60)} u ${String(e%60).padStart(2,"0")}`}function Jl({open:i,slot:e,laden:t,laadMinuten:n,radius:a,aandrijving:r}){if(i)return{tekst:"Er staat iets open",toon:"warn"};if(e==="unlocked")return{tekst:"Niet op slot",toon:"warn"};if(t==="charging"){let o=n?` \xB7 nog ${Er(n)}`:"";return{tekst:`${sa.charging}${o}`,toon:"accent"}}return t==="complete"?{tekst:sa.complete,toon:"good"}:t==="connected"?{tekst:sa.connected,toon:"neutral"}:a?{tekst:`Nog ${a.waarde} ${a.eenheid}`,toon:"neutral"}:{tekst:wt[r]?.label??"",toon:"neutral"}}var hu=100,uu=["home","thuis","at_home","athome"],mu=["not_home","away","afwezig","weg","not home","nothome"];function gu(i,e,t,n){let r=d=>d*Math.PI/180,o=r(t-i),s=r(n-e),l=Math.sin(o/2)**2+Math.cos(r(i))*Math.cos(r(t))*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.min(1,Math.sqrt(l)))}function fu(i){let e=i?.attributes??{},t=Number(e.latitude??e.lat),n=Number(e.longitude??e.lon??e.lng);if(Number.isFinite(t)&&Number.isFinite(n))return{lat:t,lon:n};let a=String(i?.state??""),r=a.match(/(?:lat|latitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i),o=a.match(/(?:lon|lng|longitude)["']?\s*[:=]\s*(-?\d+(?:\.\d+)?)/i);return r&&o?{lat:Number(r[1]),lon:Number(o[1])}:null}function ed(i,e,t=hu){if(!i)return{thuis:null,tekst:"",meters:null};let n=String(i.state??"").trim(),a=n.toLowerCase();if(a==="unavailable"||a==="unknown"||!n)return{thuis:null,tekst:"",meters:null};if(uu.includes(a))return{thuis:!0,tekst:"Thuis",meters:null};if(mu.includes(a))return{thuis:!1,tekst:"Afwezig",meters:null};let r=fu(i),o=Number(e?.config?.latitude),s=Number(e?.config?.longitude);if(r&&Number.isFinite(o)&&Number.isFinite(s)){let l=gu(r.lat,r.lon,o,s),d=l<=t;return{thuis:d,tekst:d?"Thuis":"Afwezig",meters:Math.round(l)}}return{thuis:!1,tekst:n.charAt(0).toUpperCase()+n.slice(1),meters:null}}var bu=["open","opened","ajar","unlatched","on","true","unlocked"],vu=["closed","close","shut","secured","locked","off","false","not_open"];function Ar(i){let e=String(i?.state??"").trim().toLowerCase();return!e||e==="unavailable"||e==="unknown"?null:bu.includes(e)?!0:vu.includes(e)?!1:/(^|[^a-z])(ajar|open)([^a-z]|$)/.test(e)?!0:null}function td(i){let e=String(i?.state??"").trim().toLowerCase();if(!e||e==="unavailable"||e==="unknown")return null;if(String(i?.entity_id??"").split(".")[0]==="lock")return e==="locked"?!0:e==="unlocked"||e==="open"||e==="opening"?!1:null;if(i?.attributes?.device_class==="lock"){if(e==="on")return!1;if(e==="off")return!0}return["locked","lock","secured","closed","off","false"].includes(e)?!0:["unlocked","unlock","open","unsecured","on","true"].includes(e)?!1:null}var Mr={good:E.good,warn:E.warn,bad:E.bad,neutral:E.neutral,accent:E.accent},la=class extends S{validate(e){let t={name:"",icon:"car",drivetrain:"electric",photo_size:"klein",...e};return t.battery||t.fuel||t.range||t.range_electric||t.sensors?.length||t.lock||t.image||(t[L]="Kies de aandrijving en vul minstens \xE9\xE9n sensor in \u2014 de accu, de tank of de actieradius."),t}watched(){let e=this.config;return[e.battery,e.fuel,e.range,e.range_electric,e.charging,e.charging_ready,e.charging_power,e.plug,e.lock,e.doors,e.windows,e.odometer,e.climate,e.location,...Array.isArray(e.sensors)?e.sensors:[]].filter(Boolean)}soort_(){return wt[this.config.drivetrain]?this.config.drivetrain:"electric"}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.setAttribute("foto",e.photo_size==="groot"?"groot":"klein"),this.style.containerType="inline-size",`
      <div class="card surface">
        <div class="kop">
      ...
      </div>`}wire(){this.teardown_.push(H(this.$(".card"))),this.on(this.$(".foto"),"click",()=>{let e=this.config;P(this,e.battery||e.range||e.fuel||e.lock)}),this.on(this.$(".tegels"),"click",e=>{let t=e.target.closest?.("[data-id]");t&&P(this,t.dataset.id)})}paint(){let e=this.config,t=this.soort_(),n=_r(t)?zr(v(this.hass,e.battery),e.battery_max):null,a=yr(t)?zr(v(this.hass,e.fuel),e.fuel_max):null,r=Ql(v(this.hass,e.range)),o=Xl(v(this.hass,e.charging)),s=$r(v(this.hass,e.charging_ready)),l=v(this.hass,e.lock),d=Ar(v(this.hass,e.doors)),c=Ar(v(this.hass,e.windows)),p=d===!0||c===!0,h=td(l),g=ed(v(this.hass,e.location),this.hass,Number(e.home_radius)||void 0),u=e.battery&&!v(this.hass,e.battery)&&e.range&&!v(this.hass,e.range);this.toggleAttribute("dead",!!u),this.text(".nm",e.name||M(this.hass,e.battery||e.range||e.lock,"Auto"));let k=Jl({open:p,slot:h===!1?"unlocked":h===!0?"locked":null,laden:o,laadMinuten:s,radius:r,aandrijving:t});this.text(".st",k.tekst),this.$(".st").style.setProperty("--melding",Mr[k.toon]??E.neutral),this.paintFoto_(),this.paintBalken_({accu:n,tank:a,radius:r,laden:o,soort:t}),this.paintTegels_(g,o,{slot:h,deurOpen:d,raamOpen:c}),T(this.$(".card"))}paintFoto_(){let e=this.$(".foto"),t=this.config.image;if(!t){e.dataset.bron!==""&&(e.dataset.bron="",e.innerHTML=f(this.config.icon||"car"));return}if(e.dataset.bron===t)return;e.dataset.bron=t;let n=document.createElement("img");n.src=t,n.alt=this.config.name||"De auto",n.loading="lazy",n.onerror=()=>{e.dataset.bron="",e.innerHTML=f(this.config.icon||"car")},e.replaceChildren(n)}paintBalken_({accu:e,tank:t,radius:n,laden:a,soort:r}){let o=this.config,s=this.$(".balken"),l=[];if(e!==null){let h=jr(e);l.push({sleutel:"accu",icoon:"battery",label:"Accu",pct:e,toon:a==="charging"?"accent":h.toon,waarde:`${e}%`,laadt:a==="charging"})}if(t!==null){let h=jr(t);l.push({sleutel:"tank",icoon:r==="hybrid"?"petrol":wt[r].icoon,label:"Tank",pct:t,toon:h.toon,waarde:`${t}%`,laadt:!1})}if(!l.length&&n&&l.push({sleutel:"radius",icoon:"gaugeArrow",label:"Actieradius",pct:null,toon:"neutral",waarde:`${n.waarde} ${n.eenheid}`,laadt:!1}),s.hidden=!l.length,!l.length)return;let d=n?`${n.waarde} ${n.eenheid}`:"",c=$r(v(this.hass,o.charging_ready)),p=l.map(h=>`${h.sleutel}:${h.pct}:${h.toon}:${h.laadt}`).join(",")+d+c;s.dataset.sig!==p&&(s.dataset.sig=p,s.innerHTML=l.map((h,g)=>{let u=g===0&&h.sleutel!=="radius"&&d?`<span class="w">${this.veilig_(h.waarde)} \xB7 ${this.veilig_(d)}</span>`:`<span class="w">${this.veilig_(h.waarde)}</span>`,k=h.laadt&&c?` \xB7 nog ${this.veilig_(Er(c))}`:"";return`
          <div class="meter" style="--balk:${Mr[h.toon]??E.neutral}">
            <div class="regel">
              <span class="l">${f(h.icoon)}<span>${this.veilig_(h.label)}${k}</span></span>
              ${u}
            </div>
            ${h.pct===null?"":`<div class="lijn" data-laadt="${h.laadt}"><i style="--pct:${h.pct}%"></i></div>`}
          </div>`}).join(""))}paintTegels_(e,t,n={}){let a=this.config,r=this.$(".tegels"),o=[],s=(d,c)=>{let p=v(this.hass,d);if(!p||p.state==="unavailable"||p.state==="unknown")return;let h=p.attributes?.unit_of_measurement??"",g=Number(p.state),u=Number.isFinite(g)?`${Math.round(g*10)/10}${h?` ${h}`:""}`:p.state;o.push({id:d,w:u,l:c??M(this.hass,d,d)})};if(a.location&&e?.tekst){let d=e.thuis===!1&&e.meters!==null?e.meters>=1e3?` \xB7 ${Math.round(e.meters/100)/10} km`:` \xB7 ${e.meters} m`:"";o.push({id:a.location,w:e.tekst+d,l:"Waar hij staat",toon:e.thuis===!0?"good":null})}if(a.charging){let d=v(this.hass,a.charging),c=Yl(t,d);c&&o.push({id:a.charging,w:c,l:"Laadstatus",toon:t==="charging"?"accent":t==="complete"?"good":null})}a.lock&&n.slot!==null&&n.slot!==void 0&&o.push({id:a.lock,w:n.slot?"Op slot":"Niet op slot",l:"Portierslot",toon:n.slot?"good":"warn"}),a.doors&&n.deurOpen!==null&&n.deurOpen!==void 0&&o.push({id:a.doors,w:n.deurOpen?"Open":"Dicht",l:"Deuren",toon:n.deurOpen?"warn":null}),a.windows&&n.raamOpen!==null&&n.raamOpen!==void 0&&o.push({id:a.windows,w:n.raamOpen?"Open":"Dicht",l:"Ramen",toon:n.raamOpen?"warn":null}),a.climate&&s(a.climate,"Voorverwarmen"),a.odometer&&s(a.odometer,"Kilometerstand"),a.charging_power&&s(a.charging_power,"Laadvermogen");for(let d of Array.isArray(a.sensors)?a.sensors:[])s(d,null);if(r.hidden=!o.length,!o.length)return;let l=o.map(d=>`${d.id}|${d.w}|${d.toon??""}`).join(",");r.dataset.sig!==l&&(r.dataset.sig=l,r.innerHTML=o.map(d=>`<div class="tegel" data-id="${this.veilig_(d.id)}" role="button" tabindex="0"${d.toon?` style="--tegeltoon:${Mr[d.toon]??E.neutral}"`:""}><span class="w">${this.veilig_(d.w)}</span><span class="l">${this.veilig_(d.l)}</span></div>`).join(""))}veilig_(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}getCardSize(){return this.config?.photo_size==="groot"?5:3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-auto-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>/^sensor\..*(battery|accu|soc)/i.test(a));return n?{battery:n,drivetrain:"electric"}:{drivetrain:"electric"}}};z(la,"css",`
    :host { display: block; }
    *, *::before, *::after { box-sizing: border-box; }
  ...
  `);var Sr=class extends C{defaults(){return{icon:"car",drivetrain:"electric",photo_size:"klein"}}pickers(){return[{key:"image",kind:"foto",label:"Foto van de auto"},{key:"icon",kind:"icon",label:"Icoon (zonder foto)",fallback:"car"}]}schema(){let e=wt[this.config_?.drivetrain]?this.config_.drivetrain:"electric",t=[{name:"name",selector:b.text()},{name:"drivetrain",selector:b.select(Object.entries(wt).map(([n,{label:a}])=>({value:n,label:a})))},{name:"photo_size",selector:b.select([{value:"klein",label:"Klein, naast de naam"},{value:"groot",label:"Groot, over de hele breedte"}])},{name:"range",selector:b.entity(["sensor","number"])}];return _r(e)&&t.push({name:"battery",selector:b.entity(["sensor","number"])},{name:"battery_max",selector:b.number(1,400,1)},{name:"charging",selector:b.entity(["sensor","binary_sensor","switch"])},{name:"charging_ready",selector:b.entity(["sensor"])},{name:"charging_power",selector:b.entity(["sensor"])}),yr(e)&&t.push({name:"fuel",selector:b.entity(["sensor","number"])},{name:"fuel_max",selector:b.number(1,200,1)}),t.push({name:"lock",selector:b.entity(["lock","sensor","binary_sensor"])},{name:"doors",selector:b.entity(["binary_sensor","sensor","cover"])},{name:"windows",selector:b.entity(["binary_sensor","sensor","cover"])},{name:"climate",selector:b.entity(["sensor","binary_sensor","switch","climate"])},{name:"location",selector:b.entity(["device_tracker","sensor","person"])},{name:"home_radius",selector:b.number(10,2e3,10)},{name:"odometer",selector:b.entity(["sensor"])},{name:"sensors",selector:{entity:{multiple:!0}}}),t}label(e){return{name:"Naam",drivetrain:"Aandrijving",image:"Foto van de auto",photo_size:"Hoe groot staat de foto",range:"Actieradius",battery:"Accupercentage",battery_max:"Accu-inhoud (kWh), als de sensor geen procenten geeft",charging:"Laadstatus",charging_ready:"Klaar met laden om / nog te gaan",charging_power:"Laadvermogen",fuel:"Tankniveau",fuel_max:"Tankinhoud (liter), als de sensor geen procenten geeft",lock:"Portierslot",doors:"Deuren open",windows:"Ramen open",climate:"Voorverwarmen (alleen uitlezen)",location:"Waar hij staat",home_radius:"Hoe dichtbij is thuis (meter)",odometer:"Kilometerstand",sensors:"Extra sensoren als tegel"}[e.name]??super.label(e)}helper(e){return{drivetrain:"Bepaalt welke balken er op de kaart komen \u2014 een accu, een tank, of allebei \u2014 en welke velden je hieronder ziet.",image:"Kies een bestand of sleep er een op. Home Assistant zet hem in zijn eigen media-opslag; je kunt ook een pad als /local/auto.png intypen.",range:"In de eenheid van de sensor zelf. De kaart rekent niets om: staat je Home Assistant op mijlen, dan zie je mijlen.",battery_max:"Alleen nodig als je accusensor in kWh meldt in plaats van in procenten. Dan rekent de kaart het percentage zelf uit.",fuel_max:"Alleen nodig als je tanksensor in liters meldt in plaats van in procenten.",charging_ready:"Een aantal minuten, een klok of het tijdstip waarop hij vol is \u2014 alle drie worden gelezen.",doors:"Staat er iets open, dan zegt de kaart dat en gaat al het andere even opzij. Een binary_sensor mag, maar een gewone sensor met een woord erin ook \u2014 Closed, Open, Ajar en LOCKED worden allemaal gelezen.",lock:"Alleen uitlezen: deze kaart bedient niets. Een lock-entiteit mag, maar ook een sensor die LOCKED of UNLOCKED meldt.",location:"Een device_tracker die home of not_home meldt, of een sensor met een coordinaat \u2014 beide worden gelezen. Bij een coordinaat rekent de kaart de afstand tot de locatie van je Home Assistant uit en maakt daar Thuis of Afwezig van.",home_radius:"Alleen van belang bij een sensor met een coordinaat. Binnen deze afstand van je huis heet de auto thuis. Leeg laten is 100 meter \u2014 ruim genoeg voor een oprit of een parkeerplaats om de hoek.",sensors:"Alles wat je verder nog kwijt wilt: bandenspanning, buitentemperatuur, de volgende beurt. Ze komen als tegels onderaan te staan, met de naam uit Home Assistant."}[e.name]}};I("domotiapp-auto-card-editor",Sr);N("domotiapp-auto-card",la,{name:"DomotiApp Auto",description:"Brandstof, hybride of elektrisch: accu- en tankbalk, actieradius, laadstatus, het slot en zoveel eigen sensoren als je kwijt wilt \u2014 met een foto van de auto erbij."});function nd(i,e){return i?.entities?.[e]?.device_id??null}function Nr(i,e,t,n){if(n&&t.includes(n))return n;let a=nd(i,e);if(a){let r=t.filter(o=>nd(i,o)===a);if(r.length===1)return r[0]}return null}function da(i,e,t,n,a){let r=Nr(i,e,t,n);return r===null||r===a}var id=[{sleutel:"mens",label:"Mens",icoon:"person",woorden:["person","persoon","personen","mens","people","human"]},{sleutel:"dier",label:"Dier",icoon:"dier",woorden:["pet","pets","dier","dieren","huisdier","animal","dog","hond","cat","kat"]},{sleutel:"voertuig",label:"Voertuig",icoon:"car",woorden:["vehicle","voertuig","car","auto","truck","vrachtwagen","motorcycle"]},{sleutel:"aanbellen",label:"Aanbellen",icoon:"bell",woorden:["doorbell","deurbel","aanbellen","aangebeld","visitor","bezoeker","bel","ring","chime"]},{sleutel:"ontgrendeling",label:"Ontgrendeling",icoon:"lockOpen",woorden:["unlock","unlocked","ontgrendeld","ontgrendeling","slot","lock","opener","deuropener","buzzer","toegang","access","entry","keypad","badge","pas"]}],rd={sleutel:"beweging",label:"Beweging",icoon:"cctv",woorden:[]},Yt=[...id,rd];function od(i){return Yt.find(e=>e.sleutel===i)??rd}function ad(i){return String(i??"").toLowerCase().split(/[^a-z0-9]+/).filter(Boolean)}function ca(i,e,t){if(String(i??"").split(".")[0]==="lock")return"ontgrendeling";if(t==="doorbell")return"aanbellen";let a=new Set([...ad(i),...ad(e)]);for(let r of id)if(r.woorden.some(o=>a.has(o)))return r.sleutel;return null}function sd(i,e={}){let t=i?.melder,n=t?e[`meldersoort:${t}`]:null;return n&&Yt.some(a=>a.sleutel===n)?n:ca(t,i?.naam)}function Xt(i){let e=Date.parse(i?.tijd??"");return Number.isNaN(e)?null:e}function pa(i,{soorten:e,camera:t,dag:n,config:a}={}){let r=e instanceof Set?e:new Set(e??[]),o=n==null?null:ae(n);return(Array.isArray(i)?i:[]).filter(s=>{if(r.size){let l=sd(s,a);if(!l||!r.has(l))return!1}if(t&&s.camera!==t)return!1;if(o){let l=Xt(s);if(l===null||l<o.vanaf||l>=o.tot)return!1}return!0})}function ld(i,e={}){let t={};for(let n of Array.isArray(i)?i:[]){let a=sd(n,e);a&&(t[a]=(t[a]??0)+1)}return t}function dd(i){let e=new Set((Array.isArray(i)?i:[]).map(t=>t?.soort).filter(Boolean));return Yt.filter(t=>e.has(t.sleutel))}function cd(i,e,t){let n=Array.isArray(e)?e:[];if(n.some(r=>r==null))return[...i??[]];let a=new Set(n.filter(Boolean));for(let r of Array.isArray(t)?t:[])r?.camera&&a.add(r.camera);return(i??[]).filter(r=>a.has(r))}function Or(i){let e=new Set;for(let t of Array.isArray(i)?i:[]){let n=Xt(t);n!==null&&e.add(ae(n).vanaf)}return[...e].sort((t,n)=>n-t)}function ha(i,e,t){let n=ae(e).vanaf,a=(i??[]).filter(r=>t<0?r<n:r>n);return a.length?t<0?a[0]:a[a.length-1]:null}function Tr(i){let e=new Map;for(let n of Array.isArray(i)?i:[]){let a=Xt(n),r=a===null?null:ae(a).vanaf;e.has(r)||e.set(r,[]),e.get(r).push(n)}return[...e.entries()].map(([n,a])=>({dag:n,beelden:a.sort((r,o)=>(Xt(o)??0)-(Xt(r)??0)),bytes:a.reduce((r,o)=>r+(Number(o.bytes)||0),0)})).sort((n,a)=>n.dag===null?1:a.dag===null?-1:a.dag-n.dag)}function Dr(i){let e=Number(i)||0;return e>=1024*1024*1024?`${(e/(1024*1024*1024)).toFixed(1)} GB`:e>=1024*1024?`${Math.round(e/(1024*1024))} MB`:e>=1024?`${Math.round(e/1024)} kB`:`${e} B`}function ae(i){let e=new Date(i),t=new Date(e.getFullYear(),e.getMonth(),e.getDate()).getTime(),n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1).getTime();return{vanaf:t,tot:n}}function Lr(i,e){let t=new Date(i);return new Date(t.getFullYear(),t.getMonth(),t.getDate()+e).getTime()}var ku=["zo","ma","di","wo","do","vr","za"],xu=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"];function _t(i,e=Date.now()){if(i==null)return"Alles";let t=ae(e).vanaf,n=ae(i).vanaf,a=Math.round((t-n)/864e5);if(a===0)return"Vandaag";if(a===1)return"Gisteren";let r=new Date(n);return`${ku[r.getDay()]} ${r.getDate()} ${xu[r.getMonth()]}`}function wu(i){let e=[i?.camera,...Array.isArray(i?.cameras)?i.cameras:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function _u(i){let e=[...Array.isArray(i?.motion_sensors)?i.motion_sensors:[],...i?.motion?[i.motion]:[]].filter(t=>typeof t=="string"&&t);return[...new Set(e)]}function yu(i,e){let t=wu(e),n=_u(e),a=!!e?.snapshots;return t.map(r=>{let o=n.filter(l=>da(i,l,t,e?.[`melderbij:${l}`],r)),s={};for(let l of o){let d=e?.[`melder:${l}`];typeof d=="string"&&d.trim()&&(s[l]=d.trim())}return{camera:r,aan:a&&o.length>0,melders:o,namen:s,rustperiode:pd(e?.snapshot_rustperiode,60),wachttijd:pd(e?.snapshot_wachttijd,0),ontvangers:ju(e?.snapshot_ontvangers).filter(l=>l.startsWith("person.")),alleen_afwezig:!!e?.snapshot_alleen_afwezig}})}function zu(i,e){if(!e)return!0;for(let t of Object.keys(i))if(!Cr(i[t],e[t]))return!0;return!1}function hd(i,e,t){return yu(i,e).filter(n=>zu(n,t?.[n.camera]))}function Cr(i,e){return Array.isArray(i)&&Array.isArray(e)?i.length===e.length&&i.every((t,n)=>Cr(t,e[n])):i&&e&&typeof i=="object"&&typeof e=="object"?[...new Set([...Object.keys(i),...Object.keys(e)])].every(n=>Cr(i[n],e[n])):i===e}function ju(i){return Array.isArray(i)?i.filter(e=>typeof e=="string"):typeof i=="string"&&i?[i]:[]}function pd(i,e){let t=Number(i);return Number.isFinite(t)&&t>=0?Math.round(t):e}var $u=`
  :host {
    ${W}
...
`;function nt(i){return String(i??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var Rr=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[q($u)],this.beelden_=[]}open(e){this.opts_=e,this.beelden_=e.beelden??[],this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.alleenBeeld_=!!e.beeld,this.$(".scherm").hidden=this.alleenBeeld_,e.beeld?this.toonGroot_(e.beeld):this.$(".groot").hidden=!0,this.teken_()}zet(e){this.beelden_=e??[],this.hasAttribute("open")&&this.teken_()}sluit(){this.removeAttribute("open"),this.opts_?.dicht?.()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      ...
      </div>`,this.shadowRoot.addEventListener("click",e=>{e.stopPropagation();let t=this.$(".groot");if(!t.hidden&&e.composedPath().includes(t)){if(this.alleenBeeld_)return this.sluit();t.hidden=!0;return}if(e.target.closest?.(".terug"))return this.sluit();let n=e.target.closest?.("[data-weg]");if(n){let o=this.beelden_.find(s=>s.id===n.dataset.weg);return this.opts_?.wis?.([n.dataset.weg],o?`dit beeld van ${o.naam??"de camera"}`:"dit beeld")}let a=e.target.closest?.("[data-wisdag]");if(a){let o=Tr(this.beelden_).find(s=>String(s.dag)===a.dataset.wisdag);return o?this.opts_?.wis?.(o.beelden.map(s=>s.id),`${o.beelden.length} beelden van ${_t(o.dag).toLowerCase()}`):void 0}if(e.target.closest?.(".wis"))return this.beelden_.length?this.opts_?.wis?.(this.beelden_.map(o=>o.id),`alle ${this.beelden_.length} beelden`):void 0;let r=e.target.closest?.("[data-beeld]");r&&this.toonGroot_(r.dataset.beeld)}),this.tabIndex=-1,this.addEventListener("keydown",e=>{e.key==="Escape"&&(e.stopPropagation(),!this.$(".groot").hidden&&!this.alleenBeeld_?this.$(".groot").hidden=!0:this.sluit())})}toonGroot_(e){let t=this.beelden_.find(a=>a.id===e);if(!t)return;let n=this.$(".groot");n.querySelector("img").src=t.url,n.querySelector(".onder").textContent=`${this.opts_.camNaam(t.camera)} \xB7 ${t.naam??""} \xB7 ${this.opts_.klok(t.tijd,!0)}`,n.hidden=!1}teken_(){if(this.alleenBeeld_)return;let e=Tr(this.beelden_),t=this.beelden_.reduce((r,o)=>r+(Number(o.bytes)||0),0),n=this.opts_.meerdere;this.$(".stat").textContent=this.beelden_.length?`${this.beelden_.length} beelden \xB7 ${Dr(t)}`:"",this.$(".wis").disabled=!this.beelden_.length,this.$(".lijst").innerHTML=e.length?e.map(r=>{let o=r.dag===null?"Zonder datum":_t(r.dag);return`<div class="dagkop"><span>${nt(o)}</span><span class="bij">${r.beelden.length} \xB7 ${Dr(r.bytes)}</span><button type="button" data-wisdag="${r.dag}">Wis deze dag</button></div><div class="raster">`+r.beelden.map(s=>{let l=n?`${nt(this.opts_.camNaam(s.camera))} \xB7 `:"";return`<button type="button" class="kiek" data-beeld="${nt(s.id)}"><img src="${nt(s.url)}" alt="" loading="lazy"><span class="bij">${l}${nt(s.naam??"")} \xB7 ${nt(this.opts_.klok(s.tijd))}</span><span class="weg" role="button" data-weg="${nt(s.id)}" aria-label="Verwijder">${f("close")}</span></button>`}).join("")+"</div>"}).join(""):'<div class="leeg">Er liggen geen snapshots.</div>';let a=this.$(".groot");!a.hidden&&this.alleenBeeld_===!1&&(this.beelden_.some(o=>a.querySelector("img").src.includes(o.id))||(a.hidden=!0))}};D("domotiapp-camera-archief",Rr);function ud(i){let e=document.querySelector("domotiapp-camera-archief");return e||(e=document.createElement("domotiapp-camera-archief"),document.body.appendChild(e)),e.open(i),e.focus?.(),e}function Hr(i){document.querySelector("domotiapp-camera-archief")?.zet(i)}function ua(i){let e=Number(i);return Number.isFinite(e)?Math.max(1,Math.min(6,e)):1}function Eu(i){let e=ua(i);return Math.max(0,(1-1/e)/2)}function Qt(i,e,t){let n=Eu(t),a=o=>Number.isFinite(Number(o))?Number(o):0,r=o=>Math.max(-n,Math.min(n,a(o)))+0;return{x:r(i),y:r(e)}}function ma(i,e,t={x:0,y:0}){let n=ua(i?.zoom??1),a=ua(n*(Number(e)||1));if(a===n)return{zoom:n,...Qt(i?.x,i?.y,n)};let r=Number(t?.x)||0,o=Number(t?.y)||0,s=(i?.x??0)+r*(1/n-1/a),l=(i?.y??0)+o*(1/n-1/a);return{zoom:a,...Qt(s,l,a)}}function md({zoom:i=1,x:e=0,y:t=0}={}){let n=ua(i),a=Qt(e,t,n);return`scale(${n}) translate(${(-a.x*100).toFixed(3)}%, ${(-a.y*100).toFixed(3)}%)`}var fd=[{sleutel:"auto",label:"Volgt de camera",css:null},{sleutel:"16:9",label:"16:9 (breed)",css:"16 / 9"},{sleutel:"4:3",label:"4:3",css:"4 / 3"},{sleutel:"3:2",label:"3:2",css:"3 / 2"},{sleutel:"1:1",label:"Vierkant",css:"1 / 1"}],Au=7,ga=[{k:"up",icoon:"arrowUp",label:"Omhoog"},{k:"left",icoon:"chevronRight",label:"Links",draai:180},{k:"right",icoon:"chevronRight",label:"Rechts"},{k:"down",icoon:"arrowDown",label:"Omlaag"}];function bd(i){return!!(i.presets||Array.isArray(i.preset_buttons)&&i.preset_buttons.length||ga.some(e=>i[`ptz_${e.k}`]))}var fa=class extends S{validate(e){let t={name:"",...e};return!t.camera&&!(Array.isArray(t.cameras)&&t.cameras.length)&&(t[L]="Kies een camera. Presets, richtingsknoppen en een bewegingsmelder mogen daarna."),t.presets_aan===void 0&&(t.presets_aan=bd(t)),t}watched(){let e=this.config;return[...this.cameras_(),e.presets,...this.melders_().map(t=>t.entity),...Array.isArray(e.preset_buttons)?e.preset_buttons:[]].filter(Boolean)}melders_(){let e=this.config,t=[...Array.isArray(e.motion_sensors)?e.motion_sensors:[],...e.motion?[e.motion]:[]].filter(n=>typeof n=="string");return[...new Set(t)].map(n=>{let a=e[`melder:${n}`]||M(this.hass,n)||"Beweging";return{entity:n,naam:a,bijCamera:e[`melderbij:${n}`],soort:e[`meldersoort:${n}`]||ca(n,a,v(this.hass,n)?.attributes?.device_class)}})}cameras_(){let e=this.config,t=[e.camera,...Array.isArray(e.cameras)?e.cameras:[]].filter(Boolean);return[...new Set(t)]}huidig_(){let e=this.cameras_();return e.includes(this.cam_)?this.cam_:e[0]}template(){return this.config.bare&&this.setAttribute("bare",""),this.stand_=this.stand_??{zoom:1,x:0,y:0},`
      <div class="card surface">
        <div class="vak">
          ...
          <div class="ptz" hidden>
            ${ga.map(t=>`<button type="button" data-r="${t.k}" aria-label="${t.label}"${t.draai?` style="transform: rotate(${t.draai}deg)"`:""}>${f(t.icoon)}</button>`).join("")}
          </div>
...
`;var $t=["ma","di","wo","do","vr","za","zo"],Et={ma:"maandag",di:"dinsdag",wo:"woensdag",do:"donderdag",vr:"vrijdag",za:"zaterdag",zo:"zondag"},Ld=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],xa=i=>String(i).padStart(2,"0"),Jt=i=>$t[(i.getDay()+6)%7],re=i=>`${i.getFullYear()}-${xa(i.getMonth()+1)}-${xa(i.getDate())}`,qe=i=>`${xa(i.getHours())}:${xa(i.getMinutes())}`,Cd=i=>`${Et[Jt(i)]} ${i.getDate()} ${Ld[i.getMonth()]}`;function Rd(i,e){let t=re(i);if(t===re(e))return"vandaag";let n=new Date(e.getFullYear(),e.getMonth(),e.getDate()+1);return t===re(n)?"morgen":Et[Jt(i)]}function Hd(i,e){return!(i?.van&&i.van>e||i?.tot&&i.tot<e)}var Br=(i,e)=>(i??[]).filter(t=>t.tekst&&Hd(t,e));function Id(i,e,t){let n=(i??[]).filter(r=>r.titel&&Hd(r,t)).map(r=>({...r,eigen:!0,datum:r.gemaakt??null})).sort((r,o)=>+!!o.vast-+!!r.vast||String(o.gemaakt??"").localeCompare(String(r.gemaakt??""))),a=(e??[]).filter(r=>r.titel).map(r=>({...r,eigen:!1})).sort((r,o)=>String(o.datum??"").localeCompare(String(r.datum??"")));return[...n,...a]}var Du=i=>i?.length?i.map(([e,t])=>`${e} \u2013 ${t}`).join(", "):"gesloten";function Pr(i,e){let t=re(e),n=i?.openingstijden?.[Jt(e)]??[],a="";for(let r of i?.uitzonderingen??[])r.datum===t&&(n=r.tijden??[],a=r.reden??"");return{tijden:n,reden:a}}function At(i,e){let{tijden:t,reden:n}=Pr(i,e),a=qe(e),r=t.find(([s,l])=>s<=a&&a<l),o=t.find(([s])=>s>a);return{open:!!r,tot:r?r[1]:null,straks:o?o[0]:null,tijden:t,reden:n}}function Lu(i,e){let t=At(i,e);if(t.straks)return{dag:"vandaag",tijd:t.straks};for(let n=1;n<=14;n+=1){let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()+n),{tijden:r}=Pr(i,a);if(r.length)return{dag:n===1?"morgen":Et[Jt(a)],tijd:r[0][0]}}return null}function Vd(i,e){let t=Jt(e);return $t.map(n=>{let a=n===t?Pr(i,e):null,r=a?a.tijden:i?.openingstijden?.[n]??[];return{dag:n,naam:Et[n],tekst:Du(r),reden:a?.reden??"",vandaag:n===t}})}var wa=i=>$t.some(e=>(i?.openingstijden?.[e]??[]).length>0);function Bd(i){return(i?.installatie?.verlichting?.length??0)>0?i?.instellingen?.verlichting_tonen!==!1:!1}function Kr(i,e){let t=["welkom"];return(i?.personen?.length??0)>0&&t.push("aanwezig"),((i?.nieuws?.length??0)>0||(e?.length??0)>0)&&t.push("nieuws"),i?.installatie?.weer&&t.push("weer"),Bd(i)&&t.push("verlichting"),(i?.installatie?.agendas?.length??0)>0&&t.push("agenda"),t}function Gr(i){let e=String(i??"").trim().split(/\s+/).filter(Boolean);return e.length?e.length===1?e[0].slice(0,2).toUpperCase():(e[0][0]+e[e.length-1][0]).toUpperCase():"?"}function Pd(i){let e=new Map;for(let t of i??[]){let n=t.functie||"";e.has(n)||e.set(n,[]),e.get(n).push(t)}return[...e].map(([t,n])=>({functie:t,personen:n}))}function Wr(i){let e=i??[];return{aanwezig:e.filter(t=>t.aanwezig),afwezig:e.filter(t=>!t.aanwezig)}}function Kd(i){let{aanwezig:e,afwezig:t}=Wr(i);return[...e,...t]}function Ur(i,e){if(!i)return"";let t=new Date(i);if(Number.isNaN(t.getTime()))return"";let n=Math.round((e-t)/6e4);if(n<1)return"zojuist";if(n<60)return`${n} min geleden`;if(re(t)===re(e))return`vandaag ${qe(t)}`;let a=new Date(e.getFullYear(),e.getMonth(),e.getDate()-1);return re(t)===re(a)?`gisteren ${qe(t)}`:`${t.getDate()} ${Ld[t.getMonth()].slice(0,3)}`}var Fr=(i,e)=>i?.length?i[(e%i.length+i.length)%i.length]:"";function qr(i,e){let t=At(i,e),n=["Gesloten"];t.reden&&n.push(t.reden);let a=Lu(i,e);return a&&n.push(`${a.dag} open om ${a.tijd}`),n.join(" \xB7 ")}var Ne=6,Oe=6,Ze={welkom:{naam:"Welkom",icoon:"house",pagina:null,aantal:!1,maat:[6,1]},weer:{naam:"Weer",icoon:"sun",pagina:"weer",aantal:!1,maat:[2,2]},mededeling:{naam:"Mededeling",icoon:"bell",pagina:null,aantal:!1,maat:[2,1]},openingstijden:{naam:"Openingstijden",icoon:"clock",pagina:null,aantal:!1,maat:[2,3]},aanwezig:{naam:"Aanwezig",icoon:"people",pagina:"aanwezig",aantal:!0,maat:[2,3]},nieuws:{naam:"Nieuws",icoon:"news",pagina:"nieuws",aantal:!0,maat:[2,4]},verlichting:{naam:"Verlichting",icoon:"bulb",pagina:"verlichting",aantal:!0,maat:[2,1]},agenda:{naam:"Agenda",icoon:"calendar",pagina:"agenda",aantal:!0,maat:[2,2]}},Gd=Object.keys(Ze);function _a(){return{blokken:[["welkom",0,0,6,1,0],["weer",0,1,2,2,0],["aanwezig",2,1,2,3,4],["nieuws",4,1,2,5,3],["openingstijden",0,3,2,3,0],["mededeling",2,4,2,1,0],["verlichting",2,5,2,1,4]].map(([e,t,n,a,r,o])=>({id:`std-${e}`,soort:e,x:t,y:n,w:a,h:r,aantal:o}))}}var Cu=(i,e)=>i.x<e.x+e.w&&e.x<i.x+i.w&&i.y<e.y+e.h&&e.y<i.y+i.h,Ru=i=>i.x>=0&&i.y>=0&&i.w>=1&&i.h>=1&&i.x+i.w<=Ne&&i.y+i.h<=Oe;function ya(i,e){return Ru(e)?!(i??[]).some(t=>t.id!==e.id&&Cu(t,e)):!1}function Zr(i,e,t){for(let n=0;n+t<=Oe;n+=1)for(let a=0;a+e<=Ne;a+=1)if(ya(i,{id:"",x:a,y:n,w:e,h:t}))return{x:a,y:n};return null}function za(i,e,t,n){let a=e??{};switch(i){case"welkom":return null;case"weer":return a.installatie?.weer?null:"Geen weerentiteit gekozen (Installatie)";case"mededeling":return Br(a.mededelingen,n).length?null:"Geen mededeling die nu geldt";case"openingstijden":return wa(a.praktijk)?null:"Geen openingstijden ingevuld";case"aanwezig":return(a.personen?.length??0)>0?null:"Nog geen medewerkers";case"nieuws":return null;case"verlichting":return(a.installatie?.verlichting?.length??0)>0?Bd(a)?null:"Verlichting staat uit in het beheer":"Geen lampen gekozen (Installatie)";case"agenda":return(a.installatie?.agendas?.length??0)>0?null:"Geen agenda gekozen (Installatie)";default:return"Onbekend blok"}}var Hu="domotiapp-infoscherm-card",en=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,Mt={news:en('<rect x="3.4" y="4.6" width="17.2" height="14.8" rx="2"/><path d="M7.2 9.2h9.6M7.2 12.6h9.6M7.2 16h5.6"/>'),megaphone:en('<path d="M4 11v2a1 1 0 0 0 1 1h2l5 4V6L7 10H5a1 1 0 0 0-1 1z"/><path d="M16 9a4 4 0 0 1 0 6M18.5 6.5a8 8 0 0 1 0 11"/>'),moon:en('<path d="M19.6 14.4A8 8 0 0 1 9.6 4.4a8 8 0 1 0 10 10z"/>'),offline:en('<path d="M3.4 6.8a13.6 13.6 0 0 1 17.2 0M6.6 10.4a9 9 0 0 1 10.8 0M9.8 14a4.4 4.4 0 0 1 4.4 0"/><circle cx="12" cy="18" r="1"/><path d="M4 4l16 16"/>'),back:en('<path d="m14.6 6.2-5.6 5.8 5.6 5.8"/>')},Wd=i=>Mt[i]??f(i),ja={aanwezig:{eyebrow:"Wie is er vandaag",titel:"Aanwezig",onder:"Tik op uw naam om u aan of af te melden."},nieuws:{eyebrow:"Nieuws",titel:"Wat er speelt",onder:""},weer:{eyebrow:"Weer",titel:"De komende dagen",onder:""},verlichting:{eyebrow:"Verlichting",titel:"Lampen",onder:"Tik op een lamp om hem aan of uit te zetten."},agenda:{eyebrow:"Agenda",titel:"Vandaag",onder:""}},Iu=`
  :host { display: block; height: 100%; }
  ...
  ${Dd}
`,tn=class extends S{constructor(){super(),this.stand_=null,this.feeds_=[],this.pagina_="welkom",this.uren_=[],this.dagen_=[],this.afspraken_=[],this.welkomTel_=0,this.mededelingTel_=0,this.nachtSluimer_=0,this.herkansing_=new le(()=>this.haal_()),this.verbinding_=new _e,this.fout_=null,this.html_=new Map,this.weerEntiteit_=null,this.weerOpzeggen_=[],this.agendaSleutel_=""}validate(){return{}}watched(){let e=this.stand_?.installatie;return[e?.weer,"sun.sun",...(e?.verlichting??[]).map(t=>t.entity)].filter(Boolean)}getCardSize(){return 12}template(){let e=t=>`
      <section class="pagina" data-p="${t}">
        <div class="paginakop">
          <button class="terug" type="button">${Mt.back}<span>Terug</span></button>
          <div class="pk-tekst"><div class="eyebrow">${ja[t].eyebrow}</div><div class="titel pk-titel">${ja[t].titel}</div></div>
          <div class="onder">${ja[t].onder}</div>
        </div>
      ...
      <div class="scherm">
        ...
        ${Object.keys(ja).map(e).join("")}

        <div class="laag detail">
          <button class="sluit" type="button">${Mt.back}<span>Terug</span></button>
        ...
        <div class="laag nacht">
          ...
          <div class="klok">--:--</div>
          <div class="datum"></div>
          <div class="gesloten">${Mt.moon}<span></span></div>
        </div>

        <div class="merkje">${Mt.offline}<span>Geen verbinding</span></div>
      </div>`}wire(){let e=this.$(".scherm");this.on(e,"pointerdown",()=>this.leeft_(),{capture:!0,passive:!0}),this.on(e,"click",d=>{let c=d.target,p=c.closest(".bk[data-pagina]");if(p)return this.gaNaar_(p.dataset.pagina);if(c.closest(".terug"))return this.gaNaar_("welkom");if(c.closest(".detail .sluit"))return this.sluitBericht_();let h=c.closest(".persoon[data-id]");if(h)return this.tikPersoon_(h.dataset.id);let g=c.closest(".lamp[data-id]");if(g)return this.tikLamp_(g.dataset.id);let u=c.closest(".bericht[data-id]");if(u)return this.openBericht_(u.dataset.id);c.closest(".nacht")&&(this.nachtSluimer_=Date.now()+Math.max(30,this.terugNa_()||60)*1e3,this.paintNacht_())});let t=()=>{if(this.inDialoog_())return e.style.setProperty("--hoogte","600px");let d=Math.max(0,Math.round(this.getBoundingClientRect().top)),c=d?`calc(100dvh - ${d}px)`:"100dvh";e.style.getPropertyValue("--hoogte")!==c&&e.style.setProperty("--hoogte",c)},n=()=>{t();let d=e.getBoundingClientRect();if(!d.width)return;let c=Number(this.stand_?.scherm?.schaal)||1,p=Math.min(d.width/1194,d.height?d.height/834:9)*c;e.style.setProperty("--s",Math.max(.35,p).toFixed(3)),requestAnimationFrame(()=>this.pasAlleBij_())};this.meet_=n;let a=new ResizeObserver(n);a.observe(e),this.teardown_.push(()=>a.disconnect()),this.on(window,"resize",t),n();let r=()=>{this.paintKlok_(),this.paintNacht_()},o=()=>{r(),this.klokTimer_=setTimeout(o,6e4-Date.now()%6e4+20)};o(),this.teardown_.push(()=>clearTimeout(this.klokTimer_));let s=setInterval(()=>{this.welkomTel_+=1,this.mededelingTel_+=1,this.paintRaster_()},2e4);this.teardown_.push(()=>clearInterval(s)),this.leeft_(),this.teardown_.push(()=>clearTimeout(this.terugTimer_));let l=setInterval(()=>this.haalAgenda_(),10*6e4);this.teardown_.push(()=>clearInterval(l)),this.teardown_.push(()=>this.herkansing_.stop()),this.teardown_.push(()=>this.zegWeerOp_()),this.haal_(),this.luister_()}inDialoog_(){let e=this;for(;e;){let n=e.getRootNode?.()?.host;if(!n)return!1;let a=n.tagName?.toLowerCase()??"";if(a==="hui-dialog-edit-card"||a==="hui-card-preview"||a.startsWith("hui-dialog"))return!0;e=n}return!1}async haal_(){if(this.hass?.connection)try{let e=await ba(this.hass);this.feeds_=e.feeds??[],this.fout_=null,this.herkansing_.herstel(),this.nieuweStand_(e.stand)}catch(e){if(pe(e)){this.herkansing_.plan();return}this.fout_=e?.message??"Het infoscherm kon niet laden.",this.paint()}}nieuweStand_(e){this.stand_=e,this.meet_?.(),this.abonneerWeer_(),this.haalAgenda_(),this.paint()}async abonnement_(e){let t=!1;this.teardown_.push(()=>{t=!0});let n=await e();return t?n():this.teardown_.push(()=>{try{n()}catch{}}),n}async luister_(){if(this.hass?.connection?.subscribeMessage)try{await this.abonnement_(()=>va(this.hass,e=>{e?.soort==="stand"?this.nieuweStand_(e.stand):e?.soort==="feeds"&&(this.feeds_=e.feeds??[],this.paint())}))}catch{}}set hass(e){let t=this.verbinding_.herverbonden(e);super.hass=e,t&&this.built_&&(this.haal_(),this.luister_()),this.paintMerkje_()}get hass(){return super.hass}zegWeerOp_(){for(let e of this.weerOpzeggen_)try{e()}catch{}this.weerOpzeggen_=[],this.weerEntiteit_=null}async abonneerWeer_(){let e=this.stand_?.installatie?.weer||null;if(e!==this.weerEntiteit_&&(this.zegWeerOp_(),this.weerEntiteit_=e,this.uren_=[],this.dagen_=[],!(!e||!this.hass?.connection?.subscribeMessage)))for(let[t,n]of[["hourly","uren_"],["daily","dagen_"]])try{let a=await this.hass.connection.subscribeMessage(r=>{this.weerEntiteit_===e&&(this[n]=r?.forecast??[],this.paintRaster_(),this.paintPagina_("weer"))},{type:"weather/subscribe_forecast",forecast_type:t,entity_id:e});this.weerEntiteit_!==e?a():this.weerOpzeggen_.push(a)}catch{}}async haalAgenda_(){let e=this.stand_?.installatie?.agendas??[];if(!e.length||!this.hass?.connection){this.afspraken_=[],this.agendaSleutel_="";return}this.agendaSleutel_=e.join(",");let t=new Date,n=new Date(t.getFullYear(),t.getMonth(),t.getDate()),a=new Date(t.getFullYear(),t.getMonth(),t.getDate()+1);try{let o=(await this.hass.connection.sendMessagePromise({type:"call_service",domain:"calendar",service:"get_events",service_data:{entity_id:e,start_date_time:n.toISOString(),end_date_time:a.toISOString()},return_response:!0}))?.response??{},s=[];for(let[l,d]of Object.entries(o))for(let c of d?.events??[])s.push({kalender:l,...c});s.sort((l,d)=>String(l.start).localeCompare(String(d.start))),this.afspraken_=s}catch{this.afspraken_=[]}this.paintRaster_(),this.paintPagina_("agenda")}terugNa_(){let e=Number(this.stand_?.scherm?.terug_na);return Number.isFinite(e)?e:60}leeft_(){clearTimeout(this.terugTimer_);let e=this.terugNa_();e>0&&(this.terugTimer_=setTimeout(()=>{this.sluitBericht_(),this.gaNaar_("welkom")},e*1e3))}gaNaar_(e){let t=Kr(this.stand_,this.feeds_);this.pagina_=t.includes(e)?e:"welkom",this.paintPaginas_(),this.paintPagina_(this.pagina_),this.$(`.p-inhoud[data-p="${this.pagina_}"]`)?.scrollTo?.(0,0)}async tikPersoon_(e){let t=this.stand_?.personen?.find(a=>a.id===e);if(!t||!this.hass)return;let n=!t.aanwezig;t.aanwezig=n,this.paintRaster_(),this.paintPagina_("aanwezig");try{await wd(this.hass,e,n)}catch{t.aanwezig=!n,this.paintRaster_(),this.paintPagina_("aanwezig")}}tikLamp_(e){this.hass&&this.hass.callService("homeassistant","toggle",{entity_id:e})}openBericht_(e){let t=this.nieuws_().find(r=>r.id===e);if(!t)return;let n=this.$(".detail");this.text(".d-bron",t.eigen?this.stand_?.praktijk?.naam||"Mededeling":t.bron??""),this.text(".d-titel",t.titel),this.text(".d-datum",Ur(t.datum,new Date)),this.text(".d-tekst",t.tekst||"");let a=this.$(".d-foto");a.replaceChildren(),this.plaatje_(a,t),n.classList.add("open")}sluitBericht_(){this.$(".detail")?.classList.remove("open")}plaatje_(e,t){this.stand_?.scherm?.nieuws_afbeeldingen!==!1&&(t.eigen&&t.afbeelding?jt(this.hass,t.afbeelding).then(n=>{n&&e.isConnected&&(e.innerHTML=`<img alt="" src="${n}">`)}):!t.eigen&&t.afbeelding&&/^https?:/.test(t.afbeelding)&&(e.innerHTML=`<img alt="" src="${_(t.afbeelding)}" loading="lazy">`))}nieuws_(){return Id(this.stand_?.nieuws,this.feeds_,re(new Date))}vul_(e,t,n=!0){if(!e)return!1;let a=e;return this.html_.get(a)===t?!1:(this.html_.set(a,t),e.innerHTML=t,n&&this.fotos_(e),!0)}fotos_(e){for(let n of e.querySelectorAll(".avatar[data-foto]:not([data-foto=''])"))jt(this.hass,n.dataset.foto).then(a=>{a&&n.isConnected&&(n.innerHTML=`<img alt="" src="${a}">`)});let t=this.nieuws_();for(let n of e.querySelectorAll(".bericht[data-id]")){let a=t.find(o=>o.id===n.dataset.id),r=n.querySelector(".foto");a&&r&&a.afbeelding&&this.plaatje_(r,a)}}paint(){this.$(".scherm")&&(this.paintUiterlijk_(),this.paintKop_(),this.paintRaster_(),this.paintPaginas_(),this.paintPagina_(this.pagina_),this.paintNacht_(),this.paintMerkje_())}paintUiterlijk_(){let e=this.stand_?.scherm??{},t=this.$(".scherm");t.style.setProperty("--tone",e.accent||"var(--dac-accent-hi)"),t.classList.toggle("licht",e.uiterlijk==="licht"),t.classList.toggle("rond",(e.foto_vorm??"rond")==="rond"),t.classList.toggle("stil",e.weer_animatie===!1)}paintKop_(){let e=this.stand_?.praktijk??{},t=this.stand_?.scherm?.logo??"";this.text(".naam",e.naam||(this.fout_?"Infoscherm":"")),this.text(".adres",e.adres||"");for(let n of this.$$(".logo")){let a=`${t}|${e.naam?e.naam.slice(0,1).toUpperCase():""}`;n.dataset.wens!==a&&(n.dataset.wens=a,n.classList.remove("beeld"),n.textContent=e.naam?e.naam.slice(0,1).toUpperCase():"",t&&jt(this.hass,t).then(r=>{!r||n.dataset.wens!==a||(n.innerHTML=`<img alt="" src="${r}">`,n.classList.add("beeld"))}))}this.paintKlok_()}paintKlok_(){let e=new Date;for(let t of this.$$(".klok"))this.text(t,qe(e));for(let t of this.$$(".datum"))this.text(t,Cd(e))}paintRaster_(){let e=this.$(".raster");if(!e||!this.stand_)return;let t=this.stand_.indeling?.blokken?.length?this.stand_.indeling:_a(),n=re(new Date),a=new Map;for(let r of t.blokken)Ze[r.soort]&&(za(r.soort,this.stand_,this.feeds_,n)||a.set(r.id,r));for(let r of[...e.children])a.has(r.dataset.id)||(this.html_.delete(r.querySelector(".bi")),r.remove());for(let r of a.values()){let o=e.querySelector(`.blok[data-id="${CSS.escape(r.id)}"]`);o||(o=document.createElement("div"),o.className=`blok ${r.soort}`,o.dataset.id=r.id,o.dataset.soort=r.soort,o.innerHTML=`${this.htmlKop_(r.soort)}<div class="bi"></div>`,e.appendChild(o));let s=`${r.y+1} / ${r.x+1} / span ${r.h} / span ${r.w}`;o.style.gridArea!==s&&(o.style.gridArea=s),o.classList.toggle("klein",r.h===1),this.paintBlok_(o,r)}this.pasAlleBij_()}pasAlleBij_(){for(let e of this.$$(".raster .blok"))this.pasBij_(e)}pasBij_(e){let t=e.querySelector(".bi");if(!t)return;let n=t.getBoundingClientRect().bottom-parseFloat(getComputedStyle(t).paddingBottom),a=t.querySelector(".uren");a&&(a.hidden=!1,a.hidden=a.getBoundingClientRect().bottom>n+1);let r=t.querySelector(".tegels, .n-lijst, .lampen, .afspraken, .ot");if(!r)return;let o=0,s=[...r.children];for(let p of s)p.hidden=!1;for(let p of s)p.getBoundingClientRect().bottom>n+1&&(p.hidden=!0,o+=1);let l=Number(e.dataset.meer??0)+o,d=e.querySelector(".bk-sub");if(!d)return;let c=d.dataset.basis??"";this.text(d,l>0?`${c?`${c} \xB7 `:""}nog ${l}`:c)}htmlKop_(e){let t=Ze[e];return e==="welkom"?"":t.pagina?`<button class="bk" type="button" data-pagina="${t.pagina}">
        <span class="bk-ico">${Wd(t.icoon)}</span><span class="bk-titel">${t.naam}</span><span class="bk-sub"></span>
        <span class="bk-meer"><span class="txt">Alles bekijken</span>${f("chevronRight")}</span>
      </button>`:`<div class="bk"><span class="bk-ico">${Wd(t.icoon)}</span><span class="bk-titel">${t.naam}</span><span class="bk-sub"></span></div>`}paintBlok_(e,t){let n=e.querySelector(".bi"),a=e.querySelector(".bk-sub"),r=(l,d="")=>{this.vul_(n,l),a&&(a.dataset.basis=d,this.text(a,d))},o=Number(t.aantal)||0,s=l=>l>=4?"kol-3":l>=2?"":"kol-1";switch(t.soort){case"welkom":{let l=this.stand_?.praktijk??{},d=new Date,c=l.welkom?.length?l.welkom:["Welkom"],p="";if(wa(l)){let h=At(l,d);p=h.open?`Vandaag geopend tot ${h.tot}`:qr(l,d)}r(`<div class="welkomtekst">${_(Fr(c,this.welkomTel_))}</div>${p?`<div class="welkom-onder">${_(p)}</div>`:""}`);break}case"weer":{r(this.htmlWeerNu_()+(t.h>=2?this.htmlUren_(t.w>=3?6:4):""));break}case"mededeling":{let l=Br(this.stand_?.mededelingen,re(new Date)),d=Fr(l,this.mededelingTel_);r(`<div class="chip">${Mt.megaphone}</div><div class="tekst">${_(d?.tekst??"")}</div>`);break}case"openingstijden":{let l=this.stand_?.praktijk??{},d=new Date,c=Vd(l,d),p=At(l,d),h=t.w>=3,g=h?[0,4,1,5,2,6,3].map(w=>c[w]):c,u=w=>h?w.replace(/ – /g,"\u2013").replace(/, /g," \xB7 "):w,k=`<div class="ot ${h?"twee":""} ${t.h<=2?"compact":""}">${g.map(w=>`<div class="${w.vandaag?"vandaag":""} ${w.tekst==="gesloten"?"dicht":""}"><span>${_(h?w.naam.slice(0,2):w.naam)}${w.reden?` \xB7 ${_(w.reden)}`:""}</span><span class="num">${_(u(w.tekst))}</span></div>`).join("")}</div>`,x=p.open?`Nu geopend, tot ${p.tot}`:p.straks?`Nu gesloten, om ${p.straks} weer open`:"Vandaag gesloten";r(k,x);break}case"aanwezig":{let l=this.stand_?.personen??[],d=Kd(l),c=o>0?d.slice(0,o):d,p=d.length-c.length,h=`<div class="tegels ${s(t.w)}">${c.map(u=>this.htmlPersoon_(u)).join("")}</div>`,g=this.stand_?.scherm?.aanwezig_teller!==!1?`${l.filter(u=>u.aanwezig).length} van ${l.length}`:"";e.dataset.meer=String(p),r(h,g);break}case"nieuws":{let l=this.nieuws_(),d=o>0?l.slice(0,o):l,c=d.length?`<div class="n-lijst">${d.map(p=>this.htmlBericht_(p)).join("")}</div>`:'<div class="leeg">Er is op dit moment geen nieuws.</div>';e.dataset.meer=String(l.length-d.length),r(c,"");break}case"verlichting":{let l=this.stand_?.installatie?.verlichting??[],d=o>0?l.slice(0,o):l;e.dataset.meer=String(l.length-d.length),r(`<div class="lampen ${s(t.w)}">${d.map(c=>this.htmlLamp_(c)).join("")}</div>`,"");break}case"agenda":{let l=this.afspraken_,d=o>0?l.slice(0,o):l;e.dataset.meer=String(l.length-d.length),r(d.length?`<div class="afspraken">${d.map(c=>this.htmlAfspraak_(c)).join("")}</div>`:'<div class="leeg">Geen afspraken vandaag.</div>',l.length?`${l.length} vandaag`:"");break}default:r("")}}nacht_(){return v(this.hass,"sun.sun")?.state==="below_horizon"}htmlWeerNu_(){let e=this.stand_?.installatie?.weer,t=v(this.hass,e),n=Z(this.hass,e),a=n.temperature,r=[];return t&&r.push(Td[t.state]??ee(this.hass,t)),typeof n.humidity=="number"&&r.push(`${Math.round(n.humidity)}% vochtig`),typeof n.wind_speed=="number"&&r.push(`wind ${K(this.hass,n.wind_speed,0)} ${n.wind_speed_unit??"km/h"}`),`<div class="w-nu"><div class="w-icoon">${ka(t?.state,this.nacht_())}</div><div><div class="temp">${typeof a=="number"?`${K(this.hass,a,0)}\xB0`:"--\xB0"}</div><div class="w-tekst">${_(r.join(" \xB7 "))}</div></div></div>`}htmlUren_(e){let t=Date.now(),n=this.uren_.filter(a=>new Date(a.datetime).getTime()>t-30*6e4).slice(0,e);return n.length?`<div class="uren" style="grid-template-columns: repeat(${n.length}, minmax(0, 1fr))">${n.map(a=>{let r=new Date(a.datetime);return`<div class="uur"><span class="u">${qe(r)}</span>${ka(a.condition,r.getHours()<7||r.getHours()>=21)}<span class="t">${typeof a.temperature=="number"?`${Math.round(a.temperature)}\xB0`:"--"}</span></div>`}).join("")}</div>`:""}htmlDagen_(){let e=new Date,t=this.dagen_.slice(0,7);return t.length?`<div class="dagen">${t.map(n=>{let a=new Date(n.datetime);return`<div class="dag"><span class="u">${_(Rd(a,e))}</span>${ka(n.condition)}<span class="t">${typeof n.temperature=="number"?`${Math.round(n.temperature)}\xB0`:"--"}</span>${typeof n.templow=="number"?`<span class="t2">${Math.round(n.templow)}\xB0</span>`:""}</div>`}).join("")}</div>`:""}htmlPersoon_(e){return`<div class="persoon ${e.aanwezig?"aan":""}" role="button" tabindex="0" data-id="${_(e.id)}">
    ...
    </div>`}htmlBericht_(e,t=!1){let n=e.eigen?this.stand_?.praktijk?.naam||"Mededeling":e.bron??"";return`<div class="bericht ${e.eigen?"eigen":""}" role="button" tabindex="0" data-id="${_(e.id)}">
      <div class="foto"></div>
      <div class="b-tekst">
        <div class="b-bron">${_(n)}${e.datum?` \xB7 ${_(Ur(e.datum,new Date))}`:""}</div>
        <div class="b-titel">${_(e.titel)}</div>
        ${t&&e.tekst?`<div class="b-samenvatting">${_(e.tekst)}</div>`:""}
      </div>
    </div>`}htmlLamp_(e){let t=e.entity,n=v(this.hass,t),a=n?.attributes??{},r=Y(n),o=!n||n.state==="unavailable",s=a.rgb_color,l=r&&Array.isArray(s)&&!(s[0]>240&&s[1]>240&&s[2]>240)?`rgb(${s.join(",")})`:"",d=o?"Niet bereikbaar":r?typeof a.brightness=="number"?`Aan \xB7 ${Math.round(a.brightness/255*100)}%`:"Aan":"Uit",c=e.naam||a.friendly_name||t;return`<div class="lamp ${r?"aan":""} ${o?"dood":""}" role="button" tabindex="0" data-id="${_(t)}" style="${l?`--lampkleur:${l}`:""}">
      <div class="chip">${f("bulb")}</div>
      <div class="l-tekst"><div class="l-naam">${_(c)}</div><div class="l-status">${d}</div></div>
    </div>`}htmlAfspraak_(e){let n=!String(e.start).includes("T")?"hele dag":`${qe(new Date(e.start))}${e.end?` \u2013 ${qe(new Date(e.end))}`:""}`,a=Z(this.hass,e.kalender).friendly_name??e.kalender,r=(this.stand_?.installatie?.agendas?.length??0)>1;return`<div class="afspraak"><span class="a-tijd">${_(n)}</span><span class="a-tekst">${_(e.summary??"")}</span>${r?`<span class="a-kalender">${_(a)}</span>`:""}</div>`}paintPaginas_(){Kr(this.stand_,this.feeds_).includes(this.pagina_)||(this.pagina_="welkom");for(let t of this.$$(".pagina"))t.classList.toggle("actief",t.dataset.p===this.pagina_)}paintPagina_(e){if(e!==this.pagina_||e==="welkom")return;let t=this.$(`.p-inhoud[data-p="${e}"]`);if(!t)return;let n=this.stand_?.scherm??{};switch(e){case"aanwezig":{let a=this.stand_?.personen??[],r=d=>`<div class="tegels">${d.map(c=>this.htmlPersoon_(c)).join("")}</div>`,o=n.aanwezig_weergave??"gescheiden",s;if(o==="functie"){let d=Pd(a);s=`<div class="kolommen ${d.length>=3?"drie":"twee"}">${d.map(c=>`<div class="kolom"><div class="eyebrow">${_(c.functie||"Overig")} \xB7 ${c.personen.length}</div>${r(c.personen)}</div>`).join("")}</div>`}else if(o==="lijst")s=`<div class="tegels kol-3">${a.map(d=>this.htmlPersoon_(d)).join("")}</div>`;else{let{aanwezig:d,afwezig:c}=Wr(a);s=`<div class="kolommen twee">
          ...
          </div>`}this.vul_(t,s);let l=a.filter(d=>d.aanwezig).length;this.text(".pagina[data-p='aanwezig'] .pk-titel",n.aanwezig_teller!==!1&&a.length?`${l} van ${a.length} aanwezig`:"Aanwezig");break}case"nieuws":{let a=this.nieuws_();this.vul_(t,a.length?`<div class="nieuws-raster">${a.map(r=>this.htmlBericht_(r,!0)).join("")}</div>`:'<div class="leeg">Er is op dit moment geen nieuws.</div>');break}case"weer":{this.vul_(t,`<div class="weerpagina">${this.htmlWeerNu_()}${this.htmlUren_(8)}${this.htmlDagen_()}</div>`,!1);break}case"verlichting":{let a=this.stand_?.installatie?.verlichting??[];this.vul_(t,`<div class="lampen kol-3">${a.map(r=>this.htmlLamp_(r)).join("")}</div>`,!1);break}case"agenda":{let a=this.afspraken_;this.vul_(t,a.length?`<div class="afspraken">${a.map(r=>this.htmlAfspraak_(r)).join("")}</div>`:'<div class="leeg">Geen afspraken vandaag.</div>',!1);break}default:}}paintNacht_(){let e=this.$(".nacht");if(!e)return;let t=this.stand_?.praktijk,n=new Date,a=!1;this.stand_?.scherm?.nachtstand!==!1&&t&&wa(t)&&!this.inDialoog_()&&(a=!At(t,n).open&&Date.now()>this.nachtSluimer_),a&&this.text(".nacht .gesloten span",qr(t,n)),e.classList.toggle("open",a)}paintMerkje_(){let e=this.$(".merkje");if(!e)return;let t=this.hass?.connected===!1;e.classList.toggle("open",t||!!this.fout_),this.text(".merkje span",t?"Geen verbinding":this.fout_??"")}};z(tn,"css",Iu);N(Hu,tn,{name:"DomotiApp Infoscherm",description:"Beeldvullend scherm voor een wachtkamer: logo, klok, weer, wie er is, nieuws en verlichting. Geen instellingen: alles komt uit DomotiApp Infoscherm Beheer.",preview:!1});tn.getStubConfig=()=>({});var Jr="domotiapp-infoscherm-beheer-card",Vu=["personen","mededelingen","nieuws","praktijk","scherm","installatie","indeling","instellingen"],Xr=i=>`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,Bu={news:Xr('<rect x="3.4" y="4.6" width="17.2" height="14.8" rx="2"/><path d="M7.2 9.2h9.6M7.2 12.6h9.6M7.2 16h5.6"/>'),layout:Xr('<rect x="3.4" y="3.4" width="17.2" height="17.2" rx="2"/><path d="M3.4 9.6h17.2M9.6 9.6v11"/>'),wrench:Xr('<path d="M14.5 5.5a4 4 0 0 0 4.9 5.3l-8.6 8.6a1.8 1.8 0 0 1-2.6-2.6l8.6-8.6a4 4 0 0 0-2.3-2.7z"/>')},Pu=i=>Bu[i]??f(i),Te=[{key:"personen",titel:"Medewerkers",icoon:"people",secties:["personen"]},{key:"mededelingen",titel:"Mededeling van de dag",icoon:"bell",secties:["mededelingen"]},{key:"nieuws",titel:"Nieuws van het pand",icoon:"news",secties:["nieuws"]},{key:"praktijk",titel:"Praktijk en openingstijden",icoon:"house",secties:["praktijk"]},{key:"indeling",titel:"Indeling van het scherm",icoon:"layout",secties:["indeling"]},{key:"verlichting",titel:"Verlichting",icoon:"bulb",secties:["installatie","instellingen"]},{key:"instellingen",titel:"Instellingen en logo",icoon:"cog",secties:["scherm","instellingen"]},{key:"installatie",titel:"Installatie (alleen beheerder)",icoon:"wrench",secties:["installatie","instellingen"],admin:!0}],Fd={title:"Infoscherm",show_personen:!0,show_mededelingen:!0,show_nieuws:!0,show_praktijk:!0,show_indeling:!0,show_verlichting:!0,show_instellingen:!0,show_installatie:!0,open:"personen"},Ku=`
  ...
  .raster {
    ...
    background-size: calc(100% / ${Ne}) calc(100% / ${Oe});
...
`,Ud=i=>JSON.parse(JSON.stringify(i??null)),R=i=>_(i??""),$a=(i,e,t)=>Math.min(t,Math.max(e,i)),Gu=700,Yr=150,St=class extends S{constructor(){super(),this.stand_=null,this.rechten_={},this.feedFouten_={},this.werk_={},this.vuil_=new Set,this.bezig_=new Set,this.versie_={},this.timers_={},this.fouten_={},this.uitgesteld_=new Set,this.open_=null,this.gebruikers_=null,this.meldingen_={},this.herkansing_=new le(()=>this.haal_()),this.verbinding_=new _e,this.fout_=null,this.laatstOpgeslagen_=""}validate(e){return{...Fd,...e}}watched(){return[]}getCardSize(){return 6}getGridOptions(){return{columns:"full",rows:"auto",min_rows:this.minRijen_(".card",6)}}blokken_(){return Te.filter(e=>this.config[`show_${e.key}`]!==!1&&(!e.admin||this.rechten_.is_admin))}blokInfo_(e){return Te.find(t=>t.key===e)}template(){let e=this.config;return`
      <div class="card surface ${e.bare?"bare":""}">
        ...
        ${Te.map(t=>`<section class="blok" data-blok="${t.key}" hidden>
              <button class="bk" type="button">${Pu(t.icoon)}<b>${t.titel}</b><span class="bfout" hidden></span><span class="tel"></span>${f("chevronDown")}</button>
              <div class="inhoud"></div>
            </section>`).join("")}
        <input class="file" type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml">
      </div>`}wire(){let e=this.$(".card");this.teardown_.push(H(e)),this.teardown_.push(()=>this.herkansing_.stop()),this.teardown_.push(()=>{for(let t of Object.values(this.timers_))clearTimeout(t);this.timers_={}}),this.on(e,"click",t=>this.klik_(t)),this.on(e,"input",t=>this.invoer_(t)),this.on(e,"change",t=>this.invoer_(t)),this.on(e,"pointerdown",t=>this.sleepStart_(t)),this.on(e,"focusout",t=>this.focusWeg_(t)),this.on(this.$(".file"),"change",t=>this.bestandGekozen_(t)),this.open_=this.open_??this.config.open,this.haal_(),this.luister_()}set hass(e){let t=this.verbinding_.herverbonden(e);super.hass=e,t&&this.built_&&(this.haal_(),this.luister_())}get hass(){return super.hass}async haal_(){if(this.hass?.connection)try{let e=await ba(this.hass);this.rechten_=e,this.feedFouten_=e.feed_fouten??{},this.fout_=null,this.herkansing_.herstel(),this.nieuweStand_(e.stand,!0),e.is_admin&&this.gebruikers_===null&&jd(this.hass).then(t=>{this.gebruikers_=t.gebruikers??[],this.teken_("installatie")}).catch(()=>{this.gebruikers_=[]})}catch(e){if(pe(e)){this.herkansing_.plan(),this.status_("Home Assistant start nog op\u2026","bezig");return}this.fout_=e?.message??"Het beheer kon niet laden.",this.paint()}}async luister_(){if(!this.hass?.connection?.subscribeMessage)return;let e=!1;this.teardown_.push(()=>{e=!0});try{let t=await va(this.hass,n=>{n?.soort==="stand"&&this.nieuweStand_(n.stand),n?.soort==="feeds"&&(this.feedFouten_=n.feed_fouten??{},this.teken_("instellingen"))});e?t():this.teardown_.push(()=>{try{t()}catch{}})}catch{}}nieuweStand_(e,t=!1){let n=!this.stand_;this.stand_=e;let a=new Set;for(let r of Vu){if(this.vuil_.has(r)||this.bezig_.has(r)){r==="personen"&&this.neemAanwezigOver_(e.personen);continue}if(t||n||JSON.stringify(this.werk_[r])!==JSON.stringify(e[r])){this.werk_[r]=Ud(e[r]);for(let o of Te)o.secties.includes(r)&&a.add(o.key)}}if(n||t)return this.paint();this.paintKader_();for(let r of a)this.teken_(r)}neemAanwezigOver_(e){let t=this.werk_.personen;if(!Array.isArray(t))return;let n=new Map((e??[]).map(a=>[a.id,a.aanwezig]));t.forEach((a,r)=>{if(!a.id||a._aanwezig||!n.has(a.id)||n.get(a.id)===a.aanwezig)return;a.aanwezig=n.get(a.id);let o=this.$(`.blok[data-blok="personen"] .item[data-i="${r}"]`),s=o?.querySelector('input[data-veld="aanwezig"]');s&&(s.checked=a.aanwezig);let l=o?.querySelector(".vink span:last-child");l&&(l.textContent=a.aanwezig?"Aanwezig":"Afwezig"),o?.querySelector(".avatar")?.classList.toggle("aan",a.aanwezig)}),this.tel_("personen")}paint(){if(this.$(".card")&&(this.paintKader_(),!!this.magTonen_()))for(let e of this.blokken_())this.teken_(e.key)}magTonen_(){return!this.fout_&&this.stand_&&this.rechten_.mag_beheren!==!1}paintKader_(){let e=this.$(".geen");this.fout_?(e.hidden=!1,e.textContent=this.fout_):this.stand_&&this.rechten_.mag_beheren===!1?(e.hidden=!1,e.textContent="Dit account mag het infoscherm niet beheren. Log in als receptie of beheerder."):e.hidden=!0;let t=this.magTonen_(),n=new Set(this.blokken_().map(a=>a.key));for(let a of this.$$(".blok"))a.hidden=!t||!n.has(a.dataset.blok),a.classList.toggle("open",a.dataset.blok===this.open_);t&&(this.hass?.connected===!1?this.status_("Geen verbinding","fout"):!this.bezig_.size&&!this.vuil_.size&&this.status_(this.laatstOpgeslagen_?`Opgeslagen ${this.laatstOpgeslagen_}`:"","ok"))}status_(e,t=""){let n=this.$(".status");n&&(n.textContent=e,n.className=`status ${t}`)}teken_(e,t=!1){let n=this.$(`.blok[data-blok="${e}"]`);if(!n||!this.stand_)return;let a=this.shadowRoot.activeElement;if(!t&&a&&n.contains(a)&&a.matches("input, textarea, select")){this.uitgesteld_.add(e),this.tel_(e);return}this.uitgesteld_.delete(e);let r={personen:()=>this.htmlPersonen_(this.werk_.personen),mededelingen:()=>this.htmlMededelingen_(this.werk_.mededelingen),nieuws:()=>this.htmlNieuws_(this.werk_.nieuws),praktijk:()=>this.htmlPraktijk_(this.werk_.praktijk),indeling:()=>this.htmlIndeling_(this.werk_.indeling),verlichting:()=>this.htmlVerlichting_(this.werk_.installatie,this.werk_.instellingen),instellingen:()=>this.htmlInstellingen_(this.werk_.scherm,this.werk_.instellingen),installatie:()=>this.htmlInstallatie_(this.werk_.installatie,this.werk_.instellingen)}[e](),o=n.querySelector(".inhoud");o.innerHTML=r+this.htmlVoet_(e),this.plaatjes_(o),this.tel_(e)}focusWeg_(e){if(!this.uitgesteld_.size)return;let t=e.target?.closest?.(".blok")?.dataset.blok,n=e.relatedTarget?.closest?.(".blok")?.dataset.blok;t&&t!==n&&this.uitgesteld_.has(t)&&setTimeout(()=>this.teken_(t),0)}tel_(e){let t=this.$(`.blok[data-blok="${e}"]`);if(!t)return;let n=this.werk_,a={personen:()=>`${(n.personen??[]).filter(l=>l.aanwezig).length} van ${(n.personen??[]).length} aanwezig`,mededelingen:()=>`${(n.mededelingen??[]).length}`,nieuws:()=>`${(n.nieuws??[]).length}`,praktijk:()=>n.praktijk?.naam??"",indeling:()=>`${(n.indeling?.blokken??[]).length} blokken`,verlichting:()=>`${(n.installatie?.verlichting??[]).length} lampen${n.instellingen?.verlichting_tonen===!1?" \xB7 uit":""}`,instellingen:()=>`${(n.instellingen?.feeds??[]).length} nieuwsbron(nen)`,installatie:()=>n.installatie?.weer?"weer gekozen":"geen weer"}[e]();t.querySelector(".tel").textContent=a;let o=this.blokInfo_(e).secties.map(l=>this.fouten_[l]).find(Boolean),s=t.querySelector(".bfout");s.hidden=!o,s.textContent=o?"niet opgeslagen":""}htmlVoet_(e){let n=this.blokInfo_(e).secties.map(r=>this.fouten_[r]).find(Boolean),a=this.meldingen_[e];return!n&&!a?"":`<div class="voet"><span class="melding ${n||a?.fout?"fout":""}">${R(n?`Niet opgeslagen: ${n}`:a?.tekst)}</span></div>`}veld_(e,t,n,{type:a="text",i:r,extra:o="",s}={}){return`<div class="veld"><label>${R(e)}</label><input type="${a}" data-veld="${t}" ${s?`data-s="${s}"`:""} ${r!==void 0?`data-i="${R(String(r))}"`:""} value="${R(n)}" ${o}></div>`}schakel_(e,t,{i:n,label:a,s:r}={}){return`<label class="vink"><span class="schakel"><input type="checkbox" data-veld="${e}" ${r?`data-s="${r}"`:""} ${n!==void 0?`data-i="${R(String(n))}"`:""} ${t?"checked":""}><span></span></span>${a?`<span>${R(a)}</span>`:""}</label>`}keuze_(e,t,n,a,{s:r}={}){return`<div class="veld"><label>${R(e)}</label><select data-veld="${t}" ${r?`data-s="${r}"`:""}>${a.map(([o,s])=>`<option value="${R(o)}" ${String(o)===String(n??"")?"selected":""}>${R(s)}</option>`).join("")}</select></div>`}htmlPersonen_(e=[]){return`<div class="hulp">Tik op de cirkel om een foto te kiezen. Zonder foto staan de initialen op het scherm (eerste letter van de voornaam en van het laatste woord van de achternaam). De volgorde hier is de volgorde op het scherm. Alles wordt vanzelf opgeslagen.</div>
      <div class="lijst">${e.map((n,a)=>`<div class="item persoon" data-i="${a}">
          <div class="avatar ${n.aanwezig?"aan":""}" data-actie="foto" data-i="${a}" data-bestand="${R(n.foto)}" title="Foto kiezen">${R(Gr(n.naam))}</div>
          ...
          <div class="knoppen">
            <button class="knop ico" type="button" data-actie="omhoog" data-i="${a}" title="Omhoog" ${a===0?"disabled":""}>${f("arrowUp")}</button>
            <button class="knop ico" type="button" data-actie="omlaag" data-i="${a}" title="Omlaag" ${a===e.length-1?"disabled":""}>${f("arrowDown")}</button>
            ${n.foto?`<button class="knop ico" type="button" data-actie="fotoweg" data-i="${a}" title="Foto weghalen">${f("close")}</button>`:""}
            <button class="knop ico gevaar" type="button" data-actie="verwijder" data-i="${a}" title="Verwijderen">${f("minus")}</button>
          </div>
        </div>`).join("")||'<div class="leeg">Nog geen medewerkers.</div>'}</div>
      <div><button class="knop" type="button" data-actie="nieuw">${f("plus")} Medewerker toevoegen</button></div>`}htmlMededelingen_(e=[]){return`<div class="hulp">E\xE9n regel op het welkomscherm, bijvoorbeeld "Vrijdag 20 september zijn wij vanaf 12:00 gesloten". Zonder datums staat hij er altijd; met meerdere wisselen ze elkaar af.</div>
      <div class="lijst">${e.map((n,a)=>`<div class="item mededeling" data-i="${a}">
          ...
          <div class="knoppen"><button class="knop ico gevaar" type="button" data-actie="verwijder" data-i="${a}" title="Verwijderen">${f("minus")}</button></div>
        </div>`).join("")||'<div class="leeg">Geen mededeling.</div>'}</div>
      <div><button class="knop" type="button" data-actie="nieuw">${f("plus")} Mededeling toevoegen</button></div>`}htmlNieuws_(e=[]){return`<div class="hulp">Berichten van het pand: een nieuwe collega, een verbouwing, de vakantiesluiting. Ze staan v\xF3\xF3r het nieuws van buiten. Zonder datums blijft een bericht staan tot u het weghaalt.</div>
      <div class="lijst">${e.map((n,a)=>`<div class="item bericht" data-i="${a}">
          ...
          <div class="veld"><label>Tekst</label><textarea data-veld="tekst" data-i="${a}">${R(n.tekst)}</textarea></div>
          <div class="b-onder">
            <div class="plaatje" data-bestand="${R(n.afbeelding)}">${n.afbeelding?"":f("camera")}</div>
            <button class="knop klein" type="button" data-actie="foto" data-i="${a}">${f("camera")} ${n.afbeelding?"Andere afbeelding":"Afbeelding kiezen"}</button>
            ${n.afbeelding?`<button class="knop klein" type="button" data-actie="fotoweg" data-i="${a}">${f("close")} Afbeelding weg</button>`:""}
            ${this.schakel_("vast",n.vast,{i:a,label:"Bovenaan vastzetten"})}
          </div>
        </div>`).join("")||'<div class="leeg">Nog geen berichten.</div>'}</div>
      <div><button class="knop" type="button" data-actie="nieuw">${f("plus")} Bericht toevoegen</button></div>`}htmlPraktijk_(e={}){let t=e.openingstijden??{},n=$t.map(r=>{let o=t[r]??[],s=o.length===0,l=(d,c)=>o[d]?.[c]??"";return`<span class="dag">${Et[r]}</span>
        ...
        <input type="time" class="vak2" data-veld="ot_1_1" data-i="${r}" value="${l(1,1)}" ${s?"disabled":""}>`}).join(""),a=(e.uitzonderingen??[]).map((r,o)=>`<div class="item uitz" data-i="${o}">
          ...
          <div class="knoppen"><button class="knop ico gevaar" type="button" data-actie="u_verwijder" data-i="${o}" title="Verwijderen">${f("minus")}</button></div>
        </div>`).join("");return`
      <div class="rij twee">
        ${this.veld_("Naam van de praktijk","naam",e.naam)}
        ${this.veld_("Adresregel","adres",e.adres)}
      </div>
      <div class="veld"><label>Welkomsteksten (\xE9\xE9n per regel; ze wisselen elkaar af)</label><textarea data-veld="welkom">${R((e.welkom??[]).join(`
`))}</textarea></div>
      ...
      <div class="veld"><label>Afwijkende dagen (feestdagen, studiedagen)</label>
        ...
        <div style="margin-top:8px"><button class="knop" type="button" data-actie="u_nieuw">${f("plus")} Afwijkende dag toevoegen</button></div>
      </div>`}htmlIndeling_(e){let t=e?.blokken??[],n=re(new Date),a=t.map(s=>{let l=Ze[s.soort];if(!l)return"";let d=za(s.soort,this.stand_,[],n);return`<div class="ib ${d?"ontbreekt":""}" data-id="${R(s.id)}" style="${this.ibStijl_(s)}" title="${R(d?`${l.naam}: ${d}`:`${l.naam} -- sleep om te verplaatsen, hoek rechtsonder om de maat te wijzigen`)}">
          <div class="ib-in">
            <div class="ib-kop">${f(l.icoon,"question")}<span>${l.naam}</span></div>
            ${d?`<div class="ib-nb">${R(d)}</div>`:""}
            ${l.aantal?`<div class="ib-aantal"><span>Toon</span><button type="button" data-actie="aantal_min" data-id="${R(s.id)}" title="Minder">\u2212</button><b>${s.aantal>0?s.aantal:"alle"}</b><button type="button" data-actie="aantal_plus" data-id="${R(s.id)}" title="Meer">+</button></div>`:""}
            <button class="ib-weg" type="button" data-actie="blok_weg" data-id="${R(s.id)}" title="Van het scherm halen">${f("close")}</button>
            <div class="ib-greep" title="Maat wijzigen"></div>
          </div>
        </div>`}).join(""),r=new Set(t.map(s=>s.soort)),o=Gd.filter(s=>!r.has(s));return`<div class="hulp">Zo staat het welkomscherm op de iPad. Sleep een blok om het te verplaatsen, trek aan de hoek rechtsonder om het groter of kleiner te maken, en zet met \u2212 en + hoeveel er in een blok staat ("alle" = zoveel als er is). Een gestippeld blok staat NIET op het scherm zolang er niets in te tonen valt; de reden staat erin. Elke wijziging gaat meteen naar het scherm.</div>
      ...
      <div class="knoppen" style="justify-content: flex-start">
        <select data-actie="blok_toevoegen" ${o.length?"":"disabled"} style="width:auto">
          ...
          ${o.map(s=>`<option value="${s}">${Ze[s].naam}</option>`).join("")}
        </select>
        <button class="knop" type="button" data-actie="indeling_standaard">Standaardindeling</button>
      </div>`}ibStijl_(e){return`left:${(e.x/Ne*100).toFixed(3)}%;top:${(e.y/Oe*100).toFixed(3)}%;width:${(e.w/Ne*100).toFixed(3)}%;height:${(e.h/Oe*100).toFixed(3)}%`}htmlVerlichting_(e={},t={}){let a=(e.verlichting??[]).map((r,o)=>{let s=this.hass?.states?.[r.entity]?.attributes??{};return`<div class="item lamp" data-i="${o}">
          <div class="ent"><b>${R(s.friendly_name??r.entity)}</b><span>${R(r.entity)}</span></div>
          ${this.veld_("Naam op het scherm","l_naam",r.naam,{i:o,s:"installatie",extra:`placeholder="${R(s.friendly_name??"")}"`})}
        </div>`}).join("");return`
      ${this.schakel_("verlichting_tonen",t.verlichting_tonen!==!1,{label:"Verlichting op het scherm tonen",s:"instellingen"})}
      <div class="hulp">De namen zoals ze op het scherm staan. Leeg = de naam uit Home Assistant. ${this.rechten_.is_admin?"Welke lampen erbij horen kiest u in het blok Installatie.":"Welke lampen erbij horen bepaalt de installateur."}</div>
      <div class="lijst">${a||'<div class="leeg">Er zijn nog geen lampen gekozen.</div>'}</div>`}htmlInstellingen_(e={},t={}){let n=(t.feeds??[]).map((a,r)=>`<div class="item feed" data-i="${r}">
          ...
          <div class="knoppen"><button class="knop ico gevaar" type="button" data-actie="f_verwijder" data-i="${r}" title="Verwijderen">${f("minus")}</button></div>
          ${this.feedFouten_[a.url]?`<div class="feedfout" style="grid-column: 1 / -1">Niet opgehaald: ${R(this.feedFouten_[a.url])}</div>`:""}
        </div>`).join("");return`
      <div class="rij twee">
        <div class="veld"><label>Logo</label>
          <div class="b-onder">
            <div class="plaatje logo" data-bestand="${R(e.logo)}">${e.logo?"":f("camera")}</div>
            <button class="knop klein" type="button" data-actie="logo">${f("camera")} ${e.logo?"Ander logo":"Logo kiezen"}</button>
            ${e.logo?`<button class="knop klein" type="button" data-actie="logoweg">${f("close")} Logo weg</button>`:""}
          </div>
        ...
        <div class="veld"><label>Accentkleur op het scherm</label>
          <div class="b-onder">
            <input type="color" data-veld="accent_kleur" data-s="scherm" value="${R(e.accent||"#026fa1")}">
            <input type="text" data-veld="accent" data-s="scherm" value="${R(e.accent)}" placeholder="leeg = standaard" style="max-width: 140px">
          </div>
        </div>
      </div>
      <div class="rij drie">
      ...
      ${this.schakel_("nachtstand",e.nachtstand!==!1,{label:"Nachtstand buiten de openingstijden (klok met 'Gesloten \xB7 morgen open om \u2026')",s:"scherm"})}
      ${this.schakel_("aanwezig_teller",e.aanwezig_teller!==!1,{label:"Teller bij Aanwezig (x van y)",s:"scherm"})}
      ${this.schakel_("nieuws_afbeeldingen",e.nieuws_afbeeldingen!==!1,{label:"Afbeeldingen bij het nieuws",s:"scherm"})}
      ${this.schakel_("weer_animatie",e.weer_animatie!==!1,{label:"Bewegende weericonen",s:"scherm"})}
      ${this.schakel_("reset_middernacht",t.reset_middernacht!==!1,{label:"Om middernacht iedereen op afwezig zetten",s:"instellingen"})}
      <div class="veld"><label>Nieuws van buiten (RSS)</label>
        ...
        <div class="knoppen" style="justify-content: flex-start; margin-top: 8px">
          <button class="knop" type="button" data-actie="f_nieuw">${f("plus")} Bron toevoegen</button>
          <button class="knop" type="button" data-actie="f_ververs">Nu ophalen</button>
        </div>
      </div>`}htmlInstallatie_(e={},t={}){let n=this.hass?.states??{},a=u=>Object.values(n).filter(k=>u.includes(k.entity_id.split(".")[0])).map(k=>({id:k.entity_id,naam:k.attributes?.friendly_name??k.entity_id})).sort((k,x)=>k.naam.localeCompare(x.naam,"nl")),r=a(["weather"]),o=a(["calendar"]),s=a(["light","switch"]),l=new Set(e.agendas??[]),d=new Set((e.verlichting??[]).map(u=>u.entity)),c=(u,k,x)=>u.length?u.map(w=>`<label class="vink" data-zoek="${R(`${w.naam} ${w.id}`.toLowerCase())}"><input type="checkbox" data-veld="${k}" data-s="installatie" data-i="${R(w.id)}" ${x.has(w.id)?"checked":""}> ${R(w.naam)}<span class="id">${R(w.id)}</span></label>`).join(""):'<div class="leeg">Geen entiteiten van dit soort gevonden.</div>',p="",h=this.gebruikers_??[],g=new Set(t.kiosk_gebruikers??[]);return p=`<div class="veld"><label>Kioskaccounts</label>
      ...
      <div class="gebruikers">${h.length?h.map(u=>`<label class="vink"><input type="checkbox" data-veld="kiosk" data-s="instellingen" data-i="${R(u.id)}" ${g.has(u.id)?"checked":""}> ${R(u.naam)}${u.is_admin?" (beheerder)":""}</label>`).join(""):'<div class="leeg">Gebruikers laden\u2026</div>'}</div></div>`,`
      ...
      ${this.keuze_("Weerentiteit","weer",e.weer??"",[["","(geen weer op het scherm)"],...r.map(u=>[u.id,`${u.naam} (${u.id})`])],{s:"installatie"})}
      <div class="veld"><label>Agenda's (de afspraken van vandaag)</label><div class="keuzes">${c(o,"agenda",l)}</div></div>
      <div class="veld"><label>Lampen en schakelaars op het scherm</label>
        ...
        <div class="keuzes" data-lijst="lampen">${c(s,"lamp",d)}</div>
      </div>
      ${p}`}plaatjes_(e){for(let t of e.querySelectorAll("[data-bestand]:not([data-bestand=''])"))jt(this.hass,t.dataset.bestand).then(n=>{n&&t.isConnected&&(t.innerHTML=`<img alt="" src="${n}">`)})}markeer_(e,t,n=Yr){this.vuil_.add(e),this.bron_={...this.bron_??{},[e]:t},this.versie_[e]=(this.versie_[e]??0)+1,this.fouten_[e]=null,t&&(this.meldingen_[t]=null,this.tel_(t)),this.status_("Opslaan\u2026","bezig"),clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),n)}invoer_(e){let t=e.target;if(t?.dataset?.filter)return this.filter_(t);if(t?.dataset?.actie==="blok_toevoegen")return this.blokToevoegen_(t.value,t);let n=t?.dataset?.veld;if(!n)return;let a=t.closest(".blok")?.dataset.blok;if(!a)return;let r=this.blokInfo_(a),o=t.dataset.s||r.secties[0],s=t.dataset.i,l=this.werk_[o],d=t.type==="checkbox"?t.checked:t.value,c=t.type==="text"||t.type==="url"||t.type==="number"||t.tagName==="TEXTAREA",p=t.type==="color";if(!((c||p)&&e.type!=="input")&&!(!c&&!p&&e.type!=="change")){if(o==="personen"||o==="mededelingen"||o==="nieuws"){let h=l[Number(s)];if(!h)return;if(h[n]=d,n==="naam"){let g=t.closest(".item")?.querySelector(".avatar");g&&!g.querySelector("img")&&(g.textContent=Gr(d))}if(n==="aanwezig"){h._aanwezig=!0;let g=t.closest(".vink")?.querySelector("span:last-child");g&&(g.textContent=d?"Aanwezig":"Afwezig"),t.closest(".item")?.querySelector(".avatar")?.classList.toggle("aan",d)}}else if(o==="praktijk")this.invoerPraktijk_(l,n,s,d,t);else if(o==="scherm")if(n==="accent_kleur"){l.accent=d;let h=t.closest(".b-onder")?.querySelector('[data-veld="accent"]');h&&(h.value=d)}else if(n==="accent")l.accent=String(d).trim()||null;else if(t.type==="number"){let h=Number(d);if(!Number.isFinite(h))return;l[n]=h}else l[n]=d;else if(o==="installatie"){if(n==="weer")l.weer=d||null;else if(n==="agenda"){let h=new Set(l.agendas??[]);d?h.add(s):h.delete(s),l.agendas=[...h]}else if(n==="lamp"){l.verlichting??=[];let h=l.verlichting.findIndex(g=>g.entity===s);d&&h<0&&l.verlichting.push({entity:s,naam:""}),!d&&h>=0&&l.verlichting.splice(h,1),this.uitgesteld_.add("verlichting")}else if(n==="l_naam"){let h=l.verlichting?.[Number(s)];h&&(h.naam=d)}}else if(o==="instellingen")if(n==="kiosk"){let h=new Set(l.kiosk_gebruikers??[]);d?h.add(s):h.delete(s),l.kiosk_gebruikers=[...h]}else if(n.startsWith("f_")){let h=l.feeds[Number(s)];h&&(h[n.slice(2)]=d)}else l[n]=d;this.markeer_(o,a,c?Gu:Yr)}}invoerPraktijk_(e,t,n,a,r){if(t==="welkom")e.welkom=String(a).split(`
`).map(o=>o.trim()).filter(Boolean);else if(t==="ot_open"){e.openingstijden??={},e.openingstijden[n]=a?[["08:00","17:00"]]:[];let o=r.closest(".ot-tabel");for(let l of o.querySelectorAll(`input[type="time"][data-i="${n}"]`)){l.disabled=!a;let[,d,c]=l.dataset.veld.split("_");l.value=e.openingstijden[n][Number(d)]?.[Number(c)]??""}let s=r.closest(".vink")?.querySelector("span:last-child");s&&(s.textContent=a?"open":"gesloten")}else if(t.startsWith("ot_")){let[,o,s]=t.split("_").map(Number);e.openingstijden??={};let l=e.openingstijden[n]??[];for(;l.length<=o;)l.push(["",""]);l[o][s]=a,e.openingstijden[n]=l.filter((d,c)=>c===0||d[0]&&d[1]),e.openingstijden[n].length||(e.openingstijden[n]=[["",""]])}else if(t.startsWith("u_")){let o=e.uitzonderingen[Number(n)];if(!o)return;let s=t.slice(2);if(s==="open"){o.tijden=a?[["08:00","17:00"]]:[];let l=r.closest(".item");for(let c of l.querySelectorAll('input[type="time"]'))c.disabled=!a,c.value=a?c.dataset.veld==="u_van"?"08:00":"17:00":"";let d=r.closest(".vink")?.querySelector("span:last-child");d&&(d.textContent=a?"open":"gesloten")}else s==="van"||s==="tot"?o.tijden=[[s==="van"?a:o.tijden?.[0]?.[0]??"",s==="tot"?a:o.tijden?.[0]?.[1]??""]]:o[s]=a}else e[t]=a}filter_(e){let t=e.value.trim().toLowerCase(),n=e.parentElement?.querySelector(`[data-lijst="${e.dataset.filter}"]`);for(let a of n?.querySelectorAll("[data-zoek]")??[])a.hidden=!!t&&!a.dataset.zoek.includes(t)}blokToevoegen_(e,t){t&&(t.value="");let n=Ze[e];if(!n)return;let a=this.werk_.indeling??(this.werk_.indeling={blokken:[]});if(a.blokken.some(l=>l.soort===e))return;let[r,o]=n.maat,s=Zr(a.blokken,r,o);for(;!s&&(r>1||o>1);)o>1?o-=1:r-=1,s=Zr(a.blokken,r,o);return s?(a.blokken.push({id:`b-${Date.now().toString(36)}${Math.floor(Math.random()*1e4).toString(36)}`,soort:e,x:s.x,y:s.y,w:r,h:o,aantal:n.aantal?3:0}),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):(this.meldingen_.indeling={tekst:"Er is geen plek meer. Maak eerst een ander blok kleiner of haal er een weg.",fout:!0},this.teken_("indeling",!0))}sleepStart_(e){let t=e.target.closest?.(".ib");if(!t||e.target.closest("button, input, select")||e.pointerType==="mouse"&&e.button!==0)return;let n=t.closest(".raster"),a=this.werk_.indeling,r=a?.blokken?.find(k=>k.id===t.dataset.id);if(!r||!n)return;let o=e.target.closest(".ib-greep")?"maat":"plaats",s=n.getBoundingClientRect(),l=s.width/Ne,d=s.height/Oe,c={x:e.clientX,y:e.clientY},p={...r},h=!1;e.preventDefault();try{t.setPointerCapture(e.pointerId)}catch{}t.classList.add("sleept");let g=k=>{let x=Math.round((k.clientX-c.x)/l),w=Math.round((k.clientY-c.y)/d);(x||w)&&(h=!0),p=o==="plaats"?{...r,x:$a(r.x+x,0,Ne-r.w),y:$a(r.y+w,0,Oe-r.h)}:{...r,w:$a(r.w+x,1,Ne-r.x),h:$a(r.h+w,1,Oe-r.y)},t.classList.toggle("ongeldig",!ya(a.blokken,p)),t.style.cssText=this.ibStijl_(p)},u=()=>{t.removeEventListener("pointermove",g),t.removeEventListener("pointerup",u),t.removeEventListener("pointercancel",u),t.classList.remove("sleept","ongeldig");let k=p.x!==r.x||p.y!==r.y||p.w!==r.w||p.h!==r.h;h&&k&&ya(a.blokken,p)&&(Object.assign(r,p),this.markeer_("indeling","indeling")),this.teken_("indeling",!0)};t.addEventListener("pointermove",g),t.addEventListener("pointerup",u),t.addEventListener("pointercancel",u)}async klik_(e){let t=e.target.closest(".bk");if(t){let c=t.closest(".blok").dataset.blok;this.open_=this.open_===c?null:c;for(let p of this.$$(".blok"))p.classList.toggle("open",p.dataset.blok===this.open_);this.open_&&this.uitgesteld_.has(this.open_)&&this.teken_(this.open_,!0);return}let n=e.target.closest("[data-actie]");if(!n||n.disabled||n.tagName==="SELECT")return;let a=n.closest(".blok")?.dataset.blok,r=n.dataset.actie,o=Number(n.dataset.i),l=this.blokInfo_(a)?.secties[0],d=this.werk_[l];if(r==="nieuw"){let c={personen:{naam:"",functie:"",aanwezig:!1},mededelingen:{tekst:""},nieuws:{titel:"",tekst:""}}[l];d.push(c),this.teken_(a,!0),this.$(`.blok[data-blok="${a}"] .item:last-of-type input[type="text"]`)?.focus();return}if(r==="verwijder"){let c=d[o],p=c?.naam||c?.titel||c?.tekst||"dit item";return c&&(c.id||c.naam||c.titel||c.tekst)&&!await ye({title:"Verwijderen?",text:`"${p}" verdwijnt meteen van het scherm.`,confirmText:"Verwijderen"})?void 0:(d.splice(o,1),this.markeer_(l,a),this.teken_(a,!0))}if(r==="omhoog"||r==="omlaag"){let c=r==="omhoog"?o-1:o+1;return c<0||c>=d.length?void 0:([d[o],d[c]]=[d[c],d[o]],this.markeer_(l,a),this.teken_(a,!0))}if(r==="foto"||r==="logo"){this.doel_=r==="logo"?{sectie:"scherm",blok:a,veld:"logo"}:{sectie:l,blok:a,i:o,veld:l==="personen"?"foto":"afbeelding"};let c=this.$(".file");c.value="",c.click();return}if(r==="fotoweg"||r==="logoweg")return r==="logoweg"?(this.werk_.scherm.logo=null,this.markeer_("scherm",a)):(d[o][l==="personen"?"foto":"afbeelding"]=null,this.markeer_(l,a)),this.teken_(a,!0);if(r==="u_nieuw")return d.uitzonderingen??=[],d.uitzonderingen.push({datum:"",tijden:[],reden:""}),this.teken_(a,!0);if(r==="u_verwijder")return d.uitzonderingen.splice(o,1),this.markeer_(l,a),this.teken_(a,!0);if(r==="f_nieuw"){let c=this.werk_.instellingen;return c.feeds??=[],c.feeds.push({naam:"",url:""}),this.teken_(a,!0)}if(r==="f_verwijder")return this.werk_.instellingen.feeds.splice(o,1),this.markeer_("instellingen",a),this.teken_(a,!0);if(r==="f_ververs"){n.disabled=!0;try{let c=await zd(this.hass);this.feedFouten_=c.feed_fouten??{},this.meldingen_[a]={tekst:`${(c.feeds??[]).length} bericht(en) opgehaald.`}}catch(c){this.meldingen_[a]={tekst:c?.message??"Ophalen lukte niet.",fout:!0}}return this.teken_(a,!0)}if(r==="blok_weg"||r==="aantal_min"||r==="aantal_plus"){let c=this.werk_.indeling,p=c?.blokken?.find(h=>h.id===n.dataset.id);return p?(r==="blok_weg"?c.blokken=c.blokken.filter(h=>h!==p):r==="aantal_min"?p.aantal=p.aantal<=1?0:p.aantal-1:p.aantal=Math.min(50,(p.aantal||0)+1),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}if(r==="indeling_standaard")return await ye({title:"Standaardindeling?",text:"De blokken gaan terug naar hun oorspronkelijke plek en maat.",confirmText:"Terugzetten"})?(this.werk_.indeling=_a(),this.markeer_("indeling","indeling"),this.teken_("indeling",!0)):void 0}async bestandGekozen_(e){let t=e.target.files?.[0],n=this.doel_;if(this.doel_=null,!t||!n)return;let{sectie:a,blok:r,i:o,veld:s}=n;this.meldingen_[r]={tekst:"Bezig met uploaden\u2026"},this.teken_(r,!0);try{let l=await $d(this.hass,t),d=this.werk_[a],c=o===void 0?d:d[o],p=c[s];c[s]=l.id,p&&(this.oudeBestanden_=[...this.oudeBestanden_??[],p]),this.meldingen_[r]={tekst:`${l.naam||"Bestand"} ge\xFCpload.`},this.markeer_(a,r)}catch(l){this.meldingen_[r]={tekst:l?.message??"Uploaden lukte niet.",fout:!0}}this.teken_(r,!0)}payload_(e){let t=this.werk_[e];switch(e){case"personen":return(t??[]).filter(n=>n.naam?.trim()).map(({_aanwezig:n,aanwezig:a,...r})=>n?{...r,aanwezig:a}:r);case"mededelingen":return(t??[]).filter(n=>n.tekst?.trim());case"nieuws":return(t??[]).filter(n=>n.titel?.trim());case"praktijk":return{...t,openingstijden:Object.fromEntries($t.map(n=>[n,(t.openingstijden?.[n]??[]).filter(a=>a[0]&&a[1])])),uitzonderingen:(t.uitzonderingen??[]).filter(n=>n.datum).map(n=>({...n,tijden:(n.tijden??[]).filter(a=>a[0]&&a[1])}))};case"instellingen":return{...t,feeds:(t.feeds??[]).filter(n=>n.url?.trim())};default:return t}}async bewaar_(e){if(!this.hass||this.bezig_.has(e))return;let t=this.versie_[e]??0;this.bezig_.add(e),this.status_("Opslaan\u2026","bezig");try{let a=(await _d(this.hass,e,this.payload_(e)))[e];this.koppel_(e,a),this.stand_&&(this.stand_[e]=Ud(a)),this.fouten_[e]=null,(this.versie_[e]??0)===t&&this.vuil_.delete(e);let r=new Date;this.laatstOpgeslagen_=`${String(r.getHours()).padStart(2,"0")}:${String(r.getMinutes()).padStart(2,"0")}`;for(let o of this.oudeBestanden_??[])this.inGebruik_(o)||(yd(this.hass,o).catch(()=>{}),Ed(o));this.oudeBestanden_=[]}catch(n){this.fouten_[e]=n?.message??"Opslaan lukte niet."}finally{this.bezig_.delete(e)}this.vuil_.has(e)&&(this.versie_[e]??0)!==t&&!this.fouten_[e]&&(clearTimeout(this.timers_[e]),this.timers_[e]=setTimeout(()=>this.bewaar_(e),Yr));for(let n of Te)n.secties.includes(e)&&this.tel_(n.key);if(!this.fouten_[e])for(let n of Te)n.secties.includes(e)&&n.key!==this.bron_?.[e]&&this.teken_(n.key);if(this.fouten_[e]){this.status_(`Niet opgeslagen: ${this.fouten_[e]}`,"fout");for(let n of Te)n.secties.includes(e)&&this.teken_(n.key)}else!this.bezig_.size&&!this.vuil_.size&&this.status_(`Opgeslagen ${this.laatstOpgeslagen_}`,"ok")}koppel_(e,t){let n=this.werk_[e];if(!Array.isArray(n)||!Array.isArray(t))return;let a={personen:o=>o.naam?.trim(),mededelingen:o=>o.tekst?.trim(),nieuws:o=>o.titel?.trim()}[e];if(!a)return;let r=0;n.forEach((o,s)=>{if(!a(o))return;let l=t[r];if(r+=1,!l)return;o.id=l.id,e==="personen"&&(o.initialen=l.initialen,o._aanwezig&&delete o._aanwezig),e==="nieuws"&&l.gemaakt&&(o.gemaakt=l.gemaakt);let d=this.$(`.blok[data-blok="${e}"] .item[data-i="${s}"]`);d&&(d.dataset.id=l.id)})}inGebruik_(e){let t=this.stand_??{};return t.scherm?.logo===e||(t.personen??[]).some(n=>n.foto===e)||(t.nieuws??[]).some(n=>n.afbeelding===e)||(this.werk_.personen??[]).some(n=>n.foto===e)||(this.werk_.nieuws??[]).some(n=>n.afbeelding===e)||this.werk_.scherm?.logo===e}};z(St,"css",Ku);var Wu={title:"Titel",show_personen:"Blok Medewerkers",show_mededelingen:"Blok Mededeling",show_nieuws:"Blok Nieuws",show_praktijk:"Blok Praktijk",show_indeling:"Blok Indeling",show_verlichting:"Blok Verlichting",show_instellingen:"Blok Instellingen en logo",show_installatie:"Blok Installatie (beheerder)",open:"Staat open bij het laden"},Qr=class extends C{defaults(){return{...Fd}}schema(){return[{name:"title",selector:b.text()},{name:"open",selector:b.select([...Te.map(e=>({value:e.key,label:e.titel})),{value:"",label:"Alles dicht"}])},...Te.map(e=>({name:`show_${e.key}`,selector:b.bool()}))]}label(e){return Wu[e.name]??super.label(e)}helper(e){if(e.name==="show_instellingen")return"Logo, accent, uiterlijk, nieuwsbronnen en de middernachtregel. Zet dit blok uit op een dashboard voor een receptie die daar niet aan hoeft te zitten.";if(e.name==="show_installatie")return"Weer, agenda's, lampen en kioskaccounts. Alleen een beheerder ziet dit blok, ook als het aanstaat."}};N(Jr,St,{name:"DomotiApp Infoscherm Beheer",description:"Voor de receptie: medewerkers, mededeling van de dag, nieuws, openingstijden, de indeling van het scherm en het logo. Alles wordt vanzelf opgeslagen en staat meteen op het scherm.",preview:!1});I(`${Jr}-editor`,Qr);St.getConfigElement=()=>document.createElement(`${Jr}-editor`);St.getStubConfig=()=>({title:"Infoscherm"});var Ea=globalThis,Aa=Ea.ShadowRoot&&(Ea.ShadyCSS===void 0||Ea.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,eo=Symbol(),qd=new WeakMap,nn=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==eo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Aa&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=qd.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&qd.set(t,e))}return e}toString(){return this.cssText}},De=i=>new nn(typeof i=="string"?i:i+"",void 0,eo),oe=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new nn(t,i,eo)},Zd=(i,e)=>{if(Aa)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=Ea.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},to=Aa?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return De(t)})(i):i;var{is:Uu,defineProperty:Fu,getOwnPropertyDescriptor:qu,getOwnPropertyNames:Zu,getOwnPropertySymbols:Xu,getPrototypeOf:Yu}=Object,Ma=globalThis,Xd=Ma.trustedTypes,Qu=Xd?Xd.emptyScript:"",Ju=Ma.reactiveElementPolyfillSupport,an=(i,e)=>i,no={toAttribute(i,e){switch(e){case Boolean:i=i?Qu:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Qd=(i,e)=>!Uu(i,e),Yd={attribute:!0,type:String,converter:no,reflect:!1,useDefault:!1,hasChanged:Qd};Symbol.metadata??=Symbol("metadata"),Ma.litPropertyMetadata??=new WeakMap;var Le=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Yd){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&Fu(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=qu(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Yd}static _$Ei(){if(this.hasOwnProperty(an("elementProperties")))return;let e=Yu(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(an("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(an("properties"))){let t=this.properties,n=[...Zu(t),...Xu(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(to(a))}else e!==void 0&&t.push(to(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Zd(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:no).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:no;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Qd)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};Le.elementStyles=[],Le.shadowRootOptions={mode:"open"},Le[an("elementProperties")]=new Map,Le[an("finalized")]=new Map,Ju?.({ReactiveElement:Le}),(Ma.reactiveElementVersions??=[]).push("2.1.2");var co=globalThis,Jd=i=>i,Sa=co.trustedTypes,ec=Sa?Sa.createPolicy("lit-html",{createHTML:i=>i}):void 0,oc="$lit$",Xe=`lit$${Math.random().toFixed(9).slice(2)}$`,sc="?"+Xe,em=`<${sc}>`,ot=document,on=()=>ot.createComment(""),sn=i=>i===null||typeof i!="object"&&typeof i!="function",po=Array.isArray,tm=i=>po(i)||typeof i?.[Symbol.iterator]=="function",ao=`[ 	
\f\r]`,rn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tc=/-->/g,nc=/>/g,it=RegExp(`>|${ao}(?:([^\\s"'>=/]+)(${ao}*=${ao}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ac=/'/g,ic=/"/g,lc=/^(?:script|style|textarea|title)$/i,ho=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),j=ho(1),Tx=ho(2),Dx=ho(3),st=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),rc=new WeakMap,rt=ot.createTreeWalker(ot,129);function dc(i,e){if(!po(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ec!==void 0?ec.createHTML(e):e}var nm=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=rn;for(let s=0;s<t;s++){let l=i[s],d,c,p=-1,h=0;for(;h<l.length&&(o.lastIndex=h,c=o.exec(l),c!==null);)h=o.lastIndex,o===rn?c[1]==="!--"?o=tc:c[1]!==void 0?o=nc:c[2]!==void 0?(lc.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=it):c[3]!==void 0&&(o=it):o===it?c[0]===">"?(o=a??rn,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?it:c[3]==='"'?ic:ac):o===ic||o===ac?o=it:o===tc||o===nc?o=rn:(o=it,a=void 0);let g=o===it&&i[s+1].startsWith("/>")?" ":"";r+=o===rn?l+em:p>=0?(n.push(d),l.slice(0,p)+oc+l.slice(p)+Xe+g):l+Xe+(p===-2?s:g)}return[dc(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},ln=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=nm(e,t);if(this.el=i.createElement(d,n),rt.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=rt.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(oc)){let h=c[o++],g=a.getAttribute(p).split(Xe),u=/([.?@])?(.*)/.exec(h);l.push({type:1,index:r,name:u[2],strings:g,ctor:u[1]==="."?ro:u[1]==="?"?oo:u[1]==="@"?so:Ot}),a.removeAttribute(p)}else p.startsWith(Xe)&&(l.push({type:6,index:r}),a.removeAttribute(p));if(lc.test(a.tagName)){let p=a.textContent.split(Xe),h=p.length-1;if(h>0){a.textContent=Sa?Sa.emptyScript:"";for(let g=0;g<h;g++)a.append(p[g],on()),rt.nextNode(),l.push({type:2,index:++r});a.append(p[h],on())}}}else if(a.nodeType===8)if(a.data===sc)l.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(Xe,p+1))!==-1;)l.push({type:7,index:r}),p+=Xe.length-1}r++}}static createElement(e,t){let n=ot.createElement("template");return n.innerHTML=e,n}};function Nt(i,e,t=i,n){if(e===st)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=sn(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Nt(i,a._$AS(i,e.values),a,n)),e}var io=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??ot).importNode(t,!0);rt.currentNode=a;let r=rt.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new dn(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new lo(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=rt.nextNode(),o++)}return rt.currentNode=ot,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},dn=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Nt(this,e,t),sn(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==st&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):tm(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==$&&sn(this._$AH)?this._$AA.nextSibling.data=e:this.T(ot.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=ln.createElement(dc(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new io(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=rc.get(e.strings);return t===void 0&&rc.set(e.strings,t=new ln(e)),t}k(e){po(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(on()),this.O(on()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Jd(e).nextSibling;Jd(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ot=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=$}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Nt(this,e,t,0),o=!sn(e)||e!==this._$AH&&e!==st,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Nt(this,s[n+l],t,l),d===st&&(d=this._$AH[l]),o||=!sn(d)||d!==this._$AH[l],d===$?e=$:e!==$&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ro=class extends Ot{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}},oo=class extends Ot{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==$)}},so=class extends Ot{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Nt(this,e,t,0)??$)===st)return;let n=this._$AH,a=e===$&&n!==$||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==$&&(n===$||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},lo=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Nt(this,e)}};var am=co.litHtmlPolyfillSupport;am?.(ln,dn),(co.litHtmlVersions??=[]).push("3.3.3");var cc=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new dn(e.insertBefore(on(),r),r,void 0,t??{})}return a._$AI(i),a};var uo=globalThis,te=class extends Le{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=cc(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return st}};te._$litElement$=!0,te.finalized=!0,uo.litElementHydrateSupport?.({LitElement:te});var im=uo.litElementPolyfillSupport;im?.({LitElement:te});(uo.litElementVersions??=[]).push("4.2.2");var ge=oe`
  :host {
    ${De(W)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${De(Ce)}
`;var rm=["unavailable","unknown"],om=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function Na({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||rm.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let h of om)if(d[h]!==void 0){p[h]=d[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function Oa(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var go=["hs","rgb","rgbw","rgbww","xy"],fo="color_temp",sm="onoff";var lt="kleur";var lm=["unavailable","unknown"],hc=["color_temp_kelvin","rgb_color","hs_color","xy_color"],dm=[0,100];function je(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===sm,a=t!==null&&t.includes(fo),r=t!==null&&t.some(d=>go.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!lm.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function cm(){return{state:"off"}}function uc(i,e){let t=e??je(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...fm(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function mc(i,e,t,n){return e?i&&i.state==="on"?{...i}:uc(t,n):{state:"off"}}function gc(i,e,t,n){let a=n??je(t),r=_o(i,t,a);return a.helderheid&&(r.brightness=G(e,1,255)),r}function bo(i,e,t,n){let a=n??je(t),r=_o(i,t,a);return jc(r),r.color_temp_kelvin=G(e,a.minKelvin,a.maxKelvin),r}function vo(i,e,t,n){let a=n??je(t),r=_o(i,t,a);return jc(r),r.hs_color=[G(e?.[0],0,360),G(e?.[1],0,100)],r}function Ta(i,e,t){return i??cm()}function fc(i,e,t){let n=Ta(i,e,t);if(typeof n.brightness=="number")return G(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?G(a,1,255):255}function ko(i,e,t){let n=t??je(e),a=Ta(i,e,n);if(typeof a.color_temp_kelvin=="number")return G(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?G(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Da(i,e,t){let n=Ta(i,e,t);if(mo(n.hs_color))return[G(n.hs_color[0],0,360),G(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return mo(a)?[G(a[0],0,360),G(a[1],0,100)]:[...dm]}function xo(i){return i!=null&&typeof i=="object"}function bc(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!xo(a[s]?.lights?.[o]))return!0;return!1})}function vc(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function wo(i,e,t){return Ta(i,e,t).state==="on"}function kc(i,e,t){let n=t??je(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=wo(i,e,n),r=xc(n),o=r?pm(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===lt),kleurkeuze:a&&r,stand:a?o:null}}function xc(i){return!!(i?.kleurtemp&&i?.kleur)}function pm(i,e,t){let n=t??je(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(hc.slice(1).some(r=>i[r]!==void 0))return lt}let a=e?.attributes?.color_mode;return a===fo&&n.kleurtemp?"wit":go.includes(a)&&n.kleur?lt:"wit"}function wc(i,e,t,n){let a=n??je(t);return xc(a)?e==="wit"?bo(i,ko(i,t,a),t,a):vo(i,Da(i,t,a),t,a):i}function _c(i){let e=G(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function yc(i){let e=G(i,1,100);return G(Math.round(e/100*255),1,255)}var hm=1e3,um=4e4,pc=7;function mm(i){let e=G(i,hm,um)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[G(t,0,255),G(n,0,255),G(a,0,255)]}function gm(i){let[e,t,n]=mm(i);return`rgb(${e}, ${t}, ${n})`}function zc(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:pc},(r,o)=>{let s=o/(pc-1),l=t+(n-t)*s;return`${gm(l)} ${Math.round(s*100)}%`}).join(", ")})`}function fm(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?G(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===fo&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=G(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&go.includes(a)&&mo(t.hs_color)&&(n.hs_color=[G(t.hs_color[0],0,360),G(t.hs_color[1],0,100)]),n}function _o(i,e,t){return i&&i.state==="on"?{...i}:uc(e,t)}function jc(i){for(let e of hc)delete i[e]}function mo(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function G(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var La="domotiapp-scene-card",yo="domotiapp-scene-card-editor",$c="domotiapp-scene-editor";var cn=["een","twee","drie"],Ec="pencil",Ac=["grid_options","layout_options","view_layout","visibility"];var Mc="entity_id",Tt=class extends te{constructor(){super();z(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));z(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Mc]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Mc];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},a={...this._config,entity:n.entity};n.bare?a.bare=!0:delete a.bare,a.entity!==this._config?.entity&&(delete a.name_overrides,this._getypt={}),this._stuurDoor(a)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return $;let t=this._leden();return j`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?j`
          ...
          `:$}
    `}};z(Tt,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),z(Tt,"styles",[ge,oe`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `]);var bm="domotiapp_lovelace/snapshot/create",vm="domotiapp_lovelace/snapshot/close",Ca=class{constructor({roepCommandoAan:e,entityId:t}){this._roep=e,this._entityId=t,this._aanmaak=null,this._afsluiting=null}get heeftSnapshot(){return this._aanmaak!==null}get isGesloten(){return this._afsluiting!==null}async zorgVoorSnapshot(){return this._aanmaak===null&&(this._aanmaak=this._roep(bm,{entity_id:this._entityId}).catch(e=>{throw this._aanmaak=null,e})),this._aanmaak}async sluit({opslaan:e=!1}={}){return this.heeftSnapshot?this._afsluiting!==null?this._afsluiting:(this._afsluiting=(async()=>{try{await this._aanmaak}catch{return{gedaan:!1}}return await this._roep(vm,{entity_id:this._entityId,restore:!e}),{gedaan:!0}})(),this._afsluiting):{gedaan:!1}}};async function Sc({beheer:i,oproepen:e,voerUit:t}){return await i.zorgVoorSnapshot(),t(e)}var jo="laden",$o="klaar",Nc="fout",wm=`linear-gradient(to right, ${[0,60,120,180,240,300,360].map(i=>`hsl(${i}, 100%, 50%)`).join(", ")})`,Dt=class extends te{constructor(){super(),this._scenes=null,this._leden=[],this._tab=0,this._toestand=jo,this._melding="",this._bezig=!1,this._kelvinGemeld=new Set,this._snapshot=null}firstUpdated(){this._haalOp()}async _haalOp(){this._toestand=jo;try{let e=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:this.entityId});return this._neemOver(e),this._toestand=$o,e}catch(e){return this._melding=e?.message??String(e),this._toestand=Nc,null}}_neemOver(e){this._scenes=Array.from({length:3},(t,n)=>{let a=e.scenes?.[n]??{};return{icon:a.icon||cn[n],lights:{...a.lights??{}}}}),this._leden=e.member_entity_ids??[],this._melding=""}_stateVan(e){return this.hass?.states?.[e]}_besturingVan(e){let t=je(this._stateVan(e));return t.kelvinUitDefaults&&!this._kelvinGemeld.has(e)&&(this._kelvinGemeld.add(e),console.warn(`domotiapp-scene-editor: ${e} meldt geen Kelvin-grenzen; ${t.minKelvin}\u2013${t.maxKelvin} K aangehouden (SPEC 6.3).`)),t}_waardeVan(e){return this._scenes?.[this._tab]?.lights?.[e]}_zetLamp(e,t){this._scenes=this._scenes.map((n,a)=>{if(a!==this._tab)return n;let r={...n.lights};return t===void 0?delete r[e]:r[e]=t,{...n,lights:r}})}_zetIcoon(e){this._scenes=this._scenes.map((t,n)=>n===this._tab?{...t,icon:e||cn[n]}:t)}_kiesTab(e){this._tab=e}get _kanOpslaan(){return this._toestand===$o&&!this._bezig&&this._leden.length>0}async _slaOp(){if(!this._kanOpslaan)return;this._bezig=!0,this._melding="";try{await this.hass.callWS({type:"domotiapp_lovelace/scenes/save",entity_id:this.entityId,scenes:this._scenes})}catch(t){this._melding=t?.message??String(t),this._bezig=!1;return}let e=await this._haalOp();this._bezig=!1,e&&this.dispatchEvent(new CustomEvent("scenes-opgeslagen",{detail:e,bubbles:!0,composed:!0})),this._sluit({opslaan:!0})}get _beheer(){return this._snapshot===null&&(this._snapshot=new Ca({entityId:this.entityId,roepCommandoAan:(e,t)=>this.hass.callWS({type:e,...t})})),this._snapshot}get _kanVoorbeeld(){return this._toestand===$o&&!this._bezig&&this._leden.length>0}async _voorbeeld(){if(!this._kanVoorbeeld)return;let{oproepen:e}=Na({scene:this._scenes[this._tab],memberEntityIds:this._leden,states:this.hass.states});this._bezig=!0,this._melding="";try{let t=await Sc({beheer:this._beheer,oproepen:e,voerUit:n=>Oa((a,r)=>this.hass.callService("light",a,r),n)});t.length&&(this._melding=`Deze lampen reageerden niet: ${t.map(n=>this._naam(n.entityId)).join(", ")}.`)}catch(t){this._melding=`Het voorbeeld is niet gestart: ${t?.message??String(t)}`}finally{this._bezig=!1}}_sluit({opslaan:e=!1}={}){this.dispatchEvent(new CustomEvent("editor-gesloten",{bubbles:!0,composed:!0})),this._sluitSnapshot({opslaan:e})}async _sluitSnapshot({opslaan:e}){try{await this._beheer.sluit({opslaan:e})}catch(t){console.warn(`domotiapp-scene-editor: de snapshot kon niet worden ${e?"verwijderd":"hersteld"}: ${t?.message??t}`)}}disconnectedCallback(){super.disconnectedCallback(),this._snapshot&&this._snapshot.heeftSnapshot&&this._sluitSnapshot({opslaan:!1})}_dialoogGesloten(e){e.stopPropagation(),this._sluit()}_naam(e){return this.nameOverrides?.[e]||this._stateVan(e)?.attributes?.friendly_name||e}render(){return j`
      <ha-dialog
        open
    ...
    `}_renderInhoud(){return this._toestand===jo?j`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Nc?j`
        <div class="inhoud">
      ...
      <div class="inhoud">
        ...
        ${this._melding?j`<ha-alert alert-type="error">${this._melding}</ha-alert>`:$}
        ${this._leden.length===0?j`<ha-alert alert-type="info">
              Deze lichtgroep bevat geen lampen.
            </ha-alert>`:j`<div class="lampen">
              ${this._leden.map(e=>this._renderLamp(e))}
            </div>`}
      </div>
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=wo(a,t,n),o=kc(a,t,n);return j`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
              ${this._naam(e)}
              ${n.bekend?n.beschikbaar?$:j`<span class="hint">niet bereikbaar</span>`:j`<span class="hint">lamp niet gevonden</span>`}
            </span>
            ${xo(a)?$:j`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?j`
                <div class="bediening">
                  ${o.kleurkeuze?this._renderKleurkeuze(e,t,n,a,o.stand):$}
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,mc(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:$}
        </div>
    ...
    `}_renderBesturing(e,t,n,a,r){return j`
      ${r.helderheid?this._renderHelderheid(e,t,n,a):$}
      ${r.kleurtemp?this._renderKleurtemp(e,t,n,a):$}
      ${r.kleur?this._renderKleur(e,t,n,a):$}
    `}_renderHelderheid(e,t,n,a){let r=_c(fc(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,gc(this._waardeVan(e),yc(s.detail.value),t,n))};return j`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,wc(this._waardeVan(e),s,t,n))};return j`
      <div class="kleurkeuze">
        <button
          class="keuze ${r===lt?"actief":""}"
          aria-pressed=${r===lt?"true":"false"}
          @click=${o(lt)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,a){let r=ko(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,bo(this._waardeVan(e),s.detail.value,t,n))};return j`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${zc(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=Da(a,t,n),s=l=>d=>{d.stopPropagation();let c=Da(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,vo(this._waardeVan(e),p,t,n))};return j`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${wm}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};z(Dt,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),z(Dt,"styles",[ge,oe`
    ...
    `]);var _m="0.37.0",ym=["type","entity","name_overrides","bare"],Ha="laden",pn="klaar",Eo="leeg",Ao="geen-groep",Oc="opslagfout",Tc="fout",hn=class extends te{constructor(){super();z(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=Ha,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new le(()=>this._haalScenesOp()),this._verbinding=new _e}static getConfigElement(){return document.createElement(yo)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(a=>a.startsWith("light.")&&Array.isArray(t.states[a].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?H(t):null),T(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(a=>!ym.includes(a)&&!Ac.includes(a));n.length&&console.warn(`${La}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:pt(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(this._verbinding.herverbonden(this.hass)){this._bestondVorigeKeer=n,this._herkansing.herstel(),this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===Ao){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=Ha,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?Eo:pn,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let a=t?.code;if(this._melding=t?.message??String(t),pe(t)&&this._herkansing.plan()){this._toestand=Ha;return}if(a==="home_assistant_error"){this._toestand=Oc;return}if(!this.hass.states[n]){this._toestand=Ao;return}this._toestand=Tc}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==pn)return;let{oproepen:n}=Na({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let a=await Oa((r,o)=>this.hass.callService("light",r,o),n);a.length&&this._meldMislukking(a.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),a=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:a},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===pn&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Eo:pn}render(){if(!this._config)return $;switch(this._toestand){case Ao:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Oc:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Tc:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,a=!1){return j`
      <div class="needs">
        <span class="mark">${this._icoon("question")}</span>
        <span>
          <b>${t}</b>
          ${n?j`<span class="detail">${n}</span>`:$}
          ${a?j`<button type="button" class="opnieuw" @click=${this._opnieuw}>
                Opnieuw proberen
              </button>`:$}
        </span>
      </div>
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=f(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===Eo,n=this._toestand===Ha,a=this._iconen();return j`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${a.map((r,o)=>j`
        ...
        ${t?j`<div class="mededeling">Deze lichtgroep bevat geen lampen.</div>`:this._renderNieuweLampen()}
      </div>
      ${this._editorOpen?this._renderEditor():$}
    `}_renderNieuweLampen(){if(this._toestand!==pn)return $;let t=bc(this._scenes,this._leden,3).length,n=vc(t);return n?j`<div class="mededeling">${n}</div>`:$}_renderEditor(){return j`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||cn[n])}};z(hn,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),z(hn,"styles",[ge,oe`
      :host { display: block; }
    ...
    `]);D(La,hn);D(yo,Tt);D($c,Dt);ht({type:La,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${_m}).`,preview:!1});var dt="domotiapp-alarm-card",Mo="domotiapp-alarm-card-editor",Dc="domotiapp-alarm-editor",Lc="DomotiApp Wekker",Cc="https://github.com/Sven2410/domotiapp-lovelace",$e="domotiapp_lovelace",he=Object.freeze({get:`${$e}/alarms/get`,save:`${$e}/alarms/save`,setEnabled:`${$e}/alarms/set_enabled`,delete:`${$e}/alarms/delete`,stop:`${$e}/alarms/stop`,clearMessage:`${$e}/alarms/clear_message`,search:`${$e}/sound/search`,entities:`${$e}/entities/list`,previewStart:`${$e}/preview/start`,subscribe:`${$e}/updates/subscribe`}),Ia="#026FA1";function Rc(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var zm="07:00";var jm=["uri","name","media_type","image"],$m="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",Em="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var Am="Music Assistant Wekker",Mm="Verlichting Wekker";function Va(){return{id:null,name:"",time:zm,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Hc(i){let e=Va();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:So(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:un(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function un(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of jm)e[t]=i[t]===void 0?null:i[t];return e}function So(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function No(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),So(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Ic(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:un(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Vc(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Bc(i){return So(i)&&i.slice(0,2)==="02"?$m:null}function Pc(i){return i===!1?Em:null}function Kc(i){return typeof i?.endless=="boolean"?i.endless:null}function Ba(i,e){let t=e==="lamp",n=t?Mm:Am,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function Gc(i,e){return Ba(e,"speaker")!==null?!1:No(i).ok}var Nm=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Om=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],mn="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Tm="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Dm="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Lt=class extends te{constructor(){super(),this._concept=Va(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Hc(this.wekker):Va(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:he.previewStart,speaker:this._concept.speaker,sound:un(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:he.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:un(e),endless:Kc(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=No(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:he.save,person:this.person,alarm:Ic(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return j`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return $;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Ba(t,"speaker"),r=Ba(n,"lamp"),o=Bc(e.time),s=Pc(e.endless),l=Gc(e,t);return j`
      <div class="kop">
      ...
      <div class="blok">
        ...
        ${o?j`<div class="waarschuwing">
              ${this._svg(mn)}<span>${o}</span>
            </div>`:$}
      </div>
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Nm.map(([d,c])=>j`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Vc(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${a?j`<div class="uitleg">${this._svg(mn)}<span>${a}</span></div>`:j`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
              ...
              >
                ...
                ${(t?.entities??[]).map(d=>j`<option value=${d.entity_id} ?selected=${d.entity_id===e.speaker}>
                    ${d.name}
                  </option>`)}
              </select>
            </div>`}
      ...
      <div class="blok">
        ...
        ${e.sound?j`<div class="gekozen">
              ${e.sound.image?j`<img src=${e.sound.image} alt="" />`:$}
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Om.map(([d,c])=>j`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
            ...
            @click=${()=>this._zoek()}
          >
            ${this._svg(this._zoekt?Dm:Tm)}
          </button>
        </div>
        ${this._treffers?j`<div class="treffers">
              ${this._treffers.length===0?j`<div class="treffer">Niets gevonden.</div>`:this._treffers.map(d=>j`<button
                      class="treffer"
                      type="button"
                      @click=${()=>this._kiesGeluid(d)}
                    >
                      ${d.image?j`<img src=${d.image} alt="" />`:$}
                      <span>${d.name}</span>
                      <span class="soort">${d.media_type??""}</span>
                    </button>`)}
            </div>`:$}
        ${s?j`<div class="waarschuwing">${this._svg(mn)}<span>${s}</span></div>`:$}
      </div>
      ...
      <div class="blok">
        ...
        ${r?j`<div class="uitleg">${this._svg(mn)}<span>${r}</span></div>`:j`
              <div class="vak">
                <select
                  id="lamp"
              ...
              ${e.light?j`<label class="veld" style="margin-top:10px" for="helderheid">
      ...
      ${this._melding?j`<div class="blok">
            <div class="waarschuwing ${this._melding.fout?"fout":""}">
              ${this._svg(mn)}<span>${this._melding.tekst}</span>
            </div>
          </div>`:$}
    ...
    `}};z(Lt,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),z(Lt,"styles",[ge,oe`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${De(Ia)});
      display: block;
  ...
  `]);var Wc="person",Lm="Kies een persoon in de kaartinstellingen.",Uc="De gekozen persoon is niet gevonden.",Cm="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Dw=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Fc(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Wc}.`))throw new Error(`'${e}' zit niet in het domein ${Wc}. Kies een persoon, zoals person.sven.`);return{...i}}function qc(i){return{type:`custom:${i}`}}function Zc(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Uc,isFout:!0}:{soort:"ontbreekt",tekst:Lm,isFout:!1}}function Xc(i,e){return i==="not_found"?Uc:i==="home_assistant_error"?Cm:e||"Er ging iets mis bij het ophalen van de wekkers."}var Rm=["ma","di","wo","do","vr","za","zo"],Hm="Geen wekkers ingesteld",Im="Eenmalig",Vm="Eenmalig \u2014 afgelopen",Bm="Geen wekker actief",Yc="Stoppen",Pm="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Km(i){return!Array.isArray(i)||i.length===0?Im:[...new Set(i)].sort((t,n)=>t-n).map(t=>Rm[t-1]??"?").join(" ")}function Gm(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function Qc(i,e){return Gm(i,e)?Vm:Km(i?.days)}function Jc(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Pm,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function ep(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return Hm;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Bm}function tp(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var Wm="0.37.0",Um="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Fm="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",np="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",qm="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Pa=(i,e="icoon")=>j`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,gn=class extends te{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null,this._herkansing=new le(()=>this._haalOp()),this._verbinding=new _e}setConfig(e){let t=Fc(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(Mo)}static getStubConfig(){return qc(dt)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:pt(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&(this._startAbonnement(),this._verbinding.herverbonden(this.hass)&&(this._herkansing.herstel(),this._haalOp())),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?H(e):null),T(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:he.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${dt}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${dt}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:he.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null,this._herkansing.herstel()}catch(t){if(this._config?.person!==e||pe(t)&&this._herkansing.plan())return;this._toestand=null,this._fout=Xc(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:he.entities})}catch(t){this._entiteiten=null,console.warn(`${dt}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:he.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:he.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:he.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:he.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?tp(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return $;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=Zc(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?j`<div class="card surface">
        ...
        ></domotiapp-alarm-editor>
      </div>`:j`<div class="card surface">
      ${a?this._stopknop(a):this._lijst()}
      ${this._tijdelijkeMelding?j`<div class="onderrij">
            ${Pa(np,"icoon klein")}
            <span class="boodschap">${this._tijdelijkeMelding}</span>
          </div>`:$}
    </div>`}_mededeling(e,t){return j`<div class="card surface">
      <div class="mededeling ${t?"fout":""}">${e}</div>
    </div>`}_stopknop(e){return j`<button
      class="stopknop"
      @click=${()=>this._stopAlles(e.ids)}
    >
      <div class="stop-tijd">${e.tijd}</div>
      <div class="stop-naam">${e.naam}</div>
      <div class="stop-woord">${Yc}</div>
    </button>`}_lijst(){let e=this._toestand.alarms??[],t=Date.now();return j`
      <div class="kop ${e.length===0?"leeg":""}">
        <span class="volgende">${ep(this._toestand)}</span>
        <button
          class="icoonknop"
    ...
    `}_bevestiging(e){return j`<div class="onderrij bevestiging">
      <span class="boodschap">${Rc(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=Jc(e),a=!!e.enabled;return j`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${this._bevestigVoor===e.id?this._bevestiging(e):$}
      ${n?j`<div class="onderrij ${n.isFout?"fout":""}">
            ${Pa(n.isFout?qm:np,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:$}
    `}};z(gn,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),z(gn,"styles",[ge,oe`
  ...
  `]);var Ct=class Ct extends te{constructor(){super(...arguments);z(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?$:j`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};z(Ct,"properties",{hass:{attribute:!1},_config:{state:!0}}),z(Ct,"styles",[ge,oe`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),z(Ct,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var Oo=Ct;D(dt,gn);D(Mo,Oo);D(Dc,Lt);ht({type:dt,name:Lc,description:`Wekkerkaart van DomotiApp (v${Wm}).`,preview:!1,documentationURL:Cc});var Zm=["image/png","image/jpeg","image/gif","image/webp","image/svg+xml"];function ap(i){return`/api/image/serve/${i}/original`}function ip(i){return i?Zm.includes(i.type)?i.size>12582912?`Deze afbeelding is ${Math.round(i.size/1024/1024)} MB. Home Assistant neemt er tot ${12582912/1024/1024} MB aan.`:null:"Kies een afbeelding: PNG, JPEG, GIF, WebP of SVG.":"Geen bestand gekozen."}var Xm=`
...
`,To=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=q(Xm)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[this.constructor.sheet_]}connectedCallback(){this.gebouwd_||this.bouw_(),this.teken_()}set value(e){this.value_=e??"",this.gebouwd_&&this.teken_()}get value(){return this.value_??""}set label(e){this.label_=e,this.gebouwd_&&this.teken_()}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.shadowRoot.innerHTML=`
      ...
      <div class="vak">
        ...
        <span class="rechts">
          ...
          <span class="knoppen">
            <button class="doe kies" type="button">${f("plus")}<span>Kies een bestand</span></button>
            <button class="weg leeg" type="button">Wissen</button>
          </span>
          <span class="melding" hidden></span>
        </span>
      </div>
      <input type="file" accept="image/png,image/jpeg,image/gif,image/webp,image/svg+xml" />`,this.gebouwd_=!0;let e=this.$('input[type="file"]');this.$(".kies").addEventListener("click",()=>e.click()),e.addEventListener("change",()=>{let n=e.files?.[0];e.value="",this.upload_(n)}),this.$(".leeg").addEventListener("click",()=>this.zet_(""));let t=this.$('input[type="text"]');t.addEventListener("change",()=>this.zet_(t.value.trim()))}teken_(){this.$(".kop").textContent=this.label_??"Afbeelding";let e=this.$('input[type="text"]');!(this.shadowRoot.activeElement===e)&&e.value!==this.value&&(e.value=this.value);let n=this.$(".voorbeeld");if(this.value){if(n.dataset.bron!==this.value){n.dataset.bron=this.value;let a=document.createElement("img");a.src=this.value,a.alt="",a.onerror=()=>{n.dataset.bron="",n.innerHTML=f("car")},n.replaceChildren(a)}}else n.dataset.bron!==""&&(n.dataset.bron="",n.innerHTML=f("car"))}zet_(e){this.value_=e,this.teken_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}melding_(e,t=!1){let n=this.$(".melding");n.textContent=e,n.dataset.fout=String(t),n.hidden=!e}async upload_(e){let t=ip(e);if(t)return this.melding_(t,!0);this.melding_("Bezig met uploaden\u2026"),this.$(".kies").disabled=!0;try{let n=new FormData;n.append("file",e);let a=this.hass?.auth?.data?.access_token??this.hass?.auth?.accessToken,r=await fetch("/api/image/upload",{method:"POST",body:n,headers:a?{Authorization:`Bearer ${a}`}:{}});if(!r.ok)throw new Error(`Home Assistant antwoordde met ${r.status}`);let o=await r.json();if(!o?.id)throw new Error("Home Assistant gaf geen id terug.");this.zet_(ap(o.id)),this.melding_("Ge\xFCpload.")}catch(n){this.melding_(`${n?.message??"Uploaden lukte niet"}. Je kunt het pad ook zelf intypen, bijvoorbeeld /local/auto.png.`,!0)}finally{this.$(".kies").disabled=!1}}};D("dac-foto-picker",To);var Ym="/api/domotiapp_lovelace/loader.js",rp="domotiapp-lovelace-verversing";function op(i){let e=/[?&]v=([0-9a-fA-F]+)/.exec(String(i??""));return e?e[1].toLowerCase():null}async function Qm(i){try{let e=await i(Ym,{cache:"no-store"});return e?.ok?op(await e.text()):null}catch{return null}}function Jm(){try{return globalThis.sessionStorage?.getItem(rp)??null}catch{return null}}function eg(i){try{globalThis.sessionStorage?.setItem(rp,i)}catch{return!1}return!0}function tg(i,e,t){return!i||!e?"onbekend":i===e?"actueel":t===e?"al-geprobeerd":"herladen"}function sp({eigenUrl:i,haal:e=globalThis.fetch?.bind(globalThis),herlaad:t=()=>globalThis.location?.reload(),doc:n=globalThis.document,interval:a=18e5,klok:r=setInterval}={}){let o=op(i);if(!o||!e)return()=>{};let s=!1,l=async()=>{if(!s&&!n?.querySelector?.("dialog[open], ha-dialog[open]")){s=!0;try{let p=await Qm(e);if(tg(o,p,Jm())!=="herladen"||!eg(p))return;t()}finally{s=!1}}},d=()=>n?.visibilityState==="visible"?l():void 0;n?.addEventListener?.("visibilitychange",d);let c=r(d,a);return()=>{n?.removeEventListener?.("visibilitychange",d),clearInterval(c)}}var ng="0.37.0";Zo(i=>console.warn(`domotiapp-lovelace: ${i}`));sp({eigenUrl:import.meta.url});console.info(`%c DOMOTIAPP-LOVELACE %c ${ng} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{ng as VERSION};
