var Xi=Object.defineProperty;var Yi=(i,e,t)=>e in i?Xi(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var b=(i,e,t)=>Yi(i,typeof e!="symbol"?e+"":e,t);var Y=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`,yt=null,wt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),yt=yt??[ae(rs)],this.shadowRoot.adoptedStyleSheets=yt,this.value_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,$t=null,Et=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),$t=$t??[ae(ds)],this.shadowRoot.adoptedStyleSheets=$t,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in U)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${U[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${as.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
  ...
  `);var Mt=class extends N{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[St({name:"weather",selector:v.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),St({name:"sun",selector:v.entity("sun")},{name:"precipitation_entity",selector:v.entity("sensor")}),{name:"name",selector:v.text()},{name:"hide_below",selector:v.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",bare:"Zonder kaartrand",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};D("domotiapp-header-card-editor",Mt);j("domotiapp-header-card",Ge,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var Be=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      ...
      </div>`}paint(){this.text("h3",this.config.name??"");let e=this.$(".sub");if(!e)return;let t=_(this.hass,this.config.secondary_entity),n=e.querySelector(".si"),s=e.querySelector(".sv");if(!t){s.textContent="",n.innerHTML="";return}let r=this.config.secondary_icon??"";n.dataset.icon!==r&&(n.dataset.icon=r,n.innerHTML=r?A(r):"");let o=t.attributes.unit_of_measurement;s.textContent=o?`${t.state} ${o}`:t.attributes.current_temperature!=null?`${t.attributes.current_temperature} \xB0C`:W(this.hass,t)}getCardSize(){return 1}getGridOptions(){return{columns:"full",rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-separator-card-editor")}static getStubConfig(){return{name:"Nieuwe sectie",icon:"house",tone:"accent"}}};b(Be,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var jt=class extends N{defaults(){return{line:!0,tone:"accent"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon links",fallback:"star",auto:!1},{key:"tone",kind:"tone",label:At.tone},{key:"secondary_icon",kind:"icon",label:"Icoon bij de waarde rechts",auto:!1}]}schema(){return[{name:"name",selector:v.text()},{name:"line",selector:v.bool()},{name:"secondary_entity",selector:v.entity()}]}label(e){return{line:"Lijn tonen",secondary_entity:"Waarde rechts (optioneel)"}[e.name]??super.label(e)}helper(e){if(e.name==="secondary_entity")return"Toont de status van deze entiteit rechts van de lijn, bijvoorbeeld een temperatuur of een aantal."}};D("domotiapp-separator-card-editor",jt);j("domotiapp-separator-card",Be,{name:"DomotiApp Separator",description:"Sectiekop met icoon en vervagende lijn."});var qe=class extends S{validate(e){return{layout:"row",show_state:!0,show_name:!0,show_icon:!0,...e}}watched(){return[this.config.entity].filter(Boolean)}tone_(){let e=this.config;return e.tone?L(e.tone):P(e.entity)!=="light"?U.accent:Re(_(this.hass,e.entity))??U.lit}template(){let e=this.config;return this.setAttribute("layout",["row","tile","compact"].includes(e.layout)?e.layout:"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(s,r)=>Ue(this,this.hass,e,e[s]??r);this.teardown_.push(H(this.$(".btn"),{onTap:()=>t("tap_action",{action:e.entity?"more-info":"none"}),onHold:()=>t("hold_action",{action:e.entity?"more-info":"none"}),onDouble:e.double_tap_action?()=>t("double_tap_action",{action:"none"}):void 0}));let n=this.$(".chip");n&&(this.teardown_.push(H(n,{onTap:s=>t("icon_tap_action",Ke(e.entity)),onHold:()=>t("icon_hold_action",{action:e.entity?"more-info":"none"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation()))}paint(){let e=this.config,t=_(this.hass,e.entity),n=Pe(t),s=!!e.entity&&q(t);this.toggleAttribute("on",n),this.$(".btn").classList.toggle("unavailable",s),this.$(".btn").style.setProperty("--tone",this.tone_());let r=this.$(".chip");if(r){let a=Ve(this.hass,e.entity,e.icon),d=a?`pic:${a}`:e.icon||xe(e.entity,M(this.hass,e.entity));r.dataset.icon!==d&&(r.dataset.icon=d,r.classList.toggle("pic",!!a),r.innerHTML=a?`<img src="${a}" alt="" loading="lazy" />`:A(d)),r.style.setProperty("--tone",n&&!a?this.tone_():"var(--dac-ink-3)"),r.setAttribute("aria-label",e.entity?`${O(this.hass,e.entity,e.name)} schakelen`:"Icoon")}this.text(".nm",O(this.hass,e.entity,e.name));let o=this.$(".st");o&&this.text(o,this.secondary_(t,s)),this.$(".btn").setAttribute("aria-label",`${O(this.hass,e.entity,e.name)}${t?`, ${W(this.hass,t)}`:""}`)}secondary_(e,t){return t?"Niet bereikbaar":!e||ve(e.entity_id)?"":P(e.entity_id)==="light"&&e.state==="on"&&e.attributes.brightness!=null?`${Math.round(e.attributes.brightness/255*100)}%`:W(this.hass,e)}getCardSize(){return this.config?.layout==="tile"?2:1}getGridOptions(){return this.config?.layout==="tile"?{columns:6,rows:2,min_columns:3,min_rows:2,max_rows:2}:{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-button-card-editor")}static getStubConfig(e,t){return{entity:t?.find(s=>s.startsWith("light."))??t?.find(s=>s.startsWith("switch."))??t?.[0],layout:"row"}}};b(qe,"css",`
    :host { display: block; height: 100%; }
...
`;var gs=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),fs=new Set(["hs","rgb","rgbw","rgbww","xy"]),Ot=i=>i?.attributes?.supported_color_modes??[],bs=i=>Ot(i).some(e=>gs.has(e)),Xe=i=>Ot(i).some(e=>fs.has(e)),Ye=i=>Ot(i).includes("color_temp"),Cn=i=>Math.max(1,Math.round((i??0)/255*100)),Je=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[I]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
      ...
      </div>`}wire(){let e=this.config.entity;this.teardown_.push(H(this.$(".chip"),{onTap:()=>this.hass.callService("light","toggle",{entity_id:e}),onHold:()=>F(this,e)})),this.on(this.$(".card"),"click",t=>{t.target.closest(".toggle")&&this.hass.callService("light","toggle",{entity_id:e})}),this.sliders_=new Map}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let s=Fe(e,n);this.sliders_.set(t,s),this.teardown_.push(s)}setSlider_(e,t,n=0,s=100){if(!e)return;let r=s>n?(t-n)/(s-n)*100:0;e.style.setProperty("--v",`${r}%`),e.setAttribute("aria-valuemin",String(n)),e.setAttribute("aria-valuemax",String(s)),e.setAttribute("aria-valuenow",String(t))}paint(){let e=this.config,t=_(this.hass,e.entity),n=q(t),s=t?.state==="on",r=this.$(".lamp");r.dataset.on=String(s),r.classList.toggle("unavailable",n);let o=this.$(".chip"),a=e.icon||"bulb";o.dataset.icon!==a&&(o.dataset.icon=a,o.innerHTML=A(a,"bulb")),this.text(".nm",O(this.hass,e.entity,e.name));let d=s?t?.attributes?.rgb_color:null;r.style.setProperty("--tone",d?`rgb(${d[0]},${d[1]},${d[2]})`:"var(--dac-lit)");let l=this.$(".ctl"),h=n?"none":bs(t)?"range":"toggle";if(l.dataset.kind!==h&&(l.dataset.kind=h,l.innerHTML=h==="range"?de("brightness"):h==="toggle"?'<button class="toggle" type="button" role="switch" aria-checked="false" aria-label="Aan of uit"></button>':"",this.sliders_.delete("brightness")),h==="range"){let p=l.querySelector(".slider");if(this.attach_(p,"brightness",{value:()=>t?.state==="on"?Cn(_(this.hass,e.entity)?.attributes?.brightness):0,onInput:g=>{this.setSlider_(p,g),this.text(".v",g===0?"Uit":`${g}%`)},onCommit:g=>{g===0?this.hass.callService("light","turn_off",{entity_id:e.entity}):this.hass.callService("light","turn_on",{entity_id:e.entity,brightness_pct:g})},disabled:()=>q(_(this.hass,e.entity))}),!p.classList.contains("dragging")){let g=s?Cn(t.attributes.brightness):0;this.setSlider_(p,g),this.text(".v",s?`${g}%`:"Uit")}}else h==="toggle"?(l.querySelector(".toggle")?.setAttribute("aria-checked",String(s)),this.text(".v",s?"Aan":"Uit")):this.text(".v","Niet bereikbaar");this.paintColour_(t,s)}paintColour_(e,t){let n=this.$(".colour"),s=this.config.show_colour!==!1&&(Xe(e)||Ye(e));if(n.hidden=!(s&&t),!s)return;let r=`${Xe(e)?"c":""}${Ye(e)?"t":""}`;if(n.dataset.sig!==r){n.dataset.sig=r,n.innerHTML=(Xe(e)?`<span data-kind="hue" style="display:contents">${de("hue")}</span>`:"")+(Ye(e)?`<span data-kind="kelvin" style="display:contents">${de("kelvin")}</span>`:"");let l=n.querySelector(".slider.hue");l&&(l.dataset.strip="",l.style.setProperty("--strip","linear-gradient(90deg, hsl(0 90% 55%), hsl(60 90% 55%), hsl(120 90% 55%), hsl(180 90% 55%), hsl(240 90% 55%), hsl(300 90% 55%), hsl(360 90% 55%))"),l.setAttribute("aria-label","Kleur"));let h=n.querySelector(".slider.kelvin");h&&(h.dataset.strip="",h.style.setProperty("--strip","linear-gradient(90deg,#ffb15e,#ffd6a8,#fff5e8,#eaf1ff,#cbdcff)"),h.setAttribute("aria-label","Kleurtemperatuur")),this.sliders_.delete("hue"),this.sliders_.delete("kelvin")}if(!t)return;let o=this.config.entity,a=n.querySelector(".slider.hue");a&&(this.attach_(a,"hue",{min:0,max:360,value:()=>_(this.hass,o)?.attributes?.hs_color?.[0]??0,onInput:l=>this.setSlider_(a,l,0,360),onCommit:l=>{let h=_(this.hass,o)?.attributes?.hs_color?.[1]??100;this.hass.callService("light","turn_on",{entity_id:o,hs_color:[l,h]})}}),a.classList.contains("dragging")||this.setSlider_(a,Math.round(e.attributes.hs_color?.[0]??0),0,360));let d=n.querySelector(".slider.kelvin");if(d){let l=e.attributes.min_color_temp_kelvin??2e3,h=e.attributes.max_color_temp_kelvin??6500;if(this.attach_(d,"kelvin",{min:l,max:h,step:50,value:()=>_(this.hass,o)?.attributes?.color_temp_kelvin??l,onInput:p=>this.setSlider_(d,p,l,h),onCommit:p=>this.hass.callService("light","turn_on",{entity_id:o,color_temp_kelvin:p})}),!d.classList.contains("dragging")){let p=e.attributes.color_temp_kelvin;p!=null&&this.setSlider_(d,p,l,h)}}}getCardSize(){let e=_(this.hass,this.config?.entity);return e?.state==="on"&&(Xe(e)||Ye(e))?2:1}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:1}}static getConfigElement(){return document.createElement("domotiapp-light-card-editor")}static getStubConfig(e,t){let n=t?.find(s=>s.startsWith("light."));return n?{entity:n}:{}}};b(Je,"css",`
    :host { display: block; }
...
`,It=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,this.gebouwd_&&e===this.uitObject_)return;let t=_s(e);this.gebouwd_&&JSON.stringify(In(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let s=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!s)continue;let r=Number(s[1]);r!==e&&t.add(r>e?`r${r-1}${s[2]===void 0?"":`i${s[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let s of this.open_){let r=/^r(\d+)i(\d+)$/.exec(s);if(!r||Number(r[1])!==e){n.add(s);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:s)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,s)=>{n.entity||this.open_.add(`r${t}i${s}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=xs;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),this.rows_.forEach((s,r)=>t.appendChild(this.rijBlok_(s,r))),!this.rows_.length){let s=document.createElement("p");s.className="uitleg",s.textContent="Een rij is \xE9\xE9n regel op de kaart, met \xE9\xE9n, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling.",t.appendChild(s)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let s=et({columns:2,items:[]});this.rows_.push(s);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(s,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let s=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let a=document.createElement("b");a.textContent=`Rij ${t+1}`;let d=document.createElement("small");o.append(a,d);let l=document.createElement("span");l.className="kolommen";let h=[1,2,3].map(m=>{let k=document.createElement("button");return k.type="button",k.textContent=String(m),k.title=`${m} entiteit${m>1?"en":""} in deze rij`,l.appendChild(this.binnenKop_(k,()=>{e.columns!==m&&(e.columns=m,et(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_())})),k}),p=()=>{let m=e.items.filter(y=>y.entity),k=`${e.columns} kolom${e.columns>1?"men":""}`;d.textContent=m.length?`${k} \xB7 ${m.map(y=>this.itemNaam_(y)).join(", ")}`:`${k} \xB7 nog leeg`,h.forEach(y=>y.setAttribute("aria-pressed",String(e.columns===Number(y.textContent))))};this.koppen_.push(p);let g=document.createElement("button");g.type="button",g.className="weg",g.title="Rij verwijderen",g.textContent="\u2715",this.binnenKop_(g,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),s.append(r,o,l,g);let x=document.createElement("div");return x.className="rijbody",e.items.forEach((m,k)=>x.appendChild(this.itemBlok_(e,m,t,k))),n.append(s,x),p(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity}itemBlok_(e,t,n,s){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${s}`);let o=document.createElement("summary"),a=document.createElement("span");a.className="pijl",a.textContent="\u203A";let d=document.createElement("span");d.className="nr",d.textContent=String(s+1),d.title=`Plek ${s+1} in de rij`;let l=document.createElement("span");l.className="titel";let h=document.createElement("b"),p=document.createElement("small");l.append(h,p);let g=document.createElement("button");g.type="button",g.className="weg",g.title="Deze plek leegmaken",g.textContent="\u2715",this.binnenKop_(g,()=>{e.items.splice(s,1),this.itemWeg_(n,s),et(e),this.emit_(),this.build_()}),o.append(a,d,l,g);let x=document.createElement("div");x.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.addEventListener("value-changed",$=>{$.stopPropagation(),t.entity=$.detail.value.entity??"",this.emit_()});let k=document.createElement("dac-icon-picker");k.label="Icoon",k.hass=this.hass_,k.addEventListener("value-changed",$=>{$.stopPropagation(),$.detail.value?t.icon=$.detail.value:delete t.icon,this.emit_()});let y=document.createElement("dac-tone-picker");y.label="Kleur",y.hass=this.hass_,y.addEventListener("value-changed",$=>{$.stopPropagation(),$.detail.value?t.tone=$.detail.value:delete t.tone,this.emit_()});let z=document.createElement("ha-form");z.hass=this.hass_,z.schema=[{name:"name",selector:{text:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}}],z.computeLabel=$=>({name:"Naam (overschrijft die van de entiteit)",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel"})[$.name]??$.name,z.computeHelper=$=>$.name==="icon_tap_action"?"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.":void 0,z.addEventListener("value-changed",$=>{$.stopPropagation();let be=$.detail.value;be.name?t.name=be.name:delete t.name,be.show_state===!1?t.show_state=!1:delete t.show_state;for(let De of["icon_tap_action","icon_hold_action","tap_action","hold_action"])be[De]?t[De]=be[De]:delete t[De];this.emit_()});let ee=()=>{h.textContent=t.entity?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||"",r.dataset.leeg=String(!t.entity),g.hidden=!t.entity};return this.koppen_.push(ee),m.data={entity:t.entity||void 0},k.value=t.icon??"",y.value=t.tone??"",z.data={name:t.name??"",show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action},x.append(m,k,y,z),r.append(o,x),ee(),r}emit_(){let e=In(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};C("domotiapp-entities-card-editor",It);var Hn=44,Ht=6,Vn=i=>typeof i=="string"?{entity:i}:{...i};function ks(i){if(Array.isArray(i.rows)&&i.rows.length)return i.rows.map(t=>({columns:Math.min(Math.max(1,Number(t.columns)||2),3),items:(t.items??t.entities??[]).map(Vn)}));let e=(i.items??i.entities??[]).map(Vn);return e.length?[{columns:Math.min(Math.max(1,Number(i.columns)||2),3),items:e}]:[]}var tt=class extends S{validate(e){let t=ks(e);return t.some(n=>n.items.length)?{show_state:!0,...e,rows:t}:{...e,[I]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?L(e.tone):this.config.tone?L(this.config.tone):P(e.entity)!=="light"?U.accent:Re(_(this.hass,e.entity))??U.lit}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`<div class="card surface">${e.rows.map((n,s)=>`
  ...
  `);j("domotiapp-entities-card",tt,{name:"DomotiApp Entiteiten",description:"Rijen entiteiten, elk met een eigen kolomindeling."});var ke={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},ye=(i,e)=>!!((i?.attributes?.supported_features??0)&e),ys=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},nt=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[I]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(s=>{this.on(s,"click",()=>{let r=s.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(H(e.querySelector(".chip"),{onTap:()=>F(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],s=_(this.hass,n.entity),r=M(this.hass,n.entity),o=!s||s.state==="unavailable",a=s?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=O(this.hass,n.entity,n.name);let d=ye(s,ke.SET_POSITION)&&r.current_position!=null,l=d?r.current_position>0?"open":"closed":a==="open"||a==="closed"?a:this.assumed_.get(t)??"closed";e.dataset.shown=l;let h=ys(r),p=(l==="open"?n.icon_open:n.icon_closed)??(l==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??h[l],g=e.querySelector(".chip");g.dataset.icon!==p&&(g.dataset.icon=p,g.innerHTML=A(p,h[l]));let x=e.querySelector(".st");this.dragging_.has(t)||(x.textContent=o?"Niet bereikbaar":a==="opening"?"Gaat open":a==="closing"?"Gaat dicht":d?`${r.current_position}% open`:a==="open"?"Open":a==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(y=>{if(y.dataset.act==="stop"){y.disabled=o||!ye(s,ke.STOP);return}let z=y.dataset.act==="open";y.disabled=o||(z?!ye(s,ke.OPEN):!ye(s,ke.CLOSE))});let m=e.querySelector(".pos"),k=d&&this.config.show_position!==!1;if(m.hidden=!k,k){if(m.dataset.built||(m.dataset.built="1",m.innerHTML=de("position"),m.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let z=m.querySelector(".slider"),ee=$=>{z.style.setProperty("--v",`${$}%`),z.setAttribute("aria-valuenow",String($)),e.querySelector(".st").textContent=`${$}% open`};this.teardown_.push(Fe(z,{value:()=>M(this.hass,n.entity).current_position??0,onInput:ee,onCommit:$=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:$})}))}let y=m.querySelector(".slider");if(!y.classList.contains("dragging")){let z=r.current_position??0;y.style.setProperty("--v",`${z}%`),y.setAttribute("aria-valuenow",String(z))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>ye(_(this.hass,n.entity),ke.SET_POSITION));return J(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(s=>s.startsWith("cover."));return{covers:n?[n]:[]}}};b(nt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Vt=class extends N{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:v.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};D("domotiapp-cover-card-editor",Vt);j("domotiapp-cover-card",nt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function ws(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var it=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[I]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((s,r)=>`
      <button class="p" type="button" data-i="${r}" style="--tone:var(--dac-ink-3)">
        ...
        <span class="nm"></span>
        <span class="st"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(H(e,{onTap:()=>F(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=_(this.hass,t.entity),s=ws(n);e.style.setProperty("--tone",s.home===!0?"var(--dac-good)":s.home===!1?"var(--dac-bad)":"var(--dac-warn)");let r=O(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),r),this.text(e.querySelector(".st"),s.label);let o=e.querySelector(".ph"),a=n?.attributes?.entity_picture,d=a?`img:${a}`:r?`ini:${r[0]}`:"icon";o.dataset.kind!==d&&(o.dataset.kind=d,o.innerHTML=a?`<img src="${a}" alt="" loading="lazy" />`:r?r[0].toUpperCase():w.person),e.setAttribute("aria-label",`${r}, ${s.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return J(20+t*74+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};b(it,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Pt=class extends N{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,s]of Object.entries(e.tones??{}))t[`kleur:${n}`]=s;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let s of Object.keys(t))s.startsWith("kleur:")&&(t[s]&&(n[s.slice(6)]=t[s]),delete t[s]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Rn(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};D("domotiapp-waste-card-editor",Pt);j("domotiapp-waste-card",st,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var rt=globalThis,ot=rt.ShadowRoot&&(rt.ShadyCSS===void 0||rt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Kt=Symbol(),Pn=new WeakMap,we=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Kt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(ot&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Pn.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Pn.set(t,e))}return e}toString(){return this.cssText}},Z=i=>new we(typeof i=="string"?i:i+"",void 0,Kt),V=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,s,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+i[r+1],i[0]);return new we(t,i,Kt)},Kn=(i,e)=>{if(ot)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),s=rt.litNonce;s!==void 0&&n.setAttribute("nonce",s),n.textContent=t.cssText,i.appendChild(n)}},Ut=ot?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return Z(t)})(i):i;var{is:Ss,defineProperty:As,getOwnPropertyDescriptor:zs,getOwnPropertyNames:Ms,getOwnPropertySymbols:js,getPrototypeOf:Ns}=Object,at=globalThis,Un=at.trustedTypes,Cs=Un?Un.emptyScript:"",Ts=at.reactiveElementPolyfillSupport,$e=(i,e)=>i,Wt={toAttribute(i,e){switch(e){case Boolean:i=i?Cs:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Gn=(i,e)=>!Ss(i,e),Wn={attribute:!0,type:String,converter:Wt,reflect:!1,useDefault:!1,hasChanged:Gn};Symbol.metadata??=Symbol("metadata"),at.litPropertyMetadata??=new WeakMap;var X=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Wn){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),s=this.getPropertyDescriptor(e,n,t);s!==void 0&&As(this.prototype,e,s)}}static getPropertyDescriptor(e,t,n){let{get:s,set:r}=zs(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:s,set(o){let a=s?.call(this);r?.call(this,o),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Wn}static _$Ei(){if(this.hasOwnProperty($e("elementProperties")))return;let e=Ns(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty($e("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty($e("properties"))){let t=this.properties,n=[...Ms(t),...js(t)];for(let s of n)this.createProperty(s,t[s])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,s]of t)this.elementProperties.set(n,s)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let s=this._$Eu(t,n);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let s of n)t.unshift(Ut(s))}else e!==void 0&&t.push(Ut(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Kn(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,n);if(s!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Wt).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,s=n._$Eh.get(e);if(s!==void 0&&this._$Em!==s){let r=n.getPropertyOptions(s),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Wt;this._$Em=s;let a=o.fromAttribute(t,r.type);this[s]=a??this._$Ej?.get(s)??a,this._$Em=null}}requestUpdate(e,t,n,s=!1,r){if(e!==void 0){let o=this.constructor;if(s===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Gn)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:s,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[s,r]of n){let{wrapped:o}=r,a=this[s];o!==!0||this._$AL.has(s)||a===void 0||this.C(s,void 0,r,a)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};X.elementStyles=[],X.shadowRootOptions={mode:"open"},X[$e("elementProperties")]=new Map,X[$e("finalized")]=new Map,Ts?.({ReactiveElement:X}),(at.reactiveElementVersions??=[]).push("2.1.2");var Yt=globalThis,Bn=i=>i,lt=Yt.trustedTypes,qn=lt?lt.createPolicy("lit-html",{createHTML:i=>i}):void 0,Qn="$lit$",Q=`lit$${Math.random().toFixed(9).slice(2)}$`,ei="?"+Q,Os=`<${ei}>`,ie=document,Se=()=>ie.createComment(""),Ae=i=>i===null||typeof i!="object"&&typeof i!="function",Jt=Array.isArray,Ls=i=>Jt(i)||typeof i?.[Symbol.iterator]=="function",Gt=`[ 	
\f\r]`,Ee=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Fn=/-->/g,Zn=/>/g,te=RegExp(`>|${Gt}(?:([^\\s"'>=/]+)(${Gt}*=${Gt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Xn=/'/g,Yn=/"/g,ti=/^(?:script|style|textarea|title)$/i,Qt=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),u=Qt(1),oa=Qt(2),aa=Qt(3),se=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Jn=new WeakMap,ne=ie.createTreeWalker(ie,129);function ni(i,e){if(!Jt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return qn!==void 0?qn.createHTML(e):e}var Ds=(i,e)=>{let t=i.length-1,n=[],s,r=e===2?"<svg>":e===3?"<math>":"",o=Ee;for(let a=0;a<t;a++){let d=i[a],l,h,p=-1,g=0;for(;g<d.length&&(o.lastIndex=g,h=o.exec(d),h!==null);)g=o.lastIndex,o===Ee?h[1]==="!--"?o=Fn:h[1]!==void 0?o=Zn:h[2]!==void 0?(ti.test(h[2])&&(s=RegExp("</"+h[2],"g")),o=te):h[3]!==void 0&&(o=te):o===te?h[0]===">"?(o=s??Ee,p=-1):h[1]===void 0?p=-2:(p=o.lastIndex-h[2].length,l=h[1],o=h[3]===void 0?te:h[3]==='"'?Yn:Xn):o===Yn||o===Xn?o=te:o===Fn||o===Zn?o=Ee:(o=te,s=void 0);let x=o===te&&i[a+1].startsWith("/>")?" ":"";r+=o===Ee?d+Os:p>=0?(n.push(l),d.slice(0,p)+Qn+d.slice(p)+Q+x):d+Q+(p===-2?a:x)}return[ni(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},ze=class i{constructor({strings:e,_$litType$:t},n){let s;this.parts=[];let r=0,o=0,a=e.length-1,d=this.parts,[l,h]=Ds(e,t);if(this.el=i.createElement(l,n),ne.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(s=ne.nextNode())!==null&&d.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(let p of s.getAttributeNames())if(p.endsWith(Qn)){let g=h[o++],x=s.getAttribute(p).split(Q),m=/([.?@])?(.*)/.exec(g);d.push({type:1,index:r,name:m[2],strings:x,ctor:m[1]==="."?qt:m[1]==="?"?Ft:m[1]==="@"?Zt:he}),s.removeAttribute(p)}else p.startsWith(Q)&&(d.push({type:6,index:r}),s.removeAttribute(p));if(ti.test(s.tagName)){let p=s.textContent.split(Q),g=p.length-1;if(g>0){s.textContent=lt?lt.emptyScript:"";for(let x=0;x<g;x++)s.append(p[x],Se()),ne.nextNode(),d.push({type:2,index:++r});s.append(p[g],Se())}}}else if(s.nodeType===8)if(s.data===ei)d.push({type:2,index:r});else{let p=-1;for(;(p=s.data.indexOf(Q,p+1))!==-1;)d.push({type:7,index:r}),p+=Q.length-1}r++}}static createElement(e,t){let n=ie.createElement("template");return n.innerHTML=e,n}};function ce(i,e,t=i,n){if(e===se)return e;let s=n!==void 0?t._$Co?.[n]:t._$Cl,r=Ae(e)?void 0:e._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(i),s._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=s:t._$Cl=s),s!==void 0&&(e=ce(i,s._$AS(i,e.values),s,n)),e}var Bt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,s=(e?.creationScope??ie).importNode(t,!0);ne.currentNode=s;let r=ne.nextNode(),o=0,a=0,d=n[0];for(;d!==void 0;){if(o===d.index){let l;d.type===2?l=new Me(r,r.nextSibling,this,e):d.type===1?l=new d.ctor(r,d.name,d.strings,this,e):d.type===6&&(l=new Xt(r,this,e)),this._$AV.push(l),d=n[++a]}o!==d?.index&&(r=ne.nextNode(),o++)}return ne.currentNode=ie,s}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Me=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,s){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ce(this,e,t),Ae(e)?e===f||e==null||e===""?(this._$AH!==f&&this._$AR(),this._$AH=f):e!==this._$AH&&e!==se&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ls(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==f&&Ae(this._$AH)?this._$AA.nextSibling.data=e:this.T(ie.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=ze.createElement(ni(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(t);else{let r=new Bt(s,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Jn.get(e.strings);return t===void 0&&Jn.set(e.strings,t=new ze(e)),t}k(e){Jt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,s=0;for(let r of e)s===t.length?t.push(n=new i(this.O(Se()),this.O(Se()),this,this.options)):n=t[s],n._$AI(r),s++;s<t.length&&(this._$AR(n&&n._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Bn(e).nextSibling;Bn(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},he=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,s,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=f}_$AI(e,t=this,n,s){let r=this.strings,o=!1;if(r===void 0)e=ce(this,e,t,0),o=!Ae(e)||e!==this._$AH&&e!==se,o&&(this._$AH=e);else{let a=e,d,l;for(e=r[0],d=0;d<r.length-1;d++)l=ce(this,a[n+d],t,d),l===se&&(l=this._$AH[d]),o||=!Ae(l)||l!==this._$AH[d],l===f?e=f:e!==f&&(e+=(l??"")+r[d+1]),this._$AH[d]=l}o&&!s&&this.j(e)}j(e){e===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},qt=class extends he{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===f?void 0:e}},Ft=class extends he{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==f)}},Zt=class extends he{constructor(e,t,n,s,r){super(e,t,n,s,r),this.type=5}_$AI(e,t=this){if((e=ce(this,e,t,0)??f)===se)return;let n=this._$AH,s=e===f&&n!==f||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==f&&(n===f||s);s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Xt=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ce(this,e)}};var Is=Yt.litHtmlPolyfillSupport;Is?.(ze,Me),(Yt.litHtmlVersions??=[]).push("3.3.3");var ii=(i,e,t)=>{let n=t?.renderBefore??e,s=n._$litPart$;if(s===void 0){let r=t?.renderBefore??null;n._$litPart$=s=new Me(e.insertBefore(Se(),r),r,void 0,t??{})}return s._$AI(i),s};var en=globalThis,T=class extends X{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ii(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return se}};T._$litElement$=!0,T.finalized=!0,en.litElementHydrateSupport?.({LitElement:T});var Hs=en.litElementPolyfillSupport;Hs?.({LitElement:T});(en.litElementVersions??=[]).push("4.2.2");var pe=V`
  :host {
    ${Z(Y)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${Z(Ie)}
`;var Vs=["unavailable","unknown"],Rs=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function dt({scene:i,memberEntityIds:e,states:t}){let n=[],s=[],r=i?.lights??{},o=Array.isArray(e)?e:[],a=t??{};for(let d of o){let l=r[d];if(!l||typeof l!="object")continue;let h=a[d];if(!h||Vs.includes(h.state)){s.push(d);continue}if(l.state==="off"){n.push({service:"turn_off",data:{entity_id:d,transition:1}});continue}let p={entity_id:d,transition:1};typeof l.brightness=="number"&&(p.brightness=l.brightness);for(let g of Rs)if(l[g]!==void 0){p[g]=l[g];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:s}}async function ct(i,e){let t=await Promise.allSettled(e.map(s=>i(s.service,s.data))),n=[];return t.forEach((s,r)=>{s.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:s.reason})}),n}var nn=["hs","rgb","rgbw","rgbww","xy"],sn="color_temp",Ps="onoff";var re="kleur";var Ks=["unavailable","unknown"],ri=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Us=[0,100];function G(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Ps,s=t!==null&&t.includes(sn),r=t!==null&&t.some(l=>nn.includes(l)),o=e.min_color_temp_kelvin,a=e.max_color_temp_kelvin,d=typeof o=="number"&&typeof a=="number"&&o<a;return{bekend:!0,beschikbaar:!Ks.includes(i.state),helderheid:!n,kleurtemp:s,kleur:r,minKelvin:d?Math.round(o):2e3,maxKelvin:d?Math.round(a):6535,kelvinUitDefaults:s&&!d}}function Ws(){return{state:"off"}}function oi(i,e){let t=e??G(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...Xs(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function ai(i,e,t,n){return e?i&&i.state==="on"?{...i}:oi(t,n):{state:"off"}}function li(i,e,t,n){let s=n??G(t),r=cn(i,t,s);return s.helderheid&&(r.brightness=E(e,1,255)),r}function rn(i,e,t,n){let s=n??G(t),r=cn(i,t,s);return vi(r),r.color_temp_kelvin=E(e,s.minKelvin,s.maxKelvin),r}function on(i,e,t,n){let s=n??G(t),r=cn(i,t,s);return vi(r),r.hs_color=[E(e?.[0],0,360),E(e?.[1],0,100)],r}function ht(i,e,t){return i??Ws()}function di(i,e,t){let n=ht(i,e,t);if(typeof n.brightness=="number")return E(n.brightness,1,255);let s=e?.attributes?.brightness;return typeof s=="number"?E(s,1,255):255}function an(i,e,t){let n=t??G(e),s=ht(i,e,n);if(typeof s.color_temp_kelvin=="number")return E(s.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?E(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function pt(i,e,t){let n=ht(i,e,t);if(tn(n.hs_color))return[E(n.hs_color[0],0,360),E(n.hs_color[1],0,100)];let s=e?.attributes?.hs_color;return tn(s)?[E(s[0],0,360),E(s[1],0,100)]:[...Us]}function ln(i){return i!=null&&typeof i=="object"}function ci(i,e,t){let n=Array.isArray(e)?e:[],s=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:s.length;return n.filter(o=>{for(let a=0;a<r;a+=1)if(!ln(s[a]?.lights?.[o]))return!0;return!1})}function hi(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function dn(i,e,t){return ht(i,e,t).state==="on"}function pi(i,e,t){let n=t??G(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let s=dn(i,e,n),r=ui(n),o=r?Gs(i,e,n):null;return{aanuit:!0,helderheid:s&&n.helderheid,kleurtemp:s&&n.kleurtemp&&(!r||o==="wit"),kleur:s&&n.kleur&&(!r||o===re),kleurkeuze:s&&r,stand:s?o:null}}function ui(i){return!!(i?.kleurtemp&&i?.kleur)}function Gs(i,e,t){let n=t??G(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(ri.slice(1).some(r=>i[r]!==void 0))return re}let s=e?.attributes?.color_mode;return s===sn&&n.kleurtemp?"wit":nn.includes(s)&&n.kleur?re:"wit"}function mi(i,e,t,n){let s=n??G(t);return ui(s)?e==="wit"?rn(i,an(i,t,s),t,s):on(i,pt(i,t,s),t,s):i}function gi(i){let e=E(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function fi(i){let e=E(i,1,100);return E(Math.round(e/100*255),1,255)}var Bs=1e3,qs=4e4,si=7;function Fs(i){let e=E(i,Bs,qs)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,s;return e>=66?s=255:e<=19?s=0:s=138.5177312231*Math.log(e-10)-305.0447927307,[E(t,0,255),E(n,0,255),E(s,0,255)]}function Zs(i){let[e,t,n]=Fs(i);return`rgb(${e}, ${t}, ${n})`}function bi(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:si},(r,o)=>{let a=o/(si-1),d=t+(n-t)*a;return`${Zs(d)} ${Math.round(a*100)}%`}).join(", ")})`}function Xs(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?E(t.brightness,1,255):255);let s=t.color_mode;return e.kleurtemp&&s===sn&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=E(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&nn.includes(s)&&tn(t.hs_color)&&(n.hs_color=[E(t.hs_color[0],0,360),E(t.hs_color[1],0,100)]),n}function cn(i,e,t){return i&&i.state==="on"?{...i}:oi(e,t)}function vi(i){for(let e of ri)delete i[e]}function tn(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function E(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var ut="domotiapp-scene-card",hn="domotiapp-scene-card-editor",_i="domotiapp-scene-editor";var je=["een","twee","drie"],xi="pencil",ki=["grid_options","layout_options","view_layout","visibility"];var yi="entity_id",ue=class extends T{constructor(){super();b(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));b(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[yi]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[yi];return Array.isArray(n)?n.filter(s=>s!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},s={};for(let r of t)r in this._getypt?s[r]=this._getypt[r]:n[r]&&(s[r]=n[r]);return s}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let s={...this._config};Object.keys(n).length?s.name_overrides=n:delete s.name_overrides,this._stuurDoor(s)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return f;let t=this._leden();return u`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?u`
          ...
          `:f}
    `}};b(ue,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),b(ue,"styles",[pe,V`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),s=this._waardeVan(e),r=dn(s,t,n),o=pi(s,t,n);return u`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
          ...
          ${n.bekend?u`
                <div class="bediening">
                  ${o.kleurkeuze?this._renderKleurkeuze(e,t,n,s,o.stand):f}
                  <ha-switch
                    .checked=${r}
                    @change=${a=>this._zetLamp(e,ai(s,a.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:f}
        </div>
        ${this._renderBesturing(e,t,n,s,o)}
      </div>
    `}_renderBesturing(e,t,n,s,r){return u`
      ${r.helderheid?this._renderHelderheid(e,t,n,s):f}
      ${r.kleurtemp?this._renderKleurtemp(e,t,n,s):f}
      ${r.kleur?this._renderKleur(e,t,n,s):f}
    `}_renderHelderheid(e,t,n,s){let r=gi(di(s,t,n)),o=a=>{a.stopPropagation(),this._zetLamp(e,li(this._waardeVan(e),fi(a.detail.value),t,n))};return u`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,s,r){let o=a=>d=>{d.stopPropagation(),a!==r&&this._zetLamp(e,mi(this._waardeVan(e),a,t,n))};return u`
    ...
    `}_renderKleurtemp(e,t,n,s){let r=an(s,t,n),o=a=>{a.stopPropagation(),this._zetLamp(e,rn(this._waardeVan(e),a.detail.value,t,n))};return u`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleur(e,t,n,s){let[r,o]=pt(s,t,n),a=d=>l=>{l.stopPropagation();let h=pt(this._waardeVan(e),t,n),p=d==="tint"?[l.detail.value,h[1]]:[h[0],l.detail.value];this._zetLamp(e,on(this._waardeVan(e),p,t,n))};return u`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${tr}; --control-slider-background-opacity: 1`}
              @slider-moved=${a("tint")}
              @value-changed=${a("tint")}
            ></ha-control-slider>
            <ha-control-slider
              touch-action="pan-y"
              .min=${0}
              ...
              @slider-moved=${a("verzadiging")}
              @value-changed=${a("verzadiging")}
            ></ha-control-slider>
          </div>
          <div
            class="staal"
    ...
    `}};b(me,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),b(me,"styles",[pe,V`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Ne)return f;let e=ci(this._scenes,this._leden,3).length,t=hi(e);return t?u`<div class="mededeling">${t}</div>`:f}_renderEditor(){return u`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(e,t)=>this._scenes?.[t]?.icon||je[t])}};b(Ce,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),b(Ce,"styles",[pe,V`
      :host { display: block; }
    ...
    `]);C(ut,Ce);C(hn,ue);C(_i,me);le({type:ut,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${nr}).`,preview:!1});var oe="domotiapp-alarm-card",vn="domotiapp-alarm-card-editor",Ai="domotiapp-alarm-editor",zi="DomotiApp Alarm",Mi="https://github.com/Sven2410/domotiapp-lovelace",B="domotiapp_lovelace",R=Object.freeze({get:`${B}/alarms/get`,save:`${B}/alarms/save`,setEnabled:`${B}/alarms/set_enabled`,delete:`${B}/alarms/delete`,stop:`${B}/alarms/stop`,clearMessage:`${B}/alarms/clear_message`,search:`${B}/sound/search`,entities:`${B}/entities/list`,previewStart:`${B}/preview/start`,subscribe:`${B}/updates/subscribe`}),ft="#026FA1";function ji(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var sr="07:00";var rr=["uri","name","media_type","image"],or="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",ar="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var lr="Music Assistant Wekker",dr="Verlichting Wekker";function bt(){return{id:null,name:"",time:sr,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Ni(i){let e=bt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:_n(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:Te(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function Te(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of rr)e[t]=i[t]===void 0?null:i[t];return e}function _n(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function xn(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),_n(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Ci(i){let e={name:(i.name||"").trim(),time:i.time,days:[...new Set(i.days||[])].sort((t,n)=>t-n),enabled:i.enabled!==!1,sound:Te(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(e.id=i.id),e}function Ti(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,s)=>n-s)}function Oi(i){return _n(i)&&i.slice(0,2)==="02"?or:null}function Li(i){return i===!1?ar:null}function Di(i){return typeof i?.endless=="boolean"?i.endless:null}function vt(i,e){let t=e==="lamp",n=t?dr:lr,s=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${s} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${s} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${s} met het label '${n}'.`}function Ii(i,e){return vt(e,"speaker")!==null?!1:xn(i).ok}var hr=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],pr=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Oe="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",ur="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",mr="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",ge=class extends T{constructor(){super(),this._concept=bt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Ni(this.wekker):bt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:R.previewStart,speaker:this._concept.speaker,sound:Te(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:R.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Te(e),endless:Di(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=xn(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:R.save,person:this.person,alarm:Ci(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return u`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div class="blok">
        ...
        ${o?u`<div class="waarschuwing">
              ${this._svg(Oe)}<span>${o}</span>
            </div>`:f}
      </div>
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${pr.map(([l,h])=>u`<option value=${l}>${h}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${a?u`<div class="waarschuwing">${this._svg(Oe)}<span>${a}</span></div>`:f}
      </div>
      ...
      <div class="blok">
        ...
        ${r?u`<div class="uitleg">${this._svg(Oe)}<span>${r}</span></div>`:u`
              <div class="vak">
                <select
                  id="lamp"
    ...
    `}};b(ge,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),b(ge,"styles",V`
    :host {
      --domotiapp-accent: ${Z(ft)};
      display: block;
  ...
  `);var Hi="person",gr="Kies een persoon in de kaartinstellingen.",Vi="De gekozen persoon is niet gevonden.",fr="De opgeslagen wekkers van deze persoon zijn onleesbaar.",sl=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Ri(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Hi}.`))throw new Error(`'${e}' zit niet in het domein ${Hi}. Kies een persoon, zoals person.sven.`);return{...i}}function Pi(i){return{type:`custom:${i}`}}function Ki(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Vi,isFout:!0}:{soort:"ontbreekt",tekst:gr,isFout:!1}}function Ui(i,e){return i==="not_found"?Vi:i==="home_assistant_error"?fr:e||"Er ging iets mis bij het ophalen van de wekkers."}var br=["ma","di","wo","do","vr","za","zo"],vr="Geen wekkers ingesteld",_r="Eenmalig",xr="Eenmalig \u2014 afgelopen",kr="Geen wekker actief",Wi="Stoppen",yr="Er is een melding over deze wekker, maar de tekst ontbreekt.";function wr(i){return!Array.isArray(i)||i.length===0?_r:[...new Set(i)].sort((t,n)=>t-n).map(t=>br[t-1]??"?").join(" ")}function $r(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function Gi(i,e){return $r(i,e)?xr:wr(i?.days)}function Bi(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:yr,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function qi(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return vr;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:kr}function Fi(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(a=>a?.id===o)).filter(Boolean),s=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:s.length?s.join(" en "):"Wekker",tijd:r.join(" en ")}}var Er="0.1.0",Sr="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Ar="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",Zi="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",zr="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",_t=(i,e="icoon")=>u`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    ...
    </ha-card>`}_mededeling(e,t){return u`<ha-card>
      <div class="mededeling ${t?"fout":""}">${e}</div>
    </ha-card>`}_stopknop(e){return u`<button
      class="stopknop"
    ...
    `}_bevestiging(e){return u`<div class="onderrij bevestiging">
      ...
      ${n?u`<div class="onderrij ${n.isFout?"fout":""}">
            ${_t(n.isFout?zr:Zi,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:f}
    `}};b(Le,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),b(Le,"styles",V`
  ...
  `);var fe=class fe extends T{constructor(){super(...arguments);b(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?f:u`
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};b(fe,"properties",{hass:{attribute:!1},_config:{state:!0}}),b(fe,"styles",V`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--secondary-text-color);
      font-size: var(--ha-font-size-s, 12px);
    }
  `),b(fe,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var kn=fe;C(oe,Le);C(vn,kn);C(Ai,ge);le({type:oe,name:zi,description:`Wekkerkaart van DomotiApp (v${Er}).`,preview:!1,documentationURL:Mi});var Mr="0.1.0";Mn(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${Mr} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Mr as VERSION};
