...
`;function J(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var F=i=>String(i??"").split(".")[0],f=(i,e)=>e&&i?.states?.[e]||null,R=(i,e)=>f(i,e)?.attributes??{},xe=(i,e,t)=>t?null:R(i,e).entity_picture||null;function Qe(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function S(i,e,t){return t||R(i,e).friendly_name||e||""}var Ba=new Set(["scene","script","input_button","button","event"]),Me=i=>Ba.has(F(i));function H(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Me(i.entity_id):!1}function oe(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(F(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var Ga=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),et=i=>Ga.has(F(i));function ii(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function Je(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var P=(i,e)=>Je(i,"hass-more-info",{entityId:e});function ke(i){switch(F(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function qa(i){switch(F(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function ne(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":P(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[s,o]=qa(a);e.callService(s,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[s,o]=a.split(".");e.callService(s,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),Je(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":Je(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":Je(i,"ll-custom",n);break;default:break}}function j(i,{onTap:e,onHold:t,onDouble:n}){let o=0,r=0,l=null,d=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(r++,r===1){l=setTimeout(()=>{r=0,e?.()},260);return}clearTimeout(l),r=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function I(i,e){if(!e)return"";let t=F(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function K(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var ti=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],ai=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],ni=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),Ht=(i,e)=>Math.round((ni(e)-ni(i))/864e5);function je(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Pt(i,e=new Date){if(!i)return"";let t=Ht(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?ti[i.getDay()]:`${ti[i.getDay()].slice(0,2)} ${i.getDate()} ${ai[i.getMonth()]}`}var si=i=>i?`${i.getDate()} ${ai[i.getMonth()]}`:"";var Fa="home-assistant";function oi({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:s=Fa,intervalMs:o=20,maxWachtMs:r=1e4}){let l=a();function d(){let m=i();if(!m)return!1;for(let[y,u]of e)try{m.get(y)||m.define(y,u)}catch(w){t(`kon ${y} niet registreren: ${w&&w.message}`)}return!0}function c(){let m=i();return!m||!m.get(s)?!1:d()}if(c())return!0;let p=()=>{if(!c()){if(a()-l>=r){t(`${s} is na ${r} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(p,o)}};return n(p,o),!1}var ri=[];function D(i,e){ri.push([i,e])}function ye({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(s=>s.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function li(i=()=>{}){oi({leesRegistry:()=>globalThis.customElements,definities:ri,waarschuw:i})}var Za=`
  :host {
    ${q}
    display: block;
...
`,k={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},tt={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},V=(i,e="accent")=>k[i]??(i&&/[#(]|^var/.test(i)?i:k[e]),O=Symbol("incomplete"),Xa=i=>`
  ...
  </div>`,Ya=56,di=8,Z=i=>Math.max(1,Math.ceil((i+di)/(Ya+di))),E=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[J(Za+se+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[O]||ii(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[O]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[O];e.innerHTML=t?Xa(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,!t&&(this.wire(),this.wired_=!0,this.hass_&&this.paint())}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}};x(E,"css","");function A(i,e,{name:t,description:n,preview:a=!0}={}){D(i,e),ye({type:i,name:t,description:n,preview:a})}function C(i,e){D(i,e)}var h=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,T={house:h(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,Kt=null,Ut=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Kt=Kt??[J(is)],this.shadowRoot.adoptedStyleSheets=Kt,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in k)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${k[e]}"
  ...
  `);var qt=class extends z{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}pickers(){return[{key:"tone",kind:"tone",label:"Kleur weericoon"}]}schema(){return[Wt({name:"weather",selector:g.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Wt({name:"sun",selector:g.entity("sun")},{name:"precipitation_entity",selector:g.entity("sensor")}),{name:"name",selector:g.text()},{name:"hide_below",selector:g.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",bare:"Zonder kaartrand",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};C("domotiapp-header-card-editor",qt);A("domotiapp-header-card",nt,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var it=class extends E{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
...
`;var ds=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),cs=new Set(["hs","rgb","rgbw","rgbww","xy"]),Jt=i=>i?.attributes?.supported_color_modes??[],ps=i=>Jt(i).some(e=>ds.has(e)),lt=i=>Jt(i).some(e=>cs.has(e)),dt=i=>Jt(i).includes("color_temp"),ci=i=>Math.max(1,Math.round((i??0)/255*100)),ct=class extends E{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[O]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
  ...
  `);var en=class extends z{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:g.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:g.text()},{name:"step",selector:g.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};C("domotiapp-climate-card-editor",en);A("domotiapp-climate-card",pt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var ui=i=>Math.min(Math.max(1,Number(i)||2),3),mi=i=>typeof i=="string"?{entity:i}:{...i};function ht(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();e.entity&&i.bewaard.push(e)}return i}function us(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:ui(n.columns),items:(n.items??n.entities??[]).map(mi)})):(()=>{let n=(i.items??i.entities??[]).map(mi);return n.length?[{columns:ui(i.columns),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let s=0;s<n.items.length;s+=n.columns)a.push(n.items.slice(s,s+n.columns));a.length||a.push([]);for(let s of a)t.push(ht({columns:n.columns,items:s}))}return t}var gi=i=>i.map(e=>({columns:e.columns,items:e.items.filter(t=>t.entity).map(t=>structuredClone(t))})).filter(e=>e.items.length),ms=`
...
`,tn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,this.gebouwd_&&e===this.uitObject_)return;let t=us(e);this.gebouwd_&&JSON.stringify(gi(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let s=Number(a[1]);s!==e&&t.add(s>e?`r${s-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let s=/^r(\d+)i(\d+)$/.exec(a);if(!s||Number(s[1])!==e){n.add(a);continue}let o=Number(s[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{n.entity||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=ms;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,s)=>t.appendChild(this.rijBlok_(a,s))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is \xE9\xE9n regel op de kaart, met \xE9\xE9n, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=ht({columns:2,items:[]});this.rows_.push(a);let s=this.rows_.length-1;this.open_.add(`r${s}`),this.legePlekkenOpen_(a,s),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=()=>"Waar de status staat",e.computeHelper=()=>"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar tonen geen tekst.",e.data={state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation(),t.detail.value?.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let o=document.createElement("span");o.className="titel";let r=document.createElement("b");r.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(r,l);let d=document.createElement("span");d.className="kolommen";let c=[1,2,3].map(u=>{let w=document.createElement("button");return w.type="button",w.textContent=String(u),w.title=`${u} entiteit${u>1?"en":""} in deze rij`,d.appendChild(this.binnenKop_(w,()=>{e.columns!==u&&(e.columns=u,ht(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_())})),w}),p=()=>{let u=e.items.filter($=>$.entity),w=`${e.columns} kolom${e.columns>1?"men":""}`;l.textContent=u.length?`${w} \xB7 ${u.map($=>this.itemNaam_($)).join(", ")}`:`${w} \xB7 nog leeg`,c.forEach($=>$.setAttribute("aria-pressed",String(e.columns===Number($.textContent))))};this.koppen_.push(p);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Rij verwijderen",m.textContent="\u2715",this.binnenKop_(m,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(s,o,d,m);let y=document.createElement("div");return y.className="rijbody",e.items.forEach((u,w)=>y.appendChild(this.itemBlok_(e,u,t,w))),n.append(a,y),p(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity}itemBlok_(e,t,n,a){let s=document.createElement("details");s.className="item",this.onthoud_(s,`r${n}i${a}`);let o=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),p=document.createElement("small");d.append(c,p);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),ht(e),this.emit_(),this.build_()}),o.append(r,l,d,m);let y=document.createElement("div");y.className="itembody";let u=document.createElement("ha-form");u.hass=this.hass_,u.schema=[{name:"entity",selector:{entity:{}}}],u.computeLabel=()=>"Entiteit",u.addEventListener("value-changed",M=>{M.stopPropagation(),t.entity=M.detail.value.entity??"",this.emit_()});let w=document.createElement("dac-icon-picker");w.label="Icoon",w.hass=this.hass_,w.addEventListener("value-changed",M=>{M.stopPropagation(),M.detail.value?t.icon=M.detail.value:delete t.icon,this.emit_()});let $=document.createElement("dac-tone-picker");$.label="Kleur",$.hass=this.hass_,$.addEventListener("value-changed",M=>{M.stopPropagation(),M.detail.value?t.tone=M.detail.value:delete t.tone,this.emit_()});let N=document.createElement("ha-form");N.hass=this.hass_,N.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}}],N.computeLabel=M=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel"})[M.name]??M.name,N.computeHelper=M=>{if(M.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(M.name==="toggle")return"Een schuifschakelaar rechts op de regel, in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar."},N.addEventListener("value-changed",M=>{M.stopPropagation();let _e=M.detail.value;_e.name?t.name=_e.name:delete t.name,_e.toggle===!0?t.toggle=!0:delete t.toggle,_e.show_state===!1?t.show_state=!1:delete t.show_state;for(let Ye of["icon_tap_action","icon_hold_action","tap_action","hold_action"])_e[Ye]?t[Ye]=_e[Ye]:delete t[Ye];this.emit_()});let pe=()=>{c.textContent=t.entity?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||"",s.dataset.leeg=String(!t.entity),m.hidden=!t.entity};return this.koppen_.push(pe),u.data={entity:t.entity||void 0},w.value=t.icon??"",$.value=t.tone??"",N.data={name:t.name??"",toggle:t.toggle??!1,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action},y.append(u,w,$,N),s.append(o,y),pe(),s}emit_(){let e=gi(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};D("domotiapp-entities-card-editor",tn);var fi=44,nn=6,bi=i=>typeof i=="string"?{entity:i}:{...i};function gs(i){if(Array.isArray(i.rows)&&i.rows.length)return i.rows.map(t=>({columns:Math.min(Math.max(1,Number(t.columns)||2),3),items:(t.items??t.entities??[]).map(bi)}));let e=(i.items??i.entities??[]).map(bi);return e.length?[{columns:Math.min(Math.max(1,Number(i.columns)||2),3),items:e}]:[]}var ut=class extends E{validate(e){let t=gs(e);return t.some(n=>n.items.length)?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[O]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?V(e.tone):this.config.tone?V(this.config.tone):F(e.entity)!=="light"?k.accent:Qe(f(this.hass,e.entity))??k.lit}metSchakelaar_(e){return!!e.toggle&&et(e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=e.state_position==="right";return`<div class="card surface">${e.rows.map((a,s)=>`
      <div class="row" style="--cols:${a.columns}">
        ${a.items.map((o,r)=>`
          <div class="it" role="button" tabindex="0" data-r="${s}" data-i="${r}">
            ...
            ${this.metSchakelaar_(o)?at({label:"Aan of uit"}):""}
          </div>`).join("")}
      </div>`).join("")}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(o,r)=>ne(this,this.hass,t,t[o]??r);this.teardown_.push(j(e,{onTap:()=>n("tap_action",{action:"more-info"}),onHold:()=>n("hold_action",{action:"more-info"})}));let a=e.querySelector(".chip");this.teardown_.push(j(a,{onTap:()=>n("icon_tap_action",ke(t.entity)),onHold:()=>n("icon_hold_action",{action:"more-info"})})),this.on(a,"click",o=>o.stopPropagation()),this.on(a,"pointerdown",o=>o.stopPropagation());let s=e.querySelector(".toggle");s&&this.teardown_.push(st(s,{value:()=>oe(f(this.hass,t.entity)),set:o=>this.hass.callService("homeassistant",o?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>H(f(this.hass,t.entity))}))})}paint(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=f(this.hass,t.entity),a=oe(n),s=H(n);e.dataset.on=String(a),e.classList.toggle("unavailable",s);let o=this.tone_(t);e.style.setProperty("--tone",o);let r=e.querySelector(".chip"),l=xe(this.hass,t.entity,t.icon),d=t.icon||(l?`pic:${l}`:Te(t.entity,R(this.hass,t.entity)));r.dataset.icon!==d&&(r.dataset.icon=d,r.classList.toggle("pic",!!l),r.innerHTML=l?`<img src="${l}" alt="" loading="lazy" />`:_(t.icon||Te(t.entity,R(this.hass,t.entity)))),r.style.setProperty("--tone",l?"var(--dac-ink-3)":a?o:"var(--dac-ink-3)");let c=S(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),c),r.setAttribute("aria-label",`${c} schakelen`);let p=e.querySelector(".toggle");p&&(Ce(p,a),p.style.setProperty("--tone",o),p.setAttribute("aria-label",`${c} aan of uit`));let m=e.querySelector(".st"),y=t.show_state??this.config.show_state;if(p)m.textContent="";else if(y===!1)m.textContent="";else if(s)m.textContent="Niet bereikbaar";else if(!n||Me(n.entity_id))m.textContent="";else if(F(n.entity_id)==="light"&&a&&n.attributes.brightness!=null)m.textContent=`${Math.round(n.attributes.brightness/255*100)}%`;else{let u=n.attributes.unit_of_measurement;m.textContent=u?`${n.state} ${u}`:I(this.hass,n)}e.setAttribute("aria-label",`${c}${n?`, ${I(this.hass,n)}`:""}`)})}lines_(){return(this.config?.rows??[]).reduce((e,t)=>e+Math.ceil((t.items.length||1)/t.columns),0)}getCardSize(){return Math.max(1,this.lines_())}getGridOptions(){let e=Math.max(1,this.lines_()),t=Z(12+e*fi+(e-1)*nn);return{columns:12,rows:t,min_columns:4,min_rows:t,max_rows:t}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};x(ut,"css",`
    :host { display: block; height: 100%; }
    ...
    .it {
      display: flex; align-items: center; gap: 10px;
      min-height: ${fi}px; padding: 2px 6px 2px 2px;
  ...
  `);A("domotiapp-entities-card",ut,{name:"DomotiApp Entiteiten",description:"Rijen entiteiten, elk met een eigen kolomindeling."});var W={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},B=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),an=i=>!i||i.state==="off",vi=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),sn=i=>i?.state==="playing",_i=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function xi(i){if(!i)return[];let e=[];return(B(i,W.TURN_ON)||B(i,W.TURN_OFF))&&e.push("power"),an(i)||(B(i,W.PREVIOUS_TRACK)&&e.push("prev"),B(i,W.PLAY)||B(i,W.PAUSE)||B(i,W.PLAY_MEDIA)?e.push("play"):B(i,W.STOP)&&e.push("stop"),B(i,W.NEXT_TRACK)&&e.push("next")),e}var he=i=>i?.volume_entity||i?.entity;function on(i){if(!vi(i))return[];let e=[];return B(i,W.VOLUME_MUTE)&&e.push("mute"),B(i,W.VOLUME_SET)?e.push("slider"):B(i,W.VOLUME_STEP)&&e.push("steps"),e}var de=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Oe=i=>!!i?.attributes?.is_volume_muted,fs=i=>!!i?.attributes?.mass_player_type,rn=i=>!!i?.attributes?.shuffle,ln=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},ki=i=>({off:"all",all:"one",one:"off"})[bs(i)]??"all",bs=i=>["off","all","one"].includes(i)?i:"off";function dn(i,{zoeken:e=!0}={}){if(!vi(i))return[];let t=[];return B(i,W.SHUFFLE_SET)&&t.push("shuffle"),B(i,W.REPEAT_SET)&&t.push("repeat"),e&&fs(i)&&t.push("search"),t}function yi(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function wi(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var vs=350,_s=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]],xs={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function ks(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=xs[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var ys=`
  :host {
    ${q}
...
`,cn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=J(se+ys)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n){this.hass=e,this.entity_=t,this.naam_=n,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=a=>{a.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.haalSpeakers_(),setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0)}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        ...
        <nav class="soorten">
          ${_s.map(([t,n])=>`<button type="button" data-soort="${t}" aria-pressed="${t===""}">${n}</button>`).join("")}
        </nav>
        <div class="lijst"></div>
        <footer hidden>
      ...
      </div>`}wire(){let e=this.config,t=(s,o)=>ne(this,this.hass,e,e[s]??o);this.teardown_.push(j(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(j(n,{onTap:()=>t("icon_tap_action",ke(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation());let a=s=>{let o=s.target.closest?.("[data-k]");o&&(s.stopPropagation(),this.doe_(o.dataset.k))};this.on(this.$(".ctl"),"click",a),this.on(this.$(".vol"),"click",a),this.on(this.$(".extra"),"click",a),this.on(this.$(".ctl"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".vol"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".extra"),"pointerdown",s=>s.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=f(this.hass,t),a=(s,o={})=>this.hass.callService("media_player",s,{entity_id:t,...o});switch(e){case"power":return a(an(n)?"turn_on":"turn_off");case"prev":return a("media_previous_track");case"next":return a("media_next_track");case"play":return a(sn(n)?"media_pause":"media_play");case"stop":return a("media_stop");case"mute":{let s=he(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!Oe(f(this.hass,s))},{entity_id:s})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:he(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!rn(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:ki(ln(n))},{entity_id:t});case"search":return $i(this.hass,t,S(this.hass,t,this.config.name));default:return}}paint(){let e=this.config,t=f(this.hass,e.entity),n=!t||t.state==="unavailable",a=_i(t),s=this.$(".top");s.dataset.on=String(a),s.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),r=e.show_artwork===!1?null:xe(this.hass,e.entity,e.icon),l=r?`pic:${r}`:e.icon||wi(t);o.dataset.icon!==l&&(o.dataset.icon=l,o.classList.toggle("pic",!!r),o.innerHTML=r?`<img src="${r}" alt="" loading="lazy" />`:_(l,"speaker")),o.style.setProperty("--tone",a&&!r?this.tone_():"var(--dac-ink-3)");let d=S(this.hass,e.entity,e.name),c=yi(t,p=>I(this.hass,p));this.text(".nm",d),this.text(".st",c),o.setAttribute("aria-label",`${d} afspelen of pauzeren`),s.setAttribute("aria-label",`${d}, ${c}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n)}paintKnoppen_(e,t){let n=this.$(".ctl"),a=this.config.show_controls===!1||t?[]:xi(e),s=a.join(",");n.dataset.sig!==s&&(n.dataset.sig=s,n.innerHTML=a.map(r=>`<button class="k ${r==="play"||r==="stop"?"hoofd":""}" type="button" data-k="${r}" aria-label="${mt[r].label}">${_(mt[r].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let r=sn(e)?"pause":"play";o.dataset.icon!==r&&(o.dataset.icon=r,o.innerHTML=_(r))}}paintVolume_(e,t){let n=this.$(".vol"),a=he(this.config),s=a===this.config.entity?e:f(this.hass,a),o=this.config.show_volume===!1||t?[]:on(s);if(n.hidden=!o.length,!o.length){n.dataset.sig="",this.sliders_?.delete("volume");return}let r=o.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${_("volume")}</button>`:"")+(o.includes("slider")?Q("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${_("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${_("plus")}</button>`:"")+'<span class="pct tnum"></span>',this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let l=Oe(s),d=de(s),c=n.querySelector('[data-k="mute"]');if(c){let m=l?"volumeMute":"volume";c.dataset.icon!==m&&(c.dataset.icon=m,c.innerHTML=_(m)),c.setAttribute("aria-pressed",String(l))}let p=n.querySelector(".slider");p&&(this.attach_(p,"volume",{value:()=>de(f(this.hass,he(this.config))),onInput:m=>this.setSlider_(p,m),onCommit:m=>this.hass.callService("media_player","volume_set",{volume_level:m/100},{entity_id:he(this.config)}),disabled:()=>H(f(this.hass,he(this.config)))}),p.classList.contains("dragging")||this.setSlider_(p,d)),this.text(".pct",l?"Gedempt":`${d}%`)}paintExtra_(e,t){let n=this.$(".extra"),a=t||this.config.show_controls===!1?[]:dn(e,{zoeken:this.config.show_search!==!1});n.hidden=!a.length;let s=a.join(",");if(n.dataset.sig!==s&&(n.dataset.sig=s,n.innerHTML=a.map((d,c)=>`${d==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${d}" aria-label="${mt[d].label}">${_(mt[d].icon)}</button>`).join("")),!a.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(rn(e)));let r=n.querySelector('[data-k="repeat"]');if(r){let d=ln(e),c=d==="one"?"repeatOne":"repeat";r.dataset.icon!==c&&(r.dataset.icon=c,r.innerHTML=_(c)),r.setAttribute("aria-pressed",String(d!=="off")),r.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[d])}let l=document.querySelector("domotiapp-media-browser");l?.hasAttribute("open")&&(l.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let a=re(e,n);this.sliders_.set(t,a),this.teardown_.push(a)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){let e=f(this.hass,this.config?.entity);return 1+(on(e).length?1:0)+(dn(e).length?1:0)}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:1}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("media_player."));return n?{entity:n}:{}}};x(gt,"css",`
    :host { display: block; }
  ...
  `);var pn=class extends z{defaults(){return{show_artwork:!0,show_volume:!0,show_controls:!0,show_search:!0,icon_tap_action:{action:"toggle"},tap_action:{action:"more-info"}}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"speaker"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"entity",selector:g.entity("media_player")},{name:"name",selector:g.text()},{name:"volume_entity",selector:g.entity("media_player")},{name:"show_artwork",selector:g.bool()},{name:"show_controls",selector:g.bool()},{name:"show_volume",selector:g.bool()},{name:"show_search",selector:g.bool()},{name:"icon_tap_action",selector:g.action("toggle")},{name:"icon_hold_action",selector:g.action("more-info")},{name:"tap_action",selector:g.action("more-info")},{name:"hold_action",selector:g.action("more-info")}]}label(e){return{entity:"Mediaspeler",name:"Naam (overschrijft die van de speler)",volume_entity:"Geluid van (optioneel)",show_artwork:"Albumhoes tonen",show_controls:"Knoppen tonen",show_volume:"Volume tonen",show_search:"Zoeken en groeperen tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Welke knoppen er verschijnen leest de kaart uit de speler zelf: wat hij niet kan, komt er niet op.";if(e.name==="volume_entity")return"Zit het geluid ergens anders dan het beeld \u2014 een tv met een soundbar eronder \u2014 kies dan hier de speler die het volume regelt. Leeg laten betekent: de speler zelf.";if(e.name==="show_artwork")return"Speelt er iets met een hoes, dan vult die de chip. Een eigen icoon gaat voor.";if(e.name==="show_volume")return"De volumeregel verschijnt zodra er iets speelt en verdwijnt als de speler uit gaat.";if(e.name==="show_search")return"De zoekknop opent Music Assistant over het hele scherm. Alleen bij een speler van Music Assistant; groeperen komt erbij als de speler dat aankan."}};C("domotiapp-media-card-editor",pn);A("domotiapp-media-card",gt,{name:"DomotiApp Mediaspeler",description:"Wat er speelt, de knoppen die de speler aankan, en het volume."});var Le=[{sleutel:"smoke",label:"Rook",icoon:"smoke",alarm:"Rook gedetecteerd"},{sleutel:"co",label:"Koolmonoxide",icoon:"warning",alarm:"Koolmonoxide gedetecteerd"},{sleutel:"heat",label:"Warmte",icoon:"thermo",alarm:"Te warm"},{sleutel:"temperature",label:"Temperatuur",icoon:"thermo",meting:!0},{sleutel:"battery",label:"Batterij",icoon:"battery",meting:!0}],hn=20;function un(i){if(!i||i.state==="unavailable"||i.state==="unknown")return null;if(String(i.entity_id??"").startsWith("binary_sensor."))return i.state==="on"?0:null;let e=Number(i.state);return Number.isFinite(e)?e:null}var ws=i=>!!i&&i.state==="on",$s=i=>!i||i.state==="unavailable"||i.state==="unknown";function Ei(i,e){let t=i.filter(a=>!a.meting);for(let a of t)if(ws(e(a.sleutel)))return{soort:"alarm",tekst:a.alarm,tone:"bad",icoon:a.icoon};if(i.length&&i.every(a=>$s(e(a.sleutel))))return{soort:"weg",tekst:"Niet bereikbaar",tone:"neutral",icoon:"smoke"};let n=un(e("battery"));return n!=null&&n<=hn?{soort:"batterij",tekst:`Batterij bijna leeg (${Math.round(n)}%)`,tone:"warn",icoon:"battery"}:t.length?{soort:"goed",tekst:"Alles rustig",tone:"good",icoon:"smoke"}:{soort:"meting",tekst:"",tone:"accent",icoon:"smoke"}}var Es={good:k.good,warn:k.warn,bad:k.bad,neutral:k.neutral,accent:k.accent},ft=class extends E{validate(e){return Le.filter(n=>e[n.sleutel]).length?{...e}:{...e,[O]:"Kies minstens \xE9\xE9n entiteit: rook, koolmonoxide, warmte, temperatuur of batterij."}}watched(){return Le.map(e=>this.config[e.sleutel]).filter(Boolean)}gekozen_(){return Le.filter(e=>this.config[e.sleutel])}toestand_(){let e=Ei(this.gekozen_(),t=>f(this.hass,this.config[t]));return{...e,tone:Es[e.tone]??k.accent}}batterijPct_(){return un(f(this.hass,this.config.battery))}template(){this.config.bare&&this.setAttribute("bare","");let e=this.gekozen_().map(t=>`<span class="pil" data-soort="${t.sleutel}">${_(t.icoon)}
...
`,gn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=J(se+As)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.code_=""}open(e){this.opties_=e,this.gebouwd_||this.bouw_(),this.code_="",this.bezig_=!1,this.setAttribute("open",""),this.$(".wie b").textContent=e.titel,this.$(".wie span").textContent=e.actie;let t=e.soort==="text";this.$(".pad").hidden=t,this.$(".bolletjes").hidden=t,this.$(".tekstveld").hidden=!t,this.$(".bevestig").hidden=!t,this.$(".tekstveld").value="",this.melding_(""),this.teken_(),this.escape_??=n=>{n.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),setTimeout(()=>(t?this.$(".tekstveld"):this.$('[data-t="1"]'))?.focus(),60)}sluit(){this.removeAttribute("open"),this.code_="",this.escape_&&document.removeEventListener("keydown",this.escape_,!0)}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
          <span class="wie"><b></b><span></span></span>
  ...
  `);var vn=class extends z{defaults(){return{show_current:!0,forecast_type:"daily",days:Ti}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:g.entity("weather")},{name:"name",selector:g.text()},{name:"forecast_type",selector:g.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:g.number(1,Ni)},{name:"show_current",selector:g.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};C("domotiapp-forecast-card-editor",vn);A("domotiapp-forecast-card",_t,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var De={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},Re=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Ts=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},xt=class extends E{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[O]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let s=a.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[s],{entity_id:this.config.covers[+t].entity}),s!=="stop"&&(this.assumed_.set(t,s==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(j(e.querySelector(".chip"),{onTap:()=>P(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=f(this.hass,n.entity),s=R(this.hass,n.entity),o=!a||a.state==="unavailable",r=a?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=S(this.hass,n.entity,n.name);let l=Re(a,De.SET_POSITION)&&s.current_position!=null,d=l?s.current_position>0?"open":"closed":r==="open"||r==="closed"?r:this.assumed_.get(t)??"closed";e.dataset.shown=d;let c=Ts(s),p=(d==="open"?n.icon_open:n.icon_closed)??(d==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[d],m=e.querySelector(".chip");m.dataset.icon!==p&&(m.dataset.icon=p,m.innerHTML=_(p,c[d]));let y=e.querySelector(".st");this.dragging_.has(t)||(y.textContent=o?"Niet bereikbaar":r==="opening"?"Gaat open":r==="closing"?"Gaat dicht":l?`${s.current_position}% open`:r==="open"?"Open":r==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach($=>{if($.dataset.act==="stop"){$.disabled=o||!Re(a,De.STOP);return}let N=$.dataset.act==="open";$.disabled=o||(N?!Re(a,De.OPEN):!Re(a,De.CLOSE))});let u=e.querySelector(".pos"),w=l&&this.config.show_position!==!1;if(u.hidden=!w,w){if(u.dataset.built||(u.dataset.built="1",u.innerHTML=Q("position"),u.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let N=u.querySelector(".slider"),pe=M=>{N.style.setProperty("--v",`${M}%`),N.setAttribute("aria-valuenow",String(M)),e.querySelector(".st").textContent=`${M}% open`};this.teardown_.push(re(N,{value:()=>R(this.hass,n.entity).current_position??0,onInput:pe,onCommit:M=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:M})}))}let $=u.querySelector(".slider");if(!$.classList.contains("dragging")){let N=s.current_position??0;$.style.setProperty("--v",`${N}%`),$.setAttribute("aria-valuenow",String(N))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>Re(f(this.hass,n.entity),De.SET_POSITION));return Z(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}};x(xt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var _n=class extends z{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:g.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};C("domotiapp-cover-card-editor",_n);A("domotiapp-cover-card",xt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function Ns(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var kt=class extends E{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[O]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((a,s)=>`
      <button class="p" type="button" data-i="${s}" style="--tone:var(--dac-ink-3)">
        <span class="av"><span class="ph"></span></span>
        <span class="nm"></span>
        <span class="st"></span>
      </button>`).join("");return`<div class="card surface"><div class="chips" style="--cols:${t}">${n}</div></div>`}wire(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i];this.teardown_.push(j(e,{onTap:()=>P(this,t.entity)}))})}paint(){this.$$(".p").forEach(e=>{let t=this.config.persons[+e.dataset.i],n=f(this.hass,t.entity),a=Ns(n);e.style.setProperty("--tone",a.home===!0?"var(--dac-good)":a.home===!1?"var(--dac-bad)":"var(--dac-warn)");let s=S(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),s),this.text(e.querySelector(".st"),a.label);let o=e.querySelector(".ph"),r=n?.attributes?.entity_picture,l=r?`img:${r}`:s?`ini:${s[0]}`:"icon";o.dataset.kind!==l&&(o.dataset.kind=l,o.innerHTML=r?`<img src="${r}" alt="" loading="lazy" />`:s?s[0].toUpperCase():T.person),e.setAttribute("aria-label",`${s}, ${a.label}`)})}rows_(){let e=this.config?.columns??Math.min(this.config?.persons?.length??1,6),t=Math.ceil((this.config?.persons?.length??1)/e);return Z(20+t*74+(t-1)*6)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:"full",rows:e,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-person-card-editor")}static getStubConfig(e){return{persons:Object.keys(e?.states??{}).filter(n=>n.startsWith("person.")).slice(0,6)}}};x(kt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var kn=class extends z{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Ci(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};C("domotiapp-waste-card-editor",kn);A("domotiapp-waste-card",yt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var wt=globalThis,$t=wt.ShadowRoot&&(wt.ShadyCSS===void 0||wt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,yn=Symbol(),Oi=new WeakMap,He=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==yn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if($t&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Oi.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Oi.set(t,e))}return e}toString(){return this.cssText}},ie=i=>new He(typeof i=="string"?i:i+"",void 0,yn),G=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,s)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[s+1],i[0]);return new He(t,i,yn)},Li=(i,e)=>{if($t)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=wt.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},wn=$t?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return ie(t)})(i):i;var{is:Ls,defineProperty:Ds,getOwnPropertyDescriptor:Rs,getOwnPropertyNames:Hs,getOwnPropertySymbols:Ps,getPrototypeOf:Is}=Object,Et=globalThis,Di=Et.trustedTypes,Vs=Di?Di.emptyScript:"",Ks=Et.reactiveElementPolyfillSupport,Pe=(i,e)=>i,$n={toAttribute(i,e){switch(e){case Boolean:i=i?Vs:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Hi=(i,e)=>!Ls(i,e),Ri={attribute:!0,type:String,converter:$n,reflect:!1,useDefault:!1,hasChanged:Hi};Symbol.metadata??=Symbol("metadata"),Et.litPropertyMetadata??=new WeakMap;var ae=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ri){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&Ds(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:s}=Rs(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let r=a?.call(this);s?.call(this,o),this.requestUpdate(e,r,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ri}static _$Ei(){if(this.hasOwnProperty(Pe("elementProperties")))return;let e=Is(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Pe("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Pe("properties"))){let t=this.properties,n=[...Hs(t),...Ps(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(wn(a))}else e!==void 0&&t.push(wn(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Li(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let s=(n.converter?.toAttribute!==void 0?n.converter:$n).toAttribute(t,n.type);this._$Em=e,s==null?this.removeAttribute(a):this.setAttribute(a,s),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let s=n.getPropertyOptions(a),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:$n;this._$Em=a;let r=o.fromAttribute(t,s.type);this[a]=r??this._$Ej?.get(a)??r,this._$Em=null}}requestUpdate(e,t,n,a=!1,s){if(e!==void 0){let o=this.constructor;if(a===!1&&(s=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Hi)(s,t)||n.useDefault&&n.reflect&&s===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:s},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),s!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,s]of this._$Ep)this[a]=s;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,s]of n){let{wrapped:o}=s,r=this[a];o!==!0||this._$AL.has(a)||r===void 0||this.C(a,void 0,s,r)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};ae.elementStyles=[],ae.shadowRootOptions={mode:"open"},ae[Pe("elementProperties")]=new Map,ae[Pe("finalized")]=new Map,Ks?.({ReactiveElement:ae}),(Et.reactiveElementVersions??=[]).push("2.1.2");var Tn=globalThis,Pi=i=>i,St=Tn.trustedTypes,Ii=St?St.createPolicy("lit-html",{createHTML:i=>i}):void 0,Gi="$lit$",ce=`lit$${Math.random().toFixed(9).slice(2)}$`,qi="?"+ce,Us=`<${qi}>`,ge=document,Ve=()=>ge.createComment(""),Ke=i=>i===null||typeof i!="object"&&typeof i!="function",Nn=Array.isArray,Ws=i=>Nn(i)||typeof i?.[Symbol.iterator]=="function",En=`[ 	
\f\r]`,Ie=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Vi=/-->/g,Ki=/>/g,ue=RegExp(`>|${En}(?:([^\\s"'>=/]+)(${En}*=${En}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ui=/'/g,Wi=/"/g,Fi=/^(?:script|style|textarea|title)$/i,Cn=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),b=Cn(1),sd=Cn(2),od=Cn(3),fe=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),Bi=new WeakMap,me=ge.createTreeWalker(ge,129);function Zi(i,e){if(!Nn(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ii!==void 0?Ii.createHTML(e):e}var Bs=(i,e)=>{let t=i.length-1,n=[],a,s=e===2?"<svg>":e===3?"<math>":"",o=Ie;for(let r=0;r<t;r++){let l=i[r],d,c,p=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Ie?c[1]==="!--"?o=Vi:c[1]!==void 0?o=Ki:c[2]!==void 0?(Fi.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=ue):c[3]!==void 0&&(o=ue):o===ue?c[0]===">"?(o=a??Ie,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?ue:c[3]==='"'?Wi:Ui):o===Wi||o===Ui?o=ue:o===Vi||o===Ki?o=Ie:(o=ue,a=void 0);let y=o===ue&&i[r+1].startsWith("/>")?" ":"";s+=o===Ie?l+Us:p>=0?(n.push(d),l.slice(0,p)+Gi+l.slice(p)+ce+y):l+ce+(p===-2?r:y)}return[Zi(i,s+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Ue=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let s=0,o=0,r=e.length-1,l=this.parts,[d,c]=Bs(e,t);if(this.el=i.createElement(d,n),me.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=me.nextNode())!==null&&l.length<r;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(Gi)){let m=c[o++],y=a.getAttribute(p).split(ce),u=/([.?@])?(.*)/.exec(m);l.push({type:1,index:s,name:u[2],strings:y,ctor:u[1]==="."?An:u[1]==="?"?zn:u[1]==="@"?Mn:$e}),a.removeAttribute(p)}else p.startsWith(ce)&&(l.push({type:6,index:s}),a.removeAttribute(p));if(Fi.test(a.tagName)){let p=a.textContent.split(ce),m=p.length-1;if(m>0){a.textContent=St?St.emptyScript:"";for(let y=0;y<m;y++)a.append(p[y],Ve()),me.nextNode(),l.push({type:2,index:++s});a.append(p[m],Ve())}}}else if(a.nodeType===8)if(a.data===qi)l.push({type:2,index:s});else{let p=-1;for(;(p=a.data.indexOf(ce,p+1))!==-1;)l.push({type:7,index:s}),p+=ce.length-1}s++}}static createElement(e,t){let n=ge.createElement("template");return n.innerHTML=e,n}};function we(i,e,t=i,n){if(e===fe)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,s=Ke(e)?void 0:e._$litDirective$;return a?.constructor!==s&&(a?._$AO?.(!1),s===void 0?a=void 0:(a=new s(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=we(i,a._$AS(i,e.values),a,n)),e}var Sn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??ge).importNode(t,!0);me.currentNode=a;let s=me.nextNode(),o=0,r=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new We(s,s.nextSibling,this,e):l.type===1?d=new l.ctor(s,l.name,l.strings,this,e):l.type===6&&(d=new jn(s,this,e)),this._$AV.push(d),l=n[++r]}o!==l?.index&&(s=me.nextNode(),o++)}return me.currentNode=ge,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},We=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=we(this,e,t),Ke(e)?e===v||e==null||e===""?(this._$AH!==v&&this._$AR(),this._$AH=v):e!==this._$AH&&e!==fe&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ws(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==v&&Ke(this._$AH)?this._$AA.nextSibling.data=e:this.T(ge.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Ue.createElement(Zi(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let s=new Sn(a,this),o=s.u(this.options);s.p(t),this.T(o),this._$AH=s}}_$AC(e){let t=Bi.get(e.strings);return t===void 0&&Bi.set(e.strings,t=new Ue(e)),t}k(e){Nn(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let s of e)a===t.length?t.push(n=new i(this.O(Ve()),this.O(Ve()),this,this.options)):n=t[a],n._$AI(s),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Pi(e).nextSibling;Pi(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},$e=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,s){this.type=1,this._$AH=v,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=v}_$AI(e,t=this,n,a){let s=this.strings,o=!1;if(s===void 0)e=we(this,e,t,0),o=!Ke(e)||e!==this._$AH&&e!==fe,o&&(this._$AH=e);else{let r=e,l,d;for(e=s[0],l=0;l<s.length-1;l++)d=we(this,r[n+l],t,l),d===fe&&(d=this._$AH[l]),o||=!Ke(d)||d!==this._$AH[l],d===v?e=v:e!==v&&(e+=(d??"")+s[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},An=class extends $e{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===v?void 0:e}},zn=class extends $e{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==v)}},Mn=class extends $e{constructor(e,t,n,a,s){super(e,t,n,a,s),this.type=5}_$AI(e,t=this){if((e=we(this,e,t,0)??v)===fe)return;let n=this._$AH,a=e===v&&n!==v||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,s=e!==v&&(n===v||a);a&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},jn=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){we(this,e)}};var Gs=Tn.litHtmlPolyfillSupport;Gs?.(Ue,We),(Tn.litHtmlVersions??=[]).push("3.3.3");var Xi=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let s=t?.renderBefore??null;n._$litPart$=a=new We(e.insertBefore(Ve(),s),s,void 0,t??{})}return a._$AI(i),a};var On=globalThis,U=class extends ae{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Xi(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return fe}};U._$litElement$=!0,U.finalized=!0,On.litElementHydrateSupport?.({LitElement:U});var qs=On.litElementPolyfillSupport;qs?.({LitElement:U});(On.litElementVersions??=[]).push("4.2.2");var Y=G`
  :host {
    ${ie(q)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${ie(se)}
`;var Fs=["unavailable","unknown"],Zs=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function At({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],s=i?.lights??{},o=Array.isArray(e)?e:[],r=t??{};for(let l of o){let d=s[l];if(!d||typeof d!="object")continue;let c=r[l];if(!c||Fs.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let p={entity_id:l,transition:1};typeof d.brightness=="number"&&(p.brightness=d.brightness);for(let m of Zs)if(d[m]!==void 0){p[m]=d[m];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:a}}async function zt(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,s)=>{a.status==="rejected"&&n.push({entityId:e[s].data.entity_id,fout:a.reason})}),n}var Dn=["hs","rgb","rgbw","rgbww","xy"],Rn="color_temp",Xs="onoff";var be="kleur";var Ys=["unavailable","unknown"],Ji=["color_temp_kelvin","rgb_color","hs_color","xy_color"],Js=[0,100];function ee(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===Xs,a=t!==null&&t.includes(Rn),s=t!==null&&t.some(d=>Dn.includes(d)),o=e.min_color_temp_kelvin,r=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof r=="number"&&o<r;return{bekend:!0,beschikbaar:!Ys.includes(i.state),helderheid:!n,kleurtemp:a,kleur:s,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(r):6535,kelvinUitDefaults:a&&!l}}function Qs(){return{state:"off"}}function Qi(i,e){let t=e??ee(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...so(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function ea(i,e,t,n){return e?i&&i.state==="on"?{...i}:Qi(t,n):{state:"off"}}function ta(i,e,t,n){let a=n??ee(t),s=Un(i,t,a);return a.helderheid&&(s.brightness=L(e,1,255)),s}function Hn(i,e,t,n){let a=n??ee(t),s=Un(i,t,a);return pa(s),s.color_temp_kelvin=L(e,a.minKelvin,a.maxKelvin),s}function Pn(i,e,t,n){let a=n??ee(t),s=Un(i,t,a);return pa(s),s.hs_color=[L(e?.[0],0,360),L(e?.[1],0,100)],s}function Mt(i,e,t){return i??Qs()}function na(i,e,t){let n=Mt(i,e,t);if(typeof n.brightness=="number")return L(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?L(a,1,255):255}function In(i,e,t){let n=t??ee(e),a=Mt(i,e,n);if(typeof a.color_temp_kelvin=="number")return L(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let s=e?.attributes?.color_temp_kelvin;return typeof s=="number"?L(s,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function jt(i,e,t){let n=Mt(i,e,t);if(Ln(n.hs_color))return[L(n.hs_color[0],0,360),L(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Ln(a)?[L(a[0],0,360),L(a[1],0,100)]:[...Js]}function Vn(i){return i!=null&&typeof i=="object"}function ia(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],s=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let r=0;r<s;r+=1)if(!Vn(a[r]?.lights?.[o]))return!0;return!1})}function aa(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Kn(i,e,t){return Mt(i,e,t).state==="on"}function sa(i,e,t){let n=t??ee(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Kn(i,e,n),s=oa(n),o=s?eo(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!s||o==="wit"),kleur:a&&n.kleur&&(!s||o===be),kleurkeuze:a&&s,stand:a?o:null}}function oa(i){return!!(i?.kleurtemp&&i?.kleur)}function eo(i,e,t){let n=t??ee(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(Ji.slice(1).some(s=>i[s]!==void 0))return be}let a=e?.attributes?.color_mode;return a===Rn&&n.kleurtemp?"wit":Dn.includes(a)&&n.kleur?be:"wit"}function ra(i,e,t,n){let a=n??ee(t);return oa(a)?e==="wit"?Hn(i,In(i,t,a),t,a):Pn(i,jt(i,t,a),t,a):i}function la(i){let e=L(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function da(i){let e=L(i,1,100);return L(Math.round(e/100*255),1,255)}var to=1e3,no=4e4,Yi=7;function io(i){let e=L(i,to,no)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[L(t,0,255),L(n,0,255),L(a,0,255)]}function ao(i){let[e,t,n]=io(i);return`rgb(${e}, ${t}, ${n})`}function ca(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:Yi},(s,o)=>{let r=o/(Yi-1),l=t+(n-t)*r;return`${ao(l)} ${Math.round(r*100)}%`}).join(", ")})`}function so(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?L(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===Rn&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=L(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Dn.includes(a)&&Ln(t.hs_color)&&(n.hs_color=[L(t.hs_color[0],0,360),L(t.hs_color[1],0,100)]),n}function Un(i,e,t){return i&&i.state==="on"?{...i}:Qi(e,t)}function pa(i){for(let e of Ji)delete i[e]}function Ln(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function L(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Tt="domotiapp-scene-card",Wn="domotiapp-scene-card-editor",ha="domotiapp-scene-editor";var Be=["een","twee","drie"],ua="pencil",ma=["grid_options","layout_options","view_layout","visibility"];var ga="entity_id",Ee=class extends U{constructor(){super();x(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));x(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[ga]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[ga];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let s of t)s in this._getypt?a[s]=this._getypt[s]:n[s]&&(a[s]=n[s]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[s,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[s]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return v;let t=this._leden();return b`
      <ha-form
        .hass=${this.hass}
    ...
    `}_renderInhoud(){return this._toestand===Gn?b`<div class="inhoud">Bezig met laden…</div>`:this._toestand===ba?b`
        <div class="inhoud">
      ...
      <div class="inhoud">
        ...
        ${this._melding?b`<ha-alert alert-type="error">${this._melding}</ha-alert>`:v}
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),s=Kn(a,t,n),o=sa(a,t,n);return b`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
              ${this._naam(e)}
              ${n.bekend?n.beschikbaar?v:b`<span class="hint">niet bereikbaar</span>`:b`<span class="hint">lamp niet gevonden</span>`}
            </span>
            ${Vn(a)?v:b`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?b`
                <div class="bediening">
    ...
    `}_renderBesturing(e,t,n,a,s){return b`
    ...
    `}_renderHelderheid(e,t,n,a){let s=la(na(a,t,n)),o=r=>{r.stopPropagation(),this._zetLamp(e,ta(this._waardeVan(e),da(r.detail.value),t,n))};return b`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,s){let o=r=>l=>{l.stopPropagation(),r!==s&&this._zetLamp(e,ra(this._waardeVan(e),r,t,n))};return b`
      <div class="kleurkeuze">
        <button
          class="keuze ${s===be?"actief":""}"
          aria-pressed=${s===be?"true":"false"}
          @click=${o(be)}
        >
          Kleur
        </button>
    ...
    `}_renderKleurtemp(e,t,n,a){let s=In(a,t,n),o=r=>{r.stopPropagation(),this._zetLamp(e,Hn(this._waardeVan(e),r.detail.value,t,n))};return b`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleur(e,t,n,a){let[s,o]=jt(a,t,n),r=l=>d=>{d.stopPropagation();let c=jt(this._waardeVan(e),t,n),p=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Pn(this._waardeVan(e),p,t,n))};return b`
      <div class="besturing">
        <div class="label">
    ...
    `]);var ho="0.4.0",uo=["type","entity","name_overrides"],Fn="laden",Ge="klaar",Zn="leeg",Xn="geen-groep",va="opslagfout",_a="fout",qe=class extends U{constructor(){super(),this._scenes=null,this._leden=[],this._toestand=Fn,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1}static getConfigElement(){return document.createElement(Wn)}static getStubConfig(e){return{entity:Object.keys(e?.states??{}).find(n=>n.startsWith("light.")&&Array.isArray(e.states[n].attributes?.entity_id))??""}}setConfig(e){if(!e?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let t=Object.keys(e).filter(n=>!uo.includes(n)&&!ma.includes(n));t.length&&console.warn(`${Tt}: onbekende sleutels in de configuratie: ${t.join(", ")}`),this._config=e}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6}}willUpdate(){let e=this._config?.entity;if(!this.hass||!e)return;let t=!!this.hass.states[e];if(this._opgehaaldVoor!==e){this._opgehaaldVoor=e,this._bestondVorigeKeer=t,this._haalScenesOp();return}if(t&&!this._bestondVorigeKeer&&this._toestand===Xn){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=t}async _haalScenesOp(){let e=this._config.entity;this._toestand=Fn,this._melding="";try{let t=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:e});this._scenes=t.scenes,this._leden=t.member_entity_ids??[],this._toestand=this._leden.length===0?Zn:Ge}catch(t){this._verwerkFout(t,e)}}_verwerkFout(e,t){let n=e?.code;if(this._melding=e?.message??String(e),n==="home_assistant_error"){this._toestand=va;return}if(!this.hass.states[t]){this._toestand=Xn;return}this._toestand=_a}_naam(e){return this._config?.name_overrides?.[e]||this.hass?.states?.[e]?.attributes?.friendly_name||e}async _pasSceneToe(e){if(this._bezig||this._toestand!==Ge)return;let{oproepen:t}=At({scene:this._scenes?.[e],memberEntityIds:this._leden,states:this.hass.states});if(t.length){this._bezig=!0;try{let n=await zt((a,s)=>this.hass.callService("light",a,s),t);n.length&&this._meldMislukking(n.map(a=>a.entityId))}finally{this._bezig=!1}}}_meldMislukking(e){let t=e.map(a=>this._naam(a)).join(", "),n=e.length===1?`${t} reageerde niet.`:`Deze lampen reageerden niet: ${t}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:n},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===Ge&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(e){e.stopPropagation(),this._scenes=e.detail.scenes,this._leden=e.detail.member_entity_ids??[],this._toestand=this._leden.length===0?Zn:Ge}render(){if(!this._config)return v;switch(this._toestand){case Xn:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case va:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case _a:return this._renderFout("De scenes konden niet geladen worden.",this._melding);default:return this._renderKaart()}}_renderFout(e,t){return b`
      <div class="needs">
        <span class="mark">${this._icoon("question")}</span>
        <span>
          <b>${e}</b>
          ${t?b`<span class="detail">${t}</span>`:v}
        </span>
      </div>
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=_(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===Zn,t=this._toestand===Fn,n=this._iconen();return b`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((a,s)=>b`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Ge)return v;let e=ia(this._scenes,this._leden,3).length,t=aa(e);return t?b`<div class="mededeling">${t}</div>`:v}_renderEditor(){return b`
    ...
    `]);D(Tt,qe);D(Wn,Ee);D(ha,Se);ye({type:Tt,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${ho}).`,preview:!1});var ve="domotiapp-alarm-card",Yn="domotiapp-alarm-card-editor",xa="domotiapp-alarm-editor",ka="DomotiApp Alarm",ya="https://github.com/Sven2410/domotiapp-lovelace",te="domotiapp_lovelace",X=Object.freeze({get:`${te}/alarms/get`,save:`${te}/alarms/save`,setEnabled:`${te}/alarms/set_enabled`,delete:`${te}/alarms/delete`,stop:`${te}/alarms/stop`,clearMessage:`${te}/alarms/clear_message`,search:`${te}/sound/search`,entities:`${te}/entities/list`,previewStart:`${te}/preview/start`,subscribe:`${te}/updates/subscribe`}),Ot="#026FA1";function wa(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var mo="07:00";var go=["uri","name","media_type","image"],fo="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",bo="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var vo="Music Assistant Wekker",_o="Verlichting Wekker";function Lt(){return{id:null,name:"",time:mo,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function $a(i){let e=Lt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:Jn(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:Fe(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function Fe(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of go)e[t]=i[t]===void 0?null:i[t];return e}function Jn(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function Qn(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),Jn(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Ea(i){let e={name:(i.name||"").trim(),time:i.time,days:[...new Set(i.days||[])].sort((t,n)=>t-n),enabled:i.enabled!==!1,sound:Fe(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(e.id=i.id),e}function Sa(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Aa(i){return Jn(i)&&i.slice(0,2)==="02"?fo:null}function za(i){return i===!1?bo:null}function Ma(i){return typeof i?.endless=="boolean"?i.endless:null}function Dt(i,e){let t=e==="lamp",n=t?_o:vo,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function ja(i,e){return Dt(e,"speaker")!==null?!1:Qn(i).ok}var ko=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],yo=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],Ze="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",wo="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",$o="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Ae=class extends U{constructor(){super(),this._concept=Lt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?$a(this.wekker):Lt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:X.previewStart,speaker:this._concept.speaker,sound:Fe(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:X.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Fe(e),endless:Ma(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=Qn(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:X.save,person:this.person,alarm:Ea(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return b`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div class="blok">
        ...
        ${o?b`<div class="waarschuwing">
              ${this._svg(Ze)}<span>${o}</span>
            </div>`:v}
      </div>
      ...
      <div class="blok">
        ...
        ${e.sound?b`<div class="gekozen">
              ${e.sound.image?b`<img src=${e.sound.image} alt="" />`:v}
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${yo.map(([d,c])=>b`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${this._treffers?b`<div class="treffers">
              ${this._treffers.length===0?b`<div class="treffer">Niets gevonden.</div>`:this._treffers.map(d=>b`<button
                    ...
                    >
                      ${d.image?b`<img src=${d.image} alt="" />`:v}
                      <span>${d.name}</span>
                      <span class="soort">${d.media_type??""}</span>
                    </button>`)}
            </div>`:v}
        ${r?b`<div class="waarschuwing">${this._svg(Ze)}<span>${r}</span></div>`:v}
      </div>
      ...
      <div class="blok">
        ...
        ${s?b`<div class="uitleg">${this._svg(Ze)}<span>${s}</span></div>`:b`
              <div class="vak">
                <select
                  id="lamp"
  ...
  `]);var ze=class ze extends U{constructor(){super(...arguments);x(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?v:b`
      <div class="uitleg">
  ...
  `]),x(ze,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var ei=ze;D(ve,Xe);D(Yn,ei);D(xa,Ae);ye({type:ve,name:ka,description:`Wekkerkaart van DomotiApp (v${Lo}).`,preview:!1,documentationURL:ya});var Po="0.4.0";li(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${Po} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Po as VERSION};
