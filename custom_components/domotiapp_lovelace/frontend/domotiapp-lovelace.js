var tr=Object.defineProperty;var nr=(i,e,t)=>e in i?tr(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var k=(i,e,t)=>nr(i,typeof e!="symbol"?e+"":e,t);var F=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function ee(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var oe=i=>String(i??"").split(".")[0],f=(i,e)=>e&&i?.states?.[e]||null,P=(i,e)=>f(i,e)?.attributes??{},it=(i,e,t)=>t?null:P(i,e).entity_picture||null;function si(i){if(!i||i.state!=="on")return null;let e=i.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function L(i,e,t){return t||P(i,e).friendly_name||e||""}var ir=new Set(["scene","script","input_button","button","event"]),Ht=i=>ir.has(oe(i));function W(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!Ht(i.entity_id):!1}function Ne(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(oe(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var ar=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),li=i=>ar.has(oe(i));function di(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function nt(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var U=(i,e)=>nt(i,"hass-more-info",{entityId:e});function Oe(i){switch(oe(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function rr(i){switch(oe(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function fe(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":U(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[r,o]=rr(a);e.callService(r,o,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[r,o]=a.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),nt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":nt(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":nt(i,"ll-custom",n);break;default:break}}function T(i,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,l=null,d=u=>{u.button!=null&&u.button!==0||(o=Date.now())},c=()=>{let u=o?Date.now()-o:0;if(o=0,t&&u>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){l=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(l),s=0,n()};return i.addEventListener("pointerdown",d),i.addEventListener("click",c),i.addEventListener("contextmenu",u=>u.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",d),i.removeEventListener("click",c)}}function G(i,e){if(!e)return"";let t=oe(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function V(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var ri=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],ci=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],oi=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),Pt=(i,e)=>Math.round((oi(e)-oi(i))/864e5);function Ce(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function Vt(i,e=new Date){if(!i)return"";let t=Pt(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?ri[i.getDay()]:`${ri[i.getDay()].slice(0,2)} ${i.getDate()} ${ci[i.getMonth()]}`}var pi=i=>i?`${i.getDate()} ${ci[i.getMonth()]}`:"";function or(i){let e=Math.max(1,Math.ceil((i+8)/64));return e*56+(e-1)*8}function sr(i){if(!i)return 0;let e=getComputedStyle(i),t=[...i.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function q(i,e=4){if(!i)return;let t=sr(i);if(!t){e>0&&requestAnimationFrame(()=>q(i,e-1));return}let n=`${or(t)}px`;i.style.getPropertyValue("--dac-raster")!==n&&i.style.setProperty("--dac-raster",n)}function Z(i){if(!i||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of i.children)e.observe(t);q(i)});e.observe(i);for(let t of i.children)e.observe(t);return q(i),()=>e.disconnect()}var lr="home-assistant";function hi({leesRegistry:i,definities:e,waarschuw:t=()=>{},plan:n=(l,d)=>setTimeout(l,d),nu:a=()=>Date.now(),marker:r=lr,intervalMs:o=20,maxWachtMs:s=1e4}){let l=a();function d(){let m=i();if(!m)return!1;for(let[x,h]of e)try{m.get(x)||m.define(x,h)}catch($){t(`kon ${x} niet registreren: ${$&&$.message}`)}return!0}function c(){let m=i();return!m||!m.get(r)?!1:d()}if(c())return!0;let u=()=>{if(!c()){if(a()-l>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),d();return}n(u,o)}};return n(u,o),!1}var ui=[];function N(i,e){ui.push([i,e])}function $e({type:i,name:e,description:t,preview:n=!0,documentationURL:a}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===i)&&window.customCards.push({type:i,name:e??i,description:t??"",preview:n,documentationURL:a??"https://github.com/Sven2410/domotiapp-lovelace"})}function mi(i=()=>{}){hi({leesRegistry:()=>globalThis.customElements,definities:ui,waarschuw:i})}var dr=`
  :host {
    ${F}
    display: block;
...
`,C={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},at={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},K=(i,e="accent")=>C[i]??(i&&/[#(]|^var/.test(i)?i:C[e]),O=Symbol("incomplete"),cr=i=>`
  ...
  </div>`,pr=56,gi=8,Y=i=>Math.max(1,Math.ceil((i+gi)/(pr+gi))),E=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[ee(dr+ce+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[]}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[O]||di(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[O]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[O];if(e.innerHTML=t?cr(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(Z(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,a){e&&(e.addEventListener(t,n,a),this.teardown_.push(()=>e.removeEventListener(t,n,a)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}};k(E,"css","");function A(i,e,{name:t,description:n,preview:a=!0}={}){N(i,e),$e({type:i,name:t,description:n,preview:a})}function D(i,e){N(i,e)}var p=(i,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${i}</svg>`,z={house:p(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,Kt=null,Ut=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Kt=Kt??[ee(ur)],this.shadowRoot.adoptedStyleSheets=Kt,this.value_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,Wt=null,Bt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Wt=Wt??[ee(br)],this.shadowRoot.adoptedStyleSheets=Wt,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in C)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${C[e]}"
      ...
      <div class="box">
        ...
        ${this.statuses?`<h4>Status</h4>
               <div class="row">${gr.map(n=>this.swatch(n)).join("")}</div>
               <p class="note">
...
`;var yr=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),$r=new Set(["hs","rgb","rgbw","rgbww","xy"]),Qt=i=>i?.attributes?.supported_color_modes??[],jr=i=>Qt(i).some(e=>yr.has(e)),st=i=>Qt(i).some(e=>$r.has(e)),lt=i=>Qt(i).includes("color_temp"),fi=i=>Math.max(1,Math.round((i??0)/255*100)),dt=class extends E{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[O]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
...
`;var pt={row:44,tile:96,compact:44},De=6,wi=12,zr=["row","tile","compact"],Sr=["card","items","none"],Re=i=>typeof i=="string"?{entity:i}:{...i},He=i=>Math.min(Math.max(1,Number(i)||2),3),je=i=>zr.includes(i)?i:"row",J=i=>!!(i?.entity||i?.name||i?.icon||i?.tap_action);function yi(i){if(Array.isArray(i?.rows)&&i.rows.length)return i.rows.map(t=>({columns:He(t.columns),layout:je(t.layout),items:(t.items??t.entities??[]).map(Re)}));let e=(i?.items??i?.entities??[]).map(Re);return e.length?[{columns:He(i.columns),layout:je(i.layout),items:e}]:[]}function ht(i){return Sr.includes(i?.surface)?i.surface:i?.bare?"none":"card"}var Ar=i=>Math.max(1,Math.ceil((i.items?.length||1)/i.columns));function an(i){let e=i?.rows??[];if(!e.length)return wi+pt.row;let t=ht(i)==="card"?wi:0;for(let n of e){let a=Ar(n);t+=a*pt[je(n.layout)]+(a-1)*De}return t+(e.length-1)*De}var ji=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"}],Mr=i=>ji.find(e=>e.waarde===i)?.label??"Rij";function ut(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();J(e)&&i.bewaard.push(e)}return i}function Tr(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:He(n.columns),layout:je(n.layout),items:(n.items??n.entities??[]).map(Re)})):(()=>{let n=(i.items??i.entities??[]).map(Re);return n.length?[{columns:He(i.columns),layout:je(i.layout),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let r=0;r<n.items.length;r+=n.columns)a.push(n.items.slice(r,r+n.columns));a.length||a.push([]);for(let r of a)t.push(ut({columns:n.columns,layout:n.layout,items:r}))}return t}var $i=i=>i.map(e=>({columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},items:e.items.filter(J).map(t=>structuredClone(t))})).filter(e=>e.items.length),Nr=`
...
`,rn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,this.gebouwd_&&e===this.uitObject_)return;let t=Tr(e);this.gebouwd_&&JSON.stringify($i(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let r=Number(a[1]);r!==e&&t.add(r>e?`r${r-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let r=/^r(\d+)i(\d+)$/.exec(a);if(!r||Number(r[1])!==e){n.add(a);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{J(n)||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Nr;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((a,r)=>t.appendChild(this.rijBlok_(a,r))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=ut({columns:2,layout:"row",items:[]});this.rows_.push(a);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(a,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:a=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(l=>{let d=document.createElement("button");d.type="button",d.textContent=l.label,l.titel&&(d.title=l.titel);let c=()=>{t()!==l.waarde&&n(l.waarde)};return a?this.binnenKop_(d,c):d.addEventListener("click",c),r.appendChild(d),[d,l.waarde]}),s=()=>o.forEach(([l,d])=>l.setAttribute("aria-pressed",String(t()===d)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"items",label:"Om elke entiteit apart"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="surface")return"Om elke entiteit apart geeft losse blokken in plaats van een lijst op een vlak -- dat is de vorm van een raster ruimtetegels of een rij losse knoppen.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};n.surface==="items"||n.surface==="none"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let l=document.createElement("small");o.append(s,l);let d=this.segment_([1,2,3].map(w=>({waarde:w,label:String(w),titel:`${w} entiteit${w>1?"en":""} in deze rij`})),()=>e.columns,w=>{e.columns=w,ut(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(r,o,d.wrap,c);let u=document.createElement("div");u.className="rijbody";let m=this.segment_(ji.map(w=>({waarde:w.waarde,label:w.label})),()=>e.layout,w=>{e.layout=w,this.emit_()}),x=document.createElement("div");x.className="vormrij";let h=document.createElement("b");h.textContent="Vorm van deze rij",x.append(h,m.wrap),u.appendChild(x);let $=()=>{let w=e.items.filter(J),y=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&y.push(Mr(e.layout)),y.push(w.length?w.map(ae=>this.itemNaam_(ae)).join(", "):"nog leeg"),l.textContent=y.join(" \xB7 "),d.vernieuw(),m.vernieuw()};return this.koppen_.push($),e.items.forEach((w,y)=>u.appendChild(this.itemBlok_(e,w,t,y))),n.append(a,u),$(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,a){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${a}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let d=document.createElement("span");d.className="titel";let c=document.createElement("b"),u=document.createElement("small");d.append(c,u);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),ut(e),this.emit_(),this.build_()}),o.append(s,l,d,m);let x=document.createElement("div");x.className="itembody";let h=document.createElement("ha-form");h.hass=this.hass_,h.schema=[{name:"entity",selector:{entity:{}}}],h.computeLabel=()=>"Entiteit",h.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",h.addEventListener("value-changed",j=>{j.stopPropagation(),t.entity=j.detail.value.entity??"",this.emit_()});let $=document.createElement("dac-icon-picker");$.label="Icoon",$.hass=this.hass_,$.addEventListener("value-changed",j=>{j.stopPropagation(),j.detail.value?t.icon=j.detail.value:delete t.icon,this.emit_()});let w=document.createElement("dac-tone-picker");w.label="Kleur",w.hass=this.hass_,w.addEventListener("value-changed",j=>{j.stopPropagation(),j.detail.value?t.tone=j.detail.value:delete t.tone,this.emit_()});let y=document.createElement("ha-form");y.hass=this.hass_,y.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],y.computeLabel=j=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[j.name]??j.name,y.computeHelper=j=>{if(j.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(j.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(j.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},y.addEventListener("value-changed",j=>{j.stopPropagation();let re=j.detail.value;re.name?t.name=re.name:delete t.name,re.toggle===!0?t.toggle=!0:delete t.toggle;for(let de of["show_icon","show_name","show_state"])re[de]===!1?t[de]=!1:delete t[de];for(let de of["icon_tap_action","icon_hold_action","tap_action","hold_action"])re[de]?t[de]=re[de]:delete t[de];re.double_tap_action&&re.double_tap_action.action!=="none"?t.double_tap_action=re.double_tap_action:delete t.double_tap_action,this.emit_()});let ae=()=>{c.textContent=J(t)?this.itemNaam_(t):"Kies een entiteit",u.textContent=t.entity||(J(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!J(t)),m.hidden=!J(t)};return this.koppen_.push(ae),h.data={entity:t.entity||void 0},$.value=t.icon??"",w.value=t.tone??"",y.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},x.append(h,$,w,y),r.append(o,x),ae(),r}emit_(){let e=$i(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};N("domotiapp-entities-card-editor",rn);var mt=class extends E{validate(e){let t=yi(e);return t.some(n=>n.items.some(J))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[O]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?K(e.tone):this.config.tone?K(this.config.tone):oe(e.entity)!=="light"?C.accent:si(f(this.hass,e.entity))??C.lit}metSchakelaar_(e){return!!e.toggle&&li(e.entity)}template(){let e=this.config;this.setAttribute("vlak",ht(e)),this.style.containerType="inline-size";let t=ht(e)==="items";return`<div class="card surface">${e.rows.map((a,r)=>{let o=e.state_position==="right"&&a.layout!=="tile",s=`<span class="st${o?" rechts":""}"></span>`,l=a.items.map((d,c)=>`
  ...
  `);A("domotiapp-entities-card",mt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var R={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},H=(i,e)=>!!(Number(i?.attributes?.supported_features??0)&e),on=i=>!i||i.state==="off",sn=i=>!!i&&!["off","unavailable","unknown"].includes(i.state),ln=i=>i?.state==="playing",Ei=i=>!!i&&!["off","unavailable","unknown","idle","standby"].includes(i.state);function zi(i){if(!i)return[];let e=[];return(H(i,R.TURN_ON)||H(i,R.TURN_OFF))&&e.push("power"),on(i)||(H(i,R.PREVIOUS_TRACK)&&e.push("prev"),H(i,R.PLAY)||H(i,R.PAUSE)||H(i,R.PLAY_MEDIA)?e.push("play"):H(i,R.STOP)&&e.push("stop"),H(i,R.NEXT_TRACK)&&e.push("next")),e}var be=i=>i?.volume_entity||i?.entity;function dn(i){if(!sn(i))return[];let e=[];return H(i,R.VOLUME_MUTE)&&e.push("mute"),H(i,R.VOLUME_SET)?e.push("slider"):H(i,R.VOLUME_STEP)&&e.push("steps"),e}var ue=i=>Math.round(Math.min(1,Math.max(0,Number(i?.attributes?.volume_level??0)))*100),Pe=i=>!!i?.attributes?.is_volume_muted,Si=i=>!!i?.attributes?.mass_player_type,cn=i=>!!i?.attributes?.shuffle,pn=i=>{let e=i?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Ai=i=>({off:"all",all:"one",one:"off"})[Or(i)]??"all",Or=i=>["off","all","one"].includes(i)?i:"off";function hn(i,{zoeken:e=!0}={}){if(!sn(i))return[];let t=[];return H(i,R.SHUFFLE_SET)&&t.push("shuffle"),H(i,R.REPEAT_SET)&&t.push("repeat"),e&&Si(i)&&t.push("search"),t}function Mi(i,{tonen:e=!0}={}){if(!e||!sn(i)||!H(i,R.SELECT_SOURCE)||Si(i))return null;let t=i?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:i.attributes.source??null,aantal:t.length}}function Ti(i,e=t=>t?.state??""){if(!i)return"";if(i.state==="unavailable")return"Niet bereikbaar";if(i.state==="off")return"Uit";if(i.state==="standby")return"Stand-by";let t=i.attributes??{},n=t.media_title||t.media_channel||"",a=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return i.state==="idle"||!n?a||e(i):a&&a!==n?`${n} \xB7 ${a}`:n}function un(i){let e=i?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var mn=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var me=i=>`domotiapp_lovelace/media/${i}`;function Cr(i,e){if(!i)return null;if(e)return i.uri?{type:me("favorite"),favorite:!0,uri:i.uri}:null;let t=Lr(i);return!t||!i.library_item_id?null:{type:me("favorite"),favorite:!1,kind:t,library_item_id:String(i.library_item_id)}}function Lr(i){let e=i?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var Ni={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},gn=i=>!!i?.uri,gt=(i,e,{favoriet:t=!1,zoek:n="",limiet:a=50}={})=>i.callWS({type:me("library"),kind:e,favorite:t,...n?{search:n}:{},limit:a}).then(r=>r?.items??[]),Oi=(i,e,t)=>{let n=Cr(e,t);return n?i.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},Ci=(i,e)=>i.callWS({type:me("playlist/create"),name:e}).then(t=>t?.playlist??null),Li=(i,e)=>i.callWS({type:me("playlist/remove"),library_item_id:String(e.library_item_id)}),Di=(i,e)=>i.callWS({type:me("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),Ri=(i,e,t)=>i.callWS({type:me("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),Hi=(i,e,t)=>i.callWS({type:me("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var Dr=350,Pi=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]],Rr={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function Hr(i){let e=Array.isArray(i.artists)?i.artists.map(a=>typeof a=="string"?a:a?.name).filter(Boolean).join(", "):"",t=typeof i.album=="string"?i.album:i.album?.name,n=Rr[i.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var Pr=`
  :host {
    ${F}
...
`,fn=class extends HTMLElement{static get sheet_(){return Object.hasOwn(this,"s_")||(this.s_=ee(ce+Pr)),this.s_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[new.target.sheet_],this.soort_="",this.treffers_=[],this.speakers_=null,this.opruimen_=[]}open(e,t,n,{radioModus:a=!1,speakers:r=null}={}){this.hass=e,this.entity_=t,this.naam_=n,this.radioModus_=a,this.speakerKeuze_=Array.isArray(r)&&r.length?r:null,this.gebouwd_||this.bouw_(),this.setAttribute("open",""),this.escape_??=o=>{o.key==="Escape"&&this.hasAttribute("open")&&this.sluit()},document.addEventListener("keydown",this.escape_,!0),this.$(".wie b").textContent=n,this.$(".wie span").textContent="Music Assistant",this.sprekerSig_=null,this.$("footer")?.removeAttribute("open"),this.$(".voetkop")?.setAttribute("aria-expanded","false"),this.lijst_=null,this.soort_="",this.naarTab_("zoeken"),this.haalSpeakers_(),setTimeout(()=>this.$(".zoek input")?.focus(),60)}sluit(){this.removeAttribute("open"),this.menuDicht_(),this.escape_&&document.removeEventListener("keydown",this.escape_,!0)}set hass(e){this.hass_=e,this.gebouwd_&&this.hasAttribute("open")&&this.tekenSpeakers_()}get hass(){return this.hass_}$(e){return this.shadowRoot.querySelector(e)}bouw_(){this.gebouwd_=!0,this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
          ...
          <div class="rij" data-i="${a}" data-knoppen="${d}">
            <button class="tr" type="button">
              ...
              <span class="tekst">
                ...
                <span class="ond">${this.veilig_(Hr(n))}</span>
              </span>
...
`,bn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ee(Vr+ce)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
  ...
  `);var jn=class extends M{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${Bi(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};D("domotiapp-waste-card-editor",jn);A("domotiapp-waste-card",wt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var yt=globalThis,$t=yt.ShadowRoot&&(yt.ShadyCSS===void 0||yt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,En=Symbol(),Gi=new WeakMap,Ue=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==En)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if($t&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Gi.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Gi.set(t,e))}return e}toString(){return this.cssText}},se=i=>new Ue(typeof i=="string"?i:i+"",void 0,En),B=(i,...e)=>{let t=i.length===1?i[0]:e.reduce((n,a,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+i[r+1],i[0]);return new Ue(t,i,En)},qi=(i,e)=>{if($t)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),a=yt.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,i.appendChild(n)}},zn=$t?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return se(t)})(i):i;var{is:Zr,defineProperty:Xr,getOwnPropertyDescriptor:Yr,getOwnPropertyNames:Jr,getOwnPropertySymbols:Qr,getPrototypeOf:eo}=Object,jt=globalThis,Fi=jt.trustedTypes,to=Fi?Fi.emptyScript:"",no=jt.reactiveElementPolyfillSupport,We=(i,e)=>i,Sn={toAttribute(i,e){switch(e){case Boolean:i=i?to:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Xi=(i,e)=>!Zr(i,e),Zi={attribute:!0,type:String,converter:Sn,reflect:!1,useDefault:!1,hasChanged:Xi};Symbol.metadata??=Symbol("metadata"),jt.litPropertyMetadata??=new WeakMap;var le=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Zi){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),a=this.getPropertyDescriptor(e,n,t);a!==void 0&&Xr(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){let{get:a,set:r}=Yr(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:a,set(o){let s=a?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Zi}static _$Ei(){if(this.hasOwnProperty(We("elementProperties")))return;let e=eo(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(We("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(We("properties"))){let t=this.properties,n=[...Jr(t),...Qr(t)];for(let a of n)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,a]of t)this.elementProperties.set(n,a)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let a=this._$Eu(t,n);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let a of n)t.unshift(zn(a))}else e!==void 0&&t.push(zn(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return qi(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,n);if(a!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Sn).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,a=n._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let r=n.getPropertyOptions(a),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Sn;this._$Em=a;let s=o.fromAttribute(t,r.type);this[a]=s??this._$Ej?.get(a)??s,this._$Em=null}}requestUpdate(e,t,n,a=!1,r){if(e!==void 0){let o=this.constructor;if(a===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Xi)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:a,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,r]of this._$Ep)this[a]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[a,r]of n){let{wrapped:o}=r,s=this[a];o!==!0||this._$AL.has(a)||s===void 0||this.C(a,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};le.elementStyles=[],le.shadowRootOptions={mode:"open"},le[We("elementProperties")]=new Map,le[We("finalized")]=new Map,no?.({ReactiveElement:le}),(jt.reactiveElementVersions??=[]).push("2.1.2");var Ln=globalThis,Yi=i=>i,Et=Ln.trustedTypes,Ji=Et?Et.createPolicy("lit-html",{createHTML:i=>i}):void 0,aa="$lit$",ge=`lit$${Math.random().toFixed(9).slice(2)}$`,ra="?"+ge,io=`<${ra}>`,xe=document,Ge=()=>xe.createComment(""),qe=i=>i===null||typeof i!="object"&&typeof i!="function",Dn=Array.isArray,ao=i=>Dn(i)||typeof i?.[Symbol.iterator]=="function",An=`[ 	
\f\r]`,Be=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Qi=/-->/g,ea=/>/g,ve=RegExp(`>|${An}(?:([^\\s"'>=/]+)(${An}*=${An}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ta=/'/g,na=/"/g,oa=/^(?:script|style|textarea|title)$/i,Rn=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),g=Rn(1),gd=Rn(2),fd=Rn(3),ke=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),ia=new WeakMap,_e=xe.createTreeWalker(xe,129);function sa(i,e){if(!Dn(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ji!==void 0?Ji.createHTML(e):e}var ro=(i,e)=>{let t=i.length-1,n=[],a,r=e===2?"<svg>":e===3?"<math>":"",o=Be;for(let s=0;s<t;s++){let l=i[s],d,c,u=-1,m=0;for(;m<l.length&&(o.lastIndex=m,c=o.exec(l),c!==null);)m=o.lastIndex,o===Be?c[1]==="!--"?o=Qi:c[1]!==void 0?o=ea:c[2]!==void 0?(oa.test(c[2])&&(a=RegExp("</"+c[2],"g")),o=ve):c[3]!==void 0&&(o=ve):o===ve?c[0]===">"?(o=a??Be,u=-1):c[1]===void 0?u=-2:(u=o.lastIndex-c[2].length,d=c[1],o=c[3]===void 0?ve:c[3]==='"'?na:ta):o===na||o===ta?o=ve:o===Qi||o===ea?o=Be:(o=ve,a=void 0);let x=o===ve&&i[s+1].startsWith("/>")?" ":"";r+=o===Be?l+io:u>=0?(n.push(d),l.slice(0,u)+aa+l.slice(u)+ge+x):l+ge+(u===-2?s:x)}return[sa(i,r+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Fe=class i{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,o=0,s=e.length-1,l=this.parts,[d,c]=ro(e,t);if(this.el=i.createElement(d,n),_e.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(a=_e.nextNode())!==null&&l.length<s;){if(a.nodeType===1){if(a.hasAttributes())for(let u of a.getAttributeNames())if(u.endsWith(aa)){let m=c[o++],x=a.getAttribute(u).split(ge),h=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:h[2],strings:x,ctor:h[1]==="."?Tn:h[1]==="?"?Nn:h[1]==="@"?On:ze}),a.removeAttribute(u)}else u.startsWith(ge)&&(l.push({type:6,index:r}),a.removeAttribute(u));if(oa.test(a.tagName)){let u=a.textContent.split(ge),m=u.length-1;if(m>0){a.textContent=Et?Et.emptyScript:"";for(let x=0;x<m;x++)a.append(u[x],Ge()),_e.nextNode(),l.push({type:2,index:++r});a.append(u[m],Ge())}}}else if(a.nodeType===8)if(a.data===ra)l.push({type:2,index:r});else{let u=-1;for(;(u=a.data.indexOf(ge,u+1))!==-1;)l.push({type:7,index:r}),u+=ge.length-1}r++}}static createElement(e,t){let n=xe.createElement("template");return n.innerHTML=e,n}};function Ee(i,e,t=i,n){if(e===ke)return e;let a=n!==void 0?t._$Co?.[n]:t._$Cl,r=qe(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,t,n)),n!==void 0?(t._$Co??=[])[n]=a:t._$Cl=a),a!==void 0&&(e=Ee(i,a._$AS(i,e.values),a,n)),e}var Mn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,a=(e?.creationScope??xe).importNode(t,!0);_e.currentNode=a;let r=_e.nextNode(),o=0,s=0,l=n[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new Ze(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new Cn(r,this,e)),this._$AV.push(d),l=n[++s]}o!==l?.index&&(r=_e.nextNode(),o++)}return _e.currentNode=xe,a}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Ze=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,a){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ee(this,e,t),qe(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ke&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ao(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==_&&qe(this._$AH)?this._$AA.nextSibling.data=e:this.T(xe.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,a=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Fe.createElement(sa(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===a)this._$AH.p(t);else{let r=new Mn(a,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=ia.get(e.strings);return t===void 0&&ia.set(e.strings,t=new Fe(e)),t}k(e){Dn(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,a=0;for(let r of e)a===t.length?t.push(n=new i(this.O(Ge()),this.O(Ge()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=Yi(e).nextSibling;Yi(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},ze=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,a,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=_}_$AI(e,t=this,n,a){let r=this.strings,o=!1;if(r===void 0)e=Ee(this,e,t,0),o=!qe(e)||e!==this._$AH&&e!==ke,o&&(this._$AH=e);else{let s=e,l,d;for(e=r[0],l=0;l<r.length-1;l++)d=Ee(this,s[n+l],t,l),d===ke&&(d=this._$AH[l]),o||=!qe(d)||d!==this._$AH[l],d===_?e=_:e!==_&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Tn=class extends ze{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}},Nn=class extends ze{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==_)}},On=class extends ze{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){if((e=Ee(this,e,t,0)??_)===ke)return;let n=this._$AH,a=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==_&&(n===_||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Cn=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ee(this,e)}};var oo=Ln.litHtmlPolyfillSupport;oo?.(Fe,Ze),(Ln.litHtmlVersions??=[]).push("3.3.3");var la=(i,e,t)=>{let n=t?.renderBefore??e,a=n._$litPart$;if(a===void 0){let r=t?.renderBefore??null;n._$litPart$=a=new Ze(e.insertBefore(Ge(),r),r,void 0,t??{})}return a._$AI(i),a};var Hn=globalThis,I=class extends le{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=la(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ke}};I._$litElement$=!0,I.finalized=!0,Hn.litElementHydrateSupport?.({LitElement:I});var so=Hn.litElementPolyfillSupport;so?.({LitElement:I});(Hn.litElementVersions??=[]).push("4.2.2");var Q=B`
  :host {
    ${se(F)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${se(ce)}
`;var lo=["unavailable","unknown"],co=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function zt({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let l of o){let d=r[l];if(!d||typeof d!="object")continue;let c=s[l];if(!c||lo.includes(c.state)){a.push(l);continue}if(d.state==="off"){n.push({service:"turn_off",data:{entity_id:l,transition:1}});continue}let u={entity_id:l,transition:1};typeof d.brightness=="number"&&(u.brightness=d.brightness);for(let m of co)if(d[m]!==void 0){u[m]=d[m];break}n.push({service:"turn_on",data:u})}return{oproepen:n,overgeslagen:a}}async function St(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var Vn=["hs","rgb","rgbw","rgbww","xy"],In="color_temp",po="onoff";var we="kleur";var ho=["unavailable","unknown"],ca=["color_temp_kelvin","rgb_color","hs_color","xy_color"],uo=[0,100];function ne(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===po,a=t!==null&&t.includes(In),r=t!==null&&t.some(d=>Vn.includes(d)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,l=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!ho.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:l?Math.round(o):2e3,maxKelvin:l?Math.round(s):6535,kelvinUitDefaults:a&&!l}}function mo(){return{state:"off"}}function pa(i,e){let t=e??ne(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",...xo(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function ha(i,e,t,n){return e?i&&i.state==="on"?{...i}:pa(t,n):{state:"off"}}function ua(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return a.helderheid&&(r.brightness=S(e,1,255)),r}function Kn(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return ya(r),r.color_temp_kelvin=S(e,a.minKelvin,a.maxKelvin),r}function Un(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return ya(r),r.hs_color=[S(e?.[0],0,360),S(e?.[1],0,100)],r}function At(i,e,t){return i??mo()}function ma(i,e,t){let n=At(i,e,t);if(typeof n.brightness=="number")return S(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?S(a,1,255):255}function Wn(i,e,t){let n=t??ne(e),a=At(i,e,n);if(typeof a.color_temp_kelvin=="number")return S(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?S(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Mt(i,e,t){let n=At(i,e,t);if(Pn(n.hs_color))return[S(n.hs_color[0],0,360),S(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Pn(a)?[S(a[0],0,360),S(a[1],0,100)]:[...uo]}function Bn(i){return i!=null&&typeof i=="object"}function ga(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Bn(a[s]?.lights?.[o]))return!0;return!1})}function fa(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Gn(i,e,t){return At(i,e,t).state==="on"}function ba(i,e,t){let n=t??ne(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Gn(i,e,n),r=va(n),o=r?go(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===we),kleurkeuze:a&&r,stand:a?o:null}}function va(i){return!!(i?.kleurtemp&&i?.kleur)}function go(i,e,t){let n=t??ne(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(ca.slice(1).some(r=>i[r]!==void 0))return we}let a=e?.attributes?.color_mode;return a===In&&n.kleurtemp?"wit":Vn.includes(a)&&n.kleur?we:"wit"}function _a(i,e,t,n){let a=n??ne(t);return va(a)?e==="wit"?Kn(i,Wn(i,t,a),t,a):Un(i,Mt(i,t,a),t,a):i}function xa(i){let e=S(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function ka(i){let e=S(i,1,100);return S(Math.round(e/100*255),1,255)}var fo=1e3,bo=4e4,da=7;function vo(i){let e=S(i,fo,bo)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[S(t,0,255),S(n,0,255),S(a,0,255)]}function _o(i){let[e,t,n]=vo(i);return`rgb(${e}, ${t}, ${n})`}function wa(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:da},(r,o)=>{let s=o/(da-1),l=t+(n-t)*s;return`${_o(l)} ${Math.round(s*100)}%`}).join(", ")})`}function xo(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?S(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===In&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=S(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Vn.includes(a)&&Pn(t.hs_color)&&(n.hs_color=[S(t.hs_color[0],0,360),S(t.hs_color[1],0,100)]),n}function qn(i,e,t){return i&&i.state==="on"?{...i}:pa(e,t)}function ya(i){for(let e of ca)delete i[e]}function Pn(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function S(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Tt="domotiapp-scene-card",Fn="domotiapp-scene-card-editor",$a="domotiapp-scene-editor";var Xe=["een","twee","drie"],ja="pencil",Ea=["grid_options","layout_options","view_layout","visibility"];var za="entity_id",Se=class extends I{constructor(){super();k(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));k(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[za]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[za];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return _;let t=this._leden();return g`
      <ha-form
        .hass=${this.hass}
    ...
    `}_renderInhoud(){return this._toestand===Xn?g`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Aa?g`
        <div class="inhoud">
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),a=this._waardeVan(e),r=Gn(a,t,n),o=ba(a,t,n);return g`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
            ...
            ${Bn(a)?_:g`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?g`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,ha(a,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:_}
        </div>
    ...
    `}_renderHelderheid(e,t,n,a){let r=xa(ma(a,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,ua(this._waardeVan(e),ka(s.detail.value),t,n))};return g`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,a,r){let o=s=>l=>{l.stopPropagation(),s!==r&&this._zetLamp(e,_a(this._waardeVan(e),s,t,n))};return g`
    ...
    `}_renderKleurtemp(e,t,n,a){let r=Wn(a,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Kn(this._waardeVan(e),s.detail.value,t,n))};return g`
      <div class="besturing">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${wa(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,a){let[r,o]=Mt(a,t,n),s=l=>d=>{d.stopPropagation();let c=Mt(this._waardeVan(e),t,n),u=l==="tint"?[d.detail.value,c[1]]:[c[0],d.detail.value];this._zetLamp(e,Un(this._waardeVan(e),u,t,n))};return g`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${jo}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}_icoon(e){let t=document.createElement("template");return t.innerHTML=b(e),t.content.cloneNode(!0)}_renderKaart(){let e=this._toestand===Qn,t=this._toestand===Jn,n=this._iconen();return g`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${n.map((a,r)=>g`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Ye)return _;let e=ga(this._scenes,this._leden,3).length,t=fa(e);return t?g`<div class="mededeling">${t}</div>`:_}_renderEditor(){return g`
    ...
    `]);N(Tt,Je);N(Fn,Se);N($a,Ae);$e({type:Tt,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${Eo}).`,preview:!1});var ye="domotiapp-alarm-card",ti="domotiapp-alarm-card-editor",Na="domotiapp-alarm-editor",Oa="DomotiApp Wekker",Ca="https://github.com/Sven2410/domotiapp-lovelace",ie="domotiapp_lovelace",X=Object.freeze({get:`${ie}/alarms/get`,save:`${ie}/alarms/save`,setEnabled:`${ie}/alarms/set_enabled`,delete:`${ie}/alarms/delete`,stop:`${ie}/alarms/stop`,clearMessage:`${ie}/alarms/clear_message`,search:`${ie}/sound/search`,entities:`${ie}/entities/list`,previewStart:`${ie}/preview/start`,subscribe:`${ie}/updates/subscribe`}),Ct="#026FA1";function La(i){let e=typeof i?.name=="string"?i.name.trim():"",t=typeof i?.time=="string"?i.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var So="07:00";var Ao=["uri","name","media_type","image"],Mo="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",To="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var No="Music Assistant Wekker",Oo="Verlichting Wekker";function Lt(){return{id:null,name:"",time:So,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Da(i){let e=Lt();return!i||typeof i!="object"?e:{id:typeof i.id=="string"?i.id:null,name:typeof i.name=="string"?i.name:"",time:ni(i.time)?i.time:e.time,days:Array.isArray(i.days)?[...i.days]:[],enabled:i.enabled!==!1,sound:Qe(i.sound),endless:null,speaker:typeof i.speaker=="string"?i.speaker:"",volume_pct:Number.isInteger(i.volume_pct)?i.volume_pct:e.volume_pct,light:i.light&&typeof i.light=="object"?{entity_id:i.light.entity_id,brightness_pct:Number.isInteger(i.light.brightness_pct)?i.light.brightness_pct:60}:null}}function Qe(i){if(!i||typeof i!="object"||Array.isArray(i)||typeof i.uri!="string"||!i.uri)return null;let e={};for(let t of Ao)e[t]=i[t]===void 0?null:i[t];return e}function ni(i){if(typeof i!="string"||i.length!==5||i[2]!==":")return!1;let e=Number(i.slice(0,2)),t=Number(i.slice(3));return!/^\d\d$/.test(i.slice(0,2))||!/^\d\d$/.test(i.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ii(i){let e=[];return!i||typeof i!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof i.name!="string"||!i.name.trim())&&e.push("een naam"),ni(i.time)||e.push("een geldige tijd"),i.speaker||e.push("een speaker"),(!i.sound||!i.sound.uri)&&e.push("een geluid"),(!Number.isInteger(i.volume_pct)||i.volume_pct<1||i.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Ra(i){let e=[...new Set(i.days||[])].sort((n,a)=>n-a),t={name:(i.name||"").trim(),time:i.time,days:e,enabled:e.length===0?!0:i.enabled!==!1,sound:Qe(i.sound),speaker:i.speaker,volume_pct:i.volume_pct,light:i.light?{entity_id:i.light.entity_id,brightness_pct:i.light.brightness_pct}:null};return i.id&&(t.id=i.id),t}function Ha(i,e){let t=new Set(i||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,a)=>n-a)}function Pa(i){return ni(i)&&i.slice(0,2)==="02"?Mo:null}function Va(i){return i===!1?To:null}function Ia(i){return typeof i?.endless=="boolean"?i.endless:null}function Dt(i,e){let t=e==="lamp",n=t?Oo:No,a=t?"lampen":"speakers";return!i||typeof i!="object"?`De lijst met ${a} is niet op te halen.`:i.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${a} zetten die als wekker mogen dienen.`:Array.isArray(i.entities)&&i.entities.length>0?null:Number(i.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${a} met het label '${n}'.`}function Ka(i,e){return Dt(e,"speaker")!==null?!1:ii(i).ok}var Lo=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Do=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],et="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ro="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Ho="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Me=class extends I{constructor(){super(),this._concept=Lt(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Da(this.wekker):Lt(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:X.previewStart,speaker:this._concept.speaker,sound:Qe(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:X.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:Qe(e),endless:Ia(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ii(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:X.save,person:this.person,alarm:Ra(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return g`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return _;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,a=Dt(t,"speaker"),r=Dt(n,"lamp"),o=Pa(e.time),s=Va(e.endless),l=Ka(e,t);return g`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Lo.map(([d,c])=>g`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Ha(e.days,d)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Do.map(([d,c])=>g`<option value=${d}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
  ...
  `]);var Ua="person",Po="Kies een persoon in de kaartinstellingen.",Wa="De gekozen persoon is niet gevonden.",Vo="De opgeslagen wekkers van deze persoon zijn onleesbaar.",gc=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Ba(i){if(!i||typeof i!="object"||Array.isArray(i))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=i.person;if(e==null||e==="")return{...i};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Ua}.`))throw new Error(`'${e}' zit niet in het domein ${Ua}. Kies een persoon, zoals person.sven.`);return{...i}}function Ga(i){return{type:`custom:${i}`}}function qa(i,e){return i?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Wa,isFout:!0}:{soort:"ontbreekt",tekst:Po,isFout:!1}}function Fa(i,e){return i==="not_found"?Wa:i==="home_assistant_error"?Vo:e||"Er ging iets mis bij het ophalen van de wekkers."}var Io=["ma","di","wo","do","vr","za","zo"],Ko="Geen wekkers ingesteld",Uo="Eenmalig",Wo="Eenmalig \u2014 afgelopen",Bo="Geen wekker actief",Za="Stoppen",Go="Er is een melding over deze wekker, maar de tekst ontbreekt.";function qo(i){return!Array.isArray(i)||i.length===0?Uo:[...new Set(i)].sort((t,n)=>t-n).map(t=>Io[t-1]??"?").join(" ")}function Fo(i,e){return!i||Array.isArray(i.days)&&i.days.length>0?!1:Date.parse(i?.one_shot_at??"")<=e}function Xa(i,e){return Fo(i,e)?Wo:qo(i?.days)}function Ya(i){let e=i?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Go,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function Ja(i){let e=i?.alarms;if(!Array.isArray(e)||e.length===0)return Ko;let t=i?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Bo}function Qa(i,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(i??[]).find(s=>s?.id===o)).filter(Boolean),a=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:a.length?a.join(" en "):"Wekker",tijd:r.join(" en ")}}var Zo="0.8.0",Xo="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Yo="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",er="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Jo="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",Rt=(i,e="icoon")=>g`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${i} />
  </svg>`,tt=class extends I{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null}setConfig(e){let t=Ba(e),n=t.person!==this._config?.person;this._config=t,n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(ti)}static getStubConfig(){return Ga(ye)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?Z(e):null),q(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:X.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${ye}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${ye}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let a=new Set(this._toestand.ringing??[]);n==="started"?a.add(t):a.delete(t),this._toestand={...this._toestand,ringing:[...a]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:X.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null}catch(t){if(this._config?.person!==e)return;this._toestand=null,this._fout=Fa(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:X.entities})}catch(t){this._entiteiten=null,console.warn(`${ye}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:X.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:X.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:X.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:X.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?Qa(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return _;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=qa(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let a=this._stop();return this._editorVoor!==void 0&&!a?g`<div class="card surface">
    ...
    `}_bevestiging(e){return g`<div class="onderrij bevestiging">
      <span class="boodschap">${La(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=Ya(e),a=!!e.enabled;return g`
      <div class="rij ${a?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
  ...
  `]),k(Te,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var ai=Te;N(ye,tt);N(ti,ai);N(Na,Me);$e({type:ye,name:Oa,description:`Wekkerkaart van DomotiApp (v${Zo}).`,preview:!1,documentationURL:Ca});var Qo="0.8.0";mi(i=>console.warn(`domotiapp-lovelace: ${i}`));console.info(`%c DOMOTIAPP-LOVELACE %c ${Qo} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Qo as VERSION};
