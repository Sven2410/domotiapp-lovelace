var us=Object.defineProperty;var ms=(a,e,t)=>e in a?us(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var z=(a,e,t)=>ms(a,typeof e!="symbol"?e+"":e,t);var Z=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function J(a){let e=new CSSStyleSheet;return e.replaceSync(a),e}var yn=null,fi=a=>{yn=a},he=a=>String(a??"").split(".")[0],x=(a,e)=>e&&a?.states?.[e]||null,W=(a,e)=>x(a,e)?.attributes??{},zt=(a,e,t)=>t?null:W(a,e).entity_picture||null;function bi(a){if(!a||a.state!=="on")return null;let e=a.attributes??{};if(Array.isArray(e.entity_id))return null;let t=e.rgb_color;return Array.isArray(t)&&t.length>=3?`rgb(${t[0]},${t[1]},${t[2]})`:null}function C(a,e,t){return t||W(a,e).friendly_name||e||""}var gs=new Set(["scene","script","input_button","button","event"]),zn=a=>gs.has(he(a));function ee(a){return!a||a.state==="unavailable"?!0:a.state==="unknown"?!zn(a.entity_id):!1}function ke(a){if(!a)return!1;let e=a.state;if(e==="unavailable"||e==="unknown")return!1;switch(he(a.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}var fs=new Set(["light","switch","fan","input_boolean","automation","siren","humidifier","remote","water_heater"]),vi=a=>fs.has(he(a));function ki(a,e,t){if(!a||a.themes!==e.themes||a.language!==e.language)return!0;for(let n of t)if(n&&a.states?.[n]!==e.states?.[n])return!0;return!1}function yt(a,e,t={}){a.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var Q=(a,e)=>yt(a,"hass-more-info",{entityId:e});function Xe(a){switch(he(a)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function bs(a){switch(he(a)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function ue(a,e,t,n){if(!(!n||n.action==="none")){if(n.confirmation){let i=n.confirmation===!0?{}:n.confirmation;if(!yn){console.warn("DomotiApp: geen bevestigingsscherm geladen; de actie is niet uitgevoerd.");return}yn(i).then(r=>{r&&ui(a,e,t,n)});return}ui(a,e,t,n)}}function ui(a,e,t,n){switch(n.action){case"more-info":Q(a,n.entity||t.entity);break;case"toggle":{let i=n.entity||t.entity;if(!i)break;let[r,o]=bs(i);e.callService(r,o,{entity_id:i});break}case"perform-action":case"call-service":{let i=n.perform_action||n.service;if(!i)break;let[r,o]=i.split(".");e.callService(r,o,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),yt(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":yt(a,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":yt(a,"ll-custom",n);break;default:break}}function R(a,{onTap:e,onHold:t,onDouble:n}){let o=0,s=0,d=null,l=p=>{p.button!=null&&p.button!==0||(o=Date.now())},c=()=>{let p=o?Date.now()-o:0;if(o=0,t&&p>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(s++,s===1){d=setTimeout(()=>{s=0,e?.()},260);return}clearTimeout(d),s=0,n()};return a.addEventListener("pointerdown",l),a.addEventListener("click",c),a.addEventListener("contextmenu",p=>p.preventDefault()),()=>{clearTimeout(d),a.removeEventListener("pointerdown",l),a.removeEventListener("click",c)}}function Y(a,e){if(!e)return"";let t=he(e.entity_id),n=e.attributes.device_class;return a.formatEntityState?.(e)??a.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??a.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function q(a,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(a?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var mi=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],xi=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],gi=(a=new Date)=>new Date(a.getFullYear(),a.getMonth(),a.getDate()),jn=(a,e)=>Math.round((gi(e)-gi(a))/864e5);function Qe(a){if(!a)return null;if(a instanceof Date)return Number.isNaN(+a)?null:a;let e=String(a).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function En(a,e=new Date){if(!a)return"";let t=jn(e,a);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?mi[a.getDay()]:`${mi[a.getDay()].slice(0,2)} ${a.getDate()} ${xi[a.getMonth()]}`}var _i=a=>a?`${a.getDate()} ${xi[a.getMonth()]}`:"";function vs(a){let e=Math.max(1,Math.ceil((a+8)/64));return e*56+(e-1)*8}function ks(a){if(!a)return 0;let e=getComputedStyle(a),t=[...a.children].filter(r=>r.getBoundingClientRect().height>0);if(!t.length)return 0;let n=parseFloat(e.rowGap)||0;return t.reduce((r,o)=>r+o.getBoundingClientRect().height,0)+n*(t.length-1)+parseFloat(e.paddingTop)+parseFloat(e.paddingBottom)+parseFloat(e.borderTopWidth)+parseFloat(e.borderBottomWidth)}function L(a,e=4){if(!a)return;let t=ks(a);if(!t){e>0&&requestAnimationFrame(()=>L(a,e-1));return}let n=`${vs(t)}px`;a.style.getPropertyValue("--dac-raster")!==n&&a.style.setProperty("--dac-raster",n)}function Ie(a){let e=parseFloat(a?.style?.getPropertyValue?.("--dac-raster")??"");return!Number.isFinite(e)||e<=0?null:Math.max(1,Math.round((e+8)/64))}function K(a){if(!a||typeof ResizeObserver>"u")return()=>{};let e=new ResizeObserver(()=>{for(let t of a.children)e.observe(t);L(a)});e.observe(a);for(let t of a.children)e.observe(t);return L(a),()=>e.disconnect()}var xs="home-assistant";function wi({leesRegistry:a,definities:e,waarschuw:t=()=>{},plan:n=(d,l)=>setTimeout(d,l),nu:i=()=>Date.now(),marker:r=xs,intervalMs:o=20,maxWachtMs:s=1e4}){let d=i();function l(){let h=a();if(!h)return!1;for(let[g,m]of e)try{h.get(g)||h.define(g,m)}catch(v){t(`kon ${g} niet registreren: ${v&&v.message}`)}return!0}function c(){let h=a();return!h||!h.get(r)?!1:l()}if(c())return!0;let p=()=>{if(!c()){if(i()-d>=s){t(`${r} is na ${s} ms niet verschenen; de kaart wordt alsnog geregistreerd`),l();return}n(p,o)}};return n(p,o),!1}var yi=[];function M(a,e){yi.push([a,e])}function Re({type:a,name:e,description:t,preview:n=!0,documentationURL:i}){window.customCards=window.customCards??[],!window.customCards.some(r=>r.type===a)&&window.customCards.push({type:a,name:e??a,description:t??"",preview:n,documentationURL:i??"https://github.com/Sven2410/domotiapp-lovelace"})}function zi(a=()=>{}){wi({leesRegistry:()=>globalThis.customElements,definities:yi,waarschuw:a})}var _s=`
  :host {
    ${Z}
    display: block;
...
`,N={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},Ei={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},B=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),V=(a,e="accent")=>N[a]??(a&&/[#(]|^var/.test(a)?a:N[e]),T=Symbol("incomplete"),ws=a=>`
  <div class="needs">
  ...
  </div>`,ys=56,ji=8,me=a=>Math.max(1,Math.ceil((a+ji)/(ys+ji))),S=class extends HTMLElement{static get styleSheets_(){return Object.hasOwn(this,"sheets_")||(this.sheets_=[J(_s+ve+this.css)]),this.sheets_}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=new.target.styleSheets_,this.built_=!1,this.wired_=!1,this.teardown_=[],this.bewaakFocusRing_()}bewaakFocusRing_(){let e=0,t=0;this.shadowRoot.addEventListener("pointerdown",()=>{e=Date.now()},!0),this.shadowRoot.addEventListener("keydown",()=>{t=Date.now()},!0),this.shadowRoot.addEventListener("focusin",n=>{if(t>=e)return;let i=n.target;!i?.matches||i.matches("input, textarea, select, [contenteditable]")||requestAnimationFrame(()=>{t>=e||i.isConnected&&i.matches(":focus-visible")&&i.blur?.()})},!0)}setConfig(e){let t=this.validate(e??{});this.config=t,this.built_&&(this.destroy_(),this.shadowRoot.replaceChildren(),this.built_=!1,this.wired_=!1),this.isConnected&&this.build_()}set hass(e){let t=this.hass_;if(this.hass_=e,!!this.config){if(!this.built_){this.build_();return}this.config[T]||ki(t,e,this.watched())&&this.paint()}}get hass(){return this.hass_}connectedCallback(){if(this.config){if(!this.built_){this.build_();return}this.config[T]||this.wired_||(this.wire(),this.wired_=!0,this.hass_&&this.paint())}}disconnectedCallback(){this.destroy_(),this.wired_=!1}validate(e){return e}watched(){return this.config?.entity?[this.config.entity]:[]}template(){return""}wire(){}paint(){}build_(){let e=document.createElement("template"),t=this.config?.[T];if(e.innerHTML=t?ws(t):this.template(),this.shadowRoot.appendChild(e.content),this.built_=!0,t){this.teardown_.push(K(this.$(".needs")));return}this.wire(),this.wired_=!0,this.hass_&&this.paint()}destroy_(){for(let e of this.teardown_)try{e()}catch{}this.teardown_=[]}on(e,t,n,i){e&&(e.addEventListener(t,n,i),this.teardown_.push(()=>e.removeEventListener(t,n,i)))}$(e){return this.shadowRoot.querySelector(e)}$$(e){return[...this.shadowRoot.querySelectorAll(e)]}text(e,t){let n=typeof e=="string"?this.$(e):e;n&&n.textContent!==String(t)&&(n.textContent=t)}getCardSize(){return 1}minRijen_(e=".card",t=1){return Ie(this.$(e))??t}};z(S,"css","");function O(a,e,{name:t,description:n,preview:i=!0}={}){M(a,e),Re({type:a,name:t,description:n,preview:i})}function I(a,e){M(a,e)}var u=(a,e="none")=>`<svg class="icon" viewBox="0 0 24 24" fill="${e}" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${a}</svg>`,E={house:u(`<path d="M3.2 11.3 12 4.1l8.8 7.2"/>
...
`,Sn=null,Si=a=>a.map(([e,t])=>`
      <div class="group">
        <h4>${e}</h4>
        <div class="grid">
          ${t.map(n=>`<button type="button" class="opt" data-icon="${n}" title="${xe(n)} (${n})" aria-pressed="false">${E[n]??""}<span class="naam">${xe(n)}</span></button>`).join("")}
        </div>
      </div>`).join(""),Mn=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Sn=Sn??[J($s)],this.shadowRoot.adoptedStyleSheets=Sn,this.value_="",this.vraag_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
...
`,Nn=null,On=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),Nn=Nn??[J(Ss)],this.shadowRoot.adoptedStyleSheets=Nn,this.value_="",this.label="Kleur"}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}kleur_(){return N[this.value_]??this.value_}build_(){this.shadowRoot.innerHTML=`
      ...
      </div>`;let e=this.$('input[type="color"]');e.addEventListener("input",()=>this.emit_(e.value));let t=this.$("#vrij");t.addEventListener("change",()=>{let n=t.value.trim();if(!n){this.emit_("");return}let i=As.test(n);t.setAttribute("aria-invalid",String(!i)),i&&this.emit_(n)}),this.$(".wissen").addEventListener("click",()=>this.emit_("")),this.paint_()}paint_(){if(!this.shadowRoot.firstElementChild)return;this.$(".label").textContent=this.label??"Kleur";let e=!!this.value_,t=this.$(".sw");t.setAttribute("aria-pressed",String(e)),t.classList.toggle("leeg",!e),t.style.setProperty("--c",e?this.kleur_():"transparent"),t.title=e?`Kleur: ${Ei[this.value_]??this.value_}`:"Kleur kiezen",/^#[0-9a-f]{6}$/i.test(this.kleur_())&&(this.$('input[type="color"]').value=this.kleur_()),this.$(".wissen").hidden=!e;let n=this.$("#vrij");if(this.shadowRoot.activeElement!==n){let i=this.value_ in N?"":this.value_;n.value!==i&&(n.value=i),n.setAttribute("aria-invalid","false")}}emit_(e){this.value_=e??"",this.paint_(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value_},bubbles:!0,composed:!0}))}$(e){return this.shadowRoot.querySelector(e)}};M("dac-tone-picker",On);var _={entity:a=>({entity:a?{domain:a}:{}}),text:()=>({text:{}}),multiline:()=>({text:{multiline:!0}}),bool:()=>({boolean:{}}),number:(a,e,t=1)=>({number:{min:a,max:e,step:t,mode:"box"}}),select:a=>({select:{mode:"dropdown",options:a}}),action:(a="more-info")=>({ui_action:{default_action:a}})},Cn=(...a)=>({type:"grid",name:"",schema:a});var Ms=[{name:"bare",selector:_.bool()}],Ns={bare:"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan, zodat de kaart nog een vorm heeft op een dashboard zonder vlakken."},D=class extends HTMLElement{constructor(){super(),this.config_={},this.built_=!1}setConfig(e){this.config_={...this.defaults(),...e},this.render_()}defaults(){return{}}set hass(e){this.hass_=e,this.form_&&(this.form_.hass=e);for(let t of this.pickers_??[])t.hass=e;this.render_()}get hass(){return this.hass_}connectedCallback(){this.render_()}schema(){return[]}gedeeldeVelden(){return Ms}volledigSchema_(){return[...this.schema(),...this.gedeeldeVelden()]}pickers(){return[]}label(e){return Os[e.name]??e.name}helper(){}async render_(){if(!this.hass_||!this.config_)return;if(this.built_){this.sync_();return}this.built_=!0,await customElements.whenDefined("ha-form"),this.replaceChildren(),this.pickers_=[];let e=this.pickers();this.pickerSig_=e.map(o=>o.key).join("|");let t=o=>{let s=document.createElement("div");return s.style.cssText=`display:flex;flex-direction:column;gap:12px;${o}`,s},n=t("margin-bottom:16px"),i=t("margin-top:16px");for(let o of e){let s=document.createElement(o.kind==="tone"?"dac-tone-picker":"dac-icon-picker");s.label=o.label,s.fallback=o.fallback,o.auto===!1&&(s.auto=!1),o.statuses===!1&&(s.statuses=!1),o.compact&&(s.compact=!0),s.hass=this.hass_,s.value=this.config_[o.key],s.addEventListener("value-changed",d=>{d.stopPropagation(),this.patch_({[o.key]:d.detail.value})}),this.pickers_.push(s),s.dataset.key=o.key,(o.after?i:n).appendChild(s)}n.children.length&&this.appendChild(n);let r=document.createElement("ha-form");r.hass=this.hass_,r.data=this.config_,r.schema=this.volledigSchema_(),r.computeLabel=o=>this.label(o),r.computeHelper=o=>this.helper(o)??Ns[o.name],r.addEventListener("value-changed",o=>{o.stopPropagation(),this.patch_(o.detail.value,!0)}),this.form_=r,this.appendChild(r),i.children.length&&this.appendChild(i)}sync_(){let e=this.pickers().map(t=>t.key).join("|");if(this.pickerSig_!==void 0&&this.pickerSig_!==e){this.built_=!1,this.form_=null,this.render_();return}this.form_&&(this.form_.hass=this.hass_,this.form_.schema=this.volledigSchema_(),this.form_.data=this.config_);for(let t of this.pickers_??[])t.hass=this.hass_,t.value=this.config_[t.dataset.key]}patch_(e,t=!1){let n=t?{...e}:{...this.config_,...e};this.config_.type&&(n.type=this.config_.type);for(let[i,r]of Object.entries(n))(r===""||r===void 0||r===null)&&delete n[i];this.config_=n,this.sync_(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.serialize(n)},bubbles:!0,composed:!0}))}serialize(e){return e}},Os={entity:"Entiteit",entities:"Entiteiten",name:"Naam",icon:"Icoon",tone:"Kleur",secondary:"Tweede regel",layout:"Vorm",tap_action:"Tikken",hold_action:"Vasthouden",double_tap_action:"Dubbeltikken",show_state:"Status tonen",show_name:"Naam tonen",show_icon:"Icoon tonen",fill:"Vullen",collapsible:"Inklapbaar",title:"Titel",subtitle:"Ondertitel",weather:"Weerentiteit",sun:"Zon-entiteit",person:"Persoon",persons:"Personen",covers:"Rolluiken",lights:"Lampen",sensors:"Sensoren",greeting:"Begroeting",show_clock:"Klok tonen",show_weather:"Weer tonen",show_chips:"Weerdetails tonen",compact:"Compact",columns:"Kolommen",group:"Groepsregel tonen",invert:"Open en dicht omdraaien",label:"Label",color:"Kleur",date_format:"Datumnotatie",bare:"Achtergrond weglaten"};function Cs(a=new Date){let e=a.getHours();return e<6?"Goedenacht":e<12?"Goedemorgen":e<18?"Goedemiddag":"Goedenavond"}var Ts=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],Ls=["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"],Tn={humidity:{icon:"drop",tone:"water",label:"Luchtvochtigheid"},wind:{icon:"wind",tone:"neutral",label:"Wind"},uv:{icon:"uv",tone:"solar",label:"UV-index"},precipitation:{icon:"rain",tone:"water",label:"Neerslag"},pressure:{icon:"gaugeArrow",tone:"neutral",label:"Luchtdruk"},sunrise:{icon:"sunrise",tone:"warn",label:"Zonsopkomst"},sunset:{icon:"sunset",tone:"warn",label:"Zonsondergang"}},Ds=["humidity","wind","uv","precipitation","sunset"],Hs=a=>a==null||Number.isNaN(+a)?"":["N","NO","O","ZO","Z","ZW","W","NW"][Math.round(+a/45)%8],Et=class extends S{validate(e){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768,...e}}watched(){let e=this.config;return[e.weather,e.weather_uv,e.sun,e.precipitation_entity].filter(Boolean)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.show_rule===!1&&this.setAttribute("no-rule",""),`
      <div class="strip">
        <div class="who">
          <div class="hello"></div>
          <div class="date"></div>
      ...
      </div>`}wire(){let e=()=>{let n=6e4-Date.now()%6e4+50;this.timer_=setTimeout(()=>{this.paintClock_(),e()},n)};e(),this.teardown_.push(()=>clearTimeout(this.timer_));let t=Number(this.config.hide_below)||0;if(t>0){let n=matchMedia(`(max-width: ${t-1}px)`),i=()=>this.toggleAttribute("narrow",n.matches);i(),n.addEventListener("change",i),this.teardown_.push(()=>n.removeEventListener("change",i))}}paintClock_(){let e=new Date,t=this.config.name??this.hass?.user?.name??"",n=Cs(e);this.$(".hello").innerHTML=t?`${n}, <b>${t}</b>`:n,this.text(".date",`${Ts[e.getDay()]} ${e.getDate()} ${Ls[e.getMonth()]}`);let i=this.$(".clock");i&&this.text(i,e.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"}))}paint(){this.paintClock_();let e=this.config,t=x(this.hass,e.weather),n=W(this.hass,e.weather),i=this.$(".now");if(i&&t){let d=Ye(t.state);i.style.setProperty("--wtone",V(e.tone,"water"));let l=this.hass?.config?.unit_system?.temperature??"\xB0C";this.$(".temp").innerHTML=n.temperature!=null?`${q(this.hass,n.temperature,0)}<span>${l}</span>`:"--";let c=i.querySelector(".ic");c.dataset.icon!==d&&(c.dataset.icon=d,c.innerHTML=f(d,"cloud")),this.text(i.querySelector(".cond"),Y(this.hass,t))}let r=this.$(".chips");if(!r)return;let o=Ds.map(d=>this.chip_(d,n)).filter(Boolean),s=o.map(d=>`${d.key}${d.value}`).join("|");r.dataset.sig!==s&&(r.dataset.sig=s,r.innerHTML=o.map(d=>`<span class="chip2" style="--tone:${V(Tn[d.key].tone)}" title="${Tn[d.key].label}">
             ${E[Tn[d.key].icon]??""}${d.value}
           </span>`).join(""))}chip_(e,t){let n=this.config;switch(e){case"humidity":return t.humidity!=null?{key:e,value:`${Math.round(t.humidity)}%`}:null;case"wind":{if(t.wind_speed==null)return null;let i=this.hass?.config?.unit_system?.wind_speed??"km/h",r=Hs(t.wind_bearing);return{key:e,value:`${q(this.hass,t.wind_speed,0)} ${i}${r?` ${r}`:""}`}}case"uv":{let r=W(this.hass,n.weather_uv).uv_index??t.uv_index??(n.weather_uv?Number(x(this.hass,n.weather_uv)?.state):null);return r!=null&&!Number.isNaN(+r)?{key:e,value:`UV ${q(this.hass,r,1)}`}:null}case"precipitation":{let i=x(this.hass,n.precipitation_entity);if(i){let r=Number(i.state);if(Number.isNaN(r))return null;let o=i.attributes.unit_of_measurement??"mm";return{key:e,value:`${q(this.hass,r,1)} ${o}`}}return t.precipitation!=null&&!Number.isNaN(+t.precipitation)?{key:e,value:`${q(this.hass,t.precipitation,1)} mm`}:null}case"pressure":return t.pressure!=null?{key:e,value:`${q(this.hass,t.pressure,0)} ${t.pressure_unit??"hPa"}`}:null;case"sunset":case"sunrise":{let r=x(this.hass,n.sun)?.attributes?.[e==="sunset"?"next_setting":"next_rising"];if(!r)return null;let o=new Date(r);return Number.isNaN(+o)?null:{key:e,value:o.toLocaleTimeString(this.hass?.locale?.language??"nl",{hour:"2-digit",minute:"2-digit"})}}default:return null}}getCardSize(){return 2}getGridOptions(){return{columns:"full",rows:2,min_rows:2,max_rows:2}}static getConfigElement(){return document.createElement("domotiapp-header-card-editor")}static getStubConfig(e){return{weather:Object.keys(e?.states??{}).find(n=>n.startsWith("weather.")),sun:"sun.sun"}}};z(Et,"css",`
  ...
  `);var Ln=class extends D{defaults(){return{show_clock:!0,show_weather:!0,show_chips:!0,show_rule:!0,hide_below:768}}schema(){return[Cn({name:"weather",selector:_.entity("weather")},{name:"weather_uv",selector:{entity:{domain:["weather","sensor"]}}}),Cn({name:"sun",selector:_.entity("sun")},{name:"precipitation_entity",selector:_.entity("sensor")}),{name:"name",selector:_.text()},{name:"hide_below",selector:_.number(0,1400,8)}]}label(e){return{weather:"Weer (temperatuur, wind)",weather_uv:"Tweede weerbron (UV-index)",precipitation_entity:"Neerslagsensor",show_rule:"Accentlijn tonen",hide_below:"Verbergen onder breedte (px)",name:"Naam"}[e.name]??super.label(e)}helper(e){if(e.name==="weather_uv")return"Alleen voor de UV-index. Handig als je hoofdbron die niet meelevert.";if(e.name==="precipitation_entity")return"Een sensor in mm of mm/h, bijvoorbeeld neerslagintensiteit of regen laatste uur.";if(e.name==="hide_below")return"768 verbergt de header op telefoons en houdt hem op tablets en desktops. 0 zet het uit.";if(e.name==="name")return"Leeg laten voor de naam van de ingelogde gebruiker."}};I("domotiapp-header-card-editor",Ln);O("domotiapp-header-card",Et,{name:"DomotiApp Header",description:"Smalle strip met begroeting, weer en klok. Verbergt zichzelf op telefoons."});var $t=class extends S{validate(e){return{icon:"",tone:"accent",line:!0,...e}}watched(){return this.config.secondary_entity?[this.config.secondary_entity]:[]}template(){let e=this.config,t=e.icon!==null&&e.icon!==!1;return t||this.setAttribute("no-icon",""),`
      ...
      </div>`}paint(){this.text("h3",this.config.name??"");let e=this.$(".sub");if(!e)return;let t=x(this.hass,this.config.secondary_entity),n=e.querySelector(".si"),i=e.querySelector(".sv");if(!t){i.textContent="",n.innerHTML="";return}let r=this.config.secondary_icon??"";n.dataset.icon!==r&&(n.dataset.icon=r,n.innerHTML=r?f(r):"");let o=t.attributes.unit_of_measurement;i.textContent=o?`${t.state} ${o}`:t.attributes.current_temperature!=null?`${t.attributes.current_temperature} \xB0C`:Y(this.hass,t)}getCardSize(){return 1}getGridOptions(){return{columns:"full",rows:1,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-separator-card-editor")}static getStubConfig(){return{name:"Nieuwe sectie",icon:"house",tone:"accent"}}};z($t,"css",`
    :host { display: block; height: 100%; }
...
`;var Is=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),Rs=new Set(["hs","rgb","rgbw","rgbww","xy"]),Rn=a=>a?.attributes?.supported_color_modes??[],Ps=a=>Rn(a).some(e=>Is.has(e)),At=a=>Rn(a).some(e=>Rs.has(e)),St=a=>Rn(a).includes("color_temp"),Mi=a=>Math.max(1,Math.round((a??0)/255*100)),Mt=class extends S{validate(e){let t=e.entity??e.lights?.[0]??e.entities?.[0],n=typeof t=="string"?t:t?.entity;return n?{show_colour:!0,...e,entity:n}:{...e,[T]:"Kies een lamp."}}watched(){return[this.config.entity]}template(){return this.config.bare&&this.setAttribute("bare",""),`
      ...
      </div>`}wire(){let e=this.config.entity;this.teardown_.push(R(this.$(".chip"),{onTap:()=>this.hass.callService("light","toggle",{entity_id:e}),onHold:()=>Q(this,e)})),this.on(this.$(".card"),"click",t=>{t.target.closest(".toggle")&&this.hass.callService("light","toggle",{entity_id:e})}),this.teardown_.push(K(this.$(".card"))),this.sliders_=new Map}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let i=_e(e,n);this.sliders_.set(t,i),this.teardown_.push(i)}setSlider_(e,t,n=0,i=100){if(!e)return;let r=i>n?(t-n)/(i-n)*100:0;e.style.setProperty("--v",`${r}%`),e.setAttribute("aria-valuemin",String(n)),e.setAttribute("aria-valuemax",String(i)),e.setAttribute("aria-valuenow",String(t))}paint(){let e=this.config,t=x(this.hass,e.entity),n=ee(t),i=t?.state==="on",r=this.$(".lamp");r.dataset.on=String(i),r.classList.toggle("unavailable",n);let o=this.$(".chip"),s=e.icon||"bulb";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=f(s,"bulb")),this.text(".nm",C(this.hass,e.entity,e.name));let d=i?t?.attributes?.rgb_color:null;r.style.setProperty("--tone",d?`rgb(${d[0]},${d[1]},${d[2]})`:"var(--dac-lit)");let l=this.$(".ctl"),c=n?"none":Ps(t)?"range":"toggle";if(l.dataset.kind!==c&&(l.dataset.kind=c,l.innerHTML=c==="range"?se("brightness"):c==="toggle"?'<button class="toggle" type="button" role="switch" aria-checked="false" aria-label="Aan of uit"></button>':"",this.sliders_.delete("brightness")),c==="range"){let p=l.querySelector(".slider");if(this.attach_(p,"brightness",{value:()=>t?.state==="on"?Mi(x(this.hass,e.entity)?.attributes?.brightness):0,onInput:h=>{this.setSlider_(p,h),this.text(".v",h===0?"Uit":`${h}%`)},onCommit:h=>{h===0?this.hass.callService("light","turn_off",{entity_id:e.entity}):this.hass.callService("light","turn_on",{entity_id:e.entity,brightness_pct:h})},disabled:()=>ee(x(this.hass,e.entity))}),!p.classList.contains("dragging")){let h=i?Mi(t.attributes.brightness):0;this.setSlider_(p,h),this.text(".v",i?`${h}%`:"Uit")}}else c==="toggle"?(l.querySelector(".toggle")?.setAttribute("aria-checked",String(i)),this.text(".v",i?"Aan":"Uit")):this.text(".v","Niet bereikbaar");this.paintColour_(t,i),L(this.$(".card"))}paintColour_(e,t){let n=this.$(".colour"),i=this.config.show_colour!==!1&&(At(e)||St(e));if(n.hidden=!(i&&t),!i)return;let r=`${At(e)?"c":""}${St(e)?"t":""}`;if(n.dataset.sig!==r){n.dataset.sig=r,n.innerHTML=(At(e)?`<span data-kind="hue" style="display:contents">${se("hue")}</span>`:"")+(St(e)?`<span data-kind="kelvin" style="display:contents">${se("kelvin")}</span>`:"");let l=n.querySelector(".slider.hue");l&&(l.dataset.strip="",l.style.setProperty("--strip","linear-gradient(90deg, hsl(0 90% 55%), hsl(60 90% 55%), hsl(120 90% 55%), hsl(180 90% 55%), hsl(240 90% 55%), hsl(300 90% 55%), hsl(360 90% 55%))"),l.setAttribute("aria-label","Kleur"));let c=n.querySelector(".slider.kelvin");c&&(c.dataset.strip="",c.style.setProperty("--strip","linear-gradient(90deg,#ffb15e,#ffd6a8,#fff5e8,#eaf1ff,#cbdcff)"),c.setAttribute("aria-label","Kleurtemperatuur")),this.sliders_.delete("hue"),this.sliders_.delete("kelvin")}if(!t)return;let o=this.config.entity,s=n.querySelector(".slider.hue");s&&(this.attach_(s,"hue",{min:0,max:360,value:()=>x(this.hass,o)?.attributes?.hs_color?.[0]??0,onInput:l=>this.setSlider_(s,l,0,360),onCommit:l=>{let c=x(this.hass,o)?.attributes?.hs_color?.[1]??100;this.hass.callService("light","turn_on",{entity_id:o,hs_color:[l,c]})}}),s.classList.contains("dragging")||this.setSlider_(s,Math.round(e.attributes.hs_color?.[0]??0),0,360));let d=n.querySelector(".slider.kelvin");if(d){let l=e.attributes.min_color_temp_kelvin??2e3,c=e.attributes.max_color_temp_kelvin??6500;if(this.attach_(d,"kelvin",{min:l,max:c,step:50,value:()=>x(this.hass,o)?.attributes?.color_temp_kelvin??l,onInput:p=>this.setSlider_(d,p,l,c),onCommit:p=>this.hass.callService("light","turn_on",{entity_id:o,color_temp_kelvin:p})}),!d.classList.contains("dragging")){let p=e.attributes.color_temp_kelvin;p!=null&&this.setSlider_(d,p,l,c)}}}getCardSize(){let e=x(this.hass,this.config?.entity);return e?.state==="on"&&(At(e)||St(e))?2:1}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:this.minRijen_(".card",1)}}static getConfigElement(){return document.createElement("domotiapp-light-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("light."));return n?{entity:n}:{}}};z(Mt,"css",`
    :host { display: block; }
  ...
  `);var In=class extends D{defaults(){return{show_colour:!0}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"bulb"}]}schema(){return[{name:"entity",selector:_.entity("light")},{name:"name",selector:_.text()},{name:"show_colour",selector:_.bool()}]}label(e){return{entity:"Lamp",name:"Naam (overschrijft die van de lamp)",show_colour:"Kleurstrips tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"E\xE9n lamp per kaart. Dimbaar krijgt een schuif, alleen schakelbaar een tuimelaar.";if(e.name==="show_colour")return"Kleur en kleurtemperatuur verschijnen zodra de lamp aan is. De kaart is dan twee rijen hoog."}};I("domotiapp-light-card-editor",In);O("domotiapp-light-card",Mt,{name:"DomotiApp Verlichting",description:"E\xE9n lamp op \xE9\xE9n rasterrij: dimmen, kleur en kleurtemperatuur."});function Ni(a){if(!a)return null;let e=Number(a.state);return Number.isFinite(e)?e:null}function Vs(a){let e=a?.attributes?.hvac_action;return e||(a?.state==="off"?"off":a?.state==="cool"?"cooling":a?.state==="heat"?"idle":null)}var Pn={heating:"var(--dac-solar)",cooling:"var(--dac-grid-in)",drying:"var(--dac-grid-in)",fan:"var(--dac-grid-in)"},Oi={heating:"Verwarmt",cooling:"Koelt",drying:"Ontvochtigt",fan:"Ventileert",idle:"Uit",off:"Uit"},Nt=class extends S{validate(e){return e.entity||e.temperature||e.humidity?{...e}:{...e,[T]:"Kies een thermostaat, of een temperatuursensor."}}watched(){let e=this.config;return[e.entity,e.temperature,e.humidity].filter(Boolean)}step_(){let e=W(this.hass,this.config.entity);return Number(this.config.step??e.target_temp_step)||.5}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.entity||this.setAttribute("readout",""),`
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(R(this.$(".chip"),{onTap:()=>Q(this,e.entity||e.temperature||e.humidity)}));let t=this.$(".set");t&&t.querySelectorAll("button").forEach(n=>this.on(n,"click",()=>this.nudge_(Number(n.dataset.d))))}nudge_(e){let t=this.config,n=W(this.hass,t.entity),i=this.step_(),r=Number(n.min_temp??5),o=Number(n.max_temp??35),s=this.pending_??Number(n.temperature);if(!Number.isFinite(s))return;let d=Math.min(o,Math.max(r,Math.round((s+e*i)/i)*i));this.pending_=d,this.paintTarget_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null,this.hass.callService("climate","set_temperature",{entity_id:t.entity,temperature:this.pending_}),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450)}paintTarget_(){let e=this.$(".target");if(!e)return;let t=W(this.hass,this.config.entity),n=this.pending_??Number(t.temperature);e.classList.toggle("pending",this.pending_!=null),e.textContent=Number.isFinite(n)?`${q(this.hass,n,n%1?1:0)}\xB0`:"--"}paint(){let e=this.config,t=e.entity?x(this.hass,e.entity):null,n=e.entity?ee(t):!1;this.toggleAttribute("dead",n);let i=Vs(t),r=e.tone?V(e.tone):Pn[i]??"var(--dac-ink-3)";this.$(".card").style.setProperty("--tone",r),this.toggleAttribute("busy",!!Pn[i]);let o=this.$(".chip"),s=e.icon||"thermo";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=f(s,"thermo")),o.style.setProperty("--tone",Pn[i]?r:"var(--dac-ink-3)"),this.text(".nm",C(this.hass,e.entity||e.temperature||e.humidity,e.name));let d=e.temperature?Ni(x(this.hass,e.temperature)):Number(W(this.hass,e.entity).current_temperature),l=this.hass?.config?.unit_system?.temperature??"\xB0C";this.text(".temp",Number.isFinite(d)?`${q(this.hass,d,1)} ${l}`:"--");let c=e.humidity?Ni(x(this.hass,e.humidity)):null,p=this.$(".hum");p.innerHTML=c==null?"":`${E.drop}${q(this.hass,c,0)}%`,this.text(".sep",c==null?"":"\xB7"),e.entity&&!e.humidity&&Oi[i]&&i!=="idle"&&(this.text(".sep","\xB7"),p.textContent=Oi[i]),this.paintTarget_();let h=this.$(".set");if(h){let g=W(this.hass,e.entity),m=this.pending_??Number(g.temperature);h.querySelector('[data-d="-1"]').disabled=n||m<=Number(g.min_temp??5),h.querySelector('[data-d="1"]').disabled=n||m>=Number(g.max_temp??35)}}getCardSize(){return 1}getGridOptions(){return{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-climate-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("climate."));return n?{entity:n}:{}}};z(Nt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var Vn=class extends D{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"}]}schema(){return[{name:"entity",selector:_.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:_.text()},{name:"step",selector:_.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};I("domotiapp-climate-card-editor",Vn);O("domotiapp-climate-card",Nt,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var Ci=({label:a="Aan of uit",cls:e=""}={})=>`<button class="toggle ${e}" type="button" role="switch" aria-checked="false" aria-label="${a}"><span class="knob"></span></button>`;function Bn(a,e){if(!a)return;let t=String(!!e);a.getAttribute("aria-checked")!==t&&a.setAttribute("aria-checked",t)}function Ti(a,e){let t=a.querySelector(".knob"),n=!1,i=0,r=!1,o=!1,s=()=>{n=!1,a.classList.remove("dragging"),t?.style.removeProperty("--knob")},d=m=>{m!==e.value()&&(Bn(a,m),e.set(m))},l=m=>{if(!e.disabled?.()&&!(m.button!=null&&m.button!==0)){m.stopPropagation(),n=!0,r=!1,o=!1,i=m.clientX,a.classList.add("dragging");try{a.setPointerCapture?.(m.pointerId)}catch{}}},c=m=>{if(!n)return;let v=m.clientX-i;Math.abs(v)>3&&(r=!0);let b=e.value()?22:0,j=Math.min(22,Math.max(0,b+v));t?.style.setProperty("--knob",`${j}px`)},p=m=>{if(!n)return;m.stopPropagation();let v=m.clientX-i,b=e.value()?22:0,j=Math.min(22,Math.max(0,b+v));s();try{a.hasPointerCapture?.(m.pointerId)&&a.releasePointerCapture(m.pointerId)}catch{}o=!0,d(r?j>22/2:!e.value())},h=()=>{n&&s()},g=m=>{if(m.stopPropagation(),m.preventDefault(),o){o=!1;return}e.disabled?.()||d(!e.value())};return a.addEventListener("pointerdown",l),a.addEventListener("pointermove",c),a.addEventListener("pointerup",p),a.addEventListener("pointercancel",h),a.addEventListener("click",g),()=>{a.removeEventListener("pointerdown",l),a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",p),a.removeEventListener("pointercancel",h),a.removeEventListener("click",g)}}var Li=`
  .toggle {
...
`;var Ot=a=>String(a??"").split(".")[0],Di=new Set(["input_datetime","time","date","datetime"]),Hi=a=>Di.has(Ot(a)),le=a=>String(a).padStart(2,"0");function Bs(a){let e=String(a??"");return/^\d{4}-\d{2}-\d{2}[ T]\d{1,2}:\d{2}/.test(e)?"datetime-local":/^\d{4}-\d{2}-\d{2}$/.test(e)?"date":/^\d{1,2}:\d{2}/.test(e)?"time":null}function Kn(a){if(!a)return null;let e=Ot(a.entity_id);if(e==="time")return"time";if(e==="date")return"date";if(e==="datetime")return"datetime-local";if(e!=="input_datetime")return null;let t=a.attributes??{};return typeof t.has_date=="boolean"||typeof t.has_time=="boolean"?t.has_date&&t.has_time?"datetime-local":t.has_date?"date":t.has_time?"time":null:Bs(a.state)}var Ks=a=>`${a.getFullYear()}-${le(a.getMonth()+1)}-${le(a.getDate())}T${le(a.getHours())}:${le(a.getMinutes())}`;function Gs(a){let e=-a.getTimezoneOffset(),t=e<0?"-":"+",n=Math.abs(e);return`${t}${le(Math.floor(n/60))}:${le(n%60)}`}function Ii(a,e=Kn(a)){if(!a||!e)return"";let t=String(a.state??"");if(!t||t==="unknown"||t==="unavailable")return"";if(e==="time"){let i=t.match(/^(\d{1,2}):(\d{2})/);return i?`${le(i[1])}:${i[2]}`:""}if(e==="date"){let i=t.match(/^(\d{4}-\d{2}-\d{2})$/);return i?i[1]:""}if(Ot(a.entity_id)==="datetime"){let i=new Date(t);return Number.isNaN(+i)?"":Ks(i)}let n=t.match(/^(\d{4}-\d{2}-\d{2})[ T](\d{1,2}:\d{2})/);return n?`${n[1]}T${le(n[2].split(":")[0])}:${n[2].split(":")[1]}`:""}function Ri(a,e,t){let n=Ot(a),i=String(t??"");if(!i||!Di.has(n)||!e)return null;if(e==="time"){let h=i.match(/^(\d{1,2}):(\d{2})/);if(!h)return null;let g=`${le(h[1])}:${h[2]}:00`;return n==="time"?["time","set_value",{entity_id:a,time:g}]:["input_datetime","set_datetime",{entity_id:a,time:g}]}if(e==="date")return/^\d{4}-\d{2}-\d{2}$/.test(i)?n==="date"?["date","set_value",{entity_id:a,date:i}]:["input_datetime","set_datetime",{entity_id:a,date:i}]:null;let r=i.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(!r)return null;let[,o,s,d,l,c]=r,p=`${le(l)}:${c}:00`;if(n==="datetime"){let h=Gs(new Date(+o,+s-1,+d,+l,+c));return["datetime","set_value",{entity_id:a,datetime:`${o}-${s}-${d}T${p}${h}`}]}return["input_datetime","set_datetime",{entity_id:a,datetime:`${o}-${s}-${d} ${p}`}]}var Pi=a=>String(a??"").split(".")[0],Vi=new Set(["input_select","select"]),Gn=a=>Vi.has(Pi(a));function Se(a){if(!a||!Gn(a.entity_id))return[];let e=a.attributes?.options;return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t!==""):[]}function Ct(a,e=Se(a)){let t=String(a?.state??"");return!t||t==="unknown"||t==="unavailable"?"":e.includes(t)?t:""}function Tt(a,e,t=[]){let n=Pi(a),i=String(e??"");return!i||!Vi.has(n)||t.length&&!t.includes(i)?null:[n,"select_option",{entity_id:a,option:i}]}var Bi={auto:"automatisch",automatic:"automatisch",eco:"eco",intensiv:"intensief",intensive:"intensief",kurz:"kort",quick:"snel",express:"snel",speed:"snel",glas:"glas",glass:"glas",delicate:"fijn",normal:"normaal",night:"nacht",silence:"stil",quiet:"stil",hygiene:"hygi\xEBne",hygienic:"hygi\xEBne",favorite:"favoriet",favourite:"favoriet",steam:"stoom",fresh:"fris",care:"verzorging",machinecare:"machineverzorging",machine:"machine",prerinse:"voorspoelen",rinse:"spoelen",presoak:"voorweken",soak:"weken",wash:"wassen",dry:"drogen",half:"half",load:"belading",mixed:"gemengd",maximum:"maximaal",cleaning:"reinigen",clean:"reinigen",pots:"pannen",chef:"chef",kitchen:"keuken",party:"feest",daily:"dagelijks",super:"super",turbo:"turbo",energy:"energie",saving:"zuinig",off:"uit",on:"aan",none:"geen",standby:"stand-by",ready:"gereed",pause:"pauze",stop:"stop",start:"start",finished:"klaar",low:"laag",medium:"midden",high:"hoog"},Us=/^.*program(?:me)?[_.\- ]/i,Ws=30,qs=95;function Fs(a){return String(a??"").replace(Us,"").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([a-zA-Z])(\d)/g,"$1 $2").replace(/(\d)([a-zA-Z])/g,"$1 $2").split(/[\s_.\-]+/).filter(Boolean)}function Zs(a){let e=Fs(a);if(!e.length)return"";let t=[];for(let i=0;i<e.length;i++){let r=e[i],o=r.toLowerCase();if(/^\d+$/.test(o)){let l=Number(o);t.push(l>=Ws&&l<=qs?`${l} \xB0C`:o);continue}let s=e[i+1]?.toLowerCase(),d=s?Bi[o+s]:void 0;if(d){t.push(d),i++;continue}t.push(Bi[o]??r)}let n=t.join(" ");return n.charAt(0).toUpperCase()+n.slice(1)}function Xs(a,e){let t=i=>String(i??"").toLowerCase().replace(/[^a-z0-9]/g,""),n=t(e);return!!n&&n!==t(a)}function Lt(a,e){return Xs(a,e)?String(e):Zs(a)||String(a??"")}var Ht={row:44,tile:96,compact:44,beeld:120},ye=6,Ki=12,Un=22,Qs=["row","tile","compact","beeld"],Ys=["links","midden"],Wn=48,qn=320,Dt=120,de=a=>{if(a==null||a==="")return Dt;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(qn,Math.max(Wn,e)):Dt},Je=a=>Ys.includes(a)?a:"links";function Gi(a,e){let t=Array.isArray(a)?a:[],n=Array.from({length:e},(i,r)=>typeof t[r]=="string"?t[r].trim():"");return n.some(Boolean)?n:[]}var Js=["card","items","none","open"],It=a=>typeof a?.name=="string"?a.name.trim():"",et=a=>typeof a=="string"?{entity:a}:{...a},tt=a=>Math.min(Math.max(1,Number(a)||2),3),Pe=a=>Qs.includes(a)?a:"row",ie=a=>!!(a?.entity||a?.name||a?.icon||a?.tap_action);function Ui(a){if(Array.isArray(a?.rows)&&a.rows.length)return a.rows.map(n=>{let i=tt(n.columns);return{columns:i,layout:Pe(n.layout),align:Je(n.align),image_size:de(n.image_size),column_names:Gi(n.column_names,i),items:(n.items??n.entities??[]).map(et)}});let e=(a?.items??a?.entities??[]).map(et);if(!e.length)return[];let t=tt(a.columns);return[{columns:t,layout:Pe(a.layout),align:Je(a.align),image_size:de(a.image_size),column_names:Gi(a.column_names,t),items:e}]}function Rt(a){return Js.includes(a?.surface)?a.surface:a?.bare?"none":"card"}var el=a=>Math.max(1,Math.ceil((a.items?.length||1)/a.columns)),tl=22;function nl(a){let e=Pe(a?.layout);return e!=="beeld"?Ht[e]:de(a?.image_size)+34}function Fn(a){let e=a?.rows??[],t=It(a)?Un+ye:0;if(!e.length)return Ki+t+Ht.row;let n=(Rt(a)==="card"?Ki:0)+t;for(let i of e){let r=el(i);n+=r*nl(i)+(r-1)*ye,i.column_names?.length&&(n+=tl+ye)}return n+(e.length-1)*ye}function nt(a){for(a.bewaard??=[];a.items.length<a.columns;)a.items.push(a.bewaard.pop()??{entity:""});for(;a.items.length>a.columns;){let e=a.items.pop();ie(e)&&a.bewaard.push(e)}return a}function Wi(a){let e=Array.isArray(a.rows)&&a.rows.length?a.rows.map(n=>({columns:tt(n.columns),layout:Pe(n.layout),align:Je(n.align),image_size:de(n.image_size),column_names:Array.isArray(n.column_names)?[...n.column_names]:[],items:(n.items??n.entities??[]).map(et)})):(()=>{let n=(a.items??a.entities??[]).map(et);return n.length?[{columns:tt(a.columns),layout:Pe(a.layout),align:Je(a.align),image_size:de(a.image_size),column_names:Array.isArray(a.column_names)?[...a.column_names]:[],items:n}]:[]})(),t=[];for(let n of e){let i=[];for(let r=0;r<n.items.length;r+=n.columns)i.push(n.items.slice(r,r+n.columns));i.length||i.push([]),i.forEach((r,o)=>t.push(nt({columns:n.columns,layout:n.layout,align:n.align,image_size:n.image_size,column_names:o===0?n.column_names:[],items:r})))}return t}var Zn=a=>a.map(e=>{let t=(e.column_names??[]).slice(0,e.columns).map(n=>String(n??"").trim());return{columns:e.columns,...e.layout&&e.layout!=="row"?{layout:e.layout}:{},...e.align==="midden"?{align:"midden"}:{},...e.layout==="beeld"&&e.image_size!==Dt?{image_size:de(e.image_size)}:{},...t.some(Boolean)?{column_names:t}:{},items:e.items.filter(ie).map(n=>structuredClone(n))}}).filter(e=>e.items.length);var qi=[{waarde:"row",label:"Rij"},{waarde:"tile",label:"Tegel"},{waarde:"compact",label:"Compact"},{waarde:"beeld",label:"Beeld"}],al=[{waarde:"links",label:"Links"},{waarde:"midden",label:"Midden"}],il=a=>qi.find(e=>e.waarde===a)?.label??"Rij",rl=`
...
`,Xn=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.koppen_=[]}setConfig(e){if(this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns,delete this.rest_.layout,delete this.rest_.align,delete this.rest_.image_size,delete this.rest_.column_names,this.gebouwd_&&e===this.uitObject_)return;let t=Wi(e);this.gebouwd_&&JSON.stringify(Zn(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let i=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(r>e?`r${r-1}${i[2]===void 0?"":`i${i[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let i of this.open_){let r=/^r(\d+)i(\d+)$/.exec(i);if(!r||Number(r[1])!==e){n.add(i);continue}let o=Number(r[2]);o!==t&&n.add(o>t?`r${e}i${o-1}`:i)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,i)=>{ie(n)||this.open_.add(`r${t}i${i}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=rl;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),t.appendChild(this.kaartBlok_()),this.rows_.forEach((i,r)=>t.appendChild(this.rijBlok_(i,r))),!this.rows_.length){let i=document.createElement("p");i.className="uitleg",i.textContent="Een rij is een regel op de kaart, met een, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling en zijn eigen vorm. Een rij van een kolom is een losse knop.",t.appendChild(i)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let i=nt({columns:2,layout:"row",items:[]});this.rows_.push(i);let r=this.rows_.length-1;this.open_.add(`r${r}`),this.legePlekkenOpen_(i,r),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}segment_(e,t,n,{inKop:i=!1}={}){let r=document.createElement("span");r.className="segment";let o=e.map(d=>{let l=document.createElement("button");l.type="button",l.textContent=d.label,d.titel&&(l.title=d.titel);let c=()=>{t()!==d.waarde&&n(d.waarde)};return i?this.binnenKop_(l,c):l.addEventListener("click",c),r.appendChild(l),[l,d.waarde]}),s=()=>o.forEach(([d,l])=>d.setAttribute("aria-pressed",String(t()===l)));return s(),{wrap:r,vernieuw:s}}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"name",selector:{text:{}}},{name:"surface",selector:{select:{mode:"dropdown",options:[{value:"card",label:"Om de hele kaart"},{value:"open",label:"Alleen een rand, geen vulling"},{value:"none",label:"Geen vlak"}]}}},{name:"state_position",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Onder de naam"},{value:"right",label:"Rechts op de regel"}]}}}],e.computeLabel=t=>({name:"Naam van de kaart (optioneel)",surface:"Waar het kaartvlak zit",state_position:"Waar de status staat"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="name")return"Een kop boven de entiteiten. Laat leeg voor geen kop -- de kaart is dan een rasterrij lager.";if(t.name==="surface")return"Alleen een rand geeft een doorzichtige kaart die nog wel een vorm heeft; geen vlak laat de plekken los op het dashboard staan.";if(t.name==="state_position")return"Rechts is de vorm van de entiteitenkaart van Home Assistant: de waarden komen onder elkaar uit. Regels met een schakelaar of een tijdveld tonen geen tekst, en op een tegel staat de status altijd onder de naam."},e.data={name:this.rest_.name??"",surface:this.rest_.surface??(this.rest_.bare?"none":"card"),state_position:this.rest_.state_position??"below"},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};typeof n.name=="string"&&n.name.trim()?this.rest_.name=n.name:delete this.rest_.name,n.surface==="items"||n.surface==="none"||n.surface==="open"?this.rest_.surface=n.surface:delete this.rest_.surface,delete this.rest_.bare,n.state_position==="right"?this.rest_.state_position="right":delete this.rest_.state_position,this.emit_()}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="pijl",r.textContent="\u203A";let o=document.createElement("span");o.className="titel";let s=document.createElement("b");s.textContent=`Rij ${t+1}`;let d=document.createElement("small");o.append(s,d);let l=this.segment_([1,2,3].map($=>({waarde:$,label:String($),titel:`${$} entiteit${$>1?"en":""} in deze rij`})),()=>e.columns,$=>{e.columns=$,nt(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_()},{inKop:!0}),c=document.createElement("button");c.type="button",c.className="weg",c.title="Rij verwijderen",c.textContent="\u2715",this.binnenKop_(c,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),i.append(r,o,l.wrap,c);let p=document.createElement("div");p.className="rijbody";let h=this.segment_(qi.map($=>({waarde:$.waarde,label:$.label})),()=>e.layout,$=>{e.layout=$,X(),this.emit_()}),g=document.createElement("div");g.className="vormrij";let m=document.createElement("b");m.textContent="Vorm van deze rij",g.append(m,h.wrap),p.appendChild(g);let v=this.segment_(al.map($=>({waarde:$.waarde,label:$.label})),()=>e.align??"links",$=>{e.align=$,this.emit_()}),b=document.createElement("div");b.className="vormrij";let j=document.createElement("b");j.textContent="Uitlijning",b.append(j,v.wrap),p.appendChild(b);let k=document.createElement("div");k.className="beeldvak";let A=document.createElement("ha-form");A.hass=this.hass_,A.schema=[{name:"image_size",selector:{number:{min:Wn,max:qn,step:4,mode:"slider"}}}],A.computeLabel=()=>"Grootte van de afbeelding",A.computeHelper=()=>"In pixels. Groot genoeg om een QR-code te scannen begint rond de 160.",A.data={image_size:de(e.image_size)},A.addEventListener("value-changed",$=>{$.stopPropagation(),e.image_size=de($.detail.value?.image_size),this.emit_()}),k.appendChild(A),p.appendChild(k);let X=()=>{let $=e.layout==="beeld";k.style.display=$?"":"none",b.style.display=$?"none":""};X();let be=document.createElement("div");be.className="kolomvak";let ae=document.createElement("ha-form");ae.hass=this.hass_;let di=()=>Array.from({length:e.columns},($,ne)=>({name:`k${ne}`,selector:{text:{}}}));ae.schema=di(),ae.computeLabel=$=>`Kop boven kolom ${Number($.name.slice(1))+1}`,ae.computeHelper=$=>$.name==="k0"?"Laat leeg voor geen koppen. Handig als er twee dingen naast elkaar staan die allebei een naam verdienen.":void 0;let ci=()=>Object.fromEntries(Array.from({length:e.columns},($,ne)=>[`k${ne}`,e.column_names?.[ne]??""]));ae.data=ci(),ae.addEventListener("value-changed",$=>{$.stopPropagation();let ne=$.detail.value??{};e.column_names=Array.from({length:e.columns},(hi,hs)=>ne[`k${hs}`]??""),this.emit_()}),be.appendChild(ae),p.appendChild(be);let pi=()=>{let $=e.items.filter(ie),ne=[`${e.columns} kolom${e.columns>1?"men":""}`];e.layout!=="row"&&ne.push(il(e.layout)),ne.push($.length?$.map(hi=>this.itemNaam_(hi)).join(", "):"nog leeg"),e.column_names?.some?.(Boolean)&&ne.push("met kolomkoppen"),d.textContent=ne.join(" \xB7 "),l.vernieuw(),h.vernieuw(),v.vernieuw(),X(),ae.schema.length!==e.columns&&(ae.schema=di()),ae.data=ci()};return this.koppen_.push(pi),e.items.forEach(($,ne)=>p.appendChild(this.itemBlok_(e,$,t,ne))),n.append(i,p),pi(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity||"Knop"}itemBlok_(e,t,n,i){let r=document.createElement("details");r.className="item",this.onthoud_(r,`r${n}i${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="pijl",s.textContent="\u203A";let d=document.createElement("span");d.className="nr",d.textContent=String(i+1),d.title=`Plek ${i+1} in de rij`;let l=document.createElement("span");l.className="titel";let c=document.createElement("b"),p=document.createElement("small");l.append(c,p);let h=document.createElement("button");h.type="button",h.className="weg",h.title="Deze plek leegmaken",h.textContent="\u2715",this.binnenKop_(h,()=>{e.items.splice(i,1),this.itemWeg_(n,i),nt(e),this.emit_(),this.build_()}),o.append(s,d,l,h);let g=document.createElement("div");g.className="itembody";let m=document.createElement("ha-form");m.hass=this.hass_,m.schema=[{name:"entity",selector:{entity:{}}}],m.computeLabel=()=>"Entiteit",m.computeHelper=()=>"Mag leeg blijven: zonder entiteit wordt dit een navigatieknop. Geef hem dan een naam, een icoon en een tikactie.",m.addEventListener("value-changed",k=>{k.stopPropagation(),t.entity=k.detail.value.entity??"",this.emit_()});let v=document.createElement("dac-icon-picker");v.label="Icoon",v.hass=this.hass_,v.addEventListener("value-changed",k=>{k.stopPropagation(),k.detail.value?t.icon=k.detail.value:delete t.icon,this.emit_()});let b=document.createElement("ha-form");b.hass=this.hass_,b.schema=[{name:"name",selector:{text:{}}},{name:"toggle",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}],b.computeLabel=k=>({name:"Naam (overschrijft die van de entiteit)",toggle:"Schakelaar tonen",show_icon:"Icoon tonen",show_name:"Naam tonen",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel",double_tap_action:"Dubbeltikken op de regel"})[k.name]??k.name,b.computeHelper=k=>{if(k.name==="icon_tap_action")return"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.";if(k.name==="toggle")return"Een schuifschakelaar in plaats van de statustekst. Alleen voor wat twee standen heeft: een lamp, een stopcontact, een schakelaar.";if(k.name==="show_state")return"Een tijd of datum -- een input_datetime, of een klok van een apparaat -- verschijnt hier als een veld dat je meteen kunt zetten. Uit haalt met de tekst ook dat veld weg.";if(k.name==="double_tap_action")return"Laat dit op geen actie staan als je het niet gebruikt: een regel die op dubbeltikken wacht, reageert trager op een gewone tik."},b.addEventListener("value-changed",k=>{k.stopPropagation();let A=k.detail.value;A.name?t.name=A.name:delete t.name,A.toggle===!0?t.toggle=!0:delete t.toggle;for(let X of["show_icon","show_name","show_state"])A[X]===!1?t[X]=!1:delete t[X];for(let X of["icon_tap_action","icon_hold_action","tap_action","hold_action"])A[X]?t[X]=A[X]:delete t[X];A.double_tap_action&&A.double_tap_action.action!=="none"?t.double_tap_action=A.double_tap_action:delete t.double_tap_action,this.emit_()});let j=()=>{c.textContent=ie(t)?this.itemNaam_(t):"Kies een entiteit",p.textContent=t.entity||(ie(t)?"Zonder entiteit: een navigatieknop":""),r.dataset.leeg=String(!ie(t)),h.hidden=!ie(t)};return this.koppen_.push(j),m.data={entity:t.entity||void 0},v.value=t.icon??"",b.data={name:t.name??"",toggle:t.toggle??!1,show_icon:t.show_icon??!0,show_name:t.show_name??!0,show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},g.append(m,v,b),r.append(o,g),j(),r}emit_(){let e=Zn(this.rows_),t={...this.rest_,rows:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_)n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-entities-card-editor",Xn);var Pt=class extends S{validate(e){let t=Ui(e);return t.some(n=>n.items.some(ie))?{show_state:!0,state_position:"below",...e,rows:t}:{...e,[T]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){return e.tone?V(e.tone):this.config.tone?V(this.config.tone):he(e.entity)!=="light"?N.accent:bi(x(this.hass,e.entity))??N.lit}metSchakelaar_(e){return!!e.toggle&&vi(e.entity)}metTijd_(e){return!Hi(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}metKeuze_(e){return!Gn(e.entity)||this.metSchakelaar_(e)?!1:(e.show_state??this.config.show_state)!==!1}template(){let e=this.config;this.setAttribute("vlak",Rt(e)),this.style.containerType="inline-size";let t=Rt(e)==="items",n=e.rows.map((o,s)=>{let d=e.state_position==="right"&&o.layout!=="tile",l=`<span class="st${d?" rechts":""}"></span>`,c=o.items.map((h,g)=>`
          <div class="it${t?" surface":""}" role="button" tabindex="0"
            ...
            ${d?l:""}
            ${this.metSchakelaar_(h)?Ci({label:"Aan of uit"}):""}
            ...
            ${this.metKeuze_(h)?'<span class="keuzeslot" style="display:contents"></span>':""}
              ...
              style="--cols:${o.columns}">${o.column_names.map(h=>`<span>${B(h)}</span>`).join("")}</div>`:""}
      <div class="row" data-vorm="${o.layout}" data-uit="${o.align}"
           style="--cols:${o.columns};--it-h:${o.layout==="beeld"?o.image_size+34:Ht[o.layout]}px;--beeld:${o.image_size}px">${c}</div>`}).join("");return`<div class="card surface">${It(e)?'<h3 class="kaartnaam"></h3>':""}${n}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(s,d)=>ue(this,this.hass,t,t[s]??d),i={action:t.entity?"more-info":"none"};this.teardown_.push(R(e,{onTap:()=>n("tap_action",i),onHold:()=>n("hold_action",i),onDouble:t.double_tap_action?()=>n("double_tap_action",{action:"none"}):void 0}));let r=e.querySelector(".chip");if(r&&(this.teardown_.push(R(r,{onTap:()=>n("icon_tap_action",Xe(t.entity)),onHold:()=>n("icon_hold_action",i)})),this.on(r,"click",s=>s.stopPropagation()),this.on(r,"pointerdown",s=>s.stopPropagation())),e.querySelector(".tijdslot")){let s=p=>{let h=p.target?.closest?.(".tijd");if(h&&(p.stopPropagation(),p.type==="click"))try{h.showPicker?.()}catch{}};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0);let d=null,l=null,c=()=>{clearTimeout(l),l=null;let p=d;d=null,p&&this.hass.callService(p[0],p[1],p[2])};this.teardown_.push(()=>clearTimeout(l)),this.on(e,"change",p=>{let h=p.target?.closest?.(".tijd");h&&(p.stopPropagation(),d=Ri(t.entity,h.type,h.value),clearTimeout(l),l=setTimeout(c,600))}),this.on(e,"focusout",p=>{p.target?.closest?.(".tijd")&&c()})}if(e.querySelector(".keuzeslot")){let s=d=>{d.target?.closest?.(".keuze")&&d.stopPropagation()};this.on(e,"pointerdown",s,!0),this.on(e,"click",s,!0),this.on(e,"keydown",s,!0),this.on(e,"change",d=>{let l=d.target?.closest?.(".keuze");if(!l)return;d.stopPropagation();let c=x(this.hass,t.entity),p=Tt(t.entity,l.value,Se(c));p&&this.hass.callService(p[0],p[1],p[2])})}let o=e.querySelector(".toggle");o&&this.teardown_.push(Ti(o,{value:()=>ke(x(this.hass,t.entity)),set:s=>this.hass.callService("homeassistant",s?"turn_on":"turn_off",{entity_id:t.entity}),disabled:()=>ee(x(this.hass,t.entity))}))})}paint(){let e=this.$(".kaartnaam");e&&this.text(e,It(this.config)),this.$$(".it").forEach(t=>{let n=this.item_(t.dataset.r,t.dataset.i);if(!n)return;let i=x(this.hass,n.entity),r=ke(i),o=!!n.entity&&ee(i);t.dataset.on=String(r),t.classList.toggle("unavailable",o);let s=this.tone_(n);t.style.setProperty("--tone",s);let d=C(this.hass,n.entity,n.name),l=t.querySelector(".chip");if(l){let k=zt(this.hass,n.entity,n.icon),A=n.icon||(k?`pic:${k}`:$n(n.entity,W(this.hass,n.entity)));l.dataset.icon!==A&&(l.dataset.icon=A,l.classList.toggle("pic",!!k),l.innerHTML=k?`<img src="${k}" alt="" loading="lazy" />`:f(n.icon||$n(n.entity,W(this.hass,n.entity)))),l.style.setProperty("--tone",k?"var(--dac-ink-3)":r?s:"var(--dac-ink-3)"),l.setAttribute("aria-label",n.entity?`${d} schakelen`:"Icoon")}let c=t.querySelector(".nm");c&&this.text(c,d);let p=t.querySelector(".toggle");p&&(Bn(p,r),p.style.setProperty("--tone",s),p.setAttribute("aria-label",`${d} aan of uit`));let h=t.querySelector(".tijdslot"),g=null;if(h){let k=o?null:Kn(i);h.dataset.soort!==(k??"")&&(h.dataset.soort=k??"",h.innerHTML=k?`<input class="tijd" type="${k}" step="60" />`:""),g=h.querySelector(".tijd")}if(g&&(g.setAttribute("aria-label",`${d} instellen`),this.shadowRoot.activeElement!==g)){let k=Ii(i,h.dataset.soort);g.value!==k&&(g.value=k)}let m=t.querySelector(".keuzeslot"),v=null;if(m){let k=o?[]:Se(i),A=k.map(be=>Lt(be,this.hass?.formatEntityState?.(i,be))),X=JSON.stringify([k,A]);m.dataset.opties!==X&&(m.dataset.opties=X,m.innerHTML=k.length?`<select class="keuze">${k.map((be,ae)=>`<option value="${B(be)}">${B(A[ae])}</option>`).join("")}</select>`:""),v=m.querySelector(".keuze")}if(v&&(v.setAttribute("aria-label",`${d} kiezen`),this.shadowRoot.activeElement!==v)){let k=Ct(i);v.value!==k&&(v.value=k)}let b=t.querySelector(".st"),j=n.show_state??this.config.show_state;if(p||g||v)b.textContent="";else if(j===!1)b.textContent="";else if(o)b.textContent="Niet bereikbaar";else if(!i||zn(i.entity_id))b.textContent="";else if(he(i.entity_id)==="light"&&r&&i.attributes.brightness!=null)b.textContent=`${Math.round(i.attributes.brightness/255*100)}%`;else{let k=i.attributes.unit_of_measurement;b.textContent=k?`${i.state} ${k}`:Y(this.hass,i)}t.setAttribute("aria-label",`${d}${i?`, ${Y(this.hass,i)}`:""}`)})}getCardSize(){return me(Fn(this.config))}getGridOptions(){let e=me(Fn(this.config));return{columns:12,rows:e,min_columns:4,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};z(Pt,"css",`
    :host { display: block; height: 100%; }
    ...
    .kaartnaam {
      ...
      font-size: 13px; font-weight: 600; letter-spacing: -.01em; line-height: ${Un}px;
      color: var(--dac-ink);
      white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
  ...
  `);O("domotiapp-entities-card",Pt,{name:"DomotiApp Entiteiten",description:"Entiteiten in rijen, elk met een eigen kolomindeling en vorm: regel, tegel of compacte pil. Ook voor een losse knop."});var G={PAUSE:1,SEEK:2,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,VOLUME_STEP:1024,SELECT_SOURCE:2048,STOP:4096,PLAY:16384,SHUFFLE_SET:32768,REPEAT_SET:262144,GROUPING:524288},U=(a,e)=>!!(Number(a?.attributes?.supported_features??0)&e),Ve=a=>!a||a.state==="off",Qn=a=>!!a&&!["off","unavailable","unknown"].includes(a.state),at=a=>a?.state==="playing",Fi=a=>!!a&&!["off","unavailable","unknown","idle","standby"].includes(a.state);function Zi(a){if(!a)return[];let e=[];return(U(a,G.TURN_ON)||U(a,G.TURN_OFF))&&e.push("power"),Ve(a)||(U(a,G.PREVIOUS_TRACK)&&e.push("prev"),U(a,G.PLAY)||U(a,G.PAUSE)||U(a,G.PLAY_MEDIA)?e.push("play"):U(a,G.STOP)&&e.push("stop"),U(a,G.NEXT_TRACK)&&e.push("next")),e}var Me=a=>a?.volume_entity||a?.entity;function Yn(a){if(!Qn(a))return[];let e=[];return U(a,G.VOLUME_MUTE)&&e.push("mute"),U(a,G.VOLUME_SET)?e.push("slider"):U(a,G.VOLUME_STEP)&&e.push("steps"),e}var ze=a=>Math.round(Math.min(1,Math.max(0,Number(a?.attributes?.volume_level??0)))*100),it=a=>!!a?.attributes?.is_volume_muted,Jn=a=>!!a?.attributes?.mass_player_type,ea=a=>!!a?.attributes?.shuffle,ta=a=>{let e=a?.attributes?.repeat;return["off","all","one"].includes(e)?e:"off"},Xi=a=>({off:"all",all:"one",one:"off"})[ol(a)]??"all",ol=a=>["off","all","one"].includes(a)?a:"off";function na(a,{zoeken:e=!0}={}){if(!Qn(a))return[];let t=[];return U(a,G.SHUFFLE_SET)&&t.push("shuffle"),U(a,G.REPEAT_SET)&&t.push("repeat"),e&&Jn(a)&&t.push("search"),t}function Qi(a,{tonen:e=!0}={}){if(!e||!Qn(a)||!U(a,G.SELECT_SOURCE)||Jn(a))return null;let t=a?.attributes?.source_list;return!Array.isArray(t)||t.length<2?null:{nu:a.attributes.source??null,aantal:t.length}}function Vt(a,e=t=>t?.state??""){if(!a)return"";if(a.state==="unavailable")return"Niet bereikbaar";if(a.state==="off")return"Uit";if(a.state==="standby")return"Stand-by";let t=a.attributes??{},n=t.media_title||t.media_channel||"",i=t.media_artist||t.media_series_title||t.media_album_name||t.app_name||t.source||"";return a.state==="idle"||!n?i||e(a):i&&i!==n?`${n} \xB7 ${i}`:n}function rt(a){let e=a?.attributes?.device_class;return e==="tv"?"tv":e==="receiver"?"radio":"speaker"}var sl="domotiapp-media-speler:";function aa(a,e){let t=s=>e?.states?.[s]?.attributes?.friendly_name??s,n=s=>!!e?.states?.[s],i=()=>Object.keys(e?.states??{}).filter(s=>s.startsWith("media_player."));return(Array.isArray(a?.players)&&a.players.length?[...new Set([...n(a?.entity)?[a.entity]:[],...a.players.filter(n)])]:ll(i(),e)).sort((s,d)=>String(t(s)).localeCompare(String(t(d)),"nl"))}function ll(a,e){let t=a.filter(n=>Jn(e?.states?.[n]));return t.length?t:a}var Yi=a=>sl+(a??[]).join("|");function Ji(a,e,t){if(!a?.speaker_select)return a?.entity??"";let n=null;try{n=t?.getItem?.(Yi(e))??null}catch{n=null}return n&&e?.includes(n)?n:a.entity&&e?.includes(a.entity)?a.entity:a.entity||e?.[0]||""}function er(a,e,t){try{return a?.setItem?.(Yi(e),String(t)),!0}catch{return!1}}var ia="dacScrollSlot",tr=["position","top","left","right","width","overflow"];function nr(a=globalThis.document,e=globalThis.window){let t=a?.body;if(!t?.style||t.dataset?.[ia])return()=>{};let n=e?.scrollY??a.documentElement?.scrollTop??0,i=Object.fromEntries(tr.map(o=>[o,t.style[o]]));t.dataset&&(t.dataset[ia]="1"),t.style.position="fixed",t.style.top=`-${n}px`,t.style.left="0",t.style.right="0",t.style.width="100%",t.style.overflow="hidden";let r=!1;return()=>{if(!r){r=!0;for(let o of tr)t.style[o]=i[o];t.dataset&&delete t.dataset[ia],e?.scrollTo?.(0,n)}}}var ar=[["playlists","Afspeellijsten"],["radio","Radio"],["tracks","Nummers"],["albums","Albums"],["artists","Artiesten"]];var je=a=>`domotiapp_lovelace/media/${a}`;function dl(a,e){if(!a)return null;if(e)return a.uri?{type:je("favorite"),favorite:!0,uri:a.uri}:null;let t=ir(a);return!t||!a.library_item_id?null:{type:je("favorite"),favorite:!1,kind:t,library_item_id:String(a.library_item_id)}}function ir(a){let e=a?.media_type;return{track:"tracks",album:"albums",artist:"artists",playlist:"playlists",radio:"radio",podcast:"podcasts",audiobook:"audiobooks"}[e]??null}var rr={tracks:"track",albums:"album",artists:"artist",playlists:"playlist",radio:"radio",podcasts:"podcast",audiobooks:"audiobook"},ra=[["","Alles"],["track","Nummers"],["album","Albums"],["artist","Artiesten"],["playlist","Afspeellijsten"],["radio","Radio"]];function or(a,e,t=null){return a?.kind??ir(e)??t??"playlists"}var oa=a=>!!a?.uri,Bt=(a,e,{favoriet:t=!1,zoek:n="",limiet:i=50}={})=>a.callWS({type:je("library"),kind:e,favorite:t,...n?{search:n}:{},limit:i}).then(r=>r?.items??[]),sr=(a,e,t)=>{let n=dl(e,t);return n?a.callWS(n):Promise.reject(new Error("Dit item kan niet favoriet gemaakt worden."))},lr=(a,e)=>a.callWS({type:je("playlist/create"),name:e}).then(t=>t?.playlist??null),dr=(a,e)=>a.callWS({type:je("playlist/remove"),library_item_id:String(e.library_item_id)}),cr=(a,e)=>a.callWS({type:je("playlist/tracks"),library_item_id:String(e.library_item_id),provider:e.provider??"library"}).then(t=>t?.tracks??[]),pr=(a,e,t)=>a.callWS({type:je("playlist/add_tracks"),library_item_id:String(e.library_item_id),uris:t}),hr=(a,e,t)=>a.callWS({type:je("playlist/remove_tracks"),library_item_id:String(e.library_item_id),positions:t});var cl=350,pl={track:"Nummer",album:"Album",artist:"Artiest",playlist:"Afspeellijst",radio:"Radio",podcast:"Podcast",audiobook:"Luisterboek"};function hl(a){let e=Array.isArray(a.artists)?a.artists.map(i=>typeof i=="string"?i:i?.name).filter(Boolean).join(", "):"",t=typeof a.album=="string"?a.album:a.album?.name,n=pl[a.media_type]??"";return[e,t].filter(Boolean).join(" \xB7 ")||n}var ul=`
  :host {
    ${Z}
      ...
      <div class="laag">
        ...
        <div class="menu" hidden></div>
          ...
          <div class="rij" data-i="${i}" data-knoppen="${l}">
            ...
            </div>`}).join("");for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.querySelector(".slider");if(!s)continue;let d=o.dataset.speaker;s.setAttribute("aria-label",`Volume ${o.querySelector("span")?.textContent??""}`);let l=_e(s,{value:()=>ze(x(this.hass,d)),onInput:c=>this.zetSchuif_(s,c),onCommit:c=>this.hass.callService("media_player","volume_set",{volume_level:c/100},{entity_id:d})});this.schuiven_.set(d,l)}}for(let o of this.shadowRoot.querySelectorAll(".spreker")){let s=o.dataset.speaker,d=o.querySelector(".slider");if(!d||d.classList.contains("dragging"))continue;let l=x(this.hass,s),c=ze(l);this.zetSchuif_(d,c,it(l))}}zetSchuif_(e,t,n=!1){e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t));let i=e.parentElement.querySelector(".pct");i&&(i.textContent=n?"gedempt":`${t}%`)}wisselSpeaker_(e){if(e===this.entity_)return;if(this.groepNu_().has(e)){this.hass.callService("media_player","unjoin",{},{entity_id:e});return}this.hass.callService("media_player","join",{group_members:[e]},{entity_id:this.entity_});let n=x(this.hass,this.entity_);if(typeof n?.attributes?.volume_level!="number")return;let i=ze(n),r=x(this.hass,e);U(r,G.VOLUME_SET)&&ze(r)!==i&&this.hass.callService("media_player","volume_set",{volume_level:i/100},{entity_id:e})}disconnectedCallback(){clearTimeout(this.timer_),this.scrollLos_?.(),this.scrollLos_=null,this.schuiven_?.forEach(e=>e()),this.schuiven_=null,this.escape_&&document.removeEventListener("keydown",this.escape_,!0),this.trefferBinding_?.();for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}};M("domotiapp-media-browser",sa);function ur(a,e,t,n={}){let i=document.querySelector("domotiapp-media-browser");return i||(i=document.createElement("domotiapp-media-browser"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var ml=`
  :host {
    ${Z}
    position: fixed; inset: 0; z-index: 9999;
    display: none; font-family: var(--dac-font); color: var(--dac-ink);
...
`,la=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[J(ml+ve)],this.filter_="",this.opruimen_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,da=null,ca=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),pa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),da=da??[J(gl)],this.shadowRoot.adoptedStyleSheets=da,this.opruimen_=[],this.filter_="",this.lijst_=[]}connectedCallback(){this.gebouwd_||this.bouw_()}disconnectedCallback(){for(let e of this.opruimen_)e();this.opruimen_=[],this.gebouwd_=!1}bouw_(){this.shadowRoot.innerHTML=`
      <div class="laag">
        <header>
        ...
        <div class="tel"></div>
        <div class="lijst" role="listbox"></div>
      </div>`,this.gebouwd_=!0;let e=(t,n,i)=>{t.addEventListener(n,i),this.opruimen_.push(()=>t.removeEventListener(n,i))};e(this.$(".sluit"),"click",()=>this.sluit()),e(this.$(".laag"),"click",t=>{t.target===this.$(".laag")&&this.sluit()}),e(this.$("input"),"input",t=>{this.filter_=t.target.value.trim().toLowerCase(),this.teken_()}),e(this.$("input"),"keydown",t=>{t.key==="Enter"&&this.$(".sp")?.click()}),e(this,"keydown",t=>{t.key==="Escape"&&this.hasAttribute("open")&&this.sluit()}),e(this.$(".lijst"),"click",t=>{let n=t.target.closest(".sp");n&&this.kies_(n.dataset.id)})}$(e){return this.shadowRoot.querySelector(e)}open(e,t,n,i){this.hass=e,this.lijst_=Array.isArray(t)?t:[],this.huidig_=n,this.opKeuze_=i,this.filter_="",this.gebouwd_||this.bouw_(),this.$("input").value="",this.$(".zoek").hidden=this.lijst_.length<8,this.setAttribute("open",""),this.teken_(),this.$(".zoek").hidden||setTimeout(()=>this.$("input")?.focus(),60)}sluit(){this.removeAttribute("open")}teken_(){let e=this.lijst_,t=this.filter_?e.filter(i=>String(C(this.hass,i)).toLowerCase().includes(this.filter_)):[...e];this.$(".sub").textContent=this.huidig_?`Nu: ${C(this.hass,this.huidig_)}`:"",this.$(".tel").textContent=this.filter_?`${t.length} van ${e.length}`:`${e.length} speaker${e.length===1?"":"s"}`;let n=this.$(".lijst");if(!t.length){n.innerHTML='<div class="leeg">Niets gevonden.</div>';return}n.innerHTML=t.map(i=>{let r=x(this.hass,i),o=i===this.huidig_,s=Ve(r)?"Uit":Vt(r,d=>Y(this.hass,d));return`<button class="sp" type="button" role="option" data-id="${ca(i)}"
                  data-speelt="${at(r)}" data-uit="${Ve(r)}"
                  aria-current="${o}" aria-selected="${o}">
                  <span class="ico">${f(rt(r),"speaker")}</span>
                  <span class="tekst">
                    <b>${ca(C(this.hass,i))}</b>
                    <span>${ca(s)}</span>
                  </span>
                  ${o?'<span class="nu">NU</span>':""}
                </button>`}).join("")}kies_(e){e&&(this.opKeuze_?.(e),this.sluit())}};M("domotiapp-speler-kiezer",pa);function gr(a,e,t,n){let i=document.querySelector("domotiapp-speler-kiezer");return i||(i=document.createElement("domotiapp-speler-kiezer"),document.body.appendChild(i)),i.tabIndex=-1,i.open(a,e,t,n),i.focus?.(),i}var Kt={power:{icon:"power",label:"Aan of uit"},prev:{icon:"prev",label:"Vorige"},play:{icon:"play",label:"Afspelen of pauzeren"},stop:{icon:"stop",label:"Stoppen"},next:{icon:"next",label:"Volgende"},shuffle:{icon:"shuffle",label:"Willekeurig afspelen"},repeat:{icon:"repeat",label:"Herhalen"},search:{icon:"search",label:"Zoeken in Music Assistant"}},Gt=class extends S{setConfig(e){this.ruw_=e,super.setConfig(this.metSpeler_(e))}metSpeler_(e){if(!e?.speaker_select)return e;let t=aa(e,this.hass),n=Ji(e,t,this.opslag_());return n&&n!==e.entity?{...e,entity:n}:e}set hass(e){let t=!this.hass_;if(super.hass=e,!t||!this.ruw_?.speaker_select)return;let n=this.metSpeler_(this.ruw_);n.entity&&n.entity!==this.config?.entity&&super.setConfig(n)}get hass(){return super.hass}opslag_(){try{return window.localStorage}catch{return null}}spelers_(){return aa(this.ruw_??this.config,this.hass)}groepsSpelers_(){let e=this.config.speakers;return Array.isArray(e)&&e.length||!this.config.speaker_select?e:this.spelers_()}kiesSpeler_(e){!e||e===this.config.entity||(er(this.opslag_(),this.spelers_(),e),super.setConfig({...this.ruw_,entity:e}))}validate(e){return e.entity?{layout:"row",show_artwork:!0,show_volume:!0,show_source:!0,show_controls:!0,show_search:!0,...e}:{...e,[T]:e.speaker_select?"Zet er een mediaspeler in, of wacht tot Home Assistant er een meldt.":"Kies een mediaspeler."}}watched(){return[this.config.entity,this.config.volume_entity].filter(Boolean)}tone_(){return this.config.tone?V(this.config.tone):N.accent}groot_(){return this.config.layout==="groot"}template(){return this.config.bare&&this.setAttribute("bare",""),this.setAttribute("layout",this.groot_()?"groot":"row"),`
      ...
      </div>`}wire(){let e=this.config,t=(s,d)=>ue(this,this.hass,e,e[s]??d);this.teardown_.push(K(this.$(".card"))),this.teardown_.push(R(this.$(".top"),{onTap:()=>t("tap_action",{action:"more-info"}),onHold:()=>t("hold_action",{action:"more-info"})}));let n=this.$(".chip");this.teardown_.push(R(n,{onTap:()=>t("icon_tap_action",Xe(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(n,"click",s=>s.stopPropagation()),this.on(n,"pointerdown",s=>s.stopPropagation());let i=this.$(".hoesgroot");i&&(this.teardown_.push(R(i,{onTap:()=>t("icon_tap_action",Xe(e.entity)),onHold:()=>t("icon_hold_action",{action:"more-info"})})),this.on(i,"click",s=>s.stopPropagation()),this.on(i,"pointerdown",s=>s.stopPropagation()));let r=s=>{let d=s.target.closest?.("[data-k]");d&&(s.stopPropagation(),this.doe_(d.dataset.k))},o=this.$(".spelers");o&&(this.on(o,"click",r),this.on(o,"pointerdown",s=>s.stopPropagation())),this.on(this.$(".ctl"),"click",r),this.on(this.$(".vol"),"click",r),this.on(this.$(".extra"),"click",r),this.on(this.$(".ctl"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".vol"),"pointerdown",s=>s.stopPropagation()),this.on(this.$(".extra"),"pointerdown",s=>s.stopPropagation()),this.sliders_=new Map}doe_(e){let t=this.config.entity,n=x(this.hass,t),i=(r,o={})=>this.hass.callService("media_player",r,{entity_id:t,...o});switch(e){case"power":return i(Ve(n)?"turn_on":"turn_off");case"bron":return mr(this.hass,t,C(this.hass,t,this.config.name));case"prev":return i("media_previous_track");case"next":return i("media_next_track");case"play":return i(at(n)?"media_pause":"media_play");case"stop":return i("media_stop");case"mute":{let r=Me(this.config);return this.hass.callService("media_player","volume_mute",{is_volume_muted:!it(x(this.hass,r))},{entity_id:r})}case"vol-":case"vol+":return this.hass.callService("media_player",e==="vol+"?"volume_up":"volume_down",{},{entity_id:Me(this.config)});case"shuffle":return this.hass.callService("media_player","shuffle_set",{shuffle:!ea(n)},{entity_id:t});case"repeat":return this.hass.callService("media_player","repeat_set",{repeat:Xi(ta(n))},{entity_id:t});case"speler":{let r=this.spelers_();return gr(this.hass,r,t,o=>this.kiesSpeler_(o))}case"search":return ur(this.hass,t,C(this.hass,t,this.config.name),{radioModus:this.config.radio_mode===!0,speakers:this.groepsSpelers_()});default:return}}paint(){let e=this.config,t=x(this.hass,e.entity),n=!t||t.state==="unavailable",i=Fi(t),r=this.$(".top");r.dataset.on=String(i),r.classList.toggle("unavailable",n),this.$(".card").style.setProperty("--tone",this.tone_());let o=this.$(".chip"),s=e.show_artwork===!1?null:zt(this.hass,e.entity,e.icon),d=s?`pic:${s}`:e.icon||rt(t);o.dataset.icon!==d&&(o.dataset.icon=d,o.classList.toggle("pic",!!s),o.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:f(d,"speaker")),o.style.setProperty("--tone",i&&!s?this.tone_():"var(--dac-ink-3)");let l=this.$(".hoesgroot");l&&l.dataset.icon!==d&&(l.dataset.icon=d,l.innerHTML=s?`<img src="${s}" alt="" loading="lazy" />`:f(e.icon||rt(t),"speaker"));let c=C(this.hass,e.entity,e.name),p=Vt(t,g=>Y(this.hass,g)),h=this.$(".spelers");if(h){let g=C(this.hass,e.entity);this.text(".spelers .waar",g),h.setAttribute("aria-label",`Speaker kiezen. Nu: ${g}`)}this.text(".nm",c),this.text(".st",p),o.setAttribute("aria-label",`${c} afspelen of pauzeren`),this.$(".hoesgroot")?.setAttribute("aria-label",`${c} afspelen of pauzeren`),r.setAttribute("aria-label",`${c}, ${p}`),this.paintKnoppen_(t,n),this.paintVolume_(t,n),this.paintExtra_(t,n),L(this.$(".card"))}paintKnoppen_(e,t){let n=this.$(".ctl"),i=this.config.show_controls===!1||t?[]:Zi(e),r=i.join(",");n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map(s=>`<button class="k ${s==="play"||s==="stop"?"hoofd":""}" type="button" data-k="${s}" aria-label="${Kt[s].label}">${f(Kt[s].icon)}</button>`).join(""));let o=n.querySelector('[data-k="play"]');if(o){let s=at(e)?"pause":"play";o.dataset.icon!==s&&(o.dataset.icon=s,o.innerHTML=f(s))}}paintVolume_(e,t){let n=this.$(".vol"),i=Me(this.config),r=i===this.config.entity?e:x(this.hass,i),o=this.config.show_volume===!1||t?[]:Yn(r),s=t?null:Qi(e,{tonen:this.config.show_source!==!1});if(n.hidden=!o.length&&!s,n.hidden){n.dataset.sig="",this.sliders_?.delete("volume");return}let d=[...o,s?"bron":""].join(",");n.dataset.sig!==d&&(n.dataset.sig=d,n.innerHTML=(o.includes("mute")?`<button class="k" type="button" data-k="mute" aria-label="Dempen">${f("volume")}</button>`:"")+(o.includes("slider")?se("volume"):"")+(o.includes("steps")?`<button class="k" type="button" data-k="vol-" aria-label="Zachter">${f("minus")}</button><button class="k" type="button" data-k="vol+" aria-label="Harder">${f("plus")}</button>`:"")+'<span class="pct tnum"></span>'+(s?`<button class="bronknop" type="button" data-k="bron">${f("tv")}<b></b></button>`:""),this.sliders_?.delete("volume"),n.querySelector(".slider")?.setAttribute("aria-label","Volume"));let l=n.querySelector(".bronknop");if(l){let m=s.nu||"Bron";this.text(l.querySelector("b"),m),l.setAttribute("aria-label",`Bron kiezen, nu ${m}`),l.title=`Kies uit ${s.aantal} bronnen`}let c=it(r),p=ze(r),h=n.querySelector('[data-k="mute"]');if(h){let m=c?"volumeMute":"volume";h.dataset.icon!==m&&(h.dataset.icon=m,h.innerHTML=f(m)),h.setAttribute("aria-pressed",String(c))}let g=n.querySelector(".slider");g&&(this.attach_(g,"volume",{value:()=>ze(x(this.hass,Me(this.config))),onInput:m=>this.setSlider_(g,m),onCommit:m=>this.hass.callService("media_player","volume_set",{volume_level:m/100},{entity_id:Me(this.config)}),disabled:()=>ee(x(this.hass,Me(this.config)))}),g.classList.contains("dragging")||this.setSlider_(g,p)),this.text(".pct",c?"Gedempt":`${p}%`)}paintExtra_(e,t){let n=this.$(".extra"),i=t||this.config.show_controls===!1?[]:na(e,{zoeken:this.config.show_search!==!1});n.hidden=!i.length;let r=i.join(",");if(n.dataset.sig!==r&&(n.dataset.sig=r,n.innerHTML=i.map((l,c)=>`${l==="search"&&c>0?'<span class="rek"></span>':""}<button class="k" type="button" data-k="${l}" aria-label="${Kt[l].label}">${f(Kt[l].icon)}</button>`).join("")),!i.length)return;let o=n.querySelector('[data-k="shuffle"]');o&&o.setAttribute("aria-pressed",String(ea(e)));let s=n.querySelector('[data-k="repeat"]');if(s){let l=ta(e),c=l==="one"?"repeatOne":"repeat";s.dataset.icon!==c&&(s.dataset.icon=c,s.innerHTML=f(c)),s.setAttribute("aria-pressed",String(l!=="off")),s.setAttribute("aria-label",{off:"Herhalen: uit",all:"Herhalen: alles",one:"Herhalen: dit nummer"}[l])}let d=document.querySelector("domotiapp-media-browser");d?.hasAttribute("open")&&(d.hass=this.hass)}attach_(e,t,n){if(!e||this.sliders_.has(t))return;let i=_e(e,n);this.sliders_.set(t,i),this.teardown_.push(i)}setSlider_(e,t){e&&(e.style.setProperty("--v",`${t}%`),e.setAttribute("aria-valuenow",String(t)),this.text(".pct",`${t}%`))}getCardSize(){if(this.config?.layout==="groot")return 8;let e=x(this.hass,this.config?.entity);return 1+(Yn(e).length?1:0)+(na(e).length?1:0)}getGridOptions(){let e=this.config?.layout==="groot",t=this.minRijen_(".card",e?6:this.getCardSize());return e?{columns:12,rows:"auto",min_columns:6,min_rows:t}:{columns:12,rows:"auto",min_columns:4,min_rows:t}}static getConfigElement(){return document.createElement("domotiapp-media-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("media_player."));return n?{entity:n}:{}}};z(Gt,"css",`
    :host { display: block; }
  ...
  `);var ga=class extends D{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"smoke"}]}schema(){return[{name:"name",selector:_.text()},{name:"smoke",selector:_.entity()},{name:"co",selector:_.entity()},{name:"heat",selector:_.entity()},{name:"temperature",selector:_.entity()},{name:"battery",selector:_.entity()},{name:"tap_action",selector:_.action("more-info")},{name:"hold_action",selector:_.action("more-info")}]}label(e){return{name:"Naam (overschrijft die van de melder)",smoke:"Rook",co:"Koolmonoxide",heat:"Warmte",temperature:"Temperatuur",battery:"Batterij",tap_action:"Tikken op de kaart",hold_action:"Vasthouden op de kaart"}[e.name]??super.label(e)}helper(e){if(e.name==="smoke")return"Alle vijf zijn optioneel: vul in wat je melder heeft. Wat je leeg laat, komt niet op de kaart.";if(e.name==="battery")return"Een percentage of een 'batterij bijna leeg'-sensor. Onder de 20% meldt de kaart het uit zichzelf."}};I("domotiapp-smoke-card-editor",ga);O("domotiapp-smoke-card",Ut,{name:"DomotiApp Rookmelder",description:"Rook, koolmonoxide, warmte, temperatuur en batterij \u2014 alles optioneel."});var kl=["zo","ma","di","wo","do","vr","za"],vr=5,kr=8,Wt=class extends S{validate(e){if(!e.entity)return{...e,[T]:"Kies een weerentiteit."};let t=Math.min(Math.max(1,Number(e.days)||vr),kr);return{show_current:!0,forecast_type:"daily",...e,days:t}}watched(){return[this.config.entity]}template(){this.config.bare&&this.setAttribute("bare","");let e=this.config;return`
      <div class="card surface">
        <div class="nu" role="button" tabindex="0" ${e.show_current===!1?"hidden":""}>
          <span class="chip" style="--tone:${N.accent}"></span>
          <span class="txt"><span class="nm"></span><span class="st"></span></span>
          <span class="graden tnum"></span>
        </div>
        <div class="rij" style="--n:${e.days}"></div>
      </div>`}wire(){this.teardown_.push(K(this.$(".card"))),this.teardown_.push(R(this.$(".nu"),{onTap:()=>Q(this,this.config.entity),onHold:()=>Q(this,this.config.entity)})),this.abonneer_()}async abonneer_(){let e=this.config;this.opzeggen_?.(),this.opzeggen_=null;let t=this.hass?.connection;if(!t?.subscribeMessage){this.forecastFout_="Geen verbinding voor de voorspelling.",this.paintRij_();return}try{let n=await t.subscribeMessage(i=>{this.forecast_=i?.forecast??[],this.forecastFout_=null,this.paintRij_()},{type:"weather/subscribe_forecast",forecast_type:e.forecast_type==="hourly"?"hourly":"daily",entity_id:e.entity});if(!this.isConnected){n();return}this.opzeggen_=n,this.teardown_.push(()=>{try{n()}catch{}this.opzeggen_=null})}catch{this.forecastFout_=e.forecast_type==="hourly"?"Deze weerbron geeft geen uurvoorspelling.":"Deze weerbron geeft geen dagvoorspelling.",this.paintRij_()}}paint(){let e=this.config,t=x(this.hass,e.entity),n=ee(t);this.$(".nu").classList.toggle("unavailable",n);let r=this.$(".chip"),o=e.icon||Ye(t?.state);r.dataset.icon!==o&&(r.dataset.icon=o,r.innerHTML=f(o,"cloud")),this.text(".nm",C(this.hass,e.entity,e.name)),this.text(".st",n?"Niet bereikbaar":Y(this.hass,t));let s=this.$(".graden"),d=t?.attributes?.temperature,l=t?.attributes?.temperature_unit??"\xB0C";s.innerHTML=d==null?"":`${q(this.hass,d,Number.isInteger(d)?0:1)}<small>${l}</small>`,this.paintRij_(),L(this.$(".card"))}paintRij_(){let e=this.$(".rij");if(!e)return;let t=this.config;if(this.forecastFout_&&!this.forecast_?.length){e.style.setProperty("--n",1),e.innerHTML=`<div class="leeg">${this.forecastFout_}</div>`;return}let n=(this.forecast_??[]).slice(0,t.days);if(!n.length){e.style.setProperty("--n",1),e.innerHTML='<div class="leeg">Nog geen voorspelling ontvangen\u2026</div>';return}e.style.setProperty("--n",n.length);let i=x(this.hass,t.entity)?.attributes?.temperature_unit??"";e.innerHTML=n.map((r,o)=>{let s=this.wanneer_(r.datetime,o),d=f(Ye(r.condition),"cloud"),l=r.temperature==null?"":`${q(this.hass,r.temperature,0)}\xB0`,c=r.templow==null?"":`${q(this.hass,r.templow,0)}\xB0`,p=r.precipitation_probability==null?"":`<span class="nat">${f("drop")}${Math.round(r.precipitation_probability)}%</span>`;return`
          <div class="dag" style="--tone:${N.accent}">
            <span class="wanneer">${s}</span>
            ${d}
            <span class="max tnum">${l}</span>
            ${c?`<span class="min tnum">${c}</span>`:""}
            ${p}
          </div>`}).join("")}wanneer_(e,t){let n=new Date(e);if(Number.isNaN(+n))return"";if(this.config.forecast_type==="hourly")return`${String(n.getHours()).padStart(2,"0")}:00`;let i=new Date,r=n.getDate()===i.getDate()&&n.getMonth()===i.getMonth()&&n.getFullYear()===i.getFullYear();return t===0&&r?"vandaag":kl[n.getDay()]}regels_(){return this.config?.show_current===!1?1:2}getCardSize(){return this.regels_()+1}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-forecast-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("weather."));return n?{entity:n}:{}}};z(Wt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var fa=class extends D{defaults(){return{show_current:!0,forecast_type:"daily",days:vr}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"cloudSun"}]}schema(){return[{name:"entity",selector:_.entity("weather")},{name:"name",selector:_.text()},{name:"forecast_type",selector:_.select([{value:"daily",label:"Per dag"},{value:"hourly",label:"Per uur"}])},{name:"days",selector:_.number(1,kr)},{name:"show_current",selector:_.bool()}]}label(e){return{entity:"Weerentiteit",name:"Naam (overschrijft die van de weerbron)",forecast_type:"Voorspelling",days:"Hoeveel punten",show_current:"Nu-regel tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Meer hoeft er niet ingevuld te worden: de kaart leest zelf uit wat je weerbron levert.";if(e.name==="forecast_type")return"Niet elke weerbron kan allebei. Kan hij het niet, dan zegt de kaart dat in plaats van leeg te blijven."}};I("domotiapp-forecast-card-editor",fa);O("domotiapp-forecast-card",Wt,{name:"DomotiApp Weersvoorspelling",description:"Vandaag groot, de dagen erna op een rij. E\xE9n entiteit invullen."});var st={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},lt=(a,e)=>!!((a?.attributes?.supported_features??0)&e),xl=(a={})=>{switch(a.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},qt=class extends S{validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      <div class="keys">
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(i=>{this.on(i,"click",()=>{let r=i.dataset.act,o={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",o[r],{entity_id:this.config.covers[+t].entity}),r!=="stop"&&(this.assumed_.set(t,r==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(R(e.querySelector(".chip"),{onTap:()=>Q(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],i=x(this.hass,n.entity),r=W(this.hass,n.entity),o=!i||i.state==="unavailable",s=i?.state??"unknown";e.classList.toggle("unavailable",o),e.querySelector(".nm").textContent=C(this.hass,n.entity,n.name);let d=lt(i,st.SET_POSITION)&&r.current_position!=null,l=d?r.current_position>0?"open":"closed":s==="open"||s==="closed"?s:this.assumed_.get(t)??"closed";e.dataset.shown=l;let c=xl(r),p=(l==="open"?n.icon_open:n.icon_closed)??(l==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??c[l],h=e.querySelector(".chip");h.dataset.icon!==p&&(h.dataset.icon=p,h.innerHTML=f(p,c[l]));let g=e.querySelector(".st");this.dragging_.has(t)||(g.textContent=o?"Niet bereikbaar":s==="opening"?"Gaat open":s==="closing"?"Gaat dicht":d?`${r.current_position}% open`:s==="open"?"Open":s==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(b=>{if(b.dataset.act==="stop"){b.disabled=o||!lt(i,st.STOP);return}let j=b.dataset.act==="open";b.disabled=o||(j?!lt(i,st.OPEN):!lt(i,st.CLOSE))});let m=e.querySelector(".pos"),v=d&&this.config.show_position!==!1;if(m.hidden=!v,v){if(m.dataset.built||(m.dataset.built="1",m.innerHTML=se("position"),m.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let j=m.querySelector(".slider"),k=A=>{j.style.setProperty("--v",`${A}%`),j.setAttribute("aria-valuenow",String(A)),e.querySelector(".st").textContent=`${A}% open`};this.teardown_.push(_e(j,{value:()=>W(this.hass,n.entity).current_position??0,onInput:k,onCommit:A=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:A})}))}let b=m.querySelector(".slider");if(!b.classList.contains("dragging")){let j=r.current_position??0;b.style.setProperty("--v",`${j}%`),b.setAttribute("aria-valuenow",String(j))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>lt(x(this.hass,n.entity),st.SET_POSITION));return me(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(i=>i.startsWith("cover."));return{covers:n?[n]:[]}}};z(qt,"css",`
    :host { display: block; height: 100%; }
  ...
  `);var ba=class extends D{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"}]}setConfig(e){let t={...e},n=(e.covers??e.entities??(e.entity?[e.entity]:[])).map(i=>typeof i=="string"?{entity:i}:i);t.covers=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.covers??[];t.covers=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.covers??[]).filter(t=>typeof t=="string");return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:_.text()})),{name:"show_stop",selector:_.bool()}]}label(e){if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt. Per rolluik kun je hieronder een eigen naam zetten."}};I("domotiapp-cover-card-editor",ba);O("domotiapp-cover-card",qt,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function _l(a){if(!a)return{label:"Onbekend",home:null};switch(a.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:a.state,home:!1}}}var Ft=class extends S{validate(e){let t=e.persons??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,persons:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n persoon."}}watched(){return this.config.persons.map(e=>e.entity)}template(){let e=this.config;e.bare&&this.setAttribute("bare","");let t=e.columns??Math.min(e.persons.length,6),n=e.persons.map((i,r)=>`
    ...
    :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
  `);var va=class extends D{setConfig(e){let t={...e},n=(e.persons??[]).map(i=>typeof i=="string"?{entity:i}:i);t.persons=n.map(i=>i.entity);for(let i of n)i.name&&(t[`naam:${i.entity}`]=i.name);super.setConfig(t)}serialize(e){let t={...e},n=t.persons??[];t.persons=n.map(i=>{let r=t[`naam:${i}`];return r?{entity:i,name:r}:i});for(let i of Object.keys(t))i.startsWith("naam:")&&delete t[i];return t}schema(){let e=(this.config_?.persons??[]).filter(t=>typeof t=="string");return[{name:"persons",selector:{entity:{domain:["person","device_tracker"],multiple:!0}}},...e.map(t=>({name:`naam:${t}`,selector:_.text()}))]}label(e){if(e.name==="persons")return"Personen";if(e.name.startsWith("naam:")){let t=e.name.slice(5);return`Naam voor ${this.hass?.states?.[t]?.attributes?.friendly_name??t}`}return super.label(e)}helper(e){if(e.name==="persons")return"Thuis is groen, weg is rood, geen melding is oranje. Per persoon kun je hieronder een eigen naam zetten."}};I("domotiapp-person-card-editor",va);O("domotiapp-person-card",Ft,{name:"DomotiApp Personen",description:"Wie er thuis is, compact. Het hele huishouden in \xE9\xE9n kaart."});var wl=[[/gft|groente|tuin|organi/i,"teal","binWheeled"],[/pmd|plastic|verpakking/i,"solar","binWheeled"],[/papier|karton/i,"water","binWheeled"],[/rest|grijs/i,"neutral","binWheeled"],[/textiel|kleding/i,"pink","bin"],[/glas/i,"magenta","bin"],[/kerstboom|snoei|takken/i,"teal","bin"]];function yl(a){for(let[e,t,n]of wl)if(e.test(a))return{tone:t,icon:n};return{tone:"accent",icon:"bin"}}var xr=a=>String(a??"").replace(/^(afvalbeheer|afvalwijzer|mijnafvalwijzer)\s*/i,"").replace(/\s*(mijnafvalwijzer)\s*/i," ").trim(),Zt=class extends S{validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[T]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}read_(){let e=new Date;return this.config.sensors.map(t=>{let n=x(this.hass,t.entity);if(!n)return null;let i=Qe(n.state)??Qe(n.attributes.date)??Qe(n.attributes.next_date);if(!i)return null;let r=t.label??xr(C(this.hass,t.entity,t.name)),o=yl(t.label??t.entity+r),s=this.config.tones?.[t.entity];return{label:r,date:i,days:jn(e,i),tone:V(s??t.tone??o.tone),icon:t.icon??o.icon}}).filter(t=>t&&t.days>=0).sort((t,n)=>t.date-n.date)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),`
      <div class="card surface">
  ...
  `);var ka=class extends D{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,i]of Object.entries(e.tones??{}))t[`kleur:${n}`]=i;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let i of Object.keys(t))i.startsWith("kleur:")&&(t[i]&&(n[i.slice(6)]=t[i]),delete t[i]);return Object.keys(n).length?t.tones=n:delete t.tones,t}ids_(){return(this.config_?.sensors??[]).map(e=>typeof e=="string"?e:e.entity).filter(Boolean)}pickers(){return this.ids_().map(e=>({key:`kleur:${e}`,kind:"tone",label:`Kleur voor ${xr(this.hass?.states?.[e]?.attributes?.friendly_name??e)||e}`,compact:!0,after:!0}))}schema(){return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}}]}label(e){return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};I("domotiapp-waste-card-editor",ka);O("domotiapp-waste-card",Zt,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});function Ne(a){if(a==null||a==="")return 4;let e=Math.round(Number(a));return Number.isFinite(e)?Math.min(6,Math.max(2,e)):4}function Xt(a,e=!0){if(typeof a=="string")return{name:"",icon:"",path:a,action:null,items:[]};let t=a??{};return{name:typeof t.name=="string"?t.name:"",icon:typeof t.icon=="string"?t.icon:"",path:typeof t.path=="string"?t.path:typeof t.url=="string"?t.url:typeof t.navigation_path=="string"?t.navigation_path:"",action:t.action&&typeof t.action=="object"?{...t.action}:null,items:e&&Array.isArray(t.items)?t.items.slice(0,8).map(n=>Xt(n,!1)):[]}}var Ee=a=>Array.isArray(a?.items)?a.items.filter($e):[],_r=a=>Ee(a).length>0,$e=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.path?.trim()||a.action));function wr(a){return(Array.isArray(a?.items)?a.items:[]).slice(0,20).map(t=>Xt(t))}var yr=[{id:"domotitech",label:"DomotiTech",uitleg:"Opent domotitech.nl in een nieuw tabblad, met het logo erop.",bovenaan:!0,maak:()=>({name:"DomotiTech",icon:"domotitech",path:"https://domotitech.nl",action:null,items:[]})},{id:"herstart",label:"Herstart Home Assistant",uitleg:"Roept homeassistant.restart aan, met een bevestiging ervoor.",bovenaan:!0,maak:()=>({name:"Herstart",icon:"power",path:"",action:{action:"perform-action",perform_action:"homeassistant.restart",confirmation:{title:"Weet je het zeker?",text:"Weet je het zeker dat je Home Assistant wilt herstarten?"}},items:[]})}];function zr(a,e,t=!1){let n=Array.isArray(a)?[...a]:[];if(n.length>=8)return{lijst:n,plek:-1};let i=t?0:n.length;return n.splice(i,0,e),{lijst:n,plek:i}}function Qt(a,e=4){let t=(a??[]).filter($e),n=Ne(e);if(t.length<=n)return{balk:t,meer:[],heeftMeer:!1};let i=Math.max(1,n-1);return{balk:t.slice(0,i),meer:t.slice(i),heeftMeer:!0}}function xa(a){if(a&&typeof a=="object")return a.action?a.action:xa(a.path);let e=String(a??"").trim();return e?/^[a-z][a-z0-9+.-]*:\/\//i.test(e)||e.startsWith("mailto:")?{action:"url",url_path:e}:{action:"navigate",navigation_path:e}:{action:"none"}}var El=`
...
`,jr=/^i(\d+)(s\d+)?$/,Er=a=>({...a.name?{name:a.name}:{},...a.icon?{icon:a.icon}:{},...a.path?{path:a.path}:{},...a.action?{action:structuredClone(a.action)}:{}}),$r=a=>a.filter($e).map(e=>{let t=(e.items??[]).filter($e).map(Er);return{...Er(e),...t.length?{items:t}:{}}}),_a=class extends HTMLElement{constructor(){super(),this.items_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.items,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.items)?e.items:[]).map(n=>Xt(n));this.gebouwd_&&JSON.stringify($r(t))===this.uit_||(this.items_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=El;let t=document.createElement("div");t.className="dac-nav",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="knoppen",t.appendChild(n);let{balk:i}=Qt(this.items_,this.rest_.max),r=i.length,o=this.items_.filter($e);if(this.items_.forEach((d,l)=>{if(o.indexOf(d)===r&&o.length>r){let p=document.createElement("div");p.className="grens",p.textContent="Achter de meer-knop",n.appendChild(p)}n.appendChild(this.itemBlok_(d,l))}),!this.items_.length){let d=document.createElement("p");d.className="uitleg",d.textContent="Elke knop heeft een naam, een icoon en een pad -- bijvoorbeeld /lovelace/keuken voor een view op dit dashboard, of #keuken voor een pop-up. Wat er niet meer in de balk past valt vanzelf achter de meer-knop rechts.",t.appendChild(d)}let s=document.createElement("button");s.type="button",s.className="toevoegen",s.textContent="\uFF0B  Knop toevoegen",s.disabled=this.items_.length>=20,s.addEventListener("click",()=>{this.items_.push({name:"",icon:"",path:""}),this.open_.add(`i${this.items_.length-1}`),this.emit_(),this.build_()}),t.appendChild(s)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"max",selector:{number:{min:2,max:6,step:1,mode:"box"}}},{name:"labels",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({max:"Knoppen in de balk",labels:"Namen onder de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="max")return`De meer-knop telt zelf mee. Staan er meer knoppen dan dit, dan komen de eerste ${Ne(this.rest_.max)-1} in de balk en valt de rest achter "Meer".`;if(t.name==="labels")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt de pil onder de balk weg: alleen de iconen blijven over, zwevend boven het dashboard."},e.data={max:Ne(this.rest_.max),labels:this.rest_.labels!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{};this.rest_.max=Ne(n.max),n.labels===!1?this.rest_.labels=!1:delete this.rest_.labels,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_(),this.build_()}),e}itemBlok_(e,t){let n=document.createElement("details");n.className="item",this.onthoud_(n,`i${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),d=document.createElement("small");o.append(s,d);let l=()=>{let b=!$e(e);n.dataset.leeg=String(b),r.innerHTML=f(e.icon,"grid"),s.textContent=e.name||(b?"Nieuwe knop":e.path||"Zonder naam");let j=Ee(e).length;d.textContent=j?`Menu met ${j} knop${j===1?"":"pen"}`:e.path?e.path:e.icon?`${xe(e.icon)} -- nog geen pad`:"Nog geen pad"};l(),this.koppen_.push(l);let c=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.items_.length-1;let h=this.kopKnop_("Verwijderen",E.close,()=>this.verwijder_(t));h.classList.add("weg"),i.append(r,o,c,p,h),n.appendChild(i);let g=document.createElement("div");g.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",b=>{b.stopPropagation(),e.icon=b.detail.value??"",this.emit_()});let v=document.createElement("ha-form");return v.hass=this.hass_,v.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],v.computeLabel=b=>({name:"Naam",path:"Waar gaat hij heen"})[b.name]??b.name,v.computeHelper=b=>{if(b.name!=="path")return;let j="/lovelace/keuken voor een view, #keuken voor een pop-up van bubble-card, of een https-adres voor iets buiten Home Assistant.";return _r(e)?`${j}

Deze knop heeft subknoppen en klapt dus open in plaats van ergens heen te gaan; zijn eigen pad wordt niet gebruikt.`:j},v.data={name:e.name,path:e.path},v.addEventListener("value-changed",b=>{b.stopPropagation();let j=b.detail.value??{};e.name=j.name??"",e.path=j.path??"",this.emit_()}),g.append(m,v,...this.subBlok_(e,t)),n.appendChild(g),n}subBlok_(e,t){Array.isArray(e.items)||(e.items=[]);let n=document.createElement("div");n.className="subkop",n.textContent="Subknoppen";let i=document.createElement("div");i.className="sublijst",e.items.forEach((s,d)=>i.appendChild(this.subItemBlok_(e,s,t,d)));let r=this.subKeuze_(e,t),o=document.createElement("p");return o.className="uitleg",o.textContent="Hangt hier iets onder, dan klapt deze knop een menu open BOVEN zichzelf in plaats van ergens heen te gaan. Valt de knop zelf achter de meer-knop, dan staan zijn subknoppen daar ingesprongen onder hem.",[n,i,r,o]}subKeuze_(e,t){let n=document.createElement("details");n.className="subkeuze",e.items.length>=8&&n.setAttribute("vol","");let i=document.createElement("summary");i.textContent="\uFF0B  Subknop toevoegen",n.appendChild(i);let r=document.createElement("div");r.className="keuzes",n.appendChild(r);let o=(s,d)=>{let{lijst:l,plek:c}=zr(e.items,s,d);c<0||(e.items=l,this.open_.add(`i${t}`),this.open_.add(`i${t}s${c}`),this.emit_(),this.build_(),requestAnimationFrame(()=>{this.querySelectorAll("details.sub")[c]?.scrollIntoView({block:"nearest"})}))};r.appendChild(this.keuzeKnop_("plus","Lege subknop","Zelf een naam, een icoon en een pad invullen.",()=>o({name:"",icon:"",path:"",action:null,items:[]},!1)));for(let s of yr){let d=s.maak();r.appendChild(this.keuzeKnop_(d.icon,s.label,s.uitleg,()=>o(s.maak(),s.bovenaan)))}return n}keuzeKnop_(e,t,n,i){let r=document.createElement("button");r.type="button";let o=document.createElement("span");o.className="voor",o.innerHTML=f(e,"plus");let s=document.createElement("span");s.className="tekst";let d=document.createElement("b");d.textContent=t;let l=document.createElement("small");return l.textContent=n,s.append(d,l),r.append(o,s),r.addEventListener("click",i),r}subItemBlok_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`i${n}s${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor";let d=document.createElement("span");d.className="titel";let l=document.createElement("b"),c=document.createElement("small");d.append(l,c);let p=()=>{s.innerHTML=f(t.icon,"grid"),l.textContent=t.name||($e(t)?t.path||"Zonder naam":"Nieuwe subknop"),c.textContent=t.action?`Roept ${t.action.perform_action??t.action.service??t.action.action} aan`:t.path||"Nog geen pad"};p(),this.koppen_.push(p);let h=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaatsSub_(e,n,i,-1));h.disabled=i===0;let g=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaatsSub_(e,n,i,1));g.disabled=i===e.items.length-1;let m=this.kopKnop_("Verwijderen",E.close,()=>this.verwijderSub_(e,n,i));m.classList.add("weg"),o.append(s,d,h,g,m),r.appendChild(o);let v=document.createElement("div");v.className="body";let b=document.createElement("dac-icon-picker");b.label="Icoon",b.fallback="grid",b.auto=!1,b.hass=this.hass_,b.value=t.icon,b.addEventListener("value-changed",k=>{k.stopPropagation(),t.icon=k.detail.value??"",this.emit_()});let j=document.createElement("ha-form");return j.hass=this.hass_,j.schema=[{name:"name",selector:{text:{}}},{name:"path",selector:{text:{}}}],j.computeLabel=k=>({name:"Naam",path:"Waar gaat hij heen"})[k.name]??k.name,t.action&&(j.schema=[{name:"name",selector:{text:{}}}],j.computeHelper=k=>k.name==="name"?`Deze knop voert een actie uit (${t.action.perform_action??t.action.service??t.action.action}) en gaat dus nergens heen. Weg met de knop rechtsboven.`:void 0),j.data={name:t.name,path:t.path},j.addEventListener("value-changed",k=>{k.stopPropagation();let A=k.detail.value??{};t.name=A.name??"",t.path=A.path??"",this.emit_()}),v.append(b,j),r.appendChild(v),r}verplaatsSub_(e,t,n,i){let r=n+i;if(r<0||r>=e.items.length)return;[e.items[n],e.items[r]]=[e.items[r],e.items[n]];let o=this.open_.has(`i${t}s${n}`),s=this.open_.has(`i${t}s${r}`);this.open_.delete(`i${t}s${n}`),this.open_.delete(`i${t}s${r}`),s&&this.open_.add(`i${t}s${n}`),o&&this.open_.add(`i${t}s${r}`),this.emit_(),this.build_()}verwijderSub_(e,t,n){e.items.splice(n,1);let i=new Set;for(let r of this.open_){let o=/^i(\d+)s(\d+)$/.exec(r);if(!o||Number(o[1])!==t){i.add(r);continue}let s=Number(o[2]);s!==n&&i.add(`i${t}s${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;n<0||n>=this.items_.length||([this.items_[e],this.items_[n]]=[this.items_[n],this.items_[e]],this.schuifOpen_(e,n),this.emit_(),this.build_())}verwijder_(e){this.items_.splice(e,1);let t=new Set;for(let n of this.open_){let i=jr.exec(n);if(!i)continue;let r=Number(i[1]);r!==e&&t.add(`i${r>e?r-1:r}${i[2]??""}`)}this.open_=t,this.emit_(),this.build_()}schuifOpen_(e,t){let n=new Set;for(let i of this.open_){let r=jr.exec(i);if(!r)continue;let o=Number(r[1]),s=r[2]??"";o===e?n.add(`i${t}${s}`):o===t?n.add(`i${e}${s}`):n.add(i)}this.open_=n}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=$r(this.items_),t={...this.rest_,items:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-navbar-card-editor",_a);var Ar=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*dt(a){let e=Ar(a),t=0;for(;e&&t++<40;)yield e,e=Ar(e)}function $l(a){for(let e of dt(a)){let t=e.tagName?.toLowerCase?.()??"";if(/(^|-)(edit|preview)/.test(t))return!0}return!1}function Al(a){for(let e of dt(a))if(e.tagName?.toLowerCase?.()==="hui-card")return e;return null}function Sl(a){for(let e of dt(a))if(e.tagName?.toLowerCase?.()==="hui-section")return e;return null}function Ml(a){for(let e of dt(a))if(e.classList?.contains?.("section"))return e;return null}function Sr(a){for(let e of dt(a)){let t=e.tagName?.toLowerCase?.()??"";if(t==="hui-view"||t.endsWith("-view"))return e}return null}var Yt=class extends S{validate(e){let t=wr(e),n={labels:!0,tone:"accent",...e,items:t,max:Ne(e?.max)};return t.filter(i=>i.name||i.icon||i.path).length||(n[T]="Voeg knoppen toe in de editor: een naam, een icoon en waar hij heen gaat."),n}watched(){return[]}template(){let e=this.config;e.labels===!1&&this.setAttribute("geen-namen",""),e.bare&&this.setAttribute("bare","");let{balk:t,meer:n,heeftMeer:i}=Qt(e.items,e.max),r=e.items.filter(c=>c.name||c.icon||c.path),o=(c,p)=>{let g=Ee(c).length?` data-menu="s${p}" aria-haspopup="true" aria-expanded="false"`:"";return`
      ...
      </button>`,d=n.map(c=>{let p=r.indexOf(c),h=Ee(c);return h.length?`
      <div class="regel kop">
        <span class="mi">${f(c.icon,"grid")}</span>
        <span class="mt">${B(c.name||c.path)}</span>
      </div>`+h.map((m,v)=>s(m,p,v,"sub")).join(""):s(c,p)}).join(""),l=t.map(c=>{let p=Ee(c);if(!p.length)return"";let h=r.indexOf(c);return`<div class="menu submenu" data-id="s${h}" role="menu">${p.map((g,m)=>s(g,h,m)).join("")}</div>`}).join("");return`
  ...
  `);O("domotiapp-navbar-card",Yt,{name:"DomotiApp Navbalk",description:`Vaste navigatiebalk onderaan het scherm, met een meer-menu voor wat er in de breedte niet bij past. ${2} tot ${6} knoppen in de balk.`});var Nl="dac-tabs:";function za(a){let e=a??{},t=typeof e.name=="string"?e.name:typeof e.title=="string"?e.title:"",n=Array.isArray(e.cards)?e.cards.filter(r=>r&&typeof r=="object"):[],i=n.length?n:e.card&&typeof e.card=="object"?[e.card]:[];return{name:t,icon:typeof e.icon=="string"?e.icon:"",cards:i}}var Jt=a=>!!(a&&(a.name?.trim()||a.icon?.trim()||a.cards?.length));function Mr(a){return(Array.isArray(a?.tabs)?a.tabs:[]).slice(0,8).map(za).filter(Jt)}function Ol(a,e){if(!e)return 0;let t=Math.round(Number(a?.default_tab));return!Number.isFinite(t)||t<1||t>e?0:t-1}function ja(a){let e=(a??[]).map((t,n)=>(t?.name?.trim()||t?.icon?.trim()||`tab${n}`).toLowerCase()).join("|");return Nl+e}function Cl(a,e,t){let n=null;try{n=a?.getItem?.(e)??null}catch{return null}let i=Number(n);return n===null||n===""||!Number.isInteger(i)?null:i>=0&&i<t?i:null}function Nr(a,e,t){try{return a?.setItem?.(e,String(t)),!0}catch{return!1}}function Or(a,e,t){return Cl(t,ja(e),e.length)??Ol(a,e.length)}var Tl=[["tile","Tegel"],["entities","Entiteiten"],["button","Knop"],["gauge","Meter"],["history-graph","Geschiedenis"],["statistic","Statistiek"],["sensor","Sensorgrafiek"],["light","Lamp"],["thermostat","Thermostaat"],["humidifier","Luchtbevochtiger"],["media-control","Mediaspeler"],["weather-forecast","Weersverwachting"],["markdown","Tekst (Markdown)"],["picture","Afbeelding"],["picture-entity","Afbeelding met entiteit"],["glance","Overzicht"],["area","Ruimte"],["alarm-panel","Alarmpaneel"],["calendar","Agenda"],["todo-list","Takenlijst"],["map","Kaart"],["iframe","Webpagina"],["vertical-stack","Stapel (onder elkaar)"],["horizontal-stack","Stapel (naast elkaar)"],["grid","Raster"],["conditional","Voorwaardelijk"]];function Cr(){let a=(window.customCards??[]).filter(e=>e&&typeof e.type=="string").map(e=>({type:`custom:${e.type}`,naam:e.name||e.type,uitleg:e.description||"",eigen:!0}));return a.sort((e,t)=>{let n=e.type.startsWith("custom:domotiapp-")?0:1,i=t.type.startsWith("custom:domotiapp-")?0:1;return n-i||e.naam.localeCompare(t.naam,"nl")}),[...a,...Tl.map(([e,t])=>({type:e,naam:t,uitleg:"",eigen:!1}))]}function Tr(a,e){let t=String(e??"").trim().toLowerCase();return t?a.filter(n=>`${n.naam} ${n.type} ${n.uitleg}`.toLowerCase().includes(t)):a}async function Lr(a,e){let t={type:a};try{let n=await window.loadCardHelpers?.();try{n?.createCardElement?.(t)}catch{}let i=a.startsWith("custom:")?a.slice(7):`hui-${a}-card`,o=await customElements.get(i)?.getStubConfig?.(e,Object.keys(e?.states??{}),[]);if(o&&typeof o=="object")return{...o,type:a}}catch{}return t}var Dr=()=>!!customElements.get("hui-card-element-editor");function Ll(a){let e=a?.columns,t=a?.rows,n=12;if(e!=null&&e!=="full"){let o=Math.round(Number(e));n=Number.isFinite(o)?Math.min(12,Math.max(1,o)):12}let i={gridColumn:`span ${n}`},r=Math.round(Number(t));return t!=="auto"&&Number.isFinite(r)&&r>=1&&(i.height=`${r*64-8}px`),i}function en(a,e){if(!a?.style)return;let{gridColumn:t,height:n}=Ll(e);a.style.gridColumn=t,a.style.height=n??""}function Hr(a,e,t={}){let n=Array.isArray(a)?[...a]:[],i=Number(t.index);switch(e){case"verplaats":{let r=Number(t.van),o=Number(t.naar);if(!Number.isInteger(r)||!Number.isInteger(o)||r<0||r>=n.length||o<0||o>=n.length||r===o)return null;let[s]=n.splice(r,1);return n.splice(o,0,s),n}case"dupliceer":return!Number.isInteger(i)||!n[i]?null:(n.splice(i+1,0,structuredClone(n[i])),n);case"verwijder":return!Number.isInteger(i)||!n[i]?null:(n.splice(i,1),n);case"rooster":return!Number.isInteger(i)||!n[i]||!t.rooster?null:(n[i]={...n[i],grid_options:{...n[i].grid_options??{},...t.rooster}},n);default:return null}}var Ir=a=>({...a?{config:a}:{},editMode:!0,saveConfig:async()=>{}}),Dl=()=>document.querySelector("home-assistant");function Rr({kaarten:a,hass:e,maakKaart:t,opActie:n}){let i=document.createElement("ha-sortable");i.disabled=!1,i.draggableSelector=".dac-kaart",i.rollback=!1,i.invertSwap=!0,i.options={delay:100,delayOnTouchOnly:!0,direction:"vertical",invertedSwapThreshold:.7};let r=document.createElement("div");r.className="dac-kaarten";let o=[];a.forEach((l,c)=>{let p=t(l,c);if(!p)return;let h=document.createElement("div");h.className="dac-kaart",en(h,l?.grid_options);let g=document.createElement("hui-card-edit-mode");g.hass=e,g.lovelace=Ir(),g.path=[0,0,c],g.hiddenOverlay=!1,g.appendChild(p),o.push(g),h.appendChild(g),r.appendChild(h)}),i.appendChild(r);let s=l=>{for(let c of o)c.hiddenOverlay=!l};i.addEventListener("drag-start",()=>s(!1)),i.addEventListener("drag-end",()=>s(!0)),i.addEventListener("item-moved",l=>{l.stopPropagation(),n("verplaats",{van:l.detail.oldIndex,naar:l.detail.newIndex})});let d={"ll-edit-card":l=>n("bewerk",{index:l.detail.path[2]}),"ll-duplicate-card":l=>n("dupliceer",{index:l.detail.path[2]}),"ll-delete-card":l=>n("verwijder",{index:l.detail.path[2]}),"ll-copy-card":l=>n("kopieer",{index:l.detail.path[2]}),"ll-change-grid-options":l=>n("rooster",{index:l.detail.path?.[2],rooster:l.detail.gridOptions}),"ll-move-to-section":()=>{}};for(let[l,c]of Object.entries(d))i.addEventListener(l,p=>{p.stopPropagation(),c(p)});return i}function Pr(a){try{let e=typeof structuredClone=="function"?structuredClone(a):JSON.parse(JSON.stringify(a));return sessionStorage.setItem("dashboardCardClipboard",JSON.stringify(e)),!0}catch{return!1}}function Vr({hass:a,kaarten:e}){let t=Dl();return!t||!customElements.get("hui-section")?Promise.resolve(null):new Promise(n=>{let i=null,r=null,o=!1,s=()=>{o||(o=!0,t.removeEventListener("show-dialog",d,!0),window.removeEventListener("dialog-closed",l,!0),n(i?{kaart:i}:r?{kaarten:r}:null))},d=g=>{if(g?.detail?.dialogTag!=="hui-dialog-edit-card")return;let m=g.detail?.dialogParams?.cardConfig;g.stopImmediatePropagation?.(),g.stopPropagation(),m&&(i=m);let v=t.querySelector("hui-dialog-create-card");typeof v?.closeDialog=="function"&&v.closeDialog(),setTimeout(s,0)},l=g=>{g?.detail?.dialog==="hui-dialog-create-card"&&setTimeout(s,0)};t.addEventListener("show-dialog",d,!0),window.addEventListener("dialog-closed",l,!0);let c={type:"grid",cards:[...e]},p=document.createElement("hui-section");p.style.display="none",p.hass=a,p.index=0,p.viewIndex=0,p.config=c,p.lovelace={...Ir({views:[{path:"domotiapp-kiezer",title:"DomotiApp",sections:[c]}]}),saveConfig:async g=>{let m=g?.views?.[0]?.sections?.[0]?.cards;Array.isArray(m)&&(r=m)}},t.appendChild(p),(async()=>{try{typeof p._initializeConfig=="function"?await p._initializeConfig():await p.updateComplete;let g=p._layoutElement;if(!g)throw new Error("de proxysectie heeft geen layout-element");g.dispatchEvent(new CustomEvent("ll-create-card",{bubbles:!0,composed:!0}))}catch(g){console.warn("DomotiApp: de kaartkiezer van Home Assistant ging niet open",g),s()}finally{setTimeout(()=>p.remove(),0)}})()})}var tn=()=>!!(customElements.get("hui-card-edit-mode")&&customElements.get("ha-sortable")&&customElements.get("hui-section"));var Hl=`
...
`,Kr=a=>a.filter(Jt).map(e=>({...e.name?{name:e.name}:{},...e.icon?{icon:e.icon}:{},...e.cards?.length?{cards:e.cards.map(t=>structuredClone(t))}:{}}));function Be(a){let e=String(a?.type??"").replace(/^custom:/,"");return e?(window.customCards??[]).find(n=>n?.type===e)?.name||e:"een kaart"}function Ea(a){let e=a.cards?.length??0;return e?e===1?Be(a.cards[0]):`${e} kaarten`:"Nog geen kaart"}var $a=class extends HTMLElement{constructor(){super(),this.tabs_=[],this.rest_={},this.open_=new Set}setConfig(e){if(this.rest_={...e},delete this.rest_.tabs,this.gebouwd_&&e===this.uitObject_)return;let t=(Array.isArray(e?.tabs)?e.tabs:[]).map(za);this.gebouwd_&&JSON.stringify(Kr(t))===this.uit_||(this.tabs_=t,this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, hui-card-element-editor, hui-card-visibility-editor, hui-card-layout-editor"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}set lovelace(e){this.lovelace_=e;for(let t of this.querySelectorAll("hui-card-element-editor"))t.lovelace=e}get lovelace(){return this.lovelace_}connectedCallback(){this.gebouwd_||this.build_()}async build_(){if(!this.hass_)return;if(await customElements.whenDefined("ha-form"),!this.helpers_)try{this.helpers_=await window.loadCardHelpers?.()}catch{this.helpers_=null}this.gebouwd_=!0,this.replaceChildren(),this.koppen_=[];let e=document.createElement("style");e.textContent=Hl;let t=document.createElement("div");t.className="dac-tabs",this.append(e,t),t.appendChild(this.kaartBlok_());let n=document.createElement("div");n.className="lijst",t.appendChild(n),this.tabs_.forEach((r,o)=>n.appendChild(this.tabBlok_(r,o)));let i=document.createElement("button");i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Tabblad toevoegen",i.disabled=this.tabs_.length>=8,i.addEventListener("click",()=>{this.tabs_.push({name:"",icon:"",cards:[]}),this.open_.add(`t${this.tabs_.length-1}`),this.emit_(),this.build_()}),t.appendChild(i)}kaartBlok_(){let e=document.createElement("ha-form");return e.hass=this.hass_,e.schema=[{name:"default_tab",selector:{number:{min:1,max:8,step:1,mode:"box"}}},{name:"alignment",selector:{select:{mode:"dropdown",options:[{value:"vullen",label:"Verdeeld over de breedte"},{value:"links",label:"Links"},{value:"rechts",label:"Rechts"}]}}},{name:"show_names",selector:{boolean:{}}},{name:"bare",selector:{boolean:{}}}],e.computeLabel=t=>({default_tab:"Welk tabblad staat open op een nieuw apparaat",alignment:"Uitlijning van de rij",show_names:"Namen naast de iconen",bare:"Achtergrond weglaten"})[t.name]??t.name,e.computeHelper=t=>{if(t.name==="default_tab")return"Telt vanaf 1. Dit geldt alleen zolang een apparaat nog niets gekozen heeft \u2014 daarna onthoudt elk apparaat zijn eigen tabblad, en dat van je telefoon staat los van dat van de tablet.";if(t.name==="show_names")return"Uit geeft een rij kale iconen. Dan passen er meer naast elkaar op een telefoon.";if(t.name==="bare")return"Haalt het vlak onder de kaart weg. De rij tabbladen houdt zijn eigen pil."},e.data={default_tab:Number(this.rest_.default_tab)||1,alignment:this.rest_.alignment??"vullen",show_names:this.rest_.show_names!==!1,bare:!!this.rest_.bare},e.addEventListener("value-changed",t=>{t.stopPropagation();let n=t.detail.value??{},i=Number(n.default_tab);Number.isFinite(i)&&i>1?this.rest_.default_tab=i:delete this.rest_.default_tab,n.alignment==="links"||n.alignment==="rechts"?this.rest_.alignment=n.alignment:delete this.rest_.alignment,n.show_names===!1?this.rest_.show_names=!1:delete this.rest_.show_names,n.bare?this.rest_.bare=!0:delete this.rest_.bare,this.emit_()}),e}tabBlok_(e,t){let n=document.createElement("details");n.className="tab",this.onthoud_(n,`t${t}`);let i=document.createElement("summary"),r=document.createElement("span");r.className="voor";let o=document.createElement("span");o.className="titel";let s=document.createElement("b"),d=document.createElement("small");o.append(s,d);let l=()=>{n.dataset.leeg=String(!Jt(e)),r.innerHTML=f(e.icon,"grid"),s.textContent=e.name||`Tabblad ${t+1}`,d.textContent=Ea(e)};l(),this.koppen_.push(l);let c=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaats_(t,-1));c.disabled=t===0;let p=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaats_(t,1));p.disabled=t===this.tabs_.length-1;let h=this.kopKnop_("Verwijderen",E.close,()=>this.verwijder_(t));h.classList.add("weg"),i.append(r,o,c,p,h),n.appendChild(i);let g=document.createElement("div");g.className="body";let m=document.createElement("dac-icon-picker");m.label="Icoon",m.fallback="grid",m.auto=!1,m.hass=this.hass_,m.value=e.icon,m.addEventListener("value-changed",b=>{b.stopPropagation(),e.icon=b.detail.value??"",this.emit_()});let v=document.createElement("ha-form");return v.hass=this.hass_,v.schema=[{name:"name",selector:{text:{}}}],v.computeLabel=()=>"Naam",v.computeHelper=()=>"Deze naam bepaalt ook onder welke sleutel een apparaat zijn keuze onthoudt. Hernoem je hem, dan begint elk apparaat \xE9\xE9n keer opnieuw bij het eerste tabblad.",v.data={name:e.name},v.addEventListener("value-changed",b=>{b.stopPropagation(),e.name=b.detail.value?.name??"",this.emit_()}),g.append(m,v,this.inhoudBlok_(e,t)),n.appendChild(g),n}inhoudBlok_(e,t){let n=document.createElement("div");if(n.className="kaartvak",Array.isArray(e.cards)||(e.cards=[]),!Dr()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${f("grid")}<span>Inhoud: <b>${Ea(e)}</b> \u2014 aan te passen via Code-editor weergeven.</span>`,n.appendChild(r),n}if(tn()){let r=document.createElement("div");return r.className="inhoud",r.innerHTML=`${f("grid")}<span>${e.cards.length?`<b>${Ea(e)}</b> \u2014 te bewerken in het voorbeeld hiernaast: slepen om te verplaatsen, het potlood om te bewerken.`:"Nog geen kaart \u2014 voeg er een toe in het voorbeeld hiernaast."}</span>`,n.appendChild(r),this.bewerkt_?.tab===t&&e.cards[this.bewerkt_.index]&&n.appendChild(this.bewerkVak_(e,t,this.bewerkt_.index)),n}if(e.cards.length){let r=document.createElement("div");r.className="subkop",r.textContent=e.cards.length===1?"Kaart":`${e.cards.length} kaarten`,n.appendChild(r),e.cards.forEach((o,s)=>n.appendChild(this.kaartBlok2_(e,o,t,s)))}if(this.kiest_===`t${t}`)return n.appendChild(this.kiezerBlok_(e,t)),n;let i=document.createElement("button");return i.type="button",i.className="toevoegen",i.textContent="\uFF0B  Kaart toevoegen",i.addEventListener("click",()=>{this.kiest_=`t${t}`,this.zoek_="",this.build_()}),n.appendChild(i),n}uitVoorbeeld(e,t,n){let i=this.tabs_[e];if(i){if(t==="toevoegen"){this.voegToeViaHa_(i,e);return}this.kaartActie_(i,e,t,n)}}toonBewerkVak_(){let e=this.querySelector(".bewerkvak"),t=this.bewerkt_?.tab,n=this.bewerkt_?.index,i=Number.isInteger(t)?this.tabs_[t]:null;if(!i||!i.cards[n]){e?.remove();return}let r=this.bewerkVak_(i,t,n);e?e.replaceWith(r):this.querySelectorAll(".kaartvak")[t]?.appendChild(r),r.scrollIntoView({block:"nearest"})}kaartActie_(e,t,n,i){if(n==="bewerk"){(this.bewerkt_?.tab!==t||this.bewerkt_?.index!==i.index)&&(this.kaartBlad_="config"),this.bewerkt_={tab:t,index:i.index},this.open_.add(`t${t}`);let o=this.querySelectorAll("details.tab")[t];o&&(o.open=!0),this.toonBewerkVak_();return}if(n==="kopieer"){Pr(e.cards[i.index]);return}let r=Hr(e.cards,n,i);r&&(e.cards=r,this.bewerkt_=null,this.emit_(),this.build_())}bewerkVak_(e,t,n){let i=document.createElement("div");i.className="bewerkvak";let r=document.createElement("div");r.className="kop";let o=document.createElement("b");o.textContent=Be(e.cards[n]);let s=document.createElement("button");s.type="button",s.textContent="Klaar",s.addEventListener("click",()=>{this.bewerkt_=null,this.build_()}),r.append(o,s);let d=document.createElement("div");d.className="body";let l=this.kaartTabbladen_(e,t,n,d,o);l&&i.append(r,l,d);let c=document.createElement("hui-card-element-editor");return c.hass=this.hass_,this.lovelace_&&(c.lovelace=this.lovelace_),c.value=e.cards[n],c.addEventListener("config-changed",p=>{p.stopPropagation();let h=p.detail?.config;h&&(e.cards[n]=h,this.emit_(),o.textContent=Be(h))}),c.addEventListener("GUImode-changed",p=>p.stopPropagation()),this.kaartEditor_=c,d.appendChild(c),l||i.append(r,d),i}kaartTabbladen_(e,t,n,i,r){let o=!!customElements.get("hui-card-visibility-editor"),s=!!customElements.get("hui-card-layout-editor");if(!o&&!s)return null;let d=document.createElement("div");d.className="kaarttabs";let l=[{id:"config",naam:"Configuratie"},...o?[{id:"zicht",naam:"Zichtbaarheid"}]:[],...s?[{id:"indeling",naam:"Indeling"}]:[]],c=h=>{this.kaartBlad_=h;for(let g of d.querySelectorAll("button"))g.setAttribute("aria-selected",String(g.dataset.blad===h));i.replaceChildren(this.bladInhoud_(h,e,t,n,r))};for(let h of l){let g=document.createElement("button");g.type="button",g.dataset.blad=h.id,g.textContent=h.naam,g.setAttribute("role","tab"),g.setAttribute("aria-selected","false"),g.addEventListener("click",()=>c(h.id)),d.appendChild(g)}let p=l.some(h=>h.id===this.kaartBlad_)?this.kaartBlad_:"config";return setTimeout(()=>c(p),0),d}bladInhoud_(e,t,n,i,r){if(e==="config")return this.kaartEditor_;let o=document.createElement(e==="zicht"?"hui-card-visibility-editor":"hui-card-layout-editor");return o.hass=this.hass_,o.config=t.cards[i],e==="indeling"&&(o.sectionConfig={type:"grid",column_span:1}),o.addEventListener("value-changed",s=>{s.stopPropagation();let d=s.detail?.value;d&&(t.cards[i]=d,o.config=d,this.emit_(),r.textContent=Be(d))}),o}async voegToeViaHa_(e,t){let n=await Vr({hass:this.hass_,kaarten:e.cards});n&&(n.kaarten?(e.cards=n.kaarten,this.bewerkt_=null):(e.cards.push(n.kaart),this.bewerkt_={tab:t,index:e.cards.length-1}),this.open_.add(`t${t}`),this.emit_(),this.build_())}kaartBlok2_(e,t,n,i){let r=document.createElement("details");r.className="sub",this.onthoud_(r,`t${n}k${i}`);let o=document.createElement("summary"),s=document.createElement("span");s.className="voor",s.innerHTML=f("grid");let d=document.createElement("span");d.className="titel";let l=document.createElement("b");l.textContent=Be(t);let c=document.createElement("small");c.textContent=String(t?.type??""),d.append(l,c);let p=this.kopKnop_("Omhoog",E.arrowUp,()=>this.verplaatsKaart_(e,n,i,-1));p.disabled=i===0;let h=this.kopKnop_("Omlaag",E.arrowDown,()=>this.verplaatsKaart_(e,n,i,1));h.disabled=i===e.cards.length-1;let g=this.kopKnop_("Verwijderen",E.close,()=>this.verwijderKaart_(e,n,i));g.classList.add("weg"),o.append(s,d,p,h,g),r.appendChild(o);let m=document.createElement("div");m.className="body";let v=document.createElement("hui-card-element-editor");return v.hass=this.hass_,this.lovelace_&&(v.lovelace=this.lovelace_),v.value=t,v.addEventListener("config-changed",b=>{b.stopPropagation();let j=b.detail?.config;j&&(e.cards[i]=j,this.emit_(),l.textContent=Be(j),c.textContent=String(j.type??""))}),v.addEventListener("GUImode-changed",b=>b.stopPropagation()),m.appendChild(v),r.appendChild(m),r}verplaatsKaart_(e,t,n,i){let r=n+i;if(r<0||r>=e.cards.length)return;[e.cards[n],e.cards[r]]=[e.cards[r],e.cards[n]];let o=this.open_.has(`t${t}k${n}`),s=this.open_.has(`t${t}k${r}`);this.open_.delete(`t${t}k${n}`),this.open_.delete(`t${t}k${r}`),s&&this.open_.add(`t${t}k${n}`),o&&this.open_.add(`t${t}k${r}`),this.emit_(),this.build_()}verwijderKaart_(e,t,n){e.cards.splice(n,1);let i=new Set;for(let r of this.open_){let o=new RegExp(`^t${t}k(\\d+)$`).exec(r);if(!o){i.add(r);continue}let s=Number(o[1]);s!==n&&i.add(`t${t}k${s>n?s-1:s}`)}this.open_=i,this.emit_(),this.build_()}kiezerBlok_(e,t){let n=document.createElement("div");n.className="kiezer";let i=document.createElement("input");i.type="text",i.placeholder="Zoek een kaart...",i.value=this.zoek_??"";let r=document.createElement("div");r.className="soorten";let o=()=>{let d=Tr(Cr(),this.zoek_);if(r.replaceChildren(),!d.length){let l=document.createElement("p");l.className="leeg",l.textContent="Niets gevonden. Kies iets anders, of gebruik de code-editor.",r.appendChild(l);return}for(let l of d){let c=document.createElement("button");c.type="button",c.className="soort";let p=document.createElement("b");p.textContent=l.naam;let h=document.createElement("small");h.textContent=l.uitleg||l.type,c.append(p,h),c.addEventListener("click",async()=>{e.cards.push(await Lr(l.type,this.hass_)),this.kiest_=null,this.open_.add(`t${t}`),this.open_.add(`t${t}k${e.cards.length-1}`),this.emit_(),this.build_()}),r.appendChild(c)}};o(),i.addEventListener("input",()=>{this.zoek_=i.value,o()});let s=document.createElement("button");return s.type="button",s.className="toevoegen",s.textContent="Annuleren",s.addEventListener("click",()=>{this.kiest_=null,this.build_()}),n.append(i,r,s),n}kopKnop_(e,t,n){let i=document.createElement("button");return i.type="button",i.className="rondknop",i.title=e,i.setAttribute("aria-label",e),i.innerHTML=t,i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),i.disabled||n()}),i}verplaats_(e,t){let n=e+t;if(n<0||n>=this.tabs_.length)return;[this.tabs_[e],this.tabs_[n]]=[this.tabs_[n],this.tabs_[e]];let i=this.open_.has(`t${e}`),r=this.open_.has(`t${n}`);this.open_.delete(`t${e}`),this.open_.delete(`t${n}`),r&&this.open_.add(`t${e}`),i&&this.open_.add(`t${n}`),this.emit_(),this.build_()}verwijder_(e){this.tabs_.splice(e,1);let t=new Set;for(let n of this.open_){let i=Number(n.slice(1));i!==e&&t.add(`t${i>e?i-1:i}`)}this.open_=t,this.emit_(),this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}emit_(){let e=Kr(this.tabs_),t={...this.rest_,tabs:e};this.uit_=JSON.stringify(e),this.uitObject_=t;for(let n of this.koppen_??[])n();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};M("domotiapp-tabs-card-editor",$a);var Gr=a=>a.parentElement??(a.parentNode&&a.parentNode.host)??null;function*Wr(a){let e=Gr(a),t=0;for(;e&&t++<40;)yield e,e=Gr(e)}function Ur(a){let e=null;for(let n of Wr(a))if((n.tagName?.toLowerCase?.()??"")==="hui-dialog-edit-card"){e=n;break}if(!e)return null;let t=(n,i=0)=>{if(!n||i>25)return null;if(n.tagName?.toLowerCase?.()==="domotiapp-tabs-card-editor")return n;for(let r of n.children??[]){let o=t(r,i+1);if(o)return o}if(n.shadowRoot)for(let r of n.shadowRoot.children){let o=t(r,i+1);if(o)return o}return null};return t(e)}var an=class extends S{constructor(){super(),this.kinderen_=new Map,this.open_=0}validate(e){let t=Mr(e),n={tone:"accent",...e,tabs:t};return t.length||(n[T]="Voeg tabbladen toe: elk met een naam, een icoon en een kaart erin."),n}watched(){return[]}setConfig(e){this.kinderen_.clear(),super.setConfig(e)}set hass(e){super.hass=e;for(let t of this.kinderen_.values())if(t)for(let n of t)n&&(n.hass=e)}get hass(){return super.hass}template(){let e=this.config;e.bare&&this.setAttribute("bare",""),e.show_names===!1&&this.setAttribute("geen-namen",""),(e.alignment==="links"||e.alignment==="rechts")&&this.setAttribute("uitgelijnd",e.alignment);let t=e.tabs.map((i,r)=>`
      ...
      </div>`}wire(){for(let e of this.$$(".tab"))this.on(e,"click",()=>this.kies_(Number(e.dataset.i)));this.teardown_.push(K(this.$(".card"))),this.kies_(Or(this.config,this.config.tabs,this.opslag_()),!1)}paint(){}opslag_(){try{return window.localStorage}catch{return null}}kies_(e,t=!0){let n=this.config.tabs;if(!n.length)return;let i=Math.min(Math.max(0,e),n.length-1);this.open_=i;for(let r of this.$$(".tab"))r.setAttribute("aria-selected",String(Number(r.dataset.i)===i));for(let r of this.$$(".vak"))r.dataset.open=String(Number(r.dataset.i)===i);t&&Nr(this.opslag_(),ja(n),i),this.bouw_(i)}async bouw_(e){if(this.kinderen_.has(e)){L(this.$(".card"));return}let t=this.$(`.vak[data-i="${e}"]`),n=this.config.tabs[e];if(!(!t||!n)){if(!n.cards.length){let i=document.createElement("div");i.className="leeg",i.textContent="Deze tab heeft nog geen kaart.",t.replaceChildren(i),L(this.$(".card")),this.knopLater_(e);return}this.kinderen_.set(e,null);try{if(!await window.loadCardHelpers?.())throw new Error("loadCardHelpers ontbreekt");let r=Ur(this),o=!!r,s=n.cards.map(d=>{let l=document.createElement("hui-card");return l.hass=this.hass,l.preview=o,l.config=d,en(l,d?.grid_options),l});if(this.kinderen_.set(e,s),r&&tn()){t.replaceChildren(Rr({hass:this.hass,kaarten:n.cards,maakKaart:(d,l)=>s[l]??null,opActie:(d,l)=>r.uitVoorbeeld?.(e,d,l)}),this.voegToeKnop_(e)),L(this.$(".card"));return}t.replaceChildren(...s),L(this.$(".card"))}catch(i){this.kinderen_.delete(e),t.innerHTML=`<div class="leeg">Deze kaart kon niet geladen worden: ${B(i?.message??i)}</div>`,L(this.$(".card"))}}}knopLater_(e,t=60){let n=this.$(`.vak[data-i="${e}"]`);if(!n||n.querySelector(".voegtoe")||this.config?.tabs?.[e]?.cards?.length)return;if(this.inVoorbeeld_()){n.appendChild(this.voegToeKnop_(e)),L(this.$(".card"));return}if(t<=0)return;let i=setTimeout(()=>this.knopLater_(e,t-1),50);this.teardown_.push(()=>clearTimeout(i))}inVoorbeeld_(){for(let e of Wr(this))if(e.tagName?.toLowerCase?.()==="hui-dialog-edit-card")return!0;return!1}voegToeKnop_(e){let t=document.createElement("button");return t.type="button",t.className="voegtoe",t.textContent="\uFF0B  Kaart toevoegen",t.addEventListener("click",n=>{n.stopPropagation(),Ur(this)?.uitVoorbeeld?.(e,"toevoegen",{})}),t}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-tabs-card-editor")}static getStubConfig(){return{tabs:[{name:"Woning",icon:"house",card:null},{name:"Weer",icon:"cloudSun",card:null}]}}};z(an,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);O("domotiapp-tabs-card",an,{name:"DomotiApp Tabbladen",description:"Meerdere kaarten achter tabbladen, met een rij knoppen erboven. De gekozen tab wordt per apparaat onthouden."});var P={UIT:"uit",KLAAR:"klaar",UITGESTELD:"uitgesteld",DRAAIT:"draait",PAUZE:"pauze",AF:"af",FOUT:"fout",ONBEKEND:"onbekend"},Il=[[P.FOUT,["error","fout","aborting","afgebroken"]],[P.DRAAIT,["run","active","washing","drying","rinsing","bezig","draait","on"]],[P.PAUZE,["pause","paused","pauze","onderbroken"]],[P.UITGESTELD,["delayedstart","delayed","scheduled","uitgesteld","wachten"]],[P.AF,["finished","complete","done","klaar met","afgelopen"]],[P.KLAAR,["ready","idle","standby","klaar","gereed"]],[P.UIT,["off","inactive","uit"]]],Rl=new Set([P.DRAAIT]);function Fr(a){let e=String(a??"").toLowerCase().trim();if(!e||e==="unknown"||e==="unavailable")return P.ONBEKEND;let t=e.split(/[^a-z0-9]+/).filter(Boolean);for(let[n,i]of Il)for(let r of i)if(r.includes(" ")?e.includes(r):t.includes(r))return n;return P.ONBEKEND}var Zr=a=>Rl.has(Fr(a?.state));function Xr(a,e=new Date){if(!a)return null;let t=String(a.state??"").trim();if(!t||t==="unknown"||t==="unavailable")return null;let n=a.attributes??{};if(n.device_class==="timestamp"||/^\d{4}-\d{2}-\d{2}[T ]/.test(t)){let s=new Date(t);return Number.isNaN(+s)?null:Math.max(0,Math.round((s-e)/6e4))}let i=t.match(/^(\d{1,3}):(\d{2})(?::(\d{2}))?$/);if(i)return Number(i[1])*60+Number(i[2])+(i[3]?Math.round(Number(i[3])/60):0);let r=Number(t);if(!Number.isFinite(r))return null;let o=String(n.unit_of_measurement??"min").toLowerCase();return o.startsWith("s")?Math.round(r/60):o.startsWith("h")||o.startsWith("u")?Math.round(r*60):Math.round(r)}function qr(a){if(a==null)return"";if(a<=0)return"Klaar";if(a<60)return`nog ${a} min`;let e=Math.floor(a/60),t=a%60;return t?`nog ${e} u ${t} min`:`nog ${e} uur`}function Qr(a){if(!a)return null;let e=String(a.state??"").trim();if(!e||e==="unknown"||e==="unavailable")return null;let t=Number(e);return Number.isFinite(t)?Math.min(100,Math.max(0,Math.round(t))):null}var Pl=a=>!!a&&a.state==="on",Yr=a=>a===P.DRAAIT||a===P.PAUZE||a===P.UITGESTELD;function Jr({status:a,deur:e,rest:t,pct:n}={}){let i=Fr(a?.state),r=Pl(e);if(i===P.DRAAIT){let o=[];return t!=null?o.push(qr(t)):n!=null&&o.push(`${n}%`),{soort:i,tekst:o.length?`Draait \xB7 ${o.join(" ")}`:"Draait",tone:"accent",waarschuwing:""}}return i===P.PAUZE?{soort:i,tekst:"Gepauzeerd",tone:"warn",waarschuwing:r?"Klep open":""}:i===P.FOUT?{soort:i,tekst:"Storing",tone:"bad",waarschuwing:r?"Klep open":""}:i===P.AF?{soort:i,tekst:"Programma klaar",tone:"good",waarschuwing:""}:i===P.UITGESTELD?{soort:i,tekst:t!=null?`Start over ${qr(t).replace(/^nog /,"")}`:"Uitgestelde start",tone:"accent",waarschuwing:r?"Klep open":""}:r?{soort:i,tekst:"Klep open",tone:"warn",waarschuwing:""}:i===P.UIT?{soort:i,tekst:"Uit",tone:"neutral",waarschuwing:""}:i===P.KLAAR?{soort:i,tekst:"Klaar om te starten",tone:"neutral",waarschuwing:""}:{soort:P.ONBEKEND,tekst:"Niet bereikbaar",tone:"neutral",waarschuwing:""}}function eo(a){let e=String(a??"");switch(e.split(".")[0]){case"button":return["button","press",{entity_id:e}];case"input_button":return["input_button","press",{entity_id:e}];case"script":return["script","turn_on",{entity_id:e}];case"scene":return["scene","turn_on",{entity_id:e}];case"switch":case"input_boolean":return["homeassistant","turn_on",{entity_id:e}];case"automation":return["automation","trigger",{entity_id:e}];default:return null}}var Vl={good:N.good,warn:N.warn,bad:N.bad,neutral:N.neutral,accent:N.accent},rn=class extends S{validate(e){let t={name:"",icon:"dishwasher",...e};return!t.status&&!t.remaining&&!t.progress&&!t.program&&(t[T]="Kies minstens een statussensor. Resterende tijd, voortgang, programma en de knoppen mogen daarna."),t}watched(){return[this.config.status,this.config.remaining,this.config.progress,this.config.program,this.config.door,this.config.smart,this.config.start,this.config.stop].filter(Boolean)}template(){this.config.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size";let t=(n,i,r)=>`
      <button type="button" class="knop ${n}" hidden>
        ${f(i)}<span class="lb">${B(r)}</span>
      </button>`;return`
      <div class="card surface" style="--tone:${N.accent}">
      ...
      </div>`}wire(){let e=this.config;this.on(this.$(".top"),"click",()=>{let t=e.status||e.remaining||e.program;t&&this.moreInfo_(t)}),this.on(this.$(".knop.start"),"click",()=>this.druk_(e.start)),this.on(this.$(".knop.stop"),"click",()=>this.druk_(e.stop)),this.on(this.$(".knop.slim"),"click",()=>{if(!e.smart)return;let t=ke(x(this.hass,e.smart));this.hass.callService("homeassistant",t?"turn_off":"turn_on",{entity_id:e.smart})}),this.on(this.$(".rij.programma"),"change",t=>{let n=t.target?.closest?.(".keuze");if(!n||!e.program)return;t.stopPropagation();let i=Tt(e.program,n.value,Se(x(this.hass,e.program)));i&&this.hass.callService(i[0],i[1],i[2])}),this.teardown_.push(K(this.$(".card")))}moreInfo_(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}druk_(e){let t=eo(e);t&&this.hass.callService(t[0],t[1],t[2])}paint(){let e=this.config,t=x(this.hass,e.status),n=x(this.hass,e.door),i=Xr(x(this.hass,e.remaining)),r=Qr(x(this.hass,e.progress)),o=Jr({status:t,deur:n,rest:i,pct:r}),s=Zr(t);this.toggleAttribute("draait",s),this.toggleAttribute("onbekend",s&&r==null);let d=this.$(".top"),l=Vl[o.tone]??N.accent;this.$(".card").style.setProperty("--tone",l),d.classList.toggle("unavailable",o.soort==="onbekend");let c=this.$(".chip"),p=e.icon||"dishwasher";c.dataset.icon!==p&&(c.dataset.icon=p,c.innerHTML=f(p,"dishwasher")),c.style.setProperty("--tone",l),this.text(".nm",e.name||C(this.hass,e.status,null)||"Vaatwasser");let h=this.$(".st"),g=B(o.tekst),m=o.waarschuwing?` &middot; <span class="let">${B(o.waarschuwing)}</span>`:"";h.dataset.tekst!==g+m&&(h.dataset.tekst=g+m,h.innerHTML=g+m),d.setAttribute("aria-label",`${this.$(".nm").textContent}, ${o.tekst}`);let v=this.$(".balk"),b=Yr(o.soort)&&(r!=null||s);if(v.hidden=!b,b){let j=this.$(".vul"),k=r!=null?`${r}%`:"";k&&j.style.width!==k&&(j.style.width=k),v.setAttribute("role","progressbar"),r!=null?(v.setAttribute("aria-valuenow",String(r)),v.setAttribute("aria-valuemin","0"),v.setAttribute("aria-valuemax","100")):v.removeAttribute("aria-valuenow")}this.paintBediening_(),L(this.$(".card"))}paintBediening_(){let e=this.config,t=this.$(".programslot"),n=x(this.hass,e.program),i=e.program?Se(n):[],r=i.map(l=>Lt(l,this.hass?.formatEntityState?.(n,l))),o=JSON.stringify([i,r]);t.dataset.opties!==o&&(t.dataset.opties=o,t.innerHTML=i.length?`<select class="keuze" aria-label="Programma">${i.map((l,c)=>`<option value="${B(l)}">${B(r[c])}</option>`).join("")}</select>`:"");let s=t.querySelector(".keuze");if(s&&this.shadowRoot.activeElement!==s){let l=Ct(n);s.value!==l&&(s.value=l)}let d=this.$(".knop.slim");d.hidden=!e.smart,e.smart&&(d.dataset.aan=String(ke(x(this.hass,e.smart)))),this.$(".knop.start").hidden=!e.start,this.$(".knop.stop").hidden=!e.stop,this.$(".rij.programma").hidden=!s,this.$(".rij.knoppen").hidden=!e.smart&&!e.start&&!e.stop}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:this.minRijen_(".card",2)}}static getConfigElement(){return document.createElement("domotiapp-dishwasher-card-editor")}static getStubConfig(e,t){return{status:((i,r)=>t?.find(o=>o.startsWith(i)&&r.test(o))??"")("sensor.",/vaatwas|dishwash/i),name:"Vaatwasser"}}};z(rn,"css",`
    :host { display: block; }
    ...
    :focus-visible { outline: 2px solid var(--tone); outline-offset: 2px; }
  `);var Aa=class extends D{defaults(){return{icon:"dishwasher"}}pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"dishwasher",auto:!1}]}schema(){return[{name:"name",selector:_.text()},{name:"status",selector:_.entity(["sensor","binary_sensor"])},{name:"remaining",selector:_.entity(["sensor"])},{name:"progress",selector:_.entity(["sensor","number"])},{name:"program",selector:_.entity(["select","input_select"])},{name:"start",selector:_.entity(["button","input_button","script","switch","automation"])},{name:"stop",selector:_.entity(["button","input_button","script","switch","automation"])},{name:"door",selector:_.entity(["binary_sensor"])},{name:"smart",selector:_.entity(["input_boolean","switch"])}]}label(e){return{name:"Naam",status:"Statussensor",remaining:"Resterende tijd",progress:"Voortgang (0-100%)",program:"Programmakeuze",start:"Start / pauze",stop:"Stop",door:"Klep- of deursensor",smart:"Slimme sturing"}[e.name]??super.label(e)}helper(e){return{status:"De sensor die Run, Ready, Finished of iets in die geest meldt. De kaart vertaalt dat zelf.",remaining:"Een tijdstip, een aantal minuten of een klok als 1:24:00 \u2014 alle drie worden gelezen. Een tijdstip is het moment waarop hij klaar is, geen duur.",progress:"Zonder deze sensor is er geen stand, en schuift er een streepje heen en weer zolang hij draait.",program:"Een keuzelijst met de programma's. Verschijnt als uitklaplijst op de kaart.",start:"Een knop, een script of een schakelaar \u2014 de kaart kiest zelf de juiste service.",stop:"Idem. Deze knop is rood, want hij onderbreekt iets dat loopt.",door:"Staat de klep open, dan zegt de kaart dat in plaats van 'klaar om te starten'.",smart:"De input_boolean van je eigen slimme sturing. De knop licht op als hij aanstaat."}[e.name]}};I("domotiapp-dishwasher-card-editor",Aa);O("domotiapp-dishwasher-card",rn,{name:"DomotiApp Vaatwasser",description:"Status, resterende tijd met voortgangsbalk, programmakeuze en de knoppen \u2014 met een balk die loopt zolang hij draait."});var on=globalThis,sn=on.ShadowRoot&&(on.ShadyCSS===void 0||on.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Sa=Symbol(),to=new WeakMap,ct=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Sa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(sn&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=to.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&to.set(t,e))}return e}toString(){return this.cssText}},ge=a=>new ct(typeof a=="string"?a:a+"",void 0,Sa),te=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[r+1],a[0]);return new ct(t,a,Sa)},no=(a,e)=>{if(sn)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=on.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},Ma=sn?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return ge(t)})(a):a;var{is:Bl,defineProperty:Kl,getOwnPropertyDescriptor:Gl,getOwnPropertyNames:Ul,getOwnPropertySymbols:Wl,getPrototypeOf:ql}=Object,ln=globalThis,ao=ln.trustedTypes,Fl=ao?ao.emptyScript:"",Zl=ln.reactiveElementPolyfillSupport,pt=(a,e)=>a,Na={toAttribute(a,e){switch(e){case Boolean:a=a?Fl:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},ro=(a,e)=>!Bl(a,e),io={attribute:!0,type:String,converter:Na,reflect:!1,useDefault:!1,hasChanged:ro};Symbol.metadata??=Symbol("metadata"),ln.litPropertyMetadata??=new WeakMap;var fe=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=io){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&Kl(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:r}=Gl(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let s=i?.call(this);r?.call(this,o),this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??io}static _$Ei(){if(this.hasOwnProperty(pt("elementProperties")))return;let e=ql(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(pt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(pt("properties"))){let t=this.properties,n=[...Ul(t),...Wl(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(Ma(i))}else e!==void 0&&t.push(Ma(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return no(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Na).toAttribute(t,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Na;this._$Em=i;let s=o.fromAttribute(t,r.type);this[i]=s??this._$Ej?.get(i)??s,this._$Em=null}}requestUpdate(e,t,n,i=!1,r){if(e!==void 0){let o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??ro)(r,t)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,r]of n){let{wrapped:o}=r,s=this[i];o!==!0||this._$AL.has(i)||s===void 0||this.C(i,void 0,r,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};fe.elementStyles=[],fe.shadowRootOptions={mode:"open"},fe[pt("elementProperties")]=new Map,fe[pt("finalized")]=new Map,Zl?.({ReactiveElement:fe}),(ln.reactiveElementVersions??=[]).push("2.1.2");var Ia=globalThis,oo=a=>a,dn=Ia.trustedTypes,so=dn?dn.createPolicy("lit-html",{createHTML:a=>a}):void 0,mo="$lit$",Ae=`lit$${Math.random().toFixed(9).slice(2)}$`,go="?"+Ae,Xl=`<${go}>`,Te=document,ut=()=>Te.createComment(""),mt=a=>a===null||typeof a!="object"&&typeof a!="function",Ra=Array.isArray,Ql=a=>Ra(a)||typeof a?.[Symbol.iterator]=="function",Oa=`[ 	
\f\r]`,ht=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,lo=/-->/g,co=/>/g,Oe=RegExp(`>|${Oa}(?:([^\\s"'>=/]+)(${Oa}*=${Oa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),po=/'/g,ho=/"/g,fo=/^(?:script|style|textarea|title)$/i,Pa=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),w=Pa(1),zu=Pa(2),ju=Pa(3),Le=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),uo=new WeakMap,Ce=Te.createTreeWalker(Te,129);function bo(a,e){if(!Ra(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return so!==void 0?so.createHTML(e):e}var Yl=(a,e)=>{let t=a.length-1,n=[],i,r=e===2?"<svg>":e===3?"<math>":"",o=ht;for(let s=0;s<t;s++){let d=a[s],l,c,p=-1,h=0;for(;h<d.length&&(o.lastIndex=h,c=o.exec(d),c!==null);)h=o.lastIndex,o===ht?c[1]==="!--"?o=lo:c[1]!==void 0?o=co:c[2]!==void 0?(fo.test(c[2])&&(i=RegExp("</"+c[2],"g")),o=Oe):c[3]!==void 0&&(o=Oe):o===Oe?c[0]===">"?(o=i??ht,p=-1):c[1]===void 0?p=-2:(p=o.lastIndex-c[2].length,l=c[1],o=c[3]===void 0?Oe:c[3]==='"'?ho:po):o===ho||o===po?o=Oe:o===lo||o===co?o=ht:(o=Oe,i=void 0);let g=o===Oe&&a[s+1].startsWith("/>")?" ":"";r+=o===ht?d+Xl:p>=0?(n.push(l),d.slice(0,p)+mo+d.slice(p)+Ae+g):d+Ae+(p===-2?s:g)}return[bo(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},gt=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let r=0,o=0,s=e.length-1,d=this.parts,[l,c]=Yl(e,t);if(this.el=a.createElement(l,n),Ce.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=Ce.nextNode())!==null&&d.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(mo)){let h=c[o++],g=i.getAttribute(p).split(Ae),m=/([.?@])?(.*)/.exec(h);d.push({type:1,index:r,name:m[2],strings:g,ctor:m[1]==="."?Ta:m[1]==="?"?La:m[1]==="@"?Da:Ge}),i.removeAttribute(p)}else p.startsWith(Ae)&&(d.push({type:6,index:r}),i.removeAttribute(p));if(fo.test(i.tagName)){let p=i.textContent.split(Ae),h=p.length-1;if(h>0){i.textContent=dn?dn.emptyScript:"";for(let g=0;g<h;g++)i.append(p[g],ut()),Ce.nextNode(),d.push({type:2,index:++r});i.append(p[h],ut())}}}else if(i.nodeType===8)if(i.data===go)d.push({type:2,index:r});else{let p=-1;for(;(p=i.data.indexOf(Ae,p+1))!==-1;)d.push({type:7,index:r}),p+=Ae.length-1}r++}}static createElement(e,t){let n=Te.createElement("template");return n.innerHTML=e,n}};function Ke(a,e,t=a,n){if(e===Le)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,r=mt(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=Ke(a,i._$AS(a,e.values),i,n)),e}var Ca=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??Te).importNode(t,!0);Ce.currentNode=i;let r=Ce.nextNode(),o=0,s=0,d=n[0];for(;d!==void 0;){if(o===d.index){let l;d.type===2?l=new ft(r,r.nextSibling,this,e):d.type===1?l=new d.ctor(r,d.name,d.strings,this,e):d.type===6&&(l=new Ha(r,this,e)),this._$AV.push(l),d=n[++s]}o!==d?.index&&(r=Ce.nextNode(),o++)}return Ce.currentNode=Te,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},ft=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),mt(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==Le&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ql(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&mt(this._$AH)?this._$AA.nextSibling.data=e:this.T(Te.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=gt.createElement(bo(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let r=new Ca(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=uo.get(e.strings);return t===void 0&&uo.set(e.strings,t=new gt(e)),t}k(e){Ra(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let r of e)i===t.length?t.push(n=new a(this.O(ut()),this.O(ut()),this,this.options)):n=t[i],n._$AI(r),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let n=oo(e).nextSibling;oo(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ge=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,i){let r=this.strings,o=!1;if(r===void 0)e=Ke(this,e,t,0),o=!mt(e)||e!==this._$AH&&e!==Le,o&&(this._$AH=e);else{let s=e,d,l;for(e=r[0],d=0;d<r.length-1;d++)l=Ke(this,s[n+d],t,d),l===Le&&(l=this._$AH[d]),o||=!mt(l)||l!==this._$AH[d],l===y?e=y:e!==y&&(e+=(l??"")+r[d+1]),this._$AH[d]=l}o&&!i&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ta=class extends Ge{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},La=class extends Ge{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},Da=class extends Ge{constructor(e,t,n,i,r){super(e,t,n,i,r),this.type=5}_$AI(e,t=this){if((e=Ke(this,e,t,0)??y)===Le)return;let n=this._$AH,i=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==y&&(n===y||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ha=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}};var Jl=Ia.litHtmlPolyfillSupport;Jl?.(gt,ft),(Ia.litHtmlVersions??=[]).push("3.3.3");var vo=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let r=t?.renderBefore??null;n._$litPart$=i=new ft(e.insertBefore(ut(),r),r,void 0,t??{})}return i._$AI(a),i};var Va=globalThis,F=class extends fe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=vo(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Le}};F._$litElement$=!0,F.finalized=!0,Va.litElementHydrateSupport?.({LitElement:F});var ed=Va.litElementPolyfillSupport;ed?.({LitElement:F});(Va.litElementVersions??=[]).push("4.2.2");var oe=te`
  :host {
    ${ge(Z)}
    font-family: var(--dac-font);
    color: var(--dac-ink);
  ...
  ${ge(ve)}
`;var td=["unavailable","unknown"],nd=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function cn({scene:a,memberEntityIds:e,states:t}){let n=[],i=[],r=a?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let d of o){let l=r[d];if(!l||typeof l!="object")continue;let c=s[d];if(!c||td.includes(c.state)){i.push(d);continue}if(l.state==="off"){n.push({service:"turn_off",data:{entity_id:d,transition:1}});continue}let p={entity_id:d,transition:1};typeof l.brightness=="number"&&(p.brightness=l.brightness);for(let h of nd)if(l[h]!==void 0){p[h]=l[h];break}n.push({service:"turn_on",data:p})}return{oproepen:n,overgeslagen:i}}async function pn(a,e){let t=await Promise.allSettled(e.map(i=>a(i.service,i.data))),n=[];return t.forEach((i,r)=>{i.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:i.reason})}),n}var Ka=["hs","rgb","rgbw","rgbww","xy"],Ga="color_temp",ad="onoff";var De="kleur";var id=["unavailable","unknown"],xo=["color_temp_kelvin","rgb_color","hs_color","xy_color"],rd=[0,100];function ce(a){if(!a)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=a.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===ad,i=t!==null&&t.includes(Ga),r=t!==null&&t.some(l=>Ka.includes(l)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,d=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!id.includes(a.state),helderheid:!n,kleurtemp:i,kleur:r,minKelvin:d?Math.round(o):2e3,maxKelvin:d?Math.round(s):6535,kelvinUitDefaults:i&&!d}}function od(){return{state:"off"}}function _o(a,e){let t=e??ce(a);return t.bekend&&t.beschikbaar&&a.state==="on"?{state:"on",...hd(a,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function wo(a,e,t,n){return e?a&&a.state==="on"?{...a}:_o(t,n):{state:"off"}}function yo(a,e,t,n){let i=n??ce(t),r=Xa(a,t,i);return i.helderheid&&(r.brightness=H(e,1,255)),r}function Ua(a,e,t,n){let i=n??ce(t),r=Xa(a,t,i);return Co(r),r.color_temp_kelvin=H(e,i.minKelvin,i.maxKelvin),r}function Wa(a,e,t,n){let i=n??ce(t),r=Xa(a,t,i);return Co(r),r.hs_color=[H(e?.[0],0,360),H(e?.[1],0,100)],r}function hn(a,e,t){return a??od()}function zo(a,e,t){let n=hn(a,e,t);if(typeof n.brightness=="number")return H(n.brightness,1,255);let i=e?.attributes?.brightness;return typeof i=="number"?H(i,1,255):255}function qa(a,e,t){let n=t??ce(e),i=hn(a,e,n);if(typeof i.color_temp_kelvin=="number")return H(i.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?H(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function un(a,e,t){let n=hn(a,e,t);if(Ba(n.hs_color))return[H(n.hs_color[0],0,360),H(n.hs_color[1],0,100)];let i=e?.attributes?.hs_color;return Ba(i)?[H(i[0],0,360),H(i[1],0,100)]:[...rd]}function Fa(a){return a!=null&&typeof a=="object"}function jo(a,e,t){let n=Array.isArray(e)?e:[],i=Array.isArray(a)?a:[],r=Number.isInteger(t)?t:i.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Fa(i[s]?.lights?.[o]))return!0;return!1})}function Eo(a){return!Number.isInteger(a)||a<=0?null:a===1?"1 lamp nog niet ingesteld":`${a} lampen nog niet ingesteld`}function Za(a,e,t){return hn(a,e,t).state==="on"}function $o(a,e,t){let n=t??ce(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let i=Za(a,e,n),r=Ao(n),o=r?sd(a,e,n):null;return{aanuit:!0,helderheid:i&&n.helderheid,kleurtemp:i&&n.kleurtemp&&(!r||o==="wit"),kleur:i&&n.kleur&&(!r||o===De),kleurkeuze:i&&r,stand:i?o:null}}function Ao(a){return!!(a?.kleurtemp&&a?.kleur)}function sd(a,e,t){let n=t??ce(e);if(a&&typeof a=="object"){if(typeof a.color_temp_kelvin=="number")return"wit";if(xo.slice(1).some(r=>a[r]!==void 0))return De}let i=e?.attributes?.color_mode;return i===Ga&&n.kleurtemp?"wit":Ka.includes(i)&&n.kleur?De:"wit"}function So(a,e,t,n){let i=n??ce(t);return Ao(i)?e==="wit"?Ua(a,qa(a,t,i),t,i):Wa(a,un(a,t,i),t,i):a}function Mo(a){let e=H(a,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function No(a){let e=H(a,1,100);return H(Math.round(e/100*255),1,255)}var ld=1e3,dd=4e4,ko=7;function cd(a){let e=H(a,ld,dd)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,i;return e>=66?i=255:e<=19?i=0:i=138.5177312231*Math.log(e-10)-305.0447927307,[H(t,0,255),H(n,0,255),H(i,0,255)]}function pd(a){let[e,t,n]=cd(a);return`rgb(${e}, ${t}, ${n})`}function Oo(a,e){let t=Math.min(a,e),n=Math.max(a,e);return`linear-gradient(to right, ${Array.from({length:ko},(r,o)=>{let s=o/(ko-1),d=t+(n-t)*s;return`${pd(d)} ${Math.round(s*100)}%`}).join(", ")})`}function hd(a,e){let t=a.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?H(t.brightness,1,255):255);let i=t.color_mode;return e.kleurtemp&&i===Ga&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=H(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Ka.includes(i)&&Ba(t.hs_color)&&(n.hs_color=[H(t.hs_color[0],0,360),H(t.hs_color[1],0,100)]),n}function Xa(a,e,t){return a&&a.state==="on"?{...a}:_o(e,t)}function Co(a){for(let e of xo)delete a[e]}function Ba(a){return Array.isArray(a)&&a.length===2&&typeof a[0]=="number"&&typeof a[1]=="number"}function H(a,e,t){let n=Number(a);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var mn="domotiapp-scene-card",Qa="domotiapp-scene-card-editor",To="domotiapp-scene-editor";var bt=["een","twee","drie"],Lo="pencil",Do=["grid_options","layout_options","view_layout","visibility"];var Ho="entity_id",Ue=class extends F{constructor(){super();z(this,"_label",t=>t.name==="entity"?"Lichtgroep":t.name==="bare"?"Achtergrond weglaten":this._friendlyName(t.name));z(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name==="bare"?"Haalt de vulling en de schaduw onder de kaart weg. De rand blijft staan.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[Ho]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[Ho];return Array.isArray(n)?n.filter(i=>i!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}},{name:"bare",selector:{boolean:{}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},i={};for(let r of t)r in this._getypt?i[r]=this._getypt[r]:n[r]&&(i[r]=n[r]);return i}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n=t.detail.value??{},i={...this._config,entity:n.entity};n.bare?i.bare=!0:delete i.bare,i.entity!==this._config?.entity&&(delete i.name_overrides,this._getypt={}),this._stuurDoor(i)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let i={...this._config};Object.keys(n).length?i.name_overrides=n:delete i.name_overrides,this._stuurDoor(i)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return y;let t=this._leden();return w`
      <ha-form
        .hass=${this.hass}
      ...
      ${t.length?w`
          ...
          `:y}
    `}};z(Ue,"properties",{hass:{attribute:!1},_config:{state:!0},_getypt:{state:!0}}),z(Ue,"styles",[oe,te`
      .namen {
        margin-top: 16px;
      }
      .kop {
    ...
    `}_renderInhoud(){return this._toestand===Ja?w`<div class="inhoud">Bezig met laden…</div>`:this._toestand===Ro?w`
        <div class="inhoud">
      ...
      <div class="inhoud">
        ...
        ${this._melding?w`<ha-alert alert-type="error">${this._melding}</ha-alert>`:y}
    ...
    `}_renderLamp(e){let t=this._stateVan(e),n=this._besturingVan(e),i=this._waardeVan(e),r=Za(i,t,n),o=$o(i,t,n);return w`
      <div class="lamp">
        <div class="kop">
          <div class="naam">
            <span class="tekst">
              ${this._naam(e)}
              ${n.bekend?n.beschikbaar?y:w`<span class="hint">niet bereikbaar</span>`:w`<span class="hint">lamp niet gevonden</span>`}
            </span>
            ${Fa(i)?y:w`<span class="nieuw">nieuw</span>`}
          </div>
          ${n.bekend?w`
                <div class="bediening">
                  ...
                  <ha-switch
                    .checked=${r}
                    @change=${s=>this._zetLamp(e,wo(i,s.target.checked,t,n))}
                  ></ha-switch>
                </div>
              `:y}
        </div>
    ...
    `}_renderHelderheid(e,t,n,i){let r=Mo(zo(i,t,n)),o=s=>{s.stopPropagation(),this._zetLamp(e,yo(this._waardeVan(e),No(s.detail.value),t,n))};return w`
      <div class="besturing">
        <div class="label">
    ...
    `}_renderKleurkeuze(e,t,n,i,r){let o=s=>d=>{d.stopPropagation(),s!==r&&this._zetLamp(e,So(this._waardeVan(e),s,t,n))};return w`
    ...
    `}_renderKleurtemp(e,t,n,i){let r=qa(i,t,n),o=s=>{s.stopPropagation(),this._zetLamp(e,Ua(this._waardeVan(e),s.detail.value,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <ha-control-slider
          ...
          .step=${1}
          .value=${r}
          style=${`--control-slider-background: ${Oo(n.minKelvin,n.maxKelvin)}; --control-slider-background-opacity: 1`}
          @slider-moved=${o}
          @value-changed=${o}
        ></ha-control-slider>
      </div>
    `}_renderKleur(e,t,n,i){let[r,o]=un(i,t,n),s=d=>l=>{l.stopPropagation();let c=un(this._waardeVan(e),t,n),p=d==="tint"?[l.detail.value,c[1]]:[c[0],l.detail.value];this._zetLamp(e,Wa(this._waardeVan(e),p,t,n))};return w`
      <div class="besturing">
        <div class="label">
        ...
        <div class="kleurregelaars">
          <div class="schuiven">
            <ha-control-slider
              ...
              .step=${1}
              .value=${r}
              style=${`--control-slider-background: ${bd}; --control-slider-background-opacity: 1`}
              @slider-moved=${s("tint")}
    ...
    `}};z(We,"properties",{hass:{attribute:!1},entityId:{attribute:!1},nameOverrides:{attribute:!1},_scenes:{state:!0},_leden:{state:!0},_tab:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0}}),z(We,"styles",[oe,te`
    ...
    `]);var vd=[400,1e3,2e3,4e3,8e3,15e3,3e4,3e4,3e4];function bn(a){let e=a?.code;return e==="unknown_command"?!0:e==="not_allowed"&&/niet geladen/i.test(String(a?.message??""))}var qe=class{constructor(e,{wachttijden:t=vd,klok:n,stopKlok:i}={}){this.doe_=e,this.wachttijden_=t,this.klok_=n??((r,o)=>setTimeout(r,o)),this.stopKlok_=i??(r=>clearTimeout(r)),this.poging=0,this.timer_=null}get magNog(){return this.poging<this.wachttijden_.length}plan(){if(this.timer_)return!0;if(!this.magNog)return!1;let e=this.wachttijden_[this.poging];return this.poging+=1,this.timer_=this.klok_(()=>{this.timer_=null,this.doe_()},e),!0}herstel(){this.stop(),this.poging=0}stop(){this.timer_!==null&&(this.stopKlok_(this.timer_),this.timer_=null)}};var kd="0.17.0",xd=["type","entity","name_overrides","bare"],vn="laden",vt="klaar",ti="leeg",ni="geen-groep",Po="opslagfout",Vo="fout",kt=class extends F{constructor(){super();z(this,"_opnieuw",()=>{this._herkansing.herstel(),this._haalScenesOp()});this._scenes=null,this._leden=[],this._toestand=vn,this._melding="",this._bezig=!1,this._editorOpen=!1,this._opgehaaldVoor=null,this._bestondVorigeKeer=!1,this._herkansing=new qe(()=>this._haalScenesOp())}static getConfigElement(){return document.createElement(Qa)}static getStubConfig(t){return{entity:Object.keys(t?.states??{}).find(i=>i.startsWith("light.")&&Array.isArray(t.states[i].attributes?.entity_id))??""}}updated(){let t=this.renderRoot?.querySelector(".card, .needs");t!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=t,this._rasterUit=t?K(t):null),L(t)}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}setConfig(t){if(!t?.entity)throw new Error("Kies een lichtgroep bij 'entity'.");let n=Object.keys(t).filter(i=>!xd.includes(i)&&!Do.includes(i));n.length&&console.warn(`${mn}: onbekende sleutels in de configuratie: ${n.join(", ")}`),this._config=t,this.toggleAttribute("bare",!!t.bare)}getCardSize(){return 1}getGridOptions(){return{rows:"auto",columns:"full",min_columns:6,min_rows:Ie(this.renderRoot?.querySelector?.(".card"))??1}}willUpdate(){let t=this._config?.entity;if(!this.hass||!t)return;let n=!!this.hass.states[t];if(this._opgehaaldVoor!==t){this._opgehaaldVoor=t,this._bestondVorigeKeer=n,this._haalScenesOp();return}if(n&&!this._bestondVorigeKeer&&this._toestand===ni){this._bestondVorigeKeer=!0,this._haalScenesOp();return}this._bestondVorigeKeer=n}async _haalScenesOp(){let t=this._config.entity;this._toestand=vn,this._melding="";try{let n=await this.hass.callWS({type:"domotiapp_lovelace/scenes/get",entity_id:t});this._scenes=n.scenes,this._leden=n.member_entity_ids??[],this._toestand=this._leden.length===0?ti:vt,this._herkansing.herstel()}catch(n){this._verwerkFout(n,t)}}_verwerkFout(t,n){let i=t?.code;if(this._melding=t?.message??String(t),bn(t)&&this._herkansing.plan()){this._toestand=vn;return}if(i==="home_assistant_error"){this._toestand=Po;return}if(!this.hass.states[n]){this._toestand=ni;return}this._toestand=Vo}_naam(t){return this._config?.name_overrides?.[t]||this.hass?.states?.[t]?.attributes?.friendly_name||t}async _pasSceneToe(t){if(this._bezig||this._toestand!==vt)return;let{oproepen:n}=cn({scene:this._scenes?.[t],memberEntityIds:this._leden,states:this.hass.states});if(n.length){this._bezig=!0;try{let i=await pn((r,o)=>this.hass.callService("light",r,o),n);i.length&&this._meldMislukking(i.map(r=>r.entityId))}finally{this._bezig=!1}}}_meldMislukking(t){let n=t.map(r=>this._naam(r)).join(", "),i=t.length===1?`${n} reageerde niet.`:`Deze lampen reageerden niet: ${n}.`;this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:i},bubbles:!0,composed:!0}))}_bewerk(){this._toestand===vt&&(this._editorOpen=!0)}_sluitEditor(){this._editorOpen=!1}_scenesOpgeslagen(t){t.stopPropagation(),this._scenes=t.detail.scenes,this._leden=t.detail.member_entity_ids??[],this._toestand=this._leden.length===0?ti:vt}render(){if(!this._config)return y;switch(this._toestand){case ni:return this._renderFout(`Lichtgroep ${this._config.entity} bestaat niet (meer). Pas de kaart aan.`);case Po:return this._renderFout("De opgeslagen scenes van deze kamer zijn onleesbaar.",this._melding);case Vo:return this._renderFout("De scenes konden niet geladen worden.",this._melding,!0);default:return this._renderKaart()}}_renderFout(t,n,i=!1){return w`
      <div class="needs">
        <span class="mark">${this._icoon("question")}</span>
        <span>
          <b>${t}</b>
          ${n?w`<span class="detail">${n}</span>`:y}
          ${i?w`<button type="button" class="opnieuw" @click=${this._opnieuw}>
                Opnieuw proberen
              </button>`:y}
        </span>
      </div>
    `}_icoon(t){let n=document.createElement("template");return n.innerHTML=f(t),n.content.cloneNode(!0)}_renderKaart(){let t=this._toestand===ti,n=this._toestand===vn,i=this._iconen();return w`
      <div class="card surface">
        <div class="rij">
          <div class="scenes">
            ${i.map((r,o)=>w`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==vt)return y;let t=jo(this._scenes,this._leden,3).length,n=Eo(t);return n?w`<div class="mededeling">${n}</div>`:y}_renderEditor(){return w`
      ...
      ></domotiapp-scene-editor>
    `}_iconen(){return Array.from({length:3},(t,n)=>this._scenes?.[n]?.icon||bt[n])}};z(kt,"properties",{hass:{attribute:!1},_config:{state:!0},_scenes:{state:!0},_leden:{state:!0},_toestand:{state:!0},_melding:{state:!0},_bezig:{state:!0},_editorOpen:{state:!0}}),z(kt,"styles",[oe,te`
      :host { display: block; }
    ...
    `]);M(mn,kt);M(Qa,Ue);M(To,We);Re({type:mn,name:"DomotiApp Scene",description:`Drie lichtscenes per kamer, vastgelegd bij de lichtgroep (v${kd}).`,preview:!1});var He="domotiapp-alarm-card",ai="domotiapp-alarm-card-editor",Bo="domotiapp-alarm-editor",Ko="DomotiApp Wekker",Go="https://github.com/Sven2410/domotiapp-lovelace",pe="domotiapp_lovelace",re=Object.freeze({get:`${pe}/alarms/get`,save:`${pe}/alarms/save`,setEnabled:`${pe}/alarms/set_enabled`,delete:`${pe}/alarms/delete`,stop:`${pe}/alarms/stop`,clearMessage:`${pe}/alarms/clear_message`,search:`${pe}/sound/search`,entities:`${pe}/entities/list`,previewStart:`${pe}/preview/start`,subscribe:`${pe}/updates/subscribe`}),kn="#026FA1";function Uo(a){let e=typeof a?.name=="string"?a.name.trim():"",t=typeof a?.time=="string"?a.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var _d="07:00";var wd=["uri","name","media_type","image"],yd="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",zd="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var jd="Music Assistant Wekker",Ed="Verlichting Wekker";function xn(){return{id:null,name:"",time:_d,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function Wo(a){let e=xn();return!a||typeof a!="object"?e:{id:typeof a.id=="string"?a.id:null,name:typeof a.name=="string"?a.name:"",time:ii(a.time)?a.time:e.time,days:Array.isArray(a.days)?[...a.days]:[],enabled:a.enabled!==!1,sound:xt(a.sound),endless:null,speaker:typeof a.speaker=="string"?a.speaker:"",volume_pct:Number.isInteger(a.volume_pct)?a.volume_pct:e.volume_pct,light:a.light&&typeof a.light=="object"?{entity_id:a.light.entity_id,brightness_pct:Number.isInteger(a.light.brightness_pct)?a.light.brightness_pct:60}:null}}function xt(a){if(!a||typeof a!="object"||Array.isArray(a)||typeof a.uri!="string"||!a.uri)return null;let e={};for(let t of wd)e[t]=a[t]===void 0?null:a[t];return e}function ii(a){if(typeof a!="string"||a.length!==5||a[2]!==":")return!1;let e=Number(a.slice(0,2)),t=Number(a.slice(3));return!/^\d\d$/.test(a.slice(0,2))||!/^\d\d$/.test(a.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ri(a){let e=[];return!a||typeof a!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof a.name!="string"||!a.name.trim())&&e.push("een naam"),ii(a.time)||e.push("een geldige tijd"),a.speaker||e.push("een speaker"),(!a.sound||!a.sound.uri)&&e.push("een geluid"),(!Number.isInteger(a.volume_pct)||a.volume_pct<1||a.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function qo(a){let e=[...new Set(a.days||[])].sort((n,i)=>n-i),t={name:(a.name||"").trim(),time:a.time,days:e,enabled:e.length===0?!0:a.enabled!==!1,sound:xt(a.sound),speaker:a.speaker,volume_pct:a.volume_pct,light:a.light?{entity_id:a.light.entity_id,brightness_pct:a.light.brightness_pct}:null};return a.id&&(t.id=a.id),t}function Fo(a,e){let t=new Set(a||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((n,i)=>n-i)}function Zo(a){return ii(a)&&a.slice(0,2)==="02"?yd:null}function Xo(a){return a===!1?zd:null}function Qo(a){return typeof a?.endless=="boolean"?a.endless:null}function _n(a,e){let t=e==="lamp",n=t?Ed:jd,i=t?"lampen":"speakers";return!a||typeof a!="object"?`De lijst met ${i} is niet op te halen.`:a.label_exists===!1?`Het label '${n}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${i} zetten die als wekker mogen dienen.`:Array.isArray(a.entities)&&a.entities.length>0?null:Number(a.filtered_out)>0?t?`De entiteiten met het label '${n}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${i} met het label '${n}'.`}function Yo(a,e){return _n(e,"speaker")!==null?!1:ri(a).ok}var Ad=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Sd=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],_t="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Md="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Nd="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",Fe=class extends F{constructor(){super(),this._concept=xn(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?Wo(this.wekker):xn(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:re.previewStart,speaker:this._concept.speaker,sound:xt(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:re.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let n=await this.hass.callWS(t);this._treffers=n.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:xt(e),endless:Qo(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ri(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:re.save,person:this.person,alarm:qo(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return w`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      <path d=${e} />
    </svg>`}render(){if(!this.hass)return y;let e=this._concept,t=this.entiteiten?.speakers,n=this.entiteiten?.lights,i=_n(t,"speaker"),r=_n(n,"lamp"),o=Zo(e.time),s=Xo(e.endless),d=Yo(e,t);return w`
      <div class="kop">
      ...
      <div class="blok">
        ...
        <div class="dagen">
          ${Ad.map(([l,c])=>w`<button
              ...
              aria-label=${c}
              @click=${()=>this._zet({days:Fo(e.days,l)})}
            >
              ${c}
            </button>`)}
        </div>
      ...
      <div class="blok">
        ...
        ${i?w`<div class="uitleg">${this._svg(_t)}<span>${i}</span></div>`:w`<div class="vak">
              <select
                id="speaker"
                .value=${e.speaker}
      ...
      <div class="blok">
        ...
        ${e.sound?w`<div class="gekozen">
              ${e.sound.image?w`<img src=${e.sound.image} alt="" />`:y}
        ...
        <div class="rij" style="margin-top:8px">
          ...
          <div class="vak auto">
            ...
            >
              ${Sd.map(([l,c])=>w`<option value=${l}>${c}</option>`)}
            </select>
          </div>
          <button
            class="knop zoekknop"
        ...
        ${this._treffers?w`<div class="treffers">
              ${this._treffers.length===0?w`<div class="treffer">Niets gevonden.</div>`:this._treffers.map(l=>w`<button
                    ...
                    >
                      ${l.image?w`<img src=${l.image} alt="" />`:y}
                      <span>${l.name}</span>
                      <span class="soort">${l.media_type??""}</span>
                    </button>`)}
            </div>`:y}
        ${s?w`<div class="waarschuwing">${this._svg(_t)}<span>${s}</span></div>`:y}
      </div>
      ...
      <div class="blok">
        ...
        ${r?w`<div class="uitleg">${this._svg(_t)}<span>${r}</span></div>`:w`
              <div class="vak">
                <select
                  id="lamp"
      ...
      ${this._melding?w`<div class="blok">
            <div class="waarschuwing ${this._melding.fout?"fout":""}">
              ${this._svg(_t)}<span>${this._melding.tekst}</span>
            </div>
          </div>`:y}
    ...
    `}};z(Fe,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),z(Fe,"styles",[oe,te`
    :host {
      --domotiapp-accent: var(--dac-accent-hi, ${ge(kn)});
      display: block;
  ...
  `]);var Jo="person",Od="Kies een persoon in de kaartinstellingen.",es="De gekozen persoon is niet gevonden.",Cd="De opgeslagen wekkers van deze persoon zijn onleesbaar.",Em=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function ts(a){if(!a||typeof a!="object"||Array.isArray(a))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=a.person;if(e==null||e==="")return{...a};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Jo}.`))throw new Error(`'${e}' zit niet in het domein ${Jo}. Kies een persoon, zoals person.sven.`);return{...a}}function ns(a){return{type:`custom:${a}`}}function as(a,e){return a?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:es,isFout:!0}:{soort:"ontbreekt",tekst:Od,isFout:!1}}function is(a,e){return a==="not_found"?es:a==="home_assistant_error"?Cd:e||"Er ging iets mis bij het ophalen van de wekkers."}var Td=["ma","di","wo","do","vr","za","zo"],Ld="Geen wekkers ingesteld",Dd="Eenmalig",Hd="Eenmalig \u2014 afgelopen",Id="Geen wekker actief",rs="Stoppen",Rd="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Pd(a){return!Array.isArray(a)||a.length===0?Dd:[...new Set(a)].sort((t,n)=>t-n).map(t=>Td[t-1]??"?").join(" ")}function Vd(a,e){return!a||Array.isArray(a.days)&&a.days.length>0?!1:Date.parse(a?.one_shot_at??"")<=e}function os(a,e){return Vd(a,e)?Hd:Pd(a?.days)}function ss(a){let e=a?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Rd,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function ls(a){let e=a?.alarms;if(!Array.isArray(e)||e.length===0)return Ld;let t=a?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Id}function ds(a,e){let t=[...new Set((e??[]).filter(o=>typeof o=="string"))];if(t.length===0)return null;let n=t.map(o=>(a??[]).find(s=>s?.id===o)).filter(Boolean),i=n.map(o=>o.name).filter(Boolean),r=[...new Set(n.map(o=>o.time).filter(Boolean))];return{ids:t,naam:i.length?i.join(" en "):"Wekker",tijd:r.join(" en ")}}var Bd="0.17.0",Kd="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Gd="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",cs="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Ud="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",wn=(a,e="icoon")=>w`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    <path d=${a} />
  </svg>`,wt=class extends F{constructor(){super(),this._toestand=null,this._fout=null,this._bevestigVoor=null,this._bezig=!1,this._tijdelijkeMelding=null,this._editorVoor=void 0,this._entiteiten=null,this._abonnementVoor=null,this._afmelden=null,this._herkansing=new qe(()=>this._haalOp())}setConfig(e){let t=ts(e),n=t.person!==this._config?.person;this._config=t,this.toggleAttribute("bare",!!e?.bare),n&&(this._toestand=null,this._fout=null,this._bevestigVoor=null,this._herstartAbonnement())}static getConfigElement(){return document.createElement(ai)}static getStubConfig(){return ns(He)}getGridOptions(){return{rows:"auto",columns:12,min_columns:6,min_rows:Ie(this.renderRoot?.querySelector?.(".card"))??1}}getCardSize(){if(this._stop())return 3;let e=this._toestand?.alarms?.length??0;return 1+Math.max(e,1)}connectedCallback(){super.connectedCallback(),this._herstartAbonnement()}disconnectedCallback(){super.disconnectedCallback(),this._herkansing.stop(),this._stopAbonnement(),this._rasterUit?.(),this._rasterUit=null,this._rasterVak=null}updated(e){e.has("hass")&&this.hass&&this._startAbonnement(),this._volgRaster()}_volgRaster(){let e=this.renderRoot?.querySelector(".card, .needs");e!==this._rasterVak&&(this._rasterUit?.(),this._rasterVak=e,this._rasterUit=e?K(e):null),L(e)}async _startAbonnement(){let e=this._config?.person;if(!(!this.hass||!e||!this.isConnected)&&this._abonnementVoor!==e){this._abonnementVoor=e;try{let t=await this.hass.connection.subscribeMessage(n=>this._opGebeurtenis(n),{type:re.subscribe,person:e});if(this._abonnementVoor!==e){t();return}this._afmelden=t}catch(t){console.warn(`${He}: abonneren mislukt: ${t?.message??t}`)}await this._haalOp()}}_stopAbonnement(){if(this._afmelden){try{this._afmelden()}catch(e){console.warn(`${He}: afmelden mislukt: ${e?.message??e}`)}this._afmelden=null}this._abonnementVoor=null}_herstartAbonnement(){this._stopAbonnement(),this._startAbonnement()}_opGebeurtenis(e){let t=e?.alarm_id,n=e?.event;if(typeof t=="string"&&this._toestand){let i=new Set(this._toestand.ringing??[]);n==="started"?i.add(t):i.delete(t),this._toestand={...this._toestand,ringing:[...i]}}this._haalOp()}async _haalOp(){let e=this._config?.person;if(!(!this.hass||!e))try{let t=await this.hass.callWS({type:re.get,person:e});if(this._config?.person!==e)return;this._toestand=t,this._fout=null,this._herkansing.herstel()}catch(t){if(this._config?.person!==e||bn(t)&&this._herkansing.plan())return;this._toestand=null,this._fout=is(t?.code,t?.message)}}async _roep(e){if(!(!this.hass||this._bezig)){this._bezig=!0;try{let t=await this.hass.callWS(e);t&&typeof t=="object"&&(this._toestand=t,this._fout=null)}catch(t){this._toon(t?.message??"De opdracht is niet gelukt.")}finally{this._bezig=!1}}}async _openEditor(e){if(this._bevestigVoor=null,this._editorVoor=e,!!this.hass)try{this._entiteiten=await this.hass.callWS({type:re.entities})}catch(t){this._entiteiten=null,console.warn(`${He}: entiteitenlijst ophalen mislukt: ${t?.message??t}`)}}_sluitEditor(){this._editorVoor=void 0}_toon(e){this._tijdelijkeMelding=e,clearTimeout(this._meldingTimer),this._meldingTimer=setTimeout(()=>{this._tijdelijkeMelding=null},6e3)}_person(){return this._config?.person}_zetAan(e,t){this._roep({type:re.setEnabled,person:this._person(),alarm_id:e.id,enabled:t})}_verwijder(e){this._bevestigVoor=null,this._roep({type:re.delete,person:this._person(),alarm_id:e.id})}_begrepen(e){this._roep({type:re.clearMessage,person:this._person(),alarm_id:e.id})}async _stopAlles(e){for(let t of e)await this._roep({type:re.stop,person:this._person(),alarm_id:t})}_stop(){return this._toestand?ds(this._toestand.alarms,this._toestand.ringing):null}render(){if(!this._config)return y;let e=this._config.person,t=!!(e&&this.hass?.states?.[e]),n=as(e,t);if(n.soort!=="ok")return this._mededeling(n.tekst,n.isFout);if(this._fout)return this._mededeling(this._fout,!0);if(!this._toestand)return this._mededeling("Wekkers ophalen\u2026",!1);let i=this._stop();return this._editorVoor!==void 0&&!i?w`<div class="card surface">
    ...
    `}_bevestiging(e){return w`<div class="onderrij bevestiging">
      <span class="boodschap">${Uo(e)}</span>
      <button
        class="tekstknop"
    ...
    </div>`}_rij(e,t){let n=ss(e),i=!!e.enabled;return w`
      <div class="rij ${i?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
      ...
      ${n?w`<div class="onderrij ${n.isFout?"fout":""}">
            ${wn(n.isFout?Ud:cs,"icoon klein")}
            <span class="boodschap">${n.tekst}</span>
            <button class="tekstknop" @click=${()=>this._begrepen(e)}>
              Begrepen
            </button>
          </div>`:y}
    `}};z(wt,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),z(wt,"styles",[oe,te`
  ...
  `]);var Ze=class Ze extends F{constructor(){super(...arguments);z(this,"_label",t=>({person:"Persoon",bare:"Achtergrond weglaten"})[t.name]??t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?y:w`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let n={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};z(Ze,"properties",{hass:{attribute:!1},_config:{state:!0}}),z(Ze,"styles",[oe,te`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--dac-ink-2);
      font-size: 11.5px;
    }
  `]),z(Ze,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"bare",selector:{boolean:{}}}]);var oi=Ze;M(He,wt);M(ai,oi);M(Bo,Fe);Re({type:He,name:Ko,description:`Wekkerkaart van DomotiApp (v${Bd}).`,preview:!1,documentationURL:Go});var Wd=`
  :host {
    ${Z}
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,si=null,ps=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),li=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),si=si??[J(Wd)],this.shadowRoot.adoptedStyleSheets=si}connectedCallback(){this.gebouwd_||this.bouw_()}bouw_(){this.shadowRoot.innerHTML=`
