...
`;var so=["unavailable","unknown"],lo=["color_temp_kelvin","rgb_color","hs_color","xy_color"];function zt({scene:i,memberEntityIds:e,states:t}){let n=[],a=[],r=i?.lights??{},o=Array.isArray(e)?e:[],s=t??{};for(let d of o){let l=r[d];if(!l||typeof l!="object")continue;let c=s[d];if(!c||so.includes(c.state)){a.push(d);continue}if(l.state==="off"){n.push({service:"turn_off",data:{entity_id:d,transition:1}});continue}let u={entity_id:d,transition:1};typeof l.brightness=="number"&&(u.brightness=l.brightness);for(let m of lo)if(l[m]!==void 0){u[m]=l[m];break}n.push({service:"turn_on",data:u})}return{oproepen:n,overgeslagen:a}}async function St(i,e){let t=await Promise.allSettled(e.map(a=>i(a.service,a.data))),n=[];return t.forEach((a,r)=>{a.status==="rejected"&&n.push({entityId:e[r].data.entity_id,fout:a.reason})}),n}var Vn=["hs","rgb","rgbw","rgbww","xy"],In="color_temp",co="onoff";var we="kleur";var po=["unavailable","unknown"],la=["color_temp_kelvin","rgb_color","hs_color","xy_color"],ho=[0,100];function ne(i){if(!i)return{bekend:!1,beschikbaar:!1,helderheid:!1,kleurtemp:!1,kleur:!1,minKelvin:2e3,maxKelvin:6535,kelvinUitDefaults:!1};let e=i.attributes??{},t=Array.isArray(e.supported_color_modes)?e.supported_color_modes:null,n=t!==null&&t.length===1&&t[0]===co,a=t!==null&&t.includes(In),r=t!==null&&t.some(l=>Vn.includes(l)),o=e.min_color_temp_kelvin,s=e.max_color_temp_kelvin,d=typeof o=="number"&&typeof s=="number"&&o<s;return{bekend:!0,beschikbaar:!po.includes(i.state),helderheid:!n,kleurtemp:a,kleur:r,minKelvin:d?Math.round(o):2e3,maxKelvin:d?Math.round(s):6535,kelvinUitDefaults:a&&!d}}function uo(){return{state:"off"}}function da(i,e){let t=e??ne(i);return t.bekend&&t.beschikbaar&&i.state==="on"?{state:"on",..._o(i,t)}:t.helderheid?{state:"on",brightness:255}:{state:"on"}}function ca(i,e,t,n){return e?i&&i.state==="on"?{...i}:da(t,n):{state:"off"}}function pa(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return a.helderheid&&(r.brightness=S(e,1,255)),r}function Kn(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return ka(r),r.color_temp_kelvin=S(e,a.minKelvin,a.maxKelvin),r}function Un(i,e,t,n){let a=n??ne(t),r=qn(i,t,a);return ka(r),r.hs_color=[S(e?.[0],0,360),S(e?.[1],0,100)],r}function At(i,e,t){return i??uo()}function ha(i,e,t){let n=At(i,e,t);if(typeof n.brightness=="number")return S(n.brightness,1,255);let a=e?.attributes?.brightness;return typeof a=="number"?S(a,1,255):255}function Wn(i,e,t){let n=t??ne(e),a=At(i,e,n);if(typeof a.color_temp_kelvin=="number")return S(a.color_temp_kelvin,n.minKelvin,n.maxKelvin);let r=e?.attributes?.color_temp_kelvin;return typeof r=="number"?S(r,n.minKelvin,n.maxKelvin):Math.round((n.minKelvin+n.maxKelvin)/2)}function Mt(i,e,t){let n=At(i,e,t);if(Pn(n.hs_color))return[S(n.hs_color[0],0,360),S(n.hs_color[1],0,100)];let a=e?.attributes?.hs_color;return Pn(a)?[S(a[0],0,360),S(a[1],0,100)]:[...ho]}function Bn(i){return i!=null&&typeof i=="object"}function ua(i,e,t){let n=Array.isArray(e)?e:[],a=Array.isArray(i)?i:[],r=Number.isInteger(t)?t:a.length;return n.filter(o=>{for(let s=0;s<r;s+=1)if(!Bn(a[s]?.lights?.[o]))return!0;return!1})}function ma(i){return!Number.isInteger(i)||i<=0?null:i===1?"1 lamp nog niet ingesteld":`${i} lampen nog niet ingesteld`}function Gn(i,e,t){return At(i,e,t).state==="on"}function ga(i,e,t){let n=t??ne(e);if(!n.bekend)return{aanuit:!1,helderheid:!1,kleurtemp:!1,kleur:!1,kleurkeuze:!1,stand:null};let a=Gn(i,e,n),r=fa(n),o=r?mo(i,e,n):null;return{aanuit:!0,helderheid:a&&n.helderheid,kleurtemp:a&&n.kleurtemp&&(!r||o==="wit"),kleur:a&&n.kleur&&(!r||o===we),kleurkeuze:a&&r,stand:a?o:null}}function fa(i){return!!(i?.kleurtemp&&i?.kleur)}function mo(i,e,t){let n=t??ne(e);if(i&&typeof i=="object"){if(typeof i.color_temp_kelvin=="number")return"wit";if(la.slice(1).some(r=>i[r]!==void 0))return we}let a=e?.attributes?.color_mode;return a===In&&n.kleurtemp?"wit":Vn.includes(a)&&n.kleur?we:"wit"}function ba(i,e,t,n){let a=n??ne(t);return fa(a)?e==="wit"?Kn(i,Wn(i,t,a),t,a):Un(i,Mt(i,t,a),t,a):i}function va(i){let e=S(i,0,255);return e<=0?0:Math.max(1,Math.round(e/255*100))}function _a(i){let e=S(i,1,100);return S(Math.round(e/100*255),1,255)}var go=1e3,fo=4e4,sa=7;function bo(i){let e=S(i,go,fo)/100,t=e<=66?255:329.698727446*(e-60)**-.1332047592,n=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*(e-60)**-.0755148492,a;return e>=66?a=255:e<=19?a=0:a=138.5177312231*Math.log(e-10)-305.0447927307,[S(t,0,255),S(n,0,255),S(a,0,255)]}function vo(i){let[e,t,n]=bo(i);return`rgb(${e}, ${t}, ${n})`}function xa(i,e){let t=Math.min(i,e),n=Math.max(i,e);return`linear-gradient(to right, ${Array.from({length:sa},(r,o)=>{let s=o/(sa-1),d=t+(n-t)*s;return`${vo(d)} ${Math.round(s*100)}%`}).join(", ")})`}function _o(i,e){let t=i.attributes??{},n={};e.helderheid&&(n.brightness=typeof t.brightness=="number"?S(t.brightness,1,255):255);let a=t.color_mode;return e.kleurtemp&&a===In&&typeof t.color_temp_kelvin=="number"?n.color_temp_kelvin=S(t.color_temp_kelvin,e.minKelvin,e.maxKelvin):e.kleur&&Vn.includes(a)&&Pn(t.hs_color)&&(n.hs_color=[S(t.hs_color[0],0,360),S(t.hs_color[1],0,100)]),n}function qn(i,e,t){return i&&i.state==="on"?{...i}:da(e,t)}function ka(i){for(let e of la)delete i[e]}function Pn(i){return Array.isArray(i)&&i.length===2&&typeof i[0]=="number"&&typeof i[1]=="number"}function S(i,e,t){let n=Number(i);return Number.isFinite(n)?Math.min(t,Math.max(e,Math.round(n))):e}var Tt="domotiapp-scene-card",Fn="domotiapp-scene-card-editor",wa="domotiapp-scene-editor";var Xe=["een","twee","drie"],ya="pencil",$a=["grid_options","layout_options","view_layout","visibility"];var ja="entity_id",Se=class extends I{constructor(){super();k(this,"_label",t=>t.name==="entity"?"Lichtgroep":this._friendlyName(t.name));k(this,"_helper",t=>t.name==="entity"?"De lichtgroep waarvan deze kaart de scenes beheert.":t.name);this._getypt={}}setConfig(t){this._config={...t}}_lichtgroepen(){let t=this.hass?.states??{};return Object.keys(t).filter(n=>n.startsWith("light.")&&Array.isArray(t[n].attributes?.[ja]))}_leden(){let t=this._config?.entity,n=this.hass?.states?.[t]?.attributes?.[ja];return Array.isArray(n)?n.filter(a=>a!==t):[]}_entiteitSchema(){let t=this._lichtgroepen();return[{name:"entity",required:!0,selector:t.length?{entity:{include_entities:t}}:{entity:{domain:"light"}}}]}_namenSchema(t){return t.map(n=>({name:n,selector:{text:{}}}))}_naamData(t){let n=this._config?.name_overrides??{},a={};for(let r of t)r in this._getypt?a[r]=this._getypt[r]:n[r]&&(a[r]=n[r]);return a}_friendlyName(t){return this.hass?.states?.[t]?.attributes?.friendly_name||t}_entiteitGewijzigd(t){t.stopPropagation();let n={...this._config,entity:t.detail.value.entity};n.entity!==this._config?.entity&&(delete n.name_overrides,this._getypt={}),this._stuurDoor(n)}_namenGewijzigd(t){t.stopPropagation(),this._getypt={...this._getypt,...t.detail.value};let n={};for(let[r,o]of Object.entries(this._getypt))typeof o=="string"&&o.trim()&&(n[r]=o.trim());let a={...this._config};Object.keys(n).length?a.name_overrides=n:delete a.name_overrides,this._stuurDoor(a)}_stuurDoor(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return v;let t=this._leden();return g`
    ...
    `}_renderNieuweLampen(){if(this._toestand!==Ye)return v;let e=ua(this._scenes,this._leden,3).length,t=ma(e);return t?g`<div class="mededeling">${t}</div>`:v}_renderEditor(){return g`
